...
`+e.id,s=Dt.get(n);return s||(s=Bt(o.absoluteBoundingBox,e.absoluteBoundingBox),Dt.set(n,s)),[...s.map(i=>ur({guide:i,reverseScale:t})),...s.map(i=>mr({guide:i,reverseScale:t,fontSize:r}))]},Ut=E`
  .distance-line {
    shape-rendering: geometricPrecision;
    fill: none;
    opacity: 0;
            ...
            >
              ...
              ${C(this,r,"f").map(m=>{var g;return m.id===((g=this.selectedNode)===null||g===void 0?void 0:g.id)?null:A`
                  <g>
                    ...
                    ${this.selectedNode&&Ft({node:m,distanceTo:this.selectedNode,reverseScale:d,fontSize:u})}
                  </g>
                `})}
            </svg>
          `}
...
`,Dr=T`
  ...
  bottom: 0;
  left: 0;
`,Fr=({onZoomIn:o,onZoomOut:e,onReset:t})=>h(w,null,h(le,{onClick:o},h(po,null)),h(le,{onClick:e},h(ho,null)),h(le,{onClick:t},h(uo,null))),Ur=(o,e)=>{let[t,r]=P(1);M(()=>{r(o)},e);let n=k(()=>{r(c=>c+.1)},[r]),s=k(()=>{r(c=>Math.max(c-.1,.1))},[r]),i=k(()=>{r(1)},[r]);return{scale:t,zoomIn:n,zoomOut:s,resetZoom:i}},Vr=({config:o})=>{let e=Ur(o.scale||1,[o.scale]),t=G(()=>({transform:`scale(${e.scale})`}),[e.scale]);return h("div",{css:jr},h(it,{border:!0},h("div",{style:{display:"grid",gridAutoFlow:"column",gap:"4px",alignItems:"center"}},h(w,{key:"left"},h("p",null,h("b",null,"Image")),h(at,null),h(Fr,{onReset:e.resetZoom,onZoomIn:e.zoomIn,onZoomOut:e.zoomOut})))),h(Lr,{css:zr,defaultValue:o.offset},h("img",{css:Yr,src:o.url,style:t})))},jr=T`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
`,Gr=({config:o})=>h("div",{css:Wr},h(X,{cancel:!1,href:o.url,target:o.target??"_blank",rel:o.rel??"noopener",withArrow:o.showArrow??!0},o.label||o.url)),Wr=T`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
  ...
  align-items: center;
`;st();var Zr=o=>{if(o.protocol!=="https:")return{valid:!1,error:h(w,null,"Expected HTTPS link, received ",h("code",null,o.protocol),".")};if(o.hostname!=="www.sketch.com")return{valid:!1,error:h(w,null,"Expected a hostname ",h("code",null,"www.sketch.com"),", received"," ",h("code",null,o.hostname))};let e=h(w,null,"Expected pathname ",h("code",null,"/s/<string>/a/<string>"),", received"," ",h("code",null,o.pathname),"."),t=o.pathname.split("/").slice(1);if(t.length<4)return{valid:!1,error:e};if(t[0]==="embed")return{valid:!0,data:{url:o.href,offscreen:!1}};let[r,n,s,i]=t;return r!=="s"||!n||s!=="a"||!i?{valid:!1,error:e}:{valid:!0,data:{url:`https://www.sketch.com/embed/s/${n}/a/${i}`,offscreen:!1}}},qr=({config:o})=>{let e=G(()=>{let t=Zr(new URL(o.url));return t.valid?{...t,data:{...o,...t.data}}:t},[o]);return e.valid?h($e,{defer:!0,config:e.data}):h(H,null,h(w,null,"Invalid Sketch URL"),h(w,null,e.error))},Kr=({tabs:o,deps:e=[]})=>{let[t,r]=P(o[0].id);return M(()=>{r(o[0].id)},e),h(lt,{absolute:!0,selected:t,actions:{onSelect:r}},o.map(n=>h("div",{key:n.id,id:n.id,title:n.name},n.offscreen||t===n.id?n.content:null)))},Xr=Ae(()=>Promise.resolve().then(()=>(Rr(),_o))),Jr=({config:o})=>{if(!o||"length"in o&&o.length===0)return h(H,null,h(w,null,"No designs found"),h(w,null,"Learn how to"," ",h(X,{href:"https://github.com/storybookjs/addon-designs#3-add-it-to-story",target:"_blank",rel:"noopener",withArrow:!0,cancel:!1},"display design preview for the story")));let e=[...o instanceof Array?o:[o]].map(t=>{let r={id:JSON.stringify(t),name:t.name||t.type?.toUpperCase()||"ERROR",offscreen:t.offscreen??!0};switch(t.type){case"iframe":return{...r,content:h($e,{config:t})};case"figma":return{...r,content:h(yo,{config:t}),offscreen:!1};case"sketch":return{...r,content:h(qr,{config:t})};case"figspec":case"experimental-figspec":return t.type==="experimental-figspec"&&console.warn("[storybook-addon-designs] `experimental-figspec` is deprecated. We will remove it in v7.0. Please replace it to `figspec` type."),{...r,content:h(Ee,{fallback:"Preparing Figspec viewer..."},h(Xr,{config:t})),offscreen:!1};case"image":return{...r,content:h(Vr,{config:t})};case"link":return{...r,content:h(Gr,{config:t})}}return{...r,content:h(H,null,h(w,null,"Invalid config type"),h(w,null,"Config type you set is not supported. Please choose one from"," ",h(X,{href:"https://github.com/storybookjs/addon-designs/blob/master/packages/storybook-addon-designs/src/config.ts",target:"_blank",rel:"noopener",withArrow:!0,cancel:!1},"available config types")))}});return e.length===1?h("div",null,e[0].content):h(Kr,{tabs:e,deps:[o]})},Qr=({active:o})=>{let e=co(),t=lo(Io),[r,n]=P(o);return M(()=>{n(o)},[t]),M(()=>{o&&n(!0)},[o]),r?h(Jr,{key:e.storyId,config:t}):null},en="Design";function tn(o){et.register($o,e=>{et.add(Br,{title:en,render({active:t}){return t?h(Or,null,h(Qr,{active:!0})):h("noscript",null)},type:ao.TAB,paramKey:Io})})}tn();})();
