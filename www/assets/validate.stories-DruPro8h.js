import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{a as t,d as n,o as r,s as i}from"./preview-Lxgm_fxp.js";import{c as a,h as o,n as s,t as c}from"./lit-BfcklOOD.js";import{_ as l,a as ee,f as te,i as u,l as ne,n as d,o as re,r as f,s as p,t as m,x as ie,y as h}from"./synergy-element-B1XRUXNb.js";import{r as ae,t as oe}from"./if-defined-gcdQCgEY.js";import{n as g,t as se}from"./watch-RA3ULoLi.js";import{n as ce,t as le}from"./decorator-B3p9Y8B9.js";import{t as ue}from"./button-CdIPVuol.js";import{a as de,i as fe,n as _,o as pe,r as me,t as he}from"./component-BRYPxz3B.js";import{n as ge,t as _e}from"./taggedTemplateLiteral-C9cDEsPD.js";import{n as ve,t as ye}from"./alert.component-CGcD4rSl.js";import{n as be,t as xe}from"./tooltip.component-TMyvrJu1.js";import{t as Se}from"./input-CRUG0B-6.js";var v,y,b,x,S,C,w,T,E,D,O,k=e((()=>{d(),v=[`blur`,`change`,`clear`,`focus`,`invalid`,`input`,`move`],y=(e,t)=>e.includes(t),b=e=>y(e,`blur`),x=e=>y(e,`invalid`),S=e=>e instanceof m,C=(e=``)=>e.split(` `).map(e=>e.trim()).filter(Boolean),w=(e,t)=>{let n=t.trim();return S(e)&&v.includes(n)?`syn-${n}`:n},T=e=>{if(!S(e))return;let{size:t}=e;return t??void 0},E={"syn-checkbox":`input`,"syn-combobox":`.combobox__value-input`,"syn-file":`input`,"syn-input":`input`,"syn-radio-group":`input`,"syn-range":`.input__control`,"syn-select":`.select__value-input`,"syn-switch":`input`,"syn-textarea":`.textarea__control`},D=(e,t)=>e.shadowRoot?.querySelector(t)??null,O=e=>{if(!e)return;if(!e.shadowRoot)return e;let t=e.tagName.toLowerCase(),n=E[t];if(n){let t=D(e,n);if(t)return t}return D(e,`input,select,textarea`)||e}})),A,Ce=e((()=>{c(),A=o`
  .validate {
    display: flex;
