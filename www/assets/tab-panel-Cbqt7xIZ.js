import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{c as t,h as n,n as r,t as i}from"./lit-DgWh_IaA.js";import{C as a,f as o,g as ee,p as te,x as ne}from"./library-DDo5iplL.js";import{d as s,l as c,s as l}from"./synergy-element-IoE5U-8r.js";import{n as re}from"./event-options-CDwceuuz.js";import{t as u}from"./query-DOHNhzf6.js";import{n as ie}from"./query-assigned-elements-CWXdehfi.js";import{r as d,t as ae}from"./if-defined-DmmMeZVG.js";import{n as f,t as p}from"./class-map-HZwHklGF.js";function m(e,t){let n={waitUntilFirstUpdate:!1,...t};return(t,r)=>{let{update:i}=t,a=Array.isArray(e)?e:[e];t.update=function(e){a.forEach(t=>{let i=t;if(e.has(i)){let t=e.get(i),a=this[i];t!==a&&(!n.waitUntilFirstUpdate||this.hasUpdated)&&this[r](t,a)}}),i.call(this,e)}}}function oe(){return(oe=e((()=>{})))()}var h;function g(){return(g=e((()=>{i(),h=n`
  :host {
...
`})))()}var se,ce,le,_,v,y,b,x,ue;function S(){return(S=e((()=>{se=Object.defineProperty,ce=Object.getOwnPropertyDescriptor,le=e=>{throw TypeError(e)},_=(e,t,n,r)=>{for(var i=r>1?void 0:r?ce(t,n):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(i=(r?o(t,n,i):o(i))||i);return r&&i&&se(t,n,i),i},v=(e,t,n)=>t.has(e)||le(`Cannot `+n),y=(e,t,n)=>(v(e,t,`read from private field`),n?n.call(e):t.get(e)),b=(e,t,n)=>t.has(e)?le(`Cannot add the same private member more than once`):t instanceof WeakSet?t.add(e):t.set(e,n),x=(e,t,n,r)=>(v(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),ue=(e,t,n)=>(v(e,t,`access private method`),n)})))()}var C,w;function T(){return(T=e((()=>{S(),i(),l(),w=class extends r{constructor(){super(),b(this,C,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}emit(e,t){let n=new CustomEvent(e,{bubbles:!0,cancelable:!1,composed:!0,detail:{},...t});return this.dispatchEvent(n),n}static define(e,t=this,n={}){let r=customElements.get(e);if(!r){try{customElements.define(e,t,n)}catch{customElements.define(e,class extends t{},n)}return}let i=` (unknown version)`,a=i;`version`in t&&t.version&&(i=` v`+t.version),`version`in r&&r.version&&(a=` v`+r.version),!(i&&a&&i===a)&&console.warn(`Attempted to register <${e}>${i}, but <${e}>${a} has already been registered.`)}attributeChangedCallback(e,t,n){y(this,C)||(this.constructor.elementProperties.forEach((e,t)=>{e.reflect&&this[t]!=null&&this.initialReflectedProperties.set(t,this[t])}),x(this,C,!0)),super.attributeChangedCallback(e,t,n)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach((t,n)=>{e.has(n)&&this[n]==null&&(this[n]=t)})}},C=new WeakMap,w.version=`3.24.0`,w.dependencies={},_([s()],w.prototype,`dir`,2),_([s()],w.prototype,`lang`,2)})))()}var de;function E(){return(E=e((()=>{i(),de=n`
  /* Write custom CSS here */
`})))()}var fe;function D(){return(D=e((()=>{i(),fe=n`
	/* stylelint-disable */
  :host {
...
`})))()}var rt;function it(){return(it=e((()=>{i(),rt=n`
	/* stylelint-disable */
  :host {
...
`})))()}var at;function q(){return(q=e((()=>{i(),at=n`
  :host {
...
`})))()}var J;function Y(){return(Y=e((()=>{q(),P(),He(),g(),T(),S(),p(),o(),ae(),l(),J=class extends w{constructor(){super(...arguments),this.hasFocus=!1,this.label=``,this.size=`inherit`,this.color=`currentColor`,this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){let e=!!this.href,t=e?te`a`:te`button`;return ee`
    ...
    `}},X.styles=[h,rt,tt],X.dependencies={"syn-icon-button":J,"syn-resize-observer":K},_([ie({slot:`nav`,selector:`syn-tab`})],X.prototype,`tabs`,2),_([ie({selector:`syn-tab-panel`})],X.prototype,`panels`,2),_([u(`.tab-group`)],X.prototype,`tabGroup`,2),_([u(`.tab-group__body`)],X.prototype,`body`,2),_([u(`.tab-group__nav`)],X.prototype,`nav`,2),_([u(`.tab-group__indicator`)],X.prototype,`indicator`,2),_([c()],X.prototype,`hasScrollControls`,2),_([c()],X.prototype,`shouldHideScrollStartButton`,2),_([c()],X.prototype,`shouldHideScrollEndButton`,2),_([s()],X.prototype,`placement`,2),_([s()],X.prototype,`activation`,2),_([s({attribute:`no-scroll-controls`,type:Boolean})],X.prototype,`noScrollControls`,2),_([s({type:Boolean})],X.prototype,`contained`,2),_([s({type:Boolean})],X.prototype,`sharp`,2),_([s({attribute:`fixed-scroll-controls`,type:Boolean})],X.prototype,`fixedScrollControls`,2),_([re({passive:!0})],X.prototype,`updateScrollButtons`,1),_([m(`noScrollControls`,{waitUntilFirstUpdate:!0})],X.prototype,`updateScrollControls`,1),_([m(`placement`,{waitUntilFirstUpdate:!0})],X.prototype,`syncIndicator`,1)})))()}function lt(){return(lt=e((()=>{ct(),X.define(`syn-tab-group`)})))()}function ut(){return(ut=e((()=>{lt(),ct(),Ze(),Xe(),nt(),it(),Y(),q(),P(),E(),D(),G(),U(),H(),g(),T()})))()}var dt;function ft(){return(ft=e((()=>{i(),dt=n`
  :host {
...
`})))()}var pt;function mt(){return(mt=e((()=>{i(),pt=n`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
`})))()}var ht,Z;function gt(){return(gt=e((()=>{ft(),mt(),Y(),G(),g(),T(),S(),p(),i(),l(),ht=0,Z=class extends w{constructor(){super(...arguments),this.localize=new W(this),this.attrId=++ht,this.componentId=`syn-tab-${this.attrId}`,this.panel=``,this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`tab`)}handleCloseClick(e){e.stopPropagation(),this.emit(`syn-close`)}handleActiveChange(){this.setAttribute(`aria-selected`,this.active?`true`:`false`)}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled?`true`:`false`),this.tabIndex=this.disabled&&!this.active?-1:0}render(){return this.id=this.id.length>0?this.id:this.componentId,t`
      <div
        part="base"
    ...
    `}},Z.styles=[h,pt,dt],Z.dependencies={"syn-icon-button":J},_([u(`.tab`)],Z.prototype,`tab`,2),_([s({reflect:!0})],Z.prototype,`panel`,2),_([s({type:Boolean,reflect:!0})],Z.prototype,`active`,2),_([s({type:Boolean,reflect:!0})],Z.prototype,`closable`,2),_([s({type:Boolean,reflect:!0})],Z.prototype,`disabled`,2),_([s({type:Number,reflect:!0})],Z.prototype,`tabIndex`,2),_([m(`active`)],Z.prototype,`handleActiveChange`,1),_([m(`disabled`)],Z.prototype,`handleDisabledChange`,1)})))()}function _t(){return(_t=e((()=>{gt(),Z.define(`syn-tab`)})))()}function vt(){return(vt=e((()=>{_t(),gt(),ft(),mt(),Y(),q(),P(),E(),D(),G(),U(),H(),g(),T()})))()}var yt;function Q(){return(Q=e((()=>{i(),yt=n`
  /* Write custom CSS here */
  .tab-panel {
    color: var(--syn-typography-color-text);
  }
`})))()}var bt;function xt(){return(xt=e((()=>{i(),bt=n`
	/* stylelint-disable */
  :host {
    --padding: 0;
...
`})))()}var St,$;function Ct(){return(Ct=e((()=>{Q(),xt(),g(),T(),S(),p(),i(),l(),St=0,$=class extends w{constructor(){super(...arguments),this.attrId=++St,this.componentId=`syn-tab-panel-${this.attrId}`,this.name=``,this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute(`role`,`tabpanel`)}handleActiveChange(){this.setAttribute(`aria-hidden`,this.active?`false`:`true`)}render(){return t`
      <slot
        part="base"
        class=${f({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}},$.styles=[h,bt,yt],_([s({reflect:!0})],$.prototype,`name`,2),_([s({type:Boolean,reflect:!0})],$.prototype,`active`,2),_([m(`active`)],$.prototype,`handleActiveChange`,1)})))()}function wt(){return(wt=e((()=>{Ct(),$.define(`syn-tab-panel`)})))()}function Tt(){return(Tt=e((()=>{wt(),Ct(),Q(),xt(),g(),T()})))()}export{ue as C,g as D,h as E,oe as O,y as S,S as T,E as _,G as a,_ as b,Ve as c,je as d,F as f,D as g,P as h,W as i,m as k,He as l,N as m,vt as n,U as o,ke as p,ut as r,H as s,Tt as t,Ae as u,w as v,x as w,b as x,T as y};