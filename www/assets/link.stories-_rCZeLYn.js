import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{a as t,d as n,o as r,s as i}from"./preview-DdzcclEm.js";import{c as a,t as o}from"./lit-BfcklOOD.js";import{t as s}from"./icon-8cT1hKpd.js";import{a as c,i as l,n as u,r as d,t as f}from"./component-BjD7AuVi.js";import{n as p,t as m}from"./PaddingDecorator-B8dy7wkX.js";import{n as h,t as g}from"./styles-Bi2aGHyR.js";var _,v,y,b,x,S,C,w,T,E,D,O,k;e((()=>{o(),d(),g(),r(),s(),m(),n(),{args:_,argTypes:v}=l(`syn-link`),{overrideArgs:y}=c(`syn-link`),b={args:y([{name:`default`,type:`slot`,value:`Link label`},{name:`syn-link`,type:`attribute`,value:`syn-link--medium`}],_),argTypes:v,component:`syn-link`,parameters:{chromatic:{modes:i},design:t(`41337-170604`),docs:{description:{component:u(`styles`,`link`)}}},tags:[`Navigation`,`Styles`],title:`Styles/syn-link`},x={parameters:{controls:{disable:!1}},render:e=>h(e,`a`,{class:`syn-link`,href:`javascript:void(0)`})},S={parameters:{docs:{description:{story:u(`link`,`inline`)}}},render:()=>a`
    <p style="width: 266px;">
  ...
  `},C={parameters:{docs:{description:{story:u(`link`,`prefix-suffix-icons`)}}},render:()=>a`
  ...
  `},w={parameters:{docs:{description:{story:u(`link`,`quiet`)}}},render:()=>a`
    <a href="javascript:void(0)" class="syn-link syn-link--quiet">
      <syn-icon name="keyboard_arrow_right"></syn-icon>
      Silence is gold
    </a>
  `},T={parameters:{docs:{description:{story:u(`link`,`disabled`)}}},render:()=>a`
    <a class="syn-link syn-link--disabled">
      <syn-icon name="keyboard_arrow_right"></syn-icon>
      Disabled
    </a>
  `},E={decorators:[p()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`link`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`a`);t&&t.focus()},render:()=>a`
    <a href="javascript:void(0)" class="syn-link syn-link--medium">
      <syn-icon name="keyboard_arrow_right"></syn-icon>
      Link
    </a>
  `},D={parameters:{docs:{description:{story:u(`link`,`size`)}}},render:()=>a`
