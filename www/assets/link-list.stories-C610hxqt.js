import{n as e}from"./chunk-DnJy8xQt.js";import{At as t,C as n,Ft as r,S as i,d as a,f as o,p as s,u as c}from"./iframe-CFxyVgYz.js";import{t as l}from"./icon-BNvARCZB.js";import{i as u,n as d,r as f,t as p}from"./component-u4nxi-rq.js";import{n as m,t as h}from"./styles-DSTfAhDj.js";var g,_,v,y,b,x,S,C,w,T,E,D;e((()=>{t(),i(),f(),h(),a(),s(),l(),{args:g,argTypes:_}=u(`syn-link-list`),v={...g},delete v[`default-slot`],y={..._},delete y[`default-slot`],b=(e=4,t=`medium`)=>Array(e).fill(void 0).map(()=>`
    <li>
