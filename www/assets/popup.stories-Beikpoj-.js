import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{t as r}from"./select-ghDhf1Uh.js";import{t as i}from"./option-D8fwbCp_.js";import{a,i as o,n as s,o as c,r as l}from"./component-BZMStFjM.js";import{n as u,t as d}from"./taggedTemplateLiteral-pWa2IaV6.js";import{t as f}from"./popup-C8xEbSQ8.js";import{t as p}from"./switch-C_dnR9Bk.js";import{t as m}from"./range-nBAbqPvJ.js";var h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H=e((()=>{f(),p(),r(),i(),m(),n(),l(),u(),{args:w,argTypes:T}=o(`syn-popup`),{overrideArgs:E}=a(`syn-popup`),{generateTemplate:D}=c(`syn-popup`),O={args:E([{name:`active`,type:`attribute`,value:!0},{name:`anchor`,type:`slot`,value:`<span></span>`},{name:`default`,type:`slot`,value:`<div class="box"></div>`}],w),argTypes:T,component:`syn-popup`,parameters:{chromatic:{disableSnapshot:!0},docs:{description:{component:s(`popup`,`default`)},story:{iframeHeight:300}}},tags:[`Structure`],title:`Components/syn-popup`},k={parameters:{docs:{description:{story:s(`popup`,`default`)}}},render:e=>t`
  ...
  `},A={render:()=>t(h||=d([`<div class="popup-active">
...
</style>`},M={render:()=>t(g||=d([`<div class="popup-placement">
  <syn-popup placement="top" active>
    <span slot="anchor"></span>
    <div class="box"></div>
  </syn-popup>
...
<\/script>`]))},N={render:()=>t(_||=d([`<div class="popup-distance">
...
<\/script>`]))},P={render:()=>t(v||=d([`<div class="popup-skidding">
...
<\/script>`]))},F={render:()=>t(y||=d([`<div class="popup-arrow">
  ...
  <\/script>
</div>`]))},I={render:()=>t(b||=d([`<div class="popup-sync">
...
<\/script>`]))},L={render:()=>t(x||=d([`<div class="popup-flip">
  <div class="overflow">
...
</style>`},z={render:()=>t(S||=d([`<div class="popup-shift">
  <div class="overflow">
...
<\/script>`]))},B={render:()=>t(C||=d([`<div class="popup-virtual-element">
