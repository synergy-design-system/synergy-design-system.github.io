var rn=Object.freeze,mi=Object.defineProperty;var ln=(a,e)=>rn(mi(a,"raw",{value:rn(e||a.slice())}));import{R as y,d as Dn,k as _,t as te,b as u,a as g,e as pt,f as fi}from"./static-9CmeQujl.js";import{i as h,k as p,D as In,u as dn,Q as yi,R as bi}from"./directive-helpers-CDT6qhDs.js";import{h as Nn,$ as An,r as Mn,L as gi,F as mt,b as vi,o as wi,f as xi,c as ki,s as cn,d as _i,p as jt,e as Ti,g as Ci,a as Pn,k as Si,K as zi,j as Ei,i as $i,t as Oi}from"./ref-BgFTv61d.js";import{s as Di}from"./chunk-L4EGOTBX-C9C4DwME.js";import"./entry-preview-D9TbQDUR.js";import{S as tt,d as pn,s as Ii}from"./index-B1Tckwtu.js";import"./index-7h80QhK_.js";import{n as r,a as b}from"./library-BZPO0bHa.js";import{a as v,c as w,w as m,S as ue}from"./icon.component-D4-UWHjb.js";import"./icon-BWIhAKYN.js";const Ni=h`
  :host {
    display: block;
  }
...
`;var wa=Object.defineProperty,xa=Object.getOwnPropertyDescriptor,Ee=(a,e,t,n)=>{for(var i=n>1?void 0:n?xa(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&wa(e,t,i),i};const Qe=Object.assign(document.createElement("div"),{className:"syn-toast-stack"});class ge extends v{constructor(){super(...arguments),this.hasSlotController=new W(this,"icon","suffix"),this.localize=new j(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.remainingTime=this.duration}static{this.styles=[w,ga,va]}static{this.dependencies={"syn-icon-button":tt}}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){this.countdownAnimation?.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),this.countdownAnimation?.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){const{countdownElement:e}=this,t="100%",n="0";this.countdownAnimation=e.animate([{width:t},{width:n}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.duration<1/0&&this.restartAutoHide(),await K(this.base),this.base.hidden=!1;const{keyframes:e,options:t}=N(this,"alert.show",{dir:this.localize.dir()});await F(this.base,e,t),this.emit("syn-after-show")}else{this.emit("syn-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await K(this.base);const{keyframes:e,options:t}=N(this,"alert.hide",{dir:this.localize.dir()});await F(this.base,e,t),this.base.hidden=!0,this.emit("syn-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,U(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,U(this,"syn-after-hide")}async toast(){return new Promise(e=>{this.handleCountdownChange(),Qe.parentElement===null&&document.body.append(Qe),Qe.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("syn-after-hide",()=>{Qe.removeChild(this),e(),Qe.querySelector("syn-alert")===null&&Qe.remove()},{once:!0})})}render(){return p`
    ...
    `}}Ee([u('[part~="base"]')],ge.prototype,"base",2);Ee([u(".alert__countdown-elapsed")],ge.prototype,"countdownElement",2);Ee([r({type:Boolean,reflect:!0})],ge.prototype,"open",2);Ee([r({type:Boolean,reflect:!0})],ge.prototype,"closable",2);Ee([r({reflect:!0})],ge.prototype,"variant",2);Ee([r({type:Number})],ge.prototype,"duration",2);Ee([b()],ge.prototype,"remainingTime",2);Ee([m("open",{waitUntilFirstUpdate:!0})],ge.prototype,"handleOpenChange",1);Ee([m("duration")],ge.prototype,"handleDurationChange",1);T("alert.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});T("alert.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});ge.define("syn-alert");const ka=h`
	/* stylelint-disable */
  :host {
    display: inline-flex;
  }
...
`;var Ea=Object.defineProperty,$a=Object.getOwnPropertyDescriptor,it=(a,e,t,n)=>{for(var i=n>1?void 0:n?$a(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Ea(e,t,i),i};class Ke extends v{constructor(){super(...arguments),this.hasSlotController=new W(this,"prefix","suffix"),this.renderType="button",this.rel="noreferrer noopener"}static{this.styles=[w,Sa,za]}setRenderType(){const e=this.defaultSlot.assignedElements({flatten:!0}).filter(t=>t.tagName.toLowerCase()==="syn-dropdown").length>0;if(this.href){this.renderType="link";return}if(e){this.renderType="dropdown";return}this.renderType="button"}hrefChanged(){this.setRenderType()}handleSlotChange(){this.setRenderType()}render(){return p`
      <div
        part="base"
    ...
    `}}it([u("slot:not([name])")],Ke.prototype,"defaultSlot",2);it([b()],Ke.prototype,"renderType",2);it([r()],Ke.prototype,"href",2);it([r()],Ke.prototype,"target",2);it([r()],Ke.prototype,"rel",2);it([m("href",{waitUntilFirstUpdate:!0})],Ke.prototype,"hrefChanged",1);Ke.define("syn-breadcrumb-item");const Oa=h`
	/* stylelint-disable */
  .breadcrumb {
    display: flex;
    align-items: center;
...
`;var Aa=Object.defineProperty,en=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Aa(e,t,i),i};class yt extends v{constructor(){super(...arguments),this.disableRole=!1,this.label=""}static{this.styles=[w,Na]}handleFocus(e){ot(e.target)?.toggleAttribute("data-syn-button-group__button--focus",!0)}handleBlur(e){ot(e.target)?.toggleAttribute("data-syn-button-group__button--focus",!1)}handleMouseOver(e){ot(e.target)?.toggleAttribute("data-syn-button-group__button--hover",!0)}handleMouseOut(e){ot(e.target)?.toggleAttribute("data-syn-button-group__button--hover",!1)}handleSlotChange(){const e=[...this.defaultSlot.assignedElements({flatten:!0})];e.forEach(t=>{const n=e.indexOf(t),i=ot(t);i&&(i.toggleAttribute("data-syn-button-group__button",!0),i.toggleAttribute("data-syn-button-group__button--first",n===0),i.toggleAttribute("data-syn-button-group__button--inner",n>0&&n<e.length-1),i.toggleAttribute("data-syn-button-group__button--last",n===e.length-1),i.toggleAttribute("data-syn-button-group__button--radio",i.tagName.toLowerCase()==="syn-radio-button"))})}render(){return p`
      <div
        part="base"
        class="button-group"
...
`;var Fa=Object.defineProperty,Va=Object.getOwnPropertyDescriptor,V=(a,e,t,n)=>{for(var i=n>1?void 0:n?Va(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Fa(e,t,i),i};class M extends v{constructor(){super(...arguments),this.formControlController=new _e(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new W(this,"[default]","prefix","suffix"),this.localize=new j(this),this.iconOnly=!1,this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="outline",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}static{this.styles=[w,ni,ja]}static{this.dependencies={"syn-icon":ue,"syn-spinner":tn}}get validity(){return this.isButton()?this.button.validity:bt}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}isButton(){return!this.href}isLink(){return!!this.href}handleSlotChange(){const e=Jn(this.defaultSlot).trim(),t=this.defaultSlot.assignedElements({flatten:!0}),n=t.length===1&&t[0].tagName.toLowerCase()==="syn-icon";this.iconOnly=n&&e===""}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(e){this.isButton()&&(this.button.setCustomValidity(e),this.formControlController.updateValidity())}render(){const e=this.isLink(),t=e?pt`a`:pt`button`;return _`
      ...
      >
        ...
        ${this.caret?_` <syn-icon part="caret" class="button__caret" library="system" name="caret"></syn-icon> `:""}
        ${this.loading?_`<syn-spinner part="spinner"></syn-spinner>`:""}
      </${t}>
...
`;var Ra=Object.defineProperty,Ua=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Ra(e,t,i),i};class ii extends v{constructor(){super(...arguments),this.hasSlotController=new W(this,"footer","header","image"),this.sharp=!1}static{this.styles=[w,Ha,Ba]}render(){return p`
      <div
        part="base"
    ...
    `}}Ua([r({type:Boolean,reflect:!0})],ii.prototype,"sharp");ii.define("syn-card");const Ge=(a="value")=>(e,t)=>{const n=e.constructor,i=n.prototype.attributeChangedCallback;n.prototype.attributeChangedCallback=function(o,s,l){const d=n.getPropertyOptions(a),c=typeof d.attribute=="string"?d.attribute:a;if(o===c){const f=d.converter||dn,q=(typeof f=="function"?f:f?.fromAttribute??dn.fromAttribute)(l,d.type);this[a]!==q&&(this[t]=q)}i.call(this,o,s,l)}},$e=h`
	/* stylelint-disable */
...
`;var zo=Object.defineProperty,Eo=Object.getOwnPropertyDescriptor,Ye=(a,e,t,n)=>{for(var i=n>1?void 0:n?Eo(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&zo(e,t,i),i};class Le extends v{constructor(){super(...arguments),this.hasSlotController=new W(this,"footer"),this.localize=new j(this),this.modal=new si(this),this.open=!1,this.label="",this.noHeader=!1,this.handleDocumentKeyDown=e=>{e.key==="Escape"&&this.modal.isActive()&&this.open&&(e.stopPropagation(),this.requestClose("keyboard"))}}static{this.styles=[w,Co,So]}static{this.dependencies={"syn-icon-button":tt}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),ht(this))}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate(),Ze(this),this.removeOpenListeners()}requestClose(e){if(this.emit("syn-request-close",{cancelable:!0,detail:{source:e}}).defaultPrevented){const n=N(this,"dialog.denyClose",{dir:this.localize.dir()});F(this.panel,n.keyframes,n.options);return}this.hide()}addOpenListeners(){"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard")):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){this.closeWatcher?.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),ht(this);const e=this.querySelector("[autofocus]");e&&e.removeAttribute("autofocus"),await Promise.all([K(this.dialog),K(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit("syn-initial-focus",{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute("autofocus","")});const t=N(this,"dialog.show",{dir:this.localize.dir()}),n=N(this,"dialog.overlay.show",{dir:this.localize.dir()});await Promise.all([F(this.panel,t.keyframes,t.options),F(this.overlay,n.keyframes,n.options)]),this.emit("syn-after-show")}else{this.emit("syn-hide"),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([K(this.dialog),K(this.overlay)]);const e=N(this,"dialog.hide",{dir:this.localize.dir()}),t=N(this,"dialog.overlay.hide",{dir:this.localize.dir()});await Promise.all([F(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),F(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,Ze(this);const n=this.originalTrigger;typeof n?.focus=="function"&&setTimeout(()=>n.focus()),this.emit("syn-after-hide")}}async show(){if(!this.open)return this.open=!0,U(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,U(this,"syn-after-hide")}render(){return p`
      <div
        part="base"
    ...
    `}}Ye([u(".dialog")],Le.prototype,"dialog",2);Ye([u(".dialog__panel")],Le.prototype,"panel",2);Ye([u(".dialog__overlay")],Le.prototype,"overlay",2);Ye([r({type:Boolean,reflect:!0})],Le.prototype,"open",2);Ye([r({reflect:!0})],Le.prototype,"label",2);Ye([r({attribute:"no-header",type:Boolean,reflect:!0})],Le.prototype,"noHeader",2);Ye([m("open",{waitUntilFirstUpdate:!0})],Le.prototype,"handleOpenChange",1);T("dialog.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});T("dialog.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});T("dialog.denyClose",{keyframes:[{scale:1},{scale:1.02},{scale:1}],options:{duration:250}});T("dialog.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});T("dialog.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});Le.define("syn-dialog");const $o=h`
	/* stylelint-disable */
  :host {
...
`;var Do=Object.defineProperty,Io=Object.getOwnPropertyDescriptor,ri=(a,e,t,n)=>{for(var i=n>1?void 0:n?Io(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Do(e,t,i),i};class je extends v{constructor(){super(...arguments),this.vertical=!1}static{this.styles=[w,$o,Oo]}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}}ri([r({type:Boolean,reflect:!0})],je.prototype,"vertical",2);ri([m("vertical")],je.prototype,"handleVerticalChange",1);je.define("syn-divider");function kn(a){return a.charAt(0).toUpperCase()+a.slice(1)}const No=h`
	/* stylelint-disable */
  :host {
    --size: 25rem;
    --header-spacing: var(--syn-spacing-large);
...
`;var Mo=Object.defineProperty,Po=Object.getOwnPropertyDescriptor,Ce=(a,e,t,n)=>{for(var i=n>1?void 0:n?Po(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Mo(e,t,i),i};class ye extends v{constructor(){super(...arguments),this.hasSlotController=new W(this,"footer"),this.localize=new j(this),this.modal=new si(this),this.open=!1,this.label="",this.placement="end",this.contained=!1,this.noHeader=!1,this.handleDocumentKeyDown=e=>{this.contained||e.key==="Escape"&&this.modal.isActive()&&this.open&&(e.stopImmediatePropagation(),this.requestClose("keyboard"))}}static{this.styles=[w,No,Ao]}static{this.dependencies={"syn-icon-button":tt}}firstUpdated(){this.drawer.hidden=!this.open,this.open&&(this.addOpenListeners(),this.contained||(this.modal.activate(),ht(this)))}disconnectedCallback(){super.disconnectedCallback(),Ze(this),this.removeOpenListeners()}requestClose(e){if(this.emit("syn-request-close",{cancelable:!0,detail:{source:e}}).defaultPrevented){const n=N(this,"drawer.denyClose",{dir:this.localize.dir()});F(this.panel,n.keyframes,n.options);return}this.hide()}addOpenListeners(){"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.contained||(this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard"))):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){document.removeEventListener("keydown",this.handleDocumentKeyDown),this.closeWatcher?.destroy()}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.contained||(this.modal.activate(),ht(this));const e=this.querySelector("[autofocus]");e&&e.removeAttribute("autofocus"),await Promise.all([K(this.drawer),K(this.overlay)]),this.drawer.hidden=!1,requestAnimationFrame(()=>{this.emit("syn-initial-focus",{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute("autofocus","")});const t=N(this,`drawer.show${kn(this.placement)}`,{dir:this.localize.dir()}),n=N(this,"drawer.overlay.show",{dir:this.localize.dir()});await Promise.all([F(this.panel,t.keyframes,t.options),F(this.overlay,n.keyframes,n.options)]),this.emit("syn-after-show")}else{this.emit("syn-hide"),this.removeOpenListeners(),this.contained||(this.modal.deactivate(),Ze(this)),await Promise.all([K(this.drawer),K(this.overlay)]);const e=N(this,`drawer.hide${kn(this.placement)}`,{dir:this.localize.dir()}),t=N(this,"drawer.overlay.hide",{dir:this.localize.dir()});await Promise.all([F(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),F(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.drawer.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1;const n=this.originalTrigger;typeof n?.focus=="function"&&setTimeout(()=>n.focus()),this.emit("syn-after-hide")}}handleNoModalChange(){this.open&&!this.contained&&(this.modal.activate(),ht(this)),this.open&&this.contained&&(this.modal.deactivate(),Ze(this))}async show(){if(!this.open)return this.open=!0,U(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,U(this,"syn-after-hide")}render(){return p`
      <div
        part="base"
...
`;function ts(a,e){const t={waitUntilFirstUpdated:!1,...e};return n=>class extends n{#e=!t.waitUntilFirstUpdated;updated(i){if(!this.#e){this.#e=!0;return}const o=Array.from(i).filter(([l])=>a.includes(l));if(o.length===0){super.updated(i);return}const s=o.map(([l,d])=>({attribute:l,newValue:this[l],oldValue:d}));this.emit("syn-attributes-changed",{detail:s}),super.updated(i)}}}var ns=Object.defineProperty,is=Object.getOwnPropertyDescriptor,xe=(a,e,t,n)=>{for(var i=n>1?void 0:n?is(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&ns(e,t,i),i};let ne=class extends v{constructor(){super(...arguments),this.localize=new j(this),this.type="normal",this.checked=!1,this.value="",this.loading=!1,this.disabled=!1,this.hasSlotController=new W(this,"submenu"),this.submenuController=new Jo(this,this.hasSlotController),this.handleHostClick=a=>{this.disabled&&(a.preventDefault(),a.stopImmediatePropagation())},this.handleMouseOver=a=>{this.focus(),a.stopPropagation()}}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this.handleHostClick),this.addEventListener("mouseover",this.handleMouseOver)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.handleHostClick),this.removeEventListener("mouseover",this.handleMouseOver)}handleDefaultSlotChange(){const a=this.getTextLabel();if(typeof this.cachedTextLabel>"u"){this.cachedTextLabel=a;return}a!==this.cachedTextLabel&&(this.cachedTextLabel=a,this.emit("slotchange",{bubbles:!0,composed:!1,cancelable:!1}))}handleCheckedChange(){if(this.checked&&this.type!=="checkbox"){this.checked=!1,console.error('The checked attribute can only be used on menu items with type="checkbox"',this);return}this.type==="checkbox"?this.setAttribute("aria-checked",this.checked?"true":"false"):this.removeAttribute("aria-checked")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleTypeChange(){this.type==="checkbox"?(this.setAttribute("role","menuitemcheckbox"),this.setAttribute("aria-checked",this.checked?"true":"false")):(this.setAttribute("role","menuitem"),this.removeAttribute("aria-checked"))}getTextLabel(){return Jn(this.defaultSlot)}isSubmenu(){return this.hasSlotController.test("submenu")}render(){const a=this.localize.dir()==="rtl",e=this.submenuController.isExpanded();return p`
      <div
        id="anchor"
        part="base"
        class=${y({"menu-item":!0,"menu-item--rtl":a,"menu-item--checked":this.checked,"menu-item--disabled":this.disabled,"menu-item--loading":this.loading,"menu-item--has-submenu":this.isSubmenu(),"menu-item--submenu-expanded":e})}
...
`;class ss extends v{static{this.styles=[w,as,os]}static{this.dependencies={"syn-divider":je}}render(){return p`
...
`;var ps=Object.defineProperty,hs=Object.getOwnPropertyDescriptor,re=(a,e,t,n)=>{for(var i=n>1?void 0:n?hs(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&ps(e,t,i),i};class J extends v{constructor(){super(...arguments),this.hasSlotController=new W(this,"[default]","children","prefix","suffix"),this.hasFocus=!1,this.showPrefixOnly=!1,this.currentMarkedChild=!1,this.isMultiLine=!1,this.current=!1,this.disabled=!1,this.horizontal=!1,this.chevron=!1,this.open=!1,this.divider=!1}static{this.styles=[w,cs]}static{this.dependencies={"syn-divider":je}}isButton(){return!this.href&&!this.hasSlotController.test("children")}isLink(){return!!this.href&&!this.hasSlotController.test("children")}isAccordion(){return this.hasSlotController.test("children")}getNavItemChildren(e){return Array.from(e?.assignedElements({flatten:!0})||[]).map(t=>t.tagName.toLowerCase()==="syn-nav-item"?t:Array.from(t.querySelectorAll(":scope > syn-nav-item"))).flat()}getAllNestedNavItems(e){const t=this.getNavItemChildren(e),n=t.map(i=>i.getAllNestedNavItems(i.childrenSlot)).flat();return t.concat(n)}handleCurrentMarkedChild(){const e=this.closest("syn-side-nav");(!this.open||e?.rail)&&(this.currentMarkedChild=this.getAllNestedNavItems(this.childrenSlot).some(t=>t.current))}handleClickButton(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}handleClickSummary(e){e.preventDefault(),e.stopPropagation(),!this.disabled&&(this.open?this.hideDetails():this.showDetails())}hideDetails(){this.open=!1,this.emit("syn-hide",{cancelable:!0})}showDetails(){this.open=!0,this.emit("syn-show",{cancelable:!0})}handleSlotChange(){const e=getComputedStyle(this);if(e.length===0){setTimeout(()=>{this.handleSlotChange()});return}this.handleCurrentMarkedChild();const n=e.getPropertyValue("--indentation"),i=Math.min(parseInt(n,10)+1,2);this.getNavItemChildren(this.childrenSlot).forEach(o=>{o.style.setProperty("--indentation",i.toFixed(0))})}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleWidth(e){e.forEach(t=>{if(t.contentRect.width<100){const n=this.hasSlotController.test("prefix");this.showPrefixOnly=n}else this.showPrefixOnly=!1;t.contentRect.height>48?this.isMultiLine=!0:this.isMultiLine=!1})}handleHorizontalChange(){this.horizontal?this.resizeObserver.disconnect():this.resizeObserver.observe(this)}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>this.handleWidth(e)),this.horizontal||this.resizeObserver.observe(this)}firstUpdated(e){super.firstUpdated(e),this.mutationObserver=new MutationObserver(()=>{this.childrenSlot&&this.handleCurrentMarkedChild()}),this.mutationObserver.observe(this,{attributeFilter:["current","open"],childList:!0,subtree:!0})}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect(),this.mutationObserver?.disconnect()}blur(){this.control.blur()}click(){this.control.click()}focus(e){this.control.focus(e)}render(){const e=this.isButton(),t=this.isLink(),n=this.isAccordion(),i=this.closest("syn-side-nav"),o=this.currentMarkedChild&&!this.open||this.currentMarkedChild&&this.open&&!!i?.rail&&!i?.open;let s=pt`button`;n?s=pt`summary`:t&&(s=pt`a`);const l=(this.chevron||n)&&!this.horizontal;let d;n?d=this.handleClickSummary:e&&(d=this.handleClickButton);const c=_`
      ...
      >
        ...
        ${this.divider&&!this.horizontal?_`<syn-divider class="divider" part="divider"></syn-divider>`:""}
...
`;var ms=Object.defineProperty,fs=Object.getOwnPropertyDescriptor,Nt=(a,e,t,n)=>{for(var i=n>1?void 0:n?fs(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&ms(e,t,i),i};class vt extends v{constructor(){super(...arguments),this.hasSlotController=new W(this,"[default]","prefix","suffix","label"),this.disabled=!1,this.label=""}static{this.styles=us}static{this.dependencies={"syn-divider":je}}handleDisableOptions(){const{disabled:e}=this;this.defaultSlot.assignedElements().filter(t=>t.tagName.toLowerCase()==="syn-option").forEach(t=>{t.disabled=e})}handleDisabledChange(){this.handleDisableOptions()}render(){const{disabled:e}=this,t=this.hasSlotController.test("label"),n=this.label?!0:!!t;return _`
      <div
        class=${y({optgroup:!0,"optgroup--has-label":n,"optgroup--has-prefix":this.hasSlotController.test("prefix"),"optgroup--has-suffix":this.hasSlotController.test("suffix"),"optgroup--is-disabled":this.disabled})}
    ...
    `}}Nt([u("slot:not([name])")],vt.prototype,"defaultSlot",2);Nt([r({reflect:!0,type:Boolean})],vt.prototype,"disabled",2);Nt([r()],vt.prototype,"label",2);Nt([m("disabled",{waitUntilFirstUpdate:!0})],vt.prototype,"handleDisabledChange",1);vt.define("syn-optgroup");ve.define("syn-option");O.define("syn-popup");const ys=h`
  :host {
    display: block;
...
`,Tn=a=>Array.from(a.assignedElements({flatten:!0})),bs=a=>a.tagName.toLocaleLowerCase()==="syn-nav-item"||(a.getAttribute("role")??"")==="menuitem",Cn=a=>a.filter(bs),gs=a=>{a.setAttribute("horizontal","true"),a.removeAttribute("slot"),a.removeAttribute("tabindex"),a.dataset.originalRole?a.setAttribute("role",a.dataset.originalRole):a.removeAttribute("role")},vs=a=>{a.removeAttribute("horizontal"),a.setAttribute("slot","menu"),a.setAttribute("role","menuitem")};var ws=Object.defineProperty,Fe=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&ws(e,t,i),i};class Ie extends v{constructor(){super(...arguments),this.localize=new j(this),this.itemPositionsCached=!1,this.amountOfNavItems=0,this.amountOfVisibleItems=0,this.hasItemsInDropdown=!1}static{this.styles=[w,ys]}static{this.dependencies={"syn-dropdown":ae,"syn-icon":ue,"syn-menu":It,"syn-nav-item":J}}getSlottedNavItems(){const e=Cn(Tn(this.defaultSlot)),t=Cn(Tn(this.menuSlot));return e.concat(t)}cacheItemPositions(e){const{left:t}=this.horizontalNav.getBoundingClientRect();e.forEach(n=>{n.removeAttribute("slot");const{right:i}=n.getBoundingClientRect();n.dataset.right=(i-t).toString()}),this.itemPositionsCached=!0}handlePriorityMenu(){const e=this.getSlottedNavItems();this.itemPositionsCached||this.cacheItemPositions(e);const{width:t}=this.horizontalNav.getBoundingClientRect(),n=this.priorityMenu.classList.contains("priority-menu--hidden")?0:this.priorityMenu.clientWidth,i=t-n;let o;const s=e.at(-1),l=e.map(f=>{const k=f===s?t:i,q=!!(o||parseFloat(f.dataset.right)>k);return q&&!o&&(o=parseFloat(f.dataset.right)),{isHidden:q,item:f}}),d=l.filter(({isHidden:f})=>!f).length,c=d===1;l.forEach(({item:f,isHidden:k})=>{k||c?vs(f):gs(f)}),this.hasItemsInDropdown=d!==e.length,this.amountOfVisibleItems=c?0:d}renderPriorityMenu(){return _`
      <syn-dropdown
...
`;var Ss=Object.defineProperty,Mt=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Ss(e,t,i),i};class wt extends v{constructor(){super(...arguments),this.localize=new j(this),this.value=0,this.label=""}static{this.styles=[w,Ts,Cs]}updated(e){if(super.updated(e),e.has("value")){const t=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),n=2*Math.PI*t,i=n-this.value/100*n;this.indicatorOffset=`${i}px`}}render(){return p`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
    ...
    `}}Mt([u(".progress-ring__indicator")],wt.prototype,"indicator");Mt([b()],wt.prototype,"indicatorOffset");Mt([r({type:Number,reflect:!0})],wt.prototype,"value");Mt([r()],wt.prototype,"label");wt.define("syn-progress-ring");const zs=h`
	/* stylelint-disable */
  ${ni}
...
`;var Ps=Object.defineProperty,Ls=Object.getOwnPropertyDescriptor,Xe=(a,e,t,n)=>{for(var i=n>1?void 0:n?Ls(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Ps(e,t,i),i};class Ve extends v{constructor(){super(),this.checked=!1,this.hasFocus=!1,this.size="medium",this.disabled=!1,this.handleBlur=()=>{this.hasFocus=!1,this.emit("syn-blur")},this.handleClick=()=>{this.disabled||(this.checked=!0)},this.handleFocus=()=>{this.hasFocus=!0,this.emit("syn-focus")},this.addEventListener("blur",this.handleBlur),this.addEventListener("click",this.handleClick),this.addEventListener("focus",this.handleFocus)}static{this.styles=[w,As,Ms]}static{this.dependencies={"syn-icon":ue}}connectedCallback(){super.connectedCallback(),this.setInitialAttributes()}setInitialAttributes(){this.setAttribute("role","radio"),this.setAttribute("tabindex","-1"),this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleCheckedChange(){this.setAttribute("aria-checked",this.checked?"true":"false"),this.setAttribute("tabindex",this.checked?"0":"-1")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}render(){return p`
    ...
    `}}Xe([b()],Ve.prototype,"checked",2);Xe([b()],Ve.prototype,"hasFocus",2);Xe([r()],Ve.prototype,"value",2);Xe([r({reflect:!0})],Ve.prototype,"size",2);Xe([r({type:Boolean,reflect:!0})],Ve.prototype,"disabled",2);Xe([m("checked")],Ve.prototype,"handleCheckedChange",1);Xe([m("disabled",{waitUntilFirstUpdate:!0})],Ve.prototype,"handleDisabledChange",1);Ve.define("syn-radio");const js=h`
  :host {
...
`;var Rs=Object.defineProperty,Us=Object.getOwnPropertyDescriptor,de=(a,e,t,n)=>{for(var i=n>1?void 0:n?Us(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Rs(e,t,i),i};class Z extends v{constructor(){super(),this.localize=new j(this),this.content="",this.placement="top",this.disabled=!1,this.distance=13,this.open=!1,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleBlur=()=>{this.hasTrigger("focus")&&this.hide()},this.handleClick=()=>{this.hasTrigger("click")&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger("focus")&&this.show()},this.handleDocumentKeyDown=e=>{e.key==="Escape"&&(e.stopPropagation(),this.hide())},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){const e=mn(getComputedStyle(this).getPropertyValue("--show-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.show(),e)}},this.handleMouseOut=()=>{if(this.hasTrigger("hover")){const e=mn(getComputedStyle(this).getPropertyValue("--hide-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.hide(),e)}},this.addEventListener("blur",this.handleBlur,!0),this.addEventListener("focus",this.handleFocus,!0),this.addEventListener("click",this.handleClick),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}static{this.styles=[w,Hs,Bs]}static{this.dependencies={"syn-popup":O}}disconnectedCallback(){super.disconnectedCallback(),this.closeWatcher?.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(e){return this.trigger.split(" ").includes(e)}async handleOpenChange(){if(this.open){if(this.disabled)return;this.emit("syn-show"),"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide()}):document.addEventListener("keydown",this.handleDocumentKeyDown),await K(this.body),this.body.hidden=!1,this.popup.active=!0;const{keyframes:e,options:t}=N(this,"tooltip.show",{dir:this.localize.dir()});await F(this.popup.popup,e,t),this.popup.reposition(),this.emit("syn-after-show")}else{this.emit("syn-hide"),this.closeWatcher?.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown),await K(this.body);const{keyframes:e,options:t}=N(this,"tooltip.hide",{dir:this.localize.dir()});await F(this.popup.popup,e,t),this.popup.active=!1,this.body.hidden=!0,this.emit("syn-after-hide")}}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,U(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,U(this,"syn-after-hide")}render(){return p`
    ...
    `}}de([u("slot:not([name])")],Z.prototype,"defaultSlot",2);de([u(".tooltip__body")],Z.prototype,"body",2);de([u("syn-popup")],Z.prototype,"popup",2);de([r()],Z.prototype,"content",2);de([r()],Z.prototype,"placement",2);de([r({type:Boolean,reflect:!0})],Z.prototype,"disabled",2);de([r({type:Number})],Z.prototype,"distance",2);de([r({type:Boolean,reflect:!0})],Z.prototype,"open",2);de([r({type:Number})],Z.prototype,"skidding",2);de([r()],Z.prototype,"trigger",2);de([r({type:Boolean})],Z.prototype,"hoist",2);de([m("open",{waitUntilFirstUpdate:!0})],Z.prototype,"handleOpenChange",1);de([m(["content","distance","hoist","placement","skidding"])],Z.prototype,"handleOptionsChange",1);de([m("disabled")],Z.prototype,"handleDisabledChange",1);T("tooltip.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:150,easing:"ease"}});T("tooltip.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:150,easing:"ease"}});const We=(a,e)=>a-e,ct=(a,e)=>{if(a.length!==e.length)return!0;const t=a.slice().sort(We),n=e.slice().sort(We);for(let i=0;i<t.length;i+=1)if(t[i]!==n[i])return!0;return!1},Sn=(a,e,t)=>{const n=a.getBoundingClientRect(),i=n.width;if(i<=0)return 0;let o=e;return o-=n.left,o<=0?t?1:0:o>=i?t?0:1:(o/=i,t?1-o:o)},Ws=h`
  :host {
    /*
...
`;var qs=Object.defineProperty,Ks=Object.getOwnPropertyDescriptor,Y=(a,e,t,n)=>{for(var i=n>1?void 0:n?Ks(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&qs(e,t,i),i};class G extends v{constructor(){super(),this.name="",this.label="",this.helpText="",this.disabled=!1,this.min=0,this.max=100,this.step=1,this.size="medium",this.tooltipPlacement="top",this.restrictMovement=!1,this.defaultValue="0",this.form="",this.hasSlotController=new W(this,"help-text","label","prefix","suffix","ticks"),this.formControlController=new _e(this,{assumeInteractionOn:["syn-change"]}),this.localize=new j(this),this.#e=[0],this.#t=new Map,this.#a=!1,this.#i="",this.#n=[],this.tooltipFormatter=this.localize.number.bind(this.localize)}static{this.styles=[w,$e,Oe,Ws]}static{this.dependencies={"syn-tooltip":Z}}set value(e){this.#e=e?e.split(" ").map(t=>+t).sort(We):[]}get value(){return this.#e.slice().sort(We).join(" ")}set valueAsArray(e){const t=this.#e;this.#e=Array.isArray(e)?e.slice().sort(We):e||[],ct(t,this.#e)&&this.requestUpdate("value",t.join(" "))}get valueAsArray(){return[...this.#e].sort(We)}#e;#t;#a;#i;#c;#n;get#o(){return this.localize.dir()==="rtl"}firstUpdated(){this.formControlController.updateValidity(),this.#n=Array.from(this.#e),this.thumbs.forEach(e=>{const t=e.parentElement;t.updateComplete.then(()=>{t.shadowRoot.querySelector(".tooltip__body")?.setAttribute("aria-hidden","true")})})}willUpdate(e){super.willUpdate(e),this.min>this.max&&([this.min,this.max]=[this.max,this.min]),this.step>this.max-this.min&&(this.step=this.max-this.min),this.step<=0&&(this.step=1);const t=this.#e.map(n=>{if(n<=this.min)return this.min;if(n>=this.max)return this.max;const i=this.min+this.step*Math.round((n-this.min)/this.step);return i>this.max?this.max:i});ct(this.#e,t)&&(this.#e=t)}updated(e){super.updated(e);for(const t of this.thumbs){const n=+t.dataset.rangeId;this.#t.has(n)&&this.#s(t,this.#t.get(n))}this.#r()}focus(e){const t=this.thumbs.item(0);t?t.focus(e):super.focus(e)}checkValidity(){if(this.disabled)return!0;const e=!this.#i;return e||this.formControlController.emitInvalidEvent(),e}reportValidity(){if(this.disabled)return!0;const e=this.validity.valid;return this.formControlController.setValidity(e),this.validationInput.hidden=!0,clearTimeout(this.#c),e||(this.validationInput.hidden=!1,this.validationInput.reportValidity(),this.#c=setTimeout(()=>{this.validationInput.hidden=!0},1e4)),e}setCustomValidity(e){this.#i=e,this.validationInput.setCustomValidity(e),this.formControlController.updateValidity()}getForm(){return this.formControlController.getForm()}get validity(){return this.#i?ti:bt}get validationMessage(){return this.#i}#p(e){if(this.disabled)return;const{clientX:t}=e,n=Array.from(this.thumbs),i=Sn(this.baseDiv,t,this.#o),o=this.step/(this.max-this.min),s=this.min+this.step*Math.round(i/o),l=n.reduce((f,k)=>{const q=this.#t.get(+k.dataset.rangeId),Re=this.#t.get(+f.dataset.rangeId),be=Math.abs(q-s),ze=Math.abs(Re-s);return be===ze?q<s?k:f:be<ze?k:f}),d=+l.dataset.rangeId;if(!d)return;this.#t.set(d,s),this.#s(l,s);const c=this.#e;this.#e=Array.from(this.#t.values()),this.#r(),ct(c,this.#e)&&(this.#n=Array.from(this.#e),this.emit("syn-input"),this.emit("syn-change"))}#h(e,t){const n=this.valueAsArray,o=Array.from(this.thumbs).indexOf(e),s=n[o-1]||this.min,l=n[o+1]||this.max,d=t<s||t>l;return{finalValue:Math.max(s,Math.min(l,t)),isRestricted:d,nextValue:l,prevValue:s}}async#u(e){if(this.disabled)return;const t=e.target;this.#l(t),t.dataset.pointerId&&t.releasePointerCapture(+t.dataset.pointerId),t.dataset.pointerId=e.pointerId.toString(),t.setPointerCapture(e.pointerId),t.classList.add("grabbed"),await t.parentElement.show()}#m(e){if(this.disabled)return;const t=e.target,n=+t.dataset.rangeId;if(!this.#t.has(n)||(t.dataset.pointerId?+t.dataset.pointerId:null)!==e.pointerId)return;const o=Sn(this.baseDiv,e.clientX,this.#o),s=this.step/(this.max-this.min);let l=this.min+this.step*Math.round(o/s);if(this.emit("syn-move",{cancelable:!0,detail:{element:t,value:l}}).defaultPrevented)return;if(this.restrictMovement){const f=this.#h(t,l);f.isRestricted?(l=f.finalValue,t.style.zIndex=(3+this.thumbs.length).toFixed(0)):t.style.zIndex="3"}this.#t.set(n,l),this.#s(t,l);const c=this.#e;this.#e=Array.from(this.#t.values()),this.#r(),ct(c,this.#e)&&this.emit("syn-input")}async#d(e){const t=e.target;!t.dataset.pointerId||e.pointerId!==+t.dataset.pointerId||(t.classList.remove("grabbed"),t.releasePointerCapture(e.pointerId),delete t.dataset.pointerId,ct(this.#n,this.#e)&&(this.#n=Array.from(this.#e),this.emit("syn-change")),await t.parentElement.hide())}#s(e,t){e.setAttribute("aria-valuenow",t.toString()),e.setAttribute("aria-valuetext",this.tooltipFormatter(t));const n=(t-this.min)/(this.max-this.min);e.style.insetInlineStart=`calc( ${100*n}% - var(--full-thumb-size) / 2 )`,this.#l(e)}#r(){const{activeTrack:e}=this;if(!e)return;if(this.min===this.max){e.style.insetInlineStart="0%",e.style.insetInlineEnd="0%";return}if(this.#e.length===1){const o=getComputedStyle(this).getPropertyValue("--track-active-offset")||"0%",s=100*(this.#e[0]-this.min)/(this.max-this.min);e.style.insetInlineStart=`min(${o}, ${s}%)`,e.style.insetInlineEnd=`min(calc(100% - ${o}), calc(100% - ${s}%))`;return}const t=this.#e.slice().sort(We),n=100*(t[0]-this.min)/(this.max-this.min),i=100*(t[t.length-1]-this.min)/(this.max-this.min);e.style.insetInlineStart=`${n}%`,e.style.insetInlineEnd=`calc(100% - ${i}%)`}#f(e){const t=e.target,n=+t.dataset.rangeId,i=this.#t.get(n);if(i===void 0)return;let o=i;switch(e.key){case"ArrowUp":case"Up":o=Math.min(i+this.step,this.max);break;case"ArrowDown":case"Down":o=Math.max(i-this.step,this.min);break;case"ArrowLeft":case"Left":o=this.#o?Math.min(i+this.step,this.max):Math.max(i-this.step,this.min);break;case"ArrowRight":case"Right":o=this.#o?Math.max(i-this.step,this.min):Math.min(i+this.step,this.max);break;case"PageUp":o=Math.min(i+(this.max-this.min)/5,this.max);break;case"PageDown":o=Math.max(i-(this.max-this.min)/5,this.min);break;case"Home":o=this.min;break;case"End":o=this.max;break;default:return}if(o!==i){if(this.emit("syn-move",{cancelable:!0,detail:{element:t,value:o}}).defaultPrevented)return;if(this.restrictMovement){const l=this.#h(t,o);l.isRestricted&&(o=l.finalValue)}this.#s(t,o),this.#t.set(n,o),this.#e=Array.from(this.#t.values()),this.#r(),this.#l(t),this.#n=Array.from(this.#e),this.emit("syn-input"),this.emit("syn-change")}e.stopPropagation(),e.preventDefault()}#y(e){e.relatedTarget&&this.shadowRoot?.contains(e.relatedTarget)||(this.emit("syn-blur"),this.#a=!1)}#l(e){if(this.tooltipPlacement==="none")return;const t=+e.dataset.rangeId;if(!this.#t.has(t))return;const n=this.#t.get(t),i=e.parentElement;i.content=this.tooltipFormatter(n)}#b(e){if(this.disabled)return;this.#a||(this.#a=!0,this.emit("syn-focus"));const t=e.target;t?.dataset?.rangeId&&this.#l(t)}#g(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}#v(){const e=this.hasSlotController.test("ticks"),t=this.hasSlotController.test("prefix"),n=this.hasSlotController.test("suffix");if(!e)return;let i=this.shadowRoot?.querySelector(".ticks")?.clientHeight;if(i){if(i+=2,i/=2,t){const o=this.shadowRoot?.querySelector(".input__prefix");o.style.transform=`translateY(-${i}px)`}if(n){const o=this.shadowRoot?.querySelector(".input__suffix");o.style.transform=`translateY(-${i}px)`}}}renderThumbs(e){const t=this.#e.length>1;return this.#t.clear(),this.#e.map((n,i)=>{const o=i+1;this.#t.set(o,n);const s=`thumb-${o}`;let l="",d="";return t?(d=e?`label aria-label-hidden ${s}`:`aria-label-hidden ${s}`,i===0?l=`${this.localize.term("rangeMin")} (${this.tooltipFormatter(n)})`:i===this.#e.length-1?l=`${this.localize.term("rangeMax")} (${this.tooltipFormatter(n)})`:l=this.tooltipFormatter(n)):d=e?"label aria-label-hidden":"",p`
        <syn-tooltip
      ...
      <div
        part="form-control"
        class=${y({"form-control":!0,"form-control--has-help-text":s,"form-control--has-label":o,"form-control--has-prefix":n,"form-control--has-suffix":i,"form-control--is-disabled":this.disabled,"form-control--large":this.size==="large","form-control--medium":this.size==="medium","form-control--small":this.size==="small"})}
        @focusout=${this.#y}
      >
        <label
          id="label"
    ...
    `}}Y([r()],G.prototype,"name",2);Y([r()],G.prototype,"label",2);Y([r({attribute:"help-text"})],G.prototype,"helpText",2);Y([r({reflect:!0,type:Boolean})],G.prototype,"disabled",2);Y([r({type:Number})],G.prototype,"min",2);Y([r({type:Number})],G.prototype,"max",2);Y([r({type:Number})],G.prototype,"step",2);Y([r({reflect:!0})],G.prototype,"size",2);Y([r({attribute:"tooltip-placement",type:String})],G.prototype,"tooltipPlacement",2);Y([r({type:String})],G.prototype,"value",1);Y([r({attribute:"restrict-movement",type:Boolean})],G.prototype,"restrictMovement",2);Y([Ge()],G.prototype,"defaultValue",2);Y([r({reflect:!0})],G.prototype,"form",2);Y([r({attribute:!1})],G.prototype,"tooltipFormatter",2);Y([u(".input__wrapper")],G.prototype,"baseDiv",2);Y([u(".active-track")],G.prototype,"activeTrack",2);Y([$i(".thumb")],G.prototype,"thumbs",2);Y([u(".range__validation-input")],G.prototype,"validationInput",2);G.define("syn-range");const Gs=h`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
`;var Xs=Object.defineProperty,ci=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Xs(e,t,i),i};class Pt extends v{constructor(){super(...arguments),this.localize=new j(this),this.size="medium",this.removable=!1}static{this.styles=[w,Gs,Ys]}static{this.dependencies={"syn-icon-button":tt}}handleRemoveClick(){this.emit("syn-remove")}render(){return p`
      <span
        part="base"
...
`;var nr=Object.defineProperty,ir=Object.getOwnPropertyDescriptor,He=(a,e,t,n)=>{for(var i=n>1?void 0:n?ir(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&nr(e,t,i),i};class Ae extends v{constructor(){super(),this.hasSlotController=new W(this,"[default]","footer"),this.localize=new j(this),this.isAnimationActive=!1,this.open=!1,this.rail=!1,this.noFocusTrapping=!1,this.handleMouseEnter=this.handleMouseEnter.bind(this),this.handleMouseLeave=this.handleMouseLeave.bind(this),this.addEventListener("syn-initial-focus",e=>{this.rail&&(e.preventDefault(),this.drawer.originalTrigger=null)}),this.addEventListener("focusin",e=>{e.target.tagName.toLowerCase()==="syn-nav-item"&&this.rail&&!this.open&&(this.open=!0)}),this.addEventListener("focusout",e=>{const t=e.target.tagName.toLowerCase(),n=e.relatedTarget?.tagName.toLowerCase();t==="syn-nav-item"&&n!=="syn-nav-item"&&this.rail&&this.open&&(this.open=!1)})}static{this.styles=[w,tr]}static{this.dependencies={"syn-divider":je,"syn-drawer":ye}}setDelayedCallback(e){clearTimeout(this.timeout),this.timeout=setTimeout(e,100)}handleMouseEnter(){this.setDelayedCallback(()=>{this.open=!0})}handleMouseLeave(){this.setDelayedCallback(()=>{this.open=!1})}handleRequestClose(){this.open&&(this.open=!1)}addMouseListener(){this.drawer.shadowRoot.querySelector(".drawer__panel")?.addEventListener("mouseenter",this.handleMouseEnter),this.drawer.shadowRoot.querySelector(".drawer__panel")?.addEventListener("mouseleave",this.handleMouseLeave)}removeMouseListener(){this.drawer.shadowRoot.querySelector(".drawer__panel")?.removeEventListener("mouseenter",this.handleMouseEnter),this.drawer.shadowRoot.querySelector(".drawer__panel")?.removeEventListener("mouseleave",this.handleMouseLeave)}setDrawerVisibility(e){this.drawer.shadowRoot.querySelector(".drawer").hidden=!e,this.drawer.shadowRoot.querySelector(".drawer__panel")?.setAttribute("aria-hidden",e?"false":"true")}forceDrawerVisibilityForRailMode(){return U(this.drawer,"syn-after-hide").then(()=>{this.setDrawerVisibility(!0),this.isAnimationActive=!1})}setDrawerAnimations(){const e=N(this,`sideNav.show${this.rail?"Rail":"NonRail"}`,{dir:this.localize.dir()}),t=N(this,`sideNav.hide${this.rail?"Rail":"NonRail"}`,{dir:this.localize.dir()}),n=N(this,"sideNav.overlay.hide",{dir:this.localize.dir()}),i=N(this,"sideNav.overlay.show",{dir:this.localize.dir()});Tt(this.drawer,"drawer.showStart",e),Tt(this.drawer,"drawer.hideStart",t),Tt(this.drawer,"drawer.overlay.hide",n),Tt(this.drawer,"drawer.overlay.show",i)}handleModeChange(){this.setDrawerAnimations(),this.rail?(this.addMouseListener(),this.setDrawerVisibility(!0)):(this.removeMouseListener(),this.open||this.setDrawerVisibility(!1))}handleOpenChange(){this.rail&&(this.isAnimationActive=!0,this.open?U(this.drawer,"syn-after-show").then(()=>{this.isAnimationActive=!1}):this.forceDrawerVisibilityForRailMode())}handleFocusTrapping(){this.rail||(this.noFocusTrapping?this.drawer.modal.activateExternal():this.drawer.modal.deactivateExternal())}async show(){if(!this.open)return this.open=!0,U(this.drawer,"syn-after-show")}async hide(){if(this.open)return this.open=!1,U(this.drawer,"syn-after-hide")}firstUpdated(){this.setDrawerAnimations(),this.drawer.updateComplete.then(()=>{this.drawer.shadowRoot.querySelector(".drawer__panel").tabIndex=-1}),this.rail?this.drawer.updateComplete.then(()=>{this.addMouseListener(),this.setDrawerVisibility(!0)}):this.noFocusTrapping&&this.drawer.modal.activateExternal()}disconnectedCallback(){super.disconnectedCallback(),this.drawer&&(Ze(this.drawer),this.drawer.modal.deactivate())}render(){const e=window.navigator.maxTouchPoints>0||"ontouchstart"in window,t=this.hasSlotController.test("footer");return _`
      <nav
      ...
      >
        ...
        >
          ...
          <footer class="side-nav__footer" part="footer-container" slot="footer">  
            ...
            ${t?_`<syn-divider part="footer-divider" class="side-nav__footer-divider"></syn-divider>`:""}
    ...
    `}}He([b()],Ae.prototype,"isAnimationActive",2);He([u(".side-nav__drawer")],Ae.prototype,"drawer",2);He([r({reflect:!0,type:Boolean})],Ae.prototype,"open",2);He([r({reflect:!0,type:Boolean})],Ae.prototype,"rail",2);He([r({attribute:"no-focus-trapping",reflect:!0,type:Boolean})],Ae.prototype,"noFocusTrapping",2);He([m("rail",{waitUntilFirstUpdate:!0})],Ae.prototype,"handleModeChange",1);He([m("open",{waitUntilFirstUpdate:!0})],Ae.prototype,"handleOpenChange",1);He([m("noFocusTrapping",{waitUntilFirstUpdate:!0})],Ae.prototype,"handleFocusTrapping",1);T("sideNav.showRail",{keyframes:[{width:"var(--side-nav-rail-width)"},{width:"var(--side-nav-open-width)"}],options:{duration:250,easing:"ease"}});T("sideNav.showNonRail",{keyframes:[{opacity:0,translate:"-100%"},{opacity:1,translate:"0"}],options:{duration:250,easing:"ease"}});T("sideNav.hideNonRail",{keyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"-100%"}],options:{duration:250,easing:"ease"}});T("sideNav.hideRail",{keyframes:[{width:"var(--side-nav-open-width)"},{width:"var(--side-nav-rail-width)"}],options:{duration:250,easing:"ease"}});T("sideNav.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});T("sideNav.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});Ae.define("syn-side-nav");tn.define("syn-spinner");const ar=h`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
`;var Tr=Object.defineProperty,Cr=Object.getOwnPropertyDescriptor,Be=(a,e,t,n)=>{for(var i=n>1?void 0:n?Cr(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Tr(e,t,i),i};let Sr=0;class Me extends v{constructor(){super(...arguments),this.localize=new j(this),this.attrId=++Sr,this.componentId=`syn-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}static{this.styles=[w,kr,_r]}static{this.dependencies={"syn-icon-button":tt}}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}handleCloseClick(e){e.stopPropagation(),this.emit("syn-close")}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false"),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,p`
      <div
        part="base"
    ...
    `}}Be([u(".tab")],Me.prototype,"tab",2);Be([r({reflect:!0})],Me.prototype,"panel",2);Be([r({type:Boolean,reflect:!0})],Me.prototype,"active",2);Be([r({type:Boolean,reflect:!0})],Me.prototype,"closable",2);Be([r({type:Boolean,reflect:!0})],Me.prototype,"disabled",2);Be([r({type:Number,reflect:!0})],Me.prototype,"tabIndex",2);Be([m("active")],Me.prototype,"handleActiveChange",1);Be([m("disabled")],Me.prototype,"handleDisabledChange",1);Me.define("syn-tab");Pt.define("syn-tag");const zr=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
 ...
 */`,dependencies:["syn-alert"]}],exports:[{kind:"js",name:"default",declaration:{name:"SynValidate",module:"../components/src/components/validate/validate.js"}}]}],package:{author:{name:"SICK Global UX Foundation",url:"https://www.sick.com"},description:"",homepage:"https://synergy-design-system.github.io",license:"MIT",name:"@synergy-design-system/components",version:"2.18.5"}},Br={modules:[{declarations:[{attributes:[{default:"'syn-link--small'",description:"The size of the link",name:"syn-link",type:{text:"'syn-link--small' | 'syn-link--medium' | 'syn-link--large'"}},{default:"false",description:"Applies the quiet link styling",name:"syn-link--quiet",type:{text:"boolean"}},{default:"false",description:"Applies the disabled link styling",name:"syn-link--disabled",type:{text:"boolean"}}],customElement:!0,kind:"class",members:[{attribute:"syn-link",default:"'syn-link--small'",description:"The size of the link",kind:"field",name:"syn-link",type:{text:"'syn-link--small' | 'syn-link--medium' | 'syn-link--large'"}},{attribute:"syn-link--quiet",default:"false",description:"Applies the quiet link styling",kind:"field",name:"syn-link--quiet",type:{text:"boolean"}},{attribute:"syn-link--disabled",default:"false",description:"Applies the disabled link styling",kind:"field",name:"syn-link--disabled",type:{text:"boolean"}}],name:"syn-link",slots:[{description:"Main content of syn-link",name:""}],tagName:"syn-link",tagNameWithoutPrefix:"link"}],description:"The size of the link",kind:"javascript-module",path:"../styles/src/link/index.css"},{declarations:[{attributes:[{default:"'syn-link-list--medium'",description:"The size of the link list",name:"syn-link-list",type:{text:"'syn-link-list--medium' | 'syn-link-list--small' | 'syn-link-list--large'"}},{default:"false",description:"Applies horizontal styling to the link list",name:"syn-link-list--horizontal",type:{text:"boolean"}}],customElement:!0,kind:"class",members:[{attribute:"syn-link-list",default:"'syn-link-list--medium'",description:"The size of the link list",kind:"field",name:"syn-link-list",type:{text:"'syn-link-list--medium' | 'syn-link-list--small' | 'syn-link-list--large'"}},{attribute:"syn-link-list--horizontal",default:"false",description:"Applies horizontal styling to the link list",kind:"field",name:"syn-link-list--horizontal",type:{text:"boolean"}}],name:"syn-link-list",slots:[{description:"Main content of syn-link-list",name:""}],tagName:"syn-link-list",tagNameWithoutPrefix:"link-list"}],description:"The size of the link list",kind:"javascript-module",path:"../styles/src/link-list/index.css"},{declarations:[{attributes:[{default:"true",description:"Applies the table cell styling",name:"syn-table-cell",type:{text:"boolean"}},{default:"false",description:"Applies an alternating style to help separate rows visually",name:"syn-table-cell--alternating",type:{text:"boolean"}},{default:"false",description:"Applies a border to the left of the table cell",name:"syn-table-cell--border-start",type:{text:"boolean"}},{default:"false",description:"Applies a border to the right of the table cell",name:"syn-table-cell--border-end",type:{text:"boolean"}},{default:"false",description:"Applies a border to the top of the table cell",name:"syn-table-cell--border-top",type:{text:"boolean"}},{default:"false",description:"Applies a border to the bottom of the table cell",name:"syn-table-cell--border-bottom",type:{text:"boolean"}},{default:"false",description:"Applies the table cell header styling",name:"syn-table-cell--header",type:{text:"boolean"}},{default:"",description:"Applies the selected shadow to the table cell",name:"syn-table-cell--shadow",type:{text:" | 'syn-table-cell--shadow-bottom' | 'syn-table-cell--shadow-top' | 'syn-table-cell--shadow-start' | 'syn-table-cell--shadow-end'"}},{default:"false",description:"Displays the table shadow",name:"syn-table-cell--shadow-active",type:{text:"boolean"}}],customElement:!0,kind:"class",members:[{attribute:"syn-table-cell",default:"true",description:"Applies the table cell styling",kind:"field",name:"syn-table-cell",type:{text:"boolean"}},{attribute:"syn-table-cell--alternating",default:"false",description:"Applies an alternating style to help separate rows visually",kind:"field",name:"syn-table-cell--alternating",type:{text:"boolean"}},{attribute:"syn-table-cell--border-start",default:"false",description:"Applies a border to the left of the table cell",kind:"field",name:"syn-table-cell--border-start",type:{text:"boolean"}},{attribute:"syn-table-cell--border-end",default:"false",description:"Applies a border to the right of the table cell",kind:"field",name:"syn-table-cell--border-end",type:{text:"boolean"}},{attribute:"syn-table-cell--border-top",default:"false",description:"Applies a border to the top of the table cell",kind:"field",name:"syn-table-cell--border-top",type:{text:"boolean"}},{attribute:"syn-table-cell--border-bottom",default:"false",description:"Applies a border to the bottom of the table cell",kind:"field",name:"syn-table-cell--border-bottom",type:{text:"boolean"}},{attribute:"syn-table-cell--header",default:"false",description:"Applies the table cell header styling",kind:"field",name:"syn-table-cell--header",type:{text:"boolean"}},{attribute:"syn-table-cell--shadow",default:"",description:"Applies the selected shadow to the table cell",kind:"field",name:"syn-table-cell--shadow",type:{text:" | 'syn-table-cell--shadow-bottom' | 'syn-table-cell--shadow-top' | 'syn-table-cell--shadow-start' | 'syn-table-cell--shadow-end'"}},{attribute:"syn-table-cell--shadow-active",default:"false",description:"Displays the table shadow",kind:"field",name:"syn-table-cell--shadow-active",type:{text:"boolean"}}],name:"syn-table-cell",slots:[{description:"Main content of syn-table-cell",name:""}],tagName:"syn-table-cell",tagNameWithoutPrefix:"table-cell"}],description:"Applies the table cell styling",kind:"javascript-module",path:"../styles/src/tables/table-cell.css"},{declarations:[{attributes:[{default:"false",description:"Applies the styling to a table element",name:"syn-table",type:{text:"boolean"}},{default:"true",description:"Applies all default table stylings to a table and its children",name:"syn-table--default",type:{text:"boolean"}},{default:"false",description:"Applies all alternate table stylings to a table and its children",name:"syn-table--alternating",type:{text:"boolean"}},{default:"false",description:"Applies all border table stylings to a table and its children",name:"syn-table--border",type:{text:"boolean"}}],customElement:!0,kind:"class",members:[{attribute:"syn-table",default:"false",description:"Applies the styling to a table element",kind:"field",name:"syn-table",type:{text:"boolean"}},{attribute:"syn-table--default",default:"true",description:"Applies all default table stylings to a table and its children",kind:"field",name:"syn-table--default",type:{text:"boolean"}},{attribute:"syn-table--alternating",default:"false",description:"Applies all alternate table stylings to a table and its children",kind:"field",name:"syn-table--alternating",type:{text:"boolean"}},{attribute:"syn-table--border",default:"false",description:"Applies all border table stylings to a table and its children",kind:"field",name:"syn-table--border",type:{text:"boolean"}}],name:"syn-table",slots:[{description:"Main content of syn-table",name:""}],tagName:"syn-table",tagNameWithoutPrefix:"table"}],description:"Applies the styling to a table element",kind:"javascript-module",path:"../styles/src/tables/table.css"},{declarations:[{attributes:[{default:"'syn-body--x-small'",description:"The font size of the body text",name:"syn-body",type:{text:"'syn-body--x-small' | 'syn-body--small' | 'syn-body--medium' | 'syn-body--large'"}}],customElement:!0,kind:"class",members:[{attribute:"syn-body",default:"'syn-body--x-small'",description:"The font size of the body text",kind:"field",name:"syn-body",type:{text:"'syn-body--x-small' | 'syn-body--small' | 'syn-body--medium' | 'syn-body--large'"}}],name:"syn-body",slots:[{description:"Main content of syn-body",name:""}],tagName:"syn-body",tagNameWithoutPrefix:"body"}],description:"The font size of the body text",kind:"javascript-module",path:"../styles/src/typography/body.css"},{declarations:[{attributes:[{default:"'syn-heading--3x-large'",description:"The size of the headline",name:"syn-heading",type:{text:"'syn-heading--3x-large' | 'syn-heading--2x-large' | 'syn-heading--x-large' | 'syn-heading--large'"}}],customElement:!0,kind:"class",members:[{attribute:"syn-heading",default:"'syn-heading--3x-large'",description:"The size of the headline",kind:"field",name:"syn-heading",type:{text:"'syn-heading--3x-large' | 'syn-heading--2x-large' | 'syn-heading--x-large' | 'syn-heading--large'"}}],name:"syn-heading",slots:[{description:"Main content of syn-heading",name:""}],tagName:"syn-heading",tagNameWithoutPrefix:"heading"}],description:"The size of the headline",kind:"javascript-module",path:"../styles/src/typography/heading.css"},{declarations:[{attributes:[{default:"'syn-weight--normal'",description:"The font weight to apply",name:"syn-weight",type:{text:"'syn-weight--normal' | 'syn-weight--semibold' | 'syn-weight--bold'"}}],customElement:!0,kind:"class",members:[{attribute:"syn-weight",default:"'syn-weight--normal'",description:"The font weight to apply",kind:"field",name:"syn-weight",type:{text:"'syn-weight--normal' | 'syn-weight--semibold' | 'syn-weight--bold'"}}],name:"syn-weight",slots:[{description:"Main content of syn-weight",name:""}],tagName:"syn-weight",tagNameWithoutPrefix:"weight"}],description:"The font weight to apply",kind:"javascript-module",path:"../styles/src/typography/weight.css"}],readme:"",schemaVersion:"1.0.0"};ta({hideArgRef:!0,hideScriptTag:!0});ut.modules&&(ut.modules=ut.modules.map(a=>(a.declarations&&(a.declarations=a.declarations.map(e=>(e.members&&(e.members=e.members.filter(t=>t.description&&t.privacy!=="private")),e))),a)));const Rr={...ut,modules:[...ut.modules,...Br.modules]};Di(Rr);console.log("Custom elements manifest loaded for components and styles");const qt=a=>{const{args:e,events:t,argTypes:n}=Bn(a),i=Ln(a,window.__STORYBOOK_CUSTOM_ELEMENTS_MANIFEST__),o=()=>({status:{styles:{backgroundColor:i?.status==="stable"?"#43b02a":"rgb(255, 131, 0)",borderColor:"white",color:"white"},title:`Status: ${i?.status}`},since:{styles:{backgroundColor:"#333",borderColor:"#fff",color:"#fff"},title:`Since: ${i?.since}`}});return{args:e,argTypes:(()=>{for(const d in n)n.hasOwnProperty(d)&&n[d].table&&n[d].table.category==="properties"&&(n[d].control={disabled:!0});return{...n,...i?.events?.reduce((d,c)=>(d[c.name]={...c,control:!1,table:{category:"Events"}},d),{}),...i?.members?.filter(d=>d.kind==="method").reduce((d,c)=>(d[c.name]={...c,control:!1,table:{category:"Methods"}},d),{})}})(),parameters:{badges:["status","since"],badgesConfig:o(),actions:{handles:t}}}},Je=a=>({getSuffixFromType:e=>({attribute:"",property:"-prop",slot:"-slot",cssPart:"-part",cssProperty:""})[e],getValuesFromAttribute:e=>{e.endsWith("-attr")||(e=`${e}-attr`);const{argTypes:t}=qt(a);return t[e]?.control?.type==="boolean"?[!0,!1]:t[e].options},getValuesFromAttributes:e=>e?.map(t=>(t.endsWith("-attr")||(t=`${t}-attr`),{name:t,values:Je(a).getValuesFromAttribute(t)})),overrideArgs:(e,t)=>{const n=t||qt(a).args,i=Array.isArray(e)?e:[e];for(const o of i){const s=Je(a).getSuffixFromType(o.type);n[`${o.name}${s}`]=o.value}return n}}),ol=a=>{const{template:e,manifest:t}=Bn(a),{args:n}=qt(a),{getValuesFromAttribute:i}=Je(a);return{generateTemplate:({axis:s,constants:l=[],options:d,args:c=n})=>{const f=x=>{if(!t?.style)return e(x);const P=Object.keys(x).filter(L=>L.endsWith("-attr")).reduce((L,ke)=>{const he=ke.substring(0,ke.length-5);return x[ke]===!0?L[he]=!0:x[ke]==="false"||x[ke]==="(default)"?L[he]=!1:x[ke]&&(he.endsWith("...")?L[he.replace("...",x[ke])]=!0:L[x[ke]]=!0),L},{}),Pe=x["default-slot"]||"",Ue={[a]:!0,...P},at=Object.keys(Ue).filter(L=>Ue[L]).join(" ");if(d?.templateContent){const L=d.templateContent.replaceAll("%SLOT%",Pe).replaceAll("%CLASSES%",at);return te(L)}return _`<div class=${y(Ue)}>${te(Pe)}</div>`},k=(Array.isArray(l)?l:[l]).reduce((x,P)=>({...x,[`${P.name}${Je(a).getSuffixFromType(P.type)}`]:P.value}),{});if(!s?.x&&!s?.y&&!d?.title)return _`${f({...c,...k})}`;const q=x=>x?Array.isArray(x)?x.map(P=>({...P,values:P.values||i(P.name)})):[{...x,values:x.values||i(x.name)}]:[{}],Re=q(s?.x),be=q(s?.y),xt=(Array.isArray(l)?l:[l]).find(x=>x.type==="template")?.value,kt=`uuid-${crypto.randomUUID()}`;return _`
      <style>
        ...
        ${d?.templateBackgrounds?.colors.map((x,P)=>{const Pe=Ue=>`${d?.templateBackgrounds?.colors.length}n + ${Ue+1}`;return d?.templateBackgrounds?.alternate==="y"?`
                .${kt}.story-template tbody tr.template-row:nth-of-type(${Pe(P)}) td.template {
                  background: ${x};
                }
              `:`
                .${kt}.story-template tbody tr.template-row td.template:nth-of-type(${Pe(P)}) {
                  background: ${x};
                }
              `})}
      </style>
      ${Re.map(x=>_` ${be.map(P=>{let Pe=!0;const Ue=Re.length>1||x.values,at=(x&&P||be.length>1)&&P?.values;return _`
            <table class="story-template ${kt} ${d?.classes}">
              <thead>
                ...
                ${x&&x.values&&_`
                  <tr>
                    ${at?_`<td></td>`:""} <td></td>
                    ${Ue&&_`<th colspan=${x.values?.length||0}><code>${x.title||x.name}</code></th>`}
                    </tr>
                  </tr>
                  ${_`
                    <tr>
                      ${at?_`<td></td>`:""}
                      <td></td>
                      ${x?.values?.map(L=>_`<td><code>${L.title||L}</code></td>`)}
                    </tr>
                  `}
                `}
              </thead>
              <tbody>
                ${(P?.values||[""]).map(L=>{const ke=_`
                    <tr class="template-row">
                      ${Pe&&at?_`<th rowspan="${P?.values?.length}">
                      ...
                      ${(x?.values||[""]).map(he=>_`
                          ...
                          ${xt&&te(xt.split("%TEMPLATE%")[0]||"")||""}
                            ${f({...c,...k,...x&&x.type!=="template"&&{[`${x.name}${Je(a).getSuffixFromType(x.type)}`]:he.hasOwnProperty("value")?he.value:he},...P&&P.type!=="template"&&{[`${P.name}${Je(a).getSuffixFromType(P.type)}`]:L.hasOwnProperty("value")?L.value:L}})}
...
`):n=e.innerHTML,n=n.replace(/<style><\/style>/g,"").replace(/<!-- preview-ignore:start -->[\s\S]*?<!-- preview-ignore:end -->/g,"").replace(/\/\/ preview-ignore:start[\s\S]*?\/\/ preview-ignore:end/g,"").replace(/<style>\n<\/style>/g,"").replace(/<script>\s*component = document\.querySelector\('(.+?)'\);\s*<\/script>/g,""),n}},sl=(a,e)=>{const t=pn?.components?.[a]?.[e]?.description?.value??"No Description",n=pn?.components?.[a]?.[e]?.note?.value??"",i=t.replace(/\n/g,"<br/>"),o=n.length>0?`
  ...
  > ${n.replace(/\n/g,"<br/>")}`:n;return`${i}${o}`},rl=(a,e=150)=>{const t=isNaN(e)?e:{heightPx:e},{afterRender:n="",additionalChromaticOptions:i={},heightPx:o=150,styleHeading:s={}}=t,l=Object.entries(s).map(([d,c])=>`${d}: ${c};`).join(" ");return{parameters:{chromatic:{...ui?.parameters?.chromatic,...i,disableSnapshot:!1},docs:{disable:!0}},render:(d,c)=>_`
      ${Object.entries(a).map(([f,k])=>{const q=k.name??Ii(f);return _`
          <div style='height: ${o}px; margin: var(--syn-spacing-small);'>
            <h3 data-chromatic="ignore" style='${l}'>${q}</h3>
            ${k.render?.(d,c)}
          </div>
      `})}
      ${n}
    `}};export{ol as a,sl as b,rl as c,Je as d,al as e,Fr as g,il as h,Pr as i,ui as p,qt as s};
