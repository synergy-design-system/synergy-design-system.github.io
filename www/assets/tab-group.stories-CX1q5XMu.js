import{n as e}from"./chunk-DnJy8xQt.js";import{E as t,Nt as n,Rt as r,T as i,d as a,f as o,g as s,u as c}from"./iframe-CIeU5pXv.js";import{i as l,n as u}from"./dist-DKcu4P11.js";import{t as d}from"./icon-EWLg8ZFU.js";import{a as f,i as p,n as m,o as h,r as g,t as _}from"./component-Dma-UHGC.js";import{n as v,t as y}from"./taggedTemplateLiteral-BuD1d7yP.js";import{n as b,t as x}from"./tab-panel-0GUrR1a8.js";import{t as S}from"./tab-B4Ho8wZT.js";var C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J;e((()=>{b(),S(),x(),d(),n(),u(),i(),g(),a(),s(),v(),{args:w,argTypes:T}=p(`syn-tab-group`),{overrideArgs:E}=f(`syn-tab-group`),{generateTemplate:D}=h(`syn-tab-group`),O=(e,t,{active:n=!1,closable:r=!1,disabled:i=!1}={})=>`<syn-tab slot="nav" panel="${e}" ${n?`active`:``} ${i?`disabled`:``} ${r?`closable`:``}>${t}</syn-tab>`,k=(e,n,{active:r=!1,closable:i=!1,disabled:a=!1}={})=>t(O(e,n,{active:r,closable:i,disabled:a})),A=()=>[{panel:`general`,props:{active:!0}},{panel:`custom`},{panel:`advanced`},{panel:`disabled`,props:{disabled:!0}}].map(({panel:e,props:t})=>O(e,l(e),t)).join(`
