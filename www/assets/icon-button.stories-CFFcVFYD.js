import"./icon-button-BsnFsjAn.js";import{k as n}from"./lit-element-BsyMe9HG.js";import{s as m,a as d,g as e,b,c as y}from"./component-eGmRQmem.js";import{g}from"./preview-BfEM8BLb.js";import"./icon.component-Cwq7Y_Aa.js";import"./directive-helpers-DUpkUCIH.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-D8vHI8_K.js";import"./index-B-o1Wr-g.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon-DiAnxFT_.js";const{args:f,argTypes:S}=m("syn-icon-button"),{overrideArgs:z}=y("syn-icon-button"),{generateTemplate:w}=d("syn-icon-button"),_={args:z([{name:"name",type:"attribute",value:"wallpaper"},{name:"label",type:"attribute",value:"Wallpaper"},{name:"size",type:"attribute",value:"medium"}],f),argTypes:S,component:"syn-icon-button",parameters:{design:g("2986-3736"),docs:{description:{component:e("icon-button","default")}}},title:"Components/syn-icon-button"},t={parameters:{controls:{disable:!1},docs:{description:{story:e("icon-button","default")}}},render:p=>w({args:p})},r={parameters:{docs:{description:{story:e("icon-button","sizes")}}},render:()=>n`<syn-icon-button name="wallpaper" label="Wallpaper" color="neutral" size="small"></syn-icon-button>
  ...
  </style>`},c=b({Default:t,Sizes:r,Colors:a,LinkButton:s,Disabled:o,Label:l});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  Disabled,
  Label
})`,...c.parameters?.docs?.source}}};const F=["Default","Sizes","Colors","LinkButton","Disabled","Focus","Label","Screenshot"];export{a as Colors,t as Default,o as Disabled,i as Focus,l as Label,s as LinkButton,c as Screenshot,r as Sizes,F as __namedExportsOrder,_ as default};
