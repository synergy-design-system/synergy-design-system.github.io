import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,h as n,t as r}from"./lit-BVDl_-fF.js";import{a as i,i as a,n as o,o as s,r as c,s as l,t as u,y as d}from"./synergy-element-D_jGE1Vc.js";import{n as f,t as p}from"./class-map-BNNCJSEv.js";import{n as m,t as h}from"./localize-CzgwcyM2.js";import{n as g,t as _}from"./decorator-ChmomMqD.js";import{n as v,t as y}from"./icon-button.component-B-s70dRh.js";var b,x=e((()=>{r(),b=n`
	/* stylelint-disable */
  :host {
...
`})),w,T,E=e((()=>{p(),r(),h(),l(),s(),o(),v(),x(),C(),g(),a(),w=class extends u{constructor(...e){super(...e),this.localize=new m(this),this.size=`medium`,this.removable=!1}static{this.styles=[i,b,S]}static{this.dependencies={"syn-icon-button":y}}handleRemoveClick(){this.emit(`syn-remove`)}render(){return t`
      <span
        part="base"
    ...
    `}},c([d({reflect:!0})],w.prototype,`size`,void 0),c([d({type:Boolean})],w.prototype,`removable`,void 0),w=c([_(`SynTag`)],w),T=w}));export{T as n,E as t};