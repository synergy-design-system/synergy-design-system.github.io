import{i as e}from"./preload-helper-xPQekRTU.js";import{h as t,t as n}from"./lit-BVDl_-fF.js";import{M as r,O as i,k as a}from"./iframe-BCoUYk3Z.js";import{n as o,t as s}from"./class-map-DgYlm_fS.js";import{r as c,t as l}from"./if-defined-BsCyJVG6.js";import{_ as u,a as d,f,i as p,n as m,o as h,r as g,s as _,t as v,y}from"./synergy-element-BtCydRhm.js";import{n as b,t as x}from"./icon.component-B9Dbh5an.js";import{n as S,t as C}from"./decorator-ChmomMqD.js";var w,T=e((()=>{n(),w=t`
  :host {
...
`})),E,D,O=e((()=>{s(),i(),l(),_(),h(),m(),b(),T(),S(),p(),E=class extends v{constructor(...e){super(...e),this.hasFocus=!1,this.label=``,this.size=`inherit`,this.color=`currentColor`,this.disabled=!1}static{this.styles=[d,w]}static{this.dependencies={"syn-icon":x}}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){let e=!!this.href,t=e?a`a`:a`button`;return r`
      <${t}
        part="base"
