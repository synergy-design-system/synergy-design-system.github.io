import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,d as r,f as i,g as a,u as o}from"./iframe-CkET12W3.js";import{t as s}from"./button-CpKx43QA.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-B473QWuz.js";import{n as m,t as h}from"./taggedTemplateLiteral-DxWpUJWn.js";import{n as g,t as _}from"./PaddingDecorator-Ds2TnBCu.js";import{t as v}from"./file-DkrXZdQg.js";var y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B=e((()=>{v(),s(),t(),f(),r(),_(),a(),m(),{userEvent:y}=__STORYBOOK_MODULE_TEST__,{args:x,argTypes:S}=l(`syn-file`),{overrideArgs:C}=c(`syn-file`),{generateTemplate:w}=d(`syn-file`),T={args:C([],x),argTypes:S,component:`syn-file`,parameters:{chromatic:{modes:i},design:o(`41310-271865`),docs:{description:{component:u(`file`,`default`)}}},tags:[`Form`],title:`Components/syn-file`},E={parameters:{controls:{disable:!1},docs:{description:{story:u(`file`,`default`)}}},render:e=>w({args:e})},D={parameters:{docs:{description:{story:u(`file`,`label`)}}},render:()=>n`
  ...
  `},A={parameters:{docs:{description:{story:u(`file`,`hide-value`)}}},render:()=>n`
    <syn-file
      ...
      label="This is a label"
    ></syn-file>
  `},j={decorators:[g()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`file`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-file`);t&&t.focus()},render:()=>n`
...
`},P={parameters:{docs:{description:{story:u(`file`,`sizes`)}}},render:()=>n`
  ...
  `},F={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`file`,`invalid`)}}},play:async({canvasElement:e})=>{try{let t=e.querySelector(`form`),n=t.querySelectorAll(`syn-file`),r=t.querySelector(`syn-button`);r&&n&&(await y.click(r),r.click())}catch(e){console.error(`Error in play function:`,e)}},render:()=>n(b||=h([`
