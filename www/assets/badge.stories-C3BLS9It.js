import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,d as r,f as i,g as a,u as o}from"./iframe-fXCqWTG3.js";import{t as s}from"./button-Cwo2Enjo.js";import{t as c}from"./icon-sEREnw4h.js";import{a as l,i as u,n as d,o as f,r as p,t as m}from"./component-CsQUi1XQ.js";import{t as h}from"./badge-okJR3utN.js";import{n as g,t as _}from"./menu-item-B6Yw7IvL.js";import{t as v}from"./menu-label-DNLLlT5k.js";import{t as y}from"./popup-hWVwhlsE.js";var b,x,S,C,w,T,E,D,O,k,A,j,M=e((()=>{t(),h(),s(),c(),g(),v(),_(),y(),p(),r(),a(),{args:b,argTypes:x}=u(`syn-badge`),{overrideArgs:S}=l(`syn-badge`),{generateTemplate:C}=f(`syn-badge`),w={args:S([{name:`default`,type:`slot`,value:`Badge`}],b),argTypes:x,component:`syn-badge`,parameters:{chromatic:{modes:i},design:o(`41137-656313`),docs:{description:{component:d(`badge`,`default`)}}},tags:[`Feedback`],title:`Components/syn-badge`},T={parameters:{controls:{disable:!1},docs:{description:{story:d(`badge`,`default`)}}},render:e=>C({args:e})},E={parameters:{docs:{description:{story:d(`badge`,`variants`)}}},render:()=>n`
  ...
  `},D={parameters:{docs:{description:{story:d(`badge`,`withButton`)}}},render:()=>n`
  ...
  `},O={parameters:{docs:{description:{story:d(`badge`,`menu`)}}},render:()=>n`
  ...
  `},k={parameters:{docs:{description:{story:d(`badge`,`withEmptyContent`)}}},render:()=>n`
