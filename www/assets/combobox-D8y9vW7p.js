import{e as g}from"./class-map-DuCXFyun.js";import{o as D}from"./if-defined-DcCHMlyu.js";import{k as H,o as F,c as p,D as E}from"./iframe-CfKmpROb.js";import{c as U,n as r,S as R}from"./synergy-element-D6uzLjd8.js";import{S as M,r as d}from"./icon.component-BOIuuAKO.js";import{a as u}from"./query-D0jTsbLw.js";import{s as $,a as C,g as _,b as w}from"./animation-registry-DyRYqZdt.js";import{F as P}from"./form-d9hCJUdr.js";import{H as N}from"./slot-9EVoRGQc.js";import{L as B}from"./controller-0nuky388.js";import{w as x}from"./event-B0iVuGLD.js";import{w as m}from"./watch-CEsCE2EF.js";import{f as W}from"./form-control.styles-D5Kv7-NX.js";import{S as j}from"./popup.component-bONzouLj.js";import{s as K,S as V,c as y,i as S}from"./utility-uFnjnHei.js";import{S as Q}from"./tag.component-ylJMqeU9.js";import{s as G}from"./scroll-DgKSCJoS.js";import{e as q}from"./decorator-jbWt9cIm.js";const J=H`
  ...
  */
  ...
  ${K}
`,z=t=>Array.from(t.assignedElements({flatten:!0})),X=t=>t.tagName.toLocaleLowerCase()==="syn-option"?t:Array.from(t.querySelectorAll(":scope > syn-option")),Y=t=>t.tagName.toLocaleLowerCase()==="syn-optgroup",L=t=>t.map(X),Z=t=>t.filter(Y),A=t=>t.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase(),I=t=>{const e=document.createElement("div");return E(t,e),e.firstElementChild},v=t=>t.tagName.toLocaleLowerCase()==="syn-option"?t:void 0,tt=t=>{if(t){if(t instanceof HTMLElement)return v(t);if(typeof t=="string"){const e=p`${F(t)}`,o=I(e);return v(o)}if(Object.prototype.hasOwnProperty.call(t,"_$litType$")){const e=I(t);return v(e)}}},O=t=>{const{value:e}=t;return e==null||e===""?t.getTextLabel():e},b=t=>t.map(O),k=(t,e)=>{if(!e||t===void 0||t===null||t==="")return!1;const o=e.value,s=e.getTextLabel();return String(t)===String(o)||String(t)===s},et=t=>t,Ct=(t,e)=>{if(!e)return t;const o=t.cloneNode(!0),s=o.getTextLabel();o.selected=t.selected;const n=s.toLowerCase().indexOf(e.toLowerCase()),l=o.innerHTML.indexOf(s),h=document.createElement("mark");h.textContent=s.slice(n,n+e.length),h.classList.add("syn-highlight-style");const c=s.replace(new RegExp(e,"i"),h.outerHTML),f=o.innerHTML.slice(0,l),T=o.innerHTML.slice(l+s.length);return o.innerHTML=f.concat(c,T),o};var ot=Object.defineProperty,st=Object.getOwnPropertyDescriptor,a=(t,e,o,s)=>{for(var n=s>1?void 0:s?st(e,o):e,l=t.length-1,h;l>=0;l--)(h=t[l])&&(n=(s?h(e,o,n):h(n))||n);return s&&n&&ot(e,o,n),n};let i=class extends R{constructor(){super(...arguments),this.formControlController=new P(this,{assumeInteractionOn:["syn-blur","syn-input"]}),this.hasSlotController=new N(this,"help-text","label"),this.localize=new B(this),this.lastOptions=[],this.isInitialized=!1,this.isOptionRendererTriggered=!1,this.hasFocus=!1,this.isUserInput=!1,this.displayLabel="",this.selectedOptions=[],this.numberFilteredOptions=0,this.cachedOptions=[],this.valueHasChanged=!1,this.hideOptions=!1,this.name="",this._value="",this.defaultValue="",this.size="medium",this.placeholder="",this.disabled=!1,this.readonly=!1,this.clearable=!1,this.open=!1,this.label="",this.placement="bottom",this.helpText="",this.form="",this.required=!1,this.restricted=!1,this.multiple=!1,this.getOption=et,this.filter=(t,e)=>{let o=t?.textContent||"";t instanceof V&&(o=t.getTextLabel());const s=A(o),n=A(e);return s.includes(n)?!0:t?.value?.toString()===e},this.delimiter=" ",this.maxOptionsVisible=3,this.getTag=t=>p`
    <syn-tag
      part="tag"
      exportparts="
            base:tag__base,
