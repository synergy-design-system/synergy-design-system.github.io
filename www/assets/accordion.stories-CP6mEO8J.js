import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,Ut as r,d as ee,f as i,g as a,u as o}from"./iframe-BcSabCAt.js";import{n as s,t as c}from"./class-map-ubcCJG2R.js";import{a as l,c as u,i as d,m as f,n as p,o as m,r as h,s as g,t as _}from"./synergy-element-B9jDHluB.js";import{n as v,t as y}from"./watch-0Lf6m-Da.js";import{n as b,t as x}from"./decorator-C8FY8E2M.js";import{a as S,i as C,n as w,o as te,r as ne,t as T}from"./component-CI3ThXYz.js";import{n as E,t as D}from"./taggedTemplateLiteral-DxWpUJWn.js";import{t as O}from"./details-DDMMoLhw.js";import{n as k,t as A}from"./PaddingDecorator-29WbdGSg.js";var j,M=e((()=>{t(),j=r`
  :host {
    display: block;
  }
...
`})),N,P,F=e((()=>{t(),g(),c(),p(),y(),m(),M(),b(),d(),N=class extends _{constructor(...e){super(...e),this.closeOthers=!1,this.contained=!1,this.size=`medium`,this.handleAccordionShow=e=>{this.closeOthers&&this.detailsInDefaultSlot.forEach(t=>{t!==e.target&&t.parentNode===e.target.parentNode&&t.removeAttribute(`open`)})}}static{this.styles=[l,j]}adjustDetailsSize(){this.detailsInDefaultSlot.forEach(e=>{e.setAttribute(`size`,this.size)})}adjustDetailsContained(){this.detailsInDefaultSlot.forEach(e=>{e.contained=this.contained})}handleSizeChange(){this.adjustDetailsSize()}handleContainedChange(){this.adjustDetailsContained()}connectedCallback(){super.connectedCallback(),this.addEventListener(`syn-show`,this.handleAccordionShow)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`syn-show`,this.handleAccordionShow)}handleSlotChange(){this.adjustDetailsSize(),this.adjustDetailsContained()}render(){return n`
    ...
    `}},h([u({selector:`syn-details`})],N.prototype,`detailsInDefaultSlot`,void 0),h([f({attribute:`close-others`,type:Boolean})],N.prototype,`closeOthers`,void 0),h([f({reflect:!0,type:Boolean})],N.prototype,`contained`,void 0),h([f({reflect:!0})],N.prototype,`size`,void 0),h([v(`size`,{waitUntilFirstUpdate:!0})],N.prototype,`handleSizeChange`,null),h([v(`contained`,{waitUntilFirstUpdate:!0})],N.prototype,`handleContainedChange`,null),N=h([x(`SynAccordion`)],N),P=N})),I=e((()=>{F(),F(),P.define(`syn-accordion`)})),L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=e((()=>{t(),I(),O(),ne(),ee(),A(),a(),E(),{args:R,argTypes:z}=C(`syn-accordion`),{overrideArgs:B}=S(`syn-accordion`),{generateTemplate:V}=te(`syn-accordion`),H={args:B([{name:`default`,type:`slot`,value:`
      ...
      `}],R),argTypes:z,component:`syn-accordion`,parameters:{chromatic:{modes:i},design:o(`41094-279501`),docs:{description:{component:w(`accordion`,`default`)}}},tags:[`Structure`],title:`Components/syn-accordion`},U={parameters:{controls:{disable:!1},docs:{description:{story:w(`accordion`,`default`)}}},render:e=>V({args:e})},W={parameters:{docs:{description:{story:w(`accordion`,`contained`)}}},render:()=>n`
  ...
  `},G={parameters:{docs:{description:{story:w(`accordion`,`grouping`)}}},render:()=>n`
  ...
  `},K={decorators:[k()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:w(`accordion`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-details`);t&&t.shadowRoot.querySelector(`summary`).focus()},render:()=>n`
    <syn-accordion>
  ...
  `},q=e=>({parameters:{docs:{description:{story:w(`accordion`,`disabled`)}}},render:()=>n`
  ...
  `}),J=q(!1),Y=q(!0),X={parameters:{docs:{description:{story:w(`accordion`,`size`)}}},render:()=>n(L||=D([`
    `,`
