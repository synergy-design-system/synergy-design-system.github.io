import{h as L}from"./combobox-DppW2jZM.js";import"./button-DbI0oScA.js";import"./icon-DN_Kr6gj.js";import"./option-BbIOIz1o.js";import"./optgroup-z_W_Q0Hp.js";import{g as _,x as n,o as P}from"./iframe-CQLe8N1L.js";import{g as t,s as M,c as G,a as F,b as B}from"./component-CK2YjOot.js";import{p as I}from"./PaddingDecorator-C3vechCd.js";import"./class-map-p8Fo2BeQ.js";import"./synergy-element-DdIoChvB.js";import"./icon.component-B288AM4G.js";import"./watch-CEsCE2EF.js";import"./query-DAIS6qJ0.js";import"./animation-registry-l4L8bmT6.js";import"./default-value-TMfUbSRP.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./localize-Dh03wnLC.js";import"./index-DihgwUfS.js";import"./event-B0iVuGLD.js";import"./form-control.custom.styles-_oVXu9iC.js";import"./popup.component-tRf-iCrW.js";import"./if-defined-DJvHqErx.js";import"./scroll-DgKSCJoS.js";import"./decorator-DANECR0-.js";import"./functions-CDi3doZH.js";import"./spinner.component-Dp78_HbX.js";import"./query-assigned-elements-BQ-t-koE.js";import"./divider.component-Qh53Z7H4.js";import"./preload-helper-Ct5FWWRu.js";import"./index-CQ0aEGxp.js";import"./_docs-DXCV3alH.js";var q=Object.freeze,W=Object.defineProperty,E=(o,e)=>q(W(o,"raw",{value:q(o.slice())})),D,z,R;const{userEvent:T}=__STORYBOOK_MODULE_TEST__,{args:k,argTypes:Y}=M("syn-combobox"),{overrideArgs:j}=F("syn-combobox"),{generateTemplate:Q}=G("syn-combobox"),qo={args:k,argTypes:Y,component:"syn-combobox",parameters:{design:_("25272-35634"),docs:{description:{component:t("combobox","default")},story:{height:"250px"}}},tags:["Form","SICK2018"],title:"Components/syn-combobox"},K=["Yellow","Light Green","Grey","Green","Blue","Red","Orange","Magenta","White","Purple","Pink","Black","Brown"].sort(),A=o=>`<syn-option value="${o.replaceAll(" ","_")}">${o}</syn-option>`,s=o=>P(A(o)),N=()=>K.map(A),r=()=>P(N().join(`
`)),a={parameters:{args:j({name:"default",type:"slot",value:`
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>`},k),controls:{disable:!1},docs:{description:{story:t("combobox","default")}}},render:o=>Q({args:o})},i={parameters:{docs:{description:{story:t("combobox","label")}}},render:()=>n`
  ...
  `},v={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:t("combobox","highlight")}}},play:async({canvasElement:o})=>{const e=o.querySelector("syn-combobox");await e.updateComplete,await e.show()},render:()=>{const o=L;return n(D||(D=E([`
