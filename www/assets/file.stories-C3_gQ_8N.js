import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{_ as r,d as i,f as a,p as o}from"./iframe-BJUJk-mP.js";import{t as s}from"./button-DPE3w6y_.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-Dl_LLDeh.js";import{n as m,t as h}from"./taggedTemplateLiteral-pWa2IaV6.js";import{n as g,t as _}from"./PaddingDecorator-DKDp5bXd.js";import{n as v,t as y}from"./decorators-C-ZhSsaX.js";import{t as b}from"./file-CoLaUm48.js";var x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H=e((()=>{b(),s(),n(),y(),f(),a(),_(),r(),m(),{userEvent:x}=__STORYBOOK_MODULE_TEST__,{args:C,argTypes:w}=l(`syn-file`),{overrideArgs:T}=c(`syn-file`),{generateTemplate:E}=d(`syn-file`),D={args:T([],C),argTypes:w,component:`syn-file`,parameters:{chromatic:{modes:o},design:i(`41310-271865`),docs:{description:{component:u(`file`,`default`)}}},tags:[`Form`],title:`Components/syn-file`},O={parameters:{controls:{disable:!1},docs:{description:{story:u(`file`,`default`)}}},render:e=>E({args:e})},k={parameters:{docs:{description:{story:u(`file`,`label`)}}},render:()=>t`
    <syn-file label="This is a label"></syn-file>
  `},A={parameters:{docs:{description:{story:u(`file`,`help-text`)}}},render:()=>t`
    <syn-file
      help-text="This is a help text."
      label="This is a label"
    ></syn-file>
  `},j={parameters:{docs:{description:{story:u(`file`,`multiple`)}}},render:()=>t`
    <syn-file
      label="Multiple file input"
      multiple
    ></syn-file>
  `},M={parameters:{docs:{description:{story:u(`file`,`hide-value`)}}},render:()=>t`
    <syn-file
      hide-value
      label="This is a label"
    ></syn-file>
  `},N={decorators:[g()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`file`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-file`);t&&t.focus()},render:()=>t`
    <syn-file label="This is a label" help-text="This is a help text" droparea></syn-file>
  `},P={parameters:{docs:{description:{story:u(`file`,`disabled`)}}},render:()=>t`
...
`},F={parameters:{docs:{description:{story:u(`file`,`readonly`)}}},render:()=>t`
    <div style="display: flex; flex-direction: column; gap: 1rem;">
      <syn-file
        readonly
        label="This is a label"
...
`},I={parameters:{docs:{description:{story:u(`file`,`sizes`)}}},render:()=>t`
  ...
  `},L={decorators:[v],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`file`,`invalid`)}}},play:async({canvasElement:e})=>{try{let t=e.querySelector(`form`),n=t.querySelectorAll(`syn-file`),r=t.querySelector(`syn-button`);r&&n&&(await x.click(r),r.click())}catch(e){console.error(`Error in play function:`,e)}},render:()=>t(S||=h([`
    <syn-file
    ...
    <\/script>
  `]))},R={parameters:{docs:{description:{story:u(`file`,`droparea`)}}},render:()=>t`
    <div style="display: flex; flex-direction: column; gap: var(--syn-spacing-large);">
      <syn-file
  ...
  `},z={parameters:{docs:{description:{story:u(`file`,`directory`)}}},render:()=>t`
    <div style="display: flex; flex-direction: column; gap: var(--syn-spacing-large);">
      <syn-file
        label="Button"
        webkitdirectory
