import{g as u}from"./preview-BVTXUN5H.js";import{k as a}from"./lit-element-BsyMe9HG.js";import{s as h,a as g,g as e,b as v,c as b}from"./component-Om_InD10.js";import"./index-B-o1Wr-g.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon.component-ajC_-Lh1.js";import"./directive-helpers-DUpkUCIH.js";import"./icon-button-JZu-59Z4.js";import"./icon-B81SkXQp.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-D8vHI8_K.js";var m=Object.freeze,f=Object.defineProperty,S=(r,y)=>m(f(r,"raw",{value:m(r.slice())})),d;const{args:k,argTypes:A}=h("syn-header"),{overrideArgs:w}=b("syn-header"),{generateTemplate:N}=g("syn-header"),O={args:w([{name:"label",type:"slot",value:'<span slot="label">App Name</span>'}],k),argTypes:A,component:"syn-header",parameters:{design:u("10540-8605"),docs:{description:{component:e("header","default")}}},title:"Components/syn-header"},t={parameters:{controls:{disable:!1},docs:{description:{story:e("header","default")}}},render:r=>N({args:r})},o={parameters:{docs:{description:{story:e("header","label")}}},render:()=>a`
  ...
  `},c={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:e("header","focus")}}},play:({canvasElement:r})=>{r.querySelector("a")?.focus()},render:()=>a`
    <style>
  ...
  `},i={parameters:{docs:{description:{story:e("header","navigation")}}},render:()=>a(d||(d=S([`
    ...
    <\/script>
  `])))},l={parameters:{docs:{description:{story:e("header","burger-menu")}}},render:()=>a`
    <syn-header burger-menu="closed" label="App Name">
    </syn-header>
  `},p=v({Default:t,Label:o,Logo:n,MetaNavigation:s,Navigation:i,BurgerMenu:l},{heightPx:200});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  \`
} as Story`,...n.parameters?.docs?.source}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  parameters: {
    chromatic: {
  ...
  heightPx: 200
})`,...p.parameters?.docs?.source}}};const B=["Default","Label","Logo","Focus","MetaNavigation","Navigation","BurgerMenu","Screenshot"];export{l as BurgerMenu,t as Default,c as Focus,o as Label,n as Logo,s as MetaNavigation,i as Navigation,p as Screenshot,B as __namedExportsOrder,O as default};
