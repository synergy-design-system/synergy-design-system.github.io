import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{c as t,h as n,n as r,t as i}from"./lit-D4-0ovri.js";import{C as a,f as o,g as ee,p as te,x as ne}from"./library-BTrITrk7.js";import{d as s,l as c,s as l}from"./synergy-element-Di-hMrpy.js";import{n as re}from"./event-options-CDwceuuz.js";import{t as u}from"./query-DOHNhzf6.js";import{n as ie}from"./query-assigned-elements-CWXdehfi.js";import{r as d,t as ae}from"./if-defined-BN5mMhH6.js";import{n as f,t as p}from"./class-map-LsJiuvgY.js";function m(e,t){let n={waitUntilFirstUpdate:!1,...t};return(t,r)=>{let{update:i}=t,a=Array.isArray(e)?e:[e];t.update=function(e){a.forEach(t=>{let i=t;if(e.has(i)){let t=e.get(i),a=this[i];t!==a&&(!n.waitUntilFirstUpdate||this.hasUpdated)&&this[r](t,a)}}),i.call(this,e)}}}function oe(){return(oe=e((()=>{})))()}var h;function g(){return(g=e((()=>{i(),h=n`
  :host {
...
`})))()}var k,A,De,j,M;function N(){return(N=e((()=>{Te(),O(),g(),T(),S(),i(),ne(),l(),k=Symbol(),A=Symbol(),j=new Map,M=class extends w{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label=``,this.library=`default`}async resolveIcon(e,n){let r;if(n?.spriteSheet)return this.svg=t`<svg part="svg">
        <use part="use" href="${e}" width="100%" height="100%"></use>
      </svg>`,this.svg;if(this.library===`system`){if(!e)return k;r=new Response(e,{status:200})}else try{if(r=await fetch(e,{mode:`cors`}),!r.ok)return r.status===410?k:A}catch{return A}try{let e=document.createElement(`div`);e.innerHTML=await r.text();let t=e.firstElementChild;if(t?.tagName?.toLowerCase()!==`svg`)return k;De||=new DOMParser;let n=De.parseFromString(t.outerHTML,`text/html`).body.querySelector(`svg`);return n?(n.part.add(`svg`),document.adoptNode(n)):k}catch{return k}}connectedCallback(){super.connectedCallback(),xe(this)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),Se(this)}getIconSource(){let e=Ce(this.library);return this.name&&e?{url:e.resolver(this.name),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){typeof this.label==`string`&&this.label.length>0?(this.setAttribute(`role`,`img`),this.setAttribute(`aria-label`,this.label),this.removeAttribute(`aria-hidden`)):(this.removeAttribute(`role`),this.removeAttribute(`aria-label`),this.setAttribute(`aria-hidden`,`true`))}async setIcon(){let{url:e,fromLibrary:t}=this.getIconSource(),n=t?Ce(this.library):void 0;if(!e){this.svg=null;return}let r=j.get(e);if(r||(r=this.resolveIcon(e,n),j.set(e,r)),!this.initialRender)return;let i=await r;if(i===A&&j.delete(e),e===this.getIconSource().url){if(a(i)){if(this.svg=i,n){await this.updateComplete;let e=this.shadowRoot.querySelector(`[part='svg']`);typeof n.mutator==`function`&&e&&n.mutator(e)}return}switch(i){case A:case k:this.svg=null,this.emit(`syn-error`);break;default:this.svg=i.cloneNode(!0),n?.mutator?.(this.svg),this.emit(`syn-load`)}}}render(){return this.svg}},M.styles=[h,Ee],_([c()],M.prototype,`svg`,2),_([s({reflect:!0})],M.prototype,`name`,2),_([s()],M.prototype,`src`,2),_([s()],M.prototype,`label`,2),_([s({reflect:!0})],M.prototype,`library`,2),_([m(`label`)],M.prototype,`handleLabelChange`,1),_([m([`name`,`src`,`library`])],M.prototype,`setIcon`,1)})))()}var Oe,P,ke;function Ae(){return(Ae=e((()=>{Oe={autoClamp:!1,noStepAlign:!1,noStepValidation:!1},P={autoClamp:!0,noStepAlign:!0,noStepValidation:!0},ke=(e={})=>({...Oe,...e})})))()}var je,Me;function Ne(){return(Ne=e((()=>{Ae(),je={delimiter:{SynCombobox:` `,SynOption:` `,SynSelect:` `},numericStrategy:{SynInput:P},size:{SynAccordion:`medium`,SynAlert:`medium`,SynButton:`medium`,SynButtonGroup:`medium`,SynCheckbox:`medium`,SynCheckboxGroup:`medium`,SynCombobox:`medium`,SynDetails:`medium`,SynFile:`medium`,SynIconButton:`inherit`,SynInput:`medium`,SynPagination:`medium`,SynRadio:`medium`,SynRadioButton:`medium`,SynRadioGroup:`medium`,SynRange:`medium`,SynSelect:`medium`,SynSwitch:`medium`,SynTag:`medium`,SynTagGroup:`medium`,SynTextarea:`medium`},variant:{SynAlert:`primary`,SynBadge:`primary`,SynButton:`outline`,SynButtonGroup:`outline`,SynPagination:`full`,SynSideNav:`default`,SynValidate:`native`}},Me={delimiter:{SynCombobox:` `,SynOption:` `,SynSelect:` `},numericStrategy:{SynInput:P},size:{SynAccordion:`medium`,SynAlert:`medium`,SynButton:`medium`,SynButtonGroup:`medium`,SynCheckbox:`medium`,SynCheckboxGroup:`medium`,SynCombobox:`medium`,SynDetails:`medium`,SynFile:`medium`,SynIconButton:`inherit`,SynInput:`medium`,SynPagination:`medium`,SynRadio:`medium`,SynRadioButton:`medium`,SynRadioGroup:`medium`,SynRange:`medium`,SynSelect:`medium`,SynSwitch:`medium`,SynTag:`medium`,SynTagGroup:`medium`,SynTextarea:`medium`},variant:{SynAlert:`primary`,SynBadge:`primary`,SynButton:`outline`,SynButtonGroup:`outline`,SynPagination:`full`,SynSideNav:`default`,SynValidate:`native`}}})))()}var Pe,Fe,F,Ie,Le,Re;function ze(){return(ze=e((()=>{Ne(),Pe=!1,Fe=new Map,F=new Set,Ie=e=>{Pe&&!F.has(e)&&F.add(e)},Le=e=>{F.has(e)&&F.delete(e)},Re=(e,t=`default`)=>{let n=t==="default"?je:Me;if(t==="default"){let t=Fe.get(e);if(t!==void 0)return t}let r=Object.entries(n).reduce((t,[n,r])=>{let i=r[e];return i&&(t[n]=i),t},{});return t==="default"&&Fe.set(e,r),r}})))()}function Be(e){return t=>{var n,r,i,a,o=class extends t{constructor(...t){super(...t),b(this,n,!1),b(this,r,new Map),b(this,i,[]),b(this,a),this._isInitialized=!1,this._isInitialized=!0,x(this,a,Re(e,`initial`))}get __originalDecoratedClassName(){return e}overrideGlobalSettings(e){e.forEach(e=>{y(this,r).has(e.attribute)&&(this[e.attribute]=e.newValue)})}disconnectedCallback(){super.disconnectedCallback(),Le(this)}requestUpdate(e,t,r){super.requestUpdate(e,t,r),this._isInitialized&&!y(this,n)&&e&&e in y(this,a)&&!y(this,i)?.includes(e)&&y(this,i).push(e)}willUpdate(t){if(super.willUpdate(t),y(this,n))return;x(this,n,!0);let o=Re(e);Object.entries(o).forEach(([e,t])=>{let n=this[e];n===y(this,a)[e]&&!y(this,i).includes(e)&&(y(this,r).set(e,n),this[e]=t)}),y(this,r).size>0&&Ie(this)}};return n=new WeakMap,r=new WeakMap,i=new WeakMap,a=new WeakMap,o}}function Ve(){return(Ve=e((()=>{ze(),S()})))()}function He(){We&&(z=document.documentElement.dir||`ltr`,B=document.documentElement.lang||navigator.language),[...I.keys()].forEach(e=>{typeof e.requestUpdate==`function`&&e.requestUpdate()})}function Ue(...e){e.forEach(e=>{let t=e.$code.toLowerCase();L.has(t)?L.set(t,{...L.get(t),...e}):L.set(t,e),R||=e}),He()}var I,L,R,z,B,We,Ge;function V(){return(V=e((()=>{if(I=new Set,L=new Map,z=`ltr`,B=`en`,We=typeof MutationObserver<`u`&&typeof document<`u`&&document.documentElement!==void 0,We){let e=new MutationObserver(He);z=document.documentElement.dir||`ltr`,B=document.documentElement.lang||navigator.language,e.observe(document.documentElement,{attributeFilter:[`dir`,`lang`],attributes:!0})}Ge=class{constructor(e){this.host=e,this.host.addController(this)}hostConnected(){I.add(this.host)}hostDisconnected(){I.delete(this.host)}dir(){return`${this.host.dir||z}`.toLowerCase()}lang(){return`${this.host.lang||B}`.toLowerCase()}getTranslationData(e){let t=new Intl.Locale(e.replace(/_/g,`-`)),n=t?.language.toLowerCase(),r=t?.region?.toLowerCase()??``;return{language:n,locale:t,primary:L.get(`${n}-${r}`),region:r,secondary:L.get(n)}}exists(e,t){let{primary:n,secondary:r}=this.getTranslationData(t.lang??this.lang()),i={ignoreFallback:!1,...t};return!!(n&&n[e]||r&&r[e]||i.includeFallback&&R&&R[e])}term(e,...t){let{primary:n,secondary:r}=this.getTranslationData(this.lang()),i;if(n&&n[e])i=n[e];else if(r&&r[e])i=r[e];else if(R&&R[e])i=R[e];else return console.error(`No translation found for: ${String(e)}`),String(e);return typeof i==`function`?i(...t):i}date(e,t){let n=new Date(e);return new Intl.DateTimeFormat(this.lang(),t).format(n)}number(e,t){let n=Number(e);return isNaN(n)?``:new Intl.NumberFormat(this.lang(),t).format(n)}relativeTime(e,t,n){return new Intl.RelativeTimeFormat(this.lang(),n).format(e,t)}}})))()}var Ke,qe;function H(){return(H=e((()=>{V(),Ke={$code:`en`,$name:`English`,$dir:`ltr`,clearEntry:`Clear entry`,close:`Close`,hidePassword:`Hide password`,loading:`Loading`,numOptionsSelected:e=>e===0?`No options selected`:e===1?`1 option selected`:`${e} options selected`,progress:`Progress`,remove:`Remove`,scrollToEnd:`Scroll to end`,scrollToStart:`Scroll to start`,showPassword:`Show password`,closeMenu:`Close menu`,critical:`Critical`,danger:`Danger`,error:`Error`,fileButtonText:`Select file`,fileButtonTextMultiple:`Select files`,fileDragDrop:`Drop or select file`,folderButtonText:`Select folder`,folderDragDrop:`Drop or select folder`,menu:`Menu`,noResults:`No results found`,notification:`Notification`,numFilesSelected:(e,t)=>e===0?`No ${t?`folders`:`files`} chosen`:`${e} ${t?`folders`:`files`} chosen`,openMenu:`Open menu`,paginationFirstPage:`First page`,paginationInputLabel:`Select page`,paginationItemsPerPage:`Items per page`,paginationItemSummary:(e,t,n)=>`${e}-${t} of ${n} items`,paginationLastPage:`Last page`,paginationNextPage:`Next page`,paginationOfTotalPages:e=>`of ${e}`,paginationPreviousPage:`Previous page`,rangeMax:`Maximum`,rangeMin:`Minimum`,sideNav:`Page navigation`,sideNavHide:`Hide navigation`,sideNavShow:`Show navigation`,success:`Success`,warning:`Warning`},Ue(Ke),qe=Ke})))()}var U;function W(){return(W=e((()=>{H(),V(),U=class extends Ge{},Ue(qe)})))()}var Je;function Ye(){return(Ye=e((()=>{i(),Je=n`
	/* stylelint-disable */
  :host {
    display: contents;
  }
`})))()}var G;function Xe(){return(Xe=e((()=>{Ye(),g(),T(),S(),i(),l(),G=class extends w{constructor(){super(...arguments),this.observedElements=[],this.disabled=!1}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{this.emit(`syn-resize`,{detail:{entries:e}})}),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}handleSlotChange(){this.disabled||this.startObserver()}startObserver(){let e=this.shadowRoot.querySelector(`slot`);if(e!==null){let t=e.assignedElements({flatten:!0});this.observedElements.forEach(e=>this.resizeObserver.unobserve(e)),this.observedElements=[],t.forEach(e=>{this.resizeObserver.observe(e),this.observedElements.push(e)})}}stopObserver(){this.resizeObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}render(){return t` <slot @slotchange=${this.handleSlotChange}></slot> `}},G.styles=[h,Je],_([s({type:Boolean,reflect:!0})],G.prototype,`disabled`,2),_([m(`disabled`,{waitUntilFirstUpdate:!0})],G.prototype,`handleDisabledChange`,1)})))()}function Ze(e,t){return{top:Math.round(e.getBoundingClientRect().top-t.getBoundingClientRect().top),left:Math.round(e.getBoundingClientRect().left-t.getBoundingClientRect().left)}}function Qe(e,t,n=`vertical`,r=`smooth`){let i=Ze(e,t),a=i.top+t.scrollTop,o=i.left+t.scrollLeft,ee=t.scrollLeft,te=t.scrollLeft+t.offsetWidth,ne=t.scrollTop,s=t.scrollTop+t.offsetHeight;(n===`horizontal`||n===`both`)&&(o<ee?t.scrollTo({left:o,behavior:r}):o+e.clientWidth>te&&t.scrollTo({left:o-t.offsetWidth+e.clientWidth,behavior:r})),(n===`vertical`||n===`both`)&&(a<ne?t.scrollTo({top:a,behavior:r}):a+e.clientHeight>s&&t.scrollTo({top:a-t.offsetHeight+e.clientHeight,behavior:r}))}function $e(){return($e=e((()=>{})))()}var et;function tt(){return(tt=e((()=>{i(),et=n`
...
`})))()}var nt;function rt(){return(rt=e((()=>{i(),nt=n`
	/* stylelint-disable */
  :host {
...
`})))()}var it;function K(){return(K=e((()=>{i(),it=n`
  :host {
...
`})))()}var q;function J(){return(J=e((()=>{K(),N(),Ve(),g(),T(),S(),p(),o(),ae(),l(),q=class extends w{constructor(){super(...arguments),this.hasFocus=!1,this.label=``,this.size=`inherit`,this.color=`currentColor`,this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){let e=!!this.href,t=e?te`a`:te`button`;return ee`
    ...
    `}},Y.styles=[h,nt,et],Y.dependencies={"syn-icon-button":q,"syn-resize-observer":G},_([ie({slot:`nav`,selector:`syn-tab`})],Y.prototype,`tabs`,2),_([ie({selector:`syn-tab-panel`})],Y.prototype,`panels`,2),_([u(`.tab-group`)],Y.prototype,`tabGroup`,2),_([u(`.tab-group__body`)],Y.prototype,`body`,2),_([u(`.tab-group__nav`)],Y.prototype,`nav`,2),_([u(`.tab-group__indicator`)],Y.prototype,`indicator`,2),_([c()],Y.prototype,`hasScrollControls`,2),_([c()],Y.prototype,`shouldHideScrollStartButton`,2),_([c()],Y.prototype,`shouldHideScrollEndButton`,2),_([s()],Y.prototype,`placement`,2),_([s()],Y.prototype,`activation`,2),_([s({attribute:`no-scroll-controls`,type:Boolean})],Y.prototype,`noScrollControls`,2),_([s({type:Boolean})],Y.prototype,`contained`,2),_([s({type:Boolean})],Y.prototype,`sharp`,2),_([s({attribute:`fixed-scroll-controls`,type:Boolean})],Y.prototype,`fixedScrollControls`,2),_([re({passive:!0})],Y.prototype,`updateScrollButtons`,1),_([m(`noScrollControls`,{waitUntilFirstUpdate:!0})],Y.prototype,`updateScrollControls`,1),_([m(`placement`,{waitUntilFirstUpdate:!0})],Y.prototype,`syncIndicator`,1)})))()}function ct(){return(ct=e((()=>{st(),Y.define(`syn-tab-group`)})))()}function lt(){return(lt=e((()=>{ct(),st(),Xe(),Ye(),tt(),rt(),J(),K(),N(),O(),W(),H(),V(),g(),T()})))()}var ut;function dt(){return(dt=e((()=>{i(),ut=n`
  :host {
...
`})))()}var ft;function pt(){return(pt=e((()=>{i(),ft=n`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
`})))()}var mt,X;function Z(){return(Z=e((()=>{dt(),pt(),J(),W(),g(),T(),S(),p(),i(),l(),mt=0,X=class extends w{constructor(){super(...arguments),this.localize=new U(this),this.attrId=++mt,this.componentId=`syn-tab-${this.attrId}`,this.panel=``,this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`tab`)}handleCloseClick(e){e.stopPropagation(),this.emit(`syn-close`)}handleActiveChange(){this.setAttribute(`aria-selected`,this.active?`true`:`false`)}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled?`true`:`false`),this.tabIndex=this.disabled&&!this.active?-1:0}render(){return this.id=this.id.length>0?this.id:this.componentId,t`
      <div
        part="base"
    ...
    `}},X.styles=[h,ft,ut],X.dependencies={"syn-icon-button":q},_([u(`.tab`)],X.prototype,`tab`,2),_([s({reflect:!0})],X.prototype,`panel`,2),_([s({type:Boolean,reflect:!0})],X.prototype,`active`,2),_([s({type:Boolean,reflect:!0})],X.prototype,`closable`,2),_([s({type:Boolean,reflect:!0})],X.prototype,`disabled`,2),_([s({type:Number,reflect:!0})],X.prototype,`tabIndex`,2),_([m(`active`)],X.prototype,`handleActiveChange`,1),_([m(`disabled`)],X.prototype,`handleDisabledChange`,1)})))()}function ht(){return(ht=e((()=>{Z(),X.define(`syn-tab`)})))()}function gt(){return(gt=e((()=>{ht(),Z(),dt(),pt(),J(),K(),N(),O(),W(),H(),V(),g(),T()})))()}var _t;function vt(){return(vt=e((()=>{i(),_t=n`
  /* Write custom CSS here */
  .tab-panel {
    color: var(--syn-typography-color-text);
  }
`})))()}var yt;function bt(){return(bt=e((()=>{i(),yt=n`
	/* stylelint-disable */
  :host {
    --padding: 0;
...
`})))()}var xt,Q;function $(){return($=e((()=>{vt(),bt(),g(),T(),S(),p(),i(),l(),xt=0,Q=class extends w{constructor(){super(...arguments),this.attrId=++xt,this.componentId=`syn-tab-panel-${this.attrId}`,this.name=``,this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute(`role`,`tabpanel`)}handleActiveChange(){this.setAttribute(`aria-hidden`,this.active?`false`:`true`)}render(){return t`
      <slot
        part="base"
        class=${f({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}},Q.styles=[h,yt,_t],_([s({reflect:!0})],Q.prototype,`name`,2),_([s({type:Boolean,reflect:!0})],Q.prototype,`active`,2),_([m(`active`)],Q.prototype,`handleActiveChange`,1)})))()}function St(){return(St=e((()=>{$(),Q.define(`syn-tab-panel`)})))()}function Ct(){return(Ct=e((()=>{St(),$(),vt(),bt(),g(),T()})))()}export{x as C,oe as D,g as E,m as O,ue as S,h as T,w as _,W as a,b,Be as c,Ae as d,P as f,O as g,N as h,U as i,Ve as l,M as m,gt as n,H as o,Oe as p,lt as r,V as s,Ct as t,ke as u,T as v,S as w,y as x,_ as y};