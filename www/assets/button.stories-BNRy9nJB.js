import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{a as t,d as n,o as r,s as i}from"./preview-DXkhgu0Z.js";import{c as a,t as o}from"./lit-BfcklOOD.js";import{t as s}from"./button-DVR7vfNM.js";import{t as c}from"./icon-koM57tMi.js";import{a as l,i as u,n as d,o as f,r as p,t as m}from"./component-B0n0ooCL.js";import{n as h,t as g}from"./PaddingDecorator-B8dy7wkX.js";var _,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F=e((()=>{s(),c(),o(),p(),r(),g(),n(),{args:_,argTypes:v}=u(`syn-button`),{overrideArgs:y}=l(`syn-button`),{generateTemplate:b}=f(`syn-button`),x={args:y({name:`default`,type:`slot`,value:`Default`},_),argTypes:v,component:`syn-button`,parameters:{chromatic:{modes:i},design:t(`42076-167749`),docs:{description:{component:d(`button`,`default`)}}},tags:[`Form`,`Navigation`],title:`Components/syn-button`},S={parameters:{controls:{disable:!1},docs:{description:{story:d(`button`,`default`)}}},render:e=>b({args:e})},C={parameters:{docs:{description:{story:d(`button`,`variant`)}}},render:()=>a`
  ...
  `},w={parameters:{docs:{description:{story:d(`button`,`size`)}}},render:()=>a`
  ...
  `},T={decorators:[h()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:d(`button`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-button`);t&&t.focus()},render:()=>a`<syn-button>Default</syn-button>`},E={parameters:{docs:{description:{story:d(`button`,`link`)}}},render:()=>a`
    <div style="display: flex; flex-direction: row; gap: var(--syn-spacing-large);">
  ...
  `},D={parameters:{docs:{description:{story:d(`button`,`width`)}}},render:()=>a`
  ...
  `},O={parameters:{docs:{description:{story:d(`button`,`icon-only`)}}},render:()=>a`
  ...
  `},k={parameters:{docs:{description:{story:d(`button`,`prefix-suffix`)}}},render:()=>a`
    <div style="display: flex; flex-direction: column; gap: var(--syn-spacing-large);">
      <div style="display: flex; flex-direction: row; gap: var(--syn-spacing-large);">
        <syn-button size="small">
  ...
  `},A={parameters:{docs:{description:{story:d(`button`,`caret`)}}},render:()=>a`
    <div style="align-items: anchor-center; display: flex; flex-direction: row; gap: var(--syn-spacing-large);">
  ...
  `},j={parameters:{docs:{description:{story:d(`button`,`loading`)}}},render:()=>a`
    <div style="display: flex; flex-direction: row; gap: var(--syn-spacing-large);">
  ...
  `},M={parameters:{docs:{description:{story:d(`button`,`disabled`)}}},render:()=>a`
    <div style="display: flex; flex-direction: row; gap: var(--syn-spacing-large);">
