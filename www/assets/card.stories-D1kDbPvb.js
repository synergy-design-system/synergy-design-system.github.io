import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{_ as t,a as n,d as r,o as i,s as a,y as o}from"./preview-CW-x0Dg3.js";import{c as s,t as c}from"./lit-BfcklOOD.js";import{t as l}from"./button-uOW8jMcR.js";import{t as u}from"./card-DCe4tnBE.js";import{a as d,i as f,n as p,o as m,r as h,t as g}from"./component-OsM0xRkW.js";import{t as _}from"./icon-button-BVpyRrcj.js";var v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N=e((()=>{c(),t(),u(),l(),_(),h(),i(),r(),{args:v,argTypes:y}=f(`syn-card`),{overrideArgs:b}=d(`syn-card`),{generateTemplate:x}=m(`syn-card`),S=({buttonText:e=`More info`,footerText:t=`Optional information`}={})=>`
  <footer slot="footer">
    <small>${t}</small>
    <nav>
...
`,C={args:b([{name:`image`,type:`slot`,value:`<img slot="image" src="https://synergy-design-system.github.io/card-example.jpg" alt="Multiple persons having lunch in SICK Academy" />`},{name:`default`,type:`slot`,value:`
      ...
      `},{name:`footer`,type:`slot`,value:S()}],v),argTypes:y,component:`syn-card`,parameters:{chromatic:{modes:a},design:n(`42207-351610`),docs:{description:{component:p(`card`,`default`)}}},tags:[`Structure`],title:`Components/syn-card`},w={parameters:{controls:{disable:!1},docs:{description:{story:p(`card`,`default`)}}},render:e=>x({args:e})},T={parameters:{docs:{description:{story:p(`card`,`basic-card`)}}},render:()=>s`
  ...
  `},E={parameters:{docs:{description:{story:p(`card`,`with-header`)}}},render:()=>s`
  ...
  `},D={parameters:{docs:{description:{story:p(`card`,`with-footer`)}}},render:()=>s`
    <syn-card class="card-footer">
      This card has a footer. You can put all sorts of things in it!
      ${o(S({buttonText:`Preview`,footerText:`Optional information`}))}
    </syn-card>
  ...
  `},O={parameters:{docs:{description:{story:p(`card`,`images`)}}},render:()=>s`
  ...
  `},k={parameters:{docs:{description:{story:p(`card`,`sharp`)}}},render:()=>s`
  ...
  `},A={parameters:{docs:{description:{story:p(`card`,`shadow`)}}},render:()=>s`
