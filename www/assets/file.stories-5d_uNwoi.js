...
`},b={parameters:{docs:{description:{story:d("file","sizes")}}},render:()=>i`
  ...
  `},w=X({Default:u,Label:f,HelpText:y,Multiple:m,HideValue:h,Disabled:g,Sizes:b,Invalid:v,Droparea:x,Directory:S},750);u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
...
} as Story`,...u.parameters?.docs?.source}}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
  ...
  render: () => html\`
    <syn-file label="This is a label"></syn-file>
  \`
} as Story`,...f.parameters?.docs?.source}}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
