import{w as _,x as S,T as z,i as g}from"./directive-helpers-dXnBnwbo.js";import{c as w,a as x,S as T,b as E,n as b}from"./icon.component-0RmXMwT2.js";/**
 * @license
 ...
 */const p=Symbol.for(""),B=e=>{if(e?.r===p)return e?._$litStatic$},V=e=>({_$litStatic$:e,r:p}),v=(e,...t)=>({_$litStatic$:t.reduce((r,o,n)=>r+(i=>{if(i._$litStatic$!==void 0)return i._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${i}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(o)+e[n+1],e[0]),r:p}),m=new Map,F=e=>(t,...r)=>{const o=r.length;let n,i;const s=[],h=[];let c,u=0,f=!1;for(;u<o;){for(c=t[u];u<o&&(i=r[u],(n=B(i))!==void 0);)c+=n+t[++u],f=!0;u!==o&&h.push(i),s.push(c),u++}if(u===o&&s.push(t[o]),f){const y=s.join("$$lit$$");(t=m.get(y))===void 0&&(s.raw=s,m.set(y,t=s)),r=h}return e(t,...r)},P=F(S);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const d=e=>e??z;/**
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function R(e,t){return(r,o,n)=>{const i=s=>s.renderRoot?.querySelector(e)??null;if(t){const{get:s,set:h}=typeof o=="object"?r:n??(()=>{const c=Symbol();return{get(){return this[c]},set(u){this[c]=u}}})();return $(r,o,{get(){if(t){let c=s.call(this);return c===void 0&&(c=i(this),h.call(this,c)),c}return i(this)}})}return $(r,o,{get(){return i(this)}})}}const k=g`
  .icon-button {
    color: currentColor;
    font-size: inherit;
  }
...
`;var U=Object.defineProperty,D=Object.getOwnPropertyDescriptor,l=(e,t,r,o)=>{for(var n=o>1?void 0:o?D(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(n=(o?s(t,r,n):s(n))||n);return o&&n&&U(t,r,n),n};class a extends x{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.size="inherit",this.color="currentColor",this.disabled=!1}static{this.styles=I}static{this.dependencies={"syn-icon":T}}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleClick(t){this.disabled&&(t.preventDefault(),t.stopPropagation())}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}render(){const t=!!this.href,r=t?v`a`:v`button`;return P`
    ...
    `}}l([R(".icon-button")],a.prototype,"button",2);l([E()],a.prototype,"hasFocus",2);l([b()],a.prototype,"name",2);l([b()],a.prototype,"library",2);l([b()],a.prototype,"src",2);l([b()],a.prototype,"href",2);l([b()],a.prototype,"target",2);l([b()],a.prototype,"download",2);l([b()],a.prototype,"label",2);l([b({reflect:!0})],a.prototype,"size",2);l([b({reflect:!0})],a.prototype,"color",2);l([b({type:Boolean,reflect:!0})],a.prototype,"disabled",2);a.define("syn-icon-button");export{a as S,V as a,O as b,R as c,j as e,C as i,P as n,d as o,v as s,A as t};
