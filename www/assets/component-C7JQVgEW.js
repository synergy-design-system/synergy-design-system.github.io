var Dn=Object.freeze,Ki=Object.defineProperty;var In=(t,e)=>Dn(Ki(t,"raw",{value:Dn(e||t.slice())}));import{n as r,c as f,f as ti,s as ue,u as T,e as u,b as y,o as b,i as kt,t as Gi}from"./library-BeKtmk-e.js";import{i as h,x as c,E as ni,u as Nn,B as Yi,T as Xi}from"./directive-helpers-Dvm_Ferq.js";import{a as Dt,k as ii,r as ai,L as Ji,l as Ct,b as Qi,c as Zi,d as An,f as ea,s as ta,e as na,p as nn,g as ia,h as aa,o as oi,m as oa,n as sa,j as ra,i as la,t as da}from"./ref-mC-OfJbg.js";import{s as ca}from"./chunk-L4EGOTBX-Boit2UGA.js";import"./entry-preview-DkJqm5dP.js";import{c as x,w as m,S as w,e as ie,a as ut,b as ye,d as pa}from"./icon-button-DSvkANI_.js";import{d as ha}from"./index-DrFu-skq.js";import"./index-_2TAQcTa.js";import{a as ua}from"./index-Co-BzvLd.js";const ma=h`
  :host {
    display: block;
  }
...
`;var fa=Object.defineProperty,ya=Object.getOwnPropertyDescriptor,ot=(t,e,n,i)=>{for(var a=i>1?void 0:i?ya(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&fa(e,n,a),a};let Me=class extends w{constructor(){super(...arguments),this.closeOthers=!1,this.contained=!1,this.size="medium",this.handleAccordionShow=t=>{this.closeOthers&&this.detailsInDefaultSlot.forEach(e=>{e!==t.target&&e.parentNode===t.target.parentNode&&e.removeAttribute("open")})}}adjustDetailsSize(){this.detailsInDefaultSlot.forEach(t=>{t.setAttribute("size",this.size)})}adjustDetailsContained(){this.detailsInDefaultSlot.forEach(t=>{t.contained=this.contained})}handleSizeChange(){this.adjustDetailsSize()}handleContainedChange(){this.adjustDetailsContained()}connectedCallback(){super.connectedCallback(),this.addEventListener("syn-show",this.handleAccordionShow)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("syn-show",this.handleAccordionShow)}handleSlotChange(){this.adjustDetailsSize(),this.adjustDetailsContained()}render(){return c`
      <div 
        part="base"
        class=${f({accordion:!0,"accordion--contained":this.contained})}>
        <slot @slotchange=${this.handleSlotChange}></slot>
      </div>
    `}};Me.styles=[x,ma];ot([Dt({selector:"syn-details"})],Me.prototype,"detailsInDefaultSlot",2);ot([r({attribute:"close-others",type:Boolean})],Me.prototype,"closeOthers",2);ot([r({reflect:!0,type:Boolean})],Me.prototype,"contained",2);ot([r({reflect:!0})],Me.prototype,"size",2);ot([m("size",{waitUntilFirstUpdate:!0})],Me.prototype,"handleSizeChange",1);ot([m("contained",{waitUntilFirstUpdate:!0})],Me.prototype,"handleContainedChange",1);Me=ot([ie("SynAccordion")],Me);Me.define("syn-accordion");class ba extends ii{host;element;prevData={};render(e){return ni}update(e,[n]){this.element!==e.element&&(this.element=e.element),this.host=e.options?.host||this.element,this.apply(n),this.groom(n),this.prevData={...n}}apply(e){if(!e)return;const{prevData:n,element:i}=this;for(const a in e){const o=e[a];o!==n[a]&&Ut(i,a,o)}}groom(e){const{prevData:n,element:i}=this;if(n)for(const a in n)(!e||!(a in e)&&i[a]===n[a])&&Ut(i,a,void 0)}}class ga extends ba{eventData={};apply(e){if(e)for(const n in e){const i=e[n];i!==this.eventData[n]&&this.applyEvent(n,i)}}applyEvent(e,n){const{prevData:i,element:a}=this;this.eventData[e]=n,i[e]&&a.removeEventListener(e,this,n),a.addEventListener(e,this,n)}groom(e){const{prevData:n,element:i}=this;if(n)for(const a in n)(!e||!(a in e)&&i[a]===n[a])&&this.groomEvent(a,n[a])}groomEvent(e,n){const{element:i}=this;delete this.eventData[e],i.removeEventListener(e,this,n)}handleEvent(e){const n=this.eventData[e.type];typeof n=="function"?n.call(this.host,e):n.handleEvent(e)}disconnected(){const{eventData:e,element:n}=this;for(const i in e){const a=i.slice(1),o=e[i];n.removeEventListener(a,this,o)}}reconnected(){const{eventData:e,element:n}=this;for(const i in e){const a=i.slice(1),o=e[i];n.addEventListener(a,this,o)}}}class va extends ga{apply(e){if(!e)return;const{prevData:n,element:i}=this;for(const a in e){const o=e[a];if(o===n[a])continue;const s=a.slice(1);switch(a[0]){case"@":this.eventData[s]=o,this.applyEvent(s,o);break;case".":Ut(i,s,o);break;case"?":o?i.setAttribute(s,""):i.removeAttribute(s);break;default:o?i.setAttribute(a,String(o)):i.removeAttribute(a);break}}}groom(e){const{prevData:n,element:i}=this;if(n)for(const a in n){const o=a.slice(1);if(!e||!(a in e)&&i[o]===n[a])switch(a[0]){case"@":this.groomEvent(o,n[a]);break;case".":Ut(i,o,void 0);break;case"?":i.removeAttribute(o);break;default:i.removeAttribute(a);break}}}}function Ut(t,e,n){try{t[e]=n}catch{console.warn(`Could not set property "${e}" on ${t.tagName} because it has no "setter".`)}}const wa=ti(va);let ht={};setTimeout(()=>{ht=globalThis?.__WC_STORYBOOK_HELPERS_CONFIG__||{}});function si(t,e){return e.modules?.find(i=>i.declarations?.some(a=>a.tagName===t))?.declarations.find(i=>i.kind==="class"&&i.tagName===t)}function hn(t,e=!0){const n={};return t?.members?.forEach(i=>{if(i.kind!=="field")return;const a=t.attributes?.find(C=>i.name===C.fieldName),o=i.name;if(n[o]={name:o,table:{disable:!0}},i.privacy==="private"||i.privacy==="protected"||i.static)return;const s=a?.name||i.name,l=ht.typeRef&&i[`${ht.typeRef}`]?.text||i?.type?.text,d=di(l),p=St(i.default);n[s]={name:s,description:yn(i.description,o,i.deprecated),defaultValue:p==="''"?"":p,control:e?{type:li(d,a!==void 0)}:!1,table:{category:a?"attributes":"properties",defaultValue:{summary:p},type:{summary:l}}};const g=d?.split("|");g&&g?.length>1&&(n[s].options=g.map(C=>St(C)))}),n}function xa(t,e=!0){const n={};return t?.members?.forEach(i=>{if(i.kind!=="field"||(n[i.name]={name:i.name,table:{disable:!0}},i.privacy==="private"||i.privacy==="protected"||i.static))return;const a=ht.typeRef&&i[`${ht.typeRef}`]?.text||i?.type?.text,o=di(a),s=`${i.name}`,l=li(o);n[s]={name:i.name,description:i.description,defaultValue:_a(l,i.default),control:e?{type:l}:!1,table:{category:"properties",defaultValue:{summary:St(i.default)},type:{summary:a}}};const d=o?.split("|");d&&d?.length>1&&(n[s].options=d.map(p=>St(p)))}),delete n.ref,n}function ri(t){const e={};return t?.events?.forEach(n=>{const i=Ca(n.name);e[i]={name:i,description:n.description,control:!1,table:{category:"events"}}}),e}function un(t,e=!0){const n={};return t?.cssProperties?.forEach(i=>{n[i.name]={name:i.name,description:i.description,defaultValue:i.default,control:e?{type:i.name.toLowerCase().includes("color")?"color":"text"}:!1,table:{category:"css properties"}}}),n}function mn(t,e=!0){const n={};return t?.cssParts?.forEach(i=>{n[i.name]={name:i.name,table:{disable:!0}},n[`${i.name}-part`]={name:i.name,description:yn(i.description,e?`${i.name}-part`:""),defaultValue:`${t?.tagName}::part(${i.name}) {
}`,control:e?"text":!1,table:{category:"css shadow parts"}}}),n}function fn(t,e=!0){const n={};return t?.slots?.forEach(i=>{n[i.name]={name:i.name,table:{disable:!0}};const a=i.name||"default";n[`${a}-slot`]={control:"text",name:a,description:yn(i.description,`${a}-slot`),defaultValue:a==="default"?"":`<span slot="${a}"></span>`,control:e?"text":!1,table:{category:"slots"}}}),n}function ka(t){const e={};return t?.events?.forEach(n=>{e[n.name]={name:n.name,description:n.description,control:!1,table:{category:"events",type:{summary:`CustomEvent${n.type?`<${n.type.text}>`:""}`}}}}),e}function _a(t,e){const n=St(e);return t==="boolean"?n==="true":n==="''"?"":n}function li(t,e=!1){if(!t)return"text";const n=t.toLowerCase(),i=n.split("|").map(a=>a.trim()).filter(a=>a!==""&&a!=="null"&&a!=="undefined");return Ta(n)&&!e?"object":Ft(i,"boolean")?"boolean":Ft(i,"number")&&!Ft(i,"string")&&i.every(a=>!a.includes("'"))?"number":Ft(i,"date")?"date":i.length>1&&i.every(a=>a.includes("'"))?"select":"text"}function Ta(t){return t.includes("array")||t.includes("object")||t.includes("{")||t.includes("[")||t.includes("<")}function Ft(t=[],e){return t?.find(n=>n===e)!==void 0}function di(t){return t?t.replace(" | undefined","").replace(" | null",""):""}function St(t){return t?.trim().replace(/^["'](.+(?=["']$))["']$/,"$1")}function yn(t,e,n){let i="";return n&&(i+=`\`@deprecated\` ${n}`),t&&(i+=i?`


`:"",i+=t),ht.hideArgRef||!e?i:i+=`


arg ref - \`${e}\``}const Ca=t=>`on${za(Sa(t))}`;function Sa(t=""){return t.split("-").map((i,a)=>a?i.charAt(0).toUpperCase()+i.slice(1).toLowerCase():i.toLowerCase()).join("")}function za(t){return t.charAt(0).toUpperCase()+t.slice(1)}const{useArgs:Ea}=__STORYBOOK_MODULE_PREVIEW_API__;let Wt,Mn,bn={};setTimeout(()=>{bn=globalThis?.__WC_STORYBOOK_HELPERS_CONFIG__||{}});var ei;function $a(t,e,n,i){if(!e)return T`<${ue(t.tagName)}></${ue(t.tagName)}>`;t?.tagName!==Mn&&(Wt=void 0,Mn=t?.tagName);const{attrOperators:a,additionalAttrs:o}=Oa(t,e,i),s={...a,...o},l=Na(t,e),d=Da(t,e);return Aa(t),T`${ci(t,e)}
<${ue(t.tagName)} 
  ${wa(s)}
  ${d}
  >
...
${bn.hideScriptTag?"":T(ei||(ei=In([`<script>
  window.component = document.querySelector("`,`");
<\/script>`])),t.tagName)}
`}function ci(t,e){const n=Ia(t,e);return`${n}`?.replaceAll(/\s+/g,"")!=""?T`<style>${n}</style>`:""}function Oa(t,e,n){const i=hn(t),a={},o={},s={};return Object.keys(i).forEach(l=>{const d=i[l];if(d?.table?.category!=="attributes")return;const p=d.name,g=e[l],C=d.control.type==="boolean"?`?${p}`:p;(g!==i[l].defaultValue||bn.renderDefaultAttributeValues)&&(a[C]=g==="false"?!1:g)}),Object.keys(e).filter(l=>i[l]?.table?.category==="properties").forEach(l=>{if(l.startsWith("on"))return;const d=e[l];o[`.${l}`]=d}),Object.keys(e).filter(l=>!Object.keys(n||{}).includes(l)).forEach(l=>{!l.startsWith("on")&&typeof e[l]!="function"&&(s[l]=e[l])}),{attrOperators:a,propOperators:o,additionalAttrs:s}}function Da(t,e){if(!t?.cssProperties?.length)return;const n=un(t);return ue(`style="${Object.keys(n).map(i=>{const a=n[i].name,o=e[i];return o?`${a}: ${o||""}`:null}).filter(i=>i!==null).join(";")}"`)}function Ia(t,e){const n=mn(t);if(!Object.keys(n).some(o=>!!e[o]))return;const a=Object.keys(n).filter(o=>o.endsWith("-part")).map(o=>{const s=n[o].name,l=e[o];return l?.replaceAll(/\s+/g,"")!==`${t?.tagName}::part(${s}){}`?`
${l}`:null}).filter(o=>o!==null).join(`
`);return a?ue(`${a}
`):""}function Na(t,e){const n=fn(t);return ue(`${Object.keys(n).filter(a=>a.endsWith("-slot")).map(a=>{const o=n[a].name,s=e[a];return o==="default"?s||null:s!==`<span slot="${o}"></span>`?s:null}).filter(a=>a!==null).join("")}`)}function Aa(t){Ma(t),setTimeout(()=>{const e=document.querySelector(t.tagName);Wt?.observe(e,{attributes:!0})})}function Ma(t){let e=!1;const n=Ea()[1],i=hn(t);Wt||(Wt=new MutationObserver(a=>{a.forEach(o=>{if(o.type!=="attributes"||o.attributeName==="class"&&e)return;e=!0;const s=i[`${o.attributeName}`];s?.control==="boolean"||s?.control?.type==="boolean"?n({[`${o.attributeName}`]:o.target?.hasAttribute(o.attributeName||"")}):n({[`${o.attributeName}`]:o.target.getAttribute(o.attributeName||"")}),e=!1})}))}function Pa(t){window.__WC_STORYBOOK_HELPERS_CONFIG__=t}function pi(t){const e=window.__STORYBOOK_CUSTOM_ELEMENTS_MANIFEST__;if(!e)throw new Error(`Custom Elements Manifest not found. Be sure to follow the pre-install steps in this guide:
https://www.npmjs.com/package/wc-storybook-helpers#before-you-install`);const n=si(t,e),i=n?.events?.map(o=>o.name)||[],a=hi(n);return{args:ui(n),argTypes:a,reactArgs:ja(n),reactArgTypes:mi(n),events:i,styleTemplate:o=>ci(n,o),template:(o,s)=>$a(n,o,s,a)}}function hi(t){return{...un(t),...mn(t),...fn(t),...hn(t),...ka(t)}}function ui(t,e){return e||(e=hi(t)),Object.entries(e).filter(([,i])=>i?.control).map(([i,a])=>{let o=La(a.defaultValue);return a.table?.category==="css properties"&&(o=o?.toString()),{[i]:o===void 0?"":o}}).reduce((i,a)=>({...i,...a}),{})}function La(t){try{return JSON.parse(t)}catch{return t}}function mi(t){return{...xa(t),...ri(t),...un(t,!1),...mn(t,!1),...fn(t,!1)}}function ja(t){const e=ui(t,mi(t)),n=Object.entries(ri(t)).map(([i])=>({[i]:()=>{}})).reduce((i,a)=>({...i,...a}),{});return{...e,...n}}const{useParameter:Fa,addons:Va,useEffect:Ha,useMemo:Wl,definePreview:ql}=__STORYBOOK_MODULE_PREVIEW_API__,{deprecate:Ba}=__STORYBOOK_MODULE_CLIENT_LOGGER__;var Ra=Object.defineProperty,fi=(t,e)=>{for(var n in e)Ra(t,n,{get:e[n],enumerable:!0})},Ua={};fi(Ua,{initialGlobals:()=>Ka});var qt="themes",Wa=`storybook/${qt}`,yi="theme",Pn={},qa={REGISTER_THEMES:`${Wa}/REGISTER_THEMES`},Ka={[yi]:""},Ga={};fi(Ga,{initializeThemeState:()=>gi,pluckThemeFromContext:()=>bi,useThemeParameters:()=>Ya});function bi({globals:t}){return t[yi]||""}function Ya(t){return Ba(ha`The useThemeParameters function is deprecated. Please access parameters via the context directly instead e.g.
    - const { themeOverride } = context.parameters.themes ?? {};
    `),t?t.parameters[qt]??Pn:Fa(qt,Pn)}function gi(t,e){Va.getChannel().emit(qa.REGISTER_THEMES,{defaultTheme:e,themes:t})}var Xa="html",Ln=t=>t.split(" ").filter(Boolean),Ja=({themes:t,defaultTheme:e,parentSelector:n=Xa})=>(gi(Object.keys(t),e),(i,a)=>{let{themeOverride:o}=a.parameters[qt]??{},s=bi(a);return Ha(()=>{let l=o||s||e,d=document.querySelector(n);if(!d)return;Object.entries(t).filter(([g])=>g!==l).forEach(([g,C])=>{let Y=Ln(C);Y.length>0&&d.classList.remove(...Y)});let p=Ln(t[l]);p.length>0&&d.classList.add(...p)},[o,s]),i()});const{definePreview:Kl}=__STORYBOOK_MODULE_PREVIEW_API__;var Qa=Object.defineProperty,Za=(t,e)=>{for(var n in e)Qa(t,n,{get:e[n],enumerable:!0})},eo={};Za(eo,{initialGlobals:()=>ao});var to="viewport",no={[to]:{value:void 0,isRotated:!1}},io={viewport:"reset",viewportRotated:!1},ao=globalThis.FEATURES?.viewportStoryGlobals?no:io,oo={mobile1:{name:"Small mobile",styles:{height:"568px",width:"320px"},type:"mobile"},mobile2:{name:"Large mobile",styles:{height:"896px",width:"414px"},type:"mobile"},tablet:{name:"Tablet",styles:{height:"1112px",width:"834px"},type:"tablet"}};function W(t,e,n){return new Promise(i=>{if(n?.duration===1/0)throw new Error("Promise-based animations must be finite.");const a=t.animate(e,{...n,duration:so()?0:n.duration});a.addEventListener("cancel",i,{once:!0}),a.addEventListener("finish",i,{once:!0})})}function jn(t){return t=t.toString().toLowerCase(),t.indexOf("ms")>-1?parseFloat(t):t.indexOf("s")>-1?parseFloat(t)*1e3:parseFloat(t)}function so(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Q(t){return Promise.all(t.getAnimations().map(e=>new Promise(n=>{e.cancel(),requestAnimationFrame(n)})))}function Fn(t,e){return t.map(n=>({...n,height:n.height==="auto"?`${e}px`:n.height}))}const gn=t=>{const{activeElement:e}=document;e&&t.contains(e)&&document.activeElement?.blur()},vi=new Map,rn=new WeakMap;function wi(t){return t??{keyframes:[],options:{duration:0}}}function Vn(t,e){return e.toLowerCase()==="rtl"?{keyframes:t.rtlKeyframes||t.keyframes,options:t.options}:t}function z(t,e){vi.set(t,wi(e))}function Vt(t,e,n){rn.set(t,{...rn.get(t),[e]:wi(n)})}function j(t,e,n){const i=rn.get(t);if(i?.[e])return Vn(i[e],n.dir);const a=vi.get(e);return a?Vn(a,n.dir):{keyframes:[],options:{duration:0}}}class J{constructor(e,...n){this.slotNames=[],this.handleSlotChange=i=>{const a=i.target;(this.slotNames.includes("[default]")&&!a.name||a.name&&this.slotNames.includes(a.name))&&this.host.requestUpdate()},(this.host=e).addController(this),this.slotNames=n}hasDefaultSlot(){return[...this.host.childNodes].some(e=>{if(e.nodeType===e.TEXT_NODE&&e.textContent.trim()!=="")return!0;if(e.nodeType===e.ELEMENT_NODE){const n=e;if(n.tagName.toLowerCase()==="syn-visually-hidden")return!1;if(!n.hasAttribute("slot"))return!0}return!1})}hasNamedSlot(e){return this.host.querySelector(`:scope > [slot="${e}"]`)!==null}test(e){return e==="[default]"?this.hasDefaultSlot():this.hasNamedSlot(e)}hostConnected(){this.host.shadowRoot.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener("slotchange",this.handleSlotChange)}}function xi(t){if(!t)return"";const e=t.assignedNodes({flatten:!0});let n="";return[...e].forEach(i=>{i.nodeType===Node.TEXT_NODE&&(n+=i.textContent)}),n}const ki={$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(t,e)=>`Go to slide ${t} of ${e}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:t=>t===0?"No options selected":t===1?"1 option selected":`${t} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:t=>`Slide ${t}`,toggleColorFormat:"Toggle color format",closeMenu:"Close menu",danger:"Danger",fileButtonText:"Choose file",fileButtonTextMultiple:"Choose files",folderButtonText:"Choose folder",fileDragDrop:"Drop or choose file",folderDragDrop:"Drop or choose folder",menu:"Menu",notification:"Notification",numFilesSelected:(t,e)=>t===0?`No ${e?"folder":"files"} chosen`:`${t} files`,openMenu:"Open menu",rangeMax:"Maximum",rangeMin:"Minimum",sideNav:"Side navigation",sideNavHide:"Hide navigation",sideNavShow:"Show navigation",success:"Success",warning:"Warning"};ai(ki);class R extends Ji{static{ai(ki)}}function Z(t,e){return new Promise(n=>{function i(a){a.target===t&&(t.removeEventListener(e,i),n())}t.addEventListener(e,i)})}const ro=h`
	/* stylelint-disable */
  :host {
    display: contents;
...
`;var co=Object.defineProperty,po=Object.getOwnPropertyDescriptor,Pe=(t,e,n,i)=>{for(var a=i>1?void 0:i?po(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&co(e,n,a),a};let X=class extends w{constructor(){super(...arguments),this.hasSlotController=new J(this,"icon","suffix"),this.localize=new R(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.remainingTime=this.duration}static get toastStack(){return this.currentToastStack||(this.currentToastStack=Object.assign(document.createElement("div"),{className:"syn-toast-stack"})),this.currentToastStack}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){this.countdownAnimation?.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),this.countdownAnimation?.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){const{countdownElement:t}=this,e="100%",n="0";this.countdownAnimation=t.animate([{width:e},{width:n}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.duration<1/0&&this.restartAutoHide(),await Q(this.base),this.base.hidden=!1;const{keyframes:t,options:e}=j(this,"alert.show",{dir:this.localize.dir()});await W(this.base,t,e),this.emit("syn-after-show")}else{gn(this),this.emit("syn-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await Q(this.base);const{keyframes:t,options:e}=j(this,"alert.hide",{dir:this.localize.dir()});await W(this.base,t,e),this.base.hidden=!0,this.emit("syn-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,Z(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,Z(this,"syn-after-hide")}async toast(){return new Promise(t=>{this.handleCountdownChange(),X.toastStack.parentElement===null&&document.body.append(X.toastStack),X.toastStack.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("syn-after-hide",()=>{X.toastStack.removeChild(this),t(),X.toastStack.querySelector("syn-alert")===null&&X.toastStack.remove()},{once:!0})})}render(){return c`
    ...
    `}};X.styles=[x,ro,lo];X.dependencies={"syn-icon-button":ut};Pe([u('[part~="base"]')],X.prototype,"base",2);Pe([u(".alert__countdown-elapsed")],X.prototype,"countdownElement",2);Pe([r({type:Boolean,reflect:!0})],X.prototype,"open",2);Pe([r({type:Boolean,reflect:!0})],X.prototype,"closable",2);Pe([r({reflect:!0})],X.prototype,"variant",2);Pe([r({type:Number})],X.prototype,"duration",2);Pe([y()],X.prototype,"remainingTime",2);Pe([m("open",{waitUntilFirstUpdate:!0})],X.prototype,"handleOpenChange",1);Pe([m("duration")],X.prototype,"handleDurationChange",1);X=Pe([ie("SynAlert")],X);z("alert.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});z("alert.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});X.define("syn-alert");const ho=h`
	/* stylelint-disable */
  :host {
    display: inline-flex;
  }
...
`;var mo=Object.defineProperty,fo=Object.getOwnPropertyDescriptor,_i=(t,e,n,i)=>{for(var a=i>1?void 0:i?fo(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&mo(e,n,a),a};let zt=class extends w{constructor(){super(...arguments),this.localize=new R(this),this.variant="primary"}render(){return c`
      <span
        part="base"
    ...
    `}};zt.styles=[x,ho,uo];_i([r({reflect:!0})],zt.prototype,"variant",2);zt=_i([ie("SynBadge")],zt);zt.define("syn-badge");const yo=h`
	/* stylelint-disable */
  :host {
    display: inline-flex;
  }
...
`;var go=Object.defineProperty,vo=Object.getOwnPropertyDescriptor,mt=(t,e,n,i)=>{for(var a=i>1?void 0:i?vo(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&go(e,n,a),a};class st extends w{constructor(){super(...arguments),this.hasSlotController=new J(this,"prefix","suffix"),this.renderType="button",this.rel="noreferrer noopener"}static{this.styles=[x,yo,bo]}setRenderType(){const e=this.defaultSlot.assignedElements({flatten:!0}).filter(n=>n.tagName.toLowerCase()==="syn-dropdown").length>0;if(this.href){this.renderType="link";return}if(e){this.renderType="dropdown";return}this.renderType="button"}hrefChanged(){this.setRenderType()}handleSlotChange(){this.setRenderType()}render(){return c`
    ...
    `}}mt([u("slot:not([name])")],st.prototype,"defaultSlot",2);mt([y()],st.prototype,"renderType",2);mt([r()],st.prototype,"href",2);mt([r()],st.prototype,"target",2);mt([r()],st.prototype,"rel",2);mt([m("href",{waitUntilFirstUpdate:!0})],st.prototype,"hrefChanged",1);st.define("syn-breadcrumb-item");const wo=h`
	/* stylelint-disable */
  .breadcrumb {
    display: flex;
    align-items: center;
...
`;var ko=Object.defineProperty,vn=(t,e,n,i)=>{for(var a=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=s(e,n,a)||a);return a&&ko(e,n,a),a};class Yt extends w{constructor(){super(...arguments),this.localize=new R(this),this.separatorDir=this.localize.dir(),this.label=""}static{this.styles=[x,wo,xo]}static{this.dependencies={"syn-icon":ye}}getSeparator(){const n=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[n,...n.querySelectorAll("[id]")].forEach(i=>i.removeAttribute("id")),n.setAttribute("data-default",""),n.slot="separator",n}handleSlotChange(){const e=[...this.defaultSlot.assignedElements({flatten:!0})].filter(n=>n.tagName.toLowerCase()==="syn-breadcrumb-item");e.forEach((n,i)=>{const a=n.querySelector('[slot="separator"]');a===null?n.append(this.getSeparator()):a.hasAttribute("data-default")&&a.replaceWith(this.getSeparator()),i===e.length-1?n.setAttribute("aria-current","page"):n.removeAttribute("aria-current")})}render(){return this.separatorDir!==this.localize.dir()&&(this.separatorDir=this.localize.dir(),this.updateComplete.then(()=>this.handleSlotChange())),c`
...
`;var To=Object.defineProperty,wn=(t,e,n,i)=>{for(var a=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=s(e,n,a)||a);return a&&To(e,n,a),a};class It extends w{constructor(){super(...arguments),this.disableRole=!1,this.label=""}static{this.styles=[x,_o]}handleFocus(e){bt(e.target)?.toggleAttribute("data-syn-button-group__button--focus",!0)}handleBlur(e){bt(e.target)?.toggleAttribute("data-syn-button-group__button--focus",!1)}handleMouseOver(e){bt(e.target)?.toggleAttribute("data-syn-button-group__button--hover",!0)}handleMouseOut(e){bt(e.target)?.toggleAttribute("data-syn-button-group__button--hover",!1)}handleSlotChange(){const e=[...this.defaultSlot.assignedElements({flatten:!0})];e.forEach(n=>{const i=e.indexOf(n),a=bt(n);a&&(a.toggleAttribute("data-syn-button-group__button",!0),a.toggleAttribute("data-syn-button-group__button--first",i===0),a.toggleAttribute("data-syn-button-group__button--inner",i>0&&i<e.length-1),a.toggleAttribute("data-syn-button-group__button--last",i===e.length-1),a.toggleAttribute("data-syn-button-group__button--radio",a.tagName.toLowerCase()==="syn-radio-button"))})}render(){return c`
      <div
        part="base"
        class="button-group"
...
`;class xn extends w{constructor(){super(...arguments),this.localize=new R(this)}static{this.styles=[x,So,zo]}render(){return c`
...
`;var $o=Object.defineProperty,Oo=Object.getOwnPropertyDescriptor,U=(t,e,n,i)=>{for(var a=i>1?void 0:i?Oo(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&$o(e,n,a),a};let A=class extends w{constructor(){super(...arguments),this.formControlController=new Le(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new J(this,"[default]","prefix","suffix"),this.localize=new R(this),this.iconOnly=!1,this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="outline",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:Nt}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}isButton(){return!this.href}isLink(){return!!this.href}handleSlotChange(){const t=xi(this.defaultSlot).trim(),e=this.defaultSlot.assignedElements({flatten:!0}),n=e.length===1&&e[0].tagName.toLowerCase()==="syn-icon";this.iconOnly=n&&t===""}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(t){this.isButton()&&(this.button.setCustomValidity(t),this.formControlController.updateValidity())}render(){const t=this.isLink(),e=t?kt`a`:kt`button`;return T`
      ...
      >
        ...
        ${this.caret?T` <syn-icon part="caret" class="button__caret" library="system" name="caret"></syn-icon> `:""}
        ${this.loading?T`<syn-spinner part="spinner"></syn-spinner>`:""}
      </${e}>
    `}};A.styles=[x,Ci,Eo];A.dependencies={"syn-icon":ye,"syn-spinner":xn};U([u(".button")],A.prototype,"button",2);U([u("slot:not([name])")],A.prototype,"defaultSlot",2);U([y()],A.prototype,"iconOnly",2);U([y()],A.prototype,"hasFocus",2);U([y()],A.prototype,"invalid",2);U([r({reflect:!0})],A.prototype,"title",2);U([r({reflect:!0})],A.prototype,"variant",2);U([r({reflect:!0})],A.prototype,"size",2);U([r({type:Boolean,reflect:!0})],A.prototype,"caret",2);U([r({type:Boolean,reflect:!0})],A.prototype,"disabled",2);U([r({type:Boolean,reflect:!0})],A.prototype,"loading",2);U([r()],A.prototype,"type",2);U([r()],A.prototype,"name",2);U([r()],A.prototype,"value",2);U([r()],A.prototype,"href",2);U([r()],A.prototype,"target",2);U([r()],A.prototype,"rel",2);U([r()],A.prototype,"download",2);U([r()],A.prototype,"form",2);U([r({attribute:"formaction"})],A.prototype,"formAction",2);U([r({attribute:"formenctype"})],A.prototype,"formEnctype",2);U([r({attribute:"formmethod"})],A.prototype,"formMethod",2);U([r({attribute:"formnovalidate",type:Boolean})],A.prototype,"formNoValidate",2);U([r({attribute:"formtarget"})],A.prototype,"formTarget",2);U([m("disabled",{waitUntilFirstUpdate:!0})],A.prototype,"handleDisabledChange",1);A=U([ie("SynButton")],A);A.define("syn-button");const Do=h`
	/* stylelint-disable */
  :host {
...
`;var No=Object.defineProperty,Ao=(t,e,n,i)=>{for(var a=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=s(e,n,a)||a);return a&&No(e,n,a),a};class Si extends w{constructor(){super(...arguments),this.hasSlotController=new J(this,"footer","header","image"),this.sharp=!1}static{this.styles=[x,Do,Io]}render(){return c`
      <div
        part="base"
    ...
    `}}Ao([r({type:Boolean,reflect:!0})],Si.prototype,"sharp");Si.define("syn-card");const rt=(t="value")=>(e,n)=>{const i=e.constructor,a=i.prototype.attributeChangedCallback;i.prototype.attributeChangedCallback=function(o,s,l){const d=i.getPropertyOptions(t),p=typeof d.attribute=="string"?d.attribute:t;if(o===p){const g=d.converter||Nn,Y=(typeof g=="function"?g:g?.fromAttribute??Nn.fromAttribute)(l,d.type);this[t]!==Y&&(this[n]=Y)}a.call(this,o,s,l)}},Be=h`
	/* stylelint-disable */
...
`;var Lo=Object.defineProperty,jo=Object.getOwnPropertyDescriptor,ce=(t,e,n,i)=>{for(var a=i>1?void 0:i?jo(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&Lo(e,n,a),a};let ee=class extends w{constructor(){super(...arguments),this.formControlController=new Le(this,{value:t=>t.checked?t.value||"on":void 0,defaultValue:t=>t.defaultChecked,setValue:(t,e)=>t.checked=e}),this.hasSlotController=new J(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.indeterminate=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleClick(){this.checked=!this.checked,this.indeterminate=!1,this.emit("syn-change")}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleInput(){this.emit("syn-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStateChange(){this.input.checked=this.checked,this.input.indeterminate=this.indeterminate,this.formControlController.updateValidity()}click(){this.input.click()}focus(t){this.input.focus(t)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("help-text"),e=this.helpText?!0:!!t;return c`
    ...
    `}};ee.styles=[x,Be,Mo,Re,Po];ee.dependencies={"syn-icon":ye};ce([u('input[type="checkbox"]')],ee.prototype,"input",2);ce([y()],ee.prototype,"hasFocus",2);ce([r({reflect:!0})],ee.prototype,"title",2);ce([r()],ee.prototype,"name",2);ce([r()],ee.prototype,"value",2);ce([r({reflect:!0})],ee.prototype,"size",2);ce([r({type:Boolean,reflect:!0})],ee.prototype,"disabled",2);ce([r({type:Boolean,reflect:!0})],ee.prototype,"checked",2);ce([r({type:Boolean,reflect:!0})],ee.prototype,"indeterminate",2);ce([rt("checked")],ee.prototype,"defaultChecked",2);ce([r({reflect:!0})],ee.prototype,"form",2);ce([r({type:Boolean,reflect:!0})],ee.prototype,"required",2);ce([r({attribute:"help-text"})],ee.prototype,"helpText",2);ce([m("disabled",{waitUntilFirstUpdate:!0})],ee.prototype,"handleDisabledChange",1);ce([m(["checked","indeterminate"],{waitUntilFirstUpdate:!0})],ee.prototype,"handleStateChange",1);ee=ce([ie("SynCheckbox")],ee);ee.define("syn-checkbox");const Fo=h`
	/* stylelint-disable */
  :host {
...
`;var Vo=Object.defineProperty,G=(t,e,n,i)=>{for(var a=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=s(e,n,a)||a);return a&&Vo(e,n,a),a};function Ho(t){return t!==null&&typeof t=="object"&&"getBoundingClientRect"in t&&("contextElement"in t?t.contextElement instanceof Element:!0)}class P extends w{constructor(){super(...arguments),this.localize=new R(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){const e=this.anchorEl.getBoundingClientRect(),n=this.popup.getBoundingClientRect(),i=this.placement.includes("top")||this.placement.includes("bottom");let a=0,o=0,s=0,l=0,d=0,p=0,g=0,C=0;i?e.top<n.top?(a=e.left,o=e.bottom,s=e.right,l=e.bottom,d=n.left,p=n.top,g=n.right,C=n.top):(a=n.left,o=n.bottom,s=n.right,l=n.bottom,d=e.left,p=e.top,g=e.right,C=e.top):e.left<n.left?(a=e.right,o=e.top,s=n.left,l=n.top,d=e.right,p=e.bottom,g=n.left,C=n.bottom):(a=n.right,o=n.top,s=e.left,l=e.top,d=n.right,p=n.bottom,g=e.left,C=e.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${a}px`),this.style.setProperty("--hover-bridge-top-left-y",`${o}px`),this.style.setProperty("--hover-bridge-top-right-x",`${s}px`),this.style.setProperty("--hover-bridge-top-right-y",`${l}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${d}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${p}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${g}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${C}px`)}}}static{this.styles=[x,Fo]}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has("active")&&(this.active?this.start():this.stop()),e.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){const e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchor instanceof Element||Ho(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){!this.anchorEl||!this.active||(this.cleanup=Qi(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>e())):e()})}reposition(){if(!this.active||!this.anchorEl)return;const e=[Zi({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?e.push(An({apply:({rects:i})=>{const a=this.sync==="width"||this.sync==="both",o=this.sync==="height"||this.sync==="both";this.popup.style.width=a?`${i.reference.width}px`:"",this.popup.style.height=o?`${i.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&e.push(ea({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&e.push(ta({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?e.push(An({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:i,availableHeight:a})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${a}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${i}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&e.push(na({element:this.arrowEl,padding:this.arrowPadding}));const n=this.strategy==="absolute"?i=>nn.getOffsetParent(i,ia):nn.getOffsetParent;aa(this.anchorEl,this.popup,{placement:this.placement,middleware:e,strategy:this.strategy,platform:{...nn,getOffsetParent:n}}).then(({x:i,y:a,middlewareData:o,placement:s})=>{const l=this.localize.dir()==="rtl",d={top:"bottom",right:"left",bottom:"top",left:"right"}[s.split("-")[0]];if(this.setAttribute("data-current-placement",s),Object.assign(this.popup.style,{left:`${i}px`,top:`${a}px`}),this.arrow){const p=o.arrow.x,g=o.arrow.y;let C="",Y="",qe="",Ne="";if(this.arrowPlacement==="start"){const He=typeof p=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";C=typeof g=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",Y=l?He:"",Ne=l?"":He}else if(this.arrowPlacement==="end"){const He=typeof p=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";Y=l?"":He,Ne=l?He:"",qe=typeof g=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else this.arrowPlacement==="center"?(Ne=typeof p=="number"?"calc(50% - var(--arrow-size-diagonal))":"",C=typeof g=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(Ne=typeof p=="number"?`${p}px`:"",C=typeof g=="number"?`${g}px`:"");Object.assign(this.arrowEl.style,{top:C,right:Y,bottom:qe,left:Ne,[d]:"calc(var(--arrow-size-diagonal) * -1)"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("syn-reposition")}render(){return c`
...
`,Uo=(t,e)=>{const n=e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),i=new RegExp(n,"g");return t.replace(i,"_")};var Wo=Object.defineProperty,qo=Object.getOwnPropertyDescriptor,je=(t,e,n,i)=>{for(var a=i>1?void 0:i?qo(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&Wo(e,n,a),a};class $e extends w{constructor(){super(...arguments),this.localize=new R(this),this.isInitialized=!1,this.delimiter=" ",this.current=!1,this.selected=!1,this.hasHover=!1,this.value="",this.disabled=!1}static{this.styles=[x,Bo,Ro]}static{this.dependencies={"syn-icon":ye}}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.setAttribute("aria-selected","false")}handleDefaultSlotChange(){this.isInitialized?(customElements.whenDefined("syn-combobox").then(()=>{const e=this.closest("syn-combobox");e&&e.handleDefaultSlotChange()}),customElements.whenDefined("syn-select").then(()=>{const e=this.closest("syn-select");e&&e.handleDefaultSlotChange()})):this.isInitialized=!0}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleValueChange(){if(typeof this.value=="number")return;typeof this.value!="string"&&(this.value=String(this.value));const{delimiter:e}=this;this.value.includes(e)&&(console.error(`Option values cannot include "${e}". All occurrences of "${e}" have been replaced with "_".`,this),this.value=Uo(this.value,this.delimiter))}getTextLabel(){const e=this.childNodes;let n="";return[...e].forEach(i=>{i.nodeType===Node.ELEMENT_NODE&&(i.hasAttribute("slot")||(n+=i.textContent)),i.nodeType===Node.TEXT_NODE&&(n+=i.textContent)}),n.trim()}render(){return c`
      <div
        part="base"
    ...
    `}}je([u(".option__label")],$e.prototype,"defaultSlot",2);je([y()],$e.prototype,"delimiter",2);je([y()],$e.prototype,"current",2);je([y()],$e.prototype,"selected",2);je([y()],$e.prototype,"hasHover",2);je([r({reflect:!0})],$e.prototype,"value",2);je([r({type:Boolean,reflect:!0})],$e.prototype,"disabled",2);je([m("disabled")],$e.prototype,"handleDisabledChange",1);je([m("selected")],$e.prototype,"handleSelectedChange",1);je([m("value")],$e.prototype,"handleValueChange",1);const Ko=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`,Hn=t=>Array.from(t.assignedElements({flatten:!0})),Yo=t=>t.tagName.toLocaleLowerCase()==="syn-option"?t:Array.from(t.querySelectorAll(":scope > syn-option")),Xo=t=>t.tagName.toLocaleLowerCase()==="syn-optgroup",Bn=t=>t.map(Yo),Jo=t=>t.filter(Xo),Rn=t=>t.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase(),Un=t=>{const e=document.createElement("div");return Yi(t,e),e.firstElementChild},on=t=>t.tagName.toLocaleLowerCase()==="syn-option"?t:void 0,Qo=t=>{if(t){if(t instanceof HTMLElement)return on(t);if(typeof t=="string"){const e=c`${oi(t)}`,n=Un(e);return on(n)}if(Object.prototype.hasOwnProperty.call(t,"_$litType$")){const e=Un(t);return on(e)}}};function Zo(t,e){return{top:Math.round(t.getBoundingClientRect().top-e.getBoundingClientRect().top),left:Math.round(t.getBoundingClientRect().left-e.getBoundingClientRect().left)}}const ln=new Set;function es(){const t=document.documentElement.clientWidth;return Math.abs(window.innerWidth-t)}function ts(){const t=Number(getComputedStyle(document.body).paddingRight.replace(/px/,""));return isNaN(t)||!t?0:t}function _t(t){if(ln.add(t),!document.documentElement.classList.contains("syn-scroll-lock")){const e=es()+ts();let n=getComputedStyle(document.documentElement).scrollbarGutter;(!n||n==="auto")&&(n="stable"),e<2&&(n=""),document.documentElement.style.setProperty("--syn-scroll-lock-gutter",n),document.documentElement.classList.add("syn-scroll-lock"),document.documentElement.style.setProperty("--syn-scroll-lock-size",`${e}px`)}}function pt(t){ln.delete(t),ln.size===0&&(document.documentElement.classList.remove("syn-scroll-lock"),document.documentElement.style.removeProperty("--syn-scroll-lock-size"))}function Kt(t,e,n="vertical",i="smooth"){const a=Zo(t,e),o=a.top+e.scrollTop,s=a.left+e.scrollLeft,l=e.scrollLeft,d=e.scrollLeft+e.offsetWidth,p=e.scrollTop,g=e.scrollTop+e.offsetHeight;(n==="horizontal"||n==="both")&&(s<l?e.scrollTo({left:s,behavior:i}):s+t.clientWidth>d&&e.scrollTo({left:s-e.offsetWidth+t.clientWidth,behavior:i})),(n==="vertical"||n==="both")&&(o<p?e.scrollTo({top:o,behavior:i}):o+t.clientHeight>g&&e.scrollTo({top:o-e.offsetHeight+t.clientHeight,behavior:i}))}const ns=t=>t,Gl=(t,e)=>{if(!e)return t;const n=t.cloneNode(!0),i=n.getTextLabel(),a=i.toLowerCase().indexOf(e.toLowerCase()),o=n.innerHTML.indexOf(i),s=document.createElement("mark");s.textContent=i.slice(a,a+e.length),s.classList.add("syn-highlight-style");const l=i.replace(new RegExp(e,"i"),s.outerHTML),d=n.innerHTML.slice(0,o),p=n.innerHTML.slice(o+i.length);return n.innerHTML=d.concat(l,p),n};var is=Object.defineProperty,as=Object.getOwnPropertyDescriptor,N=(t,e,n,i)=>{for(var a=i>1?void 0:i?as(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&is(e,n,a),a};let E=class extends w{constructor(){super(...arguments),this.formControlController=new Le(this,{assumeInteractionOn:["syn-blur","syn-input"]}),this.hasSlotController=new J(this,"help-text","label"),this.localize=new R(this),this.lastOptionValue="",this.isOptionRendererTriggered=!1,this.isInitialized=!1,this.hasFocus=!1,this.displayLabel="",this.numberFilteredOptions=0,this.cachedOptions=[],this.name="",this.value="",this.defaultValue="",this.size="medium",this.placeholder="",this.disabled=!1,this.clearable=!1,this.open=!1,this.hoist=!1,this.label="",this.placement="bottom",this.helpText="",this.form="",this.required=!1,this.getOption=ns,this.filter=(t,e)=>{let n=t?.textContent||"";t instanceof $e&&(n=t.getTextLabel());const i=Rn(n),a=Rn(e);return i.includes(a)?!0:t?.value===e},this.handleDocumentFocusIn=t=>{const e=t.composedPath();this&&!e.includes(this)&&this.hide()},this.handleDocumentKeyDown=t=>{if(t.target.closest(".combobox__clear")===null){if(t.key==="Escape"&&(this.open&&!this.closeWatcher?(t.preventDefault(),t.stopPropagation(),this.hide(),this.displayInput.focus({preventScroll:!0})):this.open||this.clearCombobox()),t.key==="Enter"){const i=this.getCurrentOption(),a=t.metaKey||t.ctrlKey||t.shiftKey||t.altKey;if(!this.open&&!a){setTimeout(()=>{t.defaultPrevented||this.formControlController.submit()});return}if(!this.open||i&&i.disabled)return;if(i){const o=this.lastOptionValue;this.setSelectedOption(i),this.value!==o&&this.updateComplete.then(()=>{this.emit("syn-input"),this.emit("syn-change")})}this.hide(),this.displayInput.focus({preventScroll:!0});return}["ArrowUp","ArrowDown"].includes(t.key)&&(t.preventDefault(),t.stopPropagation(),this.open||this.show(),this.selectNextOption(t.key==="ArrowDown")),["Home","End"].includes(t.key)&&(t.preventDefault(),t.stopPropagation(),t.key==="Home"?this.displayInput.setSelectionRange(0,0):t.key==="End"&&this.displayInput.setSelectionRange(this.displayInput.value.length,this.displayInput.value.length))}},this.handleDocumentMouseDown=t=>{const e=t.composedPath();this&&!e.includes(this)&&this.hide()}}get validity(){return this.valueInput.validity}get validationMessage(){return this.valueInput.validationMessage}connectedCallback(){super.connectedCallback(),this.open=!1}firstUpdated(){this.isInitialized=!0,this.formControlController.updateValidity()}willUpdate(t){super.willUpdate(t),!this.isInitialized&&!this.defaultValue&&this.value&&(this.defaultValue=this.value)}addOpenListeners(){document.addEventListener("focusin",this.handleDocumentFocusIn),document.addEventListener("keydown",this.handleDocumentKeyDown),document.addEventListener("mousedown",this.handleDocumentMouseDown),this.getRootNode()!==document&&this.getRootNode().addEventListener("focusin",this.handleDocumentFocusIn),"CloseWatcher"in window&&(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.open&&(this.hide(),this.displayInput.focus({preventScroll:!0}))})}removeOpenListeners(){document.removeEventListener("focusin",this.handleDocumentFocusIn),document.removeEventListener("keydown",this.handleDocumentKeyDown),document.removeEventListener("mousedown",this.handleDocumentMouseDown),this.getRootNode()!==document&&this.getRootNode().removeEventListener("focusin",this.handleDocumentFocusIn),this.closeWatcher?.destroy()}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleLabelClick(){this.displayInput.focus()}handleComboboxMouseDown(t){if(this.disabled)return;const e=()=>this.open?this.hide():this.show();t.preventDefault(),e().then(()=>{setTimeout(()=>this.displayInput.focus({preventScroll:!0}))})}handleComboboxKeyDown(t){t.key!=="Tab"&&this.handleDocumentKeyDown(t)}handleClearClick(t){t.stopPropagation(),this.clearCombobox()}clearCombobox(){this.value!==""&&(this.value="",this.displayInput.value="",this.lastOptionValue="",this.setSelectedOption(void 0),this.displayInput.focus({preventScroll:!0}),this.updateComplete.then(()=>{this.emit("syn-clear"),this.emit("syn-input"),this.emit("syn-change")}))}preventLoosingFocus(t){t.stopPropagation(),t.preventDefault()}handleOptionClick(t){const n=t.target.closest("syn-option"),i=this.lastOptionValue;n&&!n.disabled&&(this.setSelectedOption(n),this.updateComplete.then(()=>this.displayInput.focus({preventScroll:!0})),this.value!==i&&this.updateComplete.then(()=>{this.emit("syn-input"),this.emit("syn-change")}),this.hide(),this.displayInput.focus({preventScroll:!0}))}selectNextOption(t){const e=this.getAllFilteredOptions();if(e.length===0)return;const n=this.getCurrentOption(),i=e.indexOf(n);let a=Math.max(0,i);if(t){const o=i+1;a=o>e.length-1?0:o}else{const o=i-1;a=o<0?e.length-1:o}this.setCurrentOption(e[a]),Kt(this.getCurrentOption(),this.listbox,"vertical","auto")}getAllFilteredOptions(){return this.getSlottedOptions().filter(t=>!t.hidden)}getCurrentOption(){return this.getAllFilteredOptions().find(t=>t.current)}setCurrentOption(t){const e=this.getAllFilteredOptions();this.displayInput.removeAttribute("aria-activedescendant"),e.forEach(n=>{n.current=!1,n.setAttribute("aria-selected","false")}),t&&(t.current=!0,t.setAttribute("aria-selected","true"),this.displayInput.setAttribute("aria-activedescendant",t.id))}setSelectedOption(t){this.selectedOption=t;let e;this.selectedOption?.value?e=String(this.selectedOption.value):e=this.selectedOption?.getTextLabel(),t&&(this.lastOptionValue=e||""),this.value=e??this.displayInput.value,this.updateComplete.then(()=>{this.displayLabel=this.selectedOption?.getTextLabel()??this.displayInput.value,this.formControlController.updateValidity()})}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}handlePropertiesChange(){this.createComboboxOptionsFromQuery(this.value)}handleDisabledChange(){this.formControlController.setValidity(this.disabled),this.disabled&&(this.open=!1,this.handleOpenChange())}handleValueChange(){this.updateSelectedOptionFromValue(),this.setCurrentOption(null)}async handleOpenChange(){if(this.open&&!this.disabled){if(this.numberFilteredOptions===0){this.open=!1,this.emit("syn-error");return}this.emit("syn-show"),this.addOpenListeners(),await Q(this),this.listbox.hidden=!1,this.popup.active=!0;const{keyframes:n,options:i}=j(this,"combobox.show",{dir:this.localize.dir()});await W(this.popup.popup,n,i),this.emit("syn-after-show");return}this.setCurrentOption(null),this.displayInput.removeAttribute("aria-activedescendant"),this.emit("syn-hide"),this.removeOpenListeners(),await Q(this);const{keyframes:t,options:e}=j(this,"combobox.hide",{dir:this.localize.dir()});await W(this.popup.popup,t,e),this.listbox.hidden=!0,this.popup.active=!1,this.emit("syn-after-hide")}async show(){if(this.open||this.disabled){this.open=!1;return}return this.open=!0,Promise.race([Z(this,"syn-after-show"),Z(this,"syn-error")])}async hide(){if(!this.open||this.disabled){this.open=!1;return}return this.open=!1,Z(this,"syn-after-hide")}checkValidity(){return this.valueInput.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.valueInput.reportValidity()}setCustomValidity(t){this.valueInput.setCustomValidity(t),this.formControlController.updateValidity()}focus(t){this.displayInput.focus(t)}blur(){this.displayInput.blur()}createComboboxOptionsFromQuery(t){this.numberFilteredOptions=0,this.isOptionRendererTriggered=!0,this.cachedOptions.length===0&&this.cacheSlottedOptionsAndOptgroups(),this.getSlottedOptions().forEach(n=>{const i=this.cachedOptions.find(l=>l.id===n.id)||n,a=this.getOption(i,t);let o=Qo(a);o||(o=i);const s=!(this.filter(o,t)||t==="");o.hidden=s,n.replaceWith(o),s||(this.numberFilteredOptions+=1)}),this.getSlottedOptGroups().filter(n=>{const a=Bn(Array.from(n.children)).flat().some(o=>!o.hidden);return n.hidden=!a,a})[0]?.style.setProperty("--display-divider","none"),setTimeout(()=>{this.isOptionRendererTriggered=!1},0)}async handleInput(){const t=this.displayInput.value;this.value=t,await this.updateComplete,this.open=this.numberFilteredOptions>0,this.setSelectedOption(void 0),this.formControlController.updateValidity(),this.emit("syn-input")}handleChange(){this.selectedOption||(this.value=this.displayInput.value,this.updateComplete.then(()=>{this.formControlController.updateValidity()}),this.emit("syn-change"))}getSlottedOptions(){return Bn(Hn(this.defaultSlot)).flat()}getSlottedOptGroups(){return Jo(Hn(this.defaultSlot))}cacheSlottedOptionsAndOptgroups(){const t=this.getSlottedOptions(),e=this.getSlottedOptGroups();t.forEach((n,i)=>{n.id=n.id||`syn-combobox-option-${i}`}),e.forEach((n,i)=>{n.id=n.id||`syn-combobox-optgroup-${i}`}),this.cachedOptions=[...t]}updateSelectedOptionFromValue(){const t=this.cachedOptions.find(e=>e.value!==""&&e.value===this.value||e.getTextLabel()===this.value);t||(this.displayInput.value=this.value),this.setSelectedOption(t),this.createComboboxOptionsFromQuery(this.value)}handleDefaultSlotChange(){const e=this.getSlottedOptions().length,n=this.cachedOptions.length;if(!this.isOptionRendererTriggered||n!==e){if(!customElements.get("syn-option")){customElements.whenDefined("syn-option").then(()=>this.handleDefaultSlotChange());return}this.cacheSlottedOptionsAndOptgroups(),this.updateSelectedOptionFromValue(),this.hasFocus&&this.value.length>0&&!this.open&&this.show()}}render(){const t=this.hasSlotController.test("label"),e=this.hasSlotController.test("help-text"),n=this.label?!0:!!t,i=this.helpText?!0:!!e,a=this.clearable&&!this.disabled&&this.value.length>0,o=this.placeholder&&this.value.length===0;return c`
    ...
    `}};E.styles=[x,Be,Ko,Re,Go];E.dependencies={"syn-icon":ye,"syn-popup":P};N([u(".combobox")],E.prototype,"popup",2);N([u(".combobox__inputs")],E.prototype,"combobox",2);N([u(".combobox__display-input")],E.prototype,"displayInput",2);N([u(".combobox__value-input")],E.prototype,"valueInput",2);N([u(".combobox__listbox")],E.prototype,"listbox",2);N([u("slot:not([name])")],E.prototype,"defaultSlot",2);N([y()],E.prototype,"hasFocus",2);N([y()],E.prototype,"displayLabel",2);N([y()],E.prototype,"selectedOption",2);N([y()],E.prototype,"numberFilteredOptions",2);N([y()],E.prototype,"cachedOptions",2);N([r()],E.prototype,"name",2);N([r()],E.prototype,"value",2);N([rt()],E.prototype,"defaultValue",2);N([r({reflect:!0})],E.prototype,"size",2);N([r()],E.prototype,"placeholder",2);N([r({reflect:!0,type:Boolean})],E.prototype,"disabled",2);N([r({type:Boolean})],E.prototype,"clearable",2);N([r({reflect:!0,type:Boolean})],E.prototype,"open",2);N([r({type:Boolean})],E.prototype,"hoist",2);N([r()],E.prototype,"label",2);N([r({reflect:!0})],E.prototype,"placement",2);N([r({attribute:"help-text"})],E.prototype,"helpText",2);N([r({reflect:!0})],E.prototype,"form",2);N([r({reflect:!0,type:Boolean})],E.prototype,"required",2);N([r()],E.prototype,"getOption",2);N([r()],E.prototype,"filter",2);N([m(["filter","getOption"],{waitUntilFirstUpdate:!0})],E.prototype,"handlePropertiesChange",1);N([m("disabled",{waitUntilFirstUpdate:!0})],E.prototype,"handleDisabledChange",1);N([m("value",{waitUntilFirstUpdate:!0})],E.prototype,"handleValueChange",1);N([m("open",{waitUntilFirstUpdate:!0})],E.prototype,"handleOpenChange",1);E=N([ie("SynCombobox")],E);z("combobox.show",{keyframes:[{opacity:0,scale:.9},{opacity:1,scale:1}],options:{duration:100,easing:"ease"}});z("combobox.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.9}],options:{duration:100,easing:"ease"}});E.define("syn-combobox");const os=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`;var rs=Object.defineProperty,ls=Object.getOwnPropertyDescriptor,Oe=(t,e,n,i)=>{for(var a=i>1?void 0:i?ls(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&rs(e,n,a),a};let me=class extends w{constructor(){super(...arguments),this.localize=new R(this),this.open=!1,this.disabled=!1,this.contained=!1,this.size="medium"}firstUpdated(){this.body.style.height=this.open?"auto":"0",this.open&&(this.details.open=!0),this.detailsObserver=new MutationObserver(t=>{for(const e of t)e.type==="attributes"&&e.attributeName==="open"&&(this.details.open?this.show():this.hide())}),this.detailsObserver.observe(this.details,{attributes:!0})}disconnectedCallback(){super.disconnectedCallback(),this.detailsObserver?.disconnect()}handleSummaryClick(t){t.preventDefault(),this.disabled||(this.open?this.hide():this.show(),this.header.focus())}handleSummaryKeyDown(t){(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),this.open?this.hide():this.show()),(t.key==="ArrowUp"||t.key==="ArrowLeft")&&(t.preventDefault(),this.hide()),(t.key==="ArrowDown"||t.key==="ArrowRight")&&(t.preventDefault(),this.show())}async handleOpenChange(){if(this.open){if(this.details.open=!0,this.emit("syn-show",{cancelable:!0}).defaultPrevented){this.open=!1,this.details.open=!1;return}await Q(this.body);const{keyframes:e,options:n}=j(this,"details.show",{dir:this.localize.dir()});await W(this.body,Fn(e,this.body.scrollHeight),n),this.body.style.height="auto",this.emit("syn-after-show")}else{if(this.emit("syn-hide",{cancelable:!0}).defaultPrevented){this.details.open=!0,this.open=!0;return}await Q(this.body);const{keyframes:e,options:n}=j(this,"details.hide",{dir:this.localize.dir()});await W(this.body,Fn(e,this.body.scrollHeight),n),this.body.style.height="auto",this.details.open=!1,this.emit("syn-after-hide")}}async show(){if(!(this.open||this.disabled))return this.open=!0,Z(this,"syn-after-show")}async hide(){if(!(!this.open||this.disabled))return this.open=!1,Z(this,"syn-after-hide")}render(){return c`
    ...
    `}};me.styles=[x,os,ss];me.dependencies={"syn-icon":ye};Oe([u(".details")],me.prototype,"details",2);Oe([u(".details__header")],me.prototype,"header",2);Oe([u(".details__body")],me.prototype,"body",2);Oe([u(".details__expand-icon-slot")],me.prototype,"expandIconSlot",2);Oe([r({type:Boolean,reflect:!0})],me.prototype,"open",2);Oe([r()],me.prototype,"summary",2);Oe([r({type:Boolean,reflect:!0})],me.prototype,"disabled",2);Oe([r({type:Boolean,reflect:!0})],me.prototype,"contained",2);Oe([r({reflect:!0})],me.prototype,"size",2);Oe([m("open",{waitUntilFirstUpdate:!0})],me.prototype,"handleOpenChange",1);me=Oe([ie("SynDetails")],me);z("details.show",{keyframes:[{height:"0",opacity:"0"},{height:"auto",opacity:"1"}],options:{duration:250,easing:"linear"}});z("details.hide",{keyframes:[{height:"auto",opacity:"1"},{height:"0",opacity:"0"}],options:{duration:250,easing:"linear"}});me.define("syn-details");function*kn(t=document.activeElement){t!=null&&(yield t,"shadowRoot"in t&&t.shadowRoot&&t.shadowRoot.mode!=="closed"&&(yield*kn(t.shadowRoot.activeElement)))}function Ei(){return[...kn()].pop()}const Wn=new WeakMap;function $i(t){let e=Wn.get(t);return e||(e=window.getComputedStyle(t,null),Wn.set(t,e)),e}function ds(t){if(typeof t.checkVisibility=="function")return t.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});const e=$i(t);return e.visibility!=="hidden"&&e.display!=="none"}function cs(t){const e=$i(t),{overflowY:n,overflowX:i}=e;return n==="scroll"||i==="scroll"?!0:n!=="auto"||i!=="auto"?!1:t.scrollHeight>t.clientHeight&&n==="auto"||t.scrollWidth>t.clientWidth&&i==="auto"}function ps(t){const e=t.tagName.toLowerCase(),n=Number(t.getAttribute("tabindex"));if(t.hasAttribute("tabindex")&&(isNaN(n)||n<=-1)||t.hasAttribute("disabled")||t.closest("[inert]"))return!1;if(e==="input"&&t.getAttribute("type")==="radio"){const o=t.getRootNode(),s=`input[type='radio'][name="${t.getAttribute("name")}"]`,l=o.querySelector(`${s}:checked`);return l?l===t:o.querySelector(s)===t}return ds(t)?(e==="audio"||e==="video")&&t.hasAttribute("controls")||t.hasAttribute("tabindex")||t.hasAttribute("contenteditable")&&t.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(e)?!0:cs(t):!1}function hs(t){const e=dn(t),n=e[0]??null,i=e[e.length-1]??null;return{start:n,end:i}}function us(t,e){return t.getRootNode({composed:!0})?.host!==e}function dn(t){const e=new WeakMap,n=[];function i(a){if(a instanceof Element){if(a.hasAttribute("inert")||a.closest("[inert]")||e.has(a))return;e.set(a,!0),!n.includes(a)&&ps(a)&&n.push(a),a instanceof HTMLSlotElement&&us(a,t)&&a.assignedElements({flatten:!0}).forEach(o=>{i(o)}),a.shadowRoot!==null&&a.shadowRoot.mode==="open"&&i(a.shadowRoot)}for(const o of a.children)i(o)}return i(t),n.sort((a,o)=>{const s=Number(a.getAttribute("tabindex"))||0;return(Number(o.getAttribute("tabindex"))||0)-s})}let xt=[];class Oi{constructor(e){this.tabDirection="forward",this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=n=>{if(n.key!=="Tab"||this.isExternalActivated||!this.isActive())return;const i=Ei();if(this.previousFocus=i,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;n.shiftKey?this.tabDirection="backward":this.tabDirection="forward";const a=dn(this.element);let o=a.findIndex(l=>l===i);this.previousFocus=this.currentFocus;const s=this.tabDirection==="forward"?1:-1;for(;;){o+s>=a.length?o=0:o+s<0?o=a.length-1:o+=s,this.previousFocus=this.currentFocus;const l=a[o];if(this.tabDirection==="backward"&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||l&&this.possiblyHasTabbableChildren(l))return;n.preventDefault(),this.currentFocus=l,this.currentFocus?.focus({preventScroll:!1});const d=[...kn()];if(d.includes(this.currentFocus)||!d.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=e,this.elementsWithTabbableControls=["iframe"]}activate(){xt.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){xt=xt.filter(e=>e!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return xt[xt.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){const e=dn(this.element);if(!this.element.matches(":focus-within")){const n=e[0],i=e[e.length-1],a=this.tabDirection==="forward"?n:i;typeof a?.focus=="function"&&(this.currentFocus=a,a.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(e){return this.elementsWithTabbableControls.includes(e.tagName.toLowerCase())||e.hasAttribute("controls")}}const ms=h`
	/* stylelint-disable */
  :host {
    --width: 31rem;
...
`;var ys=Object.defineProperty,bs=Object.getOwnPropertyDescriptor,lt=(t,e,n,i)=>{for(var a=i>1?void 0:i?bs(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&ys(e,n,a),a};class Ye extends w{constructor(){super(...arguments),this.hasSlotController=new J(this,"footer"),this.localize=new R(this),this.modal=new Oi(this),this.open=!1,this.label="",this.noHeader=!1,this.handleDocumentKeyDown=e=>{e.key==="Escape"&&this.modal.isActive()&&this.open&&(e.stopPropagation(),this.requestClose("keyboard"))}}static{this.styles=[x,ms,fs]}static{this.dependencies={"syn-icon-button":ut}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),_t(this))}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate(),pt(this),this.removeOpenListeners()}requestClose(e){if(this.emit("syn-request-close",{cancelable:!0,detail:{source:e}}).defaultPrevented){const i=j(this,"dialog.denyClose",{dir:this.localize.dir()});W(this.panel,i.keyframes,i.options);return}this.hide()}addOpenListeners(){"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard")):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){this.closeWatcher?.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),_t(this);const e=this.querySelector("[autofocus]");e&&e.removeAttribute("autofocus"),await Promise.all([Q(this.dialog),Q(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit("syn-initial-focus",{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute("autofocus","")});const n=j(this,"dialog.show",{dir:this.localize.dir()}),i=j(this,"dialog.overlay.show",{dir:this.localize.dir()});await Promise.all([W(this.panel,n.keyframes,n.options),W(this.overlay,i.keyframes,i.options)]),this.emit("syn-after-show")}else{gn(this),this.emit("syn-hide"),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([Q(this.dialog),Q(this.overlay)]);const e=j(this,"dialog.hide",{dir:this.localize.dir()}),n=j(this,"dialog.overlay.hide",{dir:this.localize.dir()});await Promise.all([W(this.overlay,n.keyframes,n.options).then(()=>{this.overlay.hidden=!0}),W(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,pt(this);const i=this.originalTrigger;typeof i?.focus=="function"&&setTimeout(()=>i.focus()),this.emit("syn-after-hide")}}async show(){if(!this.open)return this.open=!0,Z(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,Z(this,"syn-after-hide")}render(){return c`
      <div
        part="base"
    ...
    `}}lt([u(".dialog")],Ye.prototype,"dialog",2);lt([u(".dialog__panel")],Ye.prototype,"panel",2);lt([u(".dialog__overlay")],Ye.prototype,"overlay",2);lt([r({type:Boolean,reflect:!0})],Ye.prototype,"open",2);lt([r({reflect:!0})],Ye.prototype,"label",2);lt([r({attribute:"no-header",type:Boolean,reflect:!0})],Ye.prototype,"noHeader",2);lt([m("open",{waitUntilFirstUpdate:!0})],Ye.prototype,"handleOpenChange",1);z("dialog.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});z("dialog.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});z("dialog.denyClose",{keyframes:[{scale:1},{scale:1.02},{scale:1}],options:{duration:250}});z("dialog.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});z("dialog.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});Ye.define("syn-dialog");const gs=h`
	/* stylelint-disable */
  :host {
...
`;var ws=Object.defineProperty,xs=Object.getOwnPropertyDescriptor,Di=(t,e,n,i)=>{for(var a=i>1?void 0:i?xs(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&ws(e,n,a),a};class Xe extends w{constructor(){super(...arguments),this.vertical=!1}static{this.styles=[x,gs,vs]}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}}Di([r({type:Boolean,reflect:!0})],Xe.prototype,"vertical",2);Di([m("vertical")],Xe.prototype,"handleVerticalChange",1);Xe.define("syn-divider");function qn(t){return t.charAt(0).toUpperCase()+t.slice(1)}const ks=h`
	/* stylelint-disable */
  :host {
    --size: 25rem;
    --header-spacing: var(--syn-spacing-large);
...
`;var Ts=Object.defineProperty,Cs=Object.getOwnPropertyDescriptor,De=(t,e,n,i)=>{for(var a=i>1?void 0:i?Cs(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&Ts(e,n,a),a};class Se extends w{constructor(){super(...arguments),this.hasSlotController=new J(this,"footer"),this.localize=new R(this),this.modal=new Oi(this),this.isVisible=!1,this.open=!1,this.label="",this.placement="end",this.contained=!1,this.noHeader=!1,this.handleDocumentKeyDown=e=>{this.contained||e.key==="Escape"&&this.modal.isActive()&&this.open&&(e.stopImmediatePropagation(),this.requestClose("keyboard"))}}static{this.styles=[x,ks,_s]}static{this.dependencies={"syn-icon-button":ut}}firstUpdated(){this.drawer.hidden=this.isVisible?!1:!this.open,this.open&&(this.addOpenListeners(),this.contained||(this.modal.activate(),_t(this)))}disconnectedCallback(){super.disconnectedCallback(),pt(this),this.removeOpenListeners()}requestClose(e){if(this.emit("syn-request-close",{cancelable:!0,detail:{source:e}}).defaultPrevented){const i=j(this,"drawer.denyClose",{dir:this.localize.dir()});W(this.panel,i.keyframes,i.options);return}this.hide()}addOpenListeners(){"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.contained||(this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard"))):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){document.removeEventListener("keydown",this.handleDocumentKeyDown),this.closeWatcher?.destroy()}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.contained||(this.modal.activate(),_t(this));const e=this.querySelector("[autofocus]");e&&e.removeAttribute("autofocus"),await Promise.all([Q(this.drawer),Q(this.overlay)]),this.drawer.hidden=!1,requestAnimationFrame(()=>{this.emit("syn-initial-focus",{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute("autofocus","")});const n=j(this,`drawer.show${qn(this.placement)}`,{dir:this.localize.dir()}),i=j(this,"drawer.overlay.show",{dir:this.localize.dir()});await Promise.all([W(this.panel,n.keyframes,n.options),W(this.overlay,i.keyframes,i.options)]),this.emit("syn-after-show")}else{gn(this),this.emit("syn-hide"),this.removeOpenListeners(),this.contained||(this.modal.deactivate(),pt(this)),await Promise.all([Q(this.drawer),Q(this.overlay)]);const e=j(this,`drawer.hide${qn(this.placement)}`,{dir:this.localize.dir()}),n=j(this,"drawer.overlay.hide",{dir:this.localize.dir()});await Promise.all([W(this.overlay,n.keyframes,n.options).then(()=>{this.overlay.hidden=!0}),W(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.drawer.hidden=!this.isVisible,this.overlay.hidden=!1,this.panel.hidden=!1;const i=this.originalTrigger;typeof i?.focus=="function"&&setTimeout(()=>i.focus()),this.emit("syn-after-hide")}}handleNoModalChange(){this.open&&!this.contained&&(this.modal.activate(),_t(this)),this.open&&this.contained&&(this.modal.deactivate(),pt(this))}async show(){if(!this.open)return this.open=!0,Z(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,Z(this,"syn-after-hide")}forceVisibility(e){this.isVisible=e,this.drawer.hidden=e?!1:!this.open}render(){return c`
      <div
        part="base"
    ...
    `}}De([y()],Se.prototype,"isVisible",2);De([u(".drawer")],Se.prototype,"drawer",2);De([u(".drawer__panel")],Se.prototype,"panel",2);De([u(".drawer__overlay")],Se.prototype,"overlay",2);De([r({type:Boolean,reflect:!0})],Se.prototype,"open",2);De([r({reflect:!0})],Se.prototype,"label",2);De([r({reflect:!0})],Se.prototype,"placement",2);De([r({type:Boolean,reflect:!0})],Se.prototype,"contained",2);De([r({attribute:"no-header",type:Boolean,reflect:!0})],Se.prototype,"noHeader",2);De([m("open",{waitUntilFirstUpdate:!0})],Se.prototype,"handleOpenChange",1);De([m("contained",{waitUntilFirstUpdate:!0})],Se.prototype,"handleNoModalChange",1);z("drawer.showTop",{keyframes:[{opacity:0,translate:"0 -100%"},{opacity:1,translate:"0 0"}],options:{duration:250,easing:"ease"}});z("drawer.hideTop",{keyframes:[{opacity:1,translate:"0 0"},{opacity:0,translate:"0 -100%"}],options:{duration:250,easing:"ease"}});z("drawer.showEnd",{keyframes:[{opacity:0,translate:"100%"},{opacity:1,translate:"0"}],rtlKeyframes:[{opacity:0,translate:"-100%"},{opacity:1,translate:"0"}],options:{duration:250,easing:"ease"}});z("drawer.hideEnd",{keyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"100%"}],rtlKeyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"-100%"}],options:{duration:250,easing:"ease"}});z("drawer.showBottom",{keyframes:[{opacity:0,translate:"0 100%"},{opacity:1,translate:"0 0"}],options:{duration:250,easing:"ease"}});z("drawer.hideBottom",{keyframes:[{opacity:1,translate:"0 0"},{opacity:0,translate:"0 100%"}],options:{duration:250,easing:"ease"}});z("drawer.showStart",{keyframes:[{opacity:0,translate:"-100%"},{opacity:1,translate:"0"}],rtlKeyframes:[{opacity:0,translate:"100%"},{opacity:1,translate:"0"}],options:{duration:250,easing:"ease"}});z("drawer.hideStart",{keyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"-100%"}],rtlKeyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"100%"}],options:{duration:250,easing:"ease"}});z("drawer.denyClose",{keyframes:[{scale:1},{scale:1.01},{scale:1}],options:{duration:250}});z("drawer.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});z("drawer.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});Se.define("syn-drawer");const Ss=h`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
`,zs=h`
  /* Write custom CSS here */
`;var Es=Object.defineProperty,$s=Object.getOwnPropertyDescriptor,ze=(t,e,n,i)=>{for(var a=i>1?void 0:i?$s(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&Es(e,n,a),a};class be extends w{constructor(){super(...arguments),this.localize=new R(this),this.open=!1,this.placement="bottom-start",this.disabled=!1,this.stayOpenOnSelect=!1,this.distance=0,this.skidding=0,this.hoist=!1,this.sync=void 0,this.handleKeyDown=e=>{this.open&&e.key==="Escape"&&(e.stopPropagation(),this.hide(),this.focusOnTrigger())},this.handleDocumentKeyDown=e=>{if(e.key==="Escape"&&this.open&&!this.closeWatcher){e.stopPropagation(),this.focusOnTrigger(),this.hide();return}if(e.key==="Tab"){if(this.open&&document.activeElement?.tagName.toLowerCase()==="syn-menu-item"){e.preventDefault(),this.hide(),this.focusOnTrigger();return}const n=(i,a)=>{if(!i)return null;const o=i.closest(a);if(o)return o;const s=i.getRootNode();return s instanceof ShadowRoot?n(s.host,a):null};setTimeout(()=>{const i=this.containingElement?.getRootNode()instanceof ShadowRoot?Ei():document.activeElement;(!this.containingElement||n(i,this.containingElement.tagName.toLowerCase())!==this.containingElement)&&this.hide()})}},this.handleDocumentMouseDown=e=>{const n=e.composedPath();this.containingElement&&!n.includes(this.containingElement)&&this.hide()},this.handlePanelSelect=e=>{const n=e.target;!this.stayOpenOnSelect&&n.tagName.toLowerCase()==="syn-menu"&&(this.hide(),this.focusOnTrigger())}}static{this.styles=[x,Ss,zs]}static{this.dependencies={"syn-popup":P}}connectedCallback(){super.connectedCallback(),this.containingElement||(this.containingElement=this)}firstUpdated(){this.panel.hidden=!this.open,this.open&&(this.addOpenListeners(),this.popup.active=!0)}disconnectedCallback(){super.disconnectedCallback(),this.removeOpenListeners(),this.hide()}focusOnTrigger(){const e=this.trigger.assignedElements({flatten:!0})[0];typeof e?.focus=="function"&&e.focus()}getMenu(){return this.panel.assignedElements({flatten:!0}).find(e=>e.tagName.toLowerCase()==="syn-menu")}handleTriggerClick(){this.open?this.hide():(this.show(),this.focusOnTrigger())}async handleTriggerKeyDown(e){if([" ","Enter"].includes(e.key)){e.preventDefault(),this.handleTriggerClick();return}const n=this.getMenu();if(n){const i=n.getAllItems(),a=i[0],o=i[i.length-1];["ArrowDown","ArrowUp","Home","End"].includes(e.key)&&(e.preventDefault(),this.open||(this.show(),await this.updateComplete),i.length>0&&this.updateComplete.then(()=>{(e.key==="ArrowDown"||e.key==="Home")&&(n.setCurrentItem(a),a.focus()),(e.key==="ArrowUp"||e.key==="End")&&(n.setCurrentItem(o),o.focus())}))}}handleTriggerKeyUp(e){e.key===" "&&e.preventDefault()}handleTriggerSlotChange(){this.updateAccessibleTrigger()}updateAccessibleTrigger(){const n=this.trigger.assignedElements({flatten:!0}).find(a=>hs(a).start);let i;if(n){switch(n.tagName.toLowerCase()){case"syn-button":case"syn-icon-button":i=n.button;break;default:i=n}i.setAttribute("aria-haspopup","true"),i.setAttribute("aria-expanded",this.open?"true":"false")}}async show(){if(!this.open)return this.open=!0,Z(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,Z(this,"syn-after-hide")}reposition(){this.popup.reposition()}addOpenListeners(){this.panel.addEventListener("syn-select",this.handlePanelSelect),"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide(),this.focusOnTrigger()}):this.panel.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keydown",this.handleDocumentKeyDown),document.addEventListener("mousedown",this.handleDocumentMouseDown)}removeOpenListeners(){this.panel&&(this.panel.removeEventListener("syn-select",this.handlePanelSelect),this.panel.removeEventListener("keydown",this.handleKeyDown)),document.removeEventListener("keydown",this.handleDocumentKeyDown),document.removeEventListener("mousedown",this.handleDocumentMouseDown),this.closeWatcher?.destroy()}async handleOpenChange(){if(this.disabled){this.open=!1;return}if(this.updateAccessibleTrigger(),this.open){this.emit("syn-show"),this.addOpenListeners(),await Q(this),this.panel.hidden=!1,this.popup.active=!0;const{keyframes:e,options:n}=j(this,"dropdown.show",{dir:this.localize.dir()});await W(this.popup.popup,e,n),this.emit("syn-after-show")}else{this.emit("syn-hide"),this.removeOpenListeners(),await Q(this);const{keyframes:e,options:n}=j(this,"dropdown.hide",{dir:this.localize.dir()});await W(this.popup.popup,e,n),this.panel.hidden=!0,this.popup.active=!1,this.emit("syn-after-hide")}}render(){return c`
      <syn-popup
        part="base"
    ...
    `}}ze([u(".dropdown")],be.prototype,"popup",2);ze([u(".dropdown__trigger")],be.prototype,"trigger",2);ze([u(".dropdown__panel")],be.prototype,"panel",2);ze([r({type:Boolean,reflect:!0})],be.prototype,"open",2);ze([r({reflect:!0})],be.prototype,"placement",2);ze([r({type:Boolean,reflect:!0})],be.prototype,"disabled",2);ze([r({attribute:"stay-open-on-select",type:Boolean,reflect:!0})],be.prototype,"stayOpenOnSelect",2);ze([r({attribute:!1})],be.prototype,"containingElement",2);ze([r({type:Number})],be.prototype,"distance",2);ze([r({type:Number})],be.prototype,"skidding",2);ze([r({type:Boolean})],be.prototype,"hoist",2);ze([r({reflect:!0})],be.prototype,"sync",2);ze([m("open",{waitUntilFirstUpdate:!0})],be.prototype,"handleOpenChange",1);z("dropdown.show",{keyframes:[{opacity:0,scale:.9},{opacity:1,scale:1}],options:{duration:100,easing:"ease"}});z("dropdown.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.9}],options:{duration:100,easing:"ease"}});be.define("syn-dropdown");const Os=h`
  :host {
    display: block;
  }
...
`;var Ds=Object.defineProperty,Is=Object.getOwnPropertyDescriptor,q=(t,e,n,i)=>{for(var a=i>1?void 0:i?Is(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&Ds(e,n,a),a};let F=class extends w{constructor(){super(...arguments),this.formControlController=new Le(this,{assumeInteractionOn:["syn-change"],value:t=>t.files}),this.hasSlotController=new J(this,"help-text","label"),this.localize=new R(this),this.userIsDragging=!1,this.name="",this.defaultValue="",this.size="medium",this.label="",this.helpText="",this.disabled=!1,this.droparea=!1,this.accept="",this.multiple=!1,this.webkitdirectory=!1,this.form="",this.required=!1,this.hideValue=!1}set files(t){this.input&&(this.input.files=t)}get files(){return this.input?.files}set value(t){this.input&&(this.input.value=t)}get value(){return this.input?.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(t){if(this.droparea){this.dropareaWrapper?.focus(t);return}this.button?.focus(t)}blur(){if(this.droparea){this.dropareaWrapper?.blur();return}this.button?.blur()}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}handleFiles(t){if(!t){this.value="";return}this.files=t}async handleTransferItems(t){if(!t)return this.value="",new Promise((s,l)=>{l(new Error("No proper items found"))});const n=Array.from(t).map(s=>s.webkitGetAsEntry()).map(s=>this.getFilesFromEntry(s)),a=(await Promise.all(n)).flat(),o=new DataTransfer;return Array.from(a).forEach(s=>o.items.add(s)),o.files}async getFilesFromEntry(t){return t?t.isFile?new Promise((e,n)=>{t.file(i=>e([i]),n)}):t.isDirectory?new Promise((e,n)=>{t.createReader().readEntries(a=>{Promise.all(a.map(o=>this.getFilesFromEntry(o))).then(o=>{e(o.flat())}).catch(n)})}):[]:[]}handleClick(t){t.preventDefault(),this.input.click()}handleChange(t){t.preventDefault(),t.stopPropagation(),this.emit("syn-input"),this.emit("syn-change")}handleDragOver(t){t.preventDefault(),t.stopPropagation(),this.userIsDragging=!0}handleDragLeave(t){t.preventDefault(),t.stopPropagation(),this.userIsDragging=!1}async handleDrop(t){if(t.preventDefault(),t.stopPropagation(),!t.dataTransfer)return;const e=await this.handleTransferItems(t.dataTransfer?.items);if(this.userIsDragging=!1,!e)return;if(!this.multiple&&!this.webkitdirectory&&e.length>1){this.emit("syn-error");return}if(this.hasSlotController.test("trigger"))this.handleFiles(e);else{const i=j(this.inputChosen,"file.text.disappear",{dir:this.localize.dir()}),a=j(this.inputChosen,"file.text.appear",{dir:this.localize.dir()});if(this.droparea){const o=j(this.dropareaIcon,"file.iconDrop",{dir:this.localize.dir()});W(this.dropareaIcon,o.keyframes,o.options)}await W(this.inputChosen,i.keyframes,i.options),this.handleFiles(e),await W(this.inputChosen,a.keyframes,a.options)}this.input.dispatchEvent(new Event("change"))}handleFocus(){this.emit("syn-focus")}handleBlur(){this.emit("syn-blur")}renderValue(){let t=!1,e=this.localize.term("numFilesSelected",0,this.webkitdirectory);return this.files&&this.files?.length>0&&(t=!0,e=this.files.length===1?this.files[0].name:this.localize.term("numFilesSelected",this.files.length,this.webkitdirectory)),c`
    ...
    `}renderButton(){let t=this.localize.term("fileButtonText");return this.multiple&&(t=this.localize.term("fileButtonTextMultiple")),this.webkitdirectory&&(t=this.localize.term("folderButtonText")),c`
      <div
    ...
    `}render(){const t=this.label||!!this.hasSlotController.test("label"),e=this.helpText?!0:!!this.hasSlotController.test("help-text"),n=!!this.hasSlotController.test("trigger");return c`
      <div
...
`;var Fs=Object.defineProperty,Vs=Object.getOwnPropertyDescriptor,$=(t,e,n,i)=>{for(var a=i>1?void 0:i?Vs(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&Fs(e,n,a),a};let _=class extends w{constructor(){super(...arguments),this.formControlController=new Le(this,{assumeInteractionOn:["syn-blur","syn-input"]}),this.hasSlotController=new J(this,"help-text","label","prefix","suffix"),this.localize=new R(this),this.hasFocus=!1,this.title="",this.__numberInput=Object.assign(document.createElement("input"),{type:"number"}),this.__dateInput=Object.assign(document.createElement("input"),{type:"date"}),this.type="text",this.name="",this.value="",this.defaultValue="",this.size="medium",this.label="",this.helpText="",this.clearable=!1,this.disabled=!1,this.placeholder="",this.readonly=!1,this.passwordToggle=!1,this.passwordVisible=!1,this.noSpinButtons=!1,this.form="",this.required=!1,this.spellcheck=!0}get valueAsDate(){return this.__dateInput.type=this.type,this.__dateInput.value=this.value,this.input?.valueAsDate||this.__dateInput.valueAsDate}set valueAsDate(t){this.__dateInput.type=this.type,this.__dateInput.valueAsDate=t,this.value=this.__dateInput.value}get valueAsNumber(){return this.__numberInput.value=this.value,this.input?.valueAsNumber||this.__numberInput.valueAsNumber}set valueAsNumber(t){this.__numberInput.valueAsNumber=t,this.value=this.__numberInput.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleStep(){this.handleInput(),this.input.focus()}handleStepUp(){this.stepUp(),this.handleStep()}handleStepDown(){this.stepDown(),this.handleStep()}isDecrementDisabled(){if(this.disabled||this.readonly)return!0;if(this.min===void 0||this.min===null||this.disabled)return!1;const t=typeof this.min=="string"?parseFloat(this.min):this.min;return this.valueAsNumber<=t}isIncrementDisabled(){if(this.disabled||this.readonly)return!0;if(this.max===void 0||this.max===null)return!1;const t=typeof this.max=="string"?parseFloat(this.max):this.max;return this.valueAsNumber>=t}handleChange(){this.value=this.input.value,this.emit("syn-change")}handleClearClick(t){t.preventDefault(),this.value!==""&&(this.value="",this.emit("syn-clear"),this.emit("syn-input"),this.emit("syn-change")),this.input.focus()}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleInput(){this.value=this.input.value,this.formControlController.updateValidity(),this.emit("syn-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}handleKeyDown(t){const e=t.metaKey||t.ctrlKey||t.shiftKey||t.altKey;t.key==="Enter"&&!e&&setTimeout(()=>{!t.defaultPrevented&&!t.isComposing&&this.formControlController.submit()})}handlePasswordToggle(){this.passwordVisible=!this.passwordVisible}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStepChange(){this.input.step=String(this.step),this.formControlController.updateValidity()}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(t){this.input.focus(t)}blur(){this.input.blur()}select(){this.input.select()}setSelectionRange(t,e,n="none"){this.input.setSelectionRange(t,e,n)}setRangeText(t,e,n,i="preserve"){const a=e??this.input.selectionStart,o=n??this.input.selectionEnd;this.input.setRangeText(t,a,o,i),this.value!==this.input.value&&(this.value=this.input.value)}showPicker(){"showPicker"in HTMLInputElement.prototype&&this.input.showPicker()}stepUp(){this.input.stepUp(),this.value!==this.input.value&&(this.value=this.input.value)}stepDown(){this.input.stepDown(),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("label"),e=this.hasSlotController.test("help-text"),n=this.hasSlotController.test("prefix"),i=this.hasSlotController.test("suffix"),a=this.label?!0:!!t,o=this.helpText?!0:!!e,l=this.clearable&&!this.disabled&&!this.readonly&&(typeof this.value=="number"||this.value.length>0);return c`
      ...
      >
        ...
        <div part="form-control-input" class="form-control-input">
          ...
          >
            ...
            ${this.type==="number"&&!this.noSpinButtons?c`
    ...
    `:c` <slot name="submenu" hidden></slot> `}}const Bs=h`
	/* stylelint-disable */
  :host {
    --submenu-offset: -2px;
...
`;function Us(t,e){const n={waitUntilFirstUpdated:!1,...e};return i=>class extends i{#e=!n.waitUntilFirstUpdated;updated(a){if(!this.#e){this.#e=!0;return}const o=Array.from(a).filter(([l])=>t.includes(l));if(o.length===0){super.updated(a);return}const s=o.map(([l,d])=>({attribute:l,newValue:this[l],oldValue:d}));this.emit("syn-attributes-changed",{detail:s}),super.updated(a)}}}var Ws=Object.defineProperty,qs=Object.getOwnPropertyDescriptor,Ie=(t,e,n,i)=>{for(var a=i>1?void 0:i?qs(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&Ws(e,n,a),a};let fe=class extends w{constructor(){super(...arguments),this.localize=new R(this),this.type="normal",this.checked=!1,this.value="",this.loading=!1,this.disabled=!1,this.hasSlotController=new J(this,"submenu"),this.submenuController=new Hs(this,this.hasSlotController),this.handleHostClick=t=>{this.disabled&&(t.preventDefault(),t.stopImmediatePropagation())},this.handleMouseOver=t=>{this.focus(),t.stopPropagation()}}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this.handleHostClick),this.addEventListener("mouseover",this.handleMouseOver)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.handleHostClick),this.removeEventListener("mouseover",this.handleMouseOver)}handleDefaultSlotChange(){const t=this.getTextLabel();if(typeof this.cachedTextLabel>"u"){this.cachedTextLabel=t;return}t!==this.cachedTextLabel&&(this.cachedTextLabel=t,this.emit("slotchange",{bubbles:!0,composed:!1,cancelable:!1}))}handleCheckedChange(){if(this.checked&&this.type!=="checkbox"){this.checked=!1,console.error('The checked attribute can only be used on menu items with type="checkbox"',this);return}this.type==="checkbox"?this.setAttribute("aria-checked",this.checked?"true":"false"):this.removeAttribute("aria-checked")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleTypeChange(){this.type==="checkbox"?(this.setAttribute("role","menuitemcheckbox"),this.setAttribute("aria-checked",this.checked?"true":"false")):(this.setAttribute("role","menuitem"),this.removeAttribute("aria-checked"))}getTextLabel(){return xi(this.defaultSlot)}isSubmenu(){return this.hasSlotController.test("submenu")}render(){const t=this.localize.dir()==="rtl",e=this.submenuController.isExpanded();return c`
      <div
        id="anchor"
        part="base"
...
`;class Ys extends w{static{this.styles=[x,Ks,Gs]}static{this.dependencies={"syn-divider":Xe}}render(){return c`
    ...
    `}}Ys.define("syn-menu-label");const Xs=h`
	/* stylelint-disable */
  :host {
    display: block;
    position: relative;
...
`;var Qs=Object.defineProperty,Ii=(t,e,n,i)=>{for(var a=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=s(e,n,a)||a);return a&&Qs(e,n,a),a};class Jt extends w{constructor(){super(...arguments),this.hasMenuItemsWithCheckmarks=!1,this.updateCheckMarksByChildPropChange=e=>{e.stopImmediatePropagation(),this.handleUpdateCheckmarks(this.getAllItems())}}static{this.styles=[x,Xs,Js]}handleUpdateCheckmarks(e){this.hasMenuItemsWithCheckmarks=e.some(n=>n.type==="checkbox"||n.loading)}disconnectedCallback(){this.removeEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu"),this.addEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}handleClick(e){const n=["menuitem","menuitemcheckbox"],i=e.composedPath(),a=i.find(d=>n.includes(d?.getAttribute?.("role")||""));if(!a||i.find(d=>d?.getAttribute?.("role")==="menu")!==this)return;const l=a;l.type==="checkbox"&&(l.checked=!l.checked),this.emit("syn-select",{detail:{item:l}})}handleKeyDown(e){if(e.key==="Enter"||e.key===" "){const n=this.getCurrentItem();e.preventDefault(),e.stopPropagation(),n?.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(e.key)){const n=this.getAllItems(),i=this.getCurrentItem();let a=i?n.indexOf(i):0;n.length>0&&(e.preventDefault(),e.stopPropagation(),e.key==="ArrowDown"?a++:e.key==="ArrowUp"?a--:e.key==="Home"?a=0:e.key==="End"&&(a=n.length-1),a<0&&(a=n.length-1),a>n.length-1&&(a=0),this.setCurrentItem(n[a]),n[a].focus())}}handleMouseDown(e){const n=e.target;this.isMenuItem(n)&&this.setCurrentItem(n)}handleSlotChange(){const e=this.getAllItems();this.handleUpdateCheckmarks(e),e.length>0&&this.setCurrentItem(e[0])}isMenuItem(e){return e.tagName.toLowerCase()==="syn-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes(e.getAttribute("role")??"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>!(e.inert||!this.isMenuItem(e)))}getCurrentItem(){return this.getAllItems().find(e=>e.getAttribute("tabindex")==="0")}setCurrentItem(e){this.getAllItems().forEach(i=>{i.setAttribute("tabindex",i===e?"0":"-1")})}render(){return c`
      ...
      ></slot>
    `}}Ii([u("slot")],Jt.prototype,"defaultSlot");Ii([y()],Jt.prototype,"hasMenuItemsWithCheckmarks");Jt.define("syn-menu");const Zs=h`
  /**
...
`;var er=Object.defineProperty,tr=Object.getOwnPropertyDescriptor,pe=(t,e,n,i)=>{for(var a=i>1?void 0:i?tr(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&er(e,n,a),a};class ae extends w{constructor(){super(...arguments),this.hasSlotController=new J(this,"[default]","children","prefix","suffix"),this.hasFocus=!1,this.showPrefixOnly=!1,this.currentMarkedChild=!1,this.isMultiLine=!1,this.rel="noreferrer noopener",this.current=!1,this.disabled=!1,this.horizontal=!1,this.chevron=!1,this.open=!1,this.divider=!1}static{this.styles=[x,Zs]}static{this.dependencies={"syn-divider":Xe}}isButton(){return!this.href&&!this.hasSlotController.test("children")}isLink(){return!!this.href&&!this.hasSlotController.test("children")}isAccordion(){return this.hasSlotController.test("children")}getNavItemChildren(e){return Array.from(e?.assignedElements({flatten:!0})||[]).map(n=>n.tagName.toLowerCase()==="syn-nav-item"?n:Array.from(n.querySelectorAll(":scope > syn-nav-item"))).flat()}getAllNestedNavItems(e){const n=this.getNavItemChildren(e),i=n.map(a=>a.getAllNestedNavItems(a.childrenSlot)).flat();return n.concat(i)}handleCurrentMarkedChild(){const e=this.closest("syn-side-nav");(!this.open||e?.variant==="rail")&&(this.currentMarkedChild=this.getAllNestedNavItems(this.childrenSlot).some(n=>n.current))}handleClickButton(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}handleClickSummary(e){e.preventDefault(),e.stopPropagation(),!this.disabled&&(this.open?this.hideDetails():this.showDetails())}hideDetails(){this.open=!1,this.emit("syn-hide",{cancelable:!0})}showDetails(){this.open=!0,this.emit("syn-show",{cancelable:!0})}handleSlotChange(){const e=getComputedStyle(this);if(e.length===0){setTimeout(()=>{this.handleSlotChange()});return}this.handleCurrentMarkedChild();const i=e.getPropertyValue("--indentation"),a=Math.min(parseInt(i,10)+1,2);this.getNavItemChildren(this.childrenSlot).forEach(o=>{o.style.setProperty("--indentation",a.toFixed(0))})}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleWidth(e){e.forEach(n=>{requestAnimationFrame(()=>{if(n.contentRect.width<100){const i=this.hasSlotController.test("prefix");this.showPrefixOnly=i}else this.showPrefixOnly=!1;n.contentRect.height>48?this.isMultiLine=!0:this.isMultiLine=!1})})}handleHorizontalChange(){this.horizontal?this.resizeObserver.disconnect():this.resizeObserver.observe(this)}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>this.handleWidth(e)),this.horizontal||this.resizeObserver.observe(this)}firstUpdated(e){super.firstUpdated(e),this.mutationObserver=new MutationObserver(()=>{this.childrenSlot&&this.handleCurrentMarkedChild()}),this.mutationObserver.observe(this,{attributeFilter:["current","open"],childList:!0,subtree:!0})}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect(),this.mutationObserver?.disconnect()}blur(){this.control.blur()}click(){this.control.click()}focus(e){this.control.focus(e)}render(){const e=this.isButton(),n=this.isLink(),i=this.isAccordion(),a=this.closest("syn-side-nav"),o=this.currentMarkedChild&&!this.open||this.currentMarkedChild&&this.open&&a?.variant==="rail"&&!a?.open;let s=kt`button`;i?s=kt`summary`:n&&(s=kt`a`);const l=(this.chevron||i)&&!this.horizontal;let d;i?d=this.handleClickSummary:e&&(d=this.handleClickButton);const p=T`
      <${s}
        ...
        @click=${d}
        ?disabled=${b(n?void 0:this.disabled)}
        @focus=${this.handleFocus}
        href=${b(n?this.href:void 0)}
        part="base"
        role=${n?"link":"button"}
        rel=${b(n?this.rel:void 0)}
        tabindex=${this.disabled?"-1":"0"}
        target=${b(n?this.target:void 0)}
      >

        ${this.divider&&!this.horizontal?T`<syn-divider class="divider" part="divider"></syn-divider>`:""}
    ...
    `:p}}pe([y()],ae.prototype,"hasFocus",2);pe([y()],ae.prototype,"showPrefixOnly",2);pe([y()],ae.prototype,"currentMarkedChild",2);pe([y()],ae.prototype,"isMultiLine",2);pe([u('slot[name="children"]')],ae.prototype,"childrenSlot",2);pe([u(".nav-item")],ae.prototype,"control",2);pe([r({reflect:!0,type:String})],ae.prototype,"href",2);pe([r()],ae.prototype,"target",2);pe([r()],ae.prototype,"rel",2);pe([r({reflect:!0,type:Boolean})],ae.prototype,"current",2);pe([r({reflect:!0,type:Boolean})],ae.prototype,"disabled",2);pe([r({reflect:!0,type:Boolean})],ae.prototype,"horizontal",2);pe([r({reflect:!0,type:Boolean})],ae.prototype,"chevron",2);pe([r({reflect:!0,type:Boolean})],ae.prototype,"open",2);pe([r({reflect:!0,type:Boolean})],ae.prototype,"divider",2);pe([m("horizontal",{waitUntilFirstUpdate:!0})],ae.prototype,"handleHorizontalChange",1);ae.define("syn-nav-item");const nr=h`
  :host {
    --display-divider: block;
  }
...
`;var ir=Object.defineProperty,_n=(t,e,n,i)=>{for(var a=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=s(e,n,a)||a);return a&&ir(e,n,a),a};const Gn=(t,e)=>{t.disabled?t.dataset.originallyDisabled="true":delete t.dataset.originallyDisabled,e&&(t.disabled=!0)};class Qt extends w{constructor(){super(...arguments),this.hasSlotController=new J(this,"[default]","prefix","suffix","label"),this.disabled=!1,this.label=""}static{this.styles=nr}static{this.dependencies={"syn-divider":Xe}}enableObserver(){this.mutationObserver.observe(this,{attributeFilter:["disabled"],childList:!0,subtree:!0})}connectedCallback(){super.connectedCallback(),this.mutationObserver=new MutationObserver(e=>{const n=e.filter(o=>o.target===this),i=e.filter(o=>o.target.matches("syn-option")),a=n.length>0||i.length>0;a&&this.mutationObserver.disconnect(),i.length>0&&i.forEach(o=>{Gn(o.target,this.disabled)}),n.length>0&&n.forEach(o=>{o.type==="attributes"&&this.assignedOptions.forEach(s=>{s.disabled=this.disabled?!0:!!s.dataset?.originallyDisabled}),o.type==="childList"&&o.addedNodes.forEach(s=>{s instanceof HTMLElement&&s.matches("syn-option")&&Gn(s,this.disabled)})}),a&&this.updateComplete.then(()=>{this.enableObserver()})}),this.enableObserver()}render(){const{disabled:e}=this,n=this.hasSlotController.test("label"),i=this.label?!0:!!n;return T`
      <div
    ...
    `}}_n([Dt({selector:"syn-option"})],Qt.prototype,"assignedOptions");_n([r({reflect:!0,type:Boolean})],Qt.prototype,"disabled");_n([r()],Qt.prototype,"label");Qt.define("syn-optgroup");$e.define("syn-option");P.define("syn-popup");const ar=h`
  :host {
    display: block;
...
`,Yn=t=>Array.from(t.assignedElements({flatten:!0})),or=t=>t.tagName.toLocaleLowerCase()==="syn-nav-item"||(t.getAttribute("role")??"")==="menuitem",Xn=t=>t.filter(or),sr=t=>{t.setAttribute("horizontal","true"),t.removeAttribute("slot"),t.removeAttribute("tabindex"),t.dataset.originalRole?t.setAttribute("role",t.dataset.originalRole):t.removeAttribute("role")},rr=t=>{t.removeAttribute("horizontal"),t.setAttribute("slot","menu"),t.setAttribute("role","menuitem")};var lr=Object.defineProperty,Je=(t,e,n,i)=>{for(var a=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=s(e,n,a)||a);return a&&lr(e,n,a),a};class Ue extends w{constructor(){super(...arguments),this.localize=new R(this),this.itemPositionsCached=!1,this.amountOfNavItems=0,this.amountOfVisibleItems=0,this.hasItemsInDropdown=!1}static{this.styles=[x,ar]}static{this.dependencies={"syn-dropdown":be,"syn-icon":ye,"syn-menu":Jt,"syn-nav-item":ae}}getSlottedNavItems(){const e=Xn(Yn(this.defaultSlot)),n=Xn(Yn(this.menuSlot));return e.concat(n)}cacheItemPositions(e){const{left:n}=this.horizontalNav.getBoundingClientRect();e.forEach(i=>{i.removeAttribute("slot");const{right:a}=i.getBoundingClientRect();i.dataset.right=(a-n).toString()}),this.itemPositionsCached=!0}handlePriorityMenu(){const e=this.getSlottedNavItems();this.itemPositionsCached||this.cacheItemPositions(e);const{width:n}=this.horizontalNav.getBoundingClientRect(),i=this.priorityMenu.classList.contains("priority-menu--hidden")?0:this.priorityMenu.clientWidth,a=n-i;let o;const s=e.at(-1),l=e.map(g=>{const C=g===s?n:a,Y=!!(o||parseFloat(g.dataset.right)>C);return Y&&!o&&(o=parseFloat(g.dataset.right)),{isHidden:Y,item:g}}),d=l.filter(({isHidden:g})=>!g).length,p=d===1;l.forEach(({item:g,isHidden:C})=>{C||p?rr(g):sr(g)}),this.hasItemsInDropdown=d!==e.length,this.amountOfVisibleItems=p?0:d}renderPriorityMenu(){return T`
      <syn-dropdown
...
`;var pr=Object.defineProperty,Tn=(t,e,n,i)=>{for(var a=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=s(e,n,a)||a);return a&&pr(e,n,a),a};class Zt extends w{constructor(){super(...arguments),this.localize=new R(this),this.value=0,this.indeterminate=!1,this.label=""}static{this.styles=[x,dr,cr]}render(){return c`
      <div
        part="base"
    ...
    `}}Tn([r({type:Number,reflect:!0})],Zt.prototype,"value");Tn([r({type:Boolean,reflect:!0})],Zt.prototype,"indeterminate");Tn([r()],Zt.prototype,"label");Zt.define("syn-progress-bar");const hr=h`
	/* stylelint-disable */
  :host {
    --size: 128px;
    --track-width: 4px;
...
`;var mr=Object.defineProperty,en=(t,e,n,i)=>{for(var a=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=s(e,n,a)||a);return a&&mr(e,n,a),a};class Mt extends w{constructor(){super(...arguments),this.localize=new R(this),this.value=0,this.label=""}static{this.styles=[x,hr,ur]}updated(e){if(super.updated(e),e.has("value")){const n=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),i=2*Math.PI*n,a=i-this.value/100*i;this.indicatorOffset=`${a}px`}}render(){return c`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
    ...
    `}}en([u(".progress-ring__indicator")],Mt.prototype,"indicator");en([y()],Mt.prototype,"indicatorOffset");en([r({type:Number,reflect:!0})],Mt.prototype,"value");en([r()],Mt.prototype,"label");Mt.define("syn-progress-ring");const fr=h`
	/* stylelint-disable */
  ${Ci}
...
`;var yr=Object.defineProperty,br=Object.getOwnPropertyDescriptor,Fe=(t,e,n,i)=>{for(var a=i>1?void 0:i?br(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&yr(e,n,a),a};let Ce=class extends w{constructor(){super(...arguments),this.hasSlotController=new J(this,"[default]","prefix","suffix"),this.hasFocus=!1,this.checked=!1,this.disabled=!1,this.size="medium",this.pill=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","presentation")}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleClick(t){if(this.disabled){t.preventDefault(),t.stopPropagation();return}this.checked=!0}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}focus(t){this.input.focus(t)}blur(){this.input.blur()}render(){return T`
    ...
    `}};Ce.styles=[x,fr];Fe([u(".button")],Ce.prototype,"input",2);Fe([u(".hidden-input")],Ce.prototype,"hiddenInput",2);Fe([y()],Ce.prototype,"hasFocus",2);Fe([r({type:Boolean,reflect:!0})],Ce.prototype,"checked",2);Fe([r()],Ce.prototype,"value",2);Fe([r({type:Boolean,reflect:!0})],Ce.prototype,"disabled",2);Fe([r({reflect:!0})],Ce.prototype,"size",2);Fe([r({type:Boolean,reflect:!0})],Ce.prototype,"pill",2);Fe([m("disabled",{waitUntilFirstUpdate:!0})],Ce.prototype,"handleDisabledChange",1);Ce=Fe([ie("SynRadioButton")],Ce);Ce.define("syn-radio-button");const gr=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`;var wr=Object.defineProperty,xr=Object.getOwnPropertyDescriptor,ge=(t,e,n,i)=>{for(var a=i>1?void 0:i?xr(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&wr(e,n,a),a};let ne=class extends w{constructor(){super(...arguments),this.formControlController=new Le(this),this.hasSlotController=new J(this,"help-text","label"),this.customValidityMessage="",this.hasButtonGroup=!1,this.errorMessage="",this.defaultValue="",this.label="",this.helpText="",this.name="option",this.value="",this.size="medium",this.form="",this.required=!1}get validity(){const t=this.required&&!this.value;return this.customValidityMessage!==""?Ti:t?Co:Nt}get validationMessage(){const t=this.required&&!this.value;return this.customValidityMessage!==""?this.customValidityMessage:t?this.validationInput.validationMessage:""}connectedCallback(){super.connectedCallback(),this.defaultValue=this.value}firstUpdated(){this.formControlController.updateValidity()}getAllRadios(){return[...this.querySelectorAll("syn-radio, syn-radio-button")]}handleRadioClick(t){const e=t.target.closest("syn-radio, syn-radio-button"),n=this.getAllRadios(),i=this.value;!e||e.disabled||(this.value=e.value,n.forEach(a=>a.checked=a===e),this.value!==i&&(this.emit("syn-change"),this.emit("syn-input")))}handleKeyDown(t){if(!["ArrowUp","ArrowDown","ArrowLeft","ArrowRight"," "].includes(t.key))return;const e=this.getAllRadios().filter(s=>!s.disabled),n=e.find(s=>s.checked)??e[0],i=t.key===" "?0:["ArrowUp","ArrowLeft"].includes(t.key)?-1:1,a=this.value;let o=e.indexOf(n)+i;o<0&&(o=e.length-1),o>e.length-1&&(o=0),this.getAllRadios().forEach(s=>{s.checked=!1,this.hasButtonGroup||s.setAttribute("tabindex","-1")}),this.value=e[o].value,e[o].checked=!0,this.hasButtonGroup?e[o].shadowRoot.querySelector("button").focus():(e[o].setAttribute("tabindex","0"),e[o].focus()),this.value!==a&&(this.emit("syn-change"),this.emit("syn-input")),t.preventDefault()}handleLabelClick(){this.focus()}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}async syncRadioElements(){const t=this.getAllRadios();if(await Promise.all(t.map(async e=>{await e.updateComplete,e.checked=e.value===this.value,e.size=this.size})),this.hasButtonGroup=t.some(e=>e.tagName.toLowerCase()==="syn-radio-button"),t.length>0&&!t.some(e=>e.checked))if(this.hasButtonGroup){const e=t[0].shadowRoot?.querySelector("button");e&&e.setAttribute("tabindex","0")}else t[0].setAttribute("tabindex","0");if(this.hasButtonGroup){const e=this.shadowRoot?.querySelector("syn-button-group");e&&(e.disableRole=!0)}}syncRadios(){if(customElements.get("syn-radio")&&customElements.get("syn-radio-button")){this.syncRadioElements();return}customElements.get("syn-radio")?this.syncRadioElements():customElements.whenDefined("syn-radio").then(()=>this.syncRadios()),customElements.get("syn-radio-button")?this.syncRadioElements():customElements.whenDefined("syn-radio-button").then(()=>this.syncRadios())}updateCheckedRadio(){this.getAllRadios().forEach(e=>e.checked=e.value===this.value),this.formControlController.setValidity(this.validity.valid)}handleSizeChange(){this.syncRadios()}handleValueChange(){this.hasUpdated&&this.updateCheckedRadio()}checkValidity(){const t=this.required&&!this.value,e=this.customValidityMessage!=="";return t||e?(this.formControlController.emitInvalidEvent(),!1):!0}getForm(){return this.formControlController.getForm()}reportValidity(){const t=this.validity.valid;return this.errorMessage=this.customValidityMessage||t?"":this.validationInput.validationMessage,this.formControlController.setValidity(t),this.validationInput.hidden=!0,clearTimeout(this.validationTimeout),t||(this.validationInput.hidden=!1,this.validationInput.reportValidity(),this.validationTimeout=setTimeout(()=>this.validationInput.hidden=!0,1e4)),t}setCustomValidity(t=""){this.customValidityMessage=t,this.errorMessage=t,this.validationInput.setCustomValidity(t),this.formControlController.updateValidity()}focus(t){const e=this.getAllRadios(),n=e.find(o=>o.checked),i=e.find(o=>!o.disabled),a=n||i;a&&a.focus(t)}render(){const t=this.hasSlotController.test("label"),e=this.hasSlotController.test("help-text"),n=this.label?!0:!!t,i=this.helpText?!0:!!e,a=c`
    ...
    `}};ne.styles=[x,Be,gr,Re,vr];ne.dependencies={"syn-button-group":It};ge([u("slot:not([name])")],ne.prototype,"defaultSlot",2);ge([u(".radio-group__validation-input")],ne.prototype,"validationInput",2);ge([y()],ne.prototype,"hasButtonGroup",2);ge([y()],ne.prototype,"errorMessage",2);ge([y()],ne.prototype,"defaultValue",2);ge([r()],ne.prototype,"label",2);ge([r({attribute:"help-text"})],ne.prototype,"helpText",2);ge([r()],ne.prototype,"name",2);ge([r({reflect:!0})],ne.prototype,"value",2);ge([r({reflect:!0})],ne.prototype,"size",2);ge([r({reflect:!0})],ne.prototype,"form",2);ge([r({type:Boolean,reflect:!0})],ne.prototype,"required",2);ge([m("size",{waitUntilFirstUpdate:!0})],ne.prototype,"handleSizeChange",1);ge([m("value")],ne.prototype,"handleValueChange",1);ne=ge([ie("SynRadioGroup")],ne);ne.define("syn-radio-group");const kr=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`;var Tr=Object.defineProperty,Cr=Object.getOwnPropertyDescriptor,Qe=(t,e,n,i)=>{for(var a=i>1?void 0:i?Cr(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&Tr(e,n,a),a};let Ee=class extends w{constructor(){super(),this.checked=!1,this.hasFocus=!1,this.size="medium",this.disabled=!1,this.handleBlur=()=>{this.hasFocus=!1,this.emit("syn-blur")},this.handleClick=()=>{this.disabled||(this.checked=!0)},this.handleFocus=()=>{this.hasFocus=!0,this.emit("syn-focus")},this.addEventListener("blur",this.handleBlur),this.addEventListener("click",this.handleClick),this.addEventListener("focus",this.handleFocus)}connectedCallback(){super.connectedCallback(),this.setInitialAttributes()}setInitialAttributes(){this.setAttribute("role","radio"),this.setAttribute("tabindex","-1"),this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleCheckedChange(){this.setAttribute("aria-checked",this.checked?"true":"false"),this.setAttribute("tabindex",this.checked?"0":"-1")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}render(){return c`
      ...
      >
        <span part="${`control${this.checked?" control--checked":""}`}" class="radio__control">
          ${this.checked?c` <syn-icon part="checked-icon" class="radio__checked-icon" library="system" name="radio"></syn-icon> `:""}
        </span>

        <slot part="label" class="radio__label"></slot>
      </span>
    `}};Ee.styles=[x,kr,_r];Ee.dependencies={"syn-icon":ye};Qe([y()],Ee.prototype,"checked",2);Qe([y()],Ee.prototype,"hasFocus",2);Qe([r()],Ee.prototype,"value",2);Qe([r({reflect:!0})],Ee.prototype,"size",2);Qe([r({type:Boolean,reflect:!0})],Ee.prototype,"disabled",2);Qe([m("checked")],Ee.prototype,"handleCheckedChange",1);Qe([m("disabled",{waitUntilFirstUpdate:!0})],Ee.prototype,"handleDisabledChange",1);Ee=Qe([ie("SynRadio")],Ee);Ee.define("syn-radio");const Sr=h`
  :host {
...
`;var zr=Object.defineProperty,Er=(t,e,n,i)=>{for(var a=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=s(e,n,a)||a);return a&&zr(e,n,a),a};class Ni extends w{constructor(){super(...arguments),this.subdivision=!1}static{this.styles=[x,Sr]}render(){return c`
      <div
    ...
    `}}Er([r({reflect:!0,type:Boolean})],Ni.prototype,"subdivision");Ni.define("syn-range-tick");const $r=h`
	/* stylelint-disable */
  :host {
    --max-width: 20rem;
    --hide-delay: 0ms;
...
`;var Dr=Object.defineProperty,Ir=Object.getOwnPropertyDescriptor,ke=(t,e,n,i)=>{for(var a=i>1?void 0:i?Ir(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&Dr(e,n,a),a};class he extends w{constructor(){super(),this.localize=new R(this),this.content="",this.placement="top",this.disabled=!1,this.distance=13,this.open=!1,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleBlur=()=>{this.hasTrigger("focus")&&this.hide()},this.handleClick=()=>{this.hasTrigger("click")&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger("focus")&&this.show()},this.handleDocumentKeyDown=e=>{e.key==="Escape"&&(e.stopPropagation(),this.hide())},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){const e=jn(getComputedStyle(this).getPropertyValue("--show-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.show(),e)}},this.handleMouseOut=()=>{if(this.hasTrigger("hover")){const e=jn(getComputedStyle(this).getPropertyValue("--hide-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.hide(),e)}},this.addEventListener("blur",this.handleBlur,!0),this.addEventListener("focus",this.handleFocus,!0),this.addEventListener("click",this.handleClick),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}static{this.styles=[x,$r,Or]}static{this.dependencies={"syn-popup":P}}disconnectedCallback(){super.disconnectedCallback(),this.closeWatcher?.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(e){return this.trigger.split(" ").includes(e)}async handleOpenChange(){if(this.open){if(this.disabled)return;this.emit("syn-show"),"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide()}):document.addEventListener("keydown",this.handleDocumentKeyDown),await Q(this.body),this.body.hidden=!1,this.popup.active=!0;const{keyframes:e,options:n}=j(this,"tooltip.show",{dir:this.localize.dir()});await W(this.popup.popup,e,n),this.popup.reposition(),this.emit("syn-after-show")}else{this.emit("syn-hide"),this.closeWatcher?.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown),await Q(this.body);const{keyframes:e,options:n}=j(this,"tooltip.hide",{dir:this.localize.dir()});await W(this.popup.popup,e,n),this.popup.active=!1,this.body.hidden=!0,this.emit("syn-after-hide")}}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,Z(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,Z(this,"syn-after-hide")}render(){return c`
      <syn-popup
        part="base"
        exportparts="
          popup:base__popup,
    ...
    `}}ke([u("slot:not([name])")],he.prototype,"defaultSlot",2);ke([u(".tooltip__body")],he.prototype,"body",2);ke([u("syn-popup")],he.prototype,"popup",2);ke([r()],he.prototype,"content",2);ke([r()],he.prototype,"placement",2);ke([r({type:Boolean,reflect:!0})],he.prototype,"disabled",2);ke([r({type:Number})],he.prototype,"distance",2);ke([r({type:Boolean,reflect:!0})],he.prototype,"open",2);ke([r({type:Number})],he.prototype,"skidding",2);ke([r()],he.prototype,"trigger",2);ke([r({type:Boolean})],he.prototype,"hoist",2);ke([m("open",{waitUntilFirstUpdate:!0})],he.prototype,"handleOpenChange",1);ke([m(["content","distance","hoist","placement","skidding"])],he.prototype,"handleOptionsChange",1);ke([m("disabled")],he.prototype,"handleDisabledChange",1);z("tooltip.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:150,easing:"ease"}});z("tooltip.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:150,easing:"ease"}});const it=(t,e)=>t-e,Et=(t,e)=>{if(t.length!==e.length)return!0;const n=t.slice().sort(it),i=e.slice().sort(it);for(let a=0;a<n.length;a+=1)if(n[a]!==i[a])return!0;return!1},Ai=(t,e,n)=>{const i=t.getBoundingClientRect(),a=i.width;if(a<=0)return 0;let o=e;return o-=i.left,o<=0?n?1:0:o>=a?n?0:1:(o/=a,n?1-o:o)},Nr=h`
  :host {
    /*
...
`;var Ar=Object.defineProperty,Mr=Object.getOwnPropertyDescriptor,Mi=t=>{throw TypeError(t)},te=(t,e,n,i)=>{for(var a=i>1?void 0:i?Mr(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&Ar(e,n,a),a},Cn=(t,e,n)=>e.has(t)||Mi("Cannot "+n),v=(t,e,n)=>(Cn(t,e,"read from private field"),n?n.call(t):e.get(t)),nt=(t,e,n)=>e.has(t)?Mi("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,n),we=(t,e,n,i)=>(Cn(t,e,"write to private field"),e.set(t,n),n),V=(t,e,n)=>(Cn(t,e,"access private method"),n),M,se,$t,dt,Bt,at,O,Ot,Sn,Pi,zn,Li,ji,Rt,Pt,Lt,Fi,Vi,ft,Hi,Bi,Ri;let K=class extends w{constructor(){super(),nt(this,O),this.name="",this.label="",this.helpText="",this.disabled=!1,this.min=0,this.max=100,this.step=1,this.size="medium",this.tooltipPlacement="top",this.restrictMovement=!1,this.defaultValue="0",this.form="",this.hasSlotController=new J(this,"help-text","label","prefix","suffix","ticks"),this.formControlController=new Le(this,{assumeInteractionOn:["syn-change"]}),this.localize=new R(this),nt(this,M,[0]),nt(this,se,new Map),nt(this,$t,!1),nt(this,dt,""),nt(this,Bt),nt(this,at,[]),this.tooltipFormatter=this.localize.number.bind(this.localize)}set value(t){we(this,M,t?t.split(" ").map(Number).sort(it):[])}get value(){return v(this,M).slice().sort(it).join(" ")}set valueAsArray(t){const e=v(this,M);we(this,M,Array.isArray(t)?t.slice().sort(it):t||[]),Et(e,v(this,M))&&this.requestUpdate("value",e.join(" "))}get valueAsArray(){return[...v(this,M)].sort(it)}disconnectedCallback(){super.disconnectedCallback(),this?.visibilityObserver?.disconnect()}firstUpdated(){this.visibilityObserver=new IntersectionObserver(t=>{const e=t.at(0);e&&e.isIntersecting&&e.target.checkVisibility()&&V(this,O,Ri).call(this,e.boundingClientRect.height)},{root:this.ticks.parentElement}),this.visibilityObserver.observe(this.ticks),this.formControlController.updateValidity(),we(this,at,Array.from(v(this,M))),this.thumbs.forEach(t=>{const e=t.parentElement;e.updateComplete.then(()=>{e.shadowRoot.querySelector(".tooltip__body")?.setAttribute("aria-hidden","true")})})}willUpdate(t){super.willUpdate(t),this.min>this.max&&([this.min,this.max]=[this.max,this.min]),this.step>this.max-this.min&&(this.step=this.max-this.min),this.step<=0&&(this.step=1);const e=v(this,M).map(n=>{if(n<=this.min)return this.min;if(n>=this.max)return this.max;const i=this.min+this.step*Math.round((n-this.min)/this.step);return i>this.max?this.max:i});Et(v(this,M),e)&&we(this,M,e)}updated(t){super.updated(t);for(const e of this.thumbs){const n=+e.dataset.rangeId;v(this,se).has(n)&&V(this,O,Pt).call(this,e,v(this,se).get(n))}V(this,O,Lt).call(this)}focus(t){const e=this.thumbs.item(0);e?e.focus(t):super.focus(t)}checkValidity(){if(this.disabled)return!0;const t=!v(this,dt);return t||this.formControlController.emitInvalidEvent(),t}reportValidity(){if(this.disabled)return!0;const t=this.validity.valid;return this.formControlController.setValidity(t),this.validationInput.hidden=!0,clearTimeout(v(this,Bt)),t||(this.validationInput.hidden=!1,this.validationInput.reportValidity(),we(this,Bt,setTimeout(()=>{this.validationInput.hidden=!0},1e4))),t}setCustomValidity(t){we(this,dt,t),this.validationInput.setCustomValidity(t),this.formControlController.updateValidity()}getForm(){return this.formControlController.getForm()}get validity(){return v(this,dt)?Ti:Nt}get validationMessage(){return v(this,dt)}renderThumbs(t){const e=v(this,M).length>1;return v(this,se).clear(),v(this,M).map((n,i)=>{const a=i+1;v(this,se).set(a,n);const o=`thumb-${a}`;let s="",l="";return e?(l=t?`label aria-label-hidden ${o}`:`aria-label-hidden ${o}`,i===0?s=`${this.localize.term("rangeMin")} (${this.tooltipFormatter(n)})`:i===v(this,M).length-1?s=`${this.localize.term("rangeMax")} (${this.tooltipFormatter(n)})`:s=this.tooltipFormatter(n)):l=t?"label aria-label-hidden":"",c`
        <syn-tooltip
        ...
        >
          <div
            ...
            @pointerup=${V(this,O,Rt)}
            @pointercancel=${V(this,O,Rt)}
            @pointerleave=${V(this,O,Rt)}
            @keydown=${V(this,O,Fi)}
            @focus=${V(this,O,Hi)}
          ></div>
        </syn-tooltip>
      `})}render(){const t=this.hasSlotController.test("label"),e=this.hasSlotController.test("help-text"),n=this.hasSlotController.test("prefix"),i=this.hasSlotController.test("suffix"),a=this.label?!0:!!t,o=this.helpText?!0:!!e;return c`
      <div
        part="form-control"
        class=${f({"form-control":!0,"form-control--has-help-text":o,"form-control--has-label":a,"form-control--has-prefix":n,"form-control--has-suffix":i,"form-control--is-disabled":this.disabled,"form-control--large":this.size==="large","form-control--medium":this.size==="medium","form-control--small":this.size==="small"})}
    ...
    `}};M=new WeakMap;se=new WeakMap;$t=new WeakMap;dt=new WeakMap;Bt=new WeakMap;at=new WeakMap;O=new WeakSet;Ot=function(){return this.localize.dir()==="rtl"};Sn=function(t,e=!0){if(this.disabled)return;const{clientX:n}=t,i=Array.from(this.thumbs),a=Ai(this.baseDiv,n,v(this,O,Ot)),o=this.step/(this.max-this.min),s=this.min+this.step*Math.round(a/o),l=i.reduce((C,Y)=>{const qe=v(this,se).get(+Y.dataset.rangeId),Ne=v(this,se).get(+C.dataset.rangeId),He=Math.abs(qe-s),et=Math.abs(Ne-s);return He===et?qe<s?Y:C:He<et?Y:C}),d=+l.dataset.rangeId;if(!d)return;v(this,se).set(d,s),V(this,O,Pt).call(this,l,s);const p=v(this,M);we(this,M,Array.from(v(this,se).values())),V(this,O,Lt).call(this),Et(p,v(this,M))&&(we(this,at,Array.from(v(this,M))),this.emit("syn-input"),this.emit("syn-change"));const g=new PointerEvent("pointerdown",t);e&&l.dispatchEvent(g)&&V(this,O,ft).call(this,l)};Pi=function(t){V(this,O,Sn).call(this,t,!1)};zn=function(t,e){const n=this.valueAsArray,a=Array.from(this.thumbs).indexOf(t),o=n[a-1]||this.min,s=n[a+1]||this.max,l=e<o||e>s;return{finalValue:Math.max(o,Math.min(s,e)),isRestricted:l,nextValue:s,prevValue:o}};Li=async function(t){if(this.disabled)return;const e=t.target;V(this,O,ft).call(this,e),e.dataset.pointerId&&e.releasePointerCapture(+e.dataset.pointerId),e.dataset.pointerId=t.pointerId.toString(),e.setPointerCapture(t.pointerId),e.classList.add("grabbed"),await e.parentElement.show()};ji=function(t){if(this.disabled)return;const e=t.target,n=+e.dataset.rangeId;if(!v(this,se).has(n)||(e.dataset.pointerId?+e.dataset.pointerId:null)!==t.pointerId)return;const a=Ai(this.baseDiv,t.clientX,v(this,O,Ot)),o=this.step/(this.max-this.min);let s=this.min+this.step*Math.round(a/o);if(this.emit("syn-move",{cancelable:!0,detail:{element:e,value:s}}).defaultPrevented)return;if(this.restrictMovement){const p=V(this,O,zn).call(this,e,s);p.isRestricted?(s=p.finalValue,e.style.zIndex=(3+this.thumbs.length).toFixed(0)):e.style.zIndex="3"}v(this,se).set(n,s),V(this,O,Pt).call(this,e,s);const d=v(this,M);we(this,M,Array.from(v(this,se).values())),V(this,O,Lt).call(this),Et(d,v(this,M))&&this.emit("syn-input")};Rt=async function(t){const e=t.target;!e.dataset.pointerId||t.pointerId!==+e.dataset.pointerId||(e.classList.remove("grabbed"),e.releasePointerCapture(t.pointerId),delete e.dataset.pointerId,Et(v(this,at),v(this,M))&&(we(this,at,Array.from(v(this,M))),this.emit("syn-change")),await e.parentElement.hide())};Pt=function(t,e){t.setAttribute("aria-valuenow",e.toString()),t.setAttribute("aria-valuetext",this.tooltipFormatter(e));const n=(e-this.min)/(this.max-this.min);t.style.insetInlineStart=`calc(${100*n}% - var(--half-thumb-size))`,V(this,O,ft).call(this,t)};Lt=function(){const{activeTrack:t}=this;if(!t)return;if(this.min===this.max){t.style.insetInlineStart="0%",t.style.insetInlineEnd="0%";return}if(v(this,M).length===1){const a=getComputedStyle(this).getPropertyValue("--track-active-offset")||"0%",o=100*(v(this,M)[0]-this.min)/(this.max-this.min);t.style.insetInlineStart=`min(${a}, ${o}%)`,t.style.insetInlineEnd=`min(calc(100% - ${a}), calc(100% - ${o}%))`;return}const e=v(this,M).slice().sort(it),n=100*(e[0]-this.min)/(this.max-this.min),i=100*(e[e.length-1]-this.min)/(this.max-this.min);t.style.insetInlineStart=`${n}%`,t.style.insetInlineEnd=`calc(100% - ${i}%)`};Fi=function(t){const e=t.target,n=+e.dataset.rangeId,i=v(this,se).get(n);if(i===void 0)return;let a=i;switch(t.key){case"ArrowUp":case"Up":a=Math.min(i+this.step,this.max);break;case"ArrowDown":case"Down":a=Math.max(i-this.step,this.min);break;case"ArrowLeft":case"Left":a=v(this,O,Ot)?Math.min(i+this.step,this.max):Math.max(i-this.step,this.min);break;case"ArrowRight":case"Right":a=v(this,O,Ot)?Math.max(i-this.step,this.min):Math.min(i+this.step,this.max);break;case"PageUp":a=Math.min(i+(this.max-this.min)/5,this.max);break;case"PageDown":a=Math.max(i-(this.max-this.min)/5,this.min);break;case"Home":a=this.min;break;case"End":a=this.max;break;default:return}if(a!==i){if(this.emit("syn-move",{cancelable:!0,detail:{element:e,value:a}}).defaultPrevented)return;if(this.restrictMovement){const s=V(this,O,zn).call(this,e,a);s.isRestricted&&(a=s.finalValue)}V(this,O,Pt).call(this,e,a),v(this,se).set(n,a),we(this,M,Array.from(v(this,se).values())),V(this,O,Lt).call(this),V(this,O,ft).call(this,e),we(this,at,Array.from(v(this,M))),this.emit("syn-input"),this.emit("syn-change")}t.stopPropagation(),t.preventDefault()};Vi=function(t){t.relatedTarget&&this.shadowRoot?.contains(t.relatedTarget)||(this.emit("syn-blur"),we(this,$t,!1))};ft=function(t){if(this.tooltipPlacement==="none")return;const e=+t.dataset.rangeId;if(!v(this,se).has(e))return;const n=v(this,se).get(e),i=t.parentElement;i.content=this.tooltipFormatter(n)};Hi=function(t){if(this.disabled)return;v(this,$t)||(we(this,$t,!0),this.emit("syn-focus"));const e=t.target;e?.dataset?.rangeId&&V(this,O,ft).call(this,e)};Bi=function(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)};Ri=function(t){const e=this.hasSlotController.test("ticks"),n=this.hasSlotController.test("prefix"),i=this.hasSlotController.test("suffix");if(!e)return;let a=t||this.shadowRoot?.querySelector(".ticks")?.clientHeight;if(a){if(a+=2,a/=2,n){const o=this.shadowRoot?.querySelector(".input__prefix");o.style.transform=`translateY(-${a}px)`}if(i){const o=this.shadowRoot?.querySelector(".input__suffix");o.style.transform=`translateY(-${a}px)`}}};K.styles=[x,Be,Re,Nr];K.dependencies={"syn-tooltip":he};te([r()],K.prototype,"name",2);te([r()],K.prototype,"label",2);te([r({attribute:"help-text"})],K.prototype,"helpText",2);te([r({reflect:!0,type:Boolean})],K.prototype,"disabled",2);te([r({type:Number})],K.prototype,"min",2);te([r({type:Number})],K.prototype,"max",2);te([r({type:Number})],K.prototype,"step",2);te([r({reflect:!0})],K.prototype,"size",2);te([r({attribute:"tooltip-placement",type:String})],K.prototype,"tooltipPlacement",2);te([r({type:String})],K.prototype,"value",1);te([r({attribute:"restrict-movement",type:Boolean})],K.prototype,"restrictMovement",2);te([rt()],K.prototype,"defaultValue",2);te([r({reflect:!0})],K.prototype,"form",2);te([r({attribute:!1})],K.prototype,"tooltipFormatter",2);te([u(".input__wrapper")],K.prototype,"baseDiv",2);te([u(".active-track")],K.prototype,"activeTrack",2);te([u(".ticks")],K.prototype,"ticks",2);te([la(".thumb")],K.prototype,"thumbs",2);te([u(".range__validation-input")],K.prototype,"validationInput",2);K=te([ie("SynRange")],K);K.define("syn-range");const Pr=h`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
`;var jr=Object.defineProperty,Fr=Object.getOwnPropertyDescriptor,En=(t,e,n,i)=>{for(var a=i>1?void 0:i?Fr(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&jr(e,n,a),a};let Ge=class extends w{constructor(){super(...arguments),this.localize=new R(this),this.size="medium",this.removable=!1}handleRemoveClick(){this.emit("syn-remove")}render(){return c`
      <span
        part="base"
    ...
    `}};Ge.styles=[x,Pr,Lr];Ge.dependencies={"syn-icon-button":ut};En([r({reflect:!0})],Ge.prototype,"size",2);En([r({type:Boolean})],Ge.prototype,"removable",2);Ge=En([ie("SynTag")],Ge);const Vr=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`,Hr=h`
  ...
  ${zi}
`,Br=t=>Array.isArray(t)||typeof t=="string"?t.length>0:typeof t=="number"?!0:!!t,Rr=(t,e)=>Array.isArray(t)&&Array.isArray(e)?t.length!==e.length?!1:t.every((n,i)=>n===e[i]):t===e;var Ur=Object.defineProperty,Wr=Object.getOwnPropertyDescriptor,D=(t,e,n,i)=>{for(var a=i>1?void 0:i?Wr(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&Ur(e,n,a),a};let S=class extends w{constructor(){super(...arguments),this.formControlController=new Le(this,{assumeInteractionOn:["syn-blur","syn-input"]}),this.hasSlotController=new J(this,"help-text","label"),this.localize=new R(this),this.isInitialized=!1,this.typeToSelectString="",this.hasFocus=!1,this.displayLabel="",this.selectedOptions=[],this.valueHasChanged=!1,this.delimiter=" ",this.name="",this._value="",this.defaultValue="",this.size="medium",this.placeholder="",this.multiple=!1,this.maxOptionsVisible=3,this.disabled=!1,this.clearable=!1,this.open=!1,this.hoist=!1,this.label="",this.placement="bottom",this.helpText="",this.form="",this.required=!1,this.getTag=t=>c`
      <syn-tag
        part="tag"
        exportparts="
              base:tag__base,
    ...
    `}};S.styles=[x,Be,Vr,Re,Hr];S.dependencies={"syn-icon":ye,"syn-popup":P,"syn-tag":Ge};D([u(".select")],S.prototype,"popup",2);D([u(".select__combobox")],S.prototype,"combobox",2);D([u(".select__display-input")],S.prototype,"displayInput",2);D([u(".select__value-input")],S.prototype,"valueInput",2);D([u(".select__listbox")],S.prototype,"listbox",2);D([u(".select__tags")],S.prototype,"tagContainer",2);D([y()],S.prototype,"hasFocus",2);D([y()],S.prototype,"displayLabel",2);D([y()],S.prototype,"currentOption",2);D([y()],S.prototype,"selectedOptions",2);D([y()],S.prototype,"valueHasChanged",2);D([r()],S.prototype,"delimiter",2);D([r()],S.prototype,"name",2);D([y()],S.prototype,"value",1);D([r({attribute:"value"})],S.prototype,"defaultValue",2);D([r({reflect:!0})],S.prototype,"size",2);D([r()],S.prototype,"placeholder",2);D([r({type:Boolean,reflect:!0})],S.prototype,"multiple",2);D([r({attribute:"max-options-visible",type:Number})],S.prototype,"maxOptionsVisible",2);D([r({type:Boolean,reflect:!0})],S.prototype,"disabled",2);D([r({type:Boolean})],S.prototype,"clearable",2);D([r({type:Boolean,reflect:!0})],S.prototype,"open",2);D([r({type:Boolean})],S.prototype,"hoist",2);D([r()],S.prototype,"label",2);D([r({reflect:!0})],S.prototype,"placement",2);D([r({attribute:"help-text"})],S.prototype,"helpText",2);D([r({reflect:!0})],S.prototype,"form",2);D([r({type:Boolean,reflect:!0})],S.prototype,"required",2);D([r()],S.prototype,"getTag",2);D([m("delimiter")],S.prototype,"handleDelimiterChange",1);D([m("disabled",{waitUntilFirstUpdate:!0})],S.prototype,"handleDisabledChange",1);D([m(["defaultValue","value","delimiter"],{waitUntilFirstUpdate:!0})],S.prototype,"handleValueChange",1);D([m("open",{waitUntilFirstUpdate:!0})],S.prototype,"handleOpenChange",1);S=D([ie("SynSelect")],S);z("select.show",{keyframes:[{opacity:0,scale:.9},{opacity:1,scale:1}],options:{duration:100,easing:"ease"}});z("select.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.9}],options:{duration:100,easing:"ease"}});S.define("syn-select");const qr=h`
  :host {
...
`;var Kr=Object.defineProperty,Gr=Object.getOwnPropertyDescriptor,Ve=(t,e,n,i)=>{for(var a=i>1?void 0:i?Gr(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&Kr(e,n,a),a};let xe=class extends w{constructor(){super(),this.hasSlotController=new J(this,"[default]","footer"),this.localize=new R(this),this.isAnimationActive=!1,this.open=!1,this.rail=!1,this.variant="default",this.noFocusTrapping=!1,this.handleMouseEnter=this.handleMouseEnter.bind(this),this.handleMouseLeave=this.handleMouseLeave.bind(this),this.addEventListener("syn-initial-focus",t=>{this.variant!=="default"&&(t.preventDefault(),this.drawer.originalTrigger=null)}),this.addEventListener("focusin",t=>{t.target.tagName.toLowerCase()==="syn-nav-item"&&this.variant==="rail"&&!this.open&&(this.open=!0)}),this.addEventListener("focusout",t=>{const e=t.target.tagName.toLowerCase(),n=t.relatedTarget?.tagName.toLowerCase();e==="syn-nav-item"&&n!=="syn-nav-item"&&this.variant==="rail"&&this.open&&(this.open=!1)})}setDelayedCallback(t){clearTimeout(this.timeout),this.timeout=setTimeout(t,100)}handleMouseEnter(){this.setDelayedCallback(()=>{this.open=!0})}handleMouseLeave(){this.setDelayedCallback(()=>{this.open=!1})}handleRequestClose(){this.open&&(this.open=!1)}addMouseListener(){this.drawer.shadowRoot.querySelector(".drawer__panel")?.addEventListener("mouseenter",this.handleMouseEnter),this.drawer.shadowRoot.querySelector(".drawer__panel")?.addEventListener("mouseleave",this.handleMouseLeave)}removeMouseListener(){this.drawer.shadowRoot.querySelector(".drawer__panel")?.removeEventListener("mouseenter",this.handleMouseEnter),this.drawer.shadowRoot.querySelector(".drawer__panel")?.removeEventListener("mouseleave",this.handleMouseLeave)}setDrawerAnimations(){const t=j(this,`sideNav.show${this.variant==="default"?"NonRail":"Rail"}`,{dir:this.localize.dir()}),e=j(this,`sideNav.hide${this.variant==="default"?"NonRail":"Rail"}`,{dir:this.localize.dir()}),n=j(this,"sideNav.overlay.hide",{dir:this.localize.dir()}),i=j(this,"sideNav.overlay.show",{dir:this.localize.dir()});Vt(this.drawer,"drawer.showStart",t),Vt(this.drawer,"drawer.hideStart",e),Vt(this.drawer,"drawer.overlay.hide",n),Vt(this.drawer,"drawer.overlay.show",i)}handleVariantChange(){switch(this.setDrawerAnimations(),this.drawer.forceVisibility(this.variant!=="default"),this.variant){case"rail":this.addMouseListener();break;case"sticky":case"default":default:this.removeMouseListener()}}handleOpenChange(){this.variant!=="default"&&(this.isAnimationActive=!0,Z(this.drawer,`syn-after-${this.open?"show":"hide"}`).then(()=>{this.isAnimationActive=!1}))}handleFocusTrapping(){this.variant==="default"&&(this.noFocusTrapping?this.drawer.modal.activateExternal():this.drawer.modal.deactivateExternal())}async show(){if(!this.open)return this.open=!0,Z(this.drawer,"syn-after-show")}async hide(){if(this.open)return this.open=!1,Z(this.drawer,"syn-after-hide")}firstUpdated(){switch(this.setDrawerAnimations(),this.drawer.updateComplete.then(()=>{this.drawer.forceVisibility(this.variant!=="default"),this.drawer.shadowRoot.querySelector(".drawer__panel").tabIndex=-1}),this.variant){case"rail":this.drawer.updateComplete.then(()=>{this.addMouseListener()});break;case"sticky":break;case"default":default:this.noFocusTrapping&&this.drawer.modal.activateExternal()}}disconnectedCallback(){super.disconnectedCallback(),this.drawer&&(pt(this.drawer),this.drawer.modal.deactivate())}willUpdate(t){super.willUpdate(t),t.has("rail")&&(this.rail&&console.warn("<syn-side-nav/>: The `rail` attribute is deprecated. Please use the `variant` attribute with `rail` instead. It will be removed in synergy version 3.0"),(!t.has("variant")||this.rail)&&(this.variant=this.rail?"rail":"default"))}toggleOpenState(){this.open=!this.open}render(){const t=window.navigator.maxTouchPoints>0||"ontouchstart"in window,e=this.hasSlotController.test("footer"),n=e||this.variant==="sticky";return T`
      ...
      >
        ...
        >
          ...
          <footer class="side-nav__footer" part="footer-container" slot="footer">  
            ...
            ${n?T`<syn-divider part="footer-divider" class="side-nav__footer-divider"></syn-divider>`:""}
            <slot name="footer" part="footer" ></slot>
            ${this.variant==="sticky"?T`<syn-nav-item part="toggle-nav-item" class="side-nav__toggle-nav-item" @click=${this.toggleOpenState} ?divider=${e}>
    ...
    `}};xe.styles=[x,qr];xe.dependencies={"syn-divider":Xe,"syn-drawer":Se,"syn-icon":ye,"syn-nav-item":ae};Ve([y()],xe.prototype,"isAnimationActive",2);Ve([u(".side-nav__drawer")],xe.prototype,"drawer",2);Ve([r({reflect:!0,type:Boolean})],xe.prototype,"open",2);Ve([r({reflect:!0,type:Boolean})],xe.prototype,"rail",2);Ve([r({reflect:!0})],xe.prototype,"variant",2);Ve([r({attribute:"no-focus-trapping",reflect:!0,type:Boolean})],xe.prototype,"noFocusTrapping",2);Ve([m("variant",{waitUntilFirstUpdate:!0})],xe.prototype,"handleVariantChange",1);Ve([m("open",{waitUntilFirstUpdate:!0})],xe.prototype,"handleOpenChange",1);Ve([m("noFocusTrapping",{waitUntilFirstUpdate:!0})],xe.prototype,"handleFocusTrapping",1);xe=Ve([ie("SynSideNav")],xe);z("sideNav.showRail",{keyframes:[{width:"var(--side-nav-rail-width)"},{width:"var(--side-nav-open-width)"}],options:{duration:250,easing:"ease"}});z("sideNav.showNonRail",{keyframes:[{opacity:0,translate:"-100%"},{opacity:1,translate:"0"}],options:{duration:250,easing:"ease"}});z("sideNav.hideNonRail",{keyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"-100%"}],options:{duration:250,easing:"ease"}});z("sideNav.hideRail",{keyframes:[{width:"var(--side-nav-open-width)"},{width:"var(--side-nav-rail-width)"}],options:{duration:250,easing:"ease"}});z("sideNav.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});z("sideNav.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});xe.define("syn-side-nav");xn.define("syn-spinner");const Yr=h`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
:host([size='small']) {
  ...
  `;var Jr=Object.defineProperty,Qr=Object.getOwnPropertyDescriptor,ve=(t,e,n,i)=>{for(var a=i>1?void 0:i?Qr(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&Jr(e,n,a),a};let re=class extends w{constructor(){super(...arguments),this.formControlController=new Le(this,{value:t=>t.checked?t.value||"on":void 0,defaultValue:t=>t.defaultChecked,setValue:(t,e)=>t.checked=e}),this.hasSlotController=new J(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleInput(){this.emit("syn-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}handleClick(){this.checked=!this.checked,this.emit("syn-change")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleKeyDown(t){t.key==="ArrowLeft"&&(t.preventDefault(),this.checked=!1,this.emit("syn-change"),this.emit("syn-input")),t.key==="ArrowRight"&&(t.preventDefault(),this.checked=!0,this.emit("syn-change"),this.emit("syn-input"))}handleCheckedChange(){this.input.checked=this.checked,this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(!0)}click(){this.input.click()}focus(t){this.input.focus(t)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("help-text"),e=this.helpText?!0:!!t;return c`
    ...
    `}};re.styles=[x,Be,Yr,Re,Xr];ve([u('input[type="checkbox"]')],re.prototype,"input",2);ve([y()],re.prototype,"hasFocus",2);ve([r({reflect:!0})],re.prototype,"title",2);ve([r()],re.prototype,"name",2);ve([r()],re.prototype,"value",2);ve([r({reflect:!0})],re.prototype,"size",2);ve([r({type:Boolean,reflect:!0})],re.prototype,"disabled",2);ve([r({type:Boolean,reflect:!0})],re.prototype,"checked",2);ve([rt("checked")],re.prototype,"defaultChecked",2);ve([r({reflect:!0})],re.prototype,"form",2);ve([r({type:Boolean,reflect:!0})],re.prototype,"required",2);ve([r({attribute:"help-text"})],re.prototype,"helpText",2);ve([m("checked",{waitUntilFirstUpdate:!0})],re.prototype,"handleCheckedChange",1);ve([m("disabled",{waitUntilFirstUpdate:!0})],re.prototype,"handleDisabledChange",1);re=ve([ie("SynSwitch")],re);re.define("syn-switch");const Zr=(t,e)=>{let n=0;return function(...i){window.clearTimeout(n),n=window.setTimeout(()=>{t.call(this,...i)},e)}},Jn=(t,e,n)=>{const i=t[e];t[e]=function(...a){i.call(this,...a),n.call(this,i,...a)}};(()=>{if(typeof window>"u")return;if(!("onscrollend"in window)){const e=new Set,n=new WeakMap,i=o=>{for(const s of o.changedTouches)e.add(s.identifier)},a=o=>{for(const s of o.changedTouches)e.delete(s.identifier)};document.addEventListener("touchstart",i,!0),document.addEventListener("touchend",a,!0),document.addEventListener("touchcancel",a,!0),Jn(EventTarget.prototype,"addEventListener",function(o,s){if(s!=="scrollend")return;const l=Zr(()=>{e.size?l():this.dispatchEvent(new Event("scrollend"))},100);o.call(this,"scroll",l,{passive:!0}),n.set(this,l)}),Jn(EventTarget.prototype,"removeEventListener",function(o,s){if(s!=="scrollend")return;const l=n.get(this);l&&o.call(this,"scroll",l,{passive:!0})})}})();const el=h`
	/* stylelint-disable */
  :host {
    display: contents;
  }
`;var tl=Object.defineProperty,nl=Object.getOwnPropertyDescriptor,Ui=(t,e,n,i)=>{for(var a=i>1?void 0:i?nl(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&tl(e,n,a),a};class $n extends w{constructor(){super(...arguments),this.observedElements=[],this.disabled=!1}static{this.styles=[x,el]}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{this.emit("syn-resize",{detail:{entries:e}})}),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}handleSlotChange(){this.disabled||this.startObserver()}startObserver(){const e=this.shadowRoot.querySelector("slot");if(e!==null){const n=e.assignedElements({flatten:!0});this.observedElements.forEach(i=>this.resizeObserver.unobserve(i)),this.observedElements=[],n.forEach(i=>{this.resizeObserver.observe(i),this.observedElements.push(i)})}}stopObserver(){this.resizeObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}render(){return c` <slot @slotchange=${this.handleSlotChange}></slot> `}}Ui([r({type:Boolean,reflect:!0})],$n.prototype,"disabled",2);Ui([m("disabled",{waitUntilFirstUpdate:!0})],$n.prototype,"handleDisabledChange",1);const il=h`
	/* stylelint-disable */
  :host {
    --indicator-color: var(--syn-color-primary-600);
    --track-color: var(--syn-color-neutral-200);
...
`;var ol=Object.defineProperty,sl=Object.getOwnPropertyDescriptor,de=(t,e,n,i)=>{for(var a=i>1?void 0:i?sl(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&ol(e,n,a),a};class oe extends w{constructor(){super(...arguments),this.focusableTabs=[],this.localize=new R(this),this.hasScrollControls=!1,this.shouldHideScrollStartButton=!1,this.shouldHideScrollEndButton=!1,this.placement="top",this.activation="auto",this.noScrollControls=!1,this.contained=!1,this.sharp=!1,this.fixedScrollControls=!1,this.scrollOffset=1}static{this.styles=[x,il,al]}static{this.dependencies={"syn-icon-button":ut,"syn-resize-observer":$n}}connectedCallback(){const e=Promise.all([customElements.whenDefined("syn-tab"),customElements.whenDefined("syn-tab-panel")]);super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>{this.repositionIndicator(),this.updateScrollControls()}),this.mutationObserver=new MutationObserver(n=>{const i=n.filter(({target:a})=>{if(a===this)return!0;if(a.closest("syn-tab-group")!==this)return!1;const o=a.tagName.toLowerCase();return o==="syn-tab"||o==="syn-tab-panel"});if(i.length!==0){if(i.some(a=>!["aria-labelledby","aria-controls"].includes(a.attributeName))&&setTimeout(()=>this.setAriaLabels()),i.some(a=>a.attributeName==="disabled"))this.syncTabsAndPanels();else if(i.some(a=>a.attributeName==="active")){const o=i.filter(s=>s.attributeName==="active"&&s.target.tagName.toLowerCase()==="syn-tab").map(s=>s.target).find(s=>s.active);o&&this.setActiveTab(o)}}}),this.updateComplete.then(()=>{this.syncTabsAndPanels(),this.mutationObserver.observe(this,{attributes:!0,attributeFilter:["active","disabled","name","panel"],childList:!0,subtree:!0}),this.resizeObserver.observe(this.nav),e.then(()=>{new IntersectionObserver((i,a)=>{i[0].intersectionRatio>0&&(this.setAriaLabels(),this.setActiveTab(this.getActiveTab()??this.tabs[0],{emitEvents:!1}),a.unobserve(i[0].target))}).observe(this.tabGroup)})})}disconnectedCallback(){super.disconnectedCallback(),this.mutationObserver?.disconnect(),this.nav&&this.resizeObserver?.unobserve(this.nav)}getActiveTab(){return this.tabs.find(e=>e.active)}handleClick(e){const i=e.target.closest("syn-tab");i?.closest("syn-tab-group")===this&&i!==null&&this.setActiveTab(i,{scrollBehavior:"smooth"})}handleKeyDown(e){const i=e.target.closest("syn-tab");if(i?.closest("syn-tab-group")===this&&(["Enter"," "].includes(e.key)&&i!==null&&(this.setActiveTab(i,{scrollBehavior:"smooth"}),e.preventDefault()),["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End"].includes(e.key))){const o=this.tabs.find(d=>d.matches(":focus")),s=this.localize.dir()==="rtl";let l=null;if(o?.tagName.toLowerCase()==="syn-tab"){if(e.key==="Home")l=this.focusableTabs[0];else if(e.key==="End")l=this.focusableTabs[this.focusableTabs.length-1];else if(["top"].includes(this.placement)&&e.key===(s?"ArrowRight":"ArrowLeft")||["start","end"].includes(this.placement)&&e.key==="ArrowUp"){const d=this.tabs.findIndex(p=>p===o);l=this.findNextFocusableTab(d,"backward")}else if(["top"].includes(this.placement)&&e.key===(s?"ArrowLeft":"ArrowRight")||["start","end"].includes(this.placement)&&e.key==="ArrowDown"){const d=this.tabs.findIndex(p=>p===o);l=this.findNextFocusableTab(d,"forward")}if(!l)return;l.tabIndex=0,l.focus({preventScroll:!0}),this.activation==="auto"?this.setActiveTab(l,{scrollBehavior:"smooth"}):this.tabs.forEach(d=>{d.tabIndex=d===l?0:-1}),["top"].includes(this.placement)&&Kt(l,this.nav,"horizontal"),e.preventDefault()}}}handleScrollToStart(){this.nav.scroll({left:this.localize.dir()==="rtl"?this.nav.scrollLeft+this.nav.clientWidth:this.nav.scrollLeft-this.nav.clientWidth,behavior:"smooth"})}handleScrollToEnd(){this.nav.scroll({left:this.localize.dir()==="rtl"?this.nav.scrollLeft-this.nav.clientWidth:this.nav.scrollLeft+this.nav.clientWidth,behavior:"smooth"})}setActiveTab(e,n){if(n={emitEvents:!0,scrollBehavior:"auto",...n},e!==this.activeTab&&!e.disabled){const i=this.activeTab;this.activeTab=e,this.tabs.forEach(a=>{a.active=a===this.activeTab,a.tabIndex=a===this.activeTab?0:-1}),this.panels.forEach(a=>a.active=a.name===this.activeTab?.panel),this.syncIndicator(),["top"].includes(this.placement)&&Kt(this.activeTab,this.nav,"horizontal",n.scrollBehavior),n.emitEvents&&(i&&this.emit("syn-tab-hide",{detail:{name:i.panel}}),this.emit("syn-tab-show",{detail:{name:this.activeTab.panel}}))}}setAriaLabels(){this.tabs.forEach(e=>{const n=this.panels.find(i=>i.name===e.panel);n&&(e.setAttribute("aria-controls",n.getAttribute("id")),n.setAttribute("aria-labelledby",e.getAttribute("id")))})}repositionIndicator(){const e=this.getActiveTab();if(!e)return;const n=e.clientWidth,i=e.clientHeight,a=this.localize.dir()==="rtl",s=this.tabs.slice(0,this.tabs.indexOf(e)).reduce((l,d)=>({left:l.left+d.clientWidth,top:l.top+d.clientHeight}),{left:0,top:0});switch(this.placement){case"top":this.indicator.style.width=`calc(${n}px - ${this.contained||this.sharp?"2 * var(--syn-spacing-large)":"0px"})`,this.indicator.style.height="auto",this.indicator.style.translate=`calc(${a?"-":""}1 * (${s.left}px + ${this.contained||this.sharp?"var(--syn-spacing-large)":"0px"}))`;break;case"start":case"end":this.indicator.style.width="auto",this.indicator.style.height=`calc(${i}px - ${this.contained||this.sharp?"2 * var(--syn-spacing-small)":"0px"})`,this.indicator.style.translate=`0 calc(${s.top}px + ${this.contained||this.sharp?"var(--syn-spacing-small)":"0px"})`;break}}syncTabsAndPanels(){this.focusableTabs=this.tabs.filter(e=>!e.disabled),this.syncIndicator(),this.updateComplete.then(()=>this.updateScrollControls())}findNextFocusableTab(e,n){let i=null;const a=n==="forward"?1:-1;let o=e+a;for(;e<this.tabs.length;){if(i=this.tabs[o]||null,i===null){n==="forward"?i=this.focusableTabs[0]:i=this.focusableTabs[this.focusableTabs.length-1];break}if(!i.disabled)break;o+=a}return i}updateScrollButtons(){this.hasScrollControls&&!this.fixedScrollControls&&(this.shouldHideScrollStartButton=this.scrollFromStart()<=this.scrollOffset,this.shouldHideScrollEndButton=this.isScrolledToEnd())}isScrolledToEnd(){return this.scrollFromStart()+this.nav.clientWidth>=this.nav.scrollWidth-this.scrollOffset}scrollFromStart(){return this.localize.dir()==="rtl"?-this.nav.scrollLeft:this.nav.scrollLeft}updateScrollControls(){this.noScrollControls?this.hasScrollControls=!1:this.hasScrollControls=["top"].includes(this.placement)&&this.nav.scrollWidth>this.nav.clientWidth+1,this.updateScrollButtons()}syncIndicator(){this.getActiveTab()?(this.indicator.style.display="block",this.repositionIndicator()):this.indicator.style.display="none"}show(e){const n=this.tabs.find(i=>i.panel===e);n&&this.setActiveTab(n,{scrollBehavior:"smooth"})}preventFocus(e){e.preventDefault()}render(){return c`
    ...
    `}}de([Dt({slot:"nav",selector:"syn-tab"})],oe.prototype,"tabs",2);de([Dt({selector:"syn-tab-panel"})],oe.prototype,"panels",2);de([u(".tab-group")],oe.prototype,"tabGroup",2);de([u(".tab-group__body")],oe.prototype,"body",2);de([u(".tab-group__nav")],oe.prototype,"nav",2);de([u(".tab-group__indicator")],oe.prototype,"indicator",2);de([y()],oe.prototype,"hasScrollControls",2);de([y()],oe.prototype,"shouldHideScrollStartButton",2);de([y()],oe.prototype,"shouldHideScrollEndButton",2);de([r()],oe.prototype,"placement",2);de([r()],oe.prototype,"activation",2);de([r({attribute:"no-scroll-controls",type:Boolean})],oe.prototype,"noScrollControls",2);de([r({type:Boolean})],oe.prototype,"contained",2);de([r({type:Boolean})],oe.prototype,"sharp",2);de([r({attribute:"fixed-scroll-controls",type:Boolean})],oe.prototype,"fixedScrollControls",2);de([da({passive:!0})],oe.prototype,"updateScrollButtons",1);de([m("noScrollControls",{waitUntilFirstUpdate:!0})],oe.prototype,"updateScrollControls",1);de([m("placement",{waitUntilFirstUpdate:!0})],oe.prototype,"syncIndicator",1);oe.define("syn-tab-group");const rl=h`
	/* stylelint-disable */
  :host {
    --padding: 0;
...
`;var dl=Object.defineProperty,cl=Object.getOwnPropertyDescriptor,On=(t,e,n,i)=>{for(var a=i>1?void 0:i?cl(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&dl(e,n,a),a};let pl=0;class tn extends w{constructor(){super(...arguments),this.attrId=++pl,this.componentId=`syn-tab-panel-${this.attrId}`,this.name="",this.active=!1}static{this.styles=[x,rl,ll]}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return c`
      <slot
        part="base"
        class=${f({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}}On([r({reflect:!0})],tn.prototype,"name",2);On([r({type:Boolean,reflect:!0})],tn.prototype,"active",2);On([m("active")],tn.prototype,"handleActiveChange",1);tn.define("syn-tab-panel");const hl=h`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
`;var ml=Object.defineProperty,fl=Object.getOwnPropertyDescriptor,Ze=(t,e,n,i)=>{for(var a=i>1?void 0:i?fl(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&ml(e,n,a),a};let yl=0;class We extends w{constructor(){super(...arguments),this.localize=new R(this),this.attrId=++yl,this.componentId=`syn-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}static{this.styles=[x,hl,ul]}static{this.dependencies={"syn-icon-button":ut}}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}handleCloseClick(e){e.stopPropagation(),this.emit("syn-close")}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false"),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,c`
      <div
        part="base"
    ...
    `}}Ze([u(".tab")],We.prototype,"tab",2);Ze([r({reflect:!0})],We.prototype,"panel",2);Ze([r({type:Boolean,reflect:!0})],We.prototype,"active",2);Ze([r({type:Boolean,reflect:!0})],We.prototype,"closable",2);Ze([r({type:Boolean,reflect:!0})],We.prototype,"disabled",2);Ze([r({type:Number,reflect:!0})],We.prototype,"tabIndex",2);Ze([m("active")],We.prototype,"handleActiveChange",1);Ze([m("disabled")],We.prototype,"handleDisabledChange",1);We.define("syn-tab");Ge.define("syn-tag");const bl=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`;var vl=Object.defineProperty,wl=Object.getOwnPropertyDescriptor,L=(t,e,n,i)=>{for(var a=i>1?void 0:i?wl(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&vl(e,n,a),a};let I=class extends w{constructor(){super(...arguments),this.formControlController=new Le(this,{assumeInteractionOn:["syn-blur","syn-input"]}),this.hasSlotController=new J(this,"help-text","label"),this.hasFocus=!1,this.title="",this.name="",this.value="",this.size="medium",this.label="",this.helpText="",this.placeholder="",this.rows=4,this.resize="vertical",this.disabled=!1,this.readonly=!1,this.form="",this.required=!1,this.spellcheck=!0,this.defaultValue=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>this.setTextareaHeight()),this.updateComplete.then(()=>{this.setTextareaHeight(),this.resizeObserver.observe(this.input)})}firstUpdated(){this.formControlController.updateValidity()}disconnectedCallback(){super.disconnectedCallback(),this.input&&this.resizeObserver?.unobserve(this.input)}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleChange(){this.value=this.input.value,this.setTextareaHeight(),this.emit("syn-change")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleInput(){this.value=this.input.value,this.emit("syn-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}setTextareaHeight(){this.resize==="auto"?(this.sizeAdjuster.style.height=`${this.input.clientHeight}px`,this.input.style.height="auto",this.input.style.height=`${this.input.scrollHeight}px`):this.input.style.height=""}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleRowsChange(){this.setTextareaHeight()}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity(),this.setTextareaHeight()}focus(t){this.input.focus(t)}blur(){this.input.blur()}select(){this.input.select()}scrollPosition(t){if(t){typeof t.top=="number"&&(this.input.scrollTop=t.top),typeof t.left=="number"&&(this.input.scrollLeft=t.left);return}return{top:this.input.scrollTop,left:this.input.scrollTop}}setSelectionRange(t,e,n="none"){this.input.setSelectionRange(t,e,n)}setRangeText(t,e,n,i="preserve"){const a=e??this.input.selectionStart,o=n??this.input.selectionEnd;this.input.setRangeText(t,a,o,i),this.value!==this.input.value&&(this.value=this.input.value,this.setTextareaHeight())}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("label"),e=this.hasSlotController.test("help-text"),n=this.label?!0:!!t,i=this.helpText?!0:!!e;return c`
    ...
    `}};I.styles=[x,Be,bl,Re,gl];L([u(".textarea__control")],I.prototype,"input",2);L([u(".textarea__size-adjuster")],I.prototype,"sizeAdjuster",2);L([y()],I.prototype,"hasFocus",2);L([r({reflect:!0})],I.prototype,"title",2);L([r()],I.prototype,"name",2);L([r()],I.prototype,"value",2);L([r({reflect:!0})],I.prototype,"size",2);L([r()],I.prototype,"label",2);L([r({attribute:"help-text"})],I.prototype,"helpText",2);L([r()],I.prototype,"placeholder",2);L([r({type:Number})],I.prototype,"rows",2);L([r()],I.prototype,"resize",2);L([r({type:Boolean,reflect:!0})],I.prototype,"disabled",2);L([r({type:Boolean,reflect:!0})],I.prototype,"readonly",2);L([r({reflect:!0})],I.prototype,"form",2);L([r({type:Boolean,reflect:!0})],I.prototype,"required",2);L([r({type:Number})],I.prototype,"minlength",2);L([r({type:Number})],I.prototype,"maxlength",2);L([r()],I.prototype,"autocapitalize",2);L([r()],I.prototype,"autocorrect",2);L([r()],I.prototype,"autocomplete",2);L([r({type:Boolean})],I.prototype,"autofocus",2);L([r()],I.prototype,"enterkeyhint",2);L([r({type:Boolean,converter:{fromAttribute:t=>!(!t||t==="false"),toAttribute:t=>t?"true":"false"}})],I.prototype,"spellcheck",2);L([r()],I.prototype,"inputmode",2);L([rt()],I.prototype,"defaultValue",2);L([m("disabled",{waitUntilFirstUpdate:!0})],I.prototype,"handleDisabledChange",1);L([m("rows",{waitUntilFirstUpdate:!0})],I.prototype,"handleRowsChange",1);L([m("value",{waitUntilFirstUpdate:!0})],I.prototype,"handleValueChange",1);I=L([ie("SynTextarea")],I);I.define("syn-textarea");he.define("syn-tooltip");const xl=["blur","change","clear","focus","invalid","input","move"],Wi=(t,e)=>t.includes(e),Qn=t=>Wi(t,"blur"),sn=t=>Wi(t,"invalid"),kl=(t="")=>t.split(" ").map(e=>e.trim()).filter(Boolean),Zn=(t,e)=>{const n=e.trim();return t instanceof w&&xl.includes(n)?`syn-${n}`:n},_l=h`
  .validate {
    display: flex;
    flex-direction: column;
    gap: var(--syn-spacing-small);
  }
`;var Tl=Object.defineProperty,Cl=Object.getOwnPropertyDescriptor,_e=(t,e,n,i)=>{for(var a=i>1?void 0:i?Cl(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(a=(i?s(e,n,a):s(a))||a);return i&&a&&Tl(e,n,a),a};let le=class extends w{constructor(){super(...arguments),this.controller=new AbortController,this.validationMessage="",this.eagerFirstMount=!0,this.isInternalTriggeredInvalid=!1,this.isValid=!0,this.variant="native",this.hideIcon=!1,this.on="",this.customValidationMessage="",this.eager=!1,this.internalRevalidate=t=>{t.currentTarget.validity?.valid&&(this.validationMessage="")},this.validate=t=>{if(sn(t.type)&&this.variant==="native"&&this.isInternalTriggeredInvalid===!0){this.isInternalTriggeredInvalid=!1;return}sn(t.type)&&this.variant!=="native"&&(t.preventDefault(),t.stopPropagation());const e=t.currentTarget;if(this.isValid=e.validity?.valid,this.eager&&this.eagerFirstMount){this.eagerFirstMount=!1,this.setValidationMessage(e);return}!this.isValid&&!Qn(t.type)&&this.handleFocus(e),this.setValidationMessage(e),!Qn(t.type)&&this.variant==="native"&&this.updateComplete.then(()=>{this.isInternalTriggeredInvalid=!0,e.reportValidity()})}}handleListenerChange(){this.updateEvents()}async handleEagerChange(){if(this.eager){const t=this.getInput();await this.updateComplete,t?.reportValidity(),this.eagerFirstMount=!0}else this.eagerFirstMount=!1}handleCustomValidationMessageChange(){const t=this.getInput();t&&(this.setCustomValidationMessage(t),this.setValidationMessage(t))}getValidity(){return this.isValid}getInput(){const t=this.slottedChildren[0];return t||void 0}getUsedEventNames(){const t=this.getInput();if(!t)return[];const e=kl(this.on),[...n]=e.filter(Boolean);return n.includes("invalid")||n.push("invalid"),n.includes("live")&&(n.push("input"),n.push("blur")),Array.from(new Set(n.filter(i=>i!=="live").map(i=>Zn(t,i))))}updateEvents(){this.controller.abort(),this.controller=new AbortController;const t=this.getInput();if(!t)return;const e=this.getUsedEventNames();e.forEach(i=>{t.addEventListener(i,this.validate,{capture:sn(i),signal:this.controller.signal})});const n=Zn(t,"change");e.includes(n)||t.addEventListener(n,this.internalRevalidate,{signal:this.controller.signal})}setValidationMessage(t){const{customValidationMessage:e}=this,n=e||t.validationMessage;this.validationMessage=n}setCustomValidationMessage(t){t.setCustomValidity(this.customValidationMessage)}handleFocus(t){const e=document.activeElement,n=e.closest("syn-validate");!e.validity?.valid&&n||(t.scrollIntoView({block:"nearest"}),t.focus())}async firstUpdated(t){super.firstUpdated(t),this.updateEvents();const e=this.getInput();this.customValidationMessage&&(e instanceof w&&await e.updateComplete,e?.setCustomValidity(this.customValidationMessage)),this.eager&&(await this.updateComplete,this.isValid=e?.validity?.valid??!1,e?.reportValidity())}connectedCallback(){super.connectedCallback(),this.observer=new MutationObserver(t=>{const e=this.getInput();if(!e)return;t.filter(({target:i})=>i===e).every(i=>{const a=i.target;return a.hasAttribute("disabled")||a.hasAttribute("readonly")})?(this.isValid=!0,this.validationMessage=""):(e instanceof w?e.updateComplete:Promise.resolve()).then(()=>{this.isValid=e?.validity?.valid??!1,this.validationMessage=e?.validationMessage??""})}),this.observer.observe(this,{attributeFilter:["disabled","readonly"],attributes:!0,subtree:!0})}disconnectedCallback(){super.disconnectedCallback(),this.controller.abort(),this?.observer?.disconnect()}renderInlineValidation(){return this.variant!=="inline"||!this.validationMessage?"":c`
      <syn-alert
        open
        ...
        variant="danger"
      >
        ${this.hideIcon?"":c`<syn-icon slot="icon" name="error" library="system"></syn-icon>`}
    ...
    `}};le.styles=[x,_l];le.dependencies={"syn-alert":X};_e([Dt()],le.prototype,"slottedChildren",2);_e([y()],le.prototype,"validationMessage",2);_e([y()],le.prototype,"eagerFirstMount",2);_e([y()],le.prototype,"isInternalTriggeredInvalid",2);_e([y()],le.prototype,"isValid",2);_e([r({reflect:!0})],le.prototype,"variant",2);_e([r({attribute:"hide-icon",reflect:!0,type:Boolean})],le.prototype,"hideIcon",2);_e([r({reflect:!0})],le.prototype,"on",2);_e([r({attribute:"custom-validation-message",type:String})],le.prototype,"customValidationMessage",2);_e([r({type:Boolean})],le.prototype,"eager",2);_e([m("on",{waitUntilFirstUpdate:!0})],le.prototype,"handleListenerChange",1);_e([m("eager",{waitUntilFirstUpdate:!1})],le.prototype,"handleEagerChange",1);_e([m("customValidationMessage",{waitUntilFirstUpdate:!0})],le.prototype,"handleCustomValidationMessageChange",1);le=_e([ie("SynValidate")],le);le.define("syn-validate");function Sl(t){const e=typeof window<"u"&&window;return!!(e&&(/Chromatic/.test(e.navigator.userAgent)||/chromatic=true/.test(e.location.href)))}const zl=(t,...e)=>Sl()?c`
      <style>
      :root {
      ...
      ${t(...e)}
    `:t(...e),Gt="🌞 light",cn="🌙 dark",El=t=>`https://www.figma.com/file/bZFqk9urD3NlghGUKrkKCR/Synergy-Digital-Design-System?type=design&node-id=${t}`,$l=(t,e="Go to Figma page")=>({label:e,type:"link",url:El(t)});function Ol(t,e){const n=document.querySelectorAll(`#anchor--${e.id}`),a=JSON.parse('{"@synergy-design-system/components":"2.31.2","@synergy-design-system/assets":"1.14.0","@synergy-design-system/styles":"1.7.1","@synergy-design-system/tokens":"2.19.0"}');return n.forEach(o=>{const s=o.querySelector(".docblock-code-toggle");if(s){const l=s.cloneNode(!0);l.textContent="Edit on CodePen",l.classList.add("docblock-codepen-button");const d=o.querySelector(".sb-bar");d?o.querySelectorAll(".docblock-codepen-button:not(:last-of-type)").forEach(p=>{p.remove()}):o.querySelectorAll(".docblock-codepen-button").forEach(p=>{p.remove()}),s.parentElement.appendChild(l),d&&(o.querySelectorAll(".docblock-codepen-button:not(:last-of-type)").forEach(p=>{p.style.display="block",p.style.borderRight="none"}),o.querySelector(".docblock-codepen-button:last-of-type").style.display="none"),l.addEventListener("click",()=>{const p=document.createElement("form");p.action="https://codepen.io/pen/define",p.method="POST",p.target="_blank";const g={css:`/* Import theme */
 ...
 */`,documentation:"https://synergy-design-system.github.io/?path=/docs/components-syn-validate--docs",dependencies:["syn-alert"]}],exports:[{kind:"js",name:"default",declaration:{name:"SynValidate",module:"../components/src/components/validate/validate.js"}}]}],package:{author:{name:"SICK Global UX Foundation",url:"https://www.sick.com"},description:"",homepage:"https://synergy-design-system.github.io",license:"MIT",name:"@synergy-design-system/components",version:"2.31.2"}},Il={modules:[{declarations:[{attributes:[{default:"'syn-link--small'",description:"The size of the link",name:"syn-link",type:{text:"'syn-link--small' | 'syn-link--medium' | 'syn-link--large'"}},{default:"false",description:"Applies the quiet link styling",name:"syn-link--quiet",type:{text:"boolean"}},{default:"false",description:"Applies the disabled link styling",name:"syn-link--disabled",type:{text:"boolean"}}],customElement:!0,kind:"class",members:[{attribute:"syn-link",default:"'syn-link--small'",description:"The size of the link",kind:"field",name:"syn-link",type:{text:"'syn-link--small' | 'syn-link--medium' | 'syn-link--large'"}},{attribute:"syn-link--quiet",default:"false",description:"Applies the quiet link styling",kind:"field",name:"syn-link--quiet",type:{text:"boolean"}},{attribute:"syn-link--disabled",default:"false",description:"Applies the disabled link styling",kind:"field",name:"syn-link--disabled",type:{text:"boolean"}}],name:"syn-link",slots:[{description:"Main content of syn-link",name:""}],tagName:"syn-link",tagNameWithoutPrefix:"link"}],description:"The size of the link",kind:"javascript-module",path:"../styles/src/link/index.css"},{declarations:[{attributes:[{default:"'syn-link-list--medium'",description:"The size of the link list",name:"syn-link-list",type:{text:"'syn-link-list--medium' | 'syn-link-list--small' | 'syn-link-list--large'"}},{default:"false",description:"Applies horizontal styling to the link list",name:"syn-link-list--horizontal",type:{text:"boolean"}}],customElement:!0,kind:"class",members:[{attribute:"syn-link-list",default:"'syn-link-list--medium'",description:"The size of the link list",kind:"field",name:"syn-link-list",type:{text:"'syn-link-list--medium' | 'syn-link-list--small' | 'syn-link-list--large'"}},{attribute:"syn-link-list--horizontal",default:"false",description:"Applies horizontal styling to the link list",kind:"field",name:"syn-link-list--horizontal",type:{text:"boolean"}}],name:"syn-link-list",slots:[{description:"Main content of syn-link-list",name:""}],tagName:"syn-link-list",tagNameWithoutPrefix:"link-list"}],description:"The size of the link list",kind:"javascript-module",path:"../styles/src/link-list/index.css"},{declarations:[{attributes:[{default:"true",description:"Applies the table cell styling",name:"syn-table-cell",type:{text:"boolean"}},{default:"false",description:"Applies an alternating style to help separate rows visually",name:"syn-table-cell--alternating",type:{text:"boolean"}},{default:"false",description:"Applies a border to the left of the table cell",name:"syn-table-cell--border-start",type:{text:"boolean"}},{default:"false",description:"Applies a border to the right of the table cell",name:"syn-table-cell--border-end",type:{text:"boolean"}},{default:"false",description:"Applies a border to the top of the table cell",name:"syn-table-cell--border-top",type:{text:"boolean"}},{default:"false",description:"Applies a border to the bottom of the table cell",name:"syn-table-cell--border-bottom",type:{text:"boolean"}},{default:"false",description:"Applies the table cell header styling",name:"syn-table-cell--header",type:{text:"boolean"}},{default:"",description:"Applies the selected shadow to the table cell",name:"syn-table-cell--shadow",type:{text:" | 'syn-table-cell--shadow-bottom' | 'syn-table-cell--shadow-top' | 'syn-table-cell--shadow-start' | 'syn-table-cell--shadow-end'"}},{default:"false",description:"Displays the table shadow",name:"syn-table-cell--shadow-active",type:{text:"boolean"}}],customElement:!0,kind:"class",members:[{attribute:"syn-table-cell",default:"true",description:"Applies the table cell styling",kind:"field",name:"syn-table-cell",type:{text:"boolean"}},{attribute:"syn-table-cell--alternating",default:"false",description:"Applies an alternating style to help separate rows visually",kind:"field",name:"syn-table-cell--alternating",type:{text:"boolean"}},{attribute:"syn-table-cell--border-start",default:"false",description:"Applies a border to the left of the table cell",kind:"field",name:"syn-table-cell--border-start",type:{text:"boolean"}},{attribute:"syn-table-cell--border-end",default:"false",description:"Applies a border to the right of the table cell",kind:"field",name:"syn-table-cell--border-end",type:{text:"boolean"}},{attribute:"syn-table-cell--border-top",default:"false",description:"Applies a border to the top of the table cell",kind:"field",name:"syn-table-cell--border-top",type:{text:"boolean"}},{attribute:"syn-table-cell--border-bottom",default:"false",description:"Applies a border to the bottom of the table cell",kind:"field",name:"syn-table-cell--border-bottom",type:{text:"boolean"}},{attribute:"syn-table-cell--header",default:"false",description:"Applies the table cell header styling",kind:"field",name:"syn-table-cell--header",type:{text:"boolean"}},{attribute:"syn-table-cell--shadow",default:"",description:"Applies the selected shadow to the table cell",kind:"field",name:"syn-table-cell--shadow",type:{text:" | 'syn-table-cell--shadow-bottom' | 'syn-table-cell--shadow-top' | 'syn-table-cell--shadow-start' | 'syn-table-cell--shadow-end'"}},{attribute:"syn-table-cell--shadow-active",default:"false",description:"Displays the table shadow",kind:"field",name:"syn-table-cell--shadow-active",type:{text:"boolean"}}],name:"syn-table-cell",slots:[{description:"Main content of syn-table-cell",name:""}],tagName:"syn-table-cell",tagNameWithoutPrefix:"table-cell"}],description:"Applies the table cell styling",kind:"javascript-module",path:"../styles/src/tables/table-cell.css"},{declarations:[{attributes:[{default:"false",description:"Applies the styling to a table element",name:"syn-table",type:{text:"boolean"}},{default:"true",description:"Applies all default table stylings to a table and its children",name:"syn-table--default",type:{text:"boolean"}},{default:"false",description:"Applies all alternate table stylings to a table and its children",name:"syn-table--alternating",type:{text:"boolean"}},{default:"false",description:"Applies all border table stylings to a table and its children",name:"syn-table--border",type:{text:"boolean"}}],customElement:!0,kind:"class",members:[{attribute:"syn-table",default:"false",description:"Applies the styling to a table element",kind:"field",name:"syn-table",type:{text:"boolean"}},{attribute:"syn-table--default",default:"true",description:"Applies all default table stylings to a table and its children",kind:"field",name:"syn-table--default",type:{text:"boolean"}},{attribute:"syn-table--alternating",default:"false",description:"Applies all alternate table stylings to a table and its children",kind:"field",name:"syn-table--alternating",type:{text:"boolean"}},{attribute:"syn-table--border",default:"false",description:"Applies all border table stylings to a table and its children",kind:"field",name:"syn-table--border",type:{text:"boolean"}}],name:"syn-table",slots:[{description:"Main content of syn-table",name:""}],tagName:"syn-table",tagNameWithoutPrefix:"table"}],description:"Applies the styling to a table element",kind:"javascript-module",path:"../styles/src/tables/table.css"},{declarations:[{attributes:[{default:"'syn-body--x-small'",description:"The font size of the body text",name:"syn-body",type:{text:"'syn-body--x-small' | 'syn-body--small' | 'syn-body--medium' | 'syn-body--large'"}}],customElement:!0,kind:"class",members:[{attribute:"syn-body",default:"'syn-body--x-small'",description:"The font size of the body text",kind:"field",name:"syn-body",type:{text:"'syn-body--x-small' | 'syn-body--small' | 'syn-body--medium' | 'syn-body--large'"}}],name:"syn-body",slots:[{description:"Main content of syn-body",name:""}],tagName:"syn-body",tagNameWithoutPrefix:"body"}],description:"The font size of the body text",kind:"javascript-module",path:"../styles/src/typography/body.css"},{declarations:[{attributes:[{default:"'syn-heading--3x-large'",description:"The size of the headline",name:"syn-heading",type:{text:"'syn-heading--3x-large' | 'syn-heading--2x-large' | 'syn-heading--x-large' | 'syn-heading--large'"}}],customElement:!0,kind:"class",members:[{attribute:"syn-heading",default:"'syn-heading--3x-large'",description:"The size of the headline",kind:"field",name:"syn-heading",type:{text:"'syn-heading--3x-large' | 'syn-heading--2x-large' | 'syn-heading--x-large' | 'syn-heading--large'"}}],name:"syn-heading",slots:[{description:"Main content of syn-heading",name:""}],tagName:"syn-heading",tagNameWithoutPrefix:"heading"}],description:"The size of the headline",kind:"javascript-module",path:"../styles/src/typography/heading.css"},{declarations:[{attributes:[{default:"'syn-weight--normal'",description:"The font weight to apply",name:"syn-weight",type:{text:"'syn-weight--normal' | 'syn-weight--semibold' | 'syn-weight--bold'"}}],customElement:!0,kind:"class",members:[{attribute:"syn-weight",default:"'syn-weight--normal'",description:"The font weight to apply",kind:"field",name:"syn-weight",type:{text:"'syn-weight--normal' | 'syn-weight--semibold' | 'syn-weight--bold'"}}],name:"syn-weight",slots:[{description:"Main content of syn-weight",name:""}],tagName:"syn-weight",tagNameWithoutPrefix:"weight"}],description:"The font weight to apply",kind:"javascript-module",path:"../styles/src/typography/weight.css"}]};Pa({hideArgRef:!0,hideScriptTag:!0});Tt.modules&&(Tt.modules=Tt.modules.map(t=>(t.declarations&&(t.declarations=t.declarations.map(e=>(e.members&&(e.members=e.members.filter(n=>n.description&&n.privacy!=="private")),e))),t)));const Nl={...Tt,modules:[...Tt.modules,...Il.modules]};ca(Nl);console.log("Custom elements manifest loaded for components and styles");const pn=t=>{const{args:e,events:n,argTypes:i}=pi(t),a=si(t,window.__STORYBOOK_CUSTOM_ELEMENTS_MANIFEST__),o=()=>({status:{styles:{backgroundColor:a?.status==="stable"?"#43b02a":"rgb(255, 131, 0)",borderColor:"white",color:"white"},title:`Status: ${a?.status}`},since:{styles:{backgroundColor:"#333",borderColor:"#fff",color:"#fff"},title:`Since: ${a?.since}`}});return{args:e,argTypes:(()=>{for(const d in i)i.hasOwnProperty(d)&&i[d].table&&i[d].table.category==="properties"&&(i[d].control={disabled:!0});return{...i,...a?.events?.reduce((d,p)=>(d[p.name]={...p,control:!1,table:{category:"Events"}},d),{}),...a?.members?.filter(d=>d.kind==="method").reduce((d,p)=>(d[p.name]={...p,control:!1,table:{category:"Methods"}},d),{})}})(),parameters:{badges:["status","since"],badgesConfig:o(),actions:{handles:n}}}},ct=t=>({getSuffixFromType:e=>({attribute:"",property:"-prop",slot:"-slot",cssPart:"-part",cssProperty:""})[e],getValuesFromAttribute:e=>{e.endsWith("-attr")||(e=`${e}-attr`);const{argTypes:n}=pn(t);return n[e]?.control?.type==="boolean"?[!0,!1]:n[e].options},getValuesFromAttributes:e=>e?.map(n=>(n.endsWith("-attr")||(n=`${n}-attr`),{name:n,values:ct(t).getValuesFromAttribute(n)})),overrideArgs:(e,n)=>{const i=n||pn(t).args,a=Array.isArray(e)?e:[e];for(const o of a){const s=ct(t).getSuffixFromType(o.type);i[`${o.name}${s}`]=o.value}return i}}),Xl=t=>{const{template:e,manifest:n}=pi(t),{args:i}=pn(t),{getValuesFromAttribute:a}=ct(t);return{generateTemplate:({axis:s,constants:l=[],options:d,args:p=i})=>{const g=k=>{if(!n?.style)return e(k);const H=Object.keys(k).filter(B=>B.endsWith("-attr")).reduce((B,Ae)=>{const Te=Ae.substring(0,Ae.length-5);return k[Ae]===!0?B[Te]=!0:k[Ae]==="false"||k[Ae]==="(default)"?B[Te]=!1:k[Ae]&&(Te.endsWith("...")?B[Te.replace("...",k[Ae])]=!0:B[k[Ae]]=!0),B},{}),Ke=k["default-slot"]||"",tt={[t]:!0,...H},yt=Object.keys(tt).filter(B=>tt[B]).join(" ");if(d?.templateContent){const B=d.templateContent.replaceAll("%SLOT%",Ke).replaceAll("%CLASSES%",yt);return ue(B)}return T`<div class=${f(tt)}>${ue(Ke)}</div>`},C=(Array.isArray(l)?l:[l]).reduce((k,H)=>({...k,[`${H.name}${ct(t).getSuffixFromType(H.type)}`]:H.value}),{});if(!s?.x&&!s?.y&&!d?.title)return T`${g({...p,...C})}`;const Y=k=>k?Array.isArray(k)?k.map(H=>({...H,values:H.values||a(H.name)})):[{...k,values:k.values||a(k.name)}]:[{}],qe=Y(s?.x),Ne=Y(s?.y),et=(Array.isArray(l)?l:[l]).find(k=>k.type==="template")?.value,jt=`uuid-${crypto.randomUUID()}`;return T`
      <style>
        ...
        ${d?.templateBackground&&`
          .${jt}.story-template tbody tr.template-row td.template {
            background: ${d?.templateBackground};
          }
        `}

        ${d?.templateBackgrounds?.colors.map((k,H)=>{const Ke=tt=>`${d?.templateBackgrounds?.colors.length}n + ${tt+1}`;return d?.templateBackgrounds?.alternate==="y"?`
                .${jt}.story-template tbody tr.template-row:nth-of-type(${Ke(H)}) td.template {
                  background: ${k};
                }
              `:`
                .${jt}.story-template tbody tr.template-row td.template:nth-of-type(${Ke(H)}) {
                  background: ${k};
                }
              `})}
      </style>
      ${qe.map(k=>T` ${Ne.map(H=>{let Ke=!0;const tt=qe.length>1||k.values,yt=(k&&H||Ne.length>1)&&H?.values;return T`
            <table class="story-template ${jt} ${d?.classes}">
              <thead>
                ${d?.title&&T`<tr>
                ...
                ${k&&k.values&&T`
                  <tr>
                    ${yt?T`<td></td>`:""} <td></td>
                    ${tt&&T`<th colspan=${k.values?.length||0}><code>${k.title||k.name}</code></th>`}
                    </tr>
                  </tr>
                  ${T`
                    <tr>
                      ${yt?T`<td></td>`:""}
                      <td></td>
                      ${k?.values?.map(B=>T`<td><code>${B.title||B}</code></td>`)}
                    </tr>
                  `}
                `}
              </thead>
              <tbody>
                ${(H?.values||[""]).map(B=>{const Ae=T`
                    <tr class="template-row">
                      ${Ke&&yt?T`<th rowspan="${H?.values?.length}">
                            <span><code>${H.title||H.name}</code></span>
                          </th>`:""}
                      <th><code>${B.title||B}</code></th>
                      ${(k?.values||[""]).map(Te=>T`
                          <td class="template template-x-${k?.values?.indexOf(Te)||1} template-y-${H?.values?.indexOf(B.value||B)||1}">
                          ${k.type==="template"&&ue((Te.value||Te).split("%TEMPLATE%")[0]||"")||""}
                          ${H.type==="template"&&ue((B.value||B).split("%TEMPLATE%")[0]||"")||""}
                          ${et&&ue(et.split("%TEMPLATE%")[0]||"")||""}
                            ${g({...p,...C,...k&&k.type!=="template"&&{[`${k.name}${ct(t).getSuffixFromType(k.type)}`]:Te.hasOwnProperty("value")?Te.value:Te},...H&&H.type!=="template"&&{[`${H.name}${ct(t).getSuffixFromType(H.type)}`]:B.hasOwnProperty("value")?B.value:B}})}
                         ${H.type==="template"&&ue((B.value||B).split("%TEMPLATE%")[1]||"")||""}
                         ${k.type==="template"&&ue((Te.value||Te).split("%TEMPLATE%")[1]||"")||""}
          ...
          `})}`)}
    `}}},Al={codeOptimizer:t=>{const{body:e}=new DOMParser().parseFromString(t,"text/html"),n=e.querySelectorAll(".template");let i="";return n.length?i=Array.from(n).map(a=>a.innerHTML).join(`
`):i=e.innerHTML,i=i.replace(/<style><\/style>/g,"").replace(/<!-- preview-ignore:start -->[\s\S]*?<!-- preview-ignore:end -->/g,"").replace(/\/\/ preview-ignore:start[\s\S]*?\/\/ preview-ignore:end/g,"").replace(/<style>\n<\/style>/g,"").replace(/<script>\s*component = document\.querySelector\('(.+?)'\);\s*<\/script>/g,""),i}},Jl=(t,e,n="components")=>{const i=pa[n][t]??{},a=i[e]?.description?.value??"No Description",o=i[e]?.note?.value??"",s=p=>p.replace(/\n/g,"<br/>"),l=s(a),d=o?`<br/><br/><strong>👨‍💻 Additional developer Information:</strong><br>${s(o)}`:"";return`${l}${d}`},Ql=(t,e=150)=>{const n=isNaN(e)?e:{heightPx:e},{afterRender:i="",additionalChromaticOptions:a={},heightPx:o=150,styleHeading:s={}}=n,l=Object.entries(s).map(([d,p])=>`${d}: ${p};`).join(" ");return{parameters:{chromatic:{...qi?.parameters?.chromatic,...a,disableSnapshot:!1},docs:{disable:!0}},render:(d,p)=>T`
      ${Object.entries(t).map(([g,C])=>{const Y=C.name??ua(g);return T`
      ...
      `})}
      ${i}
    `}};export{$l as a,ct as b,Xl as c,Ql as d,Yl as e,Jl as g,Gl as h,Sl as i,qi as p,pn as s};
