import{s as u,a as h,g,b as e,c as v,d as b}from"./component-C5VI2Py7.js";import{k as a}from"./directive-helpers-CDT6qhDs.js";import"./if-defined-BaykDp1D.js";import"./ref-lLHsj5FH.js";import"./chunk-L4EGOTBX-C9C4DwME.js";import"./entry-preview-D9TbQDUR.js";import"./index-DrFu-skq.js";import"./index-CBCu9vDS.js";import"./library-BZPO0bHa.js";import"./icon.component-ULMuVEGu.js";import"./index-7h80QhK_.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon-5q8oryo5.js";var m=Object.freeze,f=Object.defineProperty,S=(r,y)=>m(f(r,"raw",{value:m(r.slice())})),d;const{args:k,argTypes:A}=u("syn-header"),{overrideArgs:w}=b("syn-header"),{generateTemplate:N}=h("syn-header"),C={args:w([{name:"label",type:"slot",value:'<span slot="label">App Name</span>'}],k),argTypes:A,component:"syn-header",parameters:{design:g("10540-8605"),docs:{description:{component:e("header","default")}}},title:"Components/syn-header"},t={parameters:{controls:{disable:!1},docs:{description:{story:e("header","default")}}},render:r=>N({args:r})},o={parameters:{docs:{description:{story:e("header","label")}}},render:()=>a`
  ...
  `},p=v({Default:t,Label:o,Logo:n,MetaNavigation:s,Navigation:i,BurgerMenu:c},{heightPx:200});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
