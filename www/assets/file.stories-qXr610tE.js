import{e as k}from"./class-map-sgJetdT5.js";import{n as l}from"./property-BFSANEA4.js";import{r as I}from"./state-C8yAg2p0.js";import{a as S}from"./query-DAIS6qJ0.js";import{l as A,x as a,g as B}from"./iframe-BLjrJY6Z.js";import{o as O}from"./if-defined-DwES8uBy.js";import{d as P}from"./default-value-DxUArLcm.js";import{w as F}from"./watch-CEsCE2EF.js";import{L as q}from"./localize-CatY2peN.js";import{F as L}from"./form-d9hCJUdr.js";import{H as M}from"./slot-9EVoRGQc.js";import{c as H,S as j}from"./component.styles-D0Dq4Rdk.js";import{f as R,a as U}from"./form-control.custom.styles-BcYfZs17.js";import{S as W}from"./button-sjXambWb.js";import{S as Y}from"./icon.component-YUbAu1s9.js";import{s as z,g as T,b as C}from"./animation-registry-l4L8bmT6.js";import{e as G}from"./decorator-DANECR0-.js";import{g as d,s as K,a as N,c as J,b as Q}from"./component-KeVqWNnj.js";import"./index-DihgwUfS.js";import"./spinner.component-VG2sHeQK.js";import"./functions-CDi3doZH.js";import"./index-Bkk0Z6Ex.js";import"./_docs-CrPFe_9C.js";const X=A`
  :host {
    display: block;
  }
...
`;var Z=Object.defineProperty,ee=Object.getOwnPropertyDescriptor,i=(e,t,o,s)=>{for(var n=s>1?void 0:s?ee(t,o):t,p=e.length-1,c;p>=0;p--)(c=e[p])&&(n=(s?c(t,o,n):c(n))||n);return s&&n&&Z(t,o,n),n};let r=class extends j{constructor(){super(...arguments),this.formControlController=new L(this,{assumeInteractionOn:["syn-change"],value:e=>e.files}),this.hasSlotController=new M(this,"help-text","label"),this.localize=new q(this),this.userIsDragging=!1,this.name="",this.defaultValue="",this.size="medium",this.label="",this.helpText="",this.disabled=!1,this.droparea=!1,this.accept="",this.multiple=!1,this.webkitdirectory=!1,this.form="",this.required=!1,this.hideValue=!1}set files(e){this.input&&(this.input.files=e)}get files(){return this.input?.files}set value(e){this.input&&(this.input.value=e)}get value(){return this.input?.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(e){if(this.droparea){this.dropareaWrapper?.focus(e);return}this.button?.focus(e)}blur(){if(this.droparea){this.dropareaWrapper?.blur();return}this.button?.blur()}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleFiles(e){if(!e){this.value="";return}this.files=e}async handleTransferItems(e){if(!e)return this.value="",new Promise((c,E)=>{E(new Error("No proper items found"))});const o=Array.from(e).map(c=>c.webkitGetAsEntry()).map(c=>this.getFilesFromEntry(c)),n=(await Promise.all(o)).flat(),p=new DataTransfer;return Array.from(n).forEach(c=>p.items.add(c)),p.files}async getFilesFromEntry(e){return e?e.isFile?new Promise((t,o)=>{e.file(s=>t([s]),o)}):e.isDirectory?new Promise((t,o)=>{e.createReader().readEntries(n=>{Promise.all(n.map(p=>this.getFilesFromEntry(p))).then(p=>{t(p.flat())}).catch(o)})}):[]:[]}handleClick(e){e.preventDefault(),this.input.click()}handleChange(e){e.preventDefault(),e.stopPropagation(),this.emit("syn-input"),this.emit("syn-change")}handleDragOver(e){e.preventDefault(),e.stopPropagation(),this.userIsDragging=!0}handleDragLeave(e){e.preventDefault(),e.stopPropagation(),this.userIsDragging=!1}async handleDrop(e){if(e.preventDefault(),e.stopPropagation(),!e.dataTransfer)return;const t=await this.handleTransferItems(e.dataTransfer?.items);if(this.userIsDragging=!1,!t)return;if(!this.multiple&&!this.webkitdirectory&&t.length>1){this.emit("syn-error");return}if(this.hasSlotController.test("trigger"))this.handleFiles(t);else{const s=T(this.inputChosen,"file.text.disappear",{dir:this.localize.dir()}),n=T(this.inputChosen,"file.text.appear",{dir:this.localize.dir()});if(this.droparea){const p=T(this.dropareaIcon,"file.iconDrop",{dir:this.localize.dir()});C(this.dropareaIcon,p.keyframes,p.options)}await C(this.inputChosen,s.keyframes,s.options),this.handleFiles(t),await C(this.inputChosen,n.keyframes,n.options)}this.input.dispatchEvent(new Event("change"))}handleFocus(){this.emit("syn-focus")}handleBlur(){this.emit("syn-blur")}renderValue(){let e=!1,t=this.localize.term("numFilesSelected",0,this.webkitdirectory);return this.files&&this.files?.length>0&&(e=!0,t=this.files.length===1?this.files[0].name:this.localize.term("numFilesSelected",this.files.length,this.webkitdirectory)),a`
    ...
    `}};r.styles=[H,R,U,X];r.dependencies={"syn-button":W,"syn-icon":Y};i([I()],r.prototype,"userIsDragging",2);i([l({type:Object})],r.prototype,"files",1);i([l({type:String})],r.prototype,"name",2);i([l({type:String})],r.prototype,"value",1);i([P()],r.prototype,"defaultValue",2);i([l({reflect:!0})],r.prototype,"size",2);i([l()],r.prototype,"label",2);i([l({attribute:"help-text"})],r.prototype,"helpText",2);i([l({reflect:!0,type:Boolean})],r.prototype,"disabled",2);i([l({type:Boolean})],r.prototype,"droparea",2);i([l({type:String})],r.prototype,"accept",2);i([l({type:String})],r.prototype,"capture",2);i([l({reflect:!0,type:Boolean})],r.prototype,"multiple",2);i([l({reflect:!0,type:Boolean})],r.prototype,"webkitdirectory",2);i([l({reflect:!0})],r.prototype,"form",2);i([l({reflect:!0,type:Boolean})],r.prototype,"required",2);i([l({attribute:"hide-value",type:Boolean})],r.prototype,"hideValue",2);i([S(".input__control")],r.prototype,"input",2);i([S(".button")],r.prototype,"button",2);i([S(".droparea")],r.prototype,"dropareaWrapper",2);i([S(".droparea__icon")],r.prototype,"dropareaIcon",2);i([S(".input__value")],r.prototype,"inputChosen",2);i([F("disabled",{waitUntilFirstUpdate:!0})],r.prototype,"handleDisabledChange",1);i([F("value",{waitUntilFirstUpdate:!0})],r.prototype,"handleValueChange",1);r=i([G("SynFile")],r);z("file.iconDrop",{keyframes:[{scale:1},{scale:.7},{scale:1}],options:{duration:600,easing:"ease-out"}});z("file.text.disappear",{keyframes:[{opacity:1},{opacity:0,transform:"translateY(-40%)"}],options:{duration:300,easing:"cubic-bezier(0.45, 1.45, 0.8, 1)"}});z("file.text.appear",{keyframes:[{opacity:0,transform:"translateY(40%)"},{opacity:1}],options:{duration:300,easing:"cubic-bezier(0.45, 1.45, 0.8, 1)"}});r.define("syn-file");var $=Object.freeze,te=Object.defineProperty,re=(e,t)=>$(te(e,"raw",{value:$(e.slice())})),V;const{userEvent:ie}=__STORYBOOK_MODULE_TEST__,{args:ae,argTypes:se}=K("syn-file"),{overrideArgs:le}=N("syn-file"),{generateTemplate:oe}=J("syn-file"),Fe={args:le([],ae),argTypes:se,component:"syn-file",parameters:{design:B("21709-49135"),docs:{description:{component:d("file","default")}}},tags:["Form"],title:"Components/syn-file"},u={parameters:{controls:{disable:!1},docs:{description:{story:d("file","default")}}},render:e=>oe({args:e})},f={parameters:{docs:{description:{story:d("file","label")}}},render:()=>a`
    <syn-file label="This is a label"></syn-file>
  `},h={parameters:{docs:{description:{story:d("file","help-text")}}},render:()=>a`
    <syn-file
...
`},b={parameters:{docs:{description:{story:d("file","sizes")}}},render:()=>a`
  ...
  `},v={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:d("file","invalid")}}},play:async({canvasElement:e})=>{try{const t=e.querySelector("form"),o=t.querySelectorAll("syn-file"),s=t.querySelector("syn-button");s&&o&&(await ie.click(s),s.click())}catch(t){console.error("Error in play function:",t)}},render:()=>a(V||(V=re([`
...
\`
  ...
  Droparea,
  Directory
}, 750)`,...w.parameters?.docs?.source}}};const Ee=["Default","Label","HelpText","Multiple","HideValue","Focus","Disabled","Sizes","Invalid","Droparea","Directory","Screenshot"];export{u as Default,_ as Directory,g as Disabled,x as Droparea,D as Focus,h as HelpText,y as HideValue,v as Invalid,f as Label,m as Multiple,w as Screenshot,b as Sizes,Ee as __namedExportsOrder,Fe as default};
