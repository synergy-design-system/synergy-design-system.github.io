import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{_ as n,a as r,h as i,l as a}from"./preview-Dqn7rZVb.js";import{c as o,t as s}from"./lit-DgWh_IaA.js";import{t as c}from"./button-CJF0q7bA.js";import{t as l}from"./card-DrndoHEC.js";import{a as u,i as d,n as f,o as p,r as m,t as h}from"./component-DcU3u8Ku.js";import{t as g}from"./icon-button-DXXjSusN.js";var _=t({BasicCard:()=>T,CardWithFooter:()=>D,CardWithHeader:()=>E,CardWithShadow:()=>A,Default:()=>w,Images:()=>O,Screenshot:()=>j,SharpCard:()=>k,__namedExportsOrder:()=>M,default:()=>C}),v,y,b,x,S,C,w,T,E,D,O,k,A,j,M;function N(){return(N=e((()=>{s(),i(),l(),c(),g(),m(),a(),{args:v,argTypes:y}=d(`syn-card`),{overrideArgs:b}=u(`syn-card`),{generateTemplate:x}=p(`syn-card`),S=({buttonText:e=`More info`,footerText:t=`Optional information`}={})=>`
  <footer slot="footer">
    <small>${t}</small>
    <nav>
