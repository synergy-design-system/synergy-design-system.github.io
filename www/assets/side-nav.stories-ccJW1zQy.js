import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{_ as r,d as i,f as a,p as o}from"./iframe-Dn-tjrvc.js";import{t as s}from"./icon-DehYIkFS.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-D_QZftXm.js";import{n as m,t as h}from"./taggedTemplateLiteral-pWa2IaV6.js";import{n as g,t as _}from"./DisableFocusTrap-B0c7Twev.js";import{t as v}from"./nav-item-4IW9DkVJ.js";import{t as y}from"./header-CWsJpFjH.js";import{t as b}from"./side-nav-CQpq_G0n.js";var x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G=e((()=>{b(),v(),s(),y(),n(),f(),g(),a(),r(),m(),{args:k,argTypes:A}=l(`syn-side-nav`),{overrideArgs:j}=c(`syn-side-nav`),{generateTemplate:M}=d(`syn-side-nav`),N={args:j([],k),argTypes:A,component:`syn-side-nav`,parameters:{chromatic:{modes:o},design:i(`41227-327748`),docs:{container:_,description:{component:u(`side-nav`,`default`)}}},tags:[`Application Shell`],title:`Components/syn-side-nav`},P=()=>t`
...
`)}],k),parameters:{controls:{disable:!1},docs:{description:{story:u(`side-nav`,`default`)}}},render:e=>t(S||=h([`
    ...
    <\/script>
    `,`
  `]),M({args:e}),F(`.side-nav-default`))},L={parameters:{docs:{description:{story:u(`side-nav`,`rail`)}}},render:()=>t(C||=h([`
  ...
  `]),P(),F(`.side-nav-rail`))},R={parameters:{docs:{description:{story:u(`side-nav`,`sticky`)}}},render:()=>t(w||=h([`
  ...
  `]),P(),F(`.side-nav-sticky`))},z={parameters:{docs:{description:{story:u(`side-nav`,`footer`)}}},render:()=>t(T||=h([`
  ...
  `]),P(),F(`.side-nav-footer`))},B={parameters:{docs:{description:{story:u(`side-nav`,`fixed`)}}},render:()=>t(E||=h([`
  ...
  `]),P(),F(`.side-nav-fixed`))},V={parameters:{docs:{description:{story:u(`side-nav`,`shrinking`)}}},render:()=>t(D||=h([`
  ...
  `]),P(),F(`.side-nav-shrink`))},H={parameters:{docs:{description:{story:u(`side-nav`,`indentation`)}}},render:()=>t(O||=h([`
