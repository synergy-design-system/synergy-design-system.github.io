import{k as c}from"./directive-helpers-CDT6qhDs.js";import{s as m,a as y,g as h,b as e,e as u,c as g,d as f}from"./component-BkLxdTGW.js";import"./index-BpTwKCb_.js";import"./icon.component-BGOBP71j.js";import"./chunk-L4EGOTBX-C9C4DwME.js";import"./entry-preview-D9TbQDUR.js";import"./index-DrFu-skq.js";import"./index-B-o1Wr-g.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon-Cns_YRtn.js";const{args:x,argTypes:b}=m("syn-card"),{overrideArgs:S}=f("syn-card"),{generateTemplate:v}=y("syn-card"),l=({buttonText:i="More Info",footerText:p="Optional information"}={})=>`
  <footer slot="footer">
    <small>${p}</small>
    <nav>
...
`,k={args:S([{name:"image",type:"slot",value:'<img slot="image" src="/card-example.jpg" alt="Multiple persons having lunch in SICK Academy" />'},{name:"default",type:"slot",value:`
        <h3>Headline</h3>
  ...
  `},t={parameters:{docs:{description:{story:e("card","with-footer")}}},render:()=>c`
    <syn-card class="card-footer">
      ...
      ${u(l({buttonText:"Preview",footerText:"Optional information"}))}
    </syn-card>
  ...
  Images,
  SharpCard
}, 600)`,...d.parameters?.docs?.source}}};const F=["Default","BasicCard","CardWithHeader","CardWithFooter","Images","SharpCard","Screenshot"];export{r as BasicCard,t as CardWithFooter,s as CardWithHeader,a as Default,o as Images,d as Screenshot,n as SharpCard,F as __namedExportsOrder,k as default};
