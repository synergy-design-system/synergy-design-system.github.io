import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,d as r,f as i,g as a,u as o}from"./iframe-CIeU5pXv.js";import{t as s}from"./button-DQZ97ppS.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-Dma-UHGC.js";import{n as m,t as h}from"./radio-Blse5uK2.js";var g,_,v,y,b,x,S,C,w,T,E,D,O,k,A;e((()=>{h(),m(),s(),t(),f(),r(),a(),{userEvent:g}=__STORYBOOK_MODULE_TEST__,{args:_,argTypes:v}=l(`syn-radio`),{overrideArgs:y}=c(`syn-radio`),{generateTemplate:b}=d(`syn-radio`),x={args:y({name:`default`,type:`slot`,value:`Option`},_),argTypes:v,component:`syn-radio`,parameters:{chromatic:{modes:i},design:o(`41310-252390`),docs:{description:{component:u(`radio`,`default`)}}},tags:[`Form`],title:`Components/syn-radio`},S={parameters:{controls:{disable:!1},docs:{description:{story:u(`radio`,`default`)}}},render:e=>b({args:e})},C={parameters:{docs:{description:{story:u(`radio`,`initialValue`)}}},render:()=>n`
    <syn-radio-group value="1">
      <syn-radio value="1" selected>Option</syn-radio>
    </syn-radio-group>
  `},w={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`radio`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-radio`);t&&t.focus()},render:()=>n`
    <syn-radio value="1">Option</syn-radio>`},T={parameters:{docs:{description:{story:u(`radio`,`disabled`)}}},render:()=>n`
    <syn-radio value="1" disabled>Option</syn-radio>`},E={parameters:{docs:{description:{story:u(`radio`,`readonly`)}}},render:()=>n`
    <syn-radio-group value="1">
      <syn-radio value="1" readonly>Read-only content</syn-radio>
    </syn-radio-group>
  `},D={parameters:{docs:{description:{story:u(`radio`,`sizes`)}}},render:()=>n`
  ...
  Readonly,
  Sizes
})`,...k.parameters?.docs?.source}}},A=[`Default`,`InitialValue`,`Focus`,`Disabled`,`Readonly`,`Sizes`,`Invalid`,`Screenshot`]}))();export{S as Default,T as Disabled,w as Focus,C as InitialValue,O as Invalid,E as Readonly,k as Screenshot,D as Sizes,A as __namedExportsOrder,x as default};