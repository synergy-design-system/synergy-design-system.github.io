import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,d as r,f as i,g as a,u as o}from"./iframe-DJ0QlWgc.js";import{t as s}from"./button-Bu5NB7Z0.js";import{i as c,n as l,o as u,r as d,t as f}from"./component-CYGmWguq.js";import{n as p,t as m}from"./PaddingDecorator-D0C63Ei_.js";import{t as h}from"./textarea-D76jQhjB.js";var g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P;e((()=>{h(),s(),t(),d(),r(),m(),a(),{userEvent:g}=__STORYBOOK_MODULE_TEST__,{args:_,argTypes:v}=c(`syn-textarea`),{generateTemplate:y}=u(`syn-textarea`),b={args:_,argTypes:v,parameters:{chromatic:{modes:i},design:o(`41337-204379`),docs:{description:{component:l(`textarea`,`default`)}}},tags:[`Form`],title:`Components/syn-textarea`},x={parameters:{controls:{disable:!1},docs:{description:{story:l(`textarea`,`default`)}}},render:e=>y({args:e})},S={parameters:{docs:{description:{story:l(`textarea`,`labels`)}}},render:()=>n`<syn-textarea label="Comments"></syn-textarea>`},C={parameters:{docs:{description:{story:l(`textarea`,`help-text`)}}},render:()=>n`<syn-textarea label="Feedback" help-text="Please tell us what you think."> </syn-textarea>`},w={parameters:{docs:{description:{story:l(`textarea`,`rows`)}}},render:()=>n`
    ...
    </style>`},T={parameters:{docs:{description:{story:l(`textarea`,`placeholder`)}}},render:()=>n`<syn-textarea placeholder="Type something"></syn-textarea>`},E={parameters:{docs:{description:{story:l(`textarea`,`readonly`)}}},render:()=>n`<syn-textarea value="Read-only content"  readonly></syn-textarea>`},D={decorators:[p()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:l(`textarea`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-textarea`);t&&t.focus()},render:()=>n`
      <form>
        <syn-textarea placeholder="This is in focus"></syn-textarea>
      </form>
    `},O={parameters:{docs:{description:{story:l(`textarea`,`disabled`)}}},render:()=>n`<syn-textarea placeholder="Textarea" help-text="Please tell us what you think." label="Label" disabled></syn-textarea>`},k={parameters:{docs:{description:{story:l(`textarea`,`size`)}}},render:()=>n`
  ...
  `},j={parameters:{docs:{description:{story:l(`textarea`,`resize`)}}},render:()=>n`<syn-textarea resize="none"></syn-textarea>`},M={parameters:{docs:{description:{story:l(`textarea`,`resize-auto`)}}},render:()=>n`<syn-textarea resize="auto" placeholder="Type something"></syn-textarea>`},N=f({Default:x,Labels:S,HelpText:C,Rows:w,Placeholders:T,ReadonlyTextareas:E,Disabled:O,Sizes:k,PreventResizing:j,ExpandWithContent:M},500),x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  PreventResizing,
  ExpandWithContent
}, 500)`,...N.parameters?.docs?.source}}},P=[`Default`,`Labels`,`HelpText`,`Rows`,`Placeholders`,`ReadonlyTextareas`,`Focus`,`Disabled`,`Sizes`,`Invalid`,`PreventResizing`,`ExpandWithContent`,`Screenshot`]}))();export{x as Default,O as Disabled,M as ExpandWithContent,D as Focus,C as HelpText,A as Invalid,S as Labels,T as Placeholders,j as PreventResizing,E as ReadonlyTextareas,w as Rows,N as Screenshot,k as Sizes,P as __namedExportsOrder,b as default};