import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{d as n,n as r,s as i,t as a}from"./preview-DdzcclEm.js";import{c as o,t as s}from"./lit-BfcklOOD.js";import{t as c}from"./react-DvlgmmzG.js";import{d as l,f as u,i as d,p as f,u as p}from"./blocks-7PJzwYwY.js";import{t as m}from"./button-BpLoAK9F.js";import{t as h}from"./icon-8cT1hKpd.js";import{n as g,r as _}from"./component-BjD7AuVi.js";import{n as v,t as y}from"./taggedTemplateLiteral-C9cDEsPD.js";import{t as b}from"./button-group-BIuNkiwo.js";import{t as x}from"./tooltip-Cp9oQqCl.js";import{t as S}from"./header-BjbRhR4z.js";var C,w,T,E,D;t((()=>{C=e(c(),1),f(),s(),a(),m(),b(),S(),x(),h(),_(),n(),v(),T={parameters:{chromatic:{...r?.parameters?.chromatic,disableSnapshot:!1,modes:i},docs:{description:{component:g(`tooltip`,`default`,`templates`)},page:()=>C.createElement(C.Fragment,null,C.createElement(u,null),C.createElement(l,null),C.createElement(d,null),C.createElement(p,{title:``}))}},tags:[`Feedback`],title:`Templates/Tooltip`},E={parameters:{docs:{description:{story:g(`tooltip`,`single-instance`,`templates`)}}},render:()=>o(w||=y([`
  ...
  render: () => html\`
    ...
    <\/script>
  \`
}`,...E.parameters?.docs?.source}}},D=[`SingleInstance`]}))();export{E as SingleInstance,D as __namedExportsOrder,T as default};