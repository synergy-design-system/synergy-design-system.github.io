...
`})),P,F,I=e((()=>{O(),m(),D(),r(),g(),u(),j(),v(),c(),s(),y(),N(),x(),o(),P=class extends d{constructor(...e){super(...e),this.localize=new h(this),this.open=!1,this.disabled=!1,this.contained=!1,this.size=`medium`}static{this.styles=[i,M]}static{this.dependencies={"syn-icon":b}}firstUpdated(){this.body.style.height=this.open?`auto`:`0`,this.open&&(this.details.open=!0),this.detailsObserver=new MutationObserver(e=>{for(let t of e)t.type===`attributes`&&t.attributeName===`open`&&(this.details.open?this.show():this.hide())}),this.detailsObserver.observe(this.details,{attributes:!0})}disconnectedCallback(){super.disconnectedCallback(),this.detailsObserver?.disconnect()}handleSummaryClick(e){e.preventDefault(),this.disabled||(this.open?this.hide():this.show(),this.header.focus())}handleSummaryKeyDown(e){(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),this.open?this.hide():this.show()),(e.key===`ArrowUp`||e.key===`ArrowLeft`)&&(e.preventDefault(),this.hide()),(e.key===`ArrowDown`||e.key===`ArrowRight`)&&(e.preventDefault(),this.show())}async handleOpenChange(){if(this.open){if(this.details.open=!0,this.emit(`syn-show`,{cancelable:!0}).defaultPrevented){this.open=!1,this.details.open=!1;return}await E(this.body);let{keyframes:e,options:t}=k(this,`details.show`,{dir:this.localize.dir()});await C(this.body,w(e,this.body.scrollHeight),t),this.body.style.height=`auto`,this.emit(`syn-after-show`)}else{if(this.emit(`syn-hide`,{cancelable:!0}).defaultPrevented){this.details.open=!0,this.open=!0;return}await E(this.body);let{keyframes:e,options:t}=k(this,`details.hide`,{dir:this.localize.dir()});await C(this.body,w(e,this.body.scrollHeight),t),this.body.style.height=`auto`,this.details.open=!1,this.emit(`syn-after-hide`)}}async show(){if(!(this.open||this.disabled))return this.open=!0,A(this,`syn-after-show`)}async hide(){if(!(!this.open||this.disabled))return this.open=!1,A(this,`syn-after-hide`)}render(){return t`
    ...
    `}},l([a(`.details`)],P.prototype,`details`,void 0),l([a(`.details__header`)],P.prototype,`header`,void 0),l([a(`.details__body`)],P.prototype,`body`,void 0),l([a(`.details__expand-icon-slot`)],P.prototype,`expandIconSlot`,void 0),l([f({type:Boolean,reflect:!0})],P.prototype,`open`,void 0),l([f()],P.prototype,`summary`,void 0),l([f({type:Boolean,reflect:!0})],P.prototype,`disabled`,void 0),l([f({type:Boolean,reflect:!0})],P.prototype,`contained`,void 0),l([f({reflect:!0})],P.prototype,`size`,void 0),l([_(`open`,{waitUntilFirstUpdate:!0})],P.prototype,`handleOpenChange`,null),P=l([S(`SynDetails`)],P),F=P,T(`details.show`,{keyframes:[{height:`0`,opacity:`0`},{height:`auto`,opacity:`1`}],options:{duration:250,easing:`linear`}}),T(`details.hide`,{keyframes:[{height:`auto`,opacity:`1`},{height:`0`,opacity:`0`}],options:{duration:250,easing:`linear`}})})),L=e((()=>{I(),I(),F.define(`syn-details`)}));export{L as t};