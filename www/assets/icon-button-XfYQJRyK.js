import{w as _,x as S,T as z,i as g}from"./directive-helpers-po9zzQFH.js";import{a as w,c as x,S as T,b as E,n as b}from"./icon.component-9h-AoRHs.js";/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const p=Symbol.for(""),B=e=>{if(e?.r===p)return e?._$litStatic$},V=e=>({_$litStatic$:e,r:p}),v=(e,...t)=>({_$litStatic$:t.reduce((r,o,n)=>r+(s=>{if(s._$litStatic$!==void 0)return s._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${s}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(o)+e[n+1],e[0]),r:p}),m=new Map,F=e=>(t,...r)=>{const o=r.length;let n,s;const i=[],h=[];let l,u=0,f=!1;for(;u<o;){for(l=t[u];u<o&&(s=r[u],(n=B(s))!==void 0);)l+=n+t[++u],f=!0;u!==o&&h.push(s),i.push(l),u++}if(u===o&&i.push(t[o]),f){const y=i.join("$$lit$$");(t=m.get(y))===void 0&&(i.raw=i,m.set(y,t=i)),r=h}return e(t,...r)},P=F(S);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const d=e=>e??z;/**
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function R(e,t){return(r,o,n)=>{const s=i=>i.renderRoot?.querySelector(e)??null;if(t){const{get:i,set:h}=typeof o=="object"?r:n??(()=>{const l=Symbol();return{get(){return this[l]},set(u){this[l]=u}}})();return $(r,o,{get(){let l=i.call(this);return l===void 0&&(l=s(this),(l!==null||this.hasUpdated)&&h.call(this,l)),l}})}return $(r,o,{get(){return s(this)}})}}const U=g`
	/* stylelint-disable */
  :host {
