import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-DRz18Lsn.js";import{c as i,t as a}from"./lit-D4-0ovri.js";import{t as o}from"./button-CBC8ywKX.js";import{a as s,i as c,n as l,o as u,r as d,t as f}from"./component-NnlguzJ1.js";import{t as p}from"./checkbox-group-CIvO1NgC.js";import{t as m}from"./checkbox-CVHh1A6r.js";var h=t({Checked:()=>E,Default:()=>S,Disabled:()=>k,Focus:()=>O,HelpText:()=>D,HorizontalLayout:()=>w,Labels:()=>T,Readonly:()=>A,Screenshot:()=>M,Sizes:()=>j,VerticalLayout:()=>C,__namedExportsOrder:()=>N,default:()=>x}),g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N;function P(){return(P=e((()=>{p(),m(),o(),a(),d(),r(),g=e=>`${e[0].toUpperCase()}${e.slice(1)}`,_=(e=3,t={})=>Array.from({length:e},(e,n)=>i`
  <syn-checkbox
...
`),{argTypes:v}=c(`syn-checkbox-group`),{overrideArgs:y}=s(`syn-checkbox-group`),{generateTemplate:b}=u(`syn-checkbox-group`),x={args:y([{name:`label`,type:`attribute`,value:`This is a label`},{name:`default`,type:`slot`,value:`
  ...
  `},M=f({Default:S,VerticalLayout:C,HorizontalLayout:w,Labels:T,Checked:E,HelpText:D,Disabled:k,Readonly:A,Sizes:j},400),N=[`Default`,`VerticalLayout`,`HorizontalLayout`,`Labels`,`Checked`,`HelpText`,`Focus`,`Disabled`,`Readonly`,`Sizes`,`Screenshot`],S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  Readonly,
  Sizes
}, 400)`,...M.parameters?.docs?.source}}}})))()}export{h as n,P as r,S as t};