import{v as x,c as a,C as S,d as k}from"./iframe-hf7datPi.js";import{L as w}from"./localize-Dh03wnLC.js";import{S as z,c as R,n as _}from"./synergy-element-MbvDzJcB.js";import{r as C}from"./icon.component-C5ndyS-D.js";import{a as D}from"./query-D0jTsbLw.js";import"./button-BsL0ul94.js";import"./icon-kOsBw5Mx.js";import{g as s,a as E,s as B,b as L,c as O}from"./component-BJCvJqXO.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DihgwUfS.js";import"./watch-CEsCE2EF.js";import"./class-map-BV1AMrtw.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./if-defined-DbVgGXWy.js";import"./spinner.component-CGTLjUny.js";import"./decorator-UnohHU6S.js";import"./functions-B4dslKTf.js";import"./index-3hbeBem-.js";import"./_docs-DNIao1HN.js";const P=x`
	/* stylelint-disable */
  :host {
    --size: 128px;
    --track-width: 4px;
...
`;var j=Object.defineProperty,m=(r,t,d,y)=>{for(var e=void 0,v=r.length-1,h;v>=0;v--)(h=r[v])&&(e=h(t,d,e)||e);return e&&j(t,d,e),e};class g extends z{constructor(){super(...arguments),this.localize=new w(this),this.value=0,this.label=""}static{this.styles=[R,P,T]}updated(t){if(super.updated(t),t.has("value")){const d=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),y=2*Math.PI*d,e=y-this.value/100*y;this.indicatorOffset=`${e}px`}}render(){return a`
    ...
    `}}m([D(".progress-ring__indicator")],g.prototype,"indicator");m([C()],g.prototype,"indicatorOffset");m([_({type:Number,reflect:!0})],g.prototype,"value");m([_()],g.prototype,"label");g.define("syn-progress-ring");var f=Object.freeze,A=Object.defineProperty,I=(r,t)=>f(A(r,"raw",{value:f(r.slice())})),b;const{args:M,argTypes:$}=B("syn-progress-ring"),{overrideArgs:V}=O("syn-progress-ring"),{generateTemplate:F}=L("syn-progress-ring"),cr={args:V([{name:"default",type:"slot",value:""},{name:"value",type:"attribute",value:"25"}],M),argTypes:$,component:"syn-progress-ring",parameters:{chromatic:{modes:S},design:k("14207-8709"),docs:{description:{component:s("progress-ring","default")}}},tags:["Feedback"],title:"Components/syn-progress-ring"},o={parameters:{docs:{description:{story:s("progress-ring","default")}}},render:r=>F({args:r})},n={parameters:{docs:{description:{story:s("progress-ring","size")}}},render:()=>a`
  ...
  `},p={parameters:{docs:{description:{story:s("progress-ring","show-values")}}},render:()=>a(b||(b=I([`
    ...
    <\/script>
  `])))},u=E({Default:o,Size:n,TrackAndIndicatorWidth:i,Colors:c,Labels:l,ShowingValues:p},300);o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
