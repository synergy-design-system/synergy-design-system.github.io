import{i as e}from"./preload-helper-xPQekRTU.js";import{Ht as t,It as n,Lt as r,M as i,Nt as a,O as o,jt as ee,k as te,qt as s}from"./iframe-BjJCO_Oc.js";import{n as c,t as l}from"./class-map-BR8a3Elu.js";import{r as u,t as ne}from"./if-defined-B8V0AGPZ.js";import{_ as d,f,h as re,l as ie,s as p,y as m}from"./synergy-element-C6zHV5cB.js";var ae,oe,se,ce,h,le,ue,de,fe,g,pe,me,_,v,y,b,x,he,S=e((()=>{ae=Object.defineProperty,oe=Object.defineProperties,se=Object.getOwnPropertyDescriptor,ce=Object.getOwnPropertyDescriptors,h=Object.getOwnPropertySymbols,le=Object.prototype.hasOwnProperty,ue=Object.prototype.propertyIsEnumerable,de=e=>{throw TypeError(e)},fe=(e,t,n)=>t in e?ae(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,g=(e,t)=>{for(var n in t||={})le.call(t,n)&&fe(e,n,t[n]);if(h)for(var n of h(t))ue.call(t,n)&&fe(e,n,t[n]);return e},pe=(e,t)=>oe(e,ce(t)),me=(e,t)=>{var n={};for(var r in e)le.call(e,r)&&t.indexOf(r)<0&&(n[r]=e[r]);if(e!=null&&h)for(var r of h(e))t.indexOf(r)<0&&ue.call(e,r)&&(n[r]=e[r]);return n},_=(e,t,n,r)=>{for(var i=r>1?void 0:r?se(t,n):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(i=(r?o(t,n,i):o(i))||i);return r&&i&&ae(t,n,i),i},v=(e,t,n)=>t.has(e)||de(`Cannot `+n),y=(e,t,n)=>(v(e,t,`read from private field`),n?n.call(e):t.get(e)),b=(e,t,n)=>t.has(e)?de(`Cannot add the same private member more than once`):t instanceof WeakSet?t.add(e):t.set(e,n),x=(e,t,n,r)=>(v(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),he=(e,t,n)=>(v(e,t,`access private method`),n)}));function C(e,t){let n=g({waitUntilFirstUpdate:!1},t);return(t,r)=>{let{update:i}=t,a=Array.isArray(e)?e:[e];t.update=function(e){a.forEach(t=>{let i=t;if(e.has(i)){let t=e.get(i),a=this[i];t!==a&&(!n.waitUntilFirstUpdate||this.hasUpdated)&&this[r](t,a)}}),i.call(this,e)}}}var w=e((()=>{S()})),T,E=e((()=>{n(),T=s`
  :host {
...
`})),X,pt=e((()=>{ft(),R(),qe(),E(),k(),S(),l(),o(),ne(),p(),X=class extends O{constructor(){super(...arguments),this.hasFocus=!1,this.label=``,this.size=`inherit`,this.color=`currentColor`,this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){let e=!!this.href,t=e?te`a`:te`button`;return i`
      <${t}
        part="base"
        class=${c({"icon-button":!0,"icon-button--disabled":!e&&this.disabled,"icon-button--focused":this.hasFocus,"icon-button--large":this.size===`large`,"icon-button--medium":this.size===`medium`,"icon-button--small":this.size===`small`})}
    ...
    `}},Z.styles=[T,lt,st],Z.dependencies={"syn-icon-button":X,"syn-resize-observer":Y},_([ie({slot:`nav`,selector:`syn-tab`})],Z.prototype,`tabs`,2),_([ie({selector:`syn-tab-panel`})],Z.prototype,`panels`,2),_([f(`.tab-group`)],Z.prototype,`tabGroup`,2),_([f(`.tab-group__body`)],Z.prototype,`body`,2),_([f(`.tab-group__nav`)],Z.prototype,`nav`,2),_([f(`.tab-group__indicator`)],Z.prototype,`indicator`,2),_([d()],Z.prototype,`hasScrollControls`,2),_([d()],Z.prototype,`shouldHideScrollStartButton`,2),_([d()],Z.prototype,`shouldHideScrollEndButton`,2),_([m()],Z.prototype,`placement`,2),_([m()],Z.prototype,`activation`,2),_([m({attribute:`no-scroll-controls`,type:Boolean})],Z.prototype,`noScrollControls`,2),_([m({type:Boolean})],Z.prototype,`contained`,2),_([m({type:Boolean})],Z.prototype,`sharp`,2),_([m({attribute:`fixed-scroll-controls`,type:Boolean})],Z.prototype,`fixedScrollControls`,2),_([re({passive:!0})],Z.prototype,`updateScrollButtons`,1),_([C(`noScrollControls`,{waitUntilFirstUpdate:!0})],Z.prototype,`updateScrollControls`,1),_([C(`placement`,{waitUntilFirstUpdate:!0})],Z.prototype,`syncIndicator`,1)})),_t=e((()=>{gt(),Z.define(`syn-tab-group`)})),vt=e((()=>{_t(),gt(),rt(),nt(),ct(),ut(),pt(),ft(),R(),A(),j(),J(),q(),K(),E(),k()})),yt,bt=e((()=>{n(),yt=s`
  :host {
...
`})),Ct,Q,wt=e((()=>{bt(),St(),pt(),J(),w(),E(),k(),S(),l(),n(),p(),Ct=0,Q=class extends O{constructor(){super(...arguments),this.localize=new et(this),this.attrId=++Ct,this.componentId=`syn-tab-${this.attrId}`,this.panel=``,this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`tab`)}handleCloseClick(e){e.stopPropagation(),this.emit(`syn-close`)}handleActiveChange(){this.setAttribute(`aria-selected`,this.active?`true`:`false`)}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled?`true`:`false`),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,t`
      <div
        part="base"
    ...
    `}},Q.styles=[T,xt,yt],Q.dependencies={"syn-icon-button":X},_([f(`.tab`)],Q.prototype,`tab`,2),_([m({reflect:!0})],Q.prototype,`panel`,2),_([m({type:Boolean,reflect:!0})],Q.prototype,`active`,2),_([m({type:Boolean,reflect:!0})],Q.prototype,`closable`,2),_([m({type:Boolean,reflect:!0})],Q.prototype,`disabled`,2),_([m({type:Number,reflect:!0})],Q.prototype,`tabIndex`,2),_([C(`active`)],Q.prototype,`handleActiveChange`,1),_([C(`disabled`)],Q.prototype,`handleDisabledChange`,1)})),Tt=e((()=>{wt(),Q.define(`syn-tab`)})),Et=e((()=>{Tt(),wt(),bt(),St(),pt(),ft(),R(),A(),j(),J(),q(),K(),E(),k()})),Dt,Ot=e((()=>{n(),Dt=s`
  /* Write custom CSS here */
  .tab-panel {
    color: var(--syn-typography-color-text);
  }
...
`})),jt,$,Mt=e((()=>{Ot(),At(),w(),E(),k(),S(),l(),n(),p(),jt=0,$=class extends O{constructor(){super(...arguments),this.attrId=++jt,this.componentId=`syn-tab-panel-${this.attrId}`,this.name=``,this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute(`role`,`tabpanel`)}handleActiveChange(){this.setAttribute(`aria-hidden`,this.active?`false`:`true`)}render(){return t`
      <slot
        part="base"
        class=${c({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}},$.styles=[T,kt,Dt],_([m({reflect:!0})],$.prototype,`name`,2),_([m({type:Boolean,reflect:!0})],$.prototype,`active`,2),_([C(`active`)],$.prototype,`handleActiveChange`,1)})),Nt=e((()=>{Mt(),$.define(`syn-tab-panel`)})),Pt=e((()=>{Nt(),Mt(),Ot(),At(),E(),k()}));export{pe as A,C,y as D,b as E,S as M,he as O,w as S,me as T,A as _,J as a,T as b,Ke as c,Ie as d,z as f,j as g,R as h,et as i,g as j,x as k,qe as l,L as m,Et as n,q as o,Pe as p,vt as r,K as s,Pt as t,Fe as u,O as v,_ as w,E as x,k as y};