import{i as e}from"./preload-helper-xPQekRTU.js";import{D as t,Ht as n,It as r,T as i,d as a,f as o,g as s,u as c}from"./iframe-BjJCO_Oc.js";import{t as l}from"./button-Cq0pTj4t.js";import{t as u}from"./card-C7SIWrQ1.js";import{a as d,i as f,n as p,o as m,r as h,t as g}from"./component-Bp0Gg8Fw.js";import{t as _}from"./icon-button-iltpZ1cJ.js";var v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N=e((()=>{r(),i(),u(),l(),_(),h(),a(),s(),{args:v,argTypes:y}=f(`syn-card`),{overrideArgs:b}=d(`syn-card`),{generateTemplate:x}=m(`syn-card`),S=({buttonText:e=`More info`,footerText:t=`Optional information`}={})=>`
  <footer slot="footer">
    <small>${t}</small>
    <nav>
...
`,C={args:b([{name:`image`,type:`slot`,value:`<img slot="image" src="https://synergy-design-system.github.io/card-example.jpg" alt="Multiple persons having lunch in SICK Academy" />`},{name:`default`,type:`slot`,value:`
      ...
      `},{name:`footer`,type:`slot`,value:S()}],v),argTypes:y,component:`syn-card`,parameters:{chromatic:{modes:o},design:c(`42207-351610`),docs:{description:{component:p(`card`,`default`)}}},tags:[`Structure`],title:`Components/syn-card`},w={parameters:{controls:{disable:!1},docs:{description:{story:p(`card`,`default`)}}},render:e=>x({args:e})},T={parameters:{docs:{description:{story:p(`card`,`basic-card`)}}},render:()=>n`
  ...
  `},E={parameters:{docs:{description:{story:p(`card`,`with-header`)}}},render:()=>n`
  ...
  `},D={parameters:{docs:{description:{story:p(`card`,`with-footer`)}}},render:()=>n`
  ...
  `},O={parameters:{docs:{description:{story:p(`card`,`images`)}}},render:()=>n`
  ...
  `},k={parameters:{docs:{description:{story:p(`card`,`sharp`)}}},render:()=>n`
  ...
  `},A={parameters:{docs:{description:{story:p(`card`,`shadow`)}}},render:()=>n`
