import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{_ as n,a as r,h as i,l as a}from"./preview-DRz18Lsn.js";import{c as o,t as s}from"./lit-D4-0ovri.js";import{i as c,n as l}from"./dist-CxjvbReK.js";import{t as u}from"./icon-BbsmBxau.js";import{a as d,i as f,n as p,o as m,r as h,t as g}from"./component-NnlguzJ1.js";import{t as _}from"./taggedTemplateLiteral-BZenJ0bZ.js";import{n as v,t as y}from"./tab-panel-fhNVz9iK.js";import{t as b}from"./tab-BpekSoTQ.js";var x=t({ClosableTabs:()=>V,Default:()=>R,Icons:()=>G,ManualActivation:()=>W,Screenshot:()=>K,ScrollingTabs:()=>H,TabsOnEnd:()=>B,TabsOnStart:()=>z,VisualHierarchy:()=>U,__namedExportsOrder:()=>q,default:()=>L}),S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q;function J(){return(J=e((()=>{v(),b(),y(),u(),s(),l(),i(),h(),a(),{args:C,argTypes:w}=f(`syn-tab-group`),{overrideArgs:T}=d(`syn-tab-group`),{generateTemplate:E}=m(`syn-tab-group`),D=(e,t,{active:n=!1,closable:r=!1,disabled:i=!1}={})=>`<syn-tab slot="nav" panel="${e}" ${n?`active`:``} ${i?`disabled`:``} ${r?`closable`:``}>${t}</syn-tab>`,O=(e,t,{active:r=!1,closable:i=!1,disabled:a=!1}={})=>n(D(e,t,{active:r,closable:i,disabled:a})),k=()=>[{panel:`general`,props:{active:!0}},{panel:`custom`},{panel:`advanced`},{panel:`disabled`,props:{disabled:!0}}].map(({panel:e,props:t})=>D(e,c(e),t)).join(`
...
`},K=g({Default:R,TabsOnStart:z,TabsOnEnd:B,ClosableTabs:V,ScrollingTabs:H,VisualHierarchy:U,Icons:G},{heightPx:740}),q=[`Default`,`TabsOnStart`,`TabsOnEnd`,`ClosableTabs`,`ScrollingTabs`,`VisualHierarchy`,`ManualActivation`,`Icons`,`Screenshot`],R.parameters={...R.parameters,docs:{...R.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
\`
  ...
  heightPx: 740
})`,...K.parameters?.docs?.source}}}})))()}export{J as n,x as r,R as t};