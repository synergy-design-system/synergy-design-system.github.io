import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-DRz18Lsn.js";import{c as i,t as a}from"./lit-D4-0ovri.js";import{t as o}from"./range-BDOdkK3m.js";import{t as s}from"./button-CBC8ywKX.js";import{t as c}from"./input-DeuiTlMk.js";import{a as l,i as u,n as d,o as f,r as p,t as m}from"./component-NnlguzJ1.js";import{t as h}from"./taggedTemplateLiteral-BZenJ0bZ.js";import{n as g,t as _}from"./decorators-CjBNNcov.js";import{t as v}from"./range-tick-C1agnUbQ.js";var y=t({CustomTrackColors:()=>R,CustomTrackOffset:()=>z,Default:()=>k,Disabled:()=>M,Focus:()=>P,HelpText:()=>j,Invalid:()=>N,Labels:()=>A,MultiThumb:()=>B,MultiThumbWithRestrictedMovement:()=>V,PrefixSuffixText:()=>L,Readonly:()=>F,Screenshot:()=>K,Sizes:()=>I,Ticks:()=>H,TooltipDisabled:()=>W,TooltipFormatter:()=>G,TooltipPlacement:()=>U,__namedExportsOrder:()=>q,default:()=>O}),b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q;function J(){return(J=e((()=>{a(),o(),s(),c(),v(),_(),p(),r(),{userEvent:b}=__STORYBOOK_MODULE_TEST__,{args:w,argTypes:T}=u(`syn-range`),{overrideArgs:E}=l(`syn-range`),{generateTemplate:D}=f(`syn-range`),O={args:E([{name:`value`,type:`attribute`,value:`50`}],w),argTypes:T,component:`syn-range`,parameters:{chromatic:{modes:n},docs:{description:{component:d(`range`,`default`)}}},tags:[`Form`],title:`Components/syn-range`},k={parameters:{controls:{disable:!1},docs:{description:{story:d(`range`,`default`)},story:{height:`80px`}}},render:e=>D({args:e})},A={parameters:{docs:{description:{story:d(`range`,`labels`)}}},render:()=>i`
  ...
  `},G={parameters:{docs:{description:{story:d(`range`,`tooltip-formatter`)}}},render:()=>i(C||=h([`
    ...
    <\/script>
  `]))},K=m({Default:k,Labels:A,HelpText:j,Disabled:M,Readonly:F,Sizes:I,PrefixSuffixText:L,CustomTrackColors:R,CustomTrackOffset:z,MultiThumb:B,Ticks:H,TooltipPlacement:U,TooltipDisabled:W,TooltipFormatter:G},500),q=[`Default`,`Labels`,`HelpText`,`Disabled`,`Invalid`,`Focus`,`Readonly`,`Sizes`,`PrefixSuffixText`,`CustomTrackColors`,`CustomTrackOffset`,`MultiThumb`,`MultiThumbWithRestrictedMovement`,`Ticks`,`TooltipPlacement`,`TooltipDisabled`,`TooltipFormatter`,`Screenshot`],k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  TooltipDisabled,
  TooltipFormatter
}, 500)`,...K.parameters?.docs?.source}}}})))()}export{J as n,y as r,k as t};