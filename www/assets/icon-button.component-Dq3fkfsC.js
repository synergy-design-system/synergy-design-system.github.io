import{b,a as p,u as h}from"./static-gmWA-8Kq.js";import{o as e}from"./if-defined-B2ZFWIyt.js";import{n}from"./property-BGzwfL48.js";import{a as y}from"./library-6WV9-XO2.js";import{a as f}from"./query-DAIS6qJ0.js";import{c as m,S as v}from"./component.styles-DHLjuUKI.js";import{S as g}from"./icon.component-D5Mb01w1.js";import{i as d}from"./directive-helpers-DGrfjhaU.js";import{e as $}from"./decorator-DANECR0-.js";const z=d`
	/* stylelint-disable */
  :host {
...
`;var S=Object.defineProperty,_=Object.getOwnPropertyDescriptor,r=(o,i,l,a)=>{for(var s=a>1?void 0:a?_(i,l):i,c=o.length-1,u;c>=0;c--)(u=o[c])&&(s=(a?u(i,l,s):u(s))||s);return a&&s&&S(i,l,s),s};let t=class extends v{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.size="inherit",this.color="currentColor",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleClick(o){this.disabled&&(o.preventDefault(),o.stopPropagation())}click(){this.button.click()}focus(o){this.button.focus(o)}blur(){this.button.blur()}render(){const o=!!this.href,i=o?b`a`:b`button`;return h`
      <${i}
        part="base"
