import{n as e}from"./chunk-DnJy8xQt.js";import{A as t,D as n,Nt as r,O as i,Ut as a}from"./iframe-BcSabCAt.js";import{n as o,t as s}from"./class-map-ubcCJG2R.js";import{n as c,t as l}from"./if-defined-B5YranhM.js";import{a as u,i as d,m as f,n as p,o as m,p as h,r as g,s as _,t as v,u as y}from"./synergy-element-B9jDHluB.js";import{n as b,t as x}from"./icon.component-Coa5KnIf.js";import{n as S,t as C}from"./decorator-C8FY8E2M.js";var w,T=e((()=>{r(),w=a`
  :host {
...
`})),E,D,O=e((()=>{s(),n(),l(),_(),m(),p(),b(),T(),S(),d(),E=class extends v{constructor(...e){super(...e),this.hasFocus=!1,this.label=``,this.size=`inherit`,this.color=`currentColor`,this.disabled=!1}static{this.styles=[u,w]}static{this.dependencies={"syn-icon":x}}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){let e=!!this.href,n=e?i`a`:i`button`;return t`
    ...
    `}},g([y(`.icon-button`)],E.prototype,`button`,void 0),g([h()],E.prototype,`hasFocus`,void 0),g([f()],E.prototype,`name`,void 0),g([f()],E.prototype,`library`,void 0),g([f()],E.prototype,`src`,void 0),g([f()],E.prototype,`href`,void 0),g([f()],E.prototype,`target`,void 0),g([f()],E.prototype,`download`,void 0),g([f()],E.prototype,`label`,void 0),g([f({reflect:!0})],E.prototype,`size`,void 0),g([f({reflect:!0})],E.prototype,`color`,void 0),g([f({reflect:!0,type:Boolean})],E.prototype,`disabled`,void 0),E=g([C(`SynIconButton`)],E),D=E}));export{O as n,D as t};