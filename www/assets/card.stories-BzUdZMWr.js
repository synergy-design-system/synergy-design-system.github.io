import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-DWg8XNs3.js";import{D as r,T as i,d as a,f as o,g as s,u as c}from"./iframe-CVaCVGtH.js";import{t as l}from"./button-CUvYiMKB.js";import{t as u}from"./card-Cwi87Z99.js";import{a as d,i as f,n as p,o as m,r as h,t as g}from"./component-CllRTPI1.js";import{t as _}from"./icon-button-CUNxpVjV.js";var v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N=e((()=>{n(),i(),u(),l(),_(),h(),a(),s(),{args:v,argTypes:y}=f(`syn-card`),{overrideArgs:b}=d(`syn-card`),{generateTemplate:x}=m(`syn-card`),S=({buttonText:e=`More info`,footerText:t=`Optional information`}={})=>`
  <footer slot="footer">
    <small>${t}</small>
    <nav>
...
`,C={args:b([{name:`image`,type:`slot`,value:`<img slot="image" src="https://synergy-design-system.github.io/card-example.jpg" alt="Multiple persons having lunch in SICK Academy" />`},{name:`default`,type:`slot`,value:`
  ...
  `},D={parameters:{docs:{description:{story:p(`card`,`with-footer`)}}},render:()=>t`
    <syn-card class="card-footer">
      ...
      ${r(S({buttonText:`Preview`,footerText:`Optional information`}))}
    </syn-card>
