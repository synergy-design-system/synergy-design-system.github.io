import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,Ut as r}from"./iframe-CkET12W3.js";import{n as i,t as a}from"./class-map-CFhFi09d.js";import{r as o,t as s}from"./slot-BUy-JBM2.js";import{n as c,t as l}from"./localize-BO4uh8LG.js";import{a as u,i as d,m as f,n as p,o as m,p as h,r as g,s as _,t as v,u as y}from"./synergy-element-CyJGxssW.js";import{n as b,t as x}from"./watch-0Lf6m-Da.js";import{n as S,t as C}from"./decorator-C8FY8E2M.js";import{a as w,i as T,l as E,n as D,o as O,t as k}from"./animation-registry-8j1MdtzW.js";import{n as A,t as j}from"./event-BEe8X6yJ.js";import{n as M,t as N}from"./closeActiveElement-CUhkkin_.js";import{n as P,t as F}from"./icon-button.component-BbutBXAO.js";var I,L=e((()=>{t(),I=r`
...
`})),R,z,B,V=e((()=>{O(),M(),a(),D(),o(),t(),l(),_(),j(),x(),m(),p(),P(),L(),S(),d(),z=class extends v{static{R=this}constructor(...e){super(...e),this.hasSlotController=new s(this,`icon`,`suffix`),this.localize=new c(this),this.open=!1,this.closable=!1,this.variant=`primary`,this.duration=1/0,this.size=`medium`,this.remainingTime=this.duration}static{this.styles=[u,I]}static{this.dependencies={"syn-icon-button":F}}static get toastStack(){return this.currentToastStack||=Object.assign(document.createElement(`div`),{className:`syn-toast-stack`}),this.currentToastStack}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){this.countdownAnimation?.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),this.countdownAnimation?.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){let{countdownElement:e}=this;this.countdownAnimation=e.animate([{width:`100%`},{width:`0`}],{duration:this.duration,easing:`linear`})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit(`syn-show`),this.duration<1/0&&this.restartAutoHide(),await E(this.base),this.base.hidden=!1;let{keyframes:e,options:t}=k(this,`alert.show`,{dir:this.localize.dir()});await w(this.base,e,t),this.emit(`syn-after-show`)}else{N(this),this.emit(`syn-hide`),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await E(this.base);let{keyframes:e,options:t}=k(this,`alert.hide`,{dir:this.localize.dir()});await w(this.base,e,t),this.base.hidden=!0,this.emit(`syn-after-hide`)}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,A(this,`syn-after-show`)}async hide(){if(this.open)return this.open=!1,A(this,`syn-after-hide`)}async toast(){return new Promise(e=>{this.handleCountdownChange(),R.toastStack.parentElement===null&&document.body.append(R.toastStack),R.toastStack.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener(`syn-after-hide`,()=>{R.toastStack.removeChild(this),e(),R.toastStack.querySelector(`syn-alert`)===null&&R.toastStack.remove()},{once:!0})})}render(){return n`
    ...
    `}},g([y(`[part~="base"]`)],z.prototype,`base`,void 0),g([y(`.alert__countdown-elapsed`)],z.prototype,`countdownElement`,void 0),g([f({type:Boolean,reflect:!0})],z.prototype,`open`,void 0),g([f({type:Boolean,reflect:!0})],z.prototype,`closable`,void 0),g([f({reflect:!0})],z.prototype,`variant`,void 0),g([f({type:Number})],z.prototype,`duration`,void 0),g([f({reflect:!0})],z.prototype,`size`,void 0),g([h()],z.prototype,`remainingTime`,void 0),g([b(`open`,{waitUntilFirstUpdate:!0})],z.prototype,`handleOpenChange`,null),g([b(`duration`)],z.prototype,`handleDurationChange`,null),z=R=g([C(`SynAlert`)],z),B=z,T(`alert.show`,{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:`ease`}}),T(`alert.hide`,{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:`ease`}})}));export{V as n,B as t};