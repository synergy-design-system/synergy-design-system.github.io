import{e as h}from"./class-map-BazwZ-LN.js";import{d as p}from"./default-value-BZrShqFi.js";import{F as y}from"./form-d9hCJUdr.js";import{H as v}from"./slot-9EVoRGQc.js";import{j as d,x as m}from"./iframe-CD1urOGO.js";import{o as w}from"./if-defined-D5WUiRWj.js";import{l as b}from"./live-SH2bri9x.js";import{c as f,n as i,S as g}from"./synergy-element-CXOrYrDO.js";import{r as _}from"./icon.component-a8Mzi3bt.js";import{a as k}from"./query-DAIS6qJ0.js";import{w as u}from"./watch-CEsCE2EF.js";import{f as z,a as C}from"./form-control.custom.styles-PeANlGA2.js";import{e as x}from"./decorator-DeP7ND_N.js";const $=d`
	/* stylelint-disable */
  :host {
...
`,F=d`
  ...
  `;var S=Object.defineProperty,V=Object.getOwnPropertyDescriptor,o=(t,r,l,c)=>{for(var s=c>1?void 0:c?V(r,l):r,n=t.length-1,a;n>=0;n--)(a=t[n])&&(s=(c?a(r,l,s):a(s))||s);return c&&s&&S(r,l,s),s};let e=class extends g{constructor(){super(...arguments),this.formControlController=new y(this,{value:t=>t.checked?t.value||"on":void 0,defaultValue:t=>t.defaultChecked,setValue:(t,r)=>t.checked=r}),this.hasSlotController=new v(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleInput(){this.emit("syn-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}handleClick(){this.checked=!this.checked,this.emit("syn-change")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleKeyDown(t){t.key==="ArrowLeft"&&(t.preventDefault(),this.checked=!1,this.emit("syn-change"),this.emit("syn-input")),t.key==="ArrowRight"&&(t.preventDefault(),this.checked=!0,this.emit("syn-change"),this.emit("syn-input"))}handleCheckedChange(){this.input.checked=this.checked,this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(!0)}click(){this.input.click()}focus(t){this.input.focus(t)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("help-text"),r=this.helpText?!0:!!t;return m`
    ...
    `}};e.styles=[f,z,$,C,F];o([k('input[type="checkbox"]')],e.prototype,"input",2);o([_()],e.prototype,"hasFocus",2);o([i({reflect:!0})],e.prototype,"title",2);o([i()],e.prototype,"name",2);o([i()],e.prototype,"value",2);o([i({reflect:!0})],e.prototype,"size",2);o([i({type:Boolean,reflect:!0})],e.prototype,"disabled",2);o([i({type:Boolean,reflect:!0})],e.prototype,"checked",2);o([p("checked")],e.prototype,"defaultChecked",2);o([i({reflect:!0})],e.prototype,"form",2);o([i({type:Boolean,reflect:!0})],e.prototype,"required",2);o([i({attribute:"help-text"})],e.prototype,"helpText",2);o([u("checked",{waitUntilFirstUpdate:!0})],e.prototype,"handleCheckedChange",1);o([u("disabled",{waitUntilFirstUpdate:!0})],e.prototype,"handleDisabledChange",1);e=o([x("SynSwitch")],e);e.define("syn-switch");
