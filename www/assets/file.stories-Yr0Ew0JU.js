import{s as S,a as x,g as v,b as e,c as T,d as D}from"./component-7g7PvM4J.js";import{k as s}from"./lit-element-BsyMe9HG.js";import{u as z}from"./index-DbQ-iIe5.js";import"./index-Dy7bMyTO.js";import"./icon.component-Cwq7Y_Aa.js";import"./directive-helpers-DUpkUCIH.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-B-o1Wr-g.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon-DiAnxFT_.js";import"./index-C8k3Z-3Y.js";var b=Object.freeze,k=Object.defineProperty,E=(r,a)=>b(k(r,"raw",{value:b(r.slice())})),h;const{args:q,argTypes:M}=S("syn-file"),{overrideArgs:_}=D("syn-file"),{generateTemplate:w}=x("syn-file"),G={args:_([],q),argTypes:M,component:"syn-file",parameters:{design:v("21709-49135"),docs:{description:{component:e("file","default")}}},title:"Components/syn-file"},l={parameters:{controls:{disable:!1},docs:{description:{story:e("file","default")}}},render:r=>w({args:r})},t={parameters:{docs:{description:{story:e("file","label")}}},render:()=>s`
...
`},p={parameters:{docs:{description:{story:e("file","sizes")}}},render:()=>s`
  ...
  `},y={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:e("file","focus")}}},play:({canvasElement:r})=>{const a=r.querySelector("syn-file");a&&a.focus()},render:()=>s`
    <syn-file label="This is a label" help-text="This is a help text" droparea></syn-file>
  `},m={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:e("file","invalid")}}},play:async({canvasElement:r})=>{try{const a=r.querySelector("form"),g=a.querySelectorAll("syn-file"),u=a.querySelector("syn-button");u&&g&&(await z.click(u),u.click())}catch(a){console.error("Error in play function:",a)}},render:()=>s(h||(h=E([`
  ...
  `])))},f=T({Default:l,Label:t,HelpText:i,Multiple:n,HideValue:o,Disabled:c,Sizes:p,Droparea:d},350);l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
...
\`
  ...
  Sizes,
  Droparea
}, 350)`,...f.parameters?.docs?.source}}};const J=["Default","Label","HelpText","Multiple","HideValue","Disabled","Sizes","Droparea","Focus","Invalid","Screenshot"];export{l as Default,c as Disabled,d as Droparea,y as Focus,i as HelpText,o as HideValue,m as Invalid,t as Label,n as Multiple,f as Screenshot,p as Sizes,J as __namedExportsOrder,G as default};
