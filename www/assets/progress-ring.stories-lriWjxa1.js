import{n as e}from"./chunk-DnJy8xQt.js";import{At as t,Bt as n,Ft as r,d as i,f as a,p as o,u as s}from"./iframe-CFxyVgYz.js";import{n as c,t as l}from"./localize-DnZL8qNz.js";import{a as u,f as d,i as f,n as p,o as m,p as h,r as g,s as _,t as v,u as y}from"./synergy-element-DOjsnQEs.js";import{t as b}from"./button-BmPxXsuW.js";import{t as x}from"./icon-BNvARCZB.js";import{a as S,i as C,n as w,o as T,r as E,t as D}from"./component-u4nxi-rq.js";import{n as O,t as k}from"./taggedTemplateLiteral-BuD1d7yP.js";var A,j=e((()=>{t(),A=n`
	/* stylelint-disable */
  :host {
    --size: 128px;
    --track-width: 4px;
...
`})),P,F=e((()=>{t(),l(),_(),m(),p(),j(),N(),f(),P=class extends v{constructor(...e){super(...e),this.localize=new c(this),this.value=0,this.label=``}static{this.styles=[u,A,M]}updated(e){if(super.updated(e),e.has(`value`)){let e=parseFloat(getComputedStyle(this.indicator).getPropertyValue(`r`)),t=2*Math.PI*e,n=t-this.value/100*t;this.indicatorOffset=`${n}px`}}render(){return r`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
    ...
    `}},g([y(`.progress-ring__indicator`)],P.prototype,`indicator`,void 0),g([d()],P.prototype,`indicatorOffset`,void 0),g([h({type:Number,reflect:!0})],P.prototype,`value`,void 0),g([h()],P.prototype,`label`,void 0)})),I=e((()=>{F(),F(),P.define(`syn-progress-ring`)})),L,R,z,B,V,H,U,W,G,K,q,J,Y,X;e((()=>{I(),b(),x(),t(),E(),i(),o(),O(),{args:R,argTypes:z}=C(`syn-progress-ring`),{overrideArgs:B}=S(`syn-progress-ring`),{generateTemplate:V}=T(`syn-progress-ring`),H={args:B([{name:`default`,type:`slot`,value:``},{name:`value`,type:`attribute`,value:`25`}],R),argTypes:z,component:`syn-progress-ring`,parameters:{chromatic:{modes:a},design:s(`41203-296727`),docs:{description:{component:w(`progress-ring`,`default`)}}},tags:[`Feedback`],title:`Components/syn-progress-ring`},U={parameters:{docs:{description:{story:w(`progress-ring`,`default`)}}},render:e=>V({args:e})},W={parameters:{docs:{description:{story:w(`progress-ring`,`size`)}}},render:()=>r`
    <syn-progress-ring value="35" style="--size: 48px;"></syn-progress-ring>
  `},G={parameters:{docs:{description:{story:w(`progress-ring`,`track-indicator-width`)}}},render:()=>r`
    <syn-progress-ring value="50" style="--track-width: 4px; --indicator-width: 8px;"></syn-progress-ring>
  `},K={parameters:{docs:{description:{story:w(`progress-ring`,`color`)}}},render:()=>r`
    <syn-progress-ring
      value="50"
      style="--indicator-color: var(--syn-color-success-700);"
    ></syn-progress-ring>`},q={parameters:{docs:{description:{story:w(`progress-ring`,`labels`)}}},render:()=>r`
    <syn-progress-ring value="50" label="Upload progress"></syn-progress-ring>
  `},J={parameters:{docs:{description:{story:w(`progress-ring`,`show-values`)}}},render:()=>r(L||=k([`
  ...
  Labels,
  ShowingValues
}, 300)`,...Y.parameters?.docs?.source}}},X=[`Default`,`Size`,`TrackAndIndicatorWidth`,`Colors`,`Labels`,`ShowingValues`,`Screenshot`]}))();export{K as Colors,U as Default,q as Labels,Y as Screenshot,J as ShowingValues,W as Size,G as TrackAndIndicatorWidth,X as __namedExportsOrder,H as default};