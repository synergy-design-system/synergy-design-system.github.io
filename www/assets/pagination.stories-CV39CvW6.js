import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{a as t,d as n,o as r,s as i}from"./preview-DXkhgu0Z.js";import{c as a,h as o,i as s,t as c}from"./lit-BfcklOOD.js";import{a as l,i as u,n as ee,o as d,r as f,s as p,t as m,y as h}from"./synergy-element-DCZXsIq5.js";import{n as g,t as _}from"./localize-BjBTQYuo.js";import{n as te,t as ne}from"./decorator-B3p9Y8B9.js";import{n as re,t as ie}from"./divider.component-CvMY4GE0.js";import{n as ae,t as oe}from"./icon-button.component-4jL6Io4w.js";import{n as se,t as ce}from"./option.component-0UOcDjOd.js";import{n as le,t as v}from"./select.component-nRF-lvH7.js";import{a as y,i as ue,n as b,o as x,r as S,t as C}from"./component-B0n0ooCL.js";import{i as de,n as fe,t as pe}from"./ref-DP_rbb0q.js";import{n as me,t as he}from"./input.component-CUnMva8h.js";var w,ge=e((()=>{c(),w=o`
  :host {
    display: block;
  }
...
`})),T,E,D,O,k,A,j,M,N,P,F,I=e((()=>{T=[10,25,50,100],E=e=>Number.isSafeInteger(e)&&Number(e)>0,D=e=>Number.isSafeInteger(e)&&Number(e)>=0,O=(e,t,n,r)=>{let i=e.get(t);return r(i)?i:n},k=(e,t)=>Math.ceil((Number.isFinite(e)&&e>0?e:0)/(Number.isFinite(t)&&t>0?t:1)),A=(e,t,n)=>{if(e<=0)return{endIndex:0,startIndex:0};let r=k(e,t),i=Math.min(Math.max(n,1),r),a=(i-1)*t+1;return{endIndex:Math.min(i*t,e),startIndex:a}},j=(e,t)=>Number.isFinite(e)?Math.min(Math.max(e,1),Number.isFinite(t)?Math.max(t,1):1):1,M=(e,t)=>{let n=Number.isFinite(e)&&e>0?e:1;return Math.max(1,Math.ceil((Number.isFinite(t)&&t>0?t:0)/n))},N=e=>{let t=(Array.isArray(e)?e:[]).map(e=>Number(e)).filter(e=>Number.isSafeInteger(e)&&e>0);return t.length>0?t:T},P=e=>N(e).reduce((e,t)=>Math.max(e,String(t).length),1),F=(e,t)=>String(M(e,t)).length})),L,R,z,B=e((()=>{c(),p(),pe(),_(),ee(),d(),ge(),re(),ae(),he(),ce(),v(),I(),te(),u(),R=class extends m{static{L=this}constructor(...e){super(...e),this.baseRef=fe(),this.localize=new g(this),this.divider=!1,this.disabled=!1,this.size=`medium`,this.currentPage=1,this.pageSize=25,this.pageSizeOptions=[10,25,50,100],this.totalItems=0,this.variant=`full`,this.ariaLabel=`Pagination`}static{this.DEFAULT_PAGE_SIZE=25}static{this.DEFAULT_CURRENT_PAGE=1}static{this.DEFAULT_TOTAL_ITEMS=0}static{this.styles=[l,w]}static{this.dependencies={"syn-divider":ie,"syn-icon-button":oe,"syn-input":me,"syn-option":se,"syn-select":le}}pageChangedViaUserInput(e){let t=e.target.valueAsNumber;E(t)&&this.updateCurrentPage(t)}navigationClicked(e,t){e.currentTarget?.blur(),this.updateCurrentPage(t)}sanitizeInvalidPropertyValues(e){if(e.has(`pageSize`)&&!E(this.pageSize)&&(this.pageSize=O(e,`pageSize`,L.DEFAULT_PAGE_SIZE,E)),e.has(`currentPage`)&&!E(this.currentPage)&&(this.currentPage=O(e,`currentPage`,L.DEFAULT_CURRENT_PAGE,E)),e.has(`totalItems`)&&!D(this.totalItems)&&(this.totalItems=O(e,`totalItems`,L.DEFAULT_TOTAL_ITEMS,D)),e.has(`pageSizeOptions`)){let e=N(this.pageSizeOptions);(this.pageSizeOptions.length!==e.length||this.pageSizeOptions.some((t,n)=>t!==e[n]))&&(this.pageSizeOptions=e)}}updateCurrentPage(e){let t=j(e,M(this.pageSize,this.totalItems)),{currentPage:n}=this;t!==n&&(this.emit(`syn-pagination-page-changed`,{detail:{currentPage:t,previousPage:n}}),this.currentPage=t)}pageSizeChanged(e){let{currentPage:t,pageSize:n}=this,{value:r}=e.target,i=parseInt(r,10);if(!Number.isSafeInteger(i)||i<=0)return;let a=(t-1)*n+1,o=M(i,this.totalItems),s=j(Math.floor((a-1)/i)+1,o);this.pageSize=i,this.currentPage=s,this.emit(`syn-pagination-page-size-changed`,{detail:{currentPageSize:i,previousPageSize:n}}),s!==t&&this.emit(`syn-pagination-page-changed`,{detail:{currentPage:s,previousPage:t}})}willUpdate(e){super.willUpdate(e),this.sanitizeInvalidPropertyValues(e);let t=e.get(`pageSizeOptions`);if(Array.isArray(t)&&!this.pageSizeOptions.includes(this.pageSize)){let e=this.pageSizeOptions[0],t=(this.currentPage-1)*this.pageSize+1,n=M(e,this.totalItems),r=j(Math.floor((t-1)/e)+1,n);this.pageSize=e,this.currentPage=r}if(e.has(`currentPage`)||e.has(`pageSize`)||e.has(`totalItems`)){let e=M(this.pageSize,this.totalItems),t=j(this.currentPage,e);t!==this.currentPage&&(this.currentPage=t)}}updated(e){if(super.updated(e),e.has(`pageSizeOptions`)||e.has(`pageSize`)||e.has(`totalItems`)){let e=P(this.pageSizeOptions),t=F(this.pageSize,this.totalItems),n=this.baseRef.value;n&&(n.style.setProperty(`--pagination-page-size-option-char-count`,String(e)),n.style.setProperty(`--pagination-total-pages-char-count`,String(t)))}}render(){let e=k(this.totalItems,this.pageSize),t=this.variant===`compact`,n=this.disabled||e===0,r=A(this.totalItems,this.pageSize,this.currentPage),i=this.pageSizeOptions.includes(this.pageSize)?this.pageSize:this.pageSizeOptions[0],o=this.currentPage===1,c=this.currentPage===e;return a`
    ...
    `}},f([h({type:Boolean})],R.prototype,`divider`,void 0),f([h({reflect:!0,type:Boolean})],R.prototype,`disabled`,void 0),f([h({reflect:!0})],R.prototype,`size`,void 0),f([h({attribute:`current-page`,reflect:!0,type:Number})],R.prototype,`currentPage`,void 0),f([h({attribute:`page-size`,reflect:!0,type:Number})],R.prototype,`pageSize`,void 0),f([h({attribute:`page-size-options`,converter:{fromAttribute:e=>e.split(`,`).map(e=>{let t=parseInt(e.trim(),10);return Number.isSafeInteger(t)?t:null}).filter(Boolean)},type:Array})],R.prototype,`pageSizeOptions`,void 0),f([h({attribute:`total-items`,reflect:!0,type:Number})],R.prototype,`totalItems`,void 0),f([h({attribute:`variant`,reflect:!0})],R.prototype,`variant`,void 0),f([h({attribute:`aria-label`})],R.prototype,`ariaLabel`,void 0),R=L=f([ne(`SynPagination`)],R),z=R})),_e=e((()=>{B(),B(),z.define(`syn-pagination`)})),V,H,U,W,G,K,q,J,Y,X,Z,Q,$=e((()=>{_e(),c(),S(),r(),n(),{args:V,argTypes:H}=ue(`syn-pagination`),{overrideArgs:U}=y(`syn-pagination`),{generateTemplate:W}=x(`syn-pagination`),G={args:U([{name:`total-items`,type:`attribute`,value:500},{name:`page-size-options`,type:`attribute`,value:`10, 25, 50, 100`}],V),argTypes:H,component:`syn-pagination`,parameters:{chromatic:{modes:i},design:t(`49794-50102`),docs:{description:{component:b(`pagination`,`default`)}}},tags:[`Navigation`,`Filter`],title:`Components/syn-pagination`},K={parameters:{controls:{disable:!1},docs:{description:{story:b(`pagination`,`default`)}}},render:e=>W({args:e})},q={parameters:{docs:{description:{story:b(`pagination`,`with-divider`)}}},render:()=>a`
    <syn-pagination divider current-page="2" page-size="25" total-items="500" ></syn-pagination>
  `},J={parameters:{docs:{description:{story:b(`pagination`,`disabled`)}}},render:()=>a`
    <syn-pagination disabled current-page="1" page-size="25" total-items="500" ></syn-pagination>
  `},Y={parameters:{docs:{description:{story:b(`pagination`,`compact`)}}},render:()=>a`
    <syn-pagination variant="compact" current-page="1" page-size="25" total-items="500"></syn-pagination>
  `},X={parameters:{docs:{description:{story:b(`pagination`,`sizes`)}}},render:()=>a`
