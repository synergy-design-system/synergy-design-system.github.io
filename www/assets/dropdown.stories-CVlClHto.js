import{i as e,g as c}from"./preview-CSzYYz-W.js";import{x as t}from"./lit-element-ZYWMe1i1.js";import{s as l,a as v,g as n,c as w}from"./component-BD35Kgrk.js";import"./index-DH5ua8nC.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon-button-BiF6KxzB.js";import"./icon.component-BAAzxC2d.js";import"./directive-helpers-CkpR4LMI.js";import"./icon-BcesPW-x.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-BhJsmGLR.js";var y=Object.freeze,g=Object.defineProperty,h=(s,p)=>y(g(s,"raw",{value:y(p||s.slice())})),u;const{args:b,argTypes:f}=l("syn-dropdown"),{overrideArgs:S}=w("syn-dropdown"),{generateTemplate:C}=v("syn-dropdown"),z={args:S([{name:"default",type:"slot",value:`
      ...
      `},{name:"open",type:"attribute",value:e()}],b),argTypes:f,component:"syn-dropdown",parameters:{design:c("10461-8361"),docs:{description:{component:n("dropdown","default")},story:{height:"250px"}}},title:"Components/syn-dropdown"},i={parameters:{chromatic:{disableSnapshot:!1},controls:{disable:!1},docs:{description:{story:n("dropdown","default")}}},render:s=>t`
    <div style="position: relative">
      ${C({args:s})}
    </div>
  `},m={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:n("dropdown","selected")}}},render:()=>t(u||(u=h([`
    <div style="position: relative">
  ...
  `},a={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:n("dropdown","submenu")}}},render:()=>t`
    <div style="position: relative">
      <syn-dropdown ?open=${e()}>
        <syn-button slot="trigger" caret>Edit</syn-button>
