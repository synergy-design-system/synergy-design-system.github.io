import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-DRz18Lsn.js";import{c as i,t as a}from"./lit-D4-0ovri.js";import{t as o}from"./icon-BbsmBxau.js";import{t as s}from"./divider-Bas-Jfyn.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-NnlguzJ1.js";import{t as m}from"./taggedTemplateLiteral-BZenJ0bZ.js";import{t as h}from"./icon-button-Csrs2rAo.js";import{t as g}from"./prio-nav-CL6cEtzk.js";import{t as _}from"./nav-item-Dc00SA6U.js";import{t as v}from"./header-CwbUkkvO.js";var y=t({BurgerMenu:()=>N,Default:()=>E,Focus:()=>k,Label:()=>D,Logo:()=>O,MetaNavigation:()=>A,MetaNavigationWithDividers:()=>j,Navigation:()=>M,Screenshot:()=>F,Sticky:()=>P,__namedExportsOrder:()=>I,default:()=>T}),b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I;function L(){return(L=e((()=>{s(),g(),_(),v(),o(),h(),a(),f(),r(),{args:x,argTypes:S}=l(`syn-header`),{overrideArgs:C}=c(`syn-header`),{generateTemplate:w}=d(`syn-header`),T={args:C([{name:`label`,type:`slot`,value:`<span slot="label">App Name</span>`}],x),argTypes:S,component:`syn-header`,parameters:{chromatic:{modes:n},docs:{description:{component:u(`header`,`default`)}}},tags:[`Application Shell`],title:`Components/syn-header`},E={parameters:{controls:{disable:!1},docs:{description:{story:u(`header`,`default`)}}},render:e=>w({args:e})},D={parameters:{docs:{description:{story:u(`header`,`label`)}}},render:()=>i`
  ...
  `},F=p({Default:E,Label:D,Logo:O,MetaNavigation:A,MetaNavigationWithDividers:j,Navigation:M,BurgerMenu:N,Sticky:P},{heightPx:200}),I=[`Default`,`Label`,`Logo`,`Focus`,`MetaNavigation`,`MetaNavigationWithDividers`,`Navigation`,`BurgerMenu`,`Sticky`,`Screenshot`],E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  heightPx: 200
})`,...F.parameters?.docs?.source}}}})))()}export{y as n,L as r,E as t};