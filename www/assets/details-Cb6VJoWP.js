import{s as f,a as m,g as y,b as c,d as p}from"./animation-registry-l4L8bmT6.js";import{e as _}from"./class-map-CVI9ScdU.js";import{q as g,x as b}from"./iframe-CvU34O_B.js";import{L as v}from"./localize-Dh03wnLC.js";import{c as w,n as r,S as z}from"./synergy-element-B1F-Pf22.js";import{a as l}from"./query-D0jTsbLw.js";import{w as u}from"./event-B0iVuGLD.js";import{w as k}from"./watch-CEsCE2EF.js";import{S as x}from"./icon.component-BGlPOzcQ.js";import{e as S}from"./decorator-UnohHU6S.js";const A=g`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`;var O=Object.defineProperty,C=Object.getOwnPropertyDescriptor,a=(e,i,t,o)=>{for(var n=o>1?void 0:o?C(i,t):i,d=e.length-1,h;d>=0;d--)(h=e[d])&&(n=(o?h(i,t,n):h(n))||n);return o&&n&&O(i,t,n),n};let s=class extends z{constructor(){super(...arguments),this.localize=new v(this),this.open=!1,this.disabled=!1,this.contained=!1,this.size="medium"}firstUpdated(){this.body.style.height=this.open?"auto":"0",this.open&&(this.details.open=!0),this.detailsObserver=new MutationObserver(e=>{for(const i of e)i.type==="attributes"&&i.attributeName==="open"&&(this.details.open?this.show():this.hide())}),this.detailsObserver.observe(this.details,{attributes:!0})}disconnectedCallback(){super.disconnectedCallback(),this.detailsObserver?.disconnect()}handleSummaryClick(e){e.preventDefault(),this.disabled||(this.open?this.hide():this.show(),this.header.focus())}handleSummaryKeyDown(e){(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.open?this.hide():this.show()),(e.key==="ArrowUp"||e.key==="ArrowLeft")&&(e.preventDefault(),this.hide()),(e.key==="ArrowDown"||e.key==="ArrowRight")&&(e.preventDefault(),this.show())}async handleOpenChange(){if(this.open){if(this.details.open=!0,this.emit("syn-show",{cancelable:!0}).defaultPrevented){this.open=!1,this.details.open=!1;return}await m(this.body);const{keyframes:i,options:t}=y(this,"details.show",{dir:this.localize.dir()});await c(this.body,p(i,this.body.scrollHeight),t),this.body.style.height="auto",this.emit("syn-after-show")}else{if(this.emit("syn-hide",{cancelable:!0}).defaultPrevented){this.details.open=!0,this.open=!0;return}await m(this.body);const{keyframes:i,options:t}=y(this,"details.hide",{dir:this.localize.dir()});await c(this.body,p(i,this.body.scrollHeight),t),this.body.style.height="auto",this.details.open=!1,this.emit("syn-after-hide")}}async show(){if(!(this.open||this.disabled))return this.open=!0,u(this,"syn-after-show")}async hide(){if(!(!this.open||this.disabled))return this.open=!1,u(this,"syn-after-hide")}render(){return b`
      <details
        part="base"
    ...
    `}};s.styles=[w,A,D];s.dependencies={"syn-icon":x};a([l(".details")],s.prototype,"details",2);a([l(".details__header")],s.prototype,"header",2);a([l(".details__body")],s.prototype,"body",2);a([l(".details__expand-icon-slot")],s.prototype,"expandIconSlot",2);a([r({type:Boolean,reflect:!0})],s.prototype,"open",2);a([r()],s.prototype,"summary",2);a([r({type:Boolean,reflect:!0})],s.prototype,"disabled",2);a([r({type:Boolean,reflect:!0})],s.prototype,"contained",2);a([r({reflect:!0})],s.prototype,"size",2);a([k("open",{waitUntilFirstUpdate:!0})],s.prototype,"handleOpenChange",1);s=a([S("SynDetails")],s);f("details.show",{keyframes:[{height:"0",opacity:"0"},{height:"auto",opacity:"1"}],options:{duration:250,easing:"linear"}});f("details.hide",{keyframes:[{height:"auto",opacity:"1"},{height:"0",opacity:"0"}],options:{duration:250,easing:"linear"}});s.define("syn-details");
