import{i as e}from"./preload-helper-xPQekRTU.js";import{Ht as t,It as n,qt as r}from"./iframe-BLAzlACc.js";import{n as i,t as a}from"./class-map-C6rhpuKM.js";import{r as o,t as s}from"./slot-DgcqpP0-.js";import{r as c,t as l}from"./if-defined-DgNo7cOm.js";import{n as u,t as d}from"./localize-CzgwcyM2.js";import{_ as f,a as p,f as m,i as h,n as g,o as _,r as v,s as y,t as b,y as x}from"./synergy-element-A58418dp.js";import{n as S,t as C}from"./watch-I6gMK-uE.js";import{n as w,t as T}from"./icon.component-A0zaE6-F.js";var E,D=e((()=>{n(),E=r`
	/* stylelint-disable */
  :host {
    display: inline-flex;
  }
...
`})),A,j=e((()=>{a(),o(),n(),l(),y(),C(),_(),g(),D(),k(),h(),A=class extends b{constructor(...e){super(...e),this.hasSlotController=new s(this,`prefix`,`suffix`),this.renderType=`button`,this.rel=`noreferrer noopener`}static{this.styles=[p,E,O]}setRenderType(){let e=this.defaultSlot.assignedElements({flatten:!0}).filter(e=>e.tagName.toLowerCase()===`syn-dropdown`).length>0;if(this.href){this.renderType=`link`;return}if(e){this.renderType=`dropdown`;return}this.renderType=`button`}hrefChanged(){this.setRenderType()}handleSlotChange(){this.setRenderType()}render(){return t`
    ...
    `}},v([m(`slot:not([name])`)],A.prototype,`defaultSlot`,void 0),v([f()],A.prototype,`renderType`,void 0),v([x()],A.prototype,`href`,void 0),v([x()],A.prototype,`target`,void 0),v([x()],A.prototype,`rel`,void 0),v([S(`href`,{waitUntilFirstUpdate:!0})],A.prototype,`hrefChanged`,null)})),M=e((()=>{j(),j(),A.define(`syn-breadcrumb-item`)})),N,P=e((()=>{n(),N=r`
	/* stylelint-disable */
  .breadcrumb {
    display: flex;
    align-items: center;
...
`})),L,R=e((()=>{n(),d(),y(),_(),g(),w(),P(),I(),h(),L=class extends b{constructor(...e){super(...e),this.localize=new u(this),this.separatorDir=this.localize.dir(),this.label=``}static{this.styles=[p,N,F]}static{this.dependencies={"syn-icon":T}}getSeparator(){let e=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[e,...e.querySelectorAll(`[id]`)].forEach(e=>e.removeAttribute(`id`)),e.setAttribute(`data-default`,``),e.slot=`separator`,e}handleSlotChange(){let e=[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>e.tagName.toLowerCase()===`syn-breadcrumb-item`);e.forEach((t,n)=>{let r=t.querySelector(`[slot="separator"]`);r===null?t.append(this.getSeparator()):r.hasAttribute(`data-default`)&&r.replaceWith(this.getSeparator()),n===e.length-1?t.setAttribute(`aria-current`,`page`):t.removeAttribute(`aria-current`)})}render(){return this.separatorDir!==this.localize.dir()&&(this.separatorDir=this.localize.dir(),this.updateComplete.then(()=>this.handleSlotChange())),t`
    ...
    `}},v([m(`slot`)],L.prototype,`defaultSlot`,void 0),v([m(`slot[name="separator"]`)],L.prototype,`separatorSlot`,void 0),v([x()],L.prototype,`label`,void 0)})),z=e((()=>{R(),R(),L.define(`syn-breadcrumb`)}));export{M as n,z as t};