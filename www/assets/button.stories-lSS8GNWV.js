import{g}from"./preview-BfEM8BLb.js";import{k as t}from"./lit-element-BsyMe9HG.js";import{s as f,a as S,g as n,b as x,c as h}from"./component-CUJbGTln.js";import"./index-B-o1Wr-g.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon.component-Cwq7Y_Aa.js";import"./directive-helpers-DUpkUCIH.js";import"./icon-button-BsnFsjAn.js";import"./icon-DiAnxFT_.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-C_Koh2Wx.js";const{args:z,argTypes:v}=f("syn-button"),{overrideArgs:D}=h("syn-button"),{generateTemplate:k}=S("syn-button"),W={args:D({name:"default",type:"slot",value:"Button"},z),argTypes:v,component:"syn-button",parameters:{design:g("1055-22957"),docs:{description:{component:n("button","default")}}},title:"Components/syn-button"},s={parameters:{controls:{disable:!1},docs:{description:{story:n("button","default")}}},render:d=>k({args:d})},e={parameters:{docs:{description:{story:n("button","variant")}}},render:()=>t`
