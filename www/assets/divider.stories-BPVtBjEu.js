import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{_ as r,d as i,f as a,p as o}from"./iframe-Dn-tjrvc.js";import{t as s}from"./divider-B26a-g5D.js";import{i as c,n as l,o as u,r as d,t as f}from"./component-D_QZftXm.js";var p,m,h,g,_,v,y,b,x,S,C,w=e((()=>{s(),n(),d(),a(),r(),{args:p,argTypes:m}=c(`syn-divider`),{generateTemplate:h}=u(`syn-divider`),g={args:p,argTypes:m,component:`syn-divider`,parameters:{chromatic:{modes:o},design:i(`41227-216341`),docs:{description:{component:l(`divider`,`default`)}}},tags:[`Structure`],title:`Components/syn-divider`},_={parameters:{docs:{description:{story:l(`divider`,`default`)}}},render:e=>h({args:e})},v={parameters:{docs:{description:{story:l(`divider`,`width`)}}},render:()=>t`<syn-divider style="--width: var(--syn-spacing-x-small);"></syn-divider>`},y={parameters:{docs:{description:{story:l(`divider`,`color`)}}},render:()=>t`<syn-divider style="--color: var(--syn-color-primary-600);"></syn-divider>`},b={parameters:{docs:{description:{story:l(`divider`,`spacing`)}}},render:()=>t`
