import{q as p,w as lt,x as _,F as ct,y as V,u as dt}from"./iframe-BsIwdOO5.js";import{n as c}from"./synergy-element-D2zAoy3a.js";import{e as C}from"./class-map-BYJlmUdT.js";import{r as q}from"./icon.component-DfYj9s5e.js";import{t as ht}from"./event-options-3qAdqXoU.js";import{a as z}from"./query-D0jTsbLw.js";import{o as J}from"./query-assigned-elements-CblsR2sJ.js";import{o as f}from"./if-defined-xr0GHsnH.js";import{r as Z,L as ut}from"./index-DihgwUfS.js";var tt=Object.defineProperty,bt=Object.defineProperties,pt=Object.getOwnPropertyDescriptor,vt=Object.getOwnPropertyDescriptors,I=Object.getOwnPropertySymbols,et=Object.prototype.hasOwnProperty,ot=Object.prototype.propertyIsEnumerable,rt=t=>{throw TypeError(t)},N=(t,e,o)=>e in t?tt(t,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[e]=o,$=(t,e)=>{for(var o in e||(e={}))et.call(e,o)&&N(t,o,e[o]);if(I)for(var o of I(e))ot.call(e,o)&&N(t,o,e[o]);return t},ee=(t,e)=>bt(t,vt(e)),oe=(t,e)=>{var o={};for(var r in t)et.call(t,r)&&e.indexOf(r)<0&&(o[r]=t[r]);if(t!=null&&I)for(var r of I(t))e.indexOf(r)<0&&ot.call(t,r)&&(o[r]=t[r]);return o},i=(t,e,o,r)=>{for(var a=r>1?void 0:r?pt(e,o):e,s=t.length-1,l;s>=0;s--)(l=t[s])&&(a=(r?l(e,o,a):l(a))||a);return r&&a&&tt(e,o,a),a},F=(t,e,o)=>e.has(t)||rt("Cannot "+o),v=(t,e,o)=>(F(t,e,"read from private field"),e.get(t)),A=(t,e,o)=>e.has(t)?rt("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,o),P=(t,e,o,r)=>(F(t,e,"write to private field"),e.set(t,o),o),re=(t,e,o)=>(F(t,e,"access private method"),o);function S(t,e){const o=$({waitUntilFirstUpdate:!1},e);return(r,a)=>{const{update:s}=r,l=Array.isArray(t)?t:[t];r.update=function(n){l.forEach(u=>{const b=u;if(n.has(b)){const m=n.get(b),T=this[b];m!==T&&(!o.waitUntilFirstUpdate||this.hasUpdated)&&this[a](m,T)}}),s.call(this,n)}}}var k=p`
	/* stylelint-disable */
  :host {
...
`,Ut=0,B=class extends y{constructor(){super(...arguments),this.attrId=++Ut,this.componentId=`syn-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return _`
      <slot
        part="base"
        class=${C({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}};B.styles=[k,Wt,Nt];i([c({reflect:!0})],B.prototype,"name",2);i([c({type:Boolean,reflect:!0})],B.prototype,"active",2);i([S("active")],B.prototype,"handleActiveChange",1);B.define("syn-tab-panel");export{st as L,y as S,oe as _,$ as a,i as b,k as c,ee as d,w as e,Et as f,A as g,P as h,ae as i,v as j,re as k,it as m,At as n,S as w};
