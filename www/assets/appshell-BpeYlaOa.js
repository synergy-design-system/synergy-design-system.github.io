import{x as t}from"./directive-helpers-Dvm_Ferq.js";import{g as n}from"./translations-CnhJ1T76.js";var a=Object.freeze,m=Object.defineProperty,r=(e,i)=>a(m(e,"raw",{value:a(e.slice())})),o,s;const v=()=>t`
  <!-- footer -->
  <style>
    .synergy-footer-demo {
...
`,u=({withMetaNavigation:e=!1}={})=>t`
  ...
  <!-- /header -->
`,h=({noFocusTrapping:e=!1,open:i=!1,variant:l="default",hasFooter:c=!0}={})=>t`
  <!-- side-navigation -->
  <syn-side-nav
    ?no-focus-trapping=${e}
    ?open=${i}
...
`])),e),k=(e,i="syn-side-nav")=>t(s||(s=r([`
  ...
  <\/script>
`])),e,i,i);export{h as a,f as b,u as c,v as d,g as e,x as f,k as g};
