import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{d as r,f as i,g as a,u as o}from"./iframe-Cn79ht60.js";import{t as s}from"./button-BJ5RECCr.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-BsxLXFpR.js";import{n as m,t as h}from"./taggedTemplateLiteral-pWa2IaV6.js";import{t as g}from"./input-CmHjiME7.js";import{t as _}from"./range-yoKbekdL.js";import{t as v}from"./range-tick-CUxoosWq.js";var y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q=e((()=>{n(),_(),s(),g(),v(),f(),r(),a(),m(),{userEvent:y}=__STORYBOOK_MODULE_TEST__,{args:C,argTypes:w}=l(`syn-range`),{overrideArgs:T}=c(`syn-range`),{generateTemplate:E}=d(`syn-range`),D={args:T([{name:`value`,type:`attribute`,value:`50`}],C),argTypes:w,component:`syn-range`,parameters:{chromatic:{modes:i},design:o(`41310-323916`),docs:{description:{component:u(`range`,`default`)}}},tags:[`Form`],title:`Components/syn-range`},O={parameters:{controls:{disable:!1},docs:{description:{story:u(`range`,`default`)},story:{height:`80px`}}},render:e=>E({args:e})},k={parameters:{docs:{description:{story:u(`range`,`labels`)}}},render:()=>t`
    <syn-range label="Label" max="100" min="0" value="50"></syn-range>
  `},A={parameters:{docs:{description:{story:u(`range`,`help-text`)}}},render:()=>t`
    <syn-range
      ...
      value="50"
    ></syn-range>
  `},j={parameters:{docs:{description:{story:u(`range`,`disabled`)}}},render:()=>t`
    <syn-range disabled max="100" min="0" value="50"></syn-range>
  `},M={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`range`,`invalid`)}}},play:async({canvasElement:e})=>{try{let t=e.querySelector(`syn-range`),n=e.querySelector(`syn-button`);t&&n&&(await y.click(n),n.click())}catch(e){console.error(`Error in play function:`,e)}},render:()=>t(b||=h([`
  ...
  `]))},N={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`range`,`focus`)},story:{height:`80px`}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-range`);t&&t.focus()},render:()=>t`
    <form>
      <syn-range max="100" min="0" value="50"></syn-range>
    </form>
  `},P={parameters:{docs:{description:{story:u(`range`,`readonly`)}}},render:()=>t`
    <form>
      <syn-range max="100" min="0" value="50" readonly></syn-range>
    </form>
  `},F={parameters:{docs:{description:{story:u(`range`,`size`)}}},render:()=>t`
  ...
  `},I={parameters:{docs:{description:{story:u(`range`,`prefix-suffix`)}}},render:()=>t(x||=h([`
    <syn-range
      help-text="Controls the volume of the current song"
      label="Volume"
      max="100"
    ...
    <\/script>
  `]))},L={parameters:{docs:{description:{story:u(`range`,`custom-track-colors`)},story:{height:`80px`}}},render:()=>t`
    <syn-range
  ...
  `},R={parameters:{docs:{description:{story:u(`range`,`custom-track-offset`)},story:{height:`80px`}}},render:()=>t`
    <syn-range
  ...
  `},z={parameters:{docs:{description:{story:u(`range`,`multi-knob`)},story:{height:`80px`}}},render:()=>t`
    <syn-range max="100" min="0" value="30 70"></syn-range>
  `},B={parameters:{docs:{description:{story:u(`range`,`multi-knob-restrict-movement`)}}},render:()=>t`
    <syn-range
      value="30 70"
      ...
      step="1"
    ></syn-range>
  `},V={parameters:{docs:{description:{story:u(`range-tick`,`default`)}}},render:()=>t`
  <div class="wrapper">
    <syn-range
  ...
  `},H={parameters:{docs:{description:{story:u(`range`,`tooltip-placement`)},story:{height:`80px`}}},render:()=>t`
    <syn-range
      ...
      value="50"
    ></syn-range>
  `},U={parameters:{docs:{description:{story:u(`range`,`tooltip-disabled`)}}},render:()=>t`
    <syn-range
      max="100"
      min="0"
      ...
      value="50"
    ></syn-range>
  `},W={parameters:{docs:{description:{story:u(`range`,`tooltip-formatter`)}}},render:()=>t(S||=h([`
    <syn-range
  ...
  TooltipDisabled,
  TooltipFormatter
}, 500)`,...G.parameters?.docs?.source}}},K=[`Default`,`Labels`,`HelpText`,`Disabled`,`Invalid`,`Focus`,`Readonly`,`Sizes`,`PrefixSuffixText`,`CustomTrackColors`,`CustomTrackOffset`,`MultiThumb`,`MultiThumbWithRestrictedMovement`,`Ticks`,`TooltipPlacement`,`TooltipDisabled`,`TooltipFormatter`,`Screenshot`]}));q();export{L as CustomTrackColors,R as CustomTrackOffset,O as Default,j as Disabled,N as Focus,A as HelpText,M as Invalid,k as Labels,z as MultiThumb,B as MultiThumbWithRestrictedMovement,I as PrefixSuffixText,P as Readonly,G as Screenshot,F as Sizes,V as Ticks,U as TooltipDisabled,W as TooltipFormatter,H as TooltipPlacement,K as __namedExportsOrder,D as default,q as t};