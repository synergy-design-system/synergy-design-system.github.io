...
`;var Bs=Object.defineProperty,Ns=(i,t,e,o)=>{for(var s=void 0,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=r(t,e,s)||s);return s&&Bs(t,e,s),s};class Yi extends ${constructor(){super(...arguments),this.localize=new K(this),this.variant="primary"}static{this.styles=[O,Rs,Vs]}render(){return f`
      <span
        part="base"
...
`;var Ys=Object.defineProperty,li=(i,t,e,o)=>{for(var s=void 0,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=r(t,e,s)||s);return s&&Ys(t,e,s),s};class He extends ${constructor(){super(...arguments),this.localize=new K(this),this.separatorDir=this.localize.dir(),this.label=""}static{this.styles=[O,Ws,Ks]}static{this.dependencies={"syn-icon":xt}}getSeparator(){const e=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[e,...e.querySelectorAll("[id]")].forEach(o=>o.removeAttribute("id")),e.setAttribute("data-default",""),e.slot="separator",e}handleSlotChange(){const t=[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>e.tagName.toLowerCase()==="syn-breadcrumb-item");t.forEach((e,o)=>{const s=e.querySelector('[slot="separator"]');s===null?e.append(this.getSeparator()):s.hasAttribute("data-default")&&s.replaceWith(this.getSeparator()),o===t.length-1?e.setAttribute("aria-current","page"):e.removeAttribute("aria-current")})}render(){return this.separatorDir!==this.localize.dir()&&(this.separatorDir=this.localize.dir(),this.updateComplete.then(()=>this.handleSlotChange())),f`
...
`;class di extends ${constructor(){super(...arguments),this.localize=new K(this)}static{this.styles=[O,Js,to]}render(){return f`
...
`;var ro=Object.defineProperty,ao=(i,t,e,o)=>{for(var s=void 0,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=r(t,e,s)||s);return s&&ro(t,e,s),s};class Xi extends ${constructor(){super(...arguments),this.hasSlotController=new W(this,"footer","header","image"),this.nested=!1}static{this.styles=[O,oo,no]}render(){return f`
      <div
        part="base"
    ...
    `}}ao([a({type:Boolean,reflect:!0})],Xi.prototype,"nested");Xi.define("syn-card");const $e=(i="value")=>(t,e)=>{const o=t.constructor,s=o.prototype.attributeChangedCallback;o.prototype.attributeChangedCallback=function(n,r,l){const c=o.getPropertyOptions(i),d=typeof c.attribute=="string"?c.attribute:i;if(n===d){const h=c.converter||_i,y=(typeof h=="function"?h:h?.fromAttribute??_i.fromAttribute)(l,c.type);this[i]!==y&&(this[e]=y)}s.call(this,n,r,l)}};/**
 * @license
...
`;var Eo=Object.defineProperty,Ao=Object.getOwnPropertyDescriptor,Ji=(i,t,e,o)=>{for(var s=o>1?void 0:o?Ao(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=(o?r(t,e,s):r(s))||s);return o&&s&&Eo(t,e,s),s};class Nt extends ${constructor(){super(...arguments),this.vertical=!1}static{this.styles=[O,So,Oo]}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}}Ji([a({type:Boolean,reflect:!0})],Nt.prototype,"vertical",2);Ji([w("vertical")],Nt.prototype,"handleVerticalChange",1);Nt.define("syn-divider");function zi(i){return i.charAt(0).toUpperCase()+i.slice(1)}const To=p`
	/* stylelint-disable */
  :host {
    --size: 25rem;
    --header-spacing: var(--syn-spacing-large);
...
`;var or=Object.defineProperty,nr=Object.getOwnPropertyDescriptor,At=(i,t,e,o)=>{for(var s=o>1?void 0:o?nr(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=(o?r(t,e,s):r(s))||s);return o&&s&&or(t,e,s),s};class zt extends ${constructor(){super(...arguments),this.localize=new K(this),this.current=!1,this.selected=!1,this.hasHover=!1,this.value="",this.disabled=!1}static{this.styles=[O,ir,sr]}static{this.dependencies={"syn-icon":xt}}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.setAttribute("aria-selected","false")}handleDefaultSlotChange(){const t=this.getTextLabel();if(typeof this.cachedTextLabel>"u"){this.cachedTextLabel=t;return}t!==this.cachedTextLabel&&(this.cachedTextLabel=t,this.emit("slotchange",{bubbles:!0,composed:!1,cancelable:!1}))}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleValueChange(){typeof this.value!="string"&&(this.value=String(this.value)),this.value.includes(" ")&&(console.error("Option values cannot include a space. All spaces have been replaced with underscores.",this),this.value=this.value.replace(/ /g,"_"))}getTextLabel(){const t=this.childNodes;let e="";return[...t].forEach(o=>{o.nodeType===Node.ELEMENT_NODE&&(o.hasAttribute("slot")||(e+=o.textContent)),o.nodeType===Node.TEXT_NODE&&(e+=o.textContent)}),e.trim()}render(){return f`
      <div
        part="base"
...
`,Di=i=>Array.from(i.assignedElements({flatten:!0})),ar=i=>i.tagName.toLocaleLowerCase()==="syn-nav-item"||(i.getAttribute("role")??"")==="menuitem",Pi=i=>i.filter(ar);var lr=Object.defineProperty,Tt=(i,t,e,o)=>{for(var s=void 0,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=r(t,e,s)||s);return s&&lr(t,e,s),s};class $t extends ${constructor(){super(...arguments),this.priorityMenuLabel="Menu",this.itemPositionsCached=!1,this.amountOfNavItems=0,this.amountOfVisibleItems=0,this.hasItemsInDropdown=!1}static{this.styles=[O,rr]}static{this.dependencies={"syn-dropdown":tt,"syn-icon":xt,"syn-menu":gi,"syn-nav-item":Q}}getSlottedNavItems(){const t=Pi(Di(this.defaultSlot)),e=Pi(Di(this.menuSlot));return t.concat(e)}cacheItemPositions(t){t.forEach(e=>{e.removeAttribute("slot");const{right:o}=e.getBoundingClientRect();e.dataset.right=o.toString()}),this.itemPositionsCached=!0}handlePriorityMenu(){const t=this.getSlottedNavItems();this.itemPositionsCached||this.cacheItemPositions(t);const{width:e}=this.horizontalNav.getBoundingClientRect(),{clientWidth:o}=this.priorityMenu,s=e-o;let n,r=0;t.forEach(l=>{n||parseFloat(l.dataset.right)>=s?(l.removeAttribute("horizontal"),l.setAttribute("slot","menu"),l.setAttribute("role","menuitem"),n||(n=parseFloat(l.dataset.right))):(r+=1,l.setAttribute("horizontal","true"),l.removeAttribute("slot"),l.removeAttribute("tabindex"),l.dataset.originalRole?l.setAttribute("role",l.dataset.originalRole):l.removeAttribute("role"))}),this.hasItemsInDropdown=r!==t.length,this.amountOfVisibleItems=r}renderPriorityMenu(){return Y`
    ...
    `}}Tt([v("slot:not([name])")],$t.prototype,"defaultSlot");Tt([v("slot[name=menu]")],$t.prototype,"menuSlot");Tt([v(".horizontal-nav")],$t.prototype,"horizontalNav");Tt([v(".priority-menu")],$t.prototype,"priorityMenu");Tt([a({attribute:"priority-menu-label"})],$t.prototype,"priorityMenuLabel");Tt([E()],$t.prototype,"itemPositionsCached");Tt([E()],$t.prototype,"amountOfNavItems");Tt([E()],$t.prototype,"amountOfVisibleItems");Tt([E()],$t.prototype,"hasItemsInDropdown");$t.define("syn-prio-nav");/**
 * @license
...
`;var pr=Object.defineProperty,vi=(i,t,e,o)=>{for(var s=void 0,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=r(t,e,s)||s);return s&&pr(t,e,s),s};class Ye extends ${constructor(){super(...arguments),this.localize=new K(this),this.value=0,this.indeterminate=!1,this.label=""}static{this.styles=[O,hr,ur]}render(){return f`
      <div
        part="base"
...
`;var yr=Object.defineProperty,Ge=(i,t,e,o)=>{for(var s=void 0,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=r(t,e,s)||s);return s&&yr(t,e,s),s};class Te extends ${constructor(){super(...arguments),this.localize=new K(this),this.value=0,this.label=""}static{this.styles=[O,mr,fr]}updated(t){if(super.updated(t),t.has("value")){const e=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),o=2*Math.PI*e,s=o-this.value/100*o;this.indicatorOffset=`${s}px`}}render(){return f`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
...
`;var Tr=Object.defineProperty,hs=(i,t,e,o)=>{for(var s=void 0,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=r(t,e,s)||s);return s&&Tr(t,e,s),s};class Xe extends ${constructor(){super(...arguments),this.localize=new K(this),this.size="medium",this.removable=!1}static{this.styles=[O,Er,Ar]}static{this.dependencies={"syn-icon-button":Ne}}handleRemoveClick(){this.emit("syn-remove")}render(){return f`
      <span
        part="base"
...
:host([size='small']) {
  ...
  `;var Nr=Object.defineProperty,Ur=Object.getOwnPropertyDescriptor,rt=(i,t,e,o)=>{for(var s=o>1?void 0:o?Ur(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=(o?r(t,e,s):r(s))||s);return o&&s&&Nr(t,e,s),s};class it extends ${constructor(){super(...arguments),this.formControlController=new Xt(this,{value:t=>t.checked?t.value||"on":void 0,defaultValue:t=>t.defaultChecked,setValue:(t,e)=>t.checked=e}),this.hasSlotController=new W(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}static{this.styles=[O,re,Vr,ae,Br]}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleInput(){this.emit("syn-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}handleClick(){this.checked=!this.checked,this.emit("syn-change")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleKeyDown(t){t.key==="ArrowLeft"&&(t.preventDefault(),this.checked=!1,this.emit("syn-change"),this.emit("syn-input")),t.key==="ArrowRight"&&(t.preventDefault(),this.checked=!0,this.emit("syn-change"),this.emit("syn-input"))}handleCheckedChange(){this.input.checked=this.checked,this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(!0)}click(){this.input.click()}focus(t){this.input.focus(t)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("help-text"),e=this.helpText?!0:!!t;return f`
    ...
    `}}rt([v('input[type="checkbox"]')],it.prototype,"input",2);rt([E()],it.prototype,"hasFocus",2);rt([a()],it.prototype,"title",2);rt([a()],it.prototype,"name",2);rt([a()],it.prototype,"value",2);rt([a({reflect:!0})],it.prototype,"size",2);rt([a({type:Boolean,reflect:!0})],it.prototype,"disabled",2);rt([a({type:Boolean,reflect:!0})],it.prototype,"checked",2);rt([$e("checked")],it.prototype,"defaultChecked",2);rt([a({reflect:!0})],it.prototype,"form",2);rt([a({type:Boolean,reflect:!0})],it.prototype,"required",2);rt([a({attribute:"help-text"})],it.prototype,"helpText",2);rt([w("checked",{waitUntilFirstUpdate:!0})],it.prototype,"handleCheckedChange",1);rt([w("disabled",{waitUntilFirstUpdate:!0})],it.prototype,"handleDisabledChange",1);it.define("syn-switch");Xe.define("syn-tag");const Hr=p`
	/* stylelint-disable */
  :host {
    display: block;
  }
