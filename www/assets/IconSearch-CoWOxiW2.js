import{j as we,M as Ri}from"./index-CyIoYXN0.js";import{useMDXComponents as fi}from"./index-CHrGa5Tm.js";import{b as x,r as pt,R as be}from"./index-_2TAQcTa.js";import{i as d,r as ji,x as u,e as Hi,u as Pt,E as Ui,T as Wi,B as Ki}from"./directive-helpers-Dvm_Ferq.js";import{n as r,b as _,e as m,i as Ee,c as b,o as f,u as se,f as Gi,t as Zi,r as Xi}from"./library-BX4ONXik.js";import{r as yi,L as Yi,a as ot,t as Qi,l as Je,b as Ji,c as eo,f as to,s as io,d as Rt,e as oo,p as wt,g as ao,h as so,i as ro,o as vi,j as no,k as lo,m as po,n as co}from"./ref-B9GS7qLj.js";import{d as At}from"./default-icons--FEJ2Psb.js";import"./iframe-D_5xiZ8Z.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-BwkS7JH_.js";import"./index-DrFu-skq.js";/**
 * @license
...
`,Et="";function Kt(e){Et=e}function Io(e=""){if(!Et){const t=[...document.getElementsByTagName("script")],i=t.find(a=>a.hasAttribute("data-synergy"));if(i)Kt(i.getAttribute("data-synergy"));else{const a=t.find(n=>/synergy(\.min)?\.js($|\?)/.test(n.src)||/synergy-autoloader(\.min)?\.js($|\?)/.test(n.src));let s="";a&&(s=a.getAttribute("src")),Kt(s.split("/").slice(0,-1).join("/"))}}return Et.replace(/\/$/,"")+(e?`/${e.replace(/^\//,"")}`:"")}var Eo={name:"default",resolver:e=>Io(`assets/icons/${e}.svg`)},To=Eo,Gt={add:`
...
`,Ae=class extends v{constructor(){super(...arguments),this.hasSlotController=new G(this,"[default]","logo","label","meta-navigation","navigation"),this.localize=new B(this),this.isSideNavAnimating=!1,this.label="",this.burgerMenu="hidden"}toggleBurgerMenu(){switch(this.burgerMenu){case"closed":this.burgerMenu="open";break;case"open":this.burgerMenu="closed";break}}handleBurgerMenuToggle(){this.sideNav&&!this.sideNav.rail&&!this.isSideNavAnimating&&(this.sideNav.open=!this.sideNav.open),this.isSideNavAnimating||this.toggleBurgerMenu()}updateBurgerMenuBasedOnSideNav(){this.sideNav&&(this.sideNav.rail?this.burgerMenu="hidden":this.burgerMenu=this.sideNav.open?"open":"closed")}handleBurgerMenu(){const e=`syn-burger-menu-${this.burgerMenu}`;this.emit(e)}connectedCallback(){super.connectedCallback(),this.mutationObserver=new MutationObserver(()=>this.updateBurgerMenuBasedOnSideNav())}firstUpdated(){this.updateComplete.then(()=>{const e=document.querySelector("syn-side-nav");this.connectSideNavigation(e)})}disconnectedCallback(){super.disconnectedCallback(),this.mutationObserver.disconnect()}connectSideNavigation(e){if(this.mutationObserver.disconnect(),this.sideNav=e||document.querySelector("syn-side-nav"),this.sideNav){this.updateBurgerMenuBasedOnSideNav(),this.mutationObserver.observe(this.sideNav,{attributeFilter:["open","rail"],attributes:!0});const t=()=>{this.isSideNavAnimating=!0},i=()=>{this.isSideNavAnimating=!1};this.sideNav.addEventListener("syn-show",t),this.sideNav.addEventListener("syn-hide",t),this.sideNav.addEventListener("syn-after-show",i),this.sideNav.addEventListener("syn-after-hide",i)}}render(){const e=this.hasSlotController.test("navigation"),t=this.burgerMenu!=="hidden";return se`
    ...
    `}};Ae.styles=[z,Cs];Ae.dependencies={"syn-icon":ks};o([r()],Ae.prototype,"label",2);o([r({attribute:"burger-menu",reflect:!0})],Ae.prototype,"burgerMenu",2);o([_()],Ae.prototype,"sideNav",2);o([g("burgerMenu",{waitUntilFirstUpdate:!0})],Ae.prototype,"handleBurgerMenu",1);var Ss="syn-header";Ae.define("syn-header");w({displayName:"SynHeader",elementClass:Ae,events:{onSynBurgerMenuClosed:"syn-burger-menu-closed",onSynBurgerMenuHidden:"syn-burger-menu-hidden",onSynBurgerMenuOpen:"syn-burger-menu-open"},react:x,tagName:Ss});var $s="syn-icon-button";j.define("syn-icon-button");w({displayName:"SynIconButton",elementClass:j,events:{onSynBlur:"syn-blur",onSynFocus:"syn-focus"},react:x,tagName:$s});var Os="syn-icon";R.define("syn-icon");var As=w({displayName:"SynIcon",elementClass:R,events:{onSynLoad:"syn-load",onSynError:"syn-error"},react:x,tagName:Os}),Is=d`
  /**
