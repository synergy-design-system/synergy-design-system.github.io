import{g as e,a as x,s as v,b as T,c as D,d as z}from"./component-D9Cr7x-I.js";import{x as r}from"./directive-helpers-Dvm_Ferq.js";import{u as k}from"./index-CSCA1apM.js";import"./if-defined-zGpnP1OK.js";import"./ref-CgC99LRu.js";import"./chunk-L4EGOTBX-Boit2UGA.js";import"./entry-preview-DkJqm5dP.js";import"./index-DrFu-skq.js";import"./icon-button-CQW7__-s.js";import"./library-C58jM0s5.js";import"./icon.component-BoDp9LRR.js";import"./index-Vx7n56Jp.js";import"./index-_2TAQcTa.js";import"./_commonjsHelpers-CqkleIqs.js";import"./icon-mIpjUOpH.js";var h=Object.freeze,E=Object.defineProperty,w=(s,a)=>h(E(s,"raw",{value:h(s.slice())})),g;const{args:q,argTypes:M}=v("syn-file"),{overrideArgs:_}=T("syn-file"),{generateTemplate:H}=D("syn-file"),R={args:_([],q),argTypes:M,component:"syn-file",parameters:{design:x("21709-49135"),docs:{description:{component:e("file","default")}}},title:"Components/syn-file"},t={parameters:{controls:{disable:!1},docs:{description:{story:e("file","default")}}},render:s=>H({args:s})},i={parameters:{docs:{description:{story:e("file","label")}}},render:()=>r`
    <syn-file label="This is a label"></syn-file>
  `},l={parameters:{docs:{description:{story:e("file","help-text")}}},render:()=>r`
    <syn-file
...
`},p={parameters:{docs:{description:{story:e("file","sizes")}}},render:()=>r`
  ...
  `},u=z({Default:t,Label:i,HelpText:l,Multiple:o,HideValue:n,Disabled:c,Sizes:p,Invalid:d,Droparea:y,Directory:m},750);t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  render: () => html\`
    ...
    ></syn-file>
  \`
} as Story`,...l.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
\`
  ...
  Droparea,
  Directory
}, 750)`,...u.parameters?.docs?.source}}};const U=["Default","Label","HelpText","Multiple","HideValue","Focus","Disabled","Sizes","Invalid","Droparea","Directory","Screenshot"];export{t as Default,m as Directory,c as Disabled,y as Droparea,f as Focus,l as HelpText,n as HideValue,d as Invalid,i as Label,o as Multiple,u as Screenshot,p as Sizes,U as __namedExportsOrder,R as default};
