import{e as p}from"./class-map-J4m71D6f.js";import{k as b,x as f,u as h}from"./iframe-hncc6fn8.js";import{S as x,c as w,n as r}from"./synergy-element-ZP8Aphe2.js";import{S as _,r as d}from"./icon.component-uI_62ALx.js";import{a as y}from"./query-D0jTsbLw.js";import{o as c}from"./if-defined-Df6Qu0g8.js";import{S as k}from"./divider.component-CAm9t5hy.js";import{H as z}from"./slot-9EVoRGQc.js";import{w as C}from"./watch-CEsCE2EF.js";const S=b`
  /**
...
`;var $=Object.defineProperty,O=Object.getOwnPropertyDescriptor,n=(v,e,t,i)=>{for(var s=i>1?void 0:i?O(e,t):e,o=v.length-1,l;o>=0;o--)(l=v[o])&&(s=(i?l(e,t,s):l(s))||s);return i&&s&&$(e,t,s),s};class a extends x{constructor(){super(...arguments),this.hasSlotController=new z(this,"[default]","children","prefix","suffix"),this.hasFocus=!1,this.showPrefixOnly=!1,this.currentMarkedChild=!1,this.isMultiLine=!1,this.rel="noreferrer noopener",this.current=!1,this.disabled=!1,this.horizontal=!1,this.chevron=!1,this.open=!1,this.divider=!1}static{this.styles=[w,S]}static{this.dependencies={"syn-divider":k,"syn-icon":_}}isButton(){return!this.href&&!this.hasSlotController.test("children")}isLink(){return!!this.href&&!this.hasSlotController.test("children")}isAccordion(){return this.hasSlotController.test("children")}getNavItemChildren(e){return Array.from(e?.assignedElements({flatten:!0})||[]).map(t=>t.tagName.toLowerCase()==="syn-nav-item"?t:Array.from(t.querySelectorAll(":scope > syn-nav-item"))).flat()}getAllNestedNavItems(e){const t=this.getNavItemChildren(e),i=t.map(s=>s.getAllNestedNavItems(s.childrenSlot)).flat();return t.concat(i)}handleCurrentMarkedChild(){const e=this.closest("syn-side-nav");(!this.open||e?.variant==="rail")&&(this.currentMarkedChild=this.getAllNestedNavItems(this.childrenSlot).some(t=>t.current))}handleClickButton(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}handleClickSummary(e){e.preventDefault(),e.stopPropagation(),!this.disabled&&(this.open?this.hideDetails():this.showDetails())}hideDetails(){this.open=!1,this.emit("syn-hide",{cancelable:!0})}showDetails(){this.open=!0,this.emit("syn-show",{cancelable:!0})}handleSlotChange(){const e=getComputedStyle(this);if(e.length===0){setTimeout(()=>{this.handleSlotChange()});return}this.handleCurrentMarkedChild();const i=e.getPropertyValue("--indentation"),s=Math.min(parseInt(i,10)+1,2);this.getNavItemChildren(this.childrenSlot).forEach(o=>{o.style.setProperty("--indentation",s.toFixed(0))})}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleWidth(e){e.forEach(t=>{requestAnimationFrame(()=>{if(t.contentRect.width<100){const i=this.hasSlotController.test("prefix");this.showPrefixOnly=i}else this.showPrefixOnly=!1;t.contentRect.height>48?this.isMultiLine=!0:this.isMultiLine=!1})})}handleHorizontalChange(){this.horizontal?this.resizeObserver.disconnect():this.resizeObserver.observe(this)}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>this.handleWidth(e)),this.horizontal||this.resizeObserver.observe(this)}firstUpdated(e){super.firstUpdated(e),this.mutationObserver=new MutationObserver(()=>{this.childrenSlot&&this.handleCurrentMarkedChild()}),this.mutationObserver.observe(this,{attributeFilter:["current","open"],childList:!0,subtree:!0})}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect(),this.mutationObserver?.disconnect()}blur(){this.control.blur()}click(){this.control.click()}focus(e){this.control.focus(e)}render(){const e=this.isButton(),t=this.isLink(),i=this.isAccordion(),s=this.closest("syn-side-nav"),o=this.currentMarkedChild&&!this.open||this.currentMarkedChild&&this.open&&s?.variant==="rail"&&!s?.open;let l=f`button`;i?l=f`summary`:t&&(l=f`a`);const g=(this.chevron||i)&&!this.horizontal;let m;i?m=this.handleClickSummary:e&&(m=this.handleClickButton);const u=h`
    ...
    `:u}}n([d()],a.prototype,"hasFocus",2);n([d()],a.prototype,"showPrefixOnly",2);n([d()],a.prototype,"currentMarkedChild",2);n([d()],a.prototype,"isMultiLine",2);n([y('slot[name="children"]')],a.prototype,"childrenSlot",2);n([y(".nav-item")],a.prototype,"control",2);n([r({reflect:!0,type:String})],a.prototype,"href",2);n([r()],a.prototype,"target",2);n([r()],a.prototype,"rel",2);n([r({reflect:!0,type:Boolean})],a.prototype,"current",2);n([r({reflect:!0,type:Boolean})],a.prototype,"disabled",2);n([r({reflect:!0,type:Boolean})],a.prototype,"horizontal",2);n([r({reflect:!0,type:Boolean})],a.prototype,"chevron",2);n([r({reflect:!0,type:Boolean})],a.prototype,"open",2);n([r({reflect:!0,type:Boolean})],a.prototype,"divider",2);n([C("horizontal",{waitUntilFirstUpdate:!0})],a.prototype,"handleHorizontalChange",1);export{a as S};
