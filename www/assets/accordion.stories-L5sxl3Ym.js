import{l as j,x as s,g as D}from"./iframe-CWRRF7Kz.js";import{n as b}from"./property-DfgI3O36.js";import{o as q}from"./query-assigned-elements-QtOlz7Yz.js";import{e as L}from"./class-map-31AjmBp8.js";import{c as E,S as z}from"./component.styles-DAsZ-SQ-.js";import{w as x}from"./watch-CEsCE2EF.js";import{e as C}from"./decorator-DANECR0-.js";import"./details-DQLjVK8T.js";import{g as r,s as w,a as _,c as O,b as P}from"./component-Ds-2z4Q_.js";import{p as F}from"./PaddingDecorator-BAoQ8Ium.js";import"./query-DAIS6qJ0.js";import"./functions-CDi3doZH.js";import"./animation-registry-l4L8bmT6.js";import"./localize-Dh03wnLC.js";import"./index-DihgwUfS.js";import"./event-B0iVuGLD.js";import"./icon.component-CK3dmUUo.js";import"./state-1d_pmrPj.js";import"./index-Bkk0Z6Ex.js";import"./_docs-UXgsQIP6.js";const T=j`
  :host {
    display: block;
  }
...
`;var $=Object.defineProperty,I=Object.getOwnPropertyDescriptor,n=(e,o,g,u)=>{for(var t=u>1?void 0:u?I(o,g):o,v=e.length-1,h;v>=0;v--)(h=e[v])&&(t=(u?h(o,g,t):h(t))||t);return u&&t&&$(o,g,t),t};let a=class extends z{constructor(){super(...arguments),this.closeOthers=!1,this.contained=!1,this.size="medium",this.handleAccordionShow=e=>{this.closeOthers&&this.detailsInDefaultSlot.forEach(o=>{o!==e.target&&o.parentNode===e.target.parentNode&&o.removeAttribute("open")})}}adjustDetailsSize(){this.detailsInDefaultSlot.forEach(e=>{e.setAttribute("size",this.size)})}adjustDetailsContained(){this.detailsInDefaultSlot.forEach(e=>{e.contained=this.contained})}handleSizeChange(){this.adjustDetailsSize()}handleContainedChange(){this.adjustDetailsContained()}connectedCallback(){super.connectedCallback(),this.addEventListener("syn-show",this.handleAccordionShow)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("syn-show",this.handleAccordionShow)}handleSlotChange(){this.adjustDetailsSize(),this.adjustDetailsContained()}render(){return s`
  ...
  Sizes
}, 1150)`,...p.parameters?.docs?.source}}};const ue=["Default","Contained","GroupingDetails","Focus","Disabled","Sizes","Screenshot"];export{l as Contained,i as Default,m as Disabled,y as Focus,d as GroupingDetails,p as Screenshot,c as Sizes,ue as __namedExportsOrder,ce as default};
