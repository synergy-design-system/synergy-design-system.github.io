import{g as e,a as D,s as T,c as z,d as k}from"./component-CzMmmuv4.js";import{x as n}from"./directive-helpers-Dvm_Ferq.js";import{u as I}from"./index-CSCA1apM.js";import"./library-BeKtmk-e.js";import"./ref-mC-OfJbg.js";import"./chunk-L4EGOTBX-Boit2UGA.js";import"./entry-preview-DkJqm5dP.js";import"./index-DrFu-skq.js";import"./icon-button-CCixFMrH.js";import"./index-DY0LrIOm.js";import"./index-_2TAQcTa.js";import"./_commonjsHelpers-CqkleIqs.js";const{args:E,argTypes:L}=T("syn-input"),{generateTemplate:P}=z("syn-input"),j={args:E,argTypes:L,parameters:{design:D("14695-110120"),docs:{description:{component:e("input","default")}}},title:"Components/syn-input"},r={parameters:{controls:{disable:!1},docs:{description:{story:e("input","default")}}},render:s=>P({args:s})},a={parameters:{docs:{description:{story:e("input","label")}}},render:()=>n`<syn-input label="What is your name?"></syn-input>`},o={parameters:{docs:{description:{story:e("input","help-text")}}},render:()=>n`<syn-input label="Nickname" help-text="What would you like people to call you?"></syn-input>`},i={parameters:{docs:{description:{story:e("input","placeholder")}}},render:()=>n`<syn-input placeholder="Type something"></syn-input>`},p={parameters:{docs:{description:{story:e("input","clearable")}}},render:()=>n`<syn-input value="Clearable" placeholder="Clearable" clearable></syn-input>`},l={parameters:{docs:{description:{story:e("input","password-toggle")}}},render:()=>n`<syn-input type="password" placeholder="Password Toggle" password-toggle></syn-input>`},c={parameters:{docs:{description:{story:e("input","readonly")}}},render:()=>n`<syn-input value="Readonly content" readonly></syn-input>`},h={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:e("input","focus")}}},play:({canvasElement:s})=>{const t=s.querySelector("syn-input");t&&t.focus()},render:()=>n`
      <form>
  ...
  <syn-input placeholder="Large" size="large"></syn-input>`},x={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:e("input","invalid")}}},play:async({canvasElement:s})=>{try{const t=s.querySelector("form"),w=t.querySelector("syn-input"),v=t.querySelector("syn-button");v&&w&&(await I.click(v),v.click())}catch(t){console.error("Error in play function:",t)}},render:()=>n`
  ...
  `},m={parameters:{docs:{description:{story:e("input","types")}}},render:()=>n`
  ...
  <syn-input type="number" min="0" max="10" value="10"></syn-input>`},g={parameters:{docs:{description:{story:e("input","stepper-input-handling")}}},render:()=>n`
    ...
    <syn-input 
      ...
      value="0"
    ></syn-input>
  `},S=k({Default:r,Labels:a,HelpText:o,Placeholders:i,Clearable:p,TogglePassword:l,ReadonlyInputs:c,Disabled:u,Sizes:y,InputTypes:m,PrefixSuffixTextAndIcons:d,CustomizingLabelPosition:f,Stepper:b,StepperInputHandling:g},500);r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
...
}, 500)`,...S.parameters?.docs?.source}}};const G=["Default","Labels","HelpText","Placeholders","Clearable","TogglePassword","ReadonlyInputs","Focus","Disabled","Sizes","Invalid","InputTypes","PrefixSuffixTextAndIcons","CustomizingLabelPosition","Stepper","StepperInputHandling","Screenshot"];export{p as Clearable,f as CustomizingLabelPosition,r as Default,u as Disabled,h as Focus,o as HelpText,m as InputTypes,x as Invalid,a as Labels,i as Placeholders,d as PrefixSuffixTextAndIcons,c as ReadonlyInputs,S as Screenshot,y as Sizes,b as Stepper,g as StepperInputHandling,l as TogglePassword,G as __namedExportsOrder,j as default};
