import"./radio-group-c951597a.js";import{x as o}from"./directive-helpers-a6c66f8a.js";import{u as p}from"./index-8ec6bb21.js";import{s as g,g as r,b as h}from"./component-1fdd2bb4.js";import"./static-c19bae7e.js";import"./query-a4947b92.js";import"./slot-4492e2ee.js";import"./component.styles-1c783f8d.js";import"./form-control.styles-d852634a.js";import"./_commonjsHelpers-de833af9.js";import"./index-356e4a49.js";import"./chunk-757FFUVQ-7dc151b2.js";const{args:f,argTypes:S}=g("syn-radio-group"),H={args:f,argTypes:S,component:"radio-group",parameters:{docs:{description:{component:r("radio-group","default")}}},title:"Components/syn-radio-group"},l={parameters:{controls:{disable:!1},docs:{description:{story:r("radio-group","default")}}},render:()=>o`
  ...
  <syn-radio-group label="This is a label" help-text="This is checked" name="a" value="2">
    ...
    <syn-radio value="2">Option</syn-radio>
    <syn-radio value="3">Option</syn-radio>
  </syn-radio-group>`},d={name:"Invalid",parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:r("radio-group","invalid")}}},play:async({canvasElement:a})=>{try{const e=a.querySelector("syn-button");e&&(await p.click(e),e.click())}catch(e){console.error("Error in play function:",e)}},render:()=>o`
...
</style>`},c={name:"Custom validity",parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:r("radio-group","setCustomValidity")}}},play:async({canvasElement:a})=>{try{const e=a.querySelector("syn-radio-group"),u=a.querySelector("syn-button"),m=a.querySelector('syn-radio[value="1"]'),v=a.querySelector('syn-radio[value="3"]'),b="You must choose the last option";e?.setCustomValidity(b),m&&await p.click(m),v&&e?.value==="3"?e?.setCustomValidity(""):e?.setCustomValidity(b),u&&(await p.click(u),u.click(),e?.checkValidity()?console.log("All fields are valid!"):console.error("Form validation failed"))}catch(e){console.error("Error in play function:",e)}},render:()=>o`
  <form>
    ...
    <br />
    <syn-button type="submit" variant="filled">Submit</syn-button>
  </form>`},y=h([s,i,t,n],230);l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
...
}`,...c.parameters?.docs?.source}}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:"generateScreenshotStory([Labels, HelpText, Disabled, Checked], 230)",...y.parameters?.docs?.source}}};const L=["Default","Labels","HelpText","Disabled","Checked","Invalid","CustomValidity","Screenshot"];export{n as Checked,c as CustomValidity,l as Default,t as Disabled,i as HelpText,d as Invalid,s as Labels,y as Screenshot,L as __namedExportsOrder,H as default};
//# sourceMappingURL=radio-group.stories-18e46037.js.map
