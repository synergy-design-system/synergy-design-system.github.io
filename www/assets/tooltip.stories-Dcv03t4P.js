import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{a as t,d as n,o as r,s as i}from"./preview-DXkhgu0Z.js";import{c as a,t as o}from"./lit-BfcklOOD.js";import{t as s}from"./button-DVR7vfNM.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-B0n0ooCL.js";import{n as m,t as h}from"./taggedTemplateLiteral-C9cDEsPD.js";import{t as g}from"./tooltip-ByZZgRuG.js";import{t as _}from"./icon-button-BqRNEsU3.js";var v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N=e((()=>{o(),g(),s(),_(),f(),r(),n(),m(),{args:y,argTypes:b}=l(`syn-tooltip`),{overrideArgs:x}=c(`syn-tooltip`),{generateTemplate:S}=d(`syn-tooltip`),C={args:x([{name:`content`,type:`attribute`,value:`This is a tooltip`},{name:`open`,type:`attribute`,value:!0},{name:`default`,type:`slot`,value:`<syn-button>Hover me</syn-button>`}],y),argTypes:b,component:`syn-tooltip`,parameters:{chromatic:{modes:i},design:t(`41337-203414`),docs:{description:{component:u(`tooltip`,`default`)},story:{height:`200px`,inline:!1}},layout:`centered`},tags:[`Feedback`],title:`Components/syn-tooltip`},w={parameters:{controls:{disable:!1},docs:{description:{story:u(`tooltip`,`default`)}}},render:e=>S({args:e})},T={parameters:{docs:{description:{story:u(`tooltip`,`placement`)},story:{height:`450px`}},layout:`padded`},render:()=>a`
...
`},E={parameters:{docs:{description:{story:u(`tooltip`,`onclick`)}}},render:()=>a`
  <syn-tooltip content="Click again to dismiss" trigger="click" open>
    <syn-button>Click to Toggle</syn-button>
  </syn-tooltip>
  `},D={parameters:{docs:{description:{story:u(`tooltip`,`manuel`)}}},render:()=>a(v||=h([`
  ...
  <\/script>
  `]))},O={parameters:{docs:{description:{story:u(`tooltip`,`removingarrows`)}}},render:()=>a`
  <syn-tooltip content="This is a tooltip" style="--syn-tooltip-arrow-size: 0;" open>
    <syn-button>No Arrow</syn-button>
  </syn-tooltip>
  `},k={parameters:{docs:{description:{story:u(`tooltip`,`htmltooltip`)}}},render:()=>a`
  <syn-tooltip open>
    <div slot="content">I'm not <strong>just</strong> a tooltip, I'm a <em>tooltip</em> with HTML!</div>

    <syn-button>Hover me</syn-button>
  </syn-tooltip>
`},A={parameters:{docs:{description:{story:u(`tooltip`,`maxwith`)},story:{height:`400px`}}},render:()=>a`
