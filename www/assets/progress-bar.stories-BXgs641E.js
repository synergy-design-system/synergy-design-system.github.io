import{e as _}from"./class-map-Bipwc1iT.js";import{e as w,a as B,t as k,T as C,n as S,x as n,g as z,C as E}from"./iframe-DKzh7HHt.js";import{o as $}from"./if-defined-DWhkacz2.js";import{L as D}from"./localize-Dh03wnLC.js";import{S as I,c as L,n as y}from"./synergy-element-D4Cp3n7p.js";import"./button-CUlu5KaZ.js";import"./icon-ZpBo1gm6.js";import{g as i,s as T,a as P,c as O,b as j}from"./component-BVwEOs8-.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DihgwUfS.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./icon.component-CNp8HpxC.js";import"./watch-CEsCE2EF.js";import"./query-D0jTsbLw.js";import"./spinner.component-aogJALmx.js";import"./decorator-DeP7ND_N.js";import"./functions-DkH8wE0_.js";import"./index-CQ0aEGxp.js";import"./_docs-DCc6stEZ.js";const x="important",M=" !"+x,A=w(class extends B{constructor(e){if(super(e),e.type!==k.ATTRIBUTE||e.name!=="style"||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((a,s)=>{const r=e[s];return r==null?a:a+`${s=s.includes("-")?s:s.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${r};`}),"")}update(e,[a]){const{style:s}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(a)),this.render(a);for(const r of this.ft)a[r]==null&&(this.ft.delete(r),r.includes("-")?s.removeProperty(r):s[r]=null);for(const r in a){const t=a[r];if(t!=null){this.ft.add(r);const o=typeof t=="string"&&t.endsWith(M);r.includes("-")||o?s.setProperty(r,o?t.slice(0,-11):t,o?x:""):s[r]=t}}return C}}),H=S`
	/* stylelint-disable */
  :host {
    --height: 1rem;
...
`;var V=Object.defineProperty,b=(e,a,s,r)=>{for(var t=void 0,o=e.length-1,v;o>=0;o--)(v=e[o])&&(t=v(a,s,t)||t);return t&&V(a,s,t),t};class g extends I{constructor(){super(...arguments),this.localize=new D(this),this.value=0,this.indeterminate=!1,this.label=""}static{this.styles=[L,H,U]}render(){return n`
      <div
        part="base"
