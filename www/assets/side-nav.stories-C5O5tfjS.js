...
`)}],O),parameters:{controls:{disable:!1},docs:{description:{story:l(`side-nav`,`default`)}}},render:e=>i(x||=p([`
  ...
  `]),P(`.side-nav-indentation`))},H=f({Default:F,Rail:I,Sticky:L,Footer:R,Fixed:z,Shrink:B,Indentation:V},700),U=[`Default`,`Rail`,`Sticky`,`Footer`,`Fixed`,`Shrink`,`Indentation`,`Screenshot`],F.parameters={...F.parameters,docs:{...F.parameters?.docs,source:{originalSource:`{
  args: overrideArgs([{
    name: 'open',
    type: 'attribute',
    value: true
  ...
  Shrink,
  Indentation
}, 700)`,...H.parameters?.docs?.source}}}})))()}export{W as n,y as r,F as t};