...
`;var cd=Object.defineProperty,pd=Object.getOwnPropertyDescriptor,W=(a,e,t,n)=>{for(var i=n>1?void 0:n?pd(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&cd(e,t,i),i};class H extends C{constructor(){super(...arguments),this.formControlController=new Pe(this,{assumeInteractionOn:["syn-blur","syn-input"]}),this.hasSlotController=new ne(this,"help-text","label"),this.hasFocus=!1,this.title="",this.name="",this.value="",this.size="medium",this.label="",this.helpText="",this.placeholder="",this.rows=4,this.resize="vertical",this.disabled=!1,this.readonly=!1,this.form="",this.required=!1,this.spellcheck=!0,this.defaultValue=""}static{this.styles=[z,Ve,ld,He,dd]}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>this.setTextareaHeight()),this.updateComplete.then(()=>{this.setTextareaHeight(),this.resizeObserver.observe(this.input)})}firstUpdated(){this.formControlController.updateValidity()}disconnectedCallback(){super.disconnectedCallback(),this.input&&this.resizeObserver.unobserve(this.input)}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleChange(){this.value=this.input.value,this.setTextareaHeight(),this.emit("syn-change")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleInput(){this.value=this.input.value,this.emit("syn-input")}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}setTextareaHeight(){this.resize==="auto"?(this.input.style.height="auto",this.input.style.height=`${this.input.scrollHeight}px`):this.input.style.height=void 0}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleRowsChange(){this.setTextareaHeight()}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity(),this.setTextareaHeight()}focus(e){this.input.focus(e)}blur(){this.input.blur()}select(){this.input.select()}scrollPosition(e){if(e){typeof e.top=="number"&&(this.input.scrollTop=e.top),typeof e.left=="number"&&(this.input.scrollLeft=e.left);return}return{top:this.input.scrollTop,left:this.input.scrollTop}}setSelectionRange(e,t,n="none"){this.input.setSelectionRange(e,t,n)}setRangeText(e,t,n,i="preserve"){const o=t??this.input.selectionStart,s=n??this.input.selectionEnd;this.input.setRangeText(e,o,s,i),this.value!==this.input.value&&(this.value=this.input.value,this.setTextareaHeight())}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("label"),t=this.hasSlotController.test("help-text"),n=this.label?!0:!!e,i=this.helpText?!0:!!t;return m`
    ...
    `}}W([y(".textarea__control")],H.prototype,"input",2);W([$()],H.prototype,"hasFocus",2);W([r()],H.prototype,"title",2);W([r()],H.prototype,"name",2);W([r()],H.prototype,"value",2);W([r({reflect:!0})],H.prototype,"size",2);W([r()],H.prototype,"label",2);W([r({attribute:"help-text"})],H.prototype,"helpText",2);W([r()],H.prototype,"placeholder",2);W([r({type:Number})],H.prototype,"rows",2);W([r()],H.prototype,"resize",2);W([r({type:Boolean,reflect:!0})],H.prototype,"disabled",2);W([r({type:Boolean,reflect:!0})],H.prototype,"readonly",2);W([r({reflect:!0})],H.prototype,"form",2);W([r({type:Boolean,reflect:!0})],H.prototype,"required",2);W([r({type:Number})],H.prototype,"minlength",2);W([r({type:Number})],H.prototype,"maxlength",2);W([r()],H.prototype,"autocapitalize",2);W([r()],H.prototype,"autocorrect",2);W([r()],H.prototype,"autocomplete",2);W([r({type:Boolean})],H.prototype,"autofocus",2);W([r()],H.prototype,"enterkeyhint",2);W([r({type:Boolean,converter:{fromAttribute:a=>!(!a||a==="false"),toAttribute:a=>a?"true":"false"}})],H.prototype,"spellcheck",2);W([r()],H.prototype,"inputmode",2);W([tt()],H.prototype,"defaultValue",2);W([v("disabled",{waitUntilFirstUpdate:!0})],H.prototype,"handleDisabledChange",1);W([v("rows",{waitUntilFirstUpdate:!0})],H.prototype,"handleRowsChange",1);W([v("value",{waitUntilFirstUpdate:!0})],H.prototype,"handleValueChange",1);H.define("syn-textarea");le.define("syn-tooltip");function hd(a){const e=typeof window<"u"&&window;return!!(e&&(e.navigator.userAgent.match(/Chromatic/)||e.location.href.match(/chromatic=true/)))}const ud=(a,...e)=>hd()?m`
      ...
      ${a(...e)}
    `:a(...e),mn="🌞 light",jn="🌙 dark",md=a=>`https://www.figma.com/file/bZFqk9urD3NlghGUKrkKCR/Synergy-Digital-Design-System?type=design&node-id=${a}`,fd=(a,e="Go to Figma page")=>({label:e,type:"link",url:md(a)});function yd(a,e){const t=document.querySelectorAll(`#anchor--${e.id}`),i=JSON.parse('{"@synergy-design-system/components":"2.8.1","@synergy-design-system/assets":"1.8.0","@synergy-design-system/styles":"1.3.0","@synergy-design-system/tokens":"2.11.0"}');return t.forEach(o=>{const s=o.querySelector(".docblock-code-toggle");if(s){const l=s.cloneNode(!0);l.textContent="Edit on CodePen",l.classList.add("docblock-codepen-button");const d=o.querySelector(".sb-bar");d?o.querySelectorAll(".docblock-codepen-button:not(:last-of-type)").forEach(c=>{c.remove()}):o.querySelectorAll(".docblock-codepen-button").forEach(c=>{c.remove()}),s.parentElement.appendChild(l),d&&(o.querySelectorAll(".docblock-codepen-button:not(:last-of-type)").forEach(c=>{c.style.display="block",c.style.borderRight="none"}),o.querySelector(".docblock-codepen-button:last-of-type").style.display="none"),l.addEventListener("click",()=>{const c=document.createElement("form");c.action="https://codepen.io/pen/define",c.method="POST",c.target="_blank";const p={css:`/* Import theme */
