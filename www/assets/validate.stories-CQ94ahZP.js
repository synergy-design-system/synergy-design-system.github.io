import{j as q,c as r,x as A,C as R,d as L}from"./iframe-DsKXQJXQ.js";import{S as P,c as B,n as c}from"./synergy-element-CabjzCNg.js";import{r as m}from"./icon.component-DTvPafEE.js";import{a as N}from"./query-D0jTsbLw.js";import{o as U}from"./query-assigned-elements-CIlqV-be.js";import{o as j}from"./if-defined-BX7Oouk9.js";import{w as z}from"./watch-CEsCE2EF.js";import{S as H}from"./alert.component-CB_8OZUx.js";import{S as K}from"./tooltip.component-BeyBwjpk.js";import{e as W}from"./decorator-CWkWRMhy.js";import"./input-BMNX1Gb5.js";import"./button-CwUnzFy7.js";import{g as l,a as Y,s as G,b as J,c as Q}from"./component-DctbvBBf.js";import"./preload-helper-PPVm8Dsz.js";import"./animation-registry-DyRYqZdt.js";import"./closeActiveElement-Bnbpk8Kw.js";import"./class-map-BiUxp88L.js";import"./slot-9EVoRGQc.js";import"./localize-Dh03wnLC.js";import"./index-DihgwUfS.js";import"./event-B0iVuGLD.js";import"./icon-button.component-DJNErjB3.js";import"./popup.component-DUO1bfOc.js";import"./functions-bkELIyT9.js";import"./default-value-DcklCZ8c.js";import"./form-d9hCJUdr.js";import"./live-CVcYm39m.js";import"./form-control.styles-Cs3n2_9-.js";import"./divider.component-BCTfIkvP.js";import"./spinner.component-DKLMijea.js";import"./index-3hbeBem-.js";import"./_docs-DSlvmijE.js";const X=e=>(t,a)=>{a!==void 0?a.addInitializer(()=>{customElements.define(e,t)}):customElements.define(e,t)},Z=["blur","change","clear","focus","invalid","input","move"],k=(e,t)=>e.includes(t),x=e=>k(e,"blur"),F=e=>k(e,"invalid"),V=e=>e instanceof P,ee=(e="")=>e.split(" ").map(t=>t.trim()).filter(Boolean),I=(e,t)=>{const a=t.trim();return V(e)&&Z.includes(a)?`syn-${a}`:a},te=e=>{if(!V(e))return;const{size:t}=e;return t!=null?t:void 0},ae={"syn-checkbox":"input","syn-combobox":".combobox__value-input","syn-file":"input","syn-input":"input","syn-radio-group":"input","syn-range":".input__control","syn-select":".select__value-input","syn-switch":"input","syn-textarea":".textarea__control"},D=(e,t)=>e.shadowRoot?.querySelector(t)??null,ie=e=>{if(!e)return;if(!e.shadowRoot)return e;const t=e.tagName.toLowerCase(),a=ae[t];if(a){const s=D(e,a);if(s)return s}const i=D(e,"input,select,textarea");return i||e},se=q`
  .validate {
    display: flex;
