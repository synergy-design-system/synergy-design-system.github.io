import{j as x,c as a,C as S,d as k}from"./iframe-eRvaIELU.js";import{L as w}from"./controller-BGdn_hBF.js";import{S as z,c as R,n as _}from"./synergy-element-BVZI5H_G.js";import{r as C}from"./icon.component-ehmpGKuT.js";import{a as D}from"./query-D0jTsbLw.js";import"./button-BiXeV4zf.js";import"./icon-CqBzwWTC.js";import{g as s,a as E,s as B,b as L,c as O}from"./component-mLh0MrP7.js";import"./preload-helper-PPVm8Dsz.js";import"./watch-CEsCE2EF.js";import"./button.component-c4wtumtF.js";import"./class-map-BctzS3gw.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./if-defined-BvPV1s9v.js";import"./spinner.component-BI3Egrps.js";import"./decorator-CWkWRMhy.js";import"./functions-bkELIyT9.js";import"./index-3hbeBem-.js";import"./_docs-DCFLSkr0.js";const j=x`
	/* stylelint-disable */
  :host {
    --size: 128px;
    --track-width: 4px;
...
`;var T=Object.defineProperty,m=(r,t,d,y)=>{for(var e=void 0,v=r.length-1,h;v>=0;v--)(h=r[v])&&(e=h(t,d,e)||e);return e&&T(t,d,e),e};class g extends z{constructor(){super(...arguments),this.localize=new w(this),this.value=0,this.label=""}static{this.styles=[R,j,P]}updated(t){if(super.updated(t),t.has("value")){const d=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),y=2*Math.PI*d,e=y-this.value/100*y;this.indicatorOffset=`${e}px`}}render(){return a`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
