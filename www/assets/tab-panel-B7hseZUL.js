import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{c as t,h as n,n as r,t as i}from"./lit-BfcklOOD.js";import{d as a,m as o,u as ee,x as te,y as ne}from"./library-knVXvyJC.js";import{_ as s,f as c,h as re,l as ie,s as l,y as u}from"./synergy-element-BFEAJlBN.js";import{r as d,t as ae}from"./if-defined-gcdQCgEY.js";import{n as f,t as p}from"./class-map-BntiyWRh.js";function m(e,t){let n={waitUntilFirstUpdate:!1,...t};return(t,r)=>{let{update:i}=t,a=Array.isArray(e)?e:[e];t.update=function(e){a.forEach(t=>{let i=t;if(e.has(i)){let t=e.get(i),a=this[i];t!==a&&(!n.waitUntilFirstUpdate||this.hasUpdated)&&this[r](t,a)}}),i.call(this,e)}}}var h=e((()=>{})),g,_=e((()=>{i(),g=n`
  :host {
...
`})),Y,X=e((()=>{it(),F(),Be(),_(),E(),C(),p(),ee(),ae(),l(),Y=class extends T{constructor(){super(...arguments),this.hasFocus=!1,this.label=``,this.size=`inherit`,this.color=`currentColor`,this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){let e=!!this.href,t=e?a`a`:a`button`;return o`
      <${t}
        part="base"
