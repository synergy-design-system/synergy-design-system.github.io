import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-OBeF1Gx2.js";import{c as i,t as a}from"./lit-DgWh_IaA.js";import{t as o}from"./button-CNzGQe_l.js";import{a as s,i as c,n as l,o as u,r as d,t as f}from"./component-CCyurlYc.js";import{n as p,t as m}from"./menu-item-C5nOZDY4.js";import{t as h}from"./dropdown-ZKBk03-A.js";import{t as g}from"./button-group-73cF5wAc.js";import{t as _}from"./tooltip-2_zfwV1Q.js";var v=t({ButtonSizes:()=>E,Default:()=>w,DropdownsInButtonGroups:()=>D,Screenshot:()=>j,SplitButtons:()=>O,ToolbarExample:()=>A,TooltipsInButtonGroups:()=>k,Variants:()=>T,__namedExportsOrder:()=>M,default:()=>C}),y,b,x,S,C,w,T,E,D,O,k,A,j,M;function N(){return(N=e((()=>{g(),o(),h(),p(),m(),_(),a(),d(),r(),{args:y,argTypes:b}=c(`syn-button-group`),{overrideArgs:x}=s(`syn-button-group`),{generateTemplate:S}=u(`syn-button-group`),C={args:x({name:`default`,type:`slot`,value:`<syn-button>Left</syn-button>
<syn-button>Center</syn-button>
<syn-button>Right</syn-button>`},y),argTypes:b,component:`syn-button-group`,parameters:{chromatic:{modes:n},docs:{description:{component:l(`button-group`,`default`)}}},title:`Components/syn-button-group`},w={parameters:{controls:{disable:!1},docs:{description:{story:l(`button-group`,`default`)}}},render:e=>S({args:e})},T={parameters:{docs:{description:{story:l(`button-group`,`variant`)}}},render:()=>i`
    <div style="display: flex; gap: var(--syn-spacing-large); flex-direction: column;">
      ${[`outline`,`filled`].map(e=>i`
  ...
  `},E={parameters:{docs:{description:{story:l(`button-group`,`size`)}}},render:()=>i`
    <div style="display: flex; gap: var(--syn-spacing-large); flex-direction: column;">
  ...
  `},D={parameters:{docs:{description:{story:l(`button-group`,`dropdowns-in-button-groups`)}}},render:()=>i`
  ...
  `},O={parameters:{docs:{description:{story:l(`button-group`,`split-buttons`)}}},render:()=>i`
    <syn-button-group label="Example Button Group">
  ...
  `},k={parameters:{docs:{description:{story:l(`button-group`,`tooltips`)}}},render:()=>i`
    <syn-button-group label="Example Button Group">
  ...
  `},A={parameters:{docs:{description:{story:l(`button-group`,`toolbar`)}}},render:()=>i`
  ...
  `},j=f({Default:w,Variants:T,ButtonSizes:E,DropdownsInButtonGroups:D,SplitButtons:O,TooltipsInButtonGroups:k,ToolbarExample:A},280),w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  ToolbarExample
}, 280)`,...j.parameters?.docs?.source}}},M=[`Default`,`Variants`,`ButtonSizes`,`DropdownsInButtonGroups`,`SplitButtons`,`TooltipsInButtonGroups`,`ToolbarExample`,`Screenshot`]})))()}export{v as n,N as r,w as t};