import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,f as r,l as i}from"./preview-DRz18Lsn.js";import{c as a,t as o}from"./lit-D4-0ovri.js";import{t as s}from"./button-CBC8ywKX.js";import{t as c}from"./icon-BbsmBxau.js";import{t as l}from"./divider-Bas-Jfyn.js";import{a as u,i as d,n as f,o as p,r as m}from"./component-NnlguzJ1.js";import{t as h}from"./taggedTemplateLiteral-BZenJ0bZ.js";import{n as g,t as _}from"./menu-item-I3gppQTq.js";import{t as v}from"./dropdown-CCprjwSI.js";var y=t({Default:()=>E,Distance:()=>k,GettingTheSelectedItem:()=>D,Placement:()=>O,Skidding:()=>A,Submenus:()=>j,__namedExportsOrder:()=>M,default:()=>T}),b,x,S,C,w,T,E,D,O,k,A,j,M;function N(){return(N=e((()=>{o(),v(),l(),g(),_(),s(),c(),m(),i(),{args:x,argTypes:S}=d(`syn-dropdown`),{overrideArgs:C}=u(`syn-dropdown`),{generateTemplate:w}=p(`syn-dropdown`),T={args:C([{name:`default`,type:`slot`,value:`
  ...
  `},M=[`Default`,`GettingTheSelectedItem`,`Placement`,`Distance`,`Skidding`,`Submenus`],E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  parameters: {
    chromatic: {
  ...
  \`
}`,...j.parameters?.docs?.source}}}})))()}export{y as n,N as r,E as t};