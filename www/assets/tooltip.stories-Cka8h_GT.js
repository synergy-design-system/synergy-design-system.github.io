import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{B as n,Ht as r,It as i,f as a,g as o,n as s,t as c}from"./iframe-CR7gJfd0.js";import{d as l,f as u,i as d,p as f,u as p}from"./blocks-kZxNhAXg.js";import{t as m}from"./button-CylqLUyq.js";import{t as h}from"./icon-Dc1RxlDd.js";import{n as g,r as _}from"./component-Cxgfo-fM.js";import{n as v,t as y}from"./taggedTemplateLiteral-pWa2IaV6.js";import{t as b}from"./button-group-OIVrrhGI.js";import{t as x}from"./tooltip-DYcM8mDo.js";import{t as S}from"./header-BcKJDgB_.js";var C,w,T,E,D;e((()=>{C=t(n(),1),f(),i(),c(),m(),b(),S(),x(),h(),_(),o(),v(),T={parameters:{chromatic:{...s?.parameters?.chromatic,disableSnapshot:!1,modes:a},docs:{description:{component:g(`tooltip`,`default`,`templates`)},page:()=>C.createElement(C.Fragment,null,C.createElement(u,null),C.createElement(l,null),C.createElement(d,null),C.createElement(p,{title:``}))}},tags:[`Feedback`],title:`Templates/Tooltip`},E={parameters:{docs:{description:{story:g(`tooltip`,`single-instance`,`templates`)}}},render:()=>r(w||=y([`
