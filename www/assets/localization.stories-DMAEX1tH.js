import{a as e,n as t}from"./chunk-DnJy8xQt.js";import{Nt as n,R as r,Rt as i,f as a,g as o,n as s,t as c}from"./iframe-CIeU5pXv.js";import{d as l,f as u,l as d,r as f,u as p}from"./blocks-BzK-W9dh.js";import{t as m}from"./card-D9yXhJxQ.js";import{n as h,r as g}from"./component-Dma-UHGC.js";import{n as _,t as v}from"./taggedTemplateLiteral-BuD1d7yP.js";import{n as y,t as b}from"./menu-item-YDBoNzN7.js";import{t as x}from"./dropdown-CATxU7e1.js";import{t as S}from"./tooltip-DJzOesKe.js";import{t as C}from"./icon-button-DwRwxq55.js";import{t as w}from"./file-DN96uQfj.js";import{t as T}from"./prio-nav-BBgzFYOT.js";import{t as E}from"./header-3vJoFTyB.js";import{n as D,t as O}from"./localization-C80BeGZL.js";var k,A,j,M,N,P,F,I;t((()=>{k=e(r(),1),u(),n(),c(),g(),o(),D(),T(),m(),x(),w(),E(),C(),y(),b(),S(),_(),j={parameters:{chromatic:{...s?.parameters?.chromatic,disableSnapshot:!1,modes:a},docs:{description:{component:h(`localization`,`default`,`templates`)},page:()=>k.createElement(k.Fragment,null,k.createElement(l,null),k.createElement(p,null),k.createElement(f,null),k.createElement(d,{title:``}))}},tags:[`i18n`,`localization`,`translations`],title:`Templates/Localization`},M=Object.values(O()),N=M.find(e=>e.$code===`de`)||M[0],P=M.map(e=>({code:e.$code,dir:e.$dir,name:e.$name})),F={parameters:{docs:{description:{story:h(`localization`,`dynamicallySetLocalizations`,`templates`)}},synergy:{customImports:M.filter(e=>e.$code===`en`||e.$code===`de`).map(e=>`https://esm.sh/@synergy-design-system/components@latest/dist/translations/${e.$code}.js`)}},render:()=>i(A||=v([`
