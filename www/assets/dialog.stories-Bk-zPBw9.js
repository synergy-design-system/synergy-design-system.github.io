import{k as o}from"./lit-element-BsyMe9HG.js";import{s as v,a as h,g as f,b as t,e as r,d as S}from"./component-7g7PvM4J.js";import"./index-Dy7bMyTO.js";import"./icon.component-Cwq7Y_Aa.js";import"./directive-helpers-DUpkUCIH.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-B-o1Wr-g.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon-DiAnxFT_.js";var p=Object.freeze,L=Object.defineProperty,u=(e,$)=>p(L(e,"raw",{value:p(e.slice())})),g,y,b;const{args:w,argTypes:k}=v("syn-dialog"),{overrideArgs:D}=S("syn-dialog"),{generateTemplate:q}=h("syn-dialog"),a=e=>`
...
`])),e,e),x={args:D([{name:"open",type:"attribute",value:!0},{name:"label",type:"attribute",value:"Dialog"},{name:"default",type:"slot",value:"Lorem ipsum dolor sit amet, consectetur adipiscing elit."},{name:"footer",type:"slot",value:a("default-close-icon")}],w),argTypes:k,component:"syn-dialog",parameters:{chromatic:{disableSnapshot:!1},design:f("14953-11300"),docs:{description:{component:t("dialog","default")},story:{height:"400px"}}},title:"Components/syn-dialog"},n={parameters:{chromatic:{disableSnapshot:!1},controls:{disable:!1},docs:{description:{story:t("dialog","default")}}},render:e=>o`
  ...
  `},l={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:t("dialog","header-actions")}}},render:()=>o(y||(y=u([`
    ...
    <\/script>
    `,`
  `])),r(a("dialog-header-actions")),s("dialog-header-actions-story-opener"))},c={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:t("dialog","prevent-closing")}}},render:()=>o(b||(b=u([`
    ...
    <\/script>
    `,`
  `])),r(a("dialog-deny-close-actions")),s("dialog-deny-close-story-opener"))},m={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:t("dialog","focus")}}},render:()=>o`
  ...
  \`
}`,...m.parameters?.docs?.source}}};const M=["Default","CustomWidth","Scrolling","HeaderActions","PreventingTheDialogFromClosing","CustomizingInitialFocus"];export{i as CustomWidth,m as CustomizingInitialFocus,n as Default,l as HeaderActions,c as PreventingTheDialogFromClosing,d as Scrolling,M as __namedExportsOrder,x as default};
