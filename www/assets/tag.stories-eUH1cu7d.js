import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,d as r,f as i,g as a,u as o}from"./iframe-CKG-bwJX.js";import{t as s}from"./icon-CIjbzSz9.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-YYGwUeS7.js";import{n as m,t as h}from"./taggedTemplateLiteral-BuD1d7yP.js";import{t as g}from"./tag-CEf-Fuhr.js";var _,v,y,b,x,S,C,w,T,E,D,O;e((()=>{g(),s(),t(),f(),r(),a(),m(),{args:v,argTypes:y}=l(`syn-tag`),{generateTemplate:b}=d(`syn-tag`),{overrideArgs:x}=c(`syn-tag`),S={args:x([{name:`default`,type:`slot`,value:`Option`}],v),argTypes:y,component:`syn-tag`,parameters:{chromatic:{modes:i},design:o(`41163-156701`),docs:{description:{component:u(`tag`,`default`)}}},tags:[`Feedback`,`Tags`,`Filter`],title:`Components/syn-tag`},C={parameters:{controls:{disable:!1},docs:{description:{story:u(`tag`,`default`)}}},render:e=>b({args:e})},w={render:()=>n`
  ...
  Removable,
  Sizes
})`,...D.parameters?.docs?.source}}},O=[`Default`,`WithIcon`,`Removable`,`Sizes`,`Screenshot`]}))();export{C as Default,T as Removable,D as Screenshot,E as Sizes,w as WithIcon,O as __namedExportsOrder,S as default};