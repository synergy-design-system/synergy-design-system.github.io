import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-DRz18Lsn.js";import{c as i,t as a}from"./lit-D4-0ovri.js";import{t as o}from"./button-CBC8ywKX.js";import{t as s}from"./input-DeuiTlMk.js";import{a as c,i as l,n as u,o as d,r as f}from"./component-NnlguzJ1.js";import{t as p}from"./taggedTemplateLiteral-BZenJ0bZ.js";import{t as m}from"./icon-button-Csrs2rAo.js";import{n as h,t as g}from"./drawer.component-tgKaOxlV.js";import{n as _,t as v}from"./DisableFocusTrap-CA6D2uyl.js";function y(){return(y=e((()=>{h(),g.define(`syn-drawer`)})))()}var b=t({ContainedToAnElement:()=>V,CustomSize:()=>H,CustomizingInitialFocus:()=>K,Default:()=>L,HeaderActions:()=>W,PreventingTheDrawerFromClosing:()=>G,Scrolling:()=>U,SlideInFromBottom:()=>B,SlideInFromStart:()=>R,SlideInFromTop:()=>z,__namedExportsOrder:()=>q,default:()=>I}),x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q;function J(){return(J=e((()=>{y(),o(),m(),s(),a(),f(),_(),r(),{userEvent:x}=__STORYBOOK_MODULE_TEST__,{args:M,argTypes:N}=l(`syn-drawer`),{overrideArgs:P}=c(`syn-drawer`),{generateTemplate:F}=d(`syn-drawer`),I={args:M,argTypes:N,component:`syn-drawer`,parameters:{chromatic:{modes:n},docs:{container:v,description:{component:u(`drawer`,`default`)},story:{height:`400px`}}},tags:[`Structure`],title:`Components/syn-drawer`},L={args:P([{name:`open`,type:`attribute`,value:!0},{name:`contained`,type:`attribute`,value:!1},{name:`label`,type:`attribute`,value:`Drawer`},{name:`default`,type:`slot`,value:`Lorem ipsum dolor sit amet, consectetur adipiscing elit.`},{name:`footer`,type:`slot`,value:`
        ...
        <\/script>
      `}],M),parameters:{chromatic:{disableSnapshot:!1},controls:{disable:!1},docs:{description:{story:u(`drawer`,`default`)}}},render:e=>i(S||=p([`
    `,`
    ...
    <\/script>
  `]),F({args:e}))},R={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`start`)}}},render:()=>i(C||=p([`
    ...
    <script type="module">
      ...
      closeButton.addEventListener('click', () => drawer.hide());
    <\/script>
  `]))},z={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`top`)}}},render:()=>i(w||=p([`
    ...
    <script type="module">
      ...
      closeButton.addEventListener('click', () => drawer.hide());
    <\/script>
  `]))},B={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`bottom`)}}},render:()=>i(T||=p([`
    ...
    <script type="module">
      ...
      closeButton.addEventListener('click', () => drawer.hide());
    <\/script>
  `]))},V={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`contained`)}}},render:()=>i(E||=p([`
    <div
    ...
    <script type="module">
      ...
      closeButton.addEventListener('click', () => drawer.hide());
    <\/script>
  `]))},H={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`size`)}}},render:()=>i(D||=p([`
    ...
    <script type="module">
      ...
      closeButton.addEventListener('click', () => drawer.hide());
    <\/script>
  `]))},U={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`scrolling`)}}},render:()=>i(O||=p([`
    ...
    <script type="module">
      ...
      closeButton.addEventListener('click', () => drawer.hide());
    <\/script>
  `]))},W={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`action`)}}},render:()=>i(k||=p([`
    ...
    <\/script>
  `]))},G={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`closing`)}}},play:async({canvasElement:e})=>{let t=e.querySelector(`syn-drawer`),n=t?.shadowRoot?.querySelector(`.drawer__overlay`);t&&n&&await x.click(n)},render:()=>i(A||=p([`
    ...
    <\/script>`]))},K={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`fokus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-drawer`);t&&(t.open=!0)},render:()=>i(j||=p([`
    ...
    <script type="module">
      ...
      closeButton.addEventListener('click', () => drawer.hide());
    <\/script>
  `]))},q=[`Default`,`SlideInFromStart`,`SlideInFromTop`,`SlideInFromBottom`,`ContainedToAnElement`,`CustomSize`,`Scrolling`,`HeaderActions`,`PreventingTheDrawerFromClosing`,`CustomizingInitialFocus`],L.parameters={...L.parameters,docs:{...L.parameters?.docs,source:{originalSource:`{
  args: overrideArgs([{
    name: 'open',
    type: 'attribute',
    value: true
  ...
  render: () => html\`
    ...
    <\/script>
  \`
}`,...K.parameters?.docs?.source}}}})))()}export{b as n,J as r,L as t};