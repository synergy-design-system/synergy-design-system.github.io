import{j as ze,M as Xi}from"./index-D090YA4u.js";import{useMDXComponents as xi}from"./index-CHrGa5Tm.js";import{b as w,r as mt,R as _e}from"./index-_2TAQcTa.js";import{i as d,r as Yi,x as m,e as Qi,u as Kt,E as Ji,T as eo,B as to}from"./directive-helpers-Dvm_Ferq.js";import{n as r,b as _,e as h,i as De,c as x,o as y,u as te,f as io,t as oo,r as ao}from"./library-BeKtmk-e.js";import{r as wi,L as so,a as nt,t as ro,l as ot,b as no,c as lo,f as po,s as co,d as Gt,e as uo,p as $t,g as mo,h as ho,i as go,o as zi,j as fo,k as yo,m as vo,n as bo}from"./ref-mC-OfJbg.js";import{d as Lt}from"./default-icons--FEJ2Psb.js";import"./iframe-BweEGvW9.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-BwkS7JH_.js";import"./index-DrFu-skq.js";/**
 * @license
...
`,Ce=class extends b{constructor(){super(...arguments),this.vertical=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}};Ce.styles=[k,Ha,ja];o([r({type:Boolean,reflect:!0})],Ce.prototype,"vertical",2);o([f("vertical")],Ce.prototype,"handleVerticalChange",1);var W=class extends b{constructor(){super(...arguments),this.hasSlotController=new X(this,"[default]","children","prefix","suffix"),this.hasFocus=!1,this.showPrefixOnly=!1,this.currentMarkedChild=!1,this.isMultiLine=!1,this.rel="noreferrer noopener",this.current=!1,this.disabled=!1,this.horizontal=!1,this.chevron=!1,this.open=!1,this.divider=!1}isButton(){return!this.href&&!this.hasSlotController.test("children")}isLink(){return!!this.href&&!this.hasSlotController.test("children")}isAccordion(){return this.hasSlotController.test("children")}getNavItemChildren(e){return Array.from(e?.assignedElements({flatten:!0})||[]).map(t=>t.tagName.toLowerCase()==="syn-nav-item"?t:Array.from(t.querySelectorAll(":scope > syn-nav-item"))).flat()}getAllNestedNavItems(e){const t=this.getNavItemChildren(e),i=t.map(a=>a.getAllNestedNavItems(a.childrenSlot)).flat();return t.concat(i)}handleCurrentMarkedChild(){const e=this.closest("syn-side-nav");(!this.open||e?.variant==="rail")&&(this.currentMarkedChild=this.getAllNestedNavItems(this.childrenSlot).some(t=>t.current))}handleClickButton(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}handleClickSummary(e){e.preventDefault(),e.stopPropagation(),!this.disabled&&(this.open?this.hideDetails():this.showDetails())}hideDetails(){this.open=!1,this.emit("syn-hide",{cancelable:!0})}showDetails(){this.open=!0,this.emit("syn-show",{cancelable:!0})}handleSlotChange(){const e=getComputedStyle(this);if(e.length===0){setTimeout(()=>{this.handleSlotChange()});return}this.handleCurrentMarkedChild();const i=e.getPropertyValue("--indentation"),a=Math.min(parseInt(i,10)+1,2);this.getNavItemChildren(this.childrenSlot).forEach(s=>{s.style.setProperty("--indentation",a.toFixed(0))})}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleWidth(e){e.forEach(t=>{requestAnimationFrame(()=>{if(t.contentRect.width<100){const i=this.hasSlotController.test("prefix");this.showPrefixOnly=i}else this.showPrefixOnly=!1;t.contentRect.height>48?this.isMultiLine=!0:this.isMultiLine=!1})})}handleHorizontalChange(){this.horizontal?this.resizeObserver.disconnect():this.resizeObserver.observe(this)}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>this.handleWidth(e)),this.horizontal||this.resizeObserver.observe(this)}firstUpdated(e){super.firstUpdated(e),this.mutationObserver=new MutationObserver(()=>{this.childrenSlot&&this.handleCurrentMarkedChild()}),this.mutationObserver.observe(this,{attributeFilter:["current","open"],childList:!0,subtree:!0})}disconnectedCallback(){var e,t;super.disconnectedCallback(),(e=this.resizeObserver)==null||e.disconnect(),(t=this.mutationObserver)==null||t.disconnect()}blur(){this.control.blur()}click(){this.control.click()}focus(e){this.control.focus(e)}render(){const e=this.isButton(),t=this.isLink(),i=this.isAccordion(),a=this.closest("syn-side-nav"),s=this.currentMarkedChild&&!this.open||this.currentMarkedChild&&this.open&&a?.variant==="rail"&&!a?.open;let n=De`button`;i?n=De`summary`:t&&(n=De`a`);const l=(this.chevron||i)&&!this.horizontal;let p;i?p=this.handleClickSummary:e&&(p=this.handleClickButton);const c=te`
    ...
    `:c}};W.styles=[k,Ra];W.dependencies={"syn-divider":Ce};o([_()],W.prototype,"hasFocus",2);o([_()],W.prototype,"showPrefixOnly",2);o([_()],W.prototype,"currentMarkedChild",2);o([_()],W.prototype,"isMultiLine",2);o([h('slot[name="children"]')],W.prototype,"childrenSlot",2);o([h(".nav-item")],W.prototype,"control",2);o([r({reflect:!0,type:String})],W.prototype,"href",2);o([r()],W.prototype,"target",2);o([r()],W.prototype,"rel",2);o([r({reflect:!0,type:Boolean})],W.prototype,"current",2);o([r({reflect:!0,type:Boolean})],W.prototype,"disabled",2);o([r({reflect:!0,type:Boolean})],W.prototype,"horizontal",2);o([r({reflect:!0,type:Boolean})],W.prototype,"chevron",2);o([r({reflect:!0,type:Boolean})],W.prototype,"open",2);o([r({reflect:!0,type:Boolean})],W.prototype,"divider",2);o([f("horizontal",{waitUntilFirstUpdate:!0})],W.prototype,"handleHorizontalChange",1);var Ua=d`
	/* stylelint-disable */
  :host {
    --size: 25rem;
