...
`},k={parameters:{docs:{description:{story:l(`tooltip`,`maxwith`)},story:{height:`400px`}}},render:()=>i`
  ...
  `},A=f({Default:C,Placement:w,ClickTrigger:T,ManualTrigger:E,RemovingArrows:D,HTMLInTooltips:O,SettingAMaximumWidth:k},{heightPx:550,styleHeading:{"margin-bottom":`180px`}}),j=[`Default`,`Placement`,`ClickTrigger`,`ManualTrigger`,`RemovingArrows`,`HTMLInTooltips`,`SettingAMaximumWidth`,`Screenshot`],C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
...
})`,...A.parameters?.docs?.source}}}})))()}export{M as n,g as r,C as t};