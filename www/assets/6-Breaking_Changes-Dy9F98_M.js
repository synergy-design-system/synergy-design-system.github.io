import{j as r}from"./jsx-runtime-j_jdvEMj.js";import{useMDXComponents as f}from"./index-BSj771as.js";import{G as b}from"./index-Df9so8jS.js";import{ae as w,ag as v}from"./index-DVl199EM.js";import{r as E,R as x}from"./index-B-o1Wr-g.js";import"./iframe-Bz2aVMyf.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-DGdNYaqV.js";import"./index-DrFu-skq.js";const{global:T}=__STORYBOOK_MODULE_GLOBAL__,{makeDecorator:k,addons:u}=__STORYBOOK_MODULE_PREVIEW_API__,{STORY_CHANGED:S,SELECT_STORY:R}=__STORYBOOK_MODULE_CORE_EVENTS__;var C="links",{document:m,HTMLElement:A}=T;function I(e){let n={},s=(e[0]==="?"?e.substring(1):e).split("&").filter(Boolean);for(let t=0;t<s.length;t++){let o=s[t].split("=");n[decodeURIComponent(o[0])]=decodeURIComponent(o[1]||"")}return n}var c=e=>u.getChannel().emit(R,e),M=(e,n)=>new Promise(s=>{let{location:t}=m,o=I(t.search).id,i=e||o.split("--",2)[0],l=`/story/${b(i,n)}`,d=t.pathname.replace(/iframe\.html$/,""),g=`${t.origin+d}?${Object.entries({path:l}).map(h=>`${h[0]}=${h[1]}`).join("&")}`;s(g)}),y=e=>{let{target:n}=e;if(!(n instanceof A))return;let s=n,{sbKind:t,sbStory:o}=s.dataset;(t||o)&&(e.preventDefault(),c({kind:t,story:o}))},a=!1,H=()=>{a||(a=!0,m.addEventListener("click",y))},N=()=>{a&&(a=!1,m.removeEventListener("click",y))};k({name:"withLinks",parameterName:C,wrapper:(e,n)=>(H(),u.getChannel().once(S,N),e(n))});const O=`# Handling breaking changes between major versions
