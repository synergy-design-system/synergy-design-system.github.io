import{g as r}from"./preview-w2de4UgR.js";import{x as t}from"./lit-element-ZYWMe1i1.js";import{o as a}from"./select-CaFZU_ce.js";import{s as c,a as l,g as i,b as y,c as u}from"./component-B7uaMQbt.js";import"./index-DH5ua8nC.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon-button-9lkKz4Xt.js";import"./icon.component-Bqad2hdS.js";import"./directive-helpers-CkpR4LMI.js";import"./icon-DkXJLGU6.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-BhJsmGLR.js";const{args:m,argTypes:f}=c("syn-optgroup"),{overrideArgs:d}=u("syn-optgroup"),{generateTemplate:g}=l("syn-optgroup"),T={args:d([{name:"default",type:"slot",value:`
        <syn-option value="1">Option 1</syn-option>
        <syn-option value="2">Option 2</syn-option>
        <syn-option value="3">Option 3</syn-option>
      `},{name:"label",type:"attribute",value:"Section 1"}],m),argTypes:f,component:"syn-optgroup",parameters:{design:r("5619-21837"),docs:{description:{component:i("optiongroup","default")},story:{height:"400px"}}},title:"Components/syn-optgroup"},n={parameters:{controls:{disable:!1},docs:{description:{story:i("optiongroup","default")}}},render:p=>t`
    <syn-select>
      ${g({args:p})}
  ...
  `},s=y({ScreenshotStory:x},{afterRender:a("syn-select"),heightPx:400});n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
