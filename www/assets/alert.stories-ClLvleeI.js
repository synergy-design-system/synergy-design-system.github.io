import{k as n}from"./directive-helpers-B-JxG5af.js";import{g as t,a as h,s as f,b as w,c as S,d as T}from"./component-CSnz1eqc.js";import"./if-defined-98Biveud.js";import"./ref-DMm6gEez.js";import"./chunk-L4EGOTBX-Mt8q4xcs.js";import"./entry-preview-CWKZl0rh.js";import"./index-ogSvIofg.js";import"./icon-button-B618sG2i.js";import"./library-UYMiFSYt.js";import"./icon.component-CEnKTybK.js";import"./index-Vx7n56Jp.js";import"./index-CYQpqK1Q.js";import"./_commonjsHelpers-CqkleIqs.js";import"./icon-D4nLdb-j.js";var d=Object.freeze,Y=Object.defineProperty,u=(o,b)=>d(Y(o,"raw",{value:d(b||o.slice())})),p,m,g,v;const{args:k,argTypes:x}=f("syn-alert"),{overrideArgs:q}=w("syn-alert"),{generateTemplate:L}=S("syn-alert"),V={args:q([{name:"default",type:"slot",value:"This is a standard alert. You can customize its content and even the icon."},{name:"open",type:"attribute",value:!0},{name:"icon",type:"slot",value:'<syn-icon slot="icon" name="info"></syn-icon>'}],k),argTypes:x,component:"syn-alert",parameters:{design:h("15172-32035"),docs:{description:{component:t("alert","default")}}},title:"Components/syn-alert"},e={parameters:{controls:{disable:!1},docs:{description:{story:t("alert","default")}}},render:o=>L({args:o})},a={parameters:{docs:{description:{story:t("alert","variants")}}},render:()=>n`
  ...
  `},y=T({Default:e,Variants:a,Closable:r,WithoutIcons:s,Toast:_},550);e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
