import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,d as r,f as i,g as a,u as o}from"./iframe-BcSabCAt.js";import{t as s}from"./icon-BAP3aECg.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-CI3ThXYz.js";import{t as m}from"./details-DDMMoLhw.js";import{n as h,t as g}from"./PaddingDecorator-29WbdGSg.js";var _,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N=e((()=>{t(),m(),s(),f(),r(),g(),a(),{args:_,argTypes:v}=l(`syn-details`),{overrideArgs:y}=c(`syn-details`),{generateTemplate:b}=d(`syn-details`),x={args:y([{name:`summary`,type:`attribute`,value:`Toggle Me`},{name:`contained`,type:`attribute`,value:!0},{name:`default`,type:`slot`,value:`<h3 style="margin: 0 0 var(--syn-spacing-x-small); font: var(--syn-body-small-bold);">Subheadline</h3>
      Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.
      At vero eos et accusam et justo duo dolores et ea rebum.`}],_),argTypes:v,component:`syn-details`,parameters:{chromatic:{modes:i},design:o(`41227-232486`),docs:{description:{component:u(`details`,`default`)}}},tags:[`Structure`],title:`Components/syn-details`},S={parameters:{controls:{disable:!1},docs:{description:{story:u(`details`,`default`)}}},render:e=>b({args:e})},C={parameters:{docs:{description:{story:u(`details`,`open`)}}},render:()=>n`
  ...
  `},w={parameters:{docs:{description:{story:u(`details`,`contained`)}}},render:()=>n`
  ...
  `},T={decorators:[h()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`details`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-details`);t&&t.shadowRoot.querySelector(`summary`).focus()},render:()=>n`
    <syn-details summary="Toggle Me" contained>
      <h3 style="margin: 0 0 var(--syn-spacing-x-small); font: var(--syn-body-small-bold);">Subheadline</h3>
      Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.
      At vero eos et accusam et justo duo dolores et ea rebum.
    </syn-details>
  `},E=e=>({parameters:{docs:{description:{story:u(`details`,`disabled`)}}},render:()=>n`
    <syn-details summary="Toggle Me" disabled .contained=${e}>
      <h3 style="margin: 0 0 var(--syn-spacing-x-small); font: var(--syn-body-small-bold);">Subheadline</h3>
      Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.
      At vero eos et accusam et justo duo dolores et ea rebum.
    </syn-details>
  `}),D=E(!0),O=E(!1),k={parameters:{docs:{description:{story:u(`details`,`size`)}}},render:()=>n`
  ...
  `},A={parameters:{docs:{description:{story:u(`details`,`icon`)}}},render:()=>n`
    <syn-details open>
