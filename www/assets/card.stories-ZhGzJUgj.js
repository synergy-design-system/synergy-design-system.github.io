import{l as g,x as s,g as f,o as v}from"./iframe-BKpOMA2J.js";import{e as x}from"./class-map-Bm3DhBnV.js";import{n as S}from"./property-TW3g3kmA.js";import{H as _}from"./slot-9EVoRGQc.js";import{S as w,c as C}from"./component.styles-CRhVy8Ny.js";import"./button-BsjbJayn.js";import"./icon-button-D9ebQJlt.js";import{g as e,s as T,a as j,c as I,b as D}from"./component-CpIQV6Xx.js";import"./form-d9hCJUdr.js";import"./if-defined-NJCa5_I5.js";import"./localize-CatY2peN.js";import"./index-DihgwUfS.js";import"./state-hNuyXQVL.js";import"./query-DAIS6qJ0.js";import"./watch-CEsCE2EF.js";import"./icon.component-DRWgpx_9.js";import"./spinner.component-Bec8eVrx.js";import"./decorator-DANECR0-.js";import"./functions-CDi3doZH.js";import"./icon-button.component-DtyTDsuU.js";import"./index-Bkk0Z6Ex.js";import"./_docs-CrPFe_9C.js";const H=g`
	/* stylelint-disable */
  :host {
...
`;var K=Object.defineProperty,A=(r,l,y,z)=>{for(var a=void 0,m=r.length-1,h;m>=0;m--)(h=r[m])&&(a=h(l,y,a)||a);return a&&K(l,y,a),a};class u extends w{constructor(){super(...arguments),this.hasSlotController=new _(this,"footer","header","image"),this.sharp=!1}static{this.styles=[C,H,k]}render(){return s`
      <div
        part="base"
    ...
    `}}A([S({type:Boolean,reflect:!0})],u.prototype,"sharp");u.define("syn-card");const{args:F,argTypes:M}=T("syn-card"),{overrideArgs:O}=j("syn-card"),{generateTemplate:W}=I("syn-card"),b=({buttonText:r="More Info",footerText:l="Optional information"}={})=>`
  <footer slot="footer">
    <small>${l}</small>
    <nav>
...
`,nr={args:O([{name:"image",type:"slot",value:'<img slot="image" src="https://synergy-design-system.github.io/card-example.jpg" alt="Multiple persons having lunch in SICK Academy" />'},{name:"default",type:"slot",value:`
        <h3>Headline</h3>
        This are some happy employees, but not just any employees. These are SICK employees.
      `},{name:"footer",type:"slot",value:b()}],F),argTypes:M,component:"syn-card",parameters:{design:f("15409-74106"),docs:{description:{component:e("card","default")}}},tags:["Structure"],title:"Components/syn-card"},o={parameters:{controls:{disable:!1},docs:{description:{story:e("card","default")}}},render:r=>W({args:r})},t={parameters:{docs:{description:{story:e("card","basic-card")}}},render:()=>s`
