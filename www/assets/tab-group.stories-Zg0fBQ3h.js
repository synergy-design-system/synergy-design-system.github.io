import{s as G,a as E,g as _,b as t,c as O,d as F,e as u}from"./component-CtnV_Tbj.js";import{k as s}from"./directive-helpers-CDT6qhDs.js";import{p as R}from"./index-BjJXGaV5.js";import"./chunk-L4EGOTBX-C9C4DwME.js";import"./entry-preview-D9TbQDUR.js";import"./index-DrFu-skq.js";import"./index-B-o1Wr-g.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon.component-DBZeGCfw.js";import"./icon-B38ZGMQ7.js";var $=Object.freeze,q=Object.defineProperty,w=(e,n)=>$(q(e,"raw",{value:$(n||e.slice())})),S;const{args:j,argTypes:A}=G("syn-tab-group"),{overrideArgs:k}=F("syn-tab-group"),{generateTemplate:L}=E("syn-tab-group"),P=(e,n,{active:a=!1,closable:g=!1,disabled:v=!1}={})=>`<syn-tab slot="nav" panel="${e}" ${a?"active":""} ${v?"disabled":""} ${g?"closable":""}>${n}</syn-tab>`,T=(e,n,{active:a=!1,closable:g=!1,disabled:v=!1}={})=>u(P(e,n,{active:a,closable:g,disabled:v})),H=()=>[{panel:"general",props:{active:!0}},{panel:"custom"},{panel:"advanced"},{panel:"disabled",props:{disabled:!0}}].map(({panel:e,props:n})=>P(e,R(e),n)).join(`
...
\`
  ...
  heightPx: 740
})`,...d.parameters?.docs?.source}}};const Y=["Default","TabsOnStart","TabsOnEnd","ClosableTabs","ScrollingTabs","VisualHierarchy","ManualActivation","Icons","Screenshot"];export{c as ClosableTabs,r as Default,i as Icons,m as ManualActivation,d as Screenshot,p as ScrollingTabs,l as TabsOnEnd,o as TabsOnStart,b as VisualHierarchy,Y as __namedExportsOrder,X as default};
