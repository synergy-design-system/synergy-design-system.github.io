import"./side-nav-DNJpqiRF.js";import"./nav-item-BxyU3GRU.js";import"./icon-DqfgyPbM.js";import"./header-CoCrErYt.js";import{g as I,C as w,x as e}from"./iframe-BbG24dca.js";import{g as n,s as D,a as A,b as L,c as C}from"./component-DQoGmEAi.js";import{D as _}from"./DisableFocusTrap-CwoZhDam.js";import"./class-map-C4GF1kIH.js";import"./synergy-element-mvvDTlej.js";import"./icon.component-DiWeev-w.js";import"./watch-CEsCE2EF.js";import"./query-DAIS6qJ0.js";import"./slot-9EVoRGQc.js";import"./drawer.component-CUnUBaSD.js";import"./animation-registry-l4L8bmT6.js";import"./closeActiveElement-Bnbpk8Kw.js";import"./if-defined-BDvKPKv0.js";import"./localize-Dh03wnLC.js";import"./index-DihgwUfS.js";import"./scroll-DgKSCJoS.js";import"./event-B0iVuGLD.js";import"./modal-Dlsa26F3.js";import"./tabbable-D_Tgg1nc.js";import"./icon-button.component-BDSusJFU.js";import"./decorator-DeP7ND_N.js";import"./functions-DkH8wE0_.js";import"./divider.component-Cffnz0zs.js";import"./preload-helper-Ct5FWWRu.js";import"./index-CQ0aEGxp.js";import"./_docs-DmU5sf6r.js";import"./blocks-CyoGRIex.js";var y=Object.freeze,O=Object.defineProperty,a=(r,F)=>y(O(r,"raw",{value:y(r.slice())})),p,g,h,f,b,k,S,N;const{args:x,argTypes:j}=D("syn-side-nav"),{overrideArgs:q}=A("syn-side-nav"),{generateTemplate:$}=C("syn-side-nav"),ue={args:q([],x),argTypes:j,component:"syn-side-nav",parameters:{chromatic:{modes:w},design:I("12362-10883"),docs:{container:_,description:{component:n("side-nav","default")}}},tags:["Application Shell","SICK2018","SICK2025"],title:"Components/syn-side-nav"},o=()=>e`
...
`)}],x),parameters:{controls:{disable:!1},docs:{description:{story:n("side-nav","default")}}},render:r=>e(g||(g=a([`
    ...
    <\/script>
    `,`
  `])),$({args:r}),t(".side-nav-default"))},s={parameters:{docs:{description:{story:n("side-nav","rail")}}},render:()=>e(h||(h=a([`
  ...
  `])),t(".side-nav-indentation"))},u=L({Default:i,Rail:s,Sticky:d,Footer:c,Fixed:l,Shrink:m,Indentation:v},700);i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  args: overrideArgs([{
    name: 'open',
    type: 'attribute',
    value: true
  ...
  Shrink,
  Indentation
}, 700)`,...u.parameters?.docs?.source}}};const ye=["Default","Rail","Sticky","Footer","Fixed","Shrink","Indentation","Screenshot"];export{i as Default,l as Fixed,c as Footer,v as Indentation,s as Rail,u as Screenshot,m as Shrink,d as Sticky,ye as __namedExportsOrder,ue as default};
