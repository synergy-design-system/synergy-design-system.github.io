import"./icon-NtWdXWMv.js";import{k as n}from"./lit-element-BsyMe9HG.js";import{s as p,a as g,g as h,c as b,d as v}from"./component-BZvxfSsF.js";import{r as d}from"./icon.component-CExUySyX.js";import{d as f}from"./default-icons-C0-H61Dj.js";import"./index-Dfi6UpXT.js";import"./directive-helpers-DUpkUCIH.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-B-o1Wr-g.js";import"./_commonjsHelpers-Cpj98o6Y.js";const{args:w,argTypes:S}=p("syn-icon"),{overrideArgs:I}=v("syn-icon"),{generateTemplate:C}=g("syn-icon"),x=`
...
`,$={args:I({name:"name",type:"attribute",value:"wallpaper"},w),argTypes:S,component:"syn-icon",parameters:{design:h("1616-1512"),docs:{description:{component:x}}},title:"Components/syn-icon"},s={parameters:{controls:{disable:!1}},render:e=>C({args:e})},o={render:()=>n`<div style="color: var(--syn-color-primary-600);">
