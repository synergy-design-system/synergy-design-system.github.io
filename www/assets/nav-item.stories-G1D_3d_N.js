import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,d as r,f as i,g as a,u as o}from"./iframe-DJ0QlWgc.js";import{t as s}from"./icon-CiIVLsag.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-CYGmWguq.js";import{n as m,t as h}from"./PaddingDecorator-D0C63Ei_.js";import{t as g}from"./nav-item-D-Kf8igX.js";var _,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N;e((()=>{g(),s(),t(),f(),r(),h(),a(),{args:_,argTypes:v}=l(`syn-nav-item`),{overrideArgs:y}=c(`syn-nav-item`),{generateTemplate:b}=d(`syn-nav-item`),x={args:y([{name:`default`,type:`slot`,value:`Label`}],_),argTypes:v,component:`syn-nav-item`,parameters:{chromatic:{modes:i},design:o(`41163-402744`),docs:{description:{component:u(`nav-item`,`default`)}}},tags:[`Navigation`],title:`Components/syn-nav-item`},S={parameters:{controls:{disable:!1},docs:{description:{story:u(`nav-item`,`default`)}}},render:e=>b({args:e})},C={parameters:{docs:{description:{story:u(`nav-item`,`labels`)}}},render:()=>n`
    <syn-nav-item>This is a label</syn-nav-item>
  `},w={parameters:{docs:{description:{story:u(`nav-item`,`current`)}}},render:()=>n`
    <syn-nav-item current>Current Navigation item</syn-nav-item>
  `},T={parameters:{docs:{description:{story:u(`nav-item`,`nav-horizontal`)}}},render:()=>n`
  ...
  `},E={decorators:[m()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`nav-item`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-nav-item`);t&&t.focus()},render:()=>n`
    <syn-nav-item>Current navigation item</syn-nav-item>
  `},D={parameters:{docs:{description:{story:u(`nav-item`,`prefix-suffix`)}}},render:()=>n`
    <style>
    .doc-number-helper {
      align-items: center;
  ...
  `},O={parameters:{docs:{description:{story:u(`nav-item`,`children`)}}},render:()=>n`
  ...
  `},k={parameters:{docs:{description:{story:u(`nav-item`,`divider`)}}},render:()=>n`
    <nav style="width: 320px;">
      <syn-nav-item>Dividing element</syn-nav-item>
      <syn-nav-item divider>Dividing element</syn-nav-item>
    </nav>
  `},A={parameters:{docs:{description:{story:u(`nav-item`,`indentation`)}}},render:()=>n`
  ...
  `},j={parameters:{docs:{description:{story:u(`nav-item`,`disabled`)}}},render:()=>n`
  ...
  Divider,
  Disabled
}, 300)`,...M.parameters?.docs?.source}}},N=[`Default`,`Labels`,`Current`,`HorizontalNavigation`,`Focus`,`PrefixAndSuffixSlot`,`ChildrenClosedOrOpenVerticalOnly`,`Divider`,`Indentation`,`Disabled`,`Screenshot`]}))();export{O as ChildrenClosedOrOpenVerticalOnly,w as Current,S as Default,j as Disabled,k as Divider,E as Focus,T as HorizontalNavigation,A as Indentation,C as Labels,D as PrefixAndSuffixSlot,M as Screenshot,N as __namedExportsOrder,x as default};