import"./select-BLPNXHKZ.js";import"./option-DVCwqqIm.js";import"./optgroup-B5HHXSMG.js";import"./icon-DUdoh113.js";import"./button-DorK-1zF.js";import{g as w,x as n}from"./iframe-BPTGpV5F.js";import{o as L}from"./select-DWvFE8kX.js";import{g as o,s as M,c as P,a as z,b as D}from"./component-CcVK7IEJ.js";import{p as k}from"./PaddingDecorator-CEbUGvfU.js";import"./animation-registry-l4L8bmT6.js";import"./class-map-hCkpY42X.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./localize-Dh03wnLC.js";import"./index-DihgwUfS.js";import"./synergy-element-Cui3Y_g1.js";import"./icon.component-B0AQQ8Br.js";import"./watch-CEsCE2EF.js";import"./query-DAIS6qJ0.js";import"./scroll-DgKSCJoS.js";import"./event-B0iVuGLD.js";import"./form-control.custom.styles-DLhXDJis.js";import"./popup.component-B86EX2Io.js";import"./if-defined-CoHF8A8R.js";import"./tag.component-CDj0TSqc.js";import"./icon-button.component-OVKegjBO.js";import"./decorator-DANECR0-.js";import"./functions-CDi3doZH.js";import"./query-assigned-elements-QtOlz7Yz.js";import"./divider.component-SmR7tJMp.js";import"./spinner.component-BH8monv7.js";import"./preload-helper-Ct5FWWRu.js";import"./index-Bkk0Z6Ex.js";import"./_docs-DKsB8ZHg.js";var x=Object.freeze,H=Object.defineProperty,S=(e,t)=>x(H(e,"raw",{value:x(t||e.slice())})),_,T,E;const{userEvent:C}=__STORYBOOK_MODULE_TEST__,{args:q,argTypes:I}=M("syn-select"),{overrideArgs:U}=z("syn-select"),{generateTemplate:Y}=P("syn-select"),_n={args:q,argTypes:I,component:"syn-select",parameters:{design:w("5069-7562"),docs:{description:{component:o("select","default")},story:{height:"250px"}}},tags:["Form","SICK2018"],title:"Components/syn-select"},s={parameters:{args:U({name:"default",type:"slot",value:`
      ...
      `},q),controls:{disable:!1},docs:{description:{story:o("select","default")}}},render:e=>Y({args:e})},i={parameters:{docs:{description:{story:o("select","labels")}}},render:()=>n`
  ...
  `},v={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:o("select","invalid")}}},play:async({canvasElement:e})=>{const t=e.querySelector("form"),$=t.querySelector("syn-select"),f=t.querySelector("syn-button");f&&$&&(await C.click(f),f.click())},render:()=>n`
  ...
  heightPx: 400
})`,...h.parameters?.docs?.source}}};const Tn=["Default","Labels","HelpText","Placeholder","Clearable","Focus","Disabled","Multiple","SettingInitialValues","GroupingOptions","Sizes","Invalid","PrefixSuffixIcons","CustomTags","ScreenshotDefault","ScreenshotMultiple"];export{l as Clearable,g as CustomTags,s as Default,c as Disabled,r as Focus,m as GroupingOptions,p as HelpText,v as Invalid,i as Labels,y as Multiple,a as Placeholder,O as PrefixSuffixIcons,b as ScreenshotDefault,h as ScreenshotMultiple,u as SettingInitialValues,d as Sizes,Tn as __namedExportsOrder,_n as default};
