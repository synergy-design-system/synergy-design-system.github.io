import"./icon-DQ4LgkGh.js";import{k as n}from"./directive-helpers-CDT6qhDs.js";import{s as p,a as g,g as h,c as b,d as v}from"./component-Ch2orRWV.js";import{r as d}from"./library-BZPO0bHa.js";import{d as f}from"./default-icons-B7cd3LAo.js";import"./icon.component-BqaAhpVK.js";import"./if-defined-BaykDp1D.js";import"./ref-lLHsj5FH.js";import"./chunk-L4EGOTBX-C9C4DwME.js";import"./entry-preview-D9TbQDUR.js";import"./index-DrFu-skq.js";import"./index-DKU_zBw8.js";import"./index-CleY8y_P.js";import"./_commonjsHelpers-Cpj98o6Y.js";const{args:w,argTypes:S}=p("syn-icon"),{overrideArgs:I}=v("syn-icon"),{generateTemplate:C}=g("syn-icon"),x=`
...
`,V={args:I({name:"name",type:"attribute",value:"wallpaper"},w),argTypes:S,component:"syn-icon",parameters:{design:h("1616-1512"),docs:{description:{component:x}}},title:"Components/syn-icon"},s={parameters:{controls:{disable:!1}},render:e=>C({args:e})},o={render:()=>n`<div style="color: var(--syn-color-primary-600);">
...
</div>`)},y=b({Default:s,Colors:o,Sizing:r,Labels:i,CustomIcons:t,CDNIconLibrary:a,BundledIconLibrary:c,SpriteSheetUsage:l});s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    }
...
\`\`\``,...l.parameters?.docs?.description}}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`generateScreenshotStory({
  ...
  BundledIconLibrary,
  SpriteSheetUsage
})`,...y.parameters?.docs?.source}}};const B=["Default","Colors","Sizing","Labels","CustomIcons","CDNIconLibrary","BundledIconLibrary","SpriteSheetUsage","Screenshot"];export{c as BundledIconLibrary,a as CDNIconLibrary,o as Colors,t as CustomIcons,s as Default,i as Labels,y as Screenshot,r as Sizing,l as SpriteSheetUsage,B as __namedExportsOrder,V as default};
