import{g as D}from"./preview-w2de4UgR.js";import{x as n}from"./lit-element-ZYWMe1i1.js";import{o as T}from"./select-CaFZU_ce.js";import{s as $,a as M,g as o,b as E,c as P}from"./component-B7uaMQbt.js";import"./index-DH5ua8nC.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon-button-9lkKz4Xt.js";import"./icon.component-Bqad2hdS.js";import"./directive-helpers-CkpR4LMI.js";import"./icon-DkXJLGU6.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-BhJsmGLR.js";var S=Object.freeze,q=Object.defineProperty,h=(e,b)=>S(q(e,"raw",{value:S(b||e.slice())})),x,f,_;const{args:L,argTypes:z}=$("syn-select"),{overrideArgs:H}=P("syn-select"),{generateTemplate:w}=M("syn-select"),K={args:L,argTypes:z,component:"syn-select",parameters:{design:D("5069-7562"),docs:{description:{component:o("select","default")},story:{height:"250px"}}},title:"Components/syn-select"},t={parameters:{args:H({name:"default",type:"slot",value:`
      ...
      `},L),controls:{disable:!1},docs:{description:{story:o("select","default")}}},render:e=>w({args:e})},s={parameters:{docs:{description:{story:o("select","labels")}}},render:()=>n`
  ...
  `},v={parameters:{docs:{description:{story:o("select","gettag")}}},render:()=>n(f||(f=h([`
    <syn-select
      clearable
  ...
  `],[`
    ...
    <\/script>
  `])))},O=E({ScreenshotStoryDefault:C},{afterRender:T("syn-select"),heightPx:400}),g=E({ScreenshotStoryMultiple:U},{afterRender:T("syn-select"),heightPx:400});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  parameters: {
    args: overrideArgs({
      name: 'default',
      type: 'slot',
  ...
  afterRender: openSelect('syn-select'),
  heightPx: 400
})`,...g.parameters?.docs?.source}}};const Q=["Default","Labels","HelpText","Placeholder","Clearable","Focus","Disabled","Multiple","SettingInitialValues","GroupingOptions","Sizes","PrefixIcons","CustomTags","ScreenshotDefault","ScreenshotMultiple"];export{a as Clearable,v as CustomTags,t as Default,r as Disabled,l as Focus,u as GroupingOptions,i as HelpText,s as Labels,c as Multiple,p as Placeholder,d as PrefixIcons,O as ScreenshotDefault,g as ScreenshotMultiple,y as SettingInitialValues,m as Sizes,Q as __namedExportsOrder,K as default};
