import{n as e}from"./chunk-DnJy8xQt.js";import{Ft as t,L as n,Lt as r,M as i,Nt as a,P as o,Rt as s,Ut as c,j as l}from"./iframe-DJ0QlWgc.js";import{n as u,t as d}from"./class-map-DEi9Q1MK.js";import{r as ee,t as f}from"./form-BVa_zioF.js";import{r as p,t as te}from"./slot-uOU62xJ8.js";import{n as m,t as h}from"./if-defined-D8THz00N.js";import{n as g,t as _}from"./localize-DnZL8qNz.js";import{a as v,f as y,i as b,n as x,o as ne,p as S,r as C,s as w,t as T,u as E}from"./synergy-element-ChX6Se5O.js";import{n as D,t as O}from"./watch-OXZPXmne.js";import{n as k,t as A}from"./icon.component-Cmkda8ro.js";import{c as j,l as M,s as N,u as P}from"./functions-d1Pk1Eq0.js";import{n as F,t as I}from"./decorator-CJ_bAnlW.js";import{n as L,t as re}from"./live-DkPZcewy.js";import{n as R,t as z}from"./divider.component-seecbViJ.js";import{n as B,t as V}from"./default-value-D5bpNTe4.js";import{n as H,t as U}from"./form-control.styles-CPPfRdgH.js";var W,G,K=e((()=>{a(),l(),W=class extends i{constructor(e){if(super(e),this.handlePointerDown=e=>{e.button!==0||this.host.disabled||this.spinOnLongPressCallback(e)},this.handlePointerUp=e=>{e?.preventDefault(),e?.stopPropagation(),this.timeout&&this.callbacks.start(),this.stopSpinningAndCleanUp(),this.callbacks.end(),document.removeEventListener(`pointerup`,this.handlePointerUp)},e.type!==n.ELEMENT||!(e.element instanceof HTMLButtonElement))throw Error("The `longPress` directive must be used on an HTMLButtonElement.")}render(e){return t}update(e,[t]){return this.callbacks===void 0&&this.host===void 0&&(this.host=e.element,this.callbacks={...t},this.host.addEventListener(`pointerdown`,this.handlePointerDown)),r}reconnected(){this.host.addEventListener(`pointerdown`,this.handlePointerDown)}disconnected(){this.stopSpinningAndCleanUp(),this.host.removeEventListener(`pointerdown`,this.handlePointerDown),document.removeEventListener(`pointerup`,this.handlePointerUp)}spinOnLongPressCallback(e){e.preventDefault(),e.stopPropagation(),this.timeout=setTimeout(()=>{this.timeout=void 0,this.interval=setInterval(()=>{this.callbacks.start()},50)},500),document.addEventListener(`pointerup`,this.handlePointerUp),this.observer?.disconnect(),this.observer=new MutationObserver(e=>{e.forEach(e=>{e.attributeName===`disabled`&&this.stopSpinningAndCleanUp()})}),this.observer.observe(this.host,{attributes:!0})}stopSpinningAndCleanUp(){clearInterval(this.interval),clearTimeout(this.timeout),this.observer?.disconnect()}},G=o(W)})),q,J=e((()=>{a(),q=c`
	/* stylelint-disable */
  :host {
    display: block;
      ...
      >
        ...
        <div part="form-control-input" class="form-control-input">
          ...
          >
            ...
            ${this.type===`number`&&!this.noSpinButtons?s`
