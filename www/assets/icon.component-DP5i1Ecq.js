import{u as P,f as _,i as b,s as I,x as V}from"./lit-element-ZYWMe1i1.js";import{e as B}from"./directive-helpers-CkpR4LMI.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function $(e){return a({...e,state:!0,attribute:!1})}const R=b`
	/* stylelint-disable */
  :host {
...
`;var j=Object.defineProperty,U=Object.getOwnPropertyDescriptor,Z=(e,t,s,i)=>{for(var r=i>1?void 0:i?U(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(r=(i?o(t,s,r):o(r))||r);return i&&r&&j(t,s,r),r};class y extends I{emit(t,s){const i=new CustomEvent(t,{bubbles:!0,cancelable:!1,composed:!0,detail:{},...s});return this.dispatchEvent(i),i}static{this.version="1.13.0"}static define(t,s=this,i={}){const r=customElements.get(t);if(!r){customElements.define(t,class extends s{},i);return}let n=" (unknown version)",o=n;"version"in s&&s.version&&(n=" v"+s.version),"version"in r&&r.version&&(o=" v"+r.version),!(n&&o&&n===o)&&console.warn(`Attempted to register <${t}>${n}, but <${t}>${o} has already been registered.`)}static{this.dependencies={}}constructor(){super(),Object.entries(this.constructor.dependencies).forEach(([t,s])=>{this.constructor.define(t,s)})}}Z([a()],y.prototype,"dir",2);Z([a()],y.prototype,"lang",2);function E(e,t){const s={waitUntilFirstUpdate:!1,...t};return(i,r)=>{const{update:n}=i,o=Array.isArray(e)?e:[e];i.update=function(l){o.forEach(u=>{const f=u;if(l.has(f)){const m=l.get(f),x=this[f];m!==x&&(!s.waitUntilFirstUpdate||this.hasUpdated)&&this[r](m,x)}}),n.call(this,l)}}}let L="";function M(e){L=e}function D(e=""){if(!L){const t=[...document.getElementsByTagName("script")],s=t.find(i=>i.hasAttribute("data-synergy"));if(s)M(s.getAttribute("data-synergy"));else{const i=t.find(n=>/synergy(\.min)?\.js($|\?)/.test(n.src)||/synergy-autoloader(\.min)?\.js($|\?)/.test(n.src));let r="";i&&(r=i.getAttribute("src")),M(r.split("/").slice(0,-1).join("/"))}}return L.replace(/\/$/,"")+(e?`/${e.replace(/^\//,"")}`:"")}const T={name:"default",resolver:e=>D(`assets/icons/${e}.svg`)},H={add:`
		...
		<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill='currentColor'><path d="M19 6.41L17.59 5L12 10.59L6.41 5L5 6.41L10.59 12L5 17.59L6.41 19L12 13.41L17.59 19L19 17.59L13.41 12L19 6.41Z"/></svg>`},k={name:"system",resolver:e=>e in H?`data:image/svg+xml,${encodeURIComponent(H[e])}`:""};let v=[T,k],p=[];function q(e){p.push(e)}function z(e){p=p.filter(t=>t!==e)}function S(e){return v.find(t=>t.name===e)}function Q(e,t){F(e),v.push({name:e,resolver:t.resolver,mutator:t.mutator,spriteSheet:t.spriteSheet}),p.forEach(s=>{s.library===e&&s.setIcon()})}function F(e){v=v.filter(t=>t.name!==e)}const N=b`
	/* stylelint-disable */
  :host {
