import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,d as r,f as i,g as a,u as o}from"./iframe-DJ0QlWgc.js";import{t as s}from"./button-Bu5NB7Z0.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-CYGmWguq.js";import{n as m,t as h}from"./taggedTemplateLiteral-BuD1d7yP.js";import{t as g}from"./input-OiaVgEqJ.js";import{t as _}from"./range-DY_LkkJX.js";import{t as v}from"./range-tick-CDbDVhR3.js";var y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K;e((()=>{t(),_(),s(),g(),v(),f(),r(),a(),m(),{userEvent:y}=__STORYBOOK_MODULE_TEST__,{args:C,argTypes:w}=l(`syn-range`),{overrideArgs:T}=c(`syn-range`),{generateTemplate:E}=d(`syn-range`),D={args:T([{name:`value`,type:`attribute`,value:`50`}],C),argTypes:w,component:`syn-range`,parameters:{chromatic:{modes:i},design:o(`41310-323916`),docs:{description:{component:u(`range`,`default`)}}},tags:[`Form`],title:`Components/syn-range`},O={parameters:{controls:{disable:!1},docs:{description:{story:u(`range`,`default`)},story:{height:`80px`}}},render:e=>E({args:e})},k={parameters:{docs:{description:{story:u(`range`,`labels`)}}},render:()=>n`
