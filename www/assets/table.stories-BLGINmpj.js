import{d as r,g as $,C,p as z,x as a}from"./iframe-CADVxcxo.js";import{T as S,S as L,b as E,c as D}from"./blocks-BK_YQdBm.js";import{g as _}from"./component-DIYVGgkZ.js";import{g as l}from"./translations-CnhJ1T76.js";import"./button-Cl52MY6l.js";import"./icon-CXtHULQP.js";import"./preload-helper-Ct5FWWRu.js";import"./index-Bkk0Z6Ex.js";import"./_docs-DKsB8ZHg.js";import"./class-map-CsDeTdsb.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./if-defined-DdzhuTe9.js";import"./localize-Dh03wnLC.js";import"./index-DihgwUfS.js";import"./synergy-element-CyR5uAEa.js";import"./icon.component-Cgd4Rx4z.js";import"./watch-CEsCE2EF.js";import"./query-DAIS6qJ0.js";import"./spinner.component-x46UfNOX.js";import"./decorator-DANECR0-.js";import"./functions-CDi3doZH.js";var w=Object.freeze,P=Object.defineProperty,v=(e,o)=>w(P(e,"raw",{value:w(e.slice())})),g,x,f,T;const s=(e,o=5)=>new Array(o).fill(void 0).map(e),n=(e=void 0)=>{const o=e?`syn-table-cell--shadow-${e} shadow-cell`:"",t=d=>`${e==="end"&&d===0||e==="start"&&d===4||e==="bottom"?o:""}`;return a`
    <thead>
      <tr>
...
`,le={parameters:{chromatic:{...z?.parameters?.chromatic,disableSnapshot:!1,modes:C},design:$("19923-55456"),docs:{description:{component:_("table","default","templates")},page:()=>r.createElement(r.Fragment,null,r.createElement(S,null),r.createElement(L,null),r.createElement(E,null),r.createElement(D,{title:""})),story:{iframeHeight:550}}},tags:["Structure","SICK2018"],title:"Templates/Table"},h={render:()=>{const e=s(()=>c());return a`
    ...
    `}},i={render:()=>{const e=s(()=>c("end"));return a(g||(g=v([`
      ...
      <\/script>
    `])),n("end"),e)}},b={render:()=>{const e=s(()=>c("start"));return a(x||(x=v([`
      ...
      <\/script>
    `])),n("start"),e)}},p={render:()=>{const e=s(()=>c());return a(f||(f=v([`
      ...
      <\/script>
    `])),n("bottom"),e)}},u={render:()=>{const e=s(()=>B());return a(T||(T=v([`
...
}`,...u.parameters?.docs?.source}}};const te=["TableWithHeader","TableWithAlternatingRows","TableWithBorders","TableShadowLeftColumn","TableShadowRightColumn","TableShadowTopRow","TableProduct"];export{u as TableProduct,i as TableShadowLeftColumn,b as TableShadowRightColumn,p as TableShadowTopRow,y as TableWithAlternatingRows,m as TableWithBorders,h as TableWithHeader,te as __namedExportsOrder,le as default};
