import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,d as r,f as i,g as a,u as o}from"./iframe-CIeU5pXv.js";import{a as s,i as c,n as l,o as u,r as d,t as f}from"./component-Dma-UHGC.js";import{t as p}from"./prio-nav-BBgzFYOT.js";import{t as m}from"./nav-item-CvOt8anP.js";var h,g,_,v,y,b,x,S,C;e((()=>{m(),p(),t(),d(),r(),a(),{args:h,argTypes:g}=c(`syn-prio-nav`),{overrideArgs:_}=s(`syn-prio-nav`),{generateTemplate:v}=u(`syn-prio-nav`),y={args:_([{name:`default`,type:`slot`,value:`
  ...
  heightPx: 200
})`,...S.parameters?.docs?.source},description:{story:`Uncomment this to test automatic adding of nav-items`,...S.parameters?.docs?.description}}},C=[`Default`,`PriorityMenu`,`Screenshot`]}))();export{b as Default,x as PriorityMenu,S as Screenshot,C as __namedExportsOrder,y as default};