import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{_ as n,a as r,h as i,l as a}from"./preview-DRz18Lsn.js";import{c as o,t as s}from"./lit-D4-0ovri.js";import{t as c}from"./button-CBC8ywKX.js";import{t as l}from"./input-DeuiTlMk.js";import{a as u,i as d,n as f,o as p,r as m}from"./component-NnlguzJ1.js";import{t as h}from"./taggedTemplateLiteral-BZenJ0bZ.js";import{t as g}from"./icon-button-Csrs2rAo.js";import{t as _}from"./dialog-b9C4nd7n.js";var v=t({CustomWidth:()=>A,CustomizingInitialFocus:()=>P,Default:()=>k,HeaderActions:()=>M,PreventingTheDialogFromClosing:()=>N,Scrolling:()=>j,__namedExportsOrder:()=>F,default:()=>O}),y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F;function I(){return(I=e((()=>{s(),i(),_(),c(),g(),l(),m(),a(),{args:S,argTypes:C}=d(`syn-dialog`),{overrideArgs:w}=u(`syn-dialog`),{generateTemplate:T}=p(`syn-dialog`),E=e=>`
...
`]),e,e),O={args:w([{name:`open`,type:`attribute`,value:!0},{name:`label`,type:`attribute`,value:`Dialog`},{name:`default`,type:`slot`,value:`Lorem ipsum dolor sit amet, consectetur adipiscing elit.`},{name:`footer`,type:`slot`,value:E(`default-close-icon`)}],S),argTypes:C,component:`syn-dialog`,parameters:{chromatic:{disableSnapshot:!1,modes:r},docs:{description:{component:f(`dialog`,`default`)},story:{height:`400px`}}},tags:[`Structure`],title:`Components/syn-dialog`},k={parameters:{chromatic:{disableSnapshot:!1},controls:{disable:!1},docs:{description:{story:f(`dialog`,`default`)}}},render:e=>o`
  ...
  `},F=[`Default`,`CustomWidth`,`Scrolling`,`HeaderActions`,`PreventingTheDialogFromClosing`,`CustomizingInitialFocus`],k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{
  parameters: {
    chromatic: {
  ...
  \`
}`,...P.parameters?.docs?.source}}}})))()}export{v as n,I as r,k as t};