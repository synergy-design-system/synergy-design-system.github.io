import{j as r,M as f,a as b}from"./index-DX_flYiH.js";import{useMDXComponents as v}from"./index-CHrGa5Tm.js";import{e as w}from"./iframe-B2bVberJ.js";import{r as E,R as x}from"./index-_2TAQcTa.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-BwkS7JH_.js";import"./index-DrFu-skq.js";const{STORY_CHANGED:T,SELECT_STORY:k}=__STORYBOOK_MODULE_CORE_EVENTS__,{makeDecorator:S,addons:u}=__STORYBOOK_MODULE_PREVIEW_API__,{global:R}=__STORYBOOK_MODULE_GLOBAL__;var A=Object.defineProperty,C=(e,n)=>{for(var s in n)A(e,s,{get:n[s],enumerable:!0})},_="links",{document:m,HTMLElement:I}=R;function M(e){let n={},s=(e[0]==="?"?e.substring(1):e).split("&").filter(Boolean);for(let t=0;t<s.length;t++){let o=s[t].split("=");n[decodeURIComponent(o[0])]=decodeURIComponent(o[1]||"")}return n}var c=e=>u.getChannel().emit(k,e),H=(e,n)=>new Promise(s=>{let{location:t}=m,o=M(t.search).id,i=e||o.split("--",2)[0],l=`/story/${w(i,n)}`,d=t.pathname.replace(/iframe\.html$/,""),g=`${t.origin+d}?${Object.entries({path:l}).map(h=>`${h[0]}=${h[1]}`).join("&")}`;s(g)}),y=e=>{let{target:n}=e;if(!(n instanceof I))return;let s=n,{sbKind:t,sbStory:o}=s.dataset;(t||o)&&(e.preventDefault(),c({kind:t,story:o}))},a=!1,O=()=>{a||(a=!0,m.addEventListener("click",y))},N=()=>{a&&(a=!1,m.removeEventListener("click",y))},L=S({name:"withLinks",parameterName:_,wrapper:(e,n)=>(O(),u.getChannel().once(T,N),e(n))});const{definePreview:q}=__STORYBOOK_MODULE_PREVIEW_API__;var D={};C(D,{decorators:()=>F});var F=[L];const B=`# Handling breaking changes between major versions
...
-->
`;var P=0,V=e=>e.button===P&&!e.altKey&&!e.ctrlKey&&!e.metaKey&&!e.shiftKey,j=(e,n=s=>{})=>{V(e)&&(e.preventDefault(),n(e))},z=class extends E.PureComponent{constructor(){super(...arguments),this.state={href:"/"},this.updateHref=async()=>{let{kind:e,title:n=e,story:s,name:t=s}=this.props;if(n&&t){let o=await H(n,t);this.setState({href:o})}},this.handleClick=()=>{let{kind:e,title:n=e,story:s,name:t=s}=this.props;n&&t&&c({title:n,name:t})}}componentDidMount(){this.updateHref()}componentDidUpdate(e){let{kind:n,title:s,story:t,name:o}=this.props;(e.kind!==n||e.story!==t||e.title!==s||e.name!==o)&&this.updateHref()}render(){let{kind:e,title:n=e,story:s,name:t=s,children:o,...i}=this.props,{href:l}=this.state;return x.createElement("a",{href:l,onClick:d=>j(d,this.handleClick),...i},o)}};z.defaultProps={children:void 0};function p(e){return r.jsxs(r.Fragment,{children:[r.jsx(f,{title:"Packages/Components/Breaking Changes"}),`
`,r.jsx(b,{children:B})]})}function Q(e={}){const{wrapper:n}={...v(),...e.components};return n?r.jsx(n,{...e,children:r.jsx(p,{...e})}):p()}export{Q as default};
