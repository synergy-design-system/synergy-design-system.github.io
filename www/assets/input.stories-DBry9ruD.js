import"./preview-Bh9bIqQJ.js";import{x as n}from"./lit-element-ZYWMe1i1.js";import{u as w}from"./index-C3zu00Ep.js";import{s as T,a as D,g as e,b as z}from"./component-LoRKmfxj.js";import"./index-DH5ua8nC.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon-button-Bc75cIeo.js";import"./icon.component-DP5i1Ecq.js";import"./directive-helpers-CkpR4LMI.js";import"./icon-I2WFnEtA.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-Bki0Az1s.js";const{args:E,argTypes:k}=T("syn-input"),{generateTemplate:L}=D("syn-input"),_={args:E,argTypes:k,parameters:{docs:{description:{component:e("input","default")}}},title:"Components/syn-input"},t={parameters:{controls:{disable:!1},docs:{description:{story:e("input","default")}}},render:r=>L({args:r})},a={parameters:{docs:{description:{story:e("input","label")}}},render:()=>n`<syn-input label="What is your name?"></syn-input>`},o={parameters:{docs:{description:{story:e("input","help-text")}}},render:()=>n`<syn-input label="Nickname" help-text="What would you like people to call you?"></syn-input>`},i={parameters:{docs:{description:{story:e("input","placeholder")}}},render:()=>n`<syn-input placeholder="Type something"></syn-input>`},l={parameters:{docs:{description:{story:e("input","clearable")}}},render:()=>n`<syn-input value="Clearable" placeholder="Clearable" clearable></syn-input>`},p={parameters:{docs:{description:{story:e("input","password-toggle")}}},render:()=>n`<syn-input type="password" placeholder="Password Toggle" password-toggle></syn-input>`},c={parameters:{docs:{description:{story:e("input","readonly")}}},render:()=>n`<syn-input value="Readonly content" readonly></syn-input>`},h={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:e("input","focus")}}},play:({canvasElement:r})=>{const s=r.querySelector("syn-input");s&&s.focus()},render:()=>n`
      <form>
  ...
  <syn-input placeholder="Large" size="large"></syn-input>`},g={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:e("input","invalid")}}},play:async({canvasElement:r})=>{try{const s=r.querySelector("form"),v=s.querySelector("syn-input"),S=s.querySelector("syn-button");S&&v&&(await w.click(S),S.click())}catch(s){console.error("Error in play function:",s)}},render:()=>n`
  ...
  <br/>
  <syn-input type="number" min="0" max="10" value="10"></syn-input>`},x=z({Default:t,Labels:a,HelpText:o,Placeholders:i,Clearable:l,TogglePassword:p,ReadonlyInputs:c,Disabled:u,Sizes:y,InputTypes:d,PrefixSuffixTextAndIcons:m,CustomizingLabelPosition:f,Stepper:b},500);t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  Stepper
}, 500)`,...x.parameters?.docs?.source}}};const O=["Default","Labels","HelpText","Placeholders","Clearable","TogglePassword","ReadonlyInputs","Focus","Disabled","Sizes","Invalid","InputTypes","PrefixSuffixTextAndIcons","CustomizingLabelPosition","Stepper","Screenshot"];export{l as Clearable,f as CustomizingLabelPosition,t as Default,u as Disabled,h as Focus,o as HelpText,d as InputTypes,g as Invalid,a as Labels,i as Placeholders,m as PrefixSuffixTextAndIcons,c as ReadonlyInputs,x as Screenshot,y as Sizes,b as Stepper,p as TogglePassword,O as __namedExportsOrder,_ as default};
