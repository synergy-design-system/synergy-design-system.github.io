import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{c as n,t as r}from"./lit-BVDl_-fF.js";import{U as i,_ as a,n as o,p as s,t as c}from"./iframe-Dn-tjrvc.js";import{d as l,f as u,i as d,p as f,u as p}from"./blocks-Djr6a2r4.js";import{t as m}from"./button-DSjAtJ0E.js";import{t as h}from"./icon-DehYIkFS.js";import{n as g,r as _}from"./component-D_QZftXm.js";import{n as v,t as y}from"./taggedTemplateLiteral-pWa2IaV6.js";import{t as b}from"./button-group-CnqtTdJV.js";import{t as x}from"./tooltip-CWEroo5f.js";import{t as S}from"./header-CWsJpFjH.js";var C,w,T,E,D;e((()=>{C=t(i(),1),f(),r(),c(),m(),b(),S(),x(),h(),_(),a(),v(),T={parameters:{chromatic:{...o?.parameters?.chromatic,disableSnapshot:!1,modes:s},docs:{description:{component:g(`tooltip`,`default`,`templates`)},page:()=>C.createElement(C.Fragment,null,C.createElement(u,null),C.createElement(l,null),C.createElement(d,null),C.createElement(p,{title:``}))}},tags:[`Feedback`],title:`Templates/Tooltip`},E={parameters:{docs:{description:{story:g(`tooltip`,`single-instance`,`templates`)}}},render:()=>n(w||=y([`
