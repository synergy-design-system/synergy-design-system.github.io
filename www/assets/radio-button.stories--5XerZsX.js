import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-DKowTjrk.js";import{c as i,t as a}from"./lit-DgWh_IaA.js";import{t as o}from"./button-VFKvv9D6.js";import{t as s}from"./icon-CBsrAmoE.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-yQeR3V9a.js";import{n as m,t as h}from"./decorators-D4h4FA4e.js";import{t as g}from"./radio-group-BR8PlCqd.js";import{t as _}from"./radio-button-OVpiIYE-.js";var v=t({ButtonsWithIcons:()=>N,Checked:()=>E,Default:()=>T,Disabled:()=>O,Focus:()=>D,Invalid:()=>j,PrefixAndSuffixIcons:()=>M,Readonly:()=>k,Screenshot:()=>P,Sizes:()=>A,__namedExportsOrder:()=>F,default:()=>w}),y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F;function I(){return(I=e((()=>{a(),o(),s(),g(),_(),h(),f(),r(),{userEvent:y}=__STORYBOOK_MODULE_TEST__,{args:b,argTypes:x}=l(`syn-radio-button`),{overrideArgs:S}=c(`syn-radio-button`),{generateTemplate:C}=d(`syn-radio-button`),w={args:S([{name:`default`,type:`slot`,value:`Option 1`},{name:`value`,type:`attribute`,value:`1`}],b),argTypes:x,component:`syn-radio-button`,parameters:{chromatic:{modes:n},docs:{description:{component:u(`radio-button`,`default`)}}},tags:[`Form`],title:`Components/syn-radio-button`},T={parameters:{controls:{disable:!1},docs:{description:{story:u(`radio-button`,`default`)}}},render:e=>i`
