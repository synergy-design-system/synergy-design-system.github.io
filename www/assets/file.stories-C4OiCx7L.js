import{e as k}from"./class-map-BjSdlSdV.js";import{c as I,n as l,S as A}from"./synergy-element-Dyk10Crc.js";import{S as B,r as O}from"./icon.component-bmAGmC-f.js";import{a as S}from"./query-DAIS6qJ0.js";import{j as P,x as a,g as q,C as L}from"./iframe-pBZ2jdjZ.js";import{o as M}from"./if-defined-B8Ln1Nwl.js";import{d as H}from"./default-value-C41JKgq5.js";import{w as F}from"./watch-CEsCE2EF.js";import{L as j}from"./localize-Dh03wnLC.js";import{F as R}from"./form-d9hCJUdr.js";import{H as U}from"./slot-9EVoRGQc.js";import{f as W,a as Y}from"./form-control.custom.styles-BfDEqDtI.js";import{S as G}from"./button-BeNzCDPH.js";import{s as z,g as T,b as C}from"./animation-registry-l4L8bmT6.js";import{e as K}from"./decorator-DeP7ND_N.js";import{g as d,s as N,a as J,c as Q,b as X}from"./component-BVEUuXMZ.js";import{p as Z}from"./PaddingDecorator--oiG6-dJ.js";import"./preload-helper-Ct5FWWRu.js";import"./index-DihgwUfS.js";import"./spinner.component-D3datYVg.js";import"./functions-DkH8wE0_.js";import"./index-CQ0aEGxp.js";import"./_docs-DmU5sf6r.js";const ee=P`
  :host {
    display: block;
  }
...
`;var re=Object.defineProperty,te=Object.getOwnPropertyDescriptor,i=(e,r,o,s)=>{for(var n=s>1?void 0:s?te(r,o):r,p=e.length-1,c;p>=0;p--)(c=e[p])&&(n=(s?c(r,o,n):c(n))||n);return s&&n&&re(r,o,n),n};let t=class extends A{constructor(){super(...arguments),this.formControlController=new R(this,{assumeInteractionOn:["syn-change"],value:e=>e.files}),this.hasSlotController=new U(this,"help-text","label"),this.localize=new j(this),this.userIsDragging=!1,this.name="",this.defaultValue="",this.size="medium",this.label="",this.helpText="",this.disabled=!1,this.droparea=!1,this.accept="",this.multiple=!1,this.webkitdirectory=!1,this.form="",this.required=!1,this.hideValue=!1}set files(e){this.input&&(this.input.files=e)}get files(){return this.input?.files}set value(e){this.input&&(this.input.value=e)}get value(){return this.input?.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(e){if(this.droparea){this.dropareaWrapper?.focus(e);return}this.button?.focus(e)}blur(){if(this.droparea){this.dropareaWrapper?.blur();return}this.button?.blur()}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleFiles(e){if(!e){this.value="";return}this.files=e}async handleTransferItems(e){if(!e)return this.value="",new Promise((c,E)=>{E(new Error("No proper items found"))});const o=Array.from(e).map(c=>c.webkitGetAsEntry()).map(c=>this.getFilesFromEntry(c)),n=(await Promise.all(o)).flat(),p=new DataTransfer;return Array.from(n).forEach(c=>p.items.add(c)),p.files}async getFilesFromEntry(e){return e?e.isFile?new Promise((r,o)=>{e.file(s=>r([s]),o)}):e.isDirectory?new Promise((r,o)=>{e.createReader().readEntries(n=>{Promise.all(n.map(p=>this.getFilesFromEntry(p))).then(p=>{r(p.flat())}).catch(o)})}):[]:[]}handleClick(e){e.preventDefault(),this.input.click()}handleChange(e){e.preventDefault(),e.stopPropagation(),this.emit("syn-input"),this.emit("syn-change")}handleDragOver(e){e.preventDefault(),e.stopPropagation(),this.userIsDragging=!0}handleDragLeave(e){e.preventDefault(),e.stopPropagation(),this.userIsDragging=!1}async handleDrop(e){if(e.preventDefault(),e.stopPropagation(),!e.dataTransfer)return;const r=await this.handleTransferItems(e.dataTransfer?.items);if(this.userIsDragging=!1,!r)return;if(!this.multiple&&!this.webkitdirectory&&r.length>1){this.emit("syn-error");return}if(this.hasSlotController.test("trigger"))this.handleFiles(r);else{const s=T(this.inputChosen,"file.text.disappear",{dir:this.localize.dir()}),n=T(this.inputChosen,"file.text.appear",{dir:this.localize.dir()});if(this.droparea){const p=T(this.dropareaIcon,"file.iconDrop",{dir:this.localize.dir()});C(this.dropareaIcon,p.keyframes,p.options)}await C(this.inputChosen,s.keyframes,s.options),this.handleFiles(r),await C(this.inputChosen,n.keyframes,n.options)}this.input.dispatchEvent(new Event("change"))}handleFocus(){this.emit("syn-focus")}handleBlur(){this.emit("syn-blur")}renderValue(){let e=!1,r=this.localize.term("numFilesSelected",0,this.webkitdirectory);return this.files&&this.files?.length>0&&(e=!0,r=this.files.length===1?this.files[0].name:this.localize.term("numFilesSelected",this.files.length,this.webkitdirectory)),a`
    ...
    `}};t.styles=[I,W,Y,ee];t.dependencies={"syn-button":G,"syn-icon":B};i([O()],t.prototype,"userIsDragging",2);i([l({type:Object})],t.prototype,"files",1);i([l({type:String})],t.prototype,"name",2);i([l({type:String})],t.prototype,"value",1);i([H()],t.prototype,"defaultValue",2);i([l({reflect:!0})],t.prototype,"size",2);i([l()],t.prototype,"label",2);i([l({attribute:"help-text"})],t.prototype,"helpText",2);i([l({reflect:!0,type:Boolean})],t.prototype,"disabled",2);i([l({type:Boolean})],t.prototype,"droparea",2);i([l({type:String})],t.prototype,"accept",2);i([l({type:String})],t.prototype,"capture",2);i([l({reflect:!0,type:Boolean})],t.prototype,"multiple",2);i([l({reflect:!0,type:Boolean})],t.prototype,"webkitdirectory",2);i([l({reflect:!0})],t.prototype,"form",2);i([l({reflect:!0,type:Boolean})],t.prototype,"required",2);i([l({attribute:"hide-value",type:Boolean})],t.prototype,"hideValue",2);i([S(".input__control")],t.prototype,"input",2);i([S(".button")],t.prototype,"button",2);i([S(".droparea")],t.prototype,"dropareaWrapper",2);i([S(".droparea__icon")],t.prototype,"dropareaIcon",2);i([S(".input__value")],t.prototype,"inputChosen",2);i([F("disabled",{waitUntilFirstUpdate:!0})],t.prototype,"handleDisabledChange",1);i([F("value",{waitUntilFirstUpdate:!0})],t.prototype,"handleValueChange",1);t=i([K("SynFile")],t);z("file.iconDrop",{keyframes:[{scale:1},{scale:.7},{scale:1}],options:{duration:600,easing:"ease-out"}});z("file.text.disappear",{keyframes:[{opacity:1},{opacity:0,transform:"translateY(-40%)"}],options:{duration:300,easing:"cubic-bezier(0.45, 1.45, 0.8, 1)"}});z("file.text.appear",{keyframes:[{opacity:0,transform:"translateY(40%)"},{opacity:1}],options:{duration:300,easing:"cubic-bezier(0.45, 1.45, 0.8, 1)"}});t.define("syn-file");var $=Object.freeze,ie=Object.defineProperty,ae=(e,r)=>$(ie(e,"raw",{value:$(e.slice())})),V;const{userEvent:se}=__STORYBOOK_MODULE_TEST__,{args:le,argTypes:oe}=N("syn-file"),{overrideArgs:ne}=J("syn-file"),{generateTemplate:pe}=Q("syn-file"),Ie={args:ne([],le),argTypes:oe,component:"syn-file",parameters:{chromatic:{modes:L},design:q("21709-49135"),docs:{description:{component:d("file","default")}}},tags:["Form"],title:"Components/syn-file"},u={parameters:{controls:{disable:!1},docs:{description:{story:d("file","default")}}},render:e=>pe({args:e})},h={parameters:{docs:{description:{story:d("file","label")}}},render:()=>a`
