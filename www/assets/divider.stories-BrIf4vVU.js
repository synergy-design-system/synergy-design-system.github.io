import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-DWg8XNs3.js";import{d as r,f as i,g as a,u as o}from"./iframe-CVaCVGtH.js";import{t as s}from"./divider-5c3zPm77.js";import{i as c,n as l,o as u,r as d,t as f}from"./component-CllRTPI1.js";var p,m,h,g,_,v,y,b,x,S,C,w=e((()=>{s(),n(),d(),r(),a(),{args:p,argTypes:m}=c(`syn-divider`),{generateTemplate:h}=u(`syn-divider`),g={args:p,argTypes:m,component:`syn-divider`,parameters:{chromatic:{modes:i},design:o(`41227-216341`),docs:{description:{component:l(`divider`,`default`)}}},tags:[`Structure`],title:`Components/syn-divider`},_={parameters:{docs:{description:{story:l(`divider`,`default`)}}},render:e=>h({args:e})},v={parameters:{docs:{description:{story:l(`divider`,`width`)}}},render:()=>t`<syn-divider style="--width: var(--syn-spacing-x-small);"></syn-divider>`},y={parameters:{docs:{description:{story:l(`divider`,`color`)}}},render:()=>t`<syn-divider style="--color: var(--syn-color-primary-600);"></syn-divider>`},b={parameters:{docs:{description:{story:l(`divider`,`spacing`)}}},render:()=>t`
