import{k as p,z as vt,c as _,I as gt,x as j,u as ft}from"./iframe-CfKmpROb.js";import{n as c}from"./synergy-element-D6uzLjd8.js";import{e as k}from"./class-map-DuCXFyun.js";import{r as A}from"./icon.component-BOIuuAKO.js";import{t as yt}from"./event-options-3qAdqXoU.js";import{a as B}from"./query-D0jTsbLw.js";import{o as rt}from"./query-assigned-elements-CIlqV-be.js";import{o as f}from"./if-defined-DcCHMlyu.js";var at=Object.defineProperty,mt=Object.defineProperties,wt=Object.getOwnPropertyDescriptor,_t=Object.getOwnPropertyDescriptors,O=Object.getOwnPropertySymbols,st=Object.prototype.hasOwnProperty,it=Object.prototype.propertyIsEnumerable,nt=t=>{throw TypeError(t)},Y=(t,e,o)=>e in t?at(t,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[e]=o,S=(t,e)=>{for(var o in e||(e={}))st.call(e,o)&&Y(t,o,e[o]);if(O)for(var o of O(e))it.call(e,o)&&Y(t,o,e[o]);return t},ne=(t,e)=>mt(t,_t(e)),le=(t,e)=>{var o={};for(var r in t)st.call(t,r)&&e.indexOf(r)<0&&(o[r]=t[r]);if(t!=null&&O)for(var r of O(t))e.indexOf(r)<0&&it.call(t,r)&&(o[r]=t[r]);return o},i=(t,e,o,r)=>{for(var a=r>1?void 0:r?wt(e,o):e,s=t.length-1,l;s>=0;s--)(l=t[s])&&(a=(r?l(e,o,a):l(a))||a);return r&&a&&at(e,o,a),a},W=(t,e,o)=>e.has(t)||nt("Cannot "+o),v=(t,e,o)=>(W(t,e,"read from private field"),e.get(t)),q=(t,e,o)=>e.has(t)?nt("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,o),H=(t,e,o,r)=>(W(t,e,"write to private field"),e.set(t,o),o),ce=(t,e,o)=>(W(t,e,"access private method"),o);function x(t,e){const o=S({waitUntilFirstUpdate:!1},e);return(r,a)=>{const{update:s}=r,l=Array.isArray(t)?t:[t];r.update=function(n){l.forEach(h=>{const b=h;if(n.has(b)){const m=n.get(b),$=this[b];m!==$&&(!o.waitUntilFirstUpdate||this.hasUpdated)&&this[a](m,$)}}),s.call(this,n)}}}var E=p`
  :host {
...
`,M,y=class extends vt{constructor(){super(),q(this,M,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([t,e])=>{this.constructor.define(t,e)})}emit(t,e){const o=new CustomEvent(t,S({bubbles:!0,cancelable:!1,composed:!0,detail:{}},e));return this.dispatchEvent(o),o}static define(t,e=this,o={}){const r=customElements.get(t);if(!r){try{customElements.define(t,e,o)}catch{customElements.define(t,class extends e{},o)}return}let a=" (unknown version)",s=a;"version"in e&&e.version&&(a=" v"+e.version),"version"in r&&r.version&&(s=" v"+r.version),!(a&&s&&a===s)&&console.warn(`Attempted to register <${t}>${a}, but <${t}>${s} has already been registered.`)}attributeChangedCallback(t,e,o){v(this,M)||(this.constructor.elementProperties.forEach((r,a)=>{r.reflect&&this[a]!=null&&this.initialReflectedProperties.set(a,this[a])}),H(this,M,!0)),super.attributeChangedCallback(t,e,o)}willUpdate(t){super.willUpdate(t),this.initialReflectedProperties.forEach((e,o)=>{t.has(o)&&this[o]==null&&(this[o]=e)})}};M=new WeakMap;y.version="3.12.0";y.dependencies={};i([c()],y.prototype,"dir",2);i([c()],y.prototype,"lang",2);var St=p`
	/* stylelint-disable */
  :host {
...
`,P=class extends y{constructor(){super(...arguments),this.observedElements=[],this.disabled=!1}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(t=>{this.emit("syn-resize",{detail:{entries:t}})}),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}handleSlotChange(){this.disabled||this.startObserver()}startObserver(){const t=this.shadowRoot.querySelector("slot");if(t!==null){const e=t.assignedElements({flatten:!0});this.observedElements.forEach(o=>this.resizeObserver.unobserve(o)),this.observedElements=[],e.forEach(o=>{this.resizeObserver.observe(o),this.observedElements.push(o)})}}stopObserver(){this.resizeObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}render(){return _` <slot @slotchange=${this.handleSlotChange}></slot> `}};P.styles=[E,Nt];i([c({type:Boolean,reflect:!0})],P.prototype,"disabled",2);i([x("disabled",{waitUntilFirstUpdate:!0})],P.prototype,"handleDisabledChange",1);function Vt(t,e){return{top:Math.round(t.getBoundingClientRect().top-e.getBoundingClientRect().top),left:Math.round(t.getBoundingClientRect().left-e.getBoundingClientRect().left)}}function et(t,e,o="vertical",r="smooth"){const a=Vt(t,e),s=a.top+e.scrollTop,l=a.left+e.scrollLeft,n=e.scrollLeft,h=e.scrollLeft+e.offsetWidth,b=e.scrollTop,m=e.scrollTop+e.offsetHeight;(o==="horizontal"||o==="both")&&(l<n?e.scrollTo({left:l,behavior:r}):l+t.clientWidth>h&&e.scrollTo({left:l-e.offsetWidth+t.clientWidth,behavior:r})),(o==="vertical"||o==="both")&&(s<b?e.scrollTo({top:s,behavior:r}):s+t.clientHeight>m&&e.scrollTo({top:s-e.offsetHeight+t.clientHeight,behavior:r}))}var Wt=p`
  .icon-button {
    border-radius: 0;
    color: currentColor;
    font-size: inherit;
...
`,u=class extends y{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.size="inherit",this.color="currentColor",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleClick(t){this.disabled&&(t.preventDefault(),t.stopPropagation())}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}render(){const t=!!this.href,e=t?j`a`:j`button`;return ft`
    ...
    `}};d.styles=[E,Ht,Ft];d.dependencies={"syn-icon-button":u,"syn-resize-observer":P};i([rt({slot:"nav",selector:"syn-tab"})],d.prototype,"tabs",2);i([rt({selector:"syn-tab-panel"})],d.prototype,"panels",2);i([B(".tab-group")],d.prototype,"tabGroup",2);i([B(".tab-group__body")],d.prototype,"body",2);i([B(".tab-group__nav")],d.prototype,"nav",2);i([B(".tab-group__indicator")],d.prototype,"indicator",2);i([A()],d.prototype,"hasScrollControls",2);i([A()],d.prototype,"shouldHideScrollStartButton",2);i([A()],d.prototype,"shouldHideScrollEndButton",2);i([c()],d.prototype,"placement",2);i([c()],d.prototype,"activation",2);i([c({attribute:"no-scroll-controls",type:Boolean})],d.prototype,"noScrollControls",2);i([c({type:Boolean})],d.prototype,"contained",2);i([c({type:Boolean})],d.prototype,"sharp",2);i([c({attribute:"fixed-scroll-controls",type:Boolean})],d.prototype,"fixedScrollControls",2);i([yt({passive:!0})],d.prototype,"updateScrollButtons",1);i([x("noScrollControls",{waitUntilFirstUpdate:!0})],d.prototype,"updateScrollControls",1);i([x("placement",{waitUntilFirstUpdate:!0})],d.prototype,"syncIndicator",1);d.define("syn-tab-group");var jt=p`
  :host {
...
`,Kt=0,g=class extends y{constructor(){super(...arguments),this.localize=new ht(this),this.attrId=++Kt,this.componentId=`syn-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}handleCloseClick(t){t.stopPropagation(),this.emit("syn-close")}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false"),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,_`
    ...
    `}};g.styles=[E,Yt,jt];g.dependencies={"syn-icon-button":u};i([B(".tab")],g.prototype,"tab",2);i([c({reflect:!0})],g.prototype,"panel",2);i([c({type:Boolean,reflect:!0})],g.prototype,"active",2);i([c({type:Boolean,reflect:!0})],g.prototype,"closable",2);i([c({type:Boolean,reflect:!0})],g.prototype,"disabled",2);i([c({type:Number,reflect:!0})],g.prototype,"tabIndex",2);i([x("active")],g.prototype,"handleActiveChange",1);i([x("disabled")],g.prototype,"handleDisabledChange",1);g.define("syn-tab");var Xt=p`
  /* Write custom CSS here */
  .tab-panel {
    color: var(--syn-typography-color-text);
  }
...
`,Jt=0,L=class extends y{constructor(){super(...arguments),this.attrId=++Jt,this.componentId=`syn-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return _`
      ...
      ></slot>
    `}};L.styles=[E,Qt,Xt];i([c({reflect:!0})],L.prototype,"name",2);i([c({type:Boolean,reflect:!0})],L.prototype,"active",2);i([x("active")],L.prototype,"handleActiveChange",1);L.define("syn-tab-panel");export{ht as L,y as S,le as _,S as a,i as b,E as c,ne as d,w as e,Dt as f,q as g,H as h,de as i,v as j,ce as k,bt as m,Mt as n,x as w};
