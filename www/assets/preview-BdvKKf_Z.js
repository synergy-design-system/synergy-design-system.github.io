import"./index-B3ehnkiM.js";import{i as u,x as m,u as Ti,w as Zt,T as ce}from"./lit-element-DILkAbkc.js";import{a as k,c as C,w as g,n as a,b as O,S as gt}from"./icon.component-BTqLLuW4.js";import{b as So,a as x,c as Ge,t as Ct,S as ue,d as y,o as _,s as Se,n as X,e as De}from"./icon-button-B715Afvu.js";import{f as qi,m as Oo}from"./directive-helpers-DbZfDV3x.js";import"./icon-C05bciLq.js";/**
 * @license
...
`;var Ws=Object.defineProperty,qs=Object.getOwnPropertyDescriptor,oe=(i,t,e,s)=>{for(var o=s>1?void 0:s?qs(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(o=(s?r(t,e,o):r(o))||o);return s&&o&&Ws(t,e,o),o};class Ht extends k{constructor(){super(...arguments),this.hasSlotController=new G(this,"footer"),this.localize=new j(this),this.modal=new uo(this),this.open=!1,this.label="",this.noHeader=!1,this.handleDocumentKeyDown=t=>{t.key==="Escape"&&this.modal.isActive()&&this.open&&(t.stopPropagation(),this.requestClose("keyboard"))}}static{this.styles=[C,js,Hs]}static{this.dependencies={"syn-icon-button":ue}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),Ae(this))}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate(),le(this),this.closeWatcher?.destroy()}requestClose(t){if(this.emit("syn-request-close",{cancelable:!0,detail:{source:t}}).defaultPrevented){const s=V(this,"dialog.denyClose",{dir:this.localize.dir()});q(this.panel,s.keyframes,s.options);return}this.hide()}addOpenListeners(){"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard")):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){this.closeWatcher?.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),Ae(this);const t=this.querySelector("[autofocus]");t&&t.removeAttribute("autofocus"),await Promise.all([K(this.dialog),K(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit("syn-initial-focus",{cancelable:!0}).defaultPrevented||(t?t.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),t&&t.setAttribute("autofocus","")});const e=V(this,"dialog.show",{dir:this.localize.dir()}),s=V(this,"dialog.overlay.show",{dir:this.localize.dir()});await Promise.all([q(this.panel,e.keyframes,e.options),q(this.overlay,s.keyframes,s.options)]),this.emit("syn-after-show")}else{this.emit("syn-hide"),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([K(this.dialog),K(this.overlay)]);const t=V(this,"dialog.hide",{dir:this.localize.dir()}),e=V(this,"dialog.overlay.hide",{dir:this.localize.dir()});await Promise.all([q(this.overlay,e.keyframes,e.options).then(()=>{this.overlay.hidden=!0}),q(this.panel,t.keyframes,t.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,le(this);const s=this.originalTrigger;typeof s?.focus=="function"&&setTimeout(()=>s.focus()),this.emit("syn-after-hide")}}async show(){if(!this.open)return this.open=!0,Y(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,Y(this,"syn-after-hide")}render(){return m`
      <div
        part="base"
...
`;var Js=Object.defineProperty,tn=Object.getOwnPropertyDescriptor,St=(i,t,e,s)=>{for(var o=s>1?void 0:s?tn(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(o=(s?r(t,e,o):r(o))||o);return s&&o&&Js(t,e,o),o};class yt extends k{constructor(){super(...arguments),this.hasSlotController=new G(this,"footer"),this.localize=new j(this),this.modal=new uo(this),this.open=!1,this.label="",this.placement="end",this.contained=!1,this.noHeader=!1,this.handleDocumentKeyDown=t=>{this.contained||t.key==="Escape"&&this.modal.isActive()&&this.open&&(t.stopImmediatePropagation(),this.requestClose("keyboard"))}}static{this.styles=[C,Zs,Qs]}static{this.dependencies={"syn-icon-button":ue}}firstUpdated(){this.drawer.hidden=!this.open,this.open&&(this.addOpenListeners(),this.contained||(this.modal.activate(),Ae(this)))}disconnectedCallback(){super.disconnectedCallback(),le(this),this.closeWatcher?.destroy()}requestClose(t){if(this.emit("syn-request-close",{cancelable:!0,detail:{source:t}}).defaultPrevented){const s=V(this,"drawer.denyClose",{dir:this.localize.dir()});q(this.panel,s.keyframes,s.options);return}this.hide()}addOpenListeners(){"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.contained||(this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard"))):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){document.removeEventListener("keydown",this.handleDocumentKeyDown),this.closeWatcher?.destroy()}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.contained||(this.modal.activate(),Ae(this));const t=this.querySelector("[autofocus]");t&&t.removeAttribute("autofocus"),await Promise.all([K(this.drawer),K(this.overlay)]),this.drawer.hidden=!1,requestAnimationFrame(()=>{this.emit("syn-initial-focus",{cancelable:!0}).defaultPrevented||(t?t.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),t&&t.setAttribute("autofocus","")});const e=V(this,`drawer.show${Fi(this.placement)}`,{dir:this.localize.dir()}),s=V(this,"drawer.overlay.show",{dir:this.localize.dir()});await Promise.all([q(this.panel,e.keyframes,e.options),q(this.overlay,s.keyframes,s.options)]),this.emit("syn-after-show")}else{this.emit("syn-hide"),this.removeOpenListeners(),this.contained||(this.modal.deactivate(),le(this)),await Promise.all([K(this.drawer),K(this.overlay)]);const t=V(this,`drawer.hide${Fi(this.placement)}`,{dir:this.localize.dir()}),e=V(this,"drawer.overlay.hide",{dir:this.localize.dir()});await Promise.all([q(this.overlay,e.keyframes,e.options).then(()=>{this.overlay.hidden=!0}),q(this.panel,t.keyframes,t.options).then(()=>{this.panel.hidden=!0})]),this.drawer.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1;const s=this.originalTrigger;typeof s?.focus=="function"&&setTimeout(()=>s.focus()),this.emit("syn-after-hide")}}handleNoModalChange(){this.open&&!this.contained&&(this.modal.activate(),Ae(this)),this.open&&this.contained&&(this.modal.deactivate(),le(this))}async show(){if(!this.open)return this.open=!0,Y(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,Y(this,"syn-after-hide")}render(){return m`
      <div
        part="base"
...
`;var Nn=Object.defineProperty,N=(i,t,e,s)=>{for(var o=void 0,n=i.length-1,r;n>=0;n--)(r=i[n])&&(o=r(t,e,o)||o);return o&&Nn(t,e,o),o};function Un(i){return i!==null&&typeof i=="object"&&"getBoundingClientRect"in i&&("contextElement"in i?i instanceof Element:!0)}class P extends k{constructor(){super(...arguments),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){const t=this.anchorEl.getBoundingClientRect(),e=this.popup.getBoundingClientRect(),s=this.placement.includes("top")||this.placement.includes("bottom");let o=0,n=0,r=0,l=0,d=0,c=0,h=0,p=0;s?t.top<e.top?(o=t.left,n=t.bottom,r=t.right,l=t.bottom,d=e.left,c=e.top,h=e.right,p=e.top):(o=e.left,n=e.bottom,r=e.right,l=e.bottom,d=t.left,c=t.top,h=t.right,p=t.top):t.left<e.left?(o=t.right,n=t.top,r=e.left,l=e.top,d=t.right,c=t.bottom,h=e.left,p=e.bottom):(o=e.right,n=e.top,r=t.left,l=t.top,d=e.right,c=e.bottom,h=t.left,p=t.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${o}px`),this.style.setProperty("--hover-bridge-top-left-y",`${n}px`),this.style.setProperty("--hover-bridge-top-right-x",`${r}px`),this.style.setProperty("--hover-bridge-top-right-y",`${l}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${d}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${c}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${h}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${p}px`)}}}static{this.styles=[C,Vn]}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(t){super.updated(t),t.has("active")&&(this.active?this.start():this.stop()),t.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){const t=this.getRootNode();this.anchorEl=t.getElementById(this.anchor)}else this.anchor instanceof Element||Un(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.start()}start(){this.anchorEl&&(this.cleanup=Pn(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(t=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>t())):t()})}reposition(){if(!this.active||!this.anchorEl)return;const t=[pn({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?t.push(Ui({apply:({rects:s})=>{const o=this.sync==="width"||this.sync==="both",n=this.sync==="height"||this.sync==="both";this.popup.style.width=o?`${s.reference.width}px`:"",this.popup.style.height=n?`${s.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&t.push(In({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&t.push(Ln({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?t.push(Ui({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:s,availableHeight:o})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${o}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${s}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&t.push(Mn({element:this.arrowEl,padding:this.arrowPadding}));const e=this.strategy==="absolute"?s=>je.getOffsetParent(s,Rn):je.getOffsetParent;Fn(this.anchorEl,this.popup,{placement:this.placement,middleware:t,strategy:this.strategy,platform:{...je,getOffsetParent:e}}).then(({x:s,y:o,middlewareData:n,placement:r})=>{const l=getComputedStyle(this).direction==="rtl",d={top:"bottom",right:"left",bottom:"top",left:"right"}[r.split("-")[0]];if(this.setAttribute("data-current-placement",r),Object.assign(this.popup.style,{left:`${s}px`,top:`${o}px`}),this.arrow){const c=n.arrow.x,h=n.arrow.y;let p="",b="",f="",v="";if(this.arrowPlacement==="start"){const w=typeof c=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";p=typeof h=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",b=l?w:"",v=l?"":w}else if(this.arrowPlacement==="end"){const w=typeof c=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";b=l?"":w,v=l?w:"",f=typeof h=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else this.arrowPlacement==="center"?(v=typeof c=="number"?"calc(50% - var(--arrow-size-diagonal))":"",p=typeof h=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(v=typeof c=="number"?`${c}px`:"",p=typeof h=="number"?`${h}px`:"");Object.assign(this.arrowEl.style,{top:p,right:b,bottom:f,left:v,[d]:"calc(var(--arrow-size-diagonal) * -1)"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("syn-reposition")}render(){return m`
    ...
    `}}N([y(".popup")],P.prototype,"popup");N([y(".popup__arrow")],P.prototype,"arrowEl");N([a()],P.prototype,"anchor");N([a({type:Boolean,reflect:!0})],P.prototype,"active");N([a({reflect:!0})],P.prototype,"placement");N([a({reflect:!0})],P.prototype,"strategy");N([a({type:Number})],P.prototype,"distance");N([a({type:Number})],P.prototype,"skidding");N([a({type:Boolean})],P.prototype,"arrow");N([a({attribute:"arrow-placement"})],P.prototype,"arrowPlacement");N([a({attribute:"arrow-padding",type:Number})],P.prototype,"arrowPadding");N([a({type:Boolean})],P.prototype,"flip");N([a({attribute:"flip-fallback-placements",converter:{fromAttribute:i=>i.split(" ").map(t=>t.trim()).filter(t=>t!==""),toAttribute:i=>i.join(" ")}})],P.prototype,"flipFallbackPlacements");N([a({attribute:"flip-fallback-strategy"})],P.prototype,"flipFallbackStrategy");N([a({type:Object})],P.prototype,"flipBoundary");N([a({attribute:"flip-padding",type:Number})],P.prototype,"flipPadding");N([a({type:Boolean})],P.prototype,"shift");N([a({type:Object})],P.prototype,"shiftBoundary");N([a({attribute:"shift-padding",type:Number})],P.prototype,"shiftPadding");N([a({attribute:"auto-size"})],P.prototype,"autoSize");N([a()],P.prototype,"sync");N([a({type:Object})],P.prototype,"autoSizeBoundary");N([a({attribute:"auto-size-padding",type:Number})],P.prototype,"autoSizePadding");N([a({attribute:"hover-bridge",type:Boolean})],P.prototype,"hoverBridge");const jn=u`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
`;var Aa=Object.defineProperty,Ea=Object.getOwnPropertyDescriptor,at=(i,t,e,s)=>{for(var o=s>1?void 0:s?Ea(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(o=(s?r(t,e,o):r(o))||o);return s&&o&&Aa(t,e,o),o};class ot extends k{constructor(){super(),this.localize=new j(this),this.content="",this.placement="top",this.disabled=!1,this.distance=13,this.open=!1,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleBlur=()=>{this.hasTrigger("focus")&&this.hide()},this.handleClick=()=>{this.hasTrigger("click")&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger("focus")&&this.show()},this.handleDocumentKeyDown=t=>{t.key==="Escape"&&(t.stopPropagation(),this.hide())},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){const t=Pi(getComputedStyle(this).getPropertyValue("--show-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.show(),t)}},this.handleMouseOut=()=>{if(this.hasTrigger("hover")){const t=Pi(getComputedStyle(this).getPropertyValue("--hide-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.hide(),t)}},this.addEventListener("blur",this.handleBlur,!0),this.addEventListener("focus",this.handleFocus,!0),this.addEventListener("click",this.handleClick),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}static{this.styles=[C,Sa,Oa]}static{this.dependencies={"syn-popup":P}}disconnectedCallback(){this.closeWatcher?.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(t){return this.trigger.split(" ").includes(t)}async handleOpenChange(){if(this.open){if(this.disabled)return;this.emit("syn-show"),"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide()}):document.addEventListener("keydown",this.handleDocumentKeyDown),await K(this.body),this.body.hidden=!1,this.popup.active=!0;const{keyframes:t,options:e}=V(this,"tooltip.show",{dir:this.localize.dir()});await q(this.popup.popup,t,e),this.popup.reposition(),this.emit("syn-after-show")}else{this.emit("syn-hide"),this.closeWatcher?.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown),await K(this.body);const{keyframes:t,options:e}=V(this,"tooltip.hide",{dir:this.localize.dir()});await q(this.popup.popup,t,e),this.popup.active=!1,this.body.hidden=!0,this.emit("syn-after-hide")}}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,Y(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,Y(this,"syn-after-hide")}render(){return m`
      <syn-popup
        part="base"
        exportparts="
          popup:base__popup,
