import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{d as r,f as i,g as a,u as o}from"./iframe-BCoUYk3Z.js";import{t as s}from"./button-DrTiiP_n.js";import{t as c}from"./icon-DIIsNVY-.js";import{a as l,i as u,n as d,o as f,r as p,t as m}from"./component-CzEJor_j.js";import{n as h,t as g}from"./taggedTemplateLiteral-pWa2IaV6.js";import{n as _,t as v}from"./PaddingDecorator-DYDZS_5f.js";import{t as y}from"./option-2oik-IC2.js";import{t as b}from"./optgroup-Q5n-HdUT.js";import{t as x}from"./select-C5TTEk2D.js";import{n as S,t as C}from"./select-CdKfjU3U.js";var w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=e((()=>{x(),y(),b(),c(),s(),n(),C(),p(),r(),v(),a(),h(),{userEvent:w}=__STORYBOOK_MODULE_TEST__,{args:O,argTypes:k}=u(`syn-select`),{overrideArgs:A}=l(`syn-select`),{generateTemplate:j}=f(`syn-select`),M={args:O,argTypes:k,component:`syn-select`,parameters:{chromatic:{modes:i},design:o(`41325-310740`),docs:{description:{component:d(`select`,`default`)},story:{height:`250px`}}},tags:[`Form`],title:`Components/syn-select`},N={parameters:{args:A({name:`default`,type:`slot`,value:`
