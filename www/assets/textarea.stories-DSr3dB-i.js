import{s as f,a as S,g as w,b as e,c as v}from"./component-BkLxdTGW.js";import{k as r}from"./directive-helpers-CDT6qhDs.js";import{u as T}from"./index-CpPNtevm.js";import"./index-BpTwKCb_.js";import"./icon.component-BGOBP71j.js";import"./chunk-L4EGOTBX-C9C4DwME.js";import"./entry-preview-D9TbQDUR.js";import"./index-DrFu-skq.js";import"./index-B-o1Wr-g.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon-Cns_YRtn.js";const{args:k,argTypes:z}=f("syn-textarea"),{generateTemplate:D}=S("syn-textarea"),A={args:k,argTypes:z,parameters:{design:w("1101-1576"),docs:{description:{component:e("textarea","default")}}},title:"Components/syn-textarea"},s={parameters:{controls:{disable:!1},docs:{description:{story:e("textarea","default")}}},render:a=>D({args:a})},o={parameters:{docs:{description:{story:e("textarea","labels")}}},render:()=>r`<syn-textarea label="Comments"></syn-textarea>`},n={parameters:{docs:{description:{story:e("textarea","help-text")}}},render:()=>r`<syn-textarea label="Feedback" help-text="Please tell us what you think."> </syn-textarea>`},c={parameters:{docs:{description:{story:e("textarea","rows")}}},render:()=>r`
  ...
  `},y={parameters:{docs:{description:{story:e("textarea","resize")}}},render:()=>r`<syn-textarea resize="none"></syn-textarea>`},m={parameters:{docs:{description:{story:e("textarea","resize-auto")}}},render:()=>r`<syn-textarea resize="auto" placeholder="Type something"></syn-textarea>`},h=v({Default:s,Labels:o,HelpText:n,Rows:c,Placeholders:l,ReadonlyTextareas:i,Disabled:d,Sizes:p,PreventResizing:y,ExpandWithContent:m},500);s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  PreventResizing,
  ExpandWithContent
}, 500)`,...h.parameters?.docs?.source}}};const I=["Default","Labels","HelpText","Rows","Placeholders","ReadonlyTextareas","Focus","Disabled","Sizes","Invalid","PreventResizing","ExpandWithContent","Screenshot"];export{s as Default,d as Disabled,m as ExpandWithContent,x as Focus,n as HelpText,u as Invalid,o as Labels,l as Placeholders,y as PreventResizing,i as ReadonlyTextareas,c as Rows,h as Screenshot,p as Sizes,I as __namedExportsOrder,A as default};
