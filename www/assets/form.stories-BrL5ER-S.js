import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{c as n,t as r}from"./lit-BVDl_-fF.js";import{U as i,_ as a,d as o,f as s,n as c,p as l,t as u}from"./iframe-BiSXA87W.js";import{d,f,i as p,p as m,u as h}from"./blocks-CBurUJA_.js";import{t as g}from"./button-6RBRhEco.js";import{t as _}from"./divider-Cc855Qe0.js";import{t as v}from"./select-ghDhf1Uh.js";import{t as y}from"./option-D8fwbCp_.js";import{n as b,r as x}from"./component-BZMStFjM.js";import{n as S,t as C}from"./taggedTemplateLiteral-pWa2IaV6.js";import{t as w}from"./icon-button-CUYd-ZqV.js";import{t as T}from"./checkbox-group-DV4M-sub.js";import{t as E}from"./checkbox-J-wTQ_FX.js";import{t as D}from"./combobox-6GA_eS0z.js";import{t as O}from"./input-B88dl7oc.js";import{t as k}from"./fieldset-DyZwKFFQ.js";import{t as A}from"./file-DuukaPtr.js";import{t as j}from"./textarea-CgLJx41C.js";import{t as M}from"./spinner-CXHBF6WE.js";import{n as N,t as P}from"./translations-C4Vy0kAa.js";var F,I,L,R,z,B,V,H;e((()=>{F=t(i(),1),m(),r(),u(),x(),N(),s(),a(),E(),T(),k(),j(),O(),v(),y(),D(),g(),w(),M(),A(),_(),S(),R={parameters:{chromatic:{...c?.parameters?.chromatic,disableSnapshot:!1,modes:l},design:o(`16648-52486`),docs:{description:{component:b(`contact-form`,`default`,`templates`)},page:()=>F.createElement(F.Fragment,null,F.createElement(f,null),F.createElement(d,null),F.createElement(p,null),F.createElement(h,{title:``})),story:{iframeHeight:1600,inline:!0}}},tags:[`Form`],title:`Templates/Forms`},z={render:()=>n(I||=C([`
    <style>
    .synergy-form-demo {
    ...
    <\/script>
  `]),P(`contactForm.headline`),P(`contactForm.subHeadline`),P(`contactForm.topicLabel`),P(`contactForm.topics`).map((e,t)=>n`
              <syn-checkbox name="topic[${t}]" value="${e}">
                ${e}
              </syn-checkbox>
            `),P(`contactForm.requestContent`),P(`contactForm.requestLabel`),P(`contactForm.messageLabel`),P(`contactForm.contactDetailsLabel`),P(`contactForm.customerNumberLabel`),P(`contactForm.companyNameLabel`),P(`contactForm.addressLabel`),P(`contactForm.zipLabel`),P(`contactForm.cityLabel`),P(`contactForm.countryLabel`),P(`contactForm.countries`).map((e,t)=>n`
              <syn-option value=${t}>${e}</syn-option>
            `),P(`contactForm.referenceContactLabel`),P(`contactForm.phoneLabel`),P(`contactForm.faxLabel`),P(`contactForm.emailLabel`),P(`contactForm.newsletterLabel`),P(`contactForm.submitLabel`),P(`contactForm.requiredFieldInfo`),P(`contactForm.requiredFieldLink`),P(`contactForm.requiredFieldEnd`),P(`contactForm.topicsErrorMessage`))},B={...z,globals:{viewport:{value:`mobile2`}},name:`↳ Tablet`,parameters:{controls:{exclude:[`default`]},docs:{disable:!0}}},V={render:(e,t)=>n(L||=C([`
