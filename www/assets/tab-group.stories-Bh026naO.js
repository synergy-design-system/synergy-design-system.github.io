import{i as e}from"./preload-helper-xPQekRTU.js";import{D as t,Ht as n,It as r,T as i,d as a,f as o,g as s,u as c}from"./iframe-BjJCO_Oc.js";import{i as l,n as u}from"./dist-B5ofSKxt.js";import{t as d}from"./icon-BS9OsfYG.js";import{a as f,i as p,n as m,o as h,r as g,t as _}from"./component-Bp0Gg8Fw.js";import{n as v,t as y}from"./taggedTemplateLiteral-pWa2IaV6.js";import{n as b,t as x}from"./tab-panel-La6JB2Kz.js";import{t as S}from"./tab-C1B_G4iK.js";var C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y=e((()=>{b(),S(),x(),d(),r(),u(),i(),g(),a(),s(),v(),{args:w,argTypes:T}=p(`syn-tab-group`),{overrideArgs:E}=f(`syn-tab-group`),{generateTemplate:D}=h(`syn-tab-group`),O=(e,t,{active:n=!1,closable:r=!1,disabled:i=!1}={})=>`<syn-tab slot="nav" panel="${e}" ${n?`active`:``} ${i?`disabled`:``} ${r?`closable`:``}>${t}</syn-tab>`,k=(e,n,{active:r=!1,closable:i=!1,disabled:a=!1}={})=>t(O(e,n,{active:r,closable:i,disabled:a})),A=()=>[{panel:`general`,props:{active:!0}},{panel:`custom`},{panel:`advanced`},{panel:`disabled`,props:{disabled:!0}}].map(({panel:e,props:t})=>O(e,l(e),t)).join(`
...
`,L=()=>t(P()),R={args:E([{name:`default`,type:`slot`,value:P()},{name:`nav`,type:`slot`,value:A()}],w),argTypes:T,component:`syn-tab-group`,parameters:{chromatic:{modes:o},design:c(`42207-338578`),docs:{description:{component:m(`tab-group`,`default`)}}},tags:[`Navigation`],title:`Components/syn-tab-group`},z={parameters:{docs:{description:{story:m(`tab-group`,`default`)}}},render:e=>D({args:e})},B={parameters:{docs:{description:{story:m(`tab-group`,`start`)}}},render:()=>n`
  <syn-tab-group placement="start">
    ${j()}
    ${L()}
  </syn-tab-group>
  `},V={parameters:{docs:{description:{story:m(`tab-group`,`end`)}}},render:()=>n`
  <syn-tab-group placement="end">
    ${j()}
    ${L()}
  </syn-tab-group>
`},H={parameters:{docs:{description:{story:m(`tab-group`,`closable`)}}},render:()=>n(C||=y([`
  ...
  `},W={parameters:{docs:{description:{story:m(`tab-group`,`hierachy`)}}},render:()=>n`
  ...
  `},G={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:m(`tab-group`,`manuel`)}}},play:({canvasElement:e})=>{e.querySelector(`syn-tab[panel="general"]`)?.focus()},render:()=>n` 
    <syn-tab-group activation="manual">
      ${j()}
      ${L()}
    </syn-tab-group>
  `},K={parameters:{docs:{description:{story:m(`tab-group`,`icon`)}}},render:()=>n`
  <syn-tab-group>
