import{n as e}from"./chunk-DnJy8xQt.js";import{E as t,Nt as n,Rt as r,T as i,d as a,f as o,g as s,u as c}from"./iframe-rzuzvTqw.js";import{t as l}from"./button-r_Sen7MB.js";import{t as u}from"./card-CZZ1EqdD.js";import{a as d,i as f,n as p,o as m,r as h,t as g}from"./component-CQhtHSyB.js";import{t as _}from"./icon-button-CG04am_-.js";var v,y,b,x,S,C,w,T,E,D,O,k,A,j,M;e((()=>{n(),i(),u(),l(),_(),h(),a(),s(),{args:v,argTypes:y}=f(`syn-card`),{overrideArgs:b}=d(`syn-card`),{generateTemplate:x}=m(`syn-card`),S=({buttonText:e=`More info`,footerText:t=`Optional information`}={})=>`
  <footer slot="footer">
    <small>${t}</small>
    <nav>
