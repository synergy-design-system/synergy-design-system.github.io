import{l as j,x as s,g as q}from"./iframe-T704dET3.js";import{n as b}from"./property-Cf1mp-f_.js";import{o as D}from"./query-assigned-elements-QtOlz7Yz.js";import{e as L}from"./class-map-CNu6dbco.js";import{c as E,S as z}from"./component.styles-Bg22BIIN.js";import{w as x}from"./watch-CEsCE2EF.js";import{e as C}from"./decorator-DANECR0-.js";import"./details-yAJ3OjF3.js";import{g as r,s as w,a as _,c as O,b as P}from"./component-DGMMYOO4.js";import"./query-DAIS6qJ0.js";import"./functions-CDi3doZH.js";import"./animation-registry-l4L8bmT6.js";import"./localize-CatY2peN.js";import"./index-DihgwUfS.js";import"./event-B0iVuGLD.js";import"./icon.component-kZEKzyAl.js";import"./state-DOV0mQYH.js";import"./index-Bkk0Z6Ex.js";import"./_docs-CrPFe_9C.js";const F=j`
  :host {
    display: block;
  }
...
`;var T=Object.defineProperty,$=Object.getOwnPropertyDescriptor,n=(e,o,g,u)=>{for(var t=u>1?void 0:u?$(o,g):o,v=e.length-1,h;v>=0;v--)(h=e[v])&&(t=(u?h(o,g,t):h(t))||t);return u&&t&&T(o,g,t),t};let a=class extends z{constructor(){super(...arguments),this.closeOthers=!1,this.contained=!1,this.size="medium",this.handleAccordionShow=e=>{this.closeOthers&&this.detailsInDefaultSlot.forEach(o=>{o!==e.target&&o.parentNode===e.target.parentNode&&o.removeAttribute("open")})}}adjustDetailsSize(){this.detailsInDefaultSlot.forEach(e=>{e.setAttribute("size",this.size)})}adjustDetailsContained(){this.detailsInDefaultSlot.forEach(e=>{e.contained=this.contained})}handleSizeChange(){this.adjustDetailsSize()}handleContainedChange(){this.adjustDetailsContained()}connectedCallback(){super.connectedCallback(),this.addEventListener("syn-show",this.handleAccordionShow)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("syn-show",this.handleAccordionShow)}handleSlotChange(){this.adjustDetailsSize(),this.adjustDetailsContained()}render(){return s`
  ...
  Sizes
}, 1150)`,...p.parameters?.docs?.source}}};const me=["Default","Contained","GroupingDetails","Focus","Disabled","Sizes","Screenshot"];export{l as Contained,i as Default,m as Disabled,y as Focus,d as GroupingDetails,p as Screenshot,c as Sizes,me as __namedExportsOrder,de as default};
