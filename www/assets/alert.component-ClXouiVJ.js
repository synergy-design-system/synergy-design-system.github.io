import{s as v,a as h,g as m,b as u}from"./animation-registry-l4L8bmT6.js";import{b as w}from"./closeActiveElement-Bnbpk8Kw.js";import{e as p}from"./class-map-BSUKdjAi.js";import{H as _}from"./slot-9EVoRGQc.js";import{q as y,x as d}from"./iframe-3rQ6MjmB.js";import{L as z}from"./localize-Dh03wnLC.js";import{c as k,n as o,S as x}from"./synergy-element-CpGm7QZ8.js";import{r as T}from"./icon.component-BX6zfRdv.js";import{a as b}from"./query-D0jTsbLw.js";import{w as g}from"./event-B0iVuGLD.js";import{w as f}from"./watch-CEsCE2EF.js";import{S}from"./icon-button.component-CaDA6T58.js";import{e as C}from"./decorator-CVE5vLu9.js";const A=y`
	/* stylelint-disable */
  :host {
    display: contents;
...
`;var H=Object.defineProperty,$=Object.getOwnPropertyDescriptor,t=(a,r,n,s)=>{for(var i=s>1?void 0:s?$(r,n):r,l=a.length-1,c;l>=0;l--)(c=a[l])&&(i=(s?c(r,n,i):c(i))||i);return s&&i&&H(r,n,i),i};let e=class extends x{constructor(){super(...arguments),this.hasSlotController=new _(this,"icon","suffix"),this.localize=new z(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.size="medium",this.remainingTime=this.duration}static get toastStack(){return this.currentToastStack||(this.currentToastStack=Object.assign(document.createElement("div"),{className:"syn-toast-stack"})),this.currentToastStack}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){this.countdownAnimation?.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),this.countdownAnimation?.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){const{countdownElement:a}=this,r="100%",n="0";this.countdownAnimation=a.animate([{width:r},{width:n}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.duration<1/0&&this.restartAutoHide(),await h(this.base),this.base.hidden=!1;const{keyframes:a,options:r}=m(this,"alert.show",{dir:this.localize.dir()});await u(this.base,a,r),this.emit("syn-after-show")}else{w(this),this.emit("syn-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await h(this.base);const{keyframes:a,options:r}=m(this,"alert.hide",{dir:this.localize.dir()});await u(this.base,a,r),this.base.hidden=!0,this.emit("syn-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,g(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,g(this,"syn-after-hide")}async toast(){return new Promise(a=>{this.handleCountdownChange(),e.toastStack.parentElement===null&&document.body.append(e.toastStack),e.toastStack.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("syn-after-hide",()=>{e.toastStack.removeChild(this),a(),e.toastStack.querySelector("syn-alert")===null&&e.toastStack.remove()},{once:!0})})}render(){return d`
    ...
    `}};e.styles=[k,A,I];e.dependencies={"syn-icon-button":S};t([b('[part~="base"]')],e.prototype,"base",2);t([b(".alert__countdown-elapsed")],e.prototype,"countdownElement",2);t([o({type:Boolean,reflect:!0})],e.prototype,"open",2);t([o({type:Boolean,reflect:!0})],e.prototype,"closable",2);t([o({reflect:!0})],e.prototype,"variant",2);t([o({type:Number})],e.prototype,"duration",2);t([o({reflect:!0})],e.prototype,"size",2);t([T()],e.prototype,"remainingTime",2);t([f("open",{waitUntilFirstUpdate:!0})],e.prototype,"handleOpenChange",1);t([f("duration")],e.prototype,"handleDurationChange",1);e=t([C("SynAlert")],e);v("alert.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});v("alert.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});export{e as S};
