import{n as e}from"./chunk-DnJy8xQt.js";import{E as t,Nt as n,Rt as r,T as i,d as a,f as o,g as s,u as c}from"./iframe-CkET12W3.js";import{t as l}from"./button-CpKx43QA.js";import{t as u}from"./icon-EUR_U8gh.js";import{a as d,i as f,n as p,o as m,r as h,t as g}from"./component-B473QWuz.js";import{n as _,t as v}from"./taggedTemplateLiteral-DxWpUJWn.js";import{n as ee,t as te}from"./PaddingDecorator-Ds2TnBCu.js";import{n as ne,r as re,t as ie}from"./combobox-BZ4Pnto0.js";import{t as ae}from"./option-DJQggRO1.js";import{t as oe}from"./optgroup-BzqEaXY7.js";var y,se,ce,le,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=e((()=>{ie(),l(),u(),ae(),oe(),n(),i(),re(),h(),a(),te(),s(),_(),{userEvent:y}=__STORYBOOK_MODULE_TEST__,{args:b,argTypes:x}=f(`syn-combobox`),{overrideArgs:S}=d(`syn-combobox`),{generateTemplate:C}=m(`syn-combobox`),w={args:b,argTypes:x,component:`syn-combobox`,parameters:{chromatic:{modes:o},design:c(`42207-352063`),docs:{description:{component:p(`combobox`,`default`)},story:{height:`250px`}}},tags:[`Form`],title:`Components/syn-combobox`},T=[`Yellow`,`Light Green`,`Grey`,`Green`,`Blue`,`Red`,`Orange`,`Magenta`,`White`,`Purple`,`Pink`,`Black`,`Brown`].sort(),E=e=>`<syn-option value="${e.replaceAll(` `,`_`)}">${e}</syn-option>`,D=e=>t(E(e)),O=()=>T.map(E),k=()=>t(O().join(`
