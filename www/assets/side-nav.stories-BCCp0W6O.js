import{g as S}from"./preview-CSzYYz-W.js";import{x as e}from"./lit-element-ZYWMe1i1.js";import{s as b,a as k,g as n,b as w,c as I}from"./component-BD35Kgrk.js";import{D as q}from"./DisableFocusTrap-CJGYt8GJ.js";import"./index-DH5ua8nC.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon-button-BiF6KxzB.js";import"./icon.component-BAAzxC2d.js";import"./directive-helpers-CkpR4LMI.js";import"./icon-BcesPW-x.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-BhJsmGLR.js";import"./index-E63YMTTM.js";import"./iframe-C-RtZlFJ.js";import"../sb-preview/runtime.js";import"./index-B_J8iUie.js";import"./index-DSk3xmNA.js";import"./index-DrFu-skq.js";var m=Object.freeze,D=Object.defineProperty,a=(c,N)=>m(D(c,"raw",{value:m(N||c.slice())})),y,v,p,u,g,h;const{args:f,argTypes:L}=b("syn-side-nav"),{overrideArgs:x}=I("syn-side-nav"),{generateTemplate:C}=k("syn-side-nav"),U={args:x([],f),argTypes:L,component:"syn-side-nav",parameters:{design:S("12362-10883"),docs:{container:q,description:{component:n("side-nav","default")}}},title:"Components/syn-side-nav"},i={args:x([{name:"open",type:"attribute",value:!0},{name:"default",type:"slot",value:`
  ...
  <\/script>
`])),C({args:c}))},o={parameters:{docs:{description:{story:n("side-nav","rail")}}},render:()=>e(v||(v=a([`
  ...
  `])))},l=w({Default:i,Rail:o,Footer:t,Fixed:s,Shrink:r,Indentation:d},700);i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  args: overrideArgs([{
    name: 'open',
    type: 'attribute',
    value: true
