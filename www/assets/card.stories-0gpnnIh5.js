import{x as c}from"./directive-helpers-Dvm_Ferq.js";import{o as m}from"./ref-B9GS7qLj.js";import{g as e,a as y,s as h,b as g,c as u,d as f}from"./component-KFAx8TEo.js";import"./library-BX4ONXik.js";import"./chunk-L4EGOTBX-Boit2UGA.js";import"./entry-preview-DkJqm5dP.js";import"./index-DrFu-skq.js";import"./icon-button-Bf-NEYFS.js";import"./index-mLaxDseA.js";import"./index-_2TAQcTa.js";import"./_commonjsHelpers-CqkleIqs.js";const{args:x,argTypes:b}=h("syn-card"),{overrideArgs:S}=g("syn-card"),{generateTemplate:v}=u("syn-card"),l=({buttonText:d="More Info",footerText:p="Optional information"}={})=>`
  <footer slot="footer">
    <small>${p}</small>
    <nav>
...
`,W={args:S([{name:"image",type:"slot",value:'<img slot="image" src="https://synergy-design-system.github.io/card-example.jpg" alt="Multiple persons having lunch in SICK Academy" />'},{name:"default",type:"slot",value:`
        <h3>Headline</h3>
  ...
  Images,
  SharpCard
}, 600)`,...i.parameters?.docs?.source}}};const z=["Default","BasicCard","CardWithHeader","CardWithFooter","Images","SharpCard","Screenshot"];export{a as BasicCard,t as CardWithFooter,s as CardWithHeader,r as Default,o as Images,i as Screenshot,n as SharpCard,z as __namedExportsOrder,W as default};
