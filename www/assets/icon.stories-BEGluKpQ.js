import"./icon-BrqnReZV.js";import{x as e}from"./lit-element-ZYWMe1i1.js";import{s as p,a as h,b as g,c as b}from"./component-CzF4s4R4.js";import{r as d}from"./icon.component-D55FUTwa.js";import{d as f}from"./default-icons-C0-H61Dj.js";import"./icon-button-DcbuMwrE.js";import"./preview-BMgyQje8.js";import"./index-DH5ua8nC.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./directive-helpers-CkpR4LMI.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-7bc9rCDE.js";const{args:v,argTypes:w}=p("syn-icon"),{overrideArgs:S}=b("syn-icon"),{generateTemplate:I}=h("syn-icon"),C=`
...
`,G={args:S({name:"name",type:"attribute",value:"wallpaper"},v),argTypes:w,component:"syn-icon",parameters:{docs:{description:{component:C}}},title:"Components/syn-icon"},s={parameters:{controls:{disable:!1}},render:n=>I({args:n})},o={render:()=>e`<div style="color: var(--syn-color-primary-600);">
