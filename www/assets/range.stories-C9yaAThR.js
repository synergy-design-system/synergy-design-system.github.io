import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-C-q7G2lS.js";import{c as i,t as a}from"./lit-DgWh_IaA.js";import{t as o}from"./range-Dz5_t1as.js";import{t as s}from"./button-D57oz1we.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-pvg5noYG.js";import{t as m}from"./taggedTemplateLiteral-BZenJ0bZ.js";import{n as h,t as g}from"./decorators-CHSvczDY.js";import{t as _}from"./input-dBFTEpJ3.js";import{t as v}from"./range-tick-DQYXZZsA.js";var y=t({CustomTrackColors:()=>R,CustomTrackOffset:()=>z,Default:()=>k,Disabled:()=>M,Focus:()=>P,HelpText:()=>j,Invalid:()=>N,Labels:()=>A,MultiThumb:()=>B,MultiThumbWithRestrictedMovement:()=>V,PrefixSuffixText:()=>L,Readonly:()=>F,Screenshot:()=>K,Sizes:()=>I,Ticks:()=>H,TooltipDisabled:()=>W,TooltipFormatter:()=>G,TooltipPlacement:()=>U,__namedExportsOrder:()=>q,default:()=>O}),b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q;function J(){return(J=e((()=>{a(),o(),s(),_(),v(),g(),f(),r(),{userEvent:b}=__STORYBOOK_MODULE_TEST__,{args:w,argTypes:T}=l(`syn-range`),{overrideArgs:E}=c(`syn-range`),{generateTemplate:D}=d(`syn-range`),O={args:E([{name:`value`,type:`attribute`,value:`50`}],w),argTypes:T,component:`syn-range`,parameters:{chromatic:{modes:n},docs:{description:{component:u(`range`,`default`)}}},tags:[`Form`],title:`Components/syn-range`},k={parameters:{controls:{disable:!1},docs:{description:{story:u(`range`,`default`)},story:{height:`80px`}}},render:e=>D({args:e})},A={parameters:{docs:{description:{story:u(`range`,`labels`)}}},render:()=>i`
    <syn-range label="Label" max="100" min="0" value="50"></syn-range>
  `},j={parameters:{docs:{description:{story:u(`range`,`help-text`)}}},render:()=>i`
    <syn-range
      ...
      value="50"
    ></syn-range>
  `},M={parameters:{docs:{description:{story:u(`range`,`disabled`)}}},render:()=>i`
    <syn-range disabled max="100" min="0" value="50"></syn-range>
  `},N={decorators:[h],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`range`,`invalid`)}}},play:async({canvasElement:e})=>{try{let t=e.querySelector(`syn-range`),n=e.querySelector(`syn-button`);t&&n&&(await b.click(n),n.click())}catch(e){console.error(`Error in play function:`,e)}},render:()=>i(x||=m([`
    <syn-range
    ...
    <\/script>
  `]))},P={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`range`,`focus`)},story:{height:`80px`}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-range`);t&&t.focus()},render:()=>i`
    <form>
      <syn-range max="100" min="0" value="50"></syn-range>
    </form>
  `},F={parameters:{docs:{description:{story:u(`range`,`readonly`)}}},render:()=>i`
    <form>
      <syn-range max="100" min="0" value="50" readonly></syn-range>
    </form>
  `},I={parameters:{docs:{description:{story:u(`range`,`size`)}}},render:()=>i`
  ...
  `},L={parameters:{docs:{description:{story:u(`range`,`prefix-suffix`)}}},render:()=>i(S||=m([`
    <syn-range
      help-text="Controls the volume of the current song"
      label="Volume"
      max="100"
    ...
    <\/script>
  `]))},R={parameters:{docs:{description:{story:u(`range`,`custom-track-colors`)},story:{height:`80px`}}},render:()=>i`
    <syn-range
  ...
  `},z={parameters:{docs:{description:{story:u(`range`,`custom-track-offset`)},story:{height:`80px`}}},render:()=>i`
    <syn-range
  ...
  `},B={parameters:{docs:{description:{story:u(`range`,`multi-knob`)},story:{height:`80px`}}},render:()=>i`
    <syn-range max="100" min="0" value="30 70"></syn-range>
  `},V={parameters:{docs:{description:{story:u(`range`,`multi-knob-restrict-movement`)}}},render:()=>i`
    <syn-range
      value="30 70"
      ...
      step="1"
    ></syn-range>
  `},H={parameters:{docs:{description:{story:u(`range-tick`,`default`)}}},render:()=>i`
  <div class="wrapper">
    <syn-range
  ...
  `},U={parameters:{docs:{description:{story:u(`range`,`tooltip-placement`)},story:{height:`80px`}}},render:()=>i`
    <syn-range
      ...
      value="50"
    ></syn-range>
  `},W={parameters:{docs:{description:{story:u(`range`,`tooltip-disabled`)}}},render:()=>i`
    <syn-range
      max="100"
      min="0"
      ...
      value="50"
    ></syn-range>
  `},G={parameters:{docs:{description:{story:u(`range`,`tooltip-formatter`)}}},render:()=>i(C||=m([`
    <syn-range
    ...
    <\/script>
  `]))},K=p({Default:k,Labels:A,HelpText:j,Disabled:M,Readonly:F,Sizes:I,PrefixSuffixText:L,CustomTrackColors:R,CustomTrackOffset:z,MultiThumb:B,Ticks:H,TooltipPlacement:U,TooltipDisabled:W,TooltipFormatter:G},500),k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
