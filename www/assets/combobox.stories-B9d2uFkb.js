import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{_ as n,a as r,h as i,l as a}from"./preview-OBeF1Gx2.js";import{c as o,t as ee}from"./lit-DgWh_IaA.js";import{t as te}from"./button-CNzGQe_l.js";import{t as s}from"./icon-D05i1kS6.js";import{t as c}from"./option-Dz2Ahtuv.js";import{a as l,i as u,n as d,o as f,r as p,t as m}from"./component-CCyurlYc.js";import{t as h}from"./taggedTemplateLiteral-BZenJ0bZ.js";import{n as g,t as _}from"./PaddingDecorator-C4mX2Z0z.js";import{n as v,t as ne}from"./decorators-D33heMX6.js";import{n as re,r as ie,t as ae}from"./combobox-eUsSEbYo.js";import{t as oe}from"./optgroup-Yc-V8T-2.js";var se=t({AsyncOptions:()=>Y,Clearable:()=>F,CustomFilter:()=>X,Default:()=>A,Disabled:()=>I,Focus:()=>P,GroupingQuery:()=>q,HelpText:()=>M,HighlightQuery:()=>K,Invalid:()=>U,Labels:()=>j,Multiple:()=>R,NoResultsFound:()=>V,Placeholder:()=>N,PrefixSuffixTextAndIcons:()=>W,Readonly:()=>L,Restricted:()=>B,Screenshot:()=>Z,SettingInitialValue:()=>z,SimpleSuggests:()=>G,Sizes:()=>H,SuggestionContainerHeight:()=>J,__namedExportsOrder:()=>Q,default:()=>w}),y,ce,le,ue,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q;function $(){return($=e((()=>{ae(),te(),s(),c(),oe(),ee(),i(),ie(),ne(),p(),_(),a(),{userEvent:y}=__STORYBOOK_MODULE_TEST__,{args:b,argTypes:x}=u(`syn-combobox`),{overrideArgs:S}=l(`syn-combobox`),{generateTemplate:C}=f(`syn-combobox`),w={args:b,argTypes:x,component:`syn-combobox`,parameters:{chromatic:{modes:r},docs:{description:{component:d(`combobox`,`default`)},story:{height:`250px`}}},tags:[`Form`],title:`Components/syn-combobox`},T=[`Yellow`,`Light Green`,`Grey`,`Green`,`Blue`,`Red`,`Orange`,`Magenta`,`White`,`Purple`,`Pink`,`Black`,`Brown`].sort(),E=e=>`<syn-option value="${e.replaceAll(` `,`_`)}">${e}</syn-option>`,D=e=>n(E(e)),O=()=>T.map(E),k=()=>n(O().join(`
