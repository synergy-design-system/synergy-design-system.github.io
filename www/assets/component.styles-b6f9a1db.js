 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function U(o){return u({...o,state:!0,attribute:!1})}function x(o,e){const t={waitUntilFirstUpdate:!1,...e};return(n,s)=>{const{update:r}=n,i=Array.isArray(o)?o:[o];n.update=function(a){i.forEach(c=>{const d=c;if(a.has(d)){const p=a.get(d),h=this[d];p!==h&&(!t.waitUntilFirstUpdate||this.hasUpdated)&&this[s](p,h)}}),r.call(this,a)}}}var O=Object.defineProperty,E=Object.getOwnPropertyDescriptor,f=(o,e,t,n)=>{for(var s=n>1?void 0:n?E(e,t):e,r=o.length-1,i;r>=0;r--)(i=o[r])&&(s=(n?i(e,t,s):i(s))||s);return n&&s&&O(e,t,s),s};class l extends w{constructor(){super(),Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}emit(e,t){const n=new CustomEvent(e,{bubbles:!0,cancelable:!1,composed:!0,detail:{},...t});return this.dispatchEvent(n),n}static define(e,t=this,n={}){const s=customElements.get(e);if(!s){customElements.define(e,class extends t{},n);return}let r=" (unknown version)",i=r;"version"in t&&t.version&&(r=" v"+t.version),"version"in s&&s.version&&(i=" v"+s.version),!(r&&i&&r===i)&&console.warn(`Attempted to register <${e}>${r}, but <${e}>${i} has already been registered.`)}}l.version="1.0.0-main.20";l.dependencies={};f([u()],l.prototype,"dir",2);f([u()],l.prototype,"lang",2);const _=y`
	/* stylelint-disable */
  :host {
...
//# sourceMappingURL=component.styles-b6f9a1db.js.map
