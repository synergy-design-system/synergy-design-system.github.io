import{s as o,a as l,g as p,c as b,d as y}from"./component-RI737oBJ.js";import{k as t}from"./directive-helpers-CDT6qhDs.js";import{d as s}from"./index-CoZpYSVj.js";import"./chunk-L4EGOTBX-C9C4DwME.js";import"./entry-preview-D9TbQDUR.js";import"./index-DrFu-skq.js";import"./index-B-o1Wr-g.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon.component-DFI30_Lh.js";import"./icon-Cu1E08m8.js";const{args:c,argTypes:m}=o("syn-tab-panel"),{overrideArgs:i}=y("syn-tab-panel"),{generateTemplate:d}=l("syn-tab-panel"),n=()=>t`<main class="synergy-replace">Replace this slot</main>`,I={args:i([{name:"default",type:"slot",value:n().strings.join(`
`)},{name:"name",type:"attribute",value:"tab1"}],c),argTypes:m,component:"syn-tab-panel",parameters:{design:p("18086-44682"),docs:{description:{component:s.components["tab-panel"].description.value}}},title:"Components/syn-tab-panel"},a={parameters:{docs:{description:{story:s.components["tab-panel"].description.value}}},render:r=>t`
  ...
  Default
}, 200)`,...e.parameters?.docs?.source}}};const $=["Default","Screenshot"];export{a as Default,e as Screenshot,$ as __namedExportsOrder,I as default};
