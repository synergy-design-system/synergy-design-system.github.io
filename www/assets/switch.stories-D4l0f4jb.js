import{g as e,a as p,s as h,b as u,c as w,d as S}from"./component-D9Cr7x-I.js";import{x as a}from"./directive-helpers-Dvm_Ferq.js";import{u as f}from"./index-CSCA1apM.js";import"./if-defined-zGpnP1OK.js";import"./ref-CgC99LRu.js";import"./chunk-L4EGOTBX-Boit2UGA.js";import"./entry-preview-DkJqm5dP.js";import"./index-DrFu-skq.js";import"./icon-button-CQW7__-s.js";import"./library-C58jM0s5.js";import"./icon.component-BoDp9LRR.js";import"./index-Vx7n56Jp.js";import"./index-_2TAQcTa.js";import"./_commonjsHelpers-CqkleIqs.js";import"./icon-mIpjUOpH.js";const{args:b,argTypes:g}=h("syn-switch"),{overrideArgs:v}=u("syn-switch"),{generateTemplate:k}=w("syn-switch"),j={args:v({name:"default",type:"slot",value:"Option"},b),argTypes:g,component:"syn-switch",parameters:{design:p("2239-58411"),docs:{description:{component:e("switch","default")}}},title:"Components/syn-switch"},r={parameters:{controls:{disable:!1},docs:{description:{story:e("switch","default")}}},render:t=>k({args:t})},n={parameters:{docs:{description:{story:e("switch","checked")}}},render:()=>a`<syn-switch checked>Checked</syn-switch>`},o={parameters:{docs:{description:{story:e("switch","disabled")}}},render:()=>a`<syn-switch disabled>Disabled</syn-switch>`},i={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:e("switch","focus")}}},play:({canvasElement:t})=>{const s=t.querySelector("syn-switch");s&&s&&s.focus()},render:()=>a`<syn-switch>Focused</syn-switch>`},l={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:e("switch","invalid")}}},play:async({canvasElement:t})=>{try{const s=t.querySelector("form"),y=s?.querySelector("syn-switch"),m=s?.querySelector("syn-button");m&&y&&(await f.click(m),m.click())}catch(s){console.error("Error in play function:",s)}},render:()=>a`
