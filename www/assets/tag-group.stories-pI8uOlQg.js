import{i as e}from"./preload-helper-xPQekRTU.js";import{D as t,Ht as n,It as r,T as i,d as a,f as o,g as s,u as c}from"./iframe-BLAzlACc.js";import{t as l}from"./icon-BFcjyE5U.js";import{a as u,i as d,n as f,o as p,r as m,t as h}from"./component-RhnClGwj.js";import{t as g}from"./tag-group-D1USviN9.js";import{t as _}from"./tag-CSr3tEcq.js";var v,y,b,x,S,C,w,T,E,D,O,k,A=e((()=>{g(),_(),l(),r(),i(),m(),a(),s(),{args:v,argTypes:y}=d(`syn-tag-group`),{generateTemplate:b}=p(`syn-tag-group`),{overrideArgs:x}=u(`syn-tag-group`),S=e=>Array(e).fill(`<syn-tag removable>
  <syn-icon name="wallpaper"></syn-icon>
  Option
 </syn-tag>`).join(`
`),C={args:x([{name:`label`,type:`slot`,value:`This is a label`},{name:`default`,type:`slot`,value:S(6)}],v),argTypes:y,component:`syn-tag-group`,parameters:{chromatic:{modes:o},design:c(`45275-186668`),docs:{description:{component:f(`tag-group`,`default`)}}},tags:[`Feedback`,`Tags`,`Filter`],title:`Components/syn-tag-group`},w={parameters:{controls:{disable:!1},docs:{description:{story:f(`tag-group`,`default`)}}},render:e=>b({args:e})},T={parameters:{docs:{description:{story:f(`tag-group`,`labels`)}}},render:()=>n`
    <syn-tag-group>
      <div slot="label">This is a label</div>
      ${t(S(6))}
    </syn-tag-group>
  `},E={parameters:{docs:{description:{story:f(`tag-group`,`size`)}}},render:()=>n`
  ...
  `},D={parameters:{docs:{description:{story:f(`tag-group`,`label-alignment`)}}},render:()=>n`
