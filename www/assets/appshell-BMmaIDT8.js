import{k as a}from"./directive-helpers-CDT6qhDs.js";import{g as n}from"./translations-BapaEbJq.js";var i=Object.freeze,c=Object.defineProperty,r=(e,t)=>i(c(e,"raw",{value:i(e.slice())})),o,s;const d=()=>a`
  <!-- footer -->
  <style>
    .synergy-footer-demo {
  ...
  <footer class="synergy-footer-demo">
    <div class="footer-content" aria-label="Footer navigation">
      <nav class="link-wrapper">
        <a class="syn-link syn-link--medium syn-link--quiet" href="${n("footer.linksHref.imprint")}">${n("footer.linksName.imprint")}</a>
        <a class="syn-link syn-link--medium syn-link--quiet" href="${n("footer.linksHref.termsConditions")}">${n("footer.linksName.termsConditions")}</a>
        <a class="syn-link syn-link--medium syn-link--quiet" href="${n("footer.linksHref.termsOfUse")}">${n("footer.linksName.termsOfUse")}</a>
        <a class="syn-link syn-link--medium syn-link--quiet" href="${n("footer.linksHref.privacyPolicy")}">${n("footer.linksName.privacyPolicy")}</a>
      </nav>
...
`,g=({withMetaNavigation:e=!1}={})=>a`
  ...
  <!-- /header -->
`,u=({noFocusTrapping:e=!1,open:t=!1,rail:l=!1}={})=>a`
  <!-- side-navigation -->
  <syn-side-nav
    ?no-focus-trapping=${e}
    ?open=${t}
...
`])),e),x=(e,t="syn-side-nav")=>a(s||(s=r([`
  ...
  <\/script>
`])),e,t,t);export{u as a,h as b,g as c,d,v as e,f,x as g};
