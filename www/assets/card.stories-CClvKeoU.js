import{n as e}from"./chunk-DnJy8xQt.js";import{E as t,Nt as n,Rt as r,T as i,d as a,f as o,g as s,u as c}from"./iframe-DVxLZS-s.js";import{t as l}from"./button-Bh72Wntz.js";import{t as u}from"./card-jL3Mbx3S.js";import{a as d,i as f,n as p,o as m,r as h,t as g}from"./component-DniQwiZV.js";import{t as _}from"./icon-button-BtaRtnxt.js";var v,y,b,x,S,C,w,T,E,D,O,k,A,j,M;e((()=>{n(),i(),u(),l(),_(),h(),a(),s(),{args:v,argTypes:y}=f(`syn-card`),{overrideArgs:b}=d(`syn-card`),{generateTemplate:x}=m(`syn-card`),S=({buttonText:e=`More info`,footerText:t=`Optional information`}={})=>`
  <footer slot="footer">
    <small>${t}</small>
    <nav>
