...
`,$={args:f([{name:"default",type:"slot",value:o().trim()}],C),argTypes:g,component:"syn-table",parameters:{design:i("19479-134433"),docs:{description:{component:p}}},tags:["Structure","Styles"],title:"Styles/syn-table"},s={parameters:{controls:{disable:!1},docs:{description:{story:p}}},render:c=>m(c,"table")},t={render:()=>n`
...
}, 400)`,...r.parameters?.docs?.source}}};const B=["Default","AtomicTable","AutoDefaultTable","AutoAlternatingTable","AutoBorderTable","Screenshot"];export{t as AtomicTable,l as AutoAlternatingTable,a as AutoBorderTable,e as AutoDefaultTable,s as Default,r as Screenshot,B as __namedExportsOrder,$ as default};
