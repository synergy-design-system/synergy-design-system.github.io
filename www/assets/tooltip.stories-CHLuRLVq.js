import{x as n}from"./lit-element-DILkAbkc.js";import{g as u}from"./preview-B3aX1ie9.js";import{s as g,a as b,g as t,b as h,c as v}from"./component-G-xleXIh.js";import"./index-B3ehnkiM.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon.component-ECBjcGqG.js";import"./directive-helpers-DbZfDV3x.js";import"./icon-button-DB3uW5ZR.js";import"./icon-CC8qjACX.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-DU65Ag4u.js";var m=Object.freeze,x=Object.defineProperty,w=(c,k)=>m(x(c,"raw",{value:m(c.slice())})),d;const{args:f,argTypes:T}=g("syn-tooltip"),{overrideArgs:S}=v("syn-tooltip"),{generateTemplate:H}=b("syn-tooltip"),E={args:S([{name:"content",type:"attribute",value:"This is a tooltip"},{name:"open",type:"attribute",value:!0},{name:"default",type:"slot",value:"<syn-button>Hover me</syn-button>"}],f),argTypes:T,component:"syn-tooltip",parameters:{design:u("12852-79550"),docs:{description:{component:t("tooltip","default")},story:{height:"200px",inline:!1}},layout:"centered"},title:"Components/syn-tooltip"},o={parameters:{controls:{disable:!1},docs:{description:{story:t("tooltip","default")}}},render:c=>H({args:c})},e={parameters:{docs:{description:{story:t("tooltip","placement")},story:{height:"450px"}},layout:"padded"},render:()=>n`
...
`},s={parameters:{docs:{description:{story:t("tooltip","onclick")}}},render:()=>n`
  <syn-tooltip content="Click again to dismiss" trigger="click" open>
    <syn-button>Click to Toggle</syn-button>
  </syn-tooltip>
  `},i={parameters:{docs:{description:{story:t("tooltip","manuel")}}},render:()=>n(d||(d=w([`
  ...
  <\/script>
  `])))},r={parameters:{docs:{description:{story:t("tooltip","removingarrows")}}},render:()=>n`
  <syn-tooltip content="This is a tooltip" style="--syn-tooltip-arrow-size: 0;" open>
    <syn-button>No Arrow</syn-button>
  </syn-tooltip>
  `},l={parameters:{docs:{description:{story:t("tooltip","htmltooltip")}}},render:()=>n`
  <syn-tooltip open>
    <div slot="content">I'm not <strong>just</strong> a tooltip, I'm a <em>tooltip</em> with HTML!</div>

    <syn-button>Hover me</syn-button>
  </syn-tooltip>
`},p={parameters:{docs:{description:{story:t("tooltip","maxwith")},story:{height:"400px"}}},render:()=>n`
  <syn-tooltip style="--max-width: 80px;" content="This tooltip will wrap after only 80 pixels." open>
    <syn-button>Hover me</syn-button>
  </syn-tooltip>
  `},a={parameters:{docs:{description:{story:t("tooltip","hoisting")}}},render:()=>n`
  ...
  `},y=h({Default:o,Placement:e,ClickTrigger:s,ManualTrigger:i,RemovingArrows:r,HTMLInTooltips:l,SettingAMaximumWidth:p,Hoisting:a},{additionalChromaticOptions:{delay:500},heightPx:550,styleHeading:{"margin-bottom":"180px"}});o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
...
})`,...y.parameters?.docs?.source}}};const N=["Default","Placement","ClickTrigger","ManualTrigger","RemovingArrows","HTMLInTooltips","SettingAMaximumWidth","Hoisting","Screenshot"];export{s as ClickTrigger,o as Default,l as HTMLInTooltips,a as Hoisting,i as ManualTrigger,e as Placement,r as RemovingArrows,y as Screenshot,p as SettingAMaximumWidth,N as __namedExportsOrder,E as default};
