...
`},F={parameters:{docs:{description:{story:l(`file`,`sizes`)}}},render:()=>i`
  ...
  `},z=f({Default:D,Label:O,HelpText:k,Multiple:A,HideValue:j,Disabled:N,Sizes:F,Invalid:I,Droparea:L,Directory:R},750),B=[`Default`,`Label`,`HelpText`,`Multiple`,`HideValue`,`Focus`,`Disabled`,`Readonly`,`Sizes`,`Invalid`,`Droparea`,`Directory`,`Screenshot`],D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
...
\`
  ...
  Droparea,
  Directory
}, 750)`,...z.parameters?.docs?.source}}}})))()}export{y as n,V as r,D as t};