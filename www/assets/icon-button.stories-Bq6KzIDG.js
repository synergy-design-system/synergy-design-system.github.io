import"./icon-button-QDqa0G3N.js";import{x as n}from"./directive-helpers-Dvm_Ferq.js";import{g as e,a as m,s as d,b,c as y,d as g}from"./component-CRLtm6hg.js";import"./library-BeKtmk-e.js";import"./functions-CDi3doZH.js";import"./ref-mC-OfJbg.js";import"./chunk-L4EGOTBX-Boit2UGA.js";import"./entry-preview-DkJqm5dP.js";import"./index-DrFu-skq.js";import"./index-_2TAQcTa.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-BmTV649i.js";import"./custom-elements-manifest-CNncYWqS.js";const{args:S,argTypes:f}=d("syn-icon-button"),{overrideArgs:z}=b("syn-icon-button"),{generateTemplate:w}=y("syn-icon-button"),q={args:z([{name:"name",type:"attribute",value:"wallpaper"},{name:"label",type:"attribute",value:"Wallpaper"},{name:"size",type:"attribute",value:"medium"}],S),argTypes:f,component:"syn-icon-button",parameters:{design:m("2986-3736"),docs:{description:{component:e("icon-button","default")}}},title:"Components/syn-icon-button"},t={parameters:{controls:{disable:!1},docs:{description:{story:e("icon-button","default")}}},render:p=>w({args:p})},r={parameters:{docs:{description:{story:e("icon-button","sizes")}}},render:()=>n`<syn-icon-button name="wallpaper" label="Wallpaper" color="neutral" size="small"></syn-icon-button>
  ...
  </style>`},c=g({Default:t,Sizes:r,Colors:a,LinkButton:s,Disabled:o,Label:l});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  Disabled,
  Label
})`,...c.parameters?.docs?.source}}};const A=["Default","Sizes","Colors","LinkButton","Disabled","Focus","Label","Screenshot"];export{a as Colors,t as Default,o as Disabled,i as Focus,l as Label,s as LinkButton,c as Screenshot,r as Sizes,A as __namedExportsOrder,q as default};
