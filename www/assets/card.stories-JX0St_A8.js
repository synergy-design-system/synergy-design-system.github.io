import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{D as r,_ as i,d as a,f as o,k as s,p as c}from"./iframe-Dn-tjrvc.js";import{t as l}from"./button-DSjAtJ0E.js";import{t as u}from"./card-Cqmx6gRw.js";import{a as d,i as f,n as p,o as m,r as h,t as g}from"./component-D_QZftXm.js";import{t as _}from"./icon-button-BFNASnJP.js";var v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N=e((()=>{n(),r(),u(),l(),_(),h(),o(),i(),{args:v,argTypes:y}=f(`syn-card`),{overrideArgs:b}=d(`syn-card`),{generateTemplate:x}=m(`syn-card`),S=({buttonText:e=`More info`,footerText:t=`Optional information`}={})=>`
  <footer slot="footer">
    <small>${t}</small>
    <nav>
