import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-C-q7G2lS.js";import{c as i,h as a,n as o,t as s}from"./lit-DgWh_IaA.js";import{a as ee,d as c,l,n as u,o as te,r as d,s as f,t as p}from"./synergy-element-Dt4MSOQD.js";import{t as ne}from"./query-DOHNhzf6.js";import{n as re}from"./query-assigned-elements-CWXdehfi.js";import{r as ie,t as ae}from"./if-defined-DmmMeZVG.js";import{n as m}from"./watch-Q8hEwzVb.js";import{n as oe,t as se}from"./decorator-DZesXZg7.js";import{t as ce}from"./button-D57oz1we.js";import{a as le,i as ue,n as h,o as de,r as fe,t as pe}from"./component-pvg5noYG.js";import{t as me}from"./taggedTemplateLiteral-BZenJ0bZ.js";import{n as he,t as ge}from"./alert.component-DFybArqg.js";import{n as _e,t as ve}from"./tooltip.component-BDuwGxXi.js";import{t as ye}from"./input-dBFTEpJ3.js";var g;function _(){return(_=e((()=>{g=e=>(t,n)=>{n===void 0?customElements.define(e,t):n.addInitializer(()=>{customElements.define(e,t)})}})))()}var v,y,b,x,S,C,w,be,xe,T,E;function D(){return(D=e((()=>{u(),v=[`blur`,`change`,`clear`,`focus`,`invalid`,`input`,`move`],y=(e,t)=>e.includes(t),b=e=>y(e,`blur`),x=e=>y(e,`invalid`),S=e=>e instanceof p,C=(e=``)=>e.split(` `).map(e=>e.trim()).filter(Boolean),w=(e,t)=>{let n=t.trim();return S(e)&&v.includes(n)?`syn-${n}`:n},be=e=>{if(!S(e))return;let{size:t}=e;return t??void 0},xe={"syn-checkbox":`input`,"syn-combobox":`.combobox__value-input`,"syn-file":`input`,"syn-input":`input`,"syn-radio-group":`input`,"syn-range":`.input__control`,"syn-select":`.select__value-input`,"syn-switch":`input`,"syn-textarea":`.textarea__control`},T=(e,t)=>e.shadowRoot?.querySelector(t)??null,E=e=>{if(!e)return;if(!e.shadowRoot)return e;let t=e.tagName.toLowerCase(),n=xe[t];if(n){let t=T(e,n);if(t)return t}return T(e,`input,select,textarea`)||e}})))()}var O;function k(){return(k=e((()=>{s(),O=a`
  .validate {
    display: flex;
