import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{D as r,T as i,d as a,f as o,g as s,u as c}from"./iframe-Cn79ht60.js";import{t as l}from"./button-BJ5RECCr.js";import{t as u}from"./icon-caUGB1Oa.js";import{t as d}from"./option-Da8tNITW.js";import{a as f,i as p,n as m,o as h,r as g,t as _}from"./component-BsxLXFpR.js";import{n as ee,t as v}from"./taggedTemplateLiteral-pWa2IaV6.js";import{n as te,t as ne}from"./PaddingDecorator-DYDZS_5f.js";import{n as re,r as ie,t as ae}from"./combobox-BpWRO539.js";import{t as oe}from"./optgroup-D2odZL-C.js";var y,se,ce,le,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=e((()=>{ae(),l(),u(),d(),oe(),n(),i(),ie(),g(),a(),ne(),s(),ee(),{userEvent:y}=__STORYBOOK_MODULE_TEST__,{args:b,argTypes:x}=p(`syn-combobox`),{overrideArgs:S}=f(`syn-combobox`),{generateTemplate:C}=h(`syn-combobox`),w={args:b,argTypes:x,component:`syn-combobox`,parameters:{chromatic:{modes:o},design:c(`42207-352063`),docs:{description:{component:m(`combobox`,`default`)},story:{height:`250px`}}},tags:[`Form`],title:`Components/syn-combobox`},T=[`Yellow`,`Light Green`,`Grey`,`Green`,`Blue`,`Red`,`Orange`,`Magenta`,`White`,`Purple`,`Pink`,`Black`,`Brown`].sort(),E=e=>`<syn-option value="${e.replaceAll(` `,`_`)}">${e}</syn-option>`,D=e=>r(E(e)),O=()=>T.map(E),k=()=>r(O().join(`
`)),A={parameters:{args:S({name:`default`,type:`slot`,value:`
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>`},b),controls:{disable:!1},docs:{description:{story:m(`combobox`,`default`)}}},render:e=>C({args:e})},j={parameters:{docs:{description:{story:m(`combobox`,`label`)}}},render:()=>t`
    <syn-combobox label="State">
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},M={parameters:{docs:{description:{story:m(`combobox`,`help-text`)}}},render:()=>t`
    <syn-combobox label="State" help-text="Select a State">
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},N={parameters:{docs:{description:{story:m(`combobox`,`placeholder`)}}},render:()=>t`
    <syn-combobox label="State" help-text="Select a State" placeholder="Select a State">
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},P={decorators:[te()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:m(`combobox`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-combobox`);t&&t.focus()},render:()=>t`
    <syn-combobox>
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},F={parameters:{docs:{description:{story:m(`combobox`,`clearable`)}}},render:()=>t`
    <syn-combobox value="Green" clearable>
      ${k()}
    </syn-combobox>
  `},I={parameters:{docs:{description:{story:m(`combobox`,`disabled`)}}},render:()=>t`
    <syn-combobox  disabled placeholder="Disabled">
      ${k()}
    </syn-combobox>
  `},L={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:m(`combobox`,`readonly`)}}},render:()=>t`
  ...
  `},R={parameters:{docs:{description:{story:m(`combobox`,`multiple`)}}},render:()=>t`
  ...
  `},z={parameters:{docs:{description:{story:m(`combobox`,`initial-values`)}}},render:()=>t`
    <syn-combobox value="option-1 option-2 option-3" multiple clearable max-options-visible="2">
      <syn-option value="option-1">Option 1</syn-option>
      <syn-option value="option-2">Option 2</syn-option>
      <syn-option value="option-3">Option 3</syn-option>
  ...
  `},B={parameters:{docs:{description:{story:m(`combobox`,`restrict-options`)}}},render:()=>t`
    <syn-combobox value="Option 1" restricted>
      <syn-option value="option-1">Option 1</syn-option>
      <syn-option value="option-2">Option 2</syn-option>
      <syn-option value="option-3">Option 3</syn-option>
    </syn-combobox>
  `},V={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:m(`combobox`,`no-results`)},story:{inline:!1}}},play:async({canvasElement:e})=>{let t=e.querySelector(`syn-combobox`);await t.updateComplete,t.focus();let n=t.shadowRoot?.querySelector(`input`);n&&await y.type(n,`Search term`)},render:()=>t`
    <syn-combobox id="no-results" value="Search term" open restricted>
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},H={parameters:{docs:{description:{story:m(`combobox`,`size`)}}},render:()=>t`
  ...
  `},U={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:m(`combobox`,`invalid`)}}},play:async({canvasElement:e})=>{let t=e.querySelector(`form`),n=t.querySelector(`syn-combobox`),r=t.querySelector(`syn-button`);r&&n&&(await y.click(r),r.click())},render:()=>t`
  ...
  `},W={parameters:{docs:{description:{story:m(`combobox`,`preffix-sufffix`)}}},render:()=>t`
  ...
  `},G={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:m(`combobox`,`simple`)}}},play:async({canvasElement:e})=>{let t=e.querySelector(`syn-combobox`);await t.updateComplete,await t.show()},render:()=>t`
    <syn-combobox label="Preferred Color" value="g">
     ${k()}
    </syn-combobox>
  `},K={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:m(`combobox`,`highlight`)}}},play:async({canvasElement:e})=>{let t=e.querySelector(`syn-combobox`);await t.updateComplete,await t.show()},render:()=>{let e=re;return t(se||=v([`
    ...
    <\/script>
  `]),k(),e)}},q={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:m(`combobox`,`grouping`)}}},play:async({canvasElement:e})=>{let t=e.querySelector(`syn-combobox`);await t.updateComplete,await t.show()},render:()=>t`
  ...
  `},J={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:m(`combobox`,`container-height`)}}},play:async({canvasElement:e})=>{let t=e.querySelector(`syn-combobox`);await t.updateComplete,await t.show()},render:()=>t`
  ...
  `},Y={parameters:{docs:{description:{story:m(`combobox`,`async-options`)}}},render:()=>t(ce||=v([`
    ...
    <\/script>
  `])),tags:[`skip_mcp`]},X={parameters:{docs:{description:{story:m(`combobox`,`custom-filter`)}}},render:()=>t(le||=v([`
    ...
    <\/script>
  `]),k())},Z=_({Default:A,Labels:j,HelpText:M,Placeholder:N,Clearable:F,Disabled:I,Readonly:L,Multiple:R,SettingInitialValue:z,Restricted:B,NoResultsFound:V,Sizes:H,PrefixSuffixTextAndIcons:W,AsyncOptions:Y,CustomFilter:X},500),A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  parameters: {
    args: overrideArgs({
      name: 'default',
      type: 'slot',
