import{n as x,x as a,g as S,C as k}from"./iframe-DKzh7HHt.js";import{L as w}from"./localize-Dh03wnLC.js";import{S as z,c as R,n as _}from"./synergy-element-D4Cp3n7p.js";import{r as C}from"./icon.component-CNp8HpxC.js";import{a as D}from"./query-D0jTsbLw.js";import"./button-CUlu5KaZ.js";import"./icon-ZpBo1gm6.js";import{g as s,s as E,a as B,c as L,b as O}from"./component-BVwEOs8-.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DihgwUfS.js";import"./watch-CEsCE2EF.js";import"./class-map-Bipwc1iT.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./if-defined-DWhkacz2.js";import"./spinner.component-aogJALmx.js";import"./decorator-DeP7ND_N.js";import"./functions-DkH8wE0_.js";import"./index-CQ0aEGxp.js";import"./_docs-DCc6stEZ.js";const P=x`
	/* stylelint-disable */
  :host {
    --size: 128px;
    --track-width: 4px;
...
`;var j=Object.defineProperty,m=(r,t,d,y)=>{for(var e=void 0,v=r.length-1,h;v>=0;v--)(h=r[v])&&(e=h(t,d,e)||e);return e&&j(t,d,e),e};class g extends z{constructor(){super(...arguments),this.localize=new w(this),this.value=0,this.label=""}static{this.styles=[R,P,T]}updated(t){if(super.updated(t),t.has("value")){const d=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),y=2*Math.PI*d,e=y-this.value/100*y;this.indicatorOffset=`${e}px`}}render(){return a`
    ...
    `}}m([D(".progress-ring__indicator")],g.prototype,"indicator");m([C()],g.prototype,"indicatorOffset");m([_({type:Number,reflect:!0})],g.prototype,"value");m([_()],g.prototype,"label");g.define("syn-progress-ring");var f=Object.freeze,A=Object.defineProperty,I=(r,t)=>f(A(r,"raw",{value:f(r.slice())})),b;const{args:M,argTypes:$}=E("syn-progress-ring"),{overrideArgs:V}=B("syn-progress-ring"),{generateTemplate:F}=L("syn-progress-ring"),cr={args:V([{name:"default",type:"slot",value:""},{name:"value",type:"attribute",value:"25"}],M),argTypes:$,component:"syn-progress-ring",parameters:{chromatic:{modes:k},design:S("14207-8709"),docs:{description:{component:s("progress-ring","default")}}},tags:["Feedback"],title:"Components/syn-progress-ring"},o={parameters:{docs:{description:{story:s("progress-ring","default")}}},render:r=>F({args:r})},n={parameters:{docs:{description:{story:s("progress-ring","size")}}},render:()=>a`
