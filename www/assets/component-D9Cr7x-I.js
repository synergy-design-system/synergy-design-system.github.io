var Dn=Object.freeze,Ki=Object.defineProperty;var In=(t,e)=>Dn(Ki(t,"raw",{value:Dn(e||t.slice())}));import{a as f,c as ti,s as ue,u as C,e as u,o as y,i as kt,t as Gi}from"./if-defined-zGpnP1OK.js";import{i as h,x as c,E as ni,u as Nn,B as Yi,T as Xi}from"./directive-helpers-Dvm_Ferq.js";import{a as Dt,k as ii,r as ai,L as Ji,l as Ct,b as Qi,c as Zi,d as An,f as ea,s as ta,e as na,p as an,g as ia,h as aa,o as oi,m as oa,n as sa,j as ra,i as la,t as da}from"./ref-CgC99LRu.js";import{s as ca}from"./chunk-L4EGOTBX-Boit2UGA.js";import"./entry-preview-DkJqm5dP.js";import{e as re,S as ut,d as pa}from"./icon-button-CQW7__-s.js";import{d as ha}from"./index-DrFu-skq.js";import"./index-_2TAQcTa.js";import{n as r,a as b}from"./library-C58jM0s5.js";import{c as x,w as m,a as w,S as Te}from"./icon.component-BoDp9LRR.js";import"./icon-mIpjUOpH.js";import{a as ua}from"./index-Vx7n56Jp.js";const ma=h`
  :host {
    display: block;
  }
...
`;var ko=Object.defineProperty,vn=(t,e,n,a)=>{for(var i=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=s(e,n,i)||i);return i&&ko(e,n,i),i};class Xt extends w{constructor(){super(...arguments),this.localize=new R(this),this.separatorDir=this.localize.dir(),this.label=""}static{this.styles=[x,wo,xo]}static{this.dependencies={"syn-icon":Te}}getSeparator(){const n=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[n,...n.querySelectorAll("[id]")].forEach(a=>a.removeAttribute("id")),n.setAttribute("data-default",""),n.slot="separator",n}handleSlotChange(){const e=[...this.defaultSlot.assignedElements({flatten:!0})].filter(n=>n.tagName.toLowerCase()==="syn-breadcrumb-item");e.forEach((n,a)=>{const i=n.querySelector('[slot="separator"]');i===null?n.append(this.getSeparator()):i.hasAttribute("data-default")&&i.replaceWith(this.getSeparator()),a===e.length-1?n.setAttribute("aria-current","page"):n.removeAttribute("aria-current")})}render(){return this.separatorDir!==this.localize.dir()&&(this.separatorDir=this.localize.dir(),this.updateComplete.then(()=>this.handleSlotChange())),c`
...
`;var Or=Object.defineProperty,Dr=Object.getOwnPropertyDescriptor,we=(t,e,n,a)=>{for(var i=a>1?void 0:a?Dr(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&Or(e,n,i),i};class he extends w{constructor(){super(),this.localize=new R(this),this.content="",this.placement="top",this.disabled=!1,this.distance=13,this.open=!1,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleBlur=()=>{this.hasTrigger("focus")&&this.hide()},this.handleClick=()=>{this.hasTrigger("click")&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger("focus")&&this.show()},this.handleDocumentKeyDown=e=>{e.key==="Escape"&&(e.stopPropagation(),this.hide())},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){const e=jn(getComputedStyle(this).getPropertyValue("--show-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.show(),e)}},this.handleMouseOut=()=>{if(this.hasTrigger("hover")){const e=jn(getComputedStyle(this).getPropertyValue("--hide-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.hide(),e)}},this.addEventListener("blur",this.handleBlur,!0),this.addEventListener("focus",this.handleFocus,!0),this.addEventListener("click",this.handleClick),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}static{this.styles=[x,Er,$r]}static{this.dependencies={"syn-popup":P}}disconnectedCallback(){super.disconnectedCallback(),this.closeWatcher?.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(e){return this.trigger.split(" ").includes(e)}async handleOpenChange(){if(this.open){if(this.disabled)return;this.emit("syn-show"),"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide()}):document.addEventListener("keydown",this.handleDocumentKeyDown),await Z(this.body),this.body.hidden=!1,this.popup.active=!0;const{keyframes:e,options:n}=j(this,"tooltip.show",{dir:this.localize.dir()});await W(this.popup.popup,e,n),this.popup.reposition(),this.emit("syn-after-show")}else{this.emit("syn-hide"),this.closeWatcher?.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown),await Z(this.body);const{keyframes:e,options:n}=j(this,"tooltip.hide",{dir:this.localize.dir()});await W(this.popup.popup,e,n),this.popup.active=!1,this.body.hidden=!0,this.emit("syn-after-hide")}}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,J(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,J(this,"syn-after-hide")}render(){return c`
    ...
    `}}we([u("slot:not([name])")],he.prototype,"defaultSlot",2);we([u(".tooltip__body")],he.prototype,"body",2);we([u("syn-popup")],he.prototype,"popup",2);we([r()],he.prototype,"content",2);we([r()],he.prototype,"placement",2);we([r({type:Boolean,reflect:!0})],he.prototype,"disabled",2);we([r({type:Number})],he.prototype,"distance",2);we([r({type:Boolean,reflect:!0})],he.prototype,"open",2);we([r({type:Number})],he.prototype,"skidding",2);we([r()],he.prototype,"trigger",2);we([r({type:Boolean})],he.prototype,"hoist",2);we([m("open",{waitUntilFirstUpdate:!0})],he.prototype,"handleOpenChange",1);we([m(["content","distance","hoist","placement","skidding"])],he.prototype,"handleOptionsChange",1);we([m("disabled")],he.prototype,"handleDisabledChange",1);S("tooltip.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:150,easing:"ease"}});S("tooltip.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:150,easing:"ease"}});const it=(t,e)=>t-e,Et=(t,e)=>{if(t.length!==e.length)return!0;const n=t.slice().sort(it),a=e.slice().sort(it);for(let i=0;i<n.length;i+=1)if(n[i]!==a[i])return!0;return!1},Ai=(t,e,n)=>{const a=t.getBoundingClientRect(),i=a.width;if(i<=0)return 0;let o=e;return o-=a.left,o<=0?n?1:0:o>=i?n?0:1:(o/=i,n?1-o:o)},Ir=h`
  :host {
    /*
...
`;var xl=Object.defineProperty,kl=Object.getOwnPropertyDescriptor,xe=(t,e,n,a)=>{for(var i=a>1?void 0:a?kl(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&xl(e,n,i),i};let se=class extends w{constructor(){super(...arguments),this.controller=new AbortController,this.validationMessage="",this.eagerFirstMount=!0,this.isInternalTriggeredInvalid=!1,this.isValid=!0,this.variant="native",this.hideIcon=!1,this.on="",this.customValidationMessage="",this.eager=!1,this.internalRevalidate=t=>{t.currentTarget.validity?.valid&&(this.validationMessage="")},this.validate=t=>{if(rn(t.type)&&this.variant==="native"&&this.isInternalTriggeredInvalid===!0){this.isInternalTriggeredInvalid=!1;return}rn(t.type)&&this.variant!=="native"&&(t.preventDefault(),t.stopPropagation());const e=t.currentTarget;if(this.isValid=e.validity?.valid,this.eager&&this.eagerFirstMount){this.eagerFirstMount=!1,this.setValidationMessage(e);return}!this.isValid&&!Qn(t.type)&&this.handleFocus(e),this.setValidationMessage(e),!Qn(t.type)&&this.variant==="native"&&this.updateComplete.then(()=>{this.isInternalTriggeredInvalid=!0,e.reportValidity()})}}handleListenerChange(){this.updateEvents()}async handleEagerChange(){if(this.eager){const t=this.getInput();await this.updateComplete,t?.reportValidity(),this.eagerFirstMount=!0}else this.eagerFirstMount=!1}handleCustomValidationMessageChange(){const t=this.getInput();t&&(this.setCustomValidationMessage(t),this.setValidationMessage(t))}getValidity(){return this.isValid}getInput(){const t=this.slottedChildren[0];return t||void 0}getUsedEventNames(){const t=this.getInput();if(!t)return[];const e=vl(this.on),[...n]=e.filter(Boolean);return n.includes("invalid")||n.push("invalid"),n.includes("live")&&(n.push("input"),n.push("blur")),Array.from(new Set(n.filter(a=>a!=="live").map(a=>Zn(t,a))))}updateEvents(){this.controller.abort(),this.controller=new AbortController;const t=this.getInput();if(!t)return;const e=this.getUsedEventNames();e.forEach(a=>{t.addEventListener(a,this.validate,{capture:rn(a),signal:this.controller.signal})});const n=Zn(t,"change");e.includes(n)||t.addEventListener(n,this.internalRevalidate,{signal:this.controller.signal})}setValidationMessage(t){const{customValidationMessage:e}=this,n=e||t.validationMessage;this.validationMessage=n}setCustomValidationMessage(t){t.setCustomValidity(this.customValidationMessage)}handleFocus(t){const e=document.activeElement,n=e.closest("syn-validate");!e.validity?.valid&&n||(t.scrollIntoView({block:"nearest"}),t.focus())}async firstUpdated(t){super.firstUpdated(t),this.updateEvents();const e=this.getInput();this.customValidationMessage&&(e instanceof w&&await e.updateComplete,e?.setCustomValidity(this.customValidationMessage)),this.eager&&(await this.updateComplete,this.isValid=e?.validity?.valid??!1,e?.reportValidity())}connectedCallback(){super.connectedCallback(),this.observer=new MutationObserver(t=>{const e=this.getInput();if(!e)return;t.filter(({target:a})=>a===e).every(a=>{const i=a.target;return i.hasAttribute("disabled")||i.hasAttribute("readonly")})?(this.isValid=!0,this.validationMessage=""):(e instanceof w?e.updateComplete:Promise.resolve()).then(()=>{this.isValid=e?.validity?.valid??!1,this.validationMessage=e?.validationMessage??""})}),this.observer.observe(this,{attributeFilter:["disabled","readonly"],attributes:!0,subtree:!0})}disconnectedCallback(){super.disconnectedCallback(),this.controller.abort(),this?.observer?.disconnect()}renderInlineValidation(){return this.variant!=="inline"||!this.validationMessage?"":c`
    ...
    `}};se.styles=[x,wl];se.dependencies={"syn-alert":X};xe([Dt()],se.prototype,"slottedChildren",2);xe([b()],se.prototype,"validationMessage",2);xe([b()],se.prototype,"eagerFirstMount",2);xe([b()],se.prototype,"isInternalTriggeredInvalid",2);xe([b()],se.prototype,"isValid",2);xe([r({reflect:!0})],se.prototype,"variant",2);xe([r({attribute:"hide-icon",reflect:!0,type:Boolean})],se.prototype,"hideIcon",2);xe([r({reflect:!0})],se.prototype,"on",2);xe([r({attribute:"custom-validation-message",type:String})],se.prototype,"customValidationMessage",2);xe([r({type:Boolean})],se.prototype,"eager",2);xe([m("on",{waitUntilFirstUpdate:!0})],se.prototype,"handleListenerChange",1);xe([m("eager",{waitUntilFirstUpdate:!1})],se.prototype,"handleEagerChange",1);xe([m("customValidationMessage",{waitUntilFirstUpdate:!0})],se.prototype,"handleCustomValidationMessageChange",1);se=xe([re("SynValidate")],se);se.define("syn-validate");function _l(t){const e=typeof window<"u"&&window;return!!(e&&(/Chromatic/.test(e.navigator.userAgent)||/chromatic=true/.test(e.location.href)))}const Tl=(t,...e)=>_l()?c`
      <style>
      :root {
                    ...
                    <tr class="template-row">
                      ...
                      ${(k?.values||[""]).map(ke=>C`
                          ...
                          ${et&&ue(et.split("%TEMPLATE%")[0]||"")||""}
                            ${g({...p,...T,...k&&k.type!=="template"&&{[`${k.name}${ct(t).getSuffixFromType(k.type)}`]:ke.hasOwnProperty("value")?ke.value:ke},...B&&B.type!=="template"&&{[`${B.name}${ct(t).getSuffixFromType(B.type)}`]:H.hasOwnProperty("value")?H.value:H}})}
...
`):a=e.innerHTML,a=a.replace(/<style><\/style>/g,"").replace(/<!-- preview-ignore:start -->[\s\S]*?<!-- preview-ignore:end -->/g,"").replace(/\/\/ preview-ignore:start[\s\S]*?\/\/ preview-ignore:end/g,"").replace(/<style>\n<\/style>/g,"").replace(/<script>\s*component = document\.querySelector\('(.+?)'\);\s*<\/script>/g,""),a}},Jl=(t,e,n="components")=>{const a=pa[n][t]??{},i=a[e]?.description?.value??"No Description",o=a[e]?.note?.value??"",s=p=>p.replace(/\n/g,"<br/>"),l=s(i),d=o?`<br/><br/><strong>👨‍💻 Additional developer Information:</strong><br>${s(o)}`:"";return`${l}${d}`},Ql=(t,e=150)=>{const n=isNaN(e)?e:{heightPx:e},{afterRender:a="",additionalChromaticOptions:i={},heightPx:o=150,styleHeading:s={}}=n,l=Object.entries(s).map(([d,p])=>`${d}: ${p};`).join(" ");return{parameters:{chromatic:{...qi?.parameters?.chromatic,...i,disableSnapshot:!1},docs:{disable:!0}},render:(d,p)=>C`
      ...
      `})}
      ${a}
    `}};export{Sl as a,ct as b,Xl as c,Ql as d,Yl as e,Jl as g,Gl as h,_l as i,qi as p,hn as s};
