import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{D as r,T as i,d as a,f as o,g as s,u as c}from"./iframe-BCoUYk3Z.js";import{t as l}from"./button-DrTiiP_n.js";import{t as u}from"./icon-DIIsNVY-.js";import{a as d,i as f,n as p,o as m,r as h,t as g}from"./component-CzEJor_j.js";import{n as _,t as v}from"./taggedTemplateLiteral-pWa2IaV6.js";import{n as ee,t as te}from"./PaddingDecorator-DYDZS_5f.js";import{n as ne,r as re,t as ie}from"./combobox-DjvCqtwm.js";import{t as ae}from"./option-2oik-IC2.js";import{t as oe}from"./optgroup-Q5n-HdUT.js";var y,se,ce,le,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=e((()=>{ie(),l(),u(),ae(),oe(),n(),i(),re(),h(),a(),te(),s(),_(),{userEvent:y}=__STORYBOOK_MODULE_TEST__,{args:b,argTypes:x}=f(`syn-combobox`),{overrideArgs:S}=d(`syn-combobox`),{generateTemplate:C}=m(`syn-combobox`),w={args:b,argTypes:x,component:`syn-combobox`,parameters:{chromatic:{modes:o},design:c(`42207-352063`),docs:{description:{component:p(`combobox`,`default`)},story:{height:`250px`}}},tags:[`Form`],title:`Components/syn-combobox`},T=[`Yellow`,`Light Green`,`Grey`,`Green`,`Blue`,`Red`,`Orange`,`Magenta`,`White`,`Purple`,`Pink`,`Black`,`Brown`].sort(),E=e=>`<syn-option value="${e.replaceAll(` `,`_`)}">${e}</syn-option>`,D=e=>r(E(e)),O=()=>T.map(E),k=()=>r(O().join(`
