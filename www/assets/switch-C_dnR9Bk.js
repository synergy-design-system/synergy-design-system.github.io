import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,h as n,t as r}from"./lit-BVDl_-fF.js";import{_ as i,a,f as o,i as s,n as c,o as l,r as u,s as d,t as f,y as p}from"./synergy-element-DzBHqVed.js";import{r as m,t as h}from"./if-defined-BsCyJVG6.js";import{n as g,t as _}from"./class-map-D5wKsNTm.js";import{r as v,t as y}from"./form-CV4G6JGX.js";import{r as b,t as x}from"./slot-DgcqpP0-.js";import{n as S,t as C}from"./watch-I6gMK-uE.js";import{n as w,t as T}from"./decorator--vj33aRy.js";import{r as E,t as D}from"./live-DR4AKBJB.js";import{n as O,t as k}from"./form-control.styles-Bu3u3vCk.js";import{n as A,t as j}from"./default-value-zJ_4n3ED.js";var M,N=e((()=>{r(),M=n`
...
`})),P,F,I=e((()=>{_(),A(),v(),b(),r(),h(),D(),d(),C(),l(),O(),c(),N(),w(),s(),P=class extends f{constructor(...e){super(...e),this.formControlController=new y(this,{value:e=>e.checked?e.value||`on`:void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=t}),this.hasSlotController=new x(this,`help-text`),this.hasFocus=!1,this.title=``,this.name=``,this.size=`medium`,this.disabled=!1,this.readonly=!1,this.checked=!1,this.defaultChecked=!1,this.form=``,this.required=!1,this.helpText=``}static{this.styles=[a,k,M]}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleInput(){this.emit(`syn-input`)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleClick(e){if(this.readonly){e.preventDefault();return}this.checked=!this.checked,this.emit(`syn-change`)}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleKeyDown(e){this.readonly||(e.key===`ArrowLeft`&&(e.preventDefault(),this.checked=!1,this.emit(`syn-change`),this.emit(`syn-input`)),e.key===`ArrowRight`&&(e.preventDefault(),this.checked=!0,this.emit(`syn-change`),this.emit(`syn-input`)))}handleCheckedChange(){this.input.checked=this.checked,this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(!0)}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){let e=this.hasSlotController.test(`help-text`),n=this.helpText?!0:!!e;return t`
    ...
    `}},u([o(`input[type="checkbox"]`)],P.prototype,`input`,void 0),u([i()],P.prototype,`hasFocus`,void 0),u([p({reflect:!0})],P.prototype,`title`,void 0),u([p()],P.prototype,`name`,void 0),u([p()],P.prototype,`value`,void 0),u([p({reflect:!0})],P.prototype,`size`,void 0),u([p({type:Boolean,reflect:!0})],P.prototype,`disabled`,void 0),u([p({type:Boolean,reflect:!0})],P.prototype,`readonly`,void 0),u([p({type:Boolean,reflect:!0})],P.prototype,`checked`,void 0),u([j(`checked`)],P.prototype,`defaultChecked`,void 0),u([p({reflect:!0})],P.prototype,`form`,void 0),u([p({type:Boolean,reflect:!0})],P.prototype,`required`,void 0),u([p({attribute:`help-text`})],P.prototype,`helpText`,void 0),u([S(`checked`,{waitUntilFirstUpdate:!0})],P.prototype,`handleCheckedChange`,null),u([S(`disabled`,{waitUntilFirstUpdate:!0})],P.prototype,`handleDisabledChange`,null),P=u([T(`SynSwitch`)],P),F=P})),L=e((()=>{I(),I(),F.define(`syn-switch`)}));export{L as t};