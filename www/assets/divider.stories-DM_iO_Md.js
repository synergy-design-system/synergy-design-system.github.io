import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{a as t,d as n,o as r,s as i}from"./preview-DXkhgu0Z.js";import{c as a,t as o}from"./lit-BfcklOOD.js";import{t as s}from"./divider-D3jFTDSr.js";import{i as c,n as l,o as u,r as d,t as f}from"./component-B0n0ooCL.js";var p,m,h,g,_,v,y,b,x,S,C,w=e((()=>{s(),o(),d(),r(),n(),{args:p,argTypes:m}=c(`syn-divider`),{generateTemplate:h}=u(`syn-divider`),g={args:p,argTypes:m,component:`syn-divider`,parameters:{chromatic:{modes:i},design:t(`41227-216341`),docs:{description:{component:l(`divider`,`default`)}}},tags:[`Structure`],title:`Components/syn-divider`},_={parameters:{docs:{description:{story:l(`divider`,`default`)}}},render:e=>h({args:e})},v={parameters:{docs:{description:{story:l(`divider`,`width`)}}},render:()=>a`<syn-divider style="--width: var(--syn-spacing-x-small);"></syn-divider>`},y={parameters:{docs:{description:{story:l(`divider`,`color`)}}},render:()=>a`<syn-divider style="--color: var(--syn-color-primary-600);"></syn-divider>`},b={parameters:{docs:{description:{story:l(`divider`,`spacing`)}}},render:()=>a`
    <div style="text-align: center;">
      Above
      <syn-divider style="--spacing: var(--syn-spacing-large);"></syn-divider>
      Below
    </div>
  `},x={parameters:{docs:{description:{story:l(`divider`,`vertical`)}}},render:()=>a`
