import{ae as ve,af as Di}from"./index-DrZaDL_2.js";import{useMDXComponents as li}from"./index-DjKt9u9V.js";import{a as x,r as rt,R as ge}from"./index-CleY8y_P.js";import{i as c,h as Mi,k as d,n as Fi,u as Nt,D as Ni,R as Vi,Q as qi}from"./directive-helpers-CDT6qhDs.js";import{n as s,a as v,r as Bi}from"./library-BZPO0bHa.js";import{b as m,e as Ie,k as J,R as y,a as f,d as Pi,f as Ri}from"./if-defined-BaykDp1D.js";import{r as pi,L as ji,t as Hi,F as Ye,b as Ui,o as Wi,s as Vt,f as Ki,c as Zi,d as Gi,p as _t,e as Xi,g as Yi,h as ci,i as Qi,a as di,j as Ji,$ as eo,k as to,K as io}from"./ref-lLHsj5FH.js";import{d as St}from"./default-icons-B7cd3LAo.js";import"./iframe-CGHGUMSh.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-Df9so8jS.js";import"./index-9hYXp3D6.js";import"./index-DrFu-skq.js";/**
 * @license
...
`,Ot="";function jt(e){Ot=e}function bo(e=""){if(!Ot){const t=[...document.getElementsByTagName("script")],i=t.find(a=>a.hasAttribute("data-synergy"));if(i)jt(i.getAttribute("data-synergy"));else{const a=t.find(n=>/synergy(\.min)?\.js($|\?)/.test(n.src)||/synergy-autoloader(\.min)?\.js($|\?)/.test(n.src));let r="";a&&(r=a.getAttribute("src")),jt(r.split("/").slice(0,-1).join("/"))}}return Ot.replace(/\/$/,"")+(e?`/${e.replace(/^\//,"")}`:"")}var xo={name:"default",resolver:e=>bo(`assets/icons/${e}.svg`)},wo=xo,Ht={add:`
...
`,Fo=0,Pe=class extends _{constructor(){super(...arguments),this.attrId=++Fo,this.componentId=`syn-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return d`
      <slot
        part="base"
...
`,Bo=0,de=class extends _{constructor(){super(...arguments),this.localize=new V(this),this.attrId=++Bo,this.componentId=`syn-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}handleCloseClick(e){e.stopPropagation(),this.emit("syn-close")}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false"),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,d`
      <div
        part="base"
...
`,Te=class extends _{constructor(){super(...arguments),this.localize=new V(this),this.size="medium",this.removable=!1}handleRemoveClick(){this.emit("syn-remove")}render(){return d`
      <span
        part="base"
...
`,be=class extends _{constructor(){super(...arguments),this.vertical=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}};be.styles=[z,za,wa];o([s({type:Boolean,reflect:!0})],be.prototype,"vertical",2);o([h("vertical")],be.prototype,"handleVerticalChange",1);var ka=c`
	/* stylelint-disable */
  :host {
    --size: 25rem;
...
`,Re=class extends _{constructor(){super(...arguments),this.hasMenuItemsWithCheckmarks=!1,this.updateCheckMarksByChildPropChange=e=>{e.stopImmediatePropagation(),this.handleUpdateCheckmarks(this.getAllItems())}}handleUpdateCheckmarks(e){this.hasMenuItemsWithCheckmarks=e.some(t=>t.type==="checkbox"||t.loading)}disconnectedCallback(){this.removeEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu"),this.addEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}handleClick(e){const t=["menuitem","menuitemcheckbox"],i=e.composedPath(),a=i.find(p=>{var u;return t.includes(((u=p?.getAttribute)==null?void 0:u.call(p,"role"))||"")});if(!a||i.find(p=>{var u;return((u=p?.getAttribute)==null?void 0:u.call(p,"role"))==="menu"})!==this)return;const l=a;l.type==="checkbox"&&(l.checked=!l.checked),this.emit("syn-select",{detail:{item:l}})}handleKeyDown(e){if(e.key==="Enter"||e.key===" "){const t=this.getCurrentItem();e.preventDefault(),e.stopPropagation(),t?.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(e.key)){const t=this.getAllItems(),i=this.getCurrentItem();let a=i?t.indexOf(i):0;t.length>0&&(e.preventDefault(),e.stopPropagation(),e.key==="ArrowDown"?a++:e.key==="ArrowUp"?a--:e.key==="Home"?a=0:e.key==="End"&&(a=t.length-1),a<0&&(a=t.length-1),a>t.length-1&&(a=0),this.setCurrentItem(t[a]),t[a].focus())}}handleMouseDown(e){const t=e.target;this.isMenuItem(t)&&this.setCurrentItem(t)}handleSlotChange(){const e=this.getAllItems();this.handleUpdateCheckmarks(e),e.length>0&&this.setCurrentItem(e[0])}isMenuItem(e){var t;return e.tagName.toLowerCase()==="syn-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes((t=e.getAttribute("role"))!=null?t:"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>!(e.inert||!this.isMenuItem(e)))}getCurrentItem(){return this.getAllItems().find(e=>e.getAttribute("tabindex")==="0")}setCurrentItem(e){this.getAllItems().forEach(i=>{i.setAttribute("tabindex",i===e?"0":"-1")})}render(){return d`
      ...
      ></slot>
    `}};Re.styles=[z,Qa,Ya];o([m("slot")],Re.prototype,"defaultSlot",2);o([v()],Re.prototype,"hasMenuItemsWithCheckmarks",2);var Ja=c`
  /* Write custom CSS here */
`,es=c`
	/* stylelint-disable */
  :host {
...
`,Me=class extends _{constructor(){super(...arguments),this.localize=new V(this),this.value=0,this.label=""}updated(e){if(super.updated(e),e.has("value")){const t=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),i=2*Math.PI*t,a=i-this.value/100*i;this.indicatorOffset=`${a}px`}}render(){return d`
    ...
    `}};Me.styles=[z,ss,rs];o([m(".progress-ring__indicator")],Me.prototype,"indicator",2);o([v()],Me.prototype,"indicatorOffset",2);o([s({type:Number,reflect:!0})],Me.prototype,"value",2);o([s()],Me.prototype,"label",2);var ns="syn-progress-ring";Me.define("syn-progress-ring");w({displayName:"SynProgressRing",elementClass:Me,events:{},react:x,tagName:ns});var Ii=c`
	/* stylelint-disable */
  :host {
    display: inline-block;
    position: relative;
...
`,hs=B;B.define("syn-icon");var Oe=class extends _{constructor(){super(...arguments),this.hasSlotController=new W(this,"[default]","logo","label","meta-navigation","navigation"),this.localize=new V(this),this.label="",this.burgerMenu="hidden"}toggleBurgerMenu(){switch(this.burgerMenu){case"closed":this.burgerMenu="open";break;case"open":this.burgerMenu="closed";break}}handleBurgerMenuToggle(){this.sideNav&&!this.sideNav.rail&&(this.sideNav.open=!this.sideNav.open),this.toggleBurgerMenu()}updateBurgerMenuBasedOnSideNav(){this.sideNav&&(this.sideNav.rail?this.burgerMenu="hidden":this.burgerMenu=this.sideNav.open?"open":"closed")}handleBurgerMenu(){const e=`syn-burger-menu-${this.burgerMenu}`;this.emit(e)}connectedCallback(){super.connectedCallback(),this.mutationObserver=new MutationObserver(()=>this.updateBurgerMenuBasedOnSideNav())}firstUpdated(){const e=document.querySelector("syn-side-nav");this.connectSideNavigation(e)}disconnectedCallback(){super.disconnectedCallback(),this.mutationObserver.disconnect()}connectSideNavigation(e){this.mutationObserver.disconnect(),this.sideNav=e||document.querySelector("syn-side-nav"),this.sideNav&&(this.updateBurgerMenuBasedOnSideNav(),this.mutationObserver.observe(this.sideNav,{attributeFilter:["open","rail"],attributes:!0}))}render(){const e=this.hasSlotController.test("navigation"),t=this.burgerMenu!=="hidden";return J`
    ...
    `}};Oe.styles=[z,ms];Oe.dependencies={"syn-icon":hs};o([s()],Oe.prototype,"label",2);o([s({attribute:"burger-menu",reflect:!0})],Oe.prototype,"burgerMenu",2);o([v()],Oe.prototype,"sideNav",2);o([h("burgerMenu",{waitUntilFirstUpdate:!0})],Oe.prototype,"handleBurgerMenu",1);var gs="syn-header";Oe.define("syn-header");w({displayName:"SynHeader",elementClass:Oe,events:{onSynBurgerMenuClosed:"syn-burger-menu-closed",onSynBurgerMenuHidden:"syn-burger-menu-hidden",onSynBurgerMenuOpen:"syn-burger-menu-open"},react:x,tagName:gs});var fs="syn-icon-button";R.define("syn-icon-button");w({displayName:"SynIconButton",elementClass:R,events:{onSynBlur:"syn-blur",onSynFocus:"syn-focus"},react:x,tagName:fs});var ys="syn-icon";B.define("syn-icon");var vs=w({displayName:"SynIcon",elementClass:B,events:{onSynLoad:"syn-load",onSynError:"syn-error"},react:x,tagName:ys}),_s=c`
...
`,ft=class extends _{render(){return d`
    ...
    `}};ft.styles=[z,Is,As];ft.dependencies={"syn-divider":be};var Es="syn-menu-label";ft.define("syn-menu-label");w({displayName:"SynMenuLabel",elementClass:ft,events:{},react:x,tagName:Es});var Ts="syn-menu";Re.define("syn-menu");w({displayName:"SynMenu",elementClass:Re,events:{onSynSelect:"syn-select"},react:x,tagName:Ts});var Ls=c`
  :host {
...
`,Ce=class extends _{constructor(){super(...arguments),this.hasSlotController=new W(this,"prefix","suffix"),this.renderType="button",this.rel="noreferrer noopener"}setRenderType(){const e=this.defaultSlot.assignedElements({flatten:!0}).filter(t=>t.tagName.toLowerCase()==="syn-dropdown").length>0;if(this.href){this.renderType="link";return}if(e){this.renderType="dropdown";return}this.renderType="button"}hrefChanged(){this.setRenderType()}handleSlotChange(){this.setRenderType()}render(){return d`
    ...
    `}};Ce.styles=[z,pr,lr];o([m("slot:not([name])")],Ce.prototype,"defaultSlot",2);o([v()],Ce.prototype,"renderType",2);o([s()],Ce.prototype,"href",2);o([s()],Ce.prototype,"target",2);o([s()],Ce.prototype,"rel",2);o([h("href",{waitUntilFirstUpdate:!0})],Ce.prototype,"hrefChanged",1);var cr="syn-breadcrumb-item";Ce.define("syn-breadcrumb-item");w({displayName:"SynBreadcrumbItem",elementClass:Ce,events:{},react:x,tagName:cr});var dr=c`
  /* Write custom CSS here */
`,ur=c`
	/* stylelint-disable */
  .breadcrumb {
