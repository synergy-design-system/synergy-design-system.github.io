import{j as q,c as r,x as A,C as R,d as L}from"./iframe-OI-W47sE.js";import{S as P,c as B,n as c}from"./synergy-element-CDccwnU_.js";import{r as m}from"./icon.component-DZRgsOxP.js";import{a as N}from"./query-D0jTsbLw.js";import{o as U}from"./query-assigned-elements-CIlqV-be.js";import{o as j}from"./if-defined-CTCs6BF-.js";import{w as z}from"./watch-CEsCE2EF.js";import{S as H}from"./alert.component-pF2vbA7r.js";import{S as K}from"./tooltip.component-DoobPlRT.js";import{e as W}from"./decorator-CWkWRMhy.js";import"./input-C1K4cvWC.js";import"./button-C6KTTrBR.js";import{g as l,a as Y,s as G,b as J,c as Q}from"./component-C7EW-_mv.js";import"./preload-helper-PPVm8Dsz.js";import"./animation-registry-DyRYqZdt.js";import"./closeActiveElement-Bnbpk8Kw.js";import"./class-map-BXP5nj_A.js";import"./slot-9EVoRGQc.js";import"./localize-Dh03wnLC.js";import"./index-DihgwUfS.js";import"./event-B0iVuGLD.js";import"./icon-button.component-Dun_qe4y.js";import"./popup.component-5u9iTBSx.js";import"./functions-bkELIyT9.js";import"./default-value-B0eSr3SQ.js";import"./form-d9hCJUdr.js";import"./live-CXwkvnHJ.js";import"./form-control.styles-SUecHvVR.js";import"./divider.component-_RqfbsvR.js";import"./spinner.component-DNDvNCuE.js";import"./index-3hbeBem-.js";import"./_docs-DSlvmijE.js";const X=e=>(t,a)=>{a!==void 0?a.addInitializer(()=>{customElements.define(e,t)}):customElements.define(e,t)},Z=["blur","change","clear","focus","invalid","input","move"],k=(e,t)=>e.includes(t),x=e=>k(e,"blur"),F=e=>k(e,"invalid"),V=e=>e instanceof P,ee=(e="")=>e.split(" ").map(t=>t.trim()).filter(Boolean),I=(e,t)=>{const a=t.trim();return V(e)&&Z.includes(a)?`syn-${a}`:a},te=e=>{if(!V(e))return;const{size:t}=e;return t!=null?t:void 0},ae={"syn-checkbox":"input","syn-combobox":".combobox__value-input","syn-file":"input","syn-input":"input","syn-radio-group":"input","syn-range":".input__control","syn-select":".select__value-input","syn-switch":"input","syn-textarea":".textarea__control"},D=(e,t)=>e.shadowRoot?.querySelector(t)??null,ie=e=>{if(!e)return;if(!e.shadowRoot)return e;const t=e.tagName.toLowerCase(),a=ae[t];if(a){const s=D(e,a);if(s)return s}const i=D(e,"input,select,textarea");return i||e},se=q`
  .validate {
    display: flex;
