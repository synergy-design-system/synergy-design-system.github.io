import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{a as n,c as r,t as i}from"./lit-BVDl_-fF.js";import{U as a,_ as o,d as s,f as c,n as l,p as u,t as d}from"./iframe-BiSXA87W.js";import{d as f,f as p,i as m,p as h,u as g}from"./blocks-CBurUJA_.js";import{t as _}from"./button-6RBRhEco.js";import{t as v}from"./icon-BQD_aSf3.js";import{t as y}from"./select-ghDhf1Uh.js";import{t as b}from"./option-D8fwbCp_.js";import{n as x,r as S}from"./component-BZMStFjM.js";import{t as C}from"./details-rDat-VIU.js";import{n as w,t as T}from"./menu-item-BDzgx2O5.js";import{t as E}from"./dropdown-vvzkwNOf.js";import{t as D}from"./tag-group-DKTBPi52.js";import{t as O}from"./tag-DmUYTvM1.js";var k,A,j,M,N;e((()=>{k=t(a(),1),h(),i(),d(),S(),c(),o(),_(),C(),E(),w(),T(),b(),y(),D(),O(),v(),A={parameters:{chromatic:{...l?.parameters?.chromatic,disableSnapshot:!1,modes:u},design:s(`16648-52486`),docs:{description:{component:x(`tag-group`,`default`,`templates`)},page:()=>k.createElement(k.Fragment,null,k.createElement(p,null),k.createElement(f,null),k.createElement(m,null),k.createElement(g,{title:``}))}},tags:[`Feedback`,`Tags`,`Filter`],title:`Templates/Tag Group`},j={render:()=>{let e={filters:[{id:`filter-1`,name:`Housing`,options:[`metric`,`rectangular`],selected:[]},{id:`filter-2`,name:`Cable material`,options:[`PUR`,`PVC`],selected:[`PUR`]},{id:`filter-3`,name:`Length of cable`,options:[`0.2 m`,`0.3 m`,`0.7 m`,`0.23 m`,`2 m`],selected:[`0.2 m`,`0.3 m`,`0.7 m`,`0.23 m`]},{id:`filter-4`,name:`Electrical wiring`,options:[`AC 2-wire`,`DC 3-wire`,`DC 4-wire`],selected:[]},{id:`filter-5`,name:`Switching output`,options:[`NPN`,`PNP`],selected:[]},{id:`filter-6`,name:`Connection type`,options:[`Cable, 2-wire`,`Cable, 3-wire`,`Cable, 4-wire`],selected:[`Cable, 3-wire`]}],filtersOpen:!0,isMobile:!1},t=(e,t)=>r`
      <form class="filter-form">
        ...
        ${e.filters.some(e=>e.selected.length>0)?r`
          <div class="filter-tags">
            ${e.filters.filter(e=>e.selected.length>0).map(n=>r`
                <syn-tag-group
    ...
    `,i=document.createElement(`div`);return(()=>{let r,a,o=()=>{n(t(e,r),i)},s=t=>{e={...e,...t},o()},c=()=>{`ResizeObserver`in window&&(a=new ResizeObserver(t=>{if(t.length>0){let n=t[0].contentRect.width<=420;e.isMobile!==n&&s({isMobile:n})}}),setTimeout(()=>{let e=i.querySelector(`.filter-form`);e&&a&&a.observe(e)},0))},l={clearAllFilters:()=>{window.confirm(`Möchten Sie wirklich alle Filter entfernen?`)&&s({filters:e.filters.map(e=>({...e,selected:[]}))})},removeTag:(t,n)=>{s({filters:e.filters.map(e=>e.id===t?{...e,selected:e.selected.filter(e=>e!==n)}:e)})},toggleFilter:e=>{s({filtersOpen:e})},toggleOption:(t,n)=>{s({filters:e.filters.map(e=>{if(e.id===t){let t=e.selected.includes(n)?e.selected.filter(e=>e!==n):[...e.selected,n];return{...e,selected:t}}return e})})}};return r=l,o(),c(),{actions:l,cleanup:()=>{a&&a.disconnect()},rerender:o}})(),i}},M={...j,globals:{viewport:{value:`mobile2`}},name:`↳ Tablet`,parameters:{controls:{exclude:[`default`]}}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
  render: () => {
