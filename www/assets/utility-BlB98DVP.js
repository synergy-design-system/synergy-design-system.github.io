import{e as u}from"./class-map-J4m71D6f.js";import{k as h,c as g}from"./iframe-hncc6fn8.js";import{L as f}from"./controller-0nuky388.js";import{c as y,n as d,S as v}from"./synergy-element-ZP8Aphe2.js";import{S as m,r as a}from"./icon.component-uI_62ALx.js";import{a as b}from"./query-D0jTsbLw.js";import{w as l}from"./watch-CEsCE2EF.js";import{e as _}from"./decorator-jbWt9cIm.js";const x=h`
  :host {
    display: block;
...
`,z=(e,t)=>{const n=t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),s=new RegExp(n,"g");return e.replace(s,"_")};var k=Object.defineProperty,w=Object.getOwnPropertyDescriptor,i=(e,t,n,s)=>{for(var r=s>1?void 0:s?w(t,n):t,c=e.length-1,p;c>=0;c--)(p=e[c])&&(r=(s?p(t,n,r):p(r))||r);return s&&r&&k(t,n,r),r};let o=class extends v{constructor(){super(...arguments),this.localize=new f(this),this.originalValue="",this.isInitialized=!1,this.delimiter=" ",this.current=!1,this.selected=!1,this.hasHover=!1,this.value="",this.disabled=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.setAttribute("aria-selected","false")}handleDefaultSlotChange(){this.isInitialized?this.triggerParentDefaultSlotChange():this.isInitialized=!0}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleDelimiterChange(){this.sanitizeValueForDelimiter()}handleValueChange(){this.originalValue=this.value,this.sanitizeValueForDelimiter()}sanitizeValueForDelimiter(){let e=this.originalValue;if(typeof e=="number")return;typeof e!="string"&&(e=String(e));const{delimiter:t}=this;e.includes(t)&&(console.error(`Option values cannot include "${t}". All occurrences of "${t}" have been replaced with "_".`,this),e=z(e,this.delimiter)),this.value=e,this.triggerParentDefaultSlotChange()}getTextLabel(){const e=this.childNodes;let t="";return[...e].forEach(n=>{n.nodeType===Node.ELEMENT_NODE&&(n.hasAttribute("slot")||(t+=n.textContent)),n.nodeType===Node.TEXT_NODE&&(t+=n.textContent)}),t.trim()}triggerParentDefaultSlotChange(){customElements.whenDefined("syn-combobox").then(()=>{const e=this.closest("syn-combobox");e&&e.handleDefaultSlotChange()}),customElements.whenDefined("syn-select").then(()=>{const e=this.closest("syn-select");e&&e.handleDefaultSlotChange()})}render(){return g`
    ...
    `}};o.styles=[y,x];o.dependencies={"syn-icon":m};i([b(".option__label")],o.prototype,"defaultSlot",2);i([a()],o.prototype,"delimiter",2);i([a()],o.prototype,"current",2);i([a()],o.prototype,"selected",2);i([a()],o.prototype,"hasHover",2);i([d({reflect:!0})],o.prototype,"value",2);i([d({type:Boolean,reflect:!0})],o.prototype,"disabled",2);i([l("disabled")],o.prototype,"handleDisabledChange",1);i([l("selected")],o.prototype,"handleSelectedChange",1);i([l("delimiter")],o.prototype,"handleDelimiterChange",1);i([l("value")],o.prototype,"handleValueChange",1);o=i([_("SynOption")],o);const $=h`
  /**
...
`,N=e=>Array.isArray(e)||typeof e=="string"?e.length>0:typeof e=="number"?!0:!!e,P=(e,t)=>Array.isArray(e)&&Array.isArray(t)?e.length!==t.length?!1:e.every((n,s)=>n===t[s]):e===t;export{o as S,P as c,N as i,$ as s};
