import{e as P,t as A,a as F}from"./static-gmWA-8Kq.js";import{d as T}from"./default-value-DcEsLq7D.js";import{F as E}from"./form-d9hCJUdr.js";import{H as U}from"./slot-9EVoRGQc.js";import{E as M,T as O,i as $,x as b}from"./directive-helpers-DGrfjhaU.js";import{o as h}from"./if-defined-B2ZFWIyt.js";import{l as B}from"./live-DekCFwgv.js";import{L}from"./localize-CatY2peN.js";import{n as o}from"./property-BGzwfL48.js";import{a as j}from"./library-6WV9-XO2.js";import{a as H}from"./query-DAIS6qJ0.js";import{w as k}from"./watch-CEsCE2EF.js";import{c as K,S as R}from"./component.styles-Do19GEOY.js";import{f as q,a as G}from"./form-control.custom.styles-DbPhNFMw.js";import{S as W}from"./icon.component-CmAczTJK.js";import{S as Z}from"./divider.component-KO_YE4Ha.js";import{f as J}from"./async-directive-PIeysb9D.js";import{m as V,n as v,c as Q}from"./functions-CDi3doZH.js";import{e as X}from"./decorator-DANECR0-.js";class Y extends J{constructor(i){if(super(i),this.handlePointerDown=e=>{e.button!==0||this.host.disabled||this.spinOnLongPressCallback(e)},this.handlePointerUp=e=>{e?.preventDefault(),e?.stopPropagation(),this.timeout&&this.callbacks.start(),this.stopSpinningAndCleanUp(),this.callbacks.end(),document.removeEventListener("pointerup",this.handlePointerUp)},i.type!==A.ELEMENT||!(i.element instanceof HTMLButtonElement))throw new Error("The `longPress` directive must be used on an HTMLButtonElement.")}render(i){return M}update(i,[e]){return this.callbacks===void 0&&this.host===void 0&&(this.host=i.element,this.callbacks={...e},this.host.addEventListener("pointerdown",this.handlePointerDown)),O}reconnected(){this.host.addEventListener("pointerdown",this.handlePointerDown)}disconnected(){this.stopSpinningAndCleanUp(),this.host.removeEventListener("pointerdown",this.handlePointerDown),document.removeEventListener("pointerup",this.handlePointerUp)}spinOnLongPressCallback(i){i.preventDefault(),i.stopPropagation(),this.timeout=setTimeout(()=>{this.timeout=void 0,this.interval=setInterval(()=>{this.callbacks.start()},50)},500),document.addEventListener("pointerup",this.handlePointerUp),this.observer?.disconnect(),this.observer=new MutationObserver(e=>{e.forEach(r=>{r.attributeName==="disabled"&&this.stopSpinningAndCleanUp()})}),this.observer.observe(this.host,{attributes:!0})}stopSpinningAndCleanUp(){clearInterval(this.interval),clearTimeout(this.timeout),this.observer?.disconnect()}}const z=P(Y),tt=$`
	/* stylelint-disable */
  :host {
    display: block;
...
`,et=(t,i,e={})=>{const{maximumFractionDigits:r,minimumFractionDigits:a,...l}=e,p=(i==="any"||!i?1:+i).toString().split(".")[1]?.length||0;let u,m;const w=typeof a=="number",S=typeof r=="number";return w&&!S?(u=a,m=a):S&&!w?(u=r,m=r):w&&S&&(u=Math.min(a,r),m=Math.max(a,r)),p>(u||0)&&(u=p),p>(m||0)&&(m=p),typeof u<"u"&&u>100&&(u=100),typeof m<"u"&&m>100&&(m=100),new Intl.NumberFormat("en-US",{maximumFractionDigits:m,minimumFractionDigits:u,useGrouping:!1,...l}).format(t)};var nt=Object.defineProperty,st=Object.getOwnPropertyDescriptor,I=t=>{throw TypeError(t)},s=(t,i,e,r)=>{for(var a=r>1?void 0:r?st(i,e):i,l=t.length-1,d;l>=0;l--)(d=t[l])&&(a=(r?d(i,e,a):d(a))||a);return r&&a&&nt(i,e,a),a},D=(t,i,e)=>i.has(t)||I("Cannot "+e),f=(t,i,e)=>(D(t,i,"read from private field"),e?e.call(t):i.get(t)),N=(t,i,e)=>i.has(t)?I("Cannot add the same private member more than once"):i instanceof WeakSet?i.add(t):i.set(t,e),C=(t,i,e,r)=>(D(t,i,"write to private field"),i.set(t,e),e),g=(t,i,e)=>(D(t,i,"access private method"),e),c,y,x,_;let n=class extends R{constructor(){super(...arguments),N(this,y),this.formControlController=new E(this,{assumeInteractionOn:["syn-blur","syn-input"]}),this.hasSlotController=new U(this,"help-text","label","prefix","suffix"),this.localize=new L(this),this.hasFocus=!1,this.title="",this.__numberInput=Object.assign(document.createElement("input"),{type:"number"}),this.__dateInput=Object.assign(document.createElement("input"),{type:"date"}),this.type="text",this.name="",this.value="",this.defaultValue="",this.size="medium",this.label="",this.helpText="",this.clearable=!1,this.disabled=!1,this.placeholder="",this.readonly=!1,this.passwordToggle=!1,this.passwordVisible=!1,this.noSpinButtons=!1,this.form="",this.required=!1,this.spellcheck=!0,N(this,c,v)}set numericStrategy(t){switch(typeof t){case"string":C(this,c,t==="modern"?V:v);break;case"object":C(this,c,Q(t));break;default:C(this,c,v)}}get numericStrategy(){return f(this,c)}get valueAsDate(){return this.__dateInput.type=this.type,this.__dateInput.value=this.value,this.input?.valueAsDate||this.__dateInput.valueAsDate}set valueAsDate(t){this.__dateInput.type=this.type,this.__dateInput.valueAsDate=t,this.value=this.__dateInput.value}get valueAsNumber(){return this.__numberInput.value=this.value,this.input?.valueAsNumber||this.__numberInput.valueAsNumber}set valueAsNumber(t){this.__numberInput.valueAsNumber=t,this.value=this.__numberInput.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleStep(){this.handleInput(),this.input.focus()}handleStepUp(){this.stepUp(),this.handleStep()}handleStepDown(){this.stepDown(),this.handleStep()}isDecrementDisabled(){if(this.disabled||this.readonly)return!0;if(this.min===void 0||this.min===null)return!1;const t=typeof this.min=="string"?parseFloat(this.min):this.min;return parseFloat(this.value)<=t}isIncrementDisabled(){if(this.disabled||this.readonly)return!0;if(this.max===void 0||this.max===null)return!1;const t=typeof this.max=="string"?parseFloat(this.max):this.max;return parseFloat(this.value)>=t}handleNumericStrategyAutoClamp(){const{valueAsNumber:t,max:i,min:e}=this;if(!f(this,c).autoClamp)return{eventObj:null,shouldClamp:!1,nextValue:t};const r=typeof e=="string"?parseFloat(e):e,a=typeof i=="string"?parseFloat(i):i;let l=t,d="";l<r?(l=r,d="min"):l>a&&(l=a,d="max");const p=d?{detail:{clampedTo:d,lastUserValue:t}}:null;return{eventObj:p,shouldClamp:!!p,nextValue:l}}handleChange(){if(this.type==="number"&&(g(this,y,_).call(this)||f(this,c).autoClamp)){const{eventObj:t,shouldClamp:i,nextValue:e}=this.handleNumericStrategyAutoClamp();let r=f(this,c).autoClamp?e:this.valueAsNumber;if(isNaN(r)){const{max:a,min:l}=this;a!=null?r=typeof a=="string"?parseFloat(a):+a:l!=null?r=typeof l=="string"?parseFloat(l):+l:r=0}this.value=g(this,y,_).call(this)?g(this,y,x).call(this,r):r.toString(),this.updateComplete.then(()=>{i&&t&&this.emit("syn-clamp",t),this.formControlController.updateValidity(),this.emit("syn-change")});return}this.value=this.input.value,this.emit("syn-change")}handleClearClick(t){t.preventDefault(),this.value!==""&&(this.value="",this.emit("syn-clear"),this.emit("syn-input"),this.emit("syn-change")),this.input.focus()}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleInput(){this.value=this.input.value,this.formControlController.updateValidity(),this.emit("syn-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}handleKeyDown(t){if(f(this,c).noStepAlign&&this.type==="number"){const{key:e}=t;if(e==="ArrowUp"||e==="ArrowDown"){t.preventDefault(),t.stopPropagation(),e==="ArrowUp"?this.handleStepUp():e==="ArrowDown"&&this.handleStepDown(),this.handleChange();return}}const i=t.metaKey||t.ctrlKey||t.shiftKey||t.altKey;t.key==="Enter"&&!i&&setTimeout(()=>{!t.defaultPrevented&&!t.isComposing&&this.formControlController.submit()})}handlePasswordToggle(){this.passwordVisible=!this.passwordVisible}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStepChange(){f(this,c).noStepValidation||(this.input.step=String(this.step),this.formControlController.updateValidity())}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(t){this.input.focus(t)}blur(){this.input.blur()}select(){this.input.select()}setSelectionRange(t,i,e="none"){this.input.setSelectionRange(t,i,e)}setRangeText(t,i,e,r="preserve"){const a=i??this.input.selectionStart,l=e??this.input.selectionEnd;this.input.setRangeText(t,a,l,r),this.value!==this.input.value&&(this.value=this.input.value)}showPicker(){"showPicker"in HTMLInputElement.prototype&&this.input.showPicker()}stepUp(){if(f(this,c).noStepAlign){const{max:t,step:i,valueAsNumber:e}=this,r=Number.isNaN(e)?0:e,a=typeof this.min=="string"?parseFloat(this.min):this.min,l=typeof t=="string"?parseFloat(t):t,d=typeof i>"u"||i===null||i==="any"?1:typeof i=="number"?i:parseFloat(i);let p=r+d;typeof l=="number"&&l<p?p=l:typeof a=="number"&&a>p&&(p=a);const u=g(this,y,_).call(this)?g(this,y,x).call(this,p):p.toString();this.input.value=u,this.value!==this.input.value&&(this.value=this.input.value);return}this.input.stepUp(),this.value!==this.input.value&&(this.value=this.input.value)}stepDown(){if(f(this,c).noStepAlign){const{min:t,max:i,step:e,valueAsNumber:r}=this,a=Number.isNaN(r)?0:r,l=typeof t=="string"?parseFloat(t):t,d=typeof i=="string"?parseFloat(i):i,p=typeof e>"u"||e===null||e==="any"?1:typeof e=="number"?e:parseFloat(e);let u=a-p;typeof l=="number"&&l>u?u=l:typeof d=="number"&&d<u&&(u=d);const m=g(this,y,_).call(this)?g(this,y,x).call(this,u):u.toString();this.input.value=m,this.value!==this.input.value&&(this.value=this.input.value);return}this.input.stepDown(),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("label"),i=this.hasSlotController.test("help-text"),e=this.hasSlotController.test("prefix"),r=this.hasSlotController.test("suffix"),a=this.label?!0:!!t,l=this.helpText?!0:!!i,p=this.clearable&&!this.disabled&&!this.readonly&&(typeof this.value=="number"||this.value.length>0);return b`
    ...
    `}};c=new WeakMap;y=new WeakSet;x=function(t){return et(t,this.step,{maximumFractionDigits:this.maxFractionDigits,minimumFractionDigits:this.minFractionDigits,...this.numberFormatterOptions})};_=function(){const{numberFormatterOptions:t,maxFractionDigits:i,minFractionDigits:e,step:r}=this,a=typeof i<"u"&&!Number.isNaN(i),l=typeof e<"u"&&!Number.isNaN(e);return a||l||typeof t=="object"?!0:((r==="any"||!r?1:+r).toString().split(".")[1]?.length||0)>0};n.styles=[K,q,tt,G,it];n.dependencies={"syn-icon":W,"syn-divider":Z};s([H(".input__control")],n.prototype,"input",2);s([j()],n.prototype,"hasFocus",2);s([o({reflect:!0})],n.prototype,"title",2);s([o({reflect:!0})],n.prototype,"type",2);s([o()],n.prototype,"name",2);s([o()],n.prototype,"value",2);s([T()],n.prototype,"defaultValue",2);s([o({reflect:!0})],n.prototype,"size",2);s([o()],n.prototype,"label",2);s([o({attribute:"help-text"})],n.prototype,"helpText",2);s([o({type:Boolean})],n.prototype,"clearable",2);s([o({type:Boolean,reflect:!0})],n.prototype,"disabled",2);s([o()],n.prototype,"placeholder",2);s([o({type:Boolean,reflect:!0})],n.prototype,"readonly",2);s([o({attribute:"password-toggle",type:Boolean})],n.prototype,"passwordToggle",2);s([o({attribute:"password-visible",type:Boolean})],n.prototype,"passwordVisible",2);s([o({attribute:"no-spin-buttons",type:Boolean})],n.prototype,"noSpinButtons",2);s([o({reflect:!0})],n.prototype,"form",2);s([o({type:Boolean,reflect:!0})],n.prototype,"required",2);s([o()],n.prototype,"pattern",2);s([o({type:Number})],n.prototype,"minlength",2);s([o({type:Number})],n.prototype,"maxlength",2);s([o()],n.prototype,"min",2);s([o()],n.prototype,"max",2);s([o()],n.prototype,"step",2);s([o()],n.prototype,"autocapitalize",2);s([o()],n.prototype,"autocorrect",2);s([o()],n.prototype,"autocomplete",2);s([o({type:Boolean})],n.prototype,"autofocus",2);s([o()],n.prototype,"enterkeyhint",2);s([o({type:Boolean,converter:{fromAttribute:t=>!(!t||t==="false"),toAttribute:t=>t?"true":"false"}})],n.prototype,"spellcheck",2);s([o()],n.prototype,"inputmode",2);s([o({attribute:!1,reflect:!1,type:Object})],n.prototype,"numberFormatterOptions",2);s([o({attribute:"min-fraction-digits",type:Number})],n.prototype,"minFractionDigits",2);s([o({attribute:"max-fraction-digits",type:Number})],n.prototype,"maxFractionDigits",2);s([o({attribute:"numeric-strategy",converter:{fromAttribute:t=>t==="modern"?V:v},type:Object})],n.prototype,"numericStrategy",1);s([k("disabled",{waitUntilFirstUpdate:!0})],n.prototype,"handleDisabledChange",1);s([k("step",{waitUntilFirstUpdate:!0})],n.prototype,"handleStepChange",1);s([k("value",{waitUntilFirstUpdate:!0})],n.prototype,"handleValueChange",1);n=s([X("SynInput")],n);n.define("syn-input");
