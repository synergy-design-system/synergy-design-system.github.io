import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Pt as n,Rt as r,Ut as i,d as ee,f as te,g as ne,u as re}from"./iframe-CkET12W3.js";import{n as ie,t as ae}from"./if-defined-XNov7IIP.js";import{a as oe,c as se,h as ce,i as a,m as o,n as s,o as le,p as c,r as l,s as u,t as d,u as ue}from"./synergy-element-CyJGxssW.js";import{n as f,t as p}from"./watch-0Lf6m-Da.js";import{n as m,t as de}from"./decorator-C8FY8E2M.js";import{t as fe}from"./button-CpKx43QA.js";import{a as pe,i as me,n as h,o as he,r as ge,t as g}from"./component-B473QWuz.js";import{n as _,t as _e}from"./taggedTemplateLiteral-DxWpUJWn.js";import{n as ve,t as ye}from"./alert.component-bB6F0T41.js";import{n as be,t as xe}from"./tooltip.component-Bf2FkQsO.js";import{t as Se}from"./input-90NTdGJt.js";var v,y,b,x,S,C,w,T,E,D,O,k=e((()=>{s(),v=[`blur`,`change`,`clear`,`focus`,`invalid`,`input`,`move`],y=(e,t)=>e.includes(t),b=e=>y(e,`blur`),x=e=>y(e,`invalid`),S=e=>e instanceof d,C=(e=``)=>e.split(` `).map(e=>e.trim()).filter(Boolean),w=(e,t)=>{let n=t.trim();return S(e)&&v.includes(n)?`syn-${n}`:n},T=e=>{if(!S(e))return;let{size:t}=e;return t??void 0},E={"syn-checkbox":`input`,"syn-combobox":`.combobox__value-input`,"syn-file":`input`,"syn-input":`input`,"syn-radio-group":`input`,"syn-range":`.input__control`,"syn-select":`.select__value-input`,"syn-switch":`input`,"syn-textarea":`.textarea__control`},D=(e,t)=>e.shadowRoot?.querySelector(t)??null,O=e=>{if(!e)return;if(!e.shadowRoot)return e;let t=E[e.tagName.toLowerCase()];if(t){let n=D(e,t);if(n)return n}return D(e,`input,select,textarea`)||e}})),A,Ce=e((()=>{t(),A=i`
  .validate {
    display: flex;
