import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,d as r,f as i,g as a,u as o}from"./iframe-DVxLZS-s.js";import{t as s}from"./icon-B6NqE4U1.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-DniQwiZV.js";import{t as m}from"./option-C_9nm3-W.js";import{t as h}from"./select-geY1X-RY.js";import{n as g,t as _}from"./select-C308rKsn.js";var v,y,b,x,S,C,w,T,E,D,O;e((()=>{m(),h(),s(),t(),_(),f(),r(),a(),{args:v,argTypes:y}=l(`syn-option`),{overrideArgs:b}=c(`syn-option`),{generateTemplate:x}=d(`syn-option`),S={args:b([{name:`default`,type:`slot`,value:`Option 1`},{name:`value`,type:`attribute`,value:`Option_1`}],v),argTypes:y,component:`syn-option`,parameters:{design:o(`41325-312743`),docs:{chromatic:{modes:i},description:{component:u(`option`,`default`)},story:{height:`250px`}}},tags:[`Form`],title:`Components/syn-option`},C={parameters:{docs:{description:{story:u(`option`,`default`)}}},render:e=>n`
  ...
  `},T={parameters:{docs:{description:{story:u(`option`,`prefix-suffix`)}}},render:()=>n`
    <syn-select label="Select one">
  ...
  heightPx: 400
})`,...D.parameters?.docs?.source}}},O=[`Default`,`Disabled`,`PrefixAndSuffix`,`Screenshot`]}))();export{C as Default,w as Disabled,T as PrefixAndSuffix,D as Screenshot,O as __namedExportsOrder,S as default};