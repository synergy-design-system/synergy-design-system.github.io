import"./icon-button-CGeIfjdQ.js";import{C as u,c as t,d}from"./iframe-CfKmpROb.js";import{g as e,a as b,s as y,b as g,c as f}from"./component-CDJDa1-b.js";import{p as S}from"./PaddingDecorator-D47DJ8sS.js";import"./icon-button.component-B3ct88uZ.js";import"./class-map-DuCXFyun.js";import"./if-defined-DcCHMlyu.js";import"./synergy-element-D6uzLjd8.js";import"./icon.component-BOIuuAKO.js";import"./watch-CEsCE2EF.js";import"./query-D0jTsbLw.js";import"./decorator-jbWt9cIm.js";import"./functions-DCU90qiI.js";import"./preload-helper-PPVm8Dsz.js";import"./index-3hbeBem-.js";import"./_docs-VWJ8UqMU.js";const{args:z,argTypes:h}=y("syn-icon-button"),{overrideArgs:w}=f("syn-icon-button"),{generateTemplate:W}=g("syn-icon-button"),U={args:w([{name:"name",type:"attribute",value:"wallpaper"},{name:"label",type:"attribute",value:"Wallpaper"},{name:"size",type:"attribute",value:"medium"}],z),argTypes:h,component:"syn-icon-button",parameters:{chromatic:{modes:u},design:d("41137-747935"),docs:{description:{component:e("icon-button","default")}}},tags:["Form","Navigation","Icons"],title:"Components/syn-icon-button"},r={parameters:{controls:{disable:!1},docs:{description:{story:e("icon-button","default")}}},render:p=>W({args:p})},n={parameters:{docs:{description:{story:e("icon-button","sizes")}}},render:()=>t`
  ...
  </style>`},c=b({Default:r,Sizes:n,Colors:a,LinkButton:s,Disabled:o,Label:l});r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
