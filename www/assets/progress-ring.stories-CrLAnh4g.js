import{i as e}from"./preload-helper-xPQekRTU.js";import{Ht as t,It as n,d as r,f as i,g as a,qt as o,u as s}from"./iframe-BjJCO_Oc.js";import{n as c,t as l}from"./localize-CzgwcyM2.js";import{_ as u,a as d,f,i as p,n as m,o as h,r as g,s as _,t as v,y}from"./synergy-element-C6zHV5cB.js";import{t as b}from"./button-Cq0pTj4t.js";import{t as x}from"./icon-BS9OsfYG.js";import{a as S,i as C,n as w,o as T,r as E,t as D}from"./component-Bp0Gg8Fw.js";import{n as O,t as k}from"./taggedTemplateLiteral-pWa2IaV6.js";var A,j=e((()=>{n(),A=o`
	/* stylelint-disable */
  :host {
    --size: 128px;
    --track-width: 4px;
...
`})),P,F=e((()=>{n(),l(),_(),h(),m(),j(),N(),p(),P=class extends v{constructor(...e){super(...e),this.localize=new c(this),this.value=0,this.label=``}static{this.styles=[d,A,M]}updated(e){if(super.updated(e),e.has(`value`)){let e=parseFloat(getComputedStyle(this.indicator).getPropertyValue(`r`)),t=2*Math.PI*e,n=t-this.value/100*t;this.indicatorOffset=`${n}px`}}render(){return t`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
