import{W as f,j as r,M as b,a as v}from"./blocks-DF3rWpnz.js";import{useMDXComponents as w}from"./index-CMJgcIRb.js";import{r as E,j as x}from"./iframe-PfQ-yHii.js";const{STORY_CHANGED:T,SELECT_STORY:k}=__STORYBOOK_MODULE_CORE_EVENTS__,{global:S}=__STORYBOOK_MODULE_GLOBAL__,{makeDecorator:R,addons:u}=__STORYBOOK_MODULE_PREVIEW_API__;var A=Object.defineProperty,C=(e,n)=>{for(var s in n)A(e,s,{get:n[s],enumerable:!0})},_="links",{document:m,HTMLElement:I}=S;function M(e){let n={},s=(e[0]==="?"?e.substring(1):e).split("&").filter(Boolean);for(let t=0;t<s.length;t++){let o=s[t].split("=");n[decodeURIComponent(o[0])]=decodeURIComponent(o[1]||"")}return n}var c=e=>u.getChannel().emit(k,e),H=(e,n)=>new Promise(s=>{let{location:t}=m,o=M(t.search).id,i=e||o.split("--",2)[0],l=`/story/${f(i,n)}`,d=t.pathname.replace(/iframe\.html$/,""),g=`${t.origin+d}?${Object.entries({path:l}).map(h=>`${h[0]}=${h[1]}`).join("&")}`;s(g)}),y=e=>{let{target:n}=e;if(!(n instanceof I))return;let s=n,{sbKind:t,sbStory:o}=s.dataset;(t||o)&&(e.preventDefault(),c({kind:t,story:o}))},a=!1,O=()=>{a||(a=!0,m.addEventListener("click",y))},N=()=>{a&&(a=!1,m.removeEventListener("click",y))},L=R({name:"withLinks",parameterName:_,wrapper:(e,n)=>(O(),u.getChannel().once(T,N),e(n))});const{definePreview:G}=__STORYBOOK_MODULE_PREVIEW_API__;var D={};C(D,{decorators:()=>F});var F=[L];const B=`# Handling breaking changes between major versions
