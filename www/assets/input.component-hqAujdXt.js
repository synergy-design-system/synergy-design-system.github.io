import{i as e}from"./preload-helper-xPQekRTU.js";import{Ht as t,I as n,It as r,N as i,P as a,Vt as o,qt as s,z as c,zt as l}from"./iframe-BLAzlACc.js";import{n as u,t as d}from"./class-map-C6rhpuKM.js";import{r as f,t as p}from"./form-CV4G6JGX.js";import{r as m,t as ee}from"./slot-DgcqpP0-.js";import{r as h,t as g}from"./if-defined-DgNo7cOm.js";import{n as _,t as v}from"./localize-CzgwcyM2.js";import{_ as y,a as b,f as x,i as S,n as te,o as ne,r as C,s as w,t as T,y as E}from"./synergy-element-A58418dp.js";import{n as D,t as O}from"./watch-I6gMK-uE.js";import{n as k,t as A}from"./icon.component-A0zaE6-F.js";import{c as j,l as M,s as N,u as P}from"./functions-0i7OBIR0.js";import{n as F,t as I}from"./decorator-ChmomMqD.js";import{r as L,t as re}from"./live-CLjDlZjR.js";import{n as R,t as z}from"./divider.component-DmyHtxc1.js";import{n as B,t as V}from"./default-value-CEFjXaGA.js";import{n as H,t as U}from"./form-control.styles-Byg1ZVHO.js";var W,G,K=e((()=>{r(),i(),W=class extends a{constructor(e){if(super(e),this.handlePointerDown=e=>{e.button!==0||this.host.disabled||this.spinOnLongPressCallback(e)},this.handlePointerUp=e=>{e?.preventDefault(),e?.stopPropagation(),this.timeout&&this.callbacks.start(),this.stopSpinningAndCleanUp(),this.callbacks.end(),document.removeEventListener(`pointerup`,this.handlePointerUp)},e.type!==c.ELEMENT||!(e.element instanceof HTMLButtonElement))throw Error("The `longPress` directive must be used on an HTMLButtonElement.")}render(e){return l}update(e,[t]){return this.callbacks===void 0&&this.host===void 0&&(this.host=e.element,this.callbacks={...t},this.host.addEventListener(`pointerdown`,this.handlePointerDown)),o}reconnected(){this.host.addEventListener(`pointerdown`,this.handlePointerDown)}disconnected(){this.stopSpinningAndCleanUp(),this.host.removeEventListener(`pointerdown`,this.handlePointerDown),document.removeEventListener(`pointerup`,this.handlePointerUp)}spinOnLongPressCallback(e){e.preventDefault(),e.stopPropagation(),this.timeout=setTimeout(()=>{this.timeout=void 0,this.interval=setInterval(()=>{this.callbacks.start()},50)},500),document.addEventListener(`pointerup`,this.handlePointerUp),this.observer?.disconnect(),this.observer=new MutationObserver(e=>{e.forEach(e=>{e.attributeName===`disabled`&&this.stopSpinningAndCleanUp()})}),this.observer.observe(this.host,{attributes:!0})}stopSpinningAndCleanUp(){clearInterval(this.interval),clearTimeout(this.timeout),this.observer?.disconnect()}},G=n(W)})),q,J=e((()=>{r(),q=s`
	/* stylelint-disable */
  :host {
    display: block;
