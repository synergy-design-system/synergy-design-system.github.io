import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{h as t,t as n}from"./lit-D4-0ovri.js";import{f as r,g as i,p as a}from"./library-BTrITrk7.js";import{a as o,d as s,l as c,n as l,o as u,r as d,s as f,t as p}from"./synergy-element-Di-hMrpy.js";import{t as m}from"./query-DOHNhzf6.js";import{r as h,t as g}from"./if-defined-BN5mMhH6.js";import{n as _,t as v}from"./class-map-LsJiuvgY.js";import{r as y,t as b}from"./slot-CUH75lUH.js";import{n as x}from"./watch-Q8hEwzVb.js";import{n as S,t as C}from"./icon.component-C5O4LU7A.js";import{n as w,t as T}from"./divider.component-D_Q9z7hz.js";var E;function D(){return(D=e((()=>{n(),E=t`
  /**
...
`})))()}var O;function k(){return(k=e((()=>{v(),r(),f(),g(),w(),S(),y(),l(),u(),D(),O=class extends p{constructor(...e){super(...e),this.hasSlotController=new b(this,`[default]`,`children`,`prefix`,`suffix`),this.hasFocus=!1,this.showPrefixOnly=!1,this.currentMarkedChild=!1,this.isMultiLine=!1,this.rel=`noreferrer noopener`,this.current=!1,this.disabled=!1,this.horizontal=!1,this.chevron=!1,this.open=!1,this.divider=!1}static{this.styles=[o,E]}static{this.dependencies={"syn-divider":T,"syn-icon":C}}isButton(){return!this.href&&!this.hasSlotController.test(`children`)}isLink(){return!!this.href&&!this.hasSlotController.test(`children`)}isAccordion(){return this.hasSlotController.test(`children`)}getNavItemChildren(e){return Array.from(e?.assignedElements({flatten:!0})||[]).map(e=>e.tagName.toLowerCase()===`syn-nav-item`?e:Array.from(e.querySelectorAll(`:scope > syn-nav-item`))).flat()}getAllNestedNavItems(e){let t=this.getNavItemChildren(e),n=t.map(e=>e.getAllNestedNavItems(e.childrenSlot)).flat();return t.concat(n)}handleCurrentMarkedChild(){let e=this.closest(`syn-side-nav`);(!this.open||e?.variant===`rail`)&&(this.currentMarkedChild=this.getAllNestedNavItems(this.childrenSlot).some(e=>e.current))}handleClickButton(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}handleClickSummary(e){e.preventDefault(),e.stopPropagation(),!this.disabled&&(this.open?this.hideDetails():this.showDetails())}hideDetails(){this.open=!1,this.emit(`syn-hide`,{cancelable:!0})}showDetails(){this.open=!0,this.emit(`syn-show`,{cancelable:!0})}handleSlotChange(){let e=getComputedStyle(this).getPropertyValue(`--indentation`);if(e===``){requestAnimationFrame(()=>{this.handleSlotChange()});return}this.handleCurrentMarkedChild();let t=Math.min(parseInt(e,10)+1,2);this.getNavItemChildren(this.childrenSlot).forEach(e=>{e.style.setProperty(`--indentation`,t.toFixed(0))})}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleWidth(e){e.forEach(e=>{requestAnimationFrame(()=>{if(e.contentRect.width<100){let e=this.hasSlotController.test(`prefix`);this.showPrefixOnly=e}else this.showPrefixOnly=!1;this.isMultiLine=e.contentRect.height>48})})}handleHorizontalChange(){this.horizontal?this.resizeObserver.disconnect():this.resizeObserver.observe(this)}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>this.handleWidth(e)),this.horizontal||this.resizeObserver.observe(this)}firstUpdated(e){super.firstUpdated(e),this.mutationObserver=new MutationObserver(()=>{this.childrenSlot&&this.handleCurrentMarkedChild()}),this.mutationObserver.observe(this,{attributeFilter:[`current`,`open`],childList:!0,subtree:!0})}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect(),this.mutationObserver?.disconnect()}blur(){this.control.blur()}click(){this.control.click()}focus(e){this.control.focus(e)}render(){let e=this.isButton(),t=this.isLink(),n=this.isAccordion(),r=this.closest(`syn-side-nav`),o=this.currentMarkedChild&&!this.open||this.currentMarkedChild&&this.open&&r?.variant===`rail`&&!r?.open,s=a`button`;n?s=a`summary`:t&&(s=a`a`);let c=(this.chevron||n)&&!this.horizontal,l;n?l=this.handleClickSummary:e&&(l=this.handleClickButton);let u=i`
      ...
      >
        ...
        ${this.divider&&!this.horizontal?i`<syn-divider class="divider" part="divider"></syn-divider>`:``}
    ...
    `:u}},d([c()],O.prototype,`hasFocus`,void 0),d([c()],O.prototype,`showPrefixOnly`,void 0),d([c()],O.prototype,`currentMarkedChild`,void 0),d([c()],O.prototype,`isMultiLine`,void 0),d([m(`slot[name="children"]`)],O.prototype,`childrenSlot`,void 0),d([m(`.nav-item`)],O.prototype,`control`,void 0),d([s({reflect:!0,type:String})],O.prototype,`href`,void 0),d([s()],O.prototype,`target`,void 0),d([s()],O.prototype,`rel`,void 0),d([s({reflect:!0,type:Boolean})],O.prototype,`current`,void 0),d([s({reflect:!0,type:Boolean})],O.prototype,`disabled`,void 0),d([s({reflect:!0,type:Boolean})],O.prototype,`horizontal`,void 0),d([s({reflect:!0,type:Boolean})],O.prototype,`chevron`,void 0),d([s({reflect:!0,type:Boolean})],O.prototype,`open`,void 0),d([s({reflect:!0,type:Boolean})],O.prototype,`divider`,void 0),d([x(`horizontal`,{waitUntilFirstUpdate:!0})],O.prototype,`handleHorizontalChange`,null)})))()}export{k as n,O as t};