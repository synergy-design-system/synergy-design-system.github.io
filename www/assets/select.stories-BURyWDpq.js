import{g as M}from"./preview-CmgmDqI3.js";import{x as n}from"./lit-element-DILkAbkc.js";import{u as P}from"./index-BY-rbqZU.js";import{o as L}from"./select-Bz38Y8zt.js";import{s as z,a as w,g as o,b as q,c as k}from"./component-DxU6OxXl.js";import"./index-B3ehnkiM.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon.component-7B7zNgNb.js";import"./directive-helpers-DbZfDV3x.js";import"./icon-button-BDdQ3v9d.js";import"./icon-D0WpraVk.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-BQOBZeGB.js";var x=Object.freeze,H=Object.defineProperty,f=(e,t)=>x(H(e,"raw",{value:x(t||e.slice())})),_,T,E;const{args:D,argTypes:C}=z("syn-select"),{overrideArgs:I}=k("syn-select"),{generateTemplate:U}=w("syn-select"),nn={args:D,argTypes:C,component:"syn-select",parameters:{design:M("5069-7562"),docs:{description:{component:o("select","default")},story:{height:"250px"}}},title:"Components/syn-select"},s={parameters:{args:I({name:"default",type:"slot",value:`
  ...
  `},u={parameters:{docs:{description:{story:o("select","initialvalue")}}},render:()=>n(_||(_=f([`
  ...
  `},v={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:o("select","invalid")}}},play:async({canvasElement:e})=>{try{const t=e.querySelector("form"),$=t.querySelector("syn-select"),S=t.querySelector("syn-button");S&&$&&(await P.click(S),S.click())}catch(t){console.error("Error in play function:",t)}},render:()=>n`
  ...
  `},O={parameters:{docs:{description:{story:o("select","prefix")}}},render:()=>n`
  ...
  `},g={parameters:{docs:{description:{story:o("select","gettag")}}},render:()=>n(T||(T=f([`
    <syn-select
      clearable
  ...
  afterRender: openSelect('syn-select'),
  heightPx: 400
})`,...h.parameters?.docs?.source}}};const on=["Default","Labels","HelpText","Placeholder","Clearable","Focus","Disabled","Multiple","SettingInitialValues","GroupingOptions","Sizes","Invalid","PrefixIcons","CustomTags","ScreenshotDefault","ScreenshotMultiple"];export{a as Clearable,g as CustomTags,s as Default,c as Disabled,r as Focus,m as GroupingOptions,p as HelpText,v as Invalid,i as Labels,y as Multiple,l as Placeholder,O as PrefixIcons,b as ScreenshotDefault,h as ScreenshotMultiple,u as SettingInitialValues,d as Sizes,on as __namedExportsOrder,nn as default};
