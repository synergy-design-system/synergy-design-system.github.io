...
`,B={args:T([{name:"default",type:"slot",value:o().trim()}],g),argTypes:f,component:"syn-table",parameters:{chromatic:{modes:p},design:y("41227-220286"),docs:{description:{component:i}}},tags:["Structure","Styles"],title:"Styles/syn-table"},s={parameters:{controls:{disable:!1},docs:{description:{story:i}}},render:c=>C(c,"table")},t={render:()=>n`
