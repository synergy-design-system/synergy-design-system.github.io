import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{_ as t,a as n,h as r,l as i}from"./preview-DRz18Lsn.js";import{c as a,t as o}from"./lit-D4-0ovri.js";import{t as s}from"./icon-BbsmBxau.js";import{i as c,n as l,r as u,t as d}from"./component-NnlguzJ1.js";import{n as f,t as p}from"./styles-KYqa9_e7.js";var m,h,g,_,v,y,b,x,S,C,w,T;function E(){return(E=e((()=>{o(),r(),u(),p(),i(),s(),{args:m,argTypes:h}=c(`syn-link-list`),g={...m},delete g[`default-slot`],_={...h},delete _[`default-slot`],v=(e=4,t=`medium`)=>Array(e).fill(void 0).map(()=>`
    <li>
  ...
  `},w=d({Default:b,Horizontal:x,Multiline:S,Size:C},300),T=[`Default`,`Horizontal`,`Multiline`,`Size`,`Screenshot`],b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    }
  ...
  Multiline,
  Size
}, 300)`,...w.parameters?.docs?.source}}}})))()}E();export{b as Default,x as Horizontal,S as Multiline,w as Screenshot,C as Size,T as __namedExportsOrder,y as default};