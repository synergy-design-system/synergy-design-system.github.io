import{i as e}from"./preload-helper-xPQekRTU.js";import{Ht as t,It as n,d as r,f as i,g as a,u as o}from"./iframe-BjJCO_Oc.js";import{i as s,n as c,o as l,r as u,t as d}from"./component-Bp0Gg8Fw.js";import{t as f}from"./divider-CkQncvjD.js";var p,m,h,g,_,v,y,b,x,S,C,w=e((()=>{f(),n(),u(),r(),a(),{args:p,argTypes:m}=s(`syn-divider`),{generateTemplate:h}=l(`syn-divider`),g={args:p,argTypes:m,component:`syn-divider`,parameters:{chromatic:{modes:i},design:o(`41227-216341`),docs:{description:{component:c(`divider`,`default`)}}},tags:[`Structure`],title:`Components/syn-divider`},_={parameters:{docs:{description:{story:c(`divider`,`default`)}}},render:e=>h({args:e})},v={parameters:{docs:{description:{story:c(`divider`,`width`)}}},render:()=>t`<syn-divider style="--width: var(--syn-spacing-x-small);"></syn-divider>`},y={parameters:{docs:{description:{story:c(`divider`,`color`)}}},render:()=>t`<syn-divider style="--color: var(--syn-color-primary-600);"></syn-divider>`},b={parameters:{docs:{description:{story:c(`divider`,`spacing`)}}},render:()=>t`
    <div style="text-align: center;">
      Above
      <syn-divider style="--spacing: var(--syn-spacing-large);"></syn-divider>
      Below
    </div>
  `},x={parameters:{docs:{description:{story:c(`divider`,`vertical`)}}},render:()=>t`
