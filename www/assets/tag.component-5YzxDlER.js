import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,Ut as r}from"./iframe-CkET12W3.js";import{n as i,t as a}from"./class-map-CFhFi09d.js";import{n as o,t as s}from"./localize-BO4uh8LG.js";import{a as c,i as l,m as u,n as d,o as f,r as p,s as m,t as h}from"./synergy-element-CyJGxssW.js";import{n as g,t as _}from"./decorator-C8FY8E2M.js";import{n as v,t as y}from"./icon-button.component-BbutBXAO.js";var b,x=e((()=>{t(),b=r`
	/* stylelint-disable */
  :host {
...
`})),w,T,E=e((()=>{a(),t(),s(),m(),f(),d(),v(),x(),C(),g(),l(),w=class extends h{constructor(...e){super(...e),this.localize=new o(this),this.size=`medium`,this.removable=!1}static{this.styles=[c,b,S]}static{this.dependencies={"syn-icon-button":y}}handleRemoveClick(){this.emit(`syn-remove`)}render(){return n`
      <span
        part="base"
    ...
    `}},p([u({reflect:!0})],w.prototype,`size`,void 0),p([u({type:Boolean})],w.prototype,`removable`,void 0),w=p([_(`SynTag`)],w),T=w}));export{T as n,E as t};