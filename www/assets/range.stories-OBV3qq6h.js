import{u as _t}from"./index-CSCA1apM.js";import{i as St,x as y}from"./directive-helpers-DGrfjhaU.js";import{o as wt}from"./if-defined-B2ZFWIyt.js";import{n as g}from"./property-BGzwfL48.js";import{a as K}from"./query-DAIS6qJ0.js";import{r as zt}from"./query-all-BNBO5se6.js";import{a as Tt}from"./static-gmWA-8Kq.js";import{d as Ct}from"./default-value-DcEsLq7D.js";import{F as Vt,c as It,v as Mt}from"./form-d9hCJUdr.js";import{H as $t}from"./slot-9EVoRGQc.js";import{L as Dt}from"./localize-CatY2peN.js";import{c as Et,S as Pt}from"./component.styles-Do19GEOY.js";import{f as At,a as Ft}from"./form-control.custom.styles-DbPhNFMw.js";import{S as Lt}from"./tooltip.component-CCxySnho.js";import{e as qt}from"./decorator-DANECR0-.js";import"./button-BcNlV6Uq.js";import"./input-Bwh4NTvI.js";import"./range-tick-D1QkE0FV.js";import{g as h,a as Rt,s as Ot,b as Ht,d as Nt,c as Wt}from"./component-JZANH7tg.js";import"./index-DihgwUfS.js";import"./animation-registry-l4L8bmT6.js";import"./event-B0iVuGLD.js";import"./watch-CEsCE2EF.js";import"./popup.component-4h2Ou4ib.js";import"./composed-offset-position.browser.min-DQsihIor.js";import"./functions-CDi3doZH.js";import"./library-6WV9-XO2.js";import"./icon.component-CmAczTJK.js";import"./spinner.component-oeFu-uyM.js";import"./live-DekCFwgv.js";import"./divider.component-KO_YE4Ha.js";import"./async-directive-PIeysb9D.js";import"./chunk-L4EGOTBX-CsK1v_wc.js";import"./entry-preview-B_oC2lVs.js";import"./index-DrFu-skq.js";import"./_docs-CrPFe_9C.js";import"./index-_2TAQcTa.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-BmTV649i.js";import"./custom-elements-manifest-Br-JURis.js";const x=(t,e)=>t-e,R=(t,e)=>{if(t.length!==e.length)return!0;const s=t.slice().sort(x),a=e.slice().sort(x);for(let r=0;r<s.length;r+=1)if(s[r]!==a[r])return!0;return!1},pt=(t,e,s)=>{const a=t.getBoundingClientRect(),r=a.width;if(r<=0)return 0;let o=e;return o-=a.left,o<=0?s?1:0:o>=r?s?0:1:(o/=r,s?1-o:o)},jt=St`
  :host {
    /*
...
`;var Bt=Object.defineProperty,Ut=Object.getOwnPropertyDescriptor,ut=t=>{throw TypeError(t)},m=(t,e,s,a)=>{for(var r=a>1?void 0:a?Ut(e,s):e,o=t.length-1,p;o>=0;o--)(p=t[o])&&(r=(a?p(e,s,r):p(r))||r);return a&&r&&Bt(e,s,r),r},Z=(t,e,s)=>e.has(t)||ut("Cannot "+s),i=(t,e,s)=>(Z(t,e,"read from private field"),s?s.call(t):e.get(t)),b=(t,e,s)=>e.has(t)?ut("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),f=(t,e,s,a)=>(Z(t,e,"write to private field"),e.set(t,s),s),c=(t,e,s)=>(Z(t,e,"access private method"),s),l,d,O,_,X,k,n,H,tt,mt,et,dt,ht,Y,N,W,yt,ft,S,gt,vt,bt;let u=class extends Pt{constructor(){super(),b(this,n),this.name="",this.label="",this.helpText="",this.disabled=!1,this.min=0,this.max=100,this.step=1,this.size="medium",this.tooltipPlacement="top",this.restrictMovement=!1,this.defaultValue="0",this.form="",this.hasSlotController=new $t(this,"help-text","label","prefix","suffix","ticks"),this.formControlController=new Vt(this,{assumeInteractionOn:["syn-change"]}),this.localize=new Dt(this),b(this,l,[0]),b(this,d,new Map),b(this,O,!1),b(this,_,""),b(this,X),b(this,k,[]),this.tooltipFormatter=this.localize.number.bind(this.localize)}set value(t){f(this,l,t?t.split(" ").map(Number).sort(x):[])}get value(){return i(this,l).slice().sort(x).join(" ")}set valueAsArray(t){const e=i(this,l);f(this,l,Array.isArray(t)?t.slice().sort(x):t||[]),R(e,i(this,l))&&this.requestUpdate("value",e.join(" "))}get valueAsArray(){return[...i(this,l)].sort(x)}disconnectedCallback(){super.disconnectedCallback(),this?.visibilityObserver?.disconnect()}firstUpdated(){this.visibilityObserver=new IntersectionObserver(t=>{const e=t.at(0);e&&e.isIntersecting&&e.target.checkVisibility()&&c(this,n,bt).call(this,e.boundingClientRect.height)},{root:this.ticks.parentElement}),this.visibilityObserver.observe(this.ticks),this.formControlController.updateValidity(),f(this,k,Array.from(i(this,l))),this.thumbs.forEach(t=>{const e=t.parentElement;e.updateComplete.then(()=>{e.shadowRoot.querySelector(".tooltip__body")?.setAttribute("aria-hidden","true")})})}willUpdate(t){super.willUpdate(t),this.min>this.max&&([this.min,this.max]=[this.max,this.min]),this.step>this.max-this.min&&(this.step=this.max-this.min),this.step<=0&&(this.step=1);const e=i(this,l).map(s=>{if(s<=this.min)return this.min;if(s>=this.max)return this.max;const a=this.min+this.step*Math.round((s-this.min)/this.step);return a>this.max?this.max:a});R(i(this,l),e)&&f(this,l,e)}updated(t){super.updated(t);for(const e of this.thumbs){const s=+e.dataset.rangeId;i(this,d).has(s)&&c(this,n,N).call(this,e,i(this,d).get(s))}c(this,n,W).call(this)}focus(t){const e=this.thumbs.item(0);e?e.focus(t):super.focus(t)}checkValidity(){if(this.disabled)return!0;const t=!i(this,_);return t||this.formControlController.emitInvalidEvent(),t}reportValidity(){if(this.disabled)return!0;const t=this.validity.valid;return this.formControlController.setValidity(t),this.validationInput.hidden=!0,clearTimeout(i(this,X)),t||(this.validationInput.hidden=!1,this.validationInput.reportValidity(),f(this,X,setTimeout(()=>{this.validationInput.hidden=!0},1e4))),t}setCustomValidity(t){f(this,_,t),this.validationInput.setCustomValidity(t),this.formControlController.updateValidity()}getForm(){return this.formControlController.getForm()}get validity(){return i(this,_)?It:Mt}get validationMessage(){return i(this,_)}renderThumbs(t){const e=i(this,l).length>1;return i(this,d).clear(),i(this,l).map((s,a)=>{const r=a+1;i(this,d).set(r,s);const o=`thumb-${r}`;let p="",v="";return e?(v=t?`label aria-label-hidden ${o}`:`aria-label-hidden ${o}`,a===0?p=`${this.localize.term("rangeMin")} (${this.tooltipFormatter(s)})`:a===i(this,l).length-1?p=`${this.localize.term("rangeMax")} (${this.tooltipFormatter(s)})`:p=this.tooltipFormatter(s)):v=t?"label aria-label-hidden":"",y`
        <syn-tooltip
        ...
        >
          <div
            ...
            @pointerup=${c(this,n,Y)}
            @pointercancel=${c(this,n,Y)}
            @pointerleave=${c(this,n,Y)}
            @keydown=${c(this,n,yt)}
            @focus=${c(this,n,gt)}
          ></div>
        </syn-tooltip>
      ...
      <div
        part="form-control"
        class=${Tt({"form-control":!0,"form-control--has-help-text":o,"form-control--has-label":r,"form-control--has-prefix":s,"form-control--has-suffix":a,"form-control--is-disabled":this.disabled,"form-control--large":this.size==="large","form-control--medium":this.size==="medium","form-control--small":this.size==="small"})}
    ...
    `}};l=new WeakMap;d=new WeakMap;O=new WeakMap;_=new WeakMap;X=new WeakMap;k=new WeakMap;n=new WeakSet;H=function(){return this.localize.dir()==="rtl"};tt=function(t,e=!0){if(this.disabled)return;const{clientX:s}=t,a=Array.from(this.thumbs),r=pt(this.baseDiv,s,i(this,n,H)),o=this.step/(this.max-this.min),p=this.min+this.step*Math.round(r/o),v=a.reduce((J,Q)=>{const rt=i(this,d).get(+Q.dataset.rangeId),kt=i(this,d).get(+J.dataset.rangeId),it=Math.abs(rt-p),at=Math.abs(kt-p);return it===at?rt<p?Q:J:it<at?Q:J}),w=+v.dataset.rangeId;if(!w)return;i(this,d).set(w,p),c(this,n,N).call(this,v,p);const j=i(this,l);f(this,l,Array.from(i(this,d).values())),c(this,n,W).call(this),R(j,i(this,l))&&(f(this,k,Array.from(i(this,l))),this.emit("syn-input"),this.emit("syn-change"));const xt=new PointerEvent("pointerdown",t);e&&v.dispatchEvent(xt)&&c(this,n,S).call(this,v)};mt=function(t){c(this,n,tt).call(this,t,!1)};et=function(t,e){const s=this.valueAsArray,r=Array.from(this.thumbs).indexOf(t),o=s[r-1]||this.min,p=s[r+1]||this.max,v=e<o||e>p;return{finalValue:Math.max(o,Math.min(p,e)),isRestricted:v,nextValue:p,prevValue:o}};dt=async function(t){if(this.disabled)return;const e=t.target;c(this,n,S).call(this,e),e.dataset.pointerId&&e.releasePointerCapture(+e.dataset.pointerId),e.dataset.pointerId=t.pointerId.toString(),e.setPointerCapture(t.pointerId),e.classList.add("grabbed"),await e.parentElement.show()};ht=function(t){if(this.disabled)return;const e=t.target,s=+e.dataset.rangeId;if(!i(this,d).has(s)||(e.dataset.pointerId?+e.dataset.pointerId:null)!==t.pointerId)return;const r=pt(this.baseDiv,t.clientX,i(this,n,H)),o=this.step/(this.max-this.min);let p=this.min+this.step*Math.round(r/o);if(this.emit("syn-move",{cancelable:!0,detail:{element:e,value:p}}).defaultPrevented)return;if(this.restrictMovement){const j=c(this,n,et).call(this,e,p);j.isRestricted?(p=j.finalValue,e.style.zIndex=(3+this.thumbs.length).toFixed(0)):e.style.zIndex="3"}i(this,d).set(s,p),c(this,n,N).call(this,e,p);const w=i(this,l);f(this,l,Array.from(i(this,d).values())),c(this,n,W).call(this),R(w,i(this,l))&&this.emit("syn-input")};Y=async function(t){const e=t.target;!e.dataset.pointerId||t.pointerId!==+e.dataset.pointerId||(e.classList.remove("grabbed"),e.releasePointerCapture(t.pointerId),delete e.dataset.pointerId,R(i(this,k),i(this,l))&&(f(this,k,Array.from(i(this,l))),this.emit("syn-change")),await e.parentElement.hide())};N=function(t,e){t.setAttribute("aria-valuenow",e.toString()),t.setAttribute("aria-valuetext",this.tooltipFormatter(e));const s=(e-this.min)/(this.max-this.min);t.style.insetInlineStart=`calc(${100*s}% - var(--half-thumb-size))`,c(this,n,S).call(this,t)};W=function(){const{activeTrack:t}=this;if(!t)return;if(this.min===this.max){t.style.insetInlineStart="0%",t.style.insetInlineEnd="0%";return}if(i(this,l).length===1){const r=getComputedStyle(this).getPropertyValue("--track-active-offset")||"0%",o=100*(i(this,l)[0]-this.min)/(this.max-this.min);t.style.insetInlineStart=`min(${r}, ${o}%)`,t.style.insetInlineEnd=`min(calc(100% - ${r}), calc(100% - ${o}%))`;return}const e=i(this,l).slice().sort(x),s=100*(e[0]-this.min)/(this.max-this.min),a=100*(e[e.length-1]-this.min)/(this.max-this.min);t.style.insetInlineStart=`${s}%`,t.style.insetInlineEnd=`calc(100% - ${a}%)`};yt=function(t){const e=t.target,s=+e.dataset.rangeId,a=i(this,d).get(s);if(a===void 0)return;let r=a;switch(t.key){case"ArrowUp":case"Up":r=Math.min(a+this.step,this.max);break;case"ArrowDown":case"Down":r=Math.max(a-this.step,this.min);break;case"ArrowLeft":case"Left":r=i(this,n,H)?Math.min(a+this.step,this.max):Math.max(a-this.step,this.min);break;case"ArrowRight":case"Right":r=i(this,n,H)?Math.max(a-this.step,this.min):Math.min(a+this.step,this.max);break;case"PageUp":r=Math.min(a+(this.max-this.min)/5,this.max);break;case"PageDown":r=Math.max(a-(this.max-this.min)/5,this.min);break;case"Home":r=this.min;break;case"End":r=this.max;break;default:return}if(r!==a){if(this.emit("syn-move",{cancelable:!0,detail:{element:e,value:r}}).defaultPrevented)return;if(this.restrictMovement){const p=c(this,n,et).call(this,e,r);p.isRestricted&&(r=p.finalValue)}c(this,n,N).call(this,e,r),i(this,d).set(s,r),f(this,l,Array.from(i(this,d).values())),c(this,n,W).call(this),c(this,n,S).call(this,e),f(this,k,Array.from(i(this,l))),this.emit("syn-input"),this.emit("syn-change")}t.stopPropagation(),t.preventDefault()};ft=function(t){t.relatedTarget&&this.shadowRoot?.contains(t.relatedTarget)||(this.emit("syn-blur"),f(this,O,!1))};S=function(t){if(this.tooltipPlacement==="none")return;const e=+t.dataset.rangeId;if(!i(this,d).has(e))return;const s=i(this,d).get(e),a=t.parentElement;a.content=this.tooltipFormatter(s)};gt=function(t){if(this.disabled)return;i(this,O)||(f(this,O,!0),this.emit("syn-focus"));const e=t.target;e?.dataset?.rangeId&&c(this,n,S).call(this,e)};vt=function(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)};bt=function(t){const e=this.hasSlotController.test("ticks"),s=this.hasSlotController.test("prefix"),a=this.hasSlotController.test("suffix");if(!e)return;let r=t||this.shadowRoot?.querySelector(".ticks")?.clientHeight;if(r){if(r+=2,r/=2,s){const o=this.shadowRoot?.querySelector(".input__prefix");o.style.transform=`translateY(-${r}px)`}if(a){const o=this.shadowRoot?.querySelector(".input__suffix");o.style.transform=`translateY(-${r}px)`}}};u.styles=[Et,At,Ft,jt];u.dependencies={"syn-tooltip":Lt};m([g()],u.prototype,"name",2);m([g()],u.prototype,"label",2);m([g({attribute:"help-text"})],u.prototype,"helpText",2);m([g({reflect:!0,type:Boolean})],u.prototype,"disabled",2);m([g({type:Number})],u.prototype,"min",2);m([g({type:Number})],u.prototype,"max",2);m([g({type:Number})],u.prototype,"step",2);m([g({reflect:!0})],u.prototype,"size",2);m([g({attribute:"tooltip-placement",type:String})],u.prototype,"tooltipPlacement",2);m([g({type:String})],u.prototype,"value",1);m([g({attribute:"restrict-movement",type:Boolean})],u.prototype,"restrictMovement",2);m([Ct()],u.prototype,"defaultValue",2);m([g({reflect:!0})],u.prototype,"form",2);m([g({attribute:!1})],u.prototype,"tooltipFormatter",2);m([K(".input__wrapper")],u.prototype,"baseDiv",2);m([K(".active-track")],u.prototype,"activeTrack",2);m([K(".ticks")],u.prototype,"ticks",2);m([zt(".thumb")],u.prototype,"thumbs",2);m([K(".range__validation-input")],u.prototype,"validationInput",2);u=m([qt("SynRange")],u);u.define("syn-range");var nt=Object.freeze,Gt=Object.defineProperty,st=(t,e)=>nt(Gt(t,"raw",{value:nt(t.slice())})),ot,lt,ct;const{args:Xt,argTypes:Yt}=Ot("syn-range"),{overrideArgs:Kt}=Ht("syn-range"),{generateTemplate:Jt}=Nt("syn-range"),qe={args:Kt([{name:"value",type:"attribute",value:"50"}],Xt),argTypes:Yt,component:"syn-range",parameters:{design:Rt("20575-35283"),docs:{description:{component:h("range","default")}}},title:"Components/syn-range"},z={parameters:{controls:{disable:!1},docs:{description:{story:h("range","default")},story:{height:"80px"}}},render:t=>Jt({args:t})},T={parameters:{docs:{description:{story:h("range","labels")}}},render:()=>y`
  ...
  `},I={parameters:{docs:{description:{story:h("range","invalid")}}},play:async({canvasElement:t})=>{try{const e=t.querySelector("syn-range"),s=t.querySelector("syn-button");e&&s&&(await _t.click(s),s.click())}catch(e){console.error("Error in play function:",e)}},render:()=>y(ot||(ot=st([`
  ...
  `])))},B={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:h("range","focus")},story:{height:"80px"}}},play:({canvasElement:t})=>{const e=t.querySelector("syn-range");e&&e.focus()},render:()=>y`
    <form>
  ...
  `},$={parameters:{docs:{description:{story:h("range","prefix-suffix")}}},render:()=>y(lt||(lt=st([`
    <syn-range
      help-text="Controls the volume of the current song"
      label="Volume"
      max="100"
  ...
  `},U={parameters:{docs:{description:{story:h("range","multi-knob-restrict-movement")}}},render:()=>y`
    <syn-range
      value="30 70"
  ...
  `},L={parameters:{docs:{description:{story:h("range","tooltip-disabled")}}},render:()=>y`
    <syn-range
      ...
      value="50"
    ></syn-range>
  `},q={parameters:{docs:{description:{story:h("range","tooltip-formatter")}}},render:()=>y(ct||(ct=st([`
    <syn-range
    ...
    <\/script>
  `])))},G=Wt({Default:z,Labels:T,HelpText:C,Disabled:V,Invalid:I,Sizes:M,PrefixSuffixText:$,CustomTrackColors:D,CustomTrackOffset:E,MultiThumb:P,Ticks:A,TooltipPlacement:F,TooltipDisabled:L,TooltipFormatter:q},500);z.parameters={...z.parameters,docs:{...z.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
...
} as Story`,...z.parameters?.docs?.source}}};T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
  ...
  render: () => html\`
    ...
    <\/script>
  \`
}`,...q.parameters?.docs?.source}}};G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`generateScreenshotStory({
  Default,
  Labels,
  HelpText,
  Disabled,
  ...
  TooltipDisabled,
  TooltipFormatter
}, 500)`,...G.parameters?.docs?.source}}};const Re=["Default","Labels","HelpText","Disabled","Invalid","Focus","Sizes","PrefixSuffixText","CustomTrackColors","CustomTrackOffset","MultiThumb","MultiThumbWithRestrictedMovement","Ticks","TooltipPlacement","TooltipDisabled","TooltipFormatter","Screenshot"];export{D as CustomTrackColors,E as CustomTrackOffset,z as Default,V as Disabled,B as Focus,C as HelpText,I as Invalid,T as Labels,P as MultiThumb,U as MultiThumbWithRestrictedMovement,$ as PrefixSuffixText,G as Screenshot,M as Sizes,A as Ticks,L as TooltipDisabled,q as TooltipFormatter,F as TooltipPlacement,Re as __namedExportsOrder,qe as default};
