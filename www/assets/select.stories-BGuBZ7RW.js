import"./select-q118yFXX.js";import"./option-CrluRMvl.js";import"./optgroup-CwQjLtm5.js";import"./icon-DqfgyPbM.js";import"./button-mYJyVhrp.js";import{g as w,C as M,x as n}from"./iframe-BbG24dca.js";import{o as L}from"./select-B9I5Rx94.js";import{g as o,s as P,c as z,a as k,b as D}from"./component-DQoGmEAi.js";import{p as H}from"./PaddingDecorator-MkdBYu06.js";import"./animation-registry-l4L8bmT6.js";import"./class-map-C4GF1kIH.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./localize-Dh03wnLC.js";import"./index-DihgwUfS.js";import"./synergy-element-mvvDTlej.js";import"./icon.component-DiWeev-w.js";import"./watch-CEsCE2EF.js";import"./query-DAIS6qJ0.js";import"./scroll-DgKSCJoS.js";import"./event-B0iVuGLD.js";import"./form-control.custom.styles-D63D7yij.js";import"./popup.component-BV9KVoXj.js";import"./if-defined-BDvKPKv0.js";import"./tag.component-y1J0JK41.js";import"./icon-button.component-BDSusJFU.js";import"./decorator-DeP7ND_N.js";import"./functions-DkH8wE0_.js";import"./query-assigned-elements-BQ-t-koE.js";import"./divider.component-Cffnz0zs.js";import"./spinner.component-DzM8BziZ.js";import"./preload-helper-Ct5FWWRu.js";import"./index-CQ0aEGxp.js";import"./_docs-DmU5sf6r.js";var x=Object.freeze,C=Object.defineProperty,S=(e,t)=>x(C(e,"raw",{value:x(t||e.slice())})),_,T,E;const{userEvent:I}=__STORYBOOK_MODULE_TEST__,{args:q,argTypes:U}=P("syn-select"),{overrideArgs:Y}=k("syn-select"),{generateTemplate:A}=z("syn-select"),Tn={args:q,argTypes:U,component:"syn-select",parameters:{chromatic:{modes:M},design:w("5069-7562"),docs:{description:{component:o("select","default")},story:{height:"250px"}}},tags:["Form","SICK2018","SICK2025"],title:"Components/syn-select"},s={parameters:{args:Y({name:"default",type:"slot",value:`
      ...
      `},q),controls:{disable:!1},docs:{description:{story:o("select","default")}}},render:e=>A({args:e})},i={parameters:{docs:{description:{story:o("select","labels")}}},render:()=>n`
  ...
  `},r={decorators:[H()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:o("select","focus")}}},play:({canvasElement:e})=>{e.querySelector("syn-select")?.focus()},render:()=>n`
    <syn-select label="Select one">
      <syn-option value="option-1">Option 1</syn-option>
      <syn-option value="option-2">Option 2</syn-option>
      <syn-option value="option-3">Option 3</syn-option>
  ...
  `},v={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:o("select","invalid")}}},play:async({canvasElement:e})=>{const t=e.querySelector("form"),$=t.querySelector("syn-select"),f=t.querySelector("syn-button");f&&$&&(await I.click(f),f.click())},render:()=>n`
  ...
  `],[`
    ...
    <\/script>
  `])))},b=D({ScreenshotStoryDefault:F},{afterRender:L("syn-select",!1),heightPx:400}),h=D({ScreenshotStoryMultiple:R},{afterRender:L("syn-select"),heightPx:400});s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  parameters: {
    args: overrideArgs({
      name: 'default',
      type: 'slot',
  ...
  heightPx: 400
})`,...h.parameters?.docs?.source}}};const En=["Default","Labels","HelpText","Placeholder","Clearable","Focus","Disabled","Multiple","SettingInitialValues","GroupingOptions","Sizes","Invalid","PrefixSuffixIcons","CustomTags","ScreenshotDefault","ScreenshotMultiple"];export{l as Clearable,g as CustomTags,s as Default,c as Disabled,r as Focus,m as GroupingOptions,p as HelpText,v as Invalid,i as Labels,y as Multiple,a as Placeholder,O as PrefixSuffixIcons,b as ScreenshotDefault,h as ScreenshotMultiple,u as SettingInitialValues,d as Sizes,En as __namedExportsOrder,Tn as default};
