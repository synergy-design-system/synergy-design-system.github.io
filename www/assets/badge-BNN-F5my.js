...
`})),S,C,w=e((()=>{a(),n(),p(),d(),u(),s(),y(),x(),g(),l(),S=class extends m{constructor(...e){super(...e),this.localize=new o(this),this.variant=`primary`}static{this.styles=[c,v,b]}render(){return t`
      <span
        part="base"
