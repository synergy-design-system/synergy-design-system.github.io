...
`,A={parameters:{chromatic:{...i?.parameters?.chromatic,disableSnapshot:!1,modes:n},docs:{description:{component:g(`table`,`default`,`templates`)},page:()=>x.createElement(x.Fragment,null,x.createElement(l,null),x.createElement(c,null),x.createElement(u,null),x.createElement(f,{title:``})),story:{iframeHeight:550}}},tags:[`Structure`],title:`Templates/Table`},j={render:()=>{let e=E(()=>O());return o`
    ...
    `]),b(`table.productTable.header.product`),b(`table.productTable.header.availability`),b(`table.productTable.header.earliestDelivery`),b(`table.productTable.header.unitPrice`),b(`table.productTable.header.totalPrice`),e)}},R=[`TableWithHeader`,`TableWithAlternatingRows`,`TableWithBorders`,`TableShadowLeftColumn`,`TableShadowRightColumn`,`TableShadowTopRow`,`TableProduct`],j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
  render: () => {
...
}`,...L.parameters?.docs?.source}}}})))()}z();export{L as TableProduct,P as TableShadowLeftColumn,F as TableShadowRightColumn,I as TableShadowTopRow,M as TableWithAlternatingRows,N as TableWithBorders,j as TableWithHeader,R as __namedExportsOrder,A as default};