import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-DRz18Lsn.js";import{c as i,t as a}from"./lit-D4-0ovri.js";import{t as o}from"./button-CBC8ywKX.js";import{t as ee}from"./icon-BbsmBxau.js";import{t as s}from"./select-BiMMRNnt.js";import{t as c}from"./option-5Sp0fHIr.js";import{a as l,i as u,n as d,o as f,r as p,t as m}from"./component-NnlguzJ1.js";import{t as h}from"./taggedTemplateLiteral-BZenJ0bZ.js";import{n as g,t as _}from"./PaddingDecorator-Dx4_2Fla.js";import{n as v,t as y}from"./decorators-CjBNNcov.js";import{t as b}from"./optgroup-CYg2sho1.js";import{n as x,t as S}from"./select-Bk9G7Kho.js";var C=t({Clearable:()=>L,CustomTags:()=>q,Default:()=>N,Disabled:()=>z,Focus:()=>R,GroupingOptions:()=>U,HelpText:()=>F,Invalid:()=>G,Labels:()=>P,Multiple:()=>V,Placeholder:()=>I,PrefixSuffixIcons:()=>K,Readonly:()=>B,ScreenshotDefault:()=>X,ScreenshotMultiple:()=>Z,SettingInitialValues:()=>H,Sizes:()=>W,__namedExportsOrder:()=>Q,default:()=>M}),w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q;function $(){return($=e((()=>{s(),c(),b(),ee(),o(),a(),S(),p(),y(),_(),r(),{userEvent:w}=__STORYBOOK_MODULE_TEST__,{args:O,argTypes:k}=u(`syn-select`),{overrideArgs:A}=l(`syn-select`),{generateTemplate:j}=f(`syn-select`),M={args:O,argTypes:k,component:`syn-select`,parameters:{chromatic:{modes:n},docs:{description:{component:d(`select`,`default`)},story:{height:`250px`}}},tags:[`Form`],title:`Components/syn-select`},N={parameters:{args:A({name:`default`,type:`slot`,value:`
  ...
  `],[`
    ...
    <\/script>
  `]))},X=m({ScreenshotStoryDefault:J},{afterRender:x(`syn-select`,!1),heightPx:400}),Z=m({ScreenshotStoryMultiple:Y},{afterRender:x(`syn-select`),heightPx:400}),Q=[`Default`,`Labels`,`HelpText`,`Placeholder`,`Clearable`,`Focus`,`Disabled`,`Readonly`,`Multiple`,`SettingInitialValues`,`GroupingOptions`,`Sizes`,`Invalid`,`PrefixSuffixIcons`,`CustomTags`,`ScreenshotDefault`,`ScreenshotMultiple`],N.parameters={...N.parameters,docs:{...N.parameters?.docs,source:{originalSource:`{
  parameters: {
    args: overrideArgs({
      name: 'default',
      type: 'slot',
  ...
  heightPx: 400
})`,...Z.parameters?.docs?.source}}}})))()}export{$ as n,C as r,N as t};