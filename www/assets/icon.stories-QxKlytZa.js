import"./icon-zHTdwB0d.js";import{g as p,x as e,h as d}from"./iframe-DEjDpRef.js";import{s as h,a as g,c as b,b as v}from"./component-CRq7DUSa.js";import{d as u}from"./default-icons-Dpg8W8qC.js";import"./icon.component-juKEJBdj.js";import"./synergy-element-9YQF5Oan.js";import"./watch-CEsCE2EF.js";import"./preload-helper-Ct5FWWRu.js";import"./index-CQ0aEGxp.js";import"./_docs-DXCV3alH.js";const w=`Icons are small standard symbols that are primarily used in screen design.
...
\`\`\`
`,{args:S,argTypes:C}=h("syn-icon"),{overrideArgs:I}=g("syn-icon"),{generateTemplate:k}=b("syn-icon"),x=`
${w}

---

`,V={args:I({name:"name",type:"attribute",value:"wallpaper"},S),argTypes:C,component:"syn-icon",parameters:{design:p("1616-1512"),docs:{description:{component:x}}},tags:["Icons","SICK2018","SICK2025"],title:"Components/syn-icon"},s={parameters:{controls:{disable:!1}},render:n=>k({args:n})},t={render:()=>e`<div style="color: var(--syn-color-primary-600);">
...
<div style="color: var(--syn-color-error-700);">
...
</div>`},i={render:()=>e`<div style="font-size: var(--syn-font-size-2x-large);">
  <syn-icon name="warning"></syn-icon>
  <syn-icon name="inventory"></syn-icon>
  <syn-icon name="battery_charging_full"></syn-icon>
  <syn-icon name="notifications"></syn-icon>
  ...
  <syn-icon name="star_border"></syn-icon>
  <syn-icon name="delete"></syn-icon>
</div>`},o={render:()=>e`<syn-icon name="star" label="Add to favorites"></syn-icon>`},r={render:()=>e`<syn-icon src="/logo-claim.svg" style="font-size: 10rem;"></syn-icon>`},a={render:()=>(d("fa",{resolver:n=>{const f=n.replace(/^fa[rbs]-/,"");let m="regular";return n.substring(0,4)==="fas-"&&(m="solid"),n.substring(0,4)==="fab-"&&(m="brands"),`https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.15.1/svgs/${m}/${f}.svg`},mutator:n=>n.setAttribute("fill","currentColor")}),e`<div style="font-size: var(--syn-font-size-x-large);">
...
</div>`)},c={render:()=>(d("bundled-default",{mutator:n=>n.setAttribute("fill","currentColor"),resolver:n=>n in u?`data:image/svg+xml,${encodeURIComponent(u[n])}`:""}),e`<div style="font-size: var(--syn-font-size-x-large);">
...
</div>`)},l={render:()=>(d("sprite",{mutator:n=>n.setAttribute("fill","currentColor"),resolver:n=>`/sprite.svg#${n}`,spriteSheet:!0}),e`<div style="font-size: var(--syn-font-size-x-large);">
  <syn-icon library="sprite" name="settings"></syn-icon>
  <syn-icon library="sprite" name="refresh"></syn-icon>
</div>`)},y=v({Default:s,Colors:t,Sizing:i,Labels:o,CustomIcons:r,CDNIconLibrary:a,BundledIconLibrary:c,SpriteSheetUsage:l});s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    }
...
Thus, you can set the color property on the <syn-icon> element or an ancestor to change color.`,...t.parameters?.docs?.description}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
...
}`,...i.parameters?.docs?.source},description:{story:`Icons are sized relative to the current font size.
To change their size, set the font-size property on the icon itself
or on a parent element as shown below.`,...i.parameters?.docs?.description}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:'{\n  render: () => html`<syn-icon name="star" label="Add to favorites"></syn-icon>`\n}',...o.parameters?.docs?.source},description:{story:"For non-decorative icons, use the label attribute to announce it to assistive devices.",...o.parameters?.docs?.description}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:'{\n  render: () => html`<syn-icon src="/logo-claim.svg" style="font-size: 10rem;"></syn-icon>`\n}',...r.parameters?.docs?.source},description:{story:`Custom icons can be loaded individually with the src attribute.
Only SVGs on a local or CORS-enabled endpoint are supported.
If you're using more than one custom icon, it might make sense to register a custom icon library.`,...r.parameters?.docs?.description}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  render: () => {
...
\`\`\``,...l.parameters?.docs?.description}}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`generateScreenshotStory({
  ...
  BundledIconLibrary,
  SpriteSheetUsage
})`,...y.parameters?.docs?.source}}};const P=["Default","Colors","Sizing","Labels","CustomIcons","CDNIconLibrary","BundledIconLibrary","SpriteSheetUsage","Screenshot"];export{c as BundledIconLibrary,a as CDNIconLibrary,t as Colors,r as CustomIcons,s as Default,o as Labels,y as Screenshot,i as Sizing,l as SpriteSheetUsage,P as __namedExportsOrder,V as default};
