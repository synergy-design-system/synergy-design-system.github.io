import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-DRz18Lsn.js";import{c as i,t as a}from"./lit-D4-0ovri.js";import{t as o}from"./button-CBC8ywKX.js";import{a as s,i as c,n as l,o as u,r as d,t as f}from"./component-NnlguzJ1.js";import{t as p}from"./taggedTemplateLiteral-BZenJ0bZ.js";import{t as m}from"./checkbox-CVHh1A6r.js";import{n as h,t as g}from"./decorators-CjBNNcov.js";var _=t({Checked:()=>T,CustomValidity:()=>N,Default:()=>w,Disabled:()=>k,Focus:()=>O,HelpText:()=>E,Indeterminate:()=>D,Invalid:()=>M,Readonly:()=>A,Screenshot:()=>P,Sizes:()=>j,__namedExportsOrder:()=>F,default:()=>C}),v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F;function I(){return(I=e((()=>{m(),o(),a(),g(),d(),r(),{userEvent:v}=__STORYBOOK_MODULE_TEST__,{argTypes:b}=c(`syn-checkbox`),{overrideArgs:x}=s(`syn-checkbox`),{generateTemplate:S}=u(`syn-checkbox`),C={args:x([{name:`default`,type:`slot`,value:`Checkbox`}]),argTypes:b,component:`syn-checkbox`,parameters:{chromatic:{modes:n},docs:{description:{component:l(`checkbox`,`default`)}}},tags:[`Form`],title:`Components/syn-checkbox`},w={parameters:{controls:{disable:!1},docs:{description:{story:l(`checkbox`,`default`)}}},render:e=>S({args:e})},T={parameters:{docs:{description:{story:l(`checkbox`,`checked`)}}},render:()=>i`<syn-checkbox checked>Checked</syn-checkbox>`},E={parameters:{docs:{description:{story:l(`checkbox`,`help-text`)}}},render:()=>i`
  ...
  `},N={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:l(`checkbox`,`validity`)}}},play:async({canvasElement:e})=>{try{let t=e.querySelector(`form`),n=e.querySelector(`syn-button`),r=e.querySelector(`syn-checkbox`);t&&n&&r&&(r.setCustomValidity(`Don't forget to check me!`),await v.click(n),n.click(),r.blur())}catch(e){console.error(`Error in play function:`,e)}},render:()=>i(y||=p([`
    ...
    <\/script>
  `]))},P=f({Default:w,Checked:T,HelpText:E,Indeterminate:D,Disabled:k,Readonly:A,Sizes:j},200),F=[`Default`,`Checked`,`HelpText`,`Indeterminate`,`Focus`,`Disabled`,`Readonly`,`Sizes`,`Invalid`,`CustomValidity`,`Screenshot`],w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  Readonly,
  Sizes
}, 200)`,...P.parameters?.docs?.source}}}})))()}export{_ as n,I as r,w as t};