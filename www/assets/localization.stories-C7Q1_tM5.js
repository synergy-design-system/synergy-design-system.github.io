import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r,n as i,t as a}from"./preview-DVQQjuS0.js";import{c as o,t as s}from"./lit-DgWh_IaA.js";import{d as c,f as l,i as u,p as d,u as f}from"./blocks-CjiNIppL.js";import{t as p}from"./react-BZJXY1be.js";import{t as m}from"./card-D5oJtvhu.js";import{n as h,r as g}from"./component-CsPmw1q3.js";import{t as _}from"./taggedTemplateLiteral-BZenJ0bZ.js";import{n as v,t as y}from"./menu-item-Dmv0nqTV.js";import{t as b}from"./dropdown-By2MGqFX.js";import{t as x}from"./tooltip-C_nSq_ZM.js";import{t as S}from"./icon-button-DoxsuKUb.js";import{t as C}from"./file-_ovaRtfV.js";import{t as w}from"./prio-nav-S97p2tCF.js";import{t as T}from"./header-5fgNngeL.js";import{n as E,t as D}from"./localization-C1oAmRRX.js";var O,k,A,j,M,N,P,F;function I(){return(I=t((()=>{O=e(p(),1),d(),s(),a(),g(),r(),E(),w(),m(),b(),C(),T(),S(),v(),y(),x(),A={parameters:{chromatic:{...i?.parameters?.chromatic,disableSnapshot:!1,modes:n},docs:{description:{component:h(`localization`,`default`,`templates`)},page:()=>O.createElement(O.Fragment,null,O.createElement(l,null),O.createElement(c,null),O.createElement(u,null),O.createElement(f,{title:``}))}},tags:[`i18n`,`localization`,`translations`],title:`Templates/Localization`},j=Object.values(D()),M=j.find(e=>e.$code===`de`)||j[0],N=j.map(e=>({code:e.$code,dir:e.$dir,name:e.$name})),P={parameters:{docs:{description:{story:h(`localization`,`dynamicallySetLocalizations`,`templates`)}},synergy:{customImports:j.filter(e=>e.$code===`en`||e.$code===`de`).map(e=>`https://esm.sh/@synergy-design-system/components@latest/dist/translations/${e.$code}.js`)}},render:()=>o(k||=_([`
