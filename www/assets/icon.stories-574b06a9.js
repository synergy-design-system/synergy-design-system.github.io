import"./icon-b153afcc.js";import{x as n}from"./directive-helpers-a6c66f8a.js";import{s as p,a as g,b as h,c as b}from"./component-be2efc65.js";import{r as d}from"./icon.component-d6cd0d6e.js";import{d as f}from"./default-icons-cf66c625.js";import"./static-c19bae7e.js";import"./chunk-757FFUVQ-7dc151b2.js";import"./index-356e4a49.js";import"./_docs-6508e6e2.js";import"./component.styles-86aba3f6.js";const{args:v,argTypes:w}=p("syn-icon"),{overrideArgs:S}=b("syn-icon"),{generateTemplate:C}=g("syn-icon"),I=`
...
`,j={args:S({name:"name",type:"attribute",value:"wallpaper"},v),argTypes:w,component:"icon",parameters:{docs:{description:{component:I}}},title:"Components/syn-icon"},l={parameters:{controls:{disable:!1}},render:e=>C({args:e})},s={name:"Colors",render:()=>n`<div style="color: var(--syn-color-primary-600);">
...
<div style="color: var(--syn-color-error-700);">
...
</div>`},o={name:"Sizing",render:()=>n`<div style="font-size: var(--syn-font-size-2x-large);">
  <syn-icon name="warning"></syn-icon>
  <syn-icon name="inventory"></syn-icon>
  <syn-icon name="battery_charging_full"></syn-icon>
  <syn-icon name="notifications"></syn-icon>
  ...
  <syn-icon name="star_border"></syn-icon>
  <syn-icon name="delete"></syn-icon>
</div>`},r={name:"Labels",render:()=>n`<syn-icon name="star" label="Add to favorites"></syn-icon>`},i={name:"Custom icons",render:()=>n`<syn-icon src="/logo-claim.svg" style="font-size: 10rem;"></syn-icon>`},t={name:"CDN icon library",render:()=>(d("fa",{resolver:e=>{const u=e.replace(/^fa[rbs]-/,"");let m="regular";return e.substring(0,4)==="fas-"&&(m="solid"),e.substring(0,4)==="fab-"&&(m="brands"),`https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.15.1/svgs/${m}/${u}.svg`},mutator:e=>e.setAttribute("fill","currentColor")}),n`<div style="font-size: var(--syn-font-size-x-large);">
...
</div>`)},a={name:"Bundled icon library",render:()=>(d("bundled-default",{mutator:e=>e.setAttribute("fill","currentColor"),resolver:e=>e in f?`data:image/svg+xml,${encodeURIComponent(f[e])}`:""}),n`<div style="font-size: var(--syn-font-size-x-large);">
...
</div>`)},c={name:"Sprite sheet usage",render:()=>(d("sprite",{mutator:e=>e.setAttribute("fill","currentColor"),resolver:e=>`/sprite.svg#${e}`,spriteSheet:!0}),n`<div style="font-size: var(--syn-font-size-x-large);">
...
\`\`\``,...c.parameters?.docs?.description}}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:"generateScreenshotStory([Colors, Sizing, Labels, CustomIcons, CDNIconLibrary, BundledIconLibrary, SpriteSheetUsage])",...y.parameters?.docs?.source}}};const F=["Default","Colors","Sizing","Labels","CustomIcons","CDNIconLibrary","BundledIconLibrary","SpriteSheetUsage","Screenshot"];export{a as BundledIconLibrary,t as CDNIconLibrary,s as Colors,i as CustomIcons,l as Default,r as Labels,y as Screenshot,o as Sizing,c as SpriteSheetUsage,F as __namedExportsOrder,j as default};
//# sourceMappingURL=icon.stories-574b06a9.js.map
