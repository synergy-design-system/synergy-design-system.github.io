import{v as b,c as a,C as w,o as S,d as C}from"./iframe-r0CQHRKQ.js";import{e as _}from"./class-map-BSAfnhal.js";import{S as T,c as j,n as f}from"./synergy-element-C0zzvLBX.js";import{H as I}from"./slot-9EVoRGQc.js";import"./button-DPFLjHtv.js";import"./icon-button-C52Lm8gg.js";import{g as e,a as K,s as A,b as D,c as M}from"./component-H_NDQ3WO.js";import"./preload-helper-PPVm8Dsz.js";import"./form-d9hCJUdr.js";import"./if-defined-BE596y_O.js";import"./localize-Dh03wnLC.js";import"./index-DihgwUfS.js";import"./icon.component-BtCkPkUy.js";import"./watch-CEsCE2EF.js";import"./query-D0jTsbLw.js";import"./spinner.component-CBNnwNtq.js";import"./decorator-UnohHU6S.js";import"./functions-B4dslKTf.js";import"./icon-button.component-CGGXH9Zy.js";import"./index-3hbeBem-.js";import"./_docs-B-LcOZte.js";const H=b`
	/* stylelint-disable */
  :host {
...
`;var W=Object.defineProperty,v=(r,p,g,P)=>{for(var s=void 0,m=r.length-1,u;m>=0;m--)(u=r[m])&&(s=u(p,g,s)||s);return s&&W(p,g,s),s};class h extends T{constructor(){super(...arguments),this.hasSlotController=new I(this,"footer","header","image"),this.shadow=!1,this.sharp=!1}static{this.styles=[j,H,k]}render(){return a`
    ...
    `}}v([f({type:Boolean,reflect:!0})],h.prototype,"shadow");v([f({type:Boolean,reflect:!0})],h.prototype,"sharp");h.define("syn-card");const{args:F,argTypes:O}=A("syn-card"),{overrideArgs:z}=M("syn-card"),{generateTemplate:B}=D("syn-card"),x=({buttonText:r="More info",footerText:p="Optional information"}={})=>`
  <footer slot="footer">
    <small>${p}</small>
    <nav>
...
`,ne={args:z([{name:"image",type:"slot",value:'<img slot="image" src="https://synergy-design-system.github.io/card-example.jpg" alt="Multiple persons having lunch in SICK Academy" />'},{name:"default",type:"slot",value:`
  ...
  `},n={parameters:{docs:{description:{story:e("card","with-footer")}}},render:()=>a`
    <syn-card class="card-footer">
      ...
      ${S(x({buttonText:"Preview",footerText:"Optional information"}))}
    </syn-card>
  ...
  `},y=K({Default:o,BasicCard:t,CardWithHeader:d,CardWithFooter:n,Images:i,SharpCard:c,CardWithShadow:l},600);o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
