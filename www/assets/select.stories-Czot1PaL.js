import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,d as r,f as i,g as a,u as o}from"./iframe-BcSabCAt.js";import{t as s}from"./button-Bhru3s4I.js";import{t as c}from"./icon-BAP3aECg.js";import{a as l,i as u,n as d,o as f,r as p,t as m}from"./component-CI3ThXYz.js";import{n as h,t as g}from"./taggedTemplateLiteral-DxWpUJWn.js";import{n as _,t as v}from"./PaddingDecorator-29WbdGSg.js";import{t as y}from"./option-DE4zz7yv.js";import{t as b}from"./optgroup-B5dp8xhT.js";import{t as x}from"./select-CNtP0nEK.js";import{n as S,t as C}from"./select-DHagx0Kq.js";var w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=e((()=>{x(),y(),b(),c(),s(),t(),C(),p(),r(),v(),a(),h(),{userEvent:w}=__STORYBOOK_MODULE_TEST__,{args:O,argTypes:k}=u(`syn-select`),{overrideArgs:A}=l(`syn-select`),{generateTemplate:j}=f(`syn-select`),M={args:O,argTypes:k,component:`syn-select`,parameters:{chromatic:{modes:i},design:o(`41325-310740`),docs:{description:{component:d(`select`,`default`)},story:{height:`250px`}}},tags:[`Form`],title:`Components/syn-select`},N={parameters:{args:A({name:`default`,type:`slot`,value:`
  ...
  `},R={decorators:[_()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:d(`select`,`focus`)}}},play:({canvasElement:e})=>{e.querySelector(`syn-select`)?.focus()},render:()=>n`
    <syn-select label="Select one">
      <syn-option value="option-1">Option 1</syn-option>
      <syn-option value="option-2">Option 2</syn-option>
      <syn-option value="option-3">Option 3</syn-option>
  ...
  `},H={parameters:{docs:{description:{story:d(`select`,`initialvalue`)}}},render:()=>n(T||=g([`
  ...
  `},q={parameters:{docs:{description:{story:d(`select`,`gettag`)}}},render:()=>n(E||=g([`
    <syn-select
      clearable
