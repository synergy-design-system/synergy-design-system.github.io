import{e as _}from"./class-map-DuCXFyun.js";import{H as g}from"./slot-9EVoRGQc.js";import{k as d,c as m}from"./iframe-CfKmpROb.js";import{o as u}from"./if-defined-DcCHMlyu.js";import{S as f,c as y,n as c}from"./synergy-element-D6uzLjd8.js";import{r as v,S as x}from"./icon.component-BOIuuAKO.js";import{a as p}from"./query-D0jTsbLw.js";import{w as S}from"./watch-CEsCE2EF.js";import{L as w}from"./controller-0nuky388.js";const C=d`
	/* stylelint-disable */
  :host {
    display: inline-flex;
  }
...
`;var E=Object.defineProperty,h=(s,r,e,a)=>{for(var t=void 0,i=s.length-1,n;i>=0;i--)(n=s[i])&&(t=n(r,e,t)||t);return t&&E(r,e,t),t};class b extends f{constructor(){super(...arguments),this.localize=new w(this),this.separatorDir=this.localize.dir(),this.label=""}static{this.styles=[y,A,D]}static{this.dependencies={"syn-icon":x}}getSeparator(){const e=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[e,...e.querySelectorAll("[id]")].forEach(a=>a.removeAttribute("id")),e.setAttribute("data-default",""),e.slot="separator",e}handleSlotChange(){const r=[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>e.tagName.toLowerCase()==="syn-breadcrumb-item");r.forEach((e,a)=>{const t=e.querySelector('[slot="separator"]');t===null?e.append(this.getSeparator()):t.hasAttribute("data-default")&&t.replaceWith(this.getSeparator()),a===r.length-1?e.setAttribute("aria-current","page"):e.removeAttribute("aria-current")})}render(){return this.separatorDir!==this.localize.dir()&&(this.separatorDir=this.localize.dir(),this.updateComplete.then(()=>this.handleSlotChange())),m`
    ...
    `}}h([p("slot")],b.prototype,"defaultSlot");h([p('slot[name="separator"]')],b.prototype,"separatorSlot");h([c()],b.prototype,"label");b.define("syn-breadcrumb");
