import{k as c}from"./directive-helpers-B-JxG5af.js";import{a as m}from"./ref-DMm6gEez.js";import{g as e,a as y,s as h,b as g,c as u,d as f}from"./component-DJQbWcOU.js";import"./if-defined-98Biveud.js";import"./chunk-L4EGOTBX-Mt8q4xcs.js";import"./entry-preview-CWKZl0rh.js";import"./index-ogSvIofg.js";import"./icon-button-B618sG2i.js";import"./library-UYMiFSYt.js";import"./icon.component-CEnKTybK.js";import"./index-Vx7n56Jp.js";import"./index-CYQpqK1Q.js";import"./_commonjsHelpers-CqkleIqs.js";import"./icon-D4nLdb-j.js";const{args:x,argTypes:b}=h("syn-card"),{overrideArgs:S}=g("syn-card"),{generateTemplate:v}=u("syn-card"),l=({buttonText:d="More Info",footerText:p="Optional information"}={})=>`
  <footer slot="footer">
    <small>${p}</small>
    <nav>
...
`,O={args:S([{name:"image",type:"slot",value:'<img slot="image" src="https://synergy-design-system.github.io/card-example.jpg" alt="Multiple persons having lunch in SICK Academy" />'},{name:"default",type:"slot",value:`
        <h3>Headline</h3>
        This are some happy employees, but not just any employees. These are SICK employees.
      `},{name:"footer",type:"slot",value:l()}],x),argTypes:b,component:"syn-card",parameters:{design:y("15409-74106"),docs:{description:{component:e("card","default")}}},title:"Components/syn-card"},r={parameters:{controls:{disable:!1},docs:{description:{story:e("card","default")}}},render:d=>v({args:d})},a={parameters:{docs:{description:{story:e("card","basic-card")}}},render:()=>c`
  ...
  `},i=f({Default:r,BasicCard:a,CardWithHeader:s,CardWithFooter:t,Images:o,SharpCard:n},600);r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  Images,
  SharpCard
}, 600)`,...i.parameters?.docs?.source}}};const Y=["Default","BasicCard","CardWithHeader","CardWithFooter","Images","SharpCard","Screenshot"];export{a as BasicCard,t as CardWithFooter,s as CardWithHeader,r as Default,o as Images,i as Screenshot,n as SharpCard,Y as __namedExportsOrder,O as default};
