import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,Ut as r,d as i,f as a,g as o,u as s}from"./iframe-BcSabCAt.js";import{n as c,t as l}from"./localize-BO4uh8LG.js";import{a as u,i as d,m as f,n as p,o as m,p as h,r as g,s as _,t as v,u as y}from"./synergy-element-B9jDHluB.js";import{t as b}from"./button-Bhru3s4I.js";import{t as x}from"./icon-BAP3aECg.js";import{a as S,i as C,n as w,o as T,r as E,t as D}from"./component-CI3ThXYz.js";import{n as O,t as k}from"./taggedTemplateLiteral-DxWpUJWn.js";var A,j=e((()=>{t(),A=r`
	/* stylelint-disable */
  :host {
    --size: 128px;
    --track-width: 4px;
...
`})),P,F=e((()=>{t(),l(),_(),m(),p(),j(),N(),d(),P=class extends v{constructor(...e){super(...e),this.localize=new c(this),this.value=0,this.label=``}static{this.styles=[u,A,M]}updated(e){if(super.updated(e),e.has(`value`)){let e=parseFloat(getComputedStyle(this.indicator).getPropertyValue(`r`)),t=2*Math.PI*e,n=t-this.value/100*t;this.indicatorOffset=`${n}px`}}render(){return n`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
