import{i as e}from"./preload-helper-xPQekRTU.js";import{Ht as t,It as n,Lt as r,d as i,f as ee,g as te,qt as a,u as ne}from"./iframe-BjJCO_Oc.js";import{r as re,t as ie}from"./if-defined-B8V0AGPZ.js";import{_ as o,a as ae,f as oe,i as s,l as se,n as c,o as ce,r as l,s as u,t as d,x as le,y as f}from"./synergy-element-C6zHV5cB.js";import{n as p,t as m}from"./watch-I6gMK-uE.js";import{n as h,t as ue}from"./decorator-ChmomMqD.js";import{t as de}from"./button-Cq0pTj4t.js";import{a as fe,i as pe,n as g,o as me,r as he,t as ge}from"./component-Bp0Gg8Fw.js";import{n as _e,t as _}from"./taggedTemplateLiteral-pWa2IaV6.js";import{n as ve,t as ye}from"./alert.component-BOBnhBEx.js";import{n as be,t as xe}from"./tooltip.component-18HLb67u.js";import{t as Se}from"./input-Bcx7qFnd.js";var v,y,b,x,S,C,w,T,E,D,O,k=e((()=>{c(),v=[`blur`,`change`,`clear`,`focus`,`invalid`,`input`,`move`],y=(e,t)=>e.includes(t),b=e=>y(e,`blur`),x=e=>y(e,`invalid`),S=e=>e instanceof d,C=(e=``)=>e.split(` `).map(e=>e.trim()).filter(Boolean),w=(e,t)=>{let n=t.trim();return S(e)&&v.includes(n)?`syn-${n}`:n},T=e=>{if(!S(e))return;let{size:t}=e;return t??void 0},E={"syn-checkbox":`input`,"syn-combobox":`.combobox__value-input`,"syn-file":`input`,"syn-input":`input`,"syn-radio-group":`input`,"syn-range":`.input__control`,"syn-select":`.select__value-input`,"syn-switch":`input`,"syn-textarea":`.textarea__control`},D=(e,t)=>e.shadowRoot?.querySelector(t)??null,O=e=>{if(!e)return;if(!e.shadowRoot)return e;let t=E[e.tagName.toLowerCase()];if(t){let n=D(e,t);if(n)return n}return D(e,`input,select,textarea`)||e}})),A,Ce=e((()=>{n(),A=a`
  .validate {
    display: flex;
