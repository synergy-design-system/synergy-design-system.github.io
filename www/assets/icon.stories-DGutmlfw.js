import"./icon-D4nLdb-j.js";import{k as n}from"./directive-helpers-B-JxG5af.js";import{a as f,s as h,b as g,c as b,d as v}from"./component-CSnz1eqc.js";import{r as d}from"./library-UYMiFSYt.js";import{d as u}from"./default-icons-B7cd3LAo.js";import"./icon.component-CEnKTybK.js";import"./if-defined-98Biveud.js";import"./ref-DMm6gEez.js";import"./chunk-L4EGOTBX-Mt8q4xcs.js";import"./entry-preview-CWKZl0rh.js";import"./index-ogSvIofg.js";import"./icon-button-B618sG2i.js";import"./index-Vx7n56Jp.js";import"./index-CYQpqK1Q.js";import"./_commonjsHelpers-CqkleIqs.js";const{args:w,argTypes:S}=h("syn-icon"),{overrideArgs:I}=g("syn-icon"),{generateTemplate:C}=b("syn-icon"),_=`
...
---
`,R={args:I({name:"name",type:"attribute",value:"wallpaper"},w),argTypes:S,component:"syn-icon",parameters:{design:f("1616-1512"),docs:{description:{component:_}}},title:"Components/syn-icon"},s={parameters:{controls:{disable:!1}},render:e=>C({args:e})},t={render:()=>n`<div style="color: var(--syn-color-primary-600);">
...
\`\`\``,...l.parameters?.docs?.description}}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`generateScreenshotStory({
  ...
  BundledIconLibrary,
  SpriteSheetUsage
})`,...y.parameters?.docs?.source}}};const U=["Default","Colors","Sizing","Labels","CustomIcons","CDNIconLibrary","BundledIconLibrary","SpriteSheetUsage","Screenshot"];export{c as BundledIconLibrary,a as CDNIconLibrary,t as Colors,i as CustomIcons,s as Default,r as Labels,y as Screenshot,o as Sizing,l as SpriteSheetUsage,U as __namedExportsOrder,R as default};
