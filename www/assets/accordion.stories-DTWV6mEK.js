import{k as D,c as t,C as q,d as x}from"./iframe-CfKmpROb.js";import{c as L,n as h,S as E}from"./synergy-element-D6uzLjd8.js";import{o as z}from"./query-assigned-elements-CIlqV-be.js";import{e as C}from"./class-map-DuCXFyun.js";import{w as A}from"./watch-CEsCE2EF.js";import{e as _}from"./decorator-jbWt9cIm.js";import"./details-Dw3Tvm-j.js";import{g as r,a as w,s as O,b as P,c as F}from"./component-CDJDa1-b.js";import{p as T}from"./PaddingDecorator-D47DJ8sS.js";import"./preload-helper-PPVm8Dsz.js";import"./query-D0jTsbLw.js";import"./functions-DCU90qiI.js";import"./animation-registry-DyRYqZdt.js";import"./controller-0nuky388.js";import"./event-B0iVuGLD.js";import"./icon.component-BOIuuAKO.js";import"./index-3hbeBem-.js";import"./_docs-VWJ8UqMU.js";const $=D`
  :host {
    display: block;
  }
...
`;var I=Object.defineProperty,U=Object.getOwnPropertyDescriptor,n=(e,a,b,c)=>{for(var o=c>1?void 0:c?U(a,b):a,g=e.length-1,v;g>=0;g--)(v=e[g])&&(o=(c?v(a,b,o):v(o))||o);return c&&o&&I(a,b,o),o};let s=class extends E{constructor(){super(...arguments),this.closeOthers=!1,this.contained=!1,this.size="medium",this.handleAccordionShow=e=>{this.closeOthers&&this.detailsInDefaultSlot.forEach(a=>{a!==e.target&&a.parentNode===e.target.parentNode&&a.removeAttribute("open")})}}adjustDetailsSize(){this.detailsInDefaultSlot.forEach(e=>{e.setAttribute("size",this.size)})}adjustDetailsContained(){this.detailsInDefaultSlot.forEach(e=>{e.contained=this.contained})}handleSizeChange(){this.adjustDetailsSize()}handleContainedChange(){this.adjustDetailsContained()}connectedCallback(){super.connectedCallback(),this.addEventListener("syn-show",this.handleAccordionShow)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("syn-show",this.handleAccordionShow)}handleSlotChange(){this.adjustDetailsSize(),this.adjustDetailsContained()}render(){return t`
      <div 
        part="base"
        class=${C({accordion:!0,"accordion--contained":this.contained})}>
        <slot @slotchange=${this.handleSlotChange}></slot>
      </div>
    `}};s.styles=[L,$];n([z({selector:"syn-details"})],s.prototype,"detailsInDefaultSlot",2);n([h({attribute:"close-others",type:Boolean})],s.prototype,"closeOthers",2);n([h({reflect:!0,type:Boolean})],s.prototype,"contained",2);n([h({reflect:!0})],s.prototype,"size",2);n([A("size",{waitUntilFirstUpdate:!0})],s.prototype,"handleSizeChange",1);n([A("contained",{waitUntilFirstUpdate:!0})],s.prototype,"handleContainedChange",1);s=n([_("SynAccordion")],s);s.define("syn-accordion");var f=Object.freeze,k=Object.defineProperty,G=(e,a)=>f(k(e,"raw",{value:f(e.slice())})),S;const{args:B,argTypes:N}=O("syn-accordion"),{overrideArgs:R}=F("syn-accordion"),{generateTemplate:H}=P("syn-accordion"),me={args:R([{name:"default",type:"slot",value:`
      ...
      `}],B),argTypes:N,component:"syn-accordion",parameters:{chromatic:{modes:q},design:x("41094-279501"),docs:{description:{component:r("accordion","default")}}},tags:["Structure"],title:"Components/syn-accordion"},i={parameters:{controls:{disable:!1},docs:{description:{story:r("accordion","default")}}},render:e=>H({args:e})},d={parameters:{docs:{description:{story:r("accordion","contained")}}},render:()=>t`
  ...
  `}),m=j(!1),M=j(!0),u={parameters:{docs:{description:{story:r("accordion","size")}}},render:()=>t(S||(S=G([`
    `,`
  ...
  `])),["small","medium","large"].map(e=>t`
    ...
    `))},p=w({Default:i,Contained:d,GroupingDetails:l,Disabled:m,DisabledAndContained:M,Sizes:u},1150);i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  Sizes
}, 1150)`,...p.parameters?.docs?.source}}};const ue=["Default","Contained","GroupingDetails","Focus","Disabled","Sizes","Screenshot"];export{d as Contained,i as Default,m as Disabled,y as Focus,l as GroupingDetails,p as Screenshot,u as Sizes,ue as __namedExportsOrder,me as default};
