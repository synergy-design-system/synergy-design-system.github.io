import{R as a}from"./index-4g5l5LRQ.js";import{T as p,e as u,D as y,f}from"./index-1gWLh-SY.js";import{x as r}from"./directive-helpers-tpKi8sjc.js";import{p as g}from"./preview-pf1OQf_g.js";import"./_commonjsHelpers-4gQjN7DL.js";import"./iframe-jG6-tfMU.js";import"../sb-preview/runtime.js";import"./index-ogXoivrg.js";import"./index-nb0QhqUB.js";import"./index-PPLHz8o0.js";import"./icon.component-0QFYXbR8.js";import"./icon-button-J3zlNkMs.js";import"./icon-q7_MOZC1.js";const b={headline:"Contact Form",subHeadline:"Please fill in your personal information and let us know how we can help you.",topicLabel:"Your question concerns? *",topicsErrorMessage:"Please select at least one topic",topics:["Inquiry/offer","Orders/invoices","Returns/complaint","Documentation/CAD","Accessories selection","Application review","Commissioning support"],requestLabel:"Please fill in your personal information and let us know how we can help you.",requestContent:"It is very helpful if the description is as precise as possible to enable us to process your enquiry correctly. When describing applications, please specify the material/dimensions/speed, if applicable.",messageLabel:"Message",contactDetailsLabel:"Your contact details:",customerNumberLabel:"Customer Number",companyNameLabel:"Company name",nameLabel:"Your Name",addressLabel:"Address",zipLabel:"Postal Code",cityLabel:"City",countryLabel:"Country",countries:["Deutschland","USA","China"],referenceContactLabel:"Your reference contact",phoneLabel:"Phone number",faxLabel:"Fax number",emailLabel:"E-Mail address",newsletterLabel:"Yes, I would like to receive up-to-date and interesting information on solutions with products, systems and services from SICK by email on a regular basis. I can withdraw my consent at any time. To withdraw my consent, I can use the unsubscribe link in every newsletter / email at any time.",submitLabel:"Send",requiredFieldInfo:"Fields marked * are required. Your data will be treated accordingly to",requiredFieldLink:"Data protection",requiredFieldEnd:"law"},h={contactForm:b},n=(e,t="Not found",c=!0)=>e.split(".").reduce((m,d)=>m?.[d],h)??`${t}${c?` (Key: ${e})`:""}`;var s=Object.freeze,v=Object.defineProperty,F=(e,t)=>s(v(e,"raw",{value:s(t||e.slice())})),l;const O={parameters:{docs:{page:()=>a.createElement(a.Fragment,null,a.createElement(p,null),a.createElement(u,null),a.createElement(y,null),a.createElement(f,{title:""})),story:{iframeHeight:1600,inline:!1}}},title:"Templates/Forms"},i={parameters:{chromatic:{...g?.parameters?.chromatic,disableSnapshot:!1}},render:()=>r(l||(l=F([`
    <style>
    .synergy-form-demo {
    ...
    <\/script>
  `])),n("contactForm.headline"),n("contactForm.subHeadline"),n("contactForm.topicLabel"),n("contactForm.topics").map((e,t)=>r`
...
}`,...o.parameters?.docs?.source}}};const P=["ContactForm","ContactFormTablet"];export{i as ContactForm,o as ContactFormTablet,P as __namedExportsOrder,O as default};
