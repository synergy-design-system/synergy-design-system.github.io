var On=Object.freeze,Ri=Object.defineProperty;var Dn=(t,e)=>On(Ri(t,"raw",{value:On(e||t.slice())}));import{R as f,d as Zn,k as C,t as ue,e as u,b as y,a as kt,f as Wi}from"./if-defined-98Biveud.js";import{i as h,k as p,D as ei,u as In,Q as Ui,R as qi}from"./directive-helpers-B-JxG5af.js";import{h as ti,$ as ni,r as ii,L as Ki,F as Ct,b as Gi,o as Yi,c as Nn,f as Xi,s as Qi,d as Ji,p as an,e as Zi,g as ea,a as ai,k as ta,K as na,j as ia,i as aa,t as oa}from"./ref-DMm6gEez.js";import{s as sa}from"./chunk-L4EGOTBX-Mt8q4xcs.js";import"./entry-preview-CWKZl0rh.js";import{e as se,S as ut,d as ra}from"./icon-button-Hx1LwkdA.js";import{d as la}from"./index-ogSvIofg.js";import"./index-CYQpqK1Q.js";import{n as r,a as b}from"./library-UYMiFSYt.js";import{c as x,w as m,a as w,S as Te}from"./icon.component-DYLG64TD.js";import"./icon-BdYUBF6z.js";import{a as da}from"./index-Vx7n56Jp.js";const ca=h`
  :host {
    display: block;
  }
...
`,Yt=t=>{const{activeElement:e}=document;e&&t.contains(e)&&document.activeElement?.blur()};var Ja=Object.defineProperty,Za=Object.getOwnPropertyDescriptor,Ae=(t,e,n,a)=>{for(var i=a>1?void 0:a?Za(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&Ja(e,n,i),i};let X=class extends w{constructor(){super(...arguments),this.hasSlotController=new J(this,"icon","suffix"),this.localize=new R(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.remainingTime=this.duration}static get toastStack(){return this.currentToastStack||(this.currentToastStack=Object.assign(document.createElement("div"),{className:"syn-toast-stack"})),this.currentToastStack}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){this.countdownAnimation?.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),this.countdownAnimation?.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){const{countdownElement:t}=this,e="100%",n="0";this.countdownAnimation=t.animate([{width:e},{width:n}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.duration<1/0&&this.restartAutoHide(),await Z(this.base),this.base.hidden=!1;const{keyframes:t,options:e}=j(this,"alert.show",{dir:this.localize.dir()});await U(this.base,t,e),this.emit("syn-after-show")}else{Yt(this),this.emit("syn-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await Z(this.base);const{keyframes:t,options:e}=j(this,"alert.hide",{dir:this.localize.dir()});await U(this.base,t,e),this.base.hidden=!0,this.emit("syn-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,Q(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,Q(this,"syn-after-hide")}async toast(){return new Promise(t=>{this.handleCountdownChange(),X.toastStack.parentElement===null&&document.body.append(X.toastStack),X.toastStack.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("syn-after-hide",()=>{X.toastStack.removeChild(this),t(),X.toastStack.querySelector("syn-alert")===null&&X.toastStack.remove()},{once:!0})})}render(){return p`
    ...
    `}};X.styles=[x,Xa,Qa];X.dependencies={"syn-icon-button":ut};Ae([u('[part~="base"]')],X.prototype,"base",2);Ae([u(".alert__countdown-elapsed")],X.prototype,"countdownElement",2);Ae([r({type:Boolean,reflect:!0})],X.prototype,"open",2);Ae([r({type:Boolean,reflect:!0})],X.prototype,"closable",2);Ae([r({reflect:!0})],X.prototype,"variant",2);Ae([r({type:Number})],X.prototype,"duration",2);Ae([b()],X.prototype,"remainingTime",2);Ae([m("open",{waitUntilFirstUpdate:!0})],X.prototype,"handleOpenChange",1);Ae([m("duration")],X.prototype,"handleDurationChange",1);X=Ae([se("SynAlert")],X);S("alert.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});S("alert.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});X.define("syn-alert");const eo=h`
	/* stylelint-disable */
  :host {
    display: inline-flex;
  }
...
`;var so=Object.defineProperty,ro=Object.getOwnPropertyDescriptor,mt=(t,e,n,a)=>{for(var i=a>1?void 0:a?ro(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&so(e,n,i),i};class st extends w{constructor(){super(...arguments),this.hasSlotController=new J(this,"prefix","suffix"),this.renderType="button",this.rel="noreferrer noopener"}static{this.styles=[x,ao,oo]}setRenderType(){const e=this.defaultSlot.assignedElements({flatten:!0}).filter(n=>n.tagName.toLowerCase()==="syn-dropdown").length>0;if(this.href){this.renderType="link";return}if(e){this.renderType="dropdown";return}this.renderType="button"}hrefChanged(){this.setRenderType()}handleSlotChange(){this.setRenderType()}render(){return p`
    ...
    `}}mt([u("slot:not([name])")],st.prototype,"defaultSlot",2);mt([b()],st.prototype,"renderType",2);mt([r()],st.prototype,"href",2);mt([r()],st.prototype,"target",2);mt([r()],st.prototype,"rel",2);mt([m("href",{waitUntilFirstUpdate:!0})],st.prototype,"hrefChanged",1);st.define("syn-breadcrumb-item");const lo=h`
	/* stylelint-disable */
  .breadcrumb {
    display: flex;
    align-items: center;
...
`;var ko=Object.defineProperty,_o=(t,e,n,a)=>{for(var i=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=s(e,n,i)||i);return i&&ko(e,n,i),i};class _i extends w{constructor(){super(...arguments),this.hasSlotController=new J(this,"footer","header","image"),this.sharp=!1}static{this.styles=[x,wo,xo]}render(){return p`
    ...
    `}}_o([r({type:Boolean,reflect:!0})],_i.prototype,"sharp");_i.define("syn-card");const rt=(t="value")=>(e,n)=>{const a=e.constructor,i=a.prototype.attributeChangedCallback;a.prototype.attributeChangedCallback=function(o,s,l){const d=a.getPropertyOptions(t),c=typeof d.attribute=="string"?d.attribute:t;if(o===c){const g=d.converter||In,Y=(typeof g=="function"?g:g?.fromAttribute??In.fromAttribute)(l,d.type);this[t]!==Y&&(this[n]=Y)}i.call(this,o,s,l)}},Fe=h`
	/* stylelint-disable */
...
`;var So=Object.defineProperty,zo=Object.getOwnPropertyDescriptor,de=(t,e,n,a)=>{for(var i=a>1?void 0:a?zo(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&So(e,n,i),i};let ee=class extends w{constructor(){super(...arguments),this.formControlController=new Me(this,{value:t=>t.checked?t.value||"on":void 0,defaultValue:t=>t.defaultChecked,setValue:(t,e)=>t.checked=e}),this.hasSlotController=new J(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.indeterminate=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleClick(){this.checked=!this.checked,this.indeterminate=!1,this.emit("syn-change")}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleInput(){this.emit("syn-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStateChange(){this.input.checked=this.checked,this.input.indeterminate=this.indeterminate,this.formControlController.updateValidity()}click(){this.input.click()}focus(t){this.input.focus(t)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("help-text"),e=this.helpText?!0:!!t;return p`
    ...
    `}};ee.styles=[x,Fe,To,Ve,Co];ee.dependencies={"syn-icon":Te};de([u('input[type="checkbox"]')],ee.prototype,"input",2);de([b()],ee.prototype,"hasFocus",2);de([r()],ee.prototype,"title",2);de([r()],ee.prototype,"name",2);de([r()],ee.prototype,"value",2);de([r({reflect:!0})],ee.prototype,"size",2);de([r({type:Boolean,reflect:!0})],ee.prototype,"disabled",2);de([r({type:Boolean,reflect:!0})],ee.prototype,"checked",2);de([r({type:Boolean,reflect:!0})],ee.prototype,"indeterminate",2);de([rt("checked")],ee.prototype,"defaultChecked",2);de([r({reflect:!0})],ee.prototype,"form",2);de([r({type:Boolean,reflect:!0})],ee.prototype,"required",2);de([r({attribute:"help-text"})],ee.prototype,"helpText",2);de([m("disabled",{waitUntilFirstUpdate:!0})],ee.prototype,"handleDisabledChange",1);de([m(["checked","indeterminate"],{waitUntilFirstUpdate:!0})],ee.prototype,"handleStateChange",1);ee=de([se("SynCheckbox")],ee);ee.define("syn-checkbox");const Eo=h`
	/* stylelint-disable */
  :host {
...
`;var Bs=Object.defineProperty,Ei=(t,e,n,a)=>{for(var i=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=s(e,n,i)||i);return i&&Bs(e,n,i),i};class Jt extends w{constructor(){super(...arguments),this.hasMenuItemsWithCheckmarks=!1,this.updateCheckMarksByChildPropChange=e=>{e.stopImmediatePropagation(),this.handleUpdateCheckmarks(this.getAllItems())}}static{this.styles=[x,Fs,Vs]}handleUpdateCheckmarks(e){this.hasMenuItemsWithCheckmarks=e.some(n=>n.type==="checkbox"||n.loading)}disconnectedCallback(){this.removeEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu"),this.addEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}handleClick(e){const n=["menuitem","menuitemcheckbox"],a=e.composedPath(),i=a.find(d=>n.includes(d?.getAttribute?.("role")||""));if(!i||a.find(d=>d?.getAttribute?.("role")==="menu")!==this)return;const l=i;l.type==="checkbox"&&(l.checked=!l.checked),this.emit("syn-select",{detail:{item:l}})}handleKeyDown(e){if(e.key==="Enter"||e.key===" "){const n=this.getCurrentItem();e.preventDefault(),e.stopPropagation(),n?.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(e.key)){const n=this.getAllItems(),a=this.getCurrentItem();let i=a?n.indexOf(a):0;n.length>0&&(e.preventDefault(),e.stopPropagation(),e.key==="ArrowDown"?i++:e.key==="ArrowUp"?i--:e.key==="Home"?i=0:e.key==="End"&&(i=n.length-1),i<0&&(i=n.length-1),i>n.length-1&&(i=0),this.setCurrentItem(n[i]),n[i].focus())}}handleMouseDown(e){const n=e.target;this.isMenuItem(n)&&this.setCurrentItem(n)}handleSlotChange(){const e=this.getAllItems();this.handleUpdateCheckmarks(e),e.length>0&&this.setCurrentItem(e[0])}isMenuItem(e){return e.tagName.toLowerCase()==="syn-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes(e.getAttribute("role")??"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>!(e.inert||!this.isMenuItem(e)))}getCurrentItem(){return this.getAllItems().find(e=>e.getAttribute("tabindex")==="0")}setCurrentItem(e){this.getAllItems().forEach(a=>{a.setAttribute("tabindex",a===e?"0":"-1")})}render(){return p`
      ...
      ></slot>
    `}}Ei([u("slot")],Jt.prototype,"defaultSlot");Ei([b()],Jt.prototype,"hasMenuItemsWithCheckmarks");Jt.define("syn-menu");const Hs=h`
  /**
...
`;var ar=Object.defineProperty,tn=(t,e,n,a)=>{for(var i=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=s(e,n,i)||i);return i&&ar(e,n,i),i};class Mt extends w{constructor(){super(...arguments),this.localize=new R(this),this.value=0,this.label=""}static{this.styles=[x,nr,ir]}updated(e){if(super.updated(e),e.has("value")){const n=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),a=2*Math.PI*n,i=a-this.value/100*a;this.indicatorOffset=`${i}px`}}render(){return p`
    ...
    `}}tn([u(".progress-ring__indicator")],Mt.prototype,"indicator");tn([b()],Mt.prototype,"indicatorOffset");tn([r({type:Number,reflect:!0})],Mt.prototype,"value");tn([r()],Mt.prototype,"label");Mt.define("syn-progress-ring");const or=h`
	/* stylelint-disable */
  ${ki}
...
`;var cr=Object.defineProperty,pr=Object.getOwnPropertyDescriptor,be=(t,e,n,a)=>{for(var i=a>1?void 0:a?pr(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&cr(e,n,i),i};let ne=class extends w{constructor(){super(...arguments),this.formControlController=new Me(this),this.hasSlotController=new J(this,"help-text","label"),this.customValidityMessage="",this.hasButtonGroup=!1,this.errorMessage="",this.defaultValue="",this.label="",this.helpText="",this.name="option",this.value="",this.size="medium",this.form="",this.required=!1}get validity(){const t=this.required&&!this.value;return this.customValidityMessage!==""?xi:t?mo:It}get validationMessage(){const t=this.required&&!this.value;return this.customValidityMessage!==""?this.customValidityMessage:t?this.validationInput.validationMessage:""}connectedCallback(){super.connectedCallback(),this.defaultValue=this.value}firstUpdated(){this.formControlController.updateValidity()}getAllRadios(){return[...this.querySelectorAll("syn-radio, syn-radio-button")]}handleRadioClick(t){const e=t.target.closest("syn-radio, syn-radio-button"),n=this.getAllRadios(),a=this.value;!e||e.disabled||(this.value=e.value,n.forEach(i=>i.checked=i===e),this.value!==a&&(this.emit("syn-change"),this.emit("syn-input")))}handleKeyDown(t){if(!["ArrowUp","ArrowDown","ArrowLeft","ArrowRight"," "].includes(t.key))return;const e=this.getAllRadios().filter(s=>!s.disabled),n=e.find(s=>s.checked)??e[0],a=t.key===" "?0:["ArrowUp","ArrowLeft"].includes(t.key)?-1:1,i=this.value;let o=e.indexOf(n)+a;o<0&&(o=e.length-1),o>e.length-1&&(o=0),this.getAllRadios().forEach(s=>{s.checked=!1,this.hasButtonGroup||s.setAttribute("tabindex","-1")}),this.value=e[o].value,e[o].checked=!0,this.hasButtonGroup?e[o].shadowRoot.querySelector("button").focus():(e[o].setAttribute("tabindex","0"),e[o].focus()),this.value!==i&&(this.emit("syn-change"),this.emit("syn-input")),t.preventDefault()}handleLabelClick(){this.focus()}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}async syncRadioElements(){const t=this.getAllRadios();if(await Promise.all(t.map(async e=>{await e.updateComplete,e.checked=e.value===this.value,e.size=this.size})),this.hasButtonGroup=t.some(e=>e.tagName.toLowerCase()==="syn-radio-button"),t.length>0&&!t.some(e=>e.checked))if(this.hasButtonGroup){const e=t[0].shadowRoot?.querySelector("button");e&&e.setAttribute("tabindex","0")}else t[0].setAttribute("tabindex","0");if(this.hasButtonGroup){const e=this.shadowRoot?.querySelector("syn-button-group");e&&(e.disableRole=!0)}}syncRadios(){if(customElements.get("syn-radio")&&customElements.get("syn-radio-button")){this.syncRadioElements();return}customElements.get("syn-radio")?this.syncRadioElements():customElements.whenDefined("syn-radio").then(()=>this.syncRadios()),customElements.get("syn-radio-button")?this.syncRadioElements():customElements.whenDefined("syn-radio-button").then(()=>this.syncRadios())}updateCheckedRadio(){this.getAllRadios().forEach(e=>e.checked=e.value===this.value),this.formControlController.setValidity(this.validity.valid)}handleSizeChange(){this.syncRadios()}handleValueChange(){this.hasUpdated&&this.updateCheckedRadio()}checkValidity(){const t=this.required&&!this.value,e=this.customValidityMessage!=="";return t||e?(this.formControlController.emitInvalidEvent(),!1):!0}getForm(){return this.formControlController.getForm()}reportValidity(){const t=this.validity.valid;return this.errorMessage=this.customValidityMessage||t?"":this.validationInput.validationMessage,this.formControlController.setValidity(t),this.validationInput.hidden=!0,clearTimeout(this.validationTimeout),t||(this.validationInput.hidden=!1,this.validationInput.reportValidity(),this.validationTimeout=setTimeout(()=>this.validationInput.hidden=!0,1e4)),t}setCustomValidity(t=""){this.customValidityMessage=t,this.errorMessage=t,this.validationInput.setCustomValidity(t),this.formControlController.updateValidity()}focus(t){const e=this.getAllRadios(),n=e.find(o=>o.checked),a=e.find(o=>!o.disabled),i=n||a;i&&i.focus(t)}render(){const t=this.hasSlotController.test("label"),e=this.hasSlotController.test("help-text"),n=this.label?!0:!!t,a=this.helpText?!0:!!e,i=p`
    ...
    `}};ne.styles=[x,Fe,lr,Ve,dr];ne.dependencies={"syn-button-group":Dt};be([u("slot:not([name])")],ne.prototype,"defaultSlot",2);be([u(".radio-group__validation-input")],ne.prototype,"validationInput",2);be([b()],ne.prototype,"hasButtonGroup",2);be([b()],ne.prototype,"errorMessage",2);be([b()],ne.prototype,"defaultValue",2);be([r()],ne.prototype,"label",2);be([r({attribute:"help-text"})],ne.prototype,"helpText",2);be([r()],ne.prototype,"name",2);be([r({reflect:!0})],ne.prototype,"value",2);be([r({reflect:!0})],ne.prototype,"size",2);be([r({reflect:!0})],ne.prototype,"form",2);be([r({type:Boolean,reflect:!0})],ne.prototype,"required",2);be([m("size",{waitUntilFirstUpdate:!0})],ne.prototype,"handleSizeChange",1);be([m("value")],ne.prototype,"handleValueChange",1);ne=be([se("SynRadioGroup")],ne);ne.define("syn-radio-group");const hr=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`):a=e.innerHTML,a=a.replace(/<style><\/style>/g,"").replace(/<!-- preview-ignore:start -->[\s\S]*?<!-- preview-ignore:end -->/g,"").replace(/\/\/ preview-ignore:start[\s\S]*?\/\/ preview-ignore:end/g,"").replace(/<style>\n<\/style>/g,"").replace(/<script>\s*component = document\.querySelector\('(.+?)'\);\s*<\/script>/g,""),a}},Vl=(t,e,n="components")=>{const a=ra[n][t]??{},i=a[e]?.description?.value??"No Description",o=a[e]?.note?.value??"",s=c=>c.replace(/\n/g,"<br/>"),l=s(i),d=o?`<br/><br/><strong>👨‍💻 Additional developer Information:</strong><br>${s(o)}`:"";return`${l}${d}`},Bl=(t,e=150)=>{const n=isNaN(e)?e:{heightPx:e},{afterRender:a="",additionalChromaticOptions:i={},heightPx:o=150,styleHeading:s={}}=n,l=Object.entries(s).map(([d,c])=>`${d}: ${c};`).join(" ");return{parameters:{chromatic:{...Hi?.parameters?.chromatic,...i,disableSnapshot:!1},docs:{disable:!0}},render:(d,c)=>C`
      ${Object.entries(t).map(([g,T])=>{const Y=T.name??da(g);return C`
