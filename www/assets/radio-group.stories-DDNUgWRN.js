import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{_ as r,d as i,f as a,p as o}from"./iframe-BiSXA87W.js";import{t as s}from"./button-6RBRhEco.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-BZMStFjM.js";import{n as m,t as h}from"./decorators-DxqQ03yg.js";import{t as g}from"./radio-group-Dj1j6VKL.js";import{t as _}from"./radio-button-BNH_0fZm.js";import{t as v}from"./radio-DTNGUVIN.js";var y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B=e((()=>{g(),v(),_(),s(),n(),h(),f(),a(),r(),{userEvent:y}=__STORYBOOK_MODULE_TEST__,{args:b,argTypes:x}=l(`syn-radio-group`),{overrideArgs:S}=c(`syn-radio-group`),{generateTemplate:C}=d(`syn-radio-group`),w={args:b,argTypes:x,component:`syn-radio-group`,parameters:{chromatic:{modes:o},design:i(`41310-253349`),docs:{description:{component:u(`radio-group`,`default`)}}},tags:[`Form`],title:`Components/syn-radio-group`},T=e=>`${e[0].toUpperCase()}${e.slice(1)}`,E={args:S([{name:`label`,type:`attribute`,value:`This is a label`},{name:`default`,type:`slot`,value:`<syn-radio value="1">Option</syn-radio>
  ...
  `},N={parameters:{docs:{description:{story:u(`radio-group`,`size`)}}},render:()=>t`
  ...
  `},P={decorators:[m],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`radio-group`,`invalid`)}}},play:async({canvasElement:e})=>{try{let t=e.querySelector(`syn-button`);t&&(await y.click(t),t.click(),document.activeElement?.blur())}catch(e){console.error(`Error in play function:`,e)}},render:()=>t`
  ...
  `},I={parameters:{docs:{description:{story:u(`radio-group`,`radio-buttons`)}}},render:()=>t`
  ...
  `},L={parameters:{docs:{description:{story:u(`radio-group`,`horizontal-layout`)}}},render:()=>t`
