...
<syn-button>Right</syn-button>`},y),argTypes:b,component:`syn-button-group`,parameters:{chromatic:{modes:n},docs:{description:{component:l(`button-group`,`default`)}}},title:`Components/syn-button-group`},w={parameters:{controls:{disable:!1},docs:{description:{story:l(`button-group`,`default`)}}},render:e=>S({args:e})},T={parameters:{docs:{description:{story:l(`button-group`,`variant`)}}},render:()=>i`
  ...
  `},j=f({Default:w,Variants:T,ButtonSizes:E,DropdownsInButtonGroups:D,SplitButtons:O,TooltipsInButtonGroups:k,ToolbarExample:A},280),M=[`Default`,`Variants`,`ButtonSizes`,`DropdownsInButtonGroups`,`SplitButtons`,`TooltipsInButtonGroups`,`ToolbarExample`,`Screenshot`],w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  ToolbarExample
}, 280)`,...j.parameters?.docs?.source}}}})))()}export{v as n,N as r,w as t};