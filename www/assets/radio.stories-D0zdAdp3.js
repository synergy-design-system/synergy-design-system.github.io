import{g as p}from"./preview-BfEM8BLb.js";import{k as d}from"./lit-element-BsyMe9HG.js";import{u as y}from"./index-DbQ-iIe5.js";import{s as m,a as u,g as o,b as f,c as g}from"./component-eGmRQmem.js";import"./index-B-o1Wr-g.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon.component-Cwq7Y_Aa.js";import"./directive-helpers-DUpkUCIH.js";import"./icon-button-BsnFsjAn.js";import"./icon-DiAnxFT_.js";import"./index-C8k3Z-3Y.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-D8vHI8_K.js";const{args:b,argTypes:v}=m("syn-radio"),{overrideArgs:S}=g("syn-radio"),{generateTemplate:h}=u("syn-radio"),L={args:S({name:"default",type:"slot",value:"Option"},b),argTypes:v,component:"syn-radio",parameters:{design:p("1175-2494"),docs:{description:{component:o("radio","default")}}},title:"Components/syn-radio"},s={parameters:{controls:{disable:!1},docs:{description:{story:o("radio","default")}}},render:e=>h({args:e})},a={parameters:{docs:{description:{story:o("radio","disabled")}}},render:()=>d`
    ...
    <syn-radio value="1">Option</syn-radio>`},i={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:o("radio","invalid")}}},play:async({canvasElement:e})=>{try{const r=e.querySelector("syn-radio"),l=e.querySelector("syn-button");l&&r&&(await y.click(l),l.click())}catch(r){console.error("Error in play function:",r)}},render:()=>d`
  ...
  Disabled,
  Sizes
})`,...c.parameters?.docs?.source}}};const M=["Default","Disabled","Focus","Invalid","Sizes","Screenshot"];export{s as Default,a as Disabled,n as Focus,i as Invalid,c as Screenshot,t as Sizes,M as __namedExportsOrder,L as default};
