import"./button-BHxJBGCx.js";import"./icon-B8xiByvz.js";import{g,x as n}from"./iframe-BU6pI8GJ.js";import{g as t,s as f,a as S,c as x,b as h}from"./component-B9yFO2OE.js";import{p as z}from"./PaddingDecorator-DvzPzIWq.js";import"./class-map-DSRw8Zyj.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./if-defined-D_B395BP.js";import"./localize-bgLrV2YE.js";import"./synergy-element-Dr2c-Hm7.js";import"./icon.component-CIHoI7Sg.js";import"./watch-CEsCE2EF.js";import"./query-DAIS6qJ0.js";import"./spinner.component-CtOnVRzE.js";import"./decorator-DANECR0-.js";import"./functions-CDi3doZH.js";import"./preload-helper-Ct5FWWRu.js";import"./index-Bkk0Z6Ex.js";import"./_docs-UXgsQIP6.js";const{args:v,argTypes:D}=f("syn-button"),{overrideArgs:k}=S("syn-button"),{generateTemplate:w}=x("syn-button"),J={args:k({name:"default",type:"slot",value:"Button"},v),argTypes:D,component:"syn-button",parameters:{design:g("1055-22957"),docs:{description:{component:t("button","default")}}},tags:["Form","Navigation"],title:"Components/syn-button"},s={parameters:{controls:{disable:!1},docs:{description:{story:t("button","default")}}},render:d=>w({args:d})},e={parameters:{docs:{description:{story:t("button","variant")}}},render:()=>n`
  ...
  </style>`},b={decorators:[z()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:t("button","focus")}}},play:({canvasElement:d})=>{const p=d.querySelector("syn-button");p&&p.focus()},render:()=>n`<syn-button>Default</syn-button>`},r={parameters:{docs:{description:{story:t("button","link")}}},render:()=>n`
  ...
  <syn-button variant="text" disabled>Text</syn-button>`},m=h({Default:s,Variants:e,Sizes:o,LinkButtons:r,SettingACustomWidth:i,IconOnly:a,PrefixAndSuffixIcons:y,Caret:u,Loading:l,Disabled:c},280);s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
