import{i as g,x as s}from"./directive-helpers-DGrfjhaU.js";import{o as f}from"./unsafe-html-Cjw1QqN7.js";import{a as v}from"./static-gmWA-8Kq.js";import{n as x}from"./property-BGzwfL48.js";import{H as S}from"./slot-9EVoRGQc.js";import{S as _,c as w}from"./component.styles-Do19GEOY.js";import"./button-BcNlV6Uq.js";import"./icon-button-D1Ucd6-t.js";import{g as e,a as C,s as T,b as j,d as I,c as D}from"./component-JZANH7tg.js";import"./form-d9hCJUdr.js";import"./if-defined-B2ZFWIyt.js";import"./localize-CatY2peN.js";import"./index-DihgwUfS.js";import"./library-6WV9-XO2.js";import"./query-DAIS6qJ0.js";import"./watch-CEsCE2EF.js";import"./icon.component-CmAczTJK.js";import"./spinner.component-oeFu-uyM.js";import"./decorator-DANECR0-.js";import"./functions-CDi3doZH.js";import"./icon-button.component-7SPDms-o.js";import"./async-directive-PIeysb9D.js";import"./chunk-L4EGOTBX-CsK1v_wc.js";import"./entry-preview-B_oC2lVs.js";import"./index-DrFu-skq.js";import"./_docs-CrPFe_9C.js";import"./index-_2TAQcTa.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-BmTV649i.js";import"./custom-elements-manifest-Br-JURis.js";const k=g`
	/* stylelint-disable */
  :host {
...
`;var K=Object.defineProperty,A=(r,l,y,z)=>{for(var a=void 0,m=r.length-1,h;m>=0;m--)(h=r[m])&&(a=h(l,y,a)||a);return a&&K(l,y,a),a};class u extends _{constructor(){super(...arguments),this.hasSlotController=new S(this,"footer","header","image"),this.sharp=!1}static{this.styles=[w,k,H]}render(){return s`
      <div
        part="base"
    ...
    `}}A([x({type:Boolean,reflect:!0})],u.prototype,"sharp");u.define("syn-card");const{args:F,argTypes:M}=T("syn-card"),{overrideArgs:O}=j("syn-card"),{generateTemplate:W}=I("syn-card"),b=({buttonText:r="More Info",footerText:l="Optional information"}={})=>`
  <footer slot="footer">
    <small>${l}</small>
    <nav>
...
`,hr={args:O([{name:"image",type:"slot",value:'<img slot="image" src="https://synergy-design-system.github.io/card-example.jpg" alt="Multiple persons having lunch in SICK Academy" />'},{name:"default",type:"slot",value:`
        <h3>Headline</h3>
        This are some happy employees, but not just any employees. These are SICK employees.
      `},{name:"footer",type:"slot",value:b()}],F),argTypes:M,component:"syn-card",parameters:{design:C("15409-74106"),docs:{description:{component:e("card","default")}}},title:"Components/syn-card"},o={parameters:{controls:{disable:!1},docs:{description:{story:e("card","default")}}},render:r=>W({args:r})},t={parameters:{docs:{description:{story:e("card","basic-card")}}},render:()=>s`
  ...
  `},d={parameters:{docs:{description:{story:e("card","with-footer")}}},render:()=>s`
    <syn-card class="card-footer">
      ...
      ${f(b({buttonText:"Preview",footerText:"Optional information"}))}
    </syn-card>
  ...
  Images,
  SharpCard
}, 600)`,...p.parameters?.docs?.source}}};const gr=["Default","BasicCard","CardWithHeader","CardWithFooter","Images","SharpCard","Screenshot"];export{t as BasicCard,d as CardWithFooter,n as CardWithHeader,o as Default,i as Images,p as Screenshot,c as SharpCard,gr as __namedExportsOrder,hr as default};
