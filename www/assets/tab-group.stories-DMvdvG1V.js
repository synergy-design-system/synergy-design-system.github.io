import{g as t,a as G,s as E,b as _,c as O,d as F}from"./component-zWuLQ_Ni.js";import{x as s}from"./directive-helpers-Dvm_Ferq.js";import{p as R}from"./index-mLaxDseA.js";import{o as u}from"./ref-B9GS7qLj.js";import"./library-BX4ONXik.js";import"./chunk-L4EGOTBX-Boit2UGA.js";import"./entry-preview-DkJqm5dP.js";import"./index-DrFu-skq.js";import"./icon-button-Be89tDRT.js";import"./index-_2TAQcTa.js";import"./_commonjsHelpers-CqkleIqs.js";var $=Object.freeze,q=Object.defineProperty,w=(e,n)=>$(q(e,"raw",{value:$(n||e.slice())})),S;const{args:j,argTypes:A}=E("syn-tab-group"),{overrideArgs:L}=_("syn-tab-group"),{generateTemplate:k}=O("syn-tab-group"),P=(e,n,{active:a=!1,closable:g=!1,disabled:v=!1}={})=>`<syn-tab slot="nav" panel="${e}" ${a?"active":""} ${v?"disabled":""} ${g?"closable":""}>${n}</syn-tab>`,T=(e,n,{active:a=!1,closable:g=!1,disabled:v=!1}={})=>u(P(e,n,{active:a,closable:g,disabled:v})),H=()=>[{panel:"general",props:{active:!0}},{panel:"custom"},{panel:"advanced"},{panel:"disabled",props:{disabled:!0}}].map(({panel:e,props:n})=>P(e,R(e),n)).join(`
