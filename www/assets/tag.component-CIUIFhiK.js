import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{c as t,h as n,t as r}from"./lit-D4-0ovri.js";import{a as i,d as a,n as o,o as s,r as c,s as l,t as u}from"./synergy-element-Di-hMrpy.js";import{n as d,t as f}from"./class-map-LsJiuvgY.js";import{n as p,t as m}from"./localize-Du3bqz3O.js";import{n as h,t as g}from"./decorator-DZesXZg7.js";import{n as _,t as v}from"./icon-button.component-DzTeGtG4.js";var y;function b(){return(b=e((()=>{r(),y=n`
	/* stylelint-disable */
  :host {
...
`})))()}var C,w;function T(){return(T=e((()=>{f(),r(),m(),l(),s(),o(),_(),b(),S(),h(),C=class extends u{constructor(...e){super(...e),this.localize=new p(this),this.size=`medium`,this.removable=!1}static{this.styles=[i,y,x]}static{this.dependencies={"syn-icon-button":v}}handleRemoveClick(){this.emit(`syn-remove`)}render(){return t`
      <span
        part="base"
    ...
    `}},c([a({reflect:!0})],C.prototype,`size`,void 0),c([a({type:Boolean})],C.prototype,`removable`,void 0),C=c([g(`SynTag`)],C),w=C})))()}export{w as n,T as t};