import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{a as t,d as n,o as r,s as i}from"./preview-DXkhgu0Z.js";import{c as a,t as o}from"./lit-BfcklOOD.js";import{t as s}from"./button-DVR7vfNM.js";import{t as c}from"./divider-D3jFTDSr.js";import{a as l,i as u,n as d,o as f,r as p,t as m}from"./component-B0n0ooCL.js";import{n as h,t as g}from"./menu-item-Y5fCk6TC.js";import{t as _}from"./dropdown-CEqtLr3e.js";var v,y,b,x,S,C,w,T,E,D,O=e((()=>{o(),h(),g(),_(),s(),c(),p(),r(),n(),{args:v,argTypes:y}=u(`syn-menu`),{overrideArgs:b}=l(`syn-menu`),{generateTemplate:x}=f(`syn-menu`),S={args:b([{name:`default`,type:`slot`,value:`
      ...
      `}],v),argTypes:y,component:`syn-menu`,parameters:{chromatic:{modes:i},design:t(`41203-442314`),docs:{description:{component:d(`menu`,`default`)}}},tags:[`Navigation`],title:`Components/syn-menu`},C={parameters:{controls:{disable:!1},docs:{description:{story:d(`menu`,`default`)}}},render:e=>a`
    <div style="width: 200px;">
      ${x({args:e})}
    </div>
  `},w={parameters:{docs:{description:{story:d(`menu`,`dropdown`)},story:{height:`250px`}}},render:()=>a`
  ...
  `},T={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:d(`menu`,`submenu`)}}},play:async({canvasElement:e,userEvent:t})=>{let n=e.querySelector(`syn-menu-item:last-of-type`);n&&(await t.hover(n),await n.updateComplete)},render:()=>a`
