import{n as e}from"./chunk-DnJy8xQt.js";import{At as t,Bt as n,Ft as r}from"./iframe-CFxyVgYz.js";import{n as i,t as a}from"./class-map-B2P1DYC9.js";import{n as o,t as s}from"./localize-DnZL8qNz.js";import{a as c,i as l,n as u,o as d,p as f,r as p,s as m,t as h,u as g}from"./synergy-element-DOjsnQEs.js";import{n as _,t as v}from"./watch-OXZPXmne.js";import{n as y,t as b}from"./icon.component-DSYib2bb.js";import{n as x,t as S}from"./decorator-CJ_bAnlW.js";import{a as C,c as w,i as T,l as E,n as D,o as O,t as k}from"./animation-registry-DTpGRZQp.js";import{n as A,t as j}from"./event-CAQhbrA7.js";var M,N=e((()=>{t(),M=n`
  :host {
...
`})),P,F,I=e((()=>{O(),a(),D(),t(),s(),m(),j(),v(),d(),u(),y(),N(),x(),l(),P=class extends h{constructor(...e){super(...e),this.localize=new o(this),this.open=!1,this.disabled=!1,this.contained=!1,this.size=`medium`}static{this.styles=[c,M]}static{this.dependencies={"syn-icon":b}}firstUpdated(){this.body.style.height=this.open?`auto`:`0`,this.open&&(this.details.open=!0),this.detailsObserver=new MutationObserver(e=>{for(let t of e)t.type===`attributes`&&t.attributeName===`open`&&(this.details.open?this.show():this.hide())}),this.detailsObserver.observe(this.details,{attributes:!0})}disconnectedCallback(){super.disconnectedCallback(),this.detailsObserver?.disconnect()}handleSummaryClick(e){e.preventDefault(),this.disabled||(this.open?this.hide():this.show(),this.header.focus())}handleSummaryKeyDown(e){(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),this.open?this.hide():this.show()),(e.key===`ArrowUp`||e.key===`ArrowLeft`)&&(e.preventDefault(),this.hide()),(e.key===`ArrowDown`||e.key===`ArrowRight`)&&(e.preventDefault(),this.show())}async handleOpenChange(){if(this.open){if(this.details.open=!0,this.emit(`syn-show`,{cancelable:!0}).defaultPrevented){this.open=!1,this.details.open=!1;return}await E(this.body);let{keyframes:e,options:t}=k(this,`details.show`,{dir:this.localize.dir()});await C(this.body,w(e,this.body.scrollHeight),t),this.body.style.height=`auto`,this.emit(`syn-after-show`)}else{if(this.emit(`syn-hide`,{cancelable:!0}).defaultPrevented){this.details.open=!0,this.open=!0;return}await E(this.body);let{keyframes:e,options:t}=k(this,`details.hide`,{dir:this.localize.dir()});await C(this.body,w(e,this.body.scrollHeight),t),this.body.style.height=`auto`,this.details.open=!1,this.emit(`syn-after-hide`)}}async show(){if(!(this.open||this.disabled))return this.open=!0,A(this,`syn-after-show`)}async hide(){if(!(!this.open||this.disabled))return this.open=!1,A(this,`syn-after-hide`)}render(){return r`
      <details
        part="base"
        class=${i({details:!0,"details--size-small":this.size===`small`,"details--size-medium":this.size===`medium`,"details--size-large":this.size===`large`,"details--open":this.open,"details--disabled":this.disabled,"details--contained":this.contained})}
      >
        <summary
          part="header"
          id="header"
    ...
    `}},p([g(`.details`)],P.prototype,`details`,void 0),p([g(`.details__header`)],P.prototype,`header`,void 0),p([g(`.details__body`)],P.prototype,`body`,void 0),p([g(`.details__expand-icon-slot`)],P.prototype,`expandIconSlot`,void 0),p([f({type:Boolean,reflect:!0})],P.prototype,`open`,void 0),p([f()],P.prototype,`summary`,void 0),p([f({type:Boolean,reflect:!0})],P.prototype,`disabled`,void 0),p([f({type:Boolean,reflect:!0})],P.prototype,`contained`,void 0),p([f({reflect:!0})],P.prototype,`size`,void 0),p([_(`open`,{waitUntilFirstUpdate:!0})],P.prototype,`handleOpenChange`,null),P=p([S(`SynDetails`)],P),F=P,T(`details.show`,{keyframes:[{height:`0`,opacity:`0`},{height:`auto`,opacity:`1`}],options:{duration:250,easing:`linear`}}),T(`details.hide`,{keyframes:[{height:`auto`,opacity:`1`},{height:`0`,opacity:`0`}],options:{duration:250,easing:`linear`}})})),L=e((()=>{I(),I(),F.define(`syn-details`)}));export{L as t};