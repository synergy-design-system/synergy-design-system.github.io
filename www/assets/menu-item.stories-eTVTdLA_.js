import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-DqHd0TGC.js";import{c as i,t as a}from"./lit-DgWh_IaA.js";import{t as o}from"./icon-h02C05ak.js";import{t as s}from"./divider-CfB2tdlM.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-BC2Gu1dT.js";import{t as m}from"./taggedTemplateLiteral-BZenJ0bZ.js";import{n as h,t as g}from"./menu-item-xdiqn83P.js";var _=t({CheckboxMenuItems:()=>k,Default:()=>w,Disabled:()=>E,Focus:()=>O,Loading:()=>D,PrefixAndSuffix:()=>T,Screenshot:()=>j,ValueSelection:()=>A,__namedExportsOrder:()=>M,default:()=>C}),v,y,b,x,S,C,w,T,E,D,O,k,A,j,M;function N(){return(N=e((()=>{a(),s(),h(),g(),o(),f(),r(),{args:y,argTypes:b}=l(`syn-menu-item`),{overrideArgs:x}=c(`syn-menu-item`),{generateTemplate:S}=d(`syn-menu-item`),C={args:x([{name:`default`,type:`slot`,value:`Option 1`}],y),argTypes:b,component:`syn-menu-item`,parameters:{chromatic:{modes:n},docs:{description:{component:u(`menu-item`,`default`)}}},tags:[`Navigation`],title:`Components/syn-menu-item`},w={parameters:{controls:{disable:!1},docs:{description:{story:u(`menu-item`,`default`)}}},render:e=>i`
    <syn-menu>
      ${S({args:e})}
    </syn-menu>
