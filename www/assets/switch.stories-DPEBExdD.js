import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{_ as r,d as i,f as a,p as o}from"./iframe-BJUJk-mP.js";import{t as s}from"./button-DPE3w6y_.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-Dl_LLDeh.js";import{n as m,t as h}from"./decorators-C-ZhSsaX.js";import{t as g}from"./switch-CAGKMxbc.js";var _,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N=e((()=>{g(),s(),n(),h(),f(),a(),r(),{userEvent:_}=__STORYBOOK_MODULE_TEST__,{args:v,argTypes:y}=l(`syn-switch`),{overrideArgs:b}=c(`syn-switch`),{generateTemplate:x}=d(`syn-switch`),S={args:b({name:`default`,type:`slot`,value:`Option`},v),argTypes:y,component:`syn-switch`,parameters:{chromatic:{modes:o},design:i(`41310-259132`),docs:{description:{component:u(`switch`,`default`)}}},tags:[`Form`],title:`Components/syn-switch`},C={parameters:{controls:{disable:!1},docs:{description:{story:u(`switch`,`default`)}}},render:e=>x({args:e})},w={parameters:{docs:{description:{story:u(`switch`,`checked`)}}},render:()=>t`<syn-switch checked>Checked</syn-switch>`},T={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`switch`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-switch`);t&&t.focus()},render:()=>t`<syn-switch>Focused</syn-switch>`},E={parameters:{docs:{description:{story:u(`switch`,`disabled`)}}},render:()=>t`<syn-switch disabled>Disabled</syn-switch>`},D={parameters:{docs:{description:{story:u(`switch`,`readonly`)}}},render:()=>t`
  ...
  `},O={parameters:{docs:{description:{story:u(`switch`,`sizes`)}}},render:()=>t`
  ...
  `},k={parameters:{docs:{description:{story:u(`switch`,`help-text`)}}},render:()=>t`
