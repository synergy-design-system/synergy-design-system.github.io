import"./icon-c33bbd15.js";import{x as e}from"./directive-helpers-a6c66f8a.js";import{s as p,a as g,b as h,c as b}from"./component-aa40b6fc.js";import{r as d}from"./icon.component-394835e6.js";import{d as f}from"./default-icons-352e1c85.js";import"./icon-button-e03d91d2.js";import"./chunk-HJCNT6QR-924d2471.js";import"./chunk-FJPRWHXQ-913159c4.js";import"./index-356e4a49.js";import"./_docs-3cda8374.js";import"./preview-15ab7bbf.js";import"./index-76fb7be0.js";import"./_commonjsHelpers-de833af9.js";const{args:v,argTypes:w}=p("syn-icon"),{overrideArgs:S}=b("syn-icon"),{generateTemplate:C}=g("syn-icon"),I=`
...
`,G={args:S({name:"name",type:"attribute",value:"wallpaper"},v),argTypes:w,component:"icon",parameters:{docs:{description:{component:I}}},title:"Components/syn-icon"},l={parameters:{controls:{disable:!1}},render:n=>C({args:n})},s={name:"Colors",render:()=>e`<div style="color: var(--syn-color-primary-600);">
...
<div style="color: var(--syn-color-error-700);">
...
</div>`},o={name:"Sizing",render:()=>e`<div style="font-size: var(--syn-font-size-2x-large);">
  <syn-icon name="warning"></syn-icon>
  <syn-icon name="inventory"></syn-icon>
  <syn-icon name="battery_charging_full"></syn-icon>
  <syn-icon name="notifications"></syn-icon>
  ...
  <syn-icon name="star_border"></syn-icon>
  <syn-icon name="delete"></syn-icon>
</div>`},r={name:"Labels",render:()=>e`<syn-icon name="star" label="Add to favorites"></syn-icon>`},i={name:"Custom icons",render:()=>e`<syn-icon src="/logo-claim.svg" style="font-size: 10rem;"></syn-icon>`},t={name:"CDN icon library",render:()=>(d("fa",{resolver:n=>{const u=n.replace(/^fa[rbs]-/,"");let m="regular";return n.substring(0,4)==="fas-"&&(m="solid"),n.substring(0,4)==="fab-"&&(m="brands"),`https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.15.1/svgs/${m}/${u}.svg`},mutator:n=>n.setAttribute("fill","currentColor")}),e`<div style="font-size: var(--syn-font-size-x-large);">
...
</div>`)},a={name:"Bundled icon library",render:()=>(d("bundled-default",{mutator:n=>n.setAttribute("fill","currentColor"),resolver:n=>n in f?`data:image/svg+xml,${encodeURIComponent(f[n])}`:""}),e`<div style="font-size: var(--syn-font-size-x-large);">
...
</div>`)},c={name:"Sprite sheet usage",render:()=>(d("sprite",{mutator:n=>n.setAttribute("fill","currentColor"),resolver:n=>`/sprite.svg#${n}`,spriteSheet:!0}),e`<div style="font-size: var(--syn-font-size-x-large);">
  <syn-icon library="sprite" name="settings"></syn-icon>
  <syn-icon library="sprite" name="refresh"></syn-icon>
</div>`)},y=h([s,o,r,i,t,a,c]);l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    }
...
} as Story`,...l.parameters?.docs?.source},description:{story:"This shows the syn-icon in its default state",...l.parameters?.docs?.description}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  name: 'Colors',
...
}`,...s.parameters?.docs?.source},description:{story:`Icons inherit their color from the current text color.
Thus, you can set the color property on the <syn-icon> element or an ancestor to change color.`,...s.parameters?.docs?.description}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  name: 'Sizing',
...
If you're using more than one custom icon, it might make sense to register a custom icon library.`,...i.parameters?.docs?.description}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
...
}`,...t.parameters?.docs?.source},description:{story:`Icon libraries, which are provided via CDN, can also be registered.
...
to see how to handle this.`,...t.parameters?.docs?.description}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
...
}`,...a.parameters?.docs?.source},description:{story:`The package [@synergy-design-system/assets](https://github.com/synergy-design-system/synergy-design-system/tree/main/packages/assets) provides the possibility to get all default icons via a bundled file.
...
\`\`\``,...a.parameters?.docs?.description}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
...
}`,...c.parameters?.docs?.source},description:{story:`To improve performance you can use a SVG sprites to avoid multiple trips for each SVG.
...
\`\`\``,...c.parameters?.docs?.description}}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:"generateScreenshotStory([Colors, Sizing, Labels, CustomIcons, CDNIconLibrary, BundledIconLibrary, SpriteSheetUsage])",...y.parameters?.docs?.source}}};const P=["Default","Colors","Sizing","Labels","CustomIcons","CDNIconLibrary","BundledIconLibrary","SpriteSheetUsage","Screenshot"];export{a as BundledIconLibrary,t as CDNIconLibrary,s as Colors,i as CustomIcons,l as Default,r as Labels,y as Screenshot,o as Sizing,c as SpriteSheetUsage,P as __namedExportsOrder,G as default};
