import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,h as n,n as r,t as i}from"./lit-BVDl_-fF.js";import{M as a,Mt as o,O as ee,Pt as te,k as ne}from"./iframe-Cn79ht60.js";import{n as s,t as c}from"./class-map-BmdGqO7G.js";import{r as l,t as re}from"./if-defined-BsCyJVG6.js";import{_ as u,f as d,h as ie,l as ae,s as f,y as p}from"./synergy-element-fkSPPZqT.js";var oe,se,ce,le,m,ue,de,fe,pe,h,me,he,g,_,v,y,b,ge,x=e((()=>{oe=Object.defineProperty,se=Object.defineProperties,ce=Object.getOwnPropertyDescriptor,le=Object.getOwnPropertyDescriptors,m=Object.getOwnPropertySymbols,ue=Object.prototype.hasOwnProperty,de=Object.prototype.propertyIsEnumerable,fe=e=>{throw TypeError(e)},pe=(e,t,n)=>t in e?oe(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,h=(e,t)=>{for(var n in t||={})ue.call(t,n)&&pe(e,n,t[n]);if(m)for(var n of m(t))de.call(t,n)&&pe(e,n,t[n]);return e},me=(e,t)=>se(e,le(t)),he=(e,t)=>{var n={};for(var r in e)ue.call(e,r)&&t.indexOf(r)<0&&(n[r]=e[r]);if(e!=null&&m)for(var r of m(e))t.indexOf(r)<0&&de.call(e,r)&&(n[r]=e[r]);return n},g=(e,t,n,r)=>{for(var i=r>1?void 0:r?ce(t,n):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(i=(r?o(t,n,i):o(i))||i);return r&&i&&oe(t,n,i),i},_=(e,t,n)=>t.has(e)||fe(`Cannot `+n),v=(e,t,n)=>(_(e,t,`read from private field`),n?n.call(e):t.get(e)),y=(e,t,n)=>t.has(e)?fe(`Cannot add the same private member more than once`):t instanceof WeakSet?t.add(e):t.set(e,n),b=(e,t,n,r)=>(_(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),ge=(e,t,n)=>(_(e,t,`access private method`),n)}));function S(e,t){let n=h({waitUntilFirstUpdate:!1},t);return(t,r)=>{let{update:i}=t,a=Array.isArray(e)?e:[e];t.update=function(e){a.forEach(t=>{let i=t;if(e.has(i)){let t=e.get(i),a=this[i];t!==a&&(!n.waitUntilFirstUpdate||this.hasUpdated)&&this[r](t,a)}}),i.call(this,e)}}}var C=e((()=>{x()})),w,T=e((()=>{i(),w=n`
  :host {
...
`})),X,pt=e((()=>{ft(),L(),Je(),T(),O(),x(),c(),ee(),re(),f(),X=class extends D{constructor(){super(...arguments),this.hasFocus=!1,this.label=``,this.size=`inherit`,this.color=`currentColor`,this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){let e=!!this.href,t=e?ne`a`:ne`button`;return a`
      <${t}
        part="base"
        class=${s({"icon-button":!0,"icon-button--disabled":!e&&this.disabled,"icon-button--focused":this.hasFocus,"icon-button--large":this.size===`large`,"icon-button--medium":this.size===`medium`,"icon-button--small":this.size===`small`})}
        ...
        <div class="tab-group__nav-container" part="nav">
          ${this.hasScrollControls?t`
                <syn-icon-button
                  ...
                  class=${s({"tab-group__scroll-button":!0,"tab-group__scroll-button--start":!0,"tab-group__scroll-button--start--hidden":this.shouldHideScrollStartButton})}
          ...
          ${this.hasScrollControls?t`
                <syn-icon-button
                  ...
                  exportparts="base:scroll-button__base"
                  class=${s({"tab-group__scroll-button":!0,"tab-group__scroll-button--end":!0,"tab-group__scroll-button--end--hidden":this.shouldHideScrollEndButton})}
    ...
    `}},Z.styles=[w,lt,st],Z.dependencies={"syn-icon-button":X,"syn-resize-observer":Y},g([ae({slot:`nav`,selector:`syn-tab`})],Z.prototype,`tabs`,2),g([ae({selector:`syn-tab-panel`})],Z.prototype,`panels`,2),g([d(`.tab-group`)],Z.prototype,`tabGroup`,2),g([d(`.tab-group__body`)],Z.prototype,`body`,2),g([d(`.tab-group__nav`)],Z.prototype,`nav`,2),g([d(`.tab-group__indicator`)],Z.prototype,`indicator`,2),g([u()],Z.prototype,`hasScrollControls`,2),g([u()],Z.prototype,`shouldHideScrollStartButton`,2),g([u()],Z.prototype,`shouldHideScrollEndButton`,2),g([p()],Z.prototype,`placement`,2),g([p()],Z.prototype,`activation`,2),g([p({attribute:`no-scroll-controls`,type:Boolean})],Z.prototype,`noScrollControls`,2),g([p({type:Boolean})],Z.prototype,`contained`,2),g([p({type:Boolean})],Z.prototype,`sharp`,2),g([p({attribute:`fixed-scroll-controls`,type:Boolean})],Z.prototype,`fixedScrollControls`,2),g([ie({passive:!0})],Z.prototype,`updateScrollButtons`,1),g([S(`noScrollControls`,{waitUntilFirstUpdate:!0})],Z.prototype,`updateScrollControls`,1),g([S(`placement`,{waitUntilFirstUpdate:!0})],Z.prototype,`syncIndicator`,1)})),_t=e((()=>{gt(),Z.define(`syn-tab-group`)})),vt=e((()=>{_t(),gt(),rt(),nt(),ct(),ut(),pt(),ft(),L(),k(),A(),J(),K(),G(),T(),O()})),yt,bt=e((()=>{i(),yt=n`
  :host {
...
`})),Ct,Q,wt=e((()=>{bt(),St(),pt(),J(),C(),T(),O(),x(),c(),i(),f(),Ct=0,Q=class extends D{constructor(){super(...arguments),this.localize=new q(this),this.attrId=++Ct,this.componentId=`syn-tab-${this.attrId}`,this.panel=``,this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`tab`)}handleCloseClick(e){e.stopPropagation(),this.emit(`syn-close`)}handleActiveChange(){this.setAttribute(`aria-selected`,this.active?`true`:`false`)}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled?`true`:`false`),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,t`
      <div
        part="base"
    ...
    `}},Q.styles=[w,xt,yt],Q.dependencies={"syn-icon-button":X},g([d(`.tab`)],Q.prototype,`tab`,2),g([p({reflect:!0})],Q.prototype,`panel`,2),g([p({type:Boolean,reflect:!0})],Q.prototype,`active`,2),g([p({type:Boolean,reflect:!0})],Q.prototype,`closable`,2),g([p({type:Boolean,reflect:!0})],Q.prototype,`disabled`,2),g([p({type:Number,reflect:!0})],Q.prototype,`tabIndex`,2),g([S(`active`)],Q.prototype,`handleActiveChange`,1),g([S(`disabled`)],Q.prototype,`handleDisabledChange`,1)})),Tt=e((()=>{wt(),Q.define(`syn-tab`)})),Et=e((()=>{Tt(),wt(),bt(),St(),pt(),ft(),L(),k(),A(),J(),K(),G(),T(),O()})),Dt,Ot=e((()=>{i(),Dt=n`
  /* Write custom CSS here */
  .tab-panel {
    color: var(--syn-typography-color-text);
  }
...
`})),jt,$,Mt=e((()=>{Ot(),At(),C(),T(),O(),x(),c(),i(),f(),jt=0,$=class extends D{constructor(){super(...arguments),this.attrId=++jt,this.componentId=`syn-tab-panel-${this.attrId}`,this.name=``,this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute(`role`,`tabpanel`)}handleActiveChange(){this.setAttribute(`aria-hidden`,this.active?`false`:`true`)}render(){return t`
      <slot
        part="base"
        class=${s({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}},$.styles=[w,kt,Dt],g([p({reflect:!0})],$.prototype,`name`,2),g([p({type:Boolean,reflect:!0})],$.prototype,`active`,2),g([S(`active`)],$.prototype,`handleActiveChange`,1)})),Nt=e((()=>{Mt(),$.define(`syn-tab-panel`)})),Pt=e((()=>{Nt(),Mt(),Ot(),At(),T(),O()}));export{me as A,S as C,v as D,y as E,x as M,ge as O,C as S,he as T,k as _,J as a,w as b,qe as c,Le as d,R as f,A as g,L as h,q as i,h as j,b as k,Je as l,I as m,Et as n,K as o,Fe as p,vt as r,G as s,Pt as t,Ie as u,D as v,g as w,T as x,O as y};