...
`,x={args:_([{name:`default`,type:`slot`,value:y().trim()}],h),argTypes:g,component:`syn-table`,parameters:{chromatic:{modes:a},design:n(`41227-220286`),docs:{description:{component:v}}},tags:[`Structure`,`Styles`],title:`Styles/syn-table`},S={parameters:{controls:{disable:!1},docs:{description:{story:v}}},render:e=>p(e,`table`)},C={render:()=>s`
