import{g as G,a as u}from"./preview-BfEM8BLb.js";import{k as t}from"./lit-element-BsyMe9HG.js";import{p as E}from"./index-C_Koh2Wx.js";import{s as _,a as O,g as s,b as F,c as R}from"./component-CUJbGTln.js";import"./index-B-o1Wr-g.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon.component-Cwq7Y_Aa.js";import"./directive-helpers-DUpkUCIH.js";import"./icon-button-BsnFsjAn.js";import"./icon-DiAnxFT_.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";var $=Object.freeze,q=Object.defineProperty,w=(e,n)=>$(q(e,"raw",{value:$(n||e.slice())})),S;const{args:j,argTypes:A}=_("syn-tab-group"),{overrideArgs:k}=R("syn-tab-group"),{generateTemplate:L}=O("syn-tab-group"),P=(e,n,{active:a=!1,closable:g=!1,disabled:v=!1}={})=>`<syn-tab slot="nav" panel="${e}" ${a?"active":""} ${v?"disabled":""} ${g?"closable":""}>${n}</syn-tab>`,T=(e,n,{active:a=!1,closable:g=!1,disabled:v=!1}={})=>u(P(e,n,{active:a,closable:g,disabled:v})),H=()=>[{panel:"general",props:{active:!0}},{panel:"custom"},{panel:"advanced"},{panel:"disabled",props:{disabled:!0}}].map(({panel:e,props:n})=>P(e,E(e),n)).join(`
...
`,y=()=>u(D()),Y={args:k([{name:"default",type:"slot",value:D()},{name:"nav",type:"slot",value:H()}],j),argTypes:A,component:"syn-tab-group",parameters:{design:G("18021-1924779"),docs:{description:{component:s("tab-group","default")}}},title:"Components/syn-tab-group"},r={parameters:{docs:{description:{story:s("tab-group","default")}}},render:e=>L({args:e})},o={parameters:{docs:{description:{story:s("tab-group","start")}}},render:()=>t`
