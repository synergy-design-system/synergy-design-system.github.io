import{q as x,x as a,g as S,C as k}from"./iframe-3rQ6MjmB.js";import{L as w}from"./localize-Dh03wnLC.js";import{S as z,c as R,n as _}from"./synergy-element-CpGm7QZ8.js";import{r as C}from"./icon.component-BX6zfRdv.js";import{a as D}from"./query-D0jTsbLw.js";import"./button-TzOFV85w.js";import"./icon-BwfrVYmH.js";import{g as s,s as E,a as B,c as L,b as O}from"./component-Bn9Hq4ck.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DihgwUfS.js";import"./watch-CEsCE2EF.js";import"./class-map-BSUKdjAi.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./if-defined-Dk8TP58w.js";import"./spinner.component-DkdtFvkT.js";import"./decorator-CVE5vLu9.js";import"./functions-Cnw7w7U0.js";import"./index-CQ0aEGxp.js";import"./_docs-DNIao1HN.js";const P=x`
	/* stylelint-disable */
  :host {
    --size: 128px;
    --track-width: 4px;
...
`;var j=Object.defineProperty,m=(r,t,d,y)=>{for(var e=void 0,v=r.length-1,h;v>=0;v--)(h=r[v])&&(e=h(t,d,e)||e);return e&&j(t,d,e),e};class g extends z{constructor(){super(...arguments),this.localize=new w(this),this.value=0,this.label=""}static{this.styles=[R,P,T]}updated(t){if(super.updated(t),t.has("value")){const d=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),y=2*Math.PI*d,e=y-this.value/100*y;this.indicatorOffset=`${e}px`}}render(){return a`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
    ...
    `}}m([D(".progress-ring__indicator")],g.prototype,"indicator");m([C()],g.prototype,"indicatorOffset");m([_({type:Number,reflect:!0})],g.prototype,"value");m([_()],g.prototype,"label");g.define("syn-progress-ring");var f=Object.freeze,A=Object.defineProperty,I=(r,t)=>f(A(r,"raw",{value:f(r.slice())})),b;const{args:M,argTypes:$}=E("syn-progress-ring"),{overrideArgs:V}=B("syn-progress-ring"),{generateTemplate:q}=L("syn-progress-ring"),cr={args:V([{name:"default",type:"slot",value:""},{name:"value",type:"attribute",value:"25"}],M),argTypes:$,component:"syn-progress-ring",parameters:{chromatic:{modes:k},design:S("14207-8709"),docs:{description:{component:s("progress-ring","default")}}},tags:["Feedback"],title:"Components/syn-progress-ring"},o={parameters:{docs:{description:{story:s("progress-ring","default")}}},render:r=>q({args:r})},n={parameters:{docs:{description:{story:s("progress-ring","size")}}},render:()=>a`
  ...
  `},p={parameters:{docs:{description:{story:s("progress-ring","show-values")}}},render:()=>a(b||(b=I([`
    ...
    <\/script>
  `])))},u=O({Default:o,Size:n,TrackAndIndicatorWidth:i,Colors:c,Labels:l,ShowingValues:p},300);o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
