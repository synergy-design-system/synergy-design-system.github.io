import"./tab-panel-CNP7jkjp.js";import"./tab-BjcbyytY.js";import"./icon-B8xiByvz.js";import{g as G,x as t,o as u}from"./iframe-BU6pI8GJ.js";import{p as E}from"./index-Bkk0Z6Ex.js";import{g as s,s as _,a as O,c as F,b as R}from"./component-B9yFO2OE.js";import"./class-map-DSRw8Zyj.js";import"./synergy-element-Dr2c-Hm7.js";import"./icon.component-CIHoI7Sg.js";import"./watch-CEsCE2EF.js";import"./query-DAIS6qJ0.js";import"./query-assigned-elements-QtOlz7Yz.js";import"./localize-bgLrV2YE.js";import"./scroll-DgKSCJoS.js";import"./icon-button.component-nvFFNQcF.js";import"./if-defined-D_B395BP.js";import"./decorator-DANECR0-.js";import"./functions-CDi3doZH.js";import"./preload-helper-Ct5FWWRu.js";import"./_docs-UXgsQIP6.js";var $=Object.freeze,q=Object.defineProperty,j=(e,n)=>$(q(e,"raw",{value:$(n||e.slice())})),S;const{args:w,argTypes:A}=_("syn-tab-group"),{overrideArgs:L}=O("syn-tab-group"),{generateTemplate:I}=F("syn-tab-group"),P=(e,n,{active:a=!1,closable:g=!1,disabled:v=!1}={})=>`<syn-tab slot="nav" panel="${e}" ${a?"active":""} ${v?"disabled":""} ${g?"closable":""}>${n}</syn-tab>`,T=(e,n,{active:a=!1,closable:g=!1,disabled:v=!1}={})=>u(P(e,n,{active:a,closable:g,disabled:v})),H=()=>[{panel:"general",props:{active:!0}},{panel:"custom"},{panel:"advanced"},{panel:"disabled",props:{disabled:!0}}].map(({panel:e,props:n})=>P(e,E(e),n)).join(`
...
\`
  ...
  heightPx: 740
})`,...d.parameters?.docs?.source}}};const ce=["Default","TabsOnStart","TabsOnEnd","ClosableTabs","ScrollingTabs","VisualHierarchy","ManualActivation","Icons","Screenshot"];export{c as ClosableTabs,r as Default,i as Icons,m as ManualActivation,d as Screenshot,p as ScrollingTabs,l as TabsOnEnd,o as TabsOnStart,b as VisualHierarchy,ce as __namedExportsOrder,le as default};
