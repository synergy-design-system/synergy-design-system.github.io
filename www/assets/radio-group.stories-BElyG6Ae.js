import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{d as r,f as i,g as a,u as o}from"./iframe-Cn79ht60.js";import{t as s}from"./button-BJ5RECCr.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-BsxLXFpR.js";import{n as m,t as h}from"./radio-Bs6lzUct.js";var g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P=e((()=>{m(),h(),s(),n(),f(),r(),a(),{userEvent:g}=__STORYBOOK_MODULE_TEST__,{args:_,argTypes:v}=l(`syn-radio-group`),{overrideArgs:y}=c(`syn-radio-group`),{generateTemplate:b}=d(`syn-radio-group`),x={args:_,argTypes:v,component:`syn-radio-group`,parameters:{chromatic:{modes:i},design:o(`41310-253349`),docs:{description:{component:u(`radio-group`,`default`)}}},tags:[`Form`],title:`Components/syn-radio-group`},S={args:y([{name:`label`,type:`attribute`,value:`This is a label`},{name:`default`,type:`slot`,value:`<syn-radio value="1">Option</syn-radio>
  <syn-radio value="2">Option</syn-radio>
  <syn-radio value="3">Option</syn-radio>`}],_),parameters:{controls:{disable:!1},docs:{description:{story:u(`radio-group`,`default`)}}},render:e=>b({args:e})},C={parameters:{docs:{description:{story:u(`radio-group`,`labels`)}}},render:()=>t`
    <syn-radio-group label="This is a label">
      <syn-radio value="1">Option</syn-radio>
      <syn-radio value="2">Option</syn-radio>
      <syn-radio value="3">Option</syn-radio>
    </syn-radio-group>
  `},w={parameters:{docs:{description:{story:u(`radio-group`,`checked`)}}},render:()=>t`
  <syn-radio-group label="This is a label" help-text="This is checked" name="a" value="2">
    <syn-radio value="1">Option</syn-radio>
    <syn-radio value="2">Option</syn-radio>
    <syn-radio value="3">Option</syn-radio>
  </syn-radio-group>`},T={parameters:{docs:{description:{story:u(`radio-group`,`help-text`)}}},render:()=>t`
    <syn-radio-group label="This is a label" help-text="Choose the most appropriate option." name="a">
      <syn-radio value="1">Option</syn-radio>
      <syn-radio value="2">Option</syn-radio>
      <syn-radio value="3">Option</syn-radio>
    </syn-radio-group>
  `},E={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`radio-group`,`focus`)}}},play:({canvasElement:e})=>{e.querySelector(`syn-radio-group`)?.focus()},render:()=>t`
    <syn-radio-group label="This is a label" name="a">
      <syn-radio value="1" disabled>Option</syn-radio>
      <syn-radio value="2">Option</syn-radio>
      <syn-radio value="3">Option</syn-radio>
    </syn-radio-group>
  `},D={parameters:{docs:{description:{story:u(`radio-group`,`disabled`)}}},render:()=>t`
    <syn-radio-group label="This is a label" help-text="This is disabled" name="a">
      <syn-radio value="1">Option</syn-radio>
      <syn-radio value="2" disabled>Option</syn-radio>
      <syn-radio value="3">Option</syn-radio>
    </syn-radio-group>
  `},O={parameters:{docs:{description:{story:u(`radio-group`,`readonly`)}}},render:()=>t`
  ...
  `},k={parameters:{docs:{description:{story:u(`radio-group`,`size`)}}},render:()=>t`
  ...
  `},A={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`radio-group`,`invalid`)}}},play:async({canvasElement:e})=>{try{let t=e.querySelector(`syn-button`);t&&(await g.click(t),t.click(),document.activeElement?.blur())}catch(e){console.error(`Error in play function:`,e)}},render:()=>t`
  ...
  Readonly,
  Sizes
}, 400)`,...M.parameters?.docs?.source}}},N=[`Default`,`Labels`,`Checked`,`HelpText`,`Focus`,`Disabled`,`Readonly`,`Sizes`,`Invalid`,`CustomValidity`,`Screenshot`]}));P();export{w as Checked,j as CustomValidity,S as Default,D as Disabled,E as Focus,T as HelpText,A as Invalid,C as Labels,O as Readonly,M as Screenshot,k as Sizes,N as __namedExportsOrder,x as default,P as t};