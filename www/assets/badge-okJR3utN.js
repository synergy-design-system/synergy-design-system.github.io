import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,Ut as r}from"./iframe-fXCqWTG3.js";import{n as i,t as a}from"./class-map-FfzGmM48.js";import{n as o,t as s}from"./localize-DnZL8qNz.js";import{a as c,i as l,n as u,o as d,p as f,r as p,s as m,t as h}from"./synergy-element-CyrfZ-S8.js";import{n as g,t as _}from"./decorator-CJ_bAnlW.js";var v,y=e((()=>{t(),v=r`
	/* stylelint-disable */
  :host {
    display: inline-flex;
  }
...
`})),S,C,w=e((()=>{a(),t(),m(),d(),u(),s(),y(),x(),g(),l(),S=class extends h{constructor(...e){super(...e),this.localize=new o(this),this.variant=`primary`}static{this.styles=[c,v,b]}render(){return n`
      <span
        part="base"
    ...
    `}},p([f({reflect:!0})],S.prototype,`variant`,void 0),S=p([_(`SynBadge`)],S),C=S})),T=e((()=>{w(),w(),C.define(`syn-badge`)}));export{T as t};