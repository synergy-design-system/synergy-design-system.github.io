import{R as f,D as p,k as T}from"./directive-helpers-CDT6qhDs.js";/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const l=Symbol.for(""),g=t=>{if(t?.r===l)return t?._$litStatic$},j=t=>({_$litStatic$:t,r:l}),k=(t,...e)=>({_$litStatic$:e.reduce((r,s,n)=>r+(i=>{if(i._$litStatic$!==void 0)return i._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${i}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(s)+t[n+1],t[0]),r:l}),$=new Map,m=t=>(e,...r)=>{const s=r.length;let n,i;const o=[],u=[];let c,a=0,h=!1;for(;a<s;){for(c=e[a];a<s&&(i=r[a],(n=g(i))!==void 0);)c+=n+e[++a],h=!0;a!==s&&u.push(i),o.push(c),a++}if(a===s&&o.push(e[s]),h){const d=o.join("$$lit$$");(e=$.get(d))===void 0&&(o.raw=o,$.set(d,e=o)),r=u}return t(e,...r)},w=m(T);export{R,y as a,A as b,b as c,_ as d,k as e,E as f,S as i,w as k,j as t};
