import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,h as n,t as r}from"./lit-BVDl_-fF.js";import{n as i,t as a}from"./class-map-BmdGqO7G.js";import{r as o,t as s}from"./form-CV4G6JGX.js";import{r as c,t as l}from"./slot-DgcqpP0-.js";import{r as u,t as d}from"./if-defined-BsCyJVG6.js";import{a as f,f as p,i as m,n as h,o as g,r as _,s as v,t as y,y as b}from"./synergy-element-fkSPPZqT.js";import{n as x,t as S}from"./watch-I6gMK-uE.js";import{n as C,t as w}from"./icon.component-B26du9-f.js";import{n as T,t as E}from"./decorator-ChmomMqD.js";import{r as D,t as O}from"./live-C1Vl0YXB.js";import{n as k,t as A}from"./form-control.styles-Bu3u3vCk.js";import{n as j,t as M}from"./default-value-zJ_4n3ED.js";var N,P=e((()=>{r(),N=n`
...
`})),F,I,L=e((()=>{a(),j(),o(),c(),r(),d(),O(),v(),S(),g(),k(),h(),C(),P(),T(),m(),F=class extends y{constructor(...e){super(...e),this.formControlController=new s(this,{value:e=>e.checked?e.value||`on`:void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=t}),this.hasSlotController=new l(this,`help-text`),this.title=``,this.name=``,this.size=`medium`,this.disabled=!1,this.readonly=!1,this.checked=!1,this.indeterminate=!1,this.defaultChecked=!1,this.form=``,this.required=!1,this.helpText=``}static{this.styles=[f,A,N]}static{this.dependencies={"syn-icon":w}}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleClick(e){if(this.readonly){e.preventDefault();return}this.checked=!this.checked,this.indeterminate=!1,this.emit(`syn-change`)}handleBlur(){this.emit(`syn-blur`)}handleInput(){this.emit(`syn-input`)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleFocus(){this.emit(`syn-focus`)}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStateChange(){this.input.checked=this.checked,this.input.indeterminate=this.indeterminate,this.formControlController.updateValidity()}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){let e=this.hasSlotController.test(`help-text`),n=this.helpText?!0:!!e;return t`
    ...
    `}},_([p(`input[type="checkbox"]`)],F.prototype,`input`,void 0),_([b({reflect:!0})],F.prototype,`title`,void 0),_([b()],F.prototype,`name`,void 0),_([b()],F.prototype,`value`,void 0),_([b({reflect:!0})],F.prototype,`size`,void 0),_([b({type:Boolean,reflect:!0})],F.prototype,`disabled`,void 0),_([b({type:Boolean,reflect:!0})],F.prototype,`readonly`,void 0),_([b({type:Boolean,reflect:!0})],F.prototype,`checked`,void 0),_([b({type:Boolean,reflect:!0})],F.prototype,`indeterminate`,void 0),_([M(`checked`)],F.prototype,`defaultChecked`,void 0),_([b({reflect:!0})],F.prototype,`form`,void 0),_([b({type:Boolean,reflect:!0})],F.prototype,`required`,void 0),_([b({attribute:`help-text`})],F.prototype,`helpText`,void 0),_([x(`disabled`,{waitUntilFirstUpdate:!0})],F.prototype,`handleDisabledChange`,null),_([x([`checked`,`indeterminate`],{waitUntilFirstUpdate:!0})],F.prototype,`handleStateChange`,null),F=_([E(`SynCheckbox`)],F),I=F})),R=e((()=>{L(),L(),I.define(`syn-checkbox`)}));export{R as t};