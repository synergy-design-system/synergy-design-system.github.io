import{u as c,j as e,M as p}from"./blocks-DGS0qlur.js";import{I as r,e as g}from"./functions-bkELIyT9.js";import{s as m}from"./index-3hbeBem-.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-BSIZOQaR.js";function d(o){const t={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",strong:"strong",...c(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(p,{title:"Packages/Components/Configuring global settings"}),`
...
You will have to make sure to call `,e.jsx(t.code,{children:"enableSettingEmitEvents"})," before the initial render to ensure that all components are listening for the event."]}),`
...
`,e.jsx("ul",{children:Object.keys(r).map(n=>e.jsx("li",{children:e.jsx("strong",{children:n})},`attr-${n}`))}),`
`,e.jsxs(t.blockquote,{children:[`
`,e.jsxs(t.p,{children:["⚠️ This feature was considered experimental in Synergy 2.x and hidden behind a function named ",e.jsx(t.code,{children:"enableExperimentalSettingEmitEvents"}),`.
As of Synergy 3.x, this API is now marked stable and the function is deprecated. Please use `,e.jsx(t.code,{children:"enableSettingEmitEvents"})," instead."]}),`
`]}),`
...
`,e.jsxs("table",{className:"syn-table--alternating syn-table--border",style:{width:"100%"},children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:e.jsx("syn-tooltip",{content:"The name of the component when rendered into the DOM",children:e.jsx(t.p,{children:"Component"})})}),e.jsx("th",{children:e.jsx("syn-tooltip",{content:"The class name of the component, used as a key in setGlobalSettings or setDefaultSettingsForElement",children:e.jsx(t.p,{children:"ClassName"})})}),e.jsx("th",{children:e.jsx("syn-tooltip",{content:"Supported settings for the component",children:e.jsx(t.p,{children:"Settings"})})}),e.jsx("th",{children:e.jsx("syn-tooltip",{content:"Copy to add the call code to the clipboard",children:e.jsx(t.p,{children:"Example"})})})]})}),e.jsx("tbody",{children:Object.values(r).map(n=>Object.keys(n)).flat().filter((n,i,a)=>a.indexOf(n)===i).sort().map(n=>{const i=g(n),a=m(n,{delimiter:"-"}),h=`setGlobalDefaultSettings({
...
${l}: {
  ${n}: ${typeof s=="object"?JSON.stringify(s,null,2):`'${s}'`},
        ...
        `.trim()).join(`,
  `)}
});`.trim();return e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:`<${a}>`})}),e.jsx("td",{children:n}),e.jsx("td",{children:Object.entries(i).sort(([l],[s])=>l.localeCompare(s)).map(([l,s])=>e.jsxs(e.Fragment,{children:[e.jsx("strong",{children:l},`${n}--${l}--key`),":"," ",typeof s=="object"?JSON.stringify(s,null,2):s,e.jsx("br",{})]}))}),e.jsx("td",{children:e.jsx("code",{children:h})})]},`${n}--details`)})})]})]})}function S(o={}){const{wrapper:t}={...c(),...o.components};return t?e.jsx(t,{...o,children:e.jsx(d,{...o})}):d(o)}export{S as default};
