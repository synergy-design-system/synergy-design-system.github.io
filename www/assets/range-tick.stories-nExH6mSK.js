import{g as o,C as g,x as a}from"./iframe-C_zxIagT.js";import"./range-tick-DX8tAs-0.js";import{g as i,s as y,c as d,b as k}from"./component-BN4Mi68l.js";import"./preload-helper-Ct5FWWRu.js";import"./class-map-D2UDBoJ2.js";import"./synergy-element-BPI6Vef6.js";import"./index-CQ0aEGxp.js";import"./_docs-DXCV3alH.js";const{args:p,argTypes:l}=y("syn-range-tick"),{generateTemplate:u}=d("syn-range-tick"),D={args:p,argTypes:l,component:"syn-range-tick",parameters:{chromatic:{modes:g},design:o("0628-87581"),docs:{description:{component:i("range-tick","default")}}},tags:["Form","SICK2018","SICK2025"],title:"Components/syn-range-tick"},n={parameters:{controls:{disable:!1},docs:{description:{story:i("range-tick","default")}}},render:c=>u({args:c})},e={parameters:{docs:{description:{story:i("range-tick","label")}}},render:()=>a`
  ...
  `},t=k({Default:n,Labels:e,Grouping:r,SubdivisionTicks:s},230);n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  Grouping,
  SubdivisionTicks
}, 230)`,...t.parameters?.docs?.source}}};const j=["Default","Labels","Grouping","SubdivisionTicks","Screenshot"];export{n as Default,r as Grouping,e as Labels,t as Screenshot,s as SubdivisionTicks,j as __namedExportsOrder,D as default};
