import{i as e}from"./preload-helper-xPQekRTU.js";import{Ht as t,It as n,d as r,f as i,g as a,u as o}from"./iframe-Bb0l_wZA.js";import{a as s,i as c,n as l,o as u,r as d,t as f}from"./component-1GQqMfLf.js";import{n as p,t as m}from"./tab-panel-BpoBcoTY.js";import{t as h}from"./tab-BXLu1T7w.js";var g,_,v,y,b,x,S,C,w,T=e((()=>{m(),p(),h(),n(),d(),r(),a(),{args:g,argTypes:_}=c(`syn-tab-panel`),{overrideArgs:v}=s(`syn-tab-panel`),{generateTemplate:y}=u(`syn-tab-panel`),b=()=>t`<main class="synergy-replace">Replace this slot</main>`,x={args:v([{name:`default`,type:`slot`,value:b().strings.join(`
