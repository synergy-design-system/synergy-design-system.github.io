import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{l as ee,o as n}from"./preview-DRz18Lsn.js";import{c as r,t as i}from"./lit-D4-0ovri.js";import{d as te,f as a,i as o,p as s,u as c}from"./blocks-Tvq0jjN0.js";import{t as l}from"./react-Q1GcV6wX.js";import{t as u}from"./select-BiMMRNnt.js";import{t as d}from"./option-5Sp0fHIr.js";import{t as f}from"./input-DeuiTlMk.js";import{n as p,r as m,t as h}from"./waitForFinishedCharts-DyYKSNey.js";import{n as g,t as _}from"./formatter-34eogR_H.js";import{n as v,r as y,t as ne}from"./component-NnlguzJ1.js";import{t as b}from"./taggedTemplateLiteral-BZenJ0bZ.js";var x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q;function $(){return($=t((()=>{x=e(l(),1),i(),u(),d(),f(),s(),m(),g(),y(),ee(),h(),window.formatter=_,I={component:`syn-chart`,parameters:{chromatic:{delay:300,modes:n},docs:{description:{component:v(`chart`,`axes-default`)},page:()=>x.createElement(x.Fragment,null,x.createElement(a,null),x.createElement(te,null),x.createElement(o,null),x.createElement(c,{title:``}))}},play:p,tags:[`Charting`,`Data Visualization`],title:`Charts/Features/Axes`},L={parameters:{docs:{description:{story:v(`chart`,`axes-split-lines-hidden`)}}},render:()=>r(S||=b([`
    ...
    <\/script>
  `]))},R={parameters:{docs:{description:{story:v(`chart`,`axes-split-lines-visible`)}}},render:()=>r(C||=b([`
    ...
    <\/script>
  `]))},z={parameters:{docs:{description:{story:v(`chart`,`axes-horizontal-split-lines`)}}},render:()=>r(w||=b([`
    ...
    <\/script>
  `]))},B={parameters:{docs:{description:{story:v(`chart`,`axes-vertical-split-lines`)}}},render:()=>r(T||=b([`
    ...
    <\/script>
  `]))},V={parameters:{docs:{description:{story:v(`chart`,`axes-labels-hidden`)}}},render:()=>r(E||=b([`
    ...
    <\/script>
  `]))},H={parameters:{docs:{description:{story:v(`chart`,`axes-lines-visible-labels-hidden`)}}},render:()=>r(D||=b([`
    ...
    <\/script>
  `]))},U={parameters:{docs:{description:{story:v(`chart`,`axes-labels-with-icons`)}}},render:()=>r(O||=b([`
    <div class="controls">
  ...
  `]))},W={parameters:{docs:{description:{story:v(`chart`,`axes-positioning`)}}},render:()=>r(k||=b([`
    ...
    <\/script>
  `]))},G={parameters:{docs:{description:{story:v(`chart`,`axes-min-max-values`)}}},render:()=>r(A||=b([`
    <div style="display: flex; gap: var(--syn-spacing-large); margin-bottom: var(--syn-spacing-large);">
    ...
    <\/script>
  `]))},K={parameters:{docs:{description:{story:v(`chart`,`axes-multiple-y-axes`)}}},render:()=>r(j||=b([`
    ...
    <\/script>
  `]))},q={parameters:{docs:{description:{story:v(`chart`,`axes-multiple-series-per-y-axis`)}}},render:()=>r(M||=b([`
    ...
    <\/script>
  `]))},J={parameters:{docs:{description:{story:v(`chart`,`axes-label-formatting`)}}},render:()=>r(N||=b([`
    ...
    <\/script>
  `]))},Y={parameters:{docs:{description:{story:v(`chart`,`axes-label-greedily`)}}},render:()=>r(P||=b([`
    <div style="display: flex; margin-bottom: var(--syn-spacing-large);">
    ...
    <\/script>
  `]))},X={parameters:{docs:{description:{story:v(`chart`,`axes-label-evenly`)}}},render:()=>r(F||=b([`
    ...
    <\/script>
  `]))},Z=ne({AxesSplitLinesHidden:L,AxesSplitLinesVisible:R,HorizontalSplitLinesVisible:z,VerticalSplitLinesVisible:B,AxesLabelsHidden:V,AxesLinesVisibleWithLabelsHidden:H,AxesLabelsWithIcons:U,AxesPositioning:W,MinMaxValues:G,MultipleYAxes:K,MultipleSeriesPerYAxis:q,AxesLabelFormatting:J,CategoryAxesLabelGreedily:Y,CategoryAxesLabelEvenly:X},700),Q=[`AxesSplitLinesHidden`,`AxesSplitLinesVisible`,`HorizontalSplitLinesVisible`,`VerticalSplitLinesVisible`,`AxesLabelsHidden`,`AxesLinesVisibleWithLabelsHidden`,`AxesLabelsWithIcons`,`AxesPositioning`,`MinMaxValues`,`MultipleYAxes`,`MultipleSeriesPerYAxis`,`AxesLabelFormatting`,`CategoryAxesLabelGreedily`,`CategoryAxesLabelEvenly`,`Screenshot`],L.parameters={...L.parameters,docs:{...L.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}, 700)`,...Z.parameters?.docs?.source}}}})))()}$();export{J as AxesLabelFormatting,V as AxesLabelsHidden,U as AxesLabelsWithIcons,H as AxesLinesVisibleWithLabelsHidden,W as AxesPositioning,L as AxesSplitLinesHidden,R as AxesSplitLinesVisible,X as CategoryAxesLabelEvenly,Y as CategoryAxesLabelGreedily,z as HorizontalSplitLinesVisible,G as MinMaxValues,q as MultipleSeriesPerYAxis,K as MultipleYAxes,Z as Screenshot,B as VerticalSplitLinesVisible,Q as __namedExportsOrder,I as default};