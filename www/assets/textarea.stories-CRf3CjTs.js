import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-DRz18Lsn.js";import{c as i,t as a}from"./lit-D4-0ovri.js";import{t as o}from"./button-CBC8ywKX.js";import{i as s,n as c,o as l,r as u,t as d}from"./component-NnlguzJ1.js";import{n as f,t as p}from"./PaddingDecorator-Dx4_2Fla.js";import{n as m,t as h}from"./decorators-CjBNNcov.js";import{t as g}from"./textarea-RHZnTiPn.js";var _=t({Default:()=>C,Disabled:()=>A,ExpandWithContent:()=>P,Focus:()=>k,HelpText:()=>T,Invalid:()=>M,Labels:()=>w,Placeholders:()=>D,PreventResizing:()=>N,ReadonlyTextareas:()=>O,Rows:()=>E,Screenshot:()=>F,Sizes:()=>j,__namedExportsOrder:()=>I,default:()=>S}),v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I;function L(){return(L=e((()=>{g(),o(),a(),h(),u(),p(),r(),{userEvent:v}=__STORYBOOK_MODULE_TEST__,{args:y,argTypes:b}=s(`syn-textarea`),{generateTemplate:x}=l(`syn-textarea`),S={args:y,argTypes:b,parameters:{chromatic:{modes:n},docs:{description:{component:c(`textarea`,`default`)}}},tags:[`Form`],title:`Components/syn-textarea`},C={parameters:{controls:{disable:!1},docs:{description:{story:c(`textarea`,`default`)}}},render:e=>x({args:e})},w={parameters:{docs:{description:{story:c(`textarea`,`labels`)}}},render:()=>i`<syn-textarea label="Comments"></syn-textarea>`},T={parameters:{docs:{description:{story:c(`textarea`,`help-text`)}}},render:()=>i`<syn-textarea label="Feedback" help-text="Please tell us what you think."> </syn-textarea>`},E={parameters:{docs:{description:{story:c(`textarea`,`rows`)}}},render:()=>i`
  ...
  `},N={parameters:{docs:{description:{story:c(`textarea`,`resize`)}}},render:()=>i`<syn-textarea resize="none"></syn-textarea>`},P={parameters:{docs:{description:{story:c(`textarea`,`resize-auto`)}}},render:()=>i`<syn-textarea resize="auto" placeholder="Type something"></syn-textarea>`},F=d({Default:C,Labels:w,HelpText:T,Rows:E,Placeholders:D,ReadonlyTextareas:O,Disabled:A,Sizes:j,PreventResizing:N,ExpandWithContent:P},500),I=[`Default`,`Labels`,`HelpText`,`Rows`,`Placeholders`,`ReadonlyTextareas`,`Focus`,`Disabled`,`Sizes`,`Invalid`,`PreventResizing`,`ExpandWithContent`,`Screenshot`],C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  PreventResizing,
  ExpandWithContent
}, 500)`,...F.parameters?.docs?.source}}}})))()}export{L as n,_ as r,C as t};