import"./icon-2184a60b.js";import{x as n}from"./directive-helpers-a6c66f8a.js";import{s as f,a as p,b as h}from"./component-5b49799f.js";import{r as m}from"./icon.component-e33c164c.js";import{d as u}from"./default-icons-6a160ae8.js";import"./static-c19bae7e.js";import"./chunk-757FFUVQ-7dc151b2.js";import"./index-356e4a49.js";import"./component.styles-1c783f8d.js";const{args:g,argTypes:b}=f("syn-icon"),{overrideArgs:v}=h("syn-icon"),{generateTemplate:w}=p("syn-icon"),I=`
...
`,D={component:"icon",args:v({type:"attribute",value:"wallpaper",name:"name"},g),argTypes:b,parameters:{docs:{description:{component:I}}},title:"Components/syn-icon"},s={render:e=>w({args:e})},o={render:()=>n`<div style="color: var(--syn-color-primary-600);">
...
<div style="color: var(--syn-color-error-700);">
  ...
  <syn-icon name="star_border"></syn-icon>
  <syn-icon name="delete"></syn-icon>
</div>`},i={render:()=>n`<syn-icon name="star" label="Add to favorites"></syn-icon>`},t={render:()=>n`<syn-icon src="/logo-claim.svg" style="font-size: 10rem;"></syn-icon>`},a={render:()=>(m("fa",{resolver:e=>{const d=e.replace(/^fa[rbs]-/,"");let y="regular";return e.substring(0,4)==="fas-"&&(y="solid"),e.substring(0,4)==="fab-"&&(y="brands"),`https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.15.1/svgs/${y}/${d}.svg`},mutator:e=>e.setAttribute("fill","currentColor")}),n`<div style="font-size: var(--syn-font-size-x-large);">
...
</div>`)},c={render:()=>(m("bundled-default",{resolver:e=>e in u?`data:image/svg+xml,${encodeURIComponent(u[e])}`:"",mutator:e=>e.setAttribute("fill","currentColor")}),n`<div style="font-size: var(--syn-font-size-x-large);">
...
</div>`)},l={render:()=>(m("sprite",{resolver:e=>`/sprite.svg#${e}`,mutator:e=>e.setAttribute("fill","currentColor"),spriteSheet:!0}),n`<div style="font-size: var(--syn-font-size-x-large);">
...
}`,...o.parameters?.docs?.source},description:{story:"Icons inherit their color from the current text color. Thus, you can set the color property on the <syn-icon> element or an ancestor to change the color.",...o.parameters?.docs?.description}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
...
}`,...r.parameters?.docs?.source},description:{story:"Icons are sized relative to the current font size. To change their size, set the font-size property on the icon itself or on a parent element as shown below.",...r.parameters?.docs?.description}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:'{\n  render: () => html`<syn-icon name="star" label="Add to favorites"></syn-icon>`\n}',...i.parameters?.docs?.source},description:{story:"For non-decorative icons, use the label attribute to announce it to assistive devices.",...i.parameters?.docs?.description}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:'{\n  render: () => html`<syn-icon src="/logo-claim.svg" style="font-size: 10rem;"></syn-icon>`\n}',...t.parameters?.docs?.source},description:{story:`Custom icons can be loaded individually with the src attribute. Only SVGs on a local or CORS-enabled endpoint are supported.
...
\`\`\``,...l.parameters?.docs?.description}}};const N=["Default","Colors","Sizing","Labels","CustomIcons","CDNIconLibrary","BundledIconLibrary","SpriteSheetUsage"];export{c as BundledIconLibrary,a as CDNIconLibrary,o as Colors,t as CustomIcons,s as Default,i as Labels,r as Sizing,l as SpriteSheetUsage,N as __namedExportsOrder,D as default};
//# sourceMappingURL=icon.stories-9eae58ff.js.map
