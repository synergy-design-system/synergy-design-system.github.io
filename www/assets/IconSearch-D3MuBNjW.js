import{j as we,M as Ri}from"./index-DwIOv-lP.js";import{useMDXComponents as fi}from"./index-CHrGa5Tm.js";import{b as x,r as pt,R as be}from"./index-_2TAQcTa.js";import{i as d,r as ji,x as u,e as Hi,u as Pt,E as Ui,T as Wi,B as Ki}from"./directive-helpers-Dvm_Ferq.js";import{n as r,b as _,e as m,i as Ee,c as b,o as g,u as se,f as Gi,t as Zi,r as Xi}from"./library-BX4ONXik.js";import{r as yi,L as Yi,a as ot,t as Qi,l as Je,b as Ji,c as eo,f as to,s as io,d as Rt,e as oo,p as wt,g as ao,h as so,i as ro,o as vi,j as no,k as lo,m as po,n as co}from"./ref-B9GS7qLj.js";import{d as At}from"./default-icons--FEJ2Psb.js";import"./iframe-I9NLeLMH.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-BwkS7JH_.js";import"./index-DrFu-skq.js";/**
 * @license
...
`,Wo=0,je=class extends v{constructor(){super(...arguments),this.attrId=++Wo,this.componentId=`syn-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return u`
      ...
      ></slot>
    `}};je.styles=[z,Uo,Ho];o([r({reflect:!0})],je.prototype,"name",2);o([r({type:Boolean,reflect:!0})],je.prototype,"active",2);o([f("active")],je.prototype,"handleActiveChange",1);var Ko="syn-tab-panel";je.define("syn-tab-panel");w({displayName:"SynTabPanel",elementClass:je,events:{},react:x,tagName:Ko});var Go=d`
  /* Write custom CSS here */
...
`,ke=class extends v{constructor(){super(...arguments),this.vertical=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}};ke.styles=[z,La,Ta];o([r({type:Boolean,reflect:!0})],ke.prototype,"vertical",2);o([f("vertical")],ke.prototype,"handleVerticalChange",1);var Da=d`
	/* stylelint-disable */
  :host {
    --size: 25rem;
...
`,nt=class extends v{constructor(){super(...arguments),this.localize=new B(this)}render(){return u`
    ...
    `}};nt.styles=[z,ja,Ra];var Ha="syn-spinner";nt.define("syn-spinner");w({displayName:"SynSpinner",elementClass:nt,events:{},react:x,tagName:Ha});var Ua=d`
:host([size='small']) {
...
`,ni=(e,t)=>{e.disabled?e.dataset.originallyDisabled="true":delete e.dataset.originallyDisabled,t&&(e.disabled=!0)},Me=class extends v{constructor(){super(...arguments),this.hasSlotController=new G(this,"[default]","prefix","suffix","label"),this.disabled=!1,this.label=""}enableObserver(){this.mutationObserver.observe(this,{attributeFilter:["disabled"],childList:!0,subtree:!0})}connectedCallback(){super.connectedCallback(),this.mutationObserver=new MutationObserver(e=>{const t=e.filter(s=>s.target===this),i=e.filter(s=>s.target.matches("syn-option")),a=t.length>0||i.length>0;a&&this.mutationObserver.disconnect(),i.length>0&&i.forEach(s=>{ni(s.target,this.disabled)}),t.length>0&&t.forEach(s=>{s.type==="attributes"&&this.assignedOptions.forEach(n=>{var l;n.disabled=this.disabled?!0:!!((l=n.dataset)!=null&&l.originallyDisabled)}),s.type==="childList"&&s.addedNodes.forEach(n=>{n instanceof HTMLElement&&n.matches("syn-option")&&ni(n,this.disabled)})}),a&&this.updateComplete.then(()=>{this.enableObserver()})}),this.enableObserver()}render(){const{disabled:e}=this,t=this.hasSlotController.test("label"),i=this.label?!0:!!t;return se`
    ...
    `}};Me.styles=Xa;Me.dependencies={"syn-divider":ke};o([ot({selector:"syn-option"})],Me.prototype,"assignedOptions",2);o([r({reflect:!0,type:Boolean})],Me.prototype,"disabled",2);o([r()],Me.prototype,"label",2);var Ya="syn-optgroup";Me.define("syn-optgroup");w({displayName:"SynOptgroup",elementClass:Me,events:{},react:x,tagName:Ya});var Qa=d`
  /**
...
`,de=class extends v{constructor(){super(...arguments),this.localize=new B(this),this.isInitialized=!1,this.current=!1,this.selected=!1,this.hasHover=!1,this.value="",this.disabled=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.setAttribute("aria-selected","false")}handleDefaultSlotChange(){this.isInitialized?(customElements.whenDefined("syn-combobox").then(()=>{const e=this.closest("syn-combobox");e&&e.handleDefaultSlotChange()}),customElements.whenDefined("syn-select").then(()=>{const e=this.closest("syn-select");e&&e.handleDefaultSlotChange()})):this.isInitialized=!0}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleValueChange(){typeof this.value!="string"&&(this.value=String(this.value)),this.value.includes(" ")&&(console.error("Option values cannot include a space. All spaces have been replaced with underscores.",this),this.value=this.value.replace(/ /g,"_"))}getTextLabel(){const e=this.childNodes;let t="";return[...e].forEach(i=>{i.nodeType===Node.ELEMENT_NODE&&(i.hasAttribute("slot")||(t+=i.textContent)),i.nodeType===Node.TEXT_NODE&&(t+=i.textContent)}),t.trim()}render(){return u`
    ...
    `}};de.styles=[z,Ja,Qa];de.dependencies={"syn-icon":R};o([m(".option__label")],de.prototype,"defaultSlot",2);o([_()],de.prototype,"current",2);o([_()],de.prototype,"selected",2);o([_()],de.prototype,"hasHover",2);o([r({reflect:!0})],de.prototype,"value",2);o([r({type:Boolean,reflect:!0})],de.prototype,"disabled",2);o([f("disabled")],de.prototype,"handleDisabledChange",1);o([f("selected")],de.prototype,"handleSelectedChange",1);o([f("value")],de.prototype,"handleValueChange",1);var es="syn-option";de.define("syn-option");w({displayName:"SynOption",elementClass:de,events:{},react:x,tagName:es});var ts="syn-popup";T.define("syn-popup");w({displayName:"SynPopup",elementClass:T,events:{onSynReposition:"syn-reposition"},react:x,tagName:ts});var li=e=>Array.from(e.assignedElements({flatten:!0})),is=e=>{var t;return e.tagName.toLocaleLowerCase()==="syn-nav-item"||((t=e.getAttribute("role"))!=null?t:"")==="menuitem"},pi=e=>e.filter(is),os=e=>{e.setAttribute("horizontal","true"),e.removeAttribute("slot"),e.removeAttribute("tabindex"),e.dataset.originalRole?e.setAttribute("role",e.dataset.originalRole):e.removeAttribute("role")},as=e=>{e.removeAttribute("horizontal"),e.setAttribute("slot","menu"),e.setAttribute("role","menuitem")},ss=d`
  :host {
    display: block;
...
`,Ue=class extends v{constructor(){super(...arguments),this.hasMenuItemsWithCheckmarks=!1,this.updateCheckMarksByChildPropChange=e=>{e.stopImmediatePropagation(),this.handleUpdateCheckmarks(this.getAllItems())}}handleUpdateCheckmarks(e){this.hasMenuItemsWithCheckmarks=e.some(t=>t.type==="checkbox"||t.loading)}disconnectedCallback(){this.removeEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu"),this.addEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}handleClick(e){const t=["menuitem","menuitemcheckbox"],i=e.composedPath(),a=i.find(p=>{var c;return t.includes(((c=p?.getAttribute)==null?void 0:c.call(p,"role"))||"")});if(!a||i.find(p=>{var c;return((c=p?.getAttribute)==null?void 0:c.call(p,"role"))==="menu"})!==this)return;const l=a;l.type==="checkbox"&&(l.checked=!l.checked),this.emit("syn-select",{detail:{item:l}})}handleKeyDown(e){if(e.key==="Enter"||e.key===" "){const t=this.getCurrentItem();e.preventDefault(),e.stopPropagation(),t?.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(e.key)){const t=this.getAllItems(),i=this.getCurrentItem();let a=i?t.indexOf(i):0;t.length>0&&(e.preventDefault(),e.stopPropagation(),e.key==="ArrowDown"?a++:e.key==="ArrowUp"?a--:e.key==="Home"?a=0:e.key==="End"&&(a=t.length-1),a<0&&(a=t.length-1),a>t.length-1&&(a=0),this.setCurrentItem(t[a]),t[a].focus())}}handleMouseDown(e){const t=e.target;this.isMenuItem(t)&&this.setCurrentItem(t)}handleSlotChange(){const e=this.getAllItems();this.handleUpdateCheckmarks(e),e.length>0&&this.setCurrentItem(e[0])}isMenuItem(e){var t;return e.tagName.toLowerCase()==="syn-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes((t=e.getAttribute("role"))!=null?t:"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>!(e.inert||!this.isMenuItem(e)))}getCurrentItem(){return this.getAllItems().find(e=>e.getAttribute("tabindex")==="0")}setCurrentItem(e){this.getAllItems().forEach(i=>{i.setAttribute("tabindex",i===e?"0":"-1")})}render(){return u`
      ...
      ></slot>
    `}};Ue.styles=[z,ns,rs];o([m("slot")],Ue.prototype,"defaultSlot",2);o([_()],Ue.prototype,"hasMenuItemsWithCheckmarks",2);var ls=d`
  /* Write custom CSS here */
`,ps=d`
	/* stylelint-disable */
  :host {
...
`,We=class extends v{constructor(){super(...arguments),this.localize=new B(this),this.value=0,this.indeterminate=!1,this.label=""}render(){return u`
    ...
    `}};We.styles=[z,us,ds];o([r({type:Number,reflect:!0})],We.prototype,"value",2);o([r({type:Boolean,reflect:!0})],We.prototype,"indeterminate",2);o([r()],We.prototype,"label",2);var ms="syn-progress-bar";We.define("syn-progress-bar");w({displayName:"SynProgressBar",elementClass:We,events:{},react:x,tagName:ms});var hs=d`
	/* stylelint-disable */
  :host {
    --size: 128px;
    --track-width: 4px;
...
`,Fe=class extends v{constructor(){super(...arguments),this.localize=new B(this),this.value=0,this.label=""}updated(e){if(super.updated(e),e.has("value")){const t=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),i=2*Math.PI*t,a=i-this.value/100*i;this.indicatorOffset=`${a}px`}}render(){return u`
    ...
    `}};Fe.styles=[z,hs,gs];o([m(".progress-ring__indicator")],Fe.prototype,"indicator",2);o([_()],Fe.prototype,"indicatorOffset",2);o([r({type:Number,reflect:!0})],Fe.prototype,"value",2);o([r()],Fe.prototype,"label",2);var fs="syn-progress-ring";Fe.define("syn-progress-ring");w({displayName:"SynProgressRing",elementClass:Fe,events:{},react:x,tagName:fs});var Bi=d`
	/* stylelint-disable */
  :host {
    display: inline-block;
    position: relative;
...
`,zs=R;R.define("syn-icon");var Ae=class extends v{constructor(){super(...arguments),this.hasSlotController=new G(this,"[default]","logo","label","meta-navigation","navigation"),this.localize=new B(this),this.label="",this.burgerMenu="hidden"}toggleBurgerMenu(){switch(this.burgerMenu){case"closed":this.burgerMenu="open";break;case"open":this.burgerMenu="closed";break}}handleBurgerMenuToggle(){this.sideNav&&!this.sideNav.rail&&(this.sideNav.open=!this.sideNav.open),this.toggleBurgerMenu()}updateBurgerMenuBasedOnSideNav(){this.sideNav&&(this.sideNav.rail?this.burgerMenu="hidden":this.burgerMenu=this.sideNav.open?"open":"closed")}handleBurgerMenu(){const e=`syn-burger-menu-${this.burgerMenu}`;this.emit(e)}connectedCallback(){super.connectedCallback(),this.mutationObserver=new MutationObserver(()=>this.updateBurgerMenuBasedOnSideNav())}firstUpdated(){this.updateComplete.then(()=>{const e=document.querySelector("syn-side-nav");this.connectSideNavigation(e)})}disconnectedCallback(){super.disconnectedCallback(),this.mutationObserver.disconnect()}connectSideNavigation(e){this.mutationObserver.disconnect(),this.sideNav=e||document.querySelector("syn-side-nav"),this.sideNav&&(this.updateBurgerMenuBasedOnSideNav(),this.mutationObserver.observe(this.sideNav,{attributeFilter:["open","rail"],attributes:!0}))}render(){const e=this.hasSlotController.test("navigation"),t=this.burgerMenu!=="hidden";return se`
    ...
    `}};Ae.styles=[z,ws];Ae.dependencies={"syn-icon":zs};o([r()],Ae.prototype,"label",2);o([r({attribute:"burger-menu",reflect:!0})],Ae.prototype,"burgerMenu",2);o([_()],Ae.prototype,"sideNav",2);o([f("burgerMenu",{waitUntilFirstUpdate:!0})],Ae.prototype,"handleBurgerMenu",1);var ks="syn-header";Ae.define("syn-header");w({displayName:"SynHeader",elementClass:Ae,events:{onSynBurgerMenuClosed:"syn-burger-menu-closed",onSynBurgerMenuHidden:"syn-burger-menu-hidden",onSynBurgerMenuOpen:"syn-burger-menu-open"},react:x,tagName:ks});var Cs="syn-icon-button";j.define("syn-icon-button");w({displayName:"SynIconButton",elementClass:j,events:{onSynBlur:"syn-blur",onSynFocus:"syn-focus"},react:x,tagName:Cs});var Ss="syn-icon";R.define("syn-icon");var $s=w({displayName:"SynIcon",elementClass:R,events:{onSynLoad:"syn-load",onSynError:"syn-error"},react:x,tagName:Ss}),Os=d`
  /**
...
`,_t=class extends v{render(){return u`
    ...
    `}};_t.styles=[z,Bs,Ns];_t.dependencies={"syn-divider":ke};var qs="syn-menu-label";_t.define("syn-menu-label");w({displayName:"SynMenuLabel",elementClass:_t,events:{},react:x,tagName:qs});var Ps="syn-menu";Ue.define("syn-menu");w({displayName:"SynMenu",elementClass:Ue,events:{onSynSelect:"syn-select"},react:x,tagName:Ps});var Rs=d`
  :host {
...
`,xt=class extends v{constructor(){super(...arguments),this.hasSlotController=new G(this,"footer","header","image"),this.sharp=!1}render(){return u`
    ...
    `}};xt.styles=[z,js,Rs];o([r({type:Boolean,reflect:!0})],xt.prototype,"sharp",2);var Hs="syn-card";xt.define("syn-card");w({displayName:"SynCard",elementClass:xt,events:{},react:x,tagName:Hs});var Us=d`
  .checkbox__control {
    border-radius: var(--syn-input-border-radius-small);
  }
...
`,K=class extends v{constructor(){super(...arguments),this.formControlController=new ze(this,{value:e=>e.checked?e.value||"on":void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=t}),this.hasSlotController=new G(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.indeterminate=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleClick(){this.checked=!this.checked,this.indeterminate=!1,this.emit("syn-change")}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleInput(){this.emit("syn-input")}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStateChange(){this.input.checked=this.checked,this.input.indeterminate=this.indeterminate,this.formControlController.updateValidity()}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("help-text"),t=this.helpText?!0:!!e;return u`
    ...
    `}};K.styles=[z,Se,Ws,$e,Us];K.dependencies={"syn-icon":R};o([m('input[type="checkbox"]')],K.prototype,"input",2);o([_()],K.prototype,"hasFocus",2);o([r()],K.prototype,"title",2);o([r()],K.prototype,"name",2);o([r()],K.prototype,"value",2);o([r({reflect:!0})],K.prototype,"size",2);o([r({type:Boolean,reflect:!0})],K.prototype,"disabled",2);o([r({type:Boolean,reflect:!0})],K.prototype,"checked",2);o([r({type:Boolean,reflect:!0})],K.prototype,"indeterminate",2);o([Le("checked")],K.prototype,"defaultChecked",2);o([r({reflect:!0})],K.prototype,"form",2);o([r({type:Boolean,reflect:!0})],K.prototype,"required",2);o([r({attribute:"help-text"})],K.prototype,"helpText",2);o([f("disabled",{waitUntilFirstUpdate:!0})],K.prototype,"handleDisabledChange",1);o([f(["checked","indeterminate"],{waitUntilFirstUpdate:!0})],K.prototype,"handleStateChange",1);K=o([te("SynCheckbox")],K);var Ks="syn-checkbox";K.define("syn-checkbox");w({displayName:"SynCheckbox",elementClass:K,events:{onSynBlur:"syn-blur",onSynChange:"syn-change",onSynFocus:"syn-focus",onSynInput:"syn-input",onSynInvalid:"syn-invalid"},react:x,tagName:Ks});var Gs=e=>e,di=e=>Array.from(e.assignedElements({flatten:!0})),Zs=e=>e.tagName.toLocaleLowerCase()==="syn-option"?e:Array.from(e.querySelectorAll(":scope > syn-option")),Xs=e=>e.tagName.toLocaleLowerCase()==="syn-optgroup",ui=e=>e.map(Zs),Ys=e=>e.filter(Xs),mi=e=>e.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase(),hi=e=>{const t=document.createElement("div");return Ki(e,t),t.firstElementChild},Ot=e=>e.tagName.toLocaleLowerCase()==="syn-option"?e:void 0,Qs=e=>{if(e){if(e instanceof HTMLElement)return Ot(e);if(typeof e=="string"){const t=u`${vi(e)}`,i=hi(t);return Ot(i)}if(Object.prototype.hasOwnProperty.call(e,"_$litType$")){const t=hi(e);return Ot(t)}}},Js=d`
...
`,_e=class extends v{constructor(){super(...arguments),this.closeOthers=!1,this.contained=!1,this.size="medium",this.handleAccordionShow=e=>{this.closeOthers&&this.detailsInDefaultSlot.forEach(t=>{t!==e.target&&t.parentNode===e.target.parentNode&&t.removeAttribute("open")})}}adjustDetailsSize(){this.detailsInDefaultSlot.forEach(e=>{e.setAttribute("size",this.size)})}adjustDetailsContained(){this.detailsInDefaultSlot.forEach(e=>{e.contained=this.contained})}handleSizeChange(){this.adjustDetailsSize()}handleContainedChange(){this.adjustDetailsContained()}connectedCallback(){super.connectedCallback(),this.addEventListener("syn-show",this.handleAccordionShow)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("syn-show",this.handleAccordionShow)}handleSlotChange(){this.adjustDetailsSize(),this.adjustDetailsContained()}render(){return u`
    ...
    `}};_e.styles=[z,dr];o([ot({selector:"syn-details"})],_e.prototype,"detailsInDefaultSlot",2);o([r({attribute:"close-others",type:Boolean})],_e.prototype,"closeOthers",2);o([r({reflect:!0,type:Boolean})],_e.prototype,"contained",2);o([r({reflect:!0})],_e.prototype,"size",2);o([f("size",{waitUntilFirstUpdate:!0})],_e.prototype,"handleSizeChange",1);o([f("contained",{waitUntilFirstUpdate:!0})],_e.prototype,"handleContainedChange",1);_e=o([te("SynAccordion")],_e);var ur="syn-accordion";_e.define("syn-accordion");w({displayName:"SynAccordion",elementClass:_e,events:{},react:x,tagName:ur});var mr="syn-alert";H.define("syn-alert");w({displayName:"SynAlert",elementClass:H,events:{onSynShow:"syn-show",onSynAfterShow:"syn-after-show",onSynHide:"syn-hide",onSynAfterHide:"syn-after-hide"},react:x,tagName:mr});var hr=d`
  .badge {
    border: none;
    border-radius: var(--syn-border-radius-pill);
    font: var(--syn-body-medium-bold);
...
`,Pe=class extends v{constructor(){super(...arguments),this.localize=new B(this),this.variant="primary"}render(){return u`
    ...
    `}};Pe.styles=[z,gr,hr];o([r({reflect:!0})],Pe.prototype,"variant",2);Pe=o([te("SynBadge")],Pe);var fr="syn-badge";Pe.define("syn-badge");w({displayName:"SynBadge",elementClass:Pe,events:{},react:x,tagName:fr});var yr=d`
  .breadcrumb-item {
    color: var(--syn-color-neutral-500);
    font-size: var(--syn-font-size-x-small);
    font-weight: var(--syn-font-weight-normal);
...
`,Oe=class extends v{constructor(){super(...arguments),this.hasSlotController=new G(this,"prefix","suffix"),this.renderType="button",this.rel="noreferrer noopener"}setRenderType(){const e=this.defaultSlot.assignedElements({flatten:!0}).filter(t=>t.tagName.toLowerCase()==="syn-dropdown").length>0;if(this.href){this.renderType="link";return}if(e){this.renderType="dropdown";return}this.renderType="button"}hrefChanged(){this.setRenderType()}handleSlotChange(){this.setRenderType()}render(){return u`
    ...
    `}};Oe.styles=[z,vr,yr];o([m("slot:not([name])")],Oe.prototype,"defaultSlot",2);o([_()],Oe.prototype,"renderType",2);o([r()],Oe.prototype,"href",2);o([r()],Oe.prototype,"target",2);o([r()],Oe.prototype,"rel",2);o([f("href",{waitUntilFirstUpdate:!0})],Oe.prototype,"hrefChanged",1);var br="syn-breadcrumb-item";Oe.define("syn-breadcrumb-item");w({displayName:"SynBreadcrumbItem",elementClass:Oe,events:{},react:x,tagName:br});var _r=d`
  /* Write custom CSS here */
`,xr=d`
	/* stylelint-disable */
  .breadcrumb {
...
`,we.jsx(Tr,{})]})}function Wr(e={}){const{wrapper:t}={...fi(),...e.components};return t?we.jsx(t,{...e,children:we.jsx(gi,{...e})}):gi(e)}export{Wr as default};
