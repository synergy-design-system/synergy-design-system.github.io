import{C as l,c as n,d as h}from"./iframe-eRvaIELU.js";import"./divider-C22Hy51R.js";import"./menu-item-CP3JuO68.js";import"./icon-CqBzwWTC.js";import{g as e,a as x,s as f,b as g,c as v}from"./component-mLh0MrP7.js";import"./preload-helper-PPVm8Dsz.js";import"./divider.component-DLGUxJgm.js";import"./synergy-element-BVZI5H_G.js";import"./watch-CEsCE2EF.js";import"./menu.component-CZc5Zv9Z.js";import"./icon.component-ehmpGKuT.js";import"./query-D0jTsbLw.js";import"./class-map-BctzS3gw.js";import"./slot-9EVoRGQc.js";import"./controller-BGdn_hBF.js";import"./popup.component-Dn3dFsqK.js";import"./if-defined-BvPV1s9v.js";import"./spinner.component-BI3Egrps.js";import"./index-3hbeBem-.js";import"./_docs-DCFLSkr0.js";var p=Object.freeze,b=Object.defineProperty,S=(t,y)=>p(b(t,"raw",{value:p(t.slice())})),d;const{args:k,argTypes:O}=f("syn-menu-item"),{overrideArgs:w}=v("syn-menu-item"),{generateTemplate:D}=g("syn-menu-item"),J={args:w([{name:"default",type:"slot",value:"Option 1"}],k),argTypes:O,component:"syn-menu-item",parameters:{chromatic:{modes:l},design:h("10461-8626"),docs:{description:{component:e("menu-item","default")}}},tags:["Navigation"],title:"Components/syn-menu-item"},s={parameters:{controls:{disable:!1},docs:{description:{story:e("menu-item","default")}}},render:t=>n`
    <syn-menu>
      ${D({args:t})}
    </syn-menu>
  ...
  `},a={parameters:{docs:{description:{story:e("menu-item","selection")}}},render:()=>n(d||(d=S([`
    ...
    <\/script>
  `])))},u=x({Default:s,PrefixAndSuffix:m,Disabled:i,Loading:o,CheckboxMenuItems:r,ValueSelection:a},300);s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  CheckboxMenuItems,
  ValueSelection
}, 300)`,...u.parameters?.docs?.source}}};const K=["Default","PrefixAndSuffix","Disabled","Loading","Focus","CheckboxMenuItems","ValueSelection","Screenshot"];export{r as CheckboxMenuItems,s as Default,i as Disabled,c as Focus,o as Loading,m as PrefixAndSuffix,u as Screenshot,a as ValueSelection,K as __namedExportsOrder,J as default};
