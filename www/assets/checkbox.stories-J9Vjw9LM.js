import"./checkbox-3Rtv0O4l.js";import"./button-DPFLjHtv.js";import{C as v,c,d as g}from"./iframe-r0CQHRKQ.js";import{g as r,a as S,s as C,b as q,c as D}from"./component-H_NDQ3WO.js";import"./class-map-BSAfnhal.js";import"./default-value-IZvEus9V.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./if-defined-BE596y_O.js";import"./live-CBv9XL3n.js";import"./synergy-element-C0zzvLBX.js";import"./icon.component-BtCkPkUy.js";import"./watch-CEsCE2EF.js";import"./query-D0jTsbLw.js";import"./form-control.custom.styles-CtgJ8K7o.js";import"./decorator-UnohHU6S.js";import"./functions-B4dslKTf.js";import"./localize-Dh03wnLC.js";import"./index-DihgwUfS.js";import"./spinner.component-CBNnwNtq.js";import"./preload-helper-PPVm8Dsz.js";import"./index-3hbeBem-.js";import"./_docs-B-LcOZte.js";var k=Object.freeze,E=Object.defineProperty,_=(o,e)=>k(E(o,"raw",{value:k(o.slice())})),x;const{userEvent:f}=__STORYBOOK_MODULE_TEST__,{argTypes:z}=C("syn-checkbox"),{overrideArgs:I}=D("syn-checkbox"),{generateTemplate:M}=q("syn-checkbox"),ee={args:I([{name:"default",type:"slot",value:"Checkbox"}]),argTypes:z,component:"syn-checkbox",parameters:{chromatic:{modes:v},design:g("1847-5654"),docs:{description:{component:r("checkbox","default")}}},tags:["Form"],title:"Components/syn-checkbox"},n={parameters:{controls:{disable:!1},docs:{description:{story:r("checkbox","default")}}},render:o=>M({args:o})},a={parameters:{docs:{description:{story:r("checkbox","checked")}}},render:()=>c`<syn-checkbox checked>Checked</syn-checkbox>`},i={parameters:{docs:{description:{story:r("checkbox","help-text")}}},render:()=>c`
  ...
  `},p={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:r("checkbox","validity")}}},play:async({canvasElement:o})=>{try{const e=o.querySelector("form"),t=o.querySelector("syn-button"),s=o.querySelector("syn-checkbox");e&&t&&s&&(s.setCustomValidity("Don't forget to check me!"),await f.click(t),t.click(),s.blur())}catch(e){console.error("Error in play function:",e)}},render:()=>c(x||(x=_([`
    ...
    <\/script>
  `])))},u=S({Default:n,Checked:a,HelpText:i,Indeterminate:l,Disabled:d,Sizes:m});n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
