import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,d as r,f as i,g as a,u as o}from"./iframe-DVxLZS-s.js";import{t as s}from"./button-Bh72Wntz.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-DniQwiZV.js";import{n as m,t as h}from"./menu-item-BiG9-9K5.js";import{t as g}from"./dropdown-C7hxAnCm.js";import{n as _,t as v}from"./button-group.component-CZMBofHQ.js";import{t as y}from"./tooltip-CfuQsXNo.js";var b=e((()=>{_(),_(),v.define(`syn-button-group`)})),x,S,C,w,T,E,D,O,k,A,j,M,N,P;e((()=>{b(),s(),g(),m(),h(),y(),t(),f(),r(),a(),{args:x,argTypes:S}=l(`syn-button-group`),{overrideArgs:C}=c(`syn-button-group`),{generateTemplate:w}=d(`syn-button-group`),T={args:C({name:`default`,type:`slot`,value:`<syn-button>Left</syn-button>
