import{ae as ve,af as Ii}from"./index-DOZwdX_p.js";import{useMDXComponents as si}from"./index-DjKt9u9V.js";import{a as x,r as nt,R as he}from"./index-CleY8y_P.js";import{i as c,h as Ei,k as d,n as Ti,u as Mt,D as Li,R as Di}from"./directive-helpers-CDT6qhDs.js";import{n as s,a as b,r as Ni}from"./library-BZPO0bHa.js";import{b as m,e as Ie,k as J,R as y,a as g,d as Mi,f as Fi}from"./if-defined-BaykDp1D.js";import{r as ri,L as Vi,t as qi,F as Ye,b as Bi,o as Pi,s as Ft,f as Ri,c as ji,d as Hi,p as _t,e as Ui,g as Wi,h as ni,i as Ki,a as li,j as Zi,$ as Gi,k as Xi,K as Yi}from"./ref-lLHsj5FH.js";import{d as Ct}from"./default-icons-B7cd3LAo.js";import"./iframe-Bc7jEGYD.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-Df9so8jS.js";import"./index-9hYXp3D6.js";import"./index-DrFu-skq.js";/**
 * @license
...
`,Te=class extends v{constructor(){super(...arguments),this.localize=new M(this),this.size="medium",this.removable=!1}handleRemoveClick(){this.emit("syn-remove")}render(){return d`
      <span
        part="base"
    ...
    `}};Te.styles=[z,Vo,Fo];Te.dependencies={"syn-icon-button":P};o([s({reflect:!0})],Te.prototype,"size",2);o([s({type:Boolean})],Te.prototype,"removable",2);var qo="syn-tag";Te.define("syn-tag");w({displayName:"SynTag",elementClass:Te,events:{onSynRemove:"syn-remove"},react:x,tagName:qo});var Bo=c`
...
`,Le=(e="value")=>(t,i)=>{const a=t.constructor,r=a.prototype.attributeChangedCallback;a.prototype.attributeChangedCallback=function(n,l,p){var u;const f=a.getPropertyOptions(e),C=typeof f.attribute=="string"?f.attribute:e;if(n===C){const R=f.converter||Mt,q=(typeof R=="function"?R:(u=R?.fromAttribute)!=null?u:Mt.fromAttribute)(p,f.type);this[e]!==q&&(this[i]=q)}r.call(this,n,l,p)}},we=c`
	/* stylelint-disable */
...
`,$e=class extends v{constructor(){super(...arguments),this.hasSlotController=new H(this,"[default]","prefix","suffix","label"),this.disabled=!1,this.label=""}handleDisableOptions(){const{disabled:e}=this;this.defaultSlot.assignedElements().filter(t=>t.tagName.toLowerCase()==="syn-option").forEach(t=>{t.disabled=e})}handleDisabledChange(){this.handleDisableOptions()}render(){const{disabled:e}=this,t=this.hasSlotController.test("label"),i=this.label?!0:!!t;return J`
    ...
    `}};$e.styles=Ma;$e.dependencies={"syn-divider":be};o([m("slot:not([name])")],$e.prototype,"defaultSlot",2);o([s({reflect:!0,type:Boolean})],$e.prototype,"disabled",2);o([s()],$e.prototype,"label",2);o([h("disabled",{waitUntilFirstUpdate:!0})],$e.prototype,"handleDisabledChange",1);var Fa="syn-optgroup";$e.define("syn-optgroup");w({displayName:"SynOptgroup",elementClass:$e,events:{},react:x,tagName:Fa});var Va=c`
	/* stylelint-disable */
  :host {
    display: block;
    user-select: none;
...
`,ps=V;V.define("syn-icon");var Oe=class extends v{constructor(){super(...arguments),this.hasSlotController=new H(this,"[default]","logo","label","meta-navigation","navigation"),this.localize=new M(this),this.label="",this.burgerMenu="hidden"}toggleBurgerMenu(){switch(this.burgerMenu){case"closed":this.burgerMenu="open";break;case"open":this.burgerMenu="closed";break}}handleBurgerMenuToggle(){this.sideNav&&!this.sideNav.rail&&(this.sideNav.open=!this.sideNav.open),this.toggleBurgerMenu()}updateBurgerMenuBasedOnSideNav(){this.sideNav&&(this.sideNav.rail?this.burgerMenu="hidden":this.burgerMenu=this.sideNav.open?"open":"closed")}handleBurgerMenu(){const e=`syn-burger-menu-${this.burgerMenu}`;this.emit(e)}connectedCallback(){super.connectedCallback(),this.mutationObserver=new MutationObserver(()=>this.updateBurgerMenuBasedOnSideNav())}firstUpdated(){const e=document.querySelector("syn-side-nav");this.connectSideNavigation(e)}disconnectedCallback(){super.disconnectedCallback(),this.mutationObserver.disconnect()}connectSideNavigation(e){this.mutationObserver.disconnect(),this.sideNav=e||document.querySelector("syn-side-nav"),this.sideNav&&(this.updateBurgerMenuBasedOnSideNav(),this.mutationObserver.observe(this.sideNav,{attributeFilter:["open","rail"],attributes:!0}))}render(){const e=this.hasSlotController.test("navigation"),t=this.burgerMenu!=="hidden";return J`
    ...
    `}};Oe.styles=[z,ls];Oe.dependencies={"syn-icon":ps};o([s()],Oe.prototype,"label",2);o([s({attribute:"burger-menu",reflect:!0})],Oe.prototype,"burgerMenu",2);o([b()],Oe.prototype,"sideNav",2);o([h("burgerMenu",{waitUntilFirstUpdate:!0})],Oe.prototype,"handleBurgerMenu",1);var cs="syn-header";Oe.define("syn-header");w({displayName:"SynHeader",elementClass:Oe,events:{onSynBurgerMenuClosed:"syn-burger-menu-closed",onSynBurgerMenuHidden:"syn-burger-menu-hidden",onSynBurgerMenuOpen:"syn-burger-menu-open"},react:x,tagName:cs});var ds="syn-icon-button";P.define("syn-icon-button");w({displayName:"SynIconButton",elementClass:P,events:{onSynBlur:"syn-blur",onSynFocus:"syn-focus"},react:x,tagName:ds});var us="syn-icon";V.define("syn-icon");var ms=w({displayName:"SynIcon",elementClass:V,events:{onSynLoad:"syn-load",onSynError:"syn-error"},react:x,tagName:us}),hs=c`
