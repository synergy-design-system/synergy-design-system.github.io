import{e as _}from"./class-map-B2JK6qvh.js";import{e as w,a as B,t as k,T as C,j as S,x as n,g as z,C as E}from"./iframe-C6ysFTXM.js";import{o as $}from"./if-defined-RjtpvExn.js";import{L as D}from"./localize-Dh03wnLC.js";import{S as I,c as L,n as b}from"./synergy-element-Cz9u2HM2.js";import"./button-BKkl0t2-.js";import"./icon-DWi3RLUw.js";import{g as i,s as T,a as P,c as j,b as O}from"./component-Clrk8h3y.js";import"./preload-helper-Ct5FWWRu.js";import"./index-DihgwUfS.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./icon.component-pWhLRhJK.js";import"./watch-CEsCE2EF.js";import"./query-DAIS6qJ0.js";import"./spinner.component-Dr_CV3LV.js";import"./decorator-DANECR0-.js";import"./functions-CDi3doZH.js";import"./index-Bkk0Z6Ex.js";import"./_docs-UXgsQIP6.js";/**
 * @license
...
`;var V=Object.defineProperty,y=(e,a,s,r)=>{for(var t=void 0,o=e.length-1,v;o>=0;o--)(v=e[o])&&(t=v(a,s,t)||t);return t&&V(a,s,t),t};class g extends I{constructor(){super(...arguments),this.localize=new D(this),this.value=0,this.indeterminate=!1,this.label=""}static{this.styles=[L,H,U]}render(){return n`
    ...
    `}}y([b({type:Number,reflect:!0})],g.prototype,"value");y([b({type:Boolean,reflect:!0})],g.prototype,"indeterminate");y([b()],g.prototype,"label");g.define("syn-progress-bar");var h=Object.freeze,q=Object.defineProperty,F=(e,a)=>h(q(e,"raw",{value:h(e.slice())})),f;const{args:K,argTypes:N}=T("syn-progress-bar"),{overrideArgs:R}=P("syn-progress-bar"),{generateTemplate:W}=j("syn-progress-bar"),ge={args:R({name:"value",type:"attribute",value:33.3},K),argTypes:N,component:"syn-progress-bar",parameters:{chromatic:{modes:E},design:z("15533-15734"),docs:{description:{component:i("progress-bar","default")}}},tags:["Feedback","SICK2025"],title:"Components/syn-progress-bar"},l={parameters:{docs:{description:{story:i("progress-bar","default")}}},render:e=>W({args:e})},c={parameters:{docs:{description:{story:i("progress-bar","labels")}}},render:()=>n`
