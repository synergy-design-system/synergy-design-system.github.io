import"./index-DH5ua8nC.js";import{a as S,s as ce,n as q,o as v,b as w,c as Te,t as ft,e as pe,S as _i}from"./icon-button-C6r21gbd.js";import{i as y,x as g,T as Yt,u as ai,w as Ut}from"./lit-element-DILkAbkc.js";import{a as P,c as M,n as a,S as zt,b as E,w as k}from"./icon.component-C2-Oqyow.js";import{f as wi,m as Ji}from"./directive-helpers-DbZfDV3x.js";import"./icon-Xw7W5jq4.js";const He=new Set,ts=new MutationObserver(zi),Wt=new Map;let xi=document.documentElement.dir||"ltr",ki=document.documentElement.lang||navigator.language,Nt;ts.observe(document.documentElement,{attributes:!0,attributeFilter:["dir","lang"]});function Ci(...i){i.map(t=>{const e=t.$code.toLowerCase();Wt.has(e)?Wt.set(e,Object.assign(Object.assign({},Wt.get(e)),t)):Wt.set(e,t),Nt||(Nt=t)}),zi()}function zi(){xi=document.documentElement.dir||"ltr",ki=document.documentElement.lang||navigator.language,[...He.keys()].map(i=>{typeof i.requestUpdate=="function"&&i.requestUpdate()})}let es=class{constructor(t){this.host=t,this.host.addController(this)}hostConnected(){He.add(this.host)}hostDisconnected(){He.delete(this.host)}dir(){return`${this.host.dir||xi}`.toLowerCase()}lang(){return`${this.host.lang||ki}`.toLowerCase()}getTranslationData(t){var e,o;const s=new Intl.Locale(t.replace(/_/g,"-")),n=s?.language.toLowerCase(),r=(o=(e=s?.region)===null||e===void 0?void 0:e.toLowerCase())!==null&&o!==void 0?o:"",l=Wt.get(`${n}-${r}`),c=Wt.get(n);return{locale:s,language:n,region:r,primary:l,secondary:c}}exists(t,e){var o;const{primary:s,secondary:n}=this.getTranslationData((o=e.lang)!==null&&o!==void 0?o:this.lang());return e=Object.assign({includeFallback:!1},e),!!(s&&s[t]||n&&n[t]||e.includeFallback&&Nt&&Nt[t])}term(t,...e){const{primary:o,secondary:s}=this.getTranslationData(this.lang());let n;if(o&&o[t])n=o[t];else if(s&&s[t])n=s[t];else if(Nt&&Nt[t])n=Nt[t];else return console.error(`No translation found for: ${String(t)}`),String(t);return typeof n=="function"?n(...e):n}date(t,e){return t=new Date(t),new Intl.DateTimeFormat(this.lang(),e).format(t)}number(t,e){return t=Number(t),isNaN(t)?"":new Intl.NumberFormat(this.lang(),e).format(t)}relativeTime(t,e,o){return new Intl.RelativeTimeFormat(this.lang(),o).format(t,e)}};const $i={$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(i,t)=>`Go to slide ${i} of ${t}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:i=>i===0?"No options selected":i===1?"1 option selected":`${i} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:i=>`Slide ${i}`,toggleColorFormat:"Toggle color format",closeMenu:"Close menu",danger:"Danger",notification:"Notification",openMenu:"Open menu",sideNav:"Side navigation",success:"Success",warning:"Warning"};Ci($i);class Z extends es{static{Ci($i)}}const is=y`
	/* stylelint-disable */
  :host {
    display: inline-flex;
  }
...
`;var os=Object.defineProperty,ns=(i,t,e,o)=>{for(var s=void 0,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=r(t,e,s)||s);return s&&os(t,e,s),s};class Si extends P{constructor(){super(...arguments),this.localize=new Z(this),this.variant="primary"}static{this.styles=[M,is,ss]}render(){return g`
      <span
        part="base"
        class=${S({badge:!0,"badge--primary":this.variant==="primary","badge--success":this.variant==="success","badge--neutral":this.variant==="neutral","badge--warning":this.variant==="warning","badge--danger":this.variant==="danger"})}
        role="status"
      >
        <slot>
...
`;class Ei extends P{constructor(){super(...arguments),this.localize=new Z(this)}static{this.styles=[M,cs]}render(){return g`
...
`;var hs=Object.defineProperty,us=Object.getOwnPropertyDescriptor,V=(i,t,e,o)=>{for(var s=o>1?void 0:o?us(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=(o?r(t,e,s):r(s))||s);return o&&s&&hs(t,e,s),s};class R extends P{constructor(){super(...arguments),this.formControlController=new qt(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new Q(this,"[default]","prefix","suffix"),this.localize=new Z(this),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="outline",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}static{this.styles=[M,Oi,ds]}static{this.dependencies={"syn-icon":zt,"syn-spinner":Ei}}get validity(){return this.isButton()?this.button.validity:De}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(t){this.isButton()&&(this.button.setCustomValidity(t),this.formControlController.updateValidity())}render(){const t=this.isLink(),e=t?ce`a`:ce`button`;return q`
    ...
    `}}V([w(".button")],R.prototype,"button",2);V([E()],R.prototype,"hasFocus",2);V([E()],R.prototype,"invalid",2);V([a()],R.prototype,"title",2);V([a({reflect:!0})],R.prototype,"variant",2);V([a({reflect:!0})],R.prototype,"size",2);V([a({type:Boolean,reflect:!0})],R.prototype,"caret",2);V([a({type:Boolean,reflect:!0})],R.prototype,"disabled",2);V([a({type:Boolean,reflect:!0})],R.prototype,"loading",2);V([a()],R.prototype,"type",2);V([a()],R.prototype,"name",2);V([a()],R.prototype,"value",2);V([a()],R.prototype,"href",2);V([a()],R.prototype,"target",2);V([a()],R.prototype,"rel",2);V([a()],R.prototype,"download",2);V([a()],R.prototype,"form",2);V([a({attribute:"formaction"})],R.prototype,"formAction",2);V([a({attribute:"formenctype"})],R.prototype,"formEnctype",2);V([a({attribute:"formmethod"})],R.prototype,"formMethod",2);V([a({attribute:"formnovalidate",type:Boolean})],R.prototype,"formNoValidate",2);V([a({attribute:"formtarget"})],R.prototype,"formTarget",2);V([k("disabled",{waitUntilFirstUpdate:!0})],R.prototype,"handleDisabledChange",1);R.define("syn-button");const ps=y`
	/* stylelint-disable */
  :host {
    display: block;
    position: relative;
...
`;var fs=Object.defineProperty,ys=(i,t,e,o)=>{for(var s=void 0,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=r(t,e,s)||s);return s&&fs(t,e,s),s};class Ze extends P{static{this.styles=[M,ps,ms]}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu")}handleClick(t){const e=["menuitem","menuitemcheckbox"],o=t.composedPath().find(n=>e.includes(n?.getAttribute?.("role")||""));if(!o)return;const s=o;s.type==="checkbox"&&(s.checked=!s.checked),this.emit("syn-select",{detail:{item:s}})}handleKeyDown(t){if(t.key==="Enter"||t.key===" "){const e=this.getCurrentItem();t.preventDefault(),t.stopPropagation(),e?.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(t.key)){const e=this.getAllItems(),o=this.getCurrentItem();let s=o?e.indexOf(o):0;e.length>0&&(t.preventDefault(),t.stopPropagation(),t.key==="ArrowDown"?s++:t.key==="ArrowUp"?s--:t.key==="Home"?s=0:t.key==="End"&&(s=e.length-1),s<0&&(s=e.length-1),s>e.length-1&&(s=0),this.setCurrentItem(e[s]),e[s].focus())}}handleMouseDown(t){const e=t.target;this.isMenuItem(e)&&this.setCurrentItem(e)}handleSlotChange(){const t=this.getAllItems();t.length>0&&this.setCurrentItem(t[0])}isMenuItem(t){return t.tagName.toLowerCase()==="syn-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes(t.getAttribute("role")??"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(t=>!(t.inert||!this.isMenuItem(t)))}getCurrentItem(){return this.getAllItems().find(t=>t.getAttribute("tabindex")==="0")}setCurrentItem(t){this.getAllItems().forEach(o=>{o.setAttribute("tabindex",o===t?"0":"-1")})}render(){return g`
      ...
      ></slot>
    `}}ys([w("slot")],Ze.prototype,"defaultSlot");Ze.define("syn-menu");const bs=y`
	/* stylelint-disable */
  :host {
...
`;var vs=Object.defineProperty,_s=Object.getOwnPropertyDescriptor,Ai=(i,t,e,o)=>{for(var s=o>1?void 0:o?_s(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=(o?r(t,e,s):r(s))||s);return o&&s&&vs(t,e,s),s};class Rt extends P{constructor(){super(...arguments),this.vertical=!1}static{this.styles=[M,bs,gs]}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}}Ai([a({type:Boolean,reflect:!0})],Rt.prototype,"vertical",2);Ai([k("vertical")],Rt.prototype,"handleVerticalChange",1);const ws=y`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`;class ks extends P{static{this.styles=[M,ws,xs]}static{this.dependencies={"syn-divider":Rt}}render(){return g`
 ...
 */const Ss=()=>new Es;class Es{}const Be=new WeakMap,Os=pe(class extends Di{render(i){return Yt}update(i,[t]){const e=t!==this.Y;return e&&this.Y!==void 0&&this.rt(void 0),(e||this.lt!==this.ct)&&(this.Y=t,this.ht=i.options?.host,this.rt(this.ct=i.element)),Yt}rt(i){if(typeof this.Y=="function"){const t=this.ht??globalThis;let e=Be.get(t);e===void 0&&(e=new WeakMap,Be.set(t,e)),e.get(this.Y)!==void 0&&this.Y.call(this.ht,void 0),e.set(this.Y,i),i!==void 0&&this.Y.call(this.ht,i)}else this.Y.value=i}get lt(){return typeof this.Y=="function"?Be.get(this.ht??globalThis)?.get(this.Y):this.Y?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});class As{constructor(t,e,o){this.popupRef=Ss(),this.enableSubmenuTimer=-1,this.isConnected=!1,this.isPopupConnected=!1,this.skidding=0,this.submenuOpenDelay=100,this.handleMouseMove=s=>{this.host.style.setProperty("--safe-triangle-cursor-x",`${s.clientX}px`),this.host.style.setProperty("--safe-triangle-cursor-y",`${s.clientY}px`)},this.handleMouseOver=()=>{this.hasSlotController.test("submenu")&&this.enableSubmenu()},this.handleKeyDown=s=>{switch(s.key){case"Escape":case"Tab":this.disableSubmenu();break;case"ArrowLeft":s.target!==this.host&&(s.preventDefault(),s.stopPropagation(),this.host.focus(),this.disableSubmenu());break;case"ArrowRight":case"Enter":case" ":this.handleSubmenuEntry(s);break}},this.handleClick=s=>{s.target===this.host?(s.preventDefault(),s.stopPropagation()):s.target instanceof Element&&(s.target.tagName==="syn-menu-item"||s.target.role?.startsWith("menuitem"))&&this.disableSubmenu()},this.handleFocusOut=s=>{s.relatedTarget&&s.relatedTarget instanceof Element&&this.host.contains(s.relatedTarget)||this.disableSubmenu()},this.handlePopupMouseover=s=>{s.stopPropagation()},this.handlePopupReposition=()=>{const n=this.host.renderRoot.querySelector("slot[name='submenu']")?.assignedElements({flatten:!0}).filter(u=>u.localName==="syn-menu")[0],r=this.localize.dir()==="rtl";if(!n)return;const{left:l,top:c,width:d,height:h}=n.getBoundingClientRect();this.host.style.setProperty("--safe-triangle-submenu-start-x",`${r?l+d:l}px`),this.host.style.setProperty("--safe-triangle-submenu-start-y",`${c}px`),this.host.style.setProperty("--safe-triangle-submenu-end-x",`${r?l+d:l}px`),this.host.style.setProperty("--safe-triangle-submenu-end-y",`${c+h}px`)},(this.host=t).addController(this),this.hasSlotController=e,this.localize=o}hostConnected(){this.hasSlotController.test("submenu")&&!this.host.disabled&&this.addListeners()}hostDisconnected(){this.removeListeners()}hostUpdated(){this.hasSlotController.test("submenu")&&!this.host.disabled?(this.addListeners(),this.updateSkidding()):this.removeListeners()}addListeners(){this.isConnected||(this.host.addEventListener("mousemove",this.handleMouseMove),this.host.addEventListener("mouseover",this.handleMouseOver),this.host.addEventListener("keydown",this.handleKeyDown),this.host.addEventListener("click",this.handleClick),this.host.addEventListener("focusout",this.handleFocusOut),this.isConnected=!0),this.isPopupConnected||this.popupRef.value&&(this.popupRef.value.addEventListener("mouseover",this.handlePopupMouseover),this.popupRef.value.addEventListener("syn-reposition",this.handlePopupReposition),this.isPopupConnected=!0)}removeListeners(){this.isConnected&&(this.host.removeEventListener("mousemove",this.handleMouseMove),this.host.removeEventListener("mouseover",this.handleMouseOver),this.host.removeEventListener("keydown",this.handleKeyDown),this.host.removeEventListener("click",this.handleClick),this.host.removeEventListener("focusout",this.handleFocusOut),this.isConnected=!1),this.isPopupConnected&&this.popupRef.value&&(this.popupRef.value.removeEventListener("mouseover",this.handlePopupMouseover),this.popupRef.value.removeEventListener("syn-reposition",this.handlePopupReposition),this.isPopupConnected=!1)}handleSubmenuEntry(t){const e=this.host.renderRoot.querySelector("slot[name='submenu']");if(!e){console.error("Cannot activate a submenu if no corresponding menuitem can be found.",this);return}let o=null;for(const s of e.assignedElements())if(o=s.querySelectorAll("syn-menu-item, [role^='menuitem']"),o.length!==0)break;if(!(!o||o.length===0)){o[0].setAttribute("tabindex","0");for(let s=1;s!==o.length;++s)o[s].setAttribute("tabindex","-1");this.popupRef.value&&(t.preventDefault(),t.stopPropagation(),this.popupRef.value.active?o[0]instanceof HTMLElement&&o[0].focus():(this.enableSubmenu(!1),this.host.updateComplete.then(()=>{o[0]instanceof HTMLElement&&o[0].focus()}),this.host.requestUpdate()))}}setSubmenuState(t){this.popupRef.value&&this.popupRef.value.active!==t&&(this.popupRef.value.active=t,this.host.requestUpdate())}enableSubmenu(t=!0){t?(window.clearTimeout(this.enableSubmenuTimer),this.enableSubmenuTimer=window.setTimeout(()=>{this.setSubmenuState(!0)},this.submenuOpenDelay)):this.setSubmenuState(!0)}disableSubmenu(){window.clearTimeout(this.enableSubmenuTimer),this.setSubmenuState(!1)}updateSkidding(){if(!this.host.parentElement?.computedStyleMap)return;const t=this.host.parentElement.computedStyleMap(),o=["padding-top","border-top-width","margin-top"].reduce((s,n)=>{const r=t.get(n)??new CSSUnitValue(0,"px"),c=(r instanceof CSSUnitValue?r:new CSSUnitValue(0,"px")).to("px");return s-c.value},0);this.skidding=o}isExpanded(){return this.popupRef.value?this.popupRef.value.active:!1}renderSubmenu(){const t=this.localize.dir()==="ltr";return this.isConnected?g`
    ...
    `:g` <slot name="submenu" hidden></slot> `}}const Pt=Math.min,ot=Math.max,Se=Math.round,xe=Math.floor,Lt=i=>({x:i,y:i}),Ts={left:"right",right:"left",bottom:"top",top:"bottom"},Ds={start:"end",end:"start"};function qe(i,t,e){return ot(i,Pt(t,e))}function Xt(i,t){return typeof i=="function"?i(t):i}function It(i){return i.split("-")[0]}function Zt(i){return i.split("-")[1]}function Pi(i){return i==="x"?"y":"x"}function Qe(i){return i==="y"?"height":"width"}function me(i){return["top","bottom"].includes(It(i))?"y":"x"}function Je(i){return Pi(me(i))}function Ps(i,t,e){e===void 0&&(e=!1);const o=Zt(i),s=Je(i),n=Qe(s);let r=s==="x"?o===(e?"end":"start")?"right":"left":o==="start"?"bottom":"top";return t.reference[n]>t.floating[n]&&(r=Ee(r)),[r,Ee(r)]}function Ls(i){const t=Ee(i);return[je(i),t,je(t)]}function je(i){return i.replace(/start|end/g,t=>Ds[t])}function Is(i,t,e){const o=["left","right"],s=["right","left"],n=["top","bottom"],r=["bottom","top"];switch(i){case"top":case"bottom":return e?t?s:o:t?o:s;case"left":case"right":return t?n:r;default:return[]}}function Ms(i,t,e,o){const s=Zt(i);let n=Is(It(i),e==="start",o);return s&&(n=n.map(r=>r+"-"+s),t&&(n=n.concat(n.map(je)))),n}function Ee(i){return i.replace(/left|right|bottom|top/g,t=>Ts[t])}function Rs(i){return{top:0,right:0,bottom:0,left:0,...i}}function Li(i){return typeof i!="number"?Rs(i):{top:i,right:i,bottom:i,left:i}}function Oe(i){return{...i,top:i.y,left:i.x,right:i.x+i.width,bottom:i.y+i.height}}function li(i,t,e){let{reference:o,floating:s}=i;const n=me(t),r=Je(t),l=Qe(r),c=It(t),d=n==="y",h=o.x+o.width/2-s.width/2,u=o.y+o.height/2-s.height/2,m=o[l]/2-s[l]/2;let p;switch(c){case"top":p={x:h,y:o.y-s.height};break;case"bottom":p={x:h,y:o.y+o.height};break;case"right":p={x:o.x+o.width,y:u};break;case"left":p={x:o.x-s.width,y:u};break;default:p={x:o.x,y:o.y}}switch(Zt(t)){case"start":p[r]-=m*(e&&d?-1:1);break;case"end":p[r]+=m*(e&&d?-1:1);break}return p}const Fs=async(i,t,e)=>{const{placement:o="bottom",strategy:s="absolute",middleware:n=[],platform:r}=e,l=n.filter(Boolean),c=await(r.isRTL==null?void 0:r.isRTL(t));let d=await r.getElementRects({reference:i,floating:t,strategy:s}),{x:h,y:u}=li(d,o,c),m=o,p={},f=0;for(let b=0;b<l.length;b++){const{name:z,fn:_}=l[b],{x:$,y:D,data:U,reset:B}=await _({x:h,y:u,initialPlacement:o,placement:m,strategy:s,middlewareData:p,rects:d,platform:r,elements:{reference:i,floating:t}});h=$??h,u=D??u,p={...p,[z]:{...p[z],...U}},B&&f<=50&&(f++,typeof B=="object"&&(B.placement&&(m=B.placement),B.rects&&(d=B.rects===!0?await r.getElementRects({reference:i,floating:t,strategy:s}):B.rects),{x:h,y:u}=li(d,m,c)),b=-1)}return{x:h,y:u,placement:m,strategy:s,middlewareData:p}};async function ti(i,t){var e;t===void 0&&(t={});const{x:o,y:s,platform:n,rects:r,elements:l,strategy:c}=i,{boundary:d="clippingAncestors",rootBoundary:h="viewport",elementContext:u="floating",altBoundary:m=!1,padding:p=0}=Xt(t,i),f=Li(p),z=l[m?u==="floating"?"reference":"floating":u],_=Oe(await n.getClippingRect({element:(e=await(n.isElement==null?void 0:n.isElement(z)))==null||e?z:z.contextElement||await(n.getDocumentElement==null?void 0:n.getDocumentElement(l.floating)),boundary:d,rootBoundary:h,strategy:c})),$=u==="floating"?{...r.floating,x:o,y:s}:r.reference,D=await(n.getOffsetParent==null?void 0:n.getOffsetParent(l.floating)),U=await(n.isElement==null?void 0:n.isElement(D))?await(n.getScale==null?void 0:n.getScale(D))||{x:1,y:1}:{x:1,y:1},B=Oe(n.convertOffsetParentRelativeRectToViewportRelativeRect?await n.convertOffsetParentRelativeRectToViewportRelativeRect({elements:l,rect:$,offsetParent:D,strategy:c}):$);return{top:(_.top-B.top+f.top)/U.y,bottom:(B.bottom-_.bottom+f.bottom)/U.y,left:(_.left-B.left+f.left)/U.x,right:(B.right-_.right+f.right)/U.x}}const Vs=i=>({name:"arrow",options:i,async fn(t){const{x:e,y:o,placement:s,rects:n,platform:r,elements:l,middlewareData:c}=t,{element:d,padding:h=0}=Xt(i,t)||{};if(d==null)return{};const u=Li(h),m={x:e,y:o},p=Je(s),f=Qe(p),b=await r.getDimensions(d),z=p==="y",_=z?"top":"left",$=z?"bottom":"right",D=z?"clientHeight":"clientWidth",U=n.reference[f]+n.reference[p]-m[p]-n.floating[f],B=m[p]-n.reference[p],H=await(r.getOffsetParent==null?void 0:r.getOffsetParent(d));let it=H?H[D]:0;(!it||!await(r.isElement==null?void 0:r.isElement(H)))&&(it=l.floating[D]||n.floating[f]);const ut=U/2-B/2,Tt=it/2-b[f]/2-1,ee=Pt(u[_],Tt),ie=Pt(u[$],Tt),lt=ee,se=it-b[f]-ie,st=it/2-b[f]/2+ut,pt=qe(lt,st,se),mt=!c.arrow&&Zt(s)!=null&&st!==pt&&n.reference[f]/2-(st<lt?ee:ie)-b[f]/2<0,xt=mt?st<lt?st-lt:st-se:0;return{[p]:m[p]+xt,data:{[p]:pt,centerOffset:st-pt-xt,...mt&&{alignmentOffset:xt}},reset:mt}}}),Bs=function(i){return i===void 0&&(i={}),{name:"flip",options:i,async fn(t){var e,o;const{placement:s,middlewareData:n,rects:r,initialPlacement:l,platform:c,elements:d}=t,{mainAxis:h=!0,crossAxis:u=!0,fallbackPlacements:m,fallbackStrategy:p="bestFit",fallbackAxisSideDirection:f="none",flipAlignment:b=!0,...z}=Xt(i,t);if((e=n.arrow)!=null&&e.alignmentOffset)return{};const _=It(s),$=It(l)===l,D=await(c.isRTL==null?void 0:c.isRTL(d.floating)),U=m||($||!b?[Ee(l)]:Ls(l));!m&&f!=="none"&&U.push(...Ms(l,b,f,D));const B=[l,...U],H=await ti(t,z),it=[];let ut=((o=n.flip)==null?void 0:o.overflows)||[];if(h&&it.push(H[_]),u){const lt=Ps(s,r,D);it.push(H[lt[0]],H[lt[1]])}if(ut=[...ut,{placement:s,overflows:it}],!it.every(lt=>lt<=0)){var Tt,ee;const lt=(((Tt=n.flip)==null?void 0:Tt.index)||0)+1,se=B[lt];if(se)return{data:{index:lt,overflows:ut},reset:{placement:se}};let st=(ee=ut.filter(pt=>pt.overflows[0]<=0).sort((pt,mt)=>pt.overflows[1]-mt.overflows[1])[0])==null?void 0:ee.placement;if(!st)switch(p){case"bestFit":{var ie;const pt=(ie=ut.map(mt=>[mt.placement,mt.overflows.filter(xt=>xt>0).reduce((xt,Qi)=>xt+Qi,0)]).sort((mt,xt)=>mt[1]-xt[1])[0])==null?void 0:ie[0];pt&&(st=pt);break}case"initialPlacement":st=l;break}if(s!==st)return{reset:{placement:st}}}return{}}}};async function Ns(i,t){const{placement:e,platform:o,elements:s}=i,n=await(o.isRTL==null?void 0:o.isRTL(s.floating)),r=It(e),l=Zt(e),c=me(e)==="y",d=["left","top"].includes(r)?-1:1,h=n&&c?-1:1,u=Xt(t,i);let{mainAxis:m,crossAxis:p,alignmentAxis:f}=typeof u=="number"?{mainAxis:u,crossAxis:0,alignmentAxis:null}:{mainAxis:0,crossAxis:0,alignmentAxis:null,...u};return l&&typeof f=="number"&&(p=l==="end"?f*-1:f),c?{x:p*h,y:m*d}:{x:m*d,y:p*h}}const Us=function(i){return i===void 0&&(i=0),{name:"offset",options:i,async fn(t){var e,o;const{x:s,y:n,placement:r,middlewareData:l}=t,c=await Ns(t,i);return r===((e=l.offset)==null?void 0:e.placement)&&(o=l.arrow)!=null&&o.alignmentOffset?{}:{x:s+c.x,y:n+c.y,data:{...c,placement:r}}}}},Hs=function(i){return i===void 0&&(i={}),{name:"shift",options:i,async fn(t){const{x:e,y:o,placement:s}=t,{mainAxis:n=!0,crossAxis:r=!1,limiter:l={fn:z=>{let{x:_,y:$}=z;return{x:_,y:$}}},...c}=Xt(i,t),d={x:e,y:o},h=await ti(t,c),u=me(It(s)),m=Pi(u);let p=d[m],f=d[u];if(n){const z=m==="y"?"top":"left",_=m==="y"?"bottom":"right",$=p+h[z],D=p-h[_];p=qe($,p,D)}if(r){const z=u==="y"?"top":"left",_=u==="y"?"bottom":"right",$=f+h[z],D=f-h[_];f=qe($,f,D)}const b=l.fn({...t,[m]:p,[u]:f});return{...b,data:{x:b.x-e,y:b.y-o}}}}},qs=function(i){return i===void 0&&(i={}),{name:"size",options:i,async fn(t){const{placement:e,rects:o,platform:s,elements:n}=t,{apply:r=()=>{},...l}=Xt(i,t),c=await ti(t,l),d=It(e),h=Zt(e),u=me(e)==="y",{width:m,height:p}=o.floating;let f,b;d==="top"||d==="bottom"?(f=d,b=h===(await(s.isRTL==null?void 0:s.isRTL(n.floating))?"start":"end")?"left":"right"):(b=d,f=h==="end"?"top":"bottom");const z=p-c[f],_=m-c[b],$=!t.middlewareData.shift;let D=z,U=_;if(u){const H=m-c.left-c.right;U=h||$?Pt(_,H):H}else{const H=p-c.top-c.bottom;D=h||$?Pt(z,H):H}if($&&!h){const H=ot(c.left,0),it=ot(c.right,0),ut=ot(c.top,0),Tt=ot(c.bottom,0);u?U=m-2*(H!==0||it!==0?H+it:ot(c.left,c.right)):D=p-2*(ut!==0||Tt!==0?ut+Tt:ot(c.top,c.bottom))}await r({...t,availableWidth:U,availableHeight:D});const B=await s.getDimensions(n.floating);return m!==B.width||p!==B.height?{reset:{rects:!0}}:{}}}};function Mt(i){return Ii(i)?(i.nodeName||"").toLowerCase():"#document"}function rt(i){var t;return(i==null||(t=i.ownerDocument)==null?void 0:t.defaultView)||window}function $t(i){var t;return(t=(Ii(i)?i.ownerDocument:i.document)||window.document)==null?void 0:t.documentElement}function Ii(i){return i instanceof Node||i instanceof rt(i).Node}function Ct(i){return i instanceof Element||i instanceof rt(i).Element}function bt(i){return i instanceof HTMLElement||i instanceof rt(i).HTMLElement}function ci(i){return typeof ShadowRoot>"u"?!1:i instanceof ShadowRoot||i instanceof rt(i).ShadowRoot}function fe(i){const{overflow:t,overflowX:e,overflowY:o,display:s}=ct(i);return/auto|scroll|overlay|hidden|clip/.test(t+o+e)&&!["inline","contents"].includes(s)}function js(i){return["table","td","th"].includes(Mt(i))}function ei(i){const t=ii(),e=ct(i);return e.transform!=="none"||e.perspective!=="none"||(e.containerType?e.containerType!=="normal":!1)||!t&&(e.backdropFilter?e.backdropFilter!=="none":!1)||!t&&(e.filter?e.filter!=="none":!1)||["transform","perspective","filter"].some(o=>(e.willChange||"").includes(o))||["paint","layout","strict","content"].some(o=>(e.contain||"").includes(o))}function Ws(i){let t=Gt(i);for(;bt(t)&&!Pe(t);){if(ei(t))return t;t=Gt(t)}return null}function ii(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}function Pe(i){return["html","body","#document"].includes(Mt(i))}function ct(i){return rt(i).getComputedStyle(i)}function Le(i){return Ct(i)?{scrollLeft:i.scrollLeft,scrollTop:i.scrollTop}:{scrollLeft:i.pageXOffset,scrollTop:i.pageYOffset}}function Gt(i){if(Mt(i)==="html")return i;const t=i.assignedSlot||i.parentNode||ci(i)&&i.host||$t(i);return ci(t)?t.host:t}function Mi(i){const t=Gt(i);return Pe(t)?i.ownerDocument?i.ownerDocument.body:i.body:bt(t)&&fe(t)?t:Mi(t)}function he(i,t,e){var o;t===void 0&&(t=[]),e===void 0&&(e=!0);const s=Mi(i),n=s===((o=i.ownerDocument)==null?void 0:o.body),r=rt(s);return n?t.concat(r,r.visualViewport||[],fe(s)?s:[],r.frameElement&&e?he(r.frameElement):[]):t.concat(s,he(s,[],e))}function Ri(i){const t=ct(i);let e=parseFloat(t.width)||0,o=parseFloat(t.height)||0;const s=bt(i),n=s?i.offsetWidth:e,r=s?i.offsetHeight:o,l=Se(e)!==n||Se(o)!==r;return l&&(e=n,o=r),{width:e,height:o,$:l}}function si(i){return Ct(i)?i:i.contextElement}function Kt(i){const t=si(i);if(!bt(t))return Lt(1);const e=t.getBoundingClientRect(),{width:o,height:s,$:n}=Ri(t);let r=(n?Se(e.width):e.width)/o,l=(n?Se(e.height):e.height)/s;return(!r||!Number.isFinite(r))&&(r=1),(!l||!Number.isFinite(l))&&(l=1),{x:r,y:l}}const Ks=Lt(0);function Fi(i){const t=rt(i);return!ii()||!t.visualViewport?Ks:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function Ys(i,t,e){return t===void 0&&(t=!1),!e||t&&e!==rt(i)?!1:t}function Ht(i,t,e,o){t===void 0&&(t=!1),e===void 0&&(e=!1);const s=i.getBoundingClientRect(),n=si(i);let r=Lt(1);t&&(o?Ct(o)&&(r=Kt(o)):r=Kt(i));const l=Ys(n,e,o)?Fi(n):Lt(0);let c=(s.left+l.x)/r.x,d=(s.top+l.y)/r.y,h=s.width/r.x,u=s.height/r.y;if(n){const m=rt(n),p=o&&Ct(o)?rt(o):o;let f=m,b=f.frameElement;for(;b&&o&&p!==f;){const z=Kt(b),_=b.getBoundingClientRect(),$=ct(b),D=_.left+(b.clientLeft+parseFloat($.paddingLeft))*z.x,U=_.top+(b.clientTop+parseFloat($.paddingTop))*z.y;c*=z.x,d*=z.y,h*=z.x,u*=z.y,c+=D,d+=U,f=rt(b),b=f.frameElement}}return Oe({width:h,height:u,x:c,y:d})}const Gs=[":popover-open",":modal"];function Vi(i){return Gs.some(t=>{try{return i.matches(t)}catch{return!1}})}function Xs(i){let{elements:t,rect:e,offsetParent:o,strategy:s}=i;const n=s==="fixed",r=$t(o),l=t?Vi(t.floating):!1;if(o===r||l&&n)return e;let c={scrollLeft:0,scrollTop:0},d=Lt(1);const h=Lt(0),u=bt(o);if((u||!u&&!n)&&((Mt(o)!=="body"||fe(r))&&(c=Le(o)),bt(o))){const m=Ht(o);d=Kt(o),h.x=m.x+o.clientLeft,h.y=m.y+o.clientTop}return{width:e.width*d.x,height:e.height*d.y,x:e.x*d.x-c.scrollLeft*d.x+h.x,y:e.y*d.y-c.scrollTop*d.y+h.y}}function Zs(i){return Array.from(i.getClientRects())}function Bi(i){return Ht($t(i)).left+Le(i).scrollLeft}function Qs(i){const t=$t(i),e=Le(i),o=i.ownerDocument.body,s=ot(t.scrollWidth,t.clientWidth,o.scrollWidth,o.clientWidth),n=ot(t.scrollHeight,t.clientHeight,o.scrollHeight,o.clientHeight);let r=-e.scrollLeft+Bi(i);const l=-e.scrollTop;return ct(o).direction==="rtl"&&(r+=ot(t.clientWidth,o.clientWidth)-s),{width:s,height:n,x:r,y:l}}function Js(i,t){const e=rt(i),o=$t(i),s=e.visualViewport;let n=o.clientWidth,r=o.clientHeight,l=0,c=0;if(s){n=s.width,r=s.height;const d=ii();(!d||d&&t==="fixed")&&(l=s.offsetLeft,c=s.offsetTop)}return{width:n,height:r,x:l,y:c}}function to(i,t){const e=Ht(i,!0,t==="fixed"),o=e.top+i.clientTop,s=e.left+i.clientLeft,n=bt(i)?Kt(i):Lt(1),r=i.clientWidth*n.x,l=i.clientHeight*n.y,c=s*n.x,d=o*n.y;return{width:r,height:l,x:c,y:d}}function di(i,t,e){let o;if(t==="viewport")o=Js(i,e);else if(t==="document")o=Qs($t(i));else if(Ct(t))o=to(t,e);else{const s=Fi(i);o={...t,x:t.x-s.x,y:t.y-s.y}}return Oe(o)}function Ni(i,t){const e=Gt(i);return e===t||!Ct(e)||Pe(e)?!1:ct(e).position==="fixed"||Ni(e,t)}function eo(i,t){const e=t.get(i);if(e)return e;let o=he(i,[],!1).filter(l=>Ct(l)&&Mt(l)!=="body"),s=null;const n=ct(i).position==="fixed";let r=n?Gt(i):i;for(;Ct(r)&&!Pe(r);){const l=ct(r),c=ei(r);!c&&l.position==="fixed"&&(s=null),(n?!c&&!s:!c&&l.position==="static"&&!!s&&["absolute","fixed"].includes(s.position)||fe(r)&&!c&&Ni(i,r))?o=o.filter(h=>h!==r):s=l,r=Gt(r)}return t.set(i,o),o}function io(i){let{element:t,boundary:e,rootBoundary:o,strategy:s}=i;const r=[...e==="clippingAncestors"?eo(t,this._c):[].concat(e),o],l=r[0],c=r.reduce((d,h)=>{const u=di(t,h,s);return d.top=ot(u.top,d.top),d.right=Pt(u.right,d.right),d.bottom=Pt(u.bottom,d.bottom),d.left=ot(u.left,d.left),d},di(t,l,s));return{width:c.right-c.left,height:c.bottom-c.top,x:c.left,y:c.top}}function so(i){const{width:t,height:e}=Ri(i);return{width:t,height:e}}function oo(i,t,e){const o=bt(t),s=$t(t),n=e==="fixed",r=Ht(i,!0,n,t);let l={scrollLeft:0,scrollTop:0};const c=Lt(0);if(o||!o&&!n)if((Mt(t)!=="body"||fe(s))&&(l=Le(t)),o){const u=Ht(t,!0,n,t);c.x=u.x+t.clientLeft,c.y=u.y+t.clientTop}else s&&(c.x=Bi(s));const d=r.left+l.scrollLeft-c.x,h=r.top+l.scrollTop-c.y;return{x:d,y:h,width:r.width,height:r.height}}function hi(i,t){return!bt(i)||ct(i).position==="fixed"?null:t?t(i):i.offsetParent}function Ui(i,t){const e=rt(i);if(!bt(i)||Vi(i))return e;let o=hi(i,t);for(;o&&js(o)&&ct(o).position==="static";)o=hi(o,t);return o&&(Mt(o)==="html"||Mt(o)==="body"&&ct(o).position==="static"&&!ei(o))?e:o||Ws(i)||e}const no=async function(i){const t=this.getOffsetParent||Ui,e=this.getDimensions;return{reference:oo(i.reference,await t(i.floating),i.strategy),floating:{x:0,y:0,...await e(i.floating)}}};function ro(i){return ct(i).direction==="rtl"}const Ce={convertOffsetParentRelativeRectToViewportRelativeRect:Xs,getDocumentElement:$t,getClippingRect:io,getOffsetParent:Ui,getElementRects:no,getClientRects:Zs,getDimensions:so,getScale:Kt,isElement:Ct,isRTL:ro};function ao(i,t){let e=null,o;const s=$t(i);function n(){var l;clearTimeout(o),(l=e)==null||l.disconnect(),e=null}function r(l,c){l===void 0&&(l=!1),c===void 0&&(c=1),n();const{left:d,top:h,width:u,height:m}=i.getBoundingClientRect();if(l||t(),!u||!m)return;const p=xe(h),f=xe(s.clientWidth-(d+u)),b=xe(s.clientHeight-(h+m)),z=xe(d),$={rootMargin:-p+"px "+-f+"px "+-b+"px "+-z+"px",threshold:ot(0,Pt(1,c))||1};let D=!0;function U(B){const H=B[0].intersectionRatio;if(H!==c){if(!D)return r();H?r(!1,H):o=setTimeout(()=>{r(!1,1e-7)},100)}D=!1}try{e=new IntersectionObserver(U,{...$,root:s.ownerDocument})}catch{e=new IntersectionObserver(U,$)}e.observe(i)}return r(!0),n}function lo(i,t,e,o){o={};const{ancestorScroll:s=!0,ancestorResize:n=!0,elementResize:r=typeof ResizeObserver=="function",layoutShift:l=typeof IntersectionObserver=="function",animationFrame:c=!1}=o,d=si(i),h=s||n?[...d?he(d):[],...he(t)]:[];h.forEach(_=>{s&&_.addEventListener("scroll",e,{passive:!0}),n&&_.addEventListener("resize",e)});const u=d&&l?ao(d,e):null;let m=-1,p=null;r&&(p=new ResizeObserver(_=>{let[$]=_;$&&$.target===d&&p&&(p.unobserve(t),cancelAnimationFrame(m),m=requestAnimationFrame(()=>{var D;(D=p)==null||D.observe(t)})),e()}),d&&!c&&p.observe(d),p.observe(t));let f,b=c?Ht(i):null;c&&z();function z(){const _=Ht(i);b&&(_.x!==b.x||_.y!==b.y||_.width!==b.width||_.height!==b.height)&&e(),b=_,f=requestAnimationFrame(z)}return e(),()=>{var _;h.forEach($=>{s&&$.removeEventListener("scroll",e),n&&$.removeEventListener("resize",e)}),u?.(),(_=p)==null||_.disconnect(),p=null,c&&cancelAnimationFrame(f)}}const co=Hs,ho=Bs,ui=qs,uo=Vs,po=(i,t,e)=>{const o=new Map,s={platform:Ce,...e},n={...s.platform,_c:o};return Fs(i,t,{...s,platform:n})};function mo(i){return fo(i)}function Ne(i){return i.assignedSlot?i.assignedSlot:i.parentNode instanceof ShadowRoot?i.parentNode.host:i.parentNode}function fo(i){for(let t=i;t;t=Ne(t))if(t instanceof Element&&getComputedStyle(t).display==="none")return null;for(let t=Ne(i);t;t=Ne(t)){if(!(t instanceof Element))continue;const e=getComputedStyle(t);if(e.display!=="contents"&&(e.position!=="static"||e.filter!=="none"||t.tagName==="BODY"))return t}return null}const yo=y`
	/* stylelint-disable */
  :host {
...
`;var bo=Object.defineProperty,F=(i,t,e,o)=>{for(var s=void 0,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=r(t,e,s)||s);return s&&bo(t,e,s),s};function go(i){return i!==null&&typeof i=="object"&&"getBoundingClientRect"in i&&("contextElement"in i?i instanceof Element:!0)}class L extends P{constructor(){super(...arguments),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){const t=this.anchorEl.getBoundingClientRect(),e=this.popup.getBoundingClientRect(),o=this.placement.includes("top")||this.placement.includes("bottom");let s=0,n=0,r=0,l=0,c=0,d=0,h=0,u=0;o?t.top<e.top?(s=t.left,n=t.bottom,r=t.right,l=t.bottom,c=e.left,d=e.top,h=e.right,u=e.top):(s=e.left,n=e.bottom,r=e.right,l=e.bottom,c=t.left,d=t.top,h=t.right,u=t.top):t.left<e.left?(s=t.right,n=t.top,r=e.left,l=e.top,c=t.right,d=t.bottom,h=e.left,u=e.bottom):(s=e.right,n=e.top,r=t.left,l=t.top,c=e.right,d=e.bottom,h=t.left,u=t.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${s}px`),this.style.setProperty("--hover-bridge-top-left-y",`${n}px`),this.style.setProperty("--hover-bridge-top-right-x",`${r}px`),this.style.setProperty("--hover-bridge-top-right-y",`${l}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${c}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${d}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${h}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${u}px`)}}}static{this.styles=[M,yo]}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(t){super.updated(t),t.has("active")&&(this.active?this.start():this.stop()),t.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){const t=this.getRootNode();this.anchorEl=t.getElementById(this.anchor)}else this.anchor instanceof Element||go(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.start()}start(){this.anchorEl&&(this.cleanup=lo(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(t=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>t())):t()})}reposition(){if(!this.active||!this.anchorEl)return;const t=[Us({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?t.push(ui({apply:({rects:o})=>{const s=this.sync==="width"||this.sync==="both",n=this.sync==="height"||this.sync==="both";this.popup.style.width=s?`${o.reference.width}px`:"",this.popup.style.height=n?`${o.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&t.push(ho({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&t.push(co({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?t.push(ui({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:o,availableHeight:s})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${s}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${o}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&t.push(uo({element:this.arrowEl,padding:this.arrowPadding}));const e=this.strategy==="absolute"?o=>Ce.getOffsetParent(o,mo):Ce.getOffsetParent;po(this.anchorEl,this.popup,{placement:this.placement,middleware:t,strategy:this.strategy,platform:{...Ce,getOffsetParent:e}}).then(({x:o,y:s,middlewareData:n,placement:r})=>{const l=getComputedStyle(this).direction==="rtl",c={top:"bottom",right:"left",bottom:"top",left:"right"}[r.split("-")[0]];if(this.setAttribute("data-current-placement",r),Object.assign(this.popup.style,{left:`${o}px`,top:`${s}px`}),this.arrow){const d=n.arrow.x,h=n.arrow.y;let u="",m="",p="",f="";if(this.arrowPlacement==="start"){const b=typeof d=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";u=typeof h=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",m=l?b:"",f=l?"":b}else if(this.arrowPlacement==="end"){const b=typeof d=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";m=l?"":b,f=l?b:"",p=typeof h=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else this.arrowPlacement==="center"?(f=typeof d=="number"?"calc(50% - var(--arrow-size-diagonal))":"",u=typeof h=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(f=typeof d=="number"?`${d}px`:"",u=typeof h=="number"?`${h}px`:"");Object.assign(this.arrowEl.style,{top:u,right:m,bottom:p,left:f,[c]:"calc(var(--arrow-size-diagonal) * -1)"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("syn-reposition")}render(){return g`
      ...
      <div
        part="popup"
        class=${S({popup:!0,"popup--active":this.active,"popup--fixed":this.strategy==="fixed","popup--has-arrow":this.arrow})}
      >
        <slot></slot>
        ${this.arrow?g`<div part="arrow" class="popup__arrow" role="presentation"></div>`:""}
      </div>
    `}}F([w(".popup")],L.prototype,"popup");F([w(".popup__arrow")],L.prototype,"arrowEl");F([a()],L.prototype,"anchor");F([a({type:Boolean,reflect:!0})],L.prototype,"active");F([a({reflect:!0})],L.prototype,"placement");F([a({reflect:!0})],L.prototype,"strategy");F([a({type:Number})],L.prototype,"distance");F([a({type:Number})],L.prototype,"skidding");F([a({type:Boolean})],L.prototype,"arrow");F([a({attribute:"arrow-placement"})],L.prototype,"arrowPlacement");F([a({attribute:"arrow-padding",type:Number})],L.prototype,"arrowPadding");F([a({type:Boolean})],L.prototype,"flip");F([a({attribute:"flip-fallback-placements",converter:{fromAttribute:i=>i.split(" ").map(t=>t.trim()).filter(t=>t!==""),toAttribute:i=>i.join(" ")}})],L.prototype,"flipFallbackPlacements");F([a({attribute:"flip-fallback-strategy"})],L.prototype,"flipFallbackStrategy");F([a({type:Object})],L.prototype,"flipBoundary");F([a({attribute:"flip-padding",type:Number})],L.prototype,"flipPadding");F([a({type:Boolean})],L.prototype,"shift");F([a({type:Object})],L.prototype,"shiftBoundary");F([a({attribute:"shift-padding",type:Number})],L.prototype,"shiftPadding");F([a({attribute:"auto-size"})],L.prototype,"autoSize");F([a()],L.prototype,"sync");F([a({type:Object})],L.prototype,"autoSizeBoundary");F([a({attribute:"auto-size-padding",type:Number})],L.prototype,"autoSizePadding");F([a({attribute:"hover-bridge",type:Boolean})],L.prototype,"hoverBridge");const vo=y`
	/* stylelint-disable */
  :host {
    --submenu-offset: -2px;
...
`;var wo=Object.defineProperty,xo=Object.getOwnPropertyDescriptor,gt=(i,t,e,o)=>{for(var s=o>1?void 0:o?xo(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=(o?r(t,e,s):r(s))||s);return o&&s&&wo(t,e,s),s};class ht extends P{constructor(){super(...arguments),this.type="normal",this.checked=!1,this.value="",this.loading=!1,this.disabled=!1,this.localize=new Z(this),this.hasSlotController=new Q(this,"submenu"),this.submenuController=new As(this,this.hasSlotController,this.localize),this.handleHostClick=t=>{this.disabled&&(t.preventDefault(),t.stopImmediatePropagation())},this.handleMouseOver=t=>{this.focus(),t.stopPropagation()}}static{this.styles=[M,vo,_o]}static{this.dependencies={"syn-icon":zt,"syn-popup":L,"syn-spinner":Ei}}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this.handleHostClick),this.addEventListener("mouseover",this.handleMouseOver)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.handleHostClick),this.removeEventListener("mouseover",this.handleMouseOver)}handleDefaultSlotChange(){const t=this.getTextLabel();if(typeof this.cachedTextLabel>"u"){this.cachedTextLabel=t;return}t!==this.cachedTextLabel&&(this.cachedTextLabel=t,this.emit("slotchange",{bubbles:!0,composed:!1,cancelable:!1}))}handleCheckedChange(){if(this.checked&&this.type!=="checkbox"){this.checked=!1,console.error('The checked attribute can only be used on menu items with type="checkbox"',this);return}this.type==="checkbox"?this.setAttribute("aria-checked",this.checked?"true":"false"):this.removeAttribute("aria-checked")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleTypeChange(){this.type==="checkbox"?(this.setAttribute("role","menuitemcheckbox"),this.setAttribute("aria-checked",this.checked?"true":"false")):(this.setAttribute("role","menuitem"),this.removeAttribute("aria-checked"))}getTextLabel(){return ls(this.defaultSlot)}isSubmenu(){return this.hasSlotController.test("submenu")}render(){const t=this.localize.dir()==="rtl",e=this.submenuController.isExpanded();return g`
      <div
        id="anchor"
        part="base"
        class=${S({"menu-item":!0,"menu-item--rtl":t,"menu-item--checked":this.checked,"menu-item--disabled":this.disabled,"menu-item--loading":this.loading,"menu-item--has-submenu":this.isSubmenu(),"menu-item--submenu-expanded":e})}
    ...
    `}}gt([w("slot:not([name])")],ht.prototype,"defaultSlot",2);gt([w(".menu-item")],ht.prototype,"menuItem",2);gt([a()],ht.prototype,"type",2);gt([a({type:Boolean,reflect:!0})],ht.prototype,"checked",2);gt([a()],ht.prototype,"value",2);gt([a({type:Boolean,reflect:!0})],ht.prototype,"loading",2);gt([a({type:Boolean,reflect:!0})],ht.prototype,"disabled",2);gt([k("checked")],ht.prototype,"handleCheckedChange",1);gt([k("disabled")],ht.prototype,"handleDisabledChange",1);gt([k("type")],ht.prototype,"handleTypeChange",1);ht.define("syn-menu-item");L.define("syn-popup");const{useParameter:ko,addons:Co,useEffect:zo,useMemo:$r}=__STORYBOOK_MODULE_PREVIEW_API__;var $o=Object.defineProperty,So=(i,t)=>{for(var e in t)$o(i,e,{get:t[e],enumerable:!0})},Eo={};So(Eo,{initializeThemeState:()=>Wi,pluckThemeFromContext:()=>qi,useThemeParameters:()=>ji});var Hi="themes",Oo=`storybook/${Hi}`,Ao="theme",To={},Do={REGISTER_THEMES:`${Oo}/REGISTER_THEMES`};function qi({globals:i}){return i[Ao]||""}function ji(){return ko(Hi,To)}function Wi(i,t){Co.getChannel().emit(Do.REGISTER_THEMES,{defaultTheme:t,themes:i})}var Po="html",pi=i=>i.split(" ").filter(Boolean),Lo=({themes:i,defaultTheme:t,parentSelector:e=Po})=>(Wi(Object.keys(i),t),(o,s)=>{let{themeOverride:n}=ji(),r=qi(s);return zo(()=>{let l=n||r||t,c=document.querySelector(e);if(!c)return;Object.entries(i).filter(([h])=>h!==l).forEach(([h,u])=>{let m=pi(u);m.length>0&&c.classList.remove(...m)});let d=pi(i[l]);d.length>0&&c.classList.add(...d)},[n,r,e]),o()});const Io=y`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
`;var Mo=Object.defineProperty,oi=(i,t,e,o)=>{for(var s=void 0,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=r(t,e,s)||s);return s&&Mo(t,e,s),s};class ye extends P{constructor(){super(...arguments),this.disableRole=!1,this.label=""}static{this.styles=[M,Io]}handleFocus(t){ae(t.target)?.toggleAttribute("data-syn-button-group__button--focus",!0)}handleBlur(t){ae(t.target)?.toggleAttribute("data-syn-button-group__button--focus",!1)}handleMouseOver(t){ae(t.target)?.toggleAttribute("data-syn-button-group__button--hover",!0)}handleMouseOut(t){ae(t.target)?.toggleAttribute("data-syn-button-group__button--hover",!1)}handleSlotChange(){const t=[...this.defaultSlot.assignedElements({flatten:!0})];t.forEach(e=>{const o=t.indexOf(e),s=ae(e);s&&(s.toggleAttribute("data-syn-button-group__button",!0),s.toggleAttribute("data-syn-button-group__button--first",o===0),s.toggleAttribute("data-syn-button-group__button--inner",o>0&&o<t.length-1),s.toggleAttribute("data-syn-button-group__button--last",o===t.length-1),s.toggleAttribute("data-syn-button-group__button--radio",s.tagName.toLowerCase()==="syn-radio-button"))})}render(){return g`
      <div
        part="base"
        class="button-group"
    ...
    `}}oi([w("slot")],ye.prototype,"defaultSlot");oi([E()],ye.prototype,"disableRole");oi([a()],ye.prototype,"label");function ae(i){const t="syn-button, syn-radio-button";return i.closest(t)??i.querySelector(t)}ye.define("syn-button-group");const be=(i="value")=>(t,e)=>{const o=t.constructor,s=o.prototype.attributeChangedCallback;o.prototype.attributeChangedCallback=function(n,r,l){const c=o.getPropertyOptions(i),d=typeof c.attribute=="string"?c.attribute:i;if(n===d){const h=c.converter||ai,m=(typeof h=="function"?h:h?.fromAttribute??ai.fromAttribute)(l,c.type);this[i]!==m&&(this[e]=m)}s.call(this,n,r,l)}};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ue=pe(class extends Te{constructor(i){if(super(i),i.type!==ft.PROPERTY&&i.type!==ft.ATTRIBUTE&&i.type!==ft.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!wi(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[t]){if(t===Ut||t===Yt)return t;const e=i.element,o=i.name;if(i.type===ft.PROPERTY){if(t===e[o])return Ut}else if(i.type===ft.BOOLEAN_ATTRIBUTE){if(!!t===e.hasAttribute(o))return Ut}else if(i.type===ft.ATTRIBUTE&&e.getAttribute(o)===t+"")return Ut;return Ji(i),t}}),Qt=y`
	/* stylelint-disable */
...
`;var Vo=Object.defineProperty,Bo=Object.getOwnPropertyDescriptor,K=(i,t,e,o)=>{for(var s=o>1?void 0:o?Bo(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=(o?r(t,e,s):r(s))||s);return o&&s&&Vo(t,e,s),s};class j extends P{constructor(){super(...arguments),this.formControlController=new qt(this,{value:t=>t.checked?t.value||"on":void 0,defaultValue:t=>t.defaultChecked,setValue:(t,e)=>t.checked=e}),this.hasSlotController=new Q(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.indeterminate=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}static{this.styles=[M,Qt,Ro,Jt,Fo]}static{this.dependencies={"syn-icon":zt}}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleClick(){this.checked=!this.checked,this.indeterminate=!1,this.emit("syn-change")}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleInput(){this.emit("syn-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStateChange(){this.input.checked=this.checked,this.input.indeterminate=this.indeterminate,this.formControlController.updateValidity()}click(){this.input.click()}focus(t){this.input.focus(t)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("help-text"),e=this.helpText?!0:!!t;return g`
      <div
        class=${S({"form-control":!0,"form-control--small":this.size==="small","form-control--medium":this.size==="medium","form-control--large":this.size==="large","form-control--has-help-text":e})}
      >
        <label
          part="base"
    ...
    `}}K([w('input[type="checkbox"]')],j.prototype,"input",2);K([E()],j.prototype,"hasFocus",2);K([a()],j.prototype,"title",2);K([a()],j.prototype,"name",2);K([a()],j.prototype,"value",2);K([a({reflect:!0})],j.prototype,"size",2);K([a({type:Boolean,reflect:!0})],j.prototype,"disabled",2);K([a({type:Boolean,reflect:!0})],j.prototype,"checked",2);K([a({type:Boolean,reflect:!0})],j.prototype,"indeterminate",2);K([be("checked")],j.prototype,"defaultChecked",2);K([a({reflect:!0})],j.prototype,"form",2);K([a({type:Boolean,reflect:!0})],j.prototype,"required",2);K([a({attribute:"help-text"})],j.prototype,"helpText",2);K([k("disabled",{waitUntilFirstUpdate:!0})],j.prototype,"handleDisabledChange",1);K([k(["checked","indeterminate"],{waitUntilFirstUpdate:!0})],j.prototype,"handleStateChange",1);j.define("syn-checkbox");Rt.define("syn-divider");function kt(i,t,e){return new Promise(o=>{if(e?.duration===1/0)throw new Error("Promise-based animations must be finite.");const s=i.animate(t,{...e,duration:No()?0:e.duration});s.addEventListener("cancel",o,{once:!0}),s.addEventListener("finish",o,{once:!0})})}function No(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Dt(i){return Promise.all(i.getAnimations().map(t=>new Promise(e=>{t.cancel(),requestAnimationFrame(e)})))}const Ki=new Map,We=new WeakMap;function Yi(i){return i??{keyframes:[],options:{duration:0}}}function mi(i,t){return t.toLowerCase()==="rtl"?{keyframes:i.rtlKeyframes||i.keyframes,options:i.options}:i}function N(i,t){Ki.set(i,Yi(t))}function ke(i,t,e){We.set(i,{...We.get(i),[t]:Yi(e)})}function nt(i,t,e){const o=We.get(i);if(o?.[t])return mi(o[t],e.dir);const s=Ki.get(t);return s?mi(s,e.dir):{keyframes:[],options:{duration:0}}}function Uo(i,t){return{top:Math.round(i.getBoundingClientRect().top-t.getBoundingClientRect().top),left:Math.round(i.getBoundingClientRect().left-t.getBoundingClientRect().left)}}const Ke=new Set;function Ho(){const i=document.documentElement.clientWidth;return Math.abs(window.innerWidth-i)}function qo(){const i=Number(getComputedStyle(document.body).paddingRight.replace(/px/,""));return isNaN(i)||!i?0:i}function Ue(i){if(Ke.add(i),!document.documentElement.classList.contains("syn-scroll-lock")){const t=Ho()+qo();document.documentElement.classList.add("syn-scroll-lock"),document.documentElement.style.setProperty("--syn-scroll-lock-size",`${t}px`)}}function ze(i){Ke.delete(i),Ke.size===0&&(document.documentElement.classList.remove("syn-scroll-lock"),document.documentElement.style.removeProperty("--syn-scroll-lock-size"))}function jo(i,t,e="vertical",o="smooth"){const s=Uo(i,t),n=s.top+t.scrollTop,r=s.left+t.scrollLeft,l=t.scrollLeft,c=t.scrollLeft+t.offsetWidth,d=t.scrollTop,h=t.scrollTop+t.offsetHeight;(e==="horizontal"||e==="both")&&(r<l?t.scrollTo({left:r,behavior:o}):r+i.clientWidth>c&&t.scrollTo({left:r-t.offsetWidth+i.clientWidth,behavior:o})),(e==="vertical"||e==="both")&&(n<d?t.scrollTo({top:n,behavior:o}):n+i.clientHeight>h&&t.scrollTo({top:n-t.offsetHeight+i.clientHeight,behavior:o}))}function fi(i){return i.charAt(0).toUpperCase()+i.slice(1)}function yt(i,t){return new Promise(e=>{function o(s){s.target===i&&(i.removeEventListener(t,o),e())}i.addEventListener(t,o)})}function*ni(i=document.activeElement){i!=null&&(yield i,"shadowRoot"in i&&i.shadowRoot&&i.shadowRoot.mode!=="closed"&&(yield*ni(i.shadowRoot.activeElement)))}function Wo(){return[...ni()].pop()}const yi=new WeakMap;function Gi(i){let t=yi.get(i);return t||(t=window.getComputedStyle(i,null),yi.set(i,t)),t}function Ko(i){if(typeof i.checkVisibility=="function")return i.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});const t=Gi(i);return t.visibility!=="hidden"&&t.display!=="none"}function Yo(i){const t=Gi(i),{overflowY:e,overflowX:o}=t;return e==="scroll"||o==="scroll"?!0:e!=="auto"||o!=="auto"?!1:i.scrollHeight>i.clientHeight&&e==="auto"||i.scrollWidth>i.clientWidth&&o==="auto"}function Go(i){const t=i.tagName.toLowerCase(),e=Number(i.getAttribute("tabindex"));return i.hasAttribute("tabindex")&&(isNaN(e)||e<=-1)||i.hasAttribute("disabled")||i.closest("[inert]")||t==="input"&&i.getAttribute("type")==="radio"&&!i.hasAttribute("checked")||!Ko(i)?!1:(t==="audio"||t==="video")&&i.hasAttribute("controls")||i.hasAttribute("tabindex")||i.hasAttribute("contenteditable")&&i.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(t)?!0:Yo(i)}function Xo(i){const t=Ye(i),e=t[0]??null,o=t[t.length-1]??null;return{start:e,end:o}}function Zo(i,t){return i.getRootNode({composed:!0})?.host!==t}function Ye(i){const t=new WeakMap,e=[];function o(s){if(s instanceof Element){if(s.hasAttribute("inert")||s.closest("[inert]")||t.has(s))return;t.set(s,!0),!e.includes(s)&&Go(s)&&e.push(s),s instanceof HTMLSlotElement&&Zo(s,i)&&s.assignedElements({flatten:!0}).forEach(n=>{o(n)}),s.shadowRoot!==null&&s.shadowRoot.mode==="open"&&o(s.shadowRoot)}for(const n of s.children)o(n)}return o(i),e.sort((s,n)=>{const r=Number(s.getAttribute("tabindex"))||0;return(Number(n.getAttribute("tabindex"))||0)-r})}let le=[];class Qo{constructor(t){this.tabDirection="forward",this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=e=>{if(e.key!=="Tab"||this.isExternalActivated||!this.isActive())return;const o=Wo();if(this.previousFocus=o,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;e.shiftKey?this.tabDirection="backward":this.tabDirection="forward";const s=Ye(this.element);let n=s.findIndex(l=>l===o);this.previousFocus=this.currentFocus;const r=this.tabDirection==="forward"?1:-1;for(;;){n+r>=s.length?n=0:n+r<0?n=s.length-1:n+=r,this.previousFocus=this.currentFocus;const l=s[n];if(this.tabDirection==="backward"&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||l&&this.possiblyHasTabbableChildren(l))return;e.preventDefault(),this.currentFocus=l,this.currentFocus?.focus({preventScroll:!1});const c=[...ni()];if(c.includes(this.currentFocus)||!c.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=t,this.elementsWithTabbableControls=["iframe"]}activate(){le.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){le=le.filter(t=>t!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return le[le.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){const t=Ye(this.element);if(!this.element.matches(":focus-within")){const e=t[0],o=t[t.length-1],s=this.tabDirection==="forward"?e:o;typeof s?.focus=="function"&&(this.currentFocus=s,s.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(t){return this.elementsWithTabbableControls.includes(t.tagName.toLowerCase())||t.hasAttribute("controls")}}const Jo=y`
	/* stylelint-disable */
  :host {
    --size: 25rem;
...
`;var en=Object.defineProperty,sn=Object.getOwnPropertyDescriptor,vt=(i,t,e,o)=>{for(var s=o>1?void 0:o?sn(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=(o?r(t,e,s):r(s))||s);return o&&s&&en(t,e,s),s};class dt extends P{constructor(){super(...arguments),this.hasSlotController=new Q(this,"footer"),this.localize=new Z(this),this.modal=new Qo(this),this.open=!1,this.label="",this.placement="end",this.contained=!1,this.noHeader=!1,this.handleDocumentKeyDown=t=>{this.contained||t.key==="Escape"&&this.modal.isActive()&&this.open&&(t.stopImmediatePropagation(),this.requestClose("keyboard"))}}static{this.styles=[M,Jo,tn]}static{this.dependencies={"syn-icon-button":_i}}firstUpdated(){this.drawer.hidden=!this.open,this.open&&(this.addOpenListeners(),this.contained||(this.modal.activate(),Ue(this)))}disconnectedCallback(){super.disconnectedCallback(),ze(this),this.closeWatcher?.destroy()}requestClose(t){if(this.emit("syn-request-close",{cancelable:!0,detail:{source:t}}).defaultPrevented){const o=nt(this,"drawer.denyClose",{dir:this.localize.dir()});kt(this.panel,o.keyframes,o.options);return}this.hide()}addOpenListeners(){"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.contained||(this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard"))):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){document.removeEventListener("keydown",this.handleDocumentKeyDown),this.closeWatcher?.destroy()}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.contained||(this.modal.activate(),Ue(this));const t=this.querySelector("[autofocus]");t&&t.removeAttribute("autofocus"),await Promise.all([Dt(this.drawer),Dt(this.overlay)]),this.drawer.hidden=!1,requestAnimationFrame(()=>{this.emit("syn-initial-focus",{cancelable:!0}).defaultPrevented||(t?t.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),t&&t.setAttribute("autofocus","")});const e=nt(this,`drawer.show${fi(this.placement)}`,{dir:this.localize.dir()}),o=nt(this,"drawer.overlay.show",{dir:this.localize.dir()});await Promise.all([kt(this.panel,e.keyframes,e.options),kt(this.overlay,o.keyframes,o.options)]),this.emit("syn-after-show")}else{this.emit("syn-hide"),this.removeOpenListeners(),this.contained||(this.modal.deactivate(),ze(this)),await Promise.all([Dt(this.drawer),Dt(this.overlay)]);const t=nt(this,`drawer.hide${fi(this.placement)}`,{dir:this.localize.dir()}),e=nt(this,"drawer.overlay.hide",{dir:this.localize.dir()});await Promise.all([kt(this.overlay,e.keyframes,e.options).then(()=>{this.overlay.hidden=!0}),kt(this.panel,t.keyframes,t.options).then(()=>{this.panel.hidden=!0})]),this.drawer.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1;const o=this.originalTrigger;typeof o?.focus=="function"&&setTimeout(()=>o.focus()),this.emit("syn-after-hide")}}handleNoModalChange(){this.open&&!this.contained&&(this.modal.activate(),Ue(this)),this.open&&this.contained&&(this.modal.deactivate(),ze(this))}async show(){if(!this.open)return this.open=!0,yt(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,yt(this,"syn-after-hide")}render(){return g`
      <div
        part="base"
    ...
    `}}vt([w(".drawer")],dt.prototype,"drawer",2);vt([w(".drawer__panel")],dt.prototype,"panel",2);vt([w(".drawer__overlay")],dt.prototype,"overlay",2);vt([a({type:Boolean,reflect:!0})],dt.prototype,"open",2);vt([a({reflect:!0})],dt.prototype,"label",2);vt([a({reflect:!0})],dt.prototype,"placement",2);vt([a({type:Boolean,reflect:!0})],dt.prototype,"contained",2);vt([a({attribute:"no-header",type:Boolean,reflect:!0})],dt.prototype,"noHeader",2);vt([k("open",{waitUntilFirstUpdate:!0})],dt.prototype,"handleOpenChange",1);vt([k("contained",{waitUntilFirstUpdate:!0})],dt.prototype,"handleNoModalChange",1);N("drawer.showTop",{keyframes:[{opacity:0,translate:"0 -100%"},{opacity:1,translate:"0 0"}],options:{duration:250,easing:"ease"}});N("drawer.hideTop",{keyframes:[{opacity:1,translate:"0 0"},{opacity:0,translate:"0 -100%"}],options:{duration:250,easing:"ease"}});N("drawer.showEnd",{keyframes:[{opacity:0,translate:"100%"},{opacity:1,translate:"0"}],rtlKeyframes:[{opacity:0,translate:"-100%"},{opacity:1,translate:"0"}],options:{duration:250,easing:"ease"}});N("drawer.hideEnd",{keyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"100%"}],rtlKeyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"-100%"}],options:{duration:250,easing:"ease"}});N("drawer.showBottom",{keyframes:[{opacity:0,translate:"0 100%"},{opacity:1,translate:"0 0"}],options:{duration:250,easing:"ease"}});N("drawer.hideBottom",{keyframes:[{opacity:1,translate:"0 0"},{opacity:0,translate:"0 100%"}],options:{duration:250,easing:"ease"}});N("drawer.showStart",{keyframes:[{opacity:0,translate:"-100%"},{opacity:1,translate:"0"}],rtlKeyframes:[{opacity:0,translate:"100%"},{opacity:1,translate:"0"}],options:{duration:250,easing:"ease"}});N("drawer.hideStart",{keyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"-100%"}],rtlKeyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"100%"}],options:{duration:250,easing:"ease"}});N("drawer.denyClose",{keyframes:[{scale:1},{scale:1.01},{scale:1}],options:{duration:250}});N("drawer.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});N("drawer.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});dt.define("syn-drawer");const on=y`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
`,nn=y`
  /* Write custom CSS here */
`;var rn=Object.defineProperty,an=Object.getOwnPropertyDescriptor,at=(i,t,e,o)=>{for(var s=o>1?void 0:o?an(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=(o?r(t,e,s):r(s))||s);return o&&s&&rn(t,e,s),s};class Y extends P{constructor(){super(...arguments),this.localize=new Z(this),this.open=!1,this.placement="bottom-start",this.disabled=!1,this.stayOpenOnSelect=!1,this.distance=0,this.skidding=0,this.hoist=!1,this.sync=void 0,this.handleKeyDown=t=>{this.open&&t.key==="Escape"&&(t.stopPropagation(),this.hide(),this.focusOnTrigger())},this.handleDocumentKeyDown=t=>{if(t.key==="Escape"&&this.open&&!this.closeWatcher){t.stopPropagation(),this.focusOnTrigger(),this.hide();return}if(t.key==="Tab"){if(this.open&&document.activeElement?.tagName.toLowerCase()==="syn-menu-item"){t.preventDefault(),this.hide(),this.focusOnTrigger();return}setTimeout(()=>{const e=this.containingElement?.getRootNode()instanceof ShadowRoot?document.activeElement?.shadowRoot?.activeElement:document.activeElement;(!this.containingElement||e?.closest(this.containingElement.tagName.toLowerCase())!==this.containingElement)&&this.hide()})}},this.handleDocumentMouseDown=t=>{const e=t.composedPath();this.containingElement&&!e.includes(this.containingElement)&&this.hide()},this.handlePanelSelect=t=>{const e=t.target;!this.stayOpenOnSelect&&e.tagName.toLowerCase()==="syn-menu"&&(this.hide(),this.focusOnTrigger())}}static{this.styles=[M,on,nn]}static{this.dependencies={"syn-popup":L}}connectedCallback(){super.connectedCallback(),this.containingElement||(this.containingElement=this)}firstUpdated(){this.panel.hidden=!this.open,this.open&&(this.addOpenListeners(),this.popup.active=!0)}disconnectedCallback(){super.disconnectedCallback(),this.removeOpenListeners(),this.hide()}focusOnTrigger(){const t=this.trigger.assignedElements({flatten:!0})[0];typeof t?.focus=="function"&&t.focus()}getMenu(){return this.panel.assignedElements({flatten:!0}).find(t=>t.tagName.toLowerCase()==="syn-menu")}handleTriggerClick(){this.open?this.hide():(this.show(),this.focusOnTrigger())}async handleTriggerKeyDown(t){if([" ","Enter"].includes(t.key)){t.preventDefault(),this.handleTriggerClick();return}const e=this.getMenu();if(e){const o=e.getAllItems(),s=o[0],n=o[o.length-1];["ArrowDown","ArrowUp","Home","End"].includes(t.key)&&(t.preventDefault(),this.open||(this.show(),await this.updateComplete),o.length>0&&this.updateComplete.then(()=>{(t.key==="ArrowDown"||t.key==="Home")&&(e.setCurrentItem(s),s.focus()),(t.key==="ArrowUp"||t.key==="End")&&(e.setCurrentItem(n),n.focus())}))}}handleTriggerKeyUp(t){t.key===" "&&t.preventDefault()}handleTriggerSlotChange(){this.updateAccessibleTrigger()}updateAccessibleTrigger(){const e=this.trigger.assignedElements({flatten:!0}).find(s=>Xo(s).start);let o;if(e){switch(e.tagName.toLowerCase()){case"syn-button":case"syn-icon-button":o=e.button;break;default:o=e}o.setAttribute("aria-haspopup","true"),o.setAttribute("aria-expanded",this.open?"true":"false")}}async show(){if(!this.open)return this.open=!0,yt(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,yt(this,"syn-after-hide")}reposition(){this.popup.reposition()}addOpenListeners(){this.panel.addEventListener("syn-select",this.handlePanelSelect),"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide(),this.focusOnTrigger()}):this.panel.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keydown",this.handleDocumentKeyDown),document.addEventListener("mousedown",this.handleDocumentMouseDown)}removeOpenListeners(){this.panel&&(this.panel.removeEventListener("syn-select",this.handlePanelSelect),this.panel.removeEventListener("keydown",this.handleKeyDown)),document.removeEventListener("keydown",this.handleDocumentKeyDown),document.removeEventListener("mousedown",this.handleDocumentMouseDown),this.closeWatcher?.destroy()}async handleOpenChange(){if(this.disabled){this.open=!1;return}if(this.updateAccessibleTrigger(),this.open){this.emit("syn-show"),this.addOpenListeners(),await Dt(this),this.panel.hidden=!1,this.popup.active=!0;const{keyframes:t,options:e}=nt(this,"dropdown.show",{dir:this.localize.dir()});await kt(this.popup.popup,t,e),this.emit("syn-after-show")}else{this.emit("syn-hide"),this.removeOpenListeners(),await Dt(this);const{keyframes:t,options:e}=nt(this,"dropdown.hide",{dir:this.localize.dir()});await kt(this.popup.popup,t,e),this.panel.hidden=!0,this.popup.active=!1,this.emit("syn-after-hide")}}render(){return g`
      <syn-popup
        part="base"
        id="dropdown"
...
`;var cn=Object.defineProperty,dn=Object.getOwnPropertyDescriptor,ge=(i,t,e,o)=>{for(var s=o>1?void 0:o?dn(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=(o?r(t,e,s):r(s))||s);return o&&s&&cn(t,e,s),s};class te extends P{constructor(){super(...arguments),this.hasSlotController=new Q(this,"[default]","logo","label","meta-navigation","navigation"),this.localize=new Z(this),this.label="",this.showBurgerMenu=!1,this.burgerMenuVisible=!1}static{this.styles=[M,ln]}static{this.dependencies={"syn-icon":zt}}handleBurgerMenuToggle(){this.sideNav&&!this.sideNav.rail&&(this.sideNav.open=!this.sideNav.open),this.burgerMenuVisible=!this.burgerMenuVisible}updateBurgerMenuBasedOnSideNav(){this.sideNav&&(this.showBurgerMenu=!this.sideNav.rail,this.burgerMenuVisible=this.sideNav.rail?!1:this.sideNav.open)}handleBurgerMenuVisible(){this.emit(this.burgerMenuVisible?"syn-burger-menu-show":"syn-burger-menu-hide")}connectedCallback(){super.connectedCallback(),this.mutationObserver=new MutationObserver(()=>this.updateBurgerMenuBasedOnSideNav())}firstUpdated(){const t=document.querySelector("syn-side-nav");this.connectSideNavigation(t)}disconnectedCallback(){super.disconnectedCallback(),this.mutationObserver.disconnect()}connectSideNavigation(t){this.mutationObserver.disconnect(),this.sideNav=t||document.querySelector("syn-side-nav"),this.sideNav&&(this.updateBurgerMenuBasedOnSideNav(),this.mutationObserver.observe(this.sideNav,{attributeFilter:["open","rail"],attributes:!0}))}render(){const t=this.hasSlotController.test("navigation");return q`
    ...
    `}}ge([a()],te.prototype,"label",2);ge([a({attribute:"show-burger-menu",reflect:!0,type:Boolean})],te.prototype,"showBurgerMenu",2);ge([a({attribute:"burger-menu-visible",reflect:!0,type:Boolean})],te.prototype,"burgerMenuVisible",2);ge([E()],te.prototype,"sideNav",2);ge([k("burgerMenuVisible",{waitUntilFirstUpdate:!0})],te.prototype,"handleBurgerMenuVisible",1);te.define("syn-header");class hn extends Di{constructor(t){if(super(t),this.handlePointerDown=e=>{e.button!==0||this.host.disabled||this.spinOnLongPressCallback(e)},this.handlePointerUp=e=>{e?.preventDefault(),e?.stopPropagation(),this.timeout&&this.callbacks.start(),this.stopSpinningAndCleanUp(),this.callbacks.end(),document.removeEventListener("pointerup",this.handlePointerUp)},t.type!==ft.ELEMENT||!(t.element instanceof HTMLButtonElement))throw new Error("The `longPress` directive must be used on an HTMLButtonElement.")}render(t){return Yt}update(t,[e]){return this.callbacks===void 0&&this.host===void 0&&(this.host=t.element,this.callbacks={...e},this.host.addEventListener("pointerdown",this.handlePointerDown)),Ut}disconnected(){this.stopSpinningAndCleanUp(),this.host.removeEventListener("pointerdown",this.handlePointerDown),document.removeEventListener("pointerup",this.handlePointerUp)}spinOnLongPressCallback(t){t.preventDefault(),t.stopPropagation(),this.timeout=setTimeout(()=>{this.timeout=void 0,this.interval=setInterval(()=>{this.callbacks.start()},50)},500),document.addEventListener("pointerup",this.handlePointerUp),this.observer?.disconnect(),this.observer=new MutationObserver(e=>{e.forEach(o=>{o.attributeName==="disabled"&&this.stopSpinningAndCleanUp()})}),this.observer.observe(this.host,{attributes:!0})}stopSpinningAndCleanUp(){clearInterval(this.interval),clearTimeout(this.timeout),this.observer?.disconnect()}}const bi=pe(hn),un=y`
	/* stylelint-disable */
  :host {
    display: block;
  }
            ...
            ${this.type==="number"&&!this.noSpinButtons?g`
              <div part="stepper" class="input__number-stepper">
                <button
                  ...
                  aria-hidden="true"
                  ${bi({start:()=>this.handleStepDown(),end:()=>this.handleChange()})}
                  tabindex="-1"
                >
                ...
                <button
                  ...
                  aria-hidden="true"
                  ${bi({start:()=>this.handleStepUp(),end:()=>this.handleChange()})}
                  tabindex="-1"
                >
...
`;var bn=Object.defineProperty,gn=Object.getOwnPropertyDescriptor,J=(i,t,e,o)=>{for(var s=o>1?void 0:o?gn(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=(o?r(t,e,s):r(s))||s);return o&&s&&bn(t,e,s),s};class W extends P{constructor(){super(...arguments),this.hasSlotController=new Q(this,"[default]","children","prefix","suffix"),this.hasFocus=!1,this.showPrefixOnly=!1,this.currentMarkedChild=!1,this.isMultiLine=!1,this.current=!1,this.disabled=!1,this.horizontal=!1,this.chevron=!1,this.open=!1,this.divider=!1}static{this.styles=[M,yn]}static{this.dependencies={"syn-divider":Rt}}isButton(){return!this.href&&!this.hasSlotController.test("children")}isLink(){return!!this.href&&!this.hasSlotController.test("children")}isAccordion(){return this.hasSlotController.test("children")}getNavItemChildren(t){return Array.from(t?.assignedElements({flatten:!0})||[]).map(e=>e.tagName.toLowerCase()==="syn-nav-item"?e:Array.from(e.querySelectorAll(":scope > syn-nav-item"))).flat()}getAllNestedNavItems(t){const e=this.getNavItemChildren(t),o=e.map(s=>s.getAllNestedNavItems(s.childrenSlot)).flat();return e.concat(o)}handleCurrentMarkedChild(){const t=this.closest("syn-side-nav");if(!this.open||t?.rail){const o=this.getAllNestedNavItems(this.childrenSlot).findIndex(s=>!!s.shadowRoot?.querySelector(".nav-item--current"));this.currentMarkedChild=o!==-1}}handleClickButton(t){this.disabled&&(t.preventDefault(),t.stopPropagation())}handleClickSummary(t){t.preventDefault(),t.stopPropagation(),!this.disabled&&(this.open?this.hideDetails():this.showDetails())}hideDetails(){this.open=!1,this.emit("syn-hide",{cancelable:!0})}showDetails(){this.open=!0,this.emit("syn-show",{cancelable:!0})}handleSlotChange(){this.handleCurrentMarkedChild();const t=getComputedStyle(this).getPropertyValue("--indentation"),e=Math.min(parseInt(t,10)+1,2);this.getNavItemChildren(this.childrenSlot).forEach(o=>{o.style.setProperty("--indentation",e.toFixed(0))})}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleWidth(t){t.forEach(e=>{if(e.contentRect.width<100){const o=this.hasSlotController.test("prefix");this.showPrefixOnly=o}else this.showPrefixOnly=!1;e.contentRect.height>48?this.isMultiLine=!0:this.isMultiLine=!1})}handleOpenChange(){this.handleCurrentMarkedChild()}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(t=>this.handleWidth(t)),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver.disconnect()}blur(){this.control.blur()}click(){this.control.click()}focus(t){this.control.focus(t)}render(){const t=this.isButton(),e=this.isLink(),o=this.isAccordion(),s=this.closest("syn-side-nav"),n=this.currentMarkedChild&&!this.open||this.currentMarkedChild&&this.open&&!!s?.rail&&!s?.open;let r=ce`button`;o?r=ce`summary`:e&&(r=ce`a`);const l=(this.chevron||o)&&!this.horizontal;let c;o?c=this.handleClickSummary:t&&(c=this.handleClickButton);const d=q`
      ...
      >
        ...
        <div class="nav-item__content" part="content-wrapper">
          ...
          ${l?q`
            <syn-icon
              class=${S({"nav-item__chevron":!0,"nav-item__chevron-open":this.open})}
              color="currentColor"
              library="system"
              name="chevron-down"
              part="chevron"
          ...
          <div
            class=${S({"current-indicator":!0,"current-indicator--disabled":this.disabled,"current-indicator--visible":this.current||n})}
    ...
    `:d}}J([E()],W.prototype,"hasFocus",2);J([E()],W.prototype,"showPrefixOnly",2);J([E()],W.prototype,"currentMarkedChild",2);J([E()],W.prototype,"isMultiLine",2);J([w('slot[name="children"]')],W.prototype,"childrenSlot",2);J([w(".nav-item")],W.prototype,"control",2);J([a({reflect:!0,type:String})],W.prototype,"href",2);J([a({reflect:!0,type:Boolean})],W.prototype,"current",2);J([a({reflect:!0,type:Boolean})],W.prototype,"disabled",2);J([a({reflect:!0,type:Boolean})],W.prototype,"horizontal",2);J([a({reflect:!0,type:Boolean})],W.prototype,"chevron",2);J([a({reflect:!0,type:Boolean})],W.prototype,"open",2);J([a({reflect:!0,type:Boolean})],W.prototype,"divider",2);J([k("open")],W.prototype,"handleOpenChange",1);W.define("syn-nav-item");const vn=y`
  :host {
    --display-divider: block;
  }
...
`;var _n=Object.defineProperty,wn=Object.getOwnPropertyDescriptor,Ie=(i,t,e,o)=>{for(var s=o>1?void 0:o?wn(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=(o?r(t,e,s):r(s))||s);return o&&s&&_n(t,e,s),s};class ve extends P{constructor(){super(...arguments),this.hasSlotController=new Q(this,"[default]","prefix","suffix","label"),this.disabled=!1,this.label=""}static{this.styles=vn}static{this.dependencies={"syn-divider":Rt}}handleDisableOptions(){const{disabled:t}=this;this.defaultSlot.assignedElements().filter(e=>e.tagName.toLowerCase()==="syn-option").forEach(e=>{e.disabled=t})}handleDisabledChange(){this.handleDisableOptions()}render(){const{disabled:t}=this,e=this.hasSlotController.test("label"),o=this.label?!0:!!e;return q`
      <div
        class=${S({optgroup:!0,"optgroup--has-label":o,"optgroup--has-prefix":this.hasSlotController.test("prefix"),"optgroup--has-suffix":this.hasSlotController.test("suffix"),"optgroup--is-disabled":this.disabled})}
    ...
    `}}Ie([w("slot:not([name])")],ve.prototype,"defaultSlot",2);Ie([a({reflect:!0,type:Boolean})],ve.prototype,"disabled",2);Ie([a()],ve.prototype,"label",2);Ie([k("disabled",{waitUntilFirstUpdate:!0})],ve.prototype,"handleDisabledChange",1);ve.define("syn-optgroup");const xn=y`
	/* stylelint-disable */
  :host {
    display: block;
    user-select: none;
...
`;var Cn=Object.defineProperty,zn=Object.getOwnPropertyDescriptor,St=(i,t,e,o)=>{for(var s=o>1?void 0:o?zn(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=(o?r(t,e,s):r(s))||s);return o&&s&&Cn(t,e,s),s};class _t extends P{constructor(){super(...arguments),this.localize=new Z(this),this.current=!1,this.selected=!1,this.hasHover=!1,this.value="",this.disabled=!1}static{this.styles=[M,xn,kn]}static{this.dependencies={"syn-icon":zt}}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.setAttribute("aria-selected","false")}handleDefaultSlotChange(){const t=this.getTextLabel();if(typeof this.cachedTextLabel>"u"){this.cachedTextLabel=t;return}t!==this.cachedTextLabel&&(this.cachedTextLabel=t,this.emit("slotchange",{bubbles:!0,composed:!1,cancelable:!1}))}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleValueChange(){typeof this.value!="string"&&(this.value=String(this.value)),this.value.includes(" ")&&(console.error("Option values cannot include a space. All spaces have been replaced with underscores.",this),this.value=this.value.replace(/ /g,"_"))}getTextLabel(){const t=this.childNodes;let e="";return[...t].forEach(o=>{o.nodeType===Node.ELEMENT_NODE&&(o.hasAttribute("slot")||(e+=o.textContent)),o.nodeType===Node.TEXT_NODE&&(e+=o.textContent)}),e.trim()}render(){return g`
    ...
    `}}St([w(".option__label")],_t.prototype,"defaultSlot",2);St([E()],_t.prototype,"current",2);St([E()],_t.prototype,"selected",2);St([E()],_t.prototype,"hasHover",2);St([a({reflect:!0})],_t.prototype,"value",2);St([a({type:Boolean,reflect:!0})],_t.prototype,"disabled",2);St([k("disabled")],_t.prototype,"handleDisabledChange",1);St([k("selected")],_t.prototype,"handleSelectedChange",1);St([k("value")],_t.prototype,"handleValueChange",1);_t.define("syn-option");const $n=y`
  :host {
    display: block;
...
`,gi=i=>Array.from(i.assignedElements({flatten:!0})),Sn=i=>i.tagName.toLocaleLowerCase()==="syn-nav-item"||(i.getAttribute("role")??"")==="menuitem",vi=i=>i.filter(Sn);var En=Object.defineProperty,Et=(i,t,e,o)=>{for(var s=void 0,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=r(t,e,s)||s);return s&&En(t,e,s),s};class wt extends P{constructor(){super(...arguments),this.priorityMenuLabel="Menu",this.itemPositionsCached=!1,this.amountOfNavItems=0,this.amountOfVisibleItems=0,this.hasItemsInDropdown=!1}static{this.styles=[M,$n]}static{this.dependencies={"syn-dropdown":Y,"syn-icon":zt,"syn-menu":Ze,"syn-nav-item":W}}getSlottedNavItems(){const t=vi(gi(this.defaultSlot)),e=vi(gi(this.menuSlot));return t.concat(e)}cacheItemPositions(t){t.forEach(e=>{e.removeAttribute("slot");const{right:o}=e.getBoundingClientRect();e.dataset.right=o.toString()}),this.itemPositionsCached=!0}handlePriorityMenu(){const t=this.getSlottedNavItems();this.itemPositionsCached||this.cacheItemPositions(t);const{width:e}=this.horizontalNav.getBoundingClientRect(),{clientWidth:o}=this.priorityMenu,s=e-o;let n,r=0;t.forEach(l=>{n||parseFloat(l.dataset.right)>=s?(l.removeAttribute("horizontal"),l.setAttribute("slot","menu"),l.setAttribute("role","menuitem"),n||(n=parseFloat(l.dataset.right))):(r+=1,l.setAttribute("horizontal","true"),l.removeAttribute("slot"),l.removeAttribute("tabindex"),l.dataset.originalRole?l.setAttribute("role",l.dataset.originalRole):l.removeAttribute("role"))}),this.hasItemsInDropdown=r!==t.length,this.amountOfVisibleItems=r}renderPriorityMenu(){return q`
      <syn-dropdown
        class=${S({"priority-menu":!0,"priority-menu--has-visible-items":this.amountOfVisibleItems!==0,"priority-menu--hidden":!this.hasItemsInDropdown})}
        part="priority-menu"
      ...
      >
        <syn-nav-item class="priority-menu__nav-item" slot="trigger" horizontal part="priority-menu-nav-item">
          ...
          <span
            class=${S({"priority-menu__label":!0,"priority-menu__label--visible":this.amountOfVisibleItems===0})}
    ...
    `}}Et([w("slot:not([name])")],wt.prototype,"defaultSlot");Et([w("slot[name=menu]")],wt.prototype,"menuSlot");Et([w(".horizontal-nav")],wt.prototype,"horizontalNav");Et([w(".priority-menu")],wt.prototype,"priorityMenu");Et([a({attribute:"priority-menu-label"})],wt.prototype,"priorityMenuLabel");Et([E()],wt.prototype,"itemPositionsCached");Et([E()],wt.prototype,"amountOfNavItems");Et([E()],wt.prototype,"amountOfVisibleItems");Et([E()],wt.prototype,"hasItemsInDropdown");wt.define("syn-prio-nav");/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Xi="important",On=" !"+Xi,An=pe(class extends Te{constructor(i){if(super(i),i.type!==ft.ATTRIBUTE||i.name!=="style"||i.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(i){return Object.keys(i).reduce((t,e)=>{const o=i[e];return o==null?t:t+`${e=e.includes("-")?e:e.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${o};`},"")}update(i,[t]){const{style:e}=i.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(const o of this.ft)t[o]==null&&(this.ft.delete(o),o.includes("-")?e.removeProperty(o):e[o]=null);for(const o in t){const s=t[o];if(s!=null){this.ft.add(o);const n=typeof s=="string"&&s.endsWith(On);o.includes("-")||n?e.setProperty(o,n?s.slice(0,-11):s,n?Xi:""):e[o]=s}}return Ut}}),Tn=y`
	/* stylelint-disable */
  :host {
    --height: 1rem;
...
`;var Pn=Object.defineProperty,ri=(i,t,e,o)=>{for(var s=void 0,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=r(t,e,s)||s);return s&&Pn(t,e,s),s};class Me extends P{constructor(){super(...arguments),this.localize=new Z(this),this.value=0,this.indeterminate=!1,this.label=""}static{this.styles=[M,Tn,Dn]}render(){return g`
      <div
        part="base"
      ...
      >
        <div part="indicator" class="progress-bar__indicator" style=${An({width:`${this.value}%`})}>
          ${this.indeterminate?"":g` <slot part="label" class="progress-bar__label"></slot> `}
        </div>
      </div>
    `}}ri([a({type:Number,reflect:!0})],Me.prototype,"value");ri([a({type:Boolean,reflect:!0})],Me.prototype,"indeterminate");ri([a()],Me.prototype,"label");Me.define("syn-progress-bar");const Ln=y`
	/* stylelint-disable */
  :host {
    --size: 128px;
    --track-width: 4px;
...
`;var Mn=Object.defineProperty,Re=(i,t,e,o)=>{for(var s=void 0,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=r(t,e,s)||s);return s&&Mn(t,e,s),s};class _e extends P{constructor(){super(...arguments),this.localize=new Z(this),this.value=0,this.label=""}static{this.styles=[M,Ln,In]}updated(t){if(super.updated(t),t.has("value")){const e=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),o=2*Math.PI*e,s=o-this.value/100*o;this.indicatorOffset=`${s}px`}}render(){return g`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
    ...
    `}}Re([w(".progress-ring__indicator")],_e.prototype,"indicator");Re([E()],_e.prototype,"indicatorOffset");Re([a({type:Number,reflect:!0})],_e.prototype,"value");Re([a()],_e.prototype,"label");_e.define("syn-progress-ring");const Rn=y`
	/* stylelint-disable */
  ${Oi}
...
`;var Fn=Object.defineProperty,Vn=Object.getOwnPropertyDescriptor,Ft=(i,t,e,o)=>{for(var s=o>1?void 0:o?Vn(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=(o?r(t,e,s):r(s))||s);return o&&s&&Fn(t,e,s),s};class Ot extends P{constructor(){super(...arguments),this.hasSlotController=new Q(this,"[default]","prefix","suffix"),this.hasFocus=!1,this.checked=!1,this.disabled=!1,this.size="medium"}static{this.styles=[M,Rn]}connectedCallback(){super.connectedCallback(),this.setAttribute("role","presentation")}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleClick(t){if(this.disabled){t.preventDefault(),t.stopPropagation();return}this.checked=!0}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}focus(t){this.input.focus(t)}blur(){this.input.blur()}render(){return q`
    ...
    `}}Ft([w(".button")],Ot.prototype,"input",2);Ft([w(".hidden-input")],Ot.prototype,"hiddenInput",2);Ft([E()],Ot.prototype,"hasFocus",2);Ft([a({type:Boolean,reflect:!0})],Ot.prototype,"checked",2);Ft([a()],Ot.prototype,"value",2);Ft([a({type:Boolean,reflect:!0})],Ot.prototype,"disabled",2);Ft([a({reflect:!0})],Ot.prototype,"size",2);Ft([k("disabled",{waitUntilFirstUpdate:!0})],Ot.prototype,"handleDisabledChange",1);Ot.define("syn-radio-button");const Bn=y`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`;var Un=Object.defineProperty,Hn=Object.getOwnPropertyDescriptor,tt=(i,t,e,o)=>{for(var s=o>1?void 0:o?Hn(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=(o?r(t,e,s):r(s))||s);return o&&s&&Un(t,e,s),s};class G extends P{constructor(){super(...arguments),this.formControlController=new qt(this),this.hasSlotController=new Q(this,"help-text","label"),this.customValidityMessage="",this.hasButtonGroup=!1,this.errorMessage="",this.defaultValue="",this.label="",this.helpText="",this.name="option",this.value="",this.size="medium",this.form="",this.required=!1}static{this.styles=[M,Qt,Bn,Jt,Nn]}static{this.dependencies={"syn-button-group":ye}}get validity(){const t=this.required&&!this.value;return this.customValidityMessage!==""?as:t?rs:De}get validationMessage(){const t=this.required&&!this.value;return this.customValidityMessage!==""?this.customValidityMessage:t?this.validationInput.validationMessage:""}connectedCallback(){super.connectedCallback(),this.defaultValue=this.value}firstUpdated(){this.formControlController.updateValidity()}getAllRadios(){return[...this.querySelectorAll("syn-radio, syn-radio-button")]}handleRadioClick(t){const e=t.target.closest("syn-radio, syn-radio-button"),o=this.getAllRadios(),s=this.value;e.disabled||(this.value=e.value,o.forEach(n=>n.checked=n===e),this.value!==s&&(this.emit("syn-change"),this.emit("syn-input")))}handleKeyDown(t){if(!["ArrowUp","ArrowDown","ArrowLeft","ArrowRight"," "].includes(t.key))return;const e=this.getAllRadios().filter(l=>!l.disabled),o=e.find(l=>l.checked)??e[0],s=t.key===" "?0:["ArrowUp","ArrowLeft"].includes(t.key)?-1:1,n=this.value;let r=e.indexOf(o)+s;r<0&&(r=e.length-1),r>e.length-1&&(r=0),this.getAllRadios().forEach(l=>{l.checked=!1,this.hasButtonGroup||(l.tabIndex=-1)}),this.value=e[r].value,e[r].checked=!0,this.hasButtonGroup?e[r].shadowRoot.querySelector("button").focus():(e[r].tabIndex=0,e[r].focus()),this.value!==n&&(this.emit("syn-change"),this.emit("syn-input")),t.preventDefault()}handleLabelClick(){const t=this.getAllRadios(),o=t.find(s=>s.checked)||t[0];o&&o.focus()}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}async syncRadioElements(){const t=this.getAllRadios();if(await Promise.all(t.map(async e=>{await e.updateComplete,e.checked=e.value===this.value,e.size=this.size})),this.hasButtonGroup=t.some(e=>e.tagName.toLowerCase()==="syn-radio-button"),t.length>0&&!t.some(e=>e.checked))if(this.hasButtonGroup){const e=t[0].shadowRoot?.querySelector("button");e&&(e.tabIndex=0)}else t[0].tabIndex=0;if(this.hasButtonGroup){const e=this.shadowRoot?.querySelector("syn-button-group");e&&(e.disableRole=!0)}}syncRadios(){if(customElements.get("syn-radio")&&customElements.get("syn-radio-button")){this.syncRadioElements();return}customElements.get("syn-radio")?this.syncRadioElements():customElements.whenDefined("syn-radio").then(()=>this.syncRadios()),customElements.get("syn-radio-button")?this.syncRadioElements():customElements.whenDefined("syn-radio-button").then(()=>this.syncRadios())}updateCheckedRadio(){this.getAllRadios().forEach(e=>e.checked=e.value===this.value),this.formControlController.setValidity(this.validity.valid)}handleSizeChange(){this.syncRadios()}handleValueChange(){this.hasUpdated&&this.updateCheckedRadio()}checkValidity(){const t=this.required&&!this.value,e=this.customValidityMessage!=="";return t||e?(this.formControlController.emitInvalidEvent(),!1):!0}getForm(){return this.formControlController.getForm()}reportValidity(){const t=this.validity.valid;return this.errorMessage=this.customValidityMessage||t?"":this.validationInput.validationMessage,this.formControlController.setValidity(t),this.validationInput.hidden=!0,clearTimeout(this.validationTimeout),t||(this.validationInput.hidden=!1,this.validationInput.reportValidity(),this.validationTimeout=setTimeout(()=>this.validationInput.hidden=!0,1e4)),t}setCustomValidity(t=""){this.customValidityMessage=t,this.errorMessage=t,this.validationInput.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("label"),e=this.hasSlotController.test("help-text"),o=this.label?!0:!!t,s=this.helpText?!0:!!e,n=g`
    ...
    `}}tt([w("slot:not([name])")],G.prototype,"defaultSlot",2);tt([w(".radio-group__validation-input")],G.prototype,"validationInput",2);tt([E()],G.prototype,"hasButtonGroup",2);tt([E()],G.prototype,"errorMessage",2);tt([E()],G.prototype,"defaultValue",2);tt([a()],G.prototype,"label",2);tt([a({attribute:"help-text"})],G.prototype,"helpText",2);tt([a()],G.prototype,"name",2);tt([a({reflect:!0})],G.prototype,"value",2);tt([a({reflect:!0})],G.prototype,"size",2);tt([a({reflect:!0})],G.prototype,"form",2);tt([a({type:Boolean,reflect:!0})],G.prototype,"required",2);tt([k("size",{waitUntilFirstUpdate:!0})],G.prototype,"handleSizeChange",1);tt([k("value")],G.prototype,"handleValueChange",1);G.define("syn-radio-group");const qn=y`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`;var Wn=Object.defineProperty,Kn=Object.getOwnPropertyDescriptor,jt=(i,t,e,o)=>{for(var s=o>1?void 0:o?Kn(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=(o?r(t,e,s):r(s))||s);return o&&s&&Wn(t,e,s),s};class Vt extends P{constructor(){super(),this.checked=!1,this.hasFocus=!1,this.size="medium",this.disabled=!1,this.handleBlur=()=>{this.hasFocus=!1,this.emit("syn-blur")},this.handleClick=()=>{this.disabled||(this.checked=!0)},this.handleFocus=()=>{this.hasFocus=!0,this.emit("syn-focus")},this.addEventListener("blur",this.handleBlur),this.addEventListener("click",this.handleClick),this.addEventListener("focus",this.handleFocus)}static{this.styles=[M,qn,jn]}static{this.dependencies={"syn-icon":zt}}connectedCallback(){super.connectedCallback(),this.setInitialAttributes()}setInitialAttributes(){this.setAttribute("role","radio"),this.setAttribute("tabindex","-1"),this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleCheckedChange(){this.setAttribute("aria-checked",this.checked?"true":"false"),this.setAttribute("tabindex",this.checked?"0":"-1")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}render(){return g`
      <span
        part="base"
    ...
    `}}jt([E()],Vt.prototype,"checked",2);jt([E()],Vt.prototype,"hasFocus",2);jt([a()],Vt.prototype,"value",2);jt([a({reflect:!0})],Vt.prototype,"size",2);jt([a({type:Boolean,reflect:!0})],Vt.prototype,"disabled",2);jt([k("checked")],Vt.prototype,"handleCheckedChange",1);jt([k("disabled",{waitUntilFirstUpdate:!0})],Vt.prototype,"handleDisabledChange",1);Vt.define("syn-radio");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Ge extends Te{constructor(t){if(super(t),this.it=Yt,t.type!==ft.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===Yt||t==null)return this._t=void 0,this.it=t;if(t===Ut)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}}Ge.directiveName="unsafeHTML",Ge.resultType=1;const Yn=pe(Ge),Gn=y`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
`;var Zn=Object.defineProperty,Zi=(i,t,e,o)=>{for(var s=void 0,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=r(t,e,s)||s);return s&&Zn(t,e,s),s};class Fe extends P{constructor(){super(...arguments),this.localize=new Z(this),this.size="medium",this.removable=!1}static{this.styles=[M,Gn,Xn]}static{this.dependencies={"syn-icon-button":_i}}handleRemoveClick(){this.emit("syn-remove")}render(){return g`
      <span
        part="base"
    ...
    `}}Zi([a({reflect:!0})],Fe.prototype,"size");Zi([a({type:Boolean})],Fe.prototype,"removable");const Qn=y`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`;var tr=Object.defineProperty,er=Object.getOwnPropertyDescriptor,A=(i,t,e,o)=>{for(var s=o>1?void 0:o?er(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=(o?r(t,e,s):r(s))||s);return o&&s&&tr(t,e,s),s};class O extends P{constructor(){super(...arguments),this.formControlController=new qt(this,{assumeInteractionOn:["syn-blur","syn-input"]}),this.hasSlotController=new Q(this,"help-text","label"),this.localize=new Z(this),this.typeToSelectString="",this.hasFocus=!1,this.displayLabel="",this.selectedOptions=[],this.name="",this.value="",this.defaultValue="",this.size="medium",this.placeholder="",this.multiple=!1,this.maxOptionsVisible=3,this.disabled=!1,this.clearable=!1,this.open=!1,this.hoist=!1,this.label="",this.placement="bottom",this.helpText="",this.form="",this.required=!1,this.getTag=t=>g`
      <syn-tag
        part="tag"
        exportparts="
              base:tag__base,
...
`;var sr=Object.defineProperty,or=Object.getOwnPropertyDescriptor,Bt=(i,t,e,o)=>{for(var s=o>1?void 0:o?or(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=(o?r(t,e,s):r(s))||s);return o&&s&&sr(t,e,s),s};class At extends P{constructor(){super(),this.hasSlotController=new Q(this,"[default]","footer"),this.localize=new Z(this),this.isAnimationActive=!1,this.open=!1,this.rail=!1,this.noFocusTrapping=!1,this.handleMouseEnter=this.handleMouseEnter.bind(this),this.handleMouseLeave=this.handleMouseLeave.bind(this)}static{this.styles=[M,ir]}static{this.dependencies={"syn-divider":Rt,"syn-drawer":dt}}setDelayedCallback(t){clearTimeout(this.timeout),this.timeout=setTimeout(t,100)}handleMouseEnter(){this.setDelayedCallback(()=>{this.open=!0})}handleMouseLeave(){this.setDelayedCallback(()=>{this.open=!1})}handleRequestClose(){this.open&&(this.open=!1)}addMouseListener(){this.drawer.shadowRoot.querySelector(".drawer__panel")?.addEventListener("mouseenter",this.handleMouseEnter),this.drawer.shadowRoot.querySelector(".drawer__panel")?.addEventListener("mouseleave",this.handleMouseLeave)}removeMouseListener(){this.drawer.shadowRoot.querySelector(".drawer__panel")?.removeEventListener("mouseenter",this.handleMouseEnter),this.drawer.shadowRoot.querySelector(".drawer__panel")?.removeEventListener("mouseleave",this.handleMouseLeave)}setDrawerVisibility(t){this.drawer.shadowRoot.querySelector(".drawer").hidden=!t,this.drawer.shadowRoot.querySelector(".drawer__panel")?.setAttribute("aria-hidden",t?"false":"true")}forceDrawerVisibilityForRailMode(){return yt(this,"syn-after-hide").then(()=>{this.setDrawerVisibility(!0),this.isAnimationActive=!1})}setDrawerAnimations(){const t=nt(this,`sideNav.show${this.rail?"Rail":"NonRail"}`,{dir:this.localize.dir()}),e=nt(this,`sideNav.hide${this.rail?"Rail":"NonRail"}`,{dir:this.localize.dir()}),o=nt(this,"sideNav.overlay.hide",{dir:this.localize.dir()}),s=nt(this,"sideNav.overlay.show",{dir:this.localize.dir()});ke(this.drawer,"drawer.showStart",t),ke(this.drawer,"drawer.hideStart",e),ke(this.drawer,"drawer.overlay.hide",o),ke(this.drawer,"drawer.overlay.show",s)}handleModeChange(){this.setDrawerAnimations(),this.rail?(this.addMouseListener(),this.setDrawerVisibility(!0)):(this.removeMouseListener(),this.open||this.setDrawerVisibility(!1))}handleOpenChange(){this.rail&&(this.isAnimationActive=!0,this.open?yt(this.drawer,"syn-after-show").then(()=>{this.isAnimationActive=!1}):this.forceDrawerVisibilityForRailMode())}handleFocusTrapping(){this.rail||(this.noFocusTrapping?this.drawer.modal.activateExternal():this.drawer.modal.deactivateExternal())}async show(){if(!this.open)return this.open=!0,yt(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,yt(this,"syn-after-hide")}firstUpdated(){this.setDrawerAnimations(),this.rail?this.drawer.updateComplete.then(()=>{this.addMouseListener(),this.setDrawerVisibility(!0)}):this.noFocusTrapping&&this.drawer.modal.activateExternal()}disconnectedCallback(){super.disconnectedCallback(),ze(this.drawer),this.drawer.modal.deactivate()}render(){const t=window.navigator.maxTouchPoints>0||"ontouchstart"in window,e=this.hasSlotController.test("footer");return q`
      <nav
        class=${S({"side-nav":!0,"side-nav--animation":this.isAnimationActive,"side-nav--fix":!this.rail,"side-nav--has-footer":e,"side-nav--open":this.open,"side-nav--rail":this.rail,"side-nav--touch":t})}
        part="base"
      >
...
:host([size='small']) {
  ...
  `;var ar=Object.defineProperty,lr=Object.getOwnPropertyDescriptor,et=(i,t,e,o)=>{for(var s=o>1?void 0:o?lr(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=(o?r(t,e,s):r(s))||s);return o&&s&&ar(t,e,s),s};class X extends P{constructor(){super(...arguments),this.formControlController=new qt(this,{value:t=>t.checked?t.value||"on":void 0,defaultValue:t=>t.defaultChecked,setValue:(t,e)=>t.checked=e}),this.hasSlotController=new Q(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}static{this.styles=[M,Qt,nr,Jt,rr]}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleInput(){this.emit("syn-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}handleClick(){this.checked=!this.checked,this.emit("syn-change")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleKeyDown(t){t.key==="ArrowLeft"&&(t.preventDefault(),this.checked=!1,this.emit("syn-change"),this.emit("syn-input")),t.key==="ArrowRight"&&(t.preventDefault(),this.checked=!0,this.emit("syn-change"),this.emit("syn-input"))}handleCheckedChange(){this.input.checked=this.checked,this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(!0)}click(){this.input.click()}focus(t){this.input.focus(t)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("help-text"),e=this.helpText?!0:!!t;return g`
      <div
        class=${S({"form-control":!0,"form-control--small":this.size==="small","form-control--medium":this.size==="medium","form-control--large":this.size==="large","form-control--has-help-text":e})}
      >
        <label
    ...
    `}}et([w('input[type="checkbox"]')],X.prototype,"input",2);et([E()],X.prototype,"hasFocus",2);et([a()],X.prototype,"title",2);et([a()],X.prototype,"name",2);et([a()],X.prototype,"value",2);et([a({reflect:!0})],X.prototype,"size",2);et([a({type:Boolean,reflect:!0})],X.prototype,"disabled",2);et([a({type:Boolean,reflect:!0})],X.prototype,"checked",2);et([be("checked")],X.prototype,"defaultChecked",2);et([a({reflect:!0})],X.prototype,"form",2);et([a({type:Boolean,reflect:!0})],X.prototype,"required",2);et([a({attribute:"help-text"})],X.prototype,"helpText",2);et([k("checked",{waitUntilFirstUpdate:!0})],X.prototype,"handleCheckedChange",1);et([k("disabled",{waitUntilFirstUpdate:!0})],X.prototype,"handleDisabledChange",1);X.define("syn-switch");Fe.define("syn-tag");const cr=y`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`;var hr=Object.defineProperty,ur=Object.getOwnPropertyDescriptor,I=(i,t,e,o)=>{for(var s=o>1?void 0:o?ur(t,e):t,n=i.length-1,r;n>=0;n--)(r=i[n])&&(s=(o?r(t,e,s):r(s))||s);return o&&s&&hr(t,e,s),s};class T extends P{constructor(){super(...arguments),this.formControlController=new qt(this,{assumeInteractionOn:["syn-blur","syn-input"]}),this.hasSlotController=new Q(this,"help-text","label"),this.hasFocus=!1,this.title="",this.name="",this.value="",this.size="medium",this.label="",this.helpText="",this.placeholder="",this.rows=4,this.resize="vertical",this.disabled=!1,this.readonly=!1,this.form="",this.required=!1,this.spellcheck=!0,this.defaultValue=""}static{this.styles=[M,Qt,cr,Jt,dr]}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>this.setTextareaHeight()),this.updateComplete.then(()=>{this.setTextareaHeight(),this.resizeObserver.observe(this.input)})}firstUpdated(){this.formControlController.updateValidity()}disconnectedCallback(){super.disconnectedCallback(),this.input&&this.resizeObserver.unobserve(this.input)}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleChange(){this.value=this.input.value,this.setTextareaHeight(),this.emit("syn-change")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleInput(){this.value=this.input.value,this.emit("syn-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}setTextareaHeight(){this.resize==="auto"?(this.input.style.height="auto",this.input.style.height=`${this.input.scrollHeight}px`):this.input.style.height=void 0}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleRowsChange(){this.setTextareaHeight()}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity(),this.setTextareaHeight()}focus(t){this.input.focus(t)}blur(){this.input.blur()}select(){this.input.select()}scrollPosition(t){if(t){typeof t.top=="number"&&(this.input.scrollTop=t.top),typeof t.left=="number"&&(this.input.scrollLeft=t.left);return}return{top:this.input.scrollTop,left:this.input.scrollTop}}setSelectionRange(t,e,o="none"){this.input.setSelectionRange(t,e,o)}setRangeText(t,e,o,s="preserve"){const n=e??this.input.selectionStart,r=o??this.input.selectionEnd;this.input.setRangeText(t,n,r,s),this.value!==this.input.value&&(this.value=this.input.value,this.setTextareaHeight())}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("label"),e=this.hasSlotController.test("help-text"),o=this.label?!0:!!t,s=this.helpText?!0:!!e;return g`
    ...
    `}}I([w(".textarea__control")],T.prototype,"input",2);I([E()],T.prototype,"hasFocus",2);I([a()],T.prototype,"title",2);I([a()],T.prototype,"name",2);I([a()],T.prototype,"value",2);I([a({reflect:!0})],T.prototype,"size",2);I([a()],T.prototype,"label",2);I([a({attribute:"help-text"})],T.prototype,"helpText",2);I([a()],T.prototype,"placeholder",2);I([a({type:Number})],T.prototype,"rows",2);I([a()],T.prototype,"resize",2);I([a({type:Boolean,reflect:!0})],T.prototype,"disabled",2);I([a({type:Boolean,reflect:!0})],T.prototype,"readonly",2);I([a({reflect:!0})],T.prototype,"form",2);I([a({type:Boolean,reflect:!0})],T.prototype,"required",2);I([a({type:Number})],T.prototype,"minlength",2);I([a({type:Number})],T.prototype,"maxlength",2);I([a()],T.prototype,"autocapitalize",2);I([a()],T.prototype,"autocorrect",2);I([a()],T.prototype,"autocomplete",2);I([a({type:Boolean})],T.prototype,"autofocus",2);I([a()],T.prototype,"enterkeyhint",2);I([a({type:Boolean,converter:{fromAttribute:i=>!(!i||i==="false"),toAttribute:i=>i?"true":"false"}})],T.prototype,"spellcheck",2);I([a()],T.prototype,"inputmode",2);I([be()],T.prototype,"defaultValue",2);I([k("disabled",{waitUntilFirstUpdate:!0})],T.prototype,"handleDisabledChange",1);I([k("rows",{waitUntilFirstUpdate:!0})],T.prototype,"handleRowsChange",1);I([k("value",{waitUntilFirstUpdate:!0})],T.prototype,"handleValueChange",1);T.define("syn-textarea");function pr(i){const t=typeof window<"u"&&window;return!!(t&&(t.navigator.userAgent.match(/Chromatic/)||t.location.href.match(/chromatic=true/)))}const mr=(i,...t)=>pr()?g`
      <style>
      :root {
      ...
      ${i(...t)}
    `:i(...t),Ae="🌞 light",Xe="🌙 dark",fr=i=>`https://www.figma.com/file/bZFqk9urD3NlghGUKrkKCR/Synergy-Digital-Design-System?type=design&node-id=${i}`,yr=(i,t="Go to Figma page")=>({label:t,type:"link",url:fr(i)}),br=Lo({defaultTheme:Ae,parentSelector:"body",themes:{[Ae]:"syn-theme-light",[Xe]:"syn-theme-dark"}}),gr={decorators:[mr,br],parameters:{backgrounds:{default:"neutral-1000",values:[{name:"neutral-1000",value:"var(--syn-color-neutral-0)"},{name:"neutral-50",value:"var(--syn-color-neutral-50)"},{name:"primary-100",value:"var(--syn-color-primary-50)"}]},chromatic:{disableSnapshot:!0,modes:{[Ae]:{theme:Ae},[Xe]:{theme:Xe}}},controls:{disable:!0,matchers:{color:/(background|color)$/i,date:/Date$/}},design:yr("104-238"),docs:{stories:{inline:!1},toc:{headingSelector:"h2, h3"},source:{format:"html"}}}},Sr=Object.freeze(Object.defineProperty({__proto__:null,default:gr},Symbol.toStringTag,{value:"Module"}));export{Sr as a,Di as f,yr as g,pr as i,gr as p};
