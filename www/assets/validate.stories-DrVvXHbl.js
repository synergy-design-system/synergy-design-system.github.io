import{j as q,c as r,y as A,C as R,d as L}from"./iframe-eRvaIELU.js";import{S as P,c as B,n as c}from"./synergy-element-BVZI5H_G.js";import{r as m}from"./icon.component-ehmpGKuT.js";import{a as N}from"./query-D0jTsbLw.js";import{o as U}from"./query-assigned-elements-CIlqV-be.js";import{o as j}from"./if-defined-BvPV1s9v.js";import{w as z}from"./watch-CEsCE2EF.js";import{S as H}from"./alert.component-Dh4hLBz6.js";import{S as K}from"./tooltip.component-dbbCzFE9.js";import{e as W}from"./decorator-CWkWRMhy.js";import"./input-CgKZsa5v.js";import"./button-BiXeV4zf.js";import{g as l,a as Y,s as G,b as J,c as Q}from"./component-mLh0MrP7.js";import"./preload-helper-PPVm8Dsz.js";import"./animation-registry-DyRYqZdt.js";import"./closeActiveElement-Bnbpk8Kw.js";import"./class-map-BctzS3gw.js";import"./slot-9EVoRGQc.js";import"./controller-BGdn_hBF.js";import"./event-B0iVuGLD.js";import"./icon-button.component-DulU9jN8.js";import"./popup.component-Dn3dFsqK.js";import"./functions-bkELIyT9.js";import"./default-value-B9EDJvRm.js";import"./form-d9hCJUdr.js";import"./live-uQYIGJoD.js";import"./form-control.styles-CbH73JDI.js";import"./divider.component-DLGUxJgm.js";import"./button.component-c4wtumtF.js";import"./spinner.component-BI3Egrps.js";import"./index-3hbeBem-.js";import"./_docs-DCFLSkr0.js";const X=e=>(t,a)=>{a!==void 0?a.addInitializer(()=>{customElements.define(e,t)}):customElements.define(e,t)},Z=["blur","change","clear","focus","invalid","input","move"],k=(e,t)=>e.includes(t),x=e=>k(e,"blur"),F=e=>k(e,"invalid"),V=e=>e instanceof P,ee=(e="")=>e.split(" ").map(t=>t.trim()).filter(Boolean),I=(e,t)=>{const a=t.trim();return V(e)&&Z.includes(a)?`syn-${a}`:a},te=e=>{if(!V(e))return;const{size:t}=e;return t!=null?t:void 0},ae={"syn-checkbox":"input","syn-combobox":".combobox__value-input","syn-file":"input","syn-input":"input","syn-radio-group":"input","syn-range":".input__control","syn-select":".select__value-input","syn-switch":"input","syn-textarea":".textarea__control"},D=(e,t)=>e.shadowRoot?.querySelector(t)??null,ie=e=>{if(!e)return;if(!e.shadowRoot)return e;const t=e.tagName.toLowerCase(),a=ae[t];if(a){const s=D(e,a);if(s)return s}const i=D(e,"input,select,textarea");return i||e},se=q`
  .validate {
    display: flex;
