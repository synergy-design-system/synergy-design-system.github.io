import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-DRz18Lsn.js";import{c as i,t as a}from"./lit-D4-0ovri.js";import{t as o}from"./icon-BbsmBxau.js";import{t as s}from"./divider-Bas-Jfyn.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-NnlguzJ1.js";import{t as m}from"./taggedTemplateLiteral-BZenJ0bZ.js";import{n as h,t as g}from"./menu-item-I3gppQTq.js";var _=t({CheckboxMenuItems:()=>k,Default:()=>w,Disabled:()=>E,Focus:()=>O,Loading:()=>D,PrefixAndSuffix:()=>T,Screenshot:()=>j,ValueSelection:()=>A,__namedExportsOrder:()=>M,default:()=>C}),v,y,b,x,S,C,w,T,E,D,O,k,A,j,M;function N(){return(N=e((()=>{a(),s(),h(),g(),o(),f(),r(),{args:y,argTypes:b}=l(`syn-menu-item`),{overrideArgs:x}=c(`syn-menu-item`),{generateTemplate:S}=d(`syn-menu-item`),C={args:x([{name:`default`,type:`slot`,value:`Option 1`}],y),argTypes:b,component:`syn-menu-item`,parameters:{chromatic:{modes:n},docs:{description:{component:u(`menu-item`,`default`)}}},tags:[`Navigation`],title:`Components/syn-menu-item`},w={parameters:{controls:{disable:!1},docs:{description:{story:u(`menu-item`,`default`)}}},render:e=>i`
    <syn-menu>
      ${S({args:e})}
    </syn-menu>
  ...
  `},A={parameters:{docs:{description:{story:u(`menu-item`,`selection`)}}},render:()=>i(v||=m([`
    ...
    <\/script>
  `]))},j=p({Default:w,PrefixAndSuffix:T,Disabled:E,Loading:D,CheckboxMenuItems:k,ValueSelection:A},300),M=[`Default`,`PrefixAndSuffix`,`Disabled`,`Loading`,`Focus`,`CheckboxMenuItems`,`ValueSelection`,`Screenshot`],w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  CheckboxMenuItems,
  ValueSelection
}, 300)`,...j.parameters?.docs?.source}}}})))()}export{N as n,_ as r,w as t};