import{a as y}from"./static-gmWA-8Kq.js";import{i as d,x as b}from"./directive-helpers-DGrfjhaU.js";import{L as h}from"./localize-CatY2peN.js";import{n as o}from"./property-BGzwfL48.js";import{a as v}from"./query-DAIS6qJ0.js";import{w as p}from"./watch-CEsCE2EF.js";import{S as u,c as f}from"./component.styles-Do19GEOY.js";import{S as m}from"./icon-button.component-BGixvALP.js";const g=d`
	/* stylelint-disable */
  :host {
...
`;var w=Object.defineProperty,_=Object.getOwnPropertyDescriptor,e=(n,s,i,r)=>{for(var a=r>1?void 0:r?_(s,i):s,l=n.length-1,c;l>=0;l--)(c=n[l])&&(a=(r?c(s,i,a):c(a))||a);return r&&a&&w(s,i,a),a};let C=0;class t extends u{constructor(){super(...arguments),this.localize=new h(this),this.attrId=++C,this.componentId=`syn-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}static{this.styles=[f,g,x]}static{this.dependencies={"syn-icon-button":m}}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}handleCloseClick(s){s.stopPropagation(),this.emit("syn-close")}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false"),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,b`
      <div
        part="base"
