import{ae as ve,af as Di}from"./index-DvEmv000.js";import{useMDXComponents as li}from"./index-DecWcg07.js";import{a as x,r as rt,R as ge}from"./index-7h80QhK_.js";import{i as c,u as Vt,h as Mi,k as d,n as Fi,D as Vi,R as Ni,Q as qi}from"./directive-helpers-CDT6qhDs.js";import{n as s,a as b,r as Bi}from"./library-BZPO0bHa.js";import{b as m,R as v,a as f,e as Ie,k as J,d as Pi,f as Ri}from"./static-9CmeQujl.js";import{F as Ye,r as pi,L as ji,t as Hi,b as Ui,o as Wi,s as Nt,f as Ki,c as Zi,d as Gi,p as bt,e as Xi,g as Yi,h as ci,i as Qi,a as di,j as Ji,$ as eo,k as to,K as io}from"./ref-BgFTv61d.js";import{d as St}from"./default-icons-B7cd3LAo.js";import"./iframe-D-8vKhb5.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-Df9so8jS.js";import"./index-9hYXp3D6.js";import"./index-DrFu-skq.js";/**
 * @license
...
`,Te=(e="value")=>(t,i)=>{const a=t.constructor,r=a.prototype.attributeChangedCallback;a.prototype.attributeChangedCallback=function(n,l,p){var u;const g=a.getPropertyOptions(e),k=typeof g.attribute=="string"?g.attribute:e;if(n===k){const P=g.converter||Vt,F=(typeof P=="function"?P:(u=P?.fromAttribute)!=null?u:Vt.fromAttribute)(p,g.type);this[e]!==F&&(this[i]=F)}r.call(this,n,l,p)}},we=c`
	/* stylelint-disable */
...
`,ht=class extends y{constructor(){super(...arguments),this.observedElements=[],this.disabled=!1}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{this.emit("syn-resize",{detail:{entries:e}})}),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}handleSlotChange(){this.disabled||this.startObserver()}startObserver(){const e=this.shadowRoot.querySelector("slot");if(e!==null){const t=e.assignedElements({flatten:!0});this.observedElements.forEach(i=>this.resizeObserver.unobserve(i)),this.observedElements=[],t.forEach(i=>{this.resizeObserver.observe(i),this.observedElements.push(i)})}}stopObserver(){this.resizeObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}render(){return d` <slot @slotchange=${this.handleSlotChange}></slot> `}};ht.styles=[z,vo];o([s({type:Boolean,reflect:!0})],ht.prototype,"disabled",2);o([h("disabled",{waitUntilFirstUpdate:!0})],ht.prototype,"handleDisabledChange",1);function bo(e,t){return{top:Math.round(e.getBoundingClientRect().top-t.getBoundingClientRect().top),left:Math.round(e.getBoundingClientRect().left-t.getBoundingClientRect().left)}}var $t=new Set;function _o(){const e=document.documentElement.clientWidth;return Math.abs(window.innerWidth-e)}function xo(){const e=Number(getComputedStyle(document.body).paddingRight.replace(/px/,""));return isNaN(e)||!e?0:e}function Xe(e){if($t.add(e),!document.documentElement.classList.contains("syn-scroll-lock")){const t=_o()+xo();let i=getComputedStyle(document.documentElement).scrollbarGutter;(!i||i==="auto")&&(i="stable"),t<2&&(i=""),document.documentElement.style.setProperty("--syn-scroll-lock-gutter",i),document.documentElement.classList.add("syn-scroll-lock"),document.documentElement.style.setProperty("--syn-scroll-lock-size",`${t}px`)}}function qe(e){$t.delete(e),$t.size===0&&(document.documentElement.classList.remove("syn-scroll-lock"),document.documentElement.style.removeProperty("--syn-scroll-lock-size"))}function mt(e,t,i="vertical",a="smooth"){const r=bo(e,t),n=r.top+t.scrollTop,l=r.left+t.scrollLeft,p=t.scrollLeft,u=t.scrollLeft+t.offsetWidth,g=t.scrollTop,k=t.scrollTop+t.offsetHeight;(i==="horizontal"||i==="both")&&(l<p?t.scrollTo({left:l,behavior:a}):l+e.clientWidth>u&&t.scrollTo({left:l-t.offsetWidth+e.clientWidth,behavior:a})),(i==="vertical"||i==="both")&&(n<g?t.scrollTo({top:n,behavior:a}):n+e.clientHeight>k&&t.scrollTo({top:n-t.offsetHeight+e.clientHeight,behavior:a}))}var wo=c`
  .icon-button {
    border-radius: 0;
    color: currentColor;
    font-size: inherit;
...
`,Bo=0,Pe=class extends y{constructor(){super(...arguments),this.attrId=++Bo,this.componentId=`syn-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return d`
      <slot
        part="base"
        class=${v({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}};Pe.styles=[z,qo,No];o([s({reflect:!0})],Pe.prototype,"name",2);o([s({type:Boolean,reflect:!0})],Pe.prototype,"active",2);o([h("active")],Pe.prototype,"handleActiveChange",1);var Po="syn-tab-panel";Pe.define("syn-tab-panel");w({displayName:"SynTabPanel",elementClass:Pe,events:{},react:x,tagName:Po});var Ro=c`
  /* Write custom CSS here */
...
`,Ho=0,de=class extends y{constructor(){super(...arguments),this.localize=new N(this),this.attrId=++Ho,this.componentId=`syn-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}handleCloseClick(e){e.stopPropagation(),this.emit("syn-close")}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false"),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,d`
      <div
        part="base"
...
`,Le=class extends y{constructor(){super(...arguments),this.localize=new N(this),this.size="medium",this.removable=!1}handleRemoveClick(){this.emit("syn-remove")}render(){return d`
      <span
        part="base"
...
`,fe=class extends y{constructor(){super(),this.checked=!1,this.hasFocus=!1,this.size="medium",this.disabled=!1,this.handleBlur=()=>{this.hasFocus=!1,this.emit("syn-blur")},this.handleClick=()=>{this.disabled||(this.checked=!0)},this.handleFocus=()=>{this.hasFocus=!0,this.emit("syn-focus")},this.addEventListener("blur",this.handleBlur),this.addEventListener("click",this.handleClick),this.addEventListener("focus",this.handleFocus)}connectedCallback(){super.connectedCallback(),this.setInitialAttributes()}setInitialAttributes(){this.setAttribute("role","radio"),this.setAttribute("tabindex","-1"),this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleCheckedChange(){this.setAttribute("aria-checked",this.checked?"true":"false"),this.setAttribute("tabindex",this.checked?"0":"-1")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}render(){return d`
    ...
    `}};fe.styles=[z,ya,fa];fe.dependencies={"syn-icon":B};o([b()],fe.prototype,"checked",2);o([b()],fe.prototype,"hasFocus",2);o([s()],fe.prototype,"value",2);o([s({reflect:!0})],fe.prototype,"size",2);o([s({type:Boolean,reflect:!0})],fe.prototype,"disabled",2);o([h("checked")],fe.prototype,"handleCheckedChange",1);o([h("disabled",{waitUntilFirstUpdate:!0})],fe.prototype,"handleDisabledChange",1);var va="syn-radio";fe.define("syn-radio");w({displayName:"SynRadio",elementClass:fe,events:{onSynBlur:"syn-blur",onSynFocus:"syn-focus"},react:x,tagName:va});var ba=c`
  :host {
...
`,gt=class extends y{constructor(){super(...arguments),this.subdivision=!1}render(){return d`
      <div
...
`,T,Q,Je,Ne,dt,Ee,A,et,Et,Mt,xi,wi,ut,it,ot,zi,ki,at,Ci,Si,$i,j=class extends y{constructor(){super(),xe(this,A),this.name="",this.label="",this.helpText="",this.disabled=!1,this.min=0,this.max=100,this.step=1,this.size="medium",this.tooltipPlacement="top",this.restrictMovement=!1,this.defaultValue="0",this.form="",this.hasSlotController=new W(this,"help-text","label","prefix","suffix","ticks"),this.formControlController=new be(this,{assumeInteractionOn:["syn-change"]}),this.localize=new N(this),xe(this,T,[0]),xe(this,Q,new Map),xe(this,Je,!1),xe(this,Ne,""),xe(this,dt),xe(this,Ee,[]),this.tooltipFormatter=this.localize.number.bind(this.localize)}set value(e){ae(this,T,e?e.split(" ").map(t=>+t).sort(Ae):[])}get value(){return _(this,T).slice().sort(Ae).join(" ")}set valueAsArray(e){const t=_(this,T);ae(this,T,Array.isArray(e)?e.slice().sort(Ae):e||[]),Qe(t,_(this,T))&&this.requestUpdate("value",t.join(" "))}get valueAsArray(){return[..._(this,T)].sort(Ae)}firstUpdated(){this.formControlController.updateValidity(),ae(this,Ee,Array.from(_(this,T))),this.thumbs.forEach(e=>{const t=e.parentElement;t.updateComplete.then(()=>{const i=t.shadowRoot.querySelector(".tooltip__body");i?.setAttribute("aria-hidden","true")})})}willUpdate(e){super.willUpdate(e),this.min>this.max&&([this.min,this.max]=[this.max,this.min]),this.step>this.max-this.min&&(this.step=this.max-this.min),this.step<=0&&(this.step=1);const t=_(this,T).map(i=>{if(i<=this.min)return this.min;if(i>=this.max)return this.max;const a=this.min+this.step*Math.round((i-this.min)/this.step);return a>this.max?this.max:a});Qe(_(this,T),t)&&ae(this,T,t)}updated(e){super.updated(e);for(const t of this.thumbs){const i=+t.dataset.rangeId;_(this,Q).has(i)&&V(this,A,it).call(this,t,_(this,Q).get(i))}V(this,A,ot).call(this)}focus(e){const t=this.thumbs.item(0);t?t.focus(e):super.focus(e)}checkValidity(){if(this.disabled)return!0;const e=!_(this,Ne);return e||this.formControlController.emitInvalidEvent(),e}reportValidity(){if(this.disabled)return!0;const e=this.validity.valid;return this.formControlController.setValidity(e),this.validationInput.hidden=!0,clearTimeout(_(this,dt)),e||(this.validationInput.hidden=!1,this.validationInput.reportValidity(),ae(this,dt,setTimeout(()=>{this.validationInput.hidden=!0},1e4))),e}setCustomValidity(e){ae(this,Ne,e),this.validationInput.setCustomValidity(e),this.formControlController.updateValidity()}getForm(){return this.formControlController.getForm()}get validity(){return _(this,Ne)?mi:tt}get validationMessage(){return _(this,Ne)}renderThumbs(e){const t=_(this,T).length>1;return _(this,Q).clear(),_(this,T).map((i,a)=>{const r=a+1;_(this,Q).set(r,i);const n=`thumb-${r}`;let l="",p="";return t?(p=e?`label aria-label-hidden ${n}`:`aria-label-hidden ${n}`,a===0?l=`${this.localize.term("rangeMin")} (${this.tooltipFormatter(i)})`:a===_(this,T).length-1?l=`${this.localize.term("rangeMax")} (${this.tooltipFormatter(i)})`:l=this.tooltipFormatter(i)):p=e?"label aria-label-hidden":"",d`
        ...
        >
          <div
            ...
            role="slider"
            tabindex="${this.disabled?-1:0}"
            @pointerdown=${V(this,A,xi)}
            @pointermove=${V(this,A,wi)}
            @pointerup=${V(this,A,ut)}
            @pointercancel=${V(this,A,ut)}
            @pointerleave=${V(this,A,ut)}
            @keydown=${V(this,A,zi)}
            @focus=${V(this,A,Ci)}
          ></div>
        </syn-tooltip>
      `})}render(){const e=this.hasSlotController.test("label"),t=this.hasSlotController.test("help-text"),i=this.hasSlotController.test("prefix"),a=this.hasSlotController.test("suffix"),r=this.label?!0:!!e,n=this.helpText?!0:!!t;return V(this,A,$i).call(this),d`
      <div
        part="form-control"
    ...
    `}};T=new WeakMap;Q=new WeakMap;Je=new WeakMap;Ne=new WeakMap;dt=new WeakMap;Ee=new WeakMap;A=new WeakSet;et=function(){return this.localize.dir()==="rtl"};Et=function(e){if(this.disabled)return;const{clientX:t}=e,i=Array.from(this.thumbs),a=_i(this.baseDiv,t,_(this,A,et)),r=this.step/(this.max-this.min),n=this.min+this.step*Math.round(a/r),l=i.reduce((g,k)=>{const P=_(this,Q).get(+k.dataset.rangeId),Se=_(this,Q).get(+g.dataset.rangeId),F=Math.abs(P-n),H=Math.abs(Se-n);return F===H?P<n?k:g:F<H?k:g}),p=+l.dataset.rangeId;if(!p)return;_(this,Q).set(p,n),V(this,A,it).call(this,l,n);const u=_(this,T);ae(this,T,Array.from(_(this,Q).values())),V(this,A,ot).call(this),Qe(u,_(this,T))&&(ae(this,Ee,Array.from(_(this,T))),this.emit("syn-input"),this.emit("syn-change"))};Mt=function(e,t){const i=this.valueAsArray,r=Array.from(this.thumbs).indexOf(e),n=i[r-1]||this.min,l=i[r+1]||this.max,p=t<n||t>l;return{finalValue:Math.max(n,Math.min(l,t)),isRestricted:p,nextValue:l,prevValue:n}};xi=async function(e){if(this.disabled)return;const t=e.target;V(this,A,at).call(this,t),t.dataset.pointerId&&t.releasePointerCapture(+t.dataset.pointerId),t.dataset.pointerId=e.pointerId.toString(),t.setPointerCapture(e.pointerId),t.classList.add("grabbed"),await t.parentElement.show()};wi=function(e){if(this.disabled)return;const t=e.target,i=+t.dataset.rangeId;if(!_(this,Q).has(i)||(t.dataset.pointerId?+t.dataset.pointerId:null)!==e.pointerId)return;const r=_i(this.baseDiv,e.clientX,_(this,A,et)),n=this.step/(this.max-this.min);let l=this.min+this.step*Math.round(r/n);if(this.emit("syn-move",{cancelable:!0,detail:{element:t,value:l}}).defaultPrevented)return;if(this.restrictMovement){const g=V(this,A,Mt).call(this,t,l);g.isRestricted?(l=g.finalValue,t.style.zIndex=(3+this.thumbs.length).toFixed(0)):t.style.zIndex="3"}_(this,Q).set(i,l),V(this,A,it).call(this,t,l);const u=_(this,T);ae(this,T,Array.from(_(this,Q).values())),V(this,A,ot).call(this),Qe(u,_(this,T))&&this.emit("syn-input")};ut=async function(e){const t=e.target;!t.dataset.pointerId||e.pointerId!==+t.dataset.pointerId||(t.classList.remove("grabbed"),t.releasePointerCapture(e.pointerId),delete t.dataset.pointerId,Qe(_(this,Ee),_(this,T))&&(ae(this,Ee,Array.from(_(this,T))),this.emit("syn-change")),await t.parentElement.hide())};it=function(e,t){e.setAttribute("aria-valuenow",t.toString()),e.setAttribute("aria-valuetext",this.tooltipFormatter(t));const i=(t-this.min)/(this.max-this.min);e.style.insetInlineStart=`calc( ${100*i}% - var(--full-thumb-size) / 2 )`,V(this,A,at).call(this,e)};ot=function(){const{activeTrack:e}=this;if(!e)return;if(this.min===this.max){e.style.insetInlineStart="0%",e.style.insetInlineEnd="0%";return}if(_(this,T).length===1){const r=getComputedStyle(this).getPropertyValue("--track-active-offset")||"0%",n=100*(_(this,T)[0]-this.min)/(this.max-this.min);e.style.insetInlineStart=`min(${r}, ${n}%)`,e.style.insetInlineEnd=`min(calc(100% - ${r}), calc(100% - ${n}%))`;return}const t=_(this,T).slice().sort(Ae),i=100*(t[0]-this.min)/(this.max-this.min),a=100*(t[t.length-1]-this.min)/(this.max-this.min);e.style.insetInlineStart=`${i}%`,e.style.insetInlineEnd=`calc(100% - ${a}%)`};zi=function(e){const t=e.target,i=+t.dataset.rangeId,a=_(this,Q).get(i);if(a===void 0)return;let r=a;switch(e.key){case"ArrowUp":case"Up":r=Math.min(a+this.step,this.max);break;case"ArrowDown":case"Down":r=Math.max(a-this.step,this.min);break;case"ArrowLeft":case"Left":r=_(this,A,et)?Math.min(a+this.step,this.max):Math.max(a-this.step,this.min);break;case"ArrowRight":case"Right":r=_(this,A,et)?Math.max(a-this.step,this.min):Math.min(a+this.step,this.max);break;case"PageUp":r=Math.min(a+(this.max-this.min)/5,this.max);break;case"PageDown":r=Math.max(a-(this.max-this.min)/5,this.min);break;case"Home":r=this.min;break;case"End":r=this.max;break;default:return}if(r!==a){if(this.emit("syn-move",{cancelable:!0,detail:{element:t,value:r}}).defaultPrevented)return;if(this.restrictMovement){const l=V(this,A,Mt).call(this,t,r);l.isRestricted&&(r=l.finalValue)}V(this,A,it).call(this,t,r),_(this,Q).set(i,r),ae(this,T,Array.from(_(this,Q).values())),V(this,A,ot).call(this),V(this,A,at).call(this,t),ae(this,Ee,Array.from(_(this,T))),this.emit("syn-input"),this.emit("syn-change")}e.stopPropagation(),e.preventDefault()};ki=function(e){var t;e.relatedTarget&&((t=this.shadowRoot)!=null&&t.contains(e.relatedTarget))||(this.emit("syn-blur"),ae(this,Je,!1))};at=function(e){if(this.tooltipPlacement==="none")return;const t=+e.dataset.rangeId;if(!_(this,Q).has(t))return;const i=_(this,Q).get(t),a=e.parentElement;a.content=this.tooltipFormatter(i)};Ci=function(e){var t;if(this.disabled)return;_(this,Je)||(ae(this,Je,!0),this.emit("syn-focus"));const i=e.target;(t=i?.dataset)!=null&&t.rangeId&&V(this,A,at).call(this,i)};Si=function(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)};$i=function(){var e,t,i,a;const r=this.hasSlotController.test("ticks"),n=this.hasSlotController.test("prefix"),l=this.hasSlotController.test("suffix");if(!r)return;let p=(t=(e=this.shadowRoot)==null?void 0:e.querySelector(".ticks"))==null?void 0:t.clientHeight;if(p){if(p+=2,p/=2,n){const u=(i=this.shadowRoot)==null?void 0:i.querySelector(".input__prefix");u.style.transform=`translateY(-${p}px)`}if(l){const u=(a=this.shadowRoot)==null?void 0:a.querySelector(".input__suffix");u.style.transform=`translateY(-${p}px)`}}};j.styles=[z,we,ze,xa];j.dependencies={"syn-tooltip":G};o([s()],j.prototype,"name",2);o([s()],j.prototype,"label",2);o([s({attribute:"help-text"})],j.prototype,"helpText",2);o([s({reflect:!0,type:Boolean})],j.prototype,"disabled",2);o([s({type:Number})],j.prototype,"min",2);o([s({type:Number})],j.prototype,"max",2);o([s({type:Number})],j.prototype,"step",2);o([s({reflect:!0})],j.prototype,"size",2);o([s({attribute:"tooltip-placement",type:String})],j.prototype,"tooltipPlacement",2);o([s({type:String})],j.prototype,"value",1);o([s({attribute:"restrict-movement",type:Boolean})],j.prototype,"restrictMovement",2);o([Te()],j.prototype,"defaultValue",2);o([s({reflect:!0})],j.prototype,"form",2);o([s({attribute:!1})],j.prototype,"tooltipFormatter",2);o([m(".input__wrapper")],j.prototype,"baseDiv",2);o([m(".active-track")],j.prototype,"activeTrack",2);o([Qi(".thumb")],j.prototype,"thumbs",2);o([m(".range__validation-input")],j.prototype,"validationInput",2);var wa="syn-range";j.define("syn-range");w({displayName:"SynRange",elementClass:j,events:{onSynBlur:"syn-blur",onSynChange:"syn-change",onSynFocus:"syn-focus",onSynInput:"syn-input",onSynInvalid:"syn-invalid",onSynMove:"syn-move"},react:x,tagName:wa});var za=c`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`,_e=class extends y{constructor(){super(...arguments),this.vertical=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}};_e.styles=[z,Oa,$a];o([s({type:Boolean,reflect:!0})],_e.prototype,"vertical",2);o([h("vertical")],_e.prototype,"handleVerticalChange",1);var Aa=c`
	/* stylelint-disable */
  :host {
    --size: 25rem;
...
`,st=class extends y{constructor(){super(...arguments),this.localize=new N(this)}render(){return d`
      <svg part="base" class="spinner" role="progressbar" aria-label=${this.localize.term("loading")}>
        <circle class="spinner__track"></circle>
        <circle class="spinner__indicator"></circle>
      </svg>
    `}};st.styles=[z,qa,Na];var Ba="syn-spinner";st.define("syn-spinner");w({displayName:"SynSpinner",elementClass:st,events:{},react:x,tagName:Ba});var Pa=c`
  :host {
    border-radius: 0;
  }
...
`,Re=class extends y{constructor(){super(...arguments),this.hasMenuItemsWithCheckmarks=!1,this.updateCheckMarksByChildPropChange=e=>{e.stopImmediatePropagation(),this.handleUpdateCheckmarks(this.getAllItems())}}handleUpdateCheckmarks(e){this.hasMenuItemsWithCheckmarks=e.some(t=>t.type==="checkbox"||t.loading)}disconnectedCallback(){this.removeEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu"),this.addEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}handleClick(e){const t=["menuitem","menuitemcheckbox"],i=e.composedPath(),a=i.find(p=>{var u;return t.includes(((u=p?.getAttribute)==null?void 0:u.call(p,"role"))||"")});if(!a||i.find(p=>{var u;return((u=p?.getAttribute)==null?void 0:u.call(p,"role"))==="menu"})!==this)return;const l=a;l.type==="checkbox"&&(l.checked=!l.checked),this.emit("syn-select",{detail:{item:l}})}handleKeyDown(e){if(e.key==="Enter"||e.key===" "){const t=this.getCurrentItem();e.preventDefault(),e.stopPropagation(),t?.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(e.key)){const t=this.getAllItems(),i=this.getCurrentItem();let a=i?t.indexOf(i):0;t.length>0&&(e.preventDefault(),e.stopPropagation(),e.key==="ArrowDown"?a++:e.key==="ArrowUp"?a--:e.key==="Home"?a=0:e.key==="End"&&(a=t.length-1),a<0&&(a=t.length-1),a>t.length-1&&(a=0),this.setCurrentItem(t[a]),t[a].focus())}}handleMouseDown(e){const t=e.target;this.isMenuItem(t)&&this.setCurrentItem(t)}handleSlotChange(){const e=this.getAllItems();this.handleUpdateCheckmarks(e),e.length>0&&this.setCurrentItem(e[0])}isMenuItem(e){var t;return e.tagName.toLowerCase()==="syn-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes((t=e.getAttribute("role"))!=null?t:"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>!(e.inert||!this.isMenuItem(e)))}getCurrentItem(){return this.getAllItems().find(e=>e.getAttribute("tabindex")==="0")}setCurrentItem(e){this.getAllItems().forEach(i=>{i.setAttribute("tabindex",i===e?"0":"-1")})}render(){return d`
      ...
      ></slot>
    `}};Re.styles=[z,Ra,Pa];o([m("slot")],Re.prototype,"defaultSlot",2);o([b()],Re.prototype,"hasMenuItemsWithCheckmarks",2);var ja="syn-menu";Re.define("syn-menu");w({displayName:"SynMenu",elementClass:Re,events:{onSynSelect:"syn-select"},react:x,tagName:ja});var Ha=c`
  /**
...
`,je=class extends y{constructor(){super(...arguments),this.localize=new N(this),this.value=0,this.indeterminate=!1,this.label=""}render(){return d`
      <div
        part="base"
...
`,Me=class extends y{constructor(){super(...arguments),this.localize=new N(this),this.value=0,this.label=""}updated(e){if(super.updated(e),e.has("value")){const t=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),i=2*Math.PI*t,a=i-this.value/100*i;this.indicatorOffset=`${a}px`}}render(){return d`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
    ...
    `}};Me.styles=[z,ls,ps];o([m(".progress-ring__indicator")],Me.prototype,"indicator",2);o([b()],Me.prototype,"indicatorOffset",2);o([s({type:Number,reflect:!0})],Me.prototype,"value",2);o([s()],Me.prototype,"label",2);var cs="syn-progress-ring";Me.define("syn-progress-ring");w({displayName:"SynProgressRing",elementClass:Me,events:{},react:x,tagName:cs});var ds="syn-dropdown";te.define("syn-dropdown");w({displayName:"SynDropdown",elementClass:te,events:{onSynShow:"syn-show",onSynAfterShow:"syn-after-show",onSynHide:"syn-hide",onSynAfterHide:"syn-after-hide"},react:x,tagName:ds});var us=c`
  :host {
    display: block;
  }
...
`,fs=B;B.define("syn-icon");var Oe=class extends y{constructor(){super(...arguments),this.hasSlotController=new W(this,"[default]","logo","label","meta-navigation","navigation"),this.localize=new N(this),this.label="",this.burgerMenu="hidden"}toggleBurgerMenu(){switch(this.burgerMenu){case"closed":this.burgerMenu="open";break;case"open":this.burgerMenu="closed";break}}handleBurgerMenuToggle(){this.sideNav&&!this.sideNav.rail&&(this.sideNav.open=!this.sideNav.open),this.toggleBurgerMenu()}updateBurgerMenuBasedOnSideNav(){this.sideNav&&(this.sideNav.rail?this.burgerMenu="hidden":this.burgerMenu=this.sideNav.open?"open":"closed")}handleBurgerMenu(){const e=`syn-burger-menu-${this.burgerMenu}`;this.emit(e)}connectedCallback(){super.connectedCallback(),this.mutationObserver=new MutationObserver(()=>this.updateBurgerMenuBasedOnSideNav())}firstUpdated(){const e=document.querySelector("syn-side-nav");this.connectSideNavigation(e)}disconnectedCallback(){super.disconnectedCallback(),this.mutationObserver.disconnect()}connectSideNavigation(e){this.mutationObserver.disconnect(),this.sideNav=e||document.querySelector("syn-side-nav"),this.sideNav&&(this.updateBurgerMenuBasedOnSideNav(),this.mutationObserver.observe(this.sideNav,{attributeFilter:["open","rail"],attributes:!0}))}render(){const e=this.hasSlotController.test("navigation"),t=this.burgerMenu!=="hidden";return J`
    ...
    `}};Oe.styles=[z,gs];Oe.dependencies={"syn-icon":fs};o([s()],Oe.prototype,"label",2);o([s({attribute:"burger-menu",reflect:!0})],Oe.prototype,"burgerMenu",2);o([b()],Oe.prototype,"sideNav",2);o([h("burgerMenu",{waitUntilFirstUpdate:!0})],Oe.prototype,"handleBurgerMenu",1);var ys="syn-header";Oe.define("syn-header");w({displayName:"SynHeader",elementClass:Oe,events:{onSynBurgerMenuClosed:"syn-burger-menu-closed",onSynBurgerMenuHidden:"syn-burger-menu-hidden",onSynBurgerMenuOpen:"syn-burger-menu-open"},react:x,tagName:ys});var vs="syn-icon-button";R.define("syn-icon-button");w({displayName:"SynIconButton",elementClass:R,events:{onSynBlur:"syn-blur",onSynFocus:"syn-focus"},react:x,tagName:vs});var bs="syn-icon";B.define("syn-icon");var _s=w({displayName:"SynIcon",elementClass:B,events:{onSynLoad:"syn-load",onSynError:"syn-error"},react:x,tagName:bs}),xs=c`
...
`,ft=class extends y{render(){return d`
    ...
    `}};ft.styles=[z,Ts,Es];ft.dependencies={"syn-divider":_e};var Ls="syn-menu-label";ft.define("syn-menu-label");w({displayName:"SynMenuLabel",elementClass:ft,events:{},react:x,tagName:Ls});var Ds="syn-button";L.define("syn-button");w({displayName:"SynButton",elementClass:L,events:{onSynBlur:"syn-blur",onSynFocus:"syn-focus",onSynInvalid:"syn-invalid"},react:x,tagName:Ds});var Ms=c`
  :host {
...
`,yt=class extends y{constructor(){super(...arguments),this.hasSlotController=new W(this,"footer","header","image"),this.sharp=!1}render(){return d`
      <div
        part="base"
    ...
    `}};yt.styles=[z,Fs,Ms];o([s({type:Boolean,reflect:!0})],yt.prototype,"sharp",2);var Vs="syn-card";yt.define("syn-card");w({displayName:"SynCard",elementClass:yt,events:{},react:x,tagName:Vs});var Ns=c`
  .checkbox__control {
    border-radius: var(--syn-input-border-radius-small);
  }
...
`,vt=class extends y{constructor(){super(...arguments),this.localize=new N(this),this.variant="primary"}render(){return d`
      <span
        part="base"
...
`,Ce=class extends y{constructor(){super(...arguments),this.hasSlotController=new W(this,"prefix","suffix"),this.renderType="button",this.rel="noreferrer noopener"}setRenderType(){const e=this.defaultSlot.assignedElements({flatten:!0}).filter(t=>t.tagName.toLowerCase()==="syn-dropdown").length>0;if(this.href){this.renderType="link";return}if(e){this.renderType="dropdown";return}this.renderType="button"}hrefChanged(){this.setRenderType()}handleSlotChange(){this.setRenderType()}render(){return d`
    ...
    `}};Ce.styles=[z,cr,pr];o([m("slot:not([name])")],Ce.prototype,"defaultSlot",2);o([b()],Ce.prototype,"renderType",2);o([s()],Ce.prototype,"href",2);o([s()],Ce.prototype,"target",2);o([s()],Ce.prototype,"rel",2);o([h("href",{waitUntilFirstUpdate:!0})],Ce.prototype,"hrefChanged",1);var dr="syn-breadcrumb-item";Ce.define("syn-breadcrumb-item");w({displayName:"SynBreadcrumbItem",elementClass:Ce,events:{},react:x,tagName:dr});var ur=c`
  /* Write custom CSS here */
`,mr=c`
	/* stylelint-disable */
  .breadcrumb {
