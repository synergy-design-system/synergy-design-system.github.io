import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,h as n,t as r}from"./lit-DWg8XNs3.js";import{D as i,T as ee,d as te,f as a,g as ne,u as re}from"./iframe-CVaCVGtH.js";import{n as ie,t as o}from"./class-map-BVGUkHwV.js";import{r as s,t as c}from"./slot-DgcqpP0-.js";import{r as l,t as ae}from"./if-defined-iVX0Q9dp.js";import{n as oe,t as se}from"./localize-CzgwcyM2.js";import{a as ce,f as u,i as le,n as ue,o as de,r as d,s as f,t as fe,y as p}from"./synergy-element-CsptVtzA.js";import{n as m,t as h}from"./watch-I6gMK-uE.js";import{t as pe}from"./button-CUvYiMKB.js";import{a as me,i as he,n as g,o as ge,r as _e}from"./component-CllRTPI1.js";import{n as ve,t as _}from"./taggedTemplateLiteral-pWa2IaV6.js";import{a as v,i as y,l as b,n as x,o as S,t as C}from"./animation-registry-CAtzdG-I.js";import{n as w,t as T}from"./event-gTfeuJtF.js";import{n as E,t as D}from"./closeActiveElement-CbfZj3Se.js";import{n as O,t as k}from"./icon-button.component-WGC78dYU.js";import{t as A}from"./icon-button-CUNxpVjV.js";import{i as j,n as M,t as N}from"./scroll-t7qKpqAH.js";import{n as P,t as F}from"./modal-CDz5YPUc.js";import{t as ye}from"./input-qt3cotBt.js";var I,be=e((()=>{r(),I=n`
  :host {
    --width: 31rem;
...
`})),L,R=e((()=>{o(),r(),ae(),f(),S(),E(),x(),s(),se(),N(),T(),h(),de(),P(),ue(),O(),be(),le(),L=class extends fe{constructor(...e){super(...e),this.hasSlotController=new c(this,`footer`),this.localize=new oe(this),this.modal=new F(this),this.open=!1,this.label=``,this.noHeader=!1,this.handleDocumentKeyDown=e=>{e.key===`Escape`&&this.modal.isActive()&&this.open&&(e.stopPropagation(),this.requestClose(`keyboard`))}}static{this.styles=[ce,I]}static{this.dependencies={"syn-icon-button":k}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),M(this))}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate(),j(this),this.removeOpenListeners()}requestClose(e){if(this.emit(`syn-request-close`,{cancelable:!0,detail:{source:e}}).defaultPrevented){let e=C(this,`dialog.denyClose`,{dir:this.localize.dir()});v(this.panel,e.keyframes,e.options);return}this.hide()}addOpenListeners(){`CloseWatcher`in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose(`keyboard`)):document.addEventListener(`keydown`,this.handleDocumentKeyDown)}removeOpenListeners(){this.closeWatcher?.destroy(),document.removeEventListener(`keydown`,this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit(`syn-show`),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),M(this);let e=this.querySelector(`[autofocus]`);e&&e.removeAttribute(`autofocus`),await Promise.all([b(this.dialog),b(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit(`syn-initial-focus`,{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute(`autofocus`,``)});let t=C(this,`dialog.show`,{dir:this.localize.dir()}),n=C(this,`dialog.overlay.show`,{dir:this.localize.dir()});await Promise.all([v(this.panel,t.keyframes,t.options),v(this.overlay,n.keyframes,n.options)]),this.emit(`syn-after-show`)}else{D(this),this.emit(`syn-hide`),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([b(this.dialog),b(this.overlay)]);let e=C(this,`dialog.hide`,{dir:this.localize.dir()}),t=C(this,`dialog.overlay.hide`,{dir:this.localize.dir()});await Promise.all([v(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),v(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,j(this);let n=this.originalTrigger;typeof n?.focus==`function`&&setTimeout(()=>n.focus()),this.emit(`syn-after-hide`)}}async show(){if(!this.open)return this.open=!0,w(this,`syn-after-show`)}async hide(){if(this.open)return this.open=!1,w(this,`syn-after-hide`)}render(){return t`
    ...
    `}},d([u(`.dialog`)],L.prototype,`dialog`,void 0),d([u(`.dialog__panel`)],L.prototype,`panel`,void 0),d([u(`.dialog__overlay`)],L.prototype,`overlay`,void 0),d([p({reflect:!0,type:Boolean})],L.prototype,`open`,void 0),d([p({reflect:!0})],L.prototype,`label`,void 0),d([p({attribute:`no-header`,reflect:!0,type:Boolean})],L.prototype,`noHeader`,void 0),d([m(`open`,{waitUntilFirstUpdate:!0})],L.prototype,`handleOpenChange`,null),y(`dialog.show`,{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:`ease`}}),y(`dialog.hide`,{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:`ease`}}),y(`dialog.denyClose`,{keyframes:[{offset:0,transform:`translateX(0)`},{offset:.32,transform:`translateX(calc(var(--syn-spacing-x-small) * -1))`},{offset:.6,transform:`translateX(var(--syn-spacing-2x-small))`},{offset:.82,transform:`translateX(calc(var(--syn-spacing-3x-small) * -1))`},{offset:1,transform:`translateX(0)`}],options:{duration:250,easing:`cubic-bezier(0.25, 0.1, 0.25, 1)`}}),y(`dialog.overlay.show`,{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}}),y(`dialog.overlay.hide`,{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}})})),xe=e((()=>{R(),R(),L.define(`syn-dialog`)})),Se,Ce,we,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=e((()=>{r(),ee(),xe(),pe(),A(),ye(),_e(),te(),ne(),ve(),{args:z,argTypes:B}=he(`syn-dialog`),{overrideArgs:V}=me(`syn-dialog`),{generateTemplate:H}=ge(`syn-dialog`),U=e=>`
...
`,W=e=>t(Se||=_([`
  ...
  <\/script>
`]),e,e),G={args:V([{name:`open`,type:`attribute`,value:!0},{name:`label`,type:`attribute`,value:`Dialog`},{name:`default`,type:`slot`,value:`Lorem ipsum dolor sit amet, consectetur adipiscing elit.`},{name:`footer`,type:`slot`,value:U(`default-close-icon`)}],z),argTypes:B,component:`syn-dialog`,parameters:{chromatic:{disableSnapshot:!1,modes:a},design:re(`42207-348565`),docs:{description:{component:g(`dialog`,`default`)},story:{height:`400px`}}},tags:[`Structure`],title:`Components/syn-dialog`},K={parameters:{chromatic:{disableSnapshot:!1},controls:{disable:!1},docs:{description:{story:g(`dialog`,`default`)}}},render:e=>t`
    ${H({args:e})}
    ${W(`dialog-default-story-opener`)}
  `},q={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:g(`dialog`,`custom-width`)}}},render:()=>t`
    <syn-dialog open label="Dialog" style="--width: 50vw;">
      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
      ${i(U(`dialog-custom-width`))}
    </syn-dialog>
    ${W(`dialog-custom-width-story-opener`)}
  `},J={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:g(`dialog`,`scrolling`)}}},render:()=>t`
    <syn-dialog open label="Dialog">
      ...
      ${i(U(`dialog-scrolling`))}
    </syn-dialog>
    ${W(`dialog-scrolling-story-opener`)}
  `},Y={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:g(`dialog`,`header-actions`)}}},render:()=>t(Ce||=_([`
    <syn-dialog open label="Dialog">
    ...
    <\/script>
    `,`
  `]),i(U(`dialog-header-actions`)),W(`dialog-header-actions-story-opener`))},X={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:g(`dialog`,`prevent-closing`)}}},render:()=>t(we||=_([`
    ...
    <\/script>
    `,`
  `]),i(U(`dialog-deny-close-actions`)),W(`dialog-deny-close-story-opener`))},Z={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:g(`dialog`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-dialog`);t&&(t.open=!0)},render:()=>t`
    <syn-dialog label="Dialog">
      <syn-input autofocus placeholder="I will have focus when the dialog is opened"></syn-input>
      ${i(U(`dialog-initial-focus-actions`))}
    </syn-dialog>
