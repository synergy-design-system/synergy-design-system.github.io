import{i as e}from"./preload-helper-xPQekRTU.js";import{Ht as t,I as n,It as r,L as i,R as ee,Ut as a,Vt as o,d as s,f as te,g as ne,qt as c,u as re,z as ie}from"./iframe-BLAzlACc.js";import{n as ae,t as l}from"./class-map-C6rhpuKM.js";import{r as u,t as d}from"./if-defined-DgNo7cOm.js";import{n as f,t as p}from"./localize-CzgwcyM2.js";import{a as oe,i as m,n as h,o as g,r as _,s as v,t as se,y}from"./synergy-element-A58418dp.js";import{t as ce}from"./button-Ci1LHfIR.js";import{t as le}from"./icon-BFcjyE5U.js";import{a as b,i as x,n as S,o as C,r as w,t as T}from"./component-RhnClGwj.js";import{n as E,t as D}from"./taggedTemplateLiteral-pWa2IaV6.js";var O,k,A,j=e((()=>{a(),ee(),O=`important`,k=` !important`,A=n(class extends i{constructor(e){if(super(e),e.type!==ie.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(k);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?O:``):n[e]=r}}return o}})})),M=e((()=>{j()})),N,P=e((()=>{r(),N=c`
	/* stylelint-disable */
  :host {
    --height: 1rem;
...
`})),L,R=e((()=>{l(),r(),d(),p(),v(),M(),g(),h(),P(),I(),m(),L=class extends se{constructor(...e){super(...e),this.localize=new f(this),this.value=0,this.indeterminate=!1,this.label=``}static{this.styles=[oe,N,F]}render(){return t`
      <div
        part="base"
        class=${ae({"progress-bar":!0,"progress-bar--indeterminate":this.indeterminate,"progress-bar--rtl":this.localize.dir()===`rtl`})}
        role="progressbar"
        title=${u(this.title)}
    ...
    `}},_([y({type:Number,reflect:!0})],L.prototype,`value`,void 0),_([y({type:Boolean,reflect:!0})],L.prototype,`indeterminate`,void 0),_([y()],L.prototype,`label`,void 0)})),z=e((()=>{R(),R(),L.define(`syn-progress-bar`)})),B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=e((()=>{z(),ce(),le(),r(),w(),s(),ne(),E(),{args:V,argTypes:H}=x(`syn-progress-bar`),{overrideArgs:U}=b(`syn-progress-bar`),{generateTemplate:W}=C(`syn-progress-bar`),G={args:U({name:`value`,type:`attribute`,value:33.3},V),argTypes:H,component:`syn-progress-bar`,parameters:{chromatic:{modes:te},design:re(`41203-297162`),docs:{description:{component:S(`progress-bar`,`default`)}}},tags:[`Feedback`],title:`Components/syn-progress-bar`},K={parameters:{docs:{description:{story:S(`progress-bar`,`default`)}}},render:e=>W({args:e})},q={parameters:{docs:{description:{story:S(`progress-bar`,`labels`)}}},render:()=>t`
