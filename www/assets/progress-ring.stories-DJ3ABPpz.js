import{k as x,c as a,C as k,d as S}from"./iframe-hncc6fn8.js";import{L as w}from"./controller-0nuky388.js";import{S as z,c as R,n as _}from"./synergy-element-ZP8Aphe2.js";import{r as C}from"./icon.component-uI_62ALx.js";import{a as D}from"./query-D0jTsbLw.js";import"./button-BLOi7eyP.js";import"./icon-CdTGkBe_.js";import{g as s,a as E,s as B,b as L,c as O}from"./component-BDcZ8_k2.js";import"./preload-helper-PPVm8Dsz.js";import"./watch-CEsCE2EF.js";import"./button.component-CXWNkp-D.js";import"./class-map-J4m71D6f.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./if-defined-Df6Qu0g8.js";import"./spinner.component-CET_LilP.js";import"./decorator-jbWt9cIm.js";import"./functions-DCU90qiI.js";import"./index-3hbeBem-.js";import"./_docs-VWJ8UqMU.js";const P=x`
	/* stylelint-disable */
  :host {
    --size: 128px;
    --track-width: 4px;
...
`;var j=Object.defineProperty,m=(r,t,d,y)=>{for(var e=void 0,v=r.length-1,h;v>=0;v--)(h=r[v])&&(e=h(t,d,e)||e);return e&&j(t,d,e),e};class g extends z{constructor(){super(...arguments),this.localize=new w(this),this.value=0,this.label=""}static{this.styles=[R,P,T]}updated(t){if(super.updated(t),t.has("value")){const d=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),y=2*Math.PI*d,e=y-this.value/100*y;this.indicatorOffset=`${e}px`}}render(){return a`
    ...
    `}}m([D(".progress-ring__indicator")],g.prototype,"indicator");m([C()],g.prototype,"indicatorOffset");m([_({type:Number,reflect:!0})],g.prototype,"value");m([_()],g.prototype,"label");g.define("syn-progress-ring");var f=Object.freeze,A=Object.defineProperty,I=(r,t)=>f(A(r,"raw",{value:f(r.slice())})),b;const{args:M,argTypes:$}=B("syn-progress-ring"),{overrideArgs:V}=O("syn-progress-ring"),{generateTemplate:F}=L("syn-progress-ring"),cr={args:V([{name:"default",type:"slot",value:""},{name:"value",type:"attribute",value:"25"}],M),argTypes:$,component:"syn-progress-ring",parameters:{chromatic:{modes:k},design:S("14207-8709"),docs:{description:{component:s("progress-ring","default")}}},tags:["Feedback"],title:"Components/syn-progress-ring"},o={parameters:{docs:{description:{story:s("progress-ring","default")}}},render:r=>F({args:r})},n={parameters:{docs:{description:{story:s("progress-ring","size")}}},render:()=>a`
