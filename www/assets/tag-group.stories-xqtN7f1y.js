import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{a as n,d as r,n as i,o as a,s as o,t as s}from"./preview-DdzcclEm.js";import{a as c,c as l,t as u}from"./lit-BfcklOOD.js";import{t as d}from"./react-DvlgmmzG.js";import{d as f,f as p,i as m,p as h,u as g}from"./blocks-7PJzwYwY.js";import{t as _}from"./button-BpLoAK9F.js";import{t as v}from"./icon-8cT1hKpd.js";import{t as y}from"./select-CT3sGXd9.js";import{t as b}from"./option-hlWzwvd4.js";import{n as x,r as S}from"./component-BjD7AuVi.js";import{t as C}from"./details-BayOrY2q.js";import{n as w,t as T}from"./menu-item-CnD4-3lh.js";import{t as E}from"./dropdown-CKeLRYI6.js";import{t as D}from"./tag-group-BFT1EVYT.js";import{t as O}from"./tag-Dg8Tp3NV.js";var k,A,j,M,N;t((()=>{k=e(d(),1),h(),u(),s(),S(),a(),r(),_(),C(),E(),w(),T(),b(),y(),D(),O(),v(),A={parameters:{chromatic:{...i?.parameters?.chromatic,disableSnapshot:!1,modes:o},design:n(`16648-52486`),docs:{description:{component:x(`tag-group`,`default`,`templates`)},page:()=>k.createElement(k.Fragment,null,k.createElement(p,null),k.createElement(f,null),k.createElement(m,null),k.createElement(g,{title:``}))}},tags:[`Feedback`,`Tags`,`Filter`],title:`Templates/Tag Group`},j={render:()=>{let e={filters:[{id:`filter-1`,name:`Housing`,options:[`metric`,`rectangular`],selected:[]},{id:`filter-2`,name:`Cable material`,options:[`PUR`,`PVC`],selected:[`PUR`]},{id:`filter-3`,name:`Length of cable`,options:[`0.2 m`,`0.3 m`,`0.7 m`,`0.23 m`,`2 m`],selected:[`0.2 m`,`0.3 m`,`0.7 m`,`0.23 m`]},{id:`filter-4`,name:`Electrical wiring`,options:[`AC 2-wire`,`DC 3-wire`,`DC 4-wire`],selected:[]},{id:`filter-5`,name:`Switching output`,options:[`NPN`,`PNP`],selected:[]},{id:`filter-6`,name:`Connection type`,options:[`Cable, 2-wire`,`Cable, 3-wire`,`Cable, 4-wire`],selected:[`Cable, 3-wire`]}],filtersOpen:!0,isMobile:!1},t=(e,t)=>l`
      <form class="filter-form">
        ...
        ${e.filters.some(e=>e.selected.length>0)?l`
          <div class="filter-tags">
            ${e.filters.filter(e=>e.selected.length>0).map(n=>l`
                <syn-tag-group
    ...
    `,n=document.createElement(`div`);return(()=>{let r,i,a=()=>{c(t(e,r),n)},o=t=>{e={...e,...t},a()},s=()=>{`ResizeObserver`in window&&(i=new ResizeObserver(t=>{if(t.length>0){let n=t[0].contentRect.width<=420;e.isMobile!==n&&o({isMobile:n})}}),setTimeout(()=>{let e=n.querySelector(`.filter-form`);e&&i&&i.observe(e)},0))},l={clearAllFilters:()=>{if(window.confirm(`Möchten Sie wirklich alle Filter entfernen?`)){let t=e.filters.map(e=>({...e,selected:[]}));o({filters:t})}},removeTag:(t,n)=>{let r=e.filters.map(e=>e.id===t?{...e,selected:e.selected.filter(e=>e!==n)}:e);o({filters:r})},toggleFilter:e=>{o({filtersOpen:e})},toggleOption:(t,n)=>{let r=e.filters.map(e=>{if(e.id===t){let t=e.selected.includes(n)?e.selected.filter(e=>e!==n):[...e.selected,n];return{...e,selected:t}}return e});o({filters:r})}};return r=l,a(),s(),{actions:l,cleanup:()=>{i&&i.disconnect()},rerender:a}})(),n}},M={...j,globals:{viewport:{value:`mobile2`}},name:`↳ Tablet`,parameters:{controls:{exclude:[`default`]}}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
  render: () => {
