import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{a as t,d as n,m as r,o as i,p as a,s as o}from"./preview-DXkhgu0Z.js";import{c as s,t as c}from"./lit-BfcklOOD.js";import{t as l}from"./button-DVR7vfNM.js";import{t as u}from"./icon-koM57tMi.js";import{t as d}from"./divider-D3jFTDSr.js";import{a as f,i as p,n as m,o as h,r as g}from"./component-B0n0ooCL.js";import{n as _,t as v}from"./taggedTemplateLiteral-C9cDEsPD.js";import{n as y,t as b}from"./menu-item-Y5fCk6TC.js";import{t as x}from"./dropdown-CEqtLr3e.js";var S,C,w,T,E,D,O,k,A,j,M,N,P,F=e((()=>{a(),c(),x(),d(),y(),b(),l(),u(),g(),i(),n(),_(),{args:C,argTypes:w}=p(`syn-dropdown`),{overrideArgs:T}=f(`syn-dropdown`),{generateTemplate:E}=h(`syn-dropdown`),D={args:T([{name:`default`,type:`slot`,value:`
      ...
      `},{name:`open`,type:`attribute`,value:r()}],C),argTypes:w,component:`syn-dropdown`,parameters:{chromatic:{modes:o},design:t(`41203-538934`),docs:{description:{component:m(`dropdown`,`default`)},story:{height:`250px`}}},tags:[`Form`],title:`Components/syn-dropdown`},O={parameters:{chromatic:{disableSnapshot:!1},controls:{disable:!1},docs:{description:{story:m(`dropdown`,`default`)}}},render:e=>s`
    <div style="position: relative">
      ${E({args:e})}
    </div>
  `},k={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:m(`dropdown`,`selected`)}}},render:()=>s(S||=v([`
    <div style="position: relative">
    ...
    <\/script>
  `]),r())},A={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:m(`dropdown`,`placement`)}}},render:()=>s`
    <div style="position: relative">
  ...
  `},j={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:m(`dropdown`,`distance`)}}},render:()=>s`
    <div style="position: relative">
  ...
  `},M={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:m(`dropdown`,`skidding`)}}},render:()=>s`
    <div style="position: relative">
  ...
  `},N={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:m(`dropdown`,`submenu`)}}},render:()=>s`
    <div style="position: relative">
      <syn-dropdown ?open=${r()}>
        <syn-button slot="trigger" caret>Edit</syn-button>
