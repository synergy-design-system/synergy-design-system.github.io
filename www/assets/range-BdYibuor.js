import{q as Z,x as L}from"./iframe-CW_KonjK.js";import{o as tt}from"./if-defined-qefA8dKN.js";import{c as et,n as f,S as it}from"./synergy-element-BoJA4F0K.js";import{e as st,a as M}from"./query-D0jTsbLw.js";import{e as rt}from"./class-map-Bo2NiYIQ.js";import{d as at}from"./default-value-FKWl7b5r.js";import{F as nt,c as ot,v as lt}from"./form-d9hCJUdr.js";import{H as ht}from"./slot-9EVoRGQc.js";import{L as ct}from"./localize-Dh03wnLC.js";import{f as ut,a as dt}from"./form-control.custom.styles-CoSJASsY.js";import{S as pt}from"./tooltip.component-BLbyQUBM.js";import{e as mt}from"./decorator-CVE5vLu9.js";let ft;function bt(t){return(e,i)=>st(e,i,{get(){return(this.renderRoot??(ft??=document.createDocumentFragment())).querySelectorAll(t)}})}const y=(t,e)=>t-e,w=(t,e)=>{if(t.length!==e.length)return!0;const i=t.slice().sort(y),a=e.slice().sort(y);for(let s=0;s<i.length;s+=1)if(i[s]!==a[s])return!0;return!1},U=(t,e,i)=>{const a=t.getBoundingClientRect(),s=a.width;if(s<=0)return 0;let o=e;return o-=a.left,o<=0?i?1:0:o>=s?i?0:1:(o/=s,i?1-o:o)},vt=Z`
  :host {
    /*
...
`;var yt=Object.defineProperty,gt=Object.getOwnPropertyDescriptor,W=t=>{throw TypeError(t)},d=(t,e,i,a)=>{for(var s=a>1?void 0:a?gt(e,i):e,o=t.length-1,c;o>=0;o--)(c=t[o])&&(s=(a?c(e,i,s):c(s))||s);return a&&s&&yt(e,i,s),s},E=(t,e,i)=>e.has(t)||W("Cannot "+i),r=(t,e,i)=>(E(t,e,"read from private field"),i?i.call(t):e.get(t)),v=(t,e,i)=>e.has(t)?W("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,i),m=(t,e,i,a)=>(E(t,e,"write to private field"),e.set(t,i),i),h=(t,e,i)=>(E(t,e,"access private method"),i),l,p,z,x,V,g,n,S,F,q,D,H,N,T,I,C,X,j,_,G,Y,K;let u=class extends it{constructor(){super(),v(this,n),this.name="",this.label="",this.helpText="",this.disabled=!1,this.min=0,this.max=100,this.step=1,this.size="medium",this.tooltipPlacement="top",this.restrictMovement=!1,this.defaultValue="0",this.form="",this.hasSlotController=new ht(this,"help-text","label","prefix","suffix","ticks"),this.formControlController=new nt(this,{assumeInteractionOn:["syn-change"]}),this.localize=new ct(this),v(this,l,[0]),v(this,p,new Map),v(this,z,!1),v(this,x,""),v(this,V),v(this,g,[]),this.tooltipFormatter=this.localize.number.bind(this.localize)}set value(t){m(this,l,t?t.split(" ").map(Number).sort(y):[])}get value(){return r(this,l).slice().sort(y).join(" ")}set valueAsArray(t){const e=r(this,l);m(this,l,Array.isArray(t)?t.slice().sort(y):t||[]),w(e,r(this,l))&&this.requestUpdate("value",e.join(" "))}get valueAsArray(){return[...r(this,l)].sort(y)}disconnectedCallback(){super.disconnectedCallback(),this?.visibilityObserver?.disconnect()}firstUpdated(){this.visibilityObserver=new IntersectionObserver(t=>{const e=t.at(0);e&&e.isIntersecting&&e.target.checkVisibility()&&h(this,n,K).call(this,e.boundingClientRect.height)},{root:this.ticks.parentElement}),this.visibilityObserver.observe(this.ticks),this.formControlController.updateValidity(),m(this,g,Array.from(r(this,l))),this.thumbs.forEach(t=>{const e=t.parentElement;e.updateComplete.then(()=>{e.shadowRoot.querySelector(".tooltip__body")?.setAttribute("aria-hidden","true")})})}willUpdate(t){super.willUpdate(t),this.min>this.max&&([this.min,this.max]=[this.max,this.min]),this.step>this.max-this.min&&(this.step=this.max-this.min),this.step<=0&&(this.step=1);const e=r(this,l).map(i=>{if(i<=this.min)return this.min;if(i>=this.max)return this.max;const a=this.min+this.step*Math.round((i-this.min)/this.step);return a>this.max?this.max:a});w(r(this,l),e)&&m(this,l,e)}updated(t){super.updated(t);for(const e of this.thumbs){const i=+e.dataset.rangeId;r(this,p).has(i)&&h(this,n,I).call(this,e,r(this,p).get(i))}h(this,n,C).call(this)}focus(t){const e=this.thumbs.item(0);e?e.focus(t):super.focus(t)}checkValidity(){if(this.disabled)return!0;const t=!r(this,x);return t||this.formControlController.emitInvalidEvent(),t}reportValidity(){if(this.disabled)return!0;const t=this.validity.valid;return this.formControlController.setValidity(t),this.validationInput.hidden=!0,clearTimeout(r(this,V)),t||(this.validationInput.hidden=!1,this.validationInput.reportValidity(),m(this,V,setTimeout(()=>{this.validationInput.hidden=!0},1e4))),t}setCustomValidity(t){m(this,x,t),this.validationInput.setCustomValidity(t),this.formControlController.updateValidity()}getForm(){return this.formControlController.getForm()}get validity(){return r(this,x)?ot:lt}get validationMessage(){return r(this,x)}renderThumbs(t){const e=r(this,l).length>1;return r(this,p).clear(),r(this,l).map((i,a)=>{const s=a+1;r(this,p).set(s,i);const o=`thumb-${s}`;let c="",b="";return e?(b=t?`label aria-label-hidden ${o}`:`aria-label-hidden ${o}`,a===0?c=`${this.localize.term("rangeMin")} (${this.tooltipFormatter(i)})`:a===r(this,l).length-1?c=`${this.localize.term("rangeMax")} (${this.tooltipFormatter(i)})`:c=this.tooltipFormatter(i)):b=t?"label aria-label-hidden":"",L`
        ...
        >
          <div
            ...
            @pointerdown=${h(this,n,H)}
            @pointermove=${h(this,n,N)}
            @pointerup=${h(this,n,T)}
            @pointercancel=${h(this,n,T)}
            @pointerleave=${h(this,n,T)}
            @keydown=${h(this,n,X)}
            @focus=${h(this,n,G)}
          ></div>
        </syn-tooltip>
      `})}render(){const t=this.hasSlotController.test("label"),e=this.hasSlotController.test("help-text"),i=this.hasSlotController.test("prefix"),a=this.hasSlotController.test("suffix"),s=this.label?!0:!!t,o=this.helpText?!0:!!e;return L`
      <div
        part="form-control"
        class=${rt({"form-control":!0,"form-control--has-help-text":o,"form-control--has-label":s,"form-control--has-prefix":i,"form-control--has-suffix":a,"form-control--is-disabled":this.disabled,"form-control--large":this.size==="large","form-control--medium":this.size==="medium","form-control--small":this.size==="small"})}
        @focusout=${h(this,n,j)}
      >
        <label
          id="label"
    ...
    `}};l=new WeakMap;p=new WeakMap;z=new WeakMap;x=new WeakMap;V=new WeakMap;g=new WeakMap;n=new WeakSet;S=function(){return this.localize.dir()==="rtl"};F=function(t,e=!0){if(this.disabled)return;const{clientX:i}=t,a=Array.from(this.thumbs),s=U(this.baseDiv,i,r(this,n,S)),o=this.step/(this.max-this.min),c=this.min+this.step*Math.round(s/o),b=a.reduce((A,P)=>{const R=r(this,p).get(+P.dataset.rangeId),Q=r(this,p).get(+A.dataset.rangeId),O=Math.abs(R-c),B=Math.abs(Q-c);return O===B?R<c?P:A:O<B?P:A}),k=+b.dataset.rangeId;if(!k)return;r(this,p).set(k,c),h(this,n,I).call(this,b,c);const $=r(this,l);m(this,l,Array.from(r(this,p).values())),h(this,n,C).call(this),w($,r(this,l))&&(m(this,g,Array.from(r(this,l))),this.emit("syn-input"),this.emit("syn-change"));const J=new PointerEvent("pointerdown",t);e&&b.dispatchEvent(J)&&h(this,n,_).call(this,b)};q=function(t){h(this,n,F).call(this,t,!1)};D=function(t,e){const i=this.valueAsArray,s=Array.from(this.thumbs).indexOf(t),o=i[s-1]||this.min,c=i[s+1]||this.max,b=e<o||e>c;return{finalValue:Math.max(o,Math.min(c,e)),isRestricted:b,nextValue:c,prevValue:o}};H=async function(t){if(this.disabled)return;const e=t.target;h(this,n,_).call(this,e),e.dataset.pointerId&&e.releasePointerCapture(+e.dataset.pointerId),e.dataset.pointerId=t.pointerId.toString(),e.setPointerCapture(t.pointerId),e.classList.add("grabbed"),await e.parentElement.show()};N=function(t){if(this.disabled)return;const e=t.target,i=+e.dataset.rangeId;if(!r(this,p).has(i)||(e.dataset.pointerId?+e.dataset.pointerId:null)!==t.pointerId)return;const s=U(this.baseDiv,t.clientX,r(this,n,S)),o=this.step/(this.max-this.min);let c=this.min+this.step*Math.round(s/o);if(this.emit("syn-move",{cancelable:!0,detail:{element:e,value:c}}).defaultPrevented)return;if(this.restrictMovement){const $=h(this,n,D).call(this,e,c);$.isRestricted?(c=$.finalValue,e.style.zIndex=(3+this.thumbs.length).toFixed(0)):e.style.zIndex="3"}r(this,p).set(i,c),h(this,n,I).call(this,e,c);const k=r(this,l);m(this,l,Array.from(r(this,p).values())),h(this,n,C).call(this),w(k,r(this,l))&&this.emit("syn-input")};T=async function(t){const e=t.target;!e.dataset.pointerId||t.pointerId!==+e.dataset.pointerId||(e.classList.remove("grabbed"),e.releasePointerCapture(t.pointerId),delete e.dataset.pointerId,w(r(this,g),r(this,l))&&(m(this,g,Array.from(r(this,l))),this.emit("syn-change")),await e.parentElement.hide())};I=function(t,e){t.setAttribute("aria-valuenow",e.toString()),t.setAttribute("aria-valuetext",this.tooltipFormatter(e));const i=(e-this.min)/(this.max-this.min);t.style.insetInlineStart=`calc(${100*i}% - var(--half-thumb-size))`,h(this,n,_).call(this,t)};C=function(){const{activeTrack:t}=this;if(!t)return;if(this.min===this.max){t.style.insetInlineStart="0%",t.style.insetInlineEnd="0%";return}if(r(this,l).length===1){const s=getComputedStyle(this).getPropertyValue("--track-active-offset")||"0%",o=100*(r(this,l)[0]-this.min)/(this.max-this.min);t.style.insetInlineStart=`min(${s}, ${o}%)`,t.style.insetInlineEnd=`min(calc(100% - ${s}), calc(100% - ${o}%))`;return}const e=r(this,l).slice().sort(y),i=100*(e[0]-this.min)/(this.max-this.min),a=100*(e[e.length-1]-this.min)/(this.max-this.min);t.style.insetInlineStart=`${i}%`,t.style.insetInlineEnd=`calc(100% - ${a}%)`};X=function(t){const e=t.target,i=+e.dataset.rangeId,a=r(this,p).get(i);if(a===void 0)return;let s=a;switch(t.key){case"ArrowUp":case"Up":s=Math.min(a+this.step,this.max);break;case"ArrowDown":case"Down":s=Math.max(a-this.step,this.min);break;case"ArrowLeft":case"Left":s=r(this,n,S)?Math.min(a+this.step,this.max):Math.max(a-this.step,this.min);break;case"ArrowRight":case"Right":s=r(this,n,S)?Math.max(a-this.step,this.min):Math.min(a+this.step,this.max);break;case"PageUp":s=Math.min(a+(this.max-this.min)/5,this.max);break;case"PageDown":s=Math.max(a-(this.max-this.min)/5,this.min);break;case"Home":s=this.min;break;case"End":s=this.max;break;default:return}if(s!==a){if(this.emit("syn-move",{cancelable:!0,detail:{element:e,value:s}}).defaultPrevented)return;if(this.restrictMovement){const c=h(this,n,D).call(this,e,s);c.isRestricted&&(s=c.finalValue)}h(this,n,I).call(this,e,s),r(this,p).set(i,s),m(this,l,Array.from(r(this,p).values())),h(this,n,C).call(this),h(this,n,_).call(this,e),m(this,g,Array.from(r(this,l))),this.emit("syn-input"),this.emit("syn-change")}t.stopPropagation(),t.preventDefault()};j=function(t){t.relatedTarget&&this.shadowRoot?.contains(t.relatedTarget)||(this.emit("syn-blur"),m(this,z,!1))};_=function(t){if(this.tooltipPlacement==="none")return;const e=+t.dataset.rangeId;if(!r(this,p).has(e))return;const i=r(this,p).get(e),a=t.parentElement;a.content=this.tooltipFormatter(i)};G=function(t){if(this.disabled)return;r(this,z)||(m(this,z,!0),this.emit("syn-focus"));const e=t.target;e?.dataset?.rangeId&&h(this,n,_).call(this,e)};Y=function(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)};K=function(t){const e=this.hasSlotController.test("ticks"),i=this.hasSlotController.test("prefix"),a=this.hasSlotController.test("suffix");if(!e)return;let s=t||this.shadowRoot?.querySelector(".ticks")?.clientHeight;if(s){if(s+=2,s/=2,i){const o=this.shadowRoot?.querySelector(".input__prefix");o.style.transform=`translateY(-${s}px)`}if(a){const o=this.shadowRoot?.querySelector(".input__suffix");o.style.transform=`translateY(-${s}px)`}}};u.styles=[et,ut,dt,vt];u.dependencies={"syn-tooltip":pt};d([f()],u.prototype,"name",2);d([f()],u.prototype,"label",2);d([f({attribute:"help-text"})],u.prototype,"helpText",2);d([f({reflect:!0,type:Boolean})],u.prototype,"disabled",2);d([f({type:Number})],u.prototype,"min",2);d([f({type:Number})],u.prototype,"max",2);d([f({type:Number})],u.prototype,"step",2);d([f({reflect:!0})],u.prototype,"size",2);d([f({attribute:"tooltip-placement",type:String})],u.prototype,"tooltipPlacement",2);d([f({type:String})],u.prototype,"value",1);d([f({attribute:"restrict-movement",type:Boolean})],u.prototype,"restrictMovement",2);d([at()],u.prototype,"defaultValue",2);d([f({reflect:!0})],u.prototype,"form",2);d([f({attribute:!1})],u.prototype,"tooltipFormatter",2);d([M(".input__wrapper")],u.prototype,"baseDiv",2);d([M(".active-track")],u.prototype,"activeTrack",2);d([M(".ticks")],u.prototype,"ticks",2);d([bt(".thumb")],u.prototype,"thumbs",2);d([M(".range__validation-input")],u.prototype,"validationInput",2);u=d([mt("SynRange")],u);u.define("syn-range");
