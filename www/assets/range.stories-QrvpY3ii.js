import{l as _t,x as y,g as St}from"./iframe-BvpQ0TfH.js";import{o as wt}from"./if-defined-BySi0FTO.js";import{n as g}from"./property-CGHGhfqU.js";import{a as K}from"./query-DAIS6qJ0.js";import{r as zt}from"./query-all-BNBO5se6.js";import{e as Tt}from"./class-map-BFkGpxUA.js";import{d as Ct}from"./default-value-DiiqtwhZ.js";import{F as Vt,c as It,v as Mt}from"./form-d9hCJUdr.js";import{H as $t}from"./slot-9EVoRGQc.js";import{L as Dt}from"./localize-Dh03wnLC.js";import{c as Et,S as Pt}from"./component.styles-CYUvrQop.js";import{f as At,a as Ft}from"./form-control.custom.styles-C10QBedb.js";import{S as Lt}from"./tooltip.component-Blb-qBkA.js";import{e as qt}from"./decorator-DANECR0-.js";import"./button-CjF1oOJR.js";import"./input-Bx2Dz8RY.js";import"./range-tick-BIk_dmHc.js";import{g as h,s as Ot,a as Rt,c as Ht,b as Nt}from"./component-DChMAozH.js";import"./index-DihgwUfS.js";import"./animation-registry-l4L8bmT6.js";import"./event-B0iVuGLD.js";import"./watch-CEsCE2EF.js";import"./popup.component-CuzW_ICB.js";import"./composed-offset-position.browser.min-BaXfCfax.js";import"./functions-CDi3doZH.js";import"./state-B9rLvy9f.js";import"./icon.component-DVWzCQlp.js";import"./spinner.component-CPG1y9ng.js";import"./live-CdWFOzm6.js";import"./divider.component-NL2-7D5H.js";import"./index-Bkk0Z6Ex.js";import"./_docs-UXgsQIP6.js";const x=(t,e)=>t-e,q=(t,e)=>{if(t.length!==e.length)return!0;const s=t.slice().sort(x),a=e.slice().sort(x);for(let r=0;r<s.length;r+=1)if(s[r]!==a[r])return!0;return!1},pt=(t,e,s)=>{const a=t.getBoundingClientRect(),r=a.width;if(r<=0)return 0;let o=e;return o-=a.left,o<=0?s?1:0:o>=r?s?0:1:(o/=r,s?1-o:o)},Wt=_t`
  :host {
    /*
...
`;var Bt=Object.defineProperty,Ut=Object.getOwnPropertyDescriptor,ut=t=>{throw TypeError(t)},m=(t,e,s,a)=>{for(var r=a>1?void 0:a?Ut(e,s):e,o=t.length-1,p;o>=0;o--)(p=t[o])&&(r=(a?p(e,s,r):p(r))||r);return a&&r&&Bt(e,s,r),r},Z=(t,e,s)=>e.has(t)||ut("Cannot "+s),i=(t,e,s)=>(Z(t,e,"read from private field"),s?s.call(t):e.get(t)),b=(t,e,s)=>e.has(t)?ut("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),f=(t,e,s,a)=>(Z(t,e,"write to private field"),e.set(t,s),s),c=(t,e,s)=>(Z(t,e,"access private method"),s),l,d,O,_,G,k,n,R,tt,mt,et,dt,ht,X,H,N,yt,ft,S,gt,vt,bt;let u=class extends Pt{constructor(){super(),b(this,n),this.name="",this.label="",this.helpText="",this.disabled=!1,this.min=0,this.max=100,this.step=1,this.size="medium",this.tooltipPlacement="top",this.restrictMovement=!1,this.defaultValue="0",this.form="",this.hasSlotController=new $t(this,"help-text","label","prefix","suffix","ticks"),this.formControlController=new Vt(this,{assumeInteractionOn:["syn-change"]}),this.localize=new Dt(this),b(this,l,[0]),b(this,d,new Map),b(this,O,!1),b(this,_,""),b(this,G),b(this,k,[]),this.tooltipFormatter=this.localize.number.bind(this.localize)}set value(t){f(this,l,t?t.split(" ").map(Number).sort(x):[])}get value(){return i(this,l).slice().sort(x).join(" ")}set valueAsArray(t){const e=i(this,l);f(this,l,Array.isArray(t)?t.slice().sort(x):t||[]),q(e,i(this,l))&&this.requestUpdate("value",e.join(" "))}get valueAsArray(){return[...i(this,l)].sort(x)}disconnectedCallback(){super.disconnectedCallback(),this?.visibilityObserver?.disconnect()}firstUpdated(){this.visibilityObserver=new IntersectionObserver(t=>{const e=t.at(0);e&&e.isIntersecting&&e.target.checkVisibility()&&c(this,n,bt).call(this,e.boundingClientRect.height)},{root:this.ticks.parentElement}),this.visibilityObserver.observe(this.ticks),this.formControlController.updateValidity(),f(this,k,Array.from(i(this,l))),this.thumbs.forEach(t=>{const e=t.parentElement;e.updateComplete.then(()=>{e.shadowRoot.querySelector(".tooltip__body")?.setAttribute("aria-hidden","true")})})}willUpdate(t){super.willUpdate(t),this.min>this.max&&([this.min,this.max]=[this.max,this.min]),this.step>this.max-this.min&&(this.step=this.max-this.min),this.step<=0&&(this.step=1);const e=i(this,l).map(s=>{if(s<=this.min)return this.min;if(s>=this.max)return this.max;const a=this.min+this.step*Math.round((s-this.min)/this.step);return a>this.max?this.max:a});q(i(this,l),e)&&f(this,l,e)}updated(t){super.updated(t);for(const e of this.thumbs){const s=+e.dataset.rangeId;i(this,d).has(s)&&c(this,n,H).call(this,e,i(this,d).get(s))}c(this,n,N).call(this)}focus(t){const e=this.thumbs.item(0);e?e.focus(t):super.focus(t)}checkValidity(){if(this.disabled)return!0;const t=!i(this,_);return t||this.formControlController.emitInvalidEvent(),t}reportValidity(){if(this.disabled)return!0;const t=this.validity.valid;return this.formControlController.setValidity(t),this.validationInput.hidden=!0,clearTimeout(i(this,G)),t||(this.validationInput.hidden=!1,this.validationInput.reportValidity(),f(this,G,setTimeout(()=>{this.validationInput.hidden=!0},1e4))),t}setCustomValidity(t){f(this,_,t),this.validationInput.setCustomValidity(t),this.formControlController.updateValidity()}getForm(){return this.formControlController.getForm()}get validity(){return i(this,_)?It:Mt}get validationMessage(){return i(this,_)}renderThumbs(t){const e=i(this,l).length>1;return i(this,d).clear(),i(this,l).map((s,a)=>{const r=a+1;i(this,d).set(r,s);const o=`thumb-${r}`;let p="",v="";return e?(v=t?`label aria-label-hidden ${o}`:`aria-label-hidden ${o}`,a===0?p=`${this.localize.term("rangeMin")} (${this.tooltipFormatter(s)})`:a===i(this,l).length-1?p=`${this.localize.term("rangeMax")} (${this.tooltipFormatter(s)})`:p=this.tooltipFormatter(s)):v=t?"label aria-label-hidden":"",y`
  ...
  `},B={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:h("range","invalid")}}},play:async({canvasElement:t})=>{try{const e=t.querySelector("syn-range"),s=t.querySelector("syn-button");e&&s&&(await Yt.click(s),s.click())}catch(e){console.error("Error in play function:",e)}},render:()=>y(ot||(ot=st([`
  ...
  `},j={parameters:{docs:{description:{story:h("range","multi-knob-restrict-movement")}}},render:()=>y`
    <syn-range
      ...
      step="1"
    ></syn-range>
  `},P={parameters:{docs:{description:{story:h("range-tick","default")}}},render:()=>y`
  <div class="wrapper">
    <syn-range
  ...
  `},A={parameters:{docs:{description:{story:h("range","tooltip-placement")},story:{height:"80px"}}},render:()=>y`
    <syn-range
  ...
  `},L={parameters:{docs:{description:{story:h("range","tooltip-formatter")}}},render:()=>y(ct||(ct=st([`
    ...
    <\/script>
  `])))},Y=Nt({Default:z,Labels:T,HelpText:C,Disabled:V,Sizes:I,PrefixSuffixText:M,CustomTrackColors:$,CustomTrackOffset:D,MultiThumb:E,Ticks:P,TooltipPlacement:A,TooltipDisabled:F,TooltipFormatter:L},500);z.parameters={...z.parameters,docs:{...z.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
