import{k as i}from"./directive-helpers-CDT6qhDs.js";import{g as n}from"./translations-dXj_Xr11.js";var a=Object.freeze,c=Object.defineProperty,r=(e,t)=>a(c(e,"raw",{value:a(e.slice())})),o,s;const p=()=>i`
  <!-- footer -->
  <style>
    .synergy-footer-demo {
...
`,g=({withMetaNavigation:e=!1}={})=>i`
  ...
  <!-- /header -->
`,u=({noFocusTrapping:e=!1,open:t=!1,rail:l=!1}={})=>i`
  <!-- side-navigation -->
  <syn-side-nav
    ?no-focus-trapping=${e}
    ?open=${t}
...
`])),e),x=(e,t="syn-side-nav")=>i(s||(s=r([`
  ...
  <\/script>
`])),e,t,t);export{u as a,h as b,g as c,p as d,v as e,f,x as g};
