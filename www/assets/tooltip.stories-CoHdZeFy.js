import{a as e,n as t}from"./chunk-DnJy8xQt.js";import{Nt as n,R as r,Rt as i,f as a,g as o,n as s,t as c}from"./iframe-BcSabCAt.js";import{d as l,f as u,i as d,p as f,u as p}from"./blocks-DR3cHj4A.js";import{t as m}from"./button-Bhru3s4I.js";import{t as h}from"./icon-BAP3aECg.js";import{n as g,r as _}from"./component-CI3ThXYz.js";import{n as v,t as y}from"./taggedTemplateLiteral-DxWpUJWn.js";import{t as b}from"./button-group-Bb-AwUE3.js";import{t as x}from"./tooltip-B7CVR8Vb.js";import{t as S}from"./header-D1rKNlgP.js";var C,w,T,E,D;t((()=>{C=e(r(),1),f(),n(),c(),m(),b(),S(),x(),h(),_(),o(),v(),T={parameters:{chromatic:{...s?.parameters?.chromatic,disableSnapshot:!1,modes:a},docs:{description:{component:g(`tooltip`,`default`,`templates`)},page:()=>C.createElement(C.Fragment,null,C.createElement(u,null),C.createElement(l,null),C.createElement(d,null),C.createElement(p,{title:``}))}},tags:[`Feedback`],title:`Templates/Tooltip`},E={parameters:{docs:{description:{story:g(`tooltip`,`single-instance`,`templates`)}}},render:()=>i(w||=y([`
