import"./tab-panel-BklccxyF.js";import"./tab-CD4NWIyY.js";import"./icon-DqfgyPbM.js";import{g as G,C as _,x as t,o as u}from"./iframe-BbG24dca.js";import{p as E}from"./index-CQ0aEGxp.js";import{g as s,s as O,a as F,c as R,b as q}from"./component-DQoGmEAi.js";import"./class-map-C4GF1kIH.js";import"./synergy-element-mvvDTlej.js";import"./icon.component-DiWeev-w.js";import"./watch-CEsCE2EF.js";import"./event-options-CNZcgQm4.js";import"./query-DAIS6qJ0.js";import"./query-assigned-elements-BQ-t-koE.js";import"./localize-Dh03wnLC.js";import"./index-DihgwUfS.js";import"./scroll-DgKSCJoS.js";import"./icon-button.component-BDSusJFU.js";import"./if-defined-BDvKPKv0.js";import"./decorator-DeP7ND_N.js";import"./functions-DkH8wE0_.js";import"./preload-helper-Ct5FWWRu.js";import"./_docs-DmU5sf6r.js";var $=Object.freeze,j=Object.defineProperty,w=(e,n)=>$(j(e,"raw",{value:$(n||e.slice())})),S;const{args:A,argTypes:I}=O("syn-tab-group"),{overrideArgs:L}=F("syn-tab-group"),{generateTemplate:M}=R("syn-tab-group"),C=(e,n,{active:a=!1,closable:g=!1,disabled:v=!1}={})=>`<syn-tab slot="nav" panel="${e}" ${a?"active":""} ${v?"disabled":""} ${g?"closable":""}>${n}</syn-tab>`,T=(e,n,{active:a=!1,closable:g=!1,disabled:v=!1}={})=>u(C(e,n,{active:a,closable:g,disabled:v})),P=()=>[{panel:"general",props:{active:!0}},{panel:"custom"},{panel:"advanced"},{panel:"disabled",props:{disabled:!0}}].map(({panel:e,props:n})=>C(e,E(e),n)).join(`
...
`,y=()=>u(D()),be={args:L([{name:"default",type:"slot",value:D()},{name:"nav",type:"slot",value:P()}],A),argTypes:I,component:"syn-tab-group",parameters:{chromatic:{modes:_},design:G("18021-1924779"),docs:{description:{component:s("tab-group","default")}}},tags:["Navigation","SICK2018","SICK2025"],title:"Components/syn-tab-group"},r={parameters:{docs:{description:{story:s("tab-group","default")}}},render:e=>M({args:e})},o={parameters:{docs:{description:{story:s("tab-group","start")}}},render:()=>t`
...
`},d=q({Default:r,TabsOnStart:o,TabsOnEnd:l,ClosableTabs:c,ScrollingTabs:p,VisualHierarchy:b,Icons:i},{heightPx:740});r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
