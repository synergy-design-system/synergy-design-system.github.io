import{q as y,x as g,A as v,B as w,D as f,F as S}from"./iframe-CvU34O_B.js";import{n as h,S as C,c as R}from"./synergy-element-B1F-Pf22.js";import{w as m}from"./watch-CEsCE2EF.js";function L(c){return h({...c,state:!0,attribute:!1})}const I=y`
	/* stylelint-disable */
  :host {
...
`;var E=Object.defineProperty,_=Object.getOwnPropertyDescriptor,o=(c,t,i,e)=>{for(var r=e>1?void 0:e?_(t,i):t,s=c.length-1,a;s>=0;s--)(a=c[s])&&(r=(e?a(t,i,r):a(r))||r);return e&&r&&E(t,i,r),r};const l=Symbol(),u=Symbol();let d;const p=new Map;class n extends C{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}static{this.styles=[R,I,A]}async resolveIcon(t,i){let e;if(i?.spriteSheet)return this.svg=g`<svg part="svg">
