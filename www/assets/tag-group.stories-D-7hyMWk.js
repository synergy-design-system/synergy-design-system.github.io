import{a as e,n as t}from"./chunk-DnJy8xQt.js";import{At as n,F as r,Ft as i,Nt as a,d as o,f as s,n as c,p as l,t as u,u as d}from"./iframe-CFxyVgYz.js";import{d as f,f as p,l as m,r as h,u as g}from"./blocks-D9zF8cJ1.js";import{t as _}from"./button-BmPxXsuW.js";import{t as v}from"./icon-BNvARCZB.js";import{t as y}from"./details-f6ZxAjPQ.js";import{n as b,r as x}from"./component-u4nxi-rq.js";import{n as S,t as C}from"./menu-item-MM2E605I.js";import{t as w}from"./dropdown-Dteqz51A.js";import{t as T}from"./option-DU69hnW4.js";import{t as E}from"./select-IxvcXEC_.js";import{t as D}from"./tag-group-DQwhw_GU.js";import{t as O}from"./tag-CFEkQToa.js";var k,A,j,M,N;t((()=>{k=e(r(),1),p(),n(),u(),x(),o(),l(),_(),y(),w(),S(),C(),T(),E(),D(),O(),v(),A={parameters:{chromatic:{...c?.parameters?.chromatic,disableSnapshot:!1,modes:s},design:d(`16648-52486`),docs:{description:{component:b(`tag-group`,`default`,`templates`)},page:()=>k.createElement(k.Fragment,null,k.createElement(f,null),k.createElement(g,null),k.createElement(h,null),k.createElement(m,{title:``}))}},tags:[`Feedback`,`Tags`,`Filter`],title:`Templates/Tag Group`},j={render:()=>{let e={filters:[{id:`filter-1`,name:`Housing`,options:[`metric`,`rectangular`],selected:[]},{id:`filter-2`,name:`Cable material`,options:[`PUR`,`PVC`],selected:[`PUR`]},{id:`filter-3`,name:`Length of cable`,options:[`0.2 m`,`0.3 m`,`0.7 m`,`0.23 m`,`2 m`],selected:[`0.2 m`,`0.3 m`,`0.7 m`,`0.23 m`]},{id:`filter-4`,name:`Electrical wiring`,options:[`AC 2-wire`,`DC 3-wire`,`DC 4-wire`],selected:[]},{id:`filter-5`,name:`Switching output`,options:[`NPN`,`PNP`],selected:[]},{id:`filter-6`,name:`Connection type`,options:[`Cable, 2-wire`,`Cable, 3-wire`,`Cable, 4-wire`],selected:[`Cable, 3-wire`]}],filtersOpen:!0,isMobile:!1},t=(e,t)=>i`
    ...
    `,n=document.createElement(`div`);return(()=>{let r,i,o=()=>{a(t(e,r),n)},s=t=>{e={...e,...t},o()},c=()=>{`ResizeObserver`in window&&(i=new ResizeObserver(t=>{if(t.length>0){let n=t[0].contentRect.width<=420;e.isMobile!==n&&s({isMobile:n})}}),setTimeout(()=>{let e=n.querySelector(`.filter-form`);e&&i&&i.observe(e)},0))},l={clearAllFilters:()=>{window.confirm(`Möchten Sie wirklich alle Filter entfernen?`)&&s({filters:e.filters.map(e=>({...e,selected:[]}))})},removeTag:(t,n)=>{s({filters:e.filters.map(e=>e.id===t?{...e,selected:e.selected.filter(e=>e!==n)}:e)})},toggleFilter:e=>{s({filtersOpen:e})},toggleOption:(t,n)=>{s({filters:e.filters.map(e=>{if(e.id===t){let t=e.selected.includes(n)?e.selected.filter(e=>e!==n):[...e.selected,n];return{...e,selected:t}}return e})})}};return r=l,o(),c(),{actions:l,cleanup:()=>{i&&i.disconnect()},rerender:o}})(),n}},M={...j,globals:{viewport:{value:`mobile2`}},name:`↳ Tablet`,parameters:{controls:{exclude:[`default`]}}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
  render: () => {
