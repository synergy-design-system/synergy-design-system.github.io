...
`})),_e,E,D=e((()=>{x(),t(),f(),E=class extends te{constructor(){super(),y(this,_e,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}emit(e,t){let n=new CustomEvent(e,h({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(n),n}static define(e,t=this,n={}){let r=customElements.get(e);if(!r){try{customElements.define(e,t,n)}catch{customElements.define(e,class extends t{},n)}return}let i=` (unknown version)`,a=i;`version`in t&&t.version&&(i=` v`+t.version),`version`in r&&r.version&&(a=` v`+r.version),!(i&&a&&i===a)&&console.warn(`Attempted to register <${e}>${i}, but <${e}>${a} has already been registered.`)}attributeChangedCallback(e,t,n){v(this,_e)||(this.constructor.elementProperties.forEach((e,t)=>{e.reflect&&this[t]!=null&&this.initialReflectedProperties.set(t,this[t])}),b(this,_e,!0)),super.attributeChangedCallback(e,t,n)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach((t,n)=>{e.has(n)&&this[n]==null&&(this[n]=t)})}},_e=new WeakMap,E.version=`3.12.1`,E.dependencies={},g([d()],E.prototype,`dir`,2),g([d()],E.prototype,`lang`,2)})),ve,O=e((()=>{t(),ve=n`
...
`})),Y,X=e((()=>{pt(),ht(),I(),tt(),T(),D(),x(),c(),ne(),re(),f(),Y=class extends E{constructor(){super(...arguments),this.hasFocus=!1,this.label=``,this.size=`inherit`,this.color=`currentColor`,this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){let e=!!this.href,t=e?o`a`:o`button`;return r`
      <${t}
        part="base"
        class=${s({"icon-button":!0,"icon-button--disabled":!e&&this.disabled,"icon-button--focused":this.hasFocus,"icon-button--small":this.size===`small`,"icon-button--medium":this.size===`medium`,"icon-button--large":this.size===`large`})}
    ...
    `}},Z.styles=[w,nt,it],Z.dependencies={"syn-icon-button":Y,"syn-resize-observer":J},g([ie({slot:`nav`,selector:`syn-tab`})],Z.prototype,`tabs`,2),g([ie({selector:`syn-tab-panel`})],Z.prototype,`panels`,2),g([p(`.tab-group`)],Z.prototype,`tabGroup`,2),g([p(`.tab-group__body`)],Z.prototype,`body`,2),g([p(`.tab-group__nav`)],Z.prototype,`nav`,2),g([p(`.tab-group__indicator`)],Z.prototype,`indicator`,2),g([u()],Z.prototype,`hasScrollControls`,2),g([u()],Z.prototype,`shouldHideScrollStartButton`,2),g([u()],Z.prototype,`shouldHideScrollEndButton`,2),g([d()],Z.prototype,`placement`,2),g([d()],Z.prototype,`activation`,2),g([d({attribute:`no-scroll-controls`,type:Boolean})],Z.prototype,`noScrollControls`,2),g([d({type:Boolean})],Z.prototype,`contained`,2),g([d({type:Boolean})],Z.prototype,`sharp`,2),g([d({attribute:`fixed-scroll-controls`,type:Boolean})],Z.prototype,`fixedScrollControls`,2),g([ae({passive:!0})],Z.prototype,`updateScrollButtons`,1),g([S(`noScrollControls`,{waitUntilFirstUpdate:!0})],Z.prototype,`updateScrollControls`,1),g([S(`placement`,{waitUntilFirstUpdate:!0})],Z.prototype,`syncIndicator`,1)})),yt=e((()=>{vt(),Z.define(`syn-tab-group`)})),bt=e((()=>{yt(),vt(),rt(),at(),ct(),st(),X(),pt(),ht(),I(),O(),k(),G(),U(),H(),T(),D()})),xt,St=e((()=>{t(),xt=n`
  :host {
...
`})),Tt,Q,Et=e((()=>{St(),wt(),X(),G(),C(),T(),D(),x(),c(),t(),f(),Tt=0,Q=class extends E{constructor(){super(...arguments),this.localize=new W(this),this.attrId=++Tt,this.componentId=`syn-tab-${this.attrId}`,this.panel=``,this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`tab`)}handleCloseClick(e){e.stopPropagation(),this.emit(`syn-close`)}handleActiveChange(){this.setAttribute(`aria-selected`,this.active?`true`:`false`)}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled?`true`:`false`),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,a`
      <div
        part="base"
    ...
    `}},Q.styles=[w,Ct,xt],Q.dependencies={"syn-icon-button":Y},g([p(`.tab`)],Q.prototype,`tab`,2),g([d({reflect:!0})],Q.prototype,`panel`,2),g([d({type:Boolean,reflect:!0})],Q.prototype,`active`,2),g([d({type:Boolean,reflect:!0})],Q.prototype,`closable`,2),g([d({type:Boolean,reflect:!0})],Q.prototype,`disabled`,2),g([d({type:Number,reflect:!0})],Q.prototype,`tabIndex`,2),g([S(`active`)],Q.prototype,`handleActiveChange`,1),g([S(`disabled`)],Q.prototype,`handleDisabledChange`,1)})),Dt=e((()=>{Et(),Q.define(`syn-tab`)})),Ot=e((()=>{Dt(),Et(),St(),wt(),X(),pt(),ht(),I(),O(),k(),G(),U(),H(),T(),D()})),kt,At=e((()=>{t(),kt=n`
  /* Write custom CSS here */
  .tab-panel {
    color: var(--syn-typography-color-text);
  }
...
`})),Nt,$,Pt=e((()=>{At(),Mt(),C(),T(),D(),x(),c(),t(),f(),Nt=0,$=class extends E{constructor(){super(...arguments),this.attrId=++Nt,this.componentId=`syn-tab-panel-${this.attrId}`,this.name=``,this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute(`role`,`tabpanel`)}handleActiveChange(){this.setAttribute(`aria-hidden`,this.active?`false`:`true`)}render(){return a`
      <slot
        part="base"
        class=${s({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}},$.styles=[w,jt,kt],g([d({reflect:!0})],$.prototype,`name`,2),g([d({type:Boolean,reflect:!0})],$.prototype,`active`,2),g([S(`active`)],$.prototype,`handleActiveChange`,1)})),Ft=e((()=>{Pt(),$.define(`syn-tab-panel`)})),It=e((()=>{Ft(),Pt(),At(),Mt(),T(),D()}));export{me as A,S as C,v as D,y as E,x as M,ge as O,C as S,he as T,O as _,tt as a,w as b,K as c,G as d,U as f,k as g,I as h,et as i,h as j,b as k,He as l,F as m,Ot as n,Ue as o,H as p,bt as r,We as s,It as t,W as u,E as v,g as w,T as x,D as y};