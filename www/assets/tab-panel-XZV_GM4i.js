import{n as e}from"./chunk-DnJy8xQt.js";import{A as t,At as n,D as r,Nt as i,O as a,Ot as o,Pt as ee,Rt as s,Ut as c}from"./iframe-DJ0QlWgc.js";import{n as l,t as te}from"./class-map-DEi9Q1MK.js";import{n as u,t as ne}from"./if-defined-D8THz00N.js";import{c as re,d as ie,f as d,p as f,s as p,u as m}from"./synergy-element-ChX6Se5O.js";var ae,oe,se,ce,h,le,ue,de,fe,g,pe,me,_,he,v,y,b,ge,x=e((()=>{ae=Object.defineProperty,oe=Object.defineProperties,se=Object.getOwnPropertyDescriptor,ce=Object.getOwnPropertyDescriptors,h=Object.getOwnPropertySymbols,le=Object.prototype.hasOwnProperty,ue=Object.prototype.propertyIsEnumerable,de=e=>{throw TypeError(e)},fe=(e,t,n)=>t in e?ae(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,g=(e,t)=>{for(var n in t||={})le.call(t,n)&&fe(e,n,t[n]);if(h)for(var n of h(t))ue.call(t,n)&&fe(e,n,t[n]);return e},pe=(e,t)=>oe(e,ce(t)),me=(e,t)=>{var n={};for(var r in e)le.call(e,r)&&t.indexOf(r)<0&&(n[r]=e[r]);if(e!=null&&h)for(var r of h(e))t.indexOf(r)<0&&ue.call(e,r)&&(n[r]=e[r]);return n},_=(e,t,n,r)=>{for(var i=r>1?void 0:r?se(t,n):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(i=(r?o(t,n,i):o(i))||i);return r&&i&&ae(t,n,i),i},he=(e,t,n)=>t.has(e)||de(`Cannot `+n),v=(e,t,n)=>(he(e,t,`read from private field`),n?n.call(e):t.get(e)),y=(e,t,n)=>t.has(e)?de(`Cannot add the same private member more than once`):t instanceof WeakSet?t.add(e):t.set(e,n),b=(e,t,n,r)=>(he(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),ge=(e,t,n)=>(he(e,t,`access private method`),n)}));function S(e,t){let n=g({waitUntilFirstUpdate:!1},t);return(t,r)=>{let{update:i}=t,a=Array.isArray(e)?e:[e];t.update=function(e){a.forEach(t=>{let i=t;if(e.has(i)){let t=e.get(i),a=this[i];t!==a&&(!n.waitUntilFirstUpdate||this.hasUpdated)&&this[r](t,a)}}),i.call(this,e)}}}var C=e((()=>{x()})),w,T=e((()=>{i(),w=c`
  :host {
...
`})),E,D,O=e((()=>{x(),i(),p(),D=class extends ee{constructor(){super(),y(this,E,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}emit(e,t){let n=new CustomEvent(e,g({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(n),n}static define(e,t=this,n={}){let r=customElements.get(e);if(!r){try{customElements.define(e,t,n)}catch{customElements.define(e,class extends t{},n)}return}let i=` (unknown version)`,a=i;`version`in t&&t.version&&(i=` v`+t.version),`version`in r&&r.version&&(a=` v`+r.version),!(i&&a&&i===a)&&console.warn(`Attempted to register <${e}>${i}, but <${e}>${a} has already been registered.`)}attributeChangedCallback(e,t,n){v(this,E)||(this.constructor.elementProperties.forEach((e,t)=>{e.reflect&&this[t]!=null&&this.initialReflectedProperties.set(t,this[t])}),b(this,E,!0)),super.attributeChangedCallback(e,t,n)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach((t,n)=>{e.has(n)&&this[n]==null&&(this[n]=t)})}},E=new WeakMap,D.version=`3.13.3`,D.dependencies={},_([f()],D.prototype,`dir`,2),_([f()],D.prototype,`lang`,2)})),_e,k=e((()=>{i(),_e=c`
	/* stylelint-disable */
  :host {
...
`})),Y,st=e((()=>{ot(),C(),T(),O(),x(),i(),p(),Y=class extends D{constructor(){super(...arguments),this.observedElements=[],this.disabled=!1}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{this.emit(`syn-resize`,{detail:{entries:e}})}),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}handleSlotChange(){this.disabled||this.startObserver()}startObserver(){let e=this.shadowRoot.querySelector(`slot`);if(e!==null){let t=e.assignedElements({flatten:!0});this.observedElements.forEach(e=>this.resizeObserver.unobserve(e)),this.observedElements=[],t.forEach(e=>{this.resizeObserver.observe(e),this.observedElements.push(e)})}}stopObserver(){this.resizeObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}render(){return s` <slot @slotchange=${this.handleSlotChange}></slot> `}},Y.styles=[w,at],_([f({type:Boolean,reflect:!0})],Y.prototype,`disabled`,2),_([S(`disabled`,{waitUntilFirstUpdate:!0})],Y.prototype,`handleDisabledChange`,1)}));function ct(e,t){return{top:Math.round(e.getBoundingClientRect().top-t.getBoundingClientRect().top),left:Math.round(e.getBoundingClientRect().left-t.getBoundingClientRect().left)}}function lt(e,t,n=`vertical`,r=`smooth`){let i=ct(e,t),a=i.top+t.scrollTop,o=i.left+t.scrollLeft,ee=t.scrollLeft,s=t.scrollLeft+t.offsetWidth,c=t.scrollTop,l=t.scrollTop+t.offsetHeight;(n===`horizontal`||n===`both`)&&(o<ee?t.scrollTo({left:o,behavior:r}):o+e.clientWidth>s&&t.scrollTo({left:o-t.offsetWidth+e.clientWidth,behavior:r})),(n===`vertical`||n===`both`)&&(a<c?t.scrollTo({top:a,behavior:r}):a+e.clientHeight>l&&t.scrollTo({top:a-t.offsetHeight+e.clientHeight,behavior:r}))}var ut=e((()=>{})),dt,ft=e((()=>{i(),dt=c`
  :host {
...
`})),X,pt=e((()=>{ft(),L(),et(),T(),O(),x(),te(),r(),ne(),p(),X=class extends D{constructor(){super(...arguments),this.hasFocus=!1,this.label=``,this.size=`inherit`,this.color=`currentColor`,this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){let e=!!this.href,n=e?a`a`:a`button`;return t`
      <${n}
        part="base"
        class=${l({"icon-button":!0,"icon-button--disabled":!e&&this.disabled,"icon-button--focused":this.hasFocus,"icon-button--large":this.size===`large`,"icon-button--medium":this.size===`medium`,"icon-button--small":this.size===`small`})}
    ...
    `}},Z.styles=[w,rt,tt],Z.dependencies={"syn-icon-button":X,"syn-resize-observer":Y},_([re({slot:`nav`,selector:`syn-tab`})],Z.prototype,`tabs`,2),_([re({selector:`syn-tab-panel`})],Z.prototype,`panels`,2),_([m(`.tab-group`)],Z.prototype,`tabGroup`,2),_([m(`.tab-group__body`)],Z.prototype,`body`,2),_([m(`.tab-group__nav`)],Z.prototype,`nav`,2),_([m(`.tab-group__indicator`)],Z.prototype,`indicator`,2),_([d()],Z.prototype,`hasScrollControls`,2),_([d()],Z.prototype,`shouldHideScrollStartButton`,2),_([d()],Z.prototype,`shouldHideScrollEndButton`,2),_([f()],Z.prototype,`placement`,2),_([f()],Z.prototype,`activation`,2),_([f({attribute:`no-scroll-controls`,type:Boolean})],Z.prototype,`noScrollControls`,2),_([f({type:Boolean})],Z.prototype,`contained`,2),_([f({type:Boolean})],Z.prototype,`sharp`,2),_([f({attribute:`fixed-scroll-controls`,type:Boolean})],Z.prototype,`fixedScrollControls`,2),_([ie({passive:!0})],Z.prototype,`updateScrollButtons`,1),_([S(`noScrollControls`,{waitUntilFirstUpdate:!0})],Z.prototype,`updateScrollControls`,1),_([S(`placement`,{waitUntilFirstUpdate:!0})],Z.prototype,`syncIndicator`,1)})),_t=e((()=>{gt(),Z.define(`syn-tab-group`)})),vt=e((()=>{_t(),gt(),nt(),it(),st(),ot(),pt(),ft(),L(),k(),M(),K(),W(),U(),T(),O()})),yt,bt=e((()=>{i(),yt=c`
  :host {
...
`})),Ct,Q,wt=e((()=>{bt(),St(),pt(),K(),C(),T(),O(),x(),te(),i(),p(),Ct=0,Q=class extends D{constructor(){super(...arguments),this.localize=new G(this),this.attrId=++Ct,this.componentId=`syn-tab-${this.attrId}`,this.panel=``,this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`tab`)}handleCloseClick(e){e.stopPropagation(),this.emit(`syn-close`)}handleActiveChange(){this.setAttribute(`aria-selected`,this.active?`true`:`false`)}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled?`true`:`false`),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,s`
      <div
        part="base"
    ...
    `}},Q.styles=[w,xt,yt],Q.dependencies={"syn-icon-button":X},_([m(`.tab`)],Q.prototype,`tab`,2),_([f({reflect:!0})],Q.prototype,`panel`,2),_([f({type:Boolean,reflect:!0})],Q.prototype,`active`,2),_([f({type:Boolean,reflect:!0})],Q.prototype,`closable`,2),_([f({type:Boolean,reflect:!0})],Q.prototype,`disabled`,2),_([f({type:Number,reflect:!0})],Q.prototype,`tabIndex`,2),_([S(`active`)],Q.prototype,`handleActiveChange`,1),_([S(`disabled`)],Q.prototype,`handleDisabledChange`,1)})),Tt=e((()=>{wt(),Q.define(`syn-tab`)})),Et=e((()=>{Tt(),wt(),bt(),St(),pt(),ft(),L(),k(),M(),K(),W(),U(),T(),O()})),Dt,Ot=e((()=>{i(),Dt=c`
  /* Write custom CSS here */
  .tab-panel {
    color: var(--syn-typography-color-text);
  }
...
`})),jt,$,Mt=e((()=>{Ot(),At(),C(),T(),O(),x(),te(),i(),p(),jt=0,$=class extends D{constructor(){super(...arguments),this.attrId=++jt,this.componentId=`syn-tab-panel-${this.attrId}`,this.name=``,this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute(`role`,`tabpanel`)}handleActiveChange(){this.setAttribute(`aria-hidden`,this.active?`false`:`true`)}render(){return s`
      <slot
        part="base"
        class=${l({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}},$.styles=[w,kt,Dt],_([f({reflect:!0})],$.prototype,`name`,2),_([f({type:Boolean,reflect:!0})],$.prototype,`active`,2),_([S(`active`)],$.prototype,`handleActiveChange`,1)})),Nt=e((()=>{Mt(),$.define(`syn-tab-panel`)})),Pt=e((()=>{Nt(),Mt(),Ot(),At(),T(),O()}));export{pe as A,S as C,v as D,y as E,x as M,ge as O,C as S,me as T,k as _,et as a,w as b,q as c,K as d,W as f,M as g,L as h,$e as i,g as j,b as k,Ve as l,I as m,Et as n,He as o,U as p,vt as r,Ue as s,Pt as t,G as u,D as v,_ as w,T as x,O as y};