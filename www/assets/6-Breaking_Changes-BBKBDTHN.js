import{j as o,M as m,a as h}from"./blocks-DXnMXvBP.js";import{useMDXComponents as p}from"./index-Dy-99gI5.js";import{r as u,y as c,z as y,R as g}from"./iframe-DKzh7HHt.js";import"./preload-helper-PPVm8Dsz.js";const b=`# Handling breaking changes between major versions
...
-->
`;var f=0,w=e=>e.button===f&&!e.altKey&&!e.ctrlKey&&!e.metaKey&&!e.shiftKey,v=(e,n=t=>{})=>{w(e)&&(e.preventDefault(),n(e))},E=class extends u.PureComponent{constructor(){super(...arguments),this.state={href:"/"},this.updateHref=async()=>{let{kind:e,title:n=e,story:t,name:s=t}=this.props;if(n&&s){let r=await c(n,s);this.setState({href:r})}},this.handleClick=()=>{let{kind:e,title:n=e,story:t,name:s=t}=this.props;n&&s&&y({title:n,name:s})}}componentDidMount(){this.updateHref()}componentDidUpdate(e){let{kind:n,title:t,story:s,name:r}=this.props;(e.kind!==n||e.story!==s||e.title!==t||e.name!==r)&&this.updateHref()}render(){let{kind:e,title:n=e,story:t,name:s=t,children:r,...i}=this.props,{href:l}=this.state;return g.createElement("a",{href:l,onClick:d=>v(d,this.handleClick),...i},r)}};E.defaultProps={children:void 0};function a(e){return o.jsxs(o.Fragment,{children:[o.jsx(m,{title:"Packages/Components/Breaking Changes"}),`
`,o.jsx(h,{children:b})]})}function A(e={}){const{wrapper:n}={...p(),...e.components};return n?o.jsx(n,{...e,children:o.jsx(a,{...e})}):a()}export{A as default};
