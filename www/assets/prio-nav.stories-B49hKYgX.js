import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{_ as r,d as i,f as a,p as o}from"./iframe-BiSXA87W.js";import{a as s,i as c,n as l,o as u,r as d,t as f}from"./component-BZMStFjM.js";import{t as p}from"./prio-nav-DNnt2fQE.js";import{t as m}from"./nav-item-3gQnVkLs.js";var h,g,_,v,y,b,x,S,C,w=e((()=>{m(),p(),n(),d(),a(),r(),{args:h,argTypes:g}=c(`syn-prio-nav`),{overrideArgs:_}=s(`syn-prio-nav`),{generateTemplate:v}=u(`syn-prio-nav`),y={args:_([{name:`default`,type:`slot`,value:`
        <syn-nav-item current horizontal>Domains</syn-nav-item>
        <syn-nav-item horizontal>Projects</syn-nav-item>
        <syn-nav-item horizontal href="javascript:void(0)">Trainings</syn-nav-item>
      `}],h),argTypes:g,component:`syn-prio-nav`,parameters:{chromatic:{modes:o},design:i(`41227-206412`),docs:{description:{component:l(`prio-nav`,`default`)},story:{height:`200px`}}},tags:[`Navigation`],title:`Components/syn-prio-nav`},b={parameters:{controls:{disable:!1},docs:{description:{story:l(`prio-nav`,`default`)}}},render:e=>v({args:e})},x={parameters:{docs:{description:{story:l(`prio-nav`,`priority-menu`)}}},render:()=>t`
