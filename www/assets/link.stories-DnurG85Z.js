import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{_ as r,d as i,f as a,p as o}from"./iframe-BJUJk-mP.js";import{t as s}from"./icon-CWcZLnjq.js";import{a as c,i as l,n as u,r as d,t as f}from"./component-Dl_LLDeh.js";import{n as p,t as m}from"./PaddingDecorator-DKDp5bXd.js";import{n as h,t as g}from"./styles-B7JgZ6-n.js";var _,v,y,b,x,S,C,w,T,E,D,O,k;e((()=>{n(),d(),g(),a(),s(),m(),r(),{args:_,argTypes:v}=l(`syn-link`),{overrideArgs:y}=c(`syn-link`),b={args:y([{name:`default`,type:`slot`,value:`Link label`},{name:`syn-link`,type:`attribute`,value:`syn-link--medium`}],_),argTypes:v,component:`syn-link`,parameters:{chromatic:{modes:o},design:i(`41337-170604`),docs:{description:{component:u(`styles`,`link`)}}},tags:[`Navigation`,`Styles`],title:`Styles/syn-link`},x={parameters:{controls:{disable:!1}},render:e=>h(e,`a`,{class:`syn-link`,href:`javascript:void(0)`})},S={parameters:{docs:{description:{story:u(`link`,`inline`)}}},render:()=>t`
    <p style="width: 266px;">
