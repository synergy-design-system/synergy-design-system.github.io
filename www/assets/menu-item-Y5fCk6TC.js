...
`}));function R(e,t){let n={waitUntilFirstUpdated:!1,...t};return t=>class extends t{#e=!n.waitUntilFirstUpdated;updated(t){if(!this.#e){this.#e=!0;return}let n=Array.from(t).filter(([t])=>e.includes(t));if(n.length===0){super.updated(t);return}let r=n.map(([e,t])=>({attribute:e,newValue:this[e],oldValue:t}));this.emit(`syn-attributes-changed`,{detail:r}),super.updated(t)}}}var z=e((()=>{})),B,V,H=e((()=>{m(),g(),r(),y(),u(),F(),x(),c(),s(),S(),E(),w(),L(),z(),o(),B=class extends d{constructor(...e){super(...e),this.localize=new v(this),this.type=`normal`,this.checked=!1,this.value=``,this.loading=!1,this.disabled=!1,this.hasSlotController=new _(this,`submenu`),this.submenuController=new P(this,this.hasSlotController),this.handleHostClick=e=>{this.disabled&&(e.preventDefault(),e.stopImmediatePropagation())}}static{this.styles=[i,I]}static{this.dependencies={"syn-icon":C,"syn-popup":D,"syn-spinner":T}}connectedCallback(){super.connectedCallback(),this.addEventListener(`click`,this.handleHostClick)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,this.handleHostClick)}handleDefaultSlotChange(){let e=this.getTextLabel();if(this.cachedTextLabel===void 0){this.cachedTextLabel=e;return}e!==this.cachedTextLabel&&(this.cachedTextLabel=e,this.emit(`slotchange`,{bubbles:!0,composed:!1,cancelable:!1}))}handleCheckedChange(){if(this.checked&&this.type!==`checkbox`){this.checked=!1,console.error(`The checked attribute can only be used on menu items with type="checkbox"`,this);return}this.type===`checkbox`?this.setAttribute(`aria-checked`,this.checked?`true`:`false`):this.removeAttribute(`aria-checked`)}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled?`true`:`false`)}handleTypeChange(){this.type===`checkbox`?(this.setAttribute(`role`,`menuitemcheckbox`),this.setAttribute(`aria-checked`,this.checked?`true`:`false`)):(this.setAttribute(`role`,`menuitem`),this.removeAttribute(`aria-checked`))}getTextLabel(){return h(this.defaultSlot)}isSubmenu(){return this.hasSlotController.test(`submenu`)}render(){let e=this.localize.dir()===`rtl`,n=this.submenuController.isExpanded();return t`
    ...
    `}},l([a(`slot:not([name])`)],B.prototype,`defaultSlot`,void 0),l([a(`.menu-item`)],B.prototype,`menuItem`,void 0),l([f()],B.prototype,`type`,void 0),l([f({type:Boolean,reflect:!0})],B.prototype,`checked`,void 0),l([f()],B.prototype,`value`,void 0),l([f({type:Boolean,reflect:!0})],B.prototype,`loading`,void 0),l([f({type:Boolean,reflect:!0})],B.prototype,`disabled`,void 0),l([b(`checked`)],B.prototype,`handleCheckedChange`,null),l([b(`disabled`)],B.prototype,`handleDisabledChange`,null),l([b(`type`)],B.prototype,`handleTypeChange`,null),B=l([R([`type`,`loading`],{waitUntilFirstUpdated:!0})],B),V=B})),U=e((()=>{H(),H(),V.define(`syn-menu-item`)}));export{N as n,U as t};