import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{c as n,t as r}from"./lit-BVDl_-fF.js";import{U as i,_ as a,d as o,f as s,m as c}from"./iframe-Dn-tjrvc.js";import{d as l,f as u,i as d,p as f,u as p}from"./blocks-Djr6a2r4.js";import{t as m}from"./select-Dg0vn-qW.js";import{t as h}from"./option-DZsPsOWq.js";import{t as g}from"./chart-C5Iy1cSV.js";import{n as _,r as v,t as y}from"./component-D_QZftXm.js";import{n as b,t as x}from"./taggedTemplateLiteral-pWa2IaV6.js";var S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z;e((()=>{S=t(i(),1),r(),m(),h(),f(),g(),v(),s(),a(),b(),A={component:`syn-chart`,parameters:{chromatic:{modes:c,pauseAnimationAtEnd:!1},design:o(`41094-279501`),docs:{description:{component:_(`chart`,`axes-default`)},page:()=>S.createElement(S.Fragment,null,S.createElement(u,null),S.createElement(l,null),S.createElement(d,null),S.createElement(p,{title:``}))}},tags:[`Charting`,`Data Visualization`],title:`Charts/Features/Axes`},j={parameters:{docs:{description:{story:_(`chart`,`axes-split-lines-hidden`)}}},render:()=>n(C||=x([`
    ...
    <\/script>
  `]))},M={parameters:{docs:{description:{story:_(`chart`,`axes-split-lines-visible`)}}},render:()=>n(w||=x([`
    ...
    <\/script>
  `]))},N={parameters:{docs:{description:{story:_(`chart`,`axes-horizontal-split-lines`)}}},render:()=>n(T||=x([`
    ...
    <\/script>
  `]))},P={parameters:{docs:{description:{story:_(`chart`,`axes-vertical-split-lines`)}}},render:()=>n(E||=x([`
    ...
    <\/script>
  `]))},F={parameters:{docs:{description:{story:_(`chart`,`axes-labels-hidden`)}}},render:()=>n(D||=x([`
    ...
    <\/script>
  `]))},I={parameters:{docs:{description:{story:_(`chart`,`axes-lines-visible-labels-hidden`)}}},render:()=>n(O||=x([`
    ...
    <\/script>
  `]))},L={parameters:{docs:{description:{story:_(`chart`,`axes-labels-with-icons`)}}},render:()=>n(k||=x([`
    <div class="controls">
