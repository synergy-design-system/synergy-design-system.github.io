import{j as p,l as lt,x as _,z as ct,n as V,u as dt}from"./iframe-CXrVFaau.js";import{n as c}from"./synergy-element-BvBcCpFC.js";import{e as C}from"./class-map-CVbkoxKv.js";import{r as E}from"./icon.component-CFKBbt_m.js";import{t as ht}from"./event-options-CNZcgQm4.js";import{a as z}from"./query-DAIS6qJ0.js";import{o as Z}from"./query-assigned-elements-BQ-t-koE.js";import{o as f}from"./if-defined-c_iTAiOS.js";import{r as tt,L as ut}from"./index-DihgwUfS.js";var et=Object.defineProperty,bt=Object.defineProperties,pt=Object.getOwnPropertyDescriptor,vt=Object.getOwnPropertyDescriptors,M=Object.getOwnPropertySymbols,rt=Object.prototype.hasOwnProperty,ot=Object.prototype.propertyIsEnumerable,at=t=>{throw TypeError(t)},U=(t,e,r)=>e in t?et(t,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[e]=r,$=(t,e)=>{for(var r in e||(e={}))rt.call(e,r)&&U(t,r,e[r]);if(M)for(var r of M(e))ot.call(e,r)&&U(t,r,e[r]);return t},te=(t,e)=>bt(t,vt(e)),ee=(t,e)=>{var r={};for(var o in t)rt.call(t,o)&&e.indexOf(o)<0&&(r[o]=t[o]);if(t!=null&&M)for(var o of M(t))e.indexOf(o)<0&&ot.call(t,o)&&(r[o]=t[o]);return r},i=(t,e,r,o)=>{for(var a=o>1?void 0:o?pt(e,r):e,s=t.length-1,l;s>=0;s--)(l=t[s])&&(a=(o?l(e,r,a):l(a))||a);return o&&a&&et(e,r,a),a},W=(t,e,r)=>e.has(t)||at("Cannot "+r),v=(t,e,r)=>(W(t,e,"read from private field"),e.get(t)),B=(t,e,r)=>e.has(t)?at("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,r),H=(t,e,r,o)=>(W(t,e,"write to private field"),e.set(t,r),r),re=(t,e,r)=>(W(t,e,"access private method"),r);function S(t,e){const r=$({waitUntilFirstUpdate:!1},e);return(o,a)=>{const{update:s}=o,l=Array.isArray(t)?t:[t];o.update=function(n){l.forEach(u=>{const b=u;if(n.has(b)){const m=n.get(b),T=this[b];m!==T&&(!r.waitUntilFirstUpdate||this.hasUpdated)&&this[a](m,T)}}),s.call(this,n)}}}var k=p`
	/* stylelint-disable */
  :host {
...
`,O=class extends y{constructor(){super(...arguments),this.observedElements=[],this.disabled=!1}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(t=>{this.emit("syn-resize",{detail:{entries:t}})}),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}handleSlotChange(){this.disabled||this.startObserver()}startObserver(){const t=this.shadowRoot.querySelector("slot");if(t!==null){const e=t.assignedElements({flatten:!0});this.observedElements.forEach(r=>this.resizeObserver.unobserve(r)),this.observedElements=[],e.forEach(r=>{this.resizeObserver.observe(r),this.observedElements.push(r)})}}stopObserver(){this.resizeObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}render(){return _` <slot @slotchange=${this.handleSlotChange}></slot> `}};O.styles=[k,Mt];i([c({type:Boolean,reflect:!0})],O.prototype,"disabled",2);i([S("disabled",{waitUntilFirstUpdate:!0})],O.prototype,"handleDisabledChange",1);function Ot(t,e){return{top:Math.round(t.getBoundingClientRect().top-e.getBoundingClientRect().top),left:Math.round(t.getBoundingClientRect().left-e.getBoundingClientRect().left)}}function Q(t,e,r="vertical",o="smooth"){const a=Ot(t,e),s=a.top+e.scrollTop,l=a.left+e.scrollLeft,n=e.scrollLeft,u=e.scrollLeft+e.offsetWidth,b=e.scrollTop,m=e.scrollTop+e.offsetHeight;(r==="horizontal"||r==="both")&&(l<n?e.scrollTo({left:l,behavior:o}):l+t.clientWidth>u&&e.scrollTo({left:l-e.offsetWidth+t.clientWidth,behavior:o})),(r==="vertical"||r==="both")&&(s<b?e.scrollTo({top:s,behavior:o}):s+t.clientHeight>m&&e.scrollTo({top:s-e.offsetHeight+t.clientHeight,behavior:o}))}var Rt=p`
	/* stylelint-disable */
  :host {
    display: inline-block;
...
`,Ut=0,A=class extends y{constructor(){super(...arguments),this.attrId=++Ut,this.componentId=`syn-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return _`
      ...
      ></slot>
    `}};A.styles=[k,Vt,Nt];i([c({reflect:!0})],A.prototype,"name",2);i([c({type:Boolean,reflect:!0})],A.prototype,"active",2);i([S("active")],A.prototype,"handleActiveChange",1);A.define("syn-tab-panel");export{it as L,y as S,ee as _,$ as a,i as b,k as c,te as d,w as e,At as f,B as g,H as h,ae as i,v as j,re as k,oe as m,N as n,S as w};
