import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-DRz18Lsn.js";import{c as i,h as a,t as o}from"./lit-D4-0ovri.js";import{a as s,d as c,n as l,o as u,r as d,s as f,t as p}from"./synergy-element-Di-hMrpy.js";import{t as m}from"./query-DOHNhzf6.js";import{n as h,t as g}from"./localize-Du3bqz3O.js";import{t as _}from"./button-CBC8ywKX.js";import{t as v}from"./icon-BbsmBxau.js";import{a as y,i as b,n as x,o as S,r as C,t as w}from"./component-NnlguzJ1.js";import{t as T}from"./taggedTemplateLiteral-BZenJ0bZ.js";var E;function D(){return(D=e((()=>{o(),E=a`
  :host {
    --size: 120px;
...
`})))()}var O;function k(){return(k=e((()=>{f(),o(),g(),u(),l(),D(),O=class extends p{constructor(...e){super(...e),this.localize=new h(this),this.value=0,this.label=``}static{this.styles=[s,E]}updated(e){if(super.updated(e),e.has(`value`)){let e=parseFloat(getComputedStyle(this.indicator).getPropertyValue(`r`)),t=2*Math.PI*e,n=t-this.value/100*t;Number.isFinite(n)&&(this.indicator.style.strokeDashoffset=`${n}px`)}}render(){return i`
  ...
  `},U={parameters:{docs:{description:{story:x(`progress-ring`,`show-values`)}}},render:()=>i(M||=T([`
    ...
    <\/script>
  `]))},W=w({Default:R,Size:z,TrackAndIndicatorWidth:B,Colors:V,Labels:H,ShowingValues:U},300),G=[`Default`,`Size`,`TrackAndIndicatorWidth`,`Colors`,`Labels`,`ShowingValues`,`Screenshot`],R.parameters={...R.parameters,docs:{...R.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
  ...
  Labels,
  ShowingValues
}, 300)`,...W.parameters?.docs?.source}}}})))()}export{K as n,j as r,R as t};