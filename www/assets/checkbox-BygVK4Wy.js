import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,Ut as r}from"./iframe-BcSabCAt.js";import{n as i,t as a}from"./class-map-ubcCJG2R.js";import{r as o,t as s}from"./form-HkaLsLdT.js";import{r as c,t as l}from"./slot-BUy-JBM2.js";import{n as u,t as d}from"./if-defined-B5YranhM.js";import{a as f,i as p,m,n as h,o as g,r as _,s as v,t as y,u as b}from"./synergy-element-B9jDHluB.js";import{n as x,t as S}from"./watch-0Lf6m-Da.js";import{n as C,t as w}from"./icon.component-Coa5KnIf.js";import{n as T,t as E}from"./decorator-C8FY8E2M.js";import{n as D,t as O}from"./live-zyI4kXJQ.js";import{n as k,t as A}from"./default-value-B6d63V_p.js";import{n as j,t as M}from"./form-control.styles-DcimUnT6.js";var N,P=e((()=>{t(),N=r`
...
`})),F,I,L=e((()=>{a(),k(),o(),c(),t(),d(),O(),v(),S(),g(),j(),h(),C(),P(),T(),p(),F=class extends y{constructor(...e){super(...e),this.formControlController=new s(this,{value:e=>e.checked?e.value||`on`:void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=t}),this.hasSlotController=new l(this,`help-text`),this.title=``,this.name=``,this.size=`medium`,this.disabled=!1,this.readonly=!1,this.checked=!1,this.indeterminate=!1,this.defaultChecked=!1,this.form=``,this.required=!1,this.helpText=``}static{this.styles=[f,M,N]}static{this.dependencies={"syn-icon":w}}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleClick(e){if(this.readonly){e.preventDefault();return}this.checked=!this.checked,this.indeterminate=!1,this.emit(`syn-change`)}handleBlur(){this.emit(`syn-blur`)}handleInput(){this.emit(`syn-input`)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleFocus(){this.emit(`syn-focus`)}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStateChange(){this.input.checked=this.checked,this.input.indeterminate=this.indeterminate,this.formControlController.updateValidity()}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){let e=this.hasSlotController.test(`help-text`),t=this.helpText?!0:!!e;return n`
    ...
    `}},_([b(`input[type="checkbox"]`)],F.prototype,`input`,void 0),_([m({reflect:!0})],F.prototype,`title`,void 0),_([m()],F.prototype,`name`,void 0),_([m()],F.prototype,`value`,void 0),_([m({reflect:!0})],F.prototype,`size`,void 0),_([m({type:Boolean,reflect:!0})],F.prototype,`disabled`,void 0),_([m({type:Boolean,reflect:!0})],F.prototype,`readonly`,void 0),_([m({type:Boolean,reflect:!0})],F.prototype,`checked`,void 0),_([m({type:Boolean,reflect:!0})],F.prototype,`indeterminate`,void 0),_([A(`checked`)],F.prototype,`defaultChecked`,void 0),_([m({reflect:!0})],F.prototype,`form`,void 0),_([m({type:Boolean,reflect:!0})],F.prototype,`required`,void 0),_([m({attribute:`help-text`})],F.prototype,`helpText`,void 0),_([x(`disabled`,{waitUntilFirstUpdate:!0})],F.prototype,`handleDisabledChange`,null),_([x([`checked`,`indeterminate`],{waitUntilFirstUpdate:!0})],F.prototype,`handleStateChange`,null),F=_([E(`SynCheckbox`)],F),I=F})),R=e((()=>{L(),L(),I.define(`syn-checkbox`)}));export{R as t};