import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,h as n,t as r}from"./lit-DWg8XNs3.js";import{n as i,t as a}from"./class-map-BVGUkHwV.js";import{n as o,t as s}from"./localize-CzgwcyM2.js";import{_ as c,a as l,f as u,i as d,n as f,o as p,r as m,s as h,t as g,y as _}from"./synergy-element-CsptVtzA.js";import{n as v,t as y}from"./watch-I6gMK-uE.js";import{n as b,t as x}from"./icon.component-mVYlhNl8.js";import{n as S,t as C}from"./decorator-ChmomMqD.js";var w,T=e((()=>{r(),w=n`
  :host {
    display: block;
...
`})),E,D=e((()=>{E=(e,t)=>{let n=t.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`),r=new RegExp(n,`g`);return e.replace(r,`_`)}})),O,k,A=e((()=>{a(),r(),s(),h(),y(),p(),f(),b(),T(),D(),S(),d(),O=class extends g{constructor(...e){super(...e),this.localize=new o(this),this.originalValue=``,this.isInitialized=!1,this.delimiter=` `,this.current=!1,this.selected=!1,this.hasHover=!1,this.value=``,this.disabled=!1}static{this.styles=[l,w]}static{this.dependencies={"syn-icon":x}}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`option`),this.setAttribute(`aria-selected`,`false`)}handleDefaultSlotChange(){this.isInitialized?this.triggerParentDefaultSlotChange():this.isInitialized=!0}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled?`true`:`false`)}handleSelectedChange(){this.setAttribute(`aria-selected`,this.selected?`true`:`false`)}handleDelimiterChange(){this.sanitizeValueForDelimiter()}handleValueChange(){this.originalValue=this.value,this.sanitizeValueForDelimiter()}sanitizeValueForDelimiter(){let e=this.originalValue;if(typeof e==`number`)return;typeof e!=`string`&&(e=String(e));let{delimiter:t}=this;e.includes(t)&&(console.error(`Option values cannot include "${t}". All occurrences of "${t}" have been replaced with "_".`,this),e=E(e,this.delimiter)),this.value=e,this.triggerParentDefaultSlotChange()}getTextLabel(){let e=this.childNodes,t=``;return[...e].forEach(e=>{e.nodeType===Node.ELEMENT_NODE&&(e.hasAttribute(`slot`)||(t+=e.textContent)),e.nodeType===Node.TEXT_NODE&&(t+=e.textContent)}),t.trim()}triggerParentDefaultSlotChange(){customElements.whenDefined(`syn-combobox`).then(()=>{let e=this.closest(`syn-combobox`);e&&e.handleDefaultSlotChange()}),customElements.whenDefined(`syn-select`).then(()=>{let e=this.closest(`syn-select`);e&&e.handleDefaultSlotChange()})}render(){return t`
    ...
    `}},m([u(`.option__label`)],O.prototype,`defaultSlot`,void 0),m([c()],O.prototype,`delimiter`,void 0),m([c()],O.prototype,`current`,void 0),m([c()],O.prototype,`selected`,void 0),m([c()],O.prototype,`hasHover`,void 0),m([_({reflect:!0})],O.prototype,`value`,void 0),m([_({type:Boolean,reflect:!0})],O.prototype,`disabled`,void 0),m([v(`disabled`)],O.prototype,`handleDisabledChange`,null),m([v(`selected`)],O.prototype,`handleSelectedChange`,null),m([v(`delimiter`)],O.prototype,`handleDelimiterChange`,null),m([v(`value`)],O.prototype,`handleValueChange`,null),O=m([C(`SynOption`)],O),k=O})),j,M=e((()=>{r(),j=n`
  /**
