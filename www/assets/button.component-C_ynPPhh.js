import{i as e}from"./preload-helper-xPQekRTU.js";import{It as t,M as n,O as r,k as i,qt as a}from"./iframe-BjJCO_Oc.js";import{n as o,t as s}from"./class-map-BR8a3Elu.js";import{i as c,r as l,t as u}from"./form-CV4G6JGX.js";import{n as d,r as f,t as p}from"./slot-DgcqpP0-.js";import{r as m,t as h}from"./if-defined-B8V0AGPZ.js";import{n as g,t as _}from"./localize-CzgwcyM2.js";import{_ as v,a as y,f as b,i as x,n as S,o as C,r as w,s as T,t as E,y as D}from"./synergy-element-C6zHV5cB.js";import{n as O,t as k}from"./watch-I6gMK-uE.js";import{n as A,t as j}from"./icon.component-DiYdmcOy.js";import{n as M,t as N}from"./spinner.component-BA4ZBc5D.js";import{n as P,t as F}from"./decorator-ChmomMqD.js";var I,L=e((()=>{t(),I=a`
	/* stylelint-disable */
  :host {
...
`})),B,V,H=e((()=>{s(),l(),f(),r(),h(),_(),T(),k(),C(),S(),A(),M(),L(),z(),P(),x(),B=class extends E{constructor(...e){super(...e),this.formControlController=new u(this,{assumeInteractionOn:[`click`]}),this.hasSlotController=new p(this,`[default]`,`prefix`,`suffix`),this.localize=new g(this),this.iconOnly=!1,this.hasFocus=!1,this.invalid=!1,this.title=``,this.variant=`outline`,this.size=`medium`,this.caret=!1,this.disabled=!1,this.loading=!1,this.type=`button`,this.name=``,this.value=``,this.href=``,this.rel=`noreferrer noopener`}static{this.styles=[y,I,R]}static{this.dependencies={"syn-icon":j,"syn-spinner":N}}get validity(){return this.isButton()?this.button.validity:c}get validationMessage(){return this.isButton()?this.button.validationMessage:``}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleClick(){this.type===`submit`&&this.formControlController.submit(this),this.type===`reset`&&this.formControlController.reset(this)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}isButton(){return!this.href}isLink(){return!!this.href}handleSlotChange(){let e=d(this.defaultSlot).trim(),t=this.defaultSlot.assignedElements({flatten:!0}),n=t.length===1&&t[0].tagName.toLowerCase()===`syn-icon`;this.iconOnly=n&&e===``}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(e){this.isButton()&&(this.button.setCustomValidity(e),this.formControlController.updateValidity())}render(){let e=this.isLink(),t=e?i`a`:i`button`;return n`
      ...
      >
        ...
        ${this.caret?n` <syn-icon part="caret" class="button__caret" library="system" name="chevron-down"></syn-icon> `:``}
        ${this.loading?n`<syn-spinner part="spinner"></syn-spinner>`:``}
      </${t}>
