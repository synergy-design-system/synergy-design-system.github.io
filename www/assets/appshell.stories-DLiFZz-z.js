import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{B as n,Ht as r,It as i,d as a,f as o,g as s,n as c,t as l,u}from"./iframe-BjJCO_Oc.js";import{d,f,i as p,p as m,u as h}from"./blocks-BtcIpwDF.js";import{n as g,r as _}from"./component-Bp0Gg8Fw.js";import{n as v,t as y}from"./taggedTemplateLiteral-pWa2IaV6.js";import{a as b,c as x,i as S,n as C,o as w,r as T,s as E,t as D}from"./appshell-CUWyrNK9.js";var O,k,A,j,M,N,P,F,I,L,R,z;e((()=>{O=t(n(),1),m(),i(),l(),_(),a(),x(),s(),v(),A={parameters:{chromatic:{...c?.parameters?.chromatic,disableSnapshot:!1,modes:o},design:u(`16648-52486`),docs:{description:{component:g(`application-shell`,`default`,`templates`)},page:()=>O.createElement(O.Fragment,null,O.createElement(f,null),O.createElement(d,null),O.createElement(p,null),O.createElement(h,{title:``})),story:{iframeHeight:550}}},tags:[`Application Shell`],title:`Templates/AppShell`},j={parameters:{docs:{description:{story:g(`application-shell`,`side-navigation`,`templates`)}}},render:()=>r`
  ...
  `},M={parameters:{docs:{description:{story:g(`application-shell`,`side-navigation-shrinking`,`templates`)}}},render:()=>r(k||=y([`
    <!-- .synergy-demo-application -->
    ...
    <\/script>
  `]),T(),w({noFocusTrapping:!0,open:!0}),S(),C(),b(),E(`appshell-shrink`),D(`appshell-shrink`))},N={name:`Rail Navigation (Desktop)`,parameters:{docs:{description:{story:g(`application-shell`,`rail-navigation-desktop`,`templates`)}}},render:()=>r`
    <!-- .synergy-demo-application -->
  ...
  `},P={...N,globals:{viewport:{value:`mobile2`}},name:`↳ Tablet`,parameters:{controls:{exclude:[`default`]},docs:{description:{story:g(`application-shell`,`rail-navigation-mobile`,`templates`)}}}},F={name:`Sticky Navigation (Desktop)`,parameters:{docs:{description:{story:g(`application-shell`,`sticky-navigation-desktop`,`templates`)}}},render:()=>r`
    <!-- .synergy-demo-application -->
  ...
  `},I={...F,globals:{viewport:{value:`mobile2`}},name:`↳ Tablet`,parameters:{controls:{exclude:[`default`]},docs:{description:{story:g(`application-shell`,`sticky-navigation-mobile`,`templates`)}}}},L={parameters:{docs:{description:{story:g(`application-shell`,`top-navigation`,`templates`)}}},render:()=>r`
    <!-- .synergy-demo-application -->
  ...
  `},R={parameters:{docs:{description:{story:g(`application-shell`,`alternative-background`,`templates`)}}},render:()=>r`
    <!-- .synergy-demo-application -->
