...
`,B={args:T([{name:"default",type:"slot",value:o().trim()}],g),argTypes:f,component:"syn-table",parameters:{chromatic:{modes:y},design:p("19479-134433"),docs:{description:{component:i}}},tags:["Structure","Styles","SICK2025"],title:"Styles/syn-table"},s={parameters:{controls:{disable:!1},docs:{description:{story:i}}},render:c=>C(c,"table")},t={render:()=>n`
