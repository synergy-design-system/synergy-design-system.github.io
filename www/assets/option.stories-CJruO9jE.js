import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{a as t,d as n,o as r,s as i}from"./preview-DdzcclEm.js";import{c as a,t as o}from"./lit-BfcklOOD.js";import{t as s}from"./icon-8cT1hKpd.js";import{t as c}from"./select-CT3sGXd9.js";import{t as l}from"./option-hlWzwvd4.js";import{a as u,i as d,n as f,o as p,r as m,t as h}from"./component-BjD7AuVi.js";import{n as g,t as _}from"./select-Co9Ugku2.js";var v,y,b,x,S,C,w,T,E,D,O,k=e((()=>{l(),c(),s(),o(),_(),m(),r(),n(),{args:v,argTypes:y}=d(`syn-option`),{overrideArgs:b}=u(`syn-option`),{generateTemplate:x}=p(`syn-option`),S={args:b([{name:`default`,type:`slot`,value:`Option 1`},{name:`value`,type:`attribute`,value:`Option_1`}],v),argTypes:y,component:`syn-option`,parameters:{design:t(`41325-312743`),docs:{chromatic:{modes:i},description:{component:f(`option`,`default`)},story:{height:`250px`}}},tags:[`Form`],title:`Components/syn-option`},C={parameters:{docs:{description:{story:f(`option`,`default`)}}},render:e=>a`
    <syn-select label="Select one">
      ${x({args:e})}
      <syn-option value="Option_2">Option 2</syn-option>
      <syn-option value="Option_3">Option 3</syn-option>
    </syn-select>
  `},w={parameters:{docs:{description:{story:f(`option`,`disabled`)}}},render:()=>a`
  ...
  `},T={parameters:{docs:{description:{story:f(`option`,`prefix-suffix`)}}},render:()=>a`
