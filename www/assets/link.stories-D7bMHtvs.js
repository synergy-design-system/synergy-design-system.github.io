import{i as e}from"./preload-helper-xPQekRTU.js";import{Ht as t,It as n,d as r,f as i,g as a,u as o}from"./iframe-BjJCO_Oc.js";import{t as s}from"./icon-BS9OsfYG.js";import{a as c,i as l,n as u,r as d,t as f}from"./component-Bp0Gg8Fw.js";import{n as p,t as m}from"./PaddingDecorator-Dc2-NRZc.js";import{n as h,t as g}from"./styles-D5hkcN8F.js";var _,v,y,b,x,S,C,w,T,E,D,O,k;e((()=>{n(),d(),g(),r(),s(),m(),a(),{args:_,argTypes:v}=l(`syn-link`),{overrideArgs:y}=c(`syn-link`),b={args:y([{name:`default`,type:`slot`,value:`Link label`},{name:`syn-link`,type:`attribute`,value:`syn-link--medium`}],_),argTypes:v,component:`syn-link`,parameters:{chromatic:{modes:i},design:o(`41337-170604`),docs:{description:{component:u(`styles`,`link`)}}},tags:[`Navigation`,`Styles`],title:`Styles/syn-link`},x={parameters:{controls:{disable:!1}},render:e=>h(e,`a`,{class:`syn-link`,href:`javascript:void(0)`})},S={parameters:{docs:{description:{story:u(`link`,`inline`)}}},render:()=>t`
    <p style="width: 266px;">
