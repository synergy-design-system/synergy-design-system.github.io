import{j as h,x as u}from"./iframe-pBZ2jdjZ.js";import{e as y}from"./class-map-BjSdlSdV.js";import{L as g}from"./localize-Dh03wnLC.js";import{S as v,c as f,n as d}from"./synergy-element-Dyk10Crc.js";import{S as m,r as a}from"./icon.component-bmAGmC-f.js";import{a as b}from"./query-DAIS6qJ0.js";import{w as l}from"./watch-CEsCE2EF.js";const _=h`
	/* stylelint-disable */
  :host {
    display: block;
    user-select: none;
...
`,z=(r,e)=>{const o=e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),t=new RegExp(o,"g");return r.replace(t,"_")};var k=Object.defineProperty,w=Object.getOwnPropertyDescriptor,i=(r,e,o,t)=>{for(var s=t>1?void 0:t?w(e,o):e,c=r.length-1,p;c>=0;c--)(p=r[c])&&(s=(t?p(e,o,s):p(s))||s);return t&&s&&k(e,o,s),s};class n extends v{constructor(){super(...arguments),this.localize=new g(this),this.originalValue="",this.isInitialized=!1,this.delimiter=" ",this.current=!1,this.selected=!1,this.hasHover=!1,this.value="",this.disabled=!1}static{this.styles=[f,_,x]}static{this.dependencies={"syn-icon":m}}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.setAttribute("aria-selected","false")}handleDefaultSlotChange(){this.isInitialized?this.triggerParentDefaultSlotChange():this.isInitialized=!0}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleDelimiterChange(){this.sanitizeValueForDelimiter()}handleValueChange(){this.originalValue=this.value,this.sanitizeValueForDelimiter()}sanitizeValueForDelimiter(){let e=this.originalValue;if(typeof e=="number")return;typeof e!="string"&&(e=String(e));const{delimiter:o}=this;e.includes(o)&&(console.error(`Option values cannot include "${o}". All occurrences of "${o}" have been replaced with "_".`,this),e=z(e,this.delimiter)),this.value=e,this.triggerParentDefaultSlotChange()}getTextLabel(){const e=this.childNodes;let o="";return[...e].forEach(t=>{t.nodeType===Node.ELEMENT_NODE&&(t.hasAttribute("slot")||(o+=t.textContent)),t.nodeType===Node.TEXT_NODE&&(o+=t.textContent)}),o.trim()}triggerParentDefaultSlotChange(){customElements.whenDefined("syn-combobox").then(()=>{const e=this.closest("syn-combobox");e&&e.handleDefaultSlotChange()}),customElements.whenDefined("syn-select").then(()=>{const e=this.closest("syn-select");e&&e.handleDefaultSlotChange()})}render(){return u`
    ...
    `}}i([b(".option__label")],n.prototype,"defaultSlot",2);i([a()],n.prototype,"delimiter",2);i([a()],n.prototype,"current",2);i([a()],n.prototype,"selected",2);i([a()],n.prototype,"hasHover",2);i([d({reflect:!0})],n.prototype,"value",2);i([d({type:Boolean,reflect:!0})],n.prototype,"disabled",2);i([l("disabled")],n.prototype,"handleDisabledChange",1);i([l("selected")],n.prototype,"handleSelectedChange",1);i([l("delimiter")],n.prototype,"handleDelimiterChange",1);i([l("value")],n.prototype,"handleValueChange",1);const V=h`
  /**
