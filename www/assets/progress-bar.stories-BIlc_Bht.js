import{e as _}from"./class-map-DuCXFyun.js";import{e as w,i as B,t as k,E as C,k as S,c as n,C as E,d as z}from"./iframe-CfKmpROb.js";import{o as $}from"./if-defined-DcCHMlyu.js";import{L as D}from"./controller-0nuky388.js";import{S as I,c as L,n as b}from"./synergy-element-D6uzLjd8.js";import"./button-Dmxtjkv9.js";import"./icon-CfrH2nmK.js";import{g as i,a as P,s as T,b as O,c as j}from"./component-CDJDa1-b.js";import"./preload-helper-PPVm8Dsz.js";import"./button.component-iYmpiFHk.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./icon.component-BOIuuAKO.js";import"./watch-CEsCE2EF.js";import"./query-D0jTsbLw.js";import"./spinner.component-CJLz1-cE.js";import"./decorator-jbWt9cIm.js";import"./functions-DCU90qiI.js";import"./index-3hbeBem-.js";import"./_docs-VWJ8UqMU.js";const x="important",M=" !"+x,A=w(class extends B{constructor(e){if(super(e),e.type!==k.ATTRIBUTE||e.name!=="style"||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((a,s)=>{const r=e[s];return r==null?a:a+`${s=s.includes("-")?s:s.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${r};`},"")}update(e,[a]){const{style:s}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(a)),this.render(a);for(const r of this.ft)a[r]==null&&(this.ft.delete(r),r.includes("-")?s.removeProperty(r):s[r]=null);for(const r in a){const t=a[r];if(t!=null){this.ft.add(r);const o=typeof t=="string"&&t.endsWith(M);r.includes("-")||o?s.setProperty(r,o?t.slice(0,-11):t,o?x:""):s[r]=t}}return C}}),H=S`
	/* stylelint-disable */
  :host {
    --height: 1rem;
...
`;var V=Object.defineProperty,y=(e,a,s,r)=>{for(var t=void 0,o=e.length-1,v;o>=0;o--)(v=e[o])&&(t=v(a,s,t)||t);return t&&V(a,s,t),t};class g extends I{constructor(){super(...arguments),this.localize=new D(this),this.value=0,this.indeterminate=!1,this.label=""}static{this.styles=[L,H,U]}render(){return n`
      <div
        part="base"
    ...
    `}}y([b({type:Number,reflect:!0})],g.prototype,"value");y([b({type:Boolean,reflect:!0})],g.prototype,"indeterminate");y([b()],g.prototype,"label");g.define("syn-progress-bar");var h=Object.freeze,q=Object.defineProperty,F=(e,a)=>h(q(e,"raw",{value:h(e.slice())})),f;const{args:N,argTypes:R}=T("syn-progress-bar"),{overrideArgs:W}=j("syn-progress-bar"),{generateTemplate:Z}=O("syn-progress-bar"),ge={args:W({name:"value",type:"attribute",value:33.3},N),argTypes:R,component:"syn-progress-bar",parameters:{chromatic:{modes:E},design:z("41203-297162"),docs:{description:{component:i("progress-bar","default")}}},tags:["Feedback"],title:"Components/syn-progress-bar"},l={parameters:{docs:{description:{story:i("progress-bar","default")}}},render:e=>Z({args:e})},c={parameters:{docs:{description:{story:i("progress-bar","labels")}}},render:()=>n`
  ...
  `},u=P({Default:l,Labels:c,CustomHeight:p,ShowingValues:d,Indeterminate:m},180);l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
