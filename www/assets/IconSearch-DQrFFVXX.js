import{j as we,M as Ri}from"./index-jknKZv3M.js";import{useMDXComponents as fi}from"./index-CHrGa5Tm.js";import{b as x,r as pt,R as be}from"./index-_2TAQcTa.js";import{i as d,r as ji,x as u,e as Hi,u as Pt,E as Ui,T as Wi,B as Ki}from"./directive-helpers-Dvm_Ferq.js";import{n as r,a as _,r as Gi}from"./library-C58jM0s5.js";import{e as m,i as Ee,a as b,o as g,u as se,c as Zi,t as Xi}from"./if-defined-zGpnP1OK.js";import{r as yi,L as Yi,a as ot,t as Qi,l as Je,b as Ji,c as eo,f as to,s as io,d as Rt,e as oo,p as wt,g as ao,h as so,i as ro,o as vi,j as no,k as lo,m as po,n as co}from"./ref-CgC99LRu.js";import{d as At}from"./default-icons--FEJ2Psb.js";import"./iframe-Clf3-jo3.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-BwkS7JH_.js";import"./index-DrFu-skq.js";/**
 * @license
...
`,Et="";function Kt(e){Et=e}function Oo(e=""){if(!Et){const t=[...document.getElementsByTagName("script")],i=t.find(a=>a.hasAttribute("data-synergy"));if(i)Kt(i.getAttribute("data-synergy"));else{const a=t.find(n=>/synergy(\.min)?\.js($|\?)/.test(n.src)||/synergy-autoloader(\.min)?\.js($|\?)/.test(n.src));let s="";a&&(s=a.getAttribute("src")),Kt(s.split("/").slice(0,-1).join("/"))}}return Et.replace(/\/$/,"")+(e?`/${e.replace(/^\//,"")}`:"")}var Ao={name:"default",resolver:e=>Oo(`assets/icons/${e}.svg`)},Io=Ao,Gt={add:`
		...
		<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill='currentColor'><path d="M19 6.41L17.59 5L12 10.59L6.41 5L5 6.41L10.59 12L5 17.59L6.41 19L12 13.41L17.59 19L19 17.59L13.41 12L19 6.41Z"/></svg>`},Eo={name:"system",resolver:e=>e in Gt?`data:image/svg+xml,${encodeURIComponent(Gt[e])}`:""},To=Eo,Lo=[Io,To],Tt=[];function Do(e){Tt.push(e)}function Mo(e){Tt=Tt.filter(t=>t!==e)}function Zt(e){return Lo.find(t=>t.name===e)}var Fo=d`
  /* Write custom CSS here */
`,Vo=d`
	/* stylelint-disable */
  :host {
...
`,Wo=0,Re=class extends v{constructor(){super(...arguments),this.attrId=++Wo,this.componentId=`syn-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return u`
      <slot
        part="base"
        class=${b({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}};Re.styles=[z,Uo,Ho];o([r({reflect:!0})],Re.prototype,"name",2);o([r({type:Boolean,reflect:!0})],Re.prototype,"active",2);o([f("active")],Re.prototype,"handleActiveChange",1);var Ko="syn-tab-panel";Re.define("syn-tab-panel");w({displayName:"SynTabPanel",elementClass:Re,events:{},react:x,tagName:Ko});var Go=d`
  /* Write custom CSS here */
...
`,He=class extends v{constructor(){super(...arguments),this.hasMenuItemsWithCheckmarks=!1,this.updateCheckMarksByChildPropChange=e=>{e.stopImmediatePropagation(),this.handleUpdateCheckmarks(this.getAllItems())}}handleUpdateCheckmarks(e){this.hasMenuItemsWithCheckmarks=e.some(t=>t.type==="checkbox"||t.loading)}disconnectedCallback(){this.removeEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu"),this.addEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}handleClick(e){const t=["menuitem","menuitemcheckbox"],i=e.composedPath(),a=i.find(p=>{var c;return t.includes(((c=p?.getAttribute)==null?void 0:c.call(p,"role"))||"")});if(!a||i.find(p=>{var c;return((c=p?.getAttribute)==null?void 0:c.call(p,"role"))==="menu"})!==this)return;const l=a;l.type==="checkbox"&&(l.checked=!l.checked),this.emit("syn-select",{detail:{item:l}})}handleKeyDown(e){if(e.key==="Enter"||e.key===" "){const t=this.getCurrentItem();e.preventDefault(),e.stopPropagation(),t?.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(e.key)){const t=this.getAllItems(),i=this.getCurrentItem();let a=i?t.indexOf(i):0;t.length>0&&(e.preventDefault(),e.stopPropagation(),e.key==="ArrowDown"?a++:e.key==="ArrowUp"?a--:e.key==="Home"?a=0:e.key==="End"&&(a=t.length-1),a<0&&(a=t.length-1),a>t.length-1&&(a=0),this.setCurrentItem(t[a]),t[a].focus())}}handleMouseDown(e){const t=e.target;this.isMenuItem(t)&&this.setCurrentItem(t)}handleSlotChange(){const e=this.getAllItems();this.handleUpdateCheckmarks(e),e.length>0&&this.setCurrentItem(e[0])}isMenuItem(e){var t;return e.tagName.toLowerCase()==="syn-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes((t=e.getAttribute("role"))!=null?t:"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>!(e.inert||!this.isMenuItem(e)))}getCurrentItem(){return this.getAllItems().find(e=>e.getAttribute("tabindex")==="0")}setCurrentItem(e){this.getAllItems().forEach(i=>{i.setAttribute("tabindex",i===e?"0":"-1")})}render(){return u`
      ...
      ></slot>
    `}};He.styles=[z,ns,rs];o([m("slot")],He.prototype,"defaultSlot",2);o([_()],He.prototype,"hasMenuItemsWithCheckmarks",2);var ls=d`
  /* Write custom CSS here */
`,ps=d`
	/* stylelint-disable */
  :host {
...
`,Ue=class extends v{constructor(){super(...arguments),this.localize=new B(this),this.value=0,this.indeterminate=!1,this.label=""}render(){return u`
      <div
        part="base"
    ...
    `}};Ue.styles=[z,us,ds];o([r({type:Number,reflect:!0})],Ue.prototype,"value",2);o([r({type:Boolean,reflect:!0})],Ue.prototype,"indeterminate",2);o([r()],Ue.prototype,"label",2);var ms="syn-progress-bar";Ue.define("syn-progress-bar");w({displayName:"SynProgressBar",elementClass:Ue,events:{},react:x,tagName:ms});var hs=d`
	/* stylelint-disable */
  :host {
    --size: 128px;
    --track-width: 4px;
...
`,_t=class extends v{render(){return u`
    ...
    `}};_t.styles=[z,Bs,Ns];_t.dependencies={"syn-divider":ke};var qs="syn-menu-label";_t.define("syn-menu-label");w({displayName:"SynMenuLabel",elementClass:_t,events:{},react:x,tagName:qs});var Ps="syn-menu";He.define("syn-menu");w({displayName:"SynMenu",elementClass:He,events:{onSynSelect:"syn-select"},react:x,tagName:Ps});var Rs=d`
  :host {
...
`,qe=class extends v{constructor(){super(...arguments),this.localize=new B(this),this.variant="primary"}render(){return u`
      <span
        part="base"
    ...
    `}};qe.styles=[z,gr,hr];o([r({reflect:!0})],qe.prototype,"variant",2);qe=o([te("SynBadge")],qe);var fr="syn-badge";qe.define("syn-badge");w({displayName:"SynBadge",elementClass:qe,events:{},react:x,tagName:fr});var yr=d`
  .breadcrumb-item {
    color: var(--syn-color-neutral-500);
    font-size: var(--syn-font-size-x-small);
    font-weight: var(--syn-font-weight-normal);
...
`,we.jsx(Tr,{})]})}function Kr(e={}){const{wrapper:t}={...fi(),...e.components};return t?we.jsx(t,{...e,children:we.jsx(gi,{...e})}):gi(e)}export{Kr as default};
