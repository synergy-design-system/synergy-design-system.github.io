import"./preview-BMgyQje8.js";import{x as e}from"./lit-element-ZYWMe1i1.js";import{s as u,a as f,g as n,b as g,c as h}from"./component-CzF4s4R4.js";import"./index-DH5ua8nC.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon-button-DcbuMwrE.js";import"./icon.component-D55FUTwa.js";import"./directive-helpers-CkpR4LMI.js";import"./icon-BrqnReZV.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-7bc9rCDE.js";const{args:b,argTypes:x}=u("syn-nav-item"),{overrideArgs:S}=h("syn-nav-item"),{generateTemplate:D}=f("syn-nav-item"),P={args:S([{name:"default",type:"slot",value:"Label"}],b),argTypes:x,component:"syn-nav-item",parameters:{docs:{description:{component:n("nav-item","default")}}},title:"Components/syn-nav-item"},t={parameters:{controls:{disable:!1},docs:{description:{story:n("nav-item","default")}}},render:y=>D({args:y})},r={parameters:{docs:{description:{story:n("nav-item","labels")}}},render:()=>e`
  ...
  `},p=g({Default:t,Labels:r,Current:a,HorizontalNavigation:s,PrefixAndSuffixSlot:i,ChildrenClosedOrOpenVerticalOnly:o,Divider:m,Disabled:c},300);t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
