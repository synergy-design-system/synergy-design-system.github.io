import{e as _}from"./class-map-DObhmZTe.js";import{e as w,i as B,t as k,E as C,j as S,c as n,C as E,d as z}from"./iframe-DjKwnCJx.js";import{o as $}from"./if-defined-C5xfBg6O.js";import{L as D}from"./localize-Dh03wnLC.js";import{S as I,c as L,n as b}from"./synergy-element-CqcYJLyx.js";import"./button-BWr5zH_F.js";import"./icon-CFQVx00F.js";import{g as i,a as P,s as T,b as j,c as O}from"./component-Diy1U31w.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DihgwUfS.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./icon.component-Cu3Vs0eq.js";import"./watch-CEsCE2EF.js";import"./query-D0jTsbLw.js";import"./spinner.component-D8mG9v_h.js";import"./decorator-CWkWRMhy.js";import"./functions-bkELIyT9.js";import"./index-3hbeBem-.js";import"./_docs-DSlvmijE.js";const x="important",M=" !"+x,A=w(class extends B{constructor(e){if(super(e),e.type!==k.ATTRIBUTE||e.name!=="style"||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((a,s)=>{const r=e[s];return r==null?a:a+`${s=s.includes("-")?s:s.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${r};`},"")}update(e,[a]){const{style:s}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(a)),this.render(a);for(const r of this.ft)a[r]==null&&(this.ft.delete(r),r.includes("-")?s.removeProperty(r):s[r]=null);for(const r in a){const t=a[r];if(t!=null){this.ft.add(r);const o=typeof t=="string"&&t.endsWith(M);r.includes("-")||o?s.setProperty(r,o?t.slice(0,-11):t,o?x:""):s[r]=t}}return C}}),H=S`
	/* stylelint-disable */
  :host {
    --height: 1rem;
