import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,d as r,f as i,g as a,u as o}from"./iframe-CIeU5pXv.js";import{t as s}from"./button-DQZ97ppS.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-Dma-UHGC.js";import{n as m,t as h}from"./taggedTemplateLiteral-BuD1d7yP.js";import{t as g}from"./checkbox-D1LAOfOE.js";var _,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P;e((()=>{g(),s(),t(),f(),r(),a(),m(),{userEvent:_}=__STORYBOOK_MODULE_TEST__,{argTypes:y}=l(`syn-checkbox`),{overrideArgs:b}=c(`syn-checkbox`),{generateTemplate:x}=d(`syn-checkbox`),S={args:b([{name:`default`,type:`slot`,value:`Checkbox`}]),argTypes:y,component:`syn-checkbox`,parameters:{chromatic:{modes:i},design:o(`41310-257927`),docs:{description:{component:u(`checkbox`,`default`)}}},tags:[`Form`],title:`Components/syn-checkbox`},C={parameters:{controls:{disable:!1},docs:{description:{story:u(`checkbox`,`default`)}}},render:e=>x({args:e})},w={parameters:{docs:{description:{story:u(`checkbox`,`checked`)}}},render:()=>n`<syn-checkbox checked>Checked</syn-checkbox>`},T={parameters:{docs:{description:{story:u(`checkbox`,`help-text`)}}},render:()=>n`
    <syn-checkbox help-text="What should the user know about the checkbox?">Label</syn-checkbox>
  `},E={parameters:{docs:{description:{story:u(`checkbox`,`indeterminate`)}}},render:()=>n`<syn-checkbox indeterminate>Indeterminate</syn-checkbox>`},D={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`checkbox`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-checkbox`);t&&t.focus()},render:()=>n`<syn-checkbox>Focused</syn-checkbox>`},O={parameters:{docs:{description:{story:u(`checkbox`,`disabled`)}}},render:()=>n`<syn-checkbox disabled>Disabled</syn-checkbox>`},k={parameters:{docs:{description:{story:u(`checkbox`,`readonly`)}}},render:()=>n`
  ...
  `},A={parameters:{docs:{description:{story:u(`checkbox`,`sizes`)}}},render:()=>n`
    <div style="display: flex; flex-direction: column; gap: var(--syn-spacing-large);">
  ...
  Readonly,
  Sizes
}, 200)`,...N.parameters?.docs?.source}}},P=[`Default`,`Checked`,`HelpText`,`Indeterminate`,`Focus`,`Disabled`,`Readonly`,`Sizes`,`Invalid`,`CustomValidity`,`Screenshot`]}))();export{w as Checked,M as CustomValidity,C as Default,O as Disabled,D as Focus,T as HelpText,E as Indeterminate,j as Invalid,k as Readonly,N as Screenshot,A as Sizes,P as __namedExportsOrder,S as default};