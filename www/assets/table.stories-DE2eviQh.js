import{e as r,g as $,p as C,x as a}from"./iframe-GSRepqjd.js";import{T as z,S,b as L,c as E}from"./blocks-DiKNm65j.js";import{g as D}from"./component-sz2YSCF4.js";import{g as l}from"./translations-CnhJ1T76.js";import"./button-CwZJTvX8.js";import"./icon-DLaBEzps.js";import"./index-Bkk0Z6Ex.js";import"./_docs-CrPFe_9C.js";import"./class-map-QQ7HVnPG.js";import"./property-ImbD-3qY.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./static-BkNWbPkN.js";import"./if-defined-CDNCanKK.js";import"./localize-CatY2peN.js";import"./index-DihgwUfS.js";import"./directive-helpers-CvZEagFv.js";import"./query-DAIS6qJ0.js";import"./watch-CEsCE2EF.js";import"./component.styles-DXWA7L2q.js";import"./icon.component-B3J6d3UF.js";import"./spinner.component-pJEN2kXr.js";import"./decorator-DANECR0-.js";import"./functions-CDi3doZH.js";var w=Object.freeze,_=Object.defineProperty,v=(e,s)=>w(_(e,"raw",{value:w(e.slice())})),g,x,f,T;const o=(e,s=5)=>new Array(s).fill(void 0).map(e),n=(e=void 0)=>{const s=e?`syn-table-cell--shadow-${e} shadow-cell`:"",t=d=>`${e==="end"&&d===0||e==="start"&&d===4||e==="bottom"?s:""}`;return a`
    <thead>
      <tr>
...
`,te={parameters:{chromatic:{...C?.parameters?.chromatic,disableSnapshot:!1},design:$("19923-55456"),docs:{description:{component:D("table","default","templates")},page:()=>r.createElement(r.Fragment,null,r.createElement(z,null),r.createElement(S,null),r.createElement(L,null),r.createElement(E,{title:""})),story:{iframeHeight:550}}},tags:["Structure"],title:"Templates/Table"},h={render:()=>{const e=o(()=>c());return a`
    ...
    `}},i={render:()=>{const e=o(()=>c("end"));return a(g||(g=v([`
      ...
      <\/script>
    `])),n("end"),e)}},b={render:()=>{const e=o(()=>c("start"));return a(x||(x=v([`
      ...
      <\/script>
    `])),n("start"),e)}},p={render:()=>{const e=o(()=>c());return a(f||(f=v([`
...
}`,...u.parameters?.docs?.source}}};const ae=["TableWithHeader","TableWithAlternatingRows","TableWithBorders","TableShadowLeftColumn","TableShadowRightColumn","TableShadowTopRow","TableProduct"];export{u as TableProduct,i as TableShadowLeftColumn,b as TableShadowRightColumn,p as TableShadowTopRow,y as TableWithAlternatingRows,m as TableWithBorders,h as TableWithHeader,ae as __namedExportsOrder,te as default};
