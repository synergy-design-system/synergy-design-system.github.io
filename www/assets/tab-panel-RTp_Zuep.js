...
`})),X,ht=e((()=>{ft(),mt(),z(),et(),D(),A(),C(),u(),r(),te(),m(),X=class extends k{constructor(){super(...arguments),this.hasFocus=!1,this.label=``,this.size=`inherit`,this.color=`currentColor`,this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){let e=!!this.href,n=e?a`a`:a`button`;return t`
    ...
    `}},Z.styles=[E,tt,rt],Z.dependencies={"syn-icon-button":X,"syn-resize-observer":Y},v([ne({slot:`nav`,selector:`syn-tab`})],Z.prototype,`tabs`,2),v([ne({selector:`syn-tab-panel`})],Z.prototype,`panels`,2),v([h(`.tab-group`)],Z.prototype,`tabGroup`,2),v([h(`.tab-group__body`)],Z.prototype,`body`,2),v([h(`.tab-group__nav`)],Z.prototype,`nav`,2),v([h(`.tab-group__indicator`)],Z.prototype,`indicator`,2),v([f()],Z.prototype,`hasScrollControls`,2),v([f()],Z.prototype,`shouldHideScrollStartButton`,2),v([f()],Z.prototype,`shouldHideScrollEndButton`,2),v([p()],Z.prototype,`placement`,2),v([p()],Z.prototype,`activation`,2),v([p({attribute:`no-scroll-controls`,type:Boolean})],Z.prototype,`noScrollControls`,2),v([p({type:Boolean})],Z.prototype,`contained`,2),v([p({type:Boolean})],Z.prototype,`sharp`,2),v([p({attribute:`fixed-scroll-controls`,type:Boolean})],Z.prototype,`fixedScrollControls`,2),v([re({passive:!0})],Z.prototype,`updateScrollButtons`,1),v([w(`noScrollControls`,{waitUntilFirstUpdate:!0})],Z.prototype,`updateScrollControls`,1),v([w(`placement`,{waitUntilFirstUpdate:!0})],Z.prototype,`syncIndicator`,1)})),yt=e((()=>{vt(),Z.define(`syn-tab-group`)})),bt=e((()=>{yt(),vt(),nt(),it(),st(),ot(),ht(),ft(),mt(),z(),j(),P(),q(),K(),G(),D(),A()})),xt,St=e((()=>{i(),xt=c`
  :host {
...
`})),Tt,Q,Et=e((()=>{St(),wt(),ht(),T(),q(),D(),A(),C(),u(),i(),m(),Tt=0,Q=class extends k{constructor(){super(...arguments),this.localize=new ze(this),this.attrId=++Tt,this.componentId=`syn-tab-${this.attrId}`,this.panel=``,this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`tab`)}handleCloseClick(e){e.stopPropagation(),this.emit(`syn-close`)}handleActiveChange(){this.setAttribute(`aria-selected`,this.active?`true`:`false`)}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled?`true`:`false`),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,s`
      <div
        part="base"
    ...
    `}},Q.styles=[E,Ct,xt],Q.dependencies={"syn-icon-button":X},v([h(`.tab`)],Q.prototype,`tab`,2),v([p({reflect:!0})],Q.prototype,`panel`,2),v([p({type:Boolean,reflect:!0})],Q.prototype,`active`,2),v([p({type:Boolean,reflect:!0})],Q.prototype,`closable`,2),v([p({type:Boolean,reflect:!0})],Q.prototype,`disabled`,2),v([p({type:Number,reflect:!0})],Q.prototype,`tabIndex`,2),v([w(`active`)],Q.prototype,`handleActiveChange`,1),v([w(`disabled`)],Q.prototype,`handleDisabledChange`,1)})),Dt=e((()=>{Et(),Q.define(`syn-tab`)})),Ot=e((()=>{Dt(),Et(),St(),wt(),ht(),ft(),mt(),z(),j(),P(),q(),K(),G(),D(),A()})),kt,At=e((()=>{i(),kt=c`
  /* Write custom CSS here */
  .tab-panel {
    color: var(--syn-typography-color-text);
  }
...
`})),Nt,$,Pt=e((()=>{At(),Mt(),T(),D(),A(),C(),u(),i(),m(),Nt=0,$=class extends k{constructor(){super(...arguments),this.attrId=++Nt,this.componentId=`syn-tab-panel-${this.attrId}`,this.name=``,this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute(`role`,`tabpanel`)}handleActiveChange(){this.setAttribute(`aria-hidden`,this.active?`false`:`true`)}render(){return s`
      <slot
        part="base"
        class=${l({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}},$.styles=[E,jt,kt],v([p({reflect:!0})],$.prototype,`name`,2),v([p({type:Boolean,reflect:!0})],$.prototype,`active`,2),v([w(`active`)],$.prototype,`handleActiveChange`,1)})),Ft=e((()=>{Pt(),$.define(`syn-tab-panel`)})),It=e((()=>{Ft(),Pt(),At(),Mt(),D(),A()}));export{fe as A,w as C,b as D,x as E,C as M,me as O,T as S,pe as T,j as _,et as a,E as b,Ve as c,q as d,K as f,P as g,z as h,$e as i,_ as j,S as k,Be as l,R as m,Ot as n,He as o,G as p,bt as r,Ue as s,It as t,ze as u,k as v,v as w,D as x,A as y};