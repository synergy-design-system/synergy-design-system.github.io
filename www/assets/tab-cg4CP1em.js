import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,h as n,t as r}from"./lit-BVDl_-fF.js";import{a as i,f as a,i as o,n as s,o as c,r as l,s as u,t as d,y as f}from"./synergy-element-D_jGE1Vc.js";import{n as p,t as m}from"./class-map-tXbnyhp8.js";import{n as h,t as g}from"./localize-CzgwcyM2.js";import{n as _,t as v}from"./watch-I6gMK-uE.js";import{n as y,t as b}from"./icon-button.component-DnOH4E5f.js";var x,S=e((()=>{r(),x=n`
	/* stylelint-disable */
  :host {
...
`})),T,E,D=e((()=>{m(),r(),g(),u(),v(),c(),s(),y(),S(),w(),o(),T=0,E=class extends d{constructor(...e){super(...e),this.localize=new h(this),this.attrId=++T,this.componentId=`syn-tab-${this.attrId}`,this.panel=``,this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}static{this.styles=[i,x,C]}static{this.dependencies={"syn-icon-button":b}}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`tab`)}handleCloseClick(e){e.stopPropagation(),this.emit(`syn-close`)}handleActiveChange(){this.setAttribute(`aria-selected`,this.active?`true`:`false`)}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled?`true`:`false`),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,t`
      <div
        part="base"
    ...
    `}},l([a(`.tab`)],E.prototype,`tab`,void 0),l([f({reflect:!0})],E.prototype,`panel`,void 0),l([f({type:Boolean,reflect:!0})],E.prototype,`active`,void 0),l([f({type:Boolean,reflect:!0})],E.prototype,`closable`,void 0),l([f({type:Boolean,reflect:!0})],E.prototype,`disabled`,void 0),l([f({type:Number,reflect:!0})],E.prototype,`tabIndex`,void 0),l([_(`active`)],E.prototype,`handleActiveChange`,null),l([_(`disabled`)],E.prototype,`handleDisabledChange`,null)})),O=e((()=>{D(),D(),E.define(`syn-tab`)}));export{O as t};