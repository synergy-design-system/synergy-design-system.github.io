...
arg ref - \`${e}\``}const ji=a=>`on${Vi(Fi(a))}`;function Fi(a=""){return a.split("-").map((n,i)=>i?n.charAt(0).toUpperCase()+n.slice(1).toLowerCase():n.toLowerCase()).join("")}function Vi(a){return a.charAt(0).toUpperCase()+a.slice(1)}const{useArgs:Hi}=__STORYBOOK_MODULE_PREVIEW_API__;let zt,pn,Xt={};setTimeout(()=>{Xt=globalThis?.__WC_STORYBOOK_HELPERS_CONFIG__||{}});var zn;function Bi(a,e,t,n){if(!e)return k`<${te(a.tagName)}></${te(a.tagName)}>`;a?.tagName!==pn&&(zt=void 0,pn=a?.tagName);const{attrOperators:i,additionalAttrs:o}=Ri(a,e,n),s={...i,...o},l=qi(a,e),d=Wi(a,e);return Ki(a),k`${jn(a,e)}
<${te(a.tagName)} 
  ${Ii(s)}
  ${d}
  >
...
`;var ka=Object.defineProperty,_a=Object.getOwnPropertyDescriptor,it=(a,e,t,n)=>{for(var i=n>1?void 0:n?_a(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&ka(e,t,i),i};class qe extends v{constructor(){super(...arguments),this.hasSlotController=new U(this,"prefix","suffix"),this.renderType="button",this.rel="noreferrer noopener"}static{this.styles=[w,wa,xa]}setRenderType(){const e=this.defaultSlot.assignedElements({flatten:!0}).filter(t=>t.tagName.toLowerCase()==="syn-dropdown").length>0;if(this.href){this.renderType="link";return}if(e){this.renderType="dropdown";return}this.renderType="button"}hrefChanged(){this.setRenderType()}handleSlotChange(){this.setRenderType()}render(){return p`
    ...
    `}}it([u("slot:not([name])")],qe.prototype,"defaultSlot",2);it([g()],qe.prototype,"renderType",2);it([r()],qe.prototype,"href",2);it([r()],qe.prototype,"target",2);it([r()],qe.prototype,"rel",2);it([m("href",{waitUntilFirstUpdate:!0})],qe.prototype,"hrefChanged",1);qe.define("syn-breadcrumb-item");const Ta=h`
	/* stylelint-disable */
  .breadcrumb {
    display: flex;
    align-items: center;
...
`;var so=Object.defineProperty,ro=Object.getOwnPropertyDescriptor,xe=(a,e,t,n)=>{for(var i=n>1?void 0:n?ro(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&so(e,t,i),i};class be extends v{constructor(){super(...arguments),this.localize=new j(this),this.open=!1,this.disabled=!1,this.contained=!1,this.size="medium"}static{this.styles=[w,ao,oo]}static{this.dependencies={"syn-icon":he}}firstUpdated(){this.body.style.height=this.open?"auto":"0",this.open&&(this.details.open=!0),this.detailsObserver=new MutationObserver(e=>{for(const t of e)t.type==="attributes"&&t.attributeName==="open"&&(this.details.open?this.show():this.hide())}),this.detailsObserver.observe(this.details,{attributes:!0})}disconnectedCallback(){super.disconnectedCallback(),this.detailsObserver?.disconnect()}handleSummaryClick(e){e.preventDefault(),this.disabled||(this.open?this.hide():this.show(),this.header.focus())}handleSummaryKeyDown(e){(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.open?this.hide():this.show()),(e.key==="ArrowUp"||e.key==="ArrowLeft")&&(e.preventDefault(),this.hide()),(e.key==="ArrowDown"||e.key==="ArrowRight")&&(e.preventDefault(),this.show())}async handleOpenChange(){if(this.open){if(this.details.open=!0,this.emit("syn-show",{cancelable:!0}).defaultPrevented){this.open=!1,this.details.open=!1;return}await q(this.body);const{keyframes:t,options:n}=I(this,"details.show",{dir:this.localize.dir()});await F(this.body,mn(t,this.body.scrollHeight),n),this.body.style.height="auto",this.emit("syn-after-show")}else{if(this.emit("syn-hide",{cancelable:!0}).defaultPrevented){this.details.open=!0,this.open=!0;return}await q(this.body);const{keyframes:t,options:n}=I(this,"details.hide",{dir:this.localize.dir()});await F(this.body,mn(t,this.body.scrollHeight),n),this.body.style.height="auto",this.details.open=!1,this.emit("syn-after-hide")}}async show(){if(!(this.open||this.disabled))return this.open=!0,W(this,"syn-after-show")}async hide(){if(!(!this.open||this.disabled))return this.open=!1,W(this,"syn-after-hide")}render(){return p`
    ...
    `}}xe([u(".details")],be.prototype,"details",2);xe([u(".details__header")],be.prototype,"header",2);xe([u(".details__body")],be.prototype,"body",2);xe([u(".details__expand-icon-slot")],be.prototype,"expandIconSlot",2);xe([r({type:Boolean,reflect:!0})],be.prototype,"open",2);xe([r()],be.prototype,"summary",2);xe([r({type:Boolean,reflect:!0})],be.prototype,"disabled",2);xe([r({type:Boolean,reflect:!0})],be.prototype,"contained",2);xe([r({reflect:!0})],be.prototype,"size",2);xe([m("open",{waitUntilFirstUpdate:!0})],be.prototype,"handleOpenChange",1);T("details.show",{keyframes:[{height:"0",opacity:"0"},{height:"auto",opacity:"1"}],options:{duration:250,easing:"linear"}});T("details.hide",{keyframes:[{height:"auto",opacity:"1"},{height:"0",opacity:"0"}],options:{duration:250,easing:"linear"}});be.define("syn-details");function*en(a=document.activeElement){a!=null&&(yield a,"shadowRoot"in a&&a.shadowRoot&&a.shadowRoot.mode!=="closed"&&(yield*en(a.shadowRoot.activeElement)))}function lo(){return[...en()].pop()}const gn=new WeakMap;function ti(a){let e=gn.get(a);return e||(e=window.getComputedStyle(a,null),gn.set(a,e)),e}function co(a){if(typeof a.checkVisibility=="function")return a.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});const e=ti(a);return e.visibility!=="hidden"&&e.display!=="none"}function po(a){const e=ti(a),{overflowY:t,overflowX:n}=e;return t==="scroll"||n==="scroll"?!0:t!=="auto"||n!=="auto"?!1:a.scrollHeight>a.clientHeight&&t==="auto"||a.scrollWidth>a.clientWidth&&n==="auto"}function ho(a){const e=a.tagName.toLowerCase(),t=Number(a.getAttribute("tabindex"));return a.hasAttribute("tabindex")&&(isNaN(t)||t<=-1)||a.hasAttribute("disabled")||a.closest("[inert]")||e==="input"&&a.getAttribute("type")==="radio"&&!a.hasAttribute("checked")||!co(a)?!1:(e==="audio"||e==="video")&&a.hasAttribute("controls")||a.hasAttribute("tabindex")||a.hasAttribute("contenteditable")&&a.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(e)?!0:po(a)}function uo(a){const e=Bt(a),t=e[0]??null,n=e[e.length-1]??null;return{start:t,end:n}}function mo(a,e){return a.getRootNode({composed:!0})?.host!==e}function Bt(a){const e=new WeakMap,t=[];function n(i){if(i instanceof Element){if(i.hasAttribute("inert")||i.closest("[inert]")||e.has(i))return;e.set(i,!0),!t.includes(i)&&ho(i)&&t.push(i),i instanceof HTMLSlotElement&&mo(i,a)&&i.assignedElements({flatten:!0}).forEach(o=>{n(o)}),i.shadowRoot!==null&&i.shadowRoot.mode==="open"&&n(i.shadowRoot)}for(const o of i.children)n(o)}return n(a),t.sort((i,o)=>{const s=Number(i.getAttribute("tabindex"))||0;return(Number(o.getAttribute("tabindex"))||0)-s})}let dt=[];class ni{constructor(e){this.tabDirection="forward",this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=t=>{if(t.key!=="Tab"||this.isExternalActivated||!this.isActive())return;const n=lo();if(this.previousFocus=n,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;t.shiftKey?this.tabDirection="backward":this.tabDirection="forward";const i=Bt(this.element);let o=i.findIndex(l=>l===n);this.previousFocus=this.currentFocus;const s=this.tabDirection==="forward"?1:-1;for(;;){o+s>=i.length?o=0:o+s<0?o=i.length-1:o+=s,this.previousFocus=this.currentFocus;const l=i[o];if(this.tabDirection==="backward"&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||l&&this.possiblyHasTabbableChildren(l))return;t.preventDefault(),this.currentFocus=l,this.currentFocus?.focus({preventScroll:!1});const d=[...en()];if(d.includes(this.currentFocus)||!d.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=e,this.elementsWithTabbableControls=["iframe"]}activate(){dt.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){dt=dt.filter(e=>e!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return dt[dt.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){const e=Bt(this.element);if(!this.element.matches(":focus-within")){const t=e[0],n=e[e.length-1],i=this.tabDirection==="forward"?t:n;typeof i?.focus=="function"&&(this.currentFocus=i,i.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(e){return this.elementsWithTabbableControls.includes(e.tagName.toLowerCase())||e.hasAttribute("controls")}}const fo=h`
	/* stylelint-disable */
  :host {
    --width: 31rem;
...
`;var bo=Object.defineProperty,go=Object.getOwnPropertyDescriptor,Ge=(a,e,t,n)=>{for(var i=n>1?void 0:n?go(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&bo(e,t,i),i};class Me extends v{constructor(){super(...arguments),this.hasSlotController=new U(this,"footer"),this.localize=new j(this),this.modal=new ni(this),this.open=!1,this.label="",this.noHeader=!1,this.handleDocumentKeyDown=e=>{e.key==="Escape"&&this.modal.isActive()&&this.open&&(e.stopPropagation(),this.requestClose("keyboard"))}}static{this.styles=[w,fo,yo]}static{this.dependencies={"syn-icon-button":tt}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),ht(this))}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate(),Ze(this),this.removeOpenListeners()}requestClose(e){if(this.emit("syn-request-close",{cancelable:!0,detail:{source:e}}).defaultPrevented){const n=I(this,"dialog.denyClose",{dir:this.localize.dir()});F(this.panel,n.keyframes,n.options);return}this.hide()}addOpenListeners(){"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard")):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){this.closeWatcher?.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),ht(this);const e=this.querySelector("[autofocus]");e&&e.removeAttribute("autofocus"),await Promise.all([q(this.dialog),q(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit("syn-initial-focus",{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute("autofocus","")});const t=I(this,"dialog.show",{dir:this.localize.dir()}),n=I(this,"dialog.overlay.show",{dir:this.localize.dir()});await Promise.all([F(this.panel,t.keyframes,t.options),F(this.overlay,n.keyframes,n.options)]),this.emit("syn-after-show")}else{this.emit("syn-hide"),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([q(this.dialog),q(this.overlay)]);const e=I(this,"dialog.hide",{dir:this.localize.dir()}),t=I(this,"dialog.overlay.hide",{dir:this.localize.dir()});await Promise.all([F(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),F(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,Ze(this);const n=this.originalTrigger;typeof n?.focus=="function"&&setTimeout(()=>n.focus()),this.emit("syn-after-hide")}}async show(){if(!this.open)return this.open=!0,W(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,W(this,"syn-after-hide")}render(){return p`
    ...
    `}}Ge([u(".dialog")],Me.prototype,"dialog",2);Ge([u(".dialog__panel")],Me.prototype,"panel",2);Ge([u(".dialog__overlay")],Me.prototype,"overlay",2);Ge([r({type:Boolean,reflect:!0})],Me.prototype,"open",2);Ge([r({reflect:!0})],Me.prototype,"label",2);Ge([r({attribute:"no-header",type:Boolean,reflect:!0})],Me.prototype,"noHeader",2);Ge([m("open",{waitUntilFirstUpdate:!0})],Me.prototype,"handleOpenChange",1);T("dialog.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});T("dialog.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});T("dialog.denyClose",{keyframes:[{scale:1},{scale:1.02},{scale:1}],options:{duration:250}});T("dialog.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});T("dialog.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});Me.define("syn-dialog");const vo=h`
	/* stylelint-disable */
  :host {
...
`;var xo=Object.defineProperty,ko=Object.getOwnPropertyDescriptor,ii=(a,e,t,n)=>{for(var i=n>1?void 0:n?ko(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&xo(e,t,i),i};class Le extends v{constructor(){super(...arguments),this.vertical=!1}static{this.styles=[w,vo,wo]}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}}ii([r({type:Boolean,reflect:!0})],Le.prototype,"vertical",2);ii([m("vertical")],Le.prototype,"handleVerticalChange",1);Le.define("syn-divider");function vn(a){return a.charAt(0).toUpperCase()+a.slice(1)}const _o=h`
	/* stylelint-disable */
  :host {
    --size: 25rem;
    --header-spacing: var(--syn-spacing-large);
...
`;class Yo extends v{static{this.styles=[w,Ko,Go]}static{this.dependencies={"syn-divider":Le}}render(){return p`
...
`;var Ws=Object.defineProperty,oi=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Ws(e,t,i),i};class Pt extends v{constructor(){super(...arguments),this.localize=new j(this),this.size="medium",this.removable=!1}static{this.styles=[w,Bs,Rs]}static{this.dependencies={"syn-icon-button":tt}}handleRemoveClick(){this.emit("syn-remove")}render(){return p`
      <span
        part="base"
