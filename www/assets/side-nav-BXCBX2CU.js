import{e as u}from"./class-map-Dhr6WL2m.js";import{j as f,u as c}from"./iframe-DldCkxwR.js";import{c as m,n as h,S as g}from"./synergy-element-CbKmI8ZK.js";import{S as _,r as b}from"./icon.component-CUOmcJ2d.js";import{a as S}from"./query-DAIS6qJ0.js";import{H as k}from"./slot-9EVoRGQc.js";import{S as x}from"./drawer.component-tCoTbi0P.js";import{S as A}from"./divider.component-CTkM5ko8.js";import{S as N}from"./nav-item-k4FLCyUh.js";import{w}from"./event-B0iVuGLD.js";import{w as y}from"./watch-CEsCE2EF.js";import{s as o,g as d,c as l}from"./animation-registry-l4L8bmT6.js";import{L}from"./localize-Dh03wnLC.js";import{u as C}from"./scroll-DgKSCJoS.js";import{e as T}from"./decorator-DANECR0-.js";const z=f`
  :host {
...
`;var E=Object.defineProperty,F=Object.getOwnPropertyDescriptor,i=(e,t,s,n)=>{for(var r=n>1?void 0:n?F(t,s):t,v=e.length-1,p;v>=0;v--)(p=e[v])&&(r=(n?p(t,s,r):p(r))||r);return n&&r&&E(t,s,r),r};let a=class extends g{constructor(){super(),this.hasSlotController=new k(this,"[default]","footer"),this.localize=new L(this),this.isAnimationActive=!1,this.open=!1,this.rail=!1,this.variant="default",this.noFocusTrapping=!1,this.handleMouseEnter=this.handleMouseEnter.bind(this),this.handleMouseLeave=this.handleMouseLeave.bind(this),this.addEventListener("syn-initial-focus",e=>{this.variant!=="default"&&(e.preventDefault(),this.drawer.originalTrigger=null)}),this.addEventListener("focusin",e=>{e.target.tagName.toLowerCase()==="syn-nav-item"&&this.variant==="rail"&&!this.open&&(this.open=!0)}),this.addEventListener("focusout",e=>{const t=e.target.tagName.toLowerCase(),s=e.relatedTarget?.tagName.toLowerCase();t==="syn-nav-item"&&s!=="syn-nav-item"&&this.variant==="rail"&&this.open&&(this.open=!1)})}setDelayedCallback(e){clearTimeout(this.timeout),this.timeout=setTimeout(e,100)}handleMouseEnter(){this.setDelayedCallback(()=>{this.open=!0})}handleMouseLeave(){this.setDelayedCallback(()=>{this.open=!1})}handleRequestClose(){this.open&&(this.open=!1)}addMouseListener(){this.drawer.shadowRoot.querySelector(".drawer__panel")?.addEventListener("mouseenter",this.handleMouseEnter),this.drawer.shadowRoot.querySelector(".drawer__panel")?.addEventListener("mouseleave",this.handleMouseLeave)}removeMouseListener(){this.drawer.shadowRoot.querySelector(".drawer__panel")?.removeEventListener("mouseenter",this.handleMouseEnter),this.drawer.shadowRoot.querySelector(".drawer__panel")?.removeEventListener("mouseleave",this.handleMouseLeave)}setDrawerAnimations(){const e=d(this,`sideNav.show${this.variant==="default"?"NonRail":"Rail"}`,{dir:this.localize.dir()}),t=d(this,`sideNav.hide${this.variant==="default"?"NonRail":"Rail"}`,{dir:this.localize.dir()}),s=d(this,"sideNav.overlay.hide",{dir:this.localize.dir()}),n=d(this,"sideNav.overlay.show",{dir:this.localize.dir()});l(this.drawer,"drawer.showStart",e),l(this.drawer,"drawer.hideStart",t),l(this.drawer,"drawer.overlay.hide",s),l(this.drawer,"drawer.overlay.show",n)}handleVariantChange(){switch(this.setDrawerAnimations(),this.drawer.forceVisibility(this.variant!=="default"),this.variant){case"rail":this.addMouseListener();break;case"sticky":case"default":default:this.removeMouseListener()}}handleOpenChange(){this.variant!=="default"&&(this.isAnimationActive=!0,w(this.drawer,`syn-after-${this.open?"show":"hide"}`).then(()=>{this.isAnimationActive=!1}))}handleFocusTrapping(){this.variant==="default"&&(this.noFocusTrapping?this.drawer.modal.activateExternal():this.drawer.modal.deactivateExternal())}async show(){if(!this.open)return this.open=!0,w(this.drawer,"syn-after-show")}async hide(){if(this.open)return this.open=!1,w(this.drawer,"syn-after-hide")}firstUpdated(){switch(this.setDrawerAnimations(),this.drawer.updateComplete.then(()=>{this.drawer.forceVisibility(this.variant!=="default"),this.drawer.shadowRoot.querySelector(".drawer__panel").tabIndex=-1}),this.variant){case"rail":this.drawer.updateComplete.then(()=>{this.addMouseListener()});break;case"sticky":break;case"default":default:this.noFocusTrapping&&this.drawer.modal.activateExternal()}}disconnectedCallback(){super.disconnectedCallback(),this.drawer&&(C(this.drawer),this.drawer.modal.deactivate())}willUpdate(e){super.willUpdate(e),e.has("rail")&&(this.rail&&console.warn("<syn-side-nav/>: The `rail` attribute is deprecated. Please use the `variant` attribute with `rail` instead. It will be removed in synergy version 3.0"),(!e.has("variant")||this.rail)&&(this.variant=this.rail?"rail":"default"))}toggleOpenState(){this.open=!this.open}render(){const e=window.navigator.maxTouchPoints>0||"ontouchstart"in window,t=this.hasSlotController.test("footer"),s=t||this.variant==="sticky";return c`
      <nav
        class=${u({"side-nav":!0,"side-nav--animation":this.isAnimationActive,"side-nav--fix":this.variant==="default","side-nav--has-footer":t,"side-nav--open":this.open,"side-nav--rail":this.variant==="rail","side-nav--sticky":this.variant==="sticky","side-nav--touch":e})}
        part="base"
      >
        ...
        >
          ...
          <footer class="side-nav__footer" part="footer-container" slot="footer">  
            ...
            ${this.variant==="sticky"?c`<syn-nav-item part="toggle-nav-item" class="side-nav__toggle-nav-item" @click=${this.toggleOpenState} ?divider=${t}>
