import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-DRz18Lsn.js";import{c as i,t as a}from"./lit-D4-0ovri.js";import{i as o,n as s,o as c,r as l,t as u}from"./component-NnlguzJ1.js";import{t as d}from"./spinner-BytKAwZN.js";var f=t({Color:()=>b,Default:()=>_,Screenshot:()=>x,Size:()=>v,TrackWidth:()=>y,__namedExportsOrder:()=>S,default:()=>g}),p,m,h,g,_,v,y,b,x,S;function C(){return(C=e((()=>{d(),a(),l(),r(),{args:p,argTypes:m}=o(`syn-spinner`),{generateTemplate:h}=c(`syn-spinner`),g={args:p,argTypes:m,component:`syn-spinner`,parameters:{chromatic:{modes:n},docs:{description:{component:s(`spinner`,`default`)}}},tags:[`Feedback`],title:`Components/syn-spinner`},_={parameters:{docs:{description:{story:s(`spinner`,`default`)}}},render:e=>h({args:e})},v={parameters:{docs:{description:{story:s(`spinner`,`size`)}}},render:()=>i`
  ...
  `},x=u({Default:_,Size:v,TrackWidth:y,Color:b},280),S=[`Default`,`Size`,`TrackWidth`,`Color`,`Screenshot`],_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
  ...
  TrackWidth,
  Color
}, 280)`,...x.parameters?.docs?.source}}}})))()}export{C as n,f as r,_ as t};