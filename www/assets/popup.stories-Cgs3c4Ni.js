import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{c as n,t as r}from"./lit-D4-0ovri.js";import{t as i}from"./range-BDOdkK3m.js";import{t as a}from"./select-BiMMRNnt.js";import{t as o}from"./option-5Sp0fHIr.js";import{a as s,i as c,n as l,o as u,r as d}from"./component-NnlguzJ1.js";import{t as f}from"./taggedTemplateLiteral-BZenJ0bZ.js";import{t as p}from"./popup-5PBvaCYB.js";import{t as m}from"./switch-CcJZSArp.js";var h=t({Activating:()=>j,Arrows:()=>I,Default:()=>A,Distance:()=>P,ExternalAnchors:()=>M,Flip:()=>R,FlipFallbacks:()=>z,Placement:()=>N,Shift:()=>B,Skidding:()=>F,SyncingWithTheAnchorsDimensions:()=>L,VirtualElements:()=>V,__namedExportsOrder:()=>H,default:()=>k}),g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H;function U(){return(U=e((()=>{p(),m(),a(),o(),i(),r(),d(),{args:T,argTypes:E}=c(`syn-popup`),{overrideArgs:D}=s(`syn-popup`),{generateTemplate:O}=u(`syn-popup`),k={args:D([{name:`active`,type:`attribute`,value:!0},{name:`anchor`,type:`slot`,value:`<span></span>`},{name:`default`,type:`slot`,value:`<div class="box"></div>`}],T),argTypes:E,component:`syn-popup`,parameters:{chromatic:{disableSnapshot:!0},docs:{description:{component:l(`popup`,`default`)},story:{iframeHeight:300}}},tags:[`Structure`],title:`Components/syn-popup`},A={parameters:{docs:{description:{story:l(`popup`,`default`)}}},render:e=>n`
  ...
  `},j={render:()=>n(g||=f([`<div class="popup-active">
...
<\/script>`]))},M={render:()=>n`<span id="external-anchor"></span>
...
</style>`},N={render:()=>n(_||=f([`<div class="popup-placement">
  <syn-popup placement="top" active>
    <span slot="anchor"></span>
    <div class="box"></div>
  </syn-popup>
...
<\/script>`]))},P={render:()=>n(v||=f([`<div class="popup-distance">
...
<\/script>`]))},F={render:()=>n(y||=f([`<div class="popup-skidding">
...
<\/script>`]))},I={render:()=>n(b||=f([`<div class="popup-arrow">
  ...
  <\/script>
</div>`]))},L={render:()=>n(x||=f([`<div class="popup-sync">
...
<\/script>`]))},R={render:()=>n(S||=f([`<div class="popup-flip">
  <div class="overflow">
...
<\/script>`]))},z={render:()=>n`<div class="popup-flip-fallbacks">
  <div class="overflow">
...
</style>`},B={render:()=>n(C||=f([`<div class="popup-shift">
  <div class="overflow">
...
<\/script>`]))},V={render:()=>n(w||=f([`<div class="popup-virtual-element">
...
<style>
...
</style>`]))},H=[`Default`,`Activating`,`ExternalAnchors`,`Placement`,`Distance`,`Skidding`,`Arrows`,`SyncingWithTheAnchorsDimensions`,`Flip`,`FlipFallbacks`,`Shift`,`VirtualElements`],A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
  ...
  \`
} as Story`,...A.parameters?.docs?.source}}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
...
<script type="module">
  ...
  active.addEventListener('syn-change', () => (popup.active = active.checked));
<\/script>\`
}`,...j.parameters?.docs?.source},description:{story:`Popups are inactive and hidden until the active attribute is applied.
Removing the attribute will tear down all positioning logic and listeners,
meaning you can have many idle popups on the page without affecting performance.`,...j.parameters?.docs?.description}}},M.parameters={...M.parameters,docs:{...M.parameters?.docs,source:{originalSource:`{
...
}`,...M.parameters?.docs?.source},description:{story:`By default, anchors are slotted into the popup using the anchor slot.
...
to the anchor property to achieve the same effect without using an id.`,...M.parameters?.docs?.description}}},N.parameters={...N.parameters,docs:{...N.parameters?.docs,source:{originalSource:`{
...
<script type="module">
  ...
  select.addEventListener('syn-change', () => (popup.placement = select.value));
<\/script>\`
}`,...N.parameters?.docs?.source},description:{story:`Use the placement attribute to tell the popup the preferred placement of the popup.
...
available space and it will be removed when the popup is deactivated.`,...N.parameters?.docs?.description}}},P.parameters={...P.parameters,docs:{...P.parameters?.docs,source:{originalSource:`{
...
<script type="module">
  ...
  distance.addEventListener('syn-input', () => (popup.distance = distance.value));
<\/script>\`
}`,...P.parameters?.docs?.source},description:{story:`Use the distance attribute to change the distance between the popup and its anchor.
A positive value will move the popup further away and a negative value will move it closer.`,...P.parameters?.docs?.description}}},F.parameters={...F.parameters,docs:{...F.parameters?.docs,source:{originalSource:`{
...
<script type="module">
  ...
  skidding.addEventListener('syn-input', () => (popup.skidding = skidding.value));
<\/script>\`
}`,...F.parameters?.docs?.source},description:{story:`The skidding attribute is similar to distance,
but instead allows you to offset the popup along the anchor's axis.
Both positive and negative values are allowed.`,...F.parameters?.docs?.description}}},I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`{
...
}`,...I.parameters?.docs?.source},description:{story:`Add an arrow to your popup with the arrow attribute.
...
the arrow to align to the start, end, or center of the  instead.`,...I.parameters?.docs?.description}}},L.parameters={...L.parameters,docs:{...L.parameters?.docs,source:{originalSource:`{
...
<script type="module">
  ...
  sync.addEventListener('syn-change', () => (popup.sync = sync.value));
<\/script>\`
}`,...L.parameters?.docs?.source},description:{story:`Use the sync attribute to make the popup the same width or height as the anchor element.
This is useful for controls that need the popup to stay the same width or height as the trigger.`,...L.parameters?.docs?.description}}},R.parameters={...R.parameters,docs:{...R.parameters?.docs,source:{originalSource:`{
...
<script type="module">
  ...
  flip.addEventListener('syn-change', () => (popup.flip = flip.checked));
<\/script>\`
}`,...R.parameters?.docs?.source},description:{story:`When the popup doesn't have enough room in its preferred placement,
...
Additional options are available to control the flip behavior's boundary and padding.`,...R.parameters?.docs?.description}}},z.parameters={...z.parameters,docs:{...z.parameters?.docs,source:{originalSource:`{
...
}`,...z.parameters?.docs?.source},description:{story:`While using the flip attribute, you can customize the placement
...
Scroll the container to see how the popup changes it's fallback placement to prevent clipping.`,...z.parameters?.docs?.description}}},B.parameters={...B.parameters,docs:{...B.parameters?.docs,source:{originalSource:`{
...
<script type="module">
  ...
  shift.addEventListener('syn-change', () => (popup.shift = shift.checked));
<\/script>\`
}`,...B.parameters?.docs?.source},description:{story:`When a popup is longer than its anchor, it risks being clipped by an overflowing container.
...
Toggle the switch to see the difference.`,...B.parameters?.docs?.description}}},V.parameters={...V.parameters,docs:{...V.parameters?.docs,source:{originalSource:`{
...
}`,...V.parameters?.docs?.source},description:{story:`In most cases, popups are anchored to an actual element.
...
As such, a mouse is required to properly view it.`,...V.parameters?.docs?.description}}}})))()}export{U as n,h as r,A as t};