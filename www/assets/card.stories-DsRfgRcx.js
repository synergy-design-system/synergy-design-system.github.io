import{k as c}from"./lit-element-BsyMe9HG.js";import{s as m,a as y,g as h,b as e,e as u,c as g,d as f}from"./component-BZvxfSsF.js";import"./index-Dfi6UpXT.js";import"./icon.component-CExUySyX.js";import"./directive-helpers-DUpkUCIH.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-B-o1Wr-g.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon-NtWdXWMv.js";const{args:x,argTypes:b}=m("syn-card"),{overrideArgs:S}=f("syn-card"),{generateTemplate:v}=y("syn-card"),l=({buttonText:i="More Info",footerText:p="Optional information"}={})=>`
  <footer slot="footer">
    <small>${p}</small>
    <nav>
...
`,M={args:S([{name:"image",type:"slot",value:'<img slot="image" src="/card-example.jpg" alt="Multiple persons having lunch in SICK Academy" />'},{name:"default",type:"slot",value:`
        <h3>Headline</h3>
  ...
  Images,
  SharpCard
}, 600)`,...d.parameters?.docs?.source}}};const k=["Default","BasicCard","CardWithHeader","CardWithFooter","Images","SharpCard","Screenshot"];export{r as BasicCard,t as CardWithFooter,s as CardWithHeader,a as Default,o as Images,d as Screenshot,n as SharpCard,k as __namedExportsOrder,M as default};
