import"./input-wq4HqU3y.js";import"./icon-CdTGkBe_.js";import"./button-BLOi7eyP.js";import"./textarea-CxMJE91h.js";import{C as D,c as t,d as T}from"./iframe-hncc6fn8.js";import{g as e,a as z,s as E,b as k}from"./component-BDcZ8_k2.js";import{p as I}from"./PaddingDecorator-CHwledDX.js";import"./input.component-B9glR2mL.js";import"./class-map-J4m71D6f.js";import"./default-value-DoIyiDFw.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./if-defined-Df6Qu0g8.js";import"./live-DuCdd6xk.js";import"./controller-0nuky388.js";import"./synergy-element-ZP8Aphe2.js";import"./icon.component-uI_62ALx.js";import"./watch-CEsCE2EF.js";import"./query-D0jTsbLw.js";import"./form-control.styles-COnyBaWJ.js";import"./divider.component-CAm9t5hy.js";import"./functions-DCU90qiI.js";import"./decorator-jbWt9cIm.js";import"./button.component-CXWNkp-D.js";import"./spinner.component-CET_LilP.js";import"./preload-helper-PPVm8Dsz.js";import"./index-3hbeBem-.js";import"./_docs-VWJ8UqMU.js";const{userEvent:L}=__STORYBOOK_MODULE_TEST__,{args:P,argTypes:C}=E("syn-input"),{generateTemplate:q}=k("syn-input"),ie={args:P,argTypes:C,parameters:{chromatic:{modes:D},design:T("14695-110120"),docs:{description:{component:e("input","default")}}},tags:["Form"],title:"Components/syn-input"},s={parameters:{controls:{disable:!1},docs:{description:{story:e("input","default")}}},render:r=>q({args:r})},a={parameters:{docs:{description:{story:e("input","label")}}},render:()=>t`<syn-input label="What is your name?"></syn-input>`},o={parameters:{docs:{description:{story:e("input","help-text")}}},render:()=>t`<syn-input label="Nickname" help-text="What would you like people to call you?"></syn-input>`},i={parameters:{docs:{description:{story:e("input","placeholder")}}},render:()=>t`<syn-input placeholder="Type something"></syn-input>`},p={parameters:{docs:{description:{story:e("input","clearable")}}},render:()=>t`<syn-input value="Clearable" placeholder="Clearable" clearable></syn-input>`},l={parameters:{docs:{description:{story:e("input","password-toggle")}}},render:()=>t`<syn-input type="password" placeholder="Password Toggle" password-toggle></syn-input>`},c={parameters:{docs:{description:{story:e("input","readonly")}}},render:()=>t`<syn-input value="Readonly content" readonly></syn-input>`},h={decorators:[I()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:e("input","focus")}}},play:({canvasElement:r})=>{const n=r.querySelector("syn-input");n&&n.focus()},render:()=>t`
      <form>
  ...
  <syn-input type="number" min="0" max="10" value="10"></syn-input>`},g={parameters:{docs:{description:{story:e("input","stepper-input-handling")}}},render:()=>t`
    ...
    <syn-input 
      ...
      value="0"
    ></syn-input>
  `},S=z({Default:s,Labels:a,HelpText:o,Placeholders:i,Clearable:p,TogglePassword:l,ReadonlyInputs:c,Disabled:u,Sizes:m,InputTypes:d,PrefixSuffixTextAndIcons:y,CustomizingLabelPosition:f,Stepper:b,StepperInputHandling:g},500);s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
...
}, 500)`,...S.parameters?.docs?.source}}};const pe=["Default","Labels","HelpText","Placeholders","Clearable","TogglePassword","ReadonlyInputs","Focus","Disabled","Sizes","Invalid","InputTypes","PrefixSuffixTextAndIcons","CustomizingLabelPosition","Stepper","StepperInputHandling","Screenshot"];export{p as Clearable,f as CustomizingLabelPosition,s as Default,u as Disabled,h as Focus,o as HelpText,d as InputTypes,x as Invalid,a as Labels,i as Placeholders,y as PrefixSuffixTextAndIcons,c as ReadonlyInputs,S as Screenshot,m as Sizes,b as Stepper,g as StepperInputHandling,l as TogglePassword,pe as __namedExportsOrder,ie as default};
