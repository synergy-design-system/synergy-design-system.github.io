import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,d as r,f as i,g as a,u as o}from"./iframe-fXCqWTG3.js";import{t as s}from"./icon-sEREnw4h.js";import{a as c,i as l,n as u,r as d,t as f}from"./component-CsQUi1XQ.js";import{n as p,t as m}from"./PaddingDecorator-DdlyaNeD.js";import{n as h,t as g}from"./styles-DT81gWAZ.js";var _,v,y,b,x,S,C,w,T,E,D,O,k;e((()=>{t(),d(),g(),r(),s(),m(),a(),{args:_,argTypes:v}=l(`syn-link`),{overrideArgs:y}=c(`syn-link`),b={args:y([{name:`default`,type:`slot`,value:`Link label`},{name:`syn-link`,type:`attribute`,value:`syn-link--medium`}],_),argTypes:v,component:`syn-link`,parameters:{chromatic:{modes:i},design:o(`41337-170604`),docs:{description:{component:u(`styles`,`link`)}}},tags:[`Navigation`,`Styles`],title:`Styles/syn-link`},x={parameters:{controls:{disable:!1}},render:e=>h(e,`a`,{class:`syn-link`,href:`javascript:void(0)`})},S={parameters:{docs:{description:{story:u(`link`,`inline`)}}},render:()=>n`
    <p style="width: 266px;">
  ...
  `},C={parameters:{docs:{description:{story:u(`link`,`prefix-suffix-icons`)}}},render:()=>n`
  ...
  `},w={parameters:{docs:{description:{story:u(`link`,`quiet`)}}},render:()=>n`
    <a href="javascript:void(0)" class="syn-link syn-link--quiet">
      <syn-icon name="keyboard_arrow_right"></syn-icon>
      Silence is gold
    </a>
  `},T={parameters:{docs:{description:{story:u(`link`,`disabled`)}}},render:()=>n`
    <a class="syn-link syn-link--disabled">
      <syn-icon name="keyboard_arrow_right"></syn-icon>
      Disabled
    </a>
  `},E={decorators:[p()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`link`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`a`);t&&t.focus()},render:()=>n`
    <a href="javascript:void(0)" class="syn-link syn-link--medium">
      <syn-icon name="keyboard_arrow_right"></syn-icon>
      Link
    </a>
  `},D={parameters:{docs:{description:{story:u(`link`,`size`)}}},render:()=>n`
