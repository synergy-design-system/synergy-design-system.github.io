var rn=Object.freeze,mi=Object.defineProperty;var ln=(a,e)=>rn(mi(a,"raw",{value:rn(e||a.slice())}));import{R as f,d as Dn,k,t as te,b as u,a as g,e as pt,f as fi}from"./if-defined-BaykDp1D.js";import{i as h,k as c,D as Nn,u as dn,Q as yi,R as bi}from"./directive-helpers-CDT6qhDs.js";import{h as In,$ as An,r as Pn,L as gi,F as mt,b as vi,o as wi,f as xi,c as ki,s as cn,d as _i,p as jt,e as Ti,g as Ci,a as Mn,k as Si,K as zi,j as Ei,i as $i,t as Oi}from"./ref-lLHsj5FH.js";import{s as Di}from"./chunk-L4EGOTBX-C9C4DwME.js";import"./entry-preview-D9TbQDUR.js";import{S as tt,d as pn,s as Ni}from"./index-isK108u9.js";import"./index-CleY8y_P.js";import{n as r,a as b}from"./library-BZPO0bHa.js";import{a as v,c as w,w as m,S as ue}from"./icon.component-BgIIknni.js";import"./icon-BjGOW_aa.js";const Ii=h`
  :host {
    display: block;
  }
...
`;var wa=Object.defineProperty,xa=Object.getOwnPropertyDescriptor,Se=(a,e,t,n)=>{for(var i=n>1?void 0:n?xa(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&wa(e,t,i),i};const Qe=Object.assign(document.createElement("div"),{className:"syn-toast-stack"});class be extends v{constructor(){super(...arguments),this.hasSlotController=new W(this,"icon","suffix"),this.localize=new j(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.remainingTime=this.duration}static{this.styles=[w,ga,va]}static{this.dependencies={"syn-icon-button":tt}}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){this.countdownAnimation?.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),this.countdownAnimation?.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){const{countdownElement:e}=this,t="100%",n="0";this.countdownAnimation=e.animate([{width:t},{width:n}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.duration<1/0&&this.restartAutoHide(),await q(this.base),this.base.hidden=!1;const{keyframes:e,options:t}=I(this,"alert.show",{dir:this.localize.dir()});await F(this.base,e,t),this.emit("syn-after-show")}else{this.emit("syn-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await q(this.base);const{keyframes:e,options:t}=I(this,"alert.hide",{dir:this.localize.dir()});await F(this.base,e,t),this.base.hidden=!0,this.emit("syn-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,U(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,U(this,"syn-after-hide")}async toast(){return new Promise(e=>{this.handleCountdownChange(),Qe.parentElement===null&&document.body.append(Qe),Qe.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("syn-after-hide",()=>{Qe.removeChild(this),e(),Qe.querySelector("syn-alert")===null&&Qe.remove()},{once:!0})})}render(){return c`
    ...
    `}}Se([u('[part~="base"]')],be.prototype,"base",2);Se([u(".alert__countdown-elapsed")],be.prototype,"countdownElement",2);Se([r({type:Boolean,reflect:!0})],be.prototype,"open",2);Se([r({type:Boolean,reflect:!0})],be.prototype,"closable",2);Se([r({reflect:!0})],be.prototype,"variant",2);Se([r({type:Number})],be.prototype,"duration",2);Se([b()],be.prototype,"remainingTime",2);Se([m("open",{waitUntilFirstUpdate:!0})],be.prototype,"handleOpenChange",1);Se([m("duration")],be.prototype,"handleDurationChange",1);T("alert.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});T("alert.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});be.define("syn-alert");const ka=h`
	/* stylelint-disable */
  :host {
    display: inline-flex;
  }
...
`;var Ta=Object.defineProperty,Ca=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Ta(e,t,i),i};class ei extends v{constructor(){super(...arguments),this.localize=new j(this),this.variant="primary"}static{this.styles=[w,ka,_a]}render(){return c`
      <span
        part="base"
...
`;var Ea=Object.defineProperty,$a=Object.getOwnPropertyDescriptor,it=(a,e,t,n)=>{for(var i=n>1?void 0:n?$a(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Ea(e,t,i),i};class qe extends v{constructor(){super(...arguments),this.hasSlotController=new W(this,"prefix","suffix"),this.renderType="button",this.rel="noreferrer noopener"}static{this.styles=[w,Sa,za]}setRenderType(){const e=this.defaultSlot.assignedElements({flatten:!0}).filter(t=>t.tagName.toLowerCase()==="syn-dropdown").length>0;if(this.href){this.renderType="link";return}if(e){this.renderType="dropdown";return}this.renderType="button"}hrefChanged(){this.setRenderType()}handleSlotChange(){this.setRenderType()}render(){return c`
    ...
    `}}it([u("slot:not([name])")],qe.prototype,"defaultSlot",2);it([b()],qe.prototype,"renderType",2);it([r()],qe.prototype,"href",2);it([r()],qe.prototype,"target",2);it([r()],qe.prototype,"rel",2);it([m("href",{waitUntilFirstUpdate:!0})],qe.prototype,"hrefChanged",1);qe.define("syn-breadcrumb-item");const Oa=h`
	/* stylelint-disable */
  .breadcrumb {
    display: flex;
    align-items: center;
...
`;class tn extends v{constructor(){super(...arguments),this.localize=new j(this)}static{this.styles=[w,Ma,La]}render(){return c`
...
`;var Ra=Object.defineProperty,Ua=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Ra(e,t,i),i};class ii extends v{constructor(){super(...arguments),this.hasSlotController=new W(this,"footer","header","image"),this.sharp=!1}static{this.styles=[w,Ha,Ba]}render(){return c`
      <div
        part="base"
...
`;var eo=Object.defineProperty,to=Object.getOwnPropertyDescriptor,$e=(a,e,t,n)=>{for(var i=n>1?void 0:n?to(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&eo(e,t,i),i};class ge extends v{constructor(){super(...arguments),this.localize=new j(this),this.isInitialized=!1,this.current=!1,this.selected=!1,this.hasHover=!1,this.value="",this.disabled=!1}static{this.styles=[w,Ja,Za]}static{this.dependencies={"syn-icon":ue}}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.setAttribute("aria-selected","false")}handleDefaultSlotChange(){this.isInitialized?(customElements.whenDefined("syn-combobox").then(()=>{const e=this.closest("syn-combobox");e&&e.handleDefaultSlotChange()}),customElements.whenDefined("syn-select").then(()=>{const e=this.closest("syn-select");e&&e.handleDefaultSlotChange()})):this.isInitialized=!0}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleValueChange(){typeof this.value!="string"&&(this.value=String(this.value)),this.value.includes(" ")&&(console.error("Option values cannot include a space. All spaces have been replaced with underscores.",this),this.value=this.value.replace(/ /g,"_"))}getTextLabel(){const e=this.childNodes;let t="";return[...e].forEach(n=>{n.nodeType===Node.ELEMENT_NODE&&(n.hasAttribute("slot")||(t+=n.textContent)),n.nodeType===Node.TEXT_NODE&&(t+=n.textContent)}),t.trim()}render(){return c`
      <div
        part="base"
...
`;var zo=Object.defineProperty,Eo=Object.getOwnPropertyDescriptor,Ge=(a,e,t,n)=>{for(var i=n>1?void 0:n?Eo(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&zo(e,t,i),i};class Me extends v{constructor(){super(...arguments),this.hasSlotController=new W(this,"footer"),this.localize=new j(this),this.modal=new si(this),this.open=!1,this.label="",this.noHeader=!1,this.handleDocumentKeyDown=e=>{e.key==="Escape"&&this.modal.isActive()&&this.open&&(e.stopPropagation(),this.requestClose("keyboard"))}}static{this.styles=[w,Co,So]}static{this.dependencies={"syn-icon-button":tt}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),ht(this))}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate(),Ze(this),this.removeOpenListeners()}requestClose(e){if(this.emit("syn-request-close",{cancelable:!0,detail:{source:e}}).defaultPrevented){const n=I(this,"dialog.denyClose",{dir:this.localize.dir()});F(this.panel,n.keyframes,n.options);return}this.hide()}addOpenListeners(){"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard")):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){this.closeWatcher?.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),ht(this);const e=this.querySelector("[autofocus]");e&&e.removeAttribute("autofocus"),await Promise.all([q(this.dialog),q(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit("syn-initial-focus",{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute("autofocus","")});const t=I(this,"dialog.show",{dir:this.localize.dir()}),n=I(this,"dialog.overlay.show",{dir:this.localize.dir()});await Promise.all([F(this.panel,t.keyframes,t.options),F(this.overlay,n.keyframes,n.options)]),this.emit("syn-after-show")}else{this.emit("syn-hide"),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([q(this.dialog),q(this.overlay)]);const e=I(this,"dialog.hide",{dir:this.localize.dir()}),t=I(this,"dialog.overlay.hide",{dir:this.localize.dir()});await Promise.all([F(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),F(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,Ze(this);const n=this.originalTrigger;typeof n?.focus=="function"&&setTimeout(()=>n.focus()),this.emit("syn-after-hide")}}async show(){if(!this.open)return this.open=!0,U(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,U(this,"syn-after-hide")}render(){return c`
    ...
    `}}Ge([u(".dialog")],Me.prototype,"dialog",2);Ge([u(".dialog__panel")],Me.prototype,"panel",2);Ge([u(".dialog__overlay")],Me.prototype,"overlay",2);Ge([r({type:Boolean,reflect:!0})],Me.prototype,"open",2);Ge([r({reflect:!0})],Me.prototype,"label",2);Ge([r({attribute:"no-header",type:Boolean,reflect:!0})],Me.prototype,"noHeader",2);Ge([m("open",{waitUntilFirstUpdate:!0})],Me.prototype,"handleOpenChange",1);T("dialog.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});T("dialog.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});T("dialog.denyClose",{keyframes:[{scale:1},{scale:1.02},{scale:1}],options:{duration:250}});T("dialog.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});T("dialog.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});Me.define("syn-dialog");const $o=h`
	/* stylelint-disable */
  :host {
...
`;var Do=Object.defineProperty,No=Object.getOwnPropertyDescriptor,ri=(a,e,t,n)=>{for(var i=n>1?void 0:n?No(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Do(e,t,i),i};class Le extends v{constructor(){super(...arguments),this.vertical=!1}static{this.styles=[w,$o,Oo]}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}}ri([r({type:Boolean,reflect:!0})],Le.prototype,"vertical",2);ri([m("vertical")],Le.prototype,"handleVerticalChange",1);Le.define("syn-divider");function kn(a){return a.charAt(0).toUpperCase()+a.slice(1)}const Io=h`
	/* stylelint-disable */
  :host {
    --size: 25rem;
    --header-spacing: var(--syn-spacing-large);
...
`;var Xo=Object.defineProperty,Qo=Object.getOwnPropertyDescriptor,S=(a,e,t,n)=>{for(var i=n>1?void 0:n?Qo(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Xo(e,t,i),i};class C extends v{constructor(){super(...arguments),this.formControlController=new ke(this,{assumeInteractionOn:["syn-blur","syn-input"]}),this.hasSlotController=new W(this,"help-text","label","prefix","suffix"),this.localize=new j(this),this.hasFocus=!1,this.title="",this.__numberInput=Object.assign(document.createElement("input"),{type:"number"}),this.__dateInput=Object.assign(document.createElement("input"),{type:"date"}),this.type="text",this.name="",this.value="",this.defaultValue="",this.size="medium",this.label="",this.helpText="",this.clearable=!1,this.disabled=!1,this.placeholder="",this.readonly=!1,this.passwordToggle=!1,this.passwordVisible=!1,this.noSpinButtons=!1,this.form="",this.required=!1,this.spellcheck=!0}static{this.styles=[w,ze,Go,Ee,Yo]}static{this.dependencies={"syn-icon":ue,"syn-divider":Le}}get valueAsDate(){return this.__dateInput.type=this.type,this.__dateInput.value=this.value,this.input?.valueAsDate||this.__dateInput.valueAsDate}set valueAsDate(e){this.__dateInput.type=this.type,this.__dateInput.valueAsDate=e,this.value=this.__dateInput.value}get valueAsNumber(){return this.__numberInput.value=this.value,this.input?.valueAsNumber||this.__numberInput.valueAsNumber}set valueAsNumber(e){this.__numberInput.valueAsNumber=e,this.value=this.__numberInput.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleStep(){this.handleInput(),this.input.focus()}handleStepUp(){this.stepUp(),this.handleStep()}handleStepDown(){this.stepDown(),this.handleStep()}isDecrementDisabled(){if(this.disabled||this.readonly)return!0;if(this.min===void 0||this.min===null||this.disabled)return!1;const e=typeof this.min=="string"?parseFloat(this.min):this.min;return this.valueAsNumber<=e}isIncrementDisabled(){if(this.disabled||this.readonly)return!0;if(this.max===void 0||this.max===null)return!1;const e=typeof this.max=="string"?parseFloat(this.max):this.max;return this.valueAsNumber>=e}handleChange(){this.value=this.input.value,this.emit("syn-change")}handleClearClick(e){e.preventDefault(),this.value!==""&&(this.value="",this.emit("syn-clear"),this.emit("syn-input"),this.emit("syn-change")),this.input.focus()}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleInput(){this.value=this.input.value,this.formControlController.updateValidity(),this.emit("syn-input")}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleKeyDown(e){const t=e.metaKey||e.ctrlKey||e.shiftKey||e.altKey;e.key==="Enter"&&!t&&setTimeout(()=>{!e.defaultPrevented&&!e.isComposing&&this.formControlController.submit()})}handlePasswordToggle(){this.passwordVisible=!this.passwordVisible}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStepChange(){this.input.step=String(this.step),this.formControlController.updateValidity()}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(e){this.input.focus(e)}blur(){this.input.blur()}select(){this.input.select()}setSelectionRange(e,t,n="none"){this.input.setSelectionRange(e,t,n)}setRangeText(e,t,n,i="preserve"){const o=t??this.input.selectionStart,s=n??this.input.selectionEnd;this.input.setRangeText(e,o,s,i),this.value!==this.input.value&&(this.value=this.input.value)}showPicker(){"showPicker"in HTMLInputElement.prototype&&this.input.showPicker()}stepUp(){this.input.stepUp(),this.value!==this.input.value&&(this.value=this.input.value)}stepDown(){this.input.stepDown(),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("label"),t=this.hasSlotController.test("help-text"),n=this.hasSlotController.test("prefix"),i=this.hasSlotController.test("suffix"),o=this.label?!0:!!e,s=this.helpText?!0:!!t,d=this.clearable&&!this.disabled&&!this.readonly&&(typeof this.value=="number"||this.value.length>0);return c`
    ...
    `:c` <slot name="submenu" hidden></slot> `}}const Zo=h`
	/* stylelint-disable */
  :host {
    --submenu-offset: -2px;
...
`;class ss extends v{static{this.styles=[w,as,os]}static{this.dependencies={"syn-divider":Le}}render(){return c`
...
`;var ms=Object.defineProperty,fs=Object.getOwnPropertyDescriptor,It=(a,e,t,n)=>{for(var i=n>1?void 0:n?fs(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&ms(e,t,i),i};class vt extends v{constructor(){super(...arguments),this.hasSlotController=new W(this,"[default]","prefix","suffix","label"),this.disabled=!1,this.label=""}static{this.styles=us}static{this.dependencies={"syn-divider":Le}}handleDisableOptions(){const{disabled:e}=this;this.defaultSlot.assignedElements().filter(t=>t.tagName.toLowerCase()==="syn-option").forEach(t=>{t.disabled=e})}handleDisabledChange(){this.handleDisableOptions()}render(){const{disabled:e}=this,t=this.hasSlotController.test("label"),n=this.label?!0:!!t;return k`
    ...
    `}}It([u("slot:not([name])")],vt.prototype,"defaultSlot",2);It([r({reflect:!0,type:Boolean})],vt.prototype,"disabled",2);It([r()],vt.prototype,"label",2);It([m("disabled",{waitUntilFirstUpdate:!0})],vt.prototype,"handleDisabledChange",1);vt.define("syn-optgroup");ge.define("syn-option");O.define("syn-popup");const ys=h`
  :host {
    display: block;
...
`,Tn=a=>Array.from(a.assignedElements({flatten:!0})),bs=a=>a.tagName.toLocaleLowerCase()==="syn-nav-item"||(a.getAttribute("role")??"")==="menuitem",Cn=a=>a.filter(bs),gs=a=>{a.setAttribute("horizontal","true"),a.removeAttribute("slot"),a.removeAttribute("tabindex"),a.dataset.originalRole?a.setAttribute("role",a.dataset.originalRole):a.removeAttribute("role")},vs=a=>{a.removeAttribute("horizontal"),a.setAttribute("slot","menu"),a.setAttribute("role","menuitem")};var ws=Object.defineProperty,je=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&ws(e,t,i),i};class Oe extends v{constructor(){super(...arguments),this.localize=new j(this),this.itemPositionsCached=!1,this.amountOfNavItems=0,this.amountOfVisibleItems=0,this.hasItemsInDropdown=!1}static{this.styles=[w,ys]}static{this.dependencies={"syn-dropdown":ae,"syn-icon":ue,"syn-menu":Nt,"syn-nav-item":J}}getSlottedNavItems(){const e=Cn(Tn(this.defaultSlot)),t=Cn(Tn(this.menuSlot));return e.concat(t)}cacheItemPositions(e){const{left:t}=this.horizontalNav.getBoundingClientRect();e.forEach(n=>{n.removeAttribute("slot");const{right:i}=n.getBoundingClientRect();n.dataset.right=(i-t).toString()}),this.itemPositionsCached=!0}handlePriorityMenu(){const e=this.getSlottedNavItems();this.itemPositionsCached||this.cacheItemPositions(e);const{width:t}=this.horizontalNav.getBoundingClientRect(),n=this.priorityMenu.classList.contains("priority-menu--hidden")?0:this.priorityMenu.clientWidth,i=t-n;let o;const s=e.at(-1),l=e.map(y=>{const _=y===s?t:i,K=!!(o||parseFloat(y.dataset.right)>_);return K&&!o&&(o=parseFloat(y.dataset.right)),{isHidden:K,item:y}}),d=l.filter(({isHidden:y})=>!y).length,p=d===1;l.forEach(({item:y,isHidden:_})=>{_||p?vs(y):gs(y)}),this.hasItemsInDropdown=d!==e.length,this.amountOfVisibleItems=p?0:d}renderPriorityMenu(){return k`
      <syn-dropdown
...
`;var _s=Object.defineProperty,an=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&_s(e,t,i),i};class At extends v{constructor(){super(...arguments),this.localize=new j(this),this.value=0,this.indeterminate=!1,this.label=""}static{this.styles=[w,xs,ks]}render(){return c`
      <div
        part="base"
...
`;var Ss=Object.defineProperty,Pt=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Ss(e,t,i),i};class wt extends v{constructor(){super(...arguments),this.localize=new j(this),this.value=0,this.label=""}static{this.styles=[w,Ts,Cs]}updated(e){if(super.updated(e),e.has("value")){const t=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),n=2*Math.PI*t,i=n-this.value/100*n;this.indicatorOffset=`${i}px`}}render(){return c`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
    ...
    `}}Pt([u(".progress-ring__indicator")],wt.prototype,"indicator");Pt([b()],wt.prototype,"indicatorOffset");Pt([r({type:Number,reflect:!0})],wt.prototype,"value");Pt([r()],wt.prototype,"label");wt.define("syn-progress-ring");const zs=h`
	/* stylelint-disable */
  ${ni}
...
`;var Ms=Object.defineProperty,Ls=Object.getOwnPropertyDescriptor,Ye=(a,e,t,n)=>{for(var i=n>1?void 0:n?Ls(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Ms(e,t,i),i};class Fe extends v{constructor(){super(),this.checked=!1,this.hasFocus=!1,this.size="medium",this.disabled=!1,this.handleBlur=()=>{this.hasFocus=!1,this.emit("syn-blur")},this.handleClick=()=>{this.disabled||(this.checked=!0)},this.handleFocus=()=>{this.hasFocus=!0,this.emit("syn-focus")},this.addEventListener("blur",this.handleBlur),this.addEventListener("click",this.handleClick),this.addEventListener("focus",this.handleFocus)}static{this.styles=[w,As,Ps]}static{this.dependencies={"syn-icon":ue}}connectedCallback(){super.connectedCallback(),this.setInitialAttributes()}setInitialAttributes(){this.setAttribute("role","radio"),this.setAttribute("tabindex","-1"),this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleCheckedChange(){this.setAttribute("aria-checked",this.checked?"true":"false"),this.setAttribute("tabindex",this.checked?"0":"-1")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}render(){return c`
      <span
        part="base"
...
`;var Fs=Object.defineProperty,Vs=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Fs(e,t,i),i};class di extends v{constructor(){super(...arguments),this.subdivision=!1}static{this.styles=[w,js]}render(){return c`
      <div
...
`;var Xs=Object.defineProperty,ci=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Xs(e,t,i),i};class Mt extends v{constructor(){super(...arguments),this.localize=new j(this),this.size="medium",this.removable=!1}static{this.styles=[w,Gs,Ys]}static{this.dependencies={"syn-icon-button":tt}}handleRemoveClick(){this.emit("syn-remove")}render(){return c`
      <span
        part="base"
    ...
    `}}ci([r({reflect:!0})],Mt.prototype,"size");ci([r({type:Boolean})],Mt.prototype,"removable");const Qs=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`,Js=h`
  ...
  ${ai}
`;var Zs=Object.defineProperty,er=Object.getOwnPropertyDescriptor,D=(a,e,t,n)=>{for(var i=n>1?void 0:n?er(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Zs(e,t,i),i};class $ extends v{constructor(){super(...arguments),this.formControlController=new ke(this,{assumeInteractionOn:["syn-blur","syn-input"]}),this.hasSlotController=new W(this,"help-text","label"),this.localize=new j(this),this.typeToSelectString="",this.hasFocus=!1,this.displayLabel="",this.selectedOptions=[],this.valueHasChanged=!1,this.name="",this._value="",this.defaultValue="",this.size="medium",this.placeholder="",this.multiple=!1,this.maxOptionsVisible=3,this.disabled=!1,this.clearable=!1,this.open=!1,this.hoist=!1,this.label="",this.placement="bottom",this.helpText="",this.form="",this.required=!1,this.getTag=e=>c`
      <syn-tag
        part="tag"
        exportparts="
              base:tag__base,
...
:host([size='small']) {
  ...
  `;var sr=Object.defineProperty,rr=Object.getOwnPropertyDescriptor,ce=(a,e,t,n)=>{for(var i=n>1?void 0:n?rr(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&sr(e,t,i),i};class se extends v{constructor(){super(...arguments),this.formControlController=new ke(this,{value:e=>e.checked?e.value||"on":void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=t}),this.hasSlotController=new W(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}static{this.styles=[w,ze,ar,Ee,or]}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleInput(){this.emit("syn-input")}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleClick(){this.checked=!this.checked,this.emit("syn-change")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleKeyDown(e){e.key==="ArrowLeft"&&(e.preventDefault(),this.checked=!1,this.emit("syn-change"),this.emit("syn-input")),e.key==="ArrowRight"&&(e.preventDefault(),this.checked=!0,this.emit("syn-change"),this.emit("syn-input"))}handleCheckedChange(){this.input.checked=this.checked,this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(!0)}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("help-text"),t=this.helpText?!0:!!e;return c`
      <div
        class=${f({"form-control":!0,"form-control--small":this.size==="small","form-control--medium":this.size==="medium","form-control--large":this.size==="large","form-control--has-help-text":t})}
      >
        <label
...
`;var vr=Object.defineProperty,wr=Object.getOwnPropertyDescriptor,sn=(a,e,t,n)=>{for(var i=n>1?void 0:n?wr(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&vr(e,t,i),i};let xr=0;class Lt extends v{constructor(){super(...arguments),this.attrId=++xr,this.componentId=`syn-tab-panel-${this.attrId}`,this.name="",this.active=!1}static{this.styles=[w,br,gr]}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return c`
      <slot
        part="base"
...
`;var Ar=Object.defineProperty,Pr=Object.getOwnPropertyDescriptor,fe=(a,e,t,n)=>{for(var i=n>1?void 0:n?Pr(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Ar(e,t,i),i};class pe extends v{constructor(){super(...arguments),this.controller=new AbortController,this.validationMessage="",this.eagerFirstMount=!0,this.isInternalTriggeredInvalid=!1,this.isValid=!0,this.variant="native",this.hideIcon=!1,this.on="",this.customValidationMessage="",this.eager=!1,this.internalRevalidate=e=>{e.currentTarget.validity?.valid&&(this.validationMessage="")},this.validate=e=>{if(Ht(e.type)&&this.variant==="native"&&this.isInternalTriggeredInvalid===!0){this.isInternalTriggeredInvalid=!1;return}Ht(e.type)&&this.variant!=="native"&&(e.preventDefault(),e.stopPropagation());const t=e.currentTarget;if(this.isValid=t.validity?.valid,this.eager&&this.eagerFirstMount){this.eagerFirstMount=!1,this.setValidationMessage(t);return}!this.isValid&&!En(e.type)&&this.handleFocus(t),this.setValidationMessage(t),!En(e.type)&&this.variant==="native"&&this.updateComplete.then(()=>{this.isInternalTriggeredInvalid=!0,t.reportValidity()})}}static{this.styles=[w,Ir]}static{this.dependencies={"syn-alert":be}}handleListenerChange(){this.updateEvents()}async handleEagerChange(){if(this.eager){const e=this.getInput();await this.updateComplete,e?.reportValidity(),this.eagerFirstMount=!0}else this.eagerFirstMount=!1}handleCustomValidationMessageChange(){const e=this.getInput();e&&(this.setCustomValidationMessage(e),this.setValidationMessage(e))}getValidity(){return this.isValid}getInput(){const e=this.slottedChildren[0];return e||void 0}getUsedEventNames(){const e=this.getInput();if(!e)return[];const t=Nr(this.on),[...n]=t.filter(Boolean);return n.includes("invalid")||n.push("invalid"),n.includes("live")&&(n.push("input"),n.push("blur")),Array.from(new Set(n.filter(i=>i!=="live").map(i=>$n(e,i))))}updateEvents(){this.controller.abort(),this.controller=new AbortController;const e=this.getInput();if(!e)return;const t=this.getUsedEventNames();t.forEach(i=>{e.addEventListener(i,this.validate,{capture:Ht(i),signal:this.controller.signal})});const n=$n(e,"change");t.includes(n)||e.addEventListener(n,this.internalRevalidate,{signal:this.controller.signal})}setValidationMessage(e){const{customValidationMessage:t}=this,n=t||e.validationMessage;this.validationMessage=n}setCustomValidationMessage(e){e.setCustomValidity(this.customValidationMessage)}handleFocus(e){const t=document.activeElement,n=t.closest("syn-validate");!t.validity?.valid&&n||(e.scrollIntoView({block:"nearest"}),e.focus())}async firstUpdated(){if(this.updateEvents(),this.eager){const e=this.getInput();await this.updateComplete,this.isValid=e?.validity?.valid??!1,e?.reportValidity()}}disconnectedCallback(){super.disconnectedCallback(),this.controller.abort()}renderInlineValidation(){return this.variant!=="inline"||!this.validationMessage?"":c`
    ...
    `}}fe([In()],pe.prototype,"slottedChildren",2);fe([b()],pe.prototype,"validationMessage",2);fe([b()],pe.prototype,"eagerFirstMount",2);fe([b()],pe.prototype,"isInternalTriggeredInvalid",2);fe([b()],pe.prototype,"isValid",2);fe([r({reflect:!0})],pe.prototype,"variant",2);fe([r({attribute:"hide-icon",reflect:!0,type:Boolean})],pe.prototype,"hideIcon",2);fe([r({reflect:!0})],pe.prototype,"on",2);fe([r({attribute:"custom-validation-message",type:String})],pe.prototype,"customValidationMessage",2);fe([r({type:Boolean})],pe.prototype,"eager",2);fe([m("on",{waitUntilFirstUpdate:!0})],pe.prototype,"handleListenerChange",1);fe([m("eager",{waitUntilFirstUpdate:!1})],pe.prototype,"handleEagerChange",1);fe([m("customValidationMessage",{waitUntilFirstUpdate:!0})],pe.prototype,"handleCustomValidationMessageChange",1);pe.define("syn-validate");function Mr(a){const e=typeof window<"u"&&window;return!!(e&&(/Chromatic/.test(e.navigator.userAgent)||/chromatic=true/.test(e.location.href)))}const Lr=(a,...e)=>Mr()?c`
      ...
      ${a(...e)}
    `:a(...e),$t="🌞 light",Wt="🌙 dark",jr=a=>`https://www.figma.com/file/bZFqk9urD3NlghGUKrkKCR/Synergy-Digital-Design-System?type=design&node-id=${a}`,Fr=(a,e="Go to Figma page")=>({label:e,type:"link",url:jr(a)});function Vr(a,e){const t=document.querySelectorAll(`#anchor--${e.id}`),i=JSON.parse('{"@synergy-design-system/components":"2.15.2","@synergy-design-system/assets":"1.11.2","@synergy-design-system/styles":"1.6.0","@synergy-design-system/tokens":"2.16.0"}');return t.forEach(o=>{const s=o.querySelector(".docblock-code-toggle");if(s){const l=s.cloneNode(!0);l.textContent="Edit on CodePen",l.classList.add("docblock-codepen-button");const d=o.querySelector(".sb-bar");d?o.querySelectorAll(".docblock-codepen-button:not(:last-of-type)").forEach(p=>{p.remove()}):o.querySelectorAll(".docblock-codepen-button").forEach(p=>{p.remove()}),s.parentElement.appendChild(l),d&&(o.querySelectorAll(".docblock-codepen-button:not(:last-of-type)").forEach(p=>{p.style.display="block",p.style.borderRight="none"}),o.querySelector(".docblock-codepen-button:last-of-type").style.display="none"),l.addEventListener("click",()=>{const p=document.createElement("form");p.action="https://codepen.io/pen/define",p.method="POST",p.target="_blank";const y={css:`/* Import theme */
...
`):n=e.innerHTML,n=n.replace(/<style><\/style>/g,"").replace(/<!-- preview-ignore:start -->[\s\S]*?<!-- preview-ignore:end -->/g,"").replace(/\/\/ preview-ignore:start[\s\S]*?\/\/ preview-ignore:end/g,"").replace(/<style>\n<\/style>/g,"").replace(/<script>\s*component = document\.querySelector\('(.+?)'\);\s*<\/script>/g,""),n}},sl=(a,e)=>{const t=pn?.components?.[a]?.[e]?.description?.value??"No Description",n=pn?.components?.[a]?.[e]?.note?.value??"",i=t.replace(/\n/g,"<br/>"),o=n.length>0?`
  ...
  > ${n.replace(/\n/g,"<br/>")}`:n;return`${i}${o}`},rl=(a,e=150)=>{const t=isNaN(e)?e:{heightPx:e},{afterRender:n="",additionalChromaticOptions:i={},heightPx:o=150,styleHeading:s={}}=t,l=Object.entries(s).map(([d,p])=>`${d}: ${p};`).join(" ");return{parameters:{chromatic:{...ui?.parameters?.chromatic,...i,disableSnapshot:!1},docs:{disable:!0}},render:(d,p)=>k`
      ${Object.entries(a).map(([y,_])=>{const K=_.name??Ni(y);return k`
      ...
      `})}
      ${n}
    `}};export{ol as a,sl as b,rl as c,Je as d,al as e,Fr as g,il as h,Mr as i,ui as p,qt as s};
