import{s as A,a as L,g as T,b as e,c as G,d as M,h as R}from"./component-CjEFK4yx.js";import{k as r}from"./directive-helpers-CDT6qhDs.js";import{a as z}from"./ref-lLHsj5FH.js";import{u as F}from"./index-B_f3VjvO.js";import"./if-defined-BaykDp1D.js";import"./chunk-L4EGOTBX-C9C4DwME.js";import"./entry-preview-D9TbQDUR.js";import"./index-DrFu-skq.js";import"./index-Co3MNReg.js";import"./library-BZPO0bHa.js";import"./icon.component-DbLkOHCL.js";import"./index-7h80QhK_.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon-eErRpPHH.js";var w=Object.freeze,_=Object.defineProperty,$=(o,n)=>w(_(o,"raw",{value:w(o.slice())})),H,q,E;const{args:D,argTypes:B}=A("syn-combobox"),{overrideArgs:I}=M("syn-combobox"),{generateTemplate:W}=L("syn-combobox"),ao={args:D,argTypes:B,component:"syn-combobox",parameters:{design:T("25272-35634"),docs:{description:{component:e("combobox","default")},story:{height:"250px"}}},title:"Components/syn-combobox"},Y=["Yellow","Light Green","Grey","Green","Blue","Red","Orange","Magenta","White","Purple","Pink","Black","Brown"].sort(),P=o=>`<syn-option value="${o.replaceAll(" ","_")}">${o}</syn-option>`,s=o=>z(P(o)),j=()=>Y.map(P),t=()=>z(j().join(`
`)),a={parameters:{args:I({name:"default",type:"slot",value:`
  ...
  `},h={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:e("combobox","invalid")}}},play:async({canvasElement:o})=>{const n=o.querySelector("form"),k=n.querySelector("syn-combobox"),C=n.querySelector("syn-button");C&&k&&(await F.click(C),C.click())},render:()=>r`
  ...
  `])))},u={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:e("combobox","custom-filter")}}},render:()=>r(E||(E=$([`
    ...
    <\/script>
  `])),t())},v=G({Default:a,Labels:c,HelpText:i,Placeholder:l,Clearable:p,Disabled:m,Sizes:b,PrefixSuffixTextAndIcons:y,AsyncOptions:d,CustomFilter:u},500);a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  parameters: {
    args: overrideArgs({
      name: 'default',
      type: 'slot',
