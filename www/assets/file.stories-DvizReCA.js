import{e as k}from"./class-map-Bo2NiYIQ.js";import{c as I,n as l,S as A}from"./synergy-element-BoJA4F0K.js";import{S as B,r as O}from"./icon.component-9N7Azsi9.js";import{a as S}from"./query-D0jTsbLw.js";import{q as P,x as a,g as q,C as L}from"./iframe-CW_KonjK.js";import{o as M}from"./if-defined-qefA8dKN.js";import{d as H}from"./default-value-FKWl7b5r.js";import{w as F}from"./watch-CEsCE2EF.js";import{L as j}from"./localize-Dh03wnLC.js";import{F as R}from"./form-d9hCJUdr.js";import{H as U}from"./slot-9EVoRGQc.js";import{f as W,a as Y}from"./form-control.custom.styles-CoSJASsY.js";import{S as G}from"./button-BbfaGMjJ.js";import{s as z,g as T,b as C}from"./animation-registry-l4L8bmT6.js";import{e as K}from"./decorator-CVE5vLu9.js";import{g as d,s as N,a as J,c as Q,b as X}from"./component-C0ootQNb.js";import{p as Z}from"./PaddingDecorator-Bnch5h0d.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DihgwUfS.js";import"./spinner.component-DvWUUZZP.js";import"./functions-Cnw7w7U0.js";import"./index-CQ0aEGxp.js";import"./_docs-DNIao1HN.js";const ee=P`
  :host {
    display: block;
  }
...
`;var te=Object.defineProperty,re=Object.getOwnPropertyDescriptor,i=(e,t,o,s)=>{for(var n=s>1?void 0:s?re(t,o):t,p=e.length-1,c;p>=0;p--)(c=e[p])&&(n=(s?c(t,o,n):c(n))||n);return s&&n&&te(t,o,n),n};let r=class extends A{constructor(){super(...arguments),this.formControlController=new R(this,{assumeInteractionOn:["syn-change"],value:e=>e.files}),this.hasSlotController=new U(this,"help-text","label"),this.localize=new j(this),this.userIsDragging=!1,this.name="",this.defaultValue="",this.size="medium",this.label="",this.helpText="",this.disabled=!1,this.droparea=!1,this.accept="",this.multiple=!1,this.webkitdirectory=!1,this.form="",this.required=!1,this.hideValue=!1}set files(e){this.input&&(this.input.files=e)}get files(){return this.input?.files}set value(e){this.input&&(this.input.value=e)}get value(){return this.input?.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(e){if(this.droparea){this.dropareaWrapper?.focus(e);return}this.button?.focus(e)}blur(){if(this.droparea){this.dropareaWrapper?.blur();return}this.button?.blur()}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleFiles(e){if(!e){this.value="";return}this.files=e}async handleTransferItems(e){if(!e)return this.value="",new Promise((c,E)=>{E(new Error("No proper items found"))});const o=Array.from(e).map(c=>c.webkitGetAsEntry()).map(c=>this.getFilesFromEntry(c)),n=(await Promise.all(o)).flat(),p=new DataTransfer;return Array.from(n).forEach(c=>p.items.add(c)),p.files}async getFilesFromEntry(e){return e?e.isFile?new Promise((t,o)=>{e.file(s=>t([s]),o)}):e.isDirectory?new Promise((t,o)=>{e.createReader().readEntries(n=>{Promise.all(n.map(p=>this.getFilesFromEntry(p))).then(p=>{t(p.flat())}).catch(o)})}):[]:[]}handleClick(e){e.preventDefault(),this.input.click()}handleChange(e){e.preventDefault(),e.stopPropagation(),this.emit("syn-input"),this.emit("syn-change")}handleDragOver(e){e.preventDefault(),e.stopPropagation(),this.userIsDragging=!0}handleDragLeave(e){e.preventDefault(),e.stopPropagation(),this.userIsDragging=!1}async handleDrop(e){if(e.preventDefault(),e.stopPropagation(),!e.dataTransfer)return;const t=await this.handleTransferItems(e.dataTransfer?.items);if(this.userIsDragging=!1,!t)return;if(!this.multiple&&!this.webkitdirectory&&t.length>1){this.emit("syn-error");return}if(this.hasSlotController.test("trigger"))this.handleFiles(t);else{const s=T(this.inputChosen,"file.text.disappear",{dir:this.localize.dir()}),n=T(this.inputChosen,"file.text.appear",{dir:this.localize.dir()});if(this.droparea){const p=T(this.dropareaIcon,"file.iconDrop",{dir:this.localize.dir()});C(this.dropareaIcon,p.keyframes,p.options)}await C(this.inputChosen,s.keyframes,s.options),this.handleFiles(t),await C(this.inputChosen,n.keyframes,n.options)}this.input.dispatchEvent(new Event("change"))}handleFocus(){this.emit("syn-focus")}handleBlur(){this.emit("syn-blur")}renderValue(){let e=!1,t=this.localize.term("numFilesSelected",0,this.webkitdirectory);return this.files&&this.files?.length>0&&(e=!0,t=this.files.length===1?this.files[0].name:this.localize.term("numFilesSelected",this.files.length,this.webkitdirectory)),a`
    ...
    `}};r.styles=[I,W,Y,ee];r.dependencies={"syn-button":G,"syn-icon":B};i([O()],r.prototype,"userIsDragging",2);i([l({type:Object})],r.prototype,"files",1);i([l({type:String})],r.prototype,"name",2);i([l({type:String})],r.prototype,"value",1);i([H()],r.prototype,"defaultValue",2);i([l({reflect:!0})],r.prototype,"size",2);i([l()],r.prototype,"label",2);i([l({attribute:"help-text"})],r.prototype,"helpText",2);i([l({reflect:!0,type:Boolean})],r.prototype,"disabled",2);i([l({type:Boolean})],r.prototype,"droparea",2);i([l({type:String})],r.prototype,"accept",2);i([l({type:String})],r.prototype,"capture",2);i([l({reflect:!0,type:Boolean})],r.prototype,"multiple",2);i([l({reflect:!0,type:Boolean})],r.prototype,"webkitdirectory",2);i([l({reflect:!0})],r.prototype,"form",2);i([l({reflect:!0,type:Boolean})],r.prototype,"required",2);i([l({attribute:"hide-value",type:Boolean})],r.prototype,"hideValue",2);i([S(".input__control")],r.prototype,"input",2);i([S(".button")],r.prototype,"button",2);i([S(".droparea")],r.prototype,"dropareaWrapper",2);i([S(".droparea__icon")],r.prototype,"dropareaIcon",2);i([S(".input__value")],r.prototype,"inputChosen",2);i([F("disabled",{waitUntilFirstUpdate:!0})],r.prototype,"handleDisabledChange",1);i([F("value",{waitUntilFirstUpdate:!0})],r.prototype,"handleValueChange",1);r=i([K("SynFile")],r);z("file.iconDrop",{keyframes:[{scale:1},{scale:.7},{scale:1}],options:{duration:600,easing:"ease-out"}});z("file.text.disappear",{keyframes:[{opacity:1},{opacity:0,transform:"translateY(-40%)"}],options:{duration:300,easing:"cubic-bezier(0.45, 1.45, 0.8, 1)"}});z("file.text.appear",{keyframes:[{opacity:0,transform:"translateY(40%)"},{opacity:1}],options:{duration:300,easing:"cubic-bezier(0.45, 1.45, 0.8, 1)"}});r.define("syn-file");var $=Object.freeze,ie=Object.defineProperty,ae=(e,t)=>$(ie(e,"raw",{value:$(e.slice())})),V;const{userEvent:se}=__STORYBOOK_MODULE_TEST__,{args:le,argTypes:oe}=N("syn-file"),{overrideArgs:ne}=J("syn-file"),{generateTemplate:pe}=Q("syn-file"),Ie={args:ne([],le),argTypes:oe,component:"syn-file",parameters:{chromatic:{modes:L},design:q("21709-49135"),docs:{description:{component:d("file","default")}}},tags:["Form"],title:"Components/syn-file"},u={parameters:{controls:{disable:!1},docs:{description:{story:d("file","default")}}},render:e=>pe({args:e})},h={parameters:{docs:{description:{story:d("file","label")}}},render:()=>a`
  ...
  `},m={parameters:{docs:{description:{story:d("file","multiple")}}},render:()=>a`
    <syn-file
      ...
      multiple
    ></syn-file>
  `},y={parameters:{docs:{description:{story:d("file","hide-value")}}},render:()=>a`
    <syn-file
      hide-value
      label="This is a label"
    ></syn-file>
  `},D={decorators:[Z()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:d("file","focus")}}},play:({canvasElement:e})=>{const t=e.querySelector("syn-file");t&&t.focus()},render:()=>a`
...
`},b={parameters:{docs:{description:{story:d("file","sizes")}}},render:()=>a`
  ...
  `},v={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:d("file","invalid")}}},play:async({canvasElement:e})=>{try{const t=e.querySelector("form"),o=t.querySelectorAll("syn-file"),s=t.querySelector("syn-button");s&&o&&(await se.click(s),s.click())}catch(t){console.error("Error in play function:",t)}},render:()=>a(V||(V=ae([`
  ...
  `},w=X({Default:u,Label:h,HelpText:f,Multiple:m,HideValue:y,Disabled:g,Sizes:b,Invalid:v,Droparea:x,Directory:_},750);u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
