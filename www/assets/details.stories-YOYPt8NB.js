import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{a as t,d as n,o as r,s as i}from"./preview-DdzcclEm.js";import{c as a,t as o}from"./lit-BfcklOOD.js";import{t as s}from"./icon-8cT1hKpd.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-BjD7AuVi.js";import{t as m}from"./details-BayOrY2q.js";import{n as h,t as g}from"./PaddingDecorator-B8dy7wkX.js";var _,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N=e((()=>{o(),m(),s(),f(),r(),g(),n(),{args:_,argTypes:v}=l(`syn-details`),{overrideArgs:y}=c(`syn-details`),{generateTemplate:b}=d(`syn-details`),x={args:y([{name:`summary`,type:`attribute`,value:`Toggle Me`},{name:`contained`,type:`attribute`,value:!0},{name:`default`,type:`slot`,value:`<h3 style="margin: 0 0 var(--syn-spacing-x-small); font: var(--syn-body-small-bold);">Subheadline</h3>
      Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.
      At vero eos et accusam et justo duo dolores et ea rebum.`}],_),argTypes:v,component:`syn-details`,parameters:{chromatic:{modes:i},design:t(`41227-232486`),docs:{description:{component:u(`details`,`default`)}}},tags:[`Structure`],title:`Components/syn-details`},S={parameters:{controls:{disable:!1},docs:{description:{story:u(`details`,`default`)}}},render:e=>b({args:e})},C={parameters:{docs:{description:{story:u(`details`,`open`)}}},render:()=>a`
  ...
  `},w={parameters:{docs:{description:{story:u(`details`,`contained`)}}},render:()=>a`
  ...
  `},T={decorators:[h()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`details`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-details`);t&&t.shadowRoot.querySelector(`summary`).focus()},render:()=>a`
    <syn-details summary="Toggle Me" contained>
      <h3 style="margin: 0 0 var(--syn-spacing-x-small); font: var(--syn-body-small-bold);">Subheadline</h3>
      Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.
      At vero eos et accusam et justo duo dolores et ea rebum.
    </syn-details>
  `},E=e=>({parameters:{docs:{description:{story:u(`details`,`disabled`)}}},render:()=>a`
    <syn-details summary="Toggle Me" disabled .contained=${e}>
      <h3 style="margin: 0 0 var(--syn-spacing-x-small); font: var(--syn-body-small-bold);">Subheadline</h3>
      Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.
      At vero eos et accusam et justo duo dolores et ea rebum.
    </syn-details>
  `}),D=E(!0),O=E(!1),k={parameters:{docs:{description:{story:u(`details`,`size`)}}},render:()=>a`
  ...
  `},A={parameters:{docs:{description:{story:u(`details`,`icon`)}}},render:()=>a`
    <syn-details open>
