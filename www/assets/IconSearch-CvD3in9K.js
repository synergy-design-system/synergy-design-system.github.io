...
`,We=Symbol(),pt=Symbol(),zt,kt=new Map,R=class extends b{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(t,i){var a;let r;if(i?.spriteSheet)return this.svg=u`<svg part="svg">
    ...
    `}};Q.styles=[z,uo,co];Q.dependencies={"syn-icon-button":j,"syn-resize-observer":ft};o([m(".tab-group")],Q.prototype,"tabGroup",2);o([m(".tab-group__body")],Q.prototype,"body",2);o([m(".tab-group__nav")],Q.prototype,"nav",2);o([m(".tab-group__indicator")],Q.prototype,"indicator",2);o([_()],Q.prototype,"hasScrollControls",2);o([_()],Q.prototype,"shouldHideScrollStartButton",2);o([_()],Q.prototype,"shouldHideScrollEndButton",2);o([s()],Q.prototype,"placement",2);o([s()],Q.prototype,"activation",2);o([s({attribute:"no-scroll-controls",type:Boolean})],Q.prototype,"noScrollControls",2);o([s({type:Boolean})],Q.prototype,"contained",2);o([s({type:Boolean})],Q.prototype,"sharp",2);o([s({attribute:"fixed-scroll-controls",type:Boolean})],Q.prototype,"fixedScrollControls",2);o([Xi({passive:!0})],Q.prototype,"updateScrollButtons",1);o([g("noScrollControls",{waitUntilFirstUpdate:!0})],Q.prototype,"updateScrollControls",1);o([g("placement",{waitUntilFirstUpdate:!0})],Q.prototype,"syncIndicator",1);var Po="syn-tab-group";Q.define("syn-tab-group");w({displayName:"SynTabGroup",elementClass:Q,events:{onSynTabShow:"syn-tab-show",onSynTabHide:"syn-tab-hide"},react:x,tagName:Po});var Ro=d`
  /* Write custom CSS here */
  .tab-panel {
...
`,Ce=class extends b{constructor(){super(...arguments),this.localize=new B(this),this.size="medium",this.removable=!1}handleRemoveClick(){this.emit("syn-remove")}render(){return u`
    ...
    `}};Ce.styles=[z,Yo,Xo];Ce.dependencies={"syn-icon-button":j};o([s({reflect:!0})],Ce.prototype,"size",2);o([s({type:Boolean})],Ce.prototype,"removable",2);Ce=o([te("SynTag")],Ce);var Qo="syn-tag";Ce.define("syn-tag");w({displayName:"SynTag",elementClass:Ce,events:{onSynRemove:"syn-remove"},react:x,tagName:Qo});var Jo=d`
...
`;function ra(e){return e!==null&&typeof e=="object"&&"getBoundingClientRect"in e&&("contextElement"in e?e instanceof Element:!0)}var T=class extends b{constructor(){super(...arguments),this.localize=new B(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){const e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),i=this.placement.includes("top")||this.placement.includes("bottom");let a=0,r=0,n=0,l=0,p=0,c=0,h=0,k=0;i?e.top<t.top?(a=e.left,r=e.bottom,n=e.right,l=e.bottom,p=t.left,c=t.top,h=t.right,k=t.top):(a=t.left,r=t.bottom,n=t.right,l=t.bottom,p=e.left,c=e.top,h=e.right,k=e.top):e.left<t.left?(a=e.right,r=e.top,n=t.left,l=t.top,p=e.right,c=e.bottom,h=t.left,k=t.bottom):(a=t.right,r=t.top,n=e.left,l=e.top,p=t.right,c=t.bottom,h=e.left,k=e.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${a}px`),this.style.setProperty("--hover-bridge-top-left-y",`${r}px`),this.style.setProperty("--hover-bridge-top-right-x",`${n}px`),this.style.setProperty("--hover-bridge-top-right-y",`${l}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${p}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${c}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${h}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${k}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has("active")&&(this.active?this.start():this.stop()),e.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){const e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchor instanceof Element||ra(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){!this.anchorEl||!this.active||(this.cleanup=Yi(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>e())):e()})}reposition(){if(!this.active||!this.anchorEl)return;const e=[Qi({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?e.push(Pt({apply:({rects:i})=>{const a=this.sync==="width"||this.sync==="both",r=this.sync==="height"||this.sync==="both";this.popup.style.width=a?`${i.reference.width}px`:"",this.popup.style.height=r?`${i.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&e.push(Ji({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&e.push(eo({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?e.push(Pt({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:i,availableHeight:a})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${a}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${i}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&e.push(to({element:this.arrowEl,padding:this.arrowPadding}));const t=this.strategy==="absolute"?i=>xt.getOffsetParent(i,io):xt.getOffsetParent;oo(this.anchorEl,this.popup,{placement:this.placement,middleware:e,strategy:this.strategy,platform:Pe(ge({},xt),{getOffsetParent:t})}).then(({x:i,y:a,middlewareData:r,placement:n})=>{const l=this.localize.dir()==="rtl",p={top:"bottom",right:"left",bottom:"top",left:"right"}[n.split("-")[0]];if(this.setAttribute("data-current-placement",n),Object.assign(this.popup.style,{left:`${i}px`,top:`${a}px`}),this.arrow){const c=r.arrow.x,h=r.arrow.y;let k="",V="",he="",N="";if(this.arrowPlacement==="start"){const Z=typeof c=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";k=typeof h=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",V=l?Z:"",N=l?"":Z}else if(this.arrowPlacement==="end"){const Z=typeof c=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";V=l?"":Z,N=l?Z:"",he=typeof h=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else this.arrowPlacement==="center"?(N=typeof c=="number"?"calc(50% - var(--arrow-size-diagonal))":"",k=typeof h=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(N=typeof c=="number"?`${c}px`:"",k=typeof h=="number"?`${h}px`:"");Object.assign(this.arrowEl.style,{top:k,right:V,bottom:he,left:N,[p]:"calc(var(--arrow-size-diagonal) * -1)"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("syn-reposition")}render(){return u`
    ...
    `}};T.styles=[z,sa];o([m(".popup")],T.prototype,"popup",2);o([m(".popup__arrow")],T.prototype,"arrowEl",2);o([s()],T.prototype,"anchor",2);o([s({type:Boolean,reflect:!0})],T.prototype,"active",2);o([s({reflect:!0})],T.prototype,"placement",2);o([s({reflect:!0})],T.prototype,"strategy",2);o([s({type:Number})],T.prototype,"distance",2);o([s({type:Number})],T.prototype,"skidding",2);o([s({type:Boolean})],T.prototype,"arrow",2);o([s({attribute:"arrow-placement"})],T.prototype,"arrowPlacement",2);o([s({attribute:"arrow-padding",type:Number})],T.prototype,"arrowPadding",2);o([s({type:Boolean})],T.prototype,"flip",2);o([s({attribute:"flip-fallback-placements",converter:{fromAttribute:e=>e.split(" ").map(t=>t.trim()).filter(t=>t!==""),toAttribute:e=>e.join(" ")}})],T.prototype,"flipFallbackPlacements",2);o([s({attribute:"flip-fallback-strategy"})],T.prototype,"flipFallbackStrategy",2);o([s({type:Object})],T.prototype,"flipBoundary",2);o([s({attribute:"flip-padding",type:Number})],T.prototype,"flipPadding",2);o([s({type:Boolean})],T.prototype,"shift",2);o([s({type:Object})],T.prototype,"shiftBoundary",2);o([s({attribute:"shift-padding",type:Number})],T.prototype,"shiftPadding",2);o([s({attribute:"auto-size"})],T.prototype,"autoSize",2);o([s()],T.prototype,"sync",2);o([s({type:Object})],T.prototype,"autoSizeBoundary",2);o([s({attribute:"auto-size-padding",type:Number})],T.prototype,"autoSizePadding",2);o([s({attribute:"hover-bridge",type:Boolean})],T.prototype,"hoverBridge",2);function U(e,t){return new Promise(i=>{function a(r){r.target===e&&(e.removeEventListener(t,a),i())}e.addEventListener(t,a)})}function q(e,t,i){return new Promise(a=>{if(i?.duration===1/0)throw new Error("Promise-based animations must be finite.");const r=e.animate(t,Pe(ge({},i),{duration:na()?0:i.duration}));r.addEventListener("cancel",a,{once:!0}),r.addEventListener("finish",a,{once:!0})})}function Jt(e){return e=e.toString().toLowerCase(),e.indexOf("ms")>-1?parseFloat(e):e.indexOf("s")>-1?parseFloat(e)*1e3:parseFloat(e)}function na(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function X(e){return Promise.all(e.getAnimations().map(t=>new Promise(i=>{t.cancel(),requestAnimationFrame(i)})))}function ei(e,t){return e.map(i=>Pe(ge({},i),{height:i.height==="auto"?`${t}px`:i.height}))}var wi=new Map,Tt=new WeakMap;function zi(e){return e??{keyframes:[],options:{duration:0}}}function ti(e,t){return t.toLowerCase()==="rtl"?{keyframes:e.rtlKeyframes||e.keyframes,options:e.options}:e}function $(e,t){wi.set(e,zi(t))}function dt(e,t,i){Tt.set(e,Pe(ge({},Tt.get(e)),{[t]:zi(i)}))}function F(e,t,i){const a=Tt.get(e);if(a?.[t])return ti(a[t],i.dir);const r=wi.get(t);return r?ti(r,i.dir):{keyframes:[],options:{duration:0}}}var ie=class extends b{constructor(){super(),this.localize=new B(this),this.content="",this.placement="top",this.disabled=!1,this.distance=13,this.open=!1,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleBlur=()=>{this.hasTrigger("focus")&&this.hide()},this.handleClick=()=>{this.hasTrigger("click")&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger("focus")&&this.show()},this.handleDocumentKeyDown=e=>{e.key==="Escape"&&(e.stopPropagation(),this.hide())},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){const e=Jt(getComputedStyle(this).getPropertyValue("--show-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.show(),e)}},this.handleMouseOut=()=>{if(this.hasTrigger("hover")){const e=Jt(getComputedStyle(this).getPropertyValue("--hide-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.hide(),e)}},this.addEventListener("blur",this.handleBlur,!0),this.addEventListener("focus",this.handleFocus,!0),this.addEventListener("click",this.handleClick),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this.closeWatcher)==null||e.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(e){return this.trigger.split(" ").includes(e)}async handleOpenChange(){var e,t;if(this.open){if(this.disabled)return;this.emit("syn-show"),"CloseWatcher"in window?((e=this.closeWatcher)==null||e.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide()}):document.addEventListener("keydown",this.handleDocumentKeyDown),await X(this.body),this.body.hidden=!1,this.popup.active=!0;const{keyframes:i,options:a}=F(this,"tooltip.show",{dir:this.localize.dir()});await q(this.popup.popup,i,a),this.popup.reposition(),this.emit("syn-after-show")}else{this.emit("syn-hide"),(t=this.closeWatcher)==null||t.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown),await X(this.body);const{keyframes:i,options:a}=F(this,"tooltip.hide",{dir:this.localize.dir()});await q(this.popup.popup,i,a),this.popup.active=!1,this.body.hidden=!0,this.emit("syn-after-hide")}}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,U(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,U(this,"syn-after-hide")}render(){return u`
      <syn-popup
        part="base"
        exportparts="
          popup:base__popup,
...
`,me=class extends b{constructor(){super(),this.checked=!1,this.hasFocus=!1,this.size="medium",this.disabled=!1,this.handleBlur=()=>{this.hasFocus=!1,this.emit("syn-blur")},this.handleClick=()=>{this.disabled||(this.checked=!0)},this.handleFocus=()=>{this.hasFocus=!0,this.emit("syn-focus")},this.addEventListener("blur",this.handleBlur),this.addEventListener("click",this.handleClick),this.addEventListener("focus",this.handleFocus)}connectedCallback(){super.connectedCallback(),this.setInitialAttributes()}setInitialAttributes(){this.setAttribute("role","radio"),this.setAttribute("tabindex","-1"),this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleCheckedChange(){this.setAttribute("aria-checked",this.checked?"true":"false"),this.setAttribute("tabindex",this.checked?"0":"-1")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}render(){return u`
    ...
    `}};me.styles=[z,_a,va];me.dependencies={"syn-icon":R};o([_()],me.prototype,"checked",2);o([_()],me.prototype,"hasFocus",2);o([s()],me.prototype,"value",2);o([s({reflect:!0})],me.prototype,"size",2);o([s({type:Boolean,reflect:!0})],me.prototype,"disabled",2);o([g("checked")],me.prototype,"handleCheckedChange",1);o([g("disabled",{waitUntilFirstUpdate:!0})],me.prototype,"handleDisabledChange",1);me=o([te("SynRadio")],me);var xa="syn-radio";me.define("syn-radio");w({displayName:"SynRadio",elementClass:me,events:{onSynBlur:"syn-blur",onSynFocus:"syn-focus"},react:x,tagName:xa});var wa=d`
  :host {
...
`,L,ae,tt,Ne,mt,Le,A,it,Mt,Si,Vt,$i,Oi,ht,at,st,Ai,Ii,je,Ei,Ti,Li,P=class extends b{constructor(){super(),ue(this,A),this.name="",this.label="",this.helpText="",this.disabled=!1,this.min=0,this.max=100,this.step=1,this.size="medium",this.tooltipPlacement="top",this.restrictMovement=!1,this.defaultValue="0",this.form="",this.hasSlotController=new K(this,"help-text","label","prefix","suffix","ticks"),this.formControlController=new ze(this,{assumeInteractionOn:["syn-change"]}),this.localize=new B(this),ue(this,L,[0]),ue(this,ae,new Map),ue(this,tt,!1),ue(this,Ne,""),ue(this,mt),ue(this,Le,[]),this.tooltipFormatter=this.localize.number.bind(this.localize)}set value(e){oe(this,L,e?e.split(" ").map(t=>+t).sort(Ee):[])}get value(){return y(this,L).slice().sort(Ee).join(" ")}set valueAsArray(e){const t=y(this,L);oe(this,L,Array.isArray(e)?e.slice().sort(Ee):e||[]),et(t,y(this,L))&&this.requestUpdate("value",t.join(" "))}get valueAsArray(){return[...y(this,L)].sort(Ee)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this==null?void 0:this.visibilityObserver)==null||e.disconnect()}firstUpdated(){this.visibilityObserver=new IntersectionObserver(e=>{const t=e.at(0);t&&t.isIntersecting&&t.target.checkVisibility()&&M(this,A,Li).call(this,t.boundingClientRect.height)},{root:this.ticks.parentElement}),this.visibilityObserver.observe(this.ticks),this.formControlController.updateValidity(),oe(this,Le,Array.from(y(this,L))),this.thumbs.forEach(e=>{const t=e.parentElement;t.updateComplete.then(()=>{const i=t.shadowRoot.querySelector(".tooltip__body");i?.setAttribute("aria-hidden","true")})})}willUpdate(e){super.willUpdate(e),this.min>this.max&&([this.min,this.max]=[this.max,this.min]),this.step>this.max-this.min&&(this.step=this.max-this.min),this.step<=0&&(this.step=1);const t=y(this,L).map(i=>{if(i<=this.min)return this.min;if(i>=this.max)return this.max;const a=this.min+this.step*Math.round((i-this.min)/this.step);return a>this.max?this.max:a});et(y(this,L),t)&&oe(this,L,t)}updated(e){super.updated(e);for(const t of this.thumbs){const i=+t.dataset.rangeId;y(this,ae).has(i)&&M(this,A,at).call(this,t,y(this,ae).get(i))}M(this,A,st).call(this)}focus(e){const t=this.thumbs.item(0);t?t.focus(e):super.focus(e)}checkValidity(){if(this.disabled)return!0;const e=!y(this,Ne);return e||this.formControlController.emitInvalidEvent(),e}reportValidity(){if(this.disabled)return!0;const e=this.validity.valid;return this.formControlController.setValidity(e),this.validationInput.hidden=!0,clearTimeout(y(this,mt)),e||(this.validationInput.hidden=!1,this.validationInput.reportValidity(),oe(this,mt,setTimeout(()=>{this.validationInput.hidden=!0},1e4))),e}setCustomValidity(e){oe(this,Ne,e),this.validationInput.setCustomValidity(e),this.formControlController.updateValidity()}getForm(){return this.formControlController.getForm()}get validity(){return y(this,Ne)?_i:ot}get validationMessage(){return y(this,Ne)}renderThumbs(e){const t=y(this,L).length>1;return y(this,ae).clear(),y(this,L).map((i,a)=>{const r=a+1;y(this,ae).set(r,i);const n=`thumb-${r}`;let l="",p="";return t?(p=e?`label aria-label-hidden ${n}`:`aria-label-hidden ${n}`,a===0?l=`${this.localize.term("rangeMin")} (${this.tooltipFormatter(i)})`:a===y(this,L).length-1?l=`${this.localize.term("rangeMax")} (${this.tooltipFormatter(i)})`:l=this.tooltipFormatter(i)):p=e?"label aria-label-hidden":"",u`
    ...
    `}};L=new WeakMap;ae=new WeakMap;tt=new WeakMap;Ne=new WeakMap;mt=new WeakMap;Le=new WeakMap;A=new WeakSet;it=function(){return this.localize.dir()==="rtl"};Mt=function(e,t=!0){if(this.disabled)return;const{clientX:i}=e,a=Array.from(this.thumbs),r=Ci(this.baseDiv,i,y(this,A,it)),n=this.step/(this.max-this.min),l=this.min+this.step*Math.round(r/n),p=a.reduce((V,he)=>{const N=y(this,ae).get(+he.dataset.rangeId),Z=y(this,ae).get(+V.dataset.rangeId),nt=Math.abs(N-l),Bt=Math.abs(Z-l);return nt===Bt?N<l?he:V:nt<Bt?he:V}),c=+p.dataset.rangeId;if(!c)return;y(this,ae).set(c,l),M(this,A,at).call(this,p,l);const h=y(this,L);oe(this,L,Array.from(y(this,ae).values())),M(this,A,st).call(this),et(h,y(this,L))&&(oe(this,Le,Array.from(y(this,L))),this.emit("syn-input"),this.emit("syn-change"));const k=new PointerEvent("pointerdown",e);t&&p.dispatchEvent(k)&&M(this,A,je).call(this,p)};Si=function(e){M(this,A,Mt).call(this,e,!1)};Vt=function(e,t){const i=this.valueAsArray,r=Array.from(this.thumbs).indexOf(e),n=i[r-1]||this.min,l=i[r+1]||this.max,p=t<n||t>l;return{finalValue:Math.max(n,Math.min(l,t)),isRestricted:p,nextValue:l,prevValue:n}};$i=async function(e){if(this.disabled)return;const t=e.target;M(this,A,je).call(this,t),t.dataset.pointerId&&t.releasePointerCapture(+t.dataset.pointerId),t.dataset.pointerId=e.pointerId.toString(),t.setPointerCapture(e.pointerId),t.classList.add("grabbed"),await t.parentElement.show()};Oi=function(e){if(this.disabled)return;const t=e.target,i=+t.dataset.rangeId;if(!y(this,ae).has(i)||(t.dataset.pointerId?+t.dataset.pointerId:null)!==e.pointerId)return;const r=Ci(this.baseDiv,e.clientX,y(this,A,it)),n=this.step/(this.max-this.min);let l=this.min+this.step*Math.round(r/n);if(this.emit("syn-move",{cancelable:!0,detail:{element:t,value:l}}).defaultPrevented)return;if(this.restrictMovement){const h=M(this,A,Vt).call(this,t,l);h.isRestricted?(l=h.finalValue,t.style.zIndex=(3+this.thumbs.length).toFixed(0)):t.style.zIndex="3"}y(this,ae).set(i,l),M(this,A,at).call(this,t,l);const c=y(this,L);oe(this,L,Array.from(y(this,ae).values())),M(this,A,st).call(this),et(c,y(this,L))&&this.emit("syn-input")};ht=async function(e){const t=e.target;!t.dataset.pointerId||e.pointerId!==+t.dataset.pointerId||(t.classList.remove("grabbed"),t.releasePointerCapture(e.pointerId),delete t.dataset.pointerId,et(y(this,Le),y(this,L))&&(oe(this,Le,Array.from(y(this,L))),this.emit("syn-change")),await t.parentElement.hide())};at=function(e,t){e.setAttribute("aria-valuenow",t.toString()),e.setAttribute("aria-valuetext",this.tooltipFormatter(t));const i=(t-this.min)/(this.max-this.min);e.style.insetInlineStart=`calc( ${100*i}% - var(--full-thumb-size) / 2 )`,M(this,A,je).call(this,e)};st=function(){const{activeTrack:e}=this;if(!e)return;if(this.min===this.max){e.style.insetInlineStart="0%",e.style.insetInlineEnd="0%";return}if(y(this,L).length===1){const r=getComputedStyle(this).getPropertyValue("--track-active-offset")||"0%",n=100*(y(this,L)[0]-this.min)/(this.max-this.min);e.style.insetInlineStart=`min(${r}, ${n}%)`,e.style.insetInlineEnd=`min(calc(100% - ${r}), calc(100% - ${n}%))`;return}const t=y(this,L).slice().sort(Ee),i=100*(t[0]-this.min)/(this.max-this.min),a=100*(t[t.length-1]-this.min)/(this.max-this.min);e.style.insetInlineStart=`${i}%`,e.style.insetInlineEnd=`calc(100% - ${a}%)`};Ai=function(e){const t=e.target,i=+t.dataset.rangeId,a=y(this,ae).get(i);if(a===void 0)return;let r=a;switch(e.key){case"ArrowUp":case"Up":r=Math.min(a+this.step,this.max);break;case"ArrowDown":case"Down":r=Math.max(a-this.step,this.min);break;case"ArrowLeft":case"Left":r=y(this,A,it)?Math.min(a+this.step,this.max):Math.max(a-this.step,this.min);break;case"ArrowRight":case"Right":r=y(this,A,it)?Math.max(a-this.step,this.min):Math.min(a+this.step,this.max);break;case"PageUp":r=Math.min(a+(this.max-this.min)/5,this.max);break;case"PageDown":r=Math.max(a-(this.max-this.min)/5,this.min);break;case"Home":r=this.min;break;case"End":r=this.max;break;default:return}if(r!==a){if(this.emit("syn-move",{cancelable:!0,detail:{element:t,value:r}}).defaultPrevented)return;if(this.restrictMovement){const l=M(this,A,Vt).call(this,t,r);l.isRestricted&&(r=l.finalValue)}M(this,A,at).call(this,t,r),y(this,ae).set(i,r),oe(this,L,Array.from(y(this,ae).values())),M(this,A,st).call(this),M(this,A,je).call(this,t),oe(this,Le,Array.from(y(this,L))),this.emit("syn-input"),this.emit("syn-change")}e.stopPropagation(),e.preventDefault()};Ii=function(e){var t;e.relatedTarget&&((t=this.shadowRoot)!=null&&t.contains(e.relatedTarget))||(this.emit("syn-blur"),oe(this,tt,!1))};je=function(e){if(this.tooltipPlacement==="none")return;const t=+e.dataset.rangeId;if(!y(this,ae).has(t))return;const i=y(this,ae).get(t),a=e.parentElement;a.content=this.tooltipFormatter(i)};Ei=function(e){var t;if(this.disabled)return;y(this,tt)||(oe(this,tt,!0),this.emit("syn-focus"));const i=e.target;(t=i?.dataset)!=null&&t.rangeId&&M(this,A,je).call(this,i)};Ti=function(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)};Li=function(e){var t,i,a,r;const n=this.hasSlotController.test("ticks"),l=this.hasSlotController.test("prefix"),p=this.hasSlotController.test("suffix");if(!n)return;let c=e||((i=(t=this.shadowRoot)==null?void 0:t.querySelector(".ticks"))==null?void 0:i.clientHeight);if(c){if(c+=2,c/=2,l){const h=(a=this.shadowRoot)==null?void 0:a.querySelector(".input__prefix");h.style.transform=`translateY(-${c}px)`}if(p){const h=(r=this.shadowRoot)==null?void 0:r.querySelector(".input__suffix");h.style.transform=`translateY(-${c}px)`}}};P.styles=[z,Se,$e,ka];P.dependencies={"syn-tooltip":ie};o([s()],P.prototype,"name",2);o([s()],P.prototype,"label",2);o([s({attribute:"help-text"})],P.prototype,"helpText",2);o([s({reflect:!0,type:Boolean})],P.prototype,"disabled",2);o([s({type:Number})],P.prototype,"min",2);o([s({type:Number})],P.prototype,"max",2);o([s({type:Number})],P.prototype,"step",2);o([s({reflect:!0})],P.prototype,"size",2);o([s({attribute:"tooltip-placement",type:String})],P.prototype,"tooltipPlacement",2);o([s({type:String})],P.prototype,"value",1);o([s({attribute:"restrict-movement",type:Boolean})],P.prototype,"restrictMovement",2);o([De()],P.prototype,"defaultValue",2);o([s({reflect:!0})],P.prototype,"form",2);o([s({attribute:!1})],P.prototype,"tooltipFormatter",2);o([m(".input__wrapper")],P.prototype,"baseDiv",2);o([m(".active-track")],P.prototype,"activeTrack",2);o([m(".ticks")],P.prototype,"ticks",2);o([ao(".thumb")],P.prototype,"thumbs",2);o([m(".range__validation-input")],P.prototype,"validationInput",2);P=o([te("SynRange")],P);var Ca="syn-range";P.define("syn-range");w({displayName:"SynRange",elementClass:P,events:{onSynBlur:"syn-blur",onSynChange:"syn-change",onSynFocus:"syn-focus",onSynInput:"syn-input",onSynInvalid:"syn-invalid",onSynMove:"syn-move"},react:x,tagName:Ca});var Sa=d`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`,Me=class extends b{constructor(){super(...arguments),this.localize=new B(this),this.value=0,this.label=""}updated(e){if(super.updated(e),e.has("value")){const t=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),i=2*Math.PI*t,a=i-this.value/100*i;this.indicatorOffset=`${a}px`}}render(){return u`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
    ...
    `}};Me.styles=[z,ms,hs];o([m(".progress-ring__indicator")],Me.prototype,"indicator",2);o([_()],Me.prototype,"indicatorOffset",2);o([s({type:Number,reflect:!0})],Me.prototype,"value",2);o([s()],Me.prototype,"label",2);var gs="syn-progress-ring";Me.define("syn-progress-ring");w({displayName:"SynProgressRing",elementClass:Me,events:{},react:x,tagName:gs});var Vi=d`
	/* stylelint-disable */
  :host {
    display: inline-block;
    position: relative;
