import{i as e}from"./preload-helper-xPQekRTU.js";import{D as t,Ht as n,It as r,T as i,d as a,f as o,g as s,u as c}from"./iframe-Bb0l_wZA.js";import{t as l}from"./button-BfprR77y.js";import{t as u}from"./card-3e_C04JC.js";import{a as d,i as f,n as p,o as m,r as h,t as g}from"./component-1GQqMfLf.js";import{t as _}from"./icon-button-uqbGqwNA.js";var v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N=e((()=>{r(),i(),u(),l(),_(),h(),a(),s(),{args:v,argTypes:y}=f(`syn-card`),{overrideArgs:b}=d(`syn-card`),{generateTemplate:x}=m(`syn-card`),S=({buttonText:e=`More info`,footerText:t=`Optional information`}={})=>`
  <footer slot="footer">
    <small>${t}</small>
    <nav>
