import{n as e}from"./chunk-DnJy8xQt.js";import{At as t,Ft as n,d as r,f as i,p as a,u as o}from"./iframe-CFxyVgYz.js";import{a as s,i as c,n as l,r as u,t as d}from"./component-u4nxi-rq.js";import{n as f,t as p}from"./styles-DSTfAhDj.js";var m,h,g,_,v,y,b,x,S,C,w;e((()=>{t(),u(),p(),r(),a(),{args:m,argTypes:h}=c(`syn-table-cell`),{overrideArgs:g}=s(`syn-table-cell`),_={args:g([{name:`default`,type:`slot`,value:`Cell content`}],m),argTypes:h,component:`syn-table-cell`,parameters:{chromatic:{modes:i},design:o(`41227-220286`),docs:{description:{component:l(`table`,`default`)}}},tags:[`Structure`,`Styles`],title:`Styles/syn-table-cell`},v={parameters:{controls:{disable:!1},docs:{description:{story:l(`table`,`default`)}}},render:e=>n`
  ...
  `},y={parameters:{docs:{description:{story:l(`table`,`header`)}}},render:()=>n`
    <table class="syn-table" style="width: 200px;">
      <thead>
        <tr>
  ...
  `},b={parameters:{docs:{description:{story:l(`table`,`alternating`)}}},render:()=>n`
    <table class="syn-table" style="width: 200px;">
      <tbody>
        <tr>
          <td class="syn-table-cell">Cell content</td>
  ...
  `},x={parameters:{docs:{description:{story:l(`table`,`border`)}}},render:()=>n`
    <table class="syn-table" style="width: 200px;">
      <tbody>
        <tr>
  ...
  `},S={parameters:{docs:{description:{story:l(`table`,`scroll`)}}},render:()=>n`
