import{x as a}from"./lit-element-DILkAbkc.js";import{g as i,o as d}from"./preview-BYgsCrTU.js";import{s as y,b as h,c as m}from"./component-Drk5uozy.js";import{r as u}from"./styles-DfWEx-ja.js";import"./index-B3ehnkiM.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon.component-DpyZZHQr.js";import"./directive-helpers-DbZfDV3x.js";import"./icon-button-DkgSBo0Q.js";import"./icon-D6b_kyKg.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-DU65Ag4u.js";const{args:C,argTypes:g}=y("syn-table"),{overrideArgs:f}=m("syn-table"),p="It is possible to achieve different table stylings (default, with border, alternating, ...) \n  either via multiple classes on the `table`, `td` and `th` elements or as a convenient alternative\n  as auto styling class, which is applied on a `table` element. These auto styling classes will\n  style the `td` and `th` elements correctly, without the need to apply further classes.\n  <br> <br>\n  **Note:** The auto styling table classes work for simple table layouts. For more complex ones or advanced use cases, the table cell classes should be used.\n",o=()=>`
  <thead>
    <tr>
