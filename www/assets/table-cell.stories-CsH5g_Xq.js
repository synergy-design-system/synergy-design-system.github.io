import{C as n,c as o,d as y}from"./iframe-ACTE7jbd.js";import{g as t,a as b,s as i,c as p}from"./component-Bhojntsz.js";import{r as h}from"./styles-QD0UEQpW.js";import"./preload-helper-PPVm8Dsz.js";import"./index-3hbeBem-.js";import"./_docs-C8VI7_RH.js";const{args:m,argTypes:g}=i("syn-table-cell"),{overrideArgs:u}=p("syn-table-cell"),x={args:u([{name:"default",type:"slot",value:"Cell content"}],m),argTypes:g,component:"syn-table-cell",parameters:{chromatic:{modes:n},design:y("19479-134433"),docs:{description:{component:t("table","default")}}},tags:["Structure","Styles"],title:"Styles/syn-table-cell"},e={parameters:{controls:{disable:!1},docs:{description:{story:t("table","default")}}},render:d=>o`
  ...
  `},c=b({Default:e,Header:l,Alternating:s,Border:r,ScrollingBehavior:a},250);e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
