import{g as G,o as u}from"./preview-BdvKKf_Z.js";import{x as t}from"./lit-element-DILkAbkc.js";import{p as E}from"./index-Dqg6DAZ7.js";import{s as _,a as O,g as s,b as F,c as R}from"./component-CvGABkbr.js";import"./index-B3ehnkiM.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon.component-BTqLLuW4.js";import"./directive-helpers-DbZfDV3x.js";import"./icon-button-B715Afvu.js";import"./icon-C05bciLq.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";var $=Object.freeze,q=Object.defineProperty,w=(e,n)=>$(q(e,"raw",{value:$(n||e.slice())})),S;const{args:j,argTypes:A}=_("syn-tab-group"),{overrideArgs:L}=R("syn-tab-group"),{generateTemplate:k}=O("syn-tab-group"),P=(e,n,{active:a=!1,closable:g=!1,disabled:v=!1}={})=>`<syn-tab slot="nav" panel="${e}" ${a?"active":""} ${v?"disabled":""} ${g?"closable":""}>${n}</syn-tab>`,T=(e,n,{active:a=!1,closable:g=!1,disabled:v=!1}={})=>u(P(e,n,{active:a,closable:g,disabled:v})),H=()=>[{panel:"general",props:{active:!0}},{panel:"custom"},{panel:"advanced"},{panel:"disabled",props:{disabled:!0}}].map(({panel:e,props:n})=>P(e,E(e),n)).join(`
