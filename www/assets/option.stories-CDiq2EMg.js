import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-DRz18Lsn.js";import{c as i,t as a}from"./lit-D4-0ovri.js";import{t as o}from"./icon-BbsmBxau.js";import{t as s}from"./select-BiMMRNnt.js";import{t as c}from"./option-5Sp0fHIr.js";import{a as l,i as u,n as d,o as f,r as p,t as m}from"./component-NnlguzJ1.js";import{n as h,t as g}from"./select-Bk9G7Kho.js";var _=t({Default:()=>C,Disabled:()=>w,PrefixAndSuffix:()=>T,Screenshot:()=>D,__namedExportsOrder:()=>O,default:()=>S}),v,y,b,x,S,C,w,T,E,D,O;function k(){return(k=e((()=>{c(),s(),o(),a(),g(),p(),r(),{args:v,argTypes:y}=u(`syn-option`),{overrideArgs:b}=l(`syn-option`),{generateTemplate:x}=f(`syn-option`),S={args:b([{name:`default`,type:`slot`,value:`Option 1`},{name:`value`,type:`attribute`,value:`Option_1`}],v),argTypes:y,component:`syn-option`,parameters:{docs:{chromatic:{modes:n},description:{component:d(`option`,`default`)},story:{height:`250px`}}},tags:[`Form`],title:`Components/syn-option`},C={parameters:{docs:{description:{story:d(`option`,`default`)}}},render:e=>i`
  ...
  `},D=m({ScreenshotStory:E},{afterRender:h(`syn-select`,!1),heightPx:400}),O=[`Default`,`Disabled`,`PrefixAndSuffix`,`Screenshot`],C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
  ...
  heightPx: 400
})`,...D.parameters?.docs?.source}}}})))()}export{k as n,_ as r,C as t};