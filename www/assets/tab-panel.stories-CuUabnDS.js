import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{a as t,d as n,o as r,s as i}from"./preview-DdzcclEm.js";import{c as a,t as o}from"./lit-BfcklOOD.js";import{a as s,i as c,n as l,o as u,r as d,t as f}from"./component-BjD7AuVi.js";import{n as p,t as m}from"./tab-panel-CnyaIXhI.js";import{t as h}from"./tab-B9S2KBI7.js";var g,_,v,y,b,x,S,C,w,T=e((()=>{m(),p(),h(),o(),d(),r(),n(),{args:g,argTypes:_}=c(`syn-tab-panel`),{overrideArgs:v}=s(`syn-tab-panel`),{generateTemplate:y}=u(`syn-tab-panel`),b=()=>a`<main class="synergy-replace">Replace this slot</main>`,x={args:v([{name:`default`,type:`slot`,value:b().strings.join(`
`)},{name:`name`,type:`attribute`,value:`tab1`}],g),argTypes:_,component:`syn-tab-panel`,parameters:{chromatic:{modes:i},design:t(`42207-340626`),docs:{description:{component:l(`tab-panel`,`default`)}}},tags:[`Navigation`],title:`Components/syn-tab-panel`},S={parameters:{docs:{description:{story:l(`tab-panel`,`default`)}}},render:e=>a`
    <syn-tab-group>
