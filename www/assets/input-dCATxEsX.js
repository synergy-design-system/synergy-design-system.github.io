...
`,et=(t,i,e={})=>{const{maximumFractionDigits:r,minimumFractionDigits:a,...l}=e,p=(i==="any"||!i?1:+i).toString().split(".")[1]?.length||0;let u,m;const w=typeof a=="number",S=typeof r=="number";return w&&!S?(u=a,m=a):S&&!w?(u=r,m=r):w&&S&&(u=Math.min(a,r),m=Math.max(a,r)),p>(u||0)&&(u=p),p>(m||0)&&(m=p),typeof u<"u"&&u>100&&(u=100),typeof m<"u"&&m>100&&(m=100),new Intl.NumberFormat("en-US",{maximumFractionDigits:m,minimumFractionDigits:u,useGrouping:!1,...l}).format(t)};var nt=Object.defineProperty,st=Object.getOwnPropertyDescriptor,I=t=>{throw TypeError(t)},s=(t,i,e,r)=>{for(var a=r>1?void 0:r?st(i,e):i,l=t.length-1,d;l>=0;l--)(d=t[l])&&(a=(r?d(i,e,a):d(a))||a);return r&&a&&nt(i,e,a),a},D=(t,i,e)=>i.has(t)||I("Cannot "+e),y=(t,i,e)=>(D(t,i,"read from private field"),e?e.call(t):i.get(t)),N=(t,i,e)=>i.has(t)?I("Cannot add the same private member more than once"):i instanceof WeakSet?i.add(t):i.set(t,e),C=(t,i,e,r)=>(D(t,i,"write to private field"),i.set(t,e),e),g=(t,i,e)=>(D(t,i,"access private method"),e),c,f,x,v;let n=class extends K{constructor(){super(...arguments),N(this,f),this.formControlController=new A(this,{assumeInteractionOn:["syn-blur","syn-input"]}),this.hasSlotController=new T(this,"help-text","label","prefix","suffix"),this.localize=new j(this),this.hasFocus=!1,this.title="",this.__numberInput=Object.assign(document.createElement("input"),{type:"number"}),this.__dateInput=Object.assign(document.createElement("input"),{type:"date"}),this.type="text",this.name="",this.value="",this.defaultValue="",this.size="medium",this.label="",this.helpText="",this.clearable=!1,this.disabled=!1,this.placeholder="",this.readonly=!1,this.passwordToggle=!1,this.passwordVisible=!1,this.noSpinButtons=!1,this.form="",this.required=!1,this.spellcheck=!0,N(this,c,_)}set numericStrategy(t){switch(typeof t){case"string":C(this,c,t==="modern"?V:_);break;case"object":C(this,c,Q(t));break;default:C(this,c,_)}}get numericStrategy(){return y(this,c)}get valueAsDate(){return this.__dateInput.type=this.type,this.__dateInput.value=this.value,this.input?.valueAsDate||this.__dateInput.valueAsDate}set valueAsDate(t){this.__dateInput.type=this.type,this.__dateInput.valueAsDate=t,this.value=this.__dateInput.value}get valueAsNumber(){return this.__numberInput.value=this.value,this.input?.valueAsNumber||this.__numberInput.valueAsNumber}set valueAsNumber(t){this.__numberInput.valueAsNumber=t,this.value=this.__numberInput.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleStep(){this.handleInput(),this.input.focus()}handleStepUp(){this.stepUp(),this.handleStep()}handleStepDown(){this.stepDown(),this.handleStep()}isDecrementDisabled(){if(this.disabled||this.readonly)return!0;if(this.min===void 0||this.min===null)return!1;const t=typeof this.min=="string"?parseFloat(this.min):this.min;return parseFloat(this.value)<=t}isIncrementDisabled(){if(this.disabled||this.readonly)return!0;if(this.max===void 0||this.max===null)return!1;const t=typeof this.max=="string"?parseFloat(this.max):this.max;return parseFloat(this.value)>=t}handleNumericStrategyAutoClamp(){const{valueAsNumber:t,max:i,min:e}=this;if(!y(this,c).autoClamp)return{eventObj:null,shouldClamp:!1,nextValue:t};const r=typeof e=="string"?parseFloat(e):e,a=typeof i=="string"?parseFloat(i):i;let l=t,d="";l<r?(l=r,d="min"):l>a&&(l=a,d="max");const p=d?{detail:{clampedTo:d,lastUserValue:t}}:null;return{eventObj:p,shouldClamp:!!p,nextValue:l}}handleChange(){if(this.type==="number"&&(g(this,f,v).call(this)||y(this,c).autoClamp)){const{eventObj:t,shouldClamp:i,nextValue:e}=this.handleNumericStrategyAutoClamp();let r=y(this,c).autoClamp?e:this.valueAsNumber;if(isNaN(r)){const{max:a,min:l}=this;a!=null?r=typeof a=="string"?parseFloat(a):+a:l!=null?r=typeof l=="string"?parseFloat(l):+l:r=0}this.value=g(this,f,v).call(this)?g(this,f,x).call(this,r):r.toString(),this.updateComplete.then(()=>{i&&t&&this.emit("syn-clamp",t),this.formControlController.updateValidity(),this.emit("syn-change")});return}this.value=this.input.value,this.emit("syn-change")}handleClearClick(t){t.preventDefault(),this.value!==""&&(this.value="",this.emit("syn-clear"),this.emit("syn-input"),this.emit("syn-change")),this.input.focus()}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleInput(){this.value=this.input.value,this.formControlController.updateValidity(),this.emit("syn-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}handleKeyDown(t){if(y(this,c).noStepAlign&&this.type==="number"){const{key:e}=t;if(e==="ArrowUp"||e==="ArrowDown"){t.preventDefault(),t.stopPropagation(),e==="ArrowUp"?this.handleStepUp():e==="ArrowDown"&&this.handleStepDown(),this.handleChange();return}}const i=t.metaKey||t.ctrlKey||t.shiftKey||t.altKey;t.key==="Enter"&&!i&&setTimeout(()=>{!t.defaultPrevented&&!t.isComposing&&this.formControlController.submit()})}handlePasswordToggle(){this.passwordVisible=!this.passwordVisible}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStepChange(){y(this,c).noStepValidation||(this.input.step=String(this.step),this.formControlController.updateValidity())}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(t){this.input.focus(t)}blur(){this.input.blur()}select(){this.input.select()}setSelectionRange(t,i,e="none"){this.input.setSelectionRange(t,i,e)}setRangeText(t,i,e,r="preserve"){const a=i??this.input.selectionStart,l=e??this.input.selectionEnd;this.input.setRangeText(t,a,l,r),this.value!==this.input.value&&(this.value=this.input.value)}showPicker(){"showPicker"in HTMLInputElement.prototype&&this.input.showPicker()}stepUp(){if(y(this,c).noStepAlign){const{max:t,step:i,valueAsNumber:e}=this,r=Number.isNaN(e)?0:e,a=typeof this.min=="string"?parseFloat(this.min):this.min,l=typeof t=="string"?parseFloat(t):t,d=typeof i>"u"||i===null||i==="any"?1:typeof i=="number"?i:parseFloat(i);let p=r+d;typeof l=="number"&&l<p?p=l:typeof a=="number"&&a>p&&(p=a);const u=g(this,f,v).call(this)?g(this,f,x).call(this,p):p.toString();this.input.value=u,this.value!==this.input.value&&(this.value=this.input.value);return}this.input.stepUp(),this.value!==this.input.value&&(this.value=this.input.value)}stepDown(){if(y(this,c).noStepAlign){const{min:t,max:i,step:e,valueAsNumber:r}=this,a=Number.isNaN(r)?0:r,l=typeof t=="string"?parseFloat(t):t,d=typeof i=="string"?parseFloat(i):i,p=typeof e>"u"||e===null||e==="any"?1:typeof e=="number"?e:parseFloat(e);let u=a-p;typeof l=="number"&&l>u?u=l:typeof d=="number"&&d<u&&(u=d);const m=g(this,f,v).call(this)?g(this,f,x).call(this,u):u.toString();this.input.value=m,this.value!==this.input.value&&(this.value=this.input.value);return}this.input.stepDown(),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("label"),i=this.hasSlotController.test("help-text"),e=this.hasSlotController.test("prefix"),r=this.hasSlotController.test("suffix"),a=this.label?!0:!!t,l=this.helpText?!0:!!i,p=this.clearable&&!this.disabled&&!this.readonly&&(typeof this.value=="number"||this.value.length>0);return b`
      <div
        part="form-control"
        ...
        <div part="form-control-input" class="form-control-input">
          ...
          >
            ...
            <input
              ...
              min=${h(this.min)}
              max=${h(this.max)}
              step=${h(y(this,c).noStepValidation?"any":this.step)}
              .value=${L(this.value)}
    ...
    `}};c=new WeakMap;f=new WeakSet;x=function(t){return et(t,this.step,{maximumFractionDigits:this.maxFractionDigits,minimumFractionDigits:this.minFractionDigits,...this.numberFormatterOptions})};v=function(){const{numberFormatterOptions:t,maxFractionDigits:i,minFractionDigits:e,step:r}=this,a=typeof i<"u"&&!Number.isNaN(i),l=typeof e<"u"&&!Number.isNaN(e);return a||l||typeof t=="object"?!0:((r==="any"||!r?1:+r).toString().split(".")[1]?.length||0)>0};n.styles=[H,W,tt,Z,it];n.dependencies={"syn-icon":q,"syn-divider":J};s([G(".input__control")],n.prototype,"input",2);s([R()],n.prototype,"hasFocus",2);s([o({reflect:!0})],n.prototype,"title",2);s([o({reflect:!0})],n.prototype,"type",2);s([o()],n.prototype,"name",2);s([o()],n.prototype,"value",2);s([P()],n.prototype,"defaultValue",2);s([o({reflect:!0})],n.prototype,"size",2);s([o()],n.prototype,"label",2);s([o({attribute:"help-text"})],n.prototype,"helpText",2);s([o({type:Boolean})],n.prototype,"clearable",2);s([o({type:Boolean,reflect:!0})],n.prototype,"disabled",2);s([o()],n.prototype,"placeholder",2);s([o({type:Boolean,reflect:!0})],n.prototype,"readonly",2);s([o({attribute:"password-toggle",type:Boolean})],n.prototype,"passwordToggle",2);s([o({attribute:"password-visible",type:Boolean})],n.prototype,"passwordVisible",2);s([o({attribute:"no-spin-buttons",type:Boolean})],n.prototype,"noSpinButtons",2);s([o({reflect:!0})],n.prototype,"form",2);s([o({type:Boolean,reflect:!0})],n.prototype,"required",2);s([o()],n.prototype,"pattern",2);s([o({type:Number})],n.prototype,"minlength",2);s([o({type:Number})],n.prototype,"maxlength",2);s([o()],n.prototype,"min",2);s([o()],n.prototype,"max",2);s([o()],n.prototype,"step",2);s([o()],n.prototype,"autocapitalize",2);s([o()],n.prototype,"autocorrect",2);s([o()],n.prototype,"autocomplete",2);s([o({type:Boolean})],n.prototype,"autofocus",2);s([o()],n.prototype,"enterkeyhint",2);s([o({type:Boolean,converter:{fromAttribute:t=>!(!t||t==="false"),toAttribute:t=>t?"true":"false"}})],n.prototype,"spellcheck",2);s([o()],n.prototype,"inputmode",2);s([o({attribute:!1,reflect:!1,type:Object})],n.prototype,"numberFormatterOptions",2);s([o({attribute:"min-fraction-digits",type:Number})],n.prototype,"minFractionDigits",2);s([o({attribute:"max-fraction-digits",type:Number})],n.prototype,"maxFractionDigits",2);s([o({attribute:"numeric-strategy",converter:{fromAttribute:t=>t==="modern"?V:_},type:Object})],n.prototype,"numericStrategy",1);s([k("disabled",{waitUntilFirstUpdate:!0})],n.prototype,"handleDisabledChange",1);s([k("step",{waitUntilFirstUpdate:!0})],n.prototype,"handleStepChange",1);s([k("value",{waitUntilFirstUpdate:!0})],n.prototype,"handleValueChange",1);n=s([X("SynInput")],n);n.define("syn-input");
