import{n as e}from"./chunk-DnJy8xQt.js";import{At as t,Bt as n,Ft as r}from"./iframe-CFxyVgYz.js";import{n as i,t as a}from"./class-map-B2P1DYC9.js";import{a as o,i as s,n as c,r as l,t as u}from"./form-BVa_zioF.js";import{r as d,t as f}from"./slot-uOU62xJ8.js";import{a as p,f as m,i as h,n as g,o as _,p as v,r as y,s as b,t as x,u as S}from"./synergy-element-DOjsnQEs.js";import{n as C,t as w}from"./watch-OXZPXmne.js";import{n as T,t as E}from"./icon.component-DSYib2bb.js";import{n as D,t as O}from"./decorator-CJ_bAnlW.js";import{n as k,t as A}from"./button-group.component-B8Iu0wL_.js";import{n as j,t as M}from"./form-control.styles-StPD7J_a.js";var N,P=e((()=>{t(),N=n`
  :host {
    display: block;
  }
...
`})),V,H,U=e((()=>{a(),t(),b(),w(),_(),g(),T(),B(),D(),h(),V=class extends x{static{this.styles=[p,z]}static{this.dependencies={"syn-icon":E}}constructor(){super(),this.checked=!1,this.hasFocus=!1,this.size=`medium`,this.disabled=!1,this.readonly=!1,this.handleBlur=()=>{this.hasFocus=!1,this.emit(`syn-blur`)},this.handleClick=()=>{if(this.readonly){this.focus();return}this.disabled||(this.checked=!0)},this.handleFocus=()=>{this.hasFocus=!0,this.emit(`syn-focus`)},this.addEventListener(`blur`,this.handleBlur),this.addEventListener(`click`,this.handleClick),this.addEventListener(`focus`,this.handleFocus)}connectedCallback(){super.connectedCallback(),this.setInitialAttributes()}setInitialAttributes(){this.setAttribute(`role`,`radio`),this.setAttribute(`tabindex`,`-1`),this.setAttribute(`aria-disabled`,this.disabled||this.readonly?`true`:`false`)}handleCheckedChange(){this.setAttribute(`aria-checked`,this.checked?`true`:`false`),this.setAttribute(`tabindex`,this.checked?`0`:`-1`)}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled||this.readonly?`true`:`false`)}render(){return r`
      ...
      >
        <span part="${`control${this.checked?` control--checked`:``}`}" class="radio__control">
          ${this.checked?r` <syn-icon part="checked-icon" class="radio__checked-icon" library="system" name="radio"></syn-icon> `:``}
        </span>
