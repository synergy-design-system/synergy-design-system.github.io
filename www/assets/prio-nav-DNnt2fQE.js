import{i as e}from"./preload-helper-xPQekRTU.js";import{h as t,t as n}from"./lit-BVDl_-fF.js";import{A as r,P as i}from"./iframe-BiSXA87W.js";import{_ as a,a as o,f as s,i as c,n as l,o as u,r as d,s as f,t as p}from"./synergy-element-DzBHqVed.js";import{n as m,t as h}from"./class-map-D5wKsNTm.js";import{n as g,t as _}from"./localize-CzgwcyM2.js";import{n as v,t as y}from"./icon.component-DpV7RVZ_.js";import{n as b,t as x}from"./menu.component-QXax9Ckk.js";import{n as S,t as C}from"./dropdown.component-BCx8fFbI.js";import{n as w,t as T}from"./nav-item.component-agj86njO.js";var E,D=e((()=>{n(),E=t`
  :host {
    display: block;
...
`})),O,k,A,j,M,N=e((()=>{O=e=>Array.from(e.assignedElements({flatten:!0})),k=e=>e.tagName.toLocaleLowerCase()===`syn-nav-item`||(e.getAttribute(`role`)??``)===`menuitem`,A=e=>e.filter(k),j=e=>{e.setAttribute(`horizontal`,`true`),e.removeAttribute(`slot`),e.removeAttribute(`tabindex`),e.dataset.originalRole?e.setAttribute(`role`,e.dataset.originalRole):e.removeAttribute(`role`)},M=e=>{e.removeAttribute(`horizontal`),e.setAttribute(`slot`,`menu`),e.setAttribute(`role`,`menuitem`)}})),P,F=e((()=>{h(),r(),f(),u(),l(),D(),S(),v(),b(),w(),_(),N(),c(),P=class extends p{constructor(...e){super(...e),this.localize=new g(this),this.itemPositionsCached=!1,this.amountOfNavItems=0,this.amountOfVisibleItems=0,this.hasItemsInDropdown=!1}static{this.styles=[o,E]}static{this.dependencies={"syn-dropdown":C,"syn-icon":y,"syn-menu":x,"syn-nav-item":T}}getSlottedNavItems(){let e=A(O(this.defaultSlot)),t=A(O(this.menuSlot));return e.concat(t)}cacheItemPositions(e){let{left:t}=this.horizontalNav.getBoundingClientRect();e.forEach(e=>{e.removeAttribute(`slot`);let{right:n}=e.getBoundingClientRect();e.dataset.right=(n-t).toString()}),this.itemPositionsCached=!0}handlePriorityMenu(){let e=this.getSlottedNavItems();this.itemPositionsCached||this.cacheItemPositions(e);let{width:t}=this.horizontalNav.getBoundingClientRect(),n=t-(this.priorityMenu.classList.contains(`priority-menu--hidden`)?0:this.priorityMenu.clientWidth),r,i=e.at(-1),a=e.map(e=>{let a=e===i?t:n,o=!!(r||parseFloat(e.dataset.right)>a);return o&&!r&&(r=parseFloat(e.dataset.right)),{isHidden:o,item:e}}),o=a.filter(({isHidden:e})=>!e).length,s=o===1&&e.length>1;a.forEach(({item:e,isHidden:t})=>{t||s?M(e):j(e)}),this.hasItemsInDropdown=o!==e.length,this.amountOfVisibleItems=s?0:o}renderPriorityMenu(){return i`
      <syn-dropdown
        class=${m({"priority-menu":!0,"priority-menu--has-visible-items":this.amountOfVisibleItems!==0,"priority-menu--hidden":!this.hasItemsInDropdown})}
        part="priority-menu"
      ...
      >
        <syn-nav-item class="priority-menu__nav-item" slot="trigger" horizontal part="priority-menu-nav-item">
          ...
          <span
            class=${m({"priority-menu__label":!0,"priority-menu__label--visible":this.amountOfVisibleItems===0})}
    ...
    `}},d([s(`slot:not([name])`)],P.prototype,`defaultSlot`,void 0),d([s(`slot[name=menu]`)],P.prototype,`menuSlot`,void 0),d([s(`.horizontal-nav`)],P.prototype,`horizontalNav`,void 0),d([s(`.priority-menu`)],P.prototype,`priorityMenu`,void 0),d([a()],P.prototype,`itemPositionsCached`,void 0),d([a()],P.prototype,`amountOfNavItems`,void 0),d([a()],P.prototype,`amountOfVisibleItems`,void 0),d([a()],P.prototype,`hasItemsInDropdown`,void 0)})),I=e((()=>{F(),F(),P.define(`syn-prio-nav`)}));export{I as t};