import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,d as r,f as i,g as a,u as o}from"./iframe-B3D1qQau.js";import{a as s,i as c,n as l,o as u,r as d,t as f}from"./component-KgXVaxds.js";import{n as p,t as m}from"./PaddingDecorator-CiWb1ftq.js";import{t as h}from"./icon-button-Cidl_kK5.js";var g,_,v,y,b,x,S,C,w,T,E,D,O,k;e((()=>{h(),t(),d(),r(),m(),a(),{args:g,argTypes:_}=c(`syn-icon-button`),{overrideArgs:v}=s(`syn-icon-button`),{generateTemplate:y}=u(`syn-icon-button`),b={args:v([{name:`name`,type:`attribute`,value:`wallpaper`},{name:`label`,type:`attribute`,value:`Wallpaper`},{name:`size`,type:`attribute`,value:`medium`}],g),argTypes:_,component:`syn-icon-button`,parameters:{chromatic:{modes:i},design:o(`41137-747935`),docs:{description:{component:l(`icon-button`,`default`)}}},tags:[`Form`,`Navigation`,`Icons`],title:`Components/syn-icon-button`},x={parameters:{controls:{disable:!1},docs:{description:{story:l(`icon-button`,`default`)}}},render:e=>y({args:e})},S={parameters:{docs:{description:{story:l(`icon-button`,`sizes`)}}},render:()=>n`
  ...
  `},C={parameters:{docs:{description:{story:`${l(`icon-button`,`color`)}`}}},render:()=>n`<syn-icon-button name="wallpaper" label="Wallpaper" color="neutral" size="medium"></syn-icon-button>
    <syn-icon-button name="wallpaper" label="Wallpaper" color="primary" size="medium"></syn-icon-button>`},w={parameters:{docs:{description:{story:l(`icon-button`,`link`)}}},render:()=>n`<syn-icon-button name="wallpaper" label="Wallpaper" color="neutral" href="https://example.com" target="_blank" size="medium"></syn-icon-button>`},T={parameters:{docs:{description:{story:l(`icon-button`,`disabled`)}}},render:()=>n`<syn-icon-button name="wallpaper" label="Wallpaper" color="neutral" disabled size="medium"></syn-icon-button>`},E={decorators:[p()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:l(`icon-button`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-icon-button`);t&&t.focus()},render:()=>n`<syn-icon-button name="wallpaper" label="Wallpaper" color="neutral" size="medium"></syn-icon-button>`},D={parameters:{docs:{description:{story:l(`icon-button`,`label`)}}},render:()=>n`
  <div class="grid">
...
}`,...T.parameters?.docs?.source},description:{story:`Wrap a tooltip around an icon button to provide contextual information to the user.`,...T.parameters?.docs?.description}}},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
