import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{d as n,n as r,s as i,t as a}from"./preview-C7vlOWDR.js";import{c as o,t as s}from"./lit-BfcklOOD.js";import{t as c}from"./react-DvlgmmzG.js";import{d as l,f as u,i as d,p as f,u as p}from"./blocks-DsL_5jcQ.js";import{t as m}from"./card-BMQLLQbS.js";import{n as h,r as g}from"./component-tvBHR92M.js";import{n as _,t as v}from"./taggedTemplateLiteral-C9cDEsPD.js";import{n as y,t as b}from"./menu-item-DqKGEFfx.js";import{t as x}from"./dropdown-5tVLRVSt.js";import{t as S}from"./tooltip-BeQRd0T9.js";import{t as C}from"./icon-button-zN4IA_fr.js";import{t as w}from"./file-C0EGrSy_.js";import{t as T}from"./prio-nav-C33S5sIh.js";import{t as E}from"./header-nNDGruvu.js";import{n as D,t as O}from"./localization-ZulL-hTo.js";var k,A,j,M,N,P,F,I;t((()=>{k=e(c(),1),f(),s(),a(),g(),n(),D(),T(),m(),x(),w(),E(),C(),y(),b(),S(),_(),j={parameters:{chromatic:{...r?.parameters?.chromatic,disableSnapshot:!1,modes:i},docs:{description:{component:h(`localization`,`default`,`templates`)},page:()=>k.createElement(k.Fragment,null,k.createElement(u,null),k.createElement(l,null),k.createElement(d,null),k.createElement(p,{title:``}))}},tags:[`i18n`,`localization`,`translations`],title:`Templates/Localization`},M=Object.values(O()),N=M.find(e=>e.$code===`de`)||M[0],P=M.map(e=>({code:e.$code,dir:e.$dir,name:e.$name})),F={parameters:{docs:{description:{story:h(`localization`,`dynamicallySetLocalizations`,`templates`)}},synergy:{customImports:M.filter(e=>e.$code===`en`||e.$code===`de`).map(e=>`https://esm.sh/@synergy-design-system/components@latest/dist/translations/${e.$code}.js`)}},render:()=>o(A||=v([`
