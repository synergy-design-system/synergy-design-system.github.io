import{i as e}from"./preload-helper-xPQekRTU.js";import{h as t,t as n}from"./lit-BVDl_-fF.js";import{M as r,O as i}from"./iframe-Cn79ht60.js";import{n as a,t as o}from"./class-map-BmdGqO7G.js";import{r as s,t as c}from"./slot-DgcqpP0-.js";import{i as l,l as u,n as d,r as f,s as p,t as m,y as h}from"./synergy-element-fkSPPZqT.js";import{n as g,t as _}from"./divider.component-BoEfIDSs.js";var v,y=e((()=>{n(),v=t`
  :host {
...
`})),b,x,S=e((()=>{o(),i(),p(),d(),s(),g(),y(),l(),b=(e,t)=>{e.disabled?e.dataset.originallyDisabled=`true`:delete e.dataset.originallyDisabled,t&&(e.disabled=!0)},x=class extends m{constructor(...e){super(...e),this.hasSlotController=new c(this,`[default]`,`prefix`,`suffix`,`label`),this.disabled=!1,this.label=``}static{this.styles=v}static{this.dependencies={"syn-divider":_}}enableObserver(){this.mutationObserver.observe(this,{attributeFilter:[`disabled`],childList:!0,subtree:!0})}connectedCallback(){super.connectedCallback(),this.mutationObserver=new MutationObserver(e=>{let t=e.filter(e=>e.target===this),n=e.filter(e=>e.target.matches(`syn-option`)),r=t.length>0||n.length>0;r&&this.mutationObserver.disconnect(),n.length>0&&n.forEach(e=>{b(e.target,this.disabled)}),t.length>0&&t.forEach(e=>{e.type===`attributes`&&this.assignedOptions.forEach(e=>{e.disabled=this.disabled?!0:!!e.dataset?.originallyDisabled}),e.type===`childList`&&e.addedNodes.forEach(e=>{e instanceof HTMLElement&&e.matches(`syn-option`)&&b(e,this.disabled)})}),r&&this.updateComplete.then(()=>{this.enableObserver()})}),this.enableObserver()}render(){let{disabled:e}=this,t=this.hasSlotController.test(`label`);return r`
    ...
    `}},f([u({selector:`syn-option`})],x.prototype,`assignedOptions`,void 0),f([h({reflect:!0,type:Boolean})],x.prototype,`disabled`,void 0),f([h()],x.prototype,`label`,void 0)})),C=e((()=>{S(),S(),x.define(`syn-optgroup`)}));export{C as t};