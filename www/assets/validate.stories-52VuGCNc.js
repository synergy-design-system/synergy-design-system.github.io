...
`,M=class extends m{constructor(...e){super(...e),this.controller=new AbortController,this.validationMessage=``,this.eagerFirstMount=!0,this.isInternalTriggeredInvalid=!1,this.isValid=!0,this.hasFocus=!1,this.variant=`native`,this.hideIcon=!1,this.on=``,this.customValidationMessage=``,this.eager=!1,this.internalRevalidate=e=>{e.currentTarget.validity?.valid&&(this.validationMessage=``)},this.handleInputFocus=()=>{this.hasFocus=!0},this.handleInputBlur=()=>{this.hasFocus=!1},this.validate=async e=>{if(x(e.type)&&this.variant===`native`&&this.isInternalTriggeredInvalid===!0){this.isInternalTriggeredInvalid=!1;return}x(e.type)&&this.variant!==`native`&&(e.preventDefault(),e.stopPropagation());let t=e.currentTarget;if(S(t)&&await t.updateComplete,this.isValid=t.validity?.valid,this.eager&&this.eagerFirstMount){this.eagerFirstMount=!1,this.setValidationMessage(t);return}!this.isValid&&!b(e.type)&&this.handleFocus(t),this.setValidationMessage(t),!b(e.type)&&this.variant===`native`&&this.updateComplete.then(()=>{this.isInternalTriggeredInvalid=!0,t.reportValidity()})}}static{this.styles=[ee,A]}static{this.dependencies={"syn-alert":ye,"syn-tooltip":xe}}handleListenerChange(){this.updateEvents()}async handleEagerChange(){if(this.eager){let e=this.getInput();await this.updateComplete,e?.reportValidity(),this.eagerFirstMount=!0}else this.eagerFirstMount=!1}handleCustomValidationMessageChange(){let e=this.getInput();e&&(this.setCustomValidationMessage(e),this.setValidationMessage(e))}getValidity(){return this.isValid}getInput(){return this.slottedChildren[0]||void 0}setAlertSize(){this.alertSize=T(this.getInput())}getUsedEventNames(){let e=this.getInput();if(!e)return[];let[...t]=C(this.on).filter(Boolean);return t.includes(`invalid`)||t.push(`invalid`),t.includes(`live`)&&(t.push(`input`),t.push(`blur`)),Array.from(new Set(t.filter(e=>e!==`live`).map(t=>w(e,t))))}updateEvents(){this.controller.abort(),this.controller=new AbortController;let e=this.getInput();if(!e)return;let t=this.getUsedEventNames();t.forEach(t=>{e.addEventListener(t,this.validate,{capture:x(t),signal:this.controller.signal})});let n=w(e,`change`);t.includes(n)||e.addEventListener(n,this.internalRevalidate,{signal:this.controller.signal});let r=w(e,`focus`),i=w(e,`blur`);e.addEventListener(r,this.handleInputFocus,{signal:this.controller.signal}),e.addEventListener(i,this.handleInputBlur,{signal:this.controller.signal})}getDisplayValidationMessage(){return this.customValidationMessage||this.validationMessage}setValidationMessage(e){let{customValidationMessage:t}=this,n=t||e.validationMessage;this.validationMessage=n}setCustomValidationMessage(e){e.setCustomValidity(this.customValidationMessage)}handleFocus(e){let t=document.activeElement,n=t.closest(`syn-validate`);!t.validity?.valid&&n||(e.scrollIntoView({block:`nearest`}),e.focus())}async firstUpdated(e){super.firstUpdated(e),this.updateEvents();let t=this.getInput();this.customValidationMessage&&(S(t)&&await t.updateComplete,t?.setCustomValidity(this.customValidationMessage)),this.eager&&(await this.updateComplete,this.isValid=t?.validity?.valid??!1,t?.reportValidity())}connectedCallback(){super.connectedCallback(),this.sizeObserver=new MutationObserver(e=>{let t=this.getInput();t&&e.filter(({target:e})=>e===t).every(e=>e.attributeName===`size`)&&this.setAlertSize()}),this.sizeObserver.observe(this,{attributeFilter:[`size`],attributes:!0,subtree:!0}),this.observer=new MutationObserver(e=>{let t=this.getInput();t&&(e.filter(({target:e})=>e===t).every(e=>{let t=e.target;return t.hasAttribute(`disabled`)||t.hasAttribute(`readonly`)})?(this.isValid=!0,this.validationMessage=``):(S(t)?t.updateComplete:Promise.resolve()).then(()=>{this.isValid=t?.validity?.valid??!1,this.validationMessage=t?.validationMessage??``}))}),this.observer.observe(this,{attributeFilter:[`disabled`,`readonly`],attributes:!0,subtree:!0})}disconnectedCallback(){super.disconnectedCallback(),this.controller.abort(),this?.observer?.disconnect(),this?.sizeObserver?.disconnect()}updated(e){if(super.updated(e),this.variant!==`tooltip`)return;let t=this.tooltipElement;if(!t)return;let n=this.getDisplayValidationMessage();!this.isValid&&n&&this.hasFocus?(t.content=n,t.show()):t.hide()}renderInlineValidation(){let e=this.getDisplayValidationMessage();return this.variant!==`inline`||!e?``:a`
    ...
    `}},f([ne()],M.prototype,`slottedChildren`,void 0),f([te(`syn-tooltip`)],M.prototype,`tooltipElement`,void 0),f([l()],M.prototype,`validationMessage`,void 0),f([l()],M.prototype,`eagerFirstMount`,void 0),f([l()],M.prototype,`isInternalTriggeredInvalid`,void 0),f([l()],M.prototype,`isValid`,void 0),f([l()],M.prototype,`alertSize`,void 0),f([l()],M.prototype,`hasFocus`,void 0),f([h({reflect:!0})],M.prototype,`variant`,void 0),f([h({attribute:`hide-icon`,reflect:!0,type:Boolean})],M.prototype,`hideIcon`,void 0),f([h({reflect:!0})],M.prototype,`on`,void 0),f([h({attribute:`custom-validation-message`,type:String})],M.prototype,`customValidationMessage`,void 0),f([h({type:Boolean})],M.prototype,`eager`,void 0),f([g(`on`,{waitUntilFirstUpdate:!0})],M.prototype,`handleListenerChange`,null),f([g(`eager`,{waitUntilFirstUpdate:!1})],M.prototype,`handleEagerChange`,null),f([g(`customValidationMessage`,{waitUntilFirstUpdate:!0})],M.prototype,`handleCustomValidationMessageChange`,null),M=f([le(`SynValidate`)],M),N=M})),we=e((()=>{P(),P(),N.define(`syn-validate`)})),F,Te=e((()=>{c(),p(),u(),F=class extends s{static{this.formAssociated=!0}static{this.shadowRootOptions={...s.shadowRootOptions,delegatesFocus:!0}}static{this.styles=o`
    /* stylelint-disable */
    :host {
      --item-width: 32px;
      display: block;
    ...
    /* stylelint-enable */
  `}constructor(){super(),this.name=``,this.value=``,this.required=!1,this.internals=this.attachInternals()}connectedCallback(){super.connectedCallback(),this.internals.setFormValue(this.value),this.updateComplete.then(()=>{this.validate()})}get willValidate(){return this.internals.willValidate}formDisabledCallback(e){this.shadowRoot.querySelectorAll(`input`).forEach(t=>t.disabled=e)}formResetCallback(){this.value=``,this.internals.setFormValue(``)}checkValidity(){return this.validate(),this.internals.checkValidity()}reportValidity(){return this.validate(),this.internals.reportValidity()}get validity(){return this.internals.validity}get validationMessage(){return this.internals.validationMessage}validate(){let e=this.value?.length>0&&this.value===`option3`;if(e)this.internals.setValidity({});else{let e=this.shadowRoot.querySelector(`input[value="option3"]`);this.internals.setValidity({customError:!0},`You know, that this is not correct.`,e||void 0)}return e}render(){return a`
      <div>
        ${[1,2,3,4,5].map(e=>a`
          <label>
            <input
    ...
    `}selectOption(e){this.value=e,this.internals.setFormValue(e),this.validate(),this.dispatchEvent(new Event(`change`,{bubbles:!0})),this.dispatchEvent(new Event(`input`,{bubbles:!0}))}},f([h({type:String})],F.prototype,`name`,void 0),f([h({type:String})],F.prototype,`value`,void 0),f([h({type:Boolean})],F.prototype,`required`,void 0),F=f([ie(`validate-demo-radio`)],F)})),Ee,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=e((()=>{c(),we(),Se(),ue(),me(),Te(),r(),n(),ge(),{args:I,argTypes:L}=fe(`syn-validate`),{overrideArgs:R}=de(`syn-validate`),{generateTemplate:z}=pe(`syn-validate`),B={args:R([{name:`default`,type:`slot`,value:`<syn-input
  label="Invalid input"
  type="email"
  value="team(at)synergy.com"
></syn-input>`}],I),argTypes:L,component:`syn-validate`,decorators:[(e,t)=>{let n=`${t.id}-validate-demo-form`;return a(Ee||=_e([`
        <form id=`,`>
          `,`
          <p>
        ...
        <\/script>
      `]),n,e(),n)}],parameters:{chromatic:{modes:i},design:t(`41310-284767`),docs:{description:{component:_(`validate`,`default`)}}},tags:[`Form`],title:`Components/syn-validate`},V={parameters:{controls:{disable:!1},docs:{description:{story:_(`validate`,`default`)}}},render:e=>z({args:e})},H={parameters:{docs:{description:{story:_(`validate`,`tooltip`)}}},render:()=>a`
    <syn-validate
    ...
    >
      <syn-input
        ...
        required
      ></syn-input>
    </syn-validate>`},U={parameters:{docs:{description:{story:_(`validate`,`inline`)}}},render:()=>a`
    <syn-validate
  ...
  `},W={parameters:{docs:{description:{story:_(`validate`,`hide-icon`)}}},render:()=>a`
    <syn-validate
  ...
  `},G={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:_(`validate`,`size`)}}},render:()=>a`
  ...
  `},K={parameters:{docs:{description:{story:_(`validate`,`live`)}}},render:()=>a`
    <syn-validate
  ...
  `},q={parameters:{docs:{description:{story:_(`validate`,`custom-validation`)}}},render:()=>a`
    <syn-validate
  ...
  `},J={parameters:{docs:{description:{story:_(`validate`,`custom-form-field`)}}},render:()=>a`
  ...
  `},Y={parameters:{docs:{description:{story:_(`validate`,`custom-event-names`)}}},render:()=>a`
    <syn-validate
      class="validation-custom-validation"
      on="mouseover blur"
      variant="inline"
  ...
  `},X={parameters:{docs:{description:{story:_(`validate`,`eager`)}}},render:()=>a`
    <syn-validate eager variant="inline">
      <syn-input
...
`},Z=he({Default:V,TooltipVariant:H,InlineVariant:U,HideIcon:W,Live:K,CustomValidationMessage:q,CustomFormField:J,Eager:X},200),V.parameters={...V.parameters,docs:{...V.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
