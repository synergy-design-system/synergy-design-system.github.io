import{g as u}from"./preview-DszUOtWR.js";import{x as r}from"./lit-element-DILkAbkc.js";import{s as h,a as g,g as e,b as v,c as b}from"./component-CcTyadHm.js";import"./index-B3ehnkiM.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon.component-7B7zNgNb.js";import"./directive-helpers-DbZfDV3x.js";import"./icon-button-BDdQ3v9d.js";import"./icon-D0WpraVk.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-BOByFueo.js";var m=Object.freeze,f=Object.defineProperty,S=(n,y)=>m(f(n,"raw",{value:m(n.slice())})),d;const{args:A,argTypes:k}=h("syn-header"),{overrideArgs:w}=b("syn-header"),{generateTemplate:N}=g("syn-header"),O={args:w([{name:"label",type:"slot",value:'<span slot="label">App Name</span>'}],A),argTypes:k,component:"syn-header",parameters:{design:u("10540-8605"),docs:{description:{component:e("header","default")}}},title:"Components/syn-header"},a={parameters:{controls:{disable:!1},docs:{description:{story:e("header","default")}}},render:n=>N({args:n})},t={parameters:{docs:{description:{story:e("header","label")}}},render:()=>r`
