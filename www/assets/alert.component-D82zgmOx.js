import{s as g,a as u,g as m,b as h}from"./animation-registry-l4L8bmT6.js";import{b as w}from"./closeActiveElement-Bnbpk8Kw.js";import{e as p}from"./class-map-BazwZ-LN.js";import{H as _}from"./slot-9EVoRGQc.js";import{j as y,x as d}from"./iframe-CD1urOGO.js";import{L as z}from"./localize-Dh03wnLC.js";import{c as k,n as i,S as x}from"./synergy-element-CXOrYrDO.js";import{r as T}from"./icon.component-a8Mzi3bt.js";import{a as b}from"./query-DAIS6qJ0.js";import{w as v}from"./event-B0iVuGLD.js";import{w as f}from"./watch-CEsCE2EF.js";import{S}from"./icon-button.component-CYagfYrc.js";import{e as C}from"./decorator-DeP7ND_N.js";const A=y`
	/* stylelint-disable */
  :host {
    display: contents;
...
`;var H=Object.defineProperty,$=Object.getOwnPropertyDescriptor,r=(a,t,o,s)=>{for(var n=s>1?void 0:s?$(t,o):t,l=a.length-1,c;l>=0;l--)(c=a[l])&&(n=(s?c(t,o,n):c(n))||n);return s&&n&&H(t,o,n),n};let e=class extends x{constructor(){super(...arguments),this.hasSlotController=new _(this,"icon","suffix"),this.localize=new z(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.size="medium",this.remainingTime=this.duration}static get toastStack(){return this.currentToastStack||(this.currentToastStack=Object.assign(document.createElement("div"),{className:"syn-toast-stack"})),this.currentToastStack}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){this.countdownAnimation?.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),this.countdownAnimation?.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){const{countdownElement:a}=this,t="100%",o="0";this.countdownAnimation=a.animate([{width:t},{width:o}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.duration<1/0&&this.restartAutoHide(),await u(this.base),this.base.hidden=!1;const{keyframes:a,options:t}=m(this,"alert.show",{dir:this.localize.dir()});await h(this.base,a,t),this.emit("syn-after-show")}else{w(this),this.emit("syn-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await u(this.base);const{keyframes:a,options:t}=m(this,"alert.hide",{dir:this.localize.dir()});await h(this.base,a,t),this.base.hidden=!0,this.emit("syn-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,v(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,v(this,"syn-after-hide")}async toast(){return new Promise(a=>{this.handleCountdownChange(),e.toastStack.parentElement===null&&document.body.append(e.toastStack),e.toastStack.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("syn-after-hide",()=>{e.toastStack.removeChild(this),a(),e.toastStack.querySelector("syn-alert")===null&&e.toastStack.remove()},{once:!0})})}render(){return d`
    ...
    `}};e.styles=[k,A,I];e.dependencies={"syn-icon-button":S};r([b('[part~="base"]')],e.prototype,"base",2);r([b(".alert__countdown-elapsed")],e.prototype,"countdownElement",2);r([i({type:Boolean,reflect:!0})],e.prototype,"open",2);r([i({type:Boolean,reflect:!0})],e.prototype,"closable",2);r([i({reflect:!0})],e.prototype,"variant",2);r([i({type:Number})],e.prototype,"duration",2);r([i({reflect:!0})],e.prototype,"size",2);r([T()],e.prototype,"remainingTime",2);r([f("open",{waitUntilFirstUpdate:!0})],e.prototype,"handleOpenChange",1);r([f("duration")],e.prototype,"handleDurationChange",1);e=r([C("SynAlert")],e);g("alert.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});g("alert.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});export{e as S};
