import{k as n}from"./directive-helpers-CDT6qhDs.js";import{a as d}from"./ref-lLHsj5FH.js";import{s as i,g as y,c as h,d as m}from"./component-BhzPN1R2.js";import{r as u}from"./styles-MCkmFtTM.js";import"./if-defined-BaykDp1D.js";import"./chunk-L4EGOTBX-C9C4DwME.js";import"./entry-preview-D9TbQDUR.js";import"./index-DrFu-skq.js";import"./index-BQKi0hgw.js";import"./library-BZPO0bHa.js";import"./icon.component-BVnj2z6F.js";import"./index-CleY8y_P.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon-BLnpvAH5.js";const{args:C,argTypes:g}=i("syn-table"),{overrideArgs:f}=m("syn-table"),p="It is possible to achieve different table stylings (default, with border, alternating, ...) \n  either via multiple classes on the `table`, `td` and `th` elements or as a convenient alternative\n  as auto styling class, which is applied on a `table` element. These auto styling classes will\n  style the `td` and `th` elements correctly, without the need to apply further classes.\n  <br> <br>\n  **Note:** The auto styling table classes work for simple table layouts. For more complex ones or advanced use cases, the table cell classes should be used.\n",o=()=>`
  <thead>
    <tr>
...
`,O={args:f([{name:"default",type:"slot",value:o().trim()}],C),argTypes:g,component:"syn-table",parameters:{design:y("19479-134433"),docs:{description:{component:p}}},title:"Styles/syn-table"},s={parameters:{controls:{disable:!1},docs:{description:{story:p}}},render:c=>u(c,"table")},t={render:()=>n`
