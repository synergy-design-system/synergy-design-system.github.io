import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,d as r,f as i,g as a,u as o}from"./iframe-DJ0QlWgc.js";import{t as s}from"./button-Bu5NB7Z0.js";import{t as c}from"./icon-CiIVLsag.js";import{a as l,i as u,n as d,o as f,r as p,t as m}from"./component-CYGmWguq.js";import{n as h,t as g}from"./PaddingDecorator-D0C63Ei_.js";var _,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P;e((()=>{s(),c(),t(),p(),r(),g(),a(),{args:_,argTypes:v}=u(`syn-button`),{overrideArgs:y}=l(`syn-button`),{generateTemplate:b}=f(`syn-button`),x={args:y({name:`default`,type:`slot`,value:`Default`},_),argTypes:v,component:`syn-button`,parameters:{chromatic:{modes:i},design:o(`42076-167749`),docs:{description:{component:d(`button`,`default`)}}},tags:[`Form`,`Navigation`],title:`Components/syn-button`},S={parameters:{controls:{disable:!1},docs:{description:{story:d(`button`,`default`)}}},render:e=>b({args:e})},C={parameters:{docs:{description:{story:d(`button`,`variant`)}}},render:()=>n`
  ...
  `},w={parameters:{docs:{description:{story:d(`button`,`size`)}}},render:()=>n`
  ...
  `},T={decorators:[h()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:d(`button`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-button`);t&&t.focus()},render:()=>n`<syn-button>Default</syn-button>`},E={parameters:{docs:{description:{story:d(`button`,`link`)}}},render:()=>n`
    <div style="display: flex; flex-direction: row; gap: var(--syn-spacing-large);">
  ...
  `},D={parameters:{docs:{description:{story:d(`button`,`width`)}}},render:()=>n`
  ...
  `},O={parameters:{docs:{description:{story:d(`button`,`icon-only`)}}},render:()=>n`
  ...
  `},k={parameters:{docs:{description:{story:d(`button`,`prefix-suffix`)}}},render:()=>n`
    <div style="display: flex; flex-direction: column; gap: var(--syn-spacing-large);">
      <div style="display: flex; flex-direction: row; gap: var(--syn-spacing-large);">
        <syn-button size="small">
  ...
  `},A={parameters:{docs:{description:{story:d(`button`,`caret`)}}},render:()=>n`
    <div style="align-items: anchor-center; display: flex; flex-direction: row; gap: var(--syn-spacing-large);">
  ...
  `},j={parameters:{docs:{description:{story:d(`button`,`loading`)}}},render:()=>n`
    <div style="display: flex; flex-direction: row; gap: var(--syn-spacing-large);">
  ...
  `},M={parameters:{docs:{description:{story:d(`button`,`disabled`)}}},render:()=>n`
    <div style="display: flex; flex-direction: row; gap: var(--syn-spacing-large);">
