...
`;var I=Object.defineProperty,D=Object.getOwnPropertyDescriptor,c=(e,t,r,o)=>{for(var n=o>1?void 0:o?D(t,r):t,s=e.length-1,i;s>=0;s--)(i=e[s])&&(n=(o?i(t,r,n):i(n))||n);return o&&n&&I(t,r,n),n};class a extends w{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.size="inherit",this.color="currentColor",this.disabled=!1}static{this.styles=[x,U,k]}static{this.dependencies={"syn-icon":T}}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleClick(t){this.disabled&&(t.preventDefault(),t.stopPropagation())}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}render(){const t=!!this.href,r=t?v`a`:v`button`;return P`
    ...
    `}}c([R(".icon-button")],a.prototype,"button",2);c([E()],a.prototype,"hasFocus",2);c([b()],a.prototype,"name",2);c([b()],a.prototype,"library",2);c([b()],a.prototype,"src",2);c([b()],a.prototype,"href",2);c([b()],a.prototype,"target",2);c([b()],a.prototype,"download",2);c([b()],a.prototype,"label",2);c([b({reflect:!0})],a.prototype,"size",2);c([b({reflect:!0})],a.prototype,"color",2);c([b({type:Boolean,reflect:!0})],a.prototype,"disabled",2);a.define("syn-icon-button");export{a as S,R as a,j as b,C as c,O as e,V as i,P as n,d as o,v as s,A as t};
