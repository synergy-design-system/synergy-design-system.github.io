import{i as c,x as u}from"./directive-helpers-DGrfjhaU.js";import{a as y}from"./static-gmWA-8Kq.js";import{L as f}from"./localize-CatY2peN.js";import{n as d}from"./property-BGzwfL48.js";import{a as l}from"./library-6WV9-XO2.js";import{a as m}from"./query-DAIS6qJ0.js";import{w as h}from"./watch-CEsCE2EF.js";import{S as g,c as v}from"./component.styles-Do19GEOY.js";import{S as b}from"./icon.component-CmAczTJK.js";const _=c`
	/* stylelint-disable */
  :host {
    display: block;
    user-select: none;
...
`,z=(a,e)=>{const i=e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),t=new RegExp(i,"g");return a.replace(t,"_")};var w=Object.defineProperty,S=Object.getOwnPropertyDescriptor,n=(a,e,i,t)=>{for(var s=t>1?void 0:t?S(e,i):e,r=a.length-1,p;r>=0;r--)(p=a[r])&&(s=(t?p(e,i,s):p(s))||s);return t&&s&&w(e,i,s),s};class o extends g{constructor(){super(...arguments),this.localize=new f(this),this.isInitialized=!1,this.delimiter=" ",this.current=!1,this.selected=!1,this.hasHover=!1,this.value="",this.disabled=!1}static{this.styles=[v,_,x]}static{this.dependencies={"syn-icon":b}}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.setAttribute("aria-selected","false")}handleDefaultSlotChange(){this.isInitialized?(customElements.whenDefined("syn-combobox").then(()=>{const e=this.closest("syn-combobox");e&&e.handleDefaultSlotChange()}),customElements.whenDefined("syn-select").then(()=>{const e=this.closest("syn-select");e&&e.handleDefaultSlotChange()})):this.isInitialized=!0}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleValueChange(){if(typeof this.value=="number")return;typeof this.value!="string"&&(this.value=String(this.value));const{delimiter:e}=this;this.value.includes(e)&&(console.error(`Option values cannot include "${e}". All occurrences of "${e}" have been replaced with "_".`,this),this.value=z(this.value,this.delimiter))}getTextLabel(){const e=this.childNodes;let i="";return[...e].forEach(t=>{t.nodeType===Node.ELEMENT_NODE&&(t.hasAttribute("slot")||(i+=t.textContent)),t.nodeType===Node.TEXT_NODE&&(i+=t.textContent)}),i.trim()}render(){return u`
    ...
    `}}n([m(".option__label")],o.prototype,"defaultSlot",2);n([l()],o.prototype,"delimiter",2);n([l()],o.prototype,"current",2);n([l()],o.prototype,"selected",2);n([l()],o.prototype,"hasHover",2);n([d({reflect:!0})],o.prototype,"value",2);n([d({type:Boolean,reflect:!0})],o.prototype,"disabled",2);n([h("disabled")],o.prototype,"handleDisabledChange",1);n([h("selected")],o.prototype,"handleSelectedChange",1);n([h("value")],o.prototype,"handleValueChange",1);const I=c`
  /**
...
`;o.define("syn-option");export{o as S,I as s};
