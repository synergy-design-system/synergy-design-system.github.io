import{n as e}from"./chunk-DnJy8xQt.js";import{At as t,C as n,Ft as r,S as i,d as a,f as o,p as s,u as c}from"./iframe-CFxyVgYz.js";import{t as l}from"./button-BmPxXsuW.js";import{t as u}from"./card-BGAuJEx5.js";import{a as d,i as f,n as p,o as m,r as h,t as g}from"./component-u4nxi-rq.js";import{t as _}from"./icon-button-CONno8nV.js";var v,y,b,x,S,C,w,T,E,D,O,k,A,j,M;e((()=>{t(),i(),u(),l(),_(),h(),a(),s(),{args:v,argTypes:y}=f(`syn-card`),{overrideArgs:b}=d(`syn-card`),{generateTemplate:x}=m(`syn-card`),S=({buttonText:e=`More info`,footerText:t=`Optional information`}={})=>`
  <footer slot="footer">
    <small>${t}</small>
    <nav>
