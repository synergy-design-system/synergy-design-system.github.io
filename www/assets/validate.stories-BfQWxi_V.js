...
></syn-input>`}],I),argTypes:L,component:`syn-validate`,decorators:[(e,n)=>{let r=`${n.id}-validate-demo-form`;return t(Ee||=ye([`
        ...
        <\/script>
      `]),r,e(),r)}],parameters:{chromatic:{modes:te},design:re(`41310-284767`),docs:{description:{component:m(`validate`,`default`)}}},tags:[`Form`],title:`Components/syn-validate`},V={parameters:{controls:{disable:!1},docs:{description:{story:m(`validate`,`default`)}}},render:e=>z({args:e})},H={parameters:{docs:{description:{story:m(`validate`,`tooltip`)}}},render:()=>t`
    <syn-validate
