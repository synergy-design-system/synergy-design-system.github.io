var rn=Object.freeze,mi=Object.defineProperty;var ln=(a,e)=>rn(mi(a,"raw",{value:rn(e||a.slice())}));import{R as y,d as Dn,k as _,t as te,b as u,a as g,e as pt,f as fi}from"./if-defined-BaykDp1D.js";import{i as h,k as p,D as Nn,u as dn,Q as yi,R as bi}from"./directive-helpers-CDT6qhDs.js";import{h as In,$ as An,r as Mn,L as gi,F as mt,b as vi,o as wi,f as xi,c as ki,s as cn,d as _i,p as jt,e as Ti,g as Ci,a as Pn,k as Si,K as zi,j as Ei,i as $i,t as Oi}from"./ref-lLHsj5FH.js";import{s as Di}from"./chunk-L4EGOTBX-C9C4DwME.js";import"./entry-preview-D9TbQDUR.js";import{S as tt,d as pn,s as Ni}from"./index-COcX72G4.js";import"./index-7h80QhK_.js";import{n as r,a as b}from"./library-BZPO0bHa.js";import{a as v,c as w,w as m,S as ue}from"./icon.component-CK3HH8eP.js";import"./icon-EY_V5F7u.js";const Ii=h`
  :host {
    display: block;
  }
...
`;var Na=Object.defineProperty,Zt=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Na(e,t,i),i};class Ot extends v{constructor(){super(...arguments),this.localize=new j(this),this.separatorDir=this.localize.dir(),this.label=""}static{this.styles=[w,Oa,Da]}static{this.dependencies={"syn-icon":ue}}getSeparator(){const t=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[t,...t.querySelectorAll("[id]")].forEach(n=>n.removeAttribute("id")),t.setAttribute("data-default",""),t.slot="separator",t}handleSlotChange(){const e=[...this.defaultSlot.assignedElements({flatten:!0})].filter(t=>t.tagName.toLowerCase()==="syn-breadcrumb-item");e.forEach((t,n)=>{const i=t.querySelector('[slot="separator"]');i===null?t.append(this.getSeparator()):i.hasAttribute("data-default")&&i.replaceWith(this.getSeparator()),n===e.length-1?t.setAttribute("aria-current","page"):t.removeAttribute("aria-current")})}render(){return this.separatorDir!==this.localize.dir()&&(this.separatorDir=this.localize.dir(),this.updateComplete.then(()=>this.handleSlotChange())),p`
    ...
    `}}Zt([u("slot")],Ot.prototype,"defaultSlot");Zt([u('slot[name="separator"]')],Ot.prototype,"separatorSlot");Zt([r()],Ot.prototype,"label");Ot.define("syn-breadcrumb");const Ia=h`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
`;var Do=Object.defineProperty,No=Object.getOwnPropertyDescriptor,ri=(a,e,t,n)=>{for(var i=n>1?void 0:n?No(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Do(e,t,i),i};class je extends v{constructor(){super(...arguments),this.vertical=!1}static{this.styles=[w,$o,Oo]}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}}ri([r({type:Boolean,reflect:!0})],je.prototype,"vertical",2);ri([m("vertical")],je.prototype,"handleVerticalChange",1);je.define("syn-divider");function kn(a){return a.charAt(0).toUpperCase()+a.slice(1)}const Io=h`
	/* stylelint-disable */
  :host {
    --size: 25rem;
    --header-spacing: var(--syn-spacing-large);
...
`;var Mo=Object.defineProperty,Po=Object.getOwnPropertyDescriptor,Ce=(a,e,t,n)=>{for(var i=n>1?void 0:n?Po(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Mo(e,t,i),i};class ye extends v{constructor(){super(...arguments),this.hasSlotController=new W(this,"footer"),this.localize=new j(this),this.modal=new si(this),this.open=!1,this.label="",this.placement="end",this.contained=!1,this.noHeader=!1,this.handleDocumentKeyDown=e=>{this.contained||e.key==="Escape"&&this.modal.isActive()&&this.open&&(e.stopImmediatePropagation(),this.requestClose("keyboard"))}}static{this.styles=[w,Io,Ao]}static{this.dependencies={"syn-icon-button":tt}}firstUpdated(){this.drawer.hidden=!this.open,this.open&&(this.addOpenListeners(),this.contained||(this.modal.activate(),ht(this)))}disconnectedCallback(){super.disconnectedCallback(),Ze(this),this.removeOpenListeners()}requestClose(e){if(this.emit("syn-request-close",{cancelable:!0,detail:{source:e}}).defaultPrevented){const n=I(this,"drawer.denyClose",{dir:this.localize.dir()});F(this.panel,n.keyframes,n.options);return}this.hide()}addOpenListeners(){"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.contained||(this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard"))):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){document.removeEventListener("keydown",this.handleDocumentKeyDown),this.closeWatcher?.destroy()}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.contained||(this.modal.activate(),ht(this));const e=this.querySelector("[autofocus]");e&&e.removeAttribute("autofocus"),await Promise.all([K(this.drawer),K(this.overlay)]),this.drawer.hidden=!1,requestAnimationFrame(()=>{this.emit("syn-initial-focus",{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute("autofocus","")});const t=I(this,`drawer.show${kn(this.placement)}`,{dir:this.localize.dir()}),n=I(this,"drawer.overlay.show",{dir:this.localize.dir()});await Promise.all([F(this.panel,t.keyframes,t.options),F(this.overlay,n.keyframes,n.options)]),this.emit("syn-after-show")}else{this.emit("syn-hide"),this.removeOpenListeners(),this.contained||(this.modal.deactivate(),Ze(this)),await Promise.all([K(this.drawer),K(this.overlay)]);const e=I(this,`drawer.hide${kn(this.placement)}`,{dir:this.localize.dir()}),t=I(this,"drawer.overlay.hide",{dir:this.localize.dir()});await Promise.all([F(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),F(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.drawer.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1;const n=this.originalTrigger;typeof n?.focus=="function"&&setTimeout(()=>n.focus()),this.emit("syn-after-hide")}}handleNoModalChange(){this.open&&!this.contained&&(this.modal.activate(),ht(this)),this.open&&this.contained&&(this.modal.deactivate(),Ze(this))}async show(){if(!this.open)return this.open=!0,U(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,U(this,"syn-after-hide")}render(){return p`
      <div
        part="base"
...
`;var ds=Object.defineProperty,li=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&ds(e,t,i),i};class Nt extends v{constructor(){super(...arguments),this.hasMenuItemsWithCheckmarks=!1,this.updateCheckMarksByChildPropChange=e=>{e.stopImmediatePropagation(),this.handleUpdateCheckmarks(this.getAllItems())}}static{this.styles=[w,rs,ls]}handleUpdateCheckmarks(e){this.hasMenuItemsWithCheckmarks=e.some(t=>t.type==="checkbox"||t.loading)}disconnectedCallback(){this.removeEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu"),this.addEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}handleClick(e){const t=["menuitem","menuitemcheckbox"],n=e.composedPath(),i=n.find(d=>t.includes(d?.getAttribute?.("role")||""));if(!i||n.find(d=>d?.getAttribute?.("role")==="menu")!==this)return;const l=i;l.type==="checkbox"&&(l.checked=!l.checked),this.emit("syn-select",{detail:{item:l}})}handleKeyDown(e){if(e.key==="Enter"||e.key===" "){const t=this.getCurrentItem();e.preventDefault(),e.stopPropagation(),t?.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(e.key)){const t=this.getAllItems(),n=this.getCurrentItem();let i=n?t.indexOf(n):0;t.length>0&&(e.preventDefault(),e.stopPropagation(),e.key==="ArrowDown"?i++:e.key==="ArrowUp"?i--:e.key==="Home"?i=0:e.key==="End"&&(i=t.length-1),i<0&&(i=t.length-1),i>t.length-1&&(i=0),this.setCurrentItem(t[i]),t[i].focus())}}handleMouseDown(e){const t=e.target;this.isMenuItem(t)&&this.setCurrentItem(t)}handleSlotChange(){const e=this.getAllItems();this.handleUpdateCheckmarks(e),e.length>0&&this.setCurrentItem(e[0])}isMenuItem(e){return e.tagName.toLowerCase()==="syn-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes(e.getAttribute("role")??"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>!(e.inert||!this.isMenuItem(e)))}getCurrentItem(){return this.getAllItems().find(e=>e.getAttribute("tabindex")==="0")}setCurrentItem(e){this.getAllItems().forEach(n=>{n.setAttribute("tabindex",n===e?"0":"-1")})}render(){return p`
      ...
      ></slot>
    `}}li([u("slot")],Nt.prototype,"defaultSlot");li([b()],Nt.prototype,"hasMenuItemsWithCheckmarks");Nt.define("syn-menu");const cs=h`
  /**
...
`;var ms=Object.defineProperty,fs=Object.getOwnPropertyDescriptor,It=(a,e,t,n)=>{for(var i=n>1?void 0:n?fs(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&ms(e,t,i),i};class vt extends v{constructor(){super(...arguments),this.hasSlotController=new W(this,"[default]","prefix","suffix","label"),this.disabled=!1,this.label=""}static{this.styles=us}static{this.dependencies={"syn-divider":je}}handleDisableOptions(){const{disabled:e}=this;this.defaultSlot.assignedElements().filter(t=>t.tagName.toLowerCase()==="syn-option").forEach(t=>{t.disabled=e})}handleDisabledChange(){this.handleDisableOptions()}render(){const{disabled:e}=this,t=this.hasSlotController.test("label"),n=this.label?!0:!!t;return _`
    ...
    `}}It([u("slot:not([name])")],vt.prototype,"defaultSlot",2);It([r({reflect:!0,type:Boolean})],vt.prototype,"disabled",2);It([r()],vt.prototype,"label",2);It([m("disabled",{waitUntilFirstUpdate:!0})],vt.prototype,"handleDisabledChange",1);vt.define("syn-optgroup");ve.define("syn-option");O.define("syn-popup");const ys=h`
  :host {
    display: block;
...
`,Tn=a=>Array.from(a.assignedElements({flatten:!0})),bs=a=>a.tagName.toLocaleLowerCase()==="syn-nav-item"||(a.getAttribute("role")??"")==="menuitem",Cn=a=>a.filter(bs),gs=a=>{a.setAttribute("horizontal","true"),a.removeAttribute("slot"),a.removeAttribute("tabindex"),a.dataset.originalRole?a.setAttribute("role",a.dataset.originalRole):a.removeAttribute("role")},vs=a=>{a.removeAttribute("horizontal"),a.setAttribute("slot","menu"),a.setAttribute("role","menuitem")};var ws=Object.defineProperty,Fe=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&ws(e,t,i),i};class Ne extends v{constructor(){super(...arguments),this.localize=new j(this),this.itemPositionsCached=!1,this.amountOfNavItems=0,this.amountOfVisibleItems=0,this.hasItemsInDropdown=!1}static{this.styles=[w,ys]}static{this.dependencies={"syn-dropdown":ae,"syn-icon":ue,"syn-menu":Nt,"syn-nav-item":J}}getSlottedNavItems(){const e=Cn(Tn(this.defaultSlot)),t=Cn(Tn(this.menuSlot));return e.concat(t)}cacheItemPositions(e){const{left:t}=this.horizontalNav.getBoundingClientRect();e.forEach(n=>{n.removeAttribute("slot");const{right:i}=n.getBoundingClientRect();n.dataset.right=(i-t).toString()}),this.itemPositionsCached=!0}handlePriorityMenu(){const e=this.getSlottedNavItems();this.itemPositionsCached||this.cacheItemPositions(e);const{width:t}=this.horizontalNav.getBoundingClientRect(),n=this.priorityMenu.classList.contains("priority-menu--hidden")?0:this.priorityMenu.clientWidth,i=t-n;let o;const s=e.at(-1),l=e.map(f=>{const k=f===s?t:i,q=!!(o||parseFloat(f.dataset.right)>k);return q&&!o&&(o=parseFloat(f.dataset.right)),{isHidden:q,item:f}}),d=l.filter(({isHidden:f})=>!f).length,c=d===1;l.forEach(({item:f,isHidden:k})=>{k||c?vs(f):gs(f)}),this.hasItemsInDropdown=d!==e.length,this.amountOfVisibleItems=c?0:d}renderPriorityMenu(){return _`
    ...
    `}}Fe([u("slot:not([name])")],Ne.prototype,"defaultSlot");Fe([u("slot[name=menu]")],Ne.prototype,"menuSlot");Fe([u(".horizontal-nav")],Ne.prototype,"horizontalNav");Fe([u(".priority-menu")],Ne.prototype,"priorityMenu");Fe([b()],Ne.prototype,"itemPositionsCached");Fe([b()],Ne.prototype,"amountOfNavItems");Fe([b()],Ne.prototype,"amountOfVisibleItems");Fe([b()],Ne.prototype,"hasItemsInDropdown");Ne.define("syn-prio-nav");const xs=h`
	/* stylelint-disable */
  :host {
    --height: 1rem;
...
`;var Es=Object.defineProperty,$s=Object.getOwnPropertyDescriptor,Ie=(a,e,t,n)=>{for(var i=n>1?void 0:n?$s(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Es(e,t,i),i};class Se extends v{constructor(){super(...arguments),this.hasSlotController=new W(this,"[default]","prefix","suffix"),this.hasFocus=!1,this.checked=!1,this.disabled=!1,this.size="medium",this.pill=!1}static{this.styles=[w,zs]}connectedCallback(){super.connectedCallback(),this.setAttribute("role","presentation")}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleClick(e){if(this.disabled){e.preventDefault(),e.stopPropagation();return}this.checked=!0}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}focus(e){this.input.focus(e)}blur(){this.input.blur()}render(){return _`
    ...
    `}}Ie([u(".button")],Se.prototype,"input",2);Ie([u(".hidden-input")],Se.prototype,"hiddenInput",2);Ie([b()],Se.prototype,"hasFocus",2);Ie([r({type:Boolean,reflect:!0})],Se.prototype,"checked",2);Ie([r()],Se.prototype,"value",2);Ie([r({type:Boolean,reflect:!0})],Se.prototype,"disabled",2);Ie([r({reflect:!0})],Se.prototype,"size",2);Ie([r({type:Boolean,reflect:!0})],Se.prototype,"pill",2);Ie([m("disabled",{waitUntilFirstUpdate:!0})],Se.prototype,"handleDisabledChange",1);Se.define("syn-radio-button");const Os=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`):n=e.innerHTML,n=n.replace(/<style><\/style>/g,"").replace(/<!-- preview-ignore:start -->[\s\S]*?<!-- preview-ignore:end -->/g,"").replace(/\/\/ preview-ignore:start[\s\S]*?\/\/ preview-ignore:end/g,"").replace(/<style>\n<\/style>/g,"").replace(/<script>\s*component = document\.querySelector\('(.+?)'\);\s*<\/script>/g,""),n}},sl=(a,e)=>{const t=pn?.components?.[a]?.[e]?.description?.value??"No Description",n=pn?.components?.[a]?.[e]?.note?.value??"",i=t.replace(/\n/g,"<br/>"),o=n.length>0?`
  ...
  > ${n.replace(/\n/g,"<br/>")}`:n;return`${i}${o}`},rl=(a,e=150)=>{const t=isNaN(e)?e:{heightPx:e},{afterRender:n="",additionalChromaticOptions:i={},heightPx:o=150,styleHeading:s={}}=t,l=Object.entries(s).map(([d,c])=>`${d}: ${c};`).join(" ");return{parameters:{chromatic:{...ui?.parameters?.chromatic,...i,disableSnapshot:!1},docs:{disable:!0}},render:(d,c)=>_`
      ${Object.entries(a).map(([f,k])=>{const q=k.name??Ni(f);return _`
