import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{_ as r,d as i,f as a,p as o}from"./iframe-BJUJk-mP.js";import{t as s}from"./button-DPE3w6y_.js";import{t as c}from"./icon-CWcZLnjq.js";import{a as l,i as u,n as d,o as f,r as p,t as m}from"./component-Dl_LLDeh.js";import{n as h,t as g}from"./decorators-C-ZhSsaX.js";import{t as _}from"./radio-group-FDjOtuDu.js";import{t as v}from"./radio-button-lVzeVtt5.js";var y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I=e((()=>{n(),s(),c(),_(),v(),g(),p(),a(),r(),{userEvent:y}=__STORYBOOK_MODULE_TEST__,{args:b,argTypes:x}=u(`syn-radio-button`),{overrideArgs:S}=l(`syn-radio-button`),{generateTemplate:C}=f(`syn-radio-button`),w={args:S([{name:`default`,type:`slot`,value:`Option 1`},{name:`value`,type:`attribute`,value:`1`}],b),argTypes:x,component:`syn-radio-button`,parameters:{chromatic:{modes:o},design:i(`49697-83768`),docs:{description:{component:d(`radio-button`,`default`)}}},tags:[`Form`],title:`Components/syn-radio-button`},T={parameters:{controls:{disable:!1},docs:{description:{story:d(`radio-button`,`default`)}}},render:e=>t`
  ...
  `},E={parameters:{docs:{description:{story:d(`radio-button`,`checked`)}}},render:()=>t`
    <syn-radio-group label="Select an option" name="b" value="2">
      <syn-radio-button value="1">Option 1</syn-radio-button>
      <syn-radio-button value="2">Option 2</syn-radio-button>
      <syn-radio-button value="3">Option 3</syn-radio-button>
    </syn-radio-group>
  `},D={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:d(`radio-button`,`focus`)}}},play:async({canvasElement:e})=>{let t=e.querySelector(`syn-radio-group`);t&&(await t.updateComplete,t.focus())},render:()=>t`
    <syn-radio-group label="Select an option" name="b" value="1">
      <syn-radio-button value="1">Option 1</syn-radio-button>
      <syn-radio-button value="2">Option 2</syn-radio-button>
      <syn-radio-button value="3">Option 3</syn-radio-button>
    </syn-radio-group>
  `},O={parameters:{docs:{description:{story:d(`radio-button`,`disabled`)}}},render:()=>t`
    <syn-radio-group label="Select an option" name="b" value="1">
      <syn-radio-button value="1" disabled>Option 1</syn-radio-button>
      <syn-radio-button value="2" disabled>Option 2</syn-radio-button>
      <syn-radio-button value="3">Option 3</syn-radio-button>
    </syn-radio-group>
  `},k={parameters:{docs:{description:{story:d(`radio-button`,`readonly`)}}},render:()=>t`
  ...
  `},A={parameters:{docs:{description:{story:d(`radio-button`,`sizes`)}}},render:()=>t`
    <div style="display: flex; flex-direction: column; gap: var(--syn-spacing-medium);">
  ...
  `},j={decorators:[h],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:d(`radio-button`,`invalid`)}}},play:async({canvasElement:e})=>{try{let t=e.querySelector(`syn-button`);t&&(await y.click(t),t.click(),document.activeElement?.blur())}catch(e){console.error(`Error in play function:`,e)}},render:()=>t`
    <syn-radio-group label="Select an option" name="a" help-text="This is required" required>
      <syn-radio-button value="1">Option 1</syn-radio-button>
      <syn-radio-button value="2">Option 2</syn-radio-button>
      <syn-radio-button value="3">Option 3</syn-radio-button>
    </syn-radio-group>
  `},M={parameters:{docs:{description:{story:d(`radio-button`,`prefix-suffix`)}}},render:()=>t`
    <syn-radio-group label="Select an option" name="b" value="1">
  ...
  `},N={parameters:{docs:{description:{story:d(`radio-button`,`buttons-with-icons`)}}},render:()=>t`
