import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{a as t,d as n,o as r,s as i}from"./preview-DXkhgu0Z.js";import{c as a,t as o}from"./lit-BfcklOOD.js";import{t as s}from"./icon-koM57tMi.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-B0n0ooCL.js";import{n as m,t as h}from"./menu-item-Y5fCk6TC.js";import{n as g,t as _}from"./breadcrumb-B5gZP-5B.js";import{t as v}from"./dropdown-CEqtLr3e.js";var y,b,x,S,C,w,T,E,D,O,k,A,j=e((()=>{o(),_(),g(),s(),v(),m(),h(),f(),r(),n(),{args:y,argTypes:b}=l(`syn-breadcrumb`),{overrideArgs:x}=c(`syn-breadcrumb`),{generateTemplate:S}=d(`syn-breadcrumb`),C={args:x([{name:`default`,type:`slot`,value:`
        <syn-breadcrumb-item>Breadcrumb Item</syn-breadcrumb-item>
        <syn-breadcrumb-item>Breadcrumb Item</syn-breadcrumb-item>
        <syn-breadcrumb-item>Breadcrumb Item</syn-breadcrumb-item>
        <syn-breadcrumb-item>Breadcrumb Item</syn-breadcrumb-item>
      `}],y),argTypes:b,component:`syn-breadcrumb`,parameters:{chromatic:{modes:i},design:t(`41137-748938`),docs:{description:{component:u(`breadcrumb`,`default`)}}},tags:[`Navigation`],title:`Components/syn-breadcrumb`},w={parameters:{controls:{disable:!1},docs:{description:{story:u(`breadcrumb`,`default`)}}},render:e=>S({args:e})},T={parameters:{docs:{description:{story:u(`breadcrumb`,`links`)}}},render:()=>a`
    <syn-breadcrumb>
  ...
  `},E={parameters:{docs:{description:{story:u(`breadcrumb`,`prefix`)}}},render:()=>a`
    <syn-breadcrumb>
      <syn-breadcrumb-item>
  ...
  `},D={parameters:{docs:{description:{story:u(`breadcrumb`,`suffix`)}}},render:()=>a`
    <syn-breadcrumb>
      <syn-breadcrumb-item>Breadcrumb Item</syn-breadcrumb-item>
      <syn-breadcrumb-item>Breadcrumb Item</syn-breadcrumb-item>
      <syn-breadcrumb-item>
  ...
  `},O={parameters:{docs:{description:{story:u(`breadcrumb`,`menu`)}}},render:()=>a`
