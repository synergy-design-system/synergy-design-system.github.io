import{i as e}from"./preload-helper-xPQekRTU.js";import{D as t,Ht as n,It as r,T as i,d as a,f as o,g as s,u as c}from"./iframe-BjJCO_Oc.js";import{t as l}from"./button-Cq0pTj4t.js";import{t as u}from"./icon-BS9OsfYG.js";import{a as d,i as f,n as p,o as m,r as h,t as g}from"./component-Bp0Gg8Fw.js";import{n as _,t as v}from"./taggedTemplateLiteral-pWa2IaV6.js";import{n as ee,t as te}from"./PaddingDecorator-Dc2-NRZc.js";import{n as ne,r as re,t as ie}from"./combobox-D3phmmE3.js";import{t as ae}from"./option-DF2ix79p.js";import{t as oe}from"./optgroup-Df3j7wTb.js";var y,se,ce,le,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=e((()=>{ie(),l(),u(),ae(),oe(),r(),i(),re(),h(),a(),te(),s(),_(),{userEvent:y}=__STORYBOOK_MODULE_TEST__,{args:b,argTypes:x}=f(`syn-combobox`),{overrideArgs:S}=d(`syn-combobox`),{generateTemplate:C}=m(`syn-combobox`),w={args:b,argTypes:x,component:`syn-combobox`,parameters:{chromatic:{modes:o},design:c(`42207-352063`),docs:{description:{component:p(`combobox`,`default`)},story:{height:`250px`}}},tags:[`Form`],title:`Components/syn-combobox`},T=[`Yellow`,`Light Green`,`Grey`,`Green`,`Blue`,`Red`,`Orange`,`Magenta`,`White`,`Purple`,`Pink`,`Black`,`Brown`].sort(),E=e=>`<syn-option value="${e.replaceAll(` `,`_`)}">${e}</syn-option>`,D=e=>t(E(e)),O=()=>T.map(E),k=()=>t(O().join(`
