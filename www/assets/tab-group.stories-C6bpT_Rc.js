import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{D as r,_ as i,d as a,f as o,k as s,p as c}from"./iframe-BJUJk-mP.js";import{i as l,n as u}from"./dist-B5ofSKxt.js";import{t as d}from"./icon-CWcZLnjq.js";import{a as f,i as p,n as m,o as h,r as g,t as _}from"./component-Dl_LLDeh.js";import{n as v,t as y}from"./taggedTemplateLiteral-pWa2IaV6.js";import{n as b,t as x}from"./tab-panel-DtS3NDjM.js";import{t as S}from"./tab-DNQ99uKG.js";var C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y=e((()=>{b(),S(),x(),d(),n(),u(),r(),g(),o(),i(),v(),{args:w,argTypes:T}=p(`syn-tab-group`),{overrideArgs:E}=f(`syn-tab-group`),{generateTemplate:D}=h(`syn-tab-group`),O=(e,t,{active:n=!1,closable:r=!1,disabled:i=!1}={})=>`<syn-tab slot="nav" panel="${e}" ${n?`active`:``} ${i?`disabled`:``} ${r?`closable`:``}>${t}</syn-tab>`,k=(e,t,{active:n=!1,closable:r=!1,disabled:i=!1}={})=>s(O(e,t,{active:n,closable:r,disabled:i})),A=()=>[{panel:`general`,props:{active:!0}},{panel:`custom`},{panel:`advanced`},{panel:`disabled`,props:{disabled:!0}}].map(({panel:e,props:t})=>O(e,l(e),t)).join(`
