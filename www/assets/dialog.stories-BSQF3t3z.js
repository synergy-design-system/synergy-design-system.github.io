import{n as e}from"./chunk-DnJy8xQt.js";import{E as t,Nt as n,Rt as r,T as ee,Ut as te,d as i,f as ne,g as re,u as a}from"./iframe-CkET12W3.js";import{n as o,t as s}from"./class-map-CFhFi09d.js";import{r as c,t as l}from"./slot-BUy-JBM2.js";import{n as u,t as ie}from"./if-defined-XNov7IIP.js";import{n as ae,t as oe}from"./localize-BO4uh8LG.js";import{a as d,i as se,m as f,n as ce,o as le,r as p,s as ue,t as m,u as h}from"./synergy-element-CyJGxssW.js";import{n as de,t as fe}from"./watch-0Lf6m-Da.js";import{t as pe}from"./button-CpKx43QA.js";import{a as me,i as he,n as g,o as ge,r as _e}from"./component-B473QWuz.js";import{n as ve,t as _}from"./taggedTemplateLiteral-DxWpUJWn.js";import{a as v,i as y,l as b,n as x,o as S,t as C}from"./animation-registry-8j1MdtzW.js";import{n as w,t as T}from"./event-BEe8X6yJ.js";import{n as E,t as D}from"./closeActiveElement-CUhkkin_.js";import{n as O,t as k}from"./icon-button.component-BbutBXAO.js";import{t as A}from"./icon-button-DTHJyf2q.js";import{i as j,n as M,t as N}from"./scroll-C4nzmthm.js";import{n as P,t as F}from"./modal-6bMLRjv2.js";import{t as ye}from"./input-90NTdGJt.js";var I,be=e((()=>{n(),I=te`
  :host {
    --width: 31rem;
...
`})),L,R=e((()=>{s(),n(),ie(),ue(),S(),E(),x(),c(),oe(),N(),T(),fe(),le(),P(),ce(),O(),be(),se(),L=class extends m{constructor(...e){super(...e),this.hasSlotController=new l(this,`footer`),this.localize=new ae(this),this.modal=new F(this),this.open=!1,this.label=``,this.noHeader=!1,this.handleDocumentKeyDown=e=>{e.key===`Escape`&&this.modal.isActive()&&this.open&&(e.stopPropagation(),this.requestClose(`keyboard`))}}static{this.styles=[d,I]}static{this.dependencies={"syn-icon-button":k}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),M(this))}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate(),j(this),this.removeOpenListeners()}requestClose(e){if(this.emit(`syn-request-close`,{cancelable:!0,detail:{source:e}}).defaultPrevented){let e=C(this,`dialog.denyClose`,{dir:this.localize.dir()});v(this.panel,e.keyframes,e.options);return}this.hide()}addOpenListeners(){`CloseWatcher`in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose(`keyboard`)):document.addEventListener(`keydown`,this.handleDocumentKeyDown)}removeOpenListeners(){this.closeWatcher?.destroy(),document.removeEventListener(`keydown`,this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit(`syn-show`),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),M(this);let e=this.querySelector(`[autofocus]`);e&&e.removeAttribute(`autofocus`),await Promise.all([b(this.dialog),b(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit(`syn-initial-focus`,{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute(`autofocus`,``)});let t=C(this,`dialog.show`,{dir:this.localize.dir()}),n=C(this,`dialog.overlay.show`,{dir:this.localize.dir()});await Promise.all([v(this.panel,t.keyframes,t.options),v(this.overlay,n.keyframes,n.options)]),this.emit(`syn-after-show`)}else{D(this),this.emit(`syn-hide`),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([b(this.dialog),b(this.overlay)]);let e=C(this,`dialog.hide`,{dir:this.localize.dir()}),t=C(this,`dialog.overlay.hide`,{dir:this.localize.dir()});await Promise.all([v(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),v(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,j(this);let n=this.originalTrigger;typeof n?.focus==`function`&&setTimeout(()=>n.focus()),this.emit(`syn-after-hide`)}}async show(){if(!this.open)return this.open=!0,w(this,`syn-after-show`)}async hide(){if(this.open)return this.open=!1,w(this,`syn-after-hide`)}render(){return r`
    ...
    `}},p([h(`.dialog`)],L.prototype,`dialog`,void 0),p([h(`.dialog__panel`)],L.prototype,`panel`,void 0),p([h(`.dialog__overlay`)],L.prototype,`overlay`,void 0),p([f({reflect:!0,type:Boolean})],L.prototype,`open`,void 0),p([f({reflect:!0})],L.prototype,`label`,void 0),p([f({attribute:`no-header`,reflect:!0,type:Boolean})],L.prototype,`noHeader`,void 0),p([de(`open`,{waitUntilFirstUpdate:!0})],L.prototype,`handleOpenChange`,null),y(`dialog.show`,{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:`ease`}}),y(`dialog.hide`,{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:`ease`}}),y(`dialog.denyClose`,{keyframes:[{scale:1},{scale:1.02},{scale:1}],options:{duration:250}}),y(`dialog.overlay.show`,{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}}),y(`dialog.overlay.hide`,{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}})})),xe=e((()=>{R(),R(),L.define(`syn-dialog`)})),Se,Ce,we,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=e((()=>{n(),ee(),xe(),pe(),A(),ye(),_e(),i(),re(),ve(),{args:z,argTypes:B}=he(`syn-dialog`),{overrideArgs:V}=me(`syn-dialog`),{generateTemplate:H}=ge(`syn-dialog`),U=e=>`
...
`]),e,e),G={args:V([{name:`open`,type:`attribute`,value:!0},{name:`label`,type:`attribute`,value:`Dialog`},{name:`default`,type:`slot`,value:`Lorem ipsum dolor sit amet, consectetur adipiscing elit.`},{name:`footer`,type:`slot`,value:U(`default-close-icon`)}],z),argTypes:B,component:`syn-dialog`,parameters:{chromatic:{disableSnapshot:!1,modes:ne},design:a(`42207-348565`),docs:{description:{component:g(`dialog`,`default`)},story:{height:`400px`}}},tags:[`Structure`],title:`Components/syn-dialog`},K={parameters:{chromatic:{disableSnapshot:!1},controls:{disable:!1},docs:{description:{story:g(`dialog`,`default`)}}},render:e=>r`
  ...
  `},Y={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:g(`dialog`,`header-actions`)}}},render:()=>r(Ce||=_([`
    <syn-dialog open label="Dialog">
    ...
    <\/script>
    `,`
  `]),t(U(`dialog-header-actions`)),W(`dialog-header-actions-story-opener`))},X={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:g(`dialog`,`prevent-closing`)}}},render:()=>r(we||=_([`
    ...
    <\/script>
    `,`
  `]),t(U(`dialog-deny-close-actions`)),W(`dialog-deny-close-story-opener`))},Z={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:g(`dialog`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-dialog`);t&&(t.open=!0)},render:()=>r`
