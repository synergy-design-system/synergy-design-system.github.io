import{n as e}from"./chunk-DnJy8xQt.js";import{At as t,Bt as n,Ft as r}from"./iframe-CFxyVgYz.js";import{n as i,t as a}from"./class-map-B2P1DYC9.js";import{r as o,t as s}from"./form-BVa_zioF.js";import{r as c,t as l}from"./slot-uOU62xJ8.js";import{n as u,t as d}from"./if-defined-Gus0LTOI.js";import{n as f,t as p}from"./localize-DnZL8qNz.js";import{a as m,f as h,i as g,n as _,o as v,p as y,r as b,s as x,t as S,u as C}from"./synergy-element-DOjsnQEs.js";import{n as w,t as T}from"./watch-OXZPXmne.js";import{n as E,t as D}from"./icon.component-DSYib2bb.js";import{n as O,t as k}from"./button.component-pHWtjAMf.js";import{n as A,t as j}from"./decorator-CJ_bAnlW.js";import{a as M,i as N,n as P,o as F,t as I}from"./animation-registry-DTpGRZQp.js";import{n as L,t as R}from"./default-value-fPW-L6MS.js";import{n as z,t as B}from"./form-control.styles-StPD7J_a.js";var V,H=e((()=>{t(),V=n`
  :host {
    display: block;
  }
...
`})),U,W,G=e((()=>{a(),x(),t(),d(),L(),T(),p(),o(),c(),v(),z(),_(),O(),E(),H(),P(),F(),A(),g(),U=class extends S{constructor(...e){super(...e),this.formControlController=new s(this,{assumeInteractionOn:[`syn-change`],value:e=>e.files}),this.hasSlotController=new l(this,`help-text`,`label`),this.localize=new f(this),this.userIsDragging=!1,this.name=``,this.defaultValue=``,this.size=`medium`,this.label=``,this.helpText=``,this.disabled=!1,this.readonly=!1,this.droparea=!1,this.accept=``,this.multiple=!1,this.webkitdirectory=!1,this.form=``,this.required=!1,this.hideValue=!1}static{this.styles=[m,B,V]}static{this.dependencies={"syn-button":k,"syn-icon":D}}set files(e){this.input&&(this.input.files=e)}get files(){return this.input?.files}set value(e){this.input&&(this.input.value=e)}get value(){return this.input?.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(e){if(this.droparea){this.dropareaWrapper?.focus(e);return}this.button?.focus(e)}blur(){if(this.droparea){this.dropareaWrapper?.blur();return}this.button?.blur()}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleFiles(e){if(!e){this.value=``;return}this.files=e}async handleTransferItems(e){if(!e)return this.value=``,new Promise((e,t)=>{t(Error(`No proper items found`))});let t=Array.from(e).map(e=>e.webkitGetAsEntry()).map(e=>this.getFilesFromEntry(e)),n=(await Promise.all(t)).flat(),r=new DataTransfer;return Array.from(n).forEach(e=>r.items.add(e)),r.files}async getFilesFromEntry(e){return e?e.isFile?new Promise((t,n)=>{e.file(e=>t([e]),n)}):e.isDirectory?new Promise((t,n)=>{e.createReader().readEntries(e=>{Promise.all(e.map(e=>this.getFilesFromEntry(e))).then(e=>{t(e.flat())}).catch(n)})}):[]:[]}handleClick(e){e.preventDefault(),this.input.click()}handleChange(e){e.preventDefault(),e.stopPropagation(),this.emit(`syn-input`),this.emit(`syn-change`)}handleDragOver(e){e.preventDefault(),e.stopPropagation(),!(this.disabled||this.readonly)&&(this.userIsDragging=!0)}handleDragLeave(e){e.preventDefault(),e.stopPropagation(),!(this.disabled||this.readonly)&&(this.userIsDragging=!1)}async handleDrop(e){if(e.preventDefault(),e.stopPropagation(),this.disabled||this.readonly||!e.dataTransfer)return;let t=await this.handleTransferItems(e.dataTransfer?.items);if(this.userIsDragging=!1,t){if(!this.multiple&&!this.webkitdirectory&&t.length>1){this.emit(`syn-error`);return}if(this.hasSlotController.test(`trigger`))this.handleFiles(t);else{let e=I(this.inputChosen,`file.text.disappear`,{dir:this.localize.dir()}),n=I(this.inputChosen,`file.text.appear`,{dir:this.localize.dir()});if(this.droparea){let e=I(this.dropareaIcon,`file.iconDrop`,{dir:this.localize.dir()});M(this.dropareaIcon,e.keyframes,e.options)}await M(this.inputChosen,e.keyframes,e.options),this.handleFiles(t),await M(this.inputChosen,n.keyframes,n.options)}this.input.dispatchEvent(new Event(`change`))}}handleFocus(){this.emit(`syn-focus`)}handleBlur(){this.emit(`syn-blur`)}renderValue(){let e=!1,t=this.localize.term(`numFilesSelected`,0,this.webkitdirectory);return this.files&&this.files?.length>0&&(e=!0,t=this.files.length===1?this.files[0].name:this.localize.term(`numFilesSelected`,this.files.length,this.webkitdirectory)),r`
    ...
    `}renderButton(){let e=this.localize.term(`fileButtonText`);return this.multiple&&(e=this.localize.term(`fileButtonTextMultiple`)),this.webkitdirectory&&(e=this.localize.term(`folderButtonText`)),r`
      <div
    ...
    `}render(){let e=this.label||!!this.hasSlotController.test(`label`),t=this.helpText?!0:!!this.hasSlotController.test(`help-text`),n=!!this.hasSlotController.test(`trigger`);return r`
      <div
        class=${i({"form-control":!0,"form-control--droparea":this.droparea,"form-control--has-help-text":t,"form-control--has-label":e,"form-control--large":this.size===`large`,"form-control--medium":this.size===`medium`,"form-control--small":this.size===`small`,"form-control--user-dragging":this.userIsDragging})}
    ...
    `}},b([h()],U.prototype,`userIsDragging`,void 0),b([y({type:Object})],U.prototype,`files`,null),b([y({type:String})],U.prototype,`name`,void 0),b([y({type:String})],U.prototype,`value`,null),b([R()],U.prototype,`defaultValue`,void 0),b([y({reflect:!0})],U.prototype,`size`,void 0),b([y()],U.prototype,`label`,void 0),b([y({attribute:`help-text`})],U.prototype,`helpText`,void 0),b([y({reflect:!0,type:Boolean})],U.prototype,`disabled`,void 0),b([y({reflect:!0,type:Boolean})],U.prototype,`readonly`,void 0),b([y({type:Boolean})],U.prototype,`droparea`,void 0),b([y({type:String})],U.prototype,`accept`,void 0),b([y({type:String})],U.prototype,`capture`,void 0),b([y({reflect:!0,type:Boolean})],U.prototype,`multiple`,void 0),b([y({reflect:!0,type:Boolean})],U.prototype,`webkitdirectory`,void 0),b([y({reflect:!0})],U.prototype,`form`,void 0),b([y({reflect:!0,type:Boolean})],U.prototype,`required`,void 0),b([y({attribute:`hide-value`,type:Boolean})],U.prototype,`hideValue`,void 0),b([C(`.input__control`)],U.prototype,`input`,void 0),b([C(`.button`)],U.prototype,`button`,void 0),b([C(`.droparea`)],U.prototype,`dropareaWrapper`,void 0),b([C(`.droparea__icon`)],U.prototype,`dropareaIcon`,void 0),b([C(`.input__value`)],U.prototype,`inputChosen`,void 0),b([w(`disabled`,{waitUntilFirstUpdate:!0})],U.prototype,`handleDisabledChange`,null),b([w(`value`,{waitUntilFirstUpdate:!0})],U.prototype,`handleValueChange`,null),U=b([j(`SynFile`)],U),W=U,N(`file.iconDrop`,{keyframes:[{scale:1},{scale:.7},{scale:1}],options:{duration:600,easing:`ease-out`}}),N(`file.text.disappear`,{keyframes:[{opacity:1},{opacity:0,transform:`translateY(-40%)`}],options:{duration:300,easing:`cubic-bezier(0.45, 1.45, 0.8, 1)`}}),N(`file.text.appear`,{keyframes:[{opacity:0,transform:`translateY(40%)`},{opacity:1}],options:{duration:300,easing:`cubic-bezier(0.45, 1.45, 0.8, 1)`}})})),K=e((()=>{G(),G(),W.define(`syn-file`)}));export{K as t};