import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{a as t,d as n,o as r,s as i}from"./preview-Lxgm_fxp.js";import{c as a,t as o}from"./lit-BfcklOOD.js";import{a as s,i as c,n as l,r as u,t as d}from"./component-BRYPxz3B.js";import{n as f,t as p}from"./styles-dWiGus8O.js";var m,h,g,_,v,y,b,x,S,C,w;e((()=>{o(),u(),p(),r(),n(),{args:m,argTypes:h}=c(`syn-table-cell`),{overrideArgs:g}=s(`syn-table-cell`),_={args:g([{name:`default`,type:`slot`,value:`Cell content`}],m),argTypes:h,component:`syn-table-cell`,parameters:{chromatic:{modes:i},design:t(`41227-220286`),docs:{description:{component:l(`table`,`default`)}}},tags:[`Structure`,`Styles`],title:`Styles/syn-table-cell`},v={parameters:{controls:{disable:!1},docs:{description:{story:l(`table`,`default`)}}},render:e=>a`
  ...
  `},y={parameters:{docs:{description:{story:l(`table`,`header`)}}},render:()=>a`
    <table class="syn-table" style="width: 200px;">
      <thead>
        <tr>
  ...
  `},b={parameters:{docs:{description:{story:l(`table`,`alternating`)}}},render:()=>a`
    <table class="syn-table" style="width: 200px;">
      <tbody>
        <tr>
          <td class="syn-table-cell">Cell content</td>
  ...
  `},x={parameters:{docs:{description:{story:l(`table`,`border`)}}},render:()=>a`
    <table class="syn-table" style="width: 200px;">
      <tbody>
        <tr>
  ...
  `},S={parameters:{docs:{description:{story:l(`table`,`scroll`)}}},render:()=>a`
