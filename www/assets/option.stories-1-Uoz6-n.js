import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{_ as r,d as i,f as a,p as o}from"./iframe-BJUJk-mP.js";import{t as s}from"./icon-CWcZLnjq.js";import{t as c}from"./select-CNdW9Oxd.js";import{t as l}from"./option-Hzaunzc2.js";import{a as u,i as d,n as f,o as p,r as m,t as h}from"./component-Dl_LLDeh.js";import{n as g,t as _}from"./select-CdKfjU3U.js";var v,y,b,x,S,C,w,T,E,D,O,k=e((()=>{l(),c(),s(),n(),_(),m(),a(),r(),{args:v,argTypes:y}=d(`syn-option`),{overrideArgs:b}=u(`syn-option`),{generateTemplate:x}=p(`syn-option`),S={args:b([{name:`default`,type:`slot`,value:`Option 1`},{name:`value`,type:`attribute`,value:`Option_1`}],v),argTypes:y,component:`syn-option`,parameters:{design:i(`41325-312743`),docs:{chromatic:{modes:o},description:{component:f(`option`,`default`)},story:{height:`250px`}}},tags:[`Form`],title:`Components/syn-option`},C={parameters:{docs:{description:{story:f(`option`,`default`)}}},render:e=>t`
    <syn-select label="Select one">
      ${x({args:e})}
      <syn-option value="Option_2">Option 2</syn-option>
      <syn-option value="Option_3">Option 3</syn-option>
    </syn-select>
  `},w={parameters:{docs:{description:{story:f(`option`,`disabled`)}}},render:()=>t`
  ...
  `},T={parameters:{docs:{description:{story:f(`option`,`prefix-suffix`)}}},render:()=>t`
  ...
  `},D=h({ScreenshotStory:E},{afterRender:g(`syn-select`,!1),heightPx:400}),C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
