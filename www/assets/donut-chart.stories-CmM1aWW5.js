import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{l as n,o as r}from"./preview-DRz18Lsn.js";import{c as i,t as a}from"./lit-D4-0ovri.js";import{d as o,f as s,i as c,p as l,u}from"./blocks-Tvq0jjN0.js";import{t as d}from"./react-Q1GcV6wX.js";import{c as f,l as p,n as m,o as h,r as g,s as _,t as v}from"./waitForFinishedCharts-DyYKSNey.js";import{n as y,t as b}from"./formatter-34eogR_H.js";import{n as x,r as S,t as C}from"./component-NnlguzJ1.js";import{t as w}from"./taggedTemplateLiteral-BZenJ0bZ.js";var T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K;function q(){return(q=t((()=>{T=e(d(),1),a(),l(),p(),_(),g(),y(),S(),n(),v(),window.ChartTokens=f,window.ComponentTokens=h,window.formatter=b,F={component:`syn-chart`,parameters:{chromatic:{delay:300,modes:r},docs:{description:{component:x(`chart`,`donut-series-default`)},page:()=>T.createElement(T.Fragment,null,T.createElement(s,null),T.createElement(o,null),T.createElement(c,null),T.createElement(u,{title:``}))}},play:m,tags:[`Charting`,`Data Visualization`],title:`Charts/Series Types/Donut Chart`},I={parameters:{docs:{description:{story:x(`chart`,`donut-series-preset`)}}},render:()=>i(E||=w([`
  ...
  `]))},W={parameters:{docs:{description:{story:x(`chart`,`donut-series-status`)}}},render:()=>i(P||=w([`
    ...
    <\/script>
  `]))},G=C({Default:I,CustomColors:L,LabelFormatting:R,LabelsWithIcons:z,Radius:B,AdjustCenterPosition:V,Insets:H,WithLegend:U,StatusDonut:W},700),K=[`Default`,`CustomColors`,`LabelFormatting`,`LabelsWithIcons`,`Radius`,`AdjustCenterPosition`,`Insets`,`WithLegend`,`StatusDonut`,`Screenshot`],I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
  ...
  WithLegend,
  StatusDonut
}, 700)`,...G.parameters?.docs?.source}}}})))()}q();export{V as AdjustCenterPosition,L as CustomColors,I as Default,H as Insets,R as LabelFormatting,z as LabelsWithIcons,B as Radius,G as Screenshot,W as StatusDonut,U as WithLegend,K as __namedExportsOrder,F as default};