import{j as p,l as lt,x as _,z as ct,n as V,u as dt}from"./iframe-CHA1MzIk.js";import{n as c}from"./synergy-element-pv_h4y-S.js";import{e as C}from"./class-map-CRqJTAdA.js";import{r as B}from"./icon.component-DYgg5wVc.js";import{t as ut}from"./event-options-CNZcgQm4.js";import{a as k}from"./query-DAIS6qJ0.js";import{o as Z}from"./query-assigned-elements-BQ-t-koE.js";import{o as f}from"./if-defined-BfuKNPpB.js";import{r as tt,L as ht}from"./index-DihgwUfS.js";var et=Object.defineProperty,bt=Object.defineProperties,pt=Object.getOwnPropertyDescriptor,vt=Object.getOwnPropertyDescriptors,O=Object.getOwnPropertySymbols,ot=Object.prototype.hasOwnProperty,rt=Object.prototype.propertyIsEnumerable,at=t=>{throw TypeError(t)},U=(t,e,o)=>e in t?et(t,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[e]=o,E=(t,e)=>{for(var o in e||(e={}))ot.call(e,o)&&U(t,o,e[o]);if(O)for(var o of O(e))rt.call(e,o)&&U(t,o,e[o]);return t},te=(t,e)=>bt(t,vt(e)),ee=(t,e)=>{var o={};for(var r in t)ot.call(t,r)&&e.indexOf(r)<0&&(o[r]=t[r]);if(t!=null&&O)for(var r of O(t))e.indexOf(r)<0&&rt.call(t,r)&&(o[r]=t[r]);return o},i=(t,e,o,r)=>{for(var a=r>1?void 0:r?pt(e,o):e,s=t.length-1,l;s>=0;s--)(l=t[s])&&(a=(r?l(e,o,a):l(a))||a);return r&&a&&et(e,o,a),a},W=(t,e,o)=>e.has(t)||at("Cannot "+o),v=(t,e,o)=>(W(t,e,"read from private field"),e.get(t)),$=(t,e,o)=>e.has(t)?at("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,o),H=(t,e,o,r)=>(W(t,e,"write to private field"),e.set(t,o),o),oe=(t,e,o)=>(W(t,e,"access private method"),o);function S(t,e){const o=E({waitUntilFirstUpdate:!1},e);return(r,a)=>{const{update:s}=r,l=Array.isArray(t)?t:[t];r.update=function(n){l.forEach(h=>{const b=h;if(n.has(b)){const m=n.get(b),T=this[b];m!==T&&(!o.waitUntilFirstUpdate||this.hasUpdated)&&this[a](m,T)}}),s.call(this,n)}}}var z=p`
	/* stylelint-disable */
  :host {
...
`,x=Symbol(),I=Symbol(),R,P=new Map,w=class extends y{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(t,e){var o;let r;if(e?.spriteSheet)return this.svg=_`<svg part="svg">
        <use part="use" href="${t}" width="100%" height="100%"></use>
      </svg>`,this.svg;if(this.library==="system"){if(!t)return x;r=new Response(t,{status:200})}else try{if(r=await fetch(t,{mode:"cors"}),!r.ok)return r.status===410?x:I}catch{return I}try{const a=document.createElement("div");a.innerHTML=await r.text();const s=a.firstElementChild;if(((o=s?.tagName)==null?void 0:o.toLowerCase())!=="svg")return x;R||(R=new DOMParser);const n=R.parseFromString(s.outerHTML,"text/html").body.querySelector("svg");return n?(n.part.add("svg"),document.adoptNode(n)):x}catch{return x}}connectedCallback(){super.connectedCallback(),xt(this)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),Ct(this)}getIconSource(){const t=q(this.library);return this.name&&t?{url:t.resolver(this.name),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){typeof this.label=="string"&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){var t;const{url:e,fromLibrary:o}=this.getIconSource(),r=o?q(this.library):void 0;if(!e){this.svg=null;return}let a=P.get(e);if(a||(a=this.resolveIcon(e,r),P.set(e,a)),!this.initialRender)return;const s=await a;if(s===I&&P.delete(e),e===this.getIconSource().url){if(ct(s)){if(this.svg=s,r){await this.updateComplete;const l=this.shadowRoot.querySelector("[part='svg']");typeof r.mutator=="function"&&l&&r.mutator(l)}return}switch(s){case I:case x:this.svg=null,this.emit("syn-error");break;default:this.svg=s.cloneNode(!0),(t=r?.mutator)==null||t.call(r,this.svg),this.emit("syn-load")}}}render(){return this.svg}};w.styles=[z,zt,kt];i([B()],w.prototype,"svg",2);i([c({reflect:!0})],w.prototype,"name",2);i([c()],w.prototype,"src",2);i([c()],w.prototype,"label",2);i([c({reflect:!0})],w.prototype,"library",2);i([S("label")],w.prototype,"handleLabelChange",1);i([S(["name","src","library"])],w.prototype,"setIcon",1);var N={autoClamp:!1,noStepAlign:!1,noStepValidation:!1},re={autoClamp:!0,noStepAlign:!0,noStepValidation:!0},ae=(t={})=>E(E({},N),t),Tt={delimiter:{SynSelect:" "},numericStrategy:{SynInput:N},size:{SynAccordion:"medium",SynButton:"medium",SynCheckbox:"medium",SynCombobox:"medium",SynDetails:"medium",SynFile:"medium",SynIconButton:"inherit",SynInput:"medium",SynRadio:"medium",SynRadioButton:"medium",SynRadioGroup:"medium",SynRange:"medium",SynSelect:"medium",SynSwitch:"medium",SynTag:"medium",SynTextarea:"medium"},variant:{SynAlert:"primary",SynBadge:"primary",SynButton:"outline",SynSideNav:"default",SynValidate:"native"}},$t={delimiter:{SynSelect:" "},numericStrategy:{SynInput:N},size:{SynAccordion:"medium",SynButton:"medium",SynCheckbox:"medium",SynCombobox:"medium",SynDetails:"medium",SynFile:"medium",SynIconButton:"inherit",SynInput:"medium",SynRadio:"medium",SynRadioButton:"medium",SynRadioGroup:"medium",SynRange:"medium",SynSelect:"medium",SynSwitch:"medium",SynTag:"medium",SynTextarea:"medium"},variant:{SynAlert:"primary",SynBadge:"primary",SynButton:"outline",SynSideNav:"default",SynValidate:"native"}},Y=new Map,K=new Set,Et=t=>{K.has(t)&&K.delete(t)},X=(t,e="default")=>{const o=e==="default"?Tt:$t;if(e==="default"){const a=Y.get(t);if(typeof a<"u")return a}const r=Object.entries(o).reduce((a,[s,l])=>{const n=l[t];return n&&(a[s]=n),a},{});return e==="default"&&Y.set(t,r),r};function Bt(t){return e=>{var o,r,a,s,l;return l=class extends e{constructor(...n){super(...n),$(this,o,!1),$(this,r,new Map),$(this,a,[]),$(this,s),this._isInitialized=!1,this._isInitialized=!0,H(this,s,X(t,"initial"))}get __originalDecoratedClassName(){return t}overrideGlobalSettings(n){n.forEach(h=>{v(this,r).has(h.attribute)&&(this[h.attribute]=h.newValue)})}disconnectedCallback(){super.disconnectedCallback(),Et(this)}requestUpdate(n,h,b){var m;super.requestUpdate(n,h,b),!(!this._isInitialized||v(this,o)||!n||!(n in v(this,s))||(m=v(this,a))!=null&&m.includes(n))&&v(this,a).push(n)}willUpdate(n){if(super.willUpdate(n),v(this,o))return;H(this,o,!0);const h=X(t);Object.entries(h).forEach(([b,m])=>{const T=this[b],nt=v(this,s)[b];T===nt&&!v(this,a).includes(b)&&(v(this,r).set(b,T),this[b]=m)}),v(this,r).size>0}},o=new WeakMap,r=new WeakMap,a=new WeakMap,s=new WeakMap,l}}var st={$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(t,e)=>`Go to slide ${t} of ${e}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:t=>t===0?"No options selected":t===1?"1 option selected":`${t} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:t=>`Slide ${t}`,toggleColorFormat:"Toggle color format",closeMenu:"Close menu",danger:"Danger",fileButtonText:"Choose file",fileButtonTextMultiple:"Choose files",fileDragDrop:"Drop or choose file",folderButtonText:"Choose folder",folderDragDrop:"Drop or choose folder",menu:"Menu",noResults:"No results found",notification:"Notification",numFilesSelected:(t,e)=>t===0?`No ${e?"folder":"files"} chosen`:`${t} files`,openMenu:"Open menu",rangeMax:"Maximum",rangeMin:"Minimum",sideNav:"Side navigation",sideNavHide:"Hide navigation",sideNavShow:"Show navigation",success:"Success",warning:"Warning"};tt(st);var At=st,it=class extends ht{};tt(At);var It=p`
...
`,u=class extends y{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.size="inherit",this.color="currentColor",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleClick(t){this.disabled&&(t.preventDefault(),t.stopPropagation())}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}render(){const t=!!this.href,e=t?V`a`:V`button`;return dt`
    ...
    `}};d.styles=[z,Lt,It];d.dependencies={"syn-icon-button":u,"syn-resize-observer":M};i([Z({slot:"nav",selector:"syn-tab"})],d.prototype,"tabs",2);i([Z({selector:"syn-tab-panel"})],d.prototype,"panels",2);i([k(".tab-group")],d.prototype,"tabGroup",2);i([k(".tab-group__body")],d.prototype,"body",2);i([k(".tab-group__nav")],d.prototype,"nav",2);i([k(".tab-group__indicator")],d.prototype,"indicator",2);i([B()],d.prototype,"hasScrollControls",2);i([B()],d.prototype,"shouldHideScrollStartButton",2);i([B()],d.prototype,"shouldHideScrollEndButton",2);i([c()],d.prototype,"placement",2);i([c()],d.prototype,"activation",2);i([c({attribute:"no-scroll-controls",type:Boolean})],d.prototype,"noScrollControls",2);i([c({type:Boolean})],d.prototype,"contained",2);i([c({type:Boolean})],d.prototype,"sharp",2);i([c({attribute:"fixed-scroll-controls",type:Boolean})],d.prototype,"fixedScrollControls",2);i([ut({passive:!0})],d.prototype,"updateScrollButtons",1);i([S("noScrollControls",{waitUntilFirstUpdate:!0})],d.prototype,"updateScrollControls",1);i([S("placement",{waitUntilFirstUpdate:!0})],d.prototype,"syncIndicator",1);d.define("syn-tab-group");var Dt=p`
  /* Write custom CSS here */
...
`,Ut=0,A=class extends y{constructor(){super(...arguments),this.attrId=++Ut,this.componentId=`syn-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return _`
      <slot
        part="base"
        class=${C({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}};A.styles=[z,Vt,Nt];i([c({reflect:!0})],A.prototype,"name",2);i([c({type:Boolean,reflect:!0})],A.prototype,"active",2);i([S("active")],A.prototype,"handleActiveChange",1);A.define("syn-tab-panel");export{it as L,y as S,ee as _,E as a,i as b,z as c,te as d,w as e,Bt as f,$ as g,H as h,ae as i,v as j,oe as k,re as m,N as n,S as w};
