import"./icon-BSvoqWI1.js";import{g as f,x as e}from"./iframe-PfQ-yHii.js";import{s as h,a as g,c as b,b as v}from"./component-DpUHzmc7.js";import{r as d}from"./icon.component-D3GPJxDS.js";import{d as u}from"./default-icons-Dpg8W8qC.js";import"./index-Bkk0Z6Ex.js";import"./_docs-UXgsQIP6.js";import"./property-C5Clh3dC.js";import"./state-D49XWjPc.js";import"./watch-CEsCE2EF.js";import"./component.styles-DB_F015F.js";const w=`Icons are small standard symbols that are primarily used in screen design.
...
\`\`\`
`,{args:S,argTypes:I}=h("syn-icon"),{overrideArgs:C}=g("syn-icon"),{generateTemplate:x}=b("syn-icon"),k=`
${w}

---

`,O={args:C({name:"name",type:"attribute",value:"wallpaper"},S),argTypes:I,component:"syn-icon",parameters:{design:f("1616-1512"),docs:{description:{component:k}}},tags:["Icons"],title:"Components/syn-icon"},s={parameters:{controls:{disable:!1}},render:n=>x({args:n})},t={render:()=>e`<div style="color: var(--syn-color-primary-600);">
...
<div style="color: var(--syn-color-error-700);">
  ...
  <syn-icon name="star_border"></syn-icon>
  <syn-icon name="delete"></syn-icon>
</div>`},r={render:()=>e`<syn-icon name="star" label="Add to favorites"></syn-icon>`},i={render:()=>e`<syn-icon src="/logo-claim.svg" style="font-size: 10rem;"></syn-icon>`},a={render:()=>(d("fa",{resolver:n=>{const p=n.replace(/^fa[rbs]-/,"");let m="regular";return n.substring(0,4)==="fas-"&&(m="solid"),n.substring(0,4)==="fab-"&&(m="brands"),`https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.15.1/svgs/${m}/${p}.svg`},mutator:n=>n.setAttribute("fill","currentColor")}),e`<div style="font-size: var(--syn-font-size-x-large);">
