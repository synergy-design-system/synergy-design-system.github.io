import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{_ as r,d as i,f as a,p as o}from"./iframe-BJUJk-mP.js";import{t as s}from"./button-DPE3w6y_.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-Dl_LLDeh.js";import{n as m,t as h}from"./taggedTemplateLiteral-pWa2IaV6.js";import{t as g}from"./checkbox-BGwDrUrG.js";import{n as _,t as v}from"./decorators-C-ZhSsaX.js";var y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L=e((()=>{g(),s(),n(),v(),f(),a(),r(),m(),{userEvent:y}=__STORYBOOK_MODULE_TEST__,{argTypes:x}=l(`syn-checkbox`),{overrideArgs:S}=c(`syn-checkbox`),{generateTemplate:C}=d(`syn-checkbox`),w={args:S([{name:`default`,type:`slot`,value:`Checkbox`}]),argTypes:x,component:`syn-checkbox`,parameters:{chromatic:{modes:o},design:i(`41310-257927`),docs:{description:{component:u(`checkbox`,`default`)}}},tags:[`Form`],title:`Components/syn-checkbox`},T={parameters:{controls:{disable:!1},docs:{description:{story:u(`checkbox`,`default`)}}},render:e=>C({args:e})},E={parameters:{docs:{description:{story:u(`checkbox`,`checked`)}}},render:()=>t`<syn-checkbox checked>Checked</syn-checkbox>`},D={parameters:{docs:{description:{story:u(`checkbox`,`help-text`)}}},render:()=>t`
    <syn-checkbox help-text="What should the user know about the checkbox?">Label</syn-checkbox>
  `},O={parameters:{docs:{description:{story:u(`checkbox`,`indeterminate`)}}},render:()=>t`<syn-checkbox indeterminate>Indeterminate</syn-checkbox>`},k={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`checkbox`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-checkbox`);t&&t.focus()},render:()=>t`<syn-checkbox>Focused</syn-checkbox>`},A={parameters:{docs:{description:{story:u(`checkbox`,`disabled`)}}},render:()=>t`<syn-checkbox disabled>Disabled</syn-checkbox>`},j={parameters:{docs:{description:{story:u(`checkbox`,`readonly`)}}},render:()=>t`
  ...
  `},M={parameters:{docs:{description:{story:u(`checkbox`,`sizes`)}}},render:()=>t`
    <div style="display: flex; flex-direction: column; gap: var(--syn-spacing-large);">
