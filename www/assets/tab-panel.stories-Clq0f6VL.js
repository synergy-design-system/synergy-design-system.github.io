import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{_ as r,d as i,f as a,p as o}from"./iframe-Dn-tjrvc.js";import{a as s,i as c,n as l,o as u,r as d,t as f}from"./component-D_QZftXm.js";import{n as p,t as m}from"./tab-panel-Dy209ezh.js";import{t as h}from"./tab-CAN2RmZp.js";var g,_,v,y,b,x,S,C,w,T=e((()=>{m(),p(),h(),n(),d(),a(),r(),{args:g,argTypes:_}=c(`syn-tab-panel`),{overrideArgs:v}=s(`syn-tab-panel`),{generateTemplate:y}=u(`syn-tab-panel`),b=()=>t`<main class="synergy-replace">Replace this slot</main>`,x={args:v([{name:`default`,type:`slot`,value:b().strings.join(`
`)},{name:`name`,type:`attribute`,value:`tab1`}],g),argTypes:_,component:`syn-tab-panel`,parameters:{chromatic:{modes:o},design:i(`42207-340626`),docs:{description:{component:l(`tab-panel`,`default`)}}},tags:[`Navigation`],title:`Components/syn-tab-panel`},S={parameters:{docs:{description:{story:l(`tab-panel`,`default`)}}},render:e=>t`
    <syn-tab-group>
