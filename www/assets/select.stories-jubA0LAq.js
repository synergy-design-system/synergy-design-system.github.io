import{i as e}from"./preload-helper-xPQekRTU.js";import{Ht as t,It as n,d as r,f as i,g as a,u as o}from"./iframe-BLAzlACc.js";import{t as s}from"./button-Ci1LHfIR.js";import{t as c}from"./icon-BFcjyE5U.js";import{a as l,i as u,n as d,o as f,r as p,t as m}from"./component-RhnClGwj.js";import{n as h,t as g}from"./taggedTemplateLiteral-pWa2IaV6.js";import{n as _,t as v}from"./PaddingDecorator-Dxl3X7Fp.js";import{t as y}from"./option-KZHTn4qW.js";import{t as b}from"./optgroup-BJKd_veA.js";import{t as x}from"./select-DOgCzmIJ.js";import{n as S,t as C}from"./select-DKD9qKEn.js";var w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=e((()=>{x(),y(),b(),c(),s(),n(),C(),p(),r(),v(),a(),h(),{userEvent:w}=__STORYBOOK_MODULE_TEST__,{args:O,argTypes:k}=u(`syn-select`),{overrideArgs:A}=l(`syn-select`),{generateTemplate:j}=f(`syn-select`),M={args:O,argTypes:k,component:`syn-select`,parameters:{chromatic:{modes:i},design:o(`41325-310740`),docs:{description:{component:d(`select`,`default`)},story:{height:`250px`}}},tags:[`Form`],title:`Components/syn-select`},N={parameters:{args:A({name:`default`,type:`slot`,value:`
