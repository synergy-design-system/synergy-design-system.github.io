import{c as t}from"./iframe-hf7datPi.js";import{g as n}from"./translations-CnhJ1T76.js";import"./nav-item-BlR1Tm4p.js";import"./prio-nav-BosiwO-E.js";import"./header-jv16tvk6.js";import"./dropdown-S5C6SFFV.js";import"./icon-button-ChZ241qs.js";import"./menu-item-BOlOzUJj.js";import"./side-nav-C_x7xI1g.js";import"./icon-kOsBw5Mx.js";var a=Object.freeze,m=Object.defineProperty,r=(e,i)=>a(m(e,"raw",{value:a(e.slice())})),o,s;const b=()=>t`
  <!-- footer -->
  <style>
    .synergy-footer-demo {
  ...
  <footer class="synergy-footer-demo">
    <nav class="footer-content" aria-label="Footer navigation">
      <ul class="syn-link-list syn-link-list--small syn-link-list--horizontal">
        <li>
          <a class="syn-link syn-link--small syn-link--quiet" href="${n("footer.linksHref.imprint")}">
            ${n("footer.linksName.imprint")}
          </a>
        </li>
        <li>
          <a class="syn-link syn-link--small syn-link--quiet" href="${n("footer.linksHref.termsConditions")}">
            ${n("footer.linksName.termsConditions")}
          </a>
        </li>
        <li>
          <a class="syn-link syn-link--small syn-link--quiet" href="${n("footer.linksHref.termsOfUse")}">
            ${n("footer.linksName.termsOfUse")}
          </a>
        </li>
        <li>
          <a class="syn-link syn-link--small syn-link--quiet" href="${n("footer.linksHref.privacyPolicy")}">
...
`,N=({withMetaNavigation:e=!1}={})=>t`
  ...
  <!-- /header -->
`,w=({noFocusTrapping:e=!1,open:i=!1,variant:l="default",hasFooter:c=!0}={})=>t`
  <!-- side-navigation -->
  <syn-side-nav
    ?no-focus-trapping=${e}
    ?open=${i}
...
`])),e),C=(e,i="syn-side-nav")=>t(s||(s=r([`
  ...
  <\/script>
`])),e,i,i);export{_ as a,b,N as c,$ as d,C as e,q as f,w as g};
