import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{l as n,o as r}from"./preview-DRz18Lsn.js";import{c as i,t as a}from"./lit-D4-0ovri.js";import{d as o,f as s,i as c,p as l,u}from"./blocks-Tvq0jjN0.js";import{t as d}from"./react-Q1GcV6wX.js";import{n as f,r as p,t as m}from"./waitForFinishedCharts-DyYKSNey.js";import{n as h,t as g}from"./formatter-34eogR_H.js";import{n as _,r as v,t as y}from"./component-NnlguzJ1.js";import{t as b}from"./taggedTemplateLiteral-BZenJ0bZ.js";var x,S,C,w,T,E,D,O,k,A,j,M,N,P;function F(){return(F=t((()=>{x=e(d(),1),a(),l(),p(),h(),v(),n(),m(),window.formatter=g,D={component:`syn-chart`,parameters:{chromatic:{delay:300,modes:r},docs:{description:{component:_(`chart`,`gauge-series-default`)},page:()=>x.createElement(x.Fragment,null,x.createElement(s,null),x.createElement(o,null),x.createElement(c,null),x.createElement(u,{title:``}))}},play:f,tags:[`Charting`,`Data Visualization`],title:`Charts/Series Types/Gauge Chart`},O={parameters:{docs:{description:{story:_(`chart`,`gauge-series-preset`)}}},render:()=>i(S||=b([`
  ...
  `]))},M={parameters:{docs:{description:{story:_(`chart`,`gauge-series-formatter`)}}},render:()=>i(E||=b([`
    ...
    <\/script>
  `]))},N=y({Default:O,Sections:k,TrendIndicator:A,Icon:j,ValueFormatting:M},700),P=[`Default`,`Sections`,`TrendIndicator`,`Icon`,`ValueFormatting`,`Screenshot`],O.parameters={...O.parameters,docs:{...O.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
  ...
  Icon,
  ValueFormatting
}, 700)`,...N.parameters?.docs?.source}}}})))()}F();export{O as Default,j as Icon,N as Screenshot,k as Sections,A as TrendIndicator,M as ValueFormatting,P as __namedExportsOrder,D as default};