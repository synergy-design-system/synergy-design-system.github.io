import"./icon-T0CKlryb.js";import{x as e}from"./directive-helpers-po9zzQFH.js";import{s as p,a as h,b as g,c as b}from"./component-XRB3vXEd.js";import{r as d}from"./icon.component-X2LvZYBL.js";import{d as f}from"./default-icons-lOL_5Mxe.js";import"./icon-button-YFpdcvXY.js";import"./preview-hG2T33hE.js";import"./index-4g5l5LRQ.js";import"./_commonjsHelpers-4gQjN7DL.js";import"./chunk-HJCNT6QR-AqqC_ZTT.js";import"./chunk-FJPRWHXQ-vmV3xKJL.js";import"./index-PPLHz8o0.js";import"./index-FIHtO42A.js";const{args:v,argTypes:w}=p("syn-icon"),{overrideArgs:S}=b("syn-icon"),{generateTemplate:I}=h("syn-icon"),C=`
...
`,P={args:S({name:"name",type:"attribute",value:"wallpaper"},v),argTypes:w,component:"icon",parameters:{docs:{description:{component:C}}},title:"Components/syn-icon"},s={parameters:{controls:{disable:!1}},render:n=>I({args:n})},o={render:()=>e`<div style="color: var(--syn-color-primary-600);">
...
<div style="color: var(--syn-color-error-700);">
...
</div>`},r={render:()=>e`<div style="font-size: var(--syn-font-size-2x-large);">
  <syn-icon name="warning"></syn-icon>
  <syn-icon name="inventory"></syn-icon>
  <syn-icon name="battery_charging_full"></syn-icon>
  <syn-icon name="notifications"></syn-icon>
  ...
  <syn-icon name="star_border"></syn-icon>
  <syn-icon name="delete"></syn-icon>
</div>`},i={render:()=>e`<syn-icon name="star" label="Add to favorites"></syn-icon>`},t={render:()=>e`<syn-icon src="/logo-claim.svg" style="font-size: 10rem;"></syn-icon>`},a={render:()=>(d("fa",{resolver:n=>{const u=n.replace(/^fa[rbs]-/,"");let m="regular";return n.substring(0,4)==="fas-"&&(m="solid"),n.substring(0,4)==="fab-"&&(m="brands"),`https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.15.1/svgs/${m}/${u}.svg`},mutator:n=>n.setAttribute("fill","currentColor")}),e`<div style="font-size: var(--syn-font-size-x-large);">
...
</div>`)},c={render:()=>(d("bundled-default",{mutator:n=>n.setAttribute("fill","currentColor"),resolver:n=>n in f?`data:image/svg+xml,${encodeURIComponent(f[n])}`:""}),e`<div style="font-size: var(--syn-font-size-x-large);">
...
</div>`)},y=g({Default:s,Colors:o,Sizing:r,Labels:i,CustomIcons:t,CDNIconLibrary:a,BundledIconLibrary:c,SpriteSheetUsage:l});s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    }
...
\`\`\``,...l.parameters?.docs?.description}}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`generateScreenshotStory({
  ...
  BundledIconLibrary,
  SpriteSheetUsage
})`,...y.parameters?.docs?.source}}};const V=["Default","Colors","Sizing","Labels","CustomIcons","CDNIconLibrary","BundledIconLibrary","SpriteSheetUsage","Screenshot"];export{c as BundledIconLibrary,a as CDNIconLibrary,o as Colors,t as CustomIcons,s as Default,i as Labels,y as Screenshot,r as Sizing,l as SpriteSheetUsage,V as __namedExportsOrder,P as default};
