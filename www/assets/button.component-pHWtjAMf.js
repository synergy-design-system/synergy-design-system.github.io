import{n as e}from"./chunk-DnJy8xQt.js";import{At as t,Bt as n,D as r,T as i,w as a}from"./iframe-CFxyVgYz.js";import{n as o,t as s}from"./class-map-B2P1DYC9.js";import{i as c,r as l,t as u}from"./form-BVa_zioF.js";import{n as d,r as f,t as p}from"./slot-uOU62xJ8.js";import{n as m,t as h}from"./if-defined-Gus0LTOI.js";import{n as g,t as _}from"./localize-DnZL8qNz.js";import{a as v,f as y,i as b,n as x,o as S,p as C,r as w,s as T,t as E,u as D}from"./synergy-element-DOjsnQEs.js";import{n as O,t as k}from"./watch-OXZPXmne.js";import{n as A,t as j}from"./icon.component-DSYib2bb.js";import{n as M,t as N}from"./spinner.component-CiBuoe4k.js";import{n as P,t as F}from"./decorator-CJ_bAnlW.js";var I,L=e((()=>{t(),I=n`
	/* stylelint-disable */
  :host {
...
`})),B,V,H=e((()=>{s(),l(),f(),a(),h(),_(),T(),k(),S(),x(),A(),M(),L(),z(),P(),b(),B=class extends E{constructor(...e){super(...e),this.formControlController=new u(this,{assumeInteractionOn:[`click`]}),this.hasSlotController=new p(this,`[default]`,`prefix`,`suffix`),this.localize=new g(this),this.iconOnly=!1,this.hasFocus=!1,this.invalid=!1,this.title=``,this.variant=`outline`,this.size=`medium`,this.caret=!1,this.disabled=!1,this.loading=!1,this.type=`button`,this.name=``,this.value=``,this.href=``,this.rel=`noreferrer noopener`}static{this.styles=[v,I,R]}static{this.dependencies={"syn-icon":j,"syn-spinner":N}}get validity(){return this.isButton()?this.button.validity:c}get validationMessage(){return this.isButton()?this.button.validationMessage:``}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleClick(){this.type===`submit`&&this.formControlController.submit(this),this.type===`reset`&&this.formControlController.reset(this)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}isButton(){return!this.href}isLink(){return!!this.href}handleSlotChange(){let e=d(this.defaultSlot).trim(),t=this.defaultSlot.assignedElements({flatten:!0}),n=t.length===1&&t[0].tagName.toLowerCase()===`syn-icon`;this.iconOnly=n&&e===``}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(e){this.isButton()&&(this.button.setCustomValidity(e),this.formControlController.updateValidity())}render(){let e=this.isLink(),t=e?i`a`:i`button`;return r`
    ...
    `}},w([D(`.button`)],B.prototype,`button`,void 0),w([D(`slot:not([name])`)],B.prototype,`defaultSlot`,void 0),w([y()],B.prototype,`iconOnly`,void 0),w([y()],B.prototype,`hasFocus`,void 0),w([y()],B.prototype,`invalid`,void 0),w([C({reflect:!0})],B.prototype,`title`,void 0),w([C({reflect:!0})],B.prototype,`variant`,void 0),w([C({reflect:!0})],B.prototype,`size`,void 0),w([C({type:Boolean,reflect:!0})],B.prototype,`caret`,void 0),w([C({type:Boolean,reflect:!0})],B.prototype,`disabled`,void 0),w([C({type:Boolean,reflect:!0})],B.prototype,`loading`,void 0),w([C()],B.prototype,`type`,void 0),w([C()],B.prototype,`name`,void 0),w([C()],B.prototype,`value`,void 0),w([C()],B.prototype,`href`,void 0),w([C()],B.prototype,`target`,void 0),w([C()],B.prototype,`rel`,void 0),w([C()],B.prototype,`download`,void 0),w([C()],B.prototype,`form`,void 0),w([C({attribute:`formaction`})],B.prototype,`formAction`,void 0),w([C({attribute:`formenctype`})],B.prototype,`formEnctype`,void 0),w([C({attribute:`formmethod`})],B.prototype,`formMethod`,void 0),w([C({attribute:`formnovalidate`,type:Boolean})],B.prototype,`formNoValidate`,void 0),w([C({attribute:`formtarget`})],B.prototype,`formTarget`,void 0),w([O(`disabled`,{waitUntilFirstUpdate:!0})],B.prototype,`handleDisabledChange`,null),B=w([F(`SynButton`)],B),V=B}));export{H as n,V as t};