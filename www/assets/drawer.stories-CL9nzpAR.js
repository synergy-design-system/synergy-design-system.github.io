import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{_ as r,d as i,f as a,p as o}from"./iframe-BJUJk-mP.js";import{t as s}from"./button-DPE3w6y_.js";import{a as c,i as l,n as u,o as d,r as f}from"./component-Dl_LLDeh.js";import{n as p,t as m}from"./taggedTemplateLiteral-pWa2IaV6.js";import{t as h}from"./icon-button-B7cf0vry.js";import{t as g}from"./input-BU7P_yVK.js";import{n as _,t as v}from"./drawer.component-Bqj-0DRM.js";import{n as y,t as b}from"./DisableFocusTrap-BCG7NS-q.js";var x=e((()=>{_(),_(),v.define(`syn-drawer`)})),S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y=e((()=>{x(),s(),h(),g(),n(),f(),y(),a(),r(),p(),{userEvent:S}=__STORYBOOK_MODULE_TEST__,{args:N,argTypes:P}=l(`syn-drawer`),{overrideArgs:F}=c(`syn-drawer`),{generateTemplate:I}=d(`syn-drawer`),L={args:N,argTypes:P,component:`syn-drawer`,parameters:{chromatic:{modes:o},design:i(`41163-282330`),docs:{container:b,description:{component:u(`drawer`,`default`)},story:{height:`400px`}}},tags:[`Structure`],title:`Components/syn-drawer`},R={args:F([{name:`open`,type:`attribute`,value:!0},{name:`contained`,type:`attribute`,value:!1},{name:`label`,type:`attribute`,value:`Drawer`},{name:`default`,type:`slot`,value:`Lorem ipsum dolor sit amet, consectetur adipiscing elit.`},{name:`footer`,type:`slot`,value:`
        ...
        <\/script>
      `}],N),parameters:{chromatic:{disableSnapshot:!1},controls:{disable:!1},docs:{description:{story:u(`drawer`,`default`)}}},render:e=>t(C||=m([`
    `,`
    ...
    <\/script>
  `]),I({args:e}))},z={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`start`)}}},render:()=>t(w||=m([`
    ...
    <script type="module">
      ...
      closeButton.addEventListener('click', () => drawer.hide());
    <\/script>
  `]))},B={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`top`)}}},render:()=>t(T||=m([`
    ...
    <script type="module">
      ...
      closeButton.addEventListener('click', () => drawer.hide());
    <\/script>
  `]))},V={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`bottom`)}}},render:()=>t(E||=m([`
    ...
    <script type="module">
      ...
      closeButton.addEventListener('click', () => drawer.hide());
    <\/script>
  `]))},H={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`contained`)}}},render:()=>t(D||=m([`
    <div
    ...
    <script type="module">
      ...
      closeButton.addEventListener('click', () => drawer.hide());
    <\/script>
  `]))},U={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`size`)}}},render:()=>t(O||=m([`
    ...
    <script type="module">
      ...
      closeButton.addEventListener('click', () => drawer.hide());
    <\/script>
  `]))},W={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`scrolling`)}}},render:()=>t(k||=m([`
    ...
    <script type="module">
      ...
      closeButton.addEventListener('click', () => drawer.hide());
    <\/script>
  `]))},G={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`action`)}}},render:()=>t(A||=m([`
    ...
    <\/script>
  `]))},K={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`closing`)}}},play:async({canvasElement:e})=>{let t=e.querySelector(`syn-drawer`),n=t?.shadowRoot?.querySelector(`.drawer__overlay`);t&&n&&await S.click(n)},render:()=>t(j||=m([`
    ...
    <\/script>`]))},q={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`fokus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-drawer`);t&&(t.open=!0)},render:()=>t(M||=m([`
  ...
  render: () => html\`
    ...
    <\/script>
  \`
}`,...q.parameters?.docs?.source}}},J=[`Default`,`SlideInFromStart`,`SlideInFromTop`,`SlideInFromBottom`,`ContainedToAnElement`,`CustomSize`,`Scrolling`,`HeaderActions`,`PreventingTheDrawerFromClosing`,`CustomizingInitialFocus`]}));Y();export{H as ContainedToAnElement,U as CustomSize,q as CustomizingInitialFocus,R as Default,G as HeaderActions,K as PreventingTheDrawerFromClosing,W as Scrolling,V as SlideInFromBottom,z as SlideInFromStart,B as SlideInFromTop,J as __namedExportsOrder,L as default,Y as t};