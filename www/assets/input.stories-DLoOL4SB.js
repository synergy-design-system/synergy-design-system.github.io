import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-DRz18Lsn.js";import{c as i,t as a}from"./lit-D4-0ovri.js";import{t as o}from"./button-CBC8ywKX.js";import{t as s}from"./icon-BbsmBxau.js";import{t as c}from"./input-DeuiTlMk.js";import{i as l,n as u,o as d,r as f,t as p}from"./component-NnlguzJ1.js";import{n as m,t as h}from"./PaddingDecorator-Dx4_2Fla.js";import{n as g,t as _}from"./decorators-CjBNNcov.js";import{t as v}from"./textarea-RHZnTiPn.js";var y=t({Clearable:()=>k,CustomizingLabelPosition:()=>R,Default:()=>T,Disabled:()=>N,Focus:()=>M,HelpText:()=>D,InputTypes:()=>I,Invalid:()=>F,Labels:()=>E,Placeholders:()=>O,PrefixSuffixTextAndIcons:()=>L,ReadonlyInputs:()=>j,Screenshot:()=>V,Sizes:()=>P,Stepper:()=>z,StepperInputHandling:()=>B,TogglePassword:()=>A,__namedExportsOrder:()=>H,default:()=>w}),b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H;function U(){return(U=e((()=>{c(),s(),o(),v(),a(),_(),f(),h(),r(),{userEvent:b}=__STORYBOOK_MODULE_TEST__,{args:x,argTypes:S}=l(`syn-input`),{generateTemplate:C}=d(`syn-input`),w={args:x,argTypes:S,parameters:{chromatic:{modes:n},docs:{description:{component:u(`input`,`default`)}}},tags:[`Form`],title:`Components/syn-input`},T={parameters:{controls:{disable:!1},docs:{description:{story:u(`input`,`default`)}}},render:e=>C({args:e})},E={parameters:{docs:{description:{story:u(`input`,`label`)}}},render:()=>i`<syn-input label="What is your name?"></syn-input>`},D={parameters:{docs:{description:{story:u(`input`,`help-text`)}}},render:()=>i`<syn-input label="Nickname" help-text="What would you like people to call you?"></syn-input>`},O={parameters:{docs:{description:{story:u(`input`,`placeholder`)}}},render:()=>i`<syn-input placeholder="Type something"></syn-input>`},k={parameters:{docs:{description:{story:u(`input`,`clearable`)}}},render:()=>i`<syn-input value="Clearable" placeholder="Clearable" clearable></syn-input>`},A={parameters:{docs:{description:{story:u(`input`,`password-toggle`)}}},render:()=>i`<syn-input type="password" placeholder="Password Toggle" password-toggle></syn-input>`},j={parameters:{docs:{description:{story:u(`input`,`readonly`)}}},render:()=>i`<syn-input value="Readonly content" readonly></syn-input>`},M={decorators:[m()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`input`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-input`);t&&t.focus()},render:()=>i`
      <form>
        <syn-input help-text="This input is focused." label="Label" placeholder="Insert text here..."></syn-input>
      </form>
    `},N={parameters:{docs:{description:{story:u(`input`,`disabled`)}}},render:()=>i`
  <syn-input placeholder="Disabled" help-text="Help Text" label="Label" disabled>
    <syn-icon name="home" slot="prefix"></syn-icon>
    <syn-icon name="chat" slot="suffix"></syn-icon>
  </syn-input>`},P={parameters:{docs:{description:{story:u(`input`,`size`)}}},render:()=>i`
  ...
  `},I={parameters:{docs:{description:{story:u(`input`,`types`)}}},render:()=>i`
  ...
  `},L={parameters:{docs:{description:{story:u(`input`,`prefix-suffix`)}}},render:()=>i`
  ...
  <syn-input placeholder="Large" size="large">
    <syn-icon name="wallpaper" slot="prefix"></syn-icon>
    <syn-icon name="wallpaper" slot="suffix"></syn-icon>
  </syn-input>`},R={parameters:{docs:{description:{story:u(`input`,`label-position`)}}},render:()=>i`
  ...
  `},z={parameters:{docs:{description:{story:u(`input`,`stepper`)}}},render:()=>i`
  <syn-input type="number" min="0" max="10" value="0"></syn-input>
  <br/>
  <syn-input type="number" min="0" max="10" value="2"></syn-input>
  <br/>
  <syn-input type="number" min="0" max="10" value="10"></syn-input>`},B={parameters:{docs:{description:{story:u(`input`,`stepper-input-handling`)}}},render:()=>i`
    <syn-input
    ...
    <syn-input 
      ...
      value="0"
    ></syn-input>
  `},V=p({Default:T,Labels:E,HelpText:D,Placeholders:O,Clearable:k,TogglePassword:A,ReadonlyInputs:j,Disabled:N,Sizes:P,InputTypes:I,PrefixSuffixTextAndIcons:L,CustomizingLabelPosition:R,Stepper:z,StepperInputHandling:B},500),H=[`Default`,`Labels`,`HelpText`,`Placeholders`,`Clearable`,`TogglePassword`,`ReadonlyInputs`,`Focus`,`Disabled`,`Sizes`,`Invalid`,`InputTypes`,`PrefixSuffixTextAndIcons`,`CustomizingLabelPosition`,`Stepper`,`StepperInputHandling`,`Screenshot`],T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
...
}, 500)`,...V.parameters?.docs?.source}}}})))()}export{U as n,y as r,T as t};