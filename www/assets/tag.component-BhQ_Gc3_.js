import{i as e}from"./preload-helper-xPQekRTU.js";import{Ht as t,It as n,qt as r}from"./iframe-CR7gJfd0.js";import{n as i,t as a}from"./class-map-CCgPnC9L.js";import{n as o,t as s}from"./localize-CzgwcyM2.js";import{a as c,i as l,n as u,o as d,r as f,s as p,t as m,y as h}from"./synergy-element-0B3h-xal.js";import{n as g,t as _}from"./decorator-ChmomMqD.js";import{n as v,t as y}from"./icon-button.component-2eJVN6qY.js";var b,x=e((()=>{n(),b=r`
	/* stylelint-disable */
  :host {
...
`})),w,T,E=e((()=>{a(),n(),s(),p(),d(),u(),v(),x(),C(),g(),l(),w=class extends m{constructor(...e){super(...e),this.localize=new o(this),this.size=`medium`,this.removable=!1}static{this.styles=[c,b,S]}static{this.dependencies={"syn-icon-button":y}}handleRemoveClick(){this.emit(`syn-remove`)}render(){return t`
      <span
        part="base"
    ...
    `}},f([h({reflect:!0})],w.prototype,`size`,void 0),f([h({type:Boolean})],w.prototype,`removable`,void 0),w=f([_(`SynTag`)],w),T=w}));export{T as n,E as t};