import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{c as t,h as n,t as r}from"./lit-D4-0ovri.js";import{a as i,d as a,l as o,n as s,o as c,r as l,s as u,t as d}from"./synergy-element-Di-hMrpy.js";import{t as f}from"./query-DOHNhzf6.js";import{r as p,t as m}from"./if-defined-BN5mMhH6.js";import{n as h,t as g}from"./class-map-LsJiuvgY.js";import{r as _,t as v}from"./form-D9RYqjir.js";import{r as y,t as b}from"./slot-CUH75lUH.js";import{n as x}from"./watch-Q8hEwzVb.js";import{n as S,t as C}from"./decorator-DZesXZg7.js";import{r as w,t as T}from"./live-CD3WTCMN.js";import{n as E,t as D}from"./form-control.styles-BbnxDpsH.js";import{n as O,t as k}from"./default-value-Bg4Vpd0u.js";var A;function j(){return(j=e((()=>{r(),A=n`
...
`})))()}var M,N;function P(){return(P=e((()=>{g(),O(),_(),y(),r(),m(),T(),u(),c(),E(),s(),j(),S(),M=class extends d{constructor(...e){super(...e),this.formControlController=new v(this,{value:e=>e.checked?e.value||`on`:void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=t}),this.hasSlotController=new b(this,`help-text`),this.hasFocus=!1,this.title=``,this.name=``,this.size=`medium`,this.disabled=!1,this.readonly=!1,this.checked=!1,this.defaultChecked=!1,this.form=``,this.required=!1,this.helpText=``}static{this.styles=[i,D,A]}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleInput(){this.emit(`syn-input`)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleClick(e){if(this.readonly){e.preventDefault();return}this.checked=!this.checked,this.emit(`syn-change`)}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleKeyDown(e){this.readonly||(e.key===`ArrowLeft`&&(e.preventDefault(),this.checked=!1,this.emit(`syn-change`),this.emit(`syn-input`)),e.key===`ArrowRight`&&(e.preventDefault(),this.checked=!0,this.emit(`syn-change`),this.emit(`syn-input`)))}handleCheckedChange(){this.input.checked=this.checked,this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(!0)}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){let e=this.hasSlotController.test(`help-text`),n=this.helpText?!0:!!e;return t`
    ...
    `}},l([f(`input[type="checkbox"]`)],M.prototype,`input`,void 0),l([o()],M.prototype,`hasFocus`,void 0),l([a({reflect:!0})],M.prototype,`title`,void 0),l([a()],M.prototype,`name`,void 0),l([a()],M.prototype,`value`,void 0),l([a({reflect:!0})],M.prototype,`size`,void 0),l([a({type:Boolean,reflect:!0})],M.prototype,`disabled`,void 0),l([a({type:Boolean,reflect:!0})],M.prototype,`readonly`,void 0),l([a({type:Boolean,reflect:!0})],M.prototype,`checked`,void 0),l([k(`checked`)],M.prototype,`defaultChecked`,void 0),l([a({reflect:!0})],M.prototype,`form`,void 0),l([a({type:Boolean,reflect:!0})],M.prototype,`required`,void 0),l([a({attribute:`help-text`})],M.prototype,`helpText`,void 0),l([x(`checked`,{waitUntilFirstUpdate:!0})],M.prototype,`handleCheckedChange`,null),l([x(`disabled`,{waitUntilFirstUpdate:!0})],M.prototype,`handleDisabledChange`,null),M=l([C(`SynSwitch`)],M),N=M})))()}function F(){return(F=e((()=>{P(),N.define(`syn-switch`)})))()}export{F as t};