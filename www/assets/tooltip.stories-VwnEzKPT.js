import{x as o}from"./directive-helpers-Dvm_Ferq.js";import{g as t,a as u,s as g,b,c as h,d as v}from"./component-D9Cr7x-I.js";import"./if-defined-zGpnP1OK.js";import"./ref-CgC99LRu.js";import"./chunk-L4EGOTBX-Boit2UGA.js";import"./entry-preview-DkJqm5dP.js";import"./index-DrFu-skq.js";import"./icon-button-CQW7__-s.js";import"./library-C58jM0s5.js";import"./icon.component-BoDp9LRR.js";import"./index-Vx7n56Jp.js";import"./index-_2TAQcTa.js";import"./_commonjsHelpers-CqkleIqs.js";import"./icon-mIpjUOpH.js";var m=Object.freeze,x=Object.defineProperty,w=(c,k)=>m(x(c,"raw",{value:m(c.slice())})),d;const{args:f,argTypes:T}=g("syn-tooltip"),{overrideArgs:S}=b("syn-tooltip"),{generateTemplate:H}=h("syn-tooltip"),W={args:S([{name:"content",type:"attribute",value:"This is a tooltip"},{name:"open",type:"attribute",value:!0},{name:"default",type:"slot",value:"<syn-button>Hover me</syn-button>"}],f),argTypes:T,component:"syn-tooltip",parameters:{design:u("12852-79550"),docs:{description:{component:t("tooltip","default")},story:{height:"200px",inline:!1}},layout:"centered"},title:"Components/syn-tooltip"},n={parameters:{controls:{disable:!1},docs:{description:{story:t("tooltip","default")}}},render:c=>H({args:c})},e={parameters:{docs:{description:{story:t("tooltip","placement")},story:{height:"450px"}},layout:"padded"},render:()=>o`
...
`},p={parameters:{docs:{description:{story:t("tooltip","maxwith")},story:{height:"400px"}}},render:()=>o`
  ...
  `},y=v({Default:n,Placement:e,ClickTrigger:s,ManualTrigger:i,RemovingArrows:r,HTMLInTooltips:l,SettingAMaximumWidth:p,Hoisting:a},{additionalChromaticOptions:{delay:500},heightPx:550,styleHeading:{"margin-bottom":"180px"}});n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
...
})`,...y.parameters?.docs?.source}}};const q=["Default","Placement","ClickTrigger","ManualTrigger","RemovingArrows","HTMLInTooltips","SettingAMaximumWidth","Hoisting","Screenshot"];export{s as ClickTrigger,n as Default,l as HTMLInTooltips,a as Hoisting,i as ManualTrigger,e as Placement,r as RemovingArrows,y as Screenshot,p as SettingAMaximumWidth,q as __namedExportsOrder,W as default};
