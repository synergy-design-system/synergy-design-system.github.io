import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,d as r,f as i,g as a,u as o}from"./iframe-CkET12W3.js";import{t as s}from"./icon-EUR_U8gh.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-B473QWuz.js";import{n as m,t as h}from"./PaddingDecorator-Ds2TnBCu.js";import{t as g}from"./nav-item-Bh6aWHK-.js";var _,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P=e((()=>{g(),s(),t(),f(),r(),h(),a(),{args:_,argTypes:v}=l(`syn-nav-item`),{overrideArgs:y}=c(`syn-nav-item`),{generateTemplate:b}=d(`syn-nav-item`),x={args:y([{name:`default`,type:`slot`,value:`Label`}],_),argTypes:v,component:`syn-nav-item`,parameters:{chromatic:{modes:i},design:o(`41163-402744`),docs:{description:{component:u(`nav-item`,`default`)}}},tags:[`Navigation`],title:`Components/syn-nav-item`},S={parameters:{controls:{disable:!1},docs:{description:{story:u(`nav-item`,`default`)}}},render:e=>b({args:e})},C={parameters:{docs:{description:{story:u(`nav-item`,`labels`)}}},render:()=>n`
