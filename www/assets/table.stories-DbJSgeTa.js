import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{a as n,d as r,n as i,o as a,s as o,t as s}from"./preview-DXkhgu0Z.js";import{c,t as l}from"./lit-BfcklOOD.js";import{t as u}from"./react-DvlgmmzG.js";import{d,f,i as p,p as m,u as h}from"./blocks-Dyc7j8Lq.js";import{t as g}from"./button-DVR7vfNM.js";import{t as _}from"./icon-koM57tMi.js";import{n as v,r as y}from"./component-B0n0ooCL.js";import{n as b,t as x}from"./taggedTemplateLiteral-C9cDEsPD.js";import{n as S,t as C}from"./translations-_SzDANmF.js";var w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V;t((()=>{w=e(u(),1),m(),l(),s(),y(),S(),a(),r(),g(),_(),b(),k=(e,t=5)=>Array(t).fill(void 0).map(e),A=(e=void 0)=>{let t=e?`syn-table-cell--shadow-${e} shadow-cell`:``,n=n=>`${e===`end`&&n===0||e===`start`&&n===4||e===`bottom`?t:``}`;return c`
    <thead>
      <tr>
  ...
  `},j=(e=void 0)=>{let t=e?`syn-table-cell--shadow-${e} shadow-cell`:``,n=n=>`${e===`end`&&n===0||e===`start`&&n===4?t:``}`;return c`
    <tr>
...
`,N={parameters:{chromatic:{...i?.parameters?.chromatic,disableSnapshot:!1,modes:o},design:n(`41127-616898`),docs:{description:{component:v(`table`,`default`,`templates`)},page:()=>w.createElement(w.Fragment,null,w.createElement(f,null),w.createElement(d,null),w.createElement(p,null),w.createElement(h,{title:``})),story:{iframeHeight:550}}},tags:[`Structure`],title:`Templates/Table`},P={render:()=>{let e=k(()=>j());return c`
    ...
    `}},L={render:()=>{let e=k(()=>j(`end`));return c(T||=x([`
      ...
      <\/script>
    `]),A(`end`),e)}},R={render:()=>{let e=k(()=>j(`start`));return c(E||=x([`
      ...
      <\/script>
    `]),A(`start`),e)}},z={render:()=>{let e=k(()=>j());return c(D||=x([`
      ...
      <\/script>
    `]),A(`bottom`),e)}},B={render:()=>{let e=k(()=>M());return c(O||=x([`
