import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-DRz18Lsn.js";import{c as i,t as a}from"./lit-D4-0ovri.js";import{a as o,i as s,n as c,o as l,r as u,t as d}from"./component-NnlguzJ1.js";import{t as f}from"./prio-nav-CL6cEtzk.js";import{t as p}from"./nav-item-Dc00SA6U.js";var m=t({Default:()=>b,PriorityMenu:()=>x,Screenshot:()=>S,__namedExportsOrder:()=>C,default:()=>y}),h,g,_,v,y,b,x,S,C;function w(){return(w=e((()=>{p(),f(),a(),u(),r(),{args:h,argTypes:g}=s(`syn-prio-nav`),{overrideArgs:_}=o(`syn-prio-nav`),{generateTemplate:v}=l(`syn-prio-nav`),y={args:_([{name:`default`,type:`slot`,value:`
  ...
  `},S=d({Default:b,PriorityMenu:x},{heightPx:200}),C=[`Default`,`PriorityMenu`,`Screenshot`],b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  heightPx: 200
})`,...S.parameters?.docs?.source},description:{story:`Uncomment this to test automatic adding of nav-items`,...S.parameters?.docs?.description}}}})))()}export{w as n,m as r,b as t};