import{i as e}from"./preload-helper-xPQekRTU.js";import{Ht as t,It as n,d as r,f as i,g as a,u as o}from"./iframe-BLAzlACc.js";import{i as s,n as c,o as l,r as u,t as d}from"./component-RhnClGwj.js";import{t as f}from"./divider-DUlR8KM9.js";var p,m,h,g,_,v,y,b,x,S,C,w=e((()=>{f(),n(),u(),r(),a(),{args:p,argTypes:m}=s(`syn-divider`),{generateTemplate:h}=l(`syn-divider`),g={args:p,argTypes:m,component:`syn-divider`,parameters:{chromatic:{modes:i},design:o(`41227-216341`),docs:{description:{component:c(`divider`,`default`)}}},tags:[`Structure`],title:`Components/syn-divider`},_={parameters:{docs:{description:{story:c(`divider`,`default`)}}},render:e=>h({args:e})},v={parameters:{docs:{description:{story:c(`divider`,`width`)}}},render:()=>t`<syn-divider style="--width: var(--syn-spacing-x-small);"></syn-divider>`},y={parameters:{docs:{description:{story:c(`divider`,`color`)}}},render:()=>t`<syn-divider style="--color: var(--syn-color-primary-600);"></syn-divider>`},b={parameters:{docs:{description:{story:c(`divider`,`spacing`)}}},render:()=>t`
