import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,d as r,f as i,g as a,u as o}from"./iframe-CKG-bwJX.js";import{a as s,i as c,n as l,o as u,r as d,t as f}from"./component-YYGwUeS7.js";import{n as p,t as m}from"./tab-panel-DqHCCLdt.js";import{t as h}from"./tab-3dDD_3Q1.js";var g,_,v,y,b,x,S,C,w;e((()=>{m(),p(),h(),t(),d(),r(),a(),{args:g,argTypes:_}=c(`syn-tab-panel`),{overrideArgs:v}=s(`syn-tab-panel`),{generateTemplate:y}=u(`syn-tab-panel`),b=()=>n`<main class="synergy-replace">Replace this slot</main>`,x={args:v([{name:`default`,type:`slot`,value:b().strings.join(`
