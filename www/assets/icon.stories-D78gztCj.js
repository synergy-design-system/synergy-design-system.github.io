import{a as f,s as h,b as g,c as b,d as v}from"./component-CxzySary.js";import{x as n}from"./directive-helpers-Dvm_Ferq.js";import{r as d}from"./library-BX4ONXik.js";import{d as u}from"./default-icons--FEJ2Psb.js";import"./ref-B9GS7qLj.js";import"./chunk-L4EGOTBX-Boit2UGA.js";import"./entry-preview-DkJqm5dP.js";import"./index-DrFu-skq.js";import"./icon-button-BeP5EYEW.js";import"./index-mLaxDseA.js";import"./index-_2TAQcTa.js";import"./_commonjsHelpers-CqkleIqs.js";const{args:w,argTypes:S}=h("syn-icon"),{overrideArgs:I}=g("syn-icon"),{generateTemplate:C}=b("syn-icon"),x=`
...
---
`,$={args:I({name:"name",type:"attribute",value:"wallpaper"},w),argTypes:S,component:"syn-icon",parameters:{design:f("1616-1512"),docs:{description:{component:x}}},title:"Components/syn-icon"},s={parameters:{controls:{disable:!1}},render:e=>C({args:e})},t={render:()=>n`<div style="color: var(--syn-color-primary-600);">
