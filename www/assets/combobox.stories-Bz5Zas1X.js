import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{_ as n,a as r,h as i,l as a}from"./preview-DRz18Lsn.js";import{c as o,t as ee}from"./lit-D4-0ovri.js";import{t as te}from"./button-CBC8ywKX.js";import{t as s}from"./icon-BbsmBxau.js";import{t as c}from"./option-5Sp0fHIr.js";import{a as l,i as u,n as d,o as f,r as p,t as m}from"./component-NnlguzJ1.js";import{t as h}from"./taggedTemplateLiteral-BZenJ0bZ.js";import{n as g,t as _}from"./PaddingDecorator-Dx4_2Fla.js";import{n as v,t as ne}from"./decorators-CjBNNcov.js";import{n as re,r as ie,t as ae}from"./combobox-DUbchEB7.js";import{t as oe}from"./optgroup-CYg2sho1.js";var se=t({AsyncOptions:()=>Y,Clearable:()=>F,CustomFilter:()=>X,Default:()=>A,Disabled:()=>I,Focus:()=>P,GroupingQuery:()=>q,HelpText:()=>M,HighlightQuery:()=>K,Invalid:()=>U,Labels:()=>j,Multiple:()=>R,NoResultsFound:()=>V,Placeholder:()=>N,PrefixSuffixTextAndIcons:()=>W,Readonly:()=>L,Restricted:()=>B,Screenshot:()=>Z,SettingInitialValue:()=>z,SimpleSuggests:()=>G,Sizes:()=>H,SuggestionContainerHeight:()=>J,__namedExportsOrder:()=>Q,default:()=>w}),y,ce,le,ue,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q;function $(){return($=e((()=>{ae(),te(),s(),c(),oe(),ee(),i(),ie(),ne(),p(),_(),a(),{userEvent:y}=__STORYBOOK_MODULE_TEST__,{args:b,argTypes:x}=u(`syn-combobox`),{overrideArgs:S}=l(`syn-combobox`),{generateTemplate:C}=f(`syn-combobox`),w={args:b,argTypes:x,component:`syn-combobox`,parameters:{chromatic:{modes:r},docs:{description:{component:d(`combobox`,`default`)},story:{height:`250px`}}},tags:[`Form`],title:`Components/syn-combobox`},T=[`Yellow`,`Light Green`,`Grey`,`Green`,`Blue`,`Red`,`Orange`,`Magenta`,`White`,`Purple`,`Pink`,`Black`,`Brown`].sort(),E=e=>`<syn-option value="${e.replaceAll(` `,`_`)}">${e}</syn-option>`,D=e=>n(E(e)),O=()=>T.map(E),k=()=>n(O().join(`
`)),A={parameters:{args:S({name:`default`,type:`slot`,value:`
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>`},b),controls:{disable:!1},docs:{description:{story:d(`combobox`,`default`)}}},render:e=>C({args:e})},j={parameters:{docs:{description:{story:d(`combobox`,`label`)}}},render:()=>o`
    <syn-combobox label="State">
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},M={parameters:{docs:{description:{story:d(`combobox`,`help-text`)}}},render:()=>o`
    <syn-combobox label="State" help-text="Select a State">
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},N={parameters:{docs:{description:{story:d(`combobox`,`placeholder`)}}},render:()=>o`
    <syn-combobox label="State" help-text="Select a State" placeholder="Select a State">
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},P={decorators:[g()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:d(`combobox`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-combobox`);t&&t.focus()},render:()=>o`
    <syn-combobox>
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},F={parameters:{docs:{description:{story:d(`combobox`,`clearable`)}}},render:()=>o`
    <syn-combobox value="Green" clearable>
      ${k()}
    </syn-combobox>
  `},I={parameters:{docs:{description:{story:d(`combobox`,`disabled`)}}},render:()=>o`
    <syn-combobox  disabled placeholder="Disabled">
      ${k()}
    </syn-combobox>
  `},L={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:d(`combobox`,`readonly`)}}},render:()=>o`
  ...
  `},R={parameters:{docs:{description:{story:d(`combobox`,`multiple`)}}},render:()=>o`
  ...
  `},z={parameters:{docs:{description:{story:d(`combobox`,`initial-values`)}}},render:()=>o`
    <syn-combobox value="option-1 option-2 option-3" multiple clearable max-options-visible="2">
      <syn-option value="option-1">Option 1</syn-option>
      <syn-option value="option-2">Option 2</syn-option>
      <syn-option value="option-3">Option 3</syn-option>
  ...
  `},V={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:d(`combobox`,`no-results`)},story:{inline:!1}}},play:async({canvasElement:e})=>{let t=e.querySelector(`syn-combobox`);await t.updateComplete,t.focus();let n=t.shadowRoot?.querySelector(`input`);n&&await y.type(n,`Search term`)},render:()=>o`
    <syn-combobox id="no-results" value="Search term" open restricted>
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},H={parameters:{docs:{description:{story:d(`combobox`,`size`)}}},render:()=>o`
  ...
  `},U={decorators:[v],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:d(`combobox`,`invalid`)}}},play:async({canvasElement:e})=>{let t=e.querySelector(`form`),n=t.querySelector(`syn-combobox`),r=t.querySelector(`syn-button`);r&&n&&(await y.click(r),r.click())},render:()=>o`
    <syn-combobox required placeholder="Type something" help-text="This is required">
      ${k()}
    </syn-combobox>
  `},W={parameters:{docs:{description:{story:d(`combobox`,`preffix-sufffix`)}}},render:()=>o`
  ...
  `},G={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:d(`combobox`,`simple`)}}},play:async({canvasElement:e})=>{let t=e.querySelector(`syn-combobox`);await t.updateComplete,await t.show()},render:()=>o`
    <syn-combobox label="Preferred Color" value="g">
     ${k()}
    </syn-combobox>
  `},K={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:d(`combobox`,`highlight`)}}},play:async({canvasElement:e})=>{let t=e.querySelector(`syn-combobox`);await t.updateComplete,await t.show()},render:()=>{let e=re;return o(ce||=h([`
    ...
    <\/script>
  `]),k(),e)}},q={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:d(`combobox`,`grouping`)}}},play:async({canvasElement:e})=>{let t=e.querySelector(`syn-combobox`);await t.updateComplete,await t.show()},render:()=>o`
  ...
  `},J={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:d(`combobox`,`container-height`)}}},play:async({canvasElement:e})=>{let t=e.querySelector(`syn-combobox`);await t.updateComplete,await t.show()},render:()=>o`
  ...
  `},Y={parameters:{docs:{description:{story:d(`combobox`,`async-options`)}}},render:()=>o(le||=h([`
    ...
    <\/script>
  `])),tags:[`skip_mcp`]},X={parameters:{docs:{description:{story:d(`combobox`,`custom-filter`)}}},render:()=>o(ue||=h([`
    ...
    <\/script>
  `]),k())},Z=m({Default:A,Labels:j,HelpText:M,Placeholder:N,Clearable:F,Disabled:I,Readonly:L,Multiple:R,SettingInitialValue:z,Restricted:B,NoResultsFound:V,Sizes:H,PrefixSuffixTextAndIcons:W,AsyncOptions:Y,CustomFilter:X},500),Q=[`Default`,`Labels`,`HelpText`,`Placeholder`,`Focus`,`Clearable`,`Disabled`,`Readonly`,`Multiple`,`SettingInitialValue`,`Restricted`,`NoResultsFound`,`Sizes`,`Invalid`,`PrefixSuffixTextAndIcons`,`SimpleSuggests`,`HighlightQuery`,`GroupingQuery`,`SuggestionContainerHeight`,`AsyncOptions`,`CustomFilter`,`Screenshot`],A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  parameters: {
    args: overrideArgs({
      name: 'default',
      type: 'slot',
  ...
  AsyncOptions,
  CustomFilter
}, 500)`,...Z.parameters?.docs?.source}}}})))()}export{se as n,$ as r,A as t};