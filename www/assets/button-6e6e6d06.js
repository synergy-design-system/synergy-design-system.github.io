import{s as p,n as d,a as v}from"./static-c19bae7e.js";import{F as _,a as x}from"./form-daa16d55.js";import{H as k}from"./slot-4492e2ee.js";import{o as e}from"./if-defined-1099e361.js";import{L as h}from"./localize-d6e19d2a.js";import{c as m,S as y,r as f,n as r,w}from"./component.styles-226283f4.js";import{e as C}from"./query-f49a08ce.js";import{S as z}from"./icon.component-e2a42406.js";import{i as c,x as $}from"./directive-helpers-a6c66f8a.js";const B=c`
	/* stylelint-disable */
  ${m}
...
`;class g extends y{constructor(){super(...arguments),this.localize=new h(this)}render(){return $`
...
`,F=c`
  ...
  ${S}
`;var V=Object.defineProperty,I=Object.getOwnPropertyDescriptor,n=(l,t,a,s)=>{for(var i=s>1?void 0:s?I(t,a):t,u=l.length-1,b;u>=0;u--)(b=l[u])&&(i=(s?b(t,a,i):b(i))||i);return s&&i&&V(t,a,i),i};class o extends y{constructor(){super(...arguments),this.formControlController=new _(this,{form:t=>{if(t.hasAttribute("form")){const a=t.getRootNode(),s=t.getAttribute("form");return a.getElementById(s)}return t.closest("form")},assumeInteractionOn:["click"]}),this.hasSlotController=new k(this,"[default]","prefix","suffix"),this.localize=new h(this),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="outline",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:x}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(t){this.isButton()&&(this.button.setCustomValidity(t),this.formControlController.updateValidity())}render(){const t=this.isLink(),a=t?p`a`:p`button`;return d`
      <${a}
        part="base"
