import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{D as r,_ as i,d as a,f as o,k as s,p as c}from"./iframe-BJUJk-mP.js";import{t as l}from"./button-DPE3w6y_.js";import{t as u}from"./card-UhzCCoOK.js";import{a as d,i as f,n as p,o as m,r as h,t as g}from"./component-Dl_LLDeh.js";import{t as _}from"./icon-button-B7cf0vry.js";var v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N=e((()=>{n(),r(),u(),l(),_(),h(),o(),i(),{args:v,argTypes:y}=f(`syn-card`),{overrideArgs:b}=d(`syn-card`),{generateTemplate:x}=m(`syn-card`),S=({buttonText:e=`More info`,footerText:t=`Optional information`}={})=>`
  <footer slot="footer">
    <small>${t}</small>
    <nav>
...
`,C={args:b([{name:`image`,type:`slot`,value:`<img slot="image" src="https://synergy-design-system.github.io/card-example.jpg" alt="Multiple persons having lunch in SICK Academy" />`},{name:`default`,type:`slot`,value:`
      ...
      `},{name:`footer`,type:`slot`,value:S()}],v),argTypes:y,component:`syn-card`,parameters:{chromatic:{modes:c},design:a(`42207-351610`),docs:{description:{component:p(`card`,`default`)}}},tags:[`Structure`],title:`Components/syn-card`},w={parameters:{controls:{disable:!1},docs:{description:{story:p(`card`,`default`)}}},render:e=>x({args:e})},T={parameters:{docs:{description:{story:p(`card`,`basic-card`)}}},render:()=>t`
  ...
  `},E={parameters:{docs:{description:{story:p(`card`,`with-header`)}}},render:()=>t`
  ...
  `},D={parameters:{docs:{description:{story:p(`card`,`with-footer`)}}},render:()=>t`
    <syn-card class="card-footer">
      This card has a footer. You can put all sorts of things in it!
      ${s(S({buttonText:`Preview`,footerText:`Optional information`}))}
    </syn-card>
  ...
  `},O={parameters:{docs:{description:{story:p(`card`,`images`)}}},render:()=>t`
  ...
  `},k={parameters:{docs:{description:{story:p(`card`,`sharp`)}}},render:()=>t`
  ...
  `},A={parameters:{docs:{description:{story:p(`card`,`shadow`)}}},render:()=>t`
  ...
  SharpCard,
  CardWithShadow
}, 600)`,...j.parameters?.docs?.source}}},M=[`Default`,`BasicCard`,`CardWithHeader`,`CardWithFooter`,`Images`,`SharpCard`,`CardWithShadow`,`Screenshot`]}));N();export{T as BasicCard,D as CardWithFooter,E as CardWithHeader,A as CardWithShadow,w as Default,O as Images,j as Screenshot,k as SharpCard,M as __namedExportsOrder,C as default,N as t};