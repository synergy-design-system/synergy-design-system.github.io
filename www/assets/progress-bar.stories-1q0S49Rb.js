import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-DRz18Lsn.js";import{c as i,h as a,l as ee,o as te,t as o}from"./lit-D4-0ovri.js";import{_ as ne,b as s,v as c,y as re}from"./library-BTrITrk7.js";import{a as ie,d as l,n as ae,o as oe,r as u,s as d,t as f}from"./synergy-element-Di-hMrpy.js";import{r as p,t as m}from"./if-defined-BN5mMhH6.js";import{n as h,t as g}from"./class-map-LsJiuvgY.js";import{n as _,t as v}from"./localize-Du3bqz3O.js";import{t as y}from"./button-CBC8ywKX.js";import{t as b}from"./icon-BbsmBxau.js";import{a as x,i as S,n as C,o as w,r as T,t as E}from"./component-NnlguzJ1.js";import{t as se}from"./taggedTemplateLiteral-BZenJ0bZ.js";var D,O,k;function A(){return(A=e((()=>{ee(),re(),D=`important`,O=` !`+D,k=ne(class extends c{constructor(e){if(super(e),e.type!==s.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(O);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?D:``):n[e]=r}}return te}})})))()}function j(){return(j=e((()=>{A()})))()}var M;function N(){return(N=e((()=>{o(),M=a`
	/* stylelint-disable */
  :host {
    --height: 1rem;
...
`})))()}var P;function F(){return(F=e((()=>{o(),P=a`
  :host {
...
`})))()}var I;function L(){return(L=e((()=>{g(),o(),m(),v(),d(),j(),oe(),ae(),N(),F(),I=class extends f{constructor(...e){super(...e),this.localize=new _(this),this.value=0,this.indeterminate=!1,this.label=``}static{this.styles=[ie,M,P]}render(){return i`
      <div
        part="base"
  ...
  `},Z=E({Default:K,Labels:q,CustomHeight:J,ShowingValues:Y,Indeterminate:X},180),Q=[`Default`,`Labels`,`CustomHeight`,`ShowingValues`,`Indeterminate`,`Screenshot`],K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
