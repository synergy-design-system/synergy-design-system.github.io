import{s as p,n as d,a as v}from"./static-c19bae7e.js";import{F as _,a as x}from"./form-74a81bb1.js";import{H as k}from"./slot-4492e2ee.js";import{o as e}from"./if-defined-1099e361.js";import{L as h}from"./localize-3922cea4.js";import{c as m,S as y,r as f,n as r,w}from"./component.styles-86aba3f6.js";import{e as C}from"./query-f49a08ce.js";import{S as z}from"./icon.component-d6cd0d6e.js";import{i as c,x as $}from"./directive-helpers-a6c66f8a.js";const B=c`
	/* stylelint-disable */
  ${m}
...
`,F=c`
  ...
  ${S}
`;var V=Object.defineProperty,O=Object.getOwnPropertyDescriptor,o=(s,n,i,l)=>{for(var a=l>1?void 0:l?O(n,i):n,u=s.length-1,b;u>=0;u--)(b=s[u])&&(a=(l?b(n,i,a):b(a))||a);return l&&a&&V(n,i,a),a};class t extends y{constructor(){super(...arguments),this.formControlController=new _(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new k(this,"[default]","prefix","suffix"),this.localize=new h(this),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="outline",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:x}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(n){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(n)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(n){this.button.focus(n)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(n){this.isButton()&&(this.button.setCustomValidity(n),this.formControlController.updateValidity())}render(){const n=this.isLink(),i=n?p`a`:p`button`;return d`
      <${i}
        part="base"
        ...
        ?disabled=${e(n?void 0:this.disabled)}
        type=${e(n?void 0:this.type)}
        title=${this.title}
        name=${e(n?void 0:this.name)}
        value=${e(n?void 0:this.value)}
        href=${e(n?this.href:void 0)}
        target=${e(n?this.target:void 0)}
        download=${e(n?this.download:void 0)}
        rel=${e(n?this.rel:void 0)}
        role=${e(n?void 0:"button")}
