import{j as b,x as l,g as h}from"./iframe-BOwQrtv8.js";import{e as f}from"./class-map-DP3ZLXYc.js";import{c as x,n as w,S}from"./synergy-element-C2HXLdhc.js";import{L as k}from"./localize-Dh03wnLC.js";import{e as D}from"./decorator-DANECR0-.js";import"./button-0OanqdsD.js";import"./icon-Dic0LlPC.js";import"./menu-item-LnsNOQyG.js";import"./menu-label-BBYs4wgF.js";import{S as z}from"./popup.component-8qEvCNNH.js";import{g as a,s as C,a as W,c as E,b as B}from"./component-AWqm0YIg.js";import"./preload-helper-Ct5FWWRu.js";import"./index-DihgwUfS.js";import"./functions-CDi3doZH.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./if-defined-CDh1x8c0.js";import"./icon.component-0hEIZFDL.js";import"./watch-CEsCE2EF.js";import"./query-DAIS6qJ0.js";import"./spinner.component-M17Nb7oR.js";import"./menu.component-CkzfX-a0.js";import"./divider.component-axanb3Y3.js";import"./index-Bkk0Z6Ex.js";import"./_docs-UXgsQIP6.js";const _=b`
	/* stylelint-disable */
  :host {
    display: inline-flex;
  }
...
`;var P=Object.defineProperty,j=Object.getOwnPropertyDescriptor,v=(d,p,g,y)=>{for(var e=y>1?void 0:y?j(p,g):p,m=d.length-1,u;m>=0;m--)(u=d[m])&&(e=(y?u(p,g,e):u(e))||e);return y&&e&&P(p,g,e),e};let i=class extends S{constructor(){super(...arguments),this.localize=new k(this),this.variant="primary"}render(){return l`
      <span
        part="base"
    ...
    `}};i.styles=[x,_,O];v([w({reflect:!0})],i.prototype,"variant",2);i=v([D("SynBadge")],i);i.define("syn-badge");z.define("syn-popup");const{args:I,argTypes:M}=C("syn-badge"),{overrideArgs:V}=W("syn-badge"),{generateTemplate:R}=E("syn-badge"),de={args:V([{name:"default",type:"slot",value:"Badge"}],I),argTypes:M,component:"syn-badge",parameters:{design:h("14127-697884"),docs:{description:{component:a("badge","default")}}},tags:["Feedback","SICK2018"],title:"Components/syn-badge"},r={parameters:{controls:{disable:!1},docs:{description:{story:a("badge","default")}}},render:d=>R({args:d})},n={parameters:{docs:{description:{story:a("badge","variants")}}},render:()=>l`
  ...
  WithMenuItems,
  WithEmptyContent
})`,...c.parameters?.docs?.source}}};const pe=["Default","Variants","WithButtons","WithMenuItems","WithEmptyContent","Screenshot"];export{r as Default,c as Screenshot,n as Variants,s as WithButtons,o as WithEmptyContent,t as WithMenuItems,pe as __namedExportsOrder,de as default};
