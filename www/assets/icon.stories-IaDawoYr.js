import"./icon-DbE-ZVUM.js";import{x as e}from"./lit-element-DILkAbkc.js";import{s as p,a as g,b as h,c as b}from"./component-BVvQmd38.js";import{r as d}from"./icon.component-Buj3H5FC.js";import{d as f}from"./default-icons-C0-H61Dj.js";import{g as v}from"./preview-DH2w7Wk_.js";import"./icon-button-zGz1i6lT.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-DJMaw2nM.js";import"./directive-helpers-DbZfDV3x.js";import"./index-DH5ua8nC.js";import"./_commonjsHelpers-Cpj98o6Y.js";const{args:w,argTypes:S}=p("syn-icon"),{overrideArgs:I}=b("syn-icon"),{generateTemplate:C}=g("syn-icon"),x=`
...
`,G={args:I({name:"name",type:"attribute",value:"wallpaper"},w),argTypes:S,component:"syn-icon",parameters:{design:v("1616-1512"),docs:{description:{component:x}}},title:"Components/syn-icon"},s={parameters:{controls:{disable:!1}},render:n=>C({args:n})},o={render:()=>e`<div style="color: var(--syn-color-primary-600);">
