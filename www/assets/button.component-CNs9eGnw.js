import{i as e}from"./preload-helper-xPQekRTU.js";import{h as t,t as n}from"./lit-BVDl_-fF.js";import{M as r,O as i,k as a}from"./iframe-BCoUYk3Z.js";import{n as o,t as s}from"./class-map-DgYlm_fS.js";import{i as c,r as l,t as u}from"./form-CV4G6JGX.js";import{n as d,r as f,t as p}from"./slot-DgcqpP0-.js";import{r as m,t as h}from"./if-defined-BsCyJVG6.js";import{n as g,t as _}from"./localize-CzgwcyM2.js";import{_ as v,a as y,f as b,i as x,n as S,o as C,r as w,s as T,t as E,y as D}from"./synergy-element-BtCydRhm.js";import{n as O,t as k}from"./watch-I6gMK-uE.js";import{n as A,t as j}from"./icon.component-B9Dbh5an.js";import{n as M,t as N}from"./spinner.component-C6p-PuLE.js";import{n as P,t as F}from"./decorator-ChmomMqD.js";var I,L=e((()=>{n(),I=t`
	/* stylelint-disable */
  :host {
...
`})),B,V,H=e((()=>{s(),l(),f(),i(),h(),_(),T(),k(),C(),S(),A(),M(),L(),z(),P(),x(),B=class extends E{constructor(...e){super(...e),this.formControlController=new u(this,{assumeInteractionOn:[`click`]}),this.hasSlotController=new p(this,`[default]`,`prefix`,`suffix`),this.localize=new g(this),this.iconOnly=!1,this.hasFocus=!1,this.invalid=!1,this.title=``,this.variant=`outline`,this.size=`medium`,this.caret=!1,this.disabled=!1,this.loading=!1,this.type=`button`,this.name=``,this.value=``,this.href=``,this.rel=`noreferrer noopener`}static{this.styles=[y,I,R]}static{this.dependencies={"syn-icon":j,"syn-spinner":N}}get validity(){return this.isButton()?this.button.validity:c}get validationMessage(){return this.isButton()?this.button.validationMessage:``}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleClick(){this.type===`submit`&&this.formControlController.submit(this),this.type===`reset`&&this.formControlController.reset(this)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}isButton(){return!this.href}isLink(){return!!this.href}handleSlotChange(){let e=d(this.defaultSlot).trim(),t=this.defaultSlot.assignedElements({flatten:!0}),n=t.length===1&&t[0].tagName.toLowerCase()===`syn-icon`;this.iconOnly=n&&e===``}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(e){this.isButton()&&(this.button.setCustomValidity(e),this.formControlController.updateValidity())}render(){let e=this.isLink(),t=e?a`a`:a`button`;return r`
      <${t}
        part="base"
        class=${o({button:!0,"button--primary":!0,"button--text":this.variant===`text`,"button--small":this.size===`small`,"button--medium":this.size===`medium`,"button--large":this.size===`large`,"button--caret":this.caret,"button--disabled":this.disabled,"button--focused":this.hasFocus,"button--loading":this.loading,"button--filled":this.variant===`filled`,"button--outline":this.variant===`outline`,"button--rtl":this.localize.dir()===`rtl`,"button--has-label":this.hasSlotController.test(`[default]`),"button--has-prefix":this.hasSlotController.test(`prefix`),"button--has-suffix":this.hasSlotController.test(`suffix`)})}
      ...
      >
        ...
        <slot part="label" class=${o({button__label:!0,"button__icon-only":this.iconOnly})} @slotchange=${this.handleSlotChange}></slot>
        <slot name="suffix" part="suffix" class="button__suffix"></slot>
        ${this.caret?r` <syn-icon part="caret" class="button__caret" library="system" name="chevron-down"></syn-icon> `:``}
        ${this.loading?r`<syn-spinner part="spinner"></syn-spinner>`:``}
      </${t}>
    `}},w([b(`.button`)],B.prototype,`button`,void 0),w([b(`slot:not([name])`)],B.prototype,`defaultSlot`,void 0),w([v()],B.prototype,`iconOnly`,void 0),w([v()],B.prototype,`hasFocus`,void 0),w([v()],B.prototype,`invalid`,void 0),w([D({reflect:!0})],B.prototype,`title`,void 0),w([D({reflect:!0})],B.prototype,`variant`,void 0),w([D({reflect:!0})],B.prototype,`size`,void 0),w([D({type:Boolean,reflect:!0})],B.prototype,`caret`,void 0),w([D({type:Boolean,reflect:!0})],B.prototype,`disabled`,void 0),w([D({type:Boolean,reflect:!0})],B.prototype,`loading`,void 0),w([D()],B.prototype,`type`,void 0),w([D()],B.prototype,`name`,void 0),w([D()],B.prototype,`value`,void 0),w([D()],B.prototype,`href`,void 0),w([D()],B.prototype,`target`,void 0),w([D()],B.prototype,`rel`,void 0),w([D()],B.prototype,`download`,void 0),w([D()],B.prototype,`form`,void 0),w([D({attribute:`formaction`})],B.prototype,`formAction`,void 0),w([D({attribute:`formenctype`})],B.prototype,`formEnctype`,void 0),w([D({attribute:`formmethod`})],B.prototype,`formMethod`,void 0),w([D({attribute:`formnovalidate`,type:Boolean})],B.prototype,`formNoValidate`,void 0),w([D({attribute:`formtarget`})],B.prototype,`formTarget`,void 0),w([O(`disabled`,{waitUntilFirstUpdate:!0})],B.prototype,`handleDisabledChange`,null),B=w([F(`SynButton`)],B),V=B}));export{H as n,V as t};