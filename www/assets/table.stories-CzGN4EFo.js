import{a as e,n as t}from"./chunk-DnJy8xQt.js";import{At as n,F as r,Ft as i,d as a,f as o,n as s,p as c,t as l,u}from"./iframe-CFxyVgYz.js";import{d,f,l as p,r as m,u as h}from"./blocks-D9zF8cJ1.js";import{t as g}from"./button-BmPxXsuW.js";import{t as _}from"./icon-BNvARCZB.js";import{n as v,r as y}from"./component-u4nxi-rq.js";import{n as b,t as x}from"./taggedTemplateLiteral-BuD1d7yP.js";import{n as S,t as C}from"./translations-DAKIivl3.js";var w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V;t((()=>{w=e(r(),1),f(),n(),l(),y(),S(),a(),c(),g(),_(),b(),k=(e,t=5)=>Array(t).fill(void 0).map(e),A=(e=void 0)=>{let t=e?`syn-table-cell--shadow-${e} shadow-cell`:``,n=n=>`${e===`end`&&n===0||e===`start`&&n===4||e===`bottom`?t:``}`;return i`
    <thead>
      <tr>
        <th class="${n(0)}">${C(`table.header.name`)}</th>
        <th class="${n(1)}">${C(`table.header.customer`)}</th>
        <th class="${n(2)}">${C(`table.header.location`)}</th>
        <th class="${n(3)}">${C(`table.header.contractStart`)}</th>
        <th class="${n(4)}"></th>
      </tr>
    </thead>
  `},j=(e=void 0)=>{let t=e?`syn-table-cell--shadow-${e} shadow-cell`:``,n=n=>`${e===`end`&&n===0||e===`start`&&n===4?t:``}`;return i`
    <tr>
      <td class="${n(0)}">${C(`table.body.name`)}</td>
      <td class="${n(1)}">${C(`table.body.customer`)}</td>
      <td class="${n(2)}">${C(`table.body.location`)}</td>
      <td class="${n(3)}">${C(`table.body.contractStart`)}</td>
...
`,N={parameters:{chromatic:{...s?.parameters?.chromatic,disableSnapshot:!1,modes:o},design:u(`16648-52486`),docs:{description:{component:v(`table`,`default`,`templates`)},page:()=>w.createElement(w.Fragment,null,w.createElement(d,null),w.createElement(h,null),w.createElement(m,null),w.createElement(p,{title:``})),story:{iframeHeight:550}}},tags:[`Structure`],title:`Templates/Table`},P={render:()=>{let e=k(()=>j());return i`
    ...
    `}},L={render:()=>{let e=k(()=>j(`end`));return i(T||=x([`
      ...
      <\/script>
    `]),A(`end`),e)}},R={render:()=>{let e=k(()=>j(`start`));return i(E||=x([`
      ...
      <\/script>
    `]),A(`start`),e)}},z={render:()=>{let e=k(()=>j());return i(D||=x([`
      ...
      <\/script>
    `]),A(`bottom`),e)}},B={render:()=>{let e=k(()=>M());return i(O||=x([`
