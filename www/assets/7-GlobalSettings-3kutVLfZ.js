import{j as e,M as p}from"./index-DojMhIpK.js";import{useMDXComponents as c}from"./index-CHrGa5Tm.js";import{I as a,e as m,s as g}from"./index-DY0LrIOm.js";import"./iframe-BMgzQnWK.js";import"./index-_2TAQcTa.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-BwkS7JH_.js";import"./index-DrFu-skq.js";function d(o){const t={a:"a",blockquote:"blockquote",br:"br",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",td:"td",tr:"tr",...c(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(p,{title:"Packages/Components/Configuring global settings"}),`
...
`,e.jsxs("table",{className:"syn-table--alternating syn-table--border",style:{width:"100%"},children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:e.jsx("syn-tooltip",{content:"The name of the component when rendered into the DOM",children:e.jsx(t.p,{children:"Component"})})}),e.jsx("th",{children:e.jsx("syn-tooltip",{content:"The class name of the component, used as a key in setGlobalSettings or setDefaultSettingsForElement",children:e.jsx(t.p,{children:"ClassName"})})}),e.jsx("th",{children:e.jsx("syn-tooltip",{content:"Supported settings for the component",children:e.jsx(t.p,{children:"Settings"})})}),e.jsx("th",{children:e.jsx("syn-tooltip",{content:"Copy to add the call code to the clipboard",children:e.jsx(t.p,{children:"Example"})})})]})}),e.jsx("tbody",{children:Object.values(a).map(n=>Object.keys(n)).flat().filter((n,i,r)=>r.indexOf(n)===i).sort().map(n=>{const i=m(n),r=g(n,{delimiter:"-"}),h=`setGlobalDefaultSettings({
  ...
  ${l}: {
    ${n}: ${typeof s=="object"?JSON.stringify(s,null,2):`'${s}'`},
          ...
          `.trim()).join(`,
  `)}
});`.trim();return e.jsxs(t.tr,{children:[e.jsx(t.td,{children:e.jsx(t.code,{children:`<${r}>`})}),e.jsx(t.td,{children:n}),e.jsx(t.td,{children:Object.entries(i).sort(([l],[s])=>l.localeCompare(s)).map(([l,s])=>e.jsxs(e.Fragment,{children:[e.jsx(t.strong,{children:l},`${n}--${l}--key`),":"," ",typeof s=="object"?JSON.stringify(s,null,2):s,e.jsx(t.br,{})]}))}),e.jsx(t.td,{children:e.jsx(t.code,{children:h})})]},`${n}--details`)})})]})]})}function D(o={}){const{wrapper:t}={...c(),...o.components};return t?e.jsx(t,{...o,children:e.jsx(d,{...o})}):d(o)}export{D as default};
