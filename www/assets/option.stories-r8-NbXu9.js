import{g as r}from"./preview-w2de4UgR.js";import{x as s}from"./lit-element-ZYWMe1i1.js";import{o as c}from"./select-CaFZU_ce.js";import{s as p,a as l,g as i,b as y,c as u}from"./component-B7uaMQbt.js";import"./index-DH5ua8nC.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon-button-9lkKz4Xt.js";import"./icon.component-Bqad2hdS.js";import"./directive-helpers-CkpR4LMI.js";import"./icon-DkXJLGU6.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-BhJsmGLR.js";const{args:m,argTypes:d}=p("syn-option"),{overrideArgs:f}=u("syn-option"),{generateTemplate:h}=l("syn-option"),T={args:f([{name:"default",type:"slot",value:"Option 1"},{name:"value",type:"attribute",value:"Option_1"}],m),argTypes:d,component:"syn-option",parameters:{design:r("5548-17028"),docs:{description:{component:i("option","default")},story:{height:"250px"}}},title:"Components/syn-option"},n={parameters:{docs:{description:{story:i("option","default")}}},render:a=>s`
  ...
  `},t=y({ScreenshotStory:_},{afterRender:c("syn-select"),heightPx:400});n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
