import{e as y}from"./class-map-C4GF1kIH.js";import{j as d,n as b,u as p}from"./iframe-BbG24dca.js";import{o as e}from"./if-defined-BDvKPKv0.js";import{c as h,n,S as v}from"./synergy-element-mvvDTlej.js";import{S as f,r as m}from"./icon.component-DiWeev-w.js";import{a as g}from"./query-DAIS6qJ0.js";import{e as $}from"./decorator-DeP7ND_N.js";const z=d`
	/* stylelint-disable */
  :host {
...
`;var S=Object.defineProperty,_=Object.getOwnPropertyDescriptor,r=(o,i,l,a)=>{for(var s=a>1?void 0:a?_(i,l):i,c=o.length-1,u;c>=0;c--)(u=o[c])&&(s=(a?u(i,l,s):u(s))||s);return a&&s&&S(i,l,s),s};let t=class extends v{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.size="inherit",this.color="currentColor",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleClick(o){this.disabled&&(o.preventDefault(),o.stopPropagation())}click(){this.button.click()}focus(o){this.button.focus(o)}blur(){this.button.blur()}render(){const o=!!this.href,i=o?b`a`:b`button`;return p`
      <${i}
        part="base"
        class=${y({"icon-button":!0,"icon-button--disabled":!o&&this.disabled,"icon-button--focused":this.hasFocus,"icon-button--small":this.size==="small","icon-button--medium":this.size==="medium","icon-button--large":this.size==="large"})}
