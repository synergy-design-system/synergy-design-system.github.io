import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,h as n,t as r}from"./lit-BVDl_-fF.js";import{_ as i,d as a,f as o,p as s}from"./iframe-Dn-tjrvc.js";import{_ as c,a as l,f as u,i as d,n as f,o as p,r as m,s as h,t as g,y as _}from"./synergy-element-D_jGE1Vc.js";import{n as v,t as y}from"./localize-CzgwcyM2.js";import{t as b}from"./button-DSjAtJ0E.js";import{t as x}from"./icon-DehYIkFS.js";import{a as S,i as C,n as w,o as T,r as E,t as D}from"./component-D_QZftXm.js";import{n as O,t as k}from"./taggedTemplateLiteral-pWa2IaV6.js";var A,j=e((()=>{r(),A=n`
	/* stylelint-disable */
  :host {
    --size: 128px;
    --track-width: 4px;
...
`})),P,F=e((()=>{r(),y(),h(),p(),f(),j(),N(),d(),P=class extends g{constructor(...e){super(...e),this.localize=new v(this),this.value=0,this.label=``}static{this.styles=[l,A,M]}updated(e){if(super.updated(e),e.has(`value`)){let e=parseFloat(getComputedStyle(this.indicator).getPropertyValue(`r`)),t=2*Math.PI*e,n=t-this.value/100*t;this.indicatorOffset=`${n}px`}}render(){return t`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
