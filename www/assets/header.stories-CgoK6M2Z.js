import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{a as t,d as n,o as r,s as i}from"./preview-DdzcclEm.js";import{c as a,t as o}from"./lit-BfcklOOD.js";import{t as s}from"./icon-8cT1hKpd.js";import{t as c}from"./divider-l4cO4h5w.js";import{a as l,i as u,n as d,o as f,r as p,t as m}from"./component-BjD7AuVi.js";import{n as h,t as g}from"./taggedTemplateLiteral-C9cDEsPD.js";import{t as _}from"./icon-button-BwypQmbv.js";import{t as v}from"./prio-nav-BtunjFzH.js";import{t as y}from"./nav-item-HZggPeZl.js";import{t as b}from"./header-BjbRhR4z.js";var x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R=e((()=>{c(),v(),y(),b(),s(),_(),o(),p(),r(),n(),h(),{args:S,argTypes:C}=u(`syn-header`),{overrideArgs:w}=l(`syn-header`),{generateTemplate:T}=f(`syn-header`),E={args:w([{name:`label`,type:`slot`,value:`<span slot="label">App Name</span>`}],S),argTypes:C,component:`syn-header`,parameters:{chromatic:{modes:i},design:t(`41163-318668`),docs:{description:{component:d(`header`,`default`)}}},tags:[`Application Shell`],title:`Components/syn-header`},D={parameters:{controls:{disable:!1},docs:{description:{story:d(`header`,`default`)}}},render:e=>T({args:e})},O={parameters:{docs:{description:{story:d(`header`,`label`)}}},render:()=>a`
    <syn-header label="A new label"></syn-header>
  `},k={parameters:{docs:{description:{story:d(`header`,`logo`)}}},render:()=>a`
  ...
  `},A={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:d(`header`,`focus`)}}},play:({canvasElement:e})=>{e.querySelector(`a`)?.focus()},render:()=>a`
    <style>
  ...
  `},j={parameters:{docs:{description:{story:d(`header`,`options`)}}},render:()=>a`
    <syn-header label="App Name">
  ...
  `},M={parameters:{docs:{description:{story:d(`header`,`options-with-dividers`)}}},render:()=>a`
    <syn-header label="App Name">
      <nav slot="meta-navigation">
  ...
  `},N={parameters:{docs:{description:{story:d(`header`,`navigation`)}}},render:()=>a(x||=g([`
    <syn-header label="App Name">
    ...
    <\/script>
  `]))},P={parameters:{docs:{description:{story:d(`header`,`burger-menu`)}}},render:()=>a`
    <syn-header burger-menu="closed" label="App Name">
    </syn-header>
  `},F={parameters:{docs:{description:{story:d(`header`,`sticky`)}}},render:()=>a`
