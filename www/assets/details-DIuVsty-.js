import{i as e}from"./preload-helper-xPQekRTU.js";import{Ht as t,It as n,qt as r}from"./iframe-CR7gJfd0.js";import{n as i,t as a}from"./class-map-CCgPnC9L.js";import{n as o,t as s}from"./localize-CzgwcyM2.js";import{a as c,f as l,i as u,n as d,o as f,r as p,s as m,t as h,y as g}from"./synergy-element-0B3h-xal.js";import{n as _,t as v}from"./watch-I6gMK-uE.js";import{n as y,t as b}from"./icon.component-Aw3v8b3f.js";import{n as x,t as S}from"./decorator-ChmomMqD.js";import{a as C,c as w,i as T,l as E,n as D,o as O,t as k}from"./animation-registry-CAtzdG-I.js";import{n as A,t as j}from"./event-gTfeuJtF.js";var M,N=e((()=>{n(),M=r`
  :host {
...
`})),P,F,I=e((()=>{O(),a(),D(),n(),s(),m(),j(),v(),f(),d(),y(),N(),x(),u(),P=class extends h{constructor(...e){super(...e),this.localize=new o(this),this.open=!1,this.disabled=!1,this.contained=!1,this.size=`medium`}static{this.styles=[c,M]}static{this.dependencies={"syn-icon":b}}firstUpdated(){this.body.style.height=this.open?`auto`:`0`,this.open&&(this.details.open=!0),this.detailsObserver=new MutationObserver(e=>{for(let t of e)t.type===`attributes`&&t.attributeName===`open`&&(this.details.open?this.show():this.hide())}),this.detailsObserver.observe(this.details,{attributes:!0})}disconnectedCallback(){super.disconnectedCallback(),this.detailsObserver?.disconnect()}handleSummaryClick(e){e.preventDefault(),this.disabled||(this.open?this.hide():this.show(),this.header.focus())}handleSummaryKeyDown(e){(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),this.open?this.hide():this.show()),(e.key===`ArrowUp`||e.key===`ArrowLeft`)&&(e.preventDefault(),this.hide()),(e.key===`ArrowDown`||e.key===`ArrowRight`)&&(e.preventDefault(),this.show())}async handleOpenChange(){if(this.open){if(this.details.open=!0,this.emit(`syn-show`,{cancelable:!0}).defaultPrevented){this.open=!1,this.details.open=!1;return}await E(this.body);let{keyframes:e,options:t}=k(this,`details.show`,{dir:this.localize.dir()});await C(this.body,w(e,this.body.scrollHeight),t),this.body.style.height=`auto`,this.emit(`syn-after-show`)}else{if(this.emit(`syn-hide`,{cancelable:!0}).defaultPrevented){this.details.open=!0,this.open=!0;return}await E(this.body);let{keyframes:e,options:t}=k(this,`details.hide`,{dir:this.localize.dir()});await C(this.body,w(e,this.body.scrollHeight),t),this.body.style.height=`auto`,this.details.open=!1,this.emit(`syn-after-hide`)}}async show(){if(!(this.open||this.disabled))return this.open=!0,A(this,`syn-after-show`)}async hide(){if(!(!this.open||this.disabled))return this.open=!1,A(this,`syn-after-hide`)}render(){return t`
    ...
    `}},p([l(`.details`)],P.prototype,`details`,void 0),p([l(`.details__header`)],P.prototype,`header`,void 0),p([l(`.details__body`)],P.prototype,`body`,void 0),p([l(`.details__expand-icon-slot`)],P.prototype,`expandIconSlot`,void 0),p([g({type:Boolean,reflect:!0})],P.prototype,`open`,void 0),p([g()],P.prototype,`summary`,void 0),p([g({type:Boolean,reflect:!0})],P.prototype,`disabled`,void 0),p([g({type:Boolean,reflect:!0})],P.prototype,`contained`,void 0),p([g({reflect:!0})],P.prototype,`size`,void 0),p([_(`open`,{waitUntilFirstUpdate:!0})],P.prototype,`handleOpenChange`,null),P=p([S(`SynDetails`)],P),F=P,T(`details.show`,{keyframes:[{height:`0`,opacity:`0`},{height:`auto`,opacity:`1`}],options:{duration:250,easing:`linear`}}),T(`details.hide`,{keyframes:[{height:`auto`,opacity:`1`},{height:`0`,opacity:`0`}],options:{duration:250,easing:`linear`}})})),L=e((()=>{I(),I(),F.define(`syn-details`)}));export{L as t};