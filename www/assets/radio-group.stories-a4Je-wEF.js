import"./preview-GxDBaHoI.js";import{x as n}from"./directive-helpers-po9zzQFH.js";import{u as p}from"./index-qbGBgNPy.js";import{s as h,a as f,g as o,b as S,c as O}from"./component-xlfJ1Ef6.js";import"./index-4g5l5LRQ.js";import"./_commonjsHelpers-4gQjN7DL.js";import"./icon.component-zhhcjNaa.js";import"./icon-button-IfN6SgYo.js";import"./icon-dZvNvrqy.js";import"./index-PPLHz8o0.js";import"./chunk-HJCNT6QR-AqqC_ZTT.js";import"./chunk-FJPRWHXQ-vmV3xKJL.js";import"./index-x-o9IySm.js";const{args:v,argTypes:k}=h("syn-radio-group"),{overrideArgs:T}=O("syn-radio-group"),{generateTemplate:x}=f("syn-radio-group"),I={args:v,argTypes:k,component:"radio-group",parameters:{docs:{description:{component:o("radio-group","default")}}},title:"Components/syn-radio-group"},a={args:T([{name:"label",type:"attribute",value:"This is a label"},{name:"default",type:"slot",value:`<syn-radio value="1">Option</syn-radio>
    <syn-radio value="2">Option</syn-radio>
    <syn-radio value="3">Option</syn-radio>`}],v),parameters:{controls:{disable:!1},docs:{description:{story:o("radio-group","default")}}},render:r=>x({args:r})},s={parameters:{docs:{description:{story:o("radio-group","labels")}}},render:()=>n`
  <syn-radio-group label="This is a label">
    <syn-radio value="1">Option</syn-radio>
    <syn-radio value="2">Option</syn-radio>
    <syn-radio value="3">Option</syn-radio>
  </syn-radio-group>`},t={parameters:{docs:{description:{story:o("radio-group","help-text")}}},render:()=>n`
  <syn-radio-group label="This is a label" help-text="This is the help-text" name="a">
    <syn-radio value="1">Option</syn-radio>
    <syn-radio value="2">Option</syn-radio>
    <syn-radio value="3">Option</syn-radio>
  </syn-radio-group>`},i={parameters:{docs:{description:{story:o("radio-group","disabled")}}},render:()=>n`
  <syn-radio-group label="This is a label" help-text="This is disabled" name="a">
    <syn-radio value="1">Option</syn-radio>
    <syn-radio value="2" disabled>Option</syn-radio>
    <syn-radio value="3">Option</syn-radio>
  </syn-radio-group>`},l={render:()=>n`
  <syn-radio-group label="This is a label" help-text="This is checked" name="a" value="2">
    <syn-radio value="1">Option</syn-radio>
    <syn-radio value="2">Option</syn-radio>
    <syn-radio value="3">Option</syn-radio>
  </syn-radio-group>`},d={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:o("radio-group","invalid")}}},play:async({canvasElement:r})=>{try{const e=r.querySelector("syn-button");e&&(await p.click(e),e.click())}catch(e){console.error("Error in play function:",e)}},render:()=>n`
