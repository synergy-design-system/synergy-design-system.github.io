import{n as e}from"./chunk-DnJy8xQt.js";import{E as t,It as n,Nt as r,Rt as i,T as a,Ut as o}from"./iframe-CkET12W3.js";import{n as s,t as c}from"./class-map-CFhFi09d.js";import{r as l,t as ee}from"./form-HkaLsLdT.js";import{r as te,t as u}from"./slot-BUy-JBM2.js";import{n as d,t as ne}from"./if-defined-XNov7IIP.js";import{n as re,t as ie}from"./localize-BO4uh8LG.js";import{a as f,i as ae,m as p,n as oe,o as se,p as m,r as h,s as ce,t as le,u as g}from"./synergy-element-CyJGxssW.js";import{n as _,t as v}from"./watch-0Lf6m-Da.js";import{n as ue,t as de}from"./icon.component-CAiF796B.js";import{n as fe,t as pe}from"./decorator-C8FY8E2M.js";import{a as y,i as b,l as x,n as me,o as he,t as S}from"./animation-registry-8j1MdtzW.js";import{n as C,t as ge}from"./event-BEe8X6yJ.js";import{n as _e,t as ve}from"./popup.component-DH7Nqvdv.js";import{n as ye,t as w}from"./form-control.styles-D2ULM1hW.js";import{a as T,i as E,n as D,o as O,r as k,s as A,t as j}from"./utility-CiY1illa.js";import{n as M,t as N}from"./tag.component-5YzxDlER.js";import{r as P,t as be}from"./scroll-C4nzmthm.js";var F,xe=e((()=>{r(),E(),F=o`
...
`})),I,L,R,z,B,V,H,U,W,G,K,q,Se=e((()=>{r(),a(),I=e=>Array.from(e.assignedElements({flatten:!0})),L=e=>e.tagName.toLocaleLowerCase()===`syn-option`?e:Array.from(e.querySelectorAll(`:scope > syn-option`)),R=e=>e.tagName.toLocaleLowerCase()===`syn-optgroup`,z=e=>e.map(L),B=e=>e.filter(R),V=e=>e.normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).toLowerCase(),H=e=>{let t=document.createElement(`div`);return n(e,t),t.firstElementChild},U=e=>e.tagName.toLocaleLowerCase()===`syn-option`?e:void 0,W=e=>{if(e){if(e instanceof HTMLElement)return U(e);if(typeof e==`string`)return U(H(i`${t(e)}`));if(Object.prototype.hasOwnProperty.call(e,`_$litType$`))return U(H(e))}},G=e=>{let{value:t}=e;return t==null||t===``?e.getTextLabel():t},K=e=>e.map(G),q=(e,t)=>{if(!t||e==null||e===``)return!1;let n=t.value,r=t.getTextLabel();return String(e)===String(n)||String(e)===r}})),J,Y,X=e((()=>{r(),J=e=>e,Y=(e,t)=>{if(!t)return e;let n=e.cloneNode(!0),r=n.getTextLabel();n.selected=e.selected;let i=r.toLowerCase().indexOf(t.toLowerCase()),a=n.innerHTML.indexOf(r),o=document.createElement(`mark`);o.textContent=r.slice(i,i+t.length),o.classList.add(`syn-highlight-style`);let s=r.replace(new RegExp(t,`i`),o.outerHTML),c=n.innerHTML.slice(0,a),l=n.innerHTML.slice(a+r.length);return n.innerHTML=c.concat(s,l),n}})),Z,Q,$=e((()=>{c(),ne(),r(),ce(),a(),he(),l(),me(),te(),ie(),ge(),v(),se(),ye(),oe(),ue(),_e(),O(),N(),xe(),Se(),be(),X(),fe(),D(),ae(),Z=class extends le{constructor(...e){super(...e),this.formControlController=new ee(this,{assumeInteractionOn:[`syn-blur`,`syn-input`]}),this.hasSlotController=new u(this,`help-text`,`label`),this.localize=new re(this),this.lastOptions=[],this.isInitialized=!1,this.isOptionRendererTriggered=!1,this.hasFocus=!1,this.isUserInput=!1,this.displayLabel=``,this.selectedOptions=[],this.numberFilteredOptions=0,this.cachedOptions=[],this.valueHasChanged=!1,this.hideOptions=!1,this.name=``,this._value=``,this.defaultValue=``,this.size=`medium`,this.placeholder=``,this.disabled=!1,this.readonly=!1,this.clearable=!1,this.open=!1,this.label=``,this.placement=`bottom`,this.helpText=``,this.form=``,this.required=!1,this.restricted=!1,this.multiple=!1,this.getOption=J,this.filter=(e,t)=>{let n=e?.textContent||``;e instanceof A&&(n=e.getTextLabel());let r=V(n),i=V(t);return r.includes(i)?!0:e?.value?.toString()===t},this.delimiter=` `,this.maxOptionsVisible=3,this.getTag=e=>i`
  ...
  `,this.calculateTagMaxWidth=e=>{let t=e.at(0);if(!t||!this.tagContainer)return;let n=t.contentRect.width,r=this.tagContainer.getBoundingClientRect().width,i=Math.max(85,r+n-48);this.tagContainer.style.setProperty(`--syn-select-tag-max-width`,`${i}px`)},this.handleDocumentFocusIn=e=>{let t=e.composedPath();this&&!t.includes(this)&&this.hide()},this.handleDocumentKeyDown=e=>{if(e.target.closest(`.combobox__clear`)===null){if(e.key===`Escape`&&(this.open&&!this.closeWatcher?(e.preventDefault(),e.stopPropagation(),this.hide(),this.displayInput.focus({preventScroll:!0})):this.open||(this.multiple?this.clearInputField():this.clearCombobox())),e.key===`Enter`){let t=this.getCurrentOption(),n=e.metaKey||e.ctrlKey||e.shiftKey||e.altKey;if(!this.open&&!n){setTimeout(()=>{e.defaultPrevented||this.formControlController.submit()});return}if(!this.open||t&&t.disabled)return;if(t){this.isUserInput=!0,this.valueHasChanged=!0;let e=this.lastOptions?K(this.lastOptions):[];this.multiple?this.toggleOptionSelection(t):this.setSelectedOptions(t),this.selectionChanged();let n=Array.isArray(this.value)?this.value:[this.value];this.updateComplete.then(()=>{this.isUserInput=!1}),j(e,n)||this.updateComplete.then(()=>{this.emit(`syn-input`),this.emit(`syn-change`)})}this.multiple||this.hide(),this.displayInput.focus({preventScroll:!0});return}[`ArrowUp`,`ArrowDown`].includes(e.key)&&(e.preventDefault(),e.stopPropagation(),this.open||this.show(),this.selectNextOption(e.key===`ArrowDown`)),[`Home`,`End`].includes(e.key)&&(e.preventDefault(),e.stopPropagation(),e.key===`Home`?this.displayInput.setSelectionRange(0,0):e.key===`End`&&this.displayInput.setSelectionRange(this.displayLabel.length,this.displayLabel.length))}},this.handleDocumentMouseDown=e=>{let t=e.composedPath();this&&!t.includes(this)&&this.hide()}}static{this.styles=[f,w,F]}static{this.dependencies={"syn-icon":de,"syn-popup":ve,"syn-tag":M}}get value(){return this._value}set value(e){this.multiple?Array.isArray(e)||(e=typeof e==`string`?e.split(this.delimiter):[e].filter(k)):e=Array.isArray(e)?e.join(this.delimiter):e,!j(this._value,e)&&(this.valueHasChanged=!0,this._value=e)}get validity(){return this.valueInput.validity}get validationMessage(){return this.valueInput.validationMessage}enableResizeObserver(){this.multiple&&(this.resizeObserver||=new ResizeObserver(this.calculateTagMaxWidth),this.resizeObserver.observe(this.displayInput))}connectedCallback(){super.connectedCallback(),this.mutationObserver=new MutationObserver(e=>{let t=e.some(e=>{if(!(e.target instanceof A)||e.type!==`attributes`||e.attributeName!==`value`)return!1;let t=e.target.getAttribute(`value`);return e.oldValue!==t&&!!t}),n=(this.restricted||this.multiple)&&e.some(e=>e.type!==`characterData`&&e.type!==`childList`?!1:this.selectedOptions.some(t=>t===e.target||t.contains(e.target)));t&&this.handleSlotContentChange(),n&&(this.multiple?this.readonly?this.displayLabel=this.selectedOptions.map(e=>e.getTextLabel()).join(`, `):this.requestUpdate():this.displayLabel=this.selectedOptions[0]?.getTextLabel?.()??this.displayLabel)}),this.mutationObserver.observe(this,{attributeFilter:[`value`],attributeOldValue:!0,attributes:!0,characterData:!0,childList:!0,subtree:!0}),setTimeout(()=>{this.handleSlotContentChange()}),this.open=!1}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect(),this.mutationObserver?.disconnect(),this.removeOpenListeners()}firstUpdated(){this.isInitialized=!0,this.formControlController.updateValidity()}updated(e){super.updated(e),e.has(`multiple`)&&(this.multiple?this.enableResizeObserver():this.resizeObserver?.disconnect())}willUpdate(e){super.willUpdate(e);let t=this.defaultValue==null||this.defaultValue===``||Array.isArray(this.defaultValue)&&this.defaultValue.length===0;if(e.has(`value`)&&t&&this.value&&!this.isUserInput&&(this.multiple&&Array.isArray(this.value)?this.defaultValue=this.value.join(this.delimiter):this.defaultValue=this.value,this.valueHasChanged=!1),!this.isInitialized&&e.has(`value`)&&this.value!==void 0&&e.has(`multiple`)&&this.multiple&&!Array.isArray(this.defaultValue)){let e=this.valueHasChanged;this.value=typeof this.defaultValue==`string`?this.defaultValue.split(this.delimiter):[this.defaultValue].filter(k),this.valueHasChanged=e}}attributeChangedCallback(e,t,n){if(super.attributeChangedCallback(e,t,n),e===`value`){let e=this.valueHasChanged;this.value=this.defaultValue,this.valueHasChanged=e}}get tags(){return this.selectedOptions.map((e,n)=>{if(n<this.maxOptionsVisible||this.maxOptionsVisible<=0){let r=this.getTag(e,n);return i`<div @syn-remove=${t=>this.handleTagRemove(t,e)}>
    ...
    `}},h([g(`.combobox`)],Z.prototype,`popup`,void 0),h([g(`.combobox__inputs`)],Z.prototype,`combobox`,void 0),h([g(`.combobox__display-input`)],Z.prototype,`displayInput`,void 0),h([g(`.combobox__value-input`)],Z.prototype,`valueInput`,void 0),h([g(`.combobox__listbox`)],Z.prototype,`listbox`,void 0),h([g(`slot:not([name])`)],Z.prototype,`defaultSlot`,void 0),h([g(`.combobox__tags`)],Z.prototype,`tagContainer`,void 0),h([m()],Z.prototype,`hasFocus`,void 0),h([m()],Z.prototype,`isUserInput`,void 0),h([m()],Z.prototype,`displayLabel`,void 0),h([m()],Z.prototype,`selectedOptions`,void 0),h([m()],Z.prototype,`numberFilteredOptions`,void 0),h([m()],Z.prototype,`cachedOptions`,void 0),h([m()],Z.prototype,`valueHasChanged`,void 0),h([m()],Z.prototype,`hideOptions`,void 0),h([p()],Z.prototype,`name`,void 0),h([m()],Z.prototype,`value`,null),h([p({attribute:`value`})],Z.prototype,`defaultValue`,void 0),h([p({reflect:!0})],Z.prototype,`size`,void 0),h([p()],Z.prototype,`placeholder`,void 0),h([p({reflect:!0,type:Boolean})],Z.prototype,`disabled`,void 0),h([p({reflect:!0,type:Boolean})],Z.prototype,`readonly`,void 0),h([p({type:Boolean})],Z.prototype,`clearable`,void 0),h([p({reflect:!0,type:Boolean})],Z.prototype,`open`,void 0),h([p()],Z.prototype,`label`,void 0),h([p({type:Number})],Z.prototype,`maxlength`,void 0),h([p({reflect:!0})],Z.prototype,`placement`,void 0),h([p({attribute:`help-text`})],Z.prototype,`helpText`,void 0),h([p({reflect:!0})],Z.prototype,`form`,void 0),h([p({reflect:!0,type:Boolean})],Z.prototype,`required`,void 0),h([p({reflect:!0,type:Boolean})],Z.prototype,`restricted`,void 0),h([p({reflect:!0,type:Boolean})],Z.prototype,`multiple`,void 0),h([p()],Z.prototype,`getOption`,void 0),h([p()],Z.prototype,`filter`,void 0),h([p()],Z.prototype,`delimiter`,void 0),h([p({attribute:`max-options-visible`,type:Number})],Z.prototype,`maxOptionsVisible`,void 0),h([p()],Z.prototype,`getTag`,void 0),h([_([`filter`,`getOption`],{waitUntilFirstUpdate:!0})],Z.prototype,`handlePropertiesChange`,null),h([_(`displayLabel`,{waitUntilFirstUpdate:!0})],Z.prototype,`handleDisplayInputValueChange`,null),h([_([`disabled`,`readonly`],{waitUntilFirstUpdate:!0})],Z.prototype,`handleDisabledChange`,null),h([_(`delimiter`)],Z.prototype,`handleDelimiterChange`,null),h([_([`defaultValue`,`value`,`delimiter`,`multiple`,`restricted`],{waitUntilFirstUpdate:!0})],Z.prototype,`handleValueChange`,null),h([_(`open`,{waitUntilFirstUpdate:!0})],Z.prototype,`handleOpenChange`,null),Z=h([pe(`SynCombobox`)],Z),Q=Z,b(`combobox.show`,{keyframes:[{opacity:0,scale:.9},{opacity:1,scale:1}],options:{duration:100,easing:`ease`}}),b(`combobox.hide`,{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.9}],options:{duration:100,easing:`ease`}})})),Ce=e((()=>{$(),$(),Q.define(`syn-combobox`)}));export{Y as n,X as r,Ce as t};