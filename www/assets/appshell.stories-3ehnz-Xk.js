import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{a as n,d as r,n as i,o as a,s as o,t as s}from"./preview-DXkhgu0Z.js";import{c,t as l}from"./lit-BfcklOOD.js";import{t as u}from"./react-DvlgmmzG.js";import{d,f,i as p,p as m,u as h}from"./blocks-Dyc7j8Lq.js";import{n as g,r as _}from"./component-B0n0ooCL.js";import{n as v,t as y}from"./taggedTemplateLiteral-C9cDEsPD.js";import{a as b,c as x,i as S,n as C,o as w,r as T,s as E,t as D}from"./appshell-B2W09voD.js";var O,k,A,j,M,N,P,F,I,L,R,z;t((()=>{O=e(u(),1),m(),l(),s(),_(),a(),x(),r(),v(),A={parameters:{chromatic:{...i?.parameters?.chromatic,disableSnapshot:!1,modes:o},design:n(`41127-616893`),docs:{description:{component:g(`application-shell`,`default`,`templates`)},page:()=>O.createElement(O.Fragment,null,O.createElement(f,null),O.createElement(d,null),O.createElement(p,null),O.createElement(h,{title:``})),story:{iframeHeight:550}}},tags:[`Application Shell`],title:`Templates/AppShell`},j={parameters:{docs:{description:{story:g(`application-shell`,`side-navigation`,`templates`)}}},render:()=>c`
  ...
  `},M={parameters:{docs:{description:{story:g(`application-shell`,`side-navigation-shrinking`,`templates`)}}},render:()=>c(k||=y([`
    <!-- .synergy-demo-application -->
    ...
    <\/script>
  `]),T(),w({noFocusTrapping:!0,open:!0}),S(),C(),b(),E(`appshell-shrink`),D(`appshell-shrink`))},N={name:`Rail Navigation (Desktop)`,parameters:{docs:{description:{story:g(`application-shell`,`rail-navigation-desktop`,`templates`)}}},render:()=>c`
    <!-- .synergy-demo-application -->
  ...
  `},P={...N,globals:{viewport:{value:`mobile2`}},name:`↳ Tablet`,parameters:{controls:{exclude:[`default`]},docs:{description:{story:g(`application-shell`,`rail-navigation-mobile`,`templates`)}}}},F={name:`Sticky Navigation (Desktop)`,parameters:{docs:{description:{story:g(`application-shell`,`sticky-navigation-desktop`,`templates`)}}},render:()=>c`
    <!-- .synergy-demo-application -->
  ...
  `},I={...F,globals:{viewport:{value:`mobile2`}},name:`↳ Tablet`,parameters:{controls:{exclude:[`default`]},docs:{description:{story:g(`application-shell`,`sticky-navigation-mobile`,`templates`)}}}},L={parameters:{docs:{description:{story:g(`application-shell`,`top-navigation`,`templates`)}}},render:()=>c`
    <!-- .synergy-demo-application -->
  ...
  `},R={parameters:{docs:{description:{story:g(`application-shell`,`alternative-background`,`templates`)}}},render:()=>c`
    <!-- .synergy-demo-application -->
