import{u as O,a as P,s as Z,i as L,x as A,e as B}from"./directive-helpers-dXnBnwbo.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function V(e){return l({...e,state:!0,attribute:!1})}function I(e,t){const s={waitUntilFirstUpdate:!1,...t};return(i,r)=>{const{update:n}=i,o=Array.isArray(e)?e:[e];i.update=function(a){o.forEach(u=>{const f=u;if(a.has(f)){const C=a.get(f),x=this[f];C!==x&&(!s.waitUntilFirstUpdate||this.hasUpdated)&&this[r](C,x)}}),n.call(this,a)}}}var H=Object.defineProperty,j=Object.getOwnPropertyDescriptor,$=(e,t,s,i)=>{for(var r=i>1?void 0:i?j(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(r=(i?o(t,s,r):o(r))||r);return i&&r&&H(t,s,r),r};class m extends Z{emit(t,s){const i=new CustomEvent(t,{bubbles:!0,cancelable:!1,composed:!0,detail:{},...s});return this.dispatchEvent(i),i}static{this.version="1.5.1"}static define(t,s=this,i={}){const r=customElements.get(t);if(!r){customElements.define(t,class extends s{},i);return}let n=" (unknown version)",o=n;"version"in s&&s.version&&(n=" v"+s.version),"version"in r&&r.version&&(o=" v"+r.version),!(n&&o&&n===o)&&console.warn(`Attempted to register <${t}>${n}, but <${t}>${o} has already been registered.`)}static{this.dependencies={}}constructor(){super(),Object.entries(this.constructor.dependencies).forEach(([t,s])=>{this.constructor.define(t,s)})}}$([l()],m.prototype,"dir",2);$([l()],m.prototype,"lang",2);let y="";function M(e){y=e}function U(e=""){if(!y){const t=[...document.getElementsByTagName("script")],s=t.find(i=>i.hasAttribute("data-synergy"));if(s)M(s.getAttribute("data-synergy"));else{const i=t.find(n=>/synergy(\.min)?\.js($|\?)/.test(n.src)||/synergy-autoloader(\.min)?\.js($|\?)/.test(n.src));let r="";i&&(r=i.getAttribute("src")),M(r.split("/").slice(0,-1).join("/"))}}return y.replace(/\/$/,"")+(e?`/${e.replace(/^\//,"")}`:"")}const D={name:"default",resolver:e=>U(`assets/icons/${e}.svg`)},S={add:`
