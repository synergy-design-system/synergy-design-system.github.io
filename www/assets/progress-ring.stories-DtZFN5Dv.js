import{h as x,x as a,g as S}from"./iframe-B7DfbYuR.js";import{L as k}from"./localize-Dh03wnLC.js";import{S as w,c as z,n as _}from"./synergy-element-VQU4slEB.js";import{a as R}from"./icon.component-Bzj-jGeV.js";import{a as C}from"./query-DAIS6qJ0.js";import"./button-CRN7mcJk.js";import"./icon-CvW2xKii.js";import{g as s,s as D,a as E,c as B,b as L}from"./component-Czukm7wJ.js";import"./preload-helper-Ct5FWWRu.js";import"./index-DihgwUfS.js";import"./watch-CEsCE2EF.js";import"./class-map-CPtZZnXt.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./if-defined-dp71bNGA.js";import"./spinner.component-XYyzj9LU.js";import"./decorator-DANECR0-.js";import"./functions-CDi3doZH.js";import"./index-Bkk0Z6Ex.js";import"./_docs-UXgsQIP6.js";const O=x`
	/* stylelint-disable */
  :host {
    --size: 128px;
    --track-width: 4px;
...
`;var T=Object.defineProperty,m=(r,t,d,y)=>{for(var e=void 0,v=r.length-1,h;v>=0;v--)(h=r[v])&&(e=h(t,d,e)||e);return e&&T(t,d,e),e};class g extends w{constructor(){super(...arguments),this.localize=new k(this),this.value=0,this.label=""}static{this.styles=[z,O,P]}updated(t){if(super.updated(t),t.has("value")){const d=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),y=2*Math.PI*d,e=y-this.value/100*y;this.indicatorOffset=`${e}px`}}render(){return a`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
