import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{B as n,Ht as r,It as i,f as a,g as o,n as s,t as c}from"./iframe-BLAzlACc.js";import{d as l,f as u,i as d,p as f,u as p}from"./blocks-vFyq5Z8H.js";import{t as m}from"./button-Ci1LHfIR.js";import{t as h}from"./icon-BFcjyE5U.js";import{n as g,r as _}from"./component-RhnClGwj.js";import{n as v,t as y}from"./taggedTemplateLiteral-pWa2IaV6.js";import{t as b}from"./button-group-JoQHBiXB.js";import{t as x}from"./tooltip-UfYeSrQE.js";import{t as S}from"./header-HO42rLb9.js";var C,w,T,E,D;e((()=>{C=t(n(),1),f(),i(),c(),m(),b(),S(),x(),h(),_(),o(),v(),T={parameters:{chromatic:{...s?.parameters?.chromatic,disableSnapshot:!1,modes:a},docs:{description:{component:g(`tooltip`,`default`,`templates`)},page:()=>C.createElement(C.Fragment,null,C.createElement(u,null),C.createElement(l,null),C.createElement(d,null),C.createElement(p,{title:``}))}},tags:[`Feedback`],title:`Templates/Tooltip`},E={parameters:{docs:{description:{story:g(`tooltip`,`single-instance`,`templates`)}}},render:()=>r(w||=y([`
