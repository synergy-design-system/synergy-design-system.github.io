import{e as _}from"./class-map-ObrBcWXB.js";import{H as g}from"./slot-9EVoRGQc.js";import{h as c,x as m}from"./iframe-DkuhNNKt.js";import{o as h}from"./if-defined-C0_zlWaf.js";import{S as f,c as y,n as d}from"./synergy-element-DwyHbzMO.js";import{a as v,S as x}from"./icon.component-0vAZ8ena.js";import{a as b}from"./query-DAIS6qJ0.js";import{w as S}from"./watch-CEsCE2EF.js";import{L as w}from"./localize-Dh03wnLC.js";const C=c`
	/* stylelint-disable */
  :host {
    display: inline-flex;
  }
...
`;var z=Object.defineProperty,T=Object.getOwnPropertyDescriptor,l=(s,r,e,a)=>{for(var t=a>1?void 0:a?T(r,e):r,i=s.length-1,n;i>=0;i--)(n=s[i])&&(t=(a?n(r,e,t):n(t))||t);return a&&t&&z(r,e,t),t};class o extends f{constructor(){super(...arguments),this.hasSlotController=new g(this,"prefix","suffix"),this.renderType="button",this.rel="noreferrer noopener"}static{this.styles=[y,C,$]}setRenderType(){const r=this.defaultSlot.assignedElements({flatten:!0}).filter(e=>e.tagName.toLowerCase()==="syn-dropdown").length>0;if(this.href){this.renderType="link";return}if(r){this.renderType="dropdown";return}this.renderType="button"}hrefChanged(){this.setRenderType()}handleSlotChange(){this.setRenderType()}render(){return m`
    ...
    `}}l([b("slot:not([name])")],o.prototype,"defaultSlot",2);l([v()],o.prototype,"renderType",2);l([d()],o.prototype,"href",2);l([d()],o.prototype,"target",2);l([d()],o.prototype,"rel",2);l([S("href",{waitUntilFirstUpdate:!0})],o.prototype,"hrefChanged",1);o.define("syn-breadcrumb-item");const A=c`
	/* stylelint-disable */
  .breadcrumb {
    display: flex;
    align-items: center;
...
`;var E=Object.defineProperty,u=(s,r,e,a)=>{for(var t=void 0,i=s.length-1,n;i>=0;i--)(n=s[i])&&(t=n(r,e,t)||t);return t&&E(r,e,t),t};class p extends f{constructor(){super(...arguments),this.localize=new w(this),this.separatorDir=this.localize.dir(),this.label=""}static{this.styles=[y,A,D]}static{this.dependencies={"syn-icon":x}}getSeparator(){const e=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[e,...e.querySelectorAll("[id]")].forEach(a=>a.removeAttribute("id")),e.setAttribute("data-default",""),e.slot="separator",e}handleSlotChange(){const r=[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>e.tagName.toLowerCase()==="syn-breadcrumb-item");r.forEach((e,a)=>{const t=e.querySelector('[slot="separator"]');t===null?e.append(this.getSeparator()):t.hasAttribute("data-default")&&t.replaceWith(this.getSeparator()),a===r.length-1?e.setAttribute("aria-current","page"):e.removeAttribute("aria-current")})}render(){return this.separatorDir!==this.localize.dir()&&(this.separatorDir=this.localize.dir(),this.updateComplete.then(()=>this.handleSlotChange())),m`
