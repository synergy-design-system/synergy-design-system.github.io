var On=Object.freeze,Wi=Object.defineProperty;var Dn=(t,e)=>On(Wi(t,"raw",{value:On(e||t.slice())}));import{R as f,d as ei,k as C,t as he,e as u,b as g,a as kt,f as Ui}from"./if-defined-98Biveud.js";import{i as h,k as p,D as ti,u as In,Q as qi,R as Ki}from"./directive-helpers-B-JxG5af.js";import{h as ni,$ as ii,r as ai,L as Gi,F as Ct,b as Yi,o as Xi,c as Nn,f as Qi,s as Ji,d as Zi,p as an,e as ea,g as ta,a as oi,k as na,K as ia,j as aa,i as oa,t as sa}from"./ref-DMm6gEez.js";import{s as ra}from"./chunk-L4EGOTBX-Mt8q4xcs.js";import"./entry-preview-CWKZl0rh.js";import{e as se,S as ut,d as An}from"./icon-button-BbSkJUKx.js";import{d as la}from"./index-ogSvIofg.js";import"./index-CYQpqK1Q.js";import{n as r,a as y}from"./library-UYMiFSYt.js";import{c as x,w as m,a as w,S as Te}from"./icon.component-B8-ou-E1.js";import"./icon-uC7Jxn_l.js";import{a as da}from"./index-Vx7n56Jp.js";const ca=h`
  :host {
    display: block;
  }
...
${gn.hideScriptTag?"":C(Zn||(Zn=Dn([`<script>
  window.component = document.querySelector("`,`");
<\/script>`])),t.tagName)}
`}function ci(t,e){const n=Ea(t,e);return`${n}`?.replaceAll(/\s+/g,"")!=""?C`<style>${n}</style>`:""}function Sa(t,e,n){const a=un(t),i={},o={},s={};return Object.keys(a).forEach(l=>{const d=a[l];if(d?.table?.category!=="attributes")return;const c=d.name,b=e[l],T=d.control.type==="boolean"?`?${c}`:c;(b!==a[l].defaultValue||gn.renderDefaultAttributeValues)&&(i[T]=b==="false"?!1:b)}),Object.keys(e).filter(l=>a[l]?.table?.category==="properties").forEach(l=>{if(l.startsWith("on"))return;const d=e[l];o[`.${l}`]=d}),Object.keys(e).filter(l=>!Object.keys(n||{}).includes(l)).forEach(l=>{!l.startsWith("on")&&typeof e[l]!="function"&&(s[l]=e[l])}),{attrOperators:i,propOperators:o,additionalAttrs:s}}function za(t,e){if(!t?.cssProperties?.length)return;const n=mn(t);return he(`style="${Object.keys(n).map(a=>{const i=n[a].name,o=e[a];return o?`${i}: ${o||""}`:null}).filter(a=>a!==null).join(";")}"`)}function Ea(t,e){const n=fn(t);if(!Object.keys(n).some(o=>!!e[o]))return;const i=Object.keys(n).filter(o=>o.endsWith("-part")).map(o=>{const s=n[o].name,l=e[o];return l?.replaceAll(/\s+/g,"")!==`${t?.tagName}::part(${s}){}`?`
${l}`:null}).filter(o=>o!==null).join(`
`);return i?he(`${i}
`):""}function $a(t,e){const n=yn(t);return he(`${Object.keys(n).filter(i=>i.endsWith("-slot")).map(i=>{const o=n[i].name,s=e[i];return o==="default"?s||null:s!==`<span slot="${o}"></span>`?s:null}).filter(i=>i!==null).join("")}`)}function Oa(t){Da(t),setTimeout(()=>{const e=document.querySelector(t.tagName);Ut?.observe(e,{attributes:!0})})}function Da(t){let e=!1;const n=Ta()[1],a=un(t);Ut||(Ut=new MutationObserver(i=>{i.forEach(o=>{if(o.type!=="attributes"||o.attributeName==="class"&&e)return;e=!0;const s=a[`${o.attributeName}`];s?.control==="boolean"||s?.control?.type==="boolean"?n({[`${o.attributeName}`]:o.target?.hasAttribute(o.attributeName||"")}):n({[`${o.attributeName}`]:o.target.getAttribute(o.attributeName||"")}),e=!1})}))}function Ia(t){window.__WC_STORYBOOK_HELPERS_CONFIG__=t}function pi(t){const e=window.__STORYBOOK_CUSTOM_ELEMENTS_MANIFEST__;if(!e)throw new Error(`Custom Elements Manifest not found. Be sure to follow the pre-install steps in this guide:
https://www.npmjs.com/package/wc-storybook-helpers#before-you-install`);const n=si(t,e),a=n?.events?.map(o=>o.name)||[],i=hi(n);return{args:ui(n),argTypes:i,reactArgs:Aa(n),reactArgTypes:mi(n),events:a,styleTemplate:o=>ci(n,o),template:(o,s)=>Ca(n,o,s,i)}}function hi(t){return{...mn(t),...fn(t),...yn(t),...un(t),...ga(t)}}function ui(t,e){return e||(e=hi(t)),Object.entries(e).filter(([,a])=>a?.control).map(([a,i])=>{let o=Na(i.defaultValue);return i.table?.category==="css properties"&&(o=o?.toString()),{[a]:o===void 0?"":o}}).reduce((a,i)=>({...a,...i}),{})}function Na(t){try{return JSON.parse(t)}catch{return t}}function mi(t){return{...ba(t),...ri(t),...mn(t,!1),...fn(t,!1),...yn(t,!1)}}function Aa(t){const e=ui(t,mi(t)),n=Object.entries(ri(t)).map(([a])=>({[a]:()=>{}})).reduce((a,i)=>({...a,...i}),{});return{...e,...n}}const{useParameter:Ma,addons:Pa,useEffect:La,useMemo:Pl}=__STORYBOOK_MODULE_PREVIEW_API__,{deprecate:ja}=__STORYBOOK_MODULE_CLIENT_LOGGER__;var Fa=Object.defineProperty,Va=(t,e)=>{for(var n in e)Fa(t,n,{get:e[n],enumerable:!0})},qt="themes",Ba=`storybook/${qt}`,Ha="theme",Pn={},Ra={REGISTER_THEMES:`${Ba}/REGISTER_THEMES`},Wa={};Va(Wa,{initializeThemeState:()=>yi,pluckThemeFromContext:()=>fi,useThemeParameters:()=>Ua});function fi({globals:t}){return t[Ha]||""}function Ua(t){return ja(la`The useThemeParameters function is deprecated. Please access parameters via the context directly instead e.g.
    - const { themeOverride } = context.parameters.themes ?? {};
    `),t?t.parameters[qt]??Pn:Ma(qt,Pn)}function yi(t,e){Pa.getChannel().emit(Ra.REGISTER_THEMES,{defaultTheme:e,themes:t})}var qa="html",Ln=t=>t.split(" ").filter(Boolean),Ka=({themes:t,defaultTheme:e,parentSelector:n=qa})=>(yi(Object.keys(t),e),(a,i)=>{let{themeOverride:o}=i.parameters[qt]??{},s=fi(i);return La(()=>{let l=o||s||e,d=document.querySelector(n);if(!d)return;Object.entries(t).filter(([b])=>b!==l).forEach(([b,T])=>{let Y=Ln(T);Y.length>0&&d.classList.remove(...Y)});let c=Ln(t[l]);c.length>0&&d.classList.add(...c)},[o,s]),a()}),Ga={mobile1:{name:"Small mobile",styles:{height:"568px",width:"320px"},type:"mobile"},mobile2:{name:"Large mobile",styles:{height:"896px",width:"414px"},type:"mobile"},tablet:{name:"Tablet",styles:{height:"1112px",width:"834px"},type:"tablet"}};function U(t,e,n){return new Promise(a=>{if(n?.duration===1/0)throw new Error("Promise-based animations must be finite.");const i=t.animate(e,{...n,duration:Ya()?0:n.duration});i.addEventListener("cancel",a,{once:!0}),i.addEventListener("finish",a,{once:!0})})}function jn(t){return t=t.toString().toLowerCase(),t.indexOf("ms")>-1?parseFloat(t):t.indexOf("s")>-1?parseFloat(t)*1e3:parseFloat(t)}function Ya(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Z(t){return Promise.all(t.getAnimations().map(e=>new Promise(n=>{e.cancel(),requestAnimationFrame(n)})))}function Fn(t,e){return t.map(n=>({...n,height:n.height==="auto"?`${e}px`:n.height}))}const bi=new Map,ln=new WeakMap;function gi(t){return t??{keyframes:[],options:{duration:0}}}function Vn(t,e){return e.toLowerCase()==="rtl"?{keyframes:t.rtlKeyframes||t.keyframes,options:t.options}:t}function S(t,e){bi.set(t,gi(e))}function Vt(t,e,n){ln.set(t,{...ln.get(t),[e]:gi(n)})}function j(t,e,n){const a=ln.get(t);if(a?.[e])return Vn(a[e],n.dir);const i=bi.get(e);return i?Vn(i,n.dir):{keyframes:[],options:{duration:0}}}class J{constructor(e,...n){this.slotNames=[],this.handleSlotChange=a=>{const i=a.target;(this.slotNames.includes("[default]")&&!i.name||i.name&&this.slotNames.includes(i.name))&&this.host.requestUpdate()},(this.host=e).addController(this),this.slotNames=n}hasDefaultSlot(){return[...this.host.childNodes].some(e=>{if(e.nodeType===e.TEXT_NODE&&e.textContent.trim()!=="")return!0;if(e.nodeType===e.ELEMENT_NODE){const n=e;if(n.tagName.toLowerCase()==="syn-visually-hidden")return!1;if(!n.hasAttribute("slot"))return!0}return!1})}hasNamedSlot(e){return this.host.querySelector(`:scope > [slot="${e}"]`)!==null}test(e){return e==="[default]"?this.hasDefaultSlot():this.hasNamedSlot(e)}hostConnected(){this.host.shadowRoot.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener("slotchange",this.handleSlotChange)}}function vi(t){if(!t)return"";const e=t.assignedNodes({flatten:!0});let n="";return[...e].forEach(a=>{a.nodeType===Node.TEXT_NODE&&(n+=a.textContent)}),n}const wi={$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(t,e)=>`Go to slide ${t} of ${e}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:t=>t===0?"No options selected":t===1?"1 option selected":`${t} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:t=>`Slide ${t}`,toggleColorFormat:"Toggle color format",closeMenu:"Close menu",danger:"Danger",fileButtonText:"Choose file",fileButtonTextMultiple:"Choose files",folderButtonText:"Choose folder",fileDragDrop:"Drop or choose file",folderDragDrop:"Drop or choose folder",menu:"Menu",notification:"Notification",numFilesSelected:(t,e)=>t===0?`No ${e?"folder":"files"} chosen`:`${t} files`,openMenu:"Open menu",rangeMax:"Maximum",rangeMin:"Minimum",sideNav:"Side navigation",success:"Success",warning:"Warning"};ai(wi);class R extends Gi{static{ai(wi)}}function Q(t,e){return new Promise(n=>{function a(i){i.target===t&&(t.removeEventListener(e,a),n())}t.addEventListener(e,a)})}const Xa=h`
	/* stylelint-disable */
  :host {
    display: contents;
...
`;var no=Object.defineProperty,io=Object.getOwnPropertyDescriptor,xi=(t,e,n,a)=>{for(var i=a>1?void 0:a?io(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&no(e,n,i),i};let zt=class extends w{constructor(){super(...arguments),this.localize=new R(this),this.variant="primary"}render(){return p`
      <span
        part="base"
    ...
    `}};zt.styles=[x,eo,to];xi([r({reflect:!0})],zt.prototype,"variant",2);zt=xi([se("SynBadge")],zt);zt.define("syn-badge");const ao=h`
	/* stylelint-disable */
  :host {
    display: inline-flex;
  }
...
`;var ko=Object.defineProperty,_o=(t,e,n,a)=>{for(var i=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=s(e,n,i)||i);return i&&ko(e,n,i),i};class Ti extends w{constructor(){super(...arguments),this.hasSlotController=new J(this,"footer","header","image"),this.sharp=!1}static{this.styles=[x,wo,xo]}render(){return p`
      <div
        part="base"
    ...
    `}}_o([r({type:Boolean,reflect:!0})],Ti.prototype,"sharp");Ti.define("syn-card");const rt=(t="value")=>(e,n)=>{const a=e.constructor,i=a.prototype.attributeChangedCallback;a.prototype.attributeChangedCallback=function(o,s,l){const d=a.getPropertyOptions(t),c=typeof d.attribute=="string"?d.attribute:t;if(o===c){const b=d.converter||In,Y=(typeof b=="function"?b:b?.fromAttribute??In.fromAttribute)(l,d.type);this[t]!==Y&&(this[n]=Y)}i.call(this,o,s,l)}},Fe=h`
	/* stylelint-disable */
...
`;var ds=Object.defineProperty,cs=Object.getOwnPropertyDescriptor,Ei=(t,e,n,a)=>{for(var i=a>1?void 0:a?cs(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&ds(e,n,i),i};class Ye extends w{constructor(){super(...arguments),this.vertical=!1}static{this.styles=[x,rs,ls]}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}}Ei([r({type:Boolean,reflect:!0})],Ye.prototype,"vertical",2);Ei([m("vertical")],Ye.prototype,"handleVerticalChange",1);Ye.define("syn-divider");function qn(t){return t.charAt(0).toUpperCase()+t.slice(1)}const ps=h`
	/* stylelint-disable */
  :host {
    --size: 25rem;
    --header-spacing: var(--syn-spacing-large);
...
`;var _s=Object.defineProperty,Ts=Object.getOwnPropertyDescriptor,Qt=(t,e,n,a)=>{for(var i=a>1?void 0:a?Ts(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&_s(e,n,i),i};class Nt extends w{constructor(){super(...arguments),this.hasSlotController=new J(this,"[default]","logo","label","meta-navigation","navigation"),this.localize=new R(this),this.label="",this.burgerMenu="hidden"}static{this.styles=[x,ks]}static{this.dependencies={"syn-icon":Te}}toggleBurgerMenu(){switch(this.burgerMenu){case"closed":this.burgerMenu="open";break;case"open":this.burgerMenu="closed";break}}handleBurgerMenuToggle(){this.sideNav&&!this.sideNav.rail&&(this.sideNav.open=!this.sideNav.open),this.toggleBurgerMenu()}updateBurgerMenuBasedOnSideNav(){this.sideNav&&(this.sideNav.rail?this.burgerMenu="hidden":this.burgerMenu=this.sideNav.open?"open":"closed")}handleBurgerMenu(){const e=`syn-burger-menu-${this.burgerMenu}`;this.emit(e)}connectedCallback(){super.connectedCallback(),this.mutationObserver=new MutationObserver(()=>this.updateBurgerMenuBasedOnSideNav())}firstUpdated(){this.updateComplete.then(()=>{const e=document.querySelector("syn-side-nav");this.connectSideNavigation(e)})}disconnectedCallback(){super.disconnectedCallback(),this.mutationObserver.disconnect()}connectSideNavigation(e){this.mutationObserver.disconnect(),this.sideNav=e||document.querySelector("syn-side-nav"),this.sideNav&&(this.updateBurgerMenuBasedOnSideNav(),this.mutationObserver.observe(this.sideNav,{attributeFilter:["open","rail"],attributes:!0}))}render(){const e=this.hasSlotController.test("navigation"),n=this.burgerMenu!=="hidden";return C`
    ...
    `}}Qt([r()],Nt.prototype,"label",2);Qt([r({attribute:"burger-menu",reflect:!0})],Nt.prototype,"burgerMenu",2);Qt([y()],Nt.prototype,"sideNav",2);Qt([m("burgerMenu",{waitUntilFirstUpdate:!0})],Nt.prototype,"handleBurgerMenu",1);Nt.define("syn-header");class Cs extends ii{constructor(e){if(super(e),this.handlePointerDown=n=>{n.button!==0||this.host.disabled||this.spinOnLongPressCallback(n)},this.handlePointerUp=n=>{n?.preventDefault(),n?.stopPropagation(),this.timeout&&this.callbacks.start(),this.stopSpinningAndCleanUp(),this.callbacks.end(),document.removeEventListener("pointerup",this.handlePointerUp)},e.type!==Ui.ELEMENT||!(e.element instanceof HTMLButtonElement))throw new Error("The `longPress` directive must be used on an HTMLButtonElement.")}render(e){return ti}update(e,[n]){return this.callbacks===void 0&&this.host===void 0&&(this.host=e.element,this.callbacks={...n},this.host.addEventListener("pointerdown",this.handlePointerDown)),Ki}disconnected(){this.stopSpinningAndCleanUp(),this.host.removeEventListener("pointerdown",this.handlePointerDown),document.removeEventListener("pointerup",this.handlePointerUp)}spinOnLongPressCallback(e){e.preventDefault(),e.stopPropagation(),this.timeout=setTimeout(()=>{this.timeout=void 0,this.interval=setInterval(()=>{this.callbacks.start()},50)},500),document.addEventListener("pointerup",this.handlePointerUp),this.observer?.disconnect(),this.observer=new MutationObserver(n=>{n.forEach(a=>{a.attributeName==="disabled"&&this.stopSpinningAndCleanUp()})}),this.observer.observe(this.host,{attributes:!0})}stopSpinningAndCleanUp(){clearInterval(this.interval),clearTimeout(this.timeout),this.observer?.disconnect()}}const Kn=ei(Cs),Ss=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`;var Bs=Object.defineProperty,$i=(t,e,n,a)=>{for(var i=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=s(e,n,i)||i);return i&&Bs(e,n,i),i};class Jt extends w{constructor(){super(...arguments),this.hasMenuItemsWithCheckmarks=!1,this.updateCheckMarksByChildPropChange=e=>{e.stopImmediatePropagation(),this.handleUpdateCheckmarks(this.getAllItems())}}static{this.styles=[x,Fs,Vs]}handleUpdateCheckmarks(e){this.hasMenuItemsWithCheckmarks=e.some(n=>n.type==="checkbox"||n.loading)}disconnectedCallback(){this.removeEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu"),this.addEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}handleClick(e){const n=["menuitem","menuitemcheckbox"],a=e.composedPath(),i=a.find(d=>n.includes(d?.getAttribute?.("role")||""));if(!i||a.find(d=>d?.getAttribute?.("role")==="menu")!==this)return;const l=i;l.type==="checkbox"&&(l.checked=!l.checked),this.emit("syn-select",{detail:{item:l}})}handleKeyDown(e){if(e.key==="Enter"||e.key===" "){const n=this.getCurrentItem();e.preventDefault(),e.stopPropagation(),n?.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(e.key)){const n=this.getAllItems(),a=this.getCurrentItem();let i=a?n.indexOf(a):0;n.length>0&&(e.preventDefault(),e.stopPropagation(),e.key==="ArrowDown"?i++:e.key==="ArrowUp"?i--:e.key==="Home"?i=0:e.key==="End"&&(i=n.length-1),i<0&&(i=n.length-1),i>n.length-1&&(i=0),this.setCurrentItem(n[i]),n[i].focus())}}handleMouseDown(e){const n=e.target;this.isMenuItem(n)&&this.setCurrentItem(n)}handleSlotChange(){const e=this.getAllItems();this.handleUpdateCheckmarks(e),e.length>0&&this.setCurrentItem(e[0])}isMenuItem(e){return e.tagName.toLowerCase()==="syn-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes(e.getAttribute("role")??"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>!(e.inert||!this.isMenuItem(e)))}getCurrentItem(){return this.getAllItems().find(e=>e.getAttribute("tabindex")==="0")}setCurrentItem(e){this.getAllItems().forEach(a=>{a.setAttribute("tabindex",a===e?"0":"-1")})}render(){return p`
      ...
      ></slot>
    `}}$i([u("slot")],Jt.prototype,"defaultSlot");$i([y()],Jt.prototype,"hasMenuItemsWithCheckmarks");Jt.define("syn-menu");const Hs=h`
  /**
...
`;var tr=Object.defineProperty,_n=(t,e,n,a)=>{for(var i=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=s(e,n,i)||i);return i&&tr(e,n,i),i};class en extends w{constructor(){super(...arguments),this.localize=new R(this),this.value=0,this.indeterminate=!1,this.label=""}static{this.styles=[x,Zs,er]}render(){return p`
      ...
      >
        <div part="indicator" class="progress-bar__indicator" style=${aa({width:`${this.value}%`})}>
...
`;var br=Object.defineProperty,gr=(t,e,n,a)=>{for(var i=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=s(e,n,i)||i);return i&&br(e,n,i),i};class Oi extends w{constructor(){super(...arguments),this.subdivision=!1}static{this.styles=[x,yr]}render(){return p`
      <div
    ...
    `}}gr([r({reflect:!0,type:Boolean})],Oi.prototype,"subdivision");Oi.define("syn-range-tick");const vr=h`
	/* stylelint-disable */
  :host {
    --max-width: 20rem;
    --hide-delay: 0ms;
...
`;var Tr=Object.defineProperty,Cr=Object.getOwnPropertyDescriptor,Ii=t=>{throw TypeError(t)},te=(t,e,n,a)=>{for(var i=a>1?void 0:a?Cr(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&Tr(e,n,i),i},Tn=(t,e,n)=>e.has(t)||Ii("Cannot "+n),v=(t,e,n)=>(Tn(t,e,"read from private field"),n?n.call(t):e.get(t)),nt=(t,e,n)=>e.has(t)?Ii("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,n),ge=(t,e,n,a)=>(Tn(t,e,"write to private field"),e.set(t,n),n),V=(t,e,n)=>(Tn(t,e,"access private method"),n),M,ie,$t,dt,Ht,at,O,Ot,Cn,Ni,Sn,Ai,Mi,Rt,Pt,Lt,Pi,Li,ft,ji,Fi,Vi;let K=class extends w{constructor(){super(),nt(this,O),this.name="",this.label="",this.helpText="",this.disabled=!1,this.min=0,this.max=100,this.step=1,this.size="medium",this.tooltipPlacement="top",this.restrictMovement=!1,this.defaultValue="0",this.form="",this.hasSlotController=new J(this,"help-text","label","prefix","suffix","ticks"),this.formControlController=new Me(this,{assumeInteractionOn:["syn-change"]}),this.localize=new R(this),nt(this,M,[0]),nt(this,ie,new Map),nt(this,$t,!1),nt(this,dt,""),nt(this,Ht),nt(this,at,[]),this.tooltipFormatter=this.localize.number.bind(this.localize)}set value(t){ge(this,M,t?t.split(" ").map(e=>+e).sort(it):[])}get value(){return v(this,M).slice().sort(it).join(" ")}set valueAsArray(t){const e=v(this,M);ge(this,M,Array.isArray(t)?t.slice().sort(it):t||[]),Et(e,v(this,M))&&this.requestUpdate("value",e.join(" "))}get valueAsArray(){return[...v(this,M)].sort(it)}disconnectedCallback(){super.disconnectedCallback(),this?.visibilityObserver?.disconnect()}firstUpdated(){this.visibilityObserver=new IntersectionObserver(t=>{const e=t.at(0);e&&e.isIntersecting&&e.target.checkVisibility()&&V(this,O,Vi).call(this,e.boundingClientRect.height)},{root:this.ticks.parentElement}),this.visibilityObserver.observe(this.ticks),this.formControlController.updateValidity(),ge(this,at,Array.from(v(this,M))),this.thumbs.forEach(t=>{const e=t.parentElement;e.updateComplete.then(()=>{e.shadowRoot.querySelector(".tooltip__body")?.setAttribute("aria-hidden","true")})})}willUpdate(t){super.willUpdate(t),this.min>this.max&&([this.min,this.max]=[this.max,this.min]),this.step>this.max-this.min&&(this.step=this.max-this.min),this.step<=0&&(this.step=1);const e=v(this,M).map(n=>{if(n<=this.min)return this.min;if(n>=this.max)return this.max;const a=this.min+this.step*Math.round((n-this.min)/this.step);return a>this.max?this.max:a});Et(v(this,M),e)&&ge(this,M,e)}updated(t){super.updated(t);for(const e of this.thumbs){const n=+e.dataset.rangeId;v(this,ie).has(n)&&V(this,O,Pt).call(this,e,v(this,ie).get(n))}V(this,O,Lt).call(this)}focus(t){const e=this.thumbs.item(0);e?e.focus(t):super.focus(t)}checkValidity(){if(this.disabled)return!0;const t=!v(this,dt);return t||this.formControlController.emitInvalidEvent(),t}reportValidity(){if(this.disabled)return!0;const t=this.validity.valid;return this.formControlController.setValidity(t),this.validationInput.hidden=!0,clearTimeout(v(this,Ht)),t||(this.validationInput.hidden=!1,this.validationInput.reportValidity(),ge(this,Ht,setTimeout(()=>{this.validationInput.hidden=!0},1e4))),t}setCustomValidity(t){ge(this,dt,t),this.validationInput.setCustomValidity(t),this.formControlController.updateValidity()}getForm(){return this.formControlController.getForm()}get validity(){return v(this,dt)?ki:It}get validationMessage(){return v(this,dt)}renderThumbs(t){const e=v(this,M).length>1;return v(this,ie).clear(),v(this,M).map((n,a)=>{const i=a+1;v(this,ie).set(i,n);const o=`thumb-${i}`;let s="",l="";return e?(l=t?`label aria-label-hidden ${o}`:`aria-label-hidden ${o}`,a===0?s=`${this.localize.term("rangeMin")} (${this.tooltipFormatter(n)})`:a===v(this,M).length-1?s=`${this.localize.term("rangeMax")} (${this.tooltipFormatter(n)})`:s=this.tooltipFormatter(n)):l=t?"label aria-label-hidden":"",p`
        ...
        >
          <div
            ...
            role="slider"
            tabindex="${this.disabled?-1:0}"
            @pointerdown=${V(this,O,Ai)}
            @pointermove=${V(this,O,Mi)}
...
`):a=e.innerHTML,a=a.replace(/<style><\/style>/g,"").replace(/<!-- preview-ignore:start -->[\s\S]*?<!-- preview-ignore:end -->/g,"").replace(/\/\/ preview-ignore:start[\s\S]*?\/\/ preview-ignore:end/g,"").replace(/<style>\n<\/style>/g,"").replace(/<script>\s*component = document\.querySelector\('(.+?)'\);\s*<\/script>/g,""),a}},Vl=(t,e)=>{const n=An?.components?.[t]?.[e]?.description?.value??"No Description",a=An?.components?.[t]?.[e]?.note?.value??"",i=n.replace(/\n/g,"<br/>"),o=a.length>0?`

  > **👨‍💻 Additional developer Information**:<br>
  > ${a.replace(/\n/g,"<br/>")}`:a;return`${i}${o}`},Bl=(t,e=150)=>{const n=isNaN(e)?e:{heightPx:e},{afterRender:a="",additionalChromaticOptions:i={},heightPx:o=150,styleHeading:s={}}=n,l=Object.entries(s).map(([d,c])=>`${d}: ${c};`).join(" ");return{parameters:{chromatic:{...Ri?.parameters?.chromatic,...i,disableSnapshot:!1},docs:{disable:!0}},render:(d,c)=>C`
      ...
      `})}
      ${a}
    `}};export{bl as a,ct as b,Fl as c,Bl as d,jl as e,Vl as g,Ll as h,ml as i,Ri as p,hn as s};
