import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-DRz18Lsn.js";import{c as i,t as a}from"./lit-D4-0ovri.js";import{t as o}from"./input-DeuiTlMk.js";import{a as s,i as c,n as l,o as u,r as d,t as f}from"./component-NnlguzJ1.js";import{t as p}from"./fieldset-Bj06nad1.js";var m=t({Default:()=>x,Disabled:()=>w,OneColumnLayout:()=>S,Screenshot:()=>T,TwoColumnLayout:()=>C,__namedExportsOrder:()=>E,default:()=>b}),h,g,_,v,y,b,x,S,C,w,T,E;function D(){return(D=e((()=>{p(),o(),a(),d(),r(),{args:h,argTypes:g}=c(`syn-fieldset`),{overrideArgs:_}=s(`syn-fieldset`),{generateTemplate:v}=u(`syn-fieldset`),y=(e=3,t=!0)=>Array.from({length:e},(e,n)=>t?i`<syn-input name="item-${n+1}" label="Item ${n+1}"></syn-input>\n`:`<syn-input name="item-${n+1}" label="Item ${n+1}"></syn-input>`),b={args:_([{name:`layout`,type:`attribute`,value:`two-columns`},{name:`legend`,type:`attribute`,value:`Legend`},{name:`description`,type:`attribute`,value:`Description text for the fieldset. This is optional and can be used to provide additional information about the fieldset.`},{name:`default`,type:`slot`,value:y(6,!1).map(String).join(`
`)}],h),argTypes:g,component:`syn-fieldset`,parameters:{chromatic:{modes:n},docs:{description:{component:l(`fieldset`,`default`)}}},tags:[`Form`,`Structure`],title:`Components/syn-fieldset`},x={parameters:{controls:{disable:!1},docs:{description:{story:l(`fieldset`,`default`)}}},render:e=>v({args:e})},S={parameters:{controls:{disable:!1},docs:{description:{story:l(`fieldset`,`one-column-layout`)}}},render:()=>i`
  ...
  `},C={parameters:{controls:{disable:!1},docs:{description:{story:l(`fieldset`,`two-column-layout`)}}},render:()=>i`
    <syn-fieldset
      description="For container widths ≥ 640px"
      layout="two-columns"
  ...
  `},w={parameters:{controls:{disable:!1},docs:{description:{story:l(`fieldset`,`disabled`)}}},render:()=>i`
    <syn-fieldset
      disabled
      layout="two-columns"
  ...
  `},T=f({Default:x,OneColumnLayout:S,TwoColumnLayout:C,Disabled:w},750),E=[`Default`,`OneColumnLayout`,`TwoColumnLayout`,`Disabled`,`Screenshot`],x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  TwoColumnLayout,
  Disabled
}, 750)`,...T.parameters?.docs?.source}}}})))()}export{m as n,D as r,x as t};