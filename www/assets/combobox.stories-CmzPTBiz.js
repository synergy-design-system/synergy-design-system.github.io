import{n as e}from"./chunk-DnJy8xQt.js";import{E as t,Nt as n,Rt as r,T as i,d as a,f as ee,g as o,u as s}from"./iframe-DVxLZS-s.js";import{t as c}from"./button-Bh72Wntz.js";import{t as l}from"./icon-B6NqE4U1.js";import{a as te,i as ne,n as u,o as d,r as f,t as p}from"./component-DniQwiZV.js";import{n as m,t as h}from"./PaddingDecorator-B1LMzAPw.js";import{n as g,t as _}from"./taggedTemplateLiteral-BuD1d7yP.js";import{n as v,r as y,t as re}from"./combobox-Bu3SCBYq.js";import{t as ie}from"./option-C_9nm3-W.js";import{t as ae}from"./optgroup-A6kZutxo.js";var b,oe,se,ce,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{re(),c(),l(),ie(),ae(),n(),i(),y(),f(),a(),h(),o(),g(),{userEvent:b}=__STORYBOOK_MODULE_TEST__,{args:x,argTypes:S}=ne(`syn-combobox`),{overrideArgs:C}=te(`syn-combobox`),{generateTemplate:w}=d(`syn-combobox`),T={args:x,argTypes:S,component:`syn-combobox`,parameters:{chromatic:{modes:ee},design:s(`42207-352063`),docs:{description:{component:u(`combobox`,`default`)},story:{height:`250px`}}},tags:[`Form`],title:`Components/syn-combobox`},E=[`Yellow`,`Light Green`,`Grey`,`Green`,`Blue`,`Red`,`Orange`,`Magenta`,`White`,`Purple`,`Pink`,`Black`,`Brown`].sort(),D=e=>`<syn-option value="${e.replaceAll(` `,`_`)}">${e}</syn-option>`,O=e=>t(D(e)),k=()=>E.map(D),A=()=>t(k().join(`
