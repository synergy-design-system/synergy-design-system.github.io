import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t,l as n}from"./preview-DRz18Lsn.js";import{c as r,t as i}from"./lit-D4-0ovri.js";import{t as a}from"./icon-BbsmBxau.js";import{a as o,i as s,n as c,r as l,t as u}from"./component-NnlguzJ1.js";import{n as d,t as f}from"./PaddingDecorator-Dx4_2Fla.js";import{n as p,t as m}from"./styles-KYqa9_e7.js";var h,g,_,v,y,b,x,S,C,w,T,E,D;function O(){return(O=e((()=>{i(),l(),m(),a(),f(),n(),{args:h,argTypes:g}=s(`syn-link`),{overrideArgs:_}=o(`syn-link`),v={args:_([{name:`default`,type:`slot`,value:`Link label`},{name:`syn-link`,type:`attribute`,value:`syn-link--medium`}],h),argTypes:g,component:`syn-link`,parameters:{chromatic:{modes:t},docs:{description:{component:c(`styles`,`link`)}}},tags:[`Navigation`,`Styles`],title:`Styles/syn-link`},y={parameters:{controls:{disable:!1}},render:e=>p(e,`a`,{class:`syn-link`,href:`javascript:void(0)`})},b={parameters:{docs:{description:{story:c(`link`,`inline`)}}},render:()=>r`
    <p style="width: 266px;">
  ...
  `},E=u({Default:y,Inline:b,PrefixSuffixIcons:x,Quiet:S,Disabled:C,Focus:w,Size:T}),D=[`Default`,`Inline`,`PrefixSuffixIcons`,`Quiet`,`Disabled`,`Focus`,`Size`,`Screenshot`],y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    }
  ...
  Focus,
  Size
})`,...E.parameters?.docs?.source}}}})))()}O();export{y as Default,C as Disabled,w as Focus,b as Inline,x as PrefixSuffixIcons,S as Quiet,E as Screenshot,T as Size,D as __namedExportsOrder,v as default};