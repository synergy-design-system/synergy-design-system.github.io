import{i as e}from"./preload-helper-xPQekRTU.js";import{h as t,t as n}from"./lit-BVDl_-fF.js";import{A as r,P as i,j as a}from"./iframe-CvD3XlUh.js";import{_ as o,a as s,f as c,i as l,n as u,o as d,r as f,s as p,t as m,y as h}from"./synergy-element-D_jGE1Vc.js";import{r as g,t as _}from"./if-defined-BsCyJVG6.js";import{n as v,t as y}from"./class-map-tXbnyhp8.js";import{r as b,t as x}from"./slot-DgcqpP0-.js";import{n as S,t as C}from"./watch-I6gMK-uE.js";import{n as w,t as T}from"./icon.component-28BxMEdn.js";import{n as E,t as D}from"./divider.component-DZAuGMpq.js";var O,k=e((()=>{n(),O=t`
  /**
...
`})),A,j=e((()=>{y(),r(),p(),_(),E(),w(),b(),C(),u(),d(),k(),l(),A=class extends m{constructor(...e){super(...e),this.hasSlotController=new x(this,`[default]`,`children`,`prefix`,`suffix`),this.hasFocus=!1,this.showPrefixOnly=!1,this.currentMarkedChild=!1,this.isMultiLine=!1,this.rel=`noreferrer noopener`,this.current=!1,this.disabled=!1,this.horizontal=!1,this.chevron=!1,this.open=!1,this.divider=!1}static{this.styles=[s,O]}static{this.dependencies={"syn-divider":D,"syn-icon":T}}isButton(){return!this.href&&!this.hasSlotController.test(`children`)}isLink(){return!!this.href&&!this.hasSlotController.test(`children`)}isAccordion(){return this.hasSlotController.test(`children`)}getNavItemChildren(e){return Array.from(e?.assignedElements({flatten:!0})||[]).map(e=>e.tagName.toLowerCase()===`syn-nav-item`?e:Array.from(e.querySelectorAll(`:scope > syn-nav-item`))).flat()}getAllNestedNavItems(e){let t=this.getNavItemChildren(e),n=t.map(e=>e.getAllNestedNavItems(e.childrenSlot)).flat();return t.concat(n)}handleCurrentMarkedChild(){let e=this.closest(`syn-side-nav`);(!this.open||e?.variant===`rail`)&&(this.currentMarkedChild=this.getAllNestedNavItems(this.childrenSlot).some(e=>e.current))}handleClickButton(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}handleClickSummary(e){e.preventDefault(),e.stopPropagation(),!this.disabled&&(this.open?this.hideDetails():this.showDetails())}hideDetails(){this.open=!1,this.emit(`syn-hide`,{cancelable:!0})}showDetails(){this.open=!0,this.emit(`syn-show`,{cancelable:!0})}handleSlotChange(){let e=getComputedStyle(this);if(e.length===0){setTimeout(()=>{this.handleSlotChange()});return}this.handleCurrentMarkedChild();let t=e.getPropertyValue(`--indentation`),n=Math.min(parseInt(t,10)+1,2);this.getNavItemChildren(this.childrenSlot).forEach(e=>{e.style.setProperty(`--indentation`,n.toFixed(0))})}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleWidth(e){e.forEach(e=>{requestAnimationFrame(()=>{if(e.contentRect.width<100){let e=this.hasSlotController.test(`prefix`);this.showPrefixOnly=e}else this.showPrefixOnly=!1;e.contentRect.height>48?this.isMultiLine=!0:this.isMultiLine=!1})})}handleHorizontalChange(){this.horizontal?this.resizeObserver.disconnect():this.resizeObserver.observe(this)}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>this.handleWidth(e)),this.horizontal||this.resizeObserver.observe(this)}firstUpdated(e){super.firstUpdated(e),this.mutationObserver=new MutationObserver(()=>{this.childrenSlot&&this.handleCurrentMarkedChild()}),this.mutationObserver.observe(this,{attributeFilter:[`current`,`open`],childList:!0,subtree:!0})}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect(),this.mutationObserver?.disconnect()}blur(){this.control.blur()}click(){this.control.click()}focus(e){this.control.focus(e)}render(){let e=this.isButton(),t=this.isLink(),n=this.isAccordion(),r=this.closest(`syn-side-nav`),o=this.currentMarkedChild&&!this.open||this.currentMarkedChild&&this.open&&r?.variant===`rail`&&!r?.open,s=a`button`;n?s=a`summary`:t&&(s=a`a`);let c=(this.chevron||n)&&!this.horizontal,l;n?l=this.handleClickSummary:e&&(l=this.handleClickButton);let u=i`
      ...
      >
        ...
        <div class="nav-item__content" part="content-wrapper">
          ...
          <div
            class=${v({"current-indicator":!0,"current-indicator--disabled":this.disabled,"current-indicator--visible":this.current||o})}
    ...
    `:u}},f([o()],A.prototype,`hasFocus`,void 0),f([o()],A.prototype,`showPrefixOnly`,void 0),f([o()],A.prototype,`currentMarkedChild`,void 0),f([o()],A.prototype,`isMultiLine`,void 0),f([c(`slot[name="children"]`)],A.prototype,`childrenSlot`,void 0),f([c(`.nav-item`)],A.prototype,`control`,void 0),f([h({reflect:!0,type:String})],A.prototype,`href`,void 0),f([h()],A.prototype,`target`,void 0),f([h()],A.prototype,`rel`,void 0),f([h({reflect:!0,type:Boolean})],A.prototype,`current`,void 0),f([h({reflect:!0,type:Boolean})],A.prototype,`disabled`,void 0),f([h({reflect:!0,type:Boolean})],A.prototype,`horizontal`,void 0),f([h({reflect:!0,type:Boolean})],A.prototype,`chevron`,void 0),f([h({reflect:!0,type:Boolean})],A.prototype,`open`,void 0),f([h({reflect:!0,type:Boolean})],A.prototype,`divider`,void 0),f([S(`horizontal`,{waitUntilFirstUpdate:!0})],A.prototype,`handleHorizontalChange`,null)}));export{j as n,A as t};