import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{D as r,_ as i,d as a,f as o,k as s,p as c}from"./iframe-BiSXA87W.js";import{i as l,n as u}from"./dist-B5ofSKxt.js";import{t as d}from"./icon-BQD_aSf3.js";import{a as f,i as p,n as m,o as h,r as g,t as _}from"./component-BZMStFjM.js";import{n as v,t as y}from"./taggedTemplateLiteral-pWa2IaV6.js";import{n as b,t as x}from"./tab-panel-5VThoEN0.js";import{t as S}from"./tab-GQzYvV9L.js";var C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y=e((()=>{b(),S(),x(),d(),n(),u(),r(),g(),o(),i(),v(),{args:w,argTypes:T}=p(`syn-tab-group`),{overrideArgs:E}=f(`syn-tab-group`),{generateTemplate:D}=h(`syn-tab-group`),O=(e,t,{active:n=!1,closable:r=!1,disabled:i=!1}={})=>`<syn-tab slot="nav" panel="${e}" ${n?`active`:``} ${i?`disabled`:``} ${r?`closable`:``}>${t}</syn-tab>`,k=(e,t,{active:n=!1,closable:r=!1,disabled:i=!1}={})=>s(O(e,t,{active:n,closable:r,disabled:i})),A=()=>[{panel:`general`,props:{active:!0}},{panel:`custom`},{panel:`advanced`},{panel:`disabled`,props:{disabled:!0}}].map(({panel:e,props:t})=>O(e,l(e),t)).join(`
`),j=()=>s(A()),M=(e,t,n=!1)=>`<syn-tab-panel name="${e}" ${n?`active`:``}>${t}</syn-tab-panel>`,N=(e,t,n=!1)=>s(M(e,t,n)),P=()=>[`general`,`custom`,`advanced`,`disabled`].map((e,t)=>M(e,`This is the ${e} tab panel.`,t===0)).join(`
`),F=(e,n=!1)=>t`
...
`,L=()=>s(P()),R={args:E([{name:`default`,type:`slot`,value:P()},{name:`nav`,type:`slot`,value:A()}],w),argTypes:T,component:`syn-tab-group`,parameters:{chromatic:{modes:c},design:a(`42207-338578`),docs:{description:{component:m(`tab-group`,`default`)}}},tags:[`Navigation`],title:`Components/syn-tab-group`},z={parameters:{docs:{description:{story:m(`tab-group`,`default`)}}},render:e=>D({args:e})},B={parameters:{docs:{description:{story:m(`tab-group`,`start`)}}},render:()=>t`
  <syn-tab-group placement="start">
    ${j()}
    ${L()}
  </syn-tab-group>
  `},V={parameters:{docs:{description:{story:m(`tab-group`,`end`)}}},render:()=>t`
  <syn-tab-group placement="end">
    ${j()}
    ${L()}
  </syn-tab-group>
`},H={parameters:{docs:{description:{story:m(`tab-group`,`closable`)}}},render:()=>t(C||=y([`
  ...
  `},W={parameters:{docs:{description:{story:m(`tab-group`,`hierachy`)}}},render:()=>t`
  ...
  `},G={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:m(`tab-group`,`manuel`)}}},play:({canvasElement:e})=>{e.querySelector(`syn-tab[panel="general"]`)?.focus()},render:()=>t` 
    <syn-tab-group activation="manual">
      ${j()}
      ${L()}
    </syn-tab-group>
  `},K={parameters:{docs:{description:{story:m(`tab-group`,`icon`)}}},render:()=>t`
  <syn-tab-group>
...
\`
  ...
  heightPx: 740
})`,...q.parameters?.docs?.source}}},J=[`Default`,`TabsOnStart`,`TabsOnEnd`,`ClosableTabs`,`ScrollingTabs`,`VisualHierarchy`,`ManualActivation`,`Icons`,`Screenshot`]}));Y();export{H as ClosableTabs,z as Default,K as Icons,G as ManualActivation,q as Screenshot,U as ScrollingTabs,V as TabsOnEnd,B as TabsOnStart,W as VisualHierarchy,J as __namedExportsOrder,R as default,Y as t};