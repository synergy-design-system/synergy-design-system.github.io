import{a as e,n as t}from"./chunk-DnJy8xQt.js";import{It as n,Nt as r,R as i,Rt as a,d as o,f as s,g as c,n as l,t as u,u as d}from"./iframe-DVxLZS-s.js";import{d as f,f as p,l as m,r as h,u as g}from"./blocks-CeNKcH3U.js";import{t as _}from"./button-Bh72Wntz.js";import{t as v}from"./icon-B6NqE4U1.js";import{t as y}from"./details-B-CtpPL4.js";import{n as b,r as x}from"./component-DniQwiZV.js";import{n as S,t as C}from"./menu-item-BiG9-9K5.js";import{t as w}from"./dropdown-C7hxAnCm.js";import{t as T}from"./option-C_9nm3-W.js";import{t as E}from"./select-geY1X-RY.js";import{t as D}from"./tag-group-D7azQ7Rv.js";import{t as O}from"./tag-CN67GHg9.js";var k,A,j,M,N;t((()=>{k=e(i(),1),p(),r(),u(),x(),o(),c(),_(),y(),w(),S(),C(),T(),E(),D(),O(),v(),A={parameters:{chromatic:{...l?.parameters?.chromatic,disableSnapshot:!1,modes:s},design:d(`16648-52486`),docs:{description:{component:b(`tag-group`,`default`,`templates`)},page:()=>k.createElement(k.Fragment,null,k.createElement(f,null),k.createElement(g,null),k.createElement(h,null),k.createElement(m,{title:``}))}},tags:[`Feedback`,`Tags`,`Filter`],title:`Templates/Tag Group`},j={render:()=>{let e={filters:[{id:`filter-1`,name:`Housing`,options:[`metric`,`rectangular`],selected:[]},{id:`filter-2`,name:`Cable material`,options:[`PUR`,`PVC`],selected:[`PUR`]},{id:`filter-3`,name:`Length of cable`,options:[`0.2 m`,`0.3 m`,`0.7 m`,`0.23 m`,`2 m`],selected:[`0.2 m`,`0.3 m`,`0.7 m`,`0.23 m`]},{id:`filter-4`,name:`Electrical wiring`,options:[`AC 2-wire`,`DC 3-wire`,`DC 4-wire`],selected:[]},{id:`filter-5`,name:`Switching output`,options:[`NPN`,`PNP`],selected:[]},{id:`filter-6`,name:`Connection type`,options:[`Cable, 2-wire`,`Cable, 3-wire`,`Cable, 4-wire`],selected:[`Cable, 3-wire`]}],filtersOpen:!0,isMobile:!1},t=(e,t)=>a`
      <form class="filter-form">
        ...
        ${e.filters.some(e=>e.selected.length>0)?a`
          <div class="filter-tags">
            ${e.filters.filter(e=>e.selected.length>0).map(n=>a`
                <syn-tag-group
    ...
    `,r=document.createElement(`div`);return(()=>{let i,a,o=()=>{n(t(e,i),r)},s=t=>{e={...e,...t},o()},c=()=>{`ResizeObserver`in window&&(a=new ResizeObserver(t=>{if(t.length>0){let n=t[0].contentRect.width<=420;e.isMobile!==n&&s({isMobile:n})}}),setTimeout(()=>{let e=r.querySelector(`.filter-form`);e&&a&&a.observe(e)},0))},l={clearAllFilters:()=>{window.confirm(`Möchten Sie wirklich alle Filter entfernen?`)&&s({filters:e.filters.map(e=>({...e,selected:[]}))})},removeTag:(t,n)=>{s({filters:e.filters.map(e=>e.id===t?{...e,selected:e.selected.filter(e=>e!==n)}:e)})},toggleFilter:e=>{s({filtersOpen:e})},toggleOption:(t,n)=>{s({filters:e.filters.map(e=>{if(e.id===t){let t=e.selected.includes(n)?e.selected.filter(e=>e!==n):[...e.selected,n];return{...e,selected:t}}return e})})}};return i=l,o(),c(),{actions:l,cleanup:()=>{a&&a.disconnect()},rerender:o}})(),r}},M={...j,globals:{viewport:{value:`mobile2`}},name:`↳ Tablet`,parameters:{controls:{exclude:[`default`]}}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
  render: () => {
