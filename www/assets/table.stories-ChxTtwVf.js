...
`,y={args:h([{name:`default`,type:`slot`,value:_().trim()}],p),argTypes:m,component:`syn-table`,parameters:{chromatic:{modes:n},docs:{description:{component:g}}},tags:[`Structure`,`Styles`],title:`Styles/syn-table`},b={parameters:{controls:{disable:!1},docs:{description:{story:g}}},render:e=>d(e,`table`)},x={render:()=>a`
  ...
  `},T={render:()=>v()},E={render:()=>v(`border`)},D={render:()=>v(`alternating`)},O=u({AtomicTable:x,AutoDefaultTable:S,AutoAlternatingTable:C,AutoBorderTable:w,ComplexTableDefault:T,ComplexTableBorder:E,ComplexTableAlternating:D},400),k=[`Default`,`AtomicTable`,`AutoDefaultTable`,`AutoAlternatingTable`,`AutoBorderTable`,`Screenshot`],b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
...
}, 400)`,...O.parameters?.docs?.source}}}})))()}A();export{x as AtomicTable,C as AutoAlternatingTable,w as AutoBorderTable,S as AutoDefaultTable,b as Default,O as Screenshot,k as __namedExportsOrder,y as default};