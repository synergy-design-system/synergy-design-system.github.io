import{R as s}from"./index-B3ehnkiM.js";import{T as $,e as C,f as z,g as S}from"./index-DhDPsa7k.js";import{x as a}from"./lit-element-DILkAbkc.js";import{p as L,g as E}from"./preview-B3aX1ie9.js";import{g as D}from"./component-DET4JjRq.js";import{g as l}from"./translations-Y5NUIjcf.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./iframe-DHtqBpjq.js";import"../sb-preview/runtime.js";import"./index-C2eUe6cH.js";import"./index-B2MLhnBa.js";import"./index-DrFu-skq.js";import"./icon.component-ECBjcGqG.js";import"./directive-helpers-DbZfDV3x.js";import"./icon-button-DB3uW5ZR.js";import"./icon-CC8qjACX.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-DU65Ag4u.js";var w=Object.freeze,_=Object.defineProperty,v=(e,o)=>w(_(e,"raw",{value:w(e.slice())})),g,f,x,T;const n=(e,o=5)=>new Array(o).fill(void 0).map(e),r=(e=void 0)=>{const o=e?`syn-table-cell--shadow-${e} shadow-cell`:"",t=d=>`${e==="end"&&d===0||e==="start"&&d===4||e==="bottom"?o:""}`;return a`
    <thead>
      <tr>
...
`,U={parameters:{chromatic:{...L?.parameters?.chromatic,disableSnapshot:!1},design:E("19923-55456"),docs:{description:{component:D("templates","table")},page:()=>s.createElement(s.Fragment,null,s.createElement($,null),s.createElement(C,null),s.createElement(z,null),s.createElement(S,{title:""})),story:{iframeHeight:550}}},title:"Templates/Table"},h={render:()=>{const e=n(()=>c());return a`
    ...
    `}},i={render:()=>{const e=n(()=>c("end"));return a(g||(g=v([`
      ...
      <\/script>
    `])),r("end"),e)}},b={render:()=>{const e=n(()=>c("start"));return a(f||(f=v([`
      ...
      <\/script>
    `])),r("start"),e)}},p={render:()=>{const e=n(()=>c());return a(x||(x=v([`
      ...
      <\/script>
    `])),r("bottom"),e)}},u={render:()=>{const e=n(()=>P());return a(T||(T=v([`
...
}`,...u.parameters?.docs?.source}}};const V=["TableWithHeader","TableWithAlternatingRows","TableWithBorders","TableShadowLeftColumn","TableShadowRightColumn","TableShadowTopRow","TableProduct"];export{u as TableProduct,i as TableShadowLeftColumn,b as TableShadowRightColumn,p as TableShadowTopRow,y as TableWithAlternatingRows,m as TableWithBorders,h as TableWithHeader,V as __namedExportsOrder,U as default};
