import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{_ as r,d as i,f as a,p as o}from"./iframe-BJUJk-mP.js";import{t as s}from"./button-DPE3w6y_.js";import{t as c}from"./icon-CWcZLnjq.js";import{i as l,n as u,o as d,r as f,t as p}from"./component-Dl_LLDeh.js";import{n as m,t as h}from"./PaddingDecorator-DKDp5bXd.js";import{n as g,t as _}from"./decorators-C-ZhSsaX.js";import{t as v}from"./input-BU7P_yVK.js";import{t as y}from"./textarea-C9jrgusw.js";var b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U=e((()=>{v(),c(),s(),y(),n(),_(),f(),a(),h(),r(),{userEvent:b}=__STORYBOOK_MODULE_TEST__,{args:x,argTypes:S}=l(`syn-input`),{generateTemplate:C}=d(`syn-input`),w={args:x,argTypes:S,parameters:{chromatic:{modes:o},design:i(`41337-165221`),docs:{description:{component:u(`input`,`default`)}}},tags:[`Form`],title:`Components/syn-input`},T={parameters:{controls:{disable:!1},docs:{description:{story:u(`input`,`default`)}}},render:e=>C({args:e})},E={parameters:{docs:{description:{story:u(`input`,`label`)}}},render:()=>t`<syn-input label="What is your name?"></syn-input>`},D={parameters:{docs:{description:{story:u(`input`,`help-text`)}}},render:()=>t`<syn-input label="Nickname" help-text="What would you like people to call you?"></syn-input>`},O={parameters:{docs:{description:{story:u(`input`,`placeholder`)}}},render:()=>t`<syn-input placeholder="Type something"></syn-input>`},k={parameters:{docs:{description:{story:u(`input`,`clearable`)}}},render:()=>t`<syn-input value="Clearable" placeholder="Clearable" clearable></syn-input>`},A={parameters:{docs:{description:{story:u(`input`,`password-toggle`)}}},render:()=>t`<syn-input type="password" placeholder="Password Toggle" password-toggle></syn-input>`},j={parameters:{docs:{description:{story:u(`input`,`readonly`)}}},render:()=>t`<syn-input value="Readonly content" readonly></syn-input>`},M={decorators:[m()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`input`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-input`);t&&t.focus()},render:()=>t`
      <form>
        <syn-input help-text="This input is focused." label="Label" placeholder="Insert text here..."></syn-input>
      </form>
    `},N={parameters:{docs:{description:{story:u(`input`,`disabled`)}}},render:()=>t`
  <syn-input placeholder="Disabled" help-text="Help Text" label="Label" disabled>
    <syn-icon name="home" slot="prefix"></syn-icon>
    <syn-icon name="chat" slot="suffix"></syn-icon>
  </syn-input>`},P={parameters:{docs:{description:{story:u(`input`,`size`)}}},render:()=>t`
  ...
  `},I={parameters:{docs:{description:{story:u(`input`,`types`)}}},render:()=>t`
  ...
  `},L={parameters:{docs:{description:{story:u(`input`,`prefix-suffix`)}}},render:()=>t`
  ...
  <syn-input placeholder="Large" size="large">
    <syn-icon name="wallpaper" slot="prefix"></syn-icon>
    <syn-icon name="wallpaper" slot="suffix"></syn-icon>
  </syn-input>`},R={parameters:{docs:{description:{story:u(`input`,`label-position`)}}},render:()=>t`
  ...
  `},z={parameters:{docs:{description:{story:u(`input`,`stepper`)}}},render:()=>t`
  <syn-input type="number" min="0" max="10" value="0"></syn-input>
  <br/>
  <syn-input type="number" min="0" max="10" value="2"></syn-input>
  <br/>
  <syn-input type="number" min="0" max="10" value="10"></syn-input>`},B={parameters:{docs:{description:{story:u(`input`,`stepper-input-handling`)}}},render:()=>t`
    <syn-input
