import{g as p}from"./preview-CdUaHTin.js";import{x as t}from"./lit-element-DILkAbkc.js";import{s as g,a as f,g as n,b as h,c as x}from"./component-1zHCSbj9.js";import"./index-DH5ua8nC.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon-button-zGz1i6lT.js";import"./icon.component-Buj3H5FC.js";import"./directive-helpers-DbZfDV3x.js";import"./icon-DbE-ZVUM.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-IXOWi_1w.js";const{args:S,argTypes:z}=g("syn-button"),{overrideArgs:v}=x("syn-button"),{generateTemplate:D}=f("syn-button"),W={args:v({name:"default",type:"slot",value:"Button"},S),argTypes:z,component:"syn-button",parameters:{design:p("1055-22957"),docs:{description:{component:n("button","default")}}},title:"Components/syn-button"},s={parameters:{controls:{disable:!1},docs:{description:{story:n("button","default")}}},render:b=>D({args:b})},e={parameters:{docs:{description:{story:n("button","variant")}}},render:()=>t`
  ...
  </style>`},c={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:n("button","focus")}}},play:({canvasElement:b})=>{const d=b.querySelector("syn-button");d&&d.focus()},render:()=>t`<syn-button>Default</syn-button>`},r={parameters:{docs:{description:{story:n("button","link")}}},render:()=>t`
  ...
  </style>`},a={parameters:{docs:{description:{story:n("button","width")}}},render:()=>t`
  ...
  <syn-button size="large" style="width: 100%;">Large</syn-button>`},i={parameters:{docs:{description:{story:n("button","prefix-suffix")}}},render:()=>t`
  ...
  </style>`},y={parameters:{docs:{description:{story:n("button","loading")}}},render:()=>t`
  ...
  </style>`},l={parameters:{docs:{description:{story:n("button","disabled")}}},render:()=>t`
  <syn-button variant="filled" disabled>Filled</syn-button>
  <syn-button variant="outline" disabled>Outline</syn-button>
  <syn-button variant="text" disabled>Text</syn-button>`},m=h({Default:s,Variants:e,Sizes:o,LinkButtons:r,SettingACustomWidth:a,PrefixAndSuffixIcons:i,Caret:u,Loading:y,Disabled:l},280);s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  Loading,
  Disabled
}, 280)`,...m.parameters?.docs?.source}}};const P=["Default","Variants","Sizes","Focus","LinkButtons","SettingACustomWidth","PrefixAndSuffixIcons","Caret","Loading","Disabled","Screenshot"];export{u as Caret,s as Default,l as Disabled,c as Focus,r as LinkButtons,y as Loading,i as PrefixAndSuffixIcons,m as Screenshot,a as SettingACustomWidth,o as Sizes,e as Variants,P as __namedExportsOrder,W as default};
