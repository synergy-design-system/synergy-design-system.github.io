import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{a as t,d as n,o as r,s as i}from"./preview-DXkhgu0Z.js";import{c as a,t as o}from"./lit-BfcklOOD.js";import{t as s}from"./button-DVR7vfNM.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-B0n0ooCL.js";import{t as m}from"./checkbox-group-MP5ooG_L.js";import{t as h}from"./checkbox-BOGtoVhY.js";var g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P=e((()=>{m(),h(),s(),o(),f(),r(),n(),g=e=>`${e[0].toUpperCase()}${e.slice(1)}`,_=(e=3,t={})=>Array.from({length:e},(e,n)=>a`
  <syn-checkbox
...
`),{argTypes:v}=l(`syn-checkbox-group`),{overrideArgs:y}=c(`syn-checkbox-group`),{generateTemplate:b}=d(`syn-checkbox-group`),x={args:y([{name:`label`,type:`attribute`,value:`This is a label`},{name:`default`,type:`slot`,value:`
      ...
      `}]),argTypes:v,component:`syn-checkbox-group`,parameters:{chromatic:{modes:i},design:t(`50279-39073`),docs:{description:{component:u(`checkbox-group`,`default`)}}},tags:[`Form`],title:`Components/syn-checkbox-group`},S={parameters:{controls:{disable:!1},docs:{description:{story:u(`checkbox-group`,`default`)}}},render:e=>b({args:e})},C={parameters:{docs:{description:{story:u(`checkbox-group`,`vertical-layout`)}}},render:()=>a`
    <syn-checkbox-group label="This is a label" layout="vertical">
      ${_()}
    </syn-checkbox-group>
  `},w={parameters:{docs:{description:{story:u(`checkbox-group`,`horizontal-layout`)}}},render:()=>a`
    <syn-checkbox-group label="This is a label" layout="horizontal">
      ${_(11)}
    </syn-checkbox-group>
  `},T={parameters:{docs:{description:{story:u(`checkbox-group`,`labels`)}}},render:()=>a`
    <syn-checkbox-group label="This is a label">
      ${_(3)}
    </syn-checkbox-group>
  `},E={parameters:{docs:{description:{story:u(`checkbox-group`,`checked`)}}},render:()=>a`
    <syn-checkbox-group label="This is a label">
      ${_(3,{checked:[1]})}
    </syn-checkbox-group>
  `},D={parameters:{docs:{description:{story:u(`checkbox-group`,`help-text`)}}},render:()=>a`
    <syn-checkbox-group label="This is a label" help-text="Choose the most appropriate option.">
      ${_(3)}
    </syn-checkbox-group>
  `},O={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`checkbox-group`,`focus`)}}},play:({canvasElement:e})=>{e.querySelector(`syn-checkbox-group`)?.focus()},render:()=>a`
    <syn-checkbox-group label="This is a label" help-text="Choose the most appropriate option.">
      ${_(3,{checked:[1],disabled:[0]})}
    </syn-checkbox-group>
  `},k={parameters:{docs:{description:{story:u(`checkbox-group`,`disabled`)}}},render:()=>a`
    <syn-checkbox-group label="This is a disabled">
      ${_(3,{checked:[1],disabled:[0,1]})}
    </syn-checkbox-group>
  `},A={parameters:{docs:{description:{story:u(`checkbox-group`,`readonly`)}}},render:()=>a`
    <syn-checkbox-group label="This is a label">
      ${_(3,{checked:[1],readonly:[0,1]})}
    </syn-checkbox-group>
  `},j={parameters:{docs:{description:{story:u(`checkbox-group`,`sizes`)}}},render:()=>a`
