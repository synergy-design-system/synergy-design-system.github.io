import{j as Z,c as L}from"./iframe-BtlaEU6c.js";import{o as tt}from"./if-defined-D4eeoy7Q.js";import{c as et,n as f,S as it}from"./synergy-element-DNCG4YnN.js";import{e as st,a as M}from"./query-D0jTsbLw.js";import{e as rt}from"./class-map-CR1NexEI.js";import{d as at}from"./default-value-CqRUEAyG.js";import{F as ot,c as nt,v as lt}from"./form-d9hCJUdr.js";import{H as ht}from"./slot-9EVoRGQc.js";import{L as ct}from"./localize-Dh03wnLC.js";import{f as dt}from"./form-control.styles-BZYj_jBM.js";import{S as ut}from"./tooltip.component-D_CQrI11.js";import{e as pt}from"./decorator-CWkWRMhy.js";let mt;function ft(t){return(e,i)=>st(e,i,{get(){return(this.renderRoot??(mt??=document.createDocumentFragment())).querySelectorAll(t)}})}const v=(t,e)=>t-e,w=(t,e)=>{if(t.length!==e.length)return!0;const i=t.slice().sort(v),a=e.slice().sort(v);for(let s=0;s<i.length;s+=1)if(i[s]!==a[s])return!0;return!1},U=(t,e,i)=>{const a=t.getBoundingClientRect(),s=a.width;if(s<=0)return 0;let n=e;return n-=a.left,n<=0?i?1:0:n>=s?i?0:1:(n/=s,i?1-n:n)},bt=Z`
  :host {
    /*
