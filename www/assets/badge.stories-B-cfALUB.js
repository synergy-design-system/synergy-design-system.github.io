import{k as u,c as d,C as h,d as f}from"./iframe-hncc6fn8.js";import{e as x}from"./class-map-J4m71D6f.js";import{c as w,n as S,S as k}from"./synergy-element-ZP8Aphe2.js";import{L as D}from"./controller-0nuky388.js";import{e as z}from"./decorator-jbWt9cIm.js";import"./button-BLOi7eyP.js";import"./icon-CdTGkBe_.js";import"./menu-item-BuRncr0p.js";import"./menu-label-DSXlEjYN.js";import"./popup-C3OyaIs_.js";import{g as a,a as C,s as W,b as _,c as E}from"./component-BDcZ8_k2.js";import"./preload-helper-PPVm8Dsz.js";import"./functions-DCU90qiI.js";import"./button.component-CXWNkp-D.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./if-defined-Df6Qu0g8.js";import"./icon.component-uI_62ALx.js";import"./watch-CEsCE2EF.js";import"./query-D0jTsbLw.js";import"./spinner.component-CET_LilP.js";import"./menu.component-BtgFJWUG.js";import"./ref-CFo4hYfC.js";import"./popup.component-BvGfN3ZB.js";import"./divider.component-CAm9t5hy.js";import"./index-3hbeBem-.js";import"./_docs-VWJ8UqMU.js";const B=u`
	/* stylelint-disable */
  :host {
    display: inline-flex;
  }
...
`;var O=Object.defineProperty,P=Object.getOwnPropertyDescriptor,v=(l,c,y,g)=>{for(var e=g>1?void 0:g?P(c,y):c,m=l.length-1,b;m>=0;m--)(b=l[m])&&(e=(g?b(c,y,e):b(e))||e);return g&&e&&O(c,y,e),e};let i=class extends k{constructor(){super(...arguments),this.localize=new D(this),this.variant="primary"}render(){return d`
    ...
    `}};i.styles=[w,B,M];v([S({reflect:!0})],i.prototype,"variant",2);i=v([z("SynBadge")],i);i.define("syn-badge");const{args:V,argTypes:j}=W("syn-badge"),{overrideArgs:I}=E("syn-badge"),{generateTemplate:R}=_("syn-badge"),ge={args:I([{name:"default",type:"slot",value:"Badge"}],V),argTypes:j,component:"syn-badge",parameters:{chromatic:{modes:h},design:f("14127-697884"),docs:{description:{component:a("badge","default")}}},tags:["Feedback"],title:"Components/syn-badge"},r={parameters:{controls:{disable:!1},docs:{description:{story:a("badge","default")}}},render:l=>R({args:l})},n={parameters:{docs:{description:{story:a("badge","variants")}}},render:()=>d`
  ...
  `},p=C({Default:r,Variants:n,WithButtons:s,WithMenuItems:t,WithEmptyContent:o},250);r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  WithMenuItems,
  WithEmptyContent
}, 250)`,...p.parameters?.docs?.source}}};const pe=["Default","Variants","WithButtons","WithMenuItems","WithEmptyContent","Screenshot"];export{r as Default,p as Screenshot,n as Variants,s as WithButtons,o as WithEmptyContent,t as WithMenuItems,pe as __namedExportsOrder,ge as default};
