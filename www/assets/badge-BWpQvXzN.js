...
`})),S,C,w=e((()=>{a(),t(),m(),f(),d(),s(),y(),x(),g(),l(),S=class extends h{constructor(...e){super(...e),this.localize=new o(this),this.variant=`primary`}static{this.styles=[c,v,b]}render(){return n`
      <span
        part="base"
    ...
    `}},p([u({reflect:!0})],S.prototype,`variant`,void 0),S=p([_(`SynBadge`)],S),C=S})),T=e((()=>{w(),w(),C.define(`syn-badge`)}));export{T as t};