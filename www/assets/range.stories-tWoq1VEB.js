import{u as V}from"./index-B_f3VjvO.js";import{k as r}from"./directive-helpers-CDT6qhDs.js";import{s as C,a as q,g as z,b as e,c as M,d as L}from"./component-CjEFK4yx.js";import"./if-defined-BaykDp1D.js";import"./ref-lLHsj5FH.js";import"./chunk-L4EGOTBX-C9C4DwME.js";import"./entry-preview-D9TbQDUR.js";import"./index-DrFu-skq.js";import"./index-Co3MNReg.js";import"./library-BZPO0bHa.js";import"./icon.component-DbLkOHCL.js";import"./index-7h80QhK_.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon-eErRpPHH.js";var T=Object.freeze,P=Object.defineProperty,S=(t,s)=>T(P(t,"raw",{value:T(t.slice())})),D,w,E;const{args:_,argTypes:A}=C("syn-range"),{overrideArgs:F}=L("syn-range"),{generateTemplate:j}=q("syn-range"),X={args:F([{name:"value",type:"attribute",value:"50"}],_),argTypes:A,component:"syn-range",parameters:{design:z("20575-35283"),docs:{description:{component:e("range","default")}}},title:"Components/syn-range"},n={parameters:{controls:{disable:!1},docs:{description:{story:e("range","default")},story:{height:"80px"}}},render:t=>j({args:t})},a={parameters:{docs:{description:{story:e("range","labels")}}},render:()=>r`
  ...
  `},v={parameters:{docs:{description:{story:e("range","tooltip-formatter")}}},render:()=>r(E||(E=S([`
    ...
    <\/script>
  `])))},b=M({Default:n,Labels:a,HelpText:i,Disabled:o,Invalid:c,Sizes:l,PrefixSuffixText:p,CustomTrackColors:m,CustomTrackOffset:y,MultiThumb:u,Ticks:g,TooltipPlacement:d,TooltipDisabled:f,TooltipFormatter:v},500);n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  TooltipDisabled,
  TooltipFormatter
}, 500)`,...b.parameters?.docs?.source}}};const Z=["Default","Labels","HelpText","Disabled","Invalid","Focus","Sizes","PrefixSuffixText","CustomTrackColors","CustomTrackOffset","MultiThumb","MultiThumbWithRestrictedMovement","Ticks","TooltipPlacement","TooltipDisabled","TooltipFormatter","Screenshot"];export{m as CustomTrackColors,y as CustomTrackOffset,n as Default,o as Disabled,k as Focus,i as HelpText,c as Invalid,a as Labels,u as MultiThumb,x as MultiThumbWithRestrictedMovement,p as PrefixSuffixText,b as Screenshot,l as Sizes,g as Ticks,f as TooltipDisabled,v as TooltipFormatter,d as TooltipPlacement,Z as __namedExportsOrder,X as default};
