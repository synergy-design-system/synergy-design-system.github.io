var ln=Object.freeze,fi=Object.defineProperty;var dn=(a,e)=>ln(fi(a,"raw",{value:ln(e||a.slice())}));import{R as f,d as Nn,k,t as te,b as u,a as g,e as ut,f as yi}from"./if-defined-CAYRA8Ae.js";import{i as h,k as p,D as An,u as cn,Q as bi,R as gi}from"./directive-helpers-B-JxG5af.js";import{h as Mn,$ as Pn,r as Ln,L as vi,F as yt,b as wi,o as xi,c as pn,f as ki,s as _i,d as Ti,p as Ft,e as Ci,g as Si,a as jn,k as zi,K as Ei,j as $i,i as Oi,t as Di}from"./ref-CLjsg0Dj.js";import{s as Ii}from"./chunk-L4EGOTBX-Mt8q4xcs.js";import"./entry-preview-CWKZl0rh.js";import{S as it,d as hn,s as Ni}from"./index-D8HpcxQN.js";import{d as Ai}from"./index-ogSvIofg.js";import"./index-CYQpqK1Q.js";import{n as r,a as b}from"./library-UYMiFSYt.js";import{a as v,c as w,w as m,S as ue}from"./icon.component-CgdRPS1z.js";import"./icon-BM_ysiRC.js";const Mi=h`
  :host {
    display: block;
  }
...
`;var Pr=Object.defineProperty,Lr=Object.getOwnPropertyDescriptor,fe=(a,e,t,n)=>{for(var i=n>1?void 0:n?Lr(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Pr(e,t,i),i};class pe extends v{constructor(){super(...arguments),this.controller=new AbortController,this.validationMessage="",this.eagerFirstMount=!0,this.isInternalTriggeredInvalid=!1,this.isValid=!0,this.variant="native",this.hideIcon=!1,this.on="",this.customValidationMessage="",this.eager=!1,this.internalRevalidate=e=>{e.currentTarget.validity?.valid&&(this.validationMessage="")},this.validate=e=>{if(Bt(e.type)&&this.variant==="native"&&this.isInternalTriggeredInvalid===!0){this.isInternalTriggeredInvalid=!1;return}Bt(e.type)&&this.variant!=="native"&&(e.preventDefault(),e.stopPropagation());const t=e.currentTarget;if(this.isValid=t.validity?.valid,this.eager&&this.eagerFirstMount){this.eagerFirstMount=!1,this.setValidationMessage(t);return}!this.isValid&&!On(e.type)&&this.handleFocus(t),this.setValidationMessage(t),!On(e.type)&&this.variant==="native"&&this.updateComplete.then(()=>{this.isInternalTriggeredInvalid=!0,t.reportValidity()})}}static{this.styles=[w,Mr]}static{this.dependencies={"syn-alert":ei}}handleListenerChange(){this.updateEvents()}async handleEagerChange(){if(this.eager){const e=this.getInput();await this.updateComplete,e?.reportValidity(),this.eagerFirstMount=!0}else this.eagerFirstMount=!1}handleCustomValidationMessageChange(){const e=this.getInput();e&&(this.setCustomValidationMessage(e),this.setValidationMessage(e))}getValidity(){return this.isValid}getInput(){const e=this.slottedChildren[0];return e||void 0}getUsedEventNames(){const e=this.getInput();if(!e)return[];const t=Ar(this.on),[...n]=t.filter(Boolean);return n.includes("invalid")||n.push("invalid"),n.includes("live")&&(n.push("input"),n.push("blur")),Array.from(new Set(n.filter(i=>i!=="live").map(i=>Dn(e,i))))}updateEvents(){this.controller.abort(),this.controller=new AbortController;const e=this.getInput();if(!e)return;const t=this.getUsedEventNames();t.forEach(i=>{e.addEventListener(i,this.validate,{capture:Bt(i),signal:this.controller.signal})});const n=Dn(e,"change");t.includes(n)||e.addEventListener(n,this.internalRevalidate,{signal:this.controller.signal})}setValidationMessage(e){const{customValidationMessage:t}=this,n=t||e.validationMessage;this.validationMessage=n}setCustomValidationMessage(e){e.setCustomValidity(this.customValidationMessage)}handleFocus(e){const t=document.activeElement,n=t.closest("syn-validate");!t.validity?.valid&&n||(e.scrollIntoView({block:"nearest"}),e.focus())}async firstUpdated(e){super.firstUpdated(e),this.updateEvents();const t=this.getInput();this.customValidationMessage&&(t instanceof v&&await t.updateComplete,t?.setCustomValidity(this.customValidationMessage)),this.eager&&(await this.updateComplete,this.isValid=t?.validity?.valid??!1,t?.reportValidity())}connectedCallback(){super.connectedCallback(),this.observer=new MutationObserver(e=>{const t=this.getInput();if(!t)return;e.filter(({target:i})=>i===t).every(i=>{const o=i.target;return o.hasAttribute("disabled")||o.hasAttribute("readonly")})?(this.isValid=!0,this.validationMessage=""):(t instanceof v?t.updateComplete:Promise.resolve()).then(()=>{this.isValid=t?.validity?.valid??!1,this.validationMessage=t?.validationMessage??""})}),this.observer.observe(this,{attributeFilter:["disabled","readonly"],attributes:!0,subtree:!0})}disconnectedCallback(){super.disconnectedCallback(),this.controller.abort(),this?.observer?.disconnect()}renderInlineValidation(){return this.variant!=="inline"||!this.validationMessage?"":p`
    ...
    `}}fe([Mn()],pe.prototype,"slottedChildren",2);fe([b()],pe.prototype,"validationMessage",2);fe([b()],pe.prototype,"eagerFirstMount",2);fe([b()],pe.prototype,"isInternalTriggeredInvalid",2);fe([b()],pe.prototype,"isValid",2);fe([r({reflect:!0})],pe.prototype,"variant",2);fe([r({attribute:"hide-icon",reflect:!0,type:Boolean})],pe.prototype,"hideIcon",2);fe([r({reflect:!0})],pe.prototype,"on",2);fe([r({attribute:"custom-validation-message",type:String})],pe.prototype,"customValidationMessage",2);fe([r({type:Boolean})],pe.prototype,"eager",2);fe([m("on",{waitUntilFirstUpdate:!0})],pe.prototype,"handleListenerChange",1);fe([m("eager",{waitUntilFirstUpdate:!1})],pe.prototype,"handleEagerChange",1);fe([m("customValidationMessage",{waitUntilFirstUpdate:!0})],pe.prototype,"handleCustomValidationMessageChange",1);pe.define("syn-validate");function jr(a){const e=typeof window<"u"&&window;return!!(e&&(/Chromatic/.test(e.navigator.userAgent)||/chromatic=true/.test(e.location.href)))}const Fr=(a,...e)=>jr()?p`
      ...
      ${a(...e)}
    `:a(...e),Ot="🌞 light",qt="🌙 dark",Vr=a=>`https://www.figma.com/file/bZFqk9urD3NlghGUKrkKCR/Synergy-Digital-Design-System?type=design&node-id=${a}`,Hr=(a,e="Go to Figma page")=>({label:e,type:"link",url:Vr(a)});function Br(a,e){const t=document.querySelectorAll(`#anchor--${e.id}`),i=JSON.parse('{"@synergy-design-system/components":"2.19.3","@synergy-design-system/assets":"1.12.0","@synergy-design-system/styles":"1.6.0","@synergy-design-system/tokens":"2.17.0"}');return t.forEach(o=>{const s=o.querySelector(".docblock-code-toggle");if(s){const l=s.cloneNode(!0);l.textContent="Edit on CodePen",l.classList.add("docblock-codepen-button");const d=o.querySelector(".sb-bar");d?o.querySelectorAll(".docblock-codepen-button:not(:last-of-type)").forEach(c=>{c.remove()}):o.querySelectorAll(".docblock-codepen-button").forEach(c=>{c.remove()}),s.parentElement.appendChild(l),d&&(o.querySelectorAll(".docblock-codepen-button:not(:last-of-type)").forEach(c=>{c.style.display="block",c.style.borderRight="none"}),o.querySelector(".docblock-codepen-button:last-of-type").style.display="none"),l.addEventListener("click",()=>{const c=document.createElement("form");c.action="https://codepen.io/pen/define",c.method="POST",c.target="_blank";const y={css:`/* Import theme */
