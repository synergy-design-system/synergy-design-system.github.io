...
`;var j=Object.defineProperty,U=Object.getOwnPropertyDescriptor,P=(e,t,s,i)=>{for(var r=i>1?void 0:i?U(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(r=(i?o(t,s,r):o(r))||r);return i&&r&&j(t,s,r),r};class m extends A{emit(t,s){const i=new CustomEvent(t,{bubbles:!0,cancelable:!1,composed:!0,detail:{},...s});return this.dispatchEvent(i),i}static{this.version="1.9.0"}static define(t,s=this,i={}){const r=customElements.get(t);if(!r){customElements.define(t,class extends s{},i);return}let n=" (unknown version)",o=n;"version"in s&&s.version&&(n=" v"+s.version),"version"in r&&r.version&&(o=" v"+r.version),!(n&&o&&n===o)&&console.warn(`Attempted to register <${t}>${n}, but <${t}>${o} has already been registered.`)}static{this.dependencies={}}constructor(){super(),Object.entries(this.constructor.dependencies).forEach(([t,s])=>{this.constructor.define(t,s)})}}P([l()],m.prototype,"dir",2);P([l()],m.prototype,"lang",2);let y="";function M(e){y=e}function D(e=""){if(!y){const t=[...document.getElementsByTagName("script")],s=t.find(i=>i.hasAttribute("data-synergy"));if(s)M(s.getAttribute("data-synergy"));else{const i=t.find(n=>/synergy(\.min)?\.js($|\?)/.test(n.src)||/synergy-autoloader(\.min)?\.js($|\?)/.test(n.src));let r="";i&&(r=i.getAttribute("src")),M(r.split("/").slice(0,-1).join("/"))}}return y.replace(/\/$/,"")+(e?`/${e.replace(/^\//,"")}`:"")}const T={name:"default",resolver:e=>D(`assets/icons/${e}.svg`)},S={add:`
		...
		<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill='currentColor'><path d="M19 6.41L17.59 5L12 10.59L6.41 5L5 6.41L10.59 12L5 17.59L6.41 19L12 13.41L17.59 19L19 17.59L13.41 12L19 6.41Z"/></svg>`},k={name:"system",resolver:e=>e in S?`data:image/svg+xml,${encodeURIComponent(S[e])}`:""};let v=[T,k],p=[];function q(e){p.push(e)}function z(e){p=p.filter(t=>t!==e)}function E(e){return v.find(t=>t.name===e)}function K(e,t){F(e),v.push({name:e,resolver:t.resolver,mutator:t.mutator,spriteSheet:t.spriteSheet}),p.forEach(s=>{s.library===e&&s.setIcon()})}function F(e){v=v.filter(t=>t.name!==e)}const N=L`
	/* stylelint-disable */
  :host {
...
`;var Y=Object.defineProperty,G=Object.getOwnPropertyDescriptor,c=(e,t,s,i)=>{for(var r=i>1?void 0:i?G(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(r=(i?o(t,s,r):o(r))||r);return i&&r&&Y(t,s,r),r};const d=Symbol(),g=Symbol();let w;const b=new Map;class h extends m{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}static{this.styles=[H,N,W]}async resolveIcon(t,s){let i;if(s?.spriteSheet)return B`<svg part="svg">
        <use part="use" href="${t}"></use>
      </svg>`;try{if(i=await fetch(t,{mode:"cors"}),!i.ok)return i.status===410?d:g}catch{return g}try{const r=document.createElement("div");r.innerHTML=await i.text();const n=r.firstElementChild;if(n?.tagName?.toLowerCase()!=="svg")return d;w||(w=new DOMParser);const a=w.parseFromString(n.outerHTML,"text/html").body.querySelector("svg");return a?(a.part.add("svg"),document.adoptNode(a)):d}catch{return d}}connectedCallback(){super.connectedCallback(),q(this)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),z(this)}getIconSource(){const t=E(this.library);return this.name&&t?{url:t.resolver(this.name),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){typeof this.label=="string"&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){const{url:t,fromLibrary:s}=this.getIconSource(),i=s?E(this.library):void 0;if(!t){this.svg=null;return}let r=b.get(t);if(r||(r=this.resolveIcon(t,i),b.set(t,r)),!this.initialRender)return;const n=await r;if(n===g&&b.delete(t),t===this.getIconSource().url){if($(n)){this.svg=n;return}switch(n){case g:case d:this.svg=null,this.emit("syn-error");break;default:this.svg=n.cloneNode(!0),i?.mutator?.(this.svg),this.emit("syn-load")}}}render(){return this.svg}}c([V()],h.prototype,"svg",2);c([l({reflect:!0})],h.prototype,"name",2);c([l()],h.prototype,"src",2);c([l()],h.prototype,"label",2);c([l({reflect:!0})],h.prototype,"library",2);c([I("label")],h.prototype,"handleLabelChange",1);c([I(["name","src","library"])],h.prototype,"setIcon",1);export{h as S,m as a,V as b,H as c,l as n,K as r,I as w};
