import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r,n as i,t as a}from"./preview-AI1NfaYJ.js";import{c as o,t as s}from"./lit-DgWh_IaA.js";import{d as c,f as l,i as u,p as d,u as f}from"./blocks-CjiNIppL.js";import{t as p}from"./react-BZJXY1be.js";import{t as m}from"./button-BcPmD-1Q.js";import{t as h}from"./icon-CdFlfCYb.js";import{n as g,r as _}from"./component-Bm6Rp1CP.js";import{t as v}from"./taggedTemplateLiteral-BZenJ0bZ.js";import{t as y}from"./button-group-CkdNCYtx.js";import{t as b}from"./tooltip-CK6msDul.js";import{t as x}from"./header-6nMsPNNm.js";var S,C,w,T,E;function D(){return(D=t((()=>{S=e(p(),1),d(),s(),a(),m(),y(),x(),b(),h(),_(),r(),w={parameters:{chromatic:{...i?.parameters?.chromatic,disableSnapshot:!1,modes:n},docs:{description:{component:g(`tooltip`,`default`,`templates`)},page:()=>S.createElement(S.Fragment,null,S.createElement(l,null),S.createElement(c,null),S.createElement(u,null),S.createElement(f,{title:``}))}},tags:[`Feedback`],title:`Templates/Tooltip`},T={parameters:{docs:{description:{story:g(`tooltip`,`single-instance`,`templates`)}}},render:()=>o(C||=v([`
  ...
  render: () => html\`
    ...
    <\/script>
  \`
}`,...T.parameters?.docs?.source}}},E=[`SingleInstance`]})))()}D();export{T as SingleInstance,E as __namedExportsOrder,w as default};