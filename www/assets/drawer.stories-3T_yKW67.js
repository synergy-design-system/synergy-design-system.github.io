import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{a as t,d as n,o as r,s as i}from"./preview-DXkhgu0Z.js";import{c as a,t as o}from"./lit-BfcklOOD.js";import{t as s}from"./button-DVR7vfNM.js";import{a as c,i as l,n as u,o as d,r as f}from"./component-B0n0ooCL.js";import{n as p,t as m}from"./taggedTemplateLiteral-C9cDEsPD.js";import{t as h}from"./icon-button-BqRNEsU3.js";import{t as g}from"./input-kCHvP1AL.js";import{n as _,t as v}from"./drawer.component-C2p1LNxs.js";import{n as y,t as b}from"./DisableFocusTrap-BILJcelQ.js";var x=e((()=>{_(),_(),v.define(`syn-drawer`)})),S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y=e((()=>{x(),s(),h(),g(),o(),f(),y(),r(),n(),p(),{userEvent:S}=__STORYBOOK_MODULE_TEST__,{args:N,argTypes:P}=l(`syn-drawer`),{overrideArgs:F}=c(`syn-drawer`),{generateTemplate:I}=d(`syn-drawer`),L={args:N,argTypes:P,component:`syn-drawer`,parameters:{chromatic:{modes:i},design:t(`41163-282330`),docs:{container:b,description:{component:u(`drawer`,`default`)},story:{height:`400px`}}},tags:[`Structure`],title:`Components/syn-drawer`},R={args:F([{name:`open`,type:`attribute`,value:!0},{name:`contained`,type:`attribute`,value:!1},{name:`label`,type:`attribute`,value:`Drawer`},{name:`default`,type:`slot`,value:`Lorem ipsum dolor sit amet, consectetur adipiscing elit.`},{name:`footer`,type:`slot`,value:`
        ...
        <\/script>
      `}],N),parameters:{chromatic:{disableSnapshot:!1},controls:{disable:!1},docs:{description:{story:u(`drawer`,`default`)}}},render:e=>a(C||=m([`
    `,`
    ...
    <\/script>
  `]),I({args:e}))},z={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`start`)}}},render:()=>a(w||=m([`
    ...
    <script type="module">
      ...
      closeButton.addEventListener('click', () => drawer.hide());
    <\/script>
  `]))},B={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`top`)}}},render:()=>a(T||=m([`
    ...
    <script type="module">
      ...
      closeButton.addEventListener('click', () => drawer.hide());
    <\/script>
  `]))},V={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`bottom`)}}},render:()=>a(E||=m([`
    ...
    <script type="module">
      ...
      closeButton.addEventListener('click', () => drawer.hide());
    <\/script>
  `]))},H={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`contained`)}}},render:()=>a(D||=m([`
    <div
    ...
    <script type="module">
      ...
      closeButton.addEventListener('click', () => drawer.hide());
    <\/script>
  `]))},U={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`size`)}}},render:()=>a(O||=m([`
    ...
    <script type="module">
      ...
      closeButton.addEventListener('click', () => drawer.hide());
    <\/script>
  `]))},W={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`scrolling`)}}},render:()=>a(k||=m([`
    ...
    <script type="module">
      ...
      closeButton.addEventListener('click', () => drawer.hide());
    <\/script>
  `]))},G={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`action`)}}},render:()=>a(A||=m([`
    ...
    <\/script>
  `]))},K={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`closing`)}}},play:async({canvasElement:e})=>{let t=e.querySelector(`syn-drawer`),n=t?.shadowRoot?.querySelector(`.drawer__overlay`);t&&n&&await S.click(n)},render:()=>a(j||=m([`
    ...
    <\/script>`]))},q={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`drawer`,`fokus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-drawer`);t&&(t.open=!0)},render:()=>a(M||=m([`
