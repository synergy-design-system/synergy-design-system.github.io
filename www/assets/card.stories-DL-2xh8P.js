...
`,C={args:b([{name:`image`,type:`slot`,value:`<img slot="image" src="https://synergy-design-system.github.io/card-example.jpg" alt="Multiple persons having lunch in SICK Academy" />`},{name:`default`,type:`slot`,value:`
  ...
  `},j=h({Default:w,BasicCard:T,CardWithHeader:E,CardWithFooter:D,Images:O,SharpCard:k,CardWithShadow:A},600),M=[`Default`,`BasicCard`,`CardWithHeader`,`CardWithFooter`,`Images`,`SharpCard`,`CardWithShadow`,`Screenshot`],w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  SharpCard,
  CardWithShadow
}, 600)`,...j.parameters?.docs?.source}}}})))()}export{_ as n,N as r,w as t};