var rn=Object.freeze,ui=Object.defineProperty;var ln=(a,e)=>rn(ui(a,"raw",{value:rn(e||a.slice())}));import{R as f,d as Dn,k,t as te,b as u,a as g,e as pt,f as mi}from"./if-defined-BaykDp1D.js";import{i as h,k as c,D as Nn,u as dn,Q as fi,R as yi}from"./directive-helpers-CDT6qhDs.js";import{h as In,$ as An,r as Pn,L as bi,F as mt,b as gi,o as vi,f as wi,c as xi,s as cn,d as ki,p as jt,e as _i,g as Ti,a as Mn,k as Ci,K as Si,j as zi,i as Ei,t as $i}from"./ref-lLHsj5FH.js";import{s as Oi}from"./chunk-L4EGOTBX-C9C4DwME.js";import"./entry-preview-D9TbQDUR.js";import{S as tt,d as pn,s as Di}from"./index-D_qRP-_y.js";import"./index-CleY8y_P.js";import{n as r,a as b}from"./library-BZPO0bHa.js";import{a as v,c as w,w as m,S as ue}from"./icon.component-BgIIknni.js";import"./icon-BjGOW_aa.js";const Ni=h`
  :host {
    display: block;
  }
...
<\/script>`])),a.tagName)}
`}function Hn(a,e){const t=Xi(a,e);return`${t}`?.replaceAll(/\s+/g,"")!=""?k`<style>${t}</style>`:""}function Gi(a,e,t){const n=Kt(a),i={},o={},s={};return Object.keys(n).forEach(l=>{const d=n[l];if(d?.table?.category!=="attributes")return;const p=d.name,y=e[l],_=d.control.type==="boolean"?`?${p}`:p;(y!==n[l].defaultValue||Jt.renderDefaultAttributeValues)&&(i[_]=y==="false"?!1:y)}),Object.keys(e).filter(l=>n[l]?.table?.category==="properties").forEach(l=>{if(l.startsWith("on"))return;const d=e[l];o[`.${l}`]=d}),Object.keys(e).filter(l=>!Object.keys(t||{}).includes(l)).forEach(l=>{!l.startsWith("on")&&typeof e[l]!="function"&&(s[l]=e[l])}),{attrOperators:i,propOperators:o,additionalAttrs:s}}function Yi(a,e){if(!a?.cssProperties?.length)return;const t=Gt(a);return te(`style="${Object.keys(t).map(n=>{const i=t[n].name,o=e[n];return o?`${i}: ${o||""}`:null}).filter(n=>n!==null).join(";")}"`)}function Xi(a,e){const t=Yt(a);if(!Object.keys(t).some(o=>!!e[o]))return;const i=Object.keys(t).filter(o=>o.endsWith("-part")).map(o=>{const s=t[o].name,l=e[o];return l?.replaceAll(/\s+/g,"")!==`${a?.tagName}::part(${s}){}`?`
${l}`:null}).filter(o=>o!==null).join(`
`);return i?te(`${i}
`):""}function Qi(a,e){const t=Xt(a);return te(`${Object.keys(t).filter(i=>i.endsWith("-slot")).map(i=>{const o=t[i].name,s=e[i];return o==="default"?s||null:s!==`<span slot="${o}"></span>`?s:null}).filter(i=>i!==null).join("")}`)}function Ji(a){Zi(a),setTimeout(()=>{const e=document.querySelector(a.tagName);zt?.observe(e,{attributes:!0})})}function Zi(a){let e=!1;const t=qi()[1],n=Kt(a);zt||(zt=new MutationObserver(i=>{i.forEach(o=>{if(o.type!=="attributes"||o.attributeName==="class"&&e)return;e=!0;const s=n[`${o.attributeName}`];s?.control==="boolean"||s?.control?.type==="boolean"?t({[`${o.attributeName}`]:o.target?.hasAttribute(o.attributeName||"")}):t({[`${o.attributeName}`]:o.target.getAttribute(o.attributeName||"")}),e=!1})}))}function ea(a){window.__WC_STORYBOOK_HELPERS_CONFIG__=a}function Bn(a){const e=window.__STORYBOOK_CUSTOM_ELEMENTS_MANIFEST__;if(!e)throw new Error(`Custom Elements Manifest not found. Be sure to follow the pre-install steps in this guide:
https://www.npmjs.com/package/wc-storybook-helpers#before-you-install`);const t=Ln(a,e),n=t?.events?.map(o=>o.name)||[],i=Rn(t);return{args:Un(t),argTypes:i,reactArgs:na(t),reactArgTypes:Wn(t),events:n,styleTemplate:o=>Hn(t,o),template:(o,s)=>Ki(t,o,s,i)}}function Rn(a){return{...Gt(a),...Yt(a),...Xt(a),...Kt(a),...Vi(a)}}function Un(a,e){return e||(e=Rn(a)),Object.entries(e).filter(([,n])=>n?.control).map(([n,i])=>{let o=ta(i.defaultValue);return i.table?.category==="css properties"&&(o=o?.toString()),{[n]:o===void 0?"":o}}).reduce((n,i)=>({...n,...i}),{})}function ta(a){try{return JSON.parse(a)}catch{return a}}function Wn(a){return{...Fi(a),...jn(a),...Gt(a,!1),...Yt(a,!1),...Xt(a,!1)}}function na(a){const e=Un(a,Wn(a)),t=Object.entries(jn(a)).map(([n])=>({[n]:()=>{}})).reduce((n,i)=>({...n,...i}),{});return{...e,...t}}const{useParameter:ia,addons:aa,useEffect:oa,useMemo:tl}=__STORYBOOK_MODULE_PREVIEW_API__;var sa=Object.defineProperty,ra=(a,e)=>{for(var t in e)sa(a,t,{get:e[t],enumerable:!0})},la={};ra(la,{initializeThemeState:()=>Yn,pluckThemeFromContext:()=>Kn,useThemeParameters:()=>Gn});var qn="themes",da=`storybook/${qn}`,ca="theme",pa={},ha={REGISTER_THEMES:`${da}/REGISTER_THEMES`};function Kn({globals:a}){return a[ca]||""}function Gn(){return ia(qn,pa)}function Yn(a,e){aa.getChannel().emit(ha.REGISTER_THEMES,{defaultTheme:e,themes:a})}var ua="html",un=a=>a.split(" ").filter(Boolean),ma=({themes:a,defaultTheme:e,parentSelector:t=ua})=>(Yn(Object.keys(a),e),(n,i)=>{let{themeOverride:o}=Gn(),s=Kn(i);return oa(()=>{let l=o||s||e,d=document.querySelector(t);if(!d)return;Object.entries(a).filter(([y])=>y!==l).forEach(([y,_])=>{let K=un(_);K.length>0&&d.classList.remove(...K)});let p=un(a[l]);p.length>0&&d.classList.add(...p)},[o,s]),n()}),fa={mobile1:{name:"Small mobile",styles:{height:"568px",width:"320px"},type:"mobile"},mobile2:{name:"Large mobile",styles:{height:"896px",width:"414px"},type:"mobile"},tablet:{name:"Tablet",styles:{height:"1112px",width:"834px"},type:"tablet"}};function F(a,e,t){return new Promise(n=>{if(t?.duration===1/0)throw new Error("Promise-based animations must be finite.");const i=a.animate(e,{...t,duration:ya()?0:t.duration});i.addEventListener("cancel",n,{once:!0}),i.addEventListener("finish",n,{once:!0})})}function mn(a){return a=a.toString().toLowerCase(),a.indexOf("ms")>-1?parseFloat(a):a.indexOf("s")>-1?parseFloat(a)*1e3:parseFloat(a)}function ya(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function q(a){return Promise.all(a.getAnimations().map(e=>new Promise(t=>{e.cancel(),requestAnimationFrame(t)})))}function fn(a,e){return a.map(t=>({...t,height:t.height==="auto"?`${e}px`:t.height}))}const Xn=new Map,Bt=new WeakMap;function Qn(a){return a??{keyframes:[],options:{duration:0}}}function yn(a,e){return e.toLowerCase()==="rtl"?{keyframes:a.rtlKeyframes||a.keyframes,options:a.options}:a}function T(a,e){Xn.set(a,Qn(e))}function Tt(a,e,t){Bt.set(a,{...Bt.get(a),[e]:Qn(t)})}function I(a,e,t){const n=Bt.get(a);if(n?.[e])return yn(n[e],t.dir);const i=Xn.get(e);return i?yn(i,t.dir):{keyframes:[],options:{duration:0}}}class W{constructor(e,...t){this.slotNames=[],this.handleSlotChange=n=>{const i=n.target;(this.slotNames.includes("[default]")&&!i.name||i.name&&this.slotNames.includes(i.name))&&this.host.requestUpdate()},(this.host=e).addController(this),this.slotNames=t}hasDefaultSlot(){return[...this.host.childNodes].some(e=>{if(e.nodeType===e.TEXT_NODE&&e.textContent.trim()!=="")return!0;if(e.nodeType===e.ELEMENT_NODE){const t=e;if(t.tagName.toLowerCase()==="syn-visually-hidden")return!1;if(!t.hasAttribute("slot"))return!0}return!1})}hasNamedSlot(e){return this.host.querySelector(`:scope > [slot="${e}"]`)!==null}test(e){return e==="[default]"?this.hasDefaultSlot():this.hasNamedSlot(e)}hostConnected(){this.host.shadowRoot.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener("slotchange",this.handleSlotChange)}}function Jn(a){if(!a)return"";const e=a.assignedNodes({flatten:!0});let t="";return[...e].forEach(n=>{n.nodeType===Node.TEXT_NODE&&(t+=n.textContent)}),t}const Zn={$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(a,e)=>`Go to slide ${a} of ${e}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:a=>a===0?"No options selected":a===1?"1 option selected":`${a} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:a=>`Slide ${a}`,toggleColorFormat:"Toggle color format",closeMenu:"Close menu",danger:"Danger",fileButtonText:"Choose file",fileButtonTextMultiple:"Choose files",folderButtonText:"Choose folder",fileDragDrop:"Drop or choose file",folderDragDrop:"Drop or choose folder",menu:"Menu",notification:"Notification",numFilesSelected:(a,e)=>a===0?`No ${e?"folder":"files"} chosen`:`${a} files`,openMenu:"Open menu",rangeMax:"Maximum",rangeMin:"Minimum",sideNav:"Side navigation",success:"Success",warning:"Warning"};Pn(Zn);class j extends bi{static{Pn(Zn)}}function U(a,e){return new Promise(t=>{function n(i){i.target===a&&(a.removeEventListener(e,n),t())}a.addEventListener(e,n)})}const ba=h`
	/* stylelint-disable */
  :host {
    display: contents;
...
`;var va=Object.defineProperty,wa=Object.getOwnPropertyDescriptor,Se=(a,e,t,n)=>{for(var i=n>1?void 0:n?wa(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&va(e,t,i),i};const Qe=Object.assign(document.createElement("div"),{className:"syn-toast-stack"});class be extends v{constructor(){super(...arguments),this.hasSlotController=new W(this,"icon","suffix"),this.localize=new j(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.remainingTime=this.duration}static{this.styles=[w,ba,ga]}static{this.dependencies={"syn-icon-button":tt}}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){this.countdownAnimation?.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),this.countdownAnimation?.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){const{countdownElement:e}=this,t="100%",n="0";this.countdownAnimation=e.animate([{width:t},{width:n}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.duration<1/0&&this.restartAutoHide(),await q(this.base),this.base.hidden=!1;const{keyframes:e,options:t}=I(this,"alert.show",{dir:this.localize.dir()});await F(this.base,e,t),this.emit("syn-after-show")}else{this.emit("syn-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await q(this.base);const{keyframes:e,options:t}=I(this,"alert.hide",{dir:this.localize.dir()});await F(this.base,e,t),this.base.hidden=!0,this.emit("syn-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,U(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,U(this,"syn-after-hide")}async toast(){return new Promise(e=>{this.handleCountdownChange(),Qe.parentElement===null&&document.body.append(Qe),Qe.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("syn-after-hide",()=>{Qe.removeChild(this),e(),Qe.querySelector("syn-alert")===null&&Qe.remove()},{once:!0})})}render(){return c`
    ...
    `}}Se([u('[part~="base"]')],be.prototype,"base",2);Se([u(".alert__countdown-elapsed")],be.prototype,"countdownElement",2);Se([r({type:Boolean,reflect:!0})],be.prototype,"open",2);Se([r({type:Boolean,reflect:!0})],be.prototype,"closable",2);Se([r({reflect:!0})],be.prototype,"variant",2);Se([r({type:Number})],be.prototype,"duration",2);Se([b()],be.prototype,"remainingTime",2);Se([m("open",{waitUntilFirstUpdate:!0})],be.prototype,"handleOpenChange",1);Se([m("duration")],be.prototype,"handleDurationChange",1);T("alert.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});T("alert.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});be.define("syn-alert");const xa=h`
	/* stylelint-disable */
  :host {
    display: inline-flex;
  }
...
`;var _a=Object.defineProperty,Ta=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&_a(e,t,i),i};class ei extends v{constructor(){super(...arguments),this.localize=new j(this),this.variant="primary"}static{this.styles=[w,xa,ka]}render(){return c`
      <span
        part="base"
    ...
    `}}Ta([r({reflect:!0})],ei.prototype,"variant");ei.define("syn-badge");const Ca=h`
	/* stylelint-disable */
  :host {
    display: inline-flex;
  }
...
`;var za=Object.defineProperty,Ea=Object.getOwnPropertyDescriptor,it=(a,e,t,n)=>{for(var i=n>1?void 0:n?Ea(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&za(e,t,i),i};class qe extends v{constructor(){super(...arguments),this.hasSlotController=new W(this,"prefix","suffix"),this.renderType="button",this.rel="noreferrer noopener"}static{this.styles=[w,Ca,Sa]}setRenderType(){const e=this.defaultSlot.assignedElements({flatten:!0}).filter(t=>t.tagName.toLowerCase()==="syn-dropdown").length>0;if(this.href){this.renderType="link";return}if(e){this.renderType="dropdown";return}this.renderType="button"}hrefChanged(){this.setRenderType()}handleSlotChange(){this.setRenderType()}render(){return c`
      <div
        part="base"
    ...
    `}}it([u("slot:not([name])")],qe.prototype,"defaultSlot",2);it([b()],qe.prototype,"renderType",2);it([r()],qe.prototype,"href",2);it([r()],qe.prototype,"target",2);it([r()],qe.prototype,"rel",2);it([m("href",{waitUntilFirstUpdate:!0})],qe.prototype,"hrefChanged",1);qe.define("syn-breadcrumb-item");const $a=h`
	/* stylelint-disable */
  .breadcrumb {
    display: flex;
    align-items: center;
...
`;class tn extends v{constructor(){super(...arguments),this.localize=new j(this)}static{this.styles=[w,Pa,Ma]}render(){return c`
...
`;var Ba=Object.defineProperty,Ra=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Ba(e,t,i),i};class ii extends v{constructor(){super(...arguments),this.hasSlotController=new W(this,"footer","header","image"),this.sharp=!1}static{this.styles=[w,Va,Ha]}render(){return c`
      <div
        part="base"
    ...
    `}}Ra([r({type:Boolean,reflect:!0})],ii.prototype,"sharp");ii.define("syn-card");const Ke=(a="value")=>(e,t)=>{const n=e.constructor,i=n.prototype.attributeChangedCallback;n.prototype.attributeChangedCallback=function(o,s,l){const d=n.getPropertyOptions(a),p=typeof d.attribute=="string"?d.attribute:a;if(o===p){const y=d.converter||dn,K=(typeof y=="function"?y:y?.fromAttribute??dn.fromAttribute)(l,d.type);this[a]!==K&&(this[t]=K)}i.call(this,o,s,l)}},ze=h`
	/* stylelint-disable */
...
`;var qa=Object.defineProperty,Ka=Object.getOwnPropertyDescriptor,ie=(a,e,t,n)=>{for(var i=n>1?void 0:n?Ka(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&qa(e,t,i),i};class Q extends v{constructor(){super(...arguments),this.formControlController=new ke(this,{value:e=>e.checked?e.value||"on":void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=t}),this.hasSlotController=new W(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.indeterminate=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}static{this.styles=[w,ze,Ua,Ee,Wa]}static{this.dependencies={"syn-icon":ue}}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleClick(){this.checked=!this.checked,this.indeterminate=!1,this.emit("syn-change")}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleInput(){this.emit("syn-input")}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStateChange(){this.input.checked=this.checked,this.input.indeterminate=this.indeterminate,this.formControlController.updateValidity()}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("help-text"),t=this.helpText?!0:!!e;return c`
    ...
    `}}ie([u('input[type="checkbox"]')],Q.prototype,"input",2);ie([b()],Q.prototype,"hasFocus",2);ie([r()],Q.prototype,"title",2);ie([r()],Q.prototype,"name",2);ie([r()],Q.prototype,"value",2);ie([r({reflect:!0})],Q.prototype,"size",2);ie([r({type:Boolean,reflect:!0})],Q.prototype,"disabled",2);ie([r({type:Boolean,reflect:!0})],Q.prototype,"checked",2);ie([r({type:Boolean,reflect:!0})],Q.prototype,"indeterminate",2);ie([Ke("checked")],Q.prototype,"defaultChecked",2);ie([r({reflect:!0})],Q.prototype,"form",2);ie([r({type:Boolean,reflect:!0})],Q.prototype,"required",2);ie([r({attribute:"help-text"})],Q.prototype,"helpText",2);ie([m("disabled",{waitUntilFirstUpdate:!0})],Q.prototype,"handleDisabledChange",1);ie([m(["checked","indeterminate"],{waitUntilFirstUpdate:!0})],Q.prototype,"handleStateChange",1);Q.define("syn-checkbox");const Ga=h`
	/* stylelint-disable */
  :host {
...
`;var Ya=Object.defineProperty,B=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Ya(e,t,i),i};function Xa(a){return a!==null&&typeof a=="object"&&"getBoundingClientRect"in a&&("contextElement"in a?a instanceof Element:!0)}class O extends v{constructor(){super(...arguments),this.localize=new j(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){const e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),n=this.placement.includes("top")||this.placement.includes("bottom");let i=0,o=0,s=0,l=0,d=0,p=0,y=0,_=0;n?e.top<t.top?(i=e.left,o=e.bottom,s=e.right,l=e.bottom,d=t.left,p=t.top,y=t.right,_=t.top):(i=t.left,o=t.bottom,s=t.right,l=t.bottom,d=e.left,p=e.top,y=e.right,_=e.top):e.left<t.left?(i=e.right,o=e.top,s=t.left,l=t.top,d=e.right,p=e.bottom,y=t.left,_=t.bottom):(i=t.right,o=t.top,s=e.left,l=e.top,d=t.right,p=t.bottom,y=e.left,_=e.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${i}px`),this.style.setProperty("--hover-bridge-top-left-y",`${o}px`),this.style.setProperty("--hover-bridge-top-right-x",`${s}px`),this.style.setProperty("--hover-bridge-top-right-y",`${l}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${d}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${p}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${y}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${_}px`)}}}static{this.styles=[w,Ga]}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has("active")&&(this.active?this.start():this.stop()),e.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){const e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchor instanceof Element||Xa(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){!this.anchorEl||!this.active||(this.cleanup=gi(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>e())):e()})}reposition(){if(!this.active||!this.anchorEl)return;const e=[vi({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?e.push(cn({apply:({rects:n})=>{const i=this.sync==="width"||this.sync==="both",o=this.sync==="height"||this.sync==="both";this.popup.style.width=i?`${n.reference.width}px`:"",this.popup.style.height=o?`${n.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&e.push(wi({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&e.push(xi({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?e.push(cn({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:n,availableHeight:i})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${i}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${n}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&e.push(ki({element:this.arrowEl,padding:this.arrowPadding}));const t=this.strategy==="absolute"?n=>jt.getOffsetParent(n,_i):jt.getOffsetParent;Ti(this.anchorEl,this.popup,{placement:this.placement,middleware:e,strategy:this.strategy,platform:{...jt,getOffsetParent:t}}).then(({x:n,y:i,middlewareData:o,placement:s})=>{const l=this.localize.dir()==="rtl",d={top:"bottom",right:"left",bottom:"top",left:"right"}[s.split("-")[0]];if(this.setAttribute("data-current-placement",s),Object.assign(this.popup.style,{left:`${n}px`,top:`${i}px`}),this.arrow){const p=o.arrow.x,y=o.arrow.y;let _="",K="",Be="",Ae="";if(this.arrowPlacement==="start"){const Xe=typeof p=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";_=typeof y=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",K=l?Xe:"",Ae=l?"":Xe}else if(this.arrowPlacement==="end"){const Xe=typeof p=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";K=l?"":Xe,Ae=l?Xe:"",Be=typeof y=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else this.arrowPlacement==="center"?(Ae=typeof p=="number"?"calc(50% - var(--arrow-size-diagonal))":"",_=typeof y=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(Ae=typeof p=="number"?`${p}px`:"",_=typeof y=="number"?`${y}px`:"");Object.assign(this.arrowEl.style,{top:_,right:K,bottom:Be,left:Ae,[d]:"calc(var(--arrow-size-diagonal) * -1)"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("syn-reposition")}render(){return c`
...
`;var Za=Object.defineProperty,eo=Object.getOwnPropertyDescriptor,$e=(a,e,t,n)=>{for(var i=n>1?void 0:n?eo(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Za(e,t,i),i};class ge extends v{constructor(){super(...arguments),this.localize=new j(this),this.isInitialized=!1,this.current=!1,this.selected=!1,this.hasHover=!1,this.value="",this.disabled=!1}static{this.styles=[w,Qa,Ja]}static{this.dependencies={"syn-icon":ue}}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.setAttribute("aria-selected","false")}handleDefaultSlotChange(){this.isInitialized?(customElements.whenDefined("syn-combobox").then(()=>{const e=this.closest("syn-combobox");e&&e.handleDefaultSlotChange()}),customElements.whenDefined("syn-select").then(()=>{const e=this.closest("syn-select");e&&e.handleDefaultSlotChange()})):this.isInitialized=!0}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleValueChange(){typeof this.value!="string"&&(this.value=String(this.value)),this.value.includes(" ")&&(console.error("Option values cannot include a space. All spaces have been replaced with underscores.",this),this.value=this.value.replace(/ /g,"_"))}getTextLabel(){const e=this.childNodes;let t="";return[...e].forEach(n=>{n.nodeType===Node.ELEMENT_NODE&&(n.hasAttribute("slot")||(t+=n.textContent)),n.nodeType===Node.TEXT_NODE&&(t+=n.textContent)}),t.trim()}render(){return c`
      <div
        part="base"
    ...
    `}}$e([u(".option__label")],ge.prototype,"defaultSlot",2);$e([b()],ge.prototype,"current",2);$e([b()],ge.prototype,"selected",2);$e([b()],ge.prototype,"hasHover",2);$e([r({reflect:!0})],ge.prototype,"value",2);$e([r({type:Boolean,reflect:!0})],ge.prototype,"disabled",2);$e([m("disabled")],ge.prototype,"handleDisabledChange",1);$e([m("selected")],ge.prototype,"handleSelectedChange",1);$e([m("value")],ge.prototype,"handleValueChange",1);const to=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`;var yo=Object.defineProperty,bo=Object.getOwnPropertyDescriptor,_e=(a,e,t,n)=>{for(var i=n>1?void 0:n?bo(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&yo(e,t,i),i};class ve extends v{constructor(){super(...arguments),this.localize=new j(this),this.open=!1,this.disabled=!1,this.contained=!1,this.size="medium"}static{this.styles=[w,mo,fo]}static{this.dependencies={"syn-icon":ue}}firstUpdated(){this.body.style.height=this.open?"auto":"0",this.open&&(this.details.open=!0),this.detailsObserver=new MutationObserver(e=>{for(const t of e)t.type==="attributes"&&t.attributeName==="open"&&(this.details.open?this.show():this.hide())}),this.detailsObserver.observe(this.details,{attributes:!0})}disconnectedCallback(){super.disconnectedCallback(),this.detailsObserver?.disconnect()}handleSummaryClick(e){e.preventDefault(),this.disabled||(this.open?this.hide():this.show(),this.header.focus())}handleSummaryKeyDown(e){(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.open?this.hide():this.show()),(e.key==="ArrowUp"||e.key==="ArrowLeft")&&(e.preventDefault(),this.hide()),(e.key==="ArrowDown"||e.key==="ArrowRight")&&(e.preventDefault(),this.show())}async handleOpenChange(){if(this.open){if(this.details.open=!0,this.emit("syn-show",{cancelable:!0}).defaultPrevented){this.open=!1,this.details.open=!1;return}await q(this.body);const{keyframes:t,options:n}=I(this,"details.show",{dir:this.localize.dir()});await F(this.body,fn(t,this.body.scrollHeight),n),this.body.style.height="auto",this.emit("syn-after-show")}else{if(this.emit("syn-hide",{cancelable:!0}).defaultPrevented){this.details.open=!0,this.open=!0;return}await q(this.body);const{keyframes:t,options:n}=I(this,"details.hide",{dir:this.localize.dir()});await F(this.body,fn(t,this.body.scrollHeight),n),this.body.style.height="auto",this.details.open=!1,this.emit("syn-after-hide")}}async show(){if(!(this.open||this.disabled))return this.open=!0,U(this,"syn-after-show")}async hide(){if(!(!this.open||this.disabled))return this.open=!1,U(this,"syn-after-hide")}render(){return c`
      <details
        part="base"
    ...
    `}}_e([u(".details")],ve.prototype,"details",2);_e([u(".details__header")],ve.prototype,"header",2);_e([u(".details__body")],ve.prototype,"body",2);_e([u(".details__expand-icon-slot")],ve.prototype,"expandIconSlot",2);_e([r({type:Boolean,reflect:!0})],ve.prototype,"open",2);_e([r()],ve.prototype,"summary",2);_e([r({type:Boolean,reflect:!0})],ve.prototype,"disabled",2);_e([r({type:Boolean,reflect:!0})],ve.prototype,"contained",2);_e([r({reflect:!0})],ve.prototype,"size",2);_e([m("open",{waitUntilFirstUpdate:!0})],ve.prototype,"handleOpenChange",1);T("details.show",{keyframes:[{height:"0",opacity:"0"},{height:"auto",opacity:"1"}],options:{duration:250,easing:"linear"}});T("details.hide",{keyframes:[{height:"auto",opacity:"1"},{height:"0",opacity:"0"}],options:{duration:250,easing:"linear"}});ve.define("syn-details");function*nn(a=document.activeElement){a!=null&&(yield a,"shadowRoot"in a&&a.shadowRoot&&a.shadowRoot.mode!=="closed"&&(yield*nn(a.shadowRoot.activeElement)))}function go(){return[...nn()].pop()}const xn=new WeakMap;function ai(a){let e=xn.get(a);return e||(e=window.getComputedStyle(a,null),xn.set(a,e)),e}function vo(a){if(typeof a.checkVisibility=="function")return a.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});const e=ai(a);return e.visibility!=="hidden"&&e.display!=="none"}function wo(a){const e=ai(a),{overflowY:t,overflowX:n}=e;return t==="scroll"||n==="scroll"?!0:t!=="auto"||n!=="auto"?!1:a.scrollHeight>a.clientHeight&&t==="auto"||a.scrollWidth>a.clientWidth&&n==="auto"}function xo(a){const e=a.tagName.toLowerCase(),t=Number(a.getAttribute("tabindex"));return a.hasAttribute("tabindex")&&(isNaN(t)||t<=-1)||a.hasAttribute("disabled")||a.closest("[inert]")||e==="input"&&a.getAttribute("type")==="radio"&&!a.hasAttribute("checked")||!vo(a)?!1:(e==="audio"||e==="video")&&a.hasAttribute("controls")||a.hasAttribute("tabindex")||a.hasAttribute("contenteditable")&&a.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(e)?!0:wo(a)}function ko(a){const e=Ut(a),t=e[0]??null,n=e[e.length-1]??null;return{start:t,end:n}}function _o(a,e){return a.getRootNode({composed:!0})?.host!==e}function Ut(a){const e=new WeakMap,t=[];function n(i){if(i instanceof Element){if(i.hasAttribute("inert")||i.closest("[inert]")||e.has(i))return;e.set(i,!0),!t.includes(i)&&xo(i)&&t.push(i),i instanceof HTMLSlotElement&&_o(i,a)&&i.assignedElements({flatten:!0}).forEach(o=>{n(o)}),i.shadowRoot!==null&&i.shadowRoot.mode==="open"&&n(i.shadowRoot)}for(const o of i.children)n(o)}return n(a),t.sort((i,o)=>{const s=Number(i.getAttribute("tabindex"))||0;return(Number(o.getAttribute("tabindex"))||0)-s})}let dt=[];class oi{constructor(e){this.tabDirection="forward",this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=t=>{if(t.key!=="Tab"||this.isExternalActivated||!this.isActive())return;const n=go();if(this.previousFocus=n,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;t.shiftKey?this.tabDirection="backward":this.tabDirection="forward";const i=Ut(this.element);let o=i.findIndex(l=>l===n);this.previousFocus=this.currentFocus;const s=this.tabDirection==="forward"?1:-1;for(;;){o+s>=i.length?o=0:o+s<0?o=i.length-1:o+=s,this.previousFocus=this.currentFocus;const l=i[o];if(this.tabDirection==="backward"&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||l&&this.possiblyHasTabbableChildren(l))return;t.preventDefault(),this.currentFocus=l,this.currentFocus?.focus({preventScroll:!1});const d=[...nn()];if(d.includes(this.currentFocus)||!d.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=e,this.elementsWithTabbableControls=["iframe"]}activate(){dt.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){dt=dt.filter(e=>e!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return dt[dt.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){const e=Ut(this.element);if(!this.element.matches(":focus-within")){const t=e[0],n=e[e.length-1],i=this.tabDirection==="forward"?t:n;typeof i?.focus=="function"&&(this.currentFocus=i,i.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(e){return this.elementsWithTabbableControls.includes(e.tagName.toLowerCase())||e.hasAttribute("controls")}}const To=h`
	/* stylelint-disable */
  :host {
    --width: 31rem;
...
`;var So=Object.defineProperty,zo=Object.getOwnPropertyDescriptor,Ge=(a,e,t,n)=>{for(var i=n>1?void 0:n?zo(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&So(e,t,i),i};class Me extends v{constructor(){super(...arguments),this.hasSlotController=new W(this,"footer"),this.localize=new j(this),this.modal=new oi(this),this.open=!1,this.label="",this.noHeader=!1,this.handleDocumentKeyDown=e=>{e.key==="Escape"&&this.modal.isActive()&&this.open&&(e.stopPropagation(),this.requestClose("keyboard"))}}static{this.styles=[w,To,Co]}static{this.dependencies={"syn-icon-button":tt}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),ht(this))}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate(),Ze(this),this.removeOpenListeners()}requestClose(e){if(this.emit("syn-request-close",{cancelable:!0,detail:{source:e}}).defaultPrevented){const n=I(this,"dialog.denyClose",{dir:this.localize.dir()});F(this.panel,n.keyframes,n.options);return}this.hide()}addOpenListeners(){"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard")):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){this.closeWatcher?.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),ht(this);const e=this.querySelector("[autofocus]");e&&e.removeAttribute("autofocus"),await Promise.all([q(this.dialog),q(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit("syn-initial-focus",{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute("autofocus","")});const t=I(this,"dialog.show",{dir:this.localize.dir()}),n=I(this,"dialog.overlay.show",{dir:this.localize.dir()});await Promise.all([F(this.panel,t.keyframes,t.options),F(this.overlay,n.keyframes,n.options)]),this.emit("syn-after-show")}else{this.emit("syn-hide"),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([q(this.dialog),q(this.overlay)]);const e=I(this,"dialog.hide",{dir:this.localize.dir()}),t=I(this,"dialog.overlay.hide",{dir:this.localize.dir()});await Promise.all([F(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),F(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,Ze(this);const n=this.originalTrigger;typeof n?.focus=="function"&&setTimeout(()=>n.focus()),this.emit("syn-after-hide")}}async show(){if(!this.open)return this.open=!0,U(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,U(this,"syn-after-hide")}render(){return c`
    ...
    `}}Ge([u(".dialog")],Me.prototype,"dialog",2);Ge([u(".dialog__panel")],Me.prototype,"panel",2);Ge([u(".dialog__overlay")],Me.prototype,"overlay",2);Ge([r({type:Boolean,reflect:!0})],Me.prototype,"open",2);Ge([r({reflect:!0})],Me.prototype,"label",2);Ge([r({attribute:"no-header",type:Boolean,reflect:!0})],Me.prototype,"noHeader",2);Ge([m("open",{waitUntilFirstUpdate:!0})],Me.prototype,"handleOpenChange",1);T("dialog.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});T("dialog.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});T("dialog.denyClose",{keyframes:[{scale:1},{scale:1.02},{scale:1}],options:{duration:250}});T("dialog.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});T("dialog.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});Me.define("syn-dialog");const Eo=h`
	/* stylelint-disable */
  :host {
...
`;var Oo=Object.defineProperty,Do=Object.getOwnPropertyDescriptor,si=(a,e,t,n)=>{for(var i=n>1?void 0:n?Do(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Oo(e,t,i),i};class Le extends v{constructor(){super(...arguments),this.vertical=!1}static{this.styles=[w,Eo,$o]}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}}si([r({type:Boolean,reflect:!0})],Le.prototype,"vertical",2);si([m("vertical")],Le.prototype,"handleVerticalChange",1);Le.define("syn-divider");function kn(a){return a.charAt(0).toUpperCase()+a.slice(1)}const No=h`
	/* stylelint-disable */
  :host {
    --size: 25rem;
    --header-spacing: var(--syn-spacing-large);
...
`;var Ao=Object.defineProperty,Po=Object.getOwnPropertyDescriptor,Te=(a,e,t,n)=>{for(var i=n>1?void 0:n?Po(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Ao(e,t,i),i};class ye extends v{constructor(){super(...arguments),this.hasSlotController=new W(this,"footer"),this.localize=new j(this),this.modal=new oi(this),this.open=!1,this.label="",this.placement="end",this.contained=!1,this.noHeader=!1,this.handleDocumentKeyDown=e=>{this.contained||e.key==="Escape"&&this.modal.isActive()&&this.open&&(e.stopImmediatePropagation(),this.requestClose("keyboard"))}}static{this.styles=[w,No,Io]}static{this.dependencies={"syn-icon-button":tt}}firstUpdated(){this.drawer.hidden=!this.open,this.open&&(this.addOpenListeners(),this.contained||(this.modal.activate(),ht(this)))}disconnectedCallback(){super.disconnectedCallback(),Ze(this),this.removeOpenListeners()}requestClose(e){if(this.emit("syn-request-close",{cancelable:!0,detail:{source:e}}).defaultPrevented){const n=I(this,"drawer.denyClose",{dir:this.localize.dir()});F(this.panel,n.keyframes,n.options);return}this.hide()}addOpenListeners(){"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.contained||(this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard"))):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){document.removeEventListener("keydown",this.handleDocumentKeyDown),this.closeWatcher?.destroy()}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.contained||(this.modal.activate(),ht(this));const e=this.querySelector("[autofocus]");e&&e.removeAttribute("autofocus"),await Promise.all([q(this.drawer),q(this.overlay)]),this.drawer.hidden=!1,requestAnimationFrame(()=>{this.emit("syn-initial-focus",{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute("autofocus","")});const t=I(this,`drawer.show${kn(this.placement)}`,{dir:this.localize.dir()}),n=I(this,"drawer.overlay.show",{dir:this.localize.dir()});await Promise.all([F(this.panel,t.keyframes,t.options),F(this.overlay,n.keyframes,n.options)]),this.emit("syn-after-show")}else{this.emit("syn-hide"),this.removeOpenListeners(),this.contained||(this.modal.deactivate(),Ze(this)),await Promise.all([q(this.drawer),q(this.overlay)]);const e=I(this,`drawer.hide${kn(this.placement)}`,{dir:this.localize.dir()}),t=I(this,"drawer.overlay.hide",{dir:this.localize.dir()});await Promise.all([F(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),F(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.drawer.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1;const n=this.originalTrigger;typeof n?.focus=="function"&&setTimeout(()=>n.focus()),this.emit("syn-after-hide")}}handleNoModalChange(){this.open&&!this.contained&&(this.modal.activate(),ht(this)),this.open&&this.contained&&(this.modal.deactivate(),Ze(this))}async show(){if(!this.open)return this.open=!0,U(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,U(this,"syn-after-hide")}render(){return c`
      <div
        part="base"
    ...
    `}}Te([u(".drawer")],ye.prototype,"drawer",2);Te([u(".drawer__panel")],ye.prototype,"panel",2);Te([u(".drawer__overlay")],ye.prototype,"overlay",2);Te([r({type:Boolean,reflect:!0})],ye.prototype,"open",2);Te([r({reflect:!0})],ye.prototype,"label",2);Te([r({reflect:!0})],ye.prototype,"placement",2);Te([r({type:Boolean,reflect:!0})],ye.prototype,"contained",2);Te([r({attribute:"no-header",type:Boolean,reflect:!0})],ye.prototype,"noHeader",2);Te([m("open",{waitUntilFirstUpdate:!0})],ye.prototype,"handleOpenChange",1);Te([m("contained",{waitUntilFirstUpdate:!0})],ye.prototype,"handleNoModalChange",1);T("drawer.showTop",{keyframes:[{opacity:0,translate:"0 -100%"},{opacity:1,translate:"0 0"}],options:{duration:250,easing:"ease"}});T("drawer.hideTop",{keyframes:[{opacity:1,translate:"0 0"},{opacity:0,translate:"0 -100%"}],options:{duration:250,easing:"ease"}});T("drawer.showEnd",{keyframes:[{opacity:0,translate:"100%"},{opacity:1,translate:"0"}],rtlKeyframes:[{opacity:0,translate:"-100%"},{opacity:1,translate:"0"}],options:{duration:250,easing:"ease"}});T("drawer.hideEnd",{keyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"100%"}],rtlKeyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"-100%"}],options:{duration:250,easing:"ease"}});T("drawer.showBottom",{keyframes:[{opacity:0,translate:"0 100%"},{opacity:1,translate:"0 0"}],options:{duration:250,easing:"ease"}});T("drawer.hideBottom",{keyframes:[{opacity:1,translate:"0 0"},{opacity:0,translate:"0 100%"}],options:{duration:250,easing:"ease"}});T("drawer.showStart",{keyframes:[{opacity:0,translate:"-100%"},{opacity:1,translate:"0"}],rtlKeyframes:[{opacity:0,translate:"100%"},{opacity:1,translate:"0"}],options:{duration:250,easing:"ease"}});T("drawer.hideStart",{keyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"-100%"}],rtlKeyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"100%"}],options:{duration:250,easing:"ease"}});T("drawer.denyClose",{keyframes:[{scale:1},{scale:1.01},{scale:1}],options:{duration:250}});T("drawer.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});T("drawer.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});ye.define("syn-drawer");const Mo=h`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
`;var Ho=Object.defineProperty,Bo=Object.getOwnPropertyDescriptor,R=(a,e,t,n)=>{for(var i=n>1?void 0:n?Bo(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Ho(e,t,i),i};class H extends v{constructor(){super(...arguments),this.formControlController=new ke(this,{assumeInteractionOn:["syn-change"],value:e=>e.files}),this.hasSlotController=new W(this,"help-text","label"),this.localize=new j(this),this.userIsDragging=!1,this.name="",this.defaultValue="",this.size="medium",this.label="",this.helpText="",this.disabled=!1,this.droparea=!1,this.accept="",this.multiple=!1,this.webkitdirectory=!1,this.form="",this.required=!1,this.hideValue=!1}static{this.styles=[w,ze,Ee,Vo]}static{this.dependencies={"syn-button":P,"syn-icon":ue}}set files(e){this.input&&(this.input.files=e)}get files(){return this.input?.files}set value(e){this.input&&(this.input.value=e)}get value(){return this.input?.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(e){if(this.droparea){this.dropareaWrapper?.focus(e);return}this.button?.focus(e)}blur(){if(this.droparea){this.dropareaWrapper?.blur();return}this.button?.blur()}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleFiles(e){if(!e){this.value="";return}this.files=e}async handleTransferItems(e){if(!e)return this.value="",new Promise((l,d)=>{d(new Error("No proper items found"))});const n=Array.from(e).map(l=>l.webkitGetAsEntry()).map(l=>this.getFilesFromEntry(l)),o=(await Promise.all(n)).flat(),s=new DataTransfer;return Array.from(o).forEach(l=>s.items.add(l)),s.files}async getFilesFromEntry(e){return e?e.isFile?new Promise((t,n)=>{e.file(i=>t([i]),n)}):e.isDirectory?new Promise((t,n)=>{e.createReader().readEntries(o=>{Promise.all(o.map(s=>this.getFilesFromEntry(s))).then(s=>{t(s.flat())}).catch(n)})}):[]:[]}handleClick(e){e.preventDefault(),this.input.click()}handleChange(e){e.preventDefault(),e.stopPropagation(),this.emit("syn-input"),this.emit("syn-change")}handleDragOver(e){e.preventDefault(),e.stopPropagation(),this.userIsDragging=!0}handleDragLeave(e){e.preventDefault(),e.stopPropagation(),this.userIsDragging=!1}async handleDrop(e){if(e.preventDefault(),e.stopPropagation(),!e.dataTransfer)return;const t=await this.handleTransferItems(e.dataTransfer?.items);if(this.userIsDragging=!1,!t)return;if(!this.multiple&&!this.webkitdirectory&&t.length>1){this.emit("syn-error");return}if(this.hasSlotController.test("trigger"))this.handleFiles(t);else{const i=I(this.inputChosen,"file.text.disappear",{dir:this.localize.dir()}),o=I(this.inputChosen,"file.text.appear",{dir:this.localize.dir()});if(this.droparea){const s=I(this.dropareaIcon,"file.iconDrop",{dir:this.localize.dir()});F(this.dropareaIcon,s.keyframes,s.options)}await F(this.inputChosen,i.keyframes,i.options),this.handleFiles(t),await F(this.inputChosen,o.keyframes,o.options)}this.input.dispatchEvent(new Event("change"))}handleFocus(){this.emit("syn-focus")}handleBlur(){this.emit("syn-blur")}renderValue(){let e=!1,t=this.localize.term("numFilesSelected",0,this.webkitdirectory);return this.files&&this.files?.length>0&&(e=!0,t=this.files.length===1?this.files[0].name:this.localize.term("numFilesSelected",this.files.length,this.webkitdirectory)),c`
    ...
    `}renderButton(){let e=this.localize.term("fileButtonText");return this.multiple&&(e=this.localize.term("fileButtonTextMultiple")),this.webkitdirectory&&(e=this.localize.term("folderButtonText")),c`
      <div
    ...
    `}render(){const e=this.label||!!this.hasSlotController.test("label"),t=this.helpText?!0:!!this.hasSlotController.test("help-text"),n=!!this.hasSlotController.test("trigger");return c`
      <div
...
`;var Uo=Object.defineProperty,Wo=Object.getOwnPropertyDescriptor,Dt=(a,e,t,n)=>{for(var i=n>1?void 0:n?Wo(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Uo(e,t,i),i};class gt extends v{constructor(){super(...arguments),this.hasSlotController=new W(this,"[default]","logo","label","meta-navigation","navigation"),this.localize=new j(this),this.label="",this.burgerMenu="hidden"}static{this.styles=[w,Ro]}static{this.dependencies={"syn-icon":ue}}toggleBurgerMenu(){switch(this.burgerMenu){case"closed":this.burgerMenu="open";break;case"open":this.burgerMenu="closed";break}}handleBurgerMenuToggle(){this.sideNav&&!this.sideNav.rail&&(this.sideNav.open=!this.sideNav.open),this.toggleBurgerMenu()}updateBurgerMenuBasedOnSideNav(){this.sideNav&&(this.sideNav.rail?this.burgerMenu="hidden":this.burgerMenu=this.sideNav.open?"open":"closed")}handleBurgerMenu(){const e=`syn-burger-menu-${this.burgerMenu}`;this.emit(e)}connectedCallback(){super.connectedCallback(),this.mutationObserver=new MutationObserver(()=>this.updateBurgerMenuBasedOnSideNav())}firstUpdated(){const e=document.querySelector("syn-side-nav");this.connectSideNavigation(e)}disconnectedCallback(){super.disconnectedCallback(),this.mutationObserver.disconnect()}connectSideNavigation(e){this.mutationObserver.disconnect(),this.sideNav=e||document.querySelector("syn-side-nav"),this.sideNav&&(this.updateBurgerMenuBasedOnSideNav(),this.mutationObserver.observe(this.sideNav,{attributeFilter:["open","rail"],attributes:!0}))}render(){const e=this.hasSlotController.test("navigation"),t=this.burgerMenu!=="hidden";return k`
    ...
    `}}Dt([r()],gt.prototype,"label",2);Dt([r({attribute:"burger-menu",reflect:!0})],gt.prototype,"burgerMenu",2);Dt([b()],gt.prototype,"sideNav",2);Dt([m("burgerMenu",{waitUntilFirstUpdate:!0})],gt.prototype,"handleBurgerMenu",1);gt.define("syn-header");class qo extends An{constructor(e){if(super(e),this.handlePointerDown=t=>{t.button!==0||this.host.disabled||this.spinOnLongPressCallback(t)},this.handlePointerUp=t=>{t?.preventDefault(),t?.stopPropagation(),this.timeout&&this.callbacks.start(),this.stopSpinningAndCleanUp(),this.callbacks.end(),document.removeEventListener("pointerup",this.handlePointerUp)},e.type!==mi.ELEMENT||!(e.element instanceof HTMLButtonElement))throw new Error("The `longPress` directive must be used on an HTMLButtonElement.")}render(e){return Nn}update(e,[t]){return this.callbacks===void 0&&this.host===void 0&&(this.host=e.element,this.callbacks={...t},this.host.addEventListener("pointerdown",this.handlePointerDown)),yi}disconnected(){this.stopSpinningAndCleanUp(),this.host.removeEventListener("pointerdown",this.handlePointerDown),document.removeEventListener("pointerup",this.handlePointerUp)}spinOnLongPressCallback(e){e.preventDefault(),e.stopPropagation(),this.timeout=setTimeout(()=>{this.timeout=void 0,this.interval=setInterval(()=>{this.callbacks.start()},50)},500),document.addEventListener("pointerup",this.handlePointerUp),this.observer?.disconnect(),this.observer=new MutationObserver(t=>{t.forEach(n=>{n.attributeName==="disabled"&&this.stopSpinningAndCleanUp()})}),this.observer.observe(this.host,{attributes:!0})}stopSpinningAndCleanUp(){clearInterval(this.interval),clearTimeout(this.timeout),this.observer?.disconnect()}}const _n=Dn(qo),Ko=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`;var Yo=Object.defineProperty,Xo=Object.getOwnPropertyDescriptor,S=(a,e,t,n)=>{for(var i=n>1?void 0:n?Xo(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Yo(e,t,i),i};class C extends v{constructor(){super(...arguments),this.formControlController=new ke(this,{assumeInteractionOn:["syn-blur","syn-input"]}),this.hasSlotController=new W(this,"help-text","label","prefix","suffix"),this.localize=new j(this),this.hasFocus=!1,this.title="",this.__numberInput=Object.assign(document.createElement("input"),{type:"number"}),this.__dateInput=Object.assign(document.createElement("input"),{type:"date"}),this.type="text",this.name="",this.value="",this.defaultValue="",this.size="medium",this.label="",this.helpText="",this.clearable=!1,this.disabled=!1,this.placeholder="",this.readonly=!1,this.passwordToggle=!1,this.passwordVisible=!1,this.noSpinButtons=!1,this.form="",this.required=!1,this.spellcheck=!0}static{this.styles=[w,ze,Ko,Ee,Go]}static{this.dependencies={"syn-icon":ue,"syn-divider":Le}}get valueAsDate(){return this.__dateInput.type=this.type,this.__dateInput.value=this.value,this.input?.valueAsDate||this.__dateInput.valueAsDate}set valueAsDate(e){this.__dateInput.type=this.type,this.__dateInput.valueAsDate=e,this.value=this.__dateInput.value}get valueAsNumber(){return this.__numberInput.value=this.value,this.input?.valueAsNumber||this.__numberInput.valueAsNumber}set valueAsNumber(e){this.__numberInput.valueAsNumber=e,this.value=this.__numberInput.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleStep(){this.handleInput(),this.input.focus()}handleStepUp(){this.stepUp(),this.handleStep()}handleStepDown(){this.stepDown(),this.handleStep()}isDecrementDisabled(){if(this.disabled||this.readonly)return!0;if(this.min===void 0||this.min===null||this.disabled)return!1;const e=typeof this.min=="string"?parseFloat(this.min):this.min;return this.valueAsNumber<=e}isIncrementDisabled(){if(this.disabled||this.readonly)return!0;if(this.max===void 0||this.max===null)return!1;const e=typeof this.max=="string"?parseFloat(this.max):this.max;return this.valueAsNumber>=e}handleChange(){this.value=this.input.value,this.emit("syn-change")}handleClearClick(e){e.preventDefault(),this.value!==""&&(this.value="",this.emit("syn-clear"),this.emit("syn-input"),this.emit("syn-change")),this.input.focus()}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleInput(){this.value=this.input.value,this.formControlController.updateValidity(),this.emit("syn-input")}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleKeyDown(e){const t=e.metaKey||e.ctrlKey||e.shiftKey||e.altKey;e.key==="Enter"&&!t&&setTimeout(()=>{!e.defaultPrevented&&!e.isComposing&&this.formControlController.submit()})}handlePasswordToggle(){this.passwordVisible=!this.passwordVisible}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStepChange(){this.input.step=String(this.step),this.formControlController.updateValidity()}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(e){this.input.focus(e)}blur(){this.input.blur()}select(){this.input.select()}setSelectionRange(e,t,n="none"){this.input.setSelectionRange(e,t,n)}setRangeText(e,t,n,i="preserve"){const o=t??this.input.selectionStart,s=n??this.input.selectionEnd;this.input.setRangeText(e,o,s,i),this.value!==this.input.value&&(this.value=this.input.value)}showPicker(){"showPicker"in HTMLInputElement.prototype&&this.input.showPicker()}stepUp(){this.input.stepUp(),this.value!==this.input.value&&(this.value=this.input.value)}stepDown(){this.input.stepDown(),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("label"),t=this.hasSlotController.test("help-text"),n=this.hasSlotController.test("prefix"),i=this.hasSlotController.test("suffix"),o=this.label?!0:!!e,s=this.helpText?!0:!!t,d=this.clearable&&!this.disabled&&!this.readonly&&(typeof this.value=="number"||this.value.length>0);return c`
    ...
    `:c` <slot name="submenu" hidden></slot> `}}const Jo=h`
	/* stylelint-disable */
  :host {
    --submenu-offset: -2px;
...
`;function es(a,e){const t={waitUntilFirstUpdated:!1,...e};return n=>class extends n{#e=!t.waitUntilFirstUpdated;updated(i){if(!this.#e){this.#e=!0;return}const o=Array.from(i).filter(([l])=>a.includes(l));if(o.length===0){super.updated(i);return}const s=o.map(([l,d])=>({attribute:l,newValue:this[l],oldValue:d}));this.emit("syn-attributes-changed",{detail:s}),super.updated(i)}}}var ts=Object.defineProperty,ns=Object.getOwnPropertyDescriptor,we=(a,e,t,n)=>{for(var i=n>1?void 0:n?ns(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&ts(e,t,i),i};let ne=class extends v{constructor(){super(...arguments),this.localize=new j(this),this.type="normal",this.checked=!1,this.value="",this.loading=!1,this.disabled=!1,this.hasSlotController=new W(this,"submenu"),this.submenuController=new Qo(this,this.hasSlotController),this.handleHostClick=a=>{this.disabled&&(a.preventDefault(),a.stopImmediatePropagation())},this.handleMouseOver=a=>{this.focus(),a.stopPropagation()}}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this.handleHostClick),this.addEventListener("mouseover",this.handleMouseOver)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.handleHostClick),this.removeEventListener("mouseover",this.handleMouseOver)}handleDefaultSlotChange(){const a=this.getTextLabel();if(typeof this.cachedTextLabel>"u"){this.cachedTextLabel=a;return}a!==this.cachedTextLabel&&(this.cachedTextLabel=a,this.emit("slotchange",{bubbles:!0,composed:!1,cancelable:!1}))}handleCheckedChange(){if(this.checked&&this.type!=="checkbox"){this.checked=!1,console.error('The checked attribute can only be used on menu items with type="checkbox"',this);return}this.type==="checkbox"?this.setAttribute("aria-checked",this.checked?"true":"false"):this.removeAttribute("aria-checked")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleTypeChange(){this.type==="checkbox"?(this.setAttribute("role","menuitemcheckbox"),this.setAttribute("aria-checked",this.checked?"true":"false")):(this.setAttribute("role","menuitem"),this.removeAttribute("aria-checked"))}getTextLabel(){return Jn(this.defaultSlot)}isSubmenu(){return this.hasSlotController.test("submenu")}render(){const a=this.localize.dir()==="rtl",e=this.submenuController.isExpanded();return c`
    ...
    `}};ne.styles=[w,Jo,Zo];ne.dependencies={"syn-icon":ue,"syn-popup":O,"syn-spinner":tn};we([u("slot:not([name])")],ne.prototype,"defaultSlot",2);we([u(".menu-item")],ne.prototype,"menuItem",2);we([r()],ne.prototype,"type",2);we([r({type:Boolean,reflect:!0})],ne.prototype,"checked",2);we([r()],ne.prototype,"value",2);we([r({type:Boolean,reflect:!0})],ne.prototype,"loading",2);we([r({type:Boolean,reflect:!0})],ne.prototype,"disabled",2);we([m("checked")],ne.prototype,"handleCheckedChange",1);we([m("disabled")],ne.prototype,"handleDisabledChange",1);we([m("type")],ne.prototype,"handleTypeChange",1);ne=we([es(["type","loading"],{waitUntilFirstUpdated:!0})],ne);ne.define("syn-menu-item");const is=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`;class os extends v{static{this.styles=[w,is,as]}static{this.dependencies={"syn-divider":Le}}render(){return c`
    ...
    `}}os.define("syn-menu-label");const ss=h`
	/* stylelint-disable */
  :host {
    display: block;
    position: relative;
...
`;var ls=Object.defineProperty,ri=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&ls(e,t,i),i};class Nt extends v{constructor(){super(...arguments),this.hasMenuItemsWithCheckmarks=!1,this.updateCheckMarksByChildPropChange=e=>{e.stopImmediatePropagation(),this.handleUpdateCheckmarks(this.getAllItems())}}static{this.styles=[w,ss,rs]}handleUpdateCheckmarks(e){this.hasMenuItemsWithCheckmarks=e.some(t=>t.type==="checkbox"||t.loading)}disconnectedCallback(){this.removeEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu"),this.addEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}handleClick(e){const t=["menuitem","menuitemcheckbox"],n=e.composedPath(),i=n.find(d=>t.includes(d?.getAttribute?.("role")||""));if(!i||n.find(d=>d?.getAttribute?.("role")==="menu")!==this)return;const l=i;l.type==="checkbox"&&(l.checked=!l.checked),this.emit("syn-select",{detail:{item:l}})}handleKeyDown(e){if(e.key==="Enter"||e.key===" "){const t=this.getCurrentItem();e.preventDefault(),e.stopPropagation(),t?.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(e.key)){const t=this.getAllItems(),n=this.getCurrentItem();let i=n?t.indexOf(n):0;t.length>0&&(e.preventDefault(),e.stopPropagation(),e.key==="ArrowDown"?i++:e.key==="ArrowUp"?i--:e.key==="Home"?i=0:e.key==="End"&&(i=t.length-1),i<0&&(i=t.length-1),i>t.length-1&&(i=0),this.setCurrentItem(t[i]),t[i].focus())}}handleMouseDown(e){const t=e.target;this.isMenuItem(t)&&this.setCurrentItem(t)}handleSlotChange(){const e=this.getAllItems();this.handleUpdateCheckmarks(e),e.length>0&&this.setCurrentItem(e[0])}isMenuItem(e){return e.tagName.toLowerCase()==="syn-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes(e.getAttribute("role")??"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>!(e.inert||!this.isMenuItem(e)))}getCurrentItem(){return this.getAllItems().find(e=>e.getAttribute("tabindex")==="0")}setCurrentItem(e){this.getAllItems().forEach(n=>{n.setAttribute("tabindex",n===e?"0":"-1")})}render(){return c`
      ...
      ></slot>
    `}}ri([u("slot")],Nt.prototype,"defaultSlot");ri([b()],Nt.prototype,"hasMenuItemsWithCheckmarks");Nt.define("syn-menu");const ds=h`
  /**
...
`;var us=Object.defineProperty,ms=Object.getOwnPropertyDescriptor,It=(a,e,t,n)=>{for(var i=n>1?void 0:n?ms(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&us(e,t,i),i};class vt extends v{constructor(){super(...arguments),this.hasSlotController=new W(this,"[default]","prefix","suffix","label"),this.disabled=!1,this.label=""}static{this.styles=hs}static{this.dependencies={"syn-divider":Le}}handleDisableOptions(){const{disabled:e}=this;this.defaultSlot.assignedElements().filter(t=>t.tagName.toLowerCase()==="syn-option").forEach(t=>{t.disabled=e})}handleDisabledChange(){this.handleDisableOptions()}render(){const{disabled:e}=this,t=this.hasSlotController.test("label"),n=this.label?!0:!!t;return k`
      <div
    ...
    `}}It([u("slot:not([name])")],vt.prototype,"defaultSlot",2);It([r({reflect:!0,type:Boolean})],vt.prototype,"disabled",2);It([r()],vt.prototype,"label",2);It([m("disabled",{waitUntilFirstUpdate:!0})],vt.prototype,"handleDisabledChange",1);vt.define("syn-optgroup");ge.define("syn-option");O.define("syn-popup");const fs=h`
  :host {
    display: block;
...
`,Tn=a=>Array.from(a.assignedElements({flatten:!0})),ys=a=>a.tagName.toLocaleLowerCase()==="syn-nav-item"||(a.getAttribute("role")??"")==="menuitem",Cn=a=>a.filter(ys),bs=a=>{a.setAttribute("horizontal","true"),a.removeAttribute("slot"),a.removeAttribute("tabindex"),a.dataset.originalRole?a.setAttribute("role",a.dataset.originalRole):a.removeAttribute("role")},gs=a=>{a.removeAttribute("horizontal"),a.setAttribute("slot","menu"),a.setAttribute("role","menuitem")};var vs=Object.defineProperty,je=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&vs(e,t,i),i};class Oe extends v{constructor(){super(...arguments),this.localize=new j(this),this.itemPositionsCached=!1,this.amountOfNavItems=0,this.amountOfVisibleItems=0,this.hasItemsInDropdown=!1}static{this.styles=[w,fs]}static{this.dependencies={"syn-dropdown":ae,"syn-icon":ue,"syn-menu":Nt,"syn-nav-item":J}}getSlottedNavItems(){const e=Cn(Tn(this.defaultSlot)),t=Cn(Tn(this.menuSlot));return e.concat(t)}cacheItemPositions(e){const{left:t}=this.horizontalNav.getBoundingClientRect();e.forEach(n=>{n.removeAttribute("slot");const{right:i}=n.getBoundingClientRect();n.dataset.right=(i-t).toString()}),this.itemPositionsCached=!0}handlePriorityMenu(){const e=this.getSlottedNavItems();this.itemPositionsCached||this.cacheItemPositions(e);const{width:t}=this.horizontalNav.getBoundingClientRect(),n=this.priorityMenu.classList.contains("priority-menu--hidden")?0:this.priorityMenu.clientWidth,i=t-n;let o;const s=e.at(-1),l=e.map(y=>{const _=y===s?t:i,K=!!(o||parseFloat(y.dataset.right)>_);return K&&!o&&(o=parseFloat(y.dataset.right)),{isHidden:K,item:y}}),d=l.filter(({isHidden:y})=>!y).length,p=d===1;l.forEach(({item:y,isHidden:_})=>{_||p?gs(y):bs(y)}),this.hasItemsInDropdown=d!==e.length,this.amountOfVisibleItems=p?0:d}renderPriorityMenu(){return k`
      <syn-dropdown
    ...
    `}}je([u("slot:not([name])")],Oe.prototype,"defaultSlot");je([u("slot[name=menu]")],Oe.prototype,"menuSlot");je([u(".horizontal-nav")],Oe.prototype,"horizontalNav");je([u(".priority-menu")],Oe.prototype,"priorityMenu");je([b()],Oe.prototype,"itemPositionsCached");je([b()],Oe.prototype,"amountOfNavItems");je([b()],Oe.prototype,"amountOfVisibleItems");je([b()],Oe.prototype,"hasItemsInDropdown");Oe.define("syn-prio-nav");const ws=h`
	/* stylelint-disable */
  :host {
    --height: 1rem;
...
`;var ks=Object.defineProperty,an=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&ks(e,t,i),i};class At extends v{constructor(){super(...arguments),this.localize=new j(this),this.value=0,this.indeterminate=!1,this.label=""}static{this.styles=[w,ws,xs]}render(){return c`
      <div
        part="base"
    ...
    `}}an([r({type:Number,reflect:!0})],At.prototype,"value");an([r({type:Boolean,reflect:!0})],At.prototype,"indeterminate");an([r()],At.prototype,"label");At.define("syn-progress-bar");const _s=h`
	/* stylelint-disable */
  :host {
    --size: 128px;
    --track-width: 4px;
...
`;var Cs=Object.defineProperty,Pt=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Cs(e,t,i),i};class wt extends v{constructor(){super(...arguments),this.localize=new j(this),this.value=0,this.label=""}static{this.styles=[w,_s,Ts]}updated(e){if(super.updated(e),e.has("value")){const t=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),n=2*Math.PI*t,i=n-this.value/100*n;this.indicatorOffset=`${i}px`}}render(){return c`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
    ...
    `}}Pt([u(".progress-ring__indicator")],wt.prototype,"indicator");Pt([b()],wt.prototype,"indicatorOffset");Pt([r({type:Number,reflect:!0})],wt.prototype,"value");Pt([r()],wt.prototype,"label");wt.define("syn-progress-ring");const Ss=h`
	/* stylelint-disable */
  ${ni}
...
`;var zs=Object.defineProperty,Es=Object.getOwnPropertyDescriptor,De=(a,e,t,n)=>{for(var i=n>1?void 0:n?Es(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&zs(e,t,i),i};class Ce extends v{constructor(){super(...arguments),this.hasSlotController=new W(this,"[default]","prefix","suffix"),this.hasFocus=!1,this.checked=!1,this.disabled=!1,this.size="medium",this.pill=!1}static{this.styles=[w,Ss]}connectedCallback(){super.connectedCallback(),this.setAttribute("role","presentation")}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleClick(e){if(this.disabled){e.preventDefault(),e.stopPropagation();return}this.checked=!0}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}focus(e){this.input.focus(e)}blur(){this.input.blur()}render(){return k`
...
`;var Ps=Object.defineProperty,Ms=Object.getOwnPropertyDescriptor,Ye=(a,e,t,n)=>{for(var i=n>1?void 0:n?Ms(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Ps(e,t,i),i};class Fe extends v{constructor(){super(),this.checked=!1,this.hasFocus=!1,this.size="medium",this.disabled=!1,this.handleBlur=()=>{this.hasFocus=!1,this.emit("syn-blur")},this.handleClick=()=>{this.disabled||(this.checked=!0)},this.handleFocus=()=>{this.hasFocus=!0,this.emit("syn-focus")},this.addEventListener("blur",this.handleBlur),this.addEventListener("click",this.handleClick),this.addEventListener("focus",this.handleFocus)}static{this.styles=[w,Is,As]}static{this.dependencies={"syn-icon":ue}}connectedCallback(){super.connectedCallback(),this.setInitialAttributes()}setInitialAttributes(){this.setAttribute("role","radio"),this.setAttribute("tabindex","-1"),this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleCheckedChange(){this.setAttribute("aria-checked",this.checked?"true":"false"),this.setAttribute("tabindex",this.checked?"0":"-1")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}render(){return c`
      <span
        part="base"
    ...
    `}}Ye([b()],Fe.prototype,"checked",2);Ye([b()],Fe.prototype,"hasFocus",2);Ye([r()],Fe.prototype,"value",2);Ye([r({reflect:!0})],Fe.prototype,"size",2);Ye([r({type:Boolean,reflect:!0})],Fe.prototype,"disabled",2);Ye([m("checked")],Fe.prototype,"handleCheckedChange",1);Ye([m("disabled",{waitUntilFirstUpdate:!0})],Fe.prototype,"handleDisabledChange",1);Fe.define("syn-radio");const Ls=h`
  :host {
...
`;var js=Object.defineProperty,Fs=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&js(e,t,i),i};class li extends v{constructor(){super(...arguments),this.subdivision=!1}static{this.styles=[w,Ls]}render(){return c`
      <div
    ...
    `}}Fs([r({reflect:!0,type:Boolean})],li.prototype,"subdivision");li.define("syn-range-tick");const Vs=h`
	/* stylelint-disable */
  :host {
    --max-width: 20rem;
    --hide-delay: 0ms;
...
`;var Ws=Object.defineProperty,qs=Object.getOwnPropertyDescriptor,Y=(a,e,t,n)=>{for(var i=n>1?void 0:n?qs(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Ws(e,t,i),i};class G extends v{constructor(){super(),this.name="",this.label="",this.helpText="",this.disabled=!1,this.min=0,this.max=100,this.step=1,this.size="medium",this.tooltipPlacement="top",this.defaultValue="0",this.form="",this.hasSlotController=new W(this,"help-text","label","prefix","suffix","ticks"),this.formControlController=new ke(this,{assumeInteractionOn:["syn-change"]}),this.localize=new j(this),this.#e=[0],this.#t=new Map,this.#a=!1,this.#i="",this.#d=1,this.#n=[],this.tooltipFormatter=this.localize.number.bind(this.localize)}static{this.styles=[w,ze,Ee,Us]}static{this.dependencies={"syn-tooltip":Z}}set value(e){this.#e=e?e.split(" ").map(t=>+t).sort(Ue):[]}get value(){return this.#e.slice().sort(Ue).join(" ")}set valueAsArray(e){const t=this.#e;this.#e=Array.isArray(e)?e.slice().sort(Ue):e||[],ct(t,this.#e)&&this.requestUpdate("value",t.join(" "))}get valueAsArray(){return[...this.#e].sort(Ue)}#e;#t;#a;#i;#c;#d;#n;get#o(){return this.localize.dir()==="rtl"}firstUpdated(){this.formControlController.updateValidity(),this.#n=Array.from(this.#e),this.thumbs.forEach(e=>{const t=e.parentElement;t.updateComplete.then(()=>{t.shadowRoot.querySelector(".tooltip__body")?.setAttribute("aria-hidden","true")})})}willUpdate(e){super.willUpdate(e),this.min>this.max&&([this.min,this.max]=[this.max,this.min]),this.step>this.max-this.min&&(this.step=this.max-this.min),this.step<=0&&(this.step=1);const t=this.#e.map(n=>{if(n<=this.min)return this.min;if(n>=this.max)return this.max;const i=this.min+this.step*Math.round((n-this.min)/this.step);return i>this.max?this.max:i});ct(this.#e,t)&&(this.#e=t)}updated(e){super.updated(e);for(const t of this.thumbs){const n=+t.dataset.rangeId;this.#t.has(n)&&this.#s(t,this.#t.get(n))}this.#r()}focus(e){const t=this.thumbs.item(0);t?t.focus(e):super.focus(e)}checkValidity(){if(this.disabled)return!0;const e=!this.#i;return e||this.formControlController.emitInvalidEvent(),e}reportValidity(){if(this.disabled)return!0;const e=this.validity.valid;return this.formControlController.setValidity(e),this.validationInput.hidden=!0,clearTimeout(this.#c),e||(this.validationInput.hidden=!1,this.validationInput.reportValidity(),this.#c=setTimeout(()=>{this.validationInput.hidden=!0},1e4)),e}setCustomValidity(e){this.#i=e,this.validationInput.setCustomValidity(e),this.formControlController.updateValidity()}getForm(){return this.formControlController.getForm()}get validity(){return this.#i?ti:bt}get validationMessage(){return this.#i}#p(e){if(this.disabled)return;const{clientX:t}=e,n=Array.from(this.thumbs),i=Sn(this.baseDiv,t,this.#o),o=this.step/(this.max-this.min),s=this.min+this.step*Math.round(i/o),l=n.reduce((y,_)=>{const K=this.#t.get(+_.dataset.rangeId),Be=this.#t.get(+y.dataset.rangeId);return Math.abs(K-s)<=Math.abs(Be-s)?_:y}),d=+l.dataset.rangeId;if(!d)return;this.#t.set(d,s),this.#s(l,s);const p=this.#e;this.#e=Array.from(this.#t.values()),this.#r(),ct(p,this.#e)&&(this.#n=Array.from(this.#e),this.emit("syn-input"),this.emit("syn-change"))}async#u(e){if(this.disabled)return;const t=e.target;this.#l(t),t.dataset.pointerId&&t.releasePointerCapture(+t.dataset.pointerId),t.dataset.pointerId=e.pointerId.toString(),t.setPointerCapture(e.pointerId),t.classList.add("grabbed"),await t.parentElement.show()}#m(e){if(this.disabled)return;const t=e.target,n=+t.dataset.rangeId;if(!this.#t.has(n)||(t.dataset.pointerId?+t.dataset.pointerId:null)!==e.pointerId)return;const o=Sn(this.baseDiv,e.clientX,this.#o),s=this.step/(this.max-this.min),l=this.min+this.step*Math.round(o/s);if(this.emit("syn-move",{cancelable:!0,detail:{element:t,value:l}}).defaultPrevented)return;this.#t.set(n,l),this.#s(t,l);const p=this.#e;this.#e=Array.from(this.#t.values()),this.#r(),ct(p,this.#e)&&this.emit("syn-input")}async#h(e){const t=e.target;!t.dataset.pointerId||e.pointerId!==+t.dataset.pointerId||(t.classList.remove("grabbed"),t.releasePointerCapture(e.pointerId),delete t.dataset.pointerId,ct(this.#n,this.#e)&&(this.#n=Array.from(this.#e),this.emit("syn-change")),await t.parentElement.hide())}#s(e,t){e.setAttribute("aria-valuenow",t.toString()),e.setAttribute("aria-valuetext",this.tooltipFormatter(t));const n=(t-this.min)/(this.max-this.min);e.style.insetInlineStart=`calc( ${100*n}% - var(--full-thumb-size) / 2 )`,this.#l(e)}#r(){const{activeTrack:e}=this;if(!e)return;if(this.min===this.max){e.style.insetInlineStart="0%",e.style.insetInlineEnd="0%";return}if(this.#e.length===1){const o=getComputedStyle(this).getPropertyValue("--track-active-offset")||"0%",s=100*(this.#e[0]-this.min)/(this.max-this.min);e.style.insetInlineStart=`min(${o}, ${s}%)`,e.style.insetInlineEnd=`min(calc(100% - ${o}), calc(100% - ${s}%))`;return}const t=this.#e.slice().sort(Ue),n=100*(t[0]-this.min)/(this.max-this.min),i=100*(t[t.length-1]-this.min)/(this.max-this.min);e.style.insetInlineStart=`${n}%`,e.style.insetInlineEnd=`calc(100% - ${i}%)`}#f(e){const t=e.target,n=+t.dataset.rangeId,i=this.#t.get(n);if(i===void 0)return;let o=i;switch(e.key){case"ArrowUp":case"Up":o=Math.min(i+this.step,this.max);break;case"ArrowDown":case"Down":o=Math.max(i-this.step,this.min);break;case"ArrowLeft":case"Left":o=this.#o?Math.min(i+this.step,this.max):Math.max(i-this.step,this.min);break;case"ArrowRight":case"Right":o=this.#o?Math.max(i-this.step,this.min):Math.min(i+this.step,this.max);break;case"PageUp":o=Math.min(i+(this.max-this.min)/5,this.max);break;case"PageDown":o=Math.max(i-(this.max-this.min)/5,this.min);break;case"Home":o=this.min;break;case"End":o=this.max;break;default:return}if(o!==i){if(this.emit("syn-move",{cancelable:!0,detail:{element:t,value:o}}).defaultPrevented)return;this.#s(t,o),this.#t.set(n,o),this.#e=Array.from(this.#t.values()),this.#r(),this.#l(t),this.#n=Array.from(this.#e),this.emit("syn-input"),this.emit("syn-change")}e.stopPropagation(),e.preventDefault()}#y(e){e.relatedTarget&&this.shadowRoot?.contains(e.relatedTarget)||(this.emit("syn-blur"),this.#a=!1)}#l(e){if(this.tooltipPlacement==="none")return;const t=+e.dataset.rangeId;if(!this.#t.has(t))return;const n=this.#t.get(t),i=e.parentElement;i.content=this.tooltipFormatter(n)}#b(e){if(this.disabled)return;this.#a||(this.#a=!0,this.emit("syn-focus"));const t=e.target;t?.dataset?.rangeId&&this.#l(t)}#g(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}#v(){const e=this.hasSlotController.test("ticks"),t=this.hasSlotController.test("prefix"),n=this.hasSlotController.test("suffix");if(!e)return;let i=this.shadowRoot?.querySelector(".ticks")?.clientHeight;if(i){if(i+=2,i/=2,t){const o=this.shadowRoot?.querySelector(".input__prefix");o.style.transform=`translateY(-${i}px)`}if(n){const o=this.shadowRoot?.querySelector(".input__suffix");o.style.transform=`translateY(-${i}px)`}}}renderThumbs(e){const t=this.#e.length>1;return this.#t.clear(),this.#e.map((n,i)=>{this.#d+=1;const o=this.#d;this.#t.set(o,n);const s=`thumb-${o}`;let l="",d="";return t?(d=e?`label aria-label-hidden ${s}`:`aria-label-hidden ${s}`,i===0?l=`${this.localize.term("rangeMin")} (${this.tooltipFormatter(n)})`:i===this.#e.length-1?l=`${this.localize.term("rangeMax")} (${this.tooltipFormatter(n)})`:l=this.tooltipFormatter(n)):d=e?"label aria-label-hidden":"",c`
      ...
      `})}render(){const e=this.hasSlotController.test("label"),t=this.hasSlotController.test("help-text"),n=this.hasSlotController.test("prefix"),i=this.hasSlotController.test("suffix"),o=this.label?!0:!!e,s=this.helpText?!0:!!t;return this.#v(),c`
      <div
        part="form-control"
...
`;var Ys=Object.defineProperty,di=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Ys(e,t,i),i};class Mt extends v{constructor(){super(...arguments),this.localize=new j(this),this.size="medium",this.removable=!1}static{this.styles=[w,Ks,Gs]}static{this.dependencies={"syn-icon-button":tt}}handleRemoveClick(){this.emit("syn-remove")}render(){return c`
      <span
        part="base"
    ...
    `}}di([r({reflect:!0})],Mt.prototype,"size");di([r({type:Boolean})],Mt.prototype,"removable");const Xs=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`;var Js=Object.defineProperty,Zs=Object.getOwnPropertyDescriptor,D=(a,e,t,n)=>{for(var i=n>1?void 0:n?Zs(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Js(e,t,i),i};class $ extends v{constructor(){super(...arguments),this.formControlController=new ke(this,{assumeInteractionOn:["syn-blur","syn-input"]}),this.hasSlotController=new W(this,"help-text","label"),this.localize=new j(this),this.typeToSelectString="",this.hasFocus=!1,this.displayLabel="",this.selectedOptions=[],this.valueHasChanged=!1,this.name="",this._value="",this.defaultValue="",this.size="medium",this.placeholder="",this.multiple=!1,this.maxOptionsVisible=3,this.disabled=!1,this.clearable=!1,this.open=!1,this.hoist=!1,this.label="",this.placement="bottom",this.helpText="",this.form="",this.required=!1,this.getTag=e=>c`
      <syn-tag
        part="tag"
        exportparts="
              base:tag__base,
...
`;var tr=Object.defineProperty,nr=Object.getOwnPropertyDescriptor,Ve=(a,e,t,n)=>{for(var i=n>1?void 0:n?nr(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&tr(e,t,i),i};class Ne extends v{constructor(){super(),this.hasSlotController=new W(this,"[default]","footer"),this.localize=new j(this),this.isAnimationActive=!1,this.open=!1,this.rail=!1,this.noFocusTrapping=!1,this.handleMouseEnter=this.handleMouseEnter.bind(this),this.handleMouseLeave=this.handleMouseLeave.bind(this),this.addEventListener("syn-initial-focus",e=>{this.rail&&(e.preventDefault(),this.drawer.originalTrigger=null)}),this.addEventListener("focusin",e=>{e.target.tagName.toLowerCase()==="syn-nav-item"&&this.rail&&!this.open&&(this.open=!0)}),this.addEventListener("focusout",e=>{const t=e.target.tagName.toLowerCase(),n=e.relatedTarget?.tagName.toLowerCase();t==="syn-nav-item"&&n!=="syn-nav-item"&&this.rail&&this.open&&(this.open=!1)})}static{this.styles=[w,er]}static{this.dependencies={"syn-divider":Le,"syn-drawer":ye}}setDelayedCallback(e){clearTimeout(this.timeout),this.timeout=setTimeout(e,100)}handleMouseEnter(){this.setDelayedCallback(()=>{this.open=!0})}handleMouseLeave(){this.setDelayedCallback(()=>{this.open=!1})}handleRequestClose(){this.open&&(this.open=!1)}addMouseListener(){this.drawer.shadowRoot.querySelector(".drawer__panel")?.addEventListener("mouseenter",this.handleMouseEnter),this.drawer.shadowRoot.querySelector(".drawer__panel")?.addEventListener("mouseleave",this.handleMouseLeave)}removeMouseListener(){this.drawer.shadowRoot.querySelector(".drawer__panel")?.removeEventListener("mouseenter",this.handleMouseEnter),this.drawer.shadowRoot.querySelector(".drawer__panel")?.removeEventListener("mouseleave",this.handleMouseLeave)}setDrawerVisibility(e){this.drawer.shadowRoot.querySelector(".drawer").hidden=!e,this.drawer.shadowRoot.querySelector(".drawer__panel")?.setAttribute("aria-hidden",e?"false":"true")}forceDrawerVisibilityForRailMode(){return U(this,"syn-after-hide").then(()=>{this.setDrawerVisibility(!0),this.isAnimationActive=!1})}setDrawerAnimations(){const e=I(this,`sideNav.show${this.rail?"Rail":"NonRail"}`,{dir:this.localize.dir()}),t=I(this,`sideNav.hide${this.rail?"Rail":"NonRail"}`,{dir:this.localize.dir()}),n=I(this,"sideNav.overlay.hide",{dir:this.localize.dir()}),i=I(this,"sideNav.overlay.show",{dir:this.localize.dir()});Tt(this.drawer,"drawer.showStart",e),Tt(this.drawer,"drawer.hideStart",t),Tt(this.drawer,"drawer.overlay.hide",n),Tt(this.drawer,"drawer.overlay.show",i)}handleModeChange(){this.setDrawerAnimations(),this.rail?(this.addMouseListener(),this.setDrawerVisibility(!0)):(this.removeMouseListener(),this.open||this.setDrawerVisibility(!1))}handleOpenChange(){this.rail&&(this.isAnimationActive=!0,this.open?U(this.drawer,"syn-after-show").then(()=>{this.isAnimationActive=!1}):this.forceDrawerVisibilityForRailMode())}handleFocusTrapping(){this.rail||(this.noFocusTrapping?this.drawer.modal.activateExternal():this.drawer.modal.deactivateExternal())}async show(){if(!this.open)return this.open=!0,U(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,U(this,"syn-after-hide")}firstUpdated(){this.setDrawerAnimations(),this.drawer.updateComplete.then(()=>{this.drawer.shadowRoot.querySelector(".drawer__panel").tabIndex=-1}),this.rail?this.drawer.updateComplete.then(()=>{this.addMouseListener(),this.setDrawerVisibility(!0)}):this.noFocusTrapping&&this.drawer.modal.activateExternal()}disconnectedCallback(){super.disconnectedCallback(),this.drawer&&(Ze(this.drawer),this.drawer.modal.deactivate())}render(){const e=window.navigator.maxTouchPoints>0||"ontouchstart"in window,t=this.hasSlotController.test("footer");return k`
    ...
    `}}Ve([b()],Ne.prototype,"isAnimationActive",2);Ve([u(".side-nav__drawer")],Ne.prototype,"drawer",2);Ve([r({reflect:!0,type:Boolean})],Ne.prototype,"open",2);Ve([r({reflect:!0,type:Boolean})],Ne.prototype,"rail",2);Ve([r({attribute:"no-focus-trapping",reflect:!0,type:Boolean})],Ne.prototype,"noFocusTrapping",2);Ve([m("rail",{waitUntilFirstUpdate:!0})],Ne.prototype,"handleModeChange",1);Ve([m("open",{waitUntilFirstUpdate:!0})],Ne.prototype,"handleOpenChange",1);Ve([m("noFocusTrapping",{waitUntilFirstUpdate:!0})],Ne.prototype,"handleFocusTrapping",1);T("sideNav.showRail",{keyframes:[{width:"var(--side-nav-rail-width)"},{width:"var(--side-nav-open-width)"}],options:{duration:250,easing:"ease"}});T("sideNav.showNonRail",{keyframes:[{opacity:0,translate:"-100%"},{opacity:1,translate:"0"}],options:{duration:250,easing:"ease"}});T("sideNav.hideNonRail",{keyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"-100%"}],options:{duration:250,easing:"ease"}});T("sideNav.hideRail",{keyframes:[{width:"var(--side-nav-open-width)"},{width:"var(--side-nav-rail-width)"}],options:{duration:250,easing:"ease"}});T("sideNav.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});T("sideNav.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});Ne.define("syn-side-nav");tn.define("syn-spinner");const ir=h`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
:host([size='small']) {
  ...
  `;var or=Object.defineProperty,sr=Object.getOwnPropertyDescriptor,ce=(a,e,t,n)=>{for(var i=n>1?void 0:n?sr(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&or(e,t,i),i};class se extends v{constructor(){super(...arguments),this.formControlController=new ke(this,{value:e=>e.checked?e.value||"on":void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=t}),this.hasSlotController=new W(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}static{this.styles=[w,ze,ir,Ee,ar]}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleInput(){this.emit("syn-input")}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleClick(){this.checked=!this.checked,this.emit("syn-change")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleKeyDown(e){e.key==="ArrowLeft"&&(e.preventDefault(),this.checked=!1,this.emit("syn-change"),this.emit("syn-input")),e.key==="ArrowRight"&&(e.preventDefault(),this.checked=!0,this.emit("syn-change"),this.emit("syn-input"))}handleCheckedChange(){this.input.checked=this.checked,this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(!0)}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("help-text"),t=this.helpText?!0:!!e;return c`
      <div
        class=${f({"form-control":!0,"form-control--small":this.size==="small","form-control--medium":this.size==="medium","form-control--large":this.size==="large","form-control--has-help-text":t})}
      >
        <label
    ...
    `}}ce([u('input[type="checkbox"]')],se.prototype,"input",2);ce([b()],se.prototype,"hasFocus",2);ce([r()],se.prototype,"title",2);ce([r()],se.prototype,"name",2);ce([r()],se.prototype,"value",2);ce([r({reflect:!0})],se.prototype,"size",2);ce([r({type:Boolean,reflect:!0})],se.prototype,"disabled",2);ce([r({type:Boolean,reflect:!0})],se.prototype,"checked",2);ce([Ke("checked")],se.prototype,"defaultChecked",2);ce([r({reflect:!0})],se.prototype,"form",2);ce([r({type:Boolean,reflect:!0})],se.prototype,"required",2);ce([r({attribute:"help-text"})],se.prototype,"helpText",2);ce([m("checked",{waitUntilFirstUpdate:!0})],se.prototype,"handleCheckedChange",1);ce([m("disabled",{waitUntilFirstUpdate:!0})],se.prototype,"handleDisabledChange",1);se.define("syn-switch");const rr=(a,e)=>{let t=0;return function(...n){window.clearTimeout(t),t=window.setTimeout(()=>{a.call(this,...n)},e)}},zn=(a,e,t)=>{const n=a[e];a[e]=function(...i){n.call(this,...i),t.call(this,n,...i)}},lr="onscrollend"in window;if(!lr){const a=new Set,e=new WeakMap,t=i=>{for(const o of i.changedTouches)a.add(o.identifier)},n=i=>{for(const o of i.changedTouches)a.delete(o.identifier)};document.addEventListener("touchstart",t,!0),document.addEventListener("touchend",n,!0),document.addEventListener("touchcancel",n,!0),zn(EventTarget.prototype,"addEventListener",function(i,o){if(o!=="scrollend")return;const s=rr(()=>{a.size?s():this.dispatchEvent(new Event("scrollend"))},100);i.call(this,"scroll",s,{passive:!0}),e.set(this,s)}),zn(EventTarget.prototype,"removeEventListener",function(i,o){if(o!=="scrollend")return;const s=e.get(this);s&&i.call(this,"scroll",s,{passive:!0})})}const dr=h`
	/* stylelint-disable */
  :host {
    display: contents;
  }
`;var cr=Object.defineProperty,pr=Object.getOwnPropertyDescriptor,ci=(a,e,t,n)=>{for(var i=n>1?void 0:n?pr(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&cr(e,t,i),i};class on extends v{constructor(){super(...arguments),this.observedElements=[],this.disabled=!1}static{this.styles=[w,dr]}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{this.emit("syn-resize",{detail:{entries:e}})}),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}handleSlotChange(){this.disabled||this.startObserver()}startObserver(){const e=this.shadowRoot.querySelector("slot");if(e!==null){const t=e.assignedElements({flatten:!0});this.observedElements.forEach(n=>this.resizeObserver.unobserve(n)),this.observedElements=[],t.forEach(n=>{this.resizeObserver.observe(n),this.observedElements.push(n)})}}stopObserver(){this.resizeObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}render(){return c` <slot @slotchange=${this.handleSlotChange}></slot> `}}ci([r({type:Boolean,reflect:!0})],on.prototype,"disabled",2);ci([m("disabled",{waitUntilFirstUpdate:!0})],on.prototype,"handleDisabledChange",1);const hr=h`
	/* stylelint-disable */
  :host {
    --indicator-color: var(--syn-color-primary-600);
    --track-color: var(--syn-color-neutral-200);
...
`;var gr=Object.defineProperty,vr=Object.getOwnPropertyDescriptor,sn=(a,e,t,n)=>{for(var i=n>1?void 0:n?vr(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&gr(e,t,i),i};let wr=0;class Lt extends v{constructor(){super(...arguments),this.attrId=++wr,this.componentId=`syn-tab-panel-${this.attrId}`,this.name="",this.active=!1}static{this.styles=[w,yr,br]}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return c`
      <slot
        part="base"
        class=${f({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}}sn([r({reflect:!0})],Lt.prototype,"name",2);sn([r({type:Boolean,reflect:!0})],Lt.prototype,"active",2);sn([m("active")],Lt.prototype,"handleActiveChange",1);Lt.define("syn-tab-panel");const xr=h`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
`;var _r=Object.defineProperty,Tr=Object.getOwnPropertyDescriptor,He=(a,e,t,n)=>{for(var i=n>1?void 0:n?Tr(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&_r(e,t,i),i};let Cr=0;class Ie extends v{constructor(){super(...arguments),this.localize=new j(this),this.attrId=++Cr,this.componentId=`syn-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}static{this.styles=[w,xr,kr]}static{this.dependencies={"syn-icon-button":tt}}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}handleCloseClick(e){e.stopPropagation(),this.emit("syn-close")}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false"),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,c`
      <div
        part="base"
...
`;var Ir=Object.defineProperty,Ar=Object.getOwnPropertyDescriptor,fe=(a,e,t,n)=>{for(var i=n>1?void 0:n?Ar(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Ir(e,t,i),i};class pe extends v{constructor(){super(...arguments),this.controller=new AbortController,this.validationMessage="",this.eagerFirstMount=!0,this.isInternalTriggeredInvalid=!1,this.isValid=!0,this.variant="native",this.hideIcon=!1,this.on="",this.customValidationMessage="",this.eager=!1,this.internalRevalidate=e=>{e.currentTarget.validity?.valid&&(this.validationMessage="")},this.validate=e=>{if(Ht(e.type)&&this.variant==="native"&&this.isInternalTriggeredInvalid===!0){this.isInternalTriggeredInvalid=!1;return}Ht(e.type)&&this.variant!=="native"&&(e.preventDefault(),e.stopPropagation());const t=e.currentTarget;if(this.isValid=t.validity?.valid,this.eager&&this.eagerFirstMount){this.eagerFirstMount=!1,this.setValidationMessage(t);return}!this.isValid&&!En(e.type)&&this.handleFocus(t),this.setValidationMessage(t),!En(e.type)&&this.variant==="native"&&this.updateComplete.then(()=>{this.isInternalTriggeredInvalid=!0,t.reportValidity()})}}static{this.styles=[w,Nr]}static{this.dependencies={"syn-alert":be}}handleListenerChange(){this.updateEvents()}async handleEagerChange(){if(this.eager){const e=this.getInput();await this.updateComplete,e?.reportValidity(),this.eagerFirstMount=!0}else this.eagerFirstMount=!1}handleCustomValidationMessageChange(){const e=this.getInput();e&&(this.setCustomValidationMessage(e),this.setValidationMessage(e))}getValidity(){return this.isValid}getInput(){const e=this.slottedChildren[0];return e||void 0}getUsedEventNames(){const e=this.getInput();if(!e)return[];const t=Dr(this.on),[...n]=t.filter(Boolean);return n.includes("invalid")||n.push("invalid"),n.includes("live")&&(n.push("input"),n.push("blur")),Array.from(new Set(n.filter(i=>i!=="live").map(i=>$n(e,i))))}updateEvents(){this.controller.abort(),this.controller=new AbortController;const e=this.getInput();if(!e)return;const t=this.getUsedEventNames();t.forEach(i=>{e.addEventListener(i,this.validate,{capture:Ht(i),signal:this.controller.signal})});const n=$n(e,"change");t.includes(n)||e.addEventListener(n,this.internalRevalidate,{signal:this.controller.signal})}setValidationMessage(e){const{customValidationMessage:t}=this,n=t||e.validationMessage;this.validationMessage=n}setCustomValidationMessage(e){e.setCustomValidity(this.customValidationMessage)}handleFocus(e){const t=document.activeElement,n=t.closest("syn-validate");!t.validity?.valid&&n||(e.scrollIntoView({block:"nearest"}),e.focus())}async firstUpdated(){if(this.updateEvents(),this.eager){const e=this.getInput();await this.updateComplete,this.isValid=e?.validity?.valid??!1,e?.reportValidity()}}disconnectedCallback(){super.disconnectedCallback(),this.controller.abort()}renderInlineValidation(){return this.variant!=="inline"||!this.validationMessage?"":c`
    ...
    `}}fe([In()],pe.prototype,"slottedChildren",2);fe([b()],pe.prototype,"validationMessage",2);fe([b()],pe.prototype,"eagerFirstMount",2);fe([b()],pe.prototype,"isInternalTriggeredInvalid",2);fe([b()],pe.prototype,"isValid",2);fe([r({reflect:!0})],pe.prototype,"variant",2);fe([r({attribute:"hide-icon",reflect:!0,type:Boolean})],pe.prototype,"hideIcon",2);fe([r({reflect:!0})],pe.prototype,"on",2);fe([r({attribute:"custom-validation-message",type:String})],pe.prototype,"customValidationMessage",2);fe([r({type:Boolean})],pe.prototype,"eager",2);fe([m("on",{waitUntilFirstUpdate:!0})],pe.prototype,"handleListenerChange",1);fe([m("eager",{waitUntilFirstUpdate:!1})],pe.prototype,"handleEagerChange",1);fe([m("customValidationMessage",{waitUntilFirstUpdate:!0})],pe.prototype,"handleCustomValidationMessageChange",1);pe.define("syn-validate");function Pr(a){const e=typeof window<"u"&&window;return!!(e&&(/Chromatic/.test(e.navigator.userAgent)||/chromatic=true/.test(e.location.href)))}const Mr=(a,...e)=>Pr()?c`
      ...
      ${a(...e)}
    `:a(...e),$t="🌞 light",Wt="🌙 dark",Lr=a=>`https://www.figma.com/file/bZFqk9urD3NlghGUKrkKCR/Synergy-Digital-Design-System?type=design&node-id=${a}`,jr=(a,e="Go to Figma page")=>({label:e,type:"link",url:Lr(a)});function Fr(a,e){const t=document.querySelectorAll(`#anchor--${e.id}`),i=JSON.parse('{"@synergy-design-system/components":"2.15.2","@synergy-design-system/assets":"1.11.2","@synergy-design-system/styles":"1.6.0","@synergy-design-system/tokens":"2.15.1"}');return t.forEach(o=>{const s=o.querySelector(".docblock-code-toggle");if(s){const l=s.cloneNode(!0);l.textContent="Edit on CodePen",l.classList.add("docblock-codepen-button");const d=o.querySelector(".sb-bar");d?o.querySelectorAll(".docblock-codepen-button:not(:last-of-type)").forEach(p=>{p.remove()}):o.querySelectorAll(".docblock-codepen-button").forEach(p=>{p.remove()}),s.parentElement.appendChild(l),d&&(o.querySelectorAll(".docblock-codepen-button:not(:last-of-type)").forEach(p=>{p.style.display="block",p.style.borderRight="none"}),o.querySelector(".docblock-codepen-button:last-of-type").style.display="none"),l.addEventListener("click",()=>{const p=document.createElement("form");p.action="https://codepen.io/pen/define",p.method="POST",p.target="_blank";const y={css:`/* Import theme */
 ...
 */`,dependencies:["syn-alert"]}],exports:[{kind:"js",name:"default",declaration:{name:"SynValidate",module:"../components/src/components/validate/validate.js"}}]}],package:{author:{name:"SICK Global UX Foundation",url:"https://www.sick.com"},description:"",homepage:"https://synergy-design-system.github.io",license:"MIT",name:"@synergy-design-system/components",version:"2.15.2"}},Hr={modules:[{declarations:[{attributes:[{default:"'syn-link--small'",description:"The size of the link",name:"syn-link",type:{text:"'syn-link--small' | 'syn-link--medium' | 'syn-link--large'"}},{default:"false",description:"Applies the quiet link styling",name:"syn-link--quiet",type:{text:"boolean"}},{default:"false",description:"Applies the disabled link styling",name:"syn-link--disabled",type:{text:"boolean"}}],customElement:!0,kind:"class",members:[{attribute:"syn-link",default:"'syn-link--small'",description:"The size of the link",kind:"field",name:"syn-link",type:{text:"'syn-link--small' | 'syn-link--medium' | 'syn-link--large'"}},{attribute:"syn-link--quiet",default:"false",description:"Applies the quiet link styling",kind:"field",name:"syn-link--quiet",type:{text:"boolean"}},{attribute:"syn-link--disabled",default:"false",description:"Applies the disabled link styling",kind:"field",name:"syn-link--disabled",type:{text:"boolean"}}],name:"syn-link",slots:[{description:"Main content of syn-link",name:""}],tagName:"syn-link",tagNameWithoutPrefix:"link"}],description:"The size of the link",kind:"javascript-module",path:"../styles/src/link/index.css"},{declarations:[{attributes:[{default:"'syn-link-list--medium'",description:"The size of the link list",name:"syn-link-list",type:{text:"'syn-link-list--medium' | 'syn-link-list--small' | 'syn-link-list--large'"}},{default:"false",description:"Applies horizontal styling to the link list",name:"syn-link-list--horizontal",type:{text:"boolean"}}],customElement:!0,kind:"class",members:[{attribute:"syn-link-list",default:"'syn-link-list--medium'",description:"The size of the link list",kind:"field",name:"syn-link-list",type:{text:"'syn-link-list--medium' | 'syn-link-list--small' | 'syn-link-list--large'"}},{attribute:"syn-link-list--horizontal",default:"false",description:"Applies horizontal styling to the link list",kind:"field",name:"syn-link-list--horizontal",type:{text:"boolean"}}],name:"syn-link-list",slots:[{description:"Main content of syn-link-list",name:""}],tagName:"syn-link-list",tagNameWithoutPrefix:"link-list"}],description:"The size of the link list",kind:"javascript-module",path:"../styles/src/link-list/index.css"},{declarations:[{attributes:[{default:"true",description:"Applies the table cell styling",name:"syn-table-cell",type:{text:"boolean"}},{default:"false",description:"Applies an alternating style to help separate rows visually",name:"syn-table-cell--alternating",type:{text:"boolean"}},{default:"false",description:"Applies a border to the left of the table cell",name:"syn-table-cell--border-start",type:{text:"boolean"}},{default:"false",description:"Applies a border to the right of the table cell",name:"syn-table-cell--border-end",type:{text:"boolean"}},{default:"false",description:"Applies a border to the top of the table cell",name:"syn-table-cell--border-top",type:{text:"boolean"}},{default:"false",description:"Applies a border to the bottom of the table cell",name:"syn-table-cell--border-bottom",type:{text:"boolean"}},{default:"false",description:"Applies the table cell header styling",name:"syn-table-cell--header",type:{text:"boolean"}},{default:"",description:"Applies the selected shadow to the table cell",name:"syn-table-cell--shadow",type:{text:" | 'syn-table-cell--shadow-bottom' | 'syn-table-cell--shadow-top' | 'syn-table-cell--shadow-start' | 'syn-table-cell--shadow-end'"}},{default:"false",description:"Displays the table shadow",name:"syn-table-cell--shadow-active",type:{text:"boolean"}}],customElement:!0,kind:"class",members:[{attribute:"syn-table-cell",default:"true",description:"Applies the table cell styling",kind:"field",name:"syn-table-cell",type:{text:"boolean"}},{attribute:"syn-table-cell--alternating",default:"false",description:"Applies an alternating style to help separate rows visually",kind:"field",name:"syn-table-cell--alternating",type:{text:"boolean"}},{attribute:"syn-table-cell--border-start",default:"false",description:"Applies a border to the left of the table cell",kind:"field",name:"syn-table-cell--border-start",type:{text:"boolean"}},{attribute:"syn-table-cell--border-end",default:"false",description:"Applies a border to the right of the table cell",kind:"field",name:"syn-table-cell--border-end",type:{text:"boolean"}},{attribute:"syn-table-cell--border-top",default:"false",description:"Applies a border to the top of the table cell",kind:"field",name:"syn-table-cell--border-top",type:{text:"boolean"}},{attribute:"syn-table-cell--border-bottom",default:"false",description:"Applies a border to the bottom of the table cell",kind:"field",name:"syn-table-cell--border-bottom",type:{text:"boolean"}},{attribute:"syn-table-cell--header",default:"false",description:"Applies the table cell header styling",kind:"field",name:"syn-table-cell--header",type:{text:"boolean"}},{attribute:"syn-table-cell--shadow",default:"",description:"Applies the selected shadow to the table cell",kind:"field",name:"syn-table-cell--shadow",type:{text:" | 'syn-table-cell--shadow-bottom' | 'syn-table-cell--shadow-top' | 'syn-table-cell--shadow-start' | 'syn-table-cell--shadow-end'"}},{attribute:"syn-table-cell--shadow-active",default:"false",description:"Displays the table shadow",kind:"field",name:"syn-table-cell--shadow-active",type:{text:"boolean"}}],name:"syn-table-cell",slots:[{description:"Main content of syn-table-cell",name:""}],tagName:"syn-table-cell",tagNameWithoutPrefix:"table-cell"}],description:"Applies the table cell styling",kind:"javascript-module",path:"../styles/src/tables/table-cell.css"},{declarations:[{attributes:[{default:"false",description:"Applies the styling to a table element",name:"syn-table",type:{text:"boolean"}},{default:"true",description:"Applies all default table stylings to a table and its children",name:"syn-table--default",type:{text:"boolean"}},{default:"false",description:"Applies all alternate table stylings to a table and its children",name:"syn-table--alternating",type:{text:"boolean"}},{default:"false",description:"Applies all border table stylings to a table and its children",name:"syn-table--border",type:{text:"boolean"}}],customElement:!0,kind:"class",members:[{attribute:"syn-table",default:"false",description:"Applies the styling to a table element",kind:"field",name:"syn-table",type:{text:"boolean"}},{attribute:"syn-table--default",default:"true",description:"Applies all default table stylings to a table and its children",kind:"field",name:"syn-table--default",type:{text:"boolean"}},{attribute:"syn-table--alternating",default:"false",description:"Applies all alternate table stylings to a table and its children",kind:"field",name:"syn-table--alternating",type:{text:"boolean"}},{attribute:"syn-table--border",default:"false",description:"Applies all border table stylings to a table and its children",kind:"field",name:"syn-table--border",type:{text:"boolean"}}],name:"syn-table",slots:[{description:"Main content of syn-table",name:""}],tagName:"syn-table",tagNameWithoutPrefix:"table"}],description:"Applies the styling to a table element",kind:"javascript-module",path:"../styles/src/tables/table.css"},{declarations:[{attributes:[{default:"'syn-body--x-small'",description:"The font size of the body text",name:"syn-body",type:{text:"'syn-body--x-small' | 'syn-body--small' | 'syn-body--medium' | 'syn-body--large'"}}],customElement:!0,kind:"class",members:[{attribute:"syn-body",default:"'syn-body--x-small'",description:"The font size of the body text",kind:"field",name:"syn-body",type:{text:"'syn-body--x-small' | 'syn-body--small' | 'syn-body--medium' | 'syn-body--large'"}}],name:"syn-body",slots:[{description:"Main content of syn-body",name:""}],tagName:"syn-body",tagNameWithoutPrefix:"body"}],description:"The font size of the body text",kind:"javascript-module",path:"../styles/src/typography/body.css"},{declarations:[{attributes:[{default:"'syn-heading--3x-large'",description:"The size of the headline",name:"syn-heading",type:{text:"'syn-heading--3x-large' | 'syn-heading--2x-large' | 'syn-heading--x-large' | 'syn-heading--large'"}}],customElement:!0,kind:"class",members:[{attribute:"syn-heading",default:"'syn-heading--3x-large'",description:"The size of the headline",kind:"field",name:"syn-heading",type:{text:"'syn-heading--3x-large' | 'syn-heading--2x-large' | 'syn-heading--x-large' | 'syn-heading--large'"}}],name:"syn-heading",slots:[{description:"Main content of syn-heading",name:""}],tagName:"syn-heading",tagNameWithoutPrefix:"heading"}],description:"The size of the headline",kind:"javascript-module",path:"../styles/src/typography/heading.css"},{declarations:[{attributes:[{default:"'syn-weight--normal'",description:"The font weight to apply",name:"syn-weight",type:{text:"'syn-weight--normal' | 'syn-weight--semibold' | 'syn-weight--bold'"}}],customElement:!0,kind:"class",members:[{attribute:"syn-weight",default:"'syn-weight--normal'",description:"The font weight to apply",kind:"field",name:"syn-weight",type:{text:"'syn-weight--normal' | 'syn-weight--semibold' | 'syn-weight--bold'"}}],name:"syn-weight",slots:[{description:"Main content of syn-weight",name:""}],tagName:"syn-weight",tagNameWithoutPrefix:"weight"}],description:"The font weight to apply",kind:"javascript-module",path:"../styles/src/typography/weight.css"}],readme:"",schemaVersion:"1.0.0"};ea({hideArgRef:!0,hideScriptTag:!0});ut.modules&&(ut.modules=ut.modules.map(a=>(a.declarations&&(a.declarations=a.declarations.map(e=>(e.members&&(e.members=e.members.filter(t=>t.description&&t.privacy!=="private")),e))),a)));const Br={...ut,modules:[...ut.modules,...Hr.modules]};Oi(Br);console.log("Custom elements manifest loaded for components and styles");const qt=a=>{const{args:e,events:t,argTypes:n}=Bn(a),i=Ln(a,window.__STORYBOOK_CUSTOM_ELEMENTS_MANIFEST__),o=()=>({status:{styles:{backgroundColor:i?.status==="stable"?"#43b02a":"rgb(255, 131, 0)",borderColor:"white",color:"white"},title:`Status: ${i?.status}`},since:{styles:{backgroundColor:"#333",borderColor:"#fff",color:"#fff"},title:`Since: ${i?.since}`}});return{args:e,argTypes:(()=>{for(const d in n)n.hasOwnProperty(d)&&n[d].table&&n[d].table.category==="properties"&&(n[d].control={disabled:!0});return{...n,...i?.events?.reduce((d,p)=>(d[p.name]={...p,control:!1,table:{category:"Events"}},d),{}),...i?.members?.filter(d=>d.kind==="method").reduce((d,p)=>(d[p.name]={...p,control:!1,table:{category:"Methods"}},d),{})}})(),parameters:{badges:["status","since"],badgesConfig:o(),actions:{handles:t}}}},Je=a=>({getSuffixFromType:e=>({attribute:"",property:"-prop",slot:"-slot",cssPart:"-part",cssProperty:""})[e],getValuesFromAttribute:e=>{e.endsWith("-attr")||(e=`${e}-attr`);const{argTypes:t}=qt(a);return t[e]?.control?.type==="boolean"?[!0,!1]:t[e].options},getValuesFromAttributes:e=>e?.map(t=>(t.endsWith("-attr")||(t=`${t}-attr`),{name:t,values:Je(a).getValuesFromAttribute(t)})),overrideArgs:(e,t)=>{const n=t||qt(a).args,i=Array.isArray(e)?e:[e];for(const o of i){const s=Je(a).getSuffixFromType(o.type);n[`${o.name}${s}`]=o.value}return n}}),al=a=>{const{template:e,manifest:t}=Bn(a),{args:n}=qt(a),{getValuesFromAttribute:i}=Je(a);return{generateTemplate:({axis:s,constants:l=[],options:d,args:p=n})=>{const y=x=>{if(!t?.style)return e(x);const M=Object.keys(x).filter(L=>L.endsWith("-attr")).reduce((L,xe)=>{const he=xe.substring(0,xe.length-5);return x[xe]===!0?L[he]=!0:x[xe]==="false"||x[xe]==="(default)"?L[he]=!1:x[xe]&&(he.endsWith("...")?L[he.replace("...",x[xe])]=!0:L[x[xe]]=!0),L},{}),Pe=x["default-slot"]||"",Re={[a]:!0,...M},at=Object.keys(Re).filter(L=>Re[L]).join(" ");if(d?.templateContent){const L=d.templateContent.replaceAll("%SLOT%",Pe).replaceAll("%CLASSES%",at);return te(L)}return k`<div class=${f(Re)}>${te(Pe)}</div>`},_=(Array.isArray(l)?l:[l]).reduce((x,M)=>({...x,[`${M.name}${Je(a).getSuffixFromType(M.type)}`]:M.value}),{});if(!s?.x&&!s?.y&&!d?.title)return k`${y({...p,..._})}`;const K=x=>x?Array.isArray(x)?x.map(M=>({...M,values:M.values||i(M.name)})):[{...x,values:x.values||i(x.name)}]:[{}],Be=K(s?.x),Ae=K(s?.y),xt=(Array.isArray(l)?l:[l]).find(x=>x.type==="template")?.value,kt=`uuid-${crypto.randomUUID()}`;return k`
      <style>
        ...
        ${d?.templateBackgrounds?.colors.map((x,M)=>{const Pe=Re=>`${d?.templateBackgrounds?.colors.length}n + ${Re+1}`;return d?.templateBackgrounds?.alternate==="y"?`
      ...
      ${Be.map(x=>k` ${Ae.map(M=>{let Pe=!0;const Re=Be.length>1||x.values,at=(x&&M||Ae.length>1)&&M?.values;return k`
            <table class="story-template ${kt} ${d?.classes}">
              <thead>
                ...
                ${x&&x.values&&k`
                  <tr>
                    ${at?k`<td></td>`:""} <td></td>
                    ${Re&&k`<th colspan=${x.values?.length||0}><code>${x.title||x.name}</code></th>`}
                    </tr>
                  </tr>
                  ${k`
                    <tr>
              ...
              <tbody>
                ${(M?.values||[""]).map(L=>{const xe=k`
                    <tr class="template-row">
                      ...
                      ${(x?.values||[""]).map(he=>k`
                          <td class="template template-x-${x?.values?.indexOf(he)||1} template-y-${M?.values?.indexOf(L.value||L)||1}">
                          ${x.type==="template"&&te((he.value||he).split("%TEMPLATE%")[0]||"")||""}
                          ${M.type==="template"&&te((L.value||L).split("%TEMPLATE%")[0]||"")||""}
                          ${xt&&te(xt.split("%TEMPLATE%")[0]||"")||""}
                            ${y({...p,..._,...x&&x.type!=="template"&&{[`${x.name}${Je(a).getSuffixFromType(x.type)}`]:he.hasOwnProperty("value")?he.value:he},...M&&M.type!=="template"&&{[`${M.name}${Je(a).getSuffixFromType(M.type)}`]:L.hasOwnProperty("value")?L.value:L}})}
          ...
          `})}`)}
    `}}},Rr={codeOptimizer:a=>{const{body:e}=new DOMParser().parseFromString(a,"text/html"),t=e.querySelectorAll(".template");let n="";return t.length?n=Array.from(t).map(i=>i.innerHTML).join(`
`):n=e.innerHTML,n=n.replace(/<style><\/style>/g,"").replace(/<!-- preview-ignore:start -->[\s\S]*?<!-- preview-ignore:end -->/g,"").replace(/\/\/ preview-ignore:start[\s\S]*?\/\/ preview-ignore:end/g,"").replace(/<style>\n<\/style>/g,"").replace(/<script>\s*component = document\.querySelector\('(.+?)'\);\s*<\/script>/g,""),n}},ol=(a,e)=>{const t=pn?.components?.[a]?.[e]?.description?.value??"No Description",n=pn?.components?.[a]?.[e]?.note?.value??"",i=t.replace(/\n/g,"<br/>"),o=n.length>0?`

  > **👨‍💻 Additional developer Information**:<br>
  > ${n.replace(/\n/g,"<br/>")}`:n;return`${i}${o}`},sl=(a,e=150)=>{const t=isNaN(e)?e:{heightPx:e},{afterRender:n="",additionalChromaticOptions:i={},heightPx:o=150,styleHeading:s={}}=t,l=Object.entries(s).map(([d,p])=>`${d}: ${p};`).join(" ");return{parameters:{chromatic:{...hi?.parameters?.chromatic,...i,disableSnapshot:!1},docs:{disable:!0}},render:(d,p)=>k`
      ${Object.entries(a).map(([y,_])=>{const K=_.name??Di(y);return k`
      ...
      `})}
      ${n}
    `}};export{al as a,ol as b,sl as c,Je as d,il as e,jr as g,nl as h,Pr as i,hi as p,qt as s};
