import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{a as t,d as n,o as r,s as i}from"./preview-Lxgm_fxp.js";import{c as a,t as o}from"./lit-BfcklOOD.js";import{t as s}from"./icon-BLBnqcVf.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-BRYPxz3B.js";import{n as m,t as h}from"./PaddingDecorator-B8dy7wkX.js";import{t as g}from"./nav-item-D9NEZcW0.js";var _,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P=e((()=>{g(),s(),o(),f(),r(),h(),n(),{args:_,argTypes:v}=l(`syn-nav-item`),{overrideArgs:y}=c(`syn-nav-item`),{generateTemplate:b}=d(`syn-nav-item`),x={args:y([{name:`default`,type:`slot`,value:`Label`}],_),argTypes:v,component:`syn-nav-item`,parameters:{chromatic:{modes:i},design:t(`41163-402744`),docs:{description:{component:u(`nav-item`,`default`)}}},tags:[`Navigation`],title:`Components/syn-nav-item`},S={parameters:{controls:{disable:!1},docs:{description:{story:u(`nav-item`,`default`)}}},render:e=>b({args:e})},C={parameters:{docs:{description:{story:u(`nav-item`,`labels`)}}},render:()=>a`
    <syn-nav-item>This is a label</syn-nav-item>
  `},w={parameters:{docs:{description:{story:u(`nav-item`,`current`)}}},render:()=>a`
    <syn-nav-item current>Current Navigation item</syn-nav-item>
  `},T={parameters:{docs:{description:{story:u(`nav-item`,`nav-horizontal`)}}},render:()=>a`
  ...
  `},E={decorators:[m()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`nav-item`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-nav-item`);t&&t.focus()},render:()=>a`
    <syn-nav-item>Current navigation item</syn-nav-item>
  `},D={parameters:{docs:{description:{story:u(`nav-item`,`prefix-suffix`)}}},render:()=>a`
    <style>
    .doc-number-helper {
      align-items: center;
  ...
  `},O={parameters:{docs:{description:{story:u(`nav-item`,`children`)}}},render:()=>a`
  ...
  `},k={parameters:{docs:{description:{story:u(`nav-item`,`divider`)}}},render:()=>a`
    <nav style="width: 320px;">
      <syn-nav-item>Dividing element</syn-nav-item>
      <syn-nav-item divider>Dividing element</syn-nav-item>
    </nav>
  `},A={parameters:{docs:{description:{story:u(`nav-item`,`indentation`)}}},render:()=>a`
  ...
  `},j={parameters:{docs:{description:{story:u(`nav-item`,`disabled`)}}},render:()=>a`
