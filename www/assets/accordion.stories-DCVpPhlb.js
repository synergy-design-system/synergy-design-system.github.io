import{j as D,c as t,C as q,d as x}from"./iframe-eRvaIELU.js";import{c as L,n as h,S as E}from"./synergy-element-BVZI5H_G.js";import{o as z}from"./query-assigned-elements-CIlqV-be.js";import{e as C}from"./class-map-BctzS3gw.js";import{w as A}from"./watch-CEsCE2EF.js";import{e as _}from"./decorator-CWkWRMhy.js";import"./details-CGffyuBw.js";import{g as r,a as w,s as O,b as P,c as F}from"./component-mLh0MrP7.js";import{p as T}from"./PaddingDecorator-RAWfTAft.js";import"./preload-helper-PPVm8Dsz.js";import"./query-D0jTsbLw.js";import"./functions-bkELIyT9.js";import"./animation-registry-DyRYqZdt.js";import"./controller-BGdn_hBF.js";import"./event-B0iVuGLD.js";import"./icon.component-ehmpGKuT.js";import"./index-3hbeBem-.js";import"./_docs-DCFLSkr0.js";const $=D`
  :host {
    display: block;
  }
...
`;var I=Object.defineProperty,U=Object.getOwnPropertyDescriptor,n=(e,a,b,c)=>{for(var o=c>1?void 0:c?U(a,b):a,g=e.length-1,v;g>=0;g--)(v=e[g])&&(o=(c?v(a,b,o):v(o))||o);return c&&o&&I(a,b,o),o};let s=class extends E{constructor(){super(...arguments),this.closeOthers=!1,this.contained=!1,this.size="medium",this.handleAccordionShow=e=>{this.closeOthers&&this.detailsInDefaultSlot.forEach(a=>{a!==e.target&&a.parentNode===e.target.parentNode&&a.removeAttribute("open")})}}adjustDetailsSize(){this.detailsInDefaultSlot.forEach(e=>{e.setAttribute("size",this.size)})}adjustDetailsContained(){this.detailsInDefaultSlot.forEach(e=>{e.contained=this.contained})}handleSizeChange(){this.adjustDetailsSize()}handleContainedChange(){this.adjustDetailsContained()}connectedCallback(){super.connectedCallback(),this.addEventListener("syn-show",this.handleAccordionShow)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("syn-show",this.handleAccordionShow)}handleSlotChange(){this.adjustDetailsSize(),this.adjustDetailsContained()}render(){return t`
  ...
  `}),m=j(!1),M=j(!0),u={parameters:{docs:{description:{story:r("accordion","size")}}},render:()=>t(S||(S=k([`
    `,`
