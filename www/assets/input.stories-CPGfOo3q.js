import"./input-X8FFvIoM.js";import"./icon-DnrEz64j.js";import"./button-CBOgiAT1.js";import"./textarea-B5QZadAR.js";import{g as D,x as n}from"./iframe-X-eREXnq.js";import{g as e,s as T,c as z,b as E}from"./component-CZIDvlX5.js";import{p as k}from"./PaddingDecorator-DijmbXnA.js";import"./class-map-BhtoNqnr.js";import"./default-value-e9ZBSQxH.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./if-defined-BTfzndMI.js";import"./live-D2Klf_h6.js";import"./localize-Dh03wnLC.js";import"./index-DihgwUfS.js";import"./synergy-element-U-w1v_XU.js";import"./icon.component-hDyH1Egb.js";import"./watch-CEsCE2EF.js";import"./query-DAIS6qJ0.js";import"./form-control.custom.styles-DYs3NDXf.js";import"./divider.component-BGR1POiw.js";import"./functions-CDi3doZH.js";import"./decorator-DANECR0-.js";import"./spinner.component-CmYGD8jO.js";import"./preload-helper-Ct5FWWRu.js";import"./index-Bkk0Z6Ex.js";import"./_docs-UXgsQIP6.js";const{userEvent:I}=__STORYBOOK_MODULE_TEST__,{args:L,argTypes:P}=T("syn-input"),{generateTemplate:q}=z("syn-input"),ae={args:L,argTypes:P,parameters:{design:D("14695-110120"),docs:{description:{component:e("input","default")}}},tags:["Form"],title:"Components/syn-input"},s={parameters:{controls:{disable:!1},docs:{description:{story:e("input","default")}}},render:r=>q({args:r})},a={parameters:{docs:{description:{story:e("input","label")}}},render:()=>n`<syn-input label="What is your name?"></syn-input>`},o={parameters:{docs:{description:{story:e("input","help-text")}}},render:()=>n`<syn-input label="Nickname" help-text="What would you like people to call you?"></syn-input>`},i={parameters:{docs:{description:{story:e("input","placeholder")}}},render:()=>n`<syn-input placeholder="Type something"></syn-input>`},p={parameters:{docs:{description:{story:e("input","clearable")}}},render:()=>n`<syn-input value="Clearable" placeholder="Clearable" clearable></syn-input>`},l={parameters:{docs:{description:{story:e("input","password-toggle")}}},render:()=>n`<syn-input type="password" placeholder="Password Toggle" password-toggle></syn-input>`},c={parameters:{docs:{description:{story:e("input","readonly")}}},render:()=>n`<syn-input value="Readonly content" readonly></syn-input>`},h={decorators:[k()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:e("input","focus")}}},play:({canvasElement:r})=>{const t=r.querySelector("syn-input");t&&t.focus()},render:()=>n`
      <form>
  ...
  <syn-input placeholder="Large" size="large"></syn-input>`},x={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:e("input","invalid")}}},play:async({canvasElement:r})=>{try{const t=r.querySelector("form"),w=t.querySelector("syn-input"),v=t.querySelector("syn-button");v&&w&&(await I.click(v),v.click())}catch(t){console.error("Error in play function:",t)}},render:()=>n`
  ...
  <syn-input type="number" min="0" max="10" value="10"></syn-input>`},g={parameters:{docs:{description:{story:e("input","stepper-input-handling")}}},render:()=>n`
    ...
    <syn-input 
      ...
      value="0"
    ></syn-input>
  `},S=E({Default:s,Labels:a,HelpText:o,Placeholders:i,Clearable:p,TogglePassword:l,ReadonlyInputs:c,Disabled:u,Sizes:m,InputTypes:y,PrefixSuffixTextAndIcons:d,CustomizingLabelPosition:f,Stepper:b,StepperInputHandling:g},500);s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
