import"./preview-BMgyQje8.js";import{x as r}from"./lit-element-ZYWMe1i1.js";import{u as f}from"./index-C3zu00Ep.js";import{s as S,a as w,g as e,b as v}from"./component-CzF4s4R4.js";import"./index-DH5ua8nC.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon-button-DcbuMwrE.js";import"./icon.component-D55FUTwa.js";import"./directive-helpers-CkpR4LMI.js";import"./icon-BrqnReZV.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-7bc9rCDE.js";const{args:T,argTypes:z}=S("syn-textarea"),{generateTemplate:k}=w("syn-textarea"),A={args:T,argTypes:z,parameters:{docs:{description:{component:e("textarea","default")}}},title:"Components/syn-textarea"},n={parameters:{controls:{disable:!1},docs:{description:{story:e("textarea","default")}}},render:a=>k({args:a})},s={parameters:{docs:{description:{story:e("textarea","labels")}}},render:()=>r`<syn-textarea label="Comments"></syn-textarea>`},o={parameters:{docs:{description:{story:e("textarea","help-text")}}},render:()=>r`<syn-textarea label="Feedback" help-text="Please tell us what you think."> </syn-textarea>`},c={parameters:{docs:{description:{story:e("textarea","rows")}}},render:()=>r`
  ...
  PreventResizing,
  ExpandWithContent
}, 500)`,...h.parameters?.docs?.source}}};const I=["Default","Labels","HelpText","Rows","Placeholders","ReadonlyTextareas","Focus","Disabled","Sizes","Invalid","PreventResizing","ExpandWithContent","Screenshot"];export{n as Default,d as Disabled,m as ExpandWithContent,x as Focus,o as HelpText,u as Invalid,s as Labels,l as Placeholders,y as PreventResizing,i as ReadonlyTextareas,c as Rows,h as Screenshot,p as Sizes,I as __namedExportsOrder,A as default};
