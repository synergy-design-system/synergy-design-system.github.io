import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{d as r,f as i,g as a,u as o}from"./iframe-Cn79ht60.js";import{t as s}from"./button-BJ5RECCr.js";import{t as c}from"./icon-caUGB1Oa.js";import{i as l,n as u,o as d,r as f,t as p}from"./component-BsxLXFpR.js";import{n as m,t as h}from"./PaddingDecorator-DYDZS_5f.js";import{t as g}from"./input-CmHjiME7.js";import{t as _}from"./textarea-CEIbqzU7.js";var v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V=e((()=>{g(),c(),s(),_(),n(),f(),r(),h(),a(),{userEvent:v}=__STORYBOOK_MODULE_TEST__,{args:y,argTypes:b}=l(`syn-input`),{generateTemplate:x}=d(`syn-input`),S={args:y,argTypes:b,parameters:{chromatic:{modes:i},design:o(`41337-165221`),docs:{description:{component:u(`input`,`default`)}}},tags:[`Form`],title:`Components/syn-input`},C={parameters:{controls:{disable:!1},docs:{description:{story:u(`input`,`default`)}}},render:e=>x({args:e})},w={parameters:{docs:{description:{story:u(`input`,`label`)}}},render:()=>t`<syn-input label="What is your name?"></syn-input>`},T={parameters:{docs:{description:{story:u(`input`,`help-text`)}}},render:()=>t`<syn-input label="Nickname" help-text="What would you like people to call you?"></syn-input>`},E={parameters:{docs:{description:{story:u(`input`,`placeholder`)}}},render:()=>t`<syn-input placeholder="Type something"></syn-input>`},D={parameters:{docs:{description:{story:u(`input`,`clearable`)}}},render:()=>t`<syn-input value="Clearable" placeholder="Clearable" clearable></syn-input>`},O={parameters:{docs:{description:{story:u(`input`,`password-toggle`)}}},render:()=>t`<syn-input type="password" placeholder="Password Toggle" password-toggle></syn-input>`},k={parameters:{docs:{description:{story:u(`input`,`readonly`)}}},render:()=>t`<syn-input value="Readonly content" readonly></syn-input>`},A={decorators:[m()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`input`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-input`);t&&t.focus()},render:()=>t`
      <form>
        <syn-input help-text="This input is focused." label="Label" placeholder="Insert text here..."></syn-input>
      </form>
    `},j={parameters:{docs:{description:{story:u(`input`,`disabled`)}}},render:()=>t`
  <syn-input placeholder="Disabled" help-text="Help Text" label="Label" disabled>
    <syn-icon name="home" slot="prefix"></syn-icon>
    <syn-icon name="chat" slot="suffix"></syn-icon>
  </syn-input>`},M={parameters:{docs:{description:{story:u(`input`,`size`)}}},render:()=>t`
  ...
  `},P={parameters:{docs:{description:{story:u(`input`,`types`)}}},render:()=>t`
  ...
  `},F={parameters:{docs:{description:{story:u(`input`,`prefix-suffix`)}}},render:()=>t`
  ...
  <syn-input placeholder="Large" size="large">
    <syn-icon name="wallpaper" slot="prefix"></syn-icon>
    <syn-icon name="wallpaper" slot="suffix"></syn-icon>
  </syn-input>`},I={parameters:{docs:{description:{story:u(`input`,`label-position`)}}},render:()=>t`
  ...
  `},L={parameters:{docs:{description:{story:u(`input`,`stepper`)}}},render:()=>t`
  <syn-input type="number" min="0" max="10" value="0"></syn-input>
  <br/>
  <syn-input type="number" min="0" max="10" value="2"></syn-input>
  <br/>
  <syn-input type="number" min="0" max="10" value="10"></syn-input>`},R={parameters:{docs:{description:{story:u(`input`,`stepper-input-handling`)}}},render:()=>t`
    <syn-input
...
}, 500)`,...z.parameters?.docs?.source}}},B=[`Default`,`Labels`,`HelpText`,`Placeholders`,`Clearable`,`TogglePassword`,`ReadonlyInputs`,`Focus`,`Disabled`,`Sizes`,`Invalid`,`InputTypes`,`PrefixSuffixTextAndIcons`,`CustomizingLabelPosition`,`Stepper`,`StepperInputHandling`,`Screenshot`]}));V();export{D as Clearable,I as CustomizingLabelPosition,C as Default,j as Disabled,A as Focus,T as HelpText,P as InputTypes,N as Invalid,w as Labels,E as Placeholders,F as PrefixSuffixTextAndIcons,k as ReadonlyInputs,z as Screenshot,M as Sizes,L as Stepper,R as StepperInputHandling,O as TogglePassword,B as __namedExportsOrder,S as default,V as t};