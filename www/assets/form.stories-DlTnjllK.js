import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r,n as i,t as a}from"./preview-DRz18Lsn.js";import{c as o,t as s}from"./lit-D4-0ovri.js";import{d as c,f as l,i as u,p as d,u as f}from"./blocks-Tvq0jjN0.js";import{t as p}from"./react-Q1GcV6wX.js";import{t as m}from"./button-CBC8ywKX.js";import{t as h}from"./divider-Bas-Jfyn.js";import{t as g}from"./select-BiMMRNnt.js";import{t as _}from"./option-5Sp0fHIr.js";import{t as v}from"./input-DeuiTlMk.js";import{n as y,r as b}from"./component-NnlguzJ1.js";import{t as x}from"./taggedTemplateLiteral-BZenJ0bZ.js";import{t as S}from"./icon-button-Csrs2rAo.js";import{t as C}from"./checkbox-group-CIvO1NgC.js";import{t as w}from"./checkbox-CVHh1A6r.js";import{t as T}from"./combobox-DUbchEB7.js";import{t as E}from"./fieldset-Bj06nad1.js";import{t as D}from"./file-vbDiHZxN.js";import{t as O}from"./textarea-RHZnTiPn.js";import{t as k}from"./spinner-BytKAwZN.js";import{n as A,t as j}from"./translations-uscc1XxV.js";var M,N,P,F,I,L,R,z;function B(){return(B=t((()=>{M=e(p(),1),d(),s(),a(),b(),A(),r(),w(),C(),E(),O(),v(),g(),_(),T(),m(),S(),k(),D(),h(),F={parameters:{chromatic:{...i?.parameters?.chromatic,disableSnapshot:!1,modes:n},docs:{description:{component:y(`contact-form`,`default`,`templates`)},page:()=>M.createElement(M.Fragment,null,M.createElement(l,null),M.createElement(c,null),M.createElement(u,null),M.createElement(f,{title:``})),story:{iframeHeight:1600,inline:!0}}},tags:[`Form`],title:`Templates/Forms`},I={render:()=>o(N||=x([`
    <style>
    .synergy-form-demo {
  ...
  `]),j(`contactForm.headline`),j(`contactForm.subHeadline`),j(`contactForm.topicLabel`),j(`contactForm.topics`).map((e,t)=>o`
    ...
    <\/script>
  `]),j(`fileUpload.multiple.headline`),t.viewMode,j(`fileUpload.label`),j(`fileUpload.helpText`),j(`fileUpload.uploadButton`),t.viewMode)},z=[`ContactForm`,`ContactFormTablet`,`MultipleFilesUploadForm`],I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`{
  render: () => html\`
    <style>
    .synergy-form-demo {
      background: var(--syn-color-neutral-0);
  ...
  render: (_, context) => html\`
    ...
    <\/script>
  \`
}`,...R.parameters?.docs?.source}}}})))()}B();export{I as ContactForm,L as ContactFormTablet,R as MultipleFilesUploadForm,z as __namedExportsOrder,F as default};