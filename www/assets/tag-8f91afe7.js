import{a as v}from"./static-c19bae7e.js";import{i as m,x as l}from"./directive-helpers-a6c66f8a.js";import{L as d}from"./localize-3922cea4.js";import{c as y,n as g,S as u}from"./component.styles-86aba3f6.js";import{S as p}from"./icon-button.component-f28bd104.js";const h=m`
  .tag {
...
`,b=m`
  ...
  ${h}
`;var f=Object.defineProperty,z=Object.getOwnPropertyDescriptor,c=(s,t,r,n)=>{for(var e=n>1?void 0:n?z(t,r):t,i=s.length-1,o;i>=0;i--)(o=s[i])&&(e=(n?o(t,r,e):o(e))||e);return n&&e&&f(t,r,e),e};class a extends u{constructor(){super(...arguments),this.localize=new d(this),this.size="medium",this.removable=!1}handleRemoveClick(){this.emit("syn-remove")}render(){return l`
      <span
        part="base"
    ...
    `}}a.styles=b;a.dependencies={"syn-icon-button":p};c([g({reflect:!0})],a.prototype,"size",2);c([g({type:Boolean})],a.prototype,"removable",2);a.define("syn-tag");
//# sourceMappingURL=tag-8f91afe7.js.map
