import"./tab-panel-m-forR7z.js";import"./tab-Bn8LbNiW.js";import"./icon-CXtHULQP.js";import{g as G,x as t,o as u}from"./iframe-CADVxcxo.js";import{p as E}from"./index-Bkk0Z6Ex.js";import{g as s,s as _,a as O,c as F,b as R}from"./component-DIYVGgkZ.js";import"./class-map-CsDeTdsb.js";import"./synergy-element-CyR5uAEa.js";import"./icon.component-Cgd4Rx4z.js";import"./watch-CEsCE2EF.js";import"./event-options-CNZcgQm4.js";import"./query-DAIS6qJ0.js";import"./query-assigned-elements-QtOlz7Yz.js";import"./localize-Dh03wnLC.js";import"./index-DihgwUfS.js";import"./scroll-DgKSCJoS.js";import"./icon-button.component-tvEbJf6e.js";import"./if-defined-DdzhuTe9.js";import"./decorator-DANECR0-.js";import"./functions-CDi3doZH.js";import"./preload-helper-Ct5FWWRu.js";import"./_docs-DKsB8ZHg.js";var $=Object.freeze,q=Object.defineProperty,j=(e,n)=>$(q(e,"raw",{value:$(n||e.slice())})),S;const{args:w,argTypes:A}=_("syn-tab-group"),{overrideArgs:I}=O("syn-tab-group"),{generateTemplate:L}=F("syn-tab-group"),P=(e,n,{active:a=!1,closable:g=!1,disabled:v=!1}={})=>`<syn-tab slot="nav" panel="${e}" ${a?"active":""} ${v?"disabled":""} ${g?"closable":""}>${n}</syn-tab>`,T=(e,n,{active:a=!1,closable:g=!1,disabled:v=!1}={})=>u(P(e,n,{active:a,closable:g,disabled:v})),C=()=>[{panel:"general",props:{active:!0}},{panel:"custom"},{panel:"advanced"},{panel:"disabled",props:{disabled:!0}}].map(({panel:e,props:n})=>P(e,E(e),n)).join(`
`),f=()=>u(C()),H=(e,n,a=!1)=>`<syn-tab-panel name="${e}" ${a?"active":""}>${n}</syn-tab-panel>`,x=(e,n,a=!1)=>u(H(e,n,a)),D=()=>["general","custom","advanced","disabled"].map((e,n)=>H(e,`This is the ${e} tab panel.`,n===0)).join(`
`),M=(e,n=!1)=>t`
...
`,y=()=>u(D()),pe={args:I([{name:"default",type:"slot",value:D()},{name:"nav",type:"slot",value:C()}],w),argTypes:A,component:"syn-tab-group",parameters:{design:G("18021-1924779"),docs:{description:{component:s("tab-group","default")}}},tags:["Navigation","SICK2018"],title:"Components/syn-tab-group"},r={parameters:{docs:{description:{story:s("tab-group","default")}}},render:e=>L({args:e})},o={parameters:{docs:{description:{story:s("tab-group","start")}}},render:()=>t`
