import"./icon-B0bUSbWK.js";import{g as f,x as e}from"./iframe-hmg045VI.js";import{s as p,a as g,c as b,b as v}from"./component-Bo8xV33a.js";import{r as d}from"./icon.component-C3LySnyd.js";import{d as u}from"./default-icons-Dpg8W8qC.js";import"./index-Bkk0Z6Ex.js";import"./_docs-UXgsQIP6.js";import"./property-DGhSbS75.js";import"./state-DKD71wud.js";import"./watch-CEsCE2EF.js";import"./component.styles-CXuD9i9j.js";const w=`Icons are small standard symbols that are primarily used in screen design.
...
\`\`\`
`,{args:S,argTypes:I}=p("syn-icon"),{overrideArgs:k}=g("syn-icon"),{generateTemplate:C}=b("syn-icon"),x=`
${w}

---

`,$={args:k({name:"name",type:"attribute",value:"wallpaper"},S),argTypes:I,component:"syn-icon",parameters:{design:f("1616-1512"),docs:{description:{component:x}}},tags:["Icons"],title:"Components/syn-icon"},s={parameters:{controls:{disable:!1}},render:n=>C({args:n})},t={render:()=>e`<div style="color: var(--syn-color-primary-600);">
...
<div style="color: var(--syn-color-error-700);">
...
</div>`},o={render:()=>e`<div style="font-size: var(--syn-font-size-2x-large);">
  <syn-icon name="warning"></syn-icon>
  <syn-icon name="inventory"></syn-icon>
  <syn-icon name="battery_charging_full"></syn-icon>
  <syn-icon name="notifications"></syn-icon>
  ...
  <syn-icon name="star_border"></syn-icon>
  <syn-icon name="delete"></syn-icon>
</div>`},i={render:()=>e`<syn-icon name="star" label="Add to favorites"></syn-icon>`},r={render:()=>e`<syn-icon src="/logo-claim.svg" style="font-size: 10rem;"></syn-icon>`},a={render:()=>(d("fa",{resolver:n=>{const h=n.replace(/^fa[rbs]-/,"");let m="regular";return n.substring(0,4)==="fas-"&&(m="solid"),n.substring(0,4)==="fab-"&&(m="brands"),`https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.15.1/svgs/${m}/${h}.svg`},mutator:n=>n.setAttribute("fill","currentColor")}),e`<div style="font-size: var(--syn-font-size-x-large);">
...
</div>`)},y=v({Default:s,Colors:t,Sizing:o,Labels:i,CustomIcons:r,CDNIconLibrary:a,BundledIconLibrary:c,SpriteSheetUsage:l});s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    }
...
or on a parent element as shown below.`,...o.parameters?.docs?.description}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:'{\n  render: () => html`<syn-icon name="star" label="Add to favorites"></syn-icon>`\n}',...i.parameters?.docs?.source},description:{story:"For non-decorative icons, use the label attribute to announce it to assistive devices.",...i.parameters?.docs?.description}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:'{\n  render: () => html`<syn-icon src="/logo-claim.svg" style="font-size: 10rem;"></syn-icon>`\n}',...r.parameters?.docs?.source},description:{story:`Custom icons can be loaded individually with the src attribute.
...
\`\`\``,...l.parameters?.docs?.description}}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`generateScreenshotStory({
  ...
  BundledIconLibrary,
  SpriteSheetUsage
})`,...y.parameters?.docs?.source}}};const G=["Default","Colors","Sizing","Labels","CustomIcons","CDNIconLibrary","BundledIconLibrary","SpriteSheetUsage","Screenshot"];export{c as BundledIconLibrary,a as CDNIconLibrary,t as Colors,r as CustomIcons,s as Default,i as Labels,y as Screenshot,o as Sizing,l as SpriteSheetUsage,G as __namedExportsOrder,$ as default};
