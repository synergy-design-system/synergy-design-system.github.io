import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{a as t,d as n,o as r,s as i}from"./preview-DXkhgu0Z.js";import{c as a,t as o}from"./lit-BfcklOOD.js";import{t as s}from"./button-DVR7vfNM.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-B0n0ooCL.js";import{n as m,t as h}from"./menu-item-Y5fCk6TC.js";import{t as g}from"./dropdown-CEqtLr3e.js";import{t as _}from"./button-group-C47MYRmg.js";import{t as v}from"./tooltip-ByZZgRuG.js";var y,b,x,S,C,w,T,E,D,O,k,A,j,M,N=e((()=>{_(),s(),g(),m(),h(),v(),o(),f(),r(),n(),{args:y,argTypes:b}=l(`syn-button-group`),{overrideArgs:x}=c(`syn-button-group`),{generateTemplate:S}=d(`syn-button-group`),C={args:x({name:`default`,type:`slot`,value:`<syn-button>Left</syn-button>
<syn-button>Center</syn-button>
<syn-button>Right</syn-button>`},y),argTypes:b,component:`syn-button-group`,parameters:{chromatic:{modes:i},design:t(`45597-333063`),docs:{description:{component:u(`button-group`,`default`)}}},title:`Components/syn-button-group`},w={parameters:{controls:{disable:!1},docs:{description:{story:u(`button-group`,`default`)}}},render:e=>S({args:e})},T={parameters:{docs:{description:{story:u(`button-group`,`variant`)}}},render:()=>a`
    <div style="display: flex; gap: var(--syn-spacing-large); flex-direction: column;">
      ${[`outline`,`filled`].map(e=>a`
  ...
  `},E={parameters:{docs:{description:{story:u(`button-group`,`size`)}}},render:()=>a`
    <div style="display: flex; gap: var(--syn-spacing-large); flex-direction: column;">
  ...
  `},D={parameters:{docs:{description:{story:u(`button-group`,`dropdowns-in-button-groups`)}}},render:()=>a`
  ...
  `},O={parameters:{docs:{description:{story:u(`button-group`,`split-buttons`)}}},render:()=>a`
    <syn-button-group label="Example Button Group">
  ...
  `},k={parameters:{docs:{description:{story:u(`button-group`,`tooltips`)}}},render:()=>a`
    <syn-button-group label="Example Button Group">
  ...
  `},A={parameters:{docs:{description:{story:u(`button-group`,`toolbar`)}}},render:()=>a`
