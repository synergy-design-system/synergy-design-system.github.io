import{g as n,a as $,s as M,c as P,b as z,d as L}from"./component-DMA8eng6.js";import{x as o}from"./directive-helpers-Dvm_Ferq.js";import{u as k}from"./index-CSCA1apM.js";import{o as q}from"./select-CngNtP-u.js";import"./library-BX4ONXik.js";import"./ref-B9GS7qLj.js";import"./chunk-L4EGOTBX-Boit2UGA.js";import"./entry-preview-DkJqm5dP.js";import"./index-DrFu-skq.js";import"./icon-button-M_xuVFUt.js";import"./index-Vx7n56Jp.js";import"./index-_2TAQcTa.js";import"./_commonjsHelpers-CqkleIqs.js";var x=Object.freeze,H=Object.defineProperty,S=(e,t)=>x(H(e,"raw",{value:x(t||e.slice())})),_,T,E;const{args:D,argTypes:C}=M("syn-select"),{overrideArgs:I}=z("syn-select"),{generateTemplate:U}=P("syn-select"),nn={args:D,argTypes:C,component:"syn-select",parameters:{design:$("5069-7562"),docs:{description:{component:n("select","default")},story:{height:"250px"}}},title:"Components/syn-select"},s={parameters:{args:I({name:"default",type:"slot",value:`
  ...
  `},v={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:n("select","invalid")}}},play:async({canvasElement:e})=>{const t=e.querySelector("form"),w=t.querySelector("syn-select"),f=t.querySelector("syn-button");f&&w&&(await k.click(f),f.click())},render:()=>o`
  ...
  afterRender: openSelect('syn-select'),
  heightPx: 400
})`,...h.parameters?.docs?.source}}};const on=["Default","Labels","HelpText","Placeholder","Clearable","Focus","Disabled","Multiple","SettingInitialValues","GroupingOptions","Sizes","Invalid","PrefixSuffixIcons","CustomTags","ScreenshotDefault","ScreenshotMultiple"];export{a as Clearable,g as CustomTags,s as Default,c as Disabled,r as Focus,m as GroupingOptions,p as HelpText,v as Invalid,i as Labels,y as Multiple,l as Placeholder,O as PrefixSuffixIcons,b as ScreenshotDefault,h as ScreenshotMultiple,u as SettingInitialValues,d as Sizes,on as __namedExportsOrder,nn as default};
