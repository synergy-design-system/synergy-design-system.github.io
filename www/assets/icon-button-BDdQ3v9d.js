import{w as g,x as _,T as S,i as $}from"./lit-element-DILkAbkc.js";import{a as z,c as x,S as T,b as w,n as u}from"./icon.component-7B7zNgNb.js";/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const E=(o,t,n)=>(n.configurable=!0,n.enumerable=!0,Reflect.decorate&&typeof t!="object"&&Object.defineProperty(o,t,n),n);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function k(o,t){return(n,e,r)=>{const s=l=>l.renderRoot?.querySelector(o)??null;return E(n,e,{get(){return s(this)}})}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const A={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},C=o=>(...t)=>({_$litDirective$:o,values:t});let B=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,n,e){this._$Ct=t,this._$AM=n,this._$Ci=e}_$AS(t,n){return this.update(t,n)}update(t,n){return this.render(...n)}};/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const F=C(class extends B{constructor(o){if(super(o),o.type!==A.ATTRIBUTE||o.name!=="class"||o.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(o){return" "+Object.keys(o).filter(t=>o[t]).join(" ")+" "}update(o,[t]){if(this.st===void 0){this.st=new Set,o.strings!==void 0&&(this.nt=new Set(o.strings.join(" ").split(/\s/).filter(e=>e!=="")));for(const e in t)t[e]&&!this.nt?.has(e)&&this.st.add(e);return this.render(t)}const n=o.element.classList;for(const e of this.st)e in t||(n.remove(e),this.st.delete(e));for(const e in t){const r=!!t[e];r===this.st.has(e)||this.nt?.has(e)||(r?(n.add(e),this.st.add(e)):(n.remove(e),this.st.delete(e)))}return g}});/**
 * @license
...
`;var U=Object.defineProperty,a=(o,t,n,e)=>{for(var r=void 0,s=o.length-1,l;s>=0;s--)(l=o[s])&&(r=l(t,n,r)||r);return r&&U(t,n,r),r};class i extends z{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.size="inherit",this.color="currentColor",this.disabled=!1}static{this.styles=[x,O,P]}static{this.dependencies={"syn-icon":T}}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleClick(t){this.disabled&&(t.preventDefault(),t.stopPropagation())}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}render(){const t=!!this.href,n=t?v`a`:v`button`;return I`
    ...
    `}}a([k(".icon-button")],i.prototype,"button");a([w()],i.prototype,"hasFocus");a([u()],i.prototype,"name");a([u()],i.prototype,"library");a([u()],i.prototype,"src");a([u()],i.prototype,"href");a([u()],i.prototype,"target");a([u()],i.prototype,"download");a([u()],i.prototype,"label");a([u({reflect:!0})],i.prototype,"size");a([u({reflect:!0})],i.prototype,"color");a([u({type:Boolean,reflect:!0})],i.prototype,"disabled");i.define("syn-icon-button");export{i as S,F as a,E as b,B as c,k as d,C as e,N as i,I as n,c as o,v as s,A as t};
