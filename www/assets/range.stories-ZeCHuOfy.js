import{u as A}from"./index-BY-rbqZU.js";import{x as n}from"./lit-element-DILkAbkc.js";import{g as C}from"./preview-CquOqP6_.js";import{s as q,a as z,g as e,b as L,c as M}from"./component-Ag4kLFSv.js";import"./index-B3ehnkiM.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon.component-DQyUHKqc.js";import"./directive-helpers-DbZfDV3x.js";import"./icon-button-B6Lh2FYd.js";import"./icon-BPsRcIoP.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-CWcgpSpO.js";var T=Object.freeze,_=Object.defineProperty,h=(t,r)=>T(_(t,"raw",{value:T(t.slice())})),V,D,w,E;const{args:P,argTypes:j}=q("syn-range"),{overrideArgs:F}=M("syn-range"),{generateTemplate:O}=z("syn-range"),X={args:F([{name:"value",type:"attribute",value:"50"}],P),argTypes:j,component:"syn-range",parameters:{design:C("20575-35283"),docs:{description:{component:e("range","default")}}},title:"Components/syn-range"},s={parameters:{controls:{disable:!1},docs:{description:{story:e("range","default")},story:{height:"80px"}}},render:t=>O({args:t})},a={parameters:{docs:{description:{story:e("range","labels")}}},render:()=>n`
    <syn-range label="Label" max="100" min="0" value="50"></syn-range>
  `},i={parameters:{docs:{description:{story:e("range","help-text")}}},render:()=>n`
    <syn-range
      ...
      value="50"
    ></syn-range>
  `},o={parameters:{docs:{description:{story:e("range","disabled")}}},render:()=>n`
    <syn-range disabled max="100" min="0" value="50"></syn-range>
  `},c={parameters:{docs:{description:{story:e("range","invalid")}}},play:async({canvasElement:t})=>{try{const r=t.querySelector("syn-range"),S=t.querySelector("syn-button");r&&S&&(await A.click(S),S.click())}catch(r){console.error("Error in play function:",r)}},render:()=>n(V||(V=h([`
  ...
  `])))},b={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:e("range","focus")},story:{height:"80px"}}},play:({canvasElement:t})=>{const r=t.querySelector("syn-range");r&&r.focus()},render:()=>n`
    <form>
      <syn-range max="100" min="0" value="50"></syn-range>
    </form>
  `},l={parameters:{docs:{description:{story:e("range","size")}}},render:()=>n`
  ...
  `},m={parameters:{docs:{description:{story:e("range","prefix-suffix")}}},render:()=>n(D||(D=h([`
    <syn-range
      help-text="Controls the volume of the current song"
      label="Volume"
      max="100"
    ...
    <\/script>
  `])))},p={parameters:{docs:{description:{story:e("range","custom-track-colors")},story:{height:"80px"}}},render:()=>n`
    <syn-range
  ...
  `},u={parameters:{docs:{description:{story:e("range","custom-track-offset")},story:{height:"80px"}}},render:()=>n`
    <syn-range
  ...
  `},y={parameters:{docs:{description:{story:e("range","multi-knob")},story:{height:"80px"}}},render:()=>n`
    <syn-range max="100" min="0" value="30 70"></syn-range>
  `},k={parameters:{docs:{description:{story:e("range","multi-knob-restrict-movement")}}},render:()=>n(w||(w=h([`
    <syn-range
    ...
    <\/script>
  `])))},g={parameters:{docs:{description:{story:e("range","ticks")}}},render:()=>n`
  <div class="wrapper">
    <syn-range
  ...
  `},d={parameters:{docs:{description:{story:e("range","tooltip-placement")},story:{height:"80px"}}},render:()=>n`
    <syn-range
      ...
      value="50"
    ></syn-range>
  `},f={parameters:{docs:{description:{story:e("range","tooltip-disabled")}}},render:()=>n`
    <syn-range
      max="100"
      min="0"
      ...
      value="50"
    ></syn-range>
  `},v={parameters:{docs:{description:{story:e("range","tooltip-formatter")}}},render:()=>n(E||(E=h([`
    <syn-range
    ...
    <\/script>
  `])))},x=L({Default:s,Labels:a,HelpText:i,Disabled:o,Invalid:c,Sizes:l,PrefixSuffixText:m,CustomTrackColors:p,CustomTrackOffset:u,MultiThumb:y,Ticks:g,TooltipPlacement:d,TooltipDisabled:f,TooltipFormatter:v},500);s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  TooltipDisabled,
  TooltipFormatter
}, 500)`,...x.parameters?.docs?.source}}};const Z=["Default","Labels","HelpText","Disabled","Invalid","Focus","Sizes","PrefixSuffixText","CustomTrackColors","CustomTrackOffset","MultiThumb","MultiThumbWithRestrictedMovement","Ticks","TooltipPlacement","TooltipDisabled","TooltipFormatter","Screenshot"];export{p as CustomTrackColors,u as CustomTrackOffset,s as Default,o as Disabled,b as Focus,i as HelpText,c as Invalid,a as Labels,y as MultiThumb,k as MultiThumbWithRestrictedMovement,m as PrefixSuffixText,x as Screenshot,l as Sizes,g as Ticks,f as TooltipDisabled,v as TooltipFormatter,d as TooltipPlacement,Z as __namedExportsOrder,X as default};
