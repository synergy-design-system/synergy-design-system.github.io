import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{a as t,c as n,d as r,o as i}from"./preview-C7vlOWDR.js";import{c as a,t as o}from"./lit-BfcklOOD.js";import{n as s,r as c,t as l}from"./chart-DrxKYTrA.js";import{a as u,i as d,n as f,o as p,r as m,t as h}from"./component-tvBHR92M.js";import{n as g,t as _}from"./taggedTemplateLiteral-C9cDEsPD.js";var v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F=e((()=>{o(),l(),c(),m(),i(),r(),g(),{overrideArgs:C}=u(`syn-chart`),{args:w,argTypes:T}=d(`syn-chart`),{generateTemplate:E}=p(`syn-chart`),D={args:C([{name:`id`,type:`attribute`,value:`chart-default`}],w),argTypes:{...T,palette:{control:`select`,options:Object.keys(s)}},component:`syn-chart`,parameters:{chromatic:{modes:n,pauseAnimationAtEnd:!1},controls:{exclude:[`id`]},design:t(`41094-279501`),docs:{description:{component:[`>⚠️ **Experimental**:`,`>syn-chart is currently experimental.`,`>The API may change in future releases without prior notice.`,`>Use it with caution in production environments and expect potential breaking changes.
`,f(`chart`,`default`)].join(`
`)}}},tags:[`Charting`,`Data Visualization`],title:`Charts/syn-chart`},O={parameters:{controls:{disable:!1},docs:{description:{story:f(`chart`,`default`)}}},render:e=>a(v||=_([`
    `,`
    <script type="module">
    ...
    <\/script>
  `]),E({args:e}))},k={parameters:{docs:{description:{story:f(`chart`,`config`)}}},render:()=>a(y||=_([`
    ...
    <\/script>
  `]))},A={parameters:{docs:{description:{story:f(`chart`,`palette`)}}},render:()=>a(b||=_([`
    ...
    <\/script>
  `]))},j={parameters:{docs:{description:{story:f(`chart`,`get-instance`)}}},render:()=>a(x||=_([`
    ...
    <\/script>
  `]))},M={parameters:{docs:{description:{story:f(`chart`,`multiple-charts`)}}},render:()=>a(S||=_([`
