import{e as $}from"./class-map-CN3Dk8tE.js";import{c as A,n as s,S as B}from"./synergy-element-BzUY5SE_.js";import{S as O,r as P}from"./icon.component-CK7vaVNx.js";import{a as S}from"./query-D0jTsbLw.js";import{j as q,c as i,C as L,d as M}from"./iframe-pnT4pJc8.js";import{o as H}from"./if-defined-AzRyr4pU.js";import{d as j}from"./default-value-BcJuXapZ.js";import{w as E}from"./watch-CEsCE2EF.js";import{L as R}from"./localize-Dh03wnLC.js";import{F as U}from"./form-d9hCJUdr.js";import{H as W}from"./slot-9EVoRGQc.js";import{f as Y}from"./form-control.styles-Be8c_yQJ.js";import{S as G}from"./button-BkA9AyGR.js";import{s as z,g as k,b as C}from"./animation-registry-DyRYqZdt.js";import{e as K}from"./decorator-CWkWRMhy.js";import{g as d,a as N,s as J,b as Q,c as X}from"./component-D-ZvKR36.js";import{p as Z}from"./PaddingDecorator-CRdGD8RK.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DihgwUfS.js";import"./spinner.component-B-h_NUsZ.js";import"./functions-bkELIyT9.js";import"./index-3hbeBem-.js";import"./_docs-GL32a4iR.js";const ee=q`
  :host {
    display: block;
  }
...
`;var re=Object.defineProperty,te=Object.getOwnPropertyDescriptor,a=(e,t,o,l)=>{for(var n=l>1?void 0:l?te(t,o):t,p=e.length-1,c;p>=0;p--)(c=e[p])&&(n=(l?c(t,o,n):c(n))||n);return l&&n&&re(t,o,n),n};let r=class extends B{constructor(){super(...arguments),this.formControlController=new U(this,{assumeInteractionOn:["syn-change"],value:e=>e.files}),this.hasSlotController=new W(this,"help-text","label"),this.localize=new R(this),this.userIsDragging=!1,this.name="",this.defaultValue="",this.size="medium",this.label="",this.helpText="",this.disabled=!1,this.readonly=!1,this.droparea=!1,this.accept="",this.multiple=!1,this.webkitdirectory=!1,this.form="",this.required=!1,this.hideValue=!1}set files(e){this.input&&(this.input.files=e)}get files(){return this.input?.files}set value(e){this.input&&(this.input.value=e)}get value(){return this.input?.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(e){if(this.droparea){this.dropareaWrapper?.focus(e);return}this.button?.focus(e)}blur(){if(this.droparea){this.dropareaWrapper?.blur();return}this.button?.blur()}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleFiles(e){if(!e){this.value="";return}this.files=e}async handleTransferItems(e){if(!e)return this.value="",new Promise((c,I)=>{I(new Error("No proper items found"))});const o=Array.from(e).map(c=>c.webkitGetAsEntry()).map(c=>this.getFilesFromEntry(c)),n=(await Promise.all(o)).flat(),p=new DataTransfer;return Array.from(n).forEach(c=>p.items.add(c)),p.files}async getFilesFromEntry(e){return e?e.isFile?new Promise((t,o)=>{e.file(l=>t([l]),o)}):e.isDirectory?new Promise((t,o)=>{e.createReader().readEntries(n=>{Promise.all(n.map(p=>this.getFilesFromEntry(p))).then(p=>{t(p.flat())}).catch(o)})}):[]:[]}handleClick(e){e.preventDefault(),this.input.click()}handleChange(e){e.preventDefault(),e.stopPropagation(),this.emit("syn-input"),this.emit("syn-change")}handleDragOver(e){e.preventDefault(),e.stopPropagation(),!(this.disabled||this.readonly)&&(this.userIsDragging=!0)}handleDragLeave(e){e.preventDefault(),e.stopPropagation(),!(this.disabled||this.readonly)&&(this.userIsDragging=!1)}async handleDrop(e){if(e.preventDefault(),e.stopPropagation(),this.disabled||this.readonly||!e.dataTransfer)return;const t=await this.handleTransferItems(e.dataTransfer?.items);if(this.userIsDragging=!1,!t)return;if(!this.multiple&&!this.webkitdirectory&&t.length>1){this.emit("syn-error");return}if(this.hasSlotController.test("trigger"))this.handleFiles(t);else{const l=k(this.inputChosen,"file.text.disappear",{dir:this.localize.dir()}),n=k(this.inputChosen,"file.text.appear",{dir:this.localize.dir()});if(this.droparea){const p=k(this.dropareaIcon,"file.iconDrop",{dir:this.localize.dir()});C(this.dropareaIcon,p.keyframes,p.options)}await C(this.inputChosen,l.keyframes,l.options),this.handleFiles(t),await C(this.inputChosen,n.keyframes,n.options)}this.input.dispatchEvent(new Event("change"))}handleFocus(){this.emit("syn-focus")}handleBlur(){this.emit("syn-blur")}renderValue(){let e=!1,t=this.localize.term("numFilesSelected",0,this.webkitdirectory);return this.files&&this.files?.length>0&&(e=!0,t=this.files.length===1?this.files[0].name:this.localize.term("numFilesSelected",this.files.length,this.webkitdirectory)),i`
      <span
    ...
    `}};r.styles=[A,Y,ee];r.dependencies={"syn-button":G,"syn-icon":O};a([P()],r.prototype,"userIsDragging",2);a([s({type:Object})],r.prototype,"files",1);a([s({type:String})],r.prototype,"name",2);a([s({type:String})],r.prototype,"value",1);a([j()],r.prototype,"defaultValue",2);a([s({reflect:!0})],r.prototype,"size",2);a([s()],r.prototype,"label",2);a([s({attribute:"help-text"})],r.prototype,"helpText",2);a([s({reflect:!0,type:Boolean})],r.prototype,"disabled",2);a([s({reflect:!0,type:Boolean})],r.prototype,"readonly",2);a([s({type:Boolean})],r.prototype,"droparea",2);a([s({type:String})],r.prototype,"accept",2);a([s({type:String})],r.prototype,"capture",2);a([s({reflect:!0,type:Boolean})],r.prototype,"multiple",2);a([s({reflect:!0,type:Boolean})],r.prototype,"webkitdirectory",2);a([s({reflect:!0})],r.prototype,"form",2);a([s({reflect:!0,type:Boolean})],r.prototype,"required",2);a([s({attribute:"hide-value",type:Boolean})],r.prototype,"hideValue",2);a([S(".input__control")],r.prototype,"input",2);a([S(".button")],r.prototype,"button",2);a([S(".droparea")],r.prototype,"dropareaWrapper",2);a([S(".droparea__icon")],r.prototype,"dropareaIcon",2);a([S(".input__value")],r.prototype,"inputChosen",2);a([E("disabled",{waitUntilFirstUpdate:!0})],r.prototype,"handleDisabledChange",1);a([E("value",{waitUntilFirstUpdate:!0})],r.prototype,"handleValueChange",1);r=a([K("SynFile")],r);z("file.iconDrop",{keyframes:[{scale:1},{scale:.7},{scale:1}],options:{duration:600,easing:"ease-out"}});z("file.text.disappear",{keyframes:[{opacity:1},{opacity:0,transform:"translateY(-40%)"}],options:{duration:300,easing:"cubic-bezier(0.45, 1.45, 0.8, 1)"}});z("file.text.appear",{keyframes:[{opacity:0,transform:"translateY(40%)"},{opacity:1}],options:{duration:300,easing:"cubic-bezier(0.45, 1.45, 0.8, 1)"}});r.define("syn-file");var V=Object.freeze,ae=Object.defineProperty,ie=(e,t)=>V(ae(e,"raw",{value:V(e.slice())})),F;const{userEvent:se}=__STORYBOOK_MODULE_TEST__,{args:le,argTypes:oe}=J("syn-file"),{overrideArgs:ne}=X("syn-file"),{generateTemplate:pe}=Q("syn-file"),Ie={args:ne([],le),argTypes:oe,component:"syn-file",parameters:{chromatic:{modes:L},design:M("21709-49135"),docs:{description:{component:d("file","default")}}},tags:["Form"],title:"Components/syn-file"},u={parameters:{controls:{disable:!1},docs:{description:{story:d("file","default")}}},render:e=>pe({args:e})},y={parameters:{docs:{description:{story:d("file","label")}}},render:()=>i`
  ...
  `},h={parameters:{docs:{description:{story:d("file","help-text")}}},render:()=>i`
    ...
    ></syn-file>
  `},f={parameters:{docs:{description:{story:d("file","multiple")}}},render:()=>i`
    <syn-file
  ...
  `},m={parameters:{docs:{description:{story:d("file","hide-value")}}},render:()=>i`
    <syn-file
      ...
      label="This is a label"
    ></syn-file>
  `},D={decorators:[Z()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:d("file","focus")}}},play:({canvasElement:e})=>{const t=e.querySelector("syn-file");t&&t.focus()},render:()=>i`
...
`},T={parameters:{docs:{description:{story:d("file","readonly")}}},render:()=>i`
    <div style="display: flex; flex-direction: column; gap: 1rem;">
      <syn-file
        readonly
        label="This is a label"
...
`},b={parameters:{docs:{description:{story:d("file","sizes")}}},render:()=>i`
  ...
  `},v={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:d("file","invalid")}}},play:async({canvasElement:e})=>{try{const t=e.querySelector("form"),o=t.querySelectorAll("syn-file"),l=t.querySelector("syn-button");l&&o&&(await se.click(l),l.click())}catch(t){console.error("Error in play function:",t)}},render:()=>i(F||(F=ie([`
  ...
  `},w=N({Default:u,Label:y,HelpText:h,Multiple:f,HideValue:m,Disabled:g,Sizes:b,Invalid:v,Droparea:x,Directory:_},750);u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
...
\`
} as Story`,...g.parameters?.docs?.source}}};T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
\`
} as Story`,...T.parameters?.docs?.source}}};b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
  ...
  Droparea,
  Directory
}, 750)`,...w.parameters?.docs?.source}}};const Ae=["Default","Label","HelpText","Multiple","HideValue","Focus","Disabled","Readonly","Sizes","Invalid","Droparea","Directory","Screenshot"];export{u as Default,_ as Directory,g as Disabled,x as Droparea,D as Focus,h as HelpText,m as HideValue,v as Invalid,y as Label,f as Multiple,T as Readonly,w as Screenshot,b as Sizes,Ae as __namedExportsOrder,Ie as default};
