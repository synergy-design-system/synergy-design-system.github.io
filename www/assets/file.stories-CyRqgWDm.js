import{a as z}from"./static-gmWA-8Kq.js";import{n as l}from"./property-BGzwfL48.js";import{r as I}from"./state-CZ0nVzce.js";import{a as _}from"./query-DAIS6qJ0.js";import{i as A,x as a}from"./directive-helpers-DGrfjhaU.js";import{o as P}from"./if-defined-B2ZFWIyt.js";import{d as B}from"./default-value-DcEsLq7D.js";import{w as F}from"./watch-CEsCE2EF.js";import{L as q}from"./localize-CatY2peN.js";import{F as L}from"./form-d9hCJUdr.js";import{H as O}from"./slot-9EVoRGQc.js";import{c as M,S as H}from"./component.styles-Do19GEOY.js";import{f as j,a as R}from"./form-control.custom.styles-DbPhNFMw.js";import{S as U}from"./button-BtEYlTQw.js";import{S as W}from"./icon.component-CScz9CrR.js";import{s as k,g as T,b as C}from"./animation-registry-l4L8bmT6.js";import{e as Y}from"./decorator-DANECR0-.js";import{u as G}from"./index-CSCA1apM.js";import{g as d,a as N,s as J,b as K,d as Q,c as X}from"./component-CRxE2rhG.js";import"./index-DihgwUfS.js";import"./spinner.component-oeFu-uyM.js";import"./functions-CDi3doZH.js";import"./async-directive-PIeysb9D.js";import"./chunk-L4EGOTBX-CsK1v_wc.js";import"./entry-preview-B_oC2lVs.js";import"./index-DrFu-skq.js";import"./_docs-CrPFe_9C.js";import"./index-_2TAQcTa.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-BmTV649i.js";import"./custom-elements-manifest-CcHPuk5a.js";const Z=A`
  :host {
    display: block;
  }
...
`;var ee=Object.defineProperty,te=Object.getOwnPropertyDescriptor,i=(e,t,o,s)=>{for(var n=s>1?void 0:s?te(t,o):t,p=e.length-1,c;p>=0;p--)(c=e[p])&&(n=(s?c(t,o,n):c(n))||n);return s&&n&&ee(t,o,n),n};let r=class extends H{constructor(){super(...arguments),this.formControlController=new L(this,{assumeInteractionOn:["syn-change"],value:e=>e.files}),this.hasSlotController=new O(this,"help-text","label"),this.localize=new q(this),this.userIsDragging=!1,this.name="",this.defaultValue="",this.size="medium",this.label="",this.helpText="",this.disabled=!1,this.droparea=!1,this.accept="",this.multiple=!1,this.webkitdirectory=!1,this.form="",this.required=!1,this.hideValue=!1}set files(e){this.input&&(this.input.files=e)}get files(){return this.input?.files}set value(e){this.input&&(this.input.value=e)}get value(){return this.input?.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(e){if(this.droparea){this.dropareaWrapper?.focus(e);return}this.button?.focus(e)}blur(){if(this.droparea){this.dropareaWrapper?.blur();return}this.button?.blur()}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleFiles(e){if(!e){this.value="";return}this.files=e}async handleTransferItems(e){if(!e)return this.value="",new Promise((c,E)=>{E(new Error("No proper items found"))});const o=Array.from(e).map(c=>c.webkitGetAsEntry()).map(c=>this.getFilesFromEntry(c)),n=(await Promise.all(o)).flat(),p=new DataTransfer;return Array.from(n).forEach(c=>p.items.add(c)),p.files}async getFilesFromEntry(e){return e?e.isFile?new Promise((t,o)=>{e.file(s=>t([s]),o)}):e.isDirectory?new Promise((t,o)=>{e.createReader().readEntries(n=>{Promise.all(n.map(p=>this.getFilesFromEntry(p))).then(p=>{t(p.flat())}).catch(o)})}):[]:[]}handleClick(e){e.preventDefault(),this.input.click()}handleChange(e){e.preventDefault(),e.stopPropagation(),this.emit("syn-input"),this.emit("syn-change")}handleDragOver(e){e.preventDefault(),e.stopPropagation(),this.userIsDragging=!0}handleDragLeave(e){e.preventDefault(),e.stopPropagation(),this.userIsDragging=!1}async handleDrop(e){if(e.preventDefault(),e.stopPropagation(),!e.dataTransfer)return;const t=await this.handleTransferItems(e.dataTransfer?.items);if(this.userIsDragging=!1,!t)return;if(!this.multiple&&!this.webkitdirectory&&t.length>1){this.emit("syn-error");return}if(this.hasSlotController.test("trigger"))this.handleFiles(t);else{const s=T(this.inputChosen,"file.text.disappear",{dir:this.localize.dir()}),n=T(this.inputChosen,"file.text.appear",{dir:this.localize.dir()});if(this.droparea){const p=T(this.dropareaIcon,"file.iconDrop",{dir:this.localize.dir()});C(this.dropareaIcon,p.keyframes,p.options)}await C(this.inputChosen,s.keyframes,s.options),this.handleFiles(t),await C(this.inputChosen,n.keyframes,n.options)}this.input.dispatchEvent(new Event("change"))}handleFocus(){this.emit("syn-focus")}handleBlur(){this.emit("syn-blur")}renderValue(){let e=!1,t=this.localize.term("numFilesSelected",0,this.webkitdirectory);return this.files&&this.files?.length>0&&(e=!0,t=this.files.length===1?this.files[0].name:this.localize.term("numFilesSelected",this.files.length,this.webkitdirectory)),a`
    ...
    `}renderButton(){let e=this.localize.term("fileButtonText");return this.multiple&&(e=this.localize.term("fileButtonTextMultiple")),this.webkitdirectory&&(e=this.localize.term("folderButtonText")),a`
      <div
    ...
    `}render(){const e=this.label||!!this.hasSlotController.test("label"),t=this.helpText?!0:!!this.hasSlotController.test("help-text"),o=!!this.hasSlotController.test("trigger");return a`
      <div
        class=${z({"form-control":!0,"form-control--droparea":this.droparea,"form-control--has-help-text":t,"form-control--has-label":e,"form-control--large":this.size==="large","form-control--medium":this.size==="medium","form-control--small":this.size==="small","form-control--user-dragging":this.userIsDragging})}
    ...
    `}};r.styles=[M,j,R,Z];r.dependencies={"syn-button":U,"syn-icon":W};i([I()],r.prototype,"userIsDragging",2);i([l({type:Object})],r.prototype,"files",1);i([l({type:String})],r.prototype,"name",2);i([l({type:String})],r.prototype,"value",1);i([B()],r.prototype,"defaultValue",2);i([l({reflect:!0})],r.prototype,"size",2);i([l()],r.prototype,"label",2);i([l({attribute:"help-text"})],r.prototype,"helpText",2);i([l({reflect:!0,type:Boolean})],r.prototype,"disabled",2);i([l({type:Boolean})],r.prototype,"droparea",2);i([l({type:String})],r.prototype,"accept",2);i([l({type:String})],r.prototype,"capture",2);i([l({reflect:!0,type:Boolean})],r.prototype,"multiple",2);i([l({reflect:!0,type:Boolean})],r.prototype,"webkitdirectory",2);i([l({reflect:!0})],r.prototype,"form",2);i([l({reflect:!0,type:Boolean})],r.prototype,"required",2);i([l({attribute:"hide-value",type:Boolean})],r.prototype,"hideValue",2);i([_(".input__control")],r.prototype,"input",2);i([_(".button")],r.prototype,"button",2);i([_(".droparea")],r.prototype,"dropareaWrapper",2);i([_(".droparea__icon")],r.prototype,"dropareaIcon",2);i([_(".input__value")],r.prototype,"inputChosen",2);i([F("disabled",{waitUntilFirstUpdate:!0})],r.prototype,"handleDisabledChange",1);i([F("value",{waitUntilFirstUpdate:!0})],r.prototype,"handleValueChange",1);r=i([Y("SynFile")],r);k("file.iconDrop",{keyframes:[{scale:1},{scale:.7},{scale:1}],options:{duration:600,easing:"ease-out"}});k("file.text.disappear",{keyframes:[{opacity:1},{opacity:0,transform:"translateY(-40%)"}],options:{duration:300,easing:"cubic-bezier(0.45, 1.45, 0.8, 1)"}});k("file.text.appear",{keyframes:[{opacity:0,transform:"translateY(40%)"},{opacity:1}],options:{duration:300,easing:"cubic-bezier(0.45, 1.45, 0.8, 1)"}});r.define("syn-file");var $=Object.freeze,re=Object.defineProperty,ie=(e,t)=>$(re(e,"raw",{value:$(e.slice())})),V;const{args:ae,argTypes:se}=J("syn-file"),{overrideArgs:le}=K("syn-file"),{generateTemplate:oe}=Q("syn-file"),Oe={args:le([],ae),argTypes:se,component:"syn-file",parameters:{design:N("21709-49135"),docs:{description:{component:d("file","default")}}},title:"Components/syn-file"},u={parameters:{controls:{disable:!1},docs:{description:{story:d("file","default")}}},render:e=>oe({args:e})},y={parameters:{docs:{description:{story:d("file","label")}}},render:()=>a`
    <syn-file label="This is a label"></syn-file>
  `},f={parameters:{docs:{description:{story:d("file","help-text")}}},render:()=>a`
    <syn-file
      help-text="This is a help text."
      label="This is a label"
    ></syn-file>
  `},m={parameters:{docs:{description:{story:d("file","multiple")}}},render:()=>a`
    <syn-file
      label="Multiple file input"
      multiple
    ></syn-file>
  `},h={parameters:{docs:{description:{story:d("file","hide-value")}}},render:()=>a`
    <syn-file
      hide-value
      label="This is a label"
    ></syn-file>
  `},D={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:d("file","focus")}}},play:({canvasElement:e})=>{const t=e.querySelector("syn-file");t&&t.focus()},render:()=>a`
    <syn-file label="This is a label" help-text="This is a help text" droparea></syn-file>
  `},g={parameters:{docs:{description:{story:d("file","disabled")}}},render:()=>a`
...
`},b={parameters:{docs:{description:{story:d("file","sizes")}}},render:()=>a`
  ...
  `},v={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:d("file","invalid")}}},play:async({canvasElement:e})=>{try{const t=e.querySelector("form"),o=t.querySelectorAll("syn-file"),s=t.querySelector("syn-button");s&&o&&(await G.click(s),s.click())}catch(t){console.error("Error in play function:",t)}},render:()=>a(V||(V=ie([`
  ...
  `])))},x={parameters:{docs:{description:{story:d("file","droparea")}}},render:()=>a`
    <div style="display: flex; flex-direction: column; gap: var(--syn-spacing-large);">
      <syn-file
  ...
  `},S={parameters:{docs:{description:{story:d("file","directory")}}},render:()=>a`
    <div style="display: flex; flex-direction: column; gap: var(--syn-spacing-large);">
      <syn-file
        label="Button"
        webkitdirectory
  ...
  `},w=X({Default:u,Label:y,HelpText:f,Multiple:m,HideValue:h,Disabled:g,Sizes:b,Invalid:v,Droparea:x,Directory:S},750);u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
...
} as Story`,...u.parameters?.docs?.source}}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
  ...
  render: () => html\`
    <syn-file label="This is a label"></syn-file>
  \`
} as Story`,...y.parameters?.docs?.source}}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
  ...
  render: () => html\`
    ...
    ></syn-file>
  \`
} as Story`,...m.parameters?.docs?.source}}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
  ...
  render: () => html\`
    ...
    ></syn-file>
  \`
} as Story`,...h.parameters?.docs?.source}}};D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  parameters: {
    chromatic: {
  ...
  render: () => html\`
    <syn-file label="This is a label" help-text="This is a help text" droparea></syn-file>
  \`
} as Story`,...D.parameters?.docs?.source}}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
\`
  ...
  \`
} as Story`,...v.parameters?.docs?.source}}};x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
  ...
  \`
} as Story`,...x.parameters?.docs?.source}}};S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
  ...
  \`
} as Story`,...S.parameters?.docs?.source}}};w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`generateScreenshotStory({
  Default,
  Label,
  HelpText,
  Multiple,
  ...
  Droparea,
  Directory
}, 750)`,...w.parameters?.docs?.source}}};const Me=["Default","Label","HelpText","Multiple","HideValue","Focus","Disabled","Sizes","Invalid","Droparea","Directory","Screenshot"];export{u as Default,S as Directory,g as Disabled,x as Droparea,D as Focus,f as HelpText,h as HideValue,v as Invalid,y as Label,m as Multiple,w as Screenshot,b as Sizes,Me as __namedExportsOrder,Oe as default};
