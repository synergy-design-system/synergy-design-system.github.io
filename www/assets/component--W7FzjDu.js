var sn=Object.freeze,ci=Object.defineProperty;var rn=(a,e)=>sn(ci(a,"raw",{value:sn(e||a.slice())}));import{R as f,d as En,k,t as te,b as u,a as b,e as pt,f as pi}from"./if-defined-BaykDp1D.js";import{i as h,k as p,D as $n,u as ln,R as hi}from"./directive-helpers-CDT6qhDs.js";import{h as On,$ as Dn,r as Nn,L as ui,F as mt,b as mi,o as fi,f as yi,c as bi,s as dn,d as gi,p as jt,e as vi,g as wi,a as In,k as xi,K as ki,j as _i,i as Ti,t as Ci}from"./ref-lLHsj5FH.js";import{s as Si}from"./chunk-L4EGOTBX-C9C4DwME.js";import"./entry-preview-D9TbQDUR.js";import{S as tt,d as cn,s as zi}from"./index-SK-fzUQf.js";import"./index-CleY8y_P.js";import{n as r,a as g}from"./library-BZPO0bHa.js";import{a as v,c as w,w as m,S as ue}from"./icon.component-CNnTmbSm.js";import"./icon-FgfOggb5.js";const Ei=h`
  :host {
    display: block;
  }
...
`;var $i=Object.defineProperty,Oi=Object.getOwnPropertyDescriptor,nt=(a,e,t,n)=>{for(var i=n>1?void 0:n?Oi(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&$i(e,t,i),i};class Ue extends v{constructor(){super(...arguments),this.closeOthers=!1,this.contained=!1,this.size="medium",this.handleAccordionShow=e=>{this.closeOthers&&this.detailsInDefaultSlot.forEach(t=>{t!==e.target&&t.parentNode===e.target.parentNode&&t.removeAttribute("open")})}}static{this.styles=[w,Ei]}adjustDetailsSize(){this.detailsInDefaultSlot.forEach(e=>{e.setAttribute("size",this.size)})}adjustDetailsContained(){this.detailsInDefaultSlot.forEach(e=>{e.contained=this.contained})}handleSizeChange(){this.adjustDetailsSize()}handleContainedChange(){this.adjustDetailsContained()}connectedCallback(){super.connectedCallback(),this.addEventListener("syn-show",this.handleAccordionShow)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("syn-show",this.handleAccordionShow)}handleSlotChange(){this.adjustDetailsSize(),this.adjustDetailsContained()}render(){return p`
      <div 
        part="base"
        class=${f({accordion:!0,"accordion--contained":this.contained})}>
        <slot @slotchange=${this.handleSlotChange}></slot>
      </div>
    `}}nt([On({selector:"syn-details"})],Ue.prototype,"detailsInDefaultSlot",2);nt([r({attribute:"close-others",type:Boolean})],Ue.prototype,"closeOthers",2);nt([r({reflect:!0,type:Boolean})],Ue.prototype,"contained",2);nt([r({reflect:!0})],Ue.prototype,"size",2);nt([m("size",{waitUntilFirstUpdate:!0})],Ue.prototype,"handleSizeChange",1);nt([m("contained",{waitUntilFirstUpdate:!0})],Ue.prototype,"handleContainedChange",1);Ue.define("syn-accordion");class Di extends Dn{host;element;prevData={};render(e){return $n}update(e,[t]){this.element!==e.element&&(this.element=e.element),this.host=e.options?.host||this.element,this.apply(t),this.groom(t),this.prevData={...t}}apply(e){if(!e)return;const{prevData:t,element:n}=this;for(const i in e){const o=e[i];o!==t[i]&&St(n,i,o)}}groom(e){const{prevData:t,element:n}=this;if(t)for(const i in t)(!e||!(i in e)&&n[i]===t[i])&&St(n,i,void 0)}}class Ni extends Di{eventData={};apply(e){if(e)for(const t in e){const n=e[t];n!==this.eventData[t]&&this.applyEvent(t,n)}}applyEvent(e,t){const{prevData:n,element:i}=this;this.eventData[e]=t,n[e]&&i.removeEventListener(e,this,t),i.addEventListener(e,this,t)}groom(e){const{prevData:t,element:n}=this;if(t)for(const i in t)(!e||!(i in e)&&n[i]===t[i])&&this.groomEvent(i,t[i])}groomEvent(e,t){const{element:n}=this;delete this.eventData[e],n.removeEventListener(e,this,t)}handleEvent(e){const t=this.eventData[e.type];typeof t=="function"?t.call(this.host,e):t.handleEvent(e)}disconnected(){const{eventData:e,element:t}=this;for(const n in e){const i=n.slice(1),o=e[n];t.removeEventListener(i,this,o)}}reconnected(){const{eventData:e,element:t}=this;for(const n in e){const i=n.slice(1),o=e[n];t.addEventListener(i,this,o)}}}class Ii extends Ni{apply(e){if(!e)return;const{prevData:t,element:n}=this;for(const i in e){const o=e[i];if(o===t[i])continue;const s=i.slice(1);switch(i[0]){case"@":this.eventData[s]=o,this.applyEvent(s,o);break;case".":St(n,s,o);break;case"?":o?n.setAttribute(s,""):n.removeAttribute(s);break;default:o?n.setAttribute(i,String(o)):n.removeAttribute(i);break}}}groom(e){const{prevData:t,element:n}=this;if(t)for(const i in t){const o=i.slice(1);if(!e||!(i in e)&&n[o]===t[i])switch(i[0]){case"@":this.groomEvent(o,t[i]);break;case".":St(n,o,void 0);break;case"?":n.removeAttribute(o);break;default:n.removeAttribute(i);break}}}}function St(a,e,t){try{a[e]=t}catch{console.warn(`Could not set property "${e}" on ${a.tagName} because it has no "setter".`)}}const Ai=En(Ii);let et={};setTimeout(()=>{et=globalThis?.__WC_STORYBOOK_HELPERS_CONFIG__||{}});function An(a,e){return e.modules?.find(n=>n.declarations?.some(i=>i.tagName===a))?.declarations.find(n=>n.kind==="class"&&n.tagName===a)}function qt(a,e=!0){const t={};return a?.members?.forEach(n=>{if(n.kind!=="field")return;const i=a.attributes?.find(_=>n.name===_.fieldName),o=n.name;if(t[o]={name:o,table:{disable:!0}},n.privacy==="private"||n.privacy==="protected"||n.static)return;const s=i?.name||n.name,l=et.typeRef&&n[`${et.typeRef}`]?.text||n?.type?.text,d=Ln(l),c=ft(n.default);t[s]={name:s,description:Xt(n.description,o,n.deprecated),defaultValue:c==="''"?"":c,control:e?{type:Mn(d,i!==void 0)}:!1,table:{category:i?"attributes":"properties",defaultValue:{summary:c},type:{summary:l}}};const y=d?.split("|");y&&y?.length>1&&(t[s].options=y.map(_=>ft(_)))}),t}function Pi(a,e=!0){const t={};return a?.members?.forEach(n=>{if(n.kind!=="field"||(t[n.name]={name:n.name,table:{disable:!0}},n.privacy==="private"||n.privacy==="protected"||n.static))return;const i=et.typeRef&&n[`${et.typeRef}`]?.text||n?.type?.text,o=Ln(i),s=`${n.name}`,l=Mn(o);t[s]={name:n.name,description:n.description,defaultValue:Li(l,n.default),control:e?{type:l}:!1,table:{category:"properties",defaultValue:{summary:ft(n.default)},type:{summary:i}}};const d=o?.split("|");d&&d?.length>1&&(t[s].options=d.map(c=>ft(c)))}),delete t.ref,t}function Pn(a){const e={};return a?.events?.forEach(t=>{const n=Fi(t.name);e[n]={name:n,description:t.description,control:!1,table:{category:"events"}}}),e}function Kt(a,e=!0){const t={};return a?.cssProperties?.forEach(n=>{t[n.name]={name:n.name,description:n.description,defaultValue:n.default,control:e?{type:n.name.toLowerCase().includes("color")?"color":"text"}:!1,table:{category:"css properties"}}}),t}function Gt(a,e=!0){const t={};return a?.cssParts?.forEach(n=>{t[n.name]={name:n.name,table:{disable:!0}},t[`${n.name}-part`]={name:n.name,description:Xt(n.description,e?`${n.name}-part`:""),defaultValue:`${a?.tagName}::part(${n.name}) {
}`,control:e?"text":!1,table:{category:"css shadow parts"}}}),t}function Yt(a,e=!0){const t={};return a?.slots?.forEach(n=>{t[n.name]={name:n.name,table:{disable:!0}};const i=n.name||"default";t[`${i}-slot`]={control:"text",name:i,description:Xt(n.description,`${i}-slot`),defaultValue:i==="default"?"":`<span slot="${i}"></span>`,control:e?"text":!1,table:{category:"slots"}}}),t}function Mi(a){const e={};return a?.events?.forEach(t=>{e[t.name]={name:t.name,description:t.description,control:!1,table:{category:"events",type:{summary:`CustomEvent${t.type?`<${t.type.text}>`:""}`}}}}),e}function Li(a,e){const t=ft(e);return a==="boolean"?t==="true":t==="''"?"":t}function Mn(a,e=!1){if(!a)return"text";const t=a.toLowerCase(),n=t.split("|").map(i=>i.trim()).filter(i=>i!==""&&i!=="null"&&i!=="undefined");return ji(t)&&!e?"object":_t(n,"boolean")?"boolean":_t(n,"number")&&!_t(n,"string")&&n.every(i=>!i.includes("'"))?"number":_t(n,"date")?"date":n.length>1&&n.every(i=>i.includes("'"))?"select":"text"}function ji(a){return a.includes("array")||a.includes("object")||a.includes("{")||a.includes("[")||a.includes("<")}function _t(a=[],e){return a?.find(t=>t===e)!==void 0}function Ln(a){return a?a.replace(" | undefined","").replace(" | null",""):""}function ft(a){return a?.trim().replace(/^["'](.+(?=["']$))["']$/,"$1")}function Xt(a,e,t){let n="";return t&&(n+=`\`@deprecated\` ${t}`),a&&(n+=n?`


`:"",n+=a),et.hideArgRef||!e?n:n+=`


arg ref - \`${e}\``}const Fi=a=>`on${Hi(Vi(a))}`;function Vi(a=""){return a.split("-").map((n,i)=>i?n.charAt(0).toUpperCase()+n.slice(1).toLowerCase():n.toLowerCase()).join("")}function Hi(a){return a.charAt(0).toUpperCase()+a.slice(1)}const{useArgs:Bi}=__STORYBOOK_MODULE_PREVIEW_API__;let zt,pn,Qt={};setTimeout(()=>{Qt=globalThis?.__WC_STORYBOOK_HELPERS_CONFIG__||{}});var zn;function Ri(a,e,t,n){if(!e)return k`<${te(a.tagName)}></${te(a.tagName)}>`;a?.tagName!==pn&&(zt=void 0,pn=a?.tagName);const{attrOperators:i,additionalAttrs:o}=Wi(a,e,n),s={...i,...o},l=Ki(a,e),d=Ui(a,e);return Gi(a),k`${jn(a,e)}
<${te(a.tagName)} 
  ${Ai(s)}
  ${d}
  >
...
${Qt.hideScriptTag?"":k(zn||(zn=rn([`<script>
  window.component = document.querySelector("`,`");
<\/script>`])),a.tagName)}
`}function jn(a,e){const t=qi(a,e);return`${t}`?.replaceAll(/\s+/g,"")!=""?k`<style>${t}</style>`:""}function Wi(a,e,t){const n=qt(a),i={},o={},s={};return Object.keys(n).forEach(l=>{const d=n[l];if(d?.table?.category!=="attributes")return;const c=d.name,y=e[l],_=d.control.type==="boolean"?`?${c}`:c;(y!==n[l].defaultValue||Qt.renderDefaultAttributeValues)&&(i[_]=y==="false"?!1:y)}),Object.keys(e).filter(l=>n[l]?.table?.category==="properties").forEach(l=>{if(l.startsWith("on"))return;const d=e[l];o[`.${l}`]=d}),Object.keys(e).filter(l=>!Object.keys(t||{}).includes(l)).forEach(l=>{!l.startsWith("on")&&typeof e[l]!="function"&&(s[l]=e[l])}),{attrOperators:i,propOperators:o,additionalAttrs:s}}function Ui(a,e){if(!a?.cssProperties?.length)return;const t=Kt(a);return te(`style="${Object.keys(t).map(n=>{const i=t[n].name,o=e[n];return o?`${i}: ${o||""}`:null}).filter(n=>n!==null).join(";")}"`)}function qi(a,e){const t=Gt(a);if(!Object.keys(t).some(o=>!!e[o]))return;const i=Object.keys(t).filter(o=>o.endsWith("-part")).map(o=>{const s=t[o].name,l=e[o];return l?.replaceAll(/\s+/g,"")!==`${a?.tagName}::part(${s}){}`?`
${l}`:null}).filter(o=>o!==null).join(`
`);return i?te(`${i}
`):""}function Ki(a,e){const t=Yt(a);return te(`${Object.keys(t).filter(i=>i.endsWith("-slot")).map(i=>{const o=t[i].name,s=e[i];return o==="default"?s||null:s!==`<span slot="${o}"></span>`?s:null}).filter(i=>i!==null).join("")}`)}function Gi(a){Yi(a),setTimeout(()=>{const e=document.querySelector(a.tagName);zt?.observe(e,{attributes:!0})})}function Yi(a){let e=!1;const t=Bi()[1],n=qt(a);zt||(zt=new MutationObserver(i=>{i.forEach(o=>{if(o.type!=="attributes"||o.attributeName==="class"&&e)return;e=!0;const s=n[`${o.attributeName}`];s?.control==="boolean"||s?.control?.type==="boolean"?t({[`${o.attributeName}`]:o.target?.hasAttribute(o.attributeName||"")}):t({[`${o.attributeName}`]:o.target.getAttribute(o.attributeName||"")}),e=!1})}))}function Xi(a){window.__WC_STORYBOOK_HELPERS_CONFIG__=a}function Fn(a){const e=window.__STORYBOOK_CUSTOM_ELEMENTS_MANIFEST__;if(!e)throw new Error(`Custom Elements Manifest not found. Be sure to follow the pre-install steps in this guide:
https://www.npmjs.com/package/wc-storybook-helpers#before-you-install`);const t=An(a,e),n=t?.events?.map(o=>o.name)||[],i=Vn(t);return{args:Hn(t),argTypes:i,reactArgs:Ji(t),reactArgTypes:Bn(t),events:n,styleTemplate:o=>jn(t,o),template:(o,s)=>Ri(t,o,s,i)}}function Vn(a){return{...Kt(a),...Gt(a),...Yt(a),...qt(a),...Mi(a)}}function Hn(a,e){return e||(e=Vn(a)),Object.entries(e).filter(([,n])=>n?.control).map(([n,i])=>{let o=Qi(i.defaultValue);return i.table?.category==="css properties"&&(o=o?.toString()),{[n]:o===void 0?"":o}}).reduce((n,i)=>({...n,...i}),{})}function Qi(a){try{return JSON.parse(a)}catch{return a}}function Bn(a){return{...Pi(a),...Pn(a),...Kt(a,!1),...Gt(a,!1),...Yt(a,!1)}}function Ji(a){const e=Hn(a,Bn(a)),t=Object.entries(Pn(a)).map(([n])=>({[n]:()=>{}})).reduce((n,i)=>({...n,...i}),{});return{...e,...t}}const{useParameter:Zi,addons:ea,useEffect:ta,useMemo:Qr}=__STORYBOOK_MODULE_PREVIEW_API__;var na=Object.defineProperty,ia=(a,e)=>{for(var t in e)na(a,t,{get:e[t],enumerable:!0})},aa={};ia(aa,{initializeThemeState:()=>qn,pluckThemeFromContext:()=>Wn,useThemeParameters:()=>Un});var Rn="themes",oa=`storybook/${Rn}`,sa="theme",ra={},la={REGISTER_THEMES:`${oa}/REGISTER_THEMES`};function Wn({globals:a}){return a[sa]||""}function Un(){return Zi(Rn,ra)}function qn(a,e){ea.getChannel().emit(la.REGISTER_THEMES,{defaultTheme:e,themes:a})}var da="html",hn=a=>a.split(" ").filter(Boolean),ca=({themes:a,defaultTheme:e,parentSelector:t=da})=>(qn(Object.keys(a),e),(n,i)=>{let{themeOverride:o}=Un(),s=Wn(i);return ta(()=>{let l=o||s||e,d=document.querySelector(t);if(!d)return;Object.entries(a).filter(([y])=>y!==l).forEach(([y,_])=>{let K=hn(_);K.length>0&&d.classList.remove(...K)});let c=hn(a[l]);c.length>0&&d.classList.add(...c)},[o,s]),n()}),pa={mobile1:{name:"Small mobile",styles:{height:"568px",width:"320px"},type:"mobile"},mobile2:{name:"Large mobile",styles:{height:"896px",width:"414px"},type:"mobile"},tablet:{name:"Tablet",styles:{height:"1112px",width:"834px"},type:"tablet"}};function F(a,e,t){return new Promise(n=>{if(t?.duration===1/0)throw new Error("Promise-based animations must be finite.");const i=a.animate(e,{...t,duration:ha()?0:t.duration});i.addEventListener("cancel",n,{once:!0}),i.addEventListener("finish",n,{once:!0})})}function un(a){return a=a.toString().toLowerCase(),a.indexOf("ms")>-1?parseFloat(a):a.indexOf("s")>-1?parseFloat(a)*1e3:parseFloat(a)}function ha(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function q(a){return Promise.all(a.getAnimations().map(e=>new Promise(t=>{e.cancel(),requestAnimationFrame(t)})))}function mn(a,e){return a.map(t=>({...t,height:t.height==="auto"?`${e}px`:t.height}))}const Kn=new Map,Ht=new WeakMap;function Gn(a){return a??{keyframes:[],options:{duration:0}}}function fn(a,e){return e.toLowerCase()==="rtl"?{keyframes:a.rtlKeyframes||a.keyframes,options:a.options}:a}function T(a,e){Kn.set(a,Gn(e))}function Tt(a,e,t){Ht.set(a,{...Ht.get(a),[e]:Gn(t)})}function I(a,e,t){const n=Ht.get(a);if(n?.[e])return fn(n[e],t.dir);const i=Kn.get(e);return i?fn(i,t.dir):{keyframes:[],options:{duration:0}}}class U{constructor(e,...t){this.slotNames=[],this.handleSlotChange=n=>{const i=n.target;(this.slotNames.includes("[default]")&&!i.name||i.name&&this.slotNames.includes(i.name))&&this.host.requestUpdate()},(this.host=e).addController(this),this.slotNames=t}hasDefaultSlot(){return[...this.host.childNodes].some(e=>{if(e.nodeType===e.TEXT_NODE&&e.textContent.trim()!=="")return!0;if(e.nodeType===e.ELEMENT_NODE){const t=e;if(t.tagName.toLowerCase()==="syn-visually-hidden")return!1;if(!t.hasAttribute("slot"))return!0}return!1})}hasNamedSlot(e){return this.host.querySelector(`:scope > [slot="${e}"]`)!==null}test(e){return e==="[default]"?this.hasDefaultSlot():this.hasNamedSlot(e)}hostConnected(){this.host.shadowRoot.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener("slotchange",this.handleSlotChange)}}function Yn(a){if(!a)return"";const e=a.assignedNodes({flatten:!0});let t="";return[...e].forEach(n=>{n.nodeType===Node.TEXT_NODE&&(t+=n.textContent)}),t}const Xn={$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(a,e)=>`Go to slide ${a} of ${e}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:a=>a===0?"No options selected":a===1?"1 option selected":`${a} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:a=>`Slide ${a}`,toggleColorFormat:"Toggle color format",closeMenu:"Close menu",danger:"Danger",fileButtonText:"Choose file",fileButtonTextMultiple:"Choose files",folderButtonText:"Choose folder",fileDragDrop:"Drop or choose file",folderDragDrop:"Drop or choose folder",menu:"Menu",notification:"Notification",numFilesSelected:(a,e)=>a===0?`No ${e?"folder":"files"} chosen`:`${a} files`,openMenu:"Open menu",rangeMax:"Maximum",rangeMin:"Minimum",sideNav:"Side navigation",success:"Success",warning:"Warning"};Nn(Xn);class j extends ui{static{Nn(Xn)}}function W(a,e){return new Promise(t=>{function n(i){i.target===a&&(a.removeEventListener(e,n),t())}a.addEventListener(e,n)})}const ua=h`
	/* stylelint-disable */
  :host {
    display: contents;
...
`;var fa=Object.defineProperty,ya=Object.getOwnPropertyDescriptor,Se=(a,e,t,n)=>{for(var i=n>1?void 0:n?ya(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&fa(e,t,i),i};const Qe=Object.assign(document.createElement("div"),{className:"syn-toast-stack"});class be extends v{constructor(){super(...arguments),this.hasSlotController=new U(this,"icon","suffix"),this.localize=new j(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.remainingTime=this.duration}static{this.styles=[w,ua,ma]}static{this.dependencies={"syn-icon-button":tt}}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){this.countdownAnimation?.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),this.countdownAnimation?.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){const{countdownElement:e}=this,t="100%",n="0";this.countdownAnimation=e.animate([{width:t},{width:n}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.duration<1/0&&this.restartAutoHide(),await q(this.base),this.base.hidden=!1;const{keyframes:e,options:t}=I(this,"alert.show",{dir:this.localize.dir()});await F(this.base,e,t),this.emit("syn-after-show")}else{this.emit("syn-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await q(this.base);const{keyframes:e,options:t}=I(this,"alert.hide",{dir:this.localize.dir()});await F(this.base,e,t),this.base.hidden=!0,this.emit("syn-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,W(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,W(this,"syn-after-hide")}async toast(){return new Promise(e=>{this.handleCountdownChange(),Qe.parentElement===null&&document.body.append(Qe),Qe.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("syn-after-hide",()=>{Qe.removeChild(this),e(),Qe.querySelector("syn-alert")===null&&Qe.remove()},{once:!0})})}render(){return p`
    ...
    `}}Se([u('[part~="base"]')],be.prototype,"base",2);Se([u(".alert__countdown-elapsed")],be.prototype,"countdownElement",2);Se([r({type:Boolean,reflect:!0})],be.prototype,"open",2);Se([r({type:Boolean,reflect:!0})],be.prototype,"closable",2);Se([r({reflect:!0})],be.prototype,"variant",2);Se([r({type:Number})],be.prototype,"duration",2);Se([g()],be.prototype,"remainingTime",2);Se([m("open",{waitUntilFirstUpdate:!0})],be.prototype,"handleOpenChange",1);Se([m("duration")],be.prototype,"handleDurationChange",1);T("alert.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});T("alert.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});be.define("syn-alert");const ba=h`
	/* stylelint-disable */
  :host {
    display: inline-flex;
  }
...
`;var va=Object.defineProperty,wa=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&va(e,t,i),i};class Qn extends v{constructor(){super(...arguments),this.localize=new j(this),this.variant="primary"}static{this.styles=[w,ba,ga]}render(){return p`
      <span
        part="base"
    ...
    `}}wa([r({reflect:!0})],Qn.prototype,"variant");Qn.define("syn-badge");const xa=h`
	/* stylelint-disable */
  :host {
    display: inline-flex;
  }
...
`;var _a=Object.defineProperty,Ta=Object.getOwnPropertyDescriptor,it=(a,e,t,n)=>{for(var i=n>1?void 0:n?Ta(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&_a(e,t,i),i};class qe extends v{constructor(){super(...arguments),this.hasSlotController=new U(this,"prefix","suffix"),this.renderType="button",this.rel="noreferrer noopener"}static{this.styles=[w,xa,ka]}setRenderType(){const e=this.defaultSlot.assignedElements({flatten:!0}).filter(t=>t.tagName.toLowerCase()==="syn-dropdown").length>0;if(this.href){this.renderType="link";return}if(e){this.renderType="dropdown";return}this.renderType="button"}hrefChanged(){this.setRenderType()}handleSlotChange(){this.setRenderType()}render(){return p`
      <div
        part="base"
    ...
    `}}it([u("slot:not([name])")],qe.prototype,"defaultSlot",2);it([g()],qe.prototype,"renderType",2);it([r()],qe.prototype,"href",2);it([r()],qe.prototype,"target",2);it([r()],qe.prototype,"rel",2);it([m("href",{waitUntilFirstUpdate:!0})],qe.prototype,"hrefChanged",1);qe.define("syn-breadcrumb-item");const Ca=h`
	/* stylelint-disable */
  .breadcrumb {
    display: flex;
    align-items: center;
...
`;var za=Object.defineProperty,Jt=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&za(e,t,i),i};class Ot extends v{constructor(){super(...arguments),this.localize=new j(this),this.separatorDir=this.localize.dir(),this.label=""}static{this.styles=[w,Ca,Sa]}static{this.dependencies={"syn-icon":ue}}getSeparator(){const t=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[t,...t.querySelectorAll("[id]")].forEach(n=>n.removeAttribute("id")),t.setAttribute("data-default",""),t.slot="separator",t}handleSlotChange(){const e=[...this.defaultSlot.assignedElements({flatten:!0})].filter(t=>t.tagName.toLowerCase()==="syn-breadcrumb-item");e.forEach((t,n)=>{const i=t.querySelector('[slot="separator"]');i===null?t.append(this.getSeparator()):i.hasAttribute("data-default")&&i.replaceWith(this.getSeparator()),n===e.length-1?t.setAttribute("aria-current","page"):t.removeAttribute("aria-current")})}render(){return this.separatorDir!==this.localize.dir()&&(this.separatorDir=this.localize.dir(),this.updateComplete.then(()=>this.handleSlotChange())),p`
    ...
    `}}Jt([u("slot")],Ot.prototype,"defaultSlot");Jt([u('slot[name="separator"]')],Ot.prototype,"separatorSlot");Jt([r()],Ot.prototype,"label");Ot.define("syn-breadcrumb");const Ea=h`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
`;var $a=Object.defineProperty,Zt=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&$a(e,t,i),i};class yt extends v{constructor(){super(...arguments),this.disableRole=!1,this.label=""}static{this.styles=[w,Ea]}handleFocus(e){ot(e.target)?.toggleAttribute("data-syn-button-group__button--focus",!0)}handleBlur(e){ot(e.target)?.toggleAttribute("data-syn-button-group__button--focus",!1)}handleMouseOver(e){ot(e.target)?.toggleAttribute("data-syn-button-group__button--hover",!0)}handleMouseOut(e){ot(e.target)?.toggleAttribute("data-syn-button-group__button--hover",!1)}handleSlotChange(){const e=[...this.defaultSlot.assignedElements({flatten:!0})];e.forEach(t=>{const n=e.indexOf(t),i=ot(t);i&&(i.toggleAttribute("data-syn-button-group__button",!0),i.toggleAttribute("data-syn-button-group__button--first",n===0),i.toggleAttribute("data-syn-button-group__button--inner",n>0&&n<e.length-1),i.toggleAttribute("data-syn-button-group__button--last",n===e.length-1),i.toggleAttribute("data-syn-button-group__button--radio",i.tagName.toLowerCase()==="syn-radio-button"))})}render(){return p`
      <div
        part="base"
        class="button-group"
...
`;class en extends v{constructor(){super(...arguments),this.localize=new j(this)}static{this.styles=[w,Da,Na]}render(){return p`
...
`;var ja=Object.defineProperty,Fa=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&ja(e,t,i),i};class ei extends v{constructor(){super(...arguments),this.hasSlotController=new U(this,"footer","header","image"),this.sharp=!1}static{this.styles=[w,Ma,La]}render(){return p`
      <div
        part="base"
    ...
    `}}Fa([r({type:Boolean,reflect:!0})],ei.prototype,"sharp");ei.define("syn-card");const Ke=(a="value")=>(e,t)=>{const n=e.constructor,i=n.prototype.attributeChangedCallback;n.prototype.attributeChangedCallback=function(o,s,l){const d=n.getPropertyOptions(a),c=typeof d.attribute=="string"?d.attribute:a;if(o===c){const y=d.converter||ln,K=(typeof y=="function"?y:y?.fromAttribute??ln.fromAttribute)(l,d.type);this[a]!==K&&(this[t]=K)}i.call(this,o,s,l)}},ze=h`
	/* stylelint-disable */
...
`;var Ba=Object.defineProperty,Ra=Object.getOwnPropertyDescriptor,ie=(a,e,t,n)=>{for(var i=n>1?void 0:n?Ra(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Ba(e,t,i),i};class Q extends v{constructor(){super(...arguments),this.formControlController=new xe(this,{value:e=>e.checked?e.value||"on":void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=t}),this.hasSlotController=new U(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.indeterminate=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}static{this.styles=[w,ze,Va,Ee,Ha]}static{this.dependencies={"syn-icon":ue}}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleClick(){this.checked=!this.checked,this.indeterminate=!1,this.emit("syn-change")}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleInput(){this.emit("syn-input")}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStateChange(){this.input.checked=this.checked,this.input.indeterminate=this.indeterminate,this.formControlController.updateValidity()}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("help-text"),t=this.helpText?!0:!!e;return p`
    ...
    `}}ie([u('input[type="checkbox"]')],Q.prototype,"input",2);ie([g()],Q.prototype,"hasFocus",2);ie([r()],Q.prototype,"title",2);ie([r()],Q.prototype,"name",2);ie([r()],Q.prototype,"value",2);ie([r({reflect:!0})],Q.prototype,"size",2);ie([r({type:Boolean,reflect:!0})],Q.prototype,"disabled",2);ie([r({type:Boolean,reflect:!0})],Q.prototype,"checked",2);ie([r({type:Boolean,reflect:!0})],Q.prototype,"indeterminate",2);ie([Ke("checked")],Q.prototype,"defaultChecked",2);ie([r({reflect:!0})],Q.prototype,"form",2);ie([r({type:Boolean,reflect:!0})],Q.prototype,"required",2);ie([r({attribute:"help-text"})],Q.prototype,"helpText",2);ie([m("disabled",{waitUntilFirstUpdate:!0})],Q.prototype,"handleDisabledChange",1);ie([m(["checked","indeterminate"],{waitUntilFirstUpdate:!0})],Q.prototype,"handleStateChange",1);Q.define("syn-checkbox");const Wa=h`
	/* stylelint-disable */
  :host {
...
`;var Ua=Object.defineProperty,B=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Ua(e,t,i),i};function qa(a){return a!==null&&typeof a=="object"&&"getBoundingClientRect"in a&&("contextElement"in a?a instanceof Element:!0)}class O extends v{constructor(){super(...arguments),this.localize=new j(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){const e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),n=this.placement.includes("top")||this.placement.includes("bottom");let i=0,o=0,s=0,l=0,d=0,c=0,y=0,_=0;n?e.top<t.top?(i=e.left,o=e.bottom,s=e.right,l=e.bottom,d=t.left,c=t.top,y=t.right,_=t.top):(i=t.left,o=t.bottom,s=t.right,l=t.bottom,d=e.left,c=e.top,y=e.right,_=e.top):e.left<t.left?(i=e.right,o=e.top,s=t.left,l=t.top,d=e.right,c=e.bottom,y=t.left,_=t.bottom):(i=t.right,o=t.top,s=e.left,l=e.top,d=t.right,c=t.bottom,y=e.left,_=e.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${i}px`),this.style.setProperty("--hover-bridge-top-left-y",`${o}px`),this.style.setProperty("--hover-bridge-top-right-x",`${s}px`),this.style.setProperty("--hover-bridge-top-right-y",`${l}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${d}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${c}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${y}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${_}px`)}}}static{this.styles=[w,Wa]}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has("active")&&(this.active?this.start():this.stop()),e.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){const e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchor instanceof Element||qa(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){!this.anchorEl||!this.active||(this.cleanup=mi(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>e())):e()})}reposition(){if(!this.active||!this.anchorEl)return;const e=[fi({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?e.push(dn({apply:({rects:n})=>{const i=this.sync==="width"||this.sync==="both",o=this.sync==="height"||this.sync==="both";this.popup.style.width=i?`${n.reference.width}px`:"",this.popup.style.height=o?`${n.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&e.push(yi({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&e.push(bi({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?e.push(dn({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:n,availableHeight:i})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${i}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${n}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&e.push(gi({element:this.arrowEl,padding:this.arrowPadding}));const t=this.strategy==="absolute"?n=>jt.getOffsetParent(n,vi):jt.getOffsetParent;wi(this.anchorEl,this.popup,{placement:this.placement,middleware:e,strategy:this.strategy,platform:{...jt,getOffsetParent:t}}).then(({x:n,y:i,middlewareData:o,placement:s})=>{const l=this.localize.dir()==="rtl",d={top:"bottom",right:"left",bottom:"top",left:"right"}[s.split("-")[0]];if(this.setAttribute("data-current-placement",s),Object.assign(this.popup.style,{left:`${n}px`,top:`${i}px`}),this.arrow){const c=o.arrow.x,y=o.arrow.y;let _="",K="",Be="",Ae="";if(this.arrowPlacement==="start"){const Xe=typeof c=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";_=typeof y=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",K=l?Xe:"",Ae=l?"":Xe}else if(this.arrowPlacement==="end"){const Xe=typeof c=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";K=l?"":Xe,Ae=l?Xe:"",Be=typeof y=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else this.arrowPlacement==="center"?(Ae=typeof c=="number"?"calc(50% - var(--arrow-size-diagonal))":"",_=typeof y=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(Ae=typeof c=="number"?`${c}px`:"",_=typeof y=="number"?`${y}px`:"");Object.assign(this.arrowEl.style,{top:_,right:K,bottom:Be,left:Ae,[d]:"calc(var(--arrow-size-diagonal) * -1)"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("syn-reposition")}render(){return p`
...
`;var ro=Object.defineProperty,lo=Object.getOwnPropertyDescriptor,ke=(a,e,t,n)=>{for(var i=n>1?void 0:n?lo(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&ro(e,t,i),i};class ge extends v{constructor(){super(...arguments),this.localize=new j(this),this.open=!1,this.disabled=!1,this.contained=!1,this.size="medium"}static{this.styles=[w,oo,so]}static{this.dependencies={"syn-icon":ue}}firstUpdated(){this.body.style.height=this.open?"auto":"0",this.open&&(this.details.open=!0),this.detailsObserver=new MutationObserver(e=>{for(const t of e)t.type==="attributes"&&t.attributeName==="open"&&(this.details.open?this.show():this.hide())}),this.detailsObserver.observe(this.details,{attributes:!0})}disconnectedCallback(){super.disconnectedCallback(),this.detailsObserver?.disconnect()}handleSummaryClick(e){e.preventDefault(),this.disabled||(this.open?this.hide():this.show(),this.header.focus())}handleSummaryKeyDown(e){(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.open?this.hide():this.show()),(e.key==="ArrowUp"||e.key==="ArrowLeft")&&(e.preventDefault(),this.hide()),(e.key==="ArrowDown"||e.key==="ArrowRight")&&(e.preventDefault(),this.show())}async handleOpenChange(){if(this.open){if(this.details.open=!0,this.emit("syn-show",{cancelable:!0}).defaultPrevented){this.open=!1,this.details.open=!1;return}await q(this.body);const{keyframes:t,options:n}=I(this,"details.show",{dir:this.localize.dir()});await F(this.body,mn(t,this.body.scrollHeight),n),this.body.style.height="auto",this.emit("syn-after-show")}else{if(this.emit("syn-hide",{cancelable:!0}).defaultPrevented){this.details.open=!0,this.open=!0;return}await q(this.body);const{keyframes:t,options:n}=I(this,"details.hide",{dir:this.localize.dir()});await F(this.body,mn(t,this.body.scrollHeight),n),this.body.style.height="auto",this.details.open=!1,this.emit("syn-after-hide")}}async show(){if(!(this.open||this.disabled))return this.open=!0,W(this,"syn-after-show")}async hide(){if(!(!this.open||this.disabled))return this.open=!1,W(this,"syn-after-hide")}render(){return p`
    ...
    `}}ke([u(".details")],ge.prototype,"details",2);ke([u(".details__header")],ge.prototype,"header",2);ke([u(".details__body")],ge.prototype,"body",2);ke([u(".details__expand-icon-slot")],ge.prototype,"expandIconSlot",2);ke([r({type:Boolean,reflect:!0})],ge.prototype,"open",2);ke([r()],ge.prototype,"summary",2);ke([r({type:Boolean,reflect:!0})],ge.prototype,"disabled",2);ke([r({type:Boolean,reflect:!0})],ge.prototype,"contained",2);ke([r({reflect:!0})],ge.prototype,"size",2);ke([m("open",{waitUntilFirstUpdate:!0})],ge.prototype,"handleOpenChange",1);T("details.show",{keyframes:[{height:"0",opacity:"0"},{height:"auto",opacity:"1"}],options:{duration:250,easing:"linear"}});T("details.hide",{keyframes:[{height:"auto",opacity:"1"},{height:"0",opacity:"0"}],options:{duration:250,easing:"linear"}});ge.define("syn-details");function*tn(a=document.activeElement){a!=null&&(yield a,"shadowRoot"in a&&a.shadowRoot&&a.shadowRoot.mode!=="closed"&&(yield*tn(a.shadowRoot.activeElement)))}function co(){return[...tn()].pop()}const gn=new WeakMap;function ti(a){let e=gn.get(a);return e||(e=window.getComputedStyle(a,null),gn.set(a,e)),e}function po(a){if(typeof a.checkVisibility=="function")return a.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});const e=ti(a);return e.visibility!=="hidden"&&e.display!=="none"}function ho(a){const e=ti(a),{overflowY:t,overflowX:n}=e;return t==="scroll"||n==="scroll"?!0:t!=="auto"||n!=="auto"?!1:a.scrollHeight>a.clientHeight&&t==="auto"||a.scrollWidth>a.clientWidth&&n==="auto"}function uo(a){const e=a.tagName.toLowerCase(),t=Number(a.getAttribute("tabindex"));return a.hasAttribute("tabindex")&&(isNaN(t)||t<=-1)||a.hasAttribute("disabled")||a.closest("[inert]")||e==="input"&&a.getAttribute("type")==="radio"&&!a.hasAttribute("checked")||!po(a)?!1:(e==="audio"||e==="video")&&a.hasAttribute("controls")||a.hasAttribute("tabindex")||a.hasAttribute("contenteditable")&&a.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(e)?!0:ho(a)}function mo(a){const e=Rt(a),t=e[0]??null,n=e[e.length-1]??null;return{start:t,end:n}}function fo(a,e){return a.getRootNode({composed:!0})?.host!==e}function Rt(a){const e=new WeakMap,t=[];function n(i){if(i instanceof Element){if(i.hasAttribute("inert")||i.closest("[inert]")||e.has(i))return;e.set(i,!0),!t.includes(i)&&uo(i)&&t.push(i),i instanceof HTMLSlotElement&&fo(i,a)&&i.assignedElements({flatten:!0}).forEach(o=>{n(o)}),i.shadowRoot!==null&&i.shadowRoot.mode==="open"&&n(i.shadowRoot)}for(const o of i.children)n(o)}return n(a),t.sort((i,o)=>{const s=Number(i.getAttribute("tabindex"))||0;return(Number(o.getAttribute("tabindex"))||0)-s})}let dt=[];class ni{constructor(e){this.tabDirection="forward",this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=t=>{if(t.key!=="Tab"||this.isExternalActivated||!this.isActive())return;const n=co();if(this.previousFocus=n,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;t.shiftKey?this.tabDirection="backward":this.tabDirection="forward";const i=Rt(this.element);let o=i.findIndex(l=>l===n);this.previousFocus=this.currentFocus;const s=this.tabDirection==="forward"?1:-1;for(;;){o+s>=i.length?o=0:o+s<0?o=i.length-1:o+=s,this.previousFocus=this.currentFocus;const l=i[o];if(this.tabDirection==="backward"&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||l&&this.possiblyHasTabbableChildren(l))return;t.preventDefault(),this.currentFocus=l,this.currentFocus?.focus({preventScroll:!1});const d=[...tn()];if(d.includes(this.currentFocus)||!d.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=e,this.elementsWithTabbableControls=["iframe"]}activate(){dt.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){dt=dt.filter(e=>e!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return dt[dt.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){const e=Rt(this.element);if(!this.element.matches(":focus-within")){const t=e[0],n=e[e.length-1],i=this.tabDirection==="forward"?t:n;typeof i?.focus=="function"&&(this.currentFocus=i,i.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(e){return this.elementsWithTabbableControls.includes(e.tagName.toLowerCase())||e.hasAttribute("controls")}}const yo=h`
	/* stylelint-disable */
  :host {
    --width: 31rem;
...
`;var go=Object.defineProperty,vo=Object.getOwnPropertyDescriptor,Ge=(a,e,t,n)=>{for(var i=n>1?void 0:n?vo(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&go(e,t,i),i};class Me extends v{constructor(){super(...arguments),this.hasSlotController=new U(this,"footer"),this.localize=new j(this),this.modal=new ni(this),this.open=!1,this.label="",this.noHeader=!1,this.handleDocumentKeyDown=e=>{e.key==="Escape"&&this.modal.isActive()&&this.open&&(e.stopPropagation(),this.requestClose("keyboard"))}}static{this.styles=[w,yo,bo]}static{this.dependencies={"syn-icon-button":tt}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),ht(this))}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate(),Ze(this),this.removeOpenListeners()}requestClose(e){if(this.emit("syn-request-close",{cancelable:!0,detail:{source:e}}).defaultPrevented){const n=I(this,"dialog.denyClose",{dir:this.localize.dir()});F(this.panel,n.keyframes,n.options);return}this.hide()}addOpenListeners(){"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard")):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){this.closeWatcher?.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),ht(this);const e=this.querySelector("[autofocus]");e&&e.removeAttribute("autofocus"),await Promise.all([q(this.dialog),q(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit("syn-initial-focus",{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute("autofocus","")});const t=I(this,"dialog.show",{dir:this.localize.dir()}),n=I(this,"dialog.overlay.show",{dir:this.localize.dir()});await Promise.all([F(this.panel,t.keyframes,t.options),F(this.overlay,n.keyframes,n.options)]),this.emit("syn-after-show")}else{this.emit("syn-hide"),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([q(this.dialog),q(this.overlay)]);const e=I(this,"dialog.hide",{dir:this.localize.dir()}),t=I(this,"dialog.overlay.hide",{dir:this.localize.dir()});await Promise.all([F(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),F(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,Ze(this);const n=this.originalTrigger;typeof n?.focus=="function"&&setTimeout(()=>n.focus()),this.emit("syn-after-hide")}}async show(){if(!this.open)return this.open=!0,W(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,W(this,"syn-after-hide")}render(){return p`
    ...
    `}}Ge([u(".dialog")],Me.prototype,"dialog",2);Ge([u(".dialog__panel")],Me.prototype,"panel",2);Ge([u(".dialog__overlay")],Me.prototype,"overlay",2);Ge([r({type:Boolean,reflect:!0})],Me.prototype,"open",2);Ge([r({reflect:!0})],Me.prototype,"label",2);Ge([r({attribute:"no-header",type:Boolean,reflect:!0})],Me.prototype,"noHeader",2);Ge([m("open",{waitUntilFirstUpdate:!0})],Me.prototype,"handleOpenChange",1);T("dialog.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});T("dialog.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});T("dialog.denyClose",{keyframes:[{scale:1},{scale:1.02},{scale:1}],options:{duration:250}});T("dialog.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});T("dialog.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});Me.define("syn-dialog");const wo=h`
	/* stylelint-disable */
  :host {
...
`;var ko=Object.defineProperty,_o=Object.getOwnPropertyDescriptor,ii=(a,e,t,n)=>{for(var i=n>1?void 0:n?_o(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&ko(e,t,i),i};class Le extends v{constructor(){super(...arguments),this.vertical=!1}static{this.styles=[w,wo,xo]}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}}ii([r({type:Boolean,reflect:!0})],Le.prototype,"vertical",2);ii([m("vertical")],Le.prototype,"handleVerticalChange",1);Le.define("syn-divider");function vn(a){return a.charAt(0).toUpperCase()+a.slice(1)}const To=h`
	/* stylelint-disable */
  :host {
    --size: 25rem;
    --header-spacing: var(--syn-spacing-large);
...
`;var So=Object.defineProperty,zo=Object.getOwnPropertyDescriptor,_e=(a,e,t,n)=>{for(var i=n>1?void 0:n?zo(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&So(e,t,i),i};class ye extends v{constructor(){super(...arguments),this.hasSlotController=new U(this,"footer"),this.localize=new j(this),this.modal=new ni(this),this.open=!1,this.label="",this.placement="end",this.contained=!1,this.noHeader=!1,this.handleDocumentKeyDown=e=>{this.contained||e.key==="Escape"&&this.modal.isActive()&&this.open&&(e.stopImmediatePropagation(),this.requestClose("keyboard"))}}static{this.styles=[w,To,Co]}static{this.dependencies={"syn-icon-button":tt}}firstUpdated(){this.drawer.hidden=!this.open,this.open&&(this.addOpenListeners(),this.contained||(this.modal.activate(),ht(this)))}disconnectedCallback(){super.disconnectedCallback(),Ze(this),this.removeOpenListeners()}requestClose(e){if(this.emit("syn-request-close",{cancelable:!0,detail:{source:e}}).defaultPrevented){const n=I(this,"drawer.denyClose",{dir:this.localize.dir()});F(this.panel,n.keyframes,n.options);return}this.hide()}addOpenListeners(){"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.contained||(this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard"))):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){document.removeEventListener("keydown",this.handleDocumentKeyDown),this.closeWatcher?.destroy()}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.contained||(this.modal.activate(),ht(this));const e=this.querySelector("[autofocus]");e&&e.removeAttribute("autofocus"),await Promise.all([q(this.drawer),q(this.overlay)]),this.drawer.hidden=!1,requestAnimationFrame(()=>{this.emit("syn-initial-focus",{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute("autofocus","")});const t=I(this,`drawer.show${vn(this.placement)}`,{dir:this.localize.dir()}),n=I(this,"drawer.overlay.show",{dir:this.localize.dir()});await Promise.all([F(this.panel,t.keyframes,t.options),F(this.overlay,n.keyframes,n.options)]),this.emit("syn-after-show")}else{this.emit("syn-hide"),this.removeOpenListeners(),this.contained||(this.modal.deactivate(),Ze(this)),await Promise.all([q(this.drawer),q(this.overlay)]);const e=I(this,`drawer.hide${vn(this.placement)}`,{dir:this.localize.dir()}),t=I(this,"drawer.overlay.hide",{dir:this.localize.dir()});await Promise.all([F(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),F(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.drawer.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1;const n=this.originalTrigger;typeof n?.focus=="function"&&setTimeout(()=>n.focus()),this.emit("syn-after-hide")}}handleNoModalChange(){this.open&&!this.contained&&(this.modal.activate(),ht(this)),this.open&&this.contained&&(this.modal.deactivate(),Ze(this))}async show(){if(!this.open)return this.open=!0,W(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,W(this,"syn-after-hide")}render(){return p`
    ...
    `}}_e([u(".drawer")],ye.prototype,"drawer",2);_e([u(".drawer__panel")],ye.prototype,"panel",2);_e([u(".drawer__overlay")],ye.prototype,"overlay",2);_e([r({type:Boolean,reflect:!0})],ye.prototype,"open",2);_e([r({reflect:!0})],ye.prototype,"label",2);_e([r({reflect:!0})],ye.prototype,"placement",2);_e([r({type:Boolean,reflect:!0})],ye.prototype,"contained",2);_e([r({attribute:"no-header",type:Boolean,reflect:!0})],ye.prototype,"noHeader",2);_e([m("open",{waitUntilFirstUpdate:!0})],ye.prototype,"handleOpenChange",1);_e([m("contained",{waitUntilFirstUpdate:!0})],ye.prototype,"handleNoModalChange",1);T("drawer.showTop",{keyframes:[{opacity:0,translate:"0 -100%"},{opacity:1,translate:"0 0"}],options:{duration:250,easing:"ease"}});T("drawer.hideTop",{keyframes:[{opacity:1,translate:"0 0"},{opacity:0,translate:"0 -100%"}],options:{duration:250,easing:"ease"}});T("drawer.showEnd",{keyframes:[{opacity:0,translate:"100%"},{opacity:1,translate:"0"}],rtlKeyframes:[{opacity:0,translate:"-100%"},{opacity:1,translate:"0"}],options:{duration:250,easing:"ease"}});T("drawer.hideEnd",{keyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"100%"}],rtlKeyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"-100%"}],options:{duration:250,easing:"ease"}});T("drawer.showBottom",{keyframes:[{opacity:0,translate:"0 100%"},{opacity:1,translate:"0 0"}],options:{duration:250,easing:"ease"}});T("drawer.hideBottom",{keyframes:[{opacity:1,translate:"0 0"},{opacity:0,translate:"0 100%"}],options:{duration:250,easing:"ease"}});T("drawer.showStart",{keyframes:[{opacity:0,translate:"-100%"},{opacity:1,translate:"0"}],rtlKeyframes:[{opacity:0,translate:"100%"},{opacity:1,translate:"0"}],options:{duration:250,easing:"ease"}});T("drawer.hideStart",{keyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"-100%"}],rtlKeyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"100%"}],options:{duration:250,easing:"ease"}});T("drawer.denyClose",{keyframes:[{scale:1},{scale:1.01},{scale:1}],options:{duration:250}});T("drawer.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});T("drawer.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});ye.define("syn-drawer");const Eo=h`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
`;var Mo=Object.defineProperty,Lo=Object.getOwnPropertyDescriptor,Dt=(a,e,t,n)=>{for(var i=n>1?void 0:n?Lo(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Mo(e,t,i),i};class gt extends v{constructor(){super(...arguments),this.hasSlotController=new U(this,"[default]","logo","label","meta-navigation","navigation"),this.localize=new j(this),this.label="",this.burgerMenu="hidden"}static{this.styles=[w,Po]}static{this.dependencies={"syn-icon":ue}}toggleBurgerMenu(){switch(this.burgerMenu){case"closed":this.burgerMenu="open";break;case"open":this.burgerMenu="closed";break}}handleBurgerMenuToggle(){this.sideNav&&!this.sideNav.rail&&(this.sideNav.open=!this.sideNav.open),this.toggleBurgerMenu()}updateBurgerMenuBasedOnSideNav(){this.sideNav&&(this.sideNav.rail?this.burgerMenu="hidden":this.burgerMenu=this.sideNav.open?"open":"closed")}handleBurgerMenu(){const e=`syn-burger-menu-${this.burgerMenu}`;this.emit(e)}connectedCallback(){super.connectedCallback(),this.mutationObserver=new MutationObserver(()=>this.updateBurgerMenuBasedOnSideNav())}firstUpdated(){const e=document.querySelector("syn-side-nav");this.connectSideNavigation(e)}disconnectedCallback(){super.disconnectedCallback(),this.mutationObserver.disconnect()}connectSideNavigation(e){this.mutationObserver.disconnect(),this.sideNav=e||document.querySelector("syn-side-nav"),this.sideNav&&(this.updateBurgerMenuBasedOnSideNav(),this.mutationObserver.observe(this.sideNav,{attributeFilter:["open","rail"],attributes:!0}))}render(){const e=this.hasSlotController.test("navigation"),t=this.burgerMenu!=="hidden";return k`
    ...
    `}}Dt([r()],gt.prototype,"label",2);Dt([r({attribute:"burger-menu",reflect:!0})],gt.prototype,"burgerMenu",2);Dt([g()],gt.prototype,"sideNav",2);Dt([m("burgerMenu",{waitUntilFirstUpdate:!0})],gt.prototype,"handleBurgerMenu",1);gt.define("syn-header");class jo extends Dn{constructor(e){if(super(e),this.handlePointerDown=t=>{t.button!==0||this.host.disabled||this.spinOnLongPressCallback(t)},this.handlePointerUp=t=>{t?.preventDefault(),t?.stopPropagation(),this.timeout&&this.callbacks.start(),this.stopSpinningAndCleanUp(),this.callbacks.end(),document.removeEventListener("pointerup",this.handlePointerUp)},e.type!==pi.ELEMENT||!(e.element instanceof HTMLButtonElement))throw new Error("The `longPress` directive must be used on an HTMLButtonElement.")}render(e){return $n}update(e,[t]){return this.callbacks===void 0&&this.host===void 0&&(this.host=e.element,this.callbacks={...t},this.host.addEventListener("pointerdown",this.handlePointerDown)),hi}disconnected(){this.stopSpinningAndCleanUp(),this.host.removeEventListener("pointerdown",this.handlePointerDown),document.removeEventListener("pointerup",this.handlePointerUp)}spinOnLongPressCallback(e){e.preventDefault(),e.stopPropagation(),this.timeout=setTimeout(()=>{this.timeout=void 0,this.interval=setInterval(()=>{this.callbacks.start()},50)},500),document.addEventListener("pointerup",this.handlePointerUp),this.observer?.disconnect(),this.observer=new MutationObserver(t=>{t.forEach(n=>{n.attributeName==="disabled"&&this.stopSpinningAndCleanUp()})}),this.observer.observe(this.host,{attributes:!0})}stopSpinningAndCleanUp(){clearInterval(this.interval),clearTimeout(this.timeout),this.observer?.disconnect()}}const wn=En(jo),Fo=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`;var Ho=Object.defineProperty,Bo=Object.getOwnPropertyDescriptor,S=(a,e,t,n)=>{for(var i=n>1?void 0:n?Bo(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Ho(e,t,i),i};class C extends v{constructor(){super(...arguments),this.formControlController=new xe(this,{assumeInteractionOn:["syn-blur","syn-input"]}),this.hasSlotController=new U(this,"help-text","label","prefix","suffix"),this.localize=new j(this),this.hasFocus=!1,this.title="",this.__numberInput=Object.assign(document.createElement("input"),{type:"number"}),this.__dateInput=Object.assign(document.createElement("input"),{type:"date"}),this.type="text",this.name="",this.value="",this.defaultValue="",this.size="medium",this.label="",this.helpText="",this.clearable=!1,this.disabled=!1,this.placeholder="",this.readonly=!1,this.passwordToggle=!1,this.passwordVisible=!1,this.noSpinButtons=!1,this.form="",this.required=!1,this.spellcheck=!0}static{this.styles=[w,ze,Fo,Ee,Vo]}static{this.dependencies={"syn-icon":ue,"syn-divider":Le}}get valueAsDate(){return this.__dateInput.type=this.type,this.__dateInput.value=this.value,this.input?.valueAsDate||this.__dateInput.valueAsDate}set valueAsDate(e){this.__dateInput.type=this.type,this.__dateInput.valueAsDate=e,this.value=this.__dateInput.value}get valueAsNumber(){return this.__numberInput.value=this.value,this.input?.valueAsNumber||this.__numberInput.valueAsNumber}set valueAsNumber(e){this.__numberInput.valueAsNumber=e,this.value=this.__numberInput.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleStep(){this.handleInput(),this.input.focus()}handleStepUp(){this.stepUp(),this.handleStep()}handleStepDown(){this.stepDown(),this.handleStep()}isDecrementDisabled(){if(this.disabled||this.readonly)return!0;if(this.min===void 0||this.min===null||this.disabled)return!1;const e=typeof this.min=="string"?parseFloat(this.min):this.min;return this.valueAsNumber<=e}isIncrementDisabled(){if(this.disabled||this.readonly)return!0;if(this.max===void 0||this.max===null)return!1;const e=typeof this.max=="string"?parseFloat(this.max):this.max;return this.valueAsNumber>=e}handleChange(){this.value=this.input.value,this.emit("syn-change")}handleClearClick(e){e.preventDefault(),this.value!==""&&(this.value="",this.emit("syn-clear"),this.emit("syn-input"),this.emit("syn-change")),this.input.focus()}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleInput(){this.value=this.input.value,this.formControlController.updateValidity(),this.emit("syn-input")}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleKeyDown(e){const t=e.metaKey||e.ctrlKey||e.shiftKey||e.altKey;e.key==="Enter"&&!t&&setTimeout(()=>{!e.defaultPrevented&&!e.isComposing&&this.formControlController.submit()})}handlePasswordToggle(){this.passwordVisible=!this.passwordVisible}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStepChange(){this.input.step=String(this.step),this.formControlController.updateValidity()}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(e){this.input.focus(e)}blur(){this.input.blur()}select(){this.input.select()}setSelectionRange(e,t,n="none"){this.input.setSelectionRange(e,t,n)}setRangeText(e,t,n,i="preserve"){const o=t??this.input.selectionStart,s=n??this.input.selectionEnd;this.input.setRangeText(e,o,s,i),this.value!==this.input.value&&(this.value=this.input.value)}showPicker(){"showPicker"in HTMLInputElement.prototype&&this.input.showPicker()}stepUp(){this.input.stepUp(),this.value!==this.input.value&&(this.value=this.input.value)}stepDown(){this.input.stepDown(),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("label"),t=this.hasSlotController.test("help-text"),n=this.hasSlotController.test("prefix"),i=this.hasSlotController.test("suffix"),o=this.label?!0:!!e,s=this.helpText?!0:!!t,d=this.clearable&&!this.disabled&&!this.readonly&&(typeof this.value=="number"||this.value.length>0);return p`
    ...
    `:p` <slot name="submenu" hidden></slot> `}}const Wo=h`
	/* stylelint-disable */
  :host {
    --submenu-offset: -2px;
...
`;function qo(a,e){const t={waitUntilFirstUpdated:!1,...e};return n=>class extends n{#e=!t.waitUntilFirstUpdated;updated(i){if(!this.#e){this.#e=!0;return}const o=Array.from(i).filter(([l])=>a.includes(l));if(o.length===0){super.updated(i);return}const s=o.map(([l,d])=>({attribute:l,newValue:this[l],oldValue:d}));this.emit("syn-attributes-changed",{detail:s}),super.updated(i)}}}var Ko=Object.defineProperty,Go=Object.getOwnPropertyDescriptor,ve=(a,e,t,n)=>{for(var i=n>1?void 0:n?Go(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Ko(e,t,i),i};let ne=class extends v{constructor(){super(...arguments),this.localize=new j(this),this.type="normal",this.checked=!1,this.value="",this.loading=!1,this.disabled=!1,this.hasSlotController=new U(this,"submenu"),this.submenuController=new Ro(this,this.hasSlotController),this.handleHostClick=a=>{this.disabled&&(a.preventDefault(),a.stopImmediatePropagation())},this.handleMouseOver=a=>{this.focus(),a.stopPropagation()}}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this.handleHostClick),this.addEventListener("mouseover",this.handleMouseOver)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.handleHostClick),this.removeEventListener("mouseover",this.handleMouseOver)}handleDefaultSlotChange(){const a=this.getTextLabel();if(typeof this.cachedTextLabel>"u"){this.cachedTextLabel=a;return}a!==this.cachedTextLabel&&(this.cachedTextLabel=a,this.emit("slotchange",{bubbles:!0,composed:!1,cancelable:!1}))}handleCheckedChange(){if(this.checked&&this.type!=="checkbox"){this.checked=!1,console.error('The checked attribute can only be used on menu items with type="checkbox"',this);return}this.type==="checkbox"?this.setAttribute("aria-checked",this.checked?"true":"false"):this.removeAttribute("aria-checked")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleTypeChange(){this.type==="checkbox"?(this.setAttribute("role","menuitemcheckbox"),this.setAttribute("aria-checked",this.checked?"true":"false")):(this.setAttribute("role","menuitem"),this.removeAttribute("aria-checked"))}getTextLabel(){return Yn(this.defaultSlot)}isSubmenu(){return this.hasSlotController.test("submenu")}render(){const a=this.localize.dir()==="rtl",e=this.submenuController.isExpanded();return p`
    ...
    `}};ne.styles=[w,Wo,Uo];ne.dependencies={"syn-icon":ue,"syn-popup":O,"syn-spinner":en};ve([u("slot:not([name])")],ne.prototype,"defaultSlot",2);ve([u(".menu-item")],ne.prototype,"menuItem",2);ve([r()],ne.prototype,"type",2);ve([r({type:Boolean,reflect:!0})],ne.prototype,"checked",2);ve([r()],ne.prototype,"value",2);ve([r({type:Boolean,reflect:!0})],ne.prototype,"loading",2);ve([r({type:Boolean,reflect:!0})],ne.prototype,"disabled",2);ve([m("checked")],ne.prototype,"handleCheckedChange",1);ve([m("disabled")],ne.prototype,"handleDisabledChange",1);ve([m("type")],ne.prototype,"handleTypeChange",1);ne=ve([qo(["type","loading"],{waitUntilFirstUpdated:!0})],ne);ne.define("syn-menu-item");const Yo=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`;class Qo extends v{static{this.styles=[w,Yo,Xo]}static{this.dependencies={"syn-divider":Le}}render(){return p`
    ...
    `}}Qo.define("syn-menu-label");const Jo=h`
	/* stylelint-disable */
  :host {
    display: block;
    position: relative;
...
`;var es=Object.defineProperty,ai=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&es(e,t,i),i};class Nt extends v{constructor(){super(...arguments),this.hasMenuItemsWithCheckmarks=!1,this.updateCheckMarksByChildPropChange=e=>{e.stopImmediatePropagation(),this.handleUpdateCheckmarks(this.getAllItems())}}static{this.styles=[w,Jo,Zo]}handleUpdateCheckmarks(e){this.hasMenuItemsWithCheckmarks=e.some(t=>t.type==="checkbox"||t.loading)}disconnectedCallback(){this.removeEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu"),this.addEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}handleClick(e){const t=["menuitem","menuitemcheckbox"],n=e.composedPath(),i=n.find(d=>t.includes(d?.getAttribute?.("role")||""));if(!i||n.find(d=>d?.getAttribute?.("role")==="menu")!==this)return;const l=i;l.type==="checkbox"&&(l.checked=!l.checked),this.emit("syn-select",{detail:{item:l}})}handleKeyDown(e){if(e.key==="Enter"||e.key===" "){const t=this.getCurrentItem();e.preventDefault(),e.stopPropagation(),t?.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(e.key)){const t=this.getAllItems(),n=this.getCurrentItem();let i=n?t.indexOf(n):0;t.length>0&&(e.preventDefault(),e.stopPropagation(),e.key==="ArrowDown"?i++:e.key==="ArrowUp"?i--:e.key==="Home"?i=0:e.key==="End"&&(i=t.length-1),i<0&&(i=t.length-1),i>t.length-1&&(i=0),this.setCurrentItem(t[i]),t[i].focus())}}handleMouseDown(e){const t=e.target;this.isMenuItem(t)&&this.setCurrentItem(t)}handleSlotChange(){const e=this.getAllItems();this.handleUpdateCheckmarks(e),e.length>0&&this.setCurrentItem(e[0])}isMenuItem(e){return e.tagName.toLowerCase()==="syn-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes(e.getAttribute("role")??"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>!(e.inert||!this.isMenuItem(e)))}getCurrentItem(){return this.getAllItems().find(e=>e.getAttribute("tabindex")==="0")}setCurrentItem(e){this.getAllItems().forEach(n=>{n.setAttribute("tabindex",n===e?"0":"-1")})}render(){return p`
      ...
      ></slot>
    `}}ai([u("slot")],Nt.prototype,"defaultSlot");ai([g()],Nt.prototype,"hasMenuItemsWithCheckmarks");Nt.define("syn-menu");const ts=h`
  /**
...
`;var os=Object.defineProperty,ss=Object.getOwnPropertyDescriptor,It=(a,e,t,n)=>{for(var i=n>1?void 0:n?ss(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&os(e,t,i),i};class vt extends v{constructor(){super(...arguments),this.hasSlotController=new U(this,"[default]","prefix","suffix","label"),this.disabled=!1,this.label=""}static{this.styles=as}static{this.dependencies={"syn-divider":Le}}handleDisableOptions(){const{disabled:e}=this;this.defaultSlot.assignedElements().filter(t=>t.tagName.toLowerCase()==="syn-option").forEach(t=>{t.disabled=e})}handleDisabledChange(){this.handleDisableOptions()}render(){const{disabled:e}=this,t=this.hasSlotController.test("label"),n=this.label?!0:!!t;return k`
      <div
    ...
    `}}It([u("slot:not([name])")],vt.prototype,"defaultSlot",2);It([r({reflect:!0,type:Boolean})],vt.prototype,"disabled",2);It([r()],vt.prototype,"label",2);It([m("disabled",{waitUntilFirstUpdate:!0})],vt.prototype,"handleDisabledChange",1);vt.define("syn-optgroup");const rs=h`
	/* stylelint-disable */
  :host {
    display: block;
    user-select: none;
...
`;var ds=Object.defineProperty,cs=Object.getOwnPropertyDescriptor,$e=(a,e,t,n)=>{for(var i=n>1?void 0:n?cs(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&ds(e,t,i),i};class Te extends v{constructor(){super(...arguments),this.localize=new j(this),this.current=!1,this.selected=!1,this.hasHover=!1,this.value="",this.disabled=!1}static{this.styles=[w,rs,ls]}static{this.dependencies={"syn-icon":ue}}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.setAttribute("aria-selected","false")}handleDefaultSlotChange(){customElements.whenDefined("syn-combobox").then(()=>{const e=this.closest("syn-combobox");e&&e.handleDefaultSlotChange()}),customElements.whenDefined("syn-select").then(()=>{const e=this.closest("syn-select");e&&e.handleDefaultSlotChange()})}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleValueChange(){typeof this.value!="string"&&(this.value=String(this.value)),this.value.includes(" ")&&(console.error("Option values cannot include a space. All spaces have been replaced with underscores.",this),this.value=this.value.replace(/ /g,"_"))}getTextLabel(){const e=this.childNodes;let t="";return[...e].forEach(n=>{n.nodeType===Node.ELEMENT_NODE&&(n.hasAttribute("slot")||(t+=n.textContent)),n.nodeType===Node.TEXT_NODE&&(t+=n.textContent)}),t.trim()}render(){return p`
      <div
        part="base"
...
`,xn=a=>Array.from(a.assignedElements({flatten:!0})),hs=a=>a.tagName.toLocaleLowerCase()==="syn-nav-item"||(a.getAttribute("role")??"")==="menuitem",kn=a=>a.filter(hs),us=a=>{a.setAttribute("horizontal","true"),a.removeAttribute("slot"),a.removeAttribute("tabindex"),a.dataset.originalRole?a.setAttribute("role",a.dataset.originalRole):a.removeAttribute("role")},ms=a=>{a.removeAttribute("horizontal"),a.setAttribute("slot","menu"),a.setAttribute("role","menuitem")};var fs=Object.defineProperty,je=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&fs(e,t,i),i};class Oe extends v{constructor(){super(...arguments),this.localize=new j(this),this.itemPositionsCached=!1,this.amountOfNavItems=0,this.amountOfVisibleItems=0,this.hasItemsInDropdown=!1}static{this.styles=[w,ps]}static{this.dependencies={"syn-dropdown":ae,"syn-icon":ue,"syn-menu":Nt,"syn-nav-item":J}}getSlottedNavItems(){const e=kn(xn(this.defaultSlot)),t=kn(xn(this.menuSlot));return e.concat(t)}cacheItemPositions(e){const{left:t}=this.horizontalNav.getBoundingClientRect();e.forEach(n=>{n.removeAttribute("slot");const{right:i}=n.getBoundingClientRect();n.dataset.right=(i-t).toString()}),this.itemPositionsCached=!0}handlePriorityMenu(){const e=this.getSlottedNavItems();this.itemPositionsCached||this.cacheItemPositions(e);const{width:t}=this.horizontalNav.getBoundingClientRect(),n=this.priorityMenu.classList.contains("priority-menu--hidden")?0:this.priorityMenu.clientWidth,i=t-n;let o;const s=e.at(-1),l=e.map(y=>{const _=y===s?t:i,K=!!(o||parseFloat(y.dataset.right)>_);return K&&!o&&(o=parseFloat(y.dataset.right)),{isHidden:K,item:y}}),d=l.filter(({isHidden:y})=>!y).length,c=d===1;l.forEach(({item:y,isHidden:_})=>{_||c?ms(y):us(y)}),this.hasItemsInDropdown=d!==e.length,this.amountOfVisibleItems=c?0:d}renderPriorityMenu(){return k`
      <syn-dropdown
    ...
    `}}je([u("slot:not([name])")],Oe.prototype,"defaultSlot");je([u("slot[name=menu]")],Oe.prototype,"menuSlot");je([u(".horizontal-nav")],Oe.prototype,"horizontalNav");je([u(".priority-menu")],Oe.prototype,"priorityMenu");je([g()],Oe.prototype,"itemPositionsCached");je([g()],Oe.prototype,"amountOfNavItems");je([g()],Oe.prototype,"amountOfVisibleItems");je([g()],Oe.prototype,"hasItemsInDropdown");Oe.define("syn-prio-nav");const ys=h`
	/* stylelint-disable */
  :host {
    --height: 1rem;
...
`;var gs=Object.defineProperty,nn=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&gs(e,t,i),i};class At extends v{constructor(){super(...arguments),this.localize=new j(this),this.value=0,this.indeterminate=!1,this.label=""}static{this.styles=[w,ys,bs]}render(){return p`
      <div
        part="base"
      ...
      >
        <div part="indicator" class="progress-bar__indicator" style=${_i({width:`${this.value}%`})}>
          ${this.indeterminate?"":p` <slot part="label" class="progress-bar__label"></slot> `}
        </div>
      </div>
    `}}nn([r({type:Number,reflect:!0})],At.prototype,"value");nn([r({type:Boolean,reflect:!0})],At.prototype,"indeterminate");nn([r()],At.prototype,"label");At.define("syn-progress-bar");const vs=h`
	/* stylelint-disable */
  :host {
    --size: 128px;
    --track-width: 4px;
...
`;var xs=Object.defineProperty,Pt=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&xs(e,t,i),i};class wt extends v{constructor(){super(...arguments),this.localize=new j(this),this.value=0,this.label=""}static{this.styles=[w,vs,ws]}updated(e){if(super.updated(e),e.has("value")){const t=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),n=2*Math.PI*t,i=n-this.value/100*n;this.indicatorOffset=`${i}px`}}render(){return p`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
    ...
    `}}Pt([u(".progress-ring__indicator")],wt.prototype,"indicator");Pt([g()],wt.prototype,"indicatorOffset");Pt([r({type:Number,reflect:!0})],wt.prototype,"value");Pt([r()],wt.prototype,"label");wt.define("syn-progress-ring");const ks=h`
	/* stylelint-disable */
  ${Zn}
...
`;var _s=Object.defineProperty,Ts=Object.getOwnPropertyDescriptor,De=(a,e,t,n)=>{for(var i=n>1?void 0:n?Ts(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&_s(e,t,i),i};class Ce extends v{constructor(){super(...arguments),this.hasSlotController=new U(this,"[default]","prefix","suffix"),this.hasFocus=!1,this.checked=!1,this.disabled=!1,this.size="medium",this.pill=!1}static{this.styles=[w,ks]}connectedCallback(){super.connectedCallback(),this.setAttribute("role","presentation")}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleClick(e){if(this.disabled){e.preventDefault(),e.stopPropagation();return}this.checked=!0}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}focus(e){this.input.focus(e)}blur(){this.input.blur()}render(){return k`
...
`;var zs=Object.defineProperty,Es=Object.getOwnPropertyDescriptor,le=(a,e,t,n)=>{for(var i=n>1?void 0:n?Es(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&zs(e,t,i),i};class oe extends v{constructor(){super(...arguments),this.formControlController=new xe(this),this.hasSlotController=new U(this,"help-text","label"),this.customValidityMessage="",this.hasButtonGroup=!1,this.errorMessage="",this.defaultValue="",this.label="",this.helpText="",this.name="option",this.value="",this.size="medium",this.form="",this.required=!1}static{this.styles=[w,ze,Cs,Ee,Ss]}static{this.dependencies={"syn-button-group":yt}}get validity(){const e=this.required&&!this.value;return this.customValidityMessage!==""?Jn:e?Oa:bt}get validationMessage(){const e=this.required&&!this.value;return this.customValidityMessage!==""?this.customValidityMessage:e?this.validationInput.validationMessage:""}connectedCallback(){super.connectedCallback(),this.defaultValue=this.value}firstUpdated(){this.formControlController.updateValidity()}getAllRadios(){return[...this.querySelectorAll("syn-radio, syn-radio-button")]}handleRadioClick(e){const t=e.target.closest("syn-radio, syn-radio-button"),n=this.getAllRadios(),i=this.value;!t||t.disabled||(this.value=t.value,n.forEach(o=>o.checked=o===t),this.value!==i&&(this.emit("syn-change"),this.emit("syn-input")))}handleKeyDown(e){if(!["ArrowUp","ArrowDown","ArrowLeft","ArrowRight"," "].includes(e.key))return;const t=this.getAllRadios().filter(l=>!l.disabled),n=t.find(l=>l.checked)??t[0],i=e.key===" "?0:["ArrowUp","ArrowLeft"].includes(e.key)?-1:1,o=this.value;let s=t.indexOf(n)+i;s<0&&(s=t.length-1),s>t.length-1&&(s=0),this.getAllRadios().forEach(l=>{l.checked=!1,this.hasButtonGroup||l.setAttribute("tabindex","-1")}),this.value=t[s].value,t[s].checked=!0,this.hasButtonGroup?t[s].shadowRoot.querySelector("button").focus():(t[s].setAttribute("tabindex","0"),t[s].focus()),this.value!==o&&(this.emit("syn-change"),this.emit("syn-input")),e.preventDefault()}handleLabelClick(){this.focus()}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}async syncRadioElements(){const e=this.getAllRadios();if(await Promise.all(e.map(async t=>{await t.updateComplete,t.checked=t.value===this.value,t.size=this.size})),this.hasButtonGroup=e.some(t=>t.tagName.toLowerCase()==="syn-radio-button"),e.length>0&&!e.some(t=>t.checked))if(this.hasButtonGroup){const t=e[0].shadowRoot?.querySelector("button");t&&t.setAttribute("tabindex","0")}else e[0].setAttribute("tabindex","0");if(this.hasButtonGroup){const t=this.shadowRoot?.querySelector("syn-button-group");t&&(t.disableRole=!0)}}syncRadios(){if(customElements.get("syn-radio")&&customElements.get("syn-radio-button")){this.syncRadioElements();return}customElements.get("syn-radio")?this.syncRadioElements():customElements.whenDefined("syn-radio").then(()=>this.syncRadios()),customElements.get("syn-radio-button")?this.syncRadioElements():customElements.whenDefined("syn-radio-button").then(()=>this.syncRadios())}updateCheckedRadio(){this.getAllRadios().forEach(t=>t.checked=t.value===this.value),this.formControlController.setValidity(this.validity.valid)}handleSizeChange(){this.syncRadios()}handleValueChange(){this.hasUpdated&&this.updateCheckedRadio()}checkValidity(){const e=this.required&&!this.value,t=this.customValidityMessage!=="";return e||t?(this.formControlController.emitInvalidEvent(),!1):!0}getForm(){return this.formControlController.getForm()}reportValidity(){const e=this.validity.valid;return this.errorMessage=this.customValidityMessage||e?"":this.validationInput.validationMessage,this.formControlController.setValidity(e),this.validationInput.hidden=!0,clearTimeout(this.validationTimeout),e||(this.validationInput.hidden=!1,this.validationInput.reportValidity(),this.validationTimeout=setTimeout(()=>this.validationInput.hidden=!0,1e4)),e}setCustomValidity(e=""){this.customValidityMessage=e,this.errorMessage=e,this.validationInput.setCustomValidity(e),this.formControlController.updateValidity()}focus(e){const t=this.getAllRadios(),n=t.find(s=>s.checked),i=t.find(s=>!s.disabled),o=n||i;o&&o.focus(e)}render(){const e=this.hasSlotController.test("label"),t=this.hasSlotController.test("help-text"),n=this.label?!0:!!e,i=this.helpText?!0:!!t,o=p`
    ...
    `}}le([u("slot:not([name])")],oe.prototype,"defaultSlot",2);le([u(".radio-group__validation-input")],oe.prototype,"validationInput",2);le([g()],oe.prototype,"hasButtonGroup",2);le([g()],oe.prototype,"errorMessage",2);le([g()],oe.prototype,"defaultValue",2);le([r()],oe.prototype,"label",2);le([r({attribute:"help-text"})],oe.prototype,"helpText",2);le([r()],oe.prototype,"name",2);le([r({reflect:!0})],oe.prototype,"value",2);le([r({reflect:!0})],oe.prototype,"size",2);le([r({reflect:!0})],oe.prototype,"form",2);le([r({type:Boolean,reflect:!0})],oe.prototype,"required",2);le([m("size",{waitUntilFirstUpdate:!0})],oe.prototype,"handleSizeChange",1);le([m("value")],oe.prototype,"handleValueChange",1);oe.define("syn-radio-group");const $s=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`;var Ds=Object.defineProperty,Ns=Object.getOwnPropertyDescriptor,Ye=(a,e,t,n)=>{for(var i=n>1?void 0:n?Ns(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Ds(e,t,i),i};class Fe extends v{constructor(){super(),this.checked=!1,this.hasFocus=!1,this.size="medium",this.disabled=!1,this.handleBlur=()=>{this.hasFocus=!1,this.emit("syn-blur")},this.handleClick=()=>{this.disabled||(this.checked=!0)},this.handleFocus=()=>{this.hasFocus=!0,this.emit("syn-focus")},this.addEventListener("blur",this.handleBlur),this.addEventListener("click",this.handleClick),this.addEventListener("focus",this.handleFocus)}static{this.styles=[w,$s,Os]}static{this.dependencies={"syn-icon":ue}}connectedCallback(){super.connectedCallback(),this.setInitialAttributes()}setInitialAttributes(){this.setAttribute("role","radio"),this.setAttribute("tabindex","-1"),this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleCheckedChange(){this.setAttribute("aria-checked",this.checked?"true":"false"),this.setAttribute("tabindex",this.checked?"0":"-1")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}render(){return p`
      <span
        part="base"
...
`;var As=Object.defineProperty,Ps=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&As(e,t,i),i};class oi extends v{constructor(){super(...arguments),this.subdivision=!1}static{this.styles=[w,Is]}render(){return p`
      <div
    ...
    `}}Ps([r({reflect:!0,type:Boolean})],oi.prototype,"subdivision");oi.define("syn-range-tick");const Ms=h`
	/* stylelint-disable */
  :host {
    --max-width: 20rem;
    --hide-delay: 0ms;
...
`;var Us=Object.defineProperty,si=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Us(e,t,i),i};class Mt extends v{constructor(){super(...arguments),this.localize=new j(this),this.size="medium",this.removable=!1}static{this.styles=[w,Rs,Ws]}static{this.dependencies={"syn-icon-button":tt}}handleRemoveClick(){this.emit("syn-remove")}render(){return p`
      <span
        part="base"
    ...
    `}}si([r({reflect:!0})],Mt.prototype,"size");si([r({type:Boolean})],Mt.prototype,"removable");const qs=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`;var Gs=Object.defineProperty,Ys=Object.getOwnPropertyDescriptor,D=(a,e,t,n)=>{for(var i=n>1?void 0:n?Ys(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Gs(e,t,i),i};class $ extends v{constructor(){super(...arguments),this.formControlController=new xe(this,{assumeInteractionOn:["syn-blur","syn-input"]}),this.hasSlotController=new U(this,"help-text","label"),this.localize=new j(this),this.typeToSelectString="",this.hasFocus=!1,this.displayLabel="",this.selectedOptions=[],this.valueHasChanged=!1,this.name="",this._value="",this.defaultValue="",this.size="medium",this.placeholder="",this.multiple=!1,this.maxOptionsVisible=3,this.disabled=!1,this.clearable=!1,this.open=!1,this.hoist=!1,this.label="",this.placement="bottom",this.helpText="",this.form="",this.required=!1,this.getTag=e=>p`
      <syn-tag
        part="tag"
        exportparts="
              base:tag__base,
...
:host([size='small']) {
  ...
  `;var tr=Object.defineProperty,nr=Object.getOwnPropertyDescriptor,ce=(a,e,t,n)=>{for(var i=n>1?void 0:n?nr(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&tr(e,t,i),i};class se extends v{constructor(){super(...arguments),this.formControlController=new xe(this,{value:e=>e.checked?e.value||"on":void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=t}),this.hasSlotController=new U(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}static{this.styles=[w,ze,Zs,Ee,er]}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleInput(){this.emit("syn-input")}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleClick(){this.checked=!this.checked,this.emit("syn-change")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleKeyDown(e){e.key==="ArrowLeft"&&(e.preventDefault(),this.checked=!1,this.emit("syn-change"),this.emit("syn-input")),e.key==="ArrowRight"&&(e.preventDefault(),this.checked=!0,this.emit("syn-change"),this.emit("syn-input"))}handleCheckedChange(){this.input.checked=this.checked,this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(!0)}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("help-text"),t=this.helpText?!0:!!e;return p`
      <div
        class=${f({"form-control":!0,"form-control--small":this.size==="small","form-control--medium":this.size==="medium","form-control--large":this.size==="large","form-control--has-help-text":t})}
      >
        <label
    ...
    `}}ce([u('input[type="checkbox"]')],se.prototype,"input",2);ce([g()],se.prototype,"hasFocus",2);ce([r()],se.prototype,"title",2);ce([r()],se.prototype,"name",2);ce([r()],se.prototype,"value",2);ce([r({reflect:!0})],se.prototype,"size",2);ce([r({type:Boolean,reflect:!0})],se.prototype,"disabled",2);ce([r({type:Boolean,reflect:!0})],se.prototype,"checked",2);ce([Ke("checked")],se.prototype,"defaultChecked",2);ce([r({reflect:!0})],se.prototype,"form",2);ce([r({type:Boolean,reflect:!0})],se.prototype,"required",2);ce([r({attribute:"help-text"})],se.prototype,"helpText",2);ce([m("checked",{waitUntilFirstUpdate:!0})],se.prototype,"handleCheckedChange",1);ce([m("disabled",{waitUntilFirstUpdate:!0})],se.prototype,"handleDisabledChange",1);se.define("syn-switch");const ir=(a,e)=>{let t=0;return function(...n){window.clearTimeout(t),t=window.setTimeout(()=>{a.call(this,...n)},e)}},Tn=(a,e,t)=>{const n=a[e];a[e]=function(...i){n.call(this,...i),t.call(this,n,...i)}},ar="onscrollend"in window;if(!ar){const a=new Set,e=new WeakMap,t=i=>{for(const o of i.changedTouches)a.add(o.identifier)},n=i=>{for(const o of i.changedTouches)a.delete(o.identifier)};document.addEventListener("touchstart",t,!0),document.addEventListener("touchend",n,!0),document.addEventListener("touchcancel",n,!0),Tn(EventTarget.prototype,"addEventListener",function(i,o){if(o!=="scrollend")return;const s=ir(()=>{a.size?s():this.dispatchEvent(new Event("scrollend"))},100);i.call(this,"scroll",s,{passive:!0}),e.set(this,s)}),Tn(EventTarget.prototype,"removeEventListener",function(i,o){if(o!=="scrollend")return;const s=e.get(this);s&&i.call(this,"scroll",s,{passive:!0})})}const or=h`
	/* stylelint-disable */
  :host {
    display: contents;
  }
`;var sr=Object.defineProperty,rr=Object.getOwnPropertyDescriptor,ri=(a,e,t,n)=>{for(var i=n>1?void 0:n?rr(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&sr(e,t,i),i};class an extends v{constructor(){super(...arguments),this.observedElements=[],this.disabled=!1}static{this.styles=[w,or]}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{this.emit("syn-resize",{detail:{entries:e}})}),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}handleSlotChange(){this.disabled||this.startObserver()}startObserver(){const e=this.shadowRoot.querySelector("slot");if(e!==null){const t=e.assignedElements({flatten:!0});this.observedElements.forEach(n=>this.resizeObserver.unobserve(n)),this.observedElements=[],t.forEach(n=>{this.resizeObserver.observe(n),this.observedElements.push(n)})}}stopObserver(){this.resizeObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}render(){return p` <slot @slotchange=${this.handleSlotChange}></slot> `}}ri([r({type:Boolean,reflect:!0})],an.prototype,"disabled",2);ri([m("disabled",{waitUntilFirstUpdate:!0})],an.prototype,"handleDisabledChange",1);const lr=h`
	/* stylelint-disable */
  :host {
    --indicator-color: var(--syn-color-primary-600);
    --track-color: var(--syn-color-neutral-200);
...
`;var mr=Object.defineProperty,fr=Object.getOwnPropertyDescriptor,on=(a,e,t,n)=>{for(var i=n>1?void 0:n?fr(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&mr(e,t,i),i};let yr=0;class Lt extends v{constructor(){super(...arguments),this.attrId=++yr,this.componentId=`syn-tab-panel-${this.attrId}`,this.name="",this.active=!1}static{this.styles=[w,hr,ur]}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return p`
      <slot
        part="base"
        class=${f({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}}on([r({reflect:!0})],Lt.prototype,"name",2);on([r({type:Boolean,reflect:!0})],Lt.prototype,"active",2);on([m("active")],Lt.prototype,"handleActiveChange",1);Lt.define("syn-tab-panel");const br=h`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
`;var vr=Object.defineProperty,wr=Object.getOwnPropertyDescriptor,He=(a,e,t,n)=>{for(var i=n>1?void 0:n?wr(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&vr(e,t,i),i};let xr=0;class Ie extends v{constructor(){super(...arguments),this.localize=new j(this),this.attrId=++xr,this.componentId=`syn-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}static{this.styles=[w,br,gr]}static{this.dependencies={"syn-icon-button":tt}}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}handleCloseClick(e){e.stopPropagation(),this.emit("syn-close")}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false"),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,p`
      <div
        part="base"
...
`;var Tr=Object.defineProperty,Cr=Object.getOwnPropertyDescriptor,A=(a,e,t,n)=>{for(var i=n>1?void 0:n?Cr(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Tr(e,t,i),i};class N extends v{constructor(){super(...arguments),this.formControlController=new xe(this,{assumeInteractionOn:["syn-blur","syn-input"]}),this.hasSlotController=new U(this,"help-text","label"),this.hasFocus=!1,this.title="",this.name="",this.value="",this.size="medium",this.label="",this.helpText="",this.placeholder="",this.rows=4,this.resize="vertical",this.disabled=!1,this.readonly=!1,this.form="",this.required=!1,this.spellcheck=!0,this.defaultValue=""}static{this.styles=[w,ze,kr,Ee,_r]}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>this.setTextareaHeight()),this.updateComplete.then(()=>{this.setTextareaHeight(),this.resizeObserver.observe(this.input)})}firstUpdated(){this.formControlController.updateValidity()}disconnectedCallback(){super.disconnectedCallback(),this.input&&this.resizeObserver?.unobserve(this.input)}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleChange(){this.value=this.input.value,this.setTextareaHeight(),this.emit("syn-change")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleInput(){this.value=this.input.value,this.emit("syn-input")}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}setTextareaHeight(){this.resize==="auto"?(this.sizeAdjuster.style.height=`${this.input.clientHeight}px`,this.input.style.height="auto",this.input.style.height=`${this.input.scrollHeight}px`):this.input.style.height=""}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleRowsChange(){this.setTextareaHeight()}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity(),this.setTextareaHeight()}focus(e){this.input.focus(e)}blur(){this.input.blur()}select(){this.input.select()}scrollPosition(e){if(e){typeof e.top=="number"&&(this.input.scrollTop=e.top),typeof e.left=="number"&&(this.input.scrollLeft=e.left);return}return{top:this.input.scrollTop,left:this.input.scrollTop}}setSelectionRange(e,t,n="none"){this.input.setSelectionRange(e,t,n)}setRangeText(e,t,n,i="preserve"){const o=t??this.input.selectionStart,s=n??this.input.selectionEnd;this.input.setRangeText(e,o,s,i),this.value!==this.input.value&&(this.value=this.input.value,this.setTextareaHeight())}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("label"),t=this.hasSlotController.test("help-text"),n=this.label?!0:!!e,i=this.helpText?!0:!!t;return p`
    ...
    `}}A([u(".textarea__control")],N.prototype,"input",2);A([u(".textarea__size-adjuster")],N.prototype,"sizeAdjuster",2);A([g()],N.prototype,"hasFocus",2);A([r()],N.prototype,"title",2);A([r()],N.prototype,"name",2);A([r()],N.prototype,"value",2);A([r({reflect:!0})],N.prototype,"size",2);A([r()],N.prototype,"label",2);A([r({attribute:"help-text"})],N.prototype,"helpText",2);A([r()],N.prototype,"placeholder",2);A([r({type:Number})],N.prototype,"rows",2);A([r()],N.prototype,"resize",2);A([r({type:Boolean,reflect:!0})],N.prototype,"disabled",2);A([r({type:Boolean,reflect:!0})],N.prototype,"readonly",2);A([r({reflect:!0})],N.prototype,"form",2);A([r({type:Boolean,reflect:!0})],N.prototype,"required",2);A([r({type:Number})],N.prototype,"minlength",2);A([r({type:Number})],N.prototype,"maxlength",2);A([r()],N.prototype,"autocapitalize",2);A([r()],N.prototype,"autocorrect",2);A([r()],N.prototype,"autocomplete",2);A([r({type:Boolean})],N.prototype,"autofocus",2);A([r()],N.prototype,"enterkeyhint",2);A([r({type:Boolean,converter:{fromAttribute:a=>!(!a||a==="false"),toAttribute:a=>a?"true":"false"}})],N.prototype,"spellcheck",2);A([r()],N.prototype,"inputmode",2);A([Ke()],N.prototype,"defaultValue",2);A([m("disabled",{waitUntilFirstUpdate:!0})],N.prototype,"handleDisabledChange",1);A([m("rows",{waitUntilFirstUpdate:!0})],N.prototype,"handleRowsChange",1);A([m("value",{waitUntilFirstUpdate:!0})],N.prototype,"handleValueChange",1);N.define("syn-textarea");Z.define("syn-tooltip");const Sr=["blur","change","clear","focus","invalid","input","move"],li=(a,e)=>a.includes(e),Cn=a=>li(a,"blur"),Vt=a=>li(a,"invalid"),zr=(a="")=>a.split(" ").map(e=>e.trim()).filter(Boolean),Sn=(a,e)=>{const t=e.trim();return a instanceof v&&Sr.includes(t)?`syn-${t}`:t},Er=h`
  .validate {
    display: flex;
    flex-direction: column;
    gap: var(--syn-spacing-small);
  }
`;var $r=Object.defineProperty,Or=Object.getOwnPropertyDescriptor,fe=(a,e,t,n)=>{for(var i=n>1?void 0:n?Or(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&$r(e,t,i),i};class pe extends v{constructor(){super(...arguments),this.controller=new AbortController,this.validationMessage="",this.eagerFirstMount=!0,this.isInternalTriggeredInvalid=!1,this.isValid=!0,this.variant="native",this.hideIcon=!1,this.on="",this.customValidationMessage="",this.eager=!1,this.internalRevalidate=e=>{e.currentTarget.validity?.valid&&(this.validationMessage="")},this.validate=e=>{if(Vt(e.type)&&this.variant==="native"&&this.isInternalTriggeredInvalid===!0){this.isInternalTriggeredInvalid=!1;return}Vt(e.type)&&this.variant!=="native"&&(e.preventDefault(),e.stopPropagation());const t=e.currentTarget;if(this.isValid=t.validity?.valid,this.eager&&this.eagerFirstMount){this.eagerFirstMount=!1,this.setValidationMessage(t);return}!this.isValid&&!Cn(e.type)&&this.handleFocus(t),this.setValidationMessage(t),!Cn(e.type)&&this.variant==="native"&&this.updateComplete.then(()=>{this.isInternalTriggeredInvalid=!0,t.reportValidity()})}}static{this.styles=[w,Er]}static{this.dependencies={"syn-alert":be}}handleListenerChange(){this.updateEvents()}async handleEagerChange(){if(this.eager){const e=this.getInput();await this.updateComplete,e?.reportValidity(),this.eagerFirstMount=!0}else this.eagerFirstMount=!1}handleCustomValidationMessageChange(){const e=this.getInput();e&&(this.setCustomValidationMessage(e),this.setValidationMessage(e))}getValidity(){return this.isValid}getInput(){const e=this.slottedChildren[0];return e||void 0}getUsedEventNames(){const e=this.getInput();if(!e)return[];const t=zr(this.on),[...n]=t.filter(Boolean);return n.includes("invalid")||n.push("invalid"),n.includes("live")&&(n.push("input"),n.push("blur")),Array.from(new Set(n.filter(i=>i!=="live").map(i=>Sn(e,i))))}updateEvents(){this.controller.abort(),this.controller=new AbortController;const e=this.getInput();if(!e)return;const t=this.getUsedEventNames();t.forEach(i=>{e.addEventListener(i,this.validate,{capture:Vt(i),signal:this.controller.signal})});const n=Sn(e,"change");t.includes(n)||e.addEventListener(n,this.internalRevalidate,{signal:this.controller.signal})}setValidationMessage(e){const{customValidationMessage:t}=this,n=t||e.validationMessage;this.validationMessage=n}setCustomValidationMessage(e){e.setCustomValidity(this.customValidationMessage)}handleFocus(e){const t=document.activeElement,n=t.closest("syn-validate");!t.validity?.valid&&n||(e.scrollIntoView({block:"nearest"}),e.focus())}async firstUpdated(){if(this.updateEvents(),this.eager){const e=this.getInput();await this.updateComplete,this.isValid=e?.validity?.valid??!1,e?.reportValidity()}}disconnectedCallback(){super.disconnectedCallback(),this.controller.abort()}renderInlineValidation(){return this.variant!=="inline"||!this.validationMessage?"":p`
      <syn-alert
        open
    ...
    `}}fe([On()],pe.prototype,"slottedChildren",2);fe([g()],pe.prototype,"validationMessage",2);fe([g()],pe.prototype,"eagerFirstMount",2);fe([g()],pe.prototype,"isInternalTriggeredInvalid",2);fe([g()],pe.prototype,"isValid",2);fe([r({reflect:!0})],pe.prototype,"variant",2);fe([r({attribute:"hide-icon",reflect:!0,type:Boolean})],pe.prototype,"hideIcon",2);fe([r({reflect:!0})],pe.prototype,"on",2);fe([r({attribute:"custom-validation-message",type:String})],pe.prototype,"customValidationMessage",2);fe([r({type:Boolean})],pe.prototype,"eager",2);fe([m("on",{waitUntilFirstUpdate:!0})],pe.prototype,"handleListenerChange",1);fe([m("eager",{waitUntilFirstUpdate:!1})],pe.prototype,"handleEagerChange",1);fe([m("customValidationMessage",{waitUntilFirstUpdate:!0})],pe.prototype,"handleCustomValidationMessageChange",1);pe.define("syn-validate");function Dr(a){const e=typeof window<"u"&&window;return!!(e&&(/Chromatic/.test(e.navigator.userAgent)||/chromatic=true/.test(e.location.href)))}const Nr=(a,...e)=>Dr()?p`
      <style>
      :root {
 ...
 */`,dependencies:["syn-alert"]}],exports:[{kind:"js",name:"default",declaration:{name:"SynValidate",module:"../components/src/components/validate/validate.js"}}]}],package:{author:{name:"SICK Global UX Foundation",url:"https://www.sick.com"},description:"",homepage:"https://synergy-design-system.github.io",license:"MIT",name:"@synergy-design-system/components",version:"2.15.1"}},Lr={modules:[{declarations:[{attributes:[{default:"'syn-link--small'",description:"The size of the link",name:"syn-link",type:{text:"'syn-link--small' | 'syn-link--medium' | 'syn-link--large'"}},{default:"false",description:"Applies the quiet link styling",name:"syn-link--quiet",type:{text:"boolean"}},{default:"false",description:"Applies the disabled link styling",name:"syn-link--disabled",type:{text:"boolean"}}],customElement:!0,kind:"class",members:[{attribute:"syn-link",default:"'syn-link--small'",description:"The size of the link",kind:"field",name:"syn-link",type:{text:"'syn-link--small' | 'syn-link--medium' | 'syn-link--large'"}},{attribute:"syn-link--quiet",default:"false",description:"Applies the quiet link styling",kind:"field",name:"syn-link--quiet",type:{text:"boolean"}},{attribute:"syn-link--disabled",default:"false",description:"Applies the disabled link styling",kind:"field",name:"syn-link--disabled",type:{text:"boolean"}}],name:"syn-link",slots:[{description:"Main content of syn-link",name:""}],tagName:"syn-link",tagNameWithoutPrefix:"link"}],description:"The size of the link",kind:"javascript-module",path:"../styles/src/link/index.css"},{declarations:[{attributes:[{default:"'syn-link-list--medium'",description:"The size of the link list",name:"syn-link-list",type:{text:"'syn-link-list--medium' | 'syn-link-list--small' | 'syn-link-list--large'"}},{default:"false",description:"Applies horizontal styling to the link list",name:"syn-link-list--horizontal",type:{text:"boolean"}}],customElement:!0,kind:"class",members:[{attribute:"syn-link-list",default:"'syn-link-list--medium'",description:"The size of the link list",kind:"field",name:"syn-link-list",type:{text:"'syn-link-list--medium' | 'syn-link-list--small' | 'syn-link-list--large'"}},{attribute:"syn-link-list--horizontal",default:"false",description:"Applies horizontal styling to the link list",kind:"field",name:"syn-link-list--horizontal",type:{text:"boolean"}}],name:"syn-link-list",slots:[{description:"Main content of syn-link-list",name:""}],tagName:"syn-link-list",tagNameWithoutPrefix:"link-list"}],description:"The size of the link list",kind:"javascript-module",path:"../styles/src/link-list/index.css"},{declarations:[{attributes:[{default:"true",description:"Applies the table cell styling",name:"syn-table-cell",type:{text:"boolean"}},{default:"false",description:"Applies an alternating style to help separate rows visually",name:"syn-table-cell--alternating",type:{text:"boolean"}},{default:"false",description:"Applies a border to the left of the table cell",name:"syn-table-cell--border-start",type:{text:"boolean"}},{default:"false",description:"Applies a border to the right of the table cell",name:"syn-table-cell--border-end",type:{text:"boolean"}},{default:"false",description:"Applies a border to the top of the table cell",name:"syn-table-cell--border-top",type:{text:"boolean"}},{default:"false",description:"Applies a border to the bottom of the table cell",name:"syn-table-cell--border-bottom",type:{text:"boolean"}},{default:"false",description:"Applies the table cell header styling",name:"syn-table-cell--header",type:{text:"boolean"}},{default:"",description:"Applies the selected shadow to the table cell",name:"syn-table-cell--shadow",type:{text:" | 'syn-table-cell--shadow-bottom' | 'syn-table-cell--shadow-top' | 'syn-table-cell--shadow-start' | 'syn-table-cell--shadow-end'"}},{default:"false",description:"Displays the table shadow",name:"syn-table-cell--shadow-active",type:{text:"boolean"}}],customElement:!0,kind:"class",members:[{attribute:"syn-table-cell",default:"true",description:"Applies the table cell styling",kind:"field",name:"syn-table-cell",type:{text:"boolean"}},{attribute:"syn-table-cell--alternating",default:"false",description:"Applies an alternating style to help separate rows visually",kind:"field",name:"syn-table-cell--alternating",type:{text:"boolean"}},{attribute:"syn-table-cell--border-start",default:"false",description:"Applies a border to the left of the table cell",kind:"field",name:"syn-table-cell--border-start",type:{text:"boolean"}},{attribute:"syn-table-cell--border-end",default:"false",description:"Applies a border to the right of the table cell",kind:"field",name:"syn-table-cell--border-end",type:{text:"boolean"}},{attribute:"syn-table-cell--border-top",default:"false",description:"Applies a border to the top of the table cell",kind:"field",name:"syn-table-cell--border-top",type:{text:"boolean"}},{attribute:"syn-table-cell--border-bottom",default:"false",description:"Applies a border to the bottom of the table cell",kind:"field",name:"syn-table-cell--border-bottom",type:{text:"boolean"}},{attribute:"syn-table-cell--header",default:"false",description:"Applies the table cell header styling",kind:"field",name:"syn-table-cell--header",type:{text:"boolean"}},{attribute:"syn-table-cell--shadow",default:"",description:"Applies the selected shadow to the table cell",kind:"field",name:"syn-table-cell--shadow",type:{text:" | 'syn-table-cell--shadow-bottom' | 'syn-table-cell--shadow-top' | 'syn-table-cell--shadow-start' | 'syn-table-cell--shadow-end'"}},{attribute:"syn-table-cell--shadow-active",default:"false",description:"Displays the table shadow",kind:"field",name:"syn-table-cell--shadow-active",type:{text:"boolean"}}],name:"syn-table-cell",slots:[{description:"Main content of syn-table-cell",name:""}],tagName:"syn-table-cell",tagNameWithoutPrefix:"table-cell"}],description:"Applies the table cell styling",kind:"javascript-module",path:"../styles/src/tables/table-cell.css"},{declarations:[{attributes:[{default:"false",description:"Applies the styling to a table element",name:"syn-table",type:{text:"boolean"}},{default:"true",description:"Applies all default table stylings to a table and its children",name:"syn-table--default",type:{text:"boolean"}},{default:"false",description:"Applies all alternate table stylings to a table and its children",name:"syn-table--alternating",type:{text:"boolean"}},{default:"false",description:"Applies all border table stylings to a table and its children",name:"syn-table--border",type:{text:"boolean"}}],customElement:!0,kind:"class",members:[{attribute:"syn-table",default:"false",description:"Applies the styling to a table element",kind:"field",name:"syn-table",type:{text:"boolean"}},{attribute:"syn-table--default",default:"true",description:"Applies all default table stylings to a table and its children",kind:"field",name:"syn-table--default",type:{text:"boolean"}},{attribute:"syn-table--alternating",default:"false",description:"Applies all alternate table stylings to a table and its children",kind:"field",name:"syn-table--alternating",type:{text:"boolean"}},{attribute:"syn-table--border",default:"false",description:"Applies all border table stylings to a table and its children",kind:"field",name:"syn-table--border",type:{text:"boolean"}}],name:"syn-table",slots:[{description:"Main content of syn-table",name:""}],tagName:"syn-table",tagNameWithoutPrefix:"table"}],description:"Applies the styling to a table element",kind:"javascript-module",path:"../styles/src/tables/table.css"},{declarations:[{attributes:[{default:"'syn-body--x-small'",description:"The font size of the body text",name:"syn-body",type:{text:"'syn-body--x-small' | 'syn-body--small' | 'syn-body--medium' | 'syn-body--large'"}}],customElement:!0,kind:"class",members:[{attribute:"syn-body",default:"'syn-body--x-small'",description:"The font size of the body text",kind:"field",name:"syn-body",type:{text:"'syn-body--x-small' | 'syn-body--small' | 'syn-body--medium' | 'syn-body--large'"}}],name:"syn-body",slots:[{description:"Main content of syn-body",name:""}],tagName:"syn-body",tagNameWithoutPrefix:"body"}],description:"The font size of the body text",kind:"javascript-module",path:"../styles/src/typography/body.css"},{declarations:[{attributes:[{default:"'syn-heading--3x-large'",description:"The size of the headline",name:"syn-heading",type:{text:"'syn-heading--3x-large' | 'syn-heading--2x-large' | 'syn-heading--x-large' | 'syn-heading--large'"}}],customElement:!0,kind:"class",members:[{attribute:"syn-heading",default:"'syn-heading--3x-large'",description:"The size of the headline",kind:"field",name:"syn-heading",type:{text:"'syn-heading--3x-large' | 'syn-heading--2x-large' | 'syn-heading--x-large' | 'syn-heading--large'"}}],name:"syn-heading",slots:[{description:"Main content of syn-heading",name:""}],tagName:"syn-heading",tagNameWithoutPrefix:"heading"}],description:"The size of the headline",kind:"javascript-module",path:"../styles/src/typography/heading.css"},{declarations:[{attributes:[{default:"'syn-weight--normal'",description:"The font weight to apply",name:"syn-weight",type:{text:"'syn-weight--normal' | 'syn-weight--semibold' | 'syn-weight--bold'"}}],customElement:!0,kind:"class",members:[{attribute:"syn-weight",default:"'syn-weight--normal'",description:"The font weight to apply",kind:"field",name:"syn-weight",type:{text:"'syn-weight--normal' | 'syn-weight--semibold' | 'syn-weight--bold'"}}],name:"syn-weight",slots:[{description:"Main content of syn-weight",name:""}],tagName:"syn-weight",tagNameWithoutPrefix:"weight"}],description:"The font weight to apply",kind:"javascript-module",path:"../styles/src/typography/weight.css"}],readme:"",schemaVersion:"1.0.0"};Xi({hideArgRef:!0,hideScriptTag:!0});ut.modules&&(ut.modules=ut.modules.map(a=>(a.declarations&&(a.declarations=a.declarations.map(e=>(e.members&&(e.members=e.members.filter(t=>t.description&&t.privacy!=="private")),e))),a)));const jr={...ut,modules:[...ut.modules,...Lr.modules]};Si(jr);console.log("Custom elements manifest loaded for components and styles");const Ut=a=>{const{args:e,events:t,argTypes:n}=Fn(a),i=An(a,window.__STORYBOOK_CUSTOM_ELEMENTS_MANIFEST__),o=()=>({status:{styles:{backgroundColor:i?.status==="stable"?"#43b02a":"rgb(255, 131, 0)",borderColor:"white",color:"white"},title:`Status: ${i?.status}`},since:{styles:{backgroundColor:"#333",borderColor:"#fff",color:"#fff"},title:`Since: ${i?.since}`}});return{args:e,argTypes:(()=>{for(const d in n)n.hasOwnProperty(d)&&n[d].table&&n[d].table.category==="properties"&&(n[d].control={disabled:!0});return{...n,...i?.events?.reduce((d,c)=>(d[c.name]={...c,control:!1,table:{category:"Events"}},d),{}),...i?.members?.filter(d=>d.kind==="method").reduce((d,c)=>(d[c.name]={...c,control:!1,table:{category:"Methods"}},d),{})}})(),parameters:{badges:["status","since"],badgesConfig:o(),actions:{handles:t}}}},Je=a=>({getSuffixFromType:e=>({attribute:"",property:"-prop",slot:"-slot",cssPart:"-part",cssProperty:""})[e],getValuesFromAttribute:e=>{e.endsWith("-attr")||(e=`${e}-attr`);const{argTypes:t}=Ut(a);return t[e]?.control?.type==="boolean"?[!0,!1]:t[e].options},getValuesFromAttributes:e=>e?.map(t=>(t.endsWith("-attr")||(t=`${t}-attr`),{name:t,values:Je(a).getValuesFromAttribute(t)})),overrideArgs:(e,t)=>{const n=t||Ut(a).args,i=Array.isArray(e)?e:[e];for(const o of i){const s=Je(a).getSuffixFromType(o.type);n[`${o.name}${s}`]=o.value}return n}}),el=a=>{const{template:e,manifest:t}=Fn(a),{args:n}=Ut(a),{getValuesFromAttribute:i}=Je(a);return{generateTemplate:({axis:s,constants:l=[],options:d,args:c=n})=>{const y=x=>{if(!t?.style)return e(x);const M=Object.keys(x).filter(L=>L.endsWith("-attr")).reduce((L,we)=>{const he=we.substring(0,we.length-5);return x[we]===!0?L[he]=!0:x[we]==="false"||x[we]==="(default)"?L[he]=!1:x[we]&&(he.endsWith("...")?L[he.replace("...",x[we])]=!0:L[x[we]]=!0),L},{}),Pe=x["default-slot"]||"",Re={[a]:!0,...M},at=Object.keys(Re).filter(L=>Re[L]).join(" ");if(d?.templateContent){const L=d.templateContent.replaceAll("%SLOT%",Pe).replaceAll("%CLASSES%",at);return te(L)}return k`<div class=${f(Re)}>${te(Pe)}</div>`},_=(Array.isArray(l)?l:[l]).reduce((x,M)=>({...x,[`${M.name}${Je(a).getSuffixFromType(M.type)}`]:M.value}),{});if(!s?.x&&!s?.y&&!d?.title)return k`${y({...c,..._})}`;const K=x=>x?Array.isArray(x)?x.map(M=>({...M,values:M.values||i(M.name)})):[{...x,values:x.values||i(x.name)}]:[{}],Be=K(s?.x),Ae=K(s?.y),xt=(Array.isArray(l)?l:[l]).find(x=>x.type==="template")?.value,kt=`uuid-${crypto.randomUUID()}`;return k`
      ...
      ${Be.map(x=>k` ${Ae.map(M=>{let Pe=!0;const Re=Be.length>1||x.values,at=(x&&M||Ae.length>1)&&M?.values;return k`
                    ...
                    <tr class="template-row">
                      ...
                      ${(x?.values||[""]).map(he=>k`
                          ...
                          ${xt&&te(xt.split("%TEMPLATE%")[0]||"")||""}
                            ${y({...c,..._,...x&&x.type!=="template"&&{[`${x.name}${Je(a).getSuffixFromType(x.type)}`]:he.hasOwnProperty("value")?he.value:he},...M&&M.type!=="template"&&{[`${M.name}${Je(a).getSuffixFromType(M.type)}`]:L.hasOwnProperty("value")?L.value:L}})}
          ...
          `})}`)}
    `}}},Fr={codeOptimizer:a=>{const{body:e}=new DOMParser().parseFromString(a,"text/html"),t=e.querySelectorAll(".template");let n="";return t.length?n=Array.from(t).map(i=>i.innerHTML).join(`
`):n=e.innerHTML,n=n.replace(/<style><\/style>/g,"").replace(/<!-- preview-ignore:start -->[\s\S]*?<!-- preview-ignore:end -->/g,"").replace(/\/\/ preview-ignore:start[\s\S]*?\/\/ preview-ignore:end/g,"").replace(/<style>\n<\/style>/g,"").replace(/<script>\s*component = document\.querySelector\('(.+?)'\);\s*<\/script>/g,""),n}},tl=(a,e)=>{const t=cn?.components?.[a]?.[e]?.description?.value??"No Description",n=cn?.components?.[a]?.[e]?.note?.value??"",i=t.replace(/\n/g,"<br/>"),o=n.length>0?`

  > **👨‍💻 Additional developer Information**:<br>
  > ${n.replace(/\n/g,"<br/>")}`:n;return`${i}${o}`},nl=(a,e=150)=>{const t=isNaN(e)?e:{heightPx:e},{afterRender:n="",additionalChromaticOptions:i={},heightPx:o=150,styleHeading:s={}}=t,l=Object.entries(s).map(([d,c])=>`${d}: ${c};`).join(" ");return{parameters:{chromatic:{...di?.parameters?.chromatic,...i,disableSnapshot:!1},docs:{disable:!0}},render:(d,c)=>k`
      ${Object.entries(a).map(([y,_])=>{const K=_.name??zi(y);return k`
      ...
      `})}
      ${n}
    `}};export{el as a,tl as b,nl as c,Je as d,Zr as e,Ar as g,Jr as h,Dr as i,di as p,Ut as s};
