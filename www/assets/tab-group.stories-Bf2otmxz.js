import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{_ as t,a as n,d as r,o as i,s as a,y as o}from"./preview-DdzcclEm.js";import{c as s,t as c}from"./lit-BfcklOOD.js";import{i as l,n as u}from"./dist-CHjk4Jxm.js";import{t as d}from"./icon-8cT1hKpd.js";import{a as f,i as p,n as m,o as h,r as g,t as _}from"./component-BjD7AuVi.js";import{n as v,t as y}from"./taggedTemplateLiteral-C9cDEsPD.js";import{n as b,t as x}from"./tab-panel-CnyaIXhI.js";import{t as S}from"./tab-B9S2KBI7.js";var C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y=e((()=>{b(),S(),x(),d(),c(),u(),t(),g(),i(),r(),v(),{args:w,argTypes:T}=p(`syn-tab-group`),{overrideArgs:E}=f(`syn-tab-group`),{generateTemplate:D}=h(`syn-tab-group`),O=(e,t,{active:n=!1,closable:r=!1,disabled:i=!1}={})=>`<syn-tab slot="nav" panel="${e}" ${n?`active`:``} ${i?`disabled`:``} ${r?`closable`:``}>${t}</syn-tab>`,k=(e,t,{active:n=!1,closable:r=!1,disabled:i=!1}={})=>o(O(e,t,{active:n,closable:r,disabled:i})),A=()=>[{panel:`general`,props:{active:!0}},{panel:`custom`},{panel:`advanced`},{panel:`disabled`,props:{disabled:!0}}].map(({panel:e,props:t})=>O(e,l(e),t)).join(`
`),j=()=>o(A()),M=(e,t,n=!1)=>`<syn-tab-panel name="${e}" ${n?`active`:``}>${t}</syn-tab-panel>`,N=(e,t,n=!1)=>o(M(e,t,n)),P=()=>[`general`,`custom`,`advanced`,`disabled`].map((e,t)=>M(e,`This is the ${e} tab panel.`,t===0)).join(`
`),F=(e,t=!1)=>s`
...
`,L=()=>o(P()),R={args:E([{name:`default`,type:`slot`,value:P()},{name:`nav`,type:`slot`,value:A()}],w),argTypes:T,component:`syn-tab-group`,parameters:{chromatic:{modes:a},design:n(`42207-338578`),docs:{description:{component:m(`tab-group`,`default`)}}},tags:[`Navigation`],title:`Components/syn-tab-group`},z={parameters:{docs:{description:{story:m(`tab-group`,`default`)}}},render:e=>D({args:e})},B={parameters:{docs:{description:{story:m(`tab-group`,`start`)}}},render:()=>s`
  <syn-tab-group placement="start">
    ${j()}
    ${L()}
  </syn-tab-group>
  `},V={parameters:{docs:{description:{story:m(`tab-group`,`end`)}}},render:()=>s`
  <syn-tab-group placement="end">
    ${j()}
    ${L()}
  </syn-tab-group>
`},H={parameters:{docs:{description:{story:m(`tab-group`,`closable`)}}},render:()=>s(C||=y([`
  ...
  `},W={parameters:{docs:{description:{story:m(`tab-group`,`hierachy`)}}},render:()=>s`
  ...
  `},G={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:m(`tab-group`,`manuel`)}}},play:({canvasElement:e})=>{e.querySelector(`syn-tab[panel="general"]`)?.focus()},render:()=>s` 
    <syn-tab-group activation="manual">
      ${j()}
      ${L()}
    </syn-tab-group>
  `},K={parameters:{docs:{description:{story:m(`tab-group`,`icon`)}}},render:()=>s`
  <syn-tab-group>
