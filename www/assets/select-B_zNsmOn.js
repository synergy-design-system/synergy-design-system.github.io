import{s as _,a as y,g as f,b as g}from"./animation-registry-DyRYqZdt.js";import{e as b}from"./class-map-BV1AMrtw.js";import{F as w}from"./form-d9hCJUdr.js";import{H as C}from"./slot-9EVoRGQc.js";import{v as x,c as p,o as O}from"./iframe-hf7datPi.js";import{L as S}from"./localize-Dh03wnLC.js";import{c as k,n as r,S as z}from"./synergy-element-MbvDzJcB.js";import{S as D,r as d}from"./icon.component-C5ndyS-D.js";import{a as h}from"./query-D0jTsbLw.js";import{s as I}from"./scroll-DgKSCJoS.js";import{w as v}from"./event-B0iVuGLD.js";import{w as u}from"./watch-CEsCE2EF.js";import{f as $,a as T}from"./form-control.custom.styles-C54QgADS.js";import{S as V}from"./popup.component-j-BGeXcJ.js";import{S as L}from"./tag.component-Dh5jargl.js";import{s as A,i as m,c as E}from"./option-B0-G_ORf.js";import{e as H}from"./decorator-UnohHU6S.js";const F=x`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`,P=x`
  ...
  ${A}
`;var U=Object.defineProperty,M=Object.getOwnPropertyDescriptor,l=(e,t,s,a)=>{for(var o=a>1?void 0:a?M(t,s):t,c=e.length-1,n;c>=0;c--)(n=e[c])&&(o=(a?n(t,s,o):n(o))||o);return a&&o&&U(t,s,o),o};let i=class extends z{constructor(){super(...arguments),this.formControlController=new w(this,{assumeInteractionOn:["syn-blur","syn-input"]}),this.hasSlotController=new C(this,"help-text","label"),this.localize=new S(this),this.typeToSelectString="",this.isUserInput=!1,this.hasFocus=!1,this.displayLabel="",this.selectedOptions=[],this.valueHasChanged=!1,this.delimiter=" ",this.name="",this._value="",this.defaultValue="",this.size="medium",this.placeholder="",this.multiple=!1,this.maxOptionsVisible=3,this.disabled=!1,this.clearable=!1,this.open=!1,this.label="",this.placement="bottom",this.helpText="",this.form="",this.required=!1,this.getTag=e=>p`
      <syn-tag
        part="tag"
        exportparts="
              base:tag__base,
