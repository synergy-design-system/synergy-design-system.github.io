import{a as d}from"./static-gmWA-8Kq.js";import{i as m,x as g}from"./directive-helpers-DGrfjhaU.js";import{L as v}from"./localize-CatY2peN.js";import{n as c}from"./property-BGzwfL48.js";import{c as y,S as u}from"./component.styles-Do19GEOY.js";import{S as p}from"./icon-button.component-BGixvALP.js";import{e as h}from"./decorator-DANECR0-.js";const b=m`
	/* stylelint-disable */
  :host {
...
`;var z=Object.defineProperty,_=Object.getOwnPropertyDescriptor,o=(l,t,s,n)=>{for(var e=n>1?void 0:n?_(t,s):t,r=l.length-1,i;r>=0;r--)(i=l[r])&&(e=(n?i(t,s,e):i(e))||e);return n&&e&&z(t,s,e),e};let a=class extends u{constructor(){super(...arguments),this.localize=new v(this),this.size="medium",this.removable=!1}handleRemoveClick(){this.emit("syn-remove")}render(){return g`
      <span
        part="base"
    ...
    `}};a.styles=[y,b,f];a.dependencies={"syn-icon-button":p};o([c({reflect:!0})],a.prototype,"size",2);o([c({type:Boolean})],a.prototype,"removable",2);a=o([h("SynTag")],a);export{a as S};
