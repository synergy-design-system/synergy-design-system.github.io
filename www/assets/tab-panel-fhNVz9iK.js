import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{c as t,h as n,t as r}from"./lit-D4-0ovri.js";import{a as i,d as a,l as o,n as s,o as c,r as l,s as u,t as d}from"./synergy-element-Di-hMrpy.js";import{n as f}from"./event-options-CDwceuuz.js";import{t as p}from"./query-DOHNhzf6.js";import{n as m}from"./query-assigned-elements-CWXdehfi.js";import{n as h,t as g}from"./class-map-LsJiuvgY.js";import{n as _,t as v}from"./localize-Du3bqz3O.js";import{n as y}from"./watch-Q8hEwzVb.js";import{r as b,t as x}from"./scroll-CAqkVgC4.js";import{n as S,t as C}from"./icon-button.component-DzTeGtG4.js";var w,T;function E(){return(E=e((()=>{w=(e,t)=>{let n=0;return function(...r){window.clearTimeout(n),n=window.setTimeout(()=>{e.call(this,...r)},t)}},T=(e,t,n)=>{let r=e[t];e[t]=function(...e){r.call(this,...e),n.call(this,r,...e)}},(()=>{if(typeof window<`u`&&!(`onscrollend`in window)){let e=new Set,t=new WeakMap,n=t=>{for(let n of t.changedTouches)e.add(n.identifier)},r=t=>{for(let n of t.changedTouches)e.delete(n.identifier)};document.addEventListener(`touchstart`,n,!0),document.addEventListener(`touchend`,r,!0),document.addEventListener(`touchcancel`,r,!0),T(EventTarget.prototype,`addEventListener`,function(n,r){if(r!==`scrollend`)return;let i=w(()=>{e.size?i():this.dispatchEvent(new Event(`scrollend`))},100);n.call(this,`scroll`,i,{passive:!0}),t.set(this,i)}),T(EventTarget.prototype,`removeEventListener`,function(e,n){if(n!==`scrollend`)return;let r=t.get(this);r&&e.call(this,`scroll`,r,{passive:!0})})}})()})))()}var D;function O(){return(O=e((()=>{r(),D=n`
	/* stylelint-disable */
  :host {
    display: contents;
  }
`})))()}var k;function A(){return(A=e((()=>{r(),u(),c(),s(),O(),k=class extends d{constructor(...e){super(...e),this.observedElements=[],this.disabled=!1}static{this.styles=[i,D]}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{this.emit(`syn-resize`,{detail:{entries:e}})}),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}handleSlotChange(){this.disabled||this.startObserver()}startObserver(){let e=this.shadowRoot.querySelector(`slot`);if(e!==null){let t=e.assignedElements({flatten:!0});this.observedElements.forEach(e=>this.resizeObserver.unobserve(e)),this.observedElements=[],t.forEach(e=>{this.resizeObserver.observe(e),this.observedElements.push(e)})}}stopObserver(){this.resizeObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}render(){return t` <slot @slotchange=${this.handleSlotChange}></slot> `}},l([a({type:Boolean,reflect:!0})],k.prototype,`disabled`,void 0),l([y(`disabled`,{waitUntilFirstUpdate:!0})],k.prototype,`handleDisabledChange`,null)})))()}var j;function M(){return(M=e((()=>{r(),j=n`
	/* stylelint-disable */
  :host {
...
`})))()}var N;function P(){return(P=e((()=>{r(),N=n`
...
`})))()}var F;function I(){return(I=e((()=>{E(),g(),u(),r(),v(),x(),c(),s(),S(),A(),M(),P(),F=class extends d{constructor(...e){super(...e),this.focusableTabs=[],this.localize=new _(this),this.hasScrollControls=!1,this.shouldHideScrollStartButton=!1,this.shouldHideScrollEndButton=!1,this.placement=`top`,this.activation=`auto`,this.noScrollControls=!1,this.contained=!1,this.sharp=!1,this.fixedScrollControls=!1,this.scrollOffset=1}static{this.styles=[i,j,N]}static{this.dependencies={"syn-icon-button":C,"syn-resize-observer":k}}connectedCallback(){let e=Promise.all([customElements.whenDefined(`syn-tab`),customElements.whenDefined(`syn-tab-panel`)]);super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>{this.repositionIndicator(),this.updateScrollControls()}),this.mutationObserver=new MutationObserver(e=>{let t=e.filter(({target:e})=>{if(e===this)return!0;if(e.closest(`syn-tab-group`)!==this)return!1;let t=e.tagName.toLowerCase();return t===`syn-tab`||t===`syn-tab-panel`});if(t.length!==0){if(t.some(e=>![`aria-labelledby`,`aria-controls`].includes(e.attributeName))&&setTimeout(()=>this.setAriaLabels()),t.some(e=>e.attributeName===`disabled`))this.syncTabsAndPanels();else if(t.some(e=>e.attributeName===`active`)){let e=t.filter(e=>e.attributeName===`active`&&e.target.tagName.toLowerCase()===`syn-tab`).map(e=>e.target).find(e=>e.active);e&&this.setActiveTab(e)}}}),this.updateComplete.then(()=>{this.syncTabsAndPanels(),this.mutationObserver.observe(this,{attributes:!0,attributeFilter:[`active`,`disabled`,`name`,`panel`],childList:!0,subtree:!0}),this.resizeObserver.observe(this.nav),e.then(()=>{new IntersectionObserver((e,t)=>{e[0].intersectionRatio>0&&(this.setAriaLabels(),this.setActiveTab(this.getActiveTab()??this.tabs[0],{emitEvents:!1}),t.unobserve(e[0].target))}).observe(this.tabGroup)})})}disconnectedCallback(){super.disconnectedCallback(),this.mutationObserver?.disconnect(),this.nav&&this.resizeObserver?.unobserve(this.nav)}getActiveTab(){return this.tabs.find(e=>e.active)}handleClick(e){let t=e.target.closest(`syn-tab`);t?.closest(`syn-tab-group`)===this&&t!==null&&this.setActiveTab(t,{scrollBehavior:`smooth`})}handleKeyDown(e){let t=e.target.closest(`syn-tab`);if(t?.closest(`syn-tab-group`)===this&&([`Enter`,` `].includes(e.key)&&t!==null&&(this.setActiveTab(t,{scrollBehavior:`smooth`}),e.preventDefault()),[`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`Home`,`End`].includes(e.key))){let t=this.tabs.find(e=>e.matches(`:focus`)),n=this.localize.dir()===`rtl`,r=null;if(t?.tagName.toLowerCase()===`syn-tab`){if(e.key===`Home`)r=this.focusableTabs[0];else if(e.key===`End`)r=this.focusableTabs[this.focusableTabs.length-1];else if([`top`].includes(this.placement)&&e.key===(n?`ArrowRight`:`ArrowLeft`)||[`start`,`end`].includes(this.placement)&&e.key===`ArrowUp`){let e=this.tabs.findIndex(e=>e===t);r=this.findNextFocusableTab(e,`backward`)}else if([`top`].includes(this.placement)&&e.key===(n?`ArrowLeft`:`ArrowRight`)||[`start`,`end`].includes(this.placement)&&e.key===`ArrowDown`){let e=this.tabs.findIndex(e=>e===t);r=this.findNextFocusableTab(e,`forward`)}if(!r)return;r.tabIndex=0,r.focus({preventScroll:!0}),this.activation===`auto`?this.setActiveTab(r,{scrollBehavior:`smooth`}):this.tabs.forEach(e=>{e.tabIndex=e===r?0:-1}),[`top`].includes(this.placement)&&b(r,this.nav,`horizontal`),e.preventDefault()}}}handleScrollToStart(){this.nav.scroll({left:this.localize.dir()===`rtl`?this.nav.scrollLeft+this.nav.clientWidth:this.nav.scrollLeft-this.nav.clientWidth,behavior:`smooth`})}handleScrollToEnd(){this.nav.scroll({left:this.localize.dir()===`rtl`?this.nav.scrollLeft-this.nav.clientWidth:this.nav.scrollLeft+this.nav.clientWidth,behavior:`smooth`})}setActiveTab(e,t){if(t={emitEvents:!0,scrollBehavior:`auto`,...t},e!==this.activeTab&&!e.disabled){let n=this.activeTab;this.activeTab=e,this.tabs.forEach(e=>{e.active=e===this.activeTab,e.tabIndex=e===this.activeTab?0:-1}),this.panels.forEach(e=>e.active=e.name===this.activeTab?.panel),this.syncIndicator(),[`top`].includes(this.placement)&&b(this.activeTab,this.nav,`horizontal`,t.scrollBehavior),t.emitEvents&&(n&&this.emit(`syn-tab-hide`,{detail:{name:n.panel}}),this.emit(`syn-tab-show`,{detail:{name:this.activeTab.panel}}))}}setAriaLabels(){this.tabs.forEach(e=>{let t=this.panels.find(t=>t.name===e.panel);t&&(e.setAttribute(`aria-controls`,t.getAttribute(`id`)),t.setAttribute(`aria-labelledby`,e.getAttribute(`id`)))})}repositionIndicator(){let e=this.getActiveTab();if(!e)return;let t=e.clientWidth,n=e.clientHeight,r=this.localize.dir()===`rtl`,i=this.tabs.slice(0,this.tabs.indexOf(e)).reduce((e,t)=>({left:e.left+t.clientWidth,top:e.top+t.clientHeight}),{left:0,top:0});switch(this.placement){case`top`:this.indicator.style.width=`calc(${t}px - ${this.contained||this.sharp?`2 * var(--syn-spacing-large)`:`0px`})`,this.indicator.style.height=`auto`,this.indicator.style.translate=`calc(${r?`-`:``}1 * (${i.left}px + ${this.contained||this.sharp?`var(--syn-spacing-large)`:`0px`}))`;break;case`start`:case`end`:this.indicator.style.width=`auto`,this.indicator.style.height=`calc(${n}px - ${this.contained||this.sharp?`2 * var(--syn-spacing-small)`:`0px`})`,this.indicator.style.translate=`0 calc(${i.top}px + ${this.contained||this.sharp?`var(--syn-spacing-small)`:`0px`})`}}syncTabsAndPanels(){this.focusableTabs=this.tabs.filter(e=>!e.disabled),this.syncIndicator(),this.updateComplete.then(()=>this.updateScrollControls())}findNextFocusableTab(e,t){let n=null,r=t===`forward`?1:-1,i=e+r;for(;e<this.tabs.length;){if(n=this.tabs[i]||null,n===null){n=t===`forward`?this.focusableTabs[0]:this.focusableTabs[this.focusableTabs.length-1];break}if(!n.disabled)break;i+=r}return n}updateScrollButtons(){this.hasScrollControls&&!this.fixedScrollControls&&(this.shouldHideScrollStartButton=this.scrollFromStart()<=this.scrollOffset,this.shouldHideScrollEndButton=this.isScrolledToEnd())}isScrolledToEnd(){return this.scrollFromStart()+this.nav.clientWidth>=this.nav.scrollWidth-this.scrollOffset}scrollFromStart(){return this.localize.dir()===`rtl`?-this.nav.scrollLeft:this.nav.scrollLeft}updateScrollControls(){this.hasScrollControls=!this.noScrollControls&&[`top`].includes(this.placement)&&this.nav.scrollWidth>this.nav.clientWidth+1,this.updateScrollButtons()}syncIndicator(){this.getActiveTab()?(this.indicator.style.display=`block`,this.repositionIndicator()):this.indicator.style.display=`none`}show(e){let t=this.tabs.find(t=>t.panel===e);t&&this.setActiveTab(t,{scrollBehavior:`smooth`})}preventFocus(e){e.preventDefault()}render(){let e=this.localize.dir()===`rtl`;return t`
    ...
    `}},l([m({slot:`nav`,selector:`syn-tab`})],F.prototype,`tabs`,void 0),l([m({selector:`syn-tab-panel`})],F.prototype,`panels`,void 0),l([p(`.tab-group`)],F.prototype,`tabGroup`,void 0),l([p(`.tab-group__body`)],F.prototype,`body`,void 0),l([p(`.tab-group__nav`)],F.prototype,`nav`,void 0),l([p(`.tab-group__indicator`)],F.prototype,`indicator`,void 0),l([o()],F.prototype,`hasScrollControls`,void 0),l([o()],F.prototype,`shouldHideScrollStartButton`,void 0),l([o()],F.prototype,`shouldHideScrollEndButton`,void 0),l([a()],F.prototype,`placement`,void 0),l([a()],F.prototype,`activation`,void 0),l([a({attribute:`no-scroll-controls`,type:Boolean})],F.prototype,`noScrollControls`,void 0),l([a({type:Boolean})],F.prototype,`contained`,void 0),l([a({type:Boolean})],F.prototype,`sharp`,void 0),l([a({attribute:`fixed-scroll-controls`,type:Boolean})],F.prototype,`fixedScrollControls`,void 0),l([f({passive:!0})],F.prototype,`updateScrollButtons`,null),l([y(`noScrollControls`,{waitUntilFirstUpdate:!0})],F.prototype,`updateScrollControls`,null),l([y(`placement`,{waitUntilFirstUpdate:!0})],F.prototype,`syncIndicator`,null)})))()}function L(){return(L=e((()=>{I(),F.define(`syn-tab-group`)})))()}var R;function z(){return(z=e((()=>{r(),R=n`
	/* stylelint-disable */
  :host {
    --padding: 0;
...
`})))()}var B;function V(){return(V=e((()=>{r(),B=n`
  /* Write custom CSS here */
  .tab-panel {
    color: var(--syn-typography-color-text);
  }
`})))()}var H,U;function W(){return(W=e((()=>{g(),r(),u(),c(),s(),z(),V(),H=0,U=class extends d{constructor(...e){super(...e),this.attrId=++H,this.componentId=`syn-tab-panel-${this.attrId}`,this.name=``,this.active=!1}static{this.styles=[i,R,B]}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute(`role`,`tabpanel`)}handleActiveChange(){this.setAttribute(`aria-hidden`,this.active?`false`:`true`)}render(){return t`
      <slot
        part="base"
        class=${h({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}},l([a({reflect:!0})],U.prototype,`name`,void 0),l([a({type:Boolean,reflect:!0})],U.prototype,`active`,void 0),l([y(`active`)],U.prototype,`handleActiveChange`,null)})))()}function G(){return(G=e((()=>{W(),U.define(`syn-tab-panel`)})))()}export{L as n,G as t};