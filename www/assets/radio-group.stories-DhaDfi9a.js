import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-DRz18Lsn.js";import{c as i,t as a}from"./lit-D4-0ovri.js";import{t as o}from"./button-CBC8ywKX.js";import{a as s,i as c,n as l,o as u,r as d,t as f}from"./component-NnlguzJ1.js";import{n as p,t as m}from"./decorators-CjBNNcov.js";import{t as h}from"./radio-group-DJvxANR_.js";import{t as g}from"./radio-button-geQEEhQx.js";import{t as _}from"./radio-DPlqVVEm.js";var v=t({Checked:()=>O,CustomValidity:()=>F,Default:()=>E,Disabled:()=>j,Focus:()=>A,HelpText:()=>k,HorizontalLayout:()=>L,Invalid:()=>P,Labels:()=>D,RadioButtons:()=>I,Readonly:()=>M,Screenshot:()=>R,Sizes:()=>N,__namedExportsOrder:()=>z,default:()=>w}),y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z;function B(){return(B=e((()=>{h(),_(),g(),o(),a(),m(),d(),r(),{userEvent:y}=__STORYBOOK_MODULE_TEST__,{args:b,argTypes:x}=c(`syn-radio-group`),{overrideArgs:S}=s(`syn-radio-group`),{generateTemplate:C}=u(`syn-radio-group`),w={args:b,argTypes:x,component:`syn-radio-group`,parameters:{chromatic:{modes:n},docs:{description:{component:l(`radio-group`,`default`)}}},tags:[`Form`],title:`Components/syn-radio-group`},T=e=>`${e[0].toUpperCase()}${e.slice(1)}`,E={args:S([{name:`label`,type:`attribute`,value:`This is a label`},{name:`default`,type:`slot`,value:`<syn-radio value="1">Option</syn-radio>
  ...
  `},R=f({Default:E,Labels:D,Checked:O,HelpText:k,Disabled:j,Readonly:M,Sizes:N,RadioButtons:I,HorizontalLayout:L},400),z=[`Default`,`Labels`,`Checked`,`HelpText`,`Focus`,`Disabled`,`Readonly`,`Sizes`,`Invalid`,`CustomValidity`,`RadioButtons`,`HorizontalLayout`,`Screenshot`],E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  args: overrideArgs([{
    name: 'label',
    type: 'attribute',
  ...
  RadioButtons,
  HorizontalLayout
}, 400)`,...R.parameters?.docs?.source}}}})))()}export{B as n,v as r,E as t};