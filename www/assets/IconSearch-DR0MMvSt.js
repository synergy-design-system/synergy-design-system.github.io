import{j as we,M as Ri}from"./index-DGU4q6BZ.js";import{useMDXComponents as fi}from"./index-CHrGa5Tm.js";import{b as x,r as pt,R as be}from"./index-_2TAQcTa.js";import{i as d,r as ji,x as u,e as Hi,u as Pt,E as Ui,T as Wi,B as Ki}from"./directive-helpers-Dvm_Ferq.js";import{n as r,b as _,e as m,i as Ee,c as b,o as f,u as se,f as Gi,t as Zi,r as Xi}from"./library-BX4ONXik.js";import{r as yi,L as Yi,a as ot,t as Qi,l as Je,b as Ji,c as eo,f as to,s as io,d as Rt,e as oo,p as wt,g as ao,h as so,i as ro,o as vi,j as no,k as lo,m as po,n as co}from"./ref-B9GS7qLj.js";import{d as At}from"./default-icons--FEJ2Psb.js";import"./iframe-d_ddrN_C.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-BwkS7JH_.js";import"./index-DrFu-skq.js";/**
 * @license
...
`,bi=Object.defineProperty,fo=Object.defineProperties,yo=Object.getOwnPropertyDescriptor,vo=Object.getOwnPropertyDescriptors,Ut=Object.getOwnPropertySymbols,bo=Object.prototype.hasOwnProperty,_o=Object.prototype.propertyIsEnumerable,zt=(e,t)=>(t=Symbol[e])?t:Symbol.for("Symbol."+e),Mt=e=>{throw TypeError(e)},Wt=(e,t,i)=>t in e?bi(e,t,{enumerable:!0,configurable:!0,writable:!0,value:i}):e[t]=i,ge=(e,t)=>{for(var i in t||(t={}))bo.call(t,i)&&Wt(e,i,t[i]);if(Ut)for(var i of Ut(t))_o.call(t,i)&&Wt(e,i,t[i]);return e},Re=(e,t)=>fo(e,vo(t)),o=(e,t,i,a)=>{for(var s=a>1?void 0:a?yo(t,i):t,n=e.length-1,l;n>=0;n--)(l=e[n])&&(s=(a?l(t,i,s):l(s))||s);return a&&s&&bi(t,i,s),s},Ft=(e,t,i)=>t.has(e)||Mt("Cannot "+i),y=(e,t,i)=>(Ft(e,t,"read from private field"),i?i.call(e):t.get(e)),ue=(e,t,i)=>t.has(e)?Mt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,i),oe=(e,t,i,a)=>(Ft(e,t,"write to private field"),t.set(e,i),i),F=(e,t,i)=>(Ft(e,t,"access private method"),i),xo=function(e,t){this[0]=e,this[1]=t},wo=e=>{var t=e[zt("asyncIterator")],i=!1,a,s={};return t==null?(t=e[zt("iterator")](),a=n=>s[n]=l=>t[n](l)):(t=t.call(e),a=n=>s[n]=l=>{if(i){if(i=!1,n==="throw")throw l;return l}return i=!0,{done:!1,value:new xo(new Promise(p=>{var c=t[n](l);c instanceof Object||Mt("Object expected"),p(c)}),1)}}),s[zt("iterator")]=()=>s,a("next"),"throw"in t?a("throw"):s.throw=n=>{throw n},"return"in t&&a("return"),s};function g(e,t){const i=ge({waitUntilFirstUpdate:!1},t);return(a,s)=>{const{update:n}=a,l=Array.isArray(e)?e:[e];a.update=function(p){l.forEach(c=>{const h=c;if(p.has(h)){const k=p.get(h),V=this[h];k!==V&&(!i.waitUntilFirstUpdate||this.hasUpdated)&&this[s](k,V)}}),n.call(this,p)}}}var z=d`
	/* stylelint-disable */
  :host {
...
`,Et="";function Kt(e){Et=e}function Oo(e=""){if(!Et){const t=[...document.getElementsByTagName("script")],i=t.find(a=>a.hasAttribute("data-synergy"));if(i)Kt(i.getAttribute("data-synergy"));else{const a=t.find(n=>/synergy(\.min)?\.js($|\?)/.test(n.src)||/synergy-autoloader(\.min)?\.js($|\?)/.test(n.src));let s="";a&&(s=a.getAttribute("src")),Kt(s.split("/").slice(0,-1).join("/"))}}return Et.replace(/\/$/,"")+(e?`/${e.replace(/^\//,"")}`:"")}var Ao={name:"default",resolver:e=>Oo(`assets/icons/${e}.svg`)},Io=Ao,Gt={add:`
		...
		<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill='currentColor'><path d="M19 6.41L17.59 5L12 10.59L6.41 5L5 6.41L10.59 12L5 17.59L6.41 19L12 13.41L17.59 19L19 17.59L13.41 12L19 6.41Z"/></svg>`},Eo={name:"system",resolver:e=>e in Gt?Gt[e]:""},To=Eo,Lo=[Io,To],Tt=[];function Do(e){Tt.push(e)}function Mo(e){Tt=Tt.filter(t=>t!==e)}function Zt(e){return Lo.find(t=>t.name===e)}var Fo=d`
  /* Write custom CSS here */
`,Vo=d`
	/* stylelint-disable */
  :host {
...
`,ni=(e,t)=>{e.disabled?e.dataset.originallyDisabled="true":delete e.dataset.originallyDisabled,t&&(e.disabled=!0)},Me=class extends v{constructor(){super(...arguments),this.hasSlotController=new G(this,"[default]","prefix","suffix","label"),this.disabled=!1,this.label=""}enableObserver(){this.mutationObserver.observe(this,{attributeFilter:["disabled"],childList:!0,subtree:!0})}connectedCallback(){super.connectedCallback(),this.mutationObserver=new MutationObserver(e=>{const t=e.filter(s=>s.target===this),i=e.filter(s=>s.target.matches("syn-option")),a=t.length>0||i.length>0;a&&this.mutationObserver.disconnect(),i.length>0&&i.forEach(s=>{ni(s.target,this.disabled)}),t.length>0&&t.forEach(s=>{s.type==="attributes"&&this.assignedOptions.forEach(n=>{var l;n.disabled=this.disabled?!0:!!((l=n.dataset)!=null&&l.originallyDisabled)}),s.type==="childList"&&s.addedNodes.forEach(n=>{n instanceof HTMLElement&&n.matches("syn-option")&&ni(n,this.disabled)})}),a&&this.updateComplete.then(()=>{this.enableObserver()})}),this.enableObserver()}render(){const{disabled:e}=this,t=this.hasSlotController.test("label"),i=this.label?!0:!!t;return se`
    ...
    `}};Me.styles=Ya;Me.dependencies={"syn-divider":ke};o([ot({selector:"syn-option"})],Me.prototype,"assignedOptions",2);o([r({reflect:!0,type:Boolean})],Me.prototype,"disabled",2);o([r()],Me.prototype,"label",2);var Qa="syn-optgroup";Me.define("syn-optgroup");w({displayName:"SynOptgroup",elementClass:Me,events:{},react:x,tagName:Qa});var Ja=d`
  /**
...
`,Fe=class extends v{constructor(){super(...arguments),this.localize=new B(this),this.value=0,this.label=""}updated(e){if(super.updated(e),e.has("value")){const t=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),i=2*Math.PI*t,a=i-this.value/100*i;this.indicatorOffset=`${a}px`}}render(){return u`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
    ...
    `}};Fe.styles=[z,ys,fs];o([m(".progress-ring__indicator")],Fe.prototype,"indicator",2);o([_()],Fe.prototype,"indicatorOffset",2);o([r({type:Number,reflect:!0})],Fe.prototype,"value",2);o([r()],Fe.prototype,"label",2);var vs="syn-progress-ring";Fe.define("syn-progress-ring");w({displayName:"SynProgressRing",elementClass:Fe,events:{},react:x,tagName:vs});var Bi=d`
	/* stylelint-disable */
  :host {
    display: inline-block;
    position: relative;
...
`,xe=class extends v{constructor(){super(...arguments),this.hasSlotController=new G(this,"footer"),this.localize=new B(this),this.modal=new Ni(this),this.open=!1,this.label="",this.noHeader=!1,this.handleDocumentKeyDown=e=>{e.key==="Escape"&&this.modal.isActive()&&this.open&&(e.stopPropagation(),this.requestClose("keyboard"))}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),Qe(this))}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate(),qe(this),this.removeOpenListeners()}requestClose(e){if(this.emit("syn-request-close",{cancelable:!0,detail:{source:e}}).defaultPrevented){const i=M(this,"dialog.denyClose",{dir:this.localize.dir()});q(this.panel,i.keyframes,i.options);return}this.hide()}addOpenListeners(){var e;"CloseWatcher"in window?((e=this.closeWatcher)==null||e.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard")):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){var e;(e=this.closeWatcher)==null||e.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),Qe(this);const e=this.querySelector("[autofocus]");e&&e.removeAttribute("autofocus"),await Promise.all([Y(this.dialog),Y(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit("syn-initial-focus",{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute("autofocus","")});const t=M(this,"dialog.show",{dir:this.localize.dir()}),i=M(this,"dialog.overlay.show",{dir:this.localize.dir()});await Promise.all([q(this.panel,t.keyframes,t.options),q(this.overlay,i.keyframes,i.options)]),this.emit("syn-after-show")}else{vt(this),this.emit("syn-hide"),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([Y(this.dialog),Y(this.overlay)]);const e=M(this,"dialog.hide",{dir:this.localize.dir()}),t=M(this,"dialog.overlay.hide",{dir:this.localize.dir()});await Promise.all([q(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),q(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,qe(this);const i=this.originalTrigger;typeof i?.focus=="function"&&setTimeout(()=>i.focus()),this.emit("syn-after-hide")}}async show(){if(!this.open)return this.open=!0,W(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,W(this,"syn-after-hide")}render(){return u`
      <div
        part="base"
