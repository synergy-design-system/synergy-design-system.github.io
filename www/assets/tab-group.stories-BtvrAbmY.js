import{s as G,a as E,g as _,b as t,c as O,d as F}from"./component-C3peM2eQ.js";import{k as s}from"./directive-helpers-CDT6qhDs.js";import{p as R}from"./index-CDOHgizu.js";import{a as u}from"./ref-lLHsj5FH.js";import"./if-defined-BaykDp1D.js";import"./chunk-L4EGOTBX-C9C4DwME.js";import"./entry-preview-D9TbQDUR.js";import"./index-DrFu-skq.js";import"./index-7h80QhK_.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./library-BZPO0bHa.js";import"./icon.component-Bf6Q7d-N.js";import"./icon-ojhX_lXY.js";var $=Object.freeze,q=Object.defineProperty,w=(e,n)=>$(q(e,"raw",{value:$(n||e.slice())})),S;const{args:j,argTypes:A}=G("syn-tab-group"),{overrideArgs:k}=F("syn-tab-group"),{generateTemplate:L}=E("syn-tab-group"),P=(e,n,{active:a=!1,closable:g=!1,disabled:v=!1}={})=>`<syn-tab slot="nav" panel="${e}" ${a?"active":""} ${v?"disabled":""} ${g?"closable":""}>${n}</syn-tab>`,T=(e,n,{active:a=!1,closable:g=!1,disabled:v=!1}={})=>u(P(e,n,{active:a,closable:g,disabled:v})),H=()=>[{panel:"general",props:{active:!0}},{panel:"custom"},{panel:"advanced"},{panel:"disabled",props:{disabled:!0}}].map(({panel:e,props:n})=>P(e,R(e),n)).join(`
`),f=()=>u(H()),C=(e,n,a=!1)=>`<syn-tab-panel name="${e}" ${a?"active":""}>${n}</syn-tab-panel>`,x=(e,n,a=!1)=>u(C(e,n,a)),D=()=>["general","custom","advanced","disabled"].map((e,n)=>C(e,`This is the ${e} tab panel.`,n===0)).join(`
`),I=(e,n=!1)=>s`
...
`,y=()=>u(D()),ee={args:k([{name:"default",type:"slot",value:D()},{name:"nav",type:"slot",value:H()}],j),argTypes:A,component:"syn-tab-group",parameters:{design:_("18021-1924779"),docs:{description:{component:t("tab-group","default")}}},title:"Components/syn-tab-group"},r={parameters:{docs:{description:{story:t("tab-group","default")}}},render:e=>L({args:e})},o={parameters:{docs:{description:{story:t("tab-group","start")}}},render:()=>s`
...
`},c={parameters:{docs:{description:{story:t("tab-group","closable")}}},render:()=>s(S||(S=w([`
  ...
  `],[`
    ...
    <\/script>
  `])),[{content:"General",panel:"general",props:{active:!0}},{content:"Closable 1",panel:"closable-1",props:{closable:!0}},{content:"Closable 2",panel:"closable-2",props:{closable:!0}},{content:"Closable 3",panel:"closable-3",props:{closable:!0}}].map(({content:e,panel:n,props:a})=>T(n,e,a)),[{content:"general",name:"general"},{content:"first closable",name:"closable-1"},{content:"second closable",name:"closable-2"},{content:"third closable",name:"closable-3"}].map(({content:e,name:n},a)=>x(n,`This is the ${e} tab panel.`,a===0)))},p={parameters:{docs:{description:{story:t("tab-group","scrolling")}}},render:()=>s`
    <syn-tab-group>
      <!-- Tabs -->
...
\`
  ...
  heightPx: 740
})`,...d.parameters?.docs?.source}}};const ne=["Default","TabsOnStart","TabsOnEnd","ClosableTabs","ScrollingTabs","VisualHierarchy","ManualActivation","Icons","Screenshot"];export{c as ClosableTabs,r as Default,i as Icons,m as ManualActivation,d as Screenshot,p as ScrollingTabs,l as TabsOnEnd,o as TabsOnStart,b as VisualHierarchy,ne as __namedExportsOrder,ee as default};
