...
`})),Y,X=e((()=>{pt(),L(),Je(),T(),O(),x(),p(),a(),ae(),l(),Y=class extends D{constructor(){super(...arguments),this.hasFocus=!1,this.label=``,this.size=`inherit`,this.color=`currentColor`,this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){let e=!!this.href,t=e?ne`a`:ne`button`;return te`
      <${t}
        part="base"
    ...
    `}},Z.styles=[w,ut,ct],Z.dependencies={"syn-icon-button":Y,"syn-resize-observer":J},g([ie({slot:`nav`,selector:`syn-tab`})],Z.prototype,`tabs`,2),g([ie({selector:`syn-tab-panel`})],Z.prototype,`panels`,2),g([c(`.tab-group`)],Z.prototype,`tabGroup`,2),g([c(`.tab-group__body`)],Z.prototype,`body`,2),g([c(`.tab-group__nav`)],Z.prototype,`nav`,2),g([c(`.tab-group__indicator`)],Z.prototype,`indicator`,2),g([s()],Z.prototype,`hasScrollControls`,2),g([s()],Z.prototype,`shouldHideScrollStartButton`,2),g([s()],Z.prototype,`shouldHideScrollEndButton`,2),g([u()],Z.prototype,`placement`,2),g([u()],Z.prototype,`activation`,2),g([u({attribute:`no-scroll-controls`,type:Boolean})],Z.prototype,`noScrollControls`,2),g([u({type:Boolean})],Z.prototype,`contained`,2),g([u({type:Boolean})],Z.prototype,`sharp`,2),g([u({attribute:`fixed-scroll-controls`,type:Boolean})],Z.prototype,`fixedScrollControls`,2),g([re({passive:!0})],Z.prototype,`updateScrollButtons`,1),g([S(`noScrollControls`,{waitUntilFirstUpdate:!0})],Z.prototype,`updateScrollControls`,1),g([S(`placement`,{waitUntilFirstUpdate:!0})],Z.prototype,`syncIndicator`,1)})),_t=e((()=>{gt(),Z.define(`syn-tab-group`)})),vt=e((()=>{_t(),gt(),it(),rt(),lt(),dt(),X(),pt(),L(),k(),A(),q(),K(),G(),T(),O()})),yt,bt=e((()=>{i(),yt=n`
  :host {
...
`})),Ct,Q,wt=e((()=>{bt(),St(),X(),q(),C(),T(),O(),x(),p(),i(),l(),Ct=0,Q=class extends D{constructor(){super(...arguments),this.localize=new tt(this),this.attrId=++Ct,this.componentId=`syn-tab-${this.attrId}`,this.panel=``,this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`tab`)}handleCloseClick(e){e.stopPropagation(),this.emit(`syn-close`)}handleActiveChange(){this.setAttribute(`aria-selected`,this.active?`true`:`false`)}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled?`true`:`false`),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,t`
      <div
        part="base"
    ...
    `}},Q.styles=[w,xt,yt],Q.dependencies={"syn-icon-button":Y},g([c(`.tab`)],Q.prototype,`tab`,2),g([u({reflect:!0})],Q.prototype,`panel`,2),g([u({type:Boolean,reflect:!0})],Q.prototype,`active`,2),g([u({type:Boolean,reflect:!0})],Q.prototype,`closable`,2),g([u({type:Boolean,reflect:!0})],Q.prototype,`disabled`,2),g([u({type:Number,reflect:!0})],Q.prototype,`tabIndex`,2),g([S(`active`)],Q.prototype,`handleActiveChange`,1),g([S(`disabled`)],Q.prototype,`handleDisabledChange`,1)})),Tt=e((()=>{wt(),Q.define(`syn-tab`)})),Et=e((()=>{Tt(),wt(),bt(),St(),X(),pt(),L(),k(),A(),q(),K(),G(),T(),O()})),Dt,Ot=e((()=>{i(),Dt=n`
  /* Write custom CSS here */
  .tab-panel {
    color: var(--syn-typography-color-text);
  }
...
`})),jt,$,Mt=e((()=>{Ot(),At(),C(),T(),O(),x(),p(),i(),l(),jt=0,$=class extends D{constructor(){super(...arguments),this.attrId=++jt,this.componentId=`syn-tab-panel-${this.attrId}`,this.name=``,this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute(`role`,`tabpanel`)}handleActiveChange(){this.setAttribute(`aria-hidden`,this.active?`false`:`true`)}render(){return t`
      <slot
        part="base"
        class=${f({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}},$.styles=[w,kt,Dt],g([u({reflect:!0})],$.prototype,`name`,2),g([u({type:Boolean,reflect:!0})],$.prototype,`active`,2),g([S(`active`)],$.prototype,`handleActiveChange`,1)})),Nt=e((()=>{Mt(),$.define(`syn-tab-panel`)})),Pt=e((()=>{Nt(),Mt(),Ot(),At(),T(),O()}));export{me as A,S as C,v as D,y as E,x as M,ge as O,C as S,he as T,k as _,q as a,w as b,qe as c,Le as d,R as f,A as g,L as h,tt as i,h as j,b as k,Je as l,I as m,Et as n,K as o,Fe as p,vt as r,G as s,Pt as t,Ie as u,D as v,g as w,T as x,O as y};