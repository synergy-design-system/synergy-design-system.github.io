import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,d as r,f as i,g as a,u as o}from"./iframe-fXCqWTG3.js";import{t as s}from"./button-Cwo2Enjo.js";import{t as c}from"./icon-sEREnw4h.js";import{a as l,i as u,n as d,o as f,r as p,t as m}from"./component-CsQUi1XQ.js";import{n as h,t as g}from"./taggedTemplateLiteral-BuD1d7yP.js";import{t as _}from"./alert-1ohd8QxS.js";var v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R=e((()=>{t(),_(),s(),c(),p(),r(),a(),h(),{args:S,argTypes:C}=u(`syn-alert`),{overrideArgs:w}=l(`syn-alert`),{generateTemplate:T}=f(`syn-alert`),E={args:w([{name:`default`,type:`slot`,value:`This is a standard alert. You can customize its content and even the icon.`},{name:`open`,type:`attribute`,value:!0},{name:`icon`,type:`slot`,value:`<syn-icon slot="icon" name="info"></syn-icon>`}],S),argTypes:C,component:`syn-alert`,parameters:{chromatic:{modes:i},design:o(`41137-630160`),docs:{description:{component:d(`alert`,`default`)}}},tags:[`Feedback`],title:`Components/syn-alert`},D={parameters:{controls:{disable:!1},docs:{description:{story:d(`alert`,`default`)}}},render:e=>T({args:e})},O={parameters:{docs:{description:{story:d(`alert`,`variants`)}}},render:()=>n`
  ...
  `},k={parameters:{docs:{description:{story:d(`alert`,`closable`)}}},render:()=>n(v||=g([`
    ...
    <\/script>
  `]))},A={parameters:{docs:{description:{story:d(`alert`,`without-icons`)}}},render:()=>n`
    <syn-alert variant="primary" open>
      Nothing fancy here, just a simple alert.
    </syn-alert>
  `},j={parameters:{docs:{description:{story:d(`alert`,`size`)}}},render:()=>n`
  ...
  `},M={parameters:{docs:{description:{story:d(`alert`,`duration`)}}},render:()=>n(y||=g([`
  ...
  `]))},N={parameters:{docs:{description:{story:d(`alert`,`toast-notifications`)}}},render:()=>n(b||=g([`
  ...
  `],[`
    ...
    <\/script>
  `]))},P={parameters:{docs:{description:{story:d(`alert`,`creating-toasts-imperatively`)}}},render:()=>n(x||=g([`
