import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-DRz18Lsn.js";import{c as i,t as a}from"./lit-D4-0ovri.js";import{t as o}from"./button-CBC8ywKX.js";import{t as s}from"./icon-BbsmBxau.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-NnlguzJ1.js";import{n as m,t as h}from"./decorators-CjBNNcov.js";import{t as g}from"./radio-group-DJvxANR_.js";import{t as _}from"./radio-button-geQEEhQx.js";var v=t({ButtonsWithIcons:()=>N,Checked:()=>E,Default:()=>T,Disabled:()=>O,Focus:()=>D,Invalid:()=>j,PrefixAndSuffixIcons:()=>M,Readonly:()=>k,Screenshot:()=>P,Sizes:()=>A,__namedExportsOrder:()=>F,default:()=>w}),y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F;function I(){return(I=e((()=>{a(),o(),s(),g(),_(),h(),f(),r(),{userEvent:y}=__STORYBOOK_MODULE_TEST__,{args:b,argTypes:x}=l(`syn-radio-button`),{overrideArgs:S}=c(`syn-radio-button`),{generateTemplate:C}=d(`syn-radio-button`),w={args:S([{name:`default`,type:`slot`,value:`Option 1`},{name:`value`,type:`attribute`,value:`1`}],b),argTypes:x,component:`syn-radio-button`,parameters:{chromatic:{modes:n},docs:{description:{component:u(`radio-button`,`default`)}}},tags:[`Form`],title:`Components/syn-radio-button`},T={parameters:{controls:{disable:!1},docs:{description:{story:u(`radio-button`,`default`)}}},render:e=>i`
  ...
  `},P=p({Default:T,Checked:E,Disabled:O,Readonly:k,Sizes:A,PrefixAndSuffixIcons:M,ButtonsWithIcons:N},350),F=[`Default`,`Checked`,`Focus`,`Disabled`,`Readonly`,`Sizes`,`Invalid`,`PrefixAndSuffixIcons`,`ButtonsWithIcons`,`Screenshot`],T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  ButtonsWithIcons
}, 350)`,...P.parameters?.docs?.source}}}})))()}export{I as n,v as r,T as t};