import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-DWg8XNs3.js";import{D as r,T as i,d as a,f as o,g as s,u as c}from"./iframe-CVaCVGtH.js";import{a as l,i as u,r as d,t as f}from"./component-CllRTPI1.js";import{n as p,t as m}from"./styles-Bo4G5Uzy.js";var h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j;e((()=>{n(),i(),d(),m(),a(),s(),{args:h,argTypes:g}=u(`syn-table`),{overrideArgs:_}=l(`syn-table`),v="It is possible to achieve different table stylings (default, with border, alternating, ...) \n  either via multiple classes on the `table`, `td` and `th` elements or as a convenient alternative\n  as auto styling class, which is applied on a `table` element. These auto styling classes will\n  style the `td` and `th` elements correctly, without the need to apply further classes.\n  <br> <br>\n  **Note:** The auto styling table classes work for simple table layouts. For more complex ones or advanced use cases, the table cell classes should be used.\n",y=()=>`
  <thead>
    <tr>
