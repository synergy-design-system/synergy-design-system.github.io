import{n as e}from"./chunk-DnJy8xQt.js";import{A as t,At as n,D as r,Nt as i,O as a,Ot as o,Pt as ee,Rt as s,Ut as c}from"./iframe-BcSabCAt.js";import{n as l,t as u}from"./class-map-ubcCJG2R.js";import{n as d,t as te}from"./if-defined-B5YranhM.js";import{c as ne,f as re,m as f,p,s as m,u as h}from"./synergy-element-B9jDHluB.js";var ie,ae,oe,se,g,ce,le,ue,de,_,fe,pe,v,me,y,b,x,he,S=e((()=>{ie=Object.defineProperty,ae=Object.defineProperties,oe=Object.getOwnPropertyDescriptor,se=Object.getOwnPropertyDescriptors,g=Object.getOwnPropertySymbols,ce=Object.prototype.hasOwnProperty,le=Object.prototype.propertyIsEnumerable,ue=e=>{throw TypeError(e)},de=(e,t,n)=>t in e?ie(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,_=(e,t)=>{for(var n in t||={})ce.call(t,n)&&de(e,n,t[n]);if(g)for(var n of g(t))le.call(t,n)&&de(e,n,t[n]);return e},fe=(e,t)=>ae(e,se(t)),pe=(e,t)=>{var n={};for(var r in e)ce.call(e,r)&&t.indexOf(r)<0&&(n[r]=e[r]);if(e!=null&&g)for(var r of g(e))t.indexOf(r)<0&&le.call(e,r)&&(n[r]=e[r]);return n},v=(e,t,n,r)=>{for(var i=r>1?void 0:r?oe(t,n):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(i=(r?o(t,n,i):o(i))||i);return r&&i&&ie(t,n,i),i},me=(e,t,n)=>t.has(e)||ue(`Cannot `+n),y=(e,t,n)=>(me(e,t,`read from private field`),n?n.call(e):t.get(e)),b=(e,t,n)=>t.has(e)?ue(`Cannot add the same private member more than once`):t instanceof WeakSet?t.add(e):t.set(e,n),x=(e,t,n,r)=>(me(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),he=(e,t,n)=>(me(e,t,`access private method`),n)}));function C(e,t){let n=_({waitUntilFirstUpdate:!1},t);return(t,r)=>{let{update:i}=t,a=Array.isArray(e)?e:[e];t.update=function(e){a.forEach(t=>{let i=t;if(e.has(i)){let t=e.get(i),a=this[i];t!==a&&(!n.waitUntilFirstUpdate||this.hasUpdated)&&this[r](t,a)}}),i.call(this,e)}}}var w=e((()=>{S()})),T,E=e((()=>{i(),T=c`
  :host {
...
`})),D,O,k=e((()=>{S(),i(),m(),O=class extends ee{constructor(){super(),b(this,D,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}emit(e,t){let n=new CustomEvent(e,_({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(n),n}static define(e,t=this,n={}){let r=customElements.get(e);if(!r){try{customElements.define(e,t,n)}catch{customElements.define(e,class extends t{},n)}return}let i=` (unknown version)`,a=i;`version`in t&&t.version&&(i=` v`+t.version),`version`in r&&r.version&&(a=` v`+r.version),!(i&&a&&i===a)&&console.warn(`Attempted to register <${e}>${i}, but <${e}>${a} has already been registered.`)}attributeChangedCallback(e,t,n){y(this,D)||(this.constructor.elementProperties.forEach((e,t)=>{e.reflect&&this[t]!=null&&this.initialReflectedProperties.set(t,this[t])}),x(this,D,!0)),super.attributeChangedCallback(e,t,n)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach((t,n)=>{e.has(n)&&this[n]==null&&(this[n]=t)})}},D=new WeakMap,O.version=`3.15.1`,O.dependencies={},v([f()],O.prototype,`dir`,2),v([f()],O.prototype,`lang`,2)})),ge,A=e((()=>{i(),ge=c`
...
`})),X,pt=e((()=>{ft(),L(),Je(),E(),k(),S(),u(),r(),te(),m(),X=class extends O{constructor(){super(...arguments),this.hasFocus=!1,this.label=``,this.size=`inherit`,this.color=`currentColor`,this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){let e=!!this.href,n=e?a`a`:a`button`;return t`
    ...
    `}},Z.styles=[T,lt,st],Z.dependencies={"syn-icon-button":X,"syn-resize-observer":Y},v([ne({slot:`nav`,selector:`syn-tab`})],Z.prototype,`tabs`,2),v([ne({selector:`syn-tab-panel`})],Z.prototype,`panels`,2),v([h(`.tab-group`)],Z.prototype,`tabGroup`,2),v([h(`.tab-group__body`)],Z.prototype,`body`,2),v([h(`.tab-group__nav`)],Z.prototype,`nav`,2),v([h(`.tab-group__indicator`)],Z.prototype,`indicator`,2),v([p()],Z.prototype,`hasScrollControls`,2),v([p()],Z.prototype,`shouldHideScrollStartButton`,2),v([p()],Z.prototype,`shouldHideScrollEndButton`,2),v([f()],Z.prototype,`placement`,2),v([f()],Z.prototype,`activation`,2),v([f({attribute:`no-scroll-controls`,type:Boolean})],Z.prototype,`noScrollControls`,2),v([f({type:Boolean})],Z.prototype,`contained`,2),v([f({type:Boolean})],Z.prototype,`sharp`,2),v([f({attribute:`fixed-scroll-controls`,type:Boolean})],Z.prototype,`fixedScrollControls`,2),v([re({passive:!0})],Z.prototype,`updateScrollButtons`,1),v([C(`noScrollControls`,{waitUntilFirstUpdate:!0})],Z.prototype,`updateScrollControls`,1),v([C(`placement`,{waitUntilFirstUpdate:!0})],Z.prototype,`syncIndicator`,1)})),_t=e((()=>{gt(),Z.define(`syn-tab-group`)})),vt=e((()=>{_t(),gt(),rt(),nt(),ct(),ut(),pt(),ft(),L(),A(),j(),J(),K(),G(),E(),k()})),yt,bt=e((()=>{i(),yt=c`
  :host {
...
`})),Ct,Q,wt=e((()=>{bt(),St(),pt(),J(),w(),E(),k(),S(),u(),i(),m(),Ct=0,Q=class extends O{constructor(){super(...arguments),this.localize=new q(this),this.attrId=++Ct,this.componentId=`syn-tab-${this.attrId}`,this.panel=``,this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`tab`)}handleCloseClick(e){e.stopPropagation(),this.emit(`syn-close`)}handleActiveChange(){this.setAttribute(`aria-selected`,this.active?`true`:`false`)}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled?`true`:`false`),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,s`
      <div
        part="base"
    ...
    `}},Q.styles=[T,xt,yt],Q.dependencies={"syn-icon-button":X},v([h(`.tab`)],Q.prototype,`tab`,2),v([f({reflect:!0})],Q.prototype,`panel`,2),v([f({type:Boolean,reflect:!0})],Q.prototype,`active`,2),v([f({type:Boolean,reflect:!0})],Q.prototype,`closable`,2),v([f({type:Boolean,reflect:!0})],Q.prototype,`disabled`,2),v([f({type:Number,reflect:!0})],Q.prototype,`tabIndex`,2),v([C(`active`)],Q.prototype,`handleActiveChange`,1),v([C(`disabled`)],Q.prototype,`handleDisabledChange`,1)})),Tt=e((()=>{wt(),Q.define(`syn-tab`)})),Et=e((()=>{Tt(),wt(),bt(),St(),pt(),ft(),L(),A(),j(),J(),K(),G(),E(),k()})),Dt,Ot=e((()=>{i(),Dt=c`
  /* Write custom CSS here */
  .tab-panel {
    color: var(--syn-typography-color-text);
  }
...
`})),jt,$,Mt=e((()=>{Ot(),At(),w(),E(),k(),S(),u(),i(),m(),jt=0,$=class extends O{constructor(){super(...arguments),this.attrId=++jt,this.componentId=`syn-tab-panel-${this.attrId}`,this.name=``,this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute(`role`,`tabpanel`)}handleActiveChange(){this.setAttribute(`aria-hidden`,this.active?`false`:`true`)}render(){return s`
      <slot
        part="base"
        class=${l({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}},$.styles=[T,kt,Dt],v([f({reflect:!0})],$.prototype,`name`,2),v([f({type:Boolean,reflect:!0})],$.prototype,`active`,2),v([C(`active`)],$.prototype,`handleActiveChange`,1)})),Nt=e((()=>{Mt(),$.define(`syn-tab-panel`)})),Pt=e((()=>{Nt(),Mt(),Ot(),At(),E(),k()}));export{fe as A,C,y as D,b as E,S as M,he as O,w as S,pe as T,A as _,J as a,T as b,qe as c,Le as d,R as f,j as g,L as h,q as i,_ as j,x as k,Je as l,I as m,Et as n,K as o,Fe as p,vt as r,G as s,Pt as t,Ie as u,O as v,v as w,E as x,k as y};