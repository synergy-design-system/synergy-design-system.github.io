import{h as k}from"./combobox-OUEgpep4.js";import"./button-BfUvjWsk.js";import"./icon-Bb7vZsjh.js";import"./option-mK1GQqUs.js";import"./optgroup-DP0MglkL.js";import{g as L,C as M,x as n,o as P}from"./iframe-CCf0SjNU.js";import{g as t,s as G,c as F,a as B,b as I}from"./component-Brb9k3ih.js";import{p as W}from"./PaddingDecorator-Br17wgdO.js";import"./class-map-CPEWKE0X.js";import"./synergy-element-C2cCdqmn.js";import"./icon.component-BxEwtDV8.js";import"./watch-CEsCE2EF.js";import"./query-DAIS6qJ0.js";import"./animation-registry-l4L8bmT6.js";import"./default-value-3hKVLUPx.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./localize-Dh03wnLC.js";import"./index-DihgwUfS.js";import"./event-B0iVuGLD.js";import"./form-control.custom.styles-DmrjGFOc.js";import"./popup.component-Bh0AgJMM.js";import"./if-defined-BzpMTWTC.js";import"./scroll-DgKSCJoS.js";import"./decorator-DANECR0-.js";import"./functions-CDi3doZH.js";import"./spinner.component-5Pq2XyAj.js";import"./query-assigned-elements-BQ-t-koE.js";import"./divider.component-DXg6wsk3.js";import"./preload-helper-Ct5FWWRu.js";import"./index-CQ0aEGxp.js";import"./_docs-DXCV3alH.js";var q=Object.freeze,Y=Object.defineProperty,E=(o,e)=>q(Y(o,"raw",{value:q(o.slice())})),D,z,R;const{userEvent:T}=__STORYBOOK_MODULE_TEST__,{args:A,argTypes:j}=G("syn-combobox"),{overrideArgs:Q}=B("syn-combobox"),{generateTemplate:K}=F("syn-combobox"),Do={args:A,argTypes:j,component:"syn-combobox",parameters:{chromatic:{modes:M},design:L("25272-35634"),docs:{description:{component:t("combobox","default")},story:{height:"250px"}}},tags:["Form","SICK2018","SICK2025"],title:"Components/syn-combobox"},N=["Yellow","Light Green","Grey","Green","Blue","Red","Orange","Magenta","White","Purple","Pink","Black","Brown"].sort(),_=o=>`<syn-option value="${o.replaceAll(" ","_")}">${o}</syn-option>`,s=o=>P(_(o)),U=()=>N.map(_),r=()=>P(U().join(`
`)),a={parameters:{args:Q({name:"default",type:"slot",value:`
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>`},A),controls:{disable:!1},docs:{description:{story:t("combobox","default")}}},render:o=>K({args:o})},i={parameters:{docs:{description:{story:t("combobox","label")}}},render:()=>n`
    <syn-combobox label="State">
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},c={parameters:{docs:{description:{story:t("combobox","help-text")}}},render:()=>n`
    <syn-combobox label="State" help-text="Select a State">
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},p={parameters:{docs:{description:{story:t("combobox","placeholder")}}},render:()=>n`
    <syn-combobox label="State" help-text="Select a State" placeholder="Select a State">
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},h={decorators:[W()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:t("combobox","focus")}}},play:({canvasElement:o})=>{const e=o.querySelector("syn-combobox");e&&e.focus()},render:()=>n`
    <syn-combobox>
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},l={parameters:{docs:{description:{story:t("combobox","clearable")}}},render:()=>n`
    <syn-combobox value="Green" clearable>
      ${r()}
    </syn-combobox>
  `},m={parameters:{docs:{description:{story:t("combobox","disabled")}}},render:()=>n`
    <syn-combobox  disabled placeholder="Disabled">
      ${r()}
    </syn-combobox>
  `},b={parameters:{docs:{description:{story:t("combobox","restrict-options")}}},render:()=>n`
    <syn-combobox value="Option 1" restricted>
      <syn-option value="option-1">Option 1</syn-option>
      <syn-option value="option-2">Option 2</syn-option>
      <syn-option value="option-3">Option 3</syn-option>
    </syn-combobox>
  `},f={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:t("combobox","no-results")},story:{inline:!1}}},play:async({canvasElement:o})=>{const e=o.querySelector("syn-combobox");await e.updateComplete,e.focus();const g=e.shadowRoot?.querySelector("input");g&&await T.type(g,"Search term")},render:()=>n`
    <syn-combobox id="no-results" value="Search term" open restricted>
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},y={parameters:{docs:{description:{story:t("combobox","size")}}},render:()=>n`
  ...
  `},S={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:t("combobox","invalid")}}},play:async({canvasElement:o})=>{const e=o.querySelector("form"),g=e.querySelector("syn-combobox"),H=e.querySelector("syn-button");H&&g&&(await T.click(H),H.click())},render:()=>n`
  ...
  `},d={parameters:{docs:{description:{story:t("combobox","preffix-sufffix")}}},render:()=>n`
  ...
  `},O={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:t("combobox","simple")}}},play:async({canvasElement:o})=>{const e=o.querySelector("syn-combobox");await e.updateComplete,await e.show()},render:()=>n`
    <syn-combobox label="Preferred Color" value="g">
     ${r()}
    </syn-combobox>
  `},v={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:t("combobox","highlight")}}},play:async({canvasElement:o})=>{const e=o.querySelector("syn-combobox");await e.updateComplete,await e.show()},render:()=>{const o=k;return n(D||(D=E([`
    ...
    <\/script>
  `])),r(),o)}},C={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:t("combobox","grouping")}}},play:async({canvasElement:o})=>{const e=o.querySelector("syn-combobox");await e.updateComplete,await e.show()},render:()=>n`
  ...
  `},$={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:t("combobox","container-height")}}},play:async({canvasElement:o})=>{const e=o.querySelector("syn-combobox");await e.updateComplete,await e.show()},render:()=>n`
  ...
  `},u={parameters:{docs:{description:{story:t("combobox","async-options")}}},render:()=>n(z||(z=E([`
    ...
    <\/script>
  `]))),tags:["skip_mcp"]},x={parameters:{docs:{description:{story:t("combobox","custom-filter")}}},render:()=>n(R||(R=E([`
    ...
    <\/script>
  `])),r())},w=I({Default:a,Labels:i,HelpText:c,Placeholder:p,Clearable:l,Disabled:m,Restricted:b,Sizes:y,PrefixSuffixTextAndIcons:d,AsyncOptions:u,CustomFilter:x},500);a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  parameters: {
    args: overrideArgs({
      name: 'default',
      type: 'slot',
