var rn=Object.freeze,mi=Object.defineProperty;var ln=(a,e)=>rn(mi(a,"raw",{value:rn(e||a.slice())}));import{R as f,d as Dn,k,t as te,b as u,a as g,e as ut,f as fi}from"./static-9CmeQujl.js";import{i as h,k as p,D as In,u as dn,Q as yi,R as bi}from"./directive-helpers-CDT6qhDs.js";import{h as Nn,$ as An,r as Mn,L as gi,F as yt,b as vi,o as wi,f as xi,c as ki,s as cn,d as _i,p as jt,e as Ti,g as Ci,a as Pn,k as Si,K as zi,j as Ei,i as $i,t as Oi}from"./ref-BgFTv61d.js";import{s as Di}from"./chunk-L4EGOTBX-C9C4DwME.js";import"./entry-preview-D9TbQDUR.js";import{S as it,d as pn,s as Ii}from"./index-DP5Es2lv.js";import"./index-7h80QhK_.js";import{n as r,a as b}from"./library-BZPO0bHa.js";import{a as v,c as w,w as m,S as ue}from"./icon.component-DbLkOHCL.js";import"./icon-eErRpPHH.js";const Ni=h`
  :host {
    display: block;
  }
...
`;var Ai=Object.defineProperty,Mi=Object.getOwnPropertyDescriptor,at=(a,e,t,n)=>{for(var i=n>1?void 0:n?Mi(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Ai(e,t,i),i};class Ge extends v{constructor(){super(...arguments),this.closeOthers=!1,this.contained=!1,this.size="medium",this.handleAccordionShow=e=>{this.closeOthers&&this.detailsInDefaultSlot.forEach(t=>{t!==e.target&&t.parentNode===e.target.parentNode&&t.removeAttribute("open")})}}static{this.styles=[w,Ni]}adjustDetailsSize(){this.detailsInDefaultSlot.forEach(e=>{e.setAttribute("size",this.size)})}adjustDetailsContained(){this.detailsInDefaultSlot.forEach(e=>{e.contained=this.contained})}handleSizeChange(){this.adjustDetailsSize()}handleContainedChange(){this.adjustDetailsContained()}connectedCallback(){super.connectedCallback(),this.addEventListener("syn-show",this.handleAccordionShow)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("syn-show",this.handleAccordionShow)}handleSlotChange(){this.adjustDetailsSize(),this.adjustDetailsContained()}render(){return p`
      <div 
        part="base"
        class=${f({accordion:!0,"accordion--contained":this.contained})}>
        <slot @slotchange=${this.handleSlotChange}></slot>
      </div>
    `}}at([Nn({selector:"syn-details"})],Ge.prototype,"detailsInDefaultSlot",2);at([r({attribute:"close-others",type:Boolean})],Ge.prototype,"closeOthers",2);at([r({reflect:!0,type:Boolean})],Ge.prototype,"contained",2);at([r({reflect:!0})],Ge.prototype,"size",2);at([m("size",{waitUntilFirstUpdate:!0})],Ge.prototype,"handleSizeChange",1);at([m("contained",{waitUntilFirstUpdate:!0})],Ge.prototype,"handleContainedChange",1);Ge.define("syn-accordion");class Pi extends An{host;element;prevData={};render(e){return In}update(e,[t]){this.element!==e.element&&(this.element=e.element),this.host=e.options?.host||this.element,this.apply(t),this.groom(t),this.prevData={...t}}apply(e){if(!e)return;const{prevData:t,element:n}=this;for(const i in e){const o=e[i];o!==t[i]&&St(n,i,o)}}groom(e){const{prevData:t,element:n}=this;if(t)for(const i in t)(!e||!(i in e)&&n[i]===t[i])&&St(n,i,void 0)}}class Li extends Pi{eventData={};apply(e){if(e)for(const t in e){const n=e[t];n!==this.eventData[t]&&this.applyEvent(t,n)}}applyEvent(e,t){const{prevData:n,element:i}=this;this.eventData[e]=t,n[e]&&i.removeEventListener(e,this,t),i.addEventListener(e,this,t)}groom(e){const{prevData:t,element:n}=this;if(t)for(const i in t)(!e||!(i in e)&&n[i]===t[i])&&this.groomEvent(i,t[i])}groomEvent(e,t){const{element:n}=this;delete this.eventData[e],n.removeEventListener(e,this,t)}handleEvent(e){const t=this.eventData[e.type];typeof t=="function"?t.call(this.host,e):t.handleEvent(e)}disconnected(){const{eventData:e,element:t}=this;for(const n in e){const i=n.slice(1),o=e[n];t.removeEventListener(i,this,o)}}reconnected(){const{eventData:e,element:t}=this;for(const n in e){const i=n.slice(1),o=e[n];t.addEventListener(i,this,o)}}}class ji extends Li{apply(e){if(!e)return;const{prevData:t,element:n}=this;for(const i in e){const o=e[i];if(o===t[i])continue;const s=i.slice(1);switch(i[0]){case"@":this.eventData[s]=o,this.applyEvent(s,o);break;case".":St(n,s,o);break;case"?":o?n.setAttribute(s,""):n.removeAttribute(s);break;default:o?n.setAttribute(i,String(o)):n.removeAttribute(i);break}}}groom(e){const{prevData:t,element:n}=this;if(t)for(const i in t){const o=i.slice(1);if(!e||!(i in e)&&n[o]===t[i])switch(i[0]){case"@":this.groomEvent(o,t[i]);break;case".":St(n,o,void 0);break;case"?":n.removeAttribute(o);break;default:n.removeAttribute(i);break}}}}function St(a,e,t){try{a[e]=t}catch{console.warn(`Could not set property "${e}" on ${a.tagName} because it has no "setter".`)}}const Fi=Dn(ji);let nt={};setTimeout(()=>{nt=globalThis?.__WC_STORYBOOK_HELPERS_CONFIG__||{}});function Ln(a,e){return e.modules?.find(n=>n.declarations?.some(i=>i.tagName===a))?.declarations.find(n=>n.kind==="class"&&n.tagName===a)}function Kt(a,e=!0){const t={};return a?.members?.forEach(n=>{if(n.kind!=="field")return;const i=a.attributes?.find(T=>n.name===T.fieldName),o=n.name;if(t[o]={name:o,table:{disable:!0}},n.privacy==="private"||n.privacy==="protected"||n.static)return;const s=i?.name||n.name,l=nt.typeRef&&n[`${nt.typeRef}`]?.text||n?.type?.text,d=Vn(l),c=bt(n.default);t[s]={name:s,description:Qt(n.description,o,n.deprecated),defaultValue:c==="''"?"":c,control:e?{type:Fn(d,i!==void 0)}:!1,table:{category:i?"attributes":"properties",defaultValue:{summary:c},type:{summary:l}}};const y=d?.split("|");y&&y?.length>1&&(t[s].options=y.map(T=>bt(T)))}),t}function Vi(a,e=!0){const t={};return a?.members?.forEach(n=>{if(n.kind!=="field"||(t[n.name]={name:n.name,table:{disable:!0}},n.privacy==="private"||n.privacy==="protected"||n.static))return;const i=nt.typeRef&&n[`${nt.typeRef}`]?.text||n?.type?.text,o=Vn(i),s=`${n.name}`,l=Fn(o);t[s]={name:n.name,description:n.description,defaultValue:Bi(l,n.default),control:e?{type:l}:!1,table:{category:"properties",defaultValue:{summary:bt(n.default)},type:{summary:i}}};const d=o?.split("|");d&&d?.length>1&&(t[s].options=d.map(c=>bt(c)))}),delete t.ref,t}function jn(a){const e={};return a?.events?.forEach(t=>{const n=Ui(t.name);e[n]={name:n,description:t.description,control:!1,table:{category:"events"}}}),e}function Gt(a,e=!0){const t={};return a?.cssProperties?.forEach(n=>{t[n.name]={name:n.name,description:n.description,defaultValue:n.default,control:e?{type:n.name.toLowerCase().includes("color")?"color":"text"}:!1,table:{category:"css properties"}}}),t}function Yt(a,e=!0){const t={};return a?.cssParts?.forEach(n=>{t[n.name]={name:n.name,table:{disable:!0}},t[`${n.name}-part`]={name:n.name,description:Qt(n.description,e?`${n.name}-part`:""),defaultValue:`${a?.tagName}::part(${n.name}) {
}`,control:e?"text":!1,table:{category:"css shadow parts"}}}),t}function Xt(a,e=!0){const t={};return a?.slots?.forEach(n=>{t[n.name]={name:n.name,table:{disable:!0}};const i=n.name||"default";t[`${i}-slot`]={control:"text",name:i,description:Qt(n.description,`${i}-slot`),defaultValue:i==="default"?"":`<span slot="${i}"></span>`,control:e?"text":!1,table:{category:"slots"}}}),t}function Hi(a){const e={};return a?.events?.forEach(t=>{e[t.name]={name:t.name,description:t.description,control:!1,table:{category:"events",type:{summary:`CustomEvent${t.type?`<${t.type.text}>`:""}`}}}}),e}function Bi(a,e){const t=bt(e);return a==="boolean"?t==="true":t==="''"?"":t}function Fn(a,e=!1){if(!a)return"text";const t=a.toLowerCase(),n=t.split("|").map(i=>i.trim()).filter(i=>i!==""&&i!=="null"&&i!=="undefined");return Ri(t)&&!e?"object":_t(n,"boolean")?"boolean":_t(n,"number")&&!_t(n,"string")&&n.every(i=>!i.includes("'"))?"number":_t(n,"date")?"date":n.length>1&&n.every(i=>i.includes("'"))?"select":"text"}function Ri(a){return a.includes("array")||a.includes("object")||a.includes("{")||a.includes("[")||a.includes("<")}function _t(a=[],e){return a?.find(t=>t===e)!==void 0}function Vn(a){return a?a.replace(" | undefined","").replace(" | null",""):""}function bt(a){return a?.trim().replace(/^["'](.+(?=["']$))["']$/,"$1")}function Qt(a,e,t){let n="";return t&&(n+=`\`@deprecated\` ${t}`),a&&(n+=n?`


`:"",n+=a),nt.hideArgRef||!e?n:n+=`


arg ref - \`${e}\``}const Ui=a=>`on${qi(Wi(a))}`;function Wi(a=""){return a.split("-").map((n,i)=>i?n.charAt(0).toUpperCase()+n.slice(1).toLowerCase():n.toLowerCase()).join("")}function qi(a){return a.charAt(0).toUpperCase()+a.slice(1)}const{useArgs:Ki}=__STORYBOOK_MODULE_PREVIEW_API__;let zt,hn,Jt={};setTimeout(()=>{Jt=globalThis?.__WC_STORYBOOK_HELPERS_CONFIG__||{}});var On;function Gi(a,e,t,n){if(!e)return k`<${te(a.tagName)}></${te(a.tagName)}>`;a?.tagName!==hn&&(zt=void 0,hn=a?.tagName);const{attrOperators:i,additionalAttrs:o}=Yi(a,e,n),s={...i,...o},l=Ji(a,e),d=Xi(a,e);return Zi(a),k`${Hn(a,e)}
<${te(a.tagName)} 
  ${Fi(s)}
  ${d}
  >
...
${Jt.hideScriptTag?"":k(On||(On=ln([`<script>
  window.component = document.querySelector("`,`");
<\/script>`])),a.tagName)}
`}function Hn(a,e){const t=Qi(a,e);return`${t}`?.replaceAll(/\s+/g,"")!=""?k`<style>${t}</style>`:""}function Yi(a,e,t){const n=Kt(a),i={},o={},s={};return Object.keys(n).forEach(l=>{const d=n[l];if(d?.table?.category!=="attributes")return;const c=d.name,y=e[l],T=d.control.type==="boolean"?`?${c}`:c;(y!==n[l].defaultValue||Jt.renderDefaultAttributeValues)&&(i[T]=y==="false"?!1:y)}),Object.keys(e).filter(l=>n[l]?.table?.category==="properties").forEach(l=>{if(l.startsWith("on"))return;const d=e[l];o[`.${l}`]=d}),Object.keys(e).filter(l=>!Object.keys(t||{}).includes(l)).forEach(l=>{!l.startsWith("on")&&typeof e[l]!="function"&&(s[l]=e[l])}),{attrOperators:i,propOperators:o,additionalAttrs:s}}function Xi(a,e){if(!a?.cssProperties?.length)return;const t=Gt(a);return te(`style="${Object.keys(t).map(n=>{const i=t[n].name,o=e[n];return o?`${i}: ${o||""}`:null}).filter(n=>n!==null).join(";")}"`)}function Qi(a,e){const t=Yt(a);if(!Object.keys(t).some(o=>!!e[o]))return;const i=Object.keys(t).filter(o=>o.endsWith("-part")).map(o=>{const s=t[o].name,l=e[o];return l?.replaceAll(/\s+/g,"")!==`${a?.tagName}::part(${s}){}`?`
${l}`:null}).filter(o=>o!==null).join(`
`);return i?te(`${i}
`):""}function Ji(a,e){const t=Xt(a);return te(`${Object.keys(t).filter(i=>i.endsWith("-slot")).map(i=>{const o=t[i].name,s=e[i];return o==="default"?s||null:s!==`<span slot="${o}"></span>`?s:null}).filter(i=>i!==null).join("")}`)}function Zi(a){ea(a),setTimeout(()=>{const e=document.querySelector(a.tagName);zt?.observe(e,{attributes:!0})})}function ea(a){let e=!1;const t=Ki()[1],n=Kt(a);zt||(zt=new MutationObserver(i=>{i.forEach(o=>{if(o.type!=="attributes"||o.attributeName==="class"&&e)return;e=!0;const s=n[`${o.attributeName}`];s?.control==="boolean"||s?.control?.type==="boolean"?t({[`${o.attributeName}`]:o.target?.hasAttribute(o.attributeName||"")}):t({[`${o.attributeName}`]:o.target.getAttribute(o.attributeName||"")}),e=!1})}))}function ta(a){window.__WC_STORYBOOK_HELPERS_CONFIG__=a}function Bn(a){const e=window.__STORYBOOK_CUSTOM_ELEMENTS_MANIFEST__;if(!e)throw new Error(`Custom Elements Manifest not found. Be sure to follow the pre-install steps in this guide:
https://www.npmjs.com/package/wc-storybook-helpers#before-you-install`);const t=Ln(a,e),n=t?.events?.map(o=>o.name)||[],i=Rn(t);return{args:Un(t),argTypes:i,reactArgs:ia(t),reactArgTypes:Wn(t),events:n,styleTemplate:o=>Hn(t,o),template:(o,s)=>Gi(t,o,s,i)}}function Rn(a){return{...Gt(a),...Yt(a),...Xt(a),...Kt(a),...Hi(a)}}function Un(a,e){return e||(e=Rn(a)),Object.entries(e).filter(([,n])=>n?.control).map(([n,i])=>{let o=na(i.defaultValue);return i.table?.category==="css properties"&&(o=o?.toString()),{[n]:o===void 0?"":o}}).reduce((n,i)=>({...n,...i}),{})}function na(a){try{return JSON.parse(a)}catch{return a}}function Wn(a){return{...Vi(a),...jn(a),...Gt(a,!1),...Yt(a,!1),...Xt(a,!1)}}function ia(a){const e=Un(a,Wn(a)),t=Object.entries(jn(a)).map(([n])=>({[n]:()=>{}})).reduce((n,i)=>({...n,...i}),{});return{...e,...t}}const{useParameter:aa,addons:oa,useEffect:sa,useMemo:nl}=__STORYBOOK_MODULE_PREVIEW_API__;var ra=Object.defineProperty,la=(a,e)=>{for(var t in e)ra(a,t,{get:e[t],enumerable:!0})},da={};la(da,{initializeThemeState:()=>Yn,pluckThemeFromContext:()=>Kn,useThemeParameters:()=>Gn});var qn="themes",ca=`storybook/${qn}`,pa="theme",ha={},ua={REGISTER_THEMES:`${ca}/REGISTER_THEMES`};function Kn({globals:a}){return a[pa]||""}function Gn(){return aa(qn,ha)}function Yn(a,e){oa.getChannel().emit(ua.REGISTER_THEMES,{defaultTheme:e,themes:a})}var ma="html",un=a=>a.split(" ").filter(Boolean),fa=({themes:a,defaultTheme:e,parentSelector:t=ma})=>(Yn(Object.keys(a),e),(n,i)=>{let{themeOverride:o}=Gn(),s=Kn(i);return sa(()=>{let l=o||s||e,d=document.querySelector(t);if(!d)return;Object.entries(a).filter(([y])=>y!==l).forEach(([y,T])=>{let U=un(T);U.length>0&&d.classList.remove(...U)});let c=un(a[l]);c.length>0&&d.classList.add(...c)},[o,s]),n()}),ya={mobile1:{name:"Small mobile",styles:{height:"568px",width:"320px"},type:"mobile"},mobile2:{name:"Large mobile",styles:{height:"896px",width:"414px"},type:"mobile"},tablet:{name:"Tablet",styles:{height:"1112px",width:"834px"},type:"tablet"}};function F(a,e,t){return new Promise(n=>{if(t?.duration===1/0)throw new Error("Promise-based animations must be finite.");const i=a.animate(e,{...t,duration:ba()?0:t.duration});i.addEventListener("cancel",n,{once:!0}),i.addEventListener("finish",n,{once:!0})})}function mn(a){return a=a.toString().toLowerCase(),a.indexOf("ms")>-1?parseFloat(a):a.indexOf("s")>-1?parseFloat(a)*1e3:parseFloat(a)}function ba(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function K(a){return Promise.all(a.getAnimations().map(e=>new Promise(t=>{e.cancel(),requestAnimationFrame(t)})))}function fn(a,e){return a.map(t=>({...t,height:t.height==="auto"?`${e}px`:t.height}))}const Xn=new Map,Bt=new WeakMap;function Qn(a){return a??{keyframes:[],options:{duration:0}}}function yn(a,e){return e.toLowerCase()==="rtl"?{keyframes:a.rtlKeyframes||a.keyframes,options:a.options}:a}function _(a,e){Xn.set(a,Qn(e))}function Tt(a,e,t){Bt.set(a,{...Bt.get(a),[e]:Qn(t)})}function N(a,e,t){const n=Bt.get(a);if(n?.[e])return yn(n[e],t.dir);const i=Xn.get(e);return i?yn(i,t.dir):{keyframes:[],options:{duration:0}}}class q{constructor(e,...t){this.slotNames=[],this.handleSlotChange=n=>{const i=n.target;(this.slotNames.includes("[default]")&&!i.name||i.name&&this.slotNames.includes(i.name))&&this.host.requestUpdate()},(this.host=e).addController(this),this.slotNames=t}hasDefaultSlot(){return[...this.host.childNodes].some(e=>{if(e.nodeType===e.TEXT_NODE&&e.textContent.trim()!=="")return!0;if(e.nodeType===e.ELEMENT_NODE){const t=e;if(t.tagName.toLowerCase()==="syn-visually-hidden")return!1;if(!t.hasAttribute("slot"))return!0}return!1})}hasNamedSlot(e){return this.host.querySelector(`:scope > [slot="${e}"]`)!==null}test(e){return e==="[default]"?this.hasDefaultSlot():this.hasNamedSlot(e)}hostConnected(){this.host.shadowRoot.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener("slotchange",this.handleSlotChange)}}function Jn(a){if(!a)return"";const e=a.assignedNodes({flatten:!0});let t="";return[...e].forEach(n=>{n.nodeType===Node.TEXT_NODE&&(t+=n.textContent)}),t}const Zn={$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(a,e)=>`Go to slide ${a} of ${e}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:a=>a===0?"No options selected":a===1?"1 option selected":`${a} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:a=>`Slide ${a}`,toggleColorFormat:"Toggle color format",closeMenu:"Close menu",danger:"Danger",fileButtonText:"Choose file",fileButtonTextMultiple:"Choose files",folderButtonText:"Choose folder",fileDragDrop:"Drop or choose file",folderDragDrop:"Drop or choose folder",menu:"Menu",notification:"Notification",numFilesSelected:(a,e)=>a===0?`No ${e?"folder":"files"} chosen`:`${a} files`,openMenu:"Open menu",rangeMax:"Maximum",rangeMin:"Minimum",sideNav:"Side navigation",success:"Success",warning:"Warning"};Mn(Zn);class j extends gi{static{Mn(Zn)}}function W(a,e){return new Promise(t=>{function n(i){i.target===a&&(a.removeEventListener(e,n),t())}a.addEventListener(e,n)})}const ga=h`
	/* stylelint-disable */
  :host {
    display: contents;
...
`;var wa=Object.defineProperty,xa=Object.getOwnPropertyDescriptor,Ee=(a,e,t,n)=>{for(var i=n>1?void 0:n?xa(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&wa(e,t,i),i};const Ze=Object.assign(document.createElement("div"),{className:"syn-toast-stack"});class ge extends v{constructor(){super(...arguments),this.hasSlotController=new q(this,"icon","suffix"),this.localize=new j(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.remainingTime=this.duration}static{this.styles=[w,ga,va]}static{this.dependencies={"syn-icon-button":it}}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){this.countdownAnimation?.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),this.countdownAnimation?.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){const{countdownElement:e}=this,t="100%",n="0";this.countdownAnimation=e.animate([{width:t},{width:n}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.duration<1/0&&this.restartAutoHide(),await K(this.base),this.base.hidden=!1;const{keyframes:e,options:t}=N(this,"alert.show",{dir:this.localize.dir()});await F(this.base,e,t),this.emit("syn-after-show")}else{this.emit("syn-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await K(this.base);const{keyframes:e,options:t}=N(this,"alert.hide",{dir:this.localize.dir()});await F(this.base,e,t),this.base.hidden=!0,this.emit("syn-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,W(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,W(this,"syn-after-hide")}async toast(){return new Promise(e=>{this.handleCountdownChange(),Ze.parentElement===null&&document.body.append(Ze),Ze.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("syn-after-hide",()=>{Ze.removeChild(this),e(),Ze.querySelector("syn-alert")===null&&Ze.remove()},{once:!0})})}render(){return p`
    ...
    `}}Ee([u('[part~="base"]')],ge.prototype,"base",2);Ee([u(".alert__countdown-elapsed")],ge.prototype,"countdownElement",2);Ee([r({type:Boolean,reflect:!0})],ge.prototype,"open",2);Ee([r({type:Boolean,reflect:!0})],ge.prototype,"closable",2);Ee([r({reflect:!0})],ge.prototype,"variant",2);Ee([r({type:Number})],ge.prototype,"duration",2);Ee([b()],ge.prototype,"remainingTime",2);Ee([m("open",{waitUntilFirstUpdate:!0})],ge.prototype,"handleOpenChange",1);Ee([m("duration")],ge.prototype,"handleDurationChange",1);_("alert.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});_("alert.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});ge.define("syn-alert");const ka=h`
	/* stylelint-disable */
  :host {
    display: inline-flex;
  }
...
`;var Ta=Object.defineProperty,Ca=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Ta(e,t,i),i};class ei extends v{constructor(){super(...arguments),this.localize=new j(this),this.variant="primary"}static{this.styles=[w,ka,_a]}render(){return p`
      <span
        part="base"
    ...
    `}}Ca([r({reflect:!0})],ei.prototype,"variant");ei.define("syn-badge");const Sa=h`
	/* stylelint-disable */
  :host {
    display: inline-flex;
  }
...
`;var Ea=Object.defineProperty,$a=Object.getOwnPropertyDescriptor,ot=(a,e,t,n)=>{for(var i=n>1?void 0:n?$a(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Ea(e,t,i),i};class Ye extends v{constructor(){super(...arguments),this.hasSlotController=new q(this,"prefix","suffix"),this.renderType="button",this.rel="noreferrer noopener"}static{this.styles=[w,Sa,za]}setRenderType(){const e=this.defaultSlot.assignedElements({flatten:!0}).filter(t=>t.tagName.toLowerCase()==="syn-dropdown").length>0;if(this.href){this.renderType="link";return}if(e){this.renderType="dropdown";return}this.renderType="button"}hrefChanged(){this.setRenderType()}handleSlotChange(){this.setRenderType()}render(){return p`
      <div
        part="base"
    ...
    `}}ot([u("slot:not([name])")],Ye.prototype,"defaultSlot",2);ot([b()],Ye.prototype,"renderType",2);ot([r()],Ye.prototype,"href",2);ot([r()],Ye.prototype,"target",2);ot([r()],Ye.prototype,"rel",2);ot([m("href",{waitUntilFirstUpdate:!0})],Ye.prototype,"hrefChanged",1);Ye.define("syn-breadcrumb-item");const Oa=h`
	/* stylelint-disable */
  .breadcrumb {
    display: flex;
    align-items: center;
...
`;var Ia=Object.defineProperty,Zt=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Ia(e,t,i),i};class Ot extends v{constructor(){super(...arguments),this.localize=new j(this),this.separatorDir=this.localize.dir(),this.label=""}static{this.styles=[w,Oa,Da]}static{this.dependencies={"syn-icon":ue}}getSeparator(){const t=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[t,...t.querySelectorAll("[id]")].forEach(n=>n.removeAttribute("id")),t.setAttribute("data-default",""),t.slot="separator",t}handleSlotChange(){const e=[...this.defaultSlot.assignedElements({flatten:!0})].filter(t=>t.tagName.toLowerCase()==="syn-breadcrumb-item");e.forEach((t,n)=>{const i=t.querySelector('[slot="separator"]');i===null?t.append(this.getSeparator()):i.hasAttribute("data-default")&&i.replaceWith(this.getSeparator()),n===e.length-1?t.setAttribute("aria-current","page"):t.removeAttribute("aria-current")})}render(){return this.separatorDir!==this.localize.dir()&&(this.separatorDir=this.localize.dir(),this.updateComplete.then(()=>this.handleSlotChange())),p`
    ...
    `}}Zt([u("slot")],Ot.prototype,"defaultSlot");Zt([u('slot[name="separator"]')],Ot.prototype,"separatorSlot");Zt([r()],Ot.prototype,"label");Ot.define("syn-breadcrumb");const Na=h`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
`;var Aa=Object.defineProperty,en=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Aa(e,t,i),i};class gt extends v{constructor(){super(...arguments),this.disableRole=!1,this.label=""}static{this.styles=[w,Na]}handleFocus(e){rt(e.target)?.toggleAttribute("data-syn-button-group__button--focus",!0)}handleBlur(e){rt(e.target)?.toggleAttribute("data-syn-button-group__button--focus",!1)}handleMouseOver(e){rt(e.target)?.toggleAttribute("data-syn-button-group__button--hover",!0)}handleMouseOut(e){rt(e.target)?.toggleAttribute("data-syn-button-group__button--hover",!1)}handleSlotChange(){const e=[...this.defaultSlot.assignedElements({flatten:!0})];e.forEach(t=>{const n=e.indexOf(t),i=rt(t);i&&(i.toggleAttribute("data-syn-button-group__button",!0),i.toggleAttribute("data-syn-button-group__button--first",n===0),i.toggleAttribute("data-syn-button-group__button--inner",n>0&&n<e.length-1),i.toggleAttribute("data-syn-button-group__button--last",n===e.length-1),i.toggleAttribute("data-syn-button-group__button--radio",i.tagName.toLowerCase()==="syn-radio-button"))})}render(){return p`
      <div
        part="base"
        class="button-group"
...
`;class tn extends v{constructor(){super(...arguments),this.localize=new j(this)}static{this.styles=[w,Pa,La]}render(){return p`
...
`;var Ra=Object.defineProperty,Ua=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Ra(e,t,i),i};class ii extends v{constructor(){super(...arguments),this.hasSlotController=new q(this,"footer","header","image"),this.sharp=!1}static{this.styles=[w,Ha,Ba]}render(){return p`
      <div
        part="base"
    ...
    `}}Ua([r({type:Boolean,reflect:!0})],ii.prototype,"sharp");ii.define("syn-card");const Xe=(a="value")=>(e,t)=>{const n=e.constructor,i=n.prototype.attributeChangedCallback;n.prototype.attributeChangedCallback=function(o,s,l){const d=n.getPropertyOptions(a),c=typeof d.attribute=="string"?d.attribute:a;if(o===c){const y=d.converter||dn,U=(typeof y=="function"?y:y?.fromAttribute??dn.fromAttribute)(l,d.type);this[a]!==U&&(this[t]=U)}i.call(this,o,s,l)}},$e=h`
	/* stylelint-disable */
...
`;var Xa=Object.defineProperty,B=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Xa(e,t,i),i};function Qa(a){return a!==null&&typeof a=="object"&&"getBoundingClientRect"in a&&("contextElement"in a?a instanceof Element:!0)}class O extends v{constructor(){super(...arguments),this.localize=new j(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){const e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),n=this.placement.includes("top")||this.placement.includes("bottom");let i=0,o=0,s=0,l=0,d=0,c=0,y=0,T=0;n?e.top<t.top?(i=e.left,o=e.bottom,s=e.right,l=e.bottom,d=t.left,c=t.top,y=t.right,T=t.top):(i=t.left,o=t.bottom,s=t.right,l=t.bottom,d=e.left,c=e.top,y=e.right,T=e.top):e.left<t.left?(i=e.right,o=e.top,s=t.left,l=t.top,d=e.right,c=e.bottom,y=t.left,T=t.bottom):(i=t.right,o=t.top,s=e.left,l=e.top,d=t.right,c=t.bottom,y=e.left,T=e.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${i}px`),this.style.setProperty("--hover-bridge-top-left-y",`${o}px`),this.style.setProperty("--hover-bridge-top-right-x",`${s}px`),this.style.setProperty("--hover-bridge-top-right-y",`${l}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${d}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${c}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${y}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${T}px`)}}}static{this.styles=[w,Ya]}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has("active")&&(this.active?this.start():this.stop()),e.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){const e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchor instanceof Element||Qa(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){!this.anchorEl||!this.active||(this.cleanup=vi(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>e())):e()})}reposition(){if(!this.active||!this.anchorEl)return;const e=[wi({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?e.push(cn({apply:({rects:n})=>{const i=this.sync==="width"||this.sync==="both",o=this.sync==="height"||this.sync==="both";this.popup.style.width=i?`${n.reference.width}px`:"",this.popup.style.height=o?`${n.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&e.push(xi({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&e.push(ki({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?e.push(cn({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:n,availableHeight:i})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${i}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${n}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&e.push(_i({element:this.arrowEl,padding:this.arrowPadding}));const t=this.strategy==="absolute"?n=>jt.getOffsetParent(n,Ti):jt.getOffsetParent;Ci(this.anchorEl,this.popup,{placement:this.placement,middleware:e,strategy:this.strategy,platform:{...jt,getOffsetParent:t}}).then(({x:n,y:i,middlewareData:o,placement:s})=>{const l=this.localize.dir()==="rtl",d={top:"bottom",right:"left",bottom:"top",left:"right"}[s.split("-")[0]];if(this.setAttribute("data-current-placement",s),Object.assign(this.popup.style,{left:`${n}px`,top:`${i}px`}),this.arrow){const c=o.arrow.x,y=o.arrow.y;let T="",U="",ze="",be="";if(this.arrowPlacement==="start"){const Pe=typeof c=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";T=typeof y=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",U=l?Pe:"",be=l?"":Pe}else if(this.arrowPlacement==="end"){const Pe=typeof c=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";U=l?"":Pe,be=l?Pe:"",ze=typeof y=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else this.arrowPlacement==="center"?(be=typeof c=="number"?"calc(50% - var(--arrow-size-diagonal))":"",T=typeof y=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(be=typeof c=="number"?`${c}px`:"",T=typeof y=="number"?`${y}px`:"");Object.assign(this.arrowEl.style,{top:T,right:U,bottom:ze,left:be,[d]:"calc(var(--arrow-size-diagonal) * -1)"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("syn-reposition")}render(){return p`
...
`;var eo=Object.defineProperty,to=Object.getOwnPropertyDescriptor,De=(a,e,t,n)=>{for(var i=n>1?void 0:n?to(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&eo(e,t,i),i};class ve extends v{constructor(){super(...arguments),this.localize=new j(this),this.isInitialized=!1,this.current=!1,this.selected=!1,this.hasHover=!1,this.value="",this.disabled=!1}static{this.styles=[w,Ja,Za]}static{this.dependencies={"syn-icon":ue}}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.setAttribute("aria-selected","false")}handleDefaultSlotChange(){this.isInitialized?(customElements.whenDefined("syn-combobox").then(()=>{const e=this.closest("syn-combobox");e&&e.handleDefaultSlotChange()}),customElements.whenDefined("syn-select").then(()=>{const e=this.closest("syn-select");e&&e.handleDefaultSlotChange()})):this.isInitialized=!0}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleValueChange(){typeof this.value!="string"&&(this.value=String(this.value)),this.value.includes(" ")&&(console.error("Option values cannot include a space. All spaces have been replaced with underscores.",this),this.value=this.value.replace(/ /g,"_"))}getTextLabel(){const e=this.childNodes;let t="";return[...e].forEach(n=>{n.nodeType===Node.ELEMENT_NODE&&(n.hasAttribute("slot")||(t+=n.textContent)),n.nodeType===Node.TEXT_NODE&&(t+=n.textContent)}),t.trim()}render(){return p`
      <div
        part="base"
    ...
    `}}De([u(".option__label")],ve.prototype,"defaultSlot",2);De([b()],ve.prototype,"current",2);De([b()],ve.prototype,"selected",2);De([b()],ve.prototype,"hasHover",2);De([r({reflect:!0})],ve.prototype,"value",2);De([r({type:Boolean,reflect:!0})],ve.prototype,"disabled",2);De([m("disabled")],ve.prototype,"handleDisabledChange",1);De([m("selected")],ve.prototype,"handleSelectedChange",1);De([m("value")],ve.prototype,"handleValueChange",1);const no=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`;var bo=Object.defineProperty,go=Object.getOwnPropertyDescriptor,Te=(a,e,t,n)=>{for(var i=n>1?void 0:n?go(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&bo(e,t,i),i};class we extends v{constructor(){super(...arguments),this.localize=new j(this),this.open=!1,this.disabled=!1,this.contained=!1,this.size="medium"}static{this.styles=[w,fo,yo]}static{this.dependencies={"syn-icon":ue}}firstUpdated(){this.body.style.height=this.open?"auto":"0",this.open&&(this.details.open=!0),this.detailsObserver=new MutationObserver(e=>{for(const t of e)t.type==="attributes"&&t.attributeName==="open"&&(this.details.open?this.show():this.hide())}),this.detailsObserver.observe(this.details,{attributes:!0})}disconnectedCallback(){super.disconnectedCallback(),this.detailsObserver?.disconnect()}handleSummaryClick(e){e.preventDefault(),this.disabled||(this.open?this.hide():this.show(),this.header.focus())}handleSummaryKeyDown(e){(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.open?this.hide():this.show()),(e.key==="ArrowUp"||e.key==="ArrowLeft")&&(e.preventDefault(),this.hide()),(e.key==="ArrowDown"||e.key==="ArrowRight")&&(e.preventDefault(),this.show())}async handleOpenChange(){if(this.open){if(this.details.open=!0,this.emit("syn-show",{cancelable:!0}).defaultPrevented){this.open=!1,this.details.open=!1;return}await K(this.body);const{keyframes:t,options:n}=N(this,"details.show",{dir:this.localize.dir()});await F(this.body,fn(t,this.body.scrollHeight),n),this.body.style.height="auto",this.emit("syn-after-show")}else{if(this.emit("syn-hide",{cancelable:!0}).defaultPrevented){this.details.open=!0,this.open=!0;return}await K(this.body);const{keyframes:t,options:n}=N(this,"details.hide",{dir:this.localize.dir()});await F(this.body,fn(t,this.body.scrollHeight),n),this.body.style.height="auto",this.details.open=!1,this.emit("syn-after-hide")}}async show(){if(!(this.open||this.disabled))return this.open=!0,W(this,"syn-after-show")}async hide(){if(!(!this.open||this.disabled))return this.open=!1,W(this,"syn-after-hide")}render(){return p`
      <details
        part="base"
    ...
    `}}Te([u(".details")],we.prototype,"details",2);Te([u(".details__header")],we.prototype,"header",2);Te([u(".details__body")],we.prototype,"body",2);Te([u(".details__expand-icon-slot")],we.prototype,"expandIconSlot",2);Te([r({type:Boolean,reflect:!0})],we.prototype,"open",2);Te([r()],we.prototype,"summary",2);Te([r({type:Boolean,reflect:!0})],we.prototype,"disabled",2);Te([r({type:Boolean,reflect:!0})],we.prototype,"contained",2);Te([r({reflect:!0})],we.prototype,"size",2);Te([m("open",{waitUntilFirstUpdate:!0})],we.prototype,"handleOpenChange",1);_("details.show",{keyframes:[{height:"0",opacity:"0"},{height:"auto",opacity:"1"}],options:{duration:250,easing:"linear"}});_("details.hide",{keyframes:[{height:"auto",opacity:"1"},{height:"0",opacity:"0"}],options:{duration:250,easing:"linear"}});we.define("syn-details");function*nn(a=document.activeElement){a!=null&&(yield a,"shadowRoot"in a&&a.shadowRoot&&a.shadowRoot.mode!=="closed"&&(yield*nn(a.shadowRoot.activeElement)))}function vo(){return[...nn()].pop()}const xn=new WeakMap;function oi(a){let e=xn.get(a);return e||(e=window.getComputedStyle(a,null),xn.set(a,e)),e}function wo(a){if(typeof a.checkVisibility=="function")return a.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});const e=oi(a);return e.visibility!=="hidden"&&e.display!=="none"}function xo(a){const e=oi(a),{overflowY:t,overflowX:n}=e;return t==="scroll"||n==="scroll"?!0:t!=="auto"||n!=="auto"?!1:a.scrollHeight>a.clientHeight&&t==="auto"||a.scrollWidth>a.clientWidth&&n==="auto"}function ko(a){const e=a.tagName.toLowerCase(),t=Number(a.getAttribute("tabindex"));return a.hasAttribute("tabindex")&&(isNaN(t)||t<=-1)||a.hasAttribute("disabled")||a.closest("[inert]")||e==="input"&&a.getAttribute("type")==="radio"&&!a.hasAttribute("checked")||!wo(a)?!1:(e==="audio"||e==="video")&&a.hasAttribute("controls")||a.hasAttribute("tabindex")||a.hasAttribute("contenteditable")&&a.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(e)?!0:xo(a)}function _o(a){const e=Ut(a),t=e[0]??null,n=e[e.length-1]??null;return{start:t,end:n}}function To(a,e){return a.getRootNode({composed:!0})?.host!==e}function Ut(a){const e=new WeakMap,t=[];function n(i){if(i instanceof Element){if(i.hasAttribute("inert")||i.closest("[inert]")||e.has(i))return;e.set(i,!0),!t.includes(i)&&ko(i)&&t.push(i),i instanceof HTMLSlotElement&&To(i,a)&&i.assignedElements({flatten:!0}).forEach(o=>{n(o)}),i.shadowRoot!==null&&i.shadowRoot.mode==="open"&&n(i.shadowRoot)}for(const o of i.children)n(o)}return n(a),t.sort((i,o)=>{const s=Number(i.getAttribute("tabindex"))||0;return(Number(o.getAttribute("tabindex"))||0)-s})}let pt=[];class si{constructor(e){this.tabDirection="forward",this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=t=>{if(t.key!=="Tab"||this.isExternalActivated||!this.isActive())return;const n=vo();if(this.previousFocus=n,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;t.shiftKey?this.tabDirection="backward":this.tabDirection="forward";const i=Ut(this.element);let o=i.findIndex(l=>l===n);this.previousFocus=this.currentFocus;const s=this.tabDirection==="forward"?1:-1;for(;;){o+s>=i.length?o=0:o+s<0?o=i.length-1:o+=s,this.previousFocus=this.currentFocus;const l=i[o];if(this.tabDirection==="backward"&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||l&&this.possiblyHasTabbableChildren(l))return;t.preventDefault(),this.currentFocus=l,this.currentFocus?.focus({preventScroll:!1});const d=[...nn()];if(d.includes(this.currentFocus)||!d.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=e,this.elementsWithTabbableControls=["iframe"]}activate(){pt.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){pt=pt.filter(e=>e!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return pt[pt.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){const e=Ut(this.element);if(!this.element.matches(":focus-within")){const t=e[0],n=e[e.length-1],i=this.tabDirection==="forward"?t:n;typeof i?.focus=="function"&&(this.currentFocus=i,i.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(e){return this.elementsWithTabbableControls.includes(e.tagName.toLowerCase())||e.hasAttribute("controls")}}const Co=h`
	/* stylelint-disable */
  :host {
    --width: 31rem;
...
`;var zo=Object.defineProperty,Eo=Object.getOwnPropertyDescriptor,Qe=(a,e,t,n)=>{for(var i=n>1?void 0:n?Eo(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&zo(e,t,i),i};class je extends v{constructor(){super(...arguments),this.hasSlotController=new q(this,"footer"),this.localize=new j(this),this.modal=new si(this),this.open=!1,this.label="",this.noHeader=!1,this.handleDocumentKeyDown=e=>{e.key==="Escape"&&this.modal.isActive()&&this.open&&(e.stopPropagation(),this.requestClose("keyboard"))}}static{this.styles=[w,Co,So]}static{this.dependencies={"syn-icon-button":it}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),mt(this))}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate(),tt(this),this.removeOpenListeners()}requestClose(e){if(this.emit("syn-request-close",{cancelable:!0,detail:{source:e}}).defaultPrevented){const n=N(this,"dialog.denyClose",{dir:this.localize.dir()});F(this.panel,n.keyframes,n.options);return}this.hide()}addOpenListeners(){"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard")):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){this.closeWatcher?.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),mt(this);const e=this.querySelector("[autofocus]");e&&e.removeAttribute("autofocus"),await Promise.all([K(this.dialog),K(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit("syn-initial-focus",{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute("autofocus","")});const t=N(this,"dialog.show",{dir:this.localize.dir()}),n=N(this,"dialog.overlay.show",{dir:this.localize.dir()});await Promise.all([F(this.panel,t.keyframes,t.options),F(this.overlay,n.keyframes,n.options)]),this.emit("syn-after-show")}else{this.emit("syn-hide"),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([K(this.dialog),K(this.overlay)]);const e=N(this,"dialog.hide",{dir:this.localize.dir()}),t=N(this,"dialog.overlay.hide",{dir:this.localize.dir()});await Promise.all([F(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),F(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,tt(this);const n=this.originalTrigger;typeof n?.focus=="function"&&setTimeout(()=>n.focus()),this.emit("syn-after-hide")}}async show(){if(!this.open)return this.open=!0,W(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,W(this,"syn-after-hide")}render(){return p`
    ...
    `}}Qe([u(".dialog")],je.prototype,"dialog",2);Qe([u(".dialog__panel")],je.prototype,"panel",2);Qe([u(".dialog__overlay")],je.prototype,"overlay",2);Qe([r({type:Boolean,reflect:!0})],je.prototype,"open",2);Qe([r({reflect:!0})],je.prototype,"label",2);Qe([r({attribute:"no-header",type:Boolean,reflect:!0})],je.prototype,"noHeader",2);Qe([m("open",{waitUntilFirstUpdate:!0})],je.prototype,"handleOpenChange",1);_("dialog.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});_("dialog.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});_("dialog.denyClose",{keyframes:[{scale:1},{scale:1.02},{scale:1}],options:{duration:250}});_("dialog.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});_("dialog.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});je.define("syn-dialog");const $o=h`
	/* stylelint-disable */
  :host {
...
`;var Do=Object.defineProperty,Io=Object.getOwnPropertyDescriptor,ri=(a,e,t,n)=>{for(var i=n>1?void 0:n?Io(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Do(e,t,i),i};class Fe extends v{constructor(){super(...arguments),this.vertical=!1}static{this.styles=[w,$o,Oo]}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}}ri([r({type:Boolean,reflect:!0})],Fe.prototype,"vertical",2);ri([m("vertical")],Fe.prototype,"handleVerticalChange",1);Fe.define("syn-divider");function kn(a){return a.charAt(0).toUpperCase()+a.slice(1)}const No=h`
	/* stylelint-disable */
  :host {
    --size: 25rem;
    --header-spacing: var(--syn-spacing-large);
...
`;var Mo=Object.defineProperty,Po=Object.getOwnPropertyDescriptor,Ce=(a,e,t,n)=>{for(var i=n>1?void 0:n?Po(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Mo(e,t,i),i};class ye extends v{constructor(){super(...arguments),this.hasSlotController=new q(this,"footer"),this.localize=new j(this),this.modal=new si(this),this.open=!1,this.label="",this.placement="end",this.contained=!1,this.noHeader=!1,this.handleDocumentKeyDown=e=>{this.contained||e.key==="Escape"&&this.modal.isActive()&&this.open&&(e.stopImmediatePropagation(),this.requestClose("keyboard"))}}static{this.styles=[w,No,Ao]}static{this.dependencies={"syn-icon-button":it}}firstUpdated(){this.drawer.hidden=!this.open,this.open&&(this.addOpenListeners(),this.contained||(this.modal.activate(),mt(this)))}disconnectedCallback(){super.disconnectedCallback(),tt(this),this.removeOpenListeners()}requestClose(e){if(this.emit("syn-request-close",{cancelable:!0,detail:{source:e}}).defaultPrevented){const n=N(this,"drawer.denyClose",{dir:this.localize.dir()});F(this.panel,n.keyframes,n.options);return}this.hide()}addOpenListeners(){"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.contained||(this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard"))):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){document.removeEventListener("keydown",this.handleDocumentKeyDown),this.closeWatcher?.destroy()}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.contained||(this.modal.activate(),mt(this));const e=this.querySelector("[autofocus]");e&&e.removeAttribute("autofocus"),await Promise.all([K(this.drawer),K(this.overlay)]),this.drawer.hidden=!1,requestAnimationFrame(()=>{this.emit("syn-initial-focus",{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute("autofocus","")});const t=N(this,`drawer.show${kn(this.placement)}`,{dir:this.localize.dir()}),n=N(this,"drawer.overlay.show",{dir:this.localize.dir()});await Promise.all([F(this.panel,t.keyframes,t.options),F(this.overlay,n.keyframes,n.options)]),this.emit("syn-after-show")}else{this.emit("syn-hide"),this.removeOpenListeners(),this.contained||(this.modal.deactivate(),tt(this)),await Promise.all([K(this.drawer),K(this.overlay)]);const e=N(this,`drawer.hide${kn(this.placement)}`,{dir:this.localize.dir()}),t=N(this,"drawer.overlay.hide",{dir:this.localize.dir()});await Promise.all([F(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),F(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.drawer.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1;const n=this.originalTrigger;typeof n?.focus=="function"&&setTimeout(()=>n.focus()),this.emit("syn-after-hide")}}handleNoModalChange(){this.open&&!this.contained&&(this.modal.activate(),mt(this)),this.open&&this.contained&&(this.modal.deactivate(),tt(this))}async show(){if(!this.open)return this.open=!0,W(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,W(this,"syn-after-hide")}render(){return p`
      <div
        part="base"
...
`;var Wo=Object.defineProperty,qo=Object.getOwnPropertyDescriptor,Dt=(a,e,t,n)=>{for(var i=n>1?void 0:n?qo(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Wo(e,t,i),i};class wt extends v{constructor(){super(...arguments),this.hasSlotController=new q(this,"[default]","logo","label","meta-navigation","navigation"),this.localize=new j(this),this.label="",this.burgerMenu="hidden"}static{this.styles=[w,Uo]}static{this.dependencies={"syn-icon":ue}}toggleBurgerMenu(){switch(this.burgerMenu){case"closed":this.burgerMenu="open";break;case"open":this.burgerMenu="closed";break}}handleBurgerMenuToggle(){this.sideNav&&!this.sideNav.rail&&(this.sideNav.open=!this.sideNav.open),this.toggleBurgerMenu()}updateBurgerMenuBasedOnSideNav(){this.sideNav&&(this.sideNav.rail?this.burgerMenu="hidden":this.burgerMenu=this.sideNav.open?"open":"closed")}handleBurgerMenu(){const e=`syn-burger-menu-${this.burgerMenu}`;this.emit(e)}connectedCallback(){super.connectedCallback(),this.mutationObserver=new MutationObserver(()=>this.updateBurgerMenuBasedOnSideNav())}firstUpdated(){const e=document.querySelector("syn-side-nav");this.connectSideNavigation(e)}disconnectedCallback(){super.disconnectedCallback(),this.mutationObserver.disconnect()}connectSideNavigation(e){this.mutationObserver.disconnect(),this.sideNav=e||document.querySelector("syn-side-nav"),this.sideNav&&(this.updateBurgerMenuBasedOnSideNav(),this.mutationObserver.observe(this.sideNav,{attributeFilter:["open","rail"],attributes:!0}))}render(){const e=this.hasSlotController.test("navigation"),t=this.burgerMenu!=="hidden";return k`
    ...
    `}}Dt([r()],wt.prototype,"label",2);Dt([r({attribute:"burger-menu",reflect:!0})],wt.prototype,"burgerMenu",2);Dt([b()],wt.prototype,"sideNav",2);Dt([m("burgerMenu",{waitUntilFirstUpdate:!0})],wt.prototype,"handleBurgerMenu",1);wt.define("syn-header");class Ko extends An{constructor(e){if(super(e),this.handlePointerDown=t=>{t.button!==0||this.host.disabled||this.spinOnLongPressCallback(t)},this.handlePointerUp=t=>{t?.preventDefault(),t?.stopPropagation(),this.timeout&&this.callbacks.start(),this.stopSpinningAndCleanUp(),this.callbacks.end(),document.removeEventListener("pointerup",this.handlePointerUp)},e.type!==fi.ELEMENT||!(e.element instanceof HTMLButtonElement))throw new Error("The `longPress` directive must be used on an HTMLButtonElement.")}render(e){return In}update(e,[t]){return this.callbacks===void 0&&this.host===void 0&&(this.host=e.element,this.callbacks={...t},this.host.addEventListener("pointerdown",this.handlePointerDown)),bi}disconnected(){this.stopSpinningAndCleanUp(),this.host.removeEventListener("pointerdown",this.handlePointerDown),document.removeEventListener("pointerup",this.handlePointerUp)}spinOnLongPressCallback(e){e.preventDefault(),e.stopPropagation(),this.timeout=setTimeout(()=>{this.timeout=void 0,this.interval=setInterval(()=>{this.callbacks.start()},50)},500),document.addEventListener("pointerup",this.handlePointerUp),this.observer?.disconnect(),this.observer=new MutationObserver(t=>{t.forEach(n=>{n.attributeName==="disabled"&&this.stopSpinningAndCleanUp()})}),this.observer.observe(this.host,{attributes:!0})}stopSpinningAndCleanUp(){clearInterval(this.interval),clearTimeout(this.timeout),this.observer?.disconnect()}}const _n=Dn(Ko),Go=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`;var Xo=Object.defineProperty,Qo=Object.getOwnPropertyDescriptor,S=(a,e,t,n)=>{for(var i=n>1?void 0:n?Qo(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Xo(e,t,i),i};class C extends v{constructor(){super(...arguments),this.formControlController=new _e(this,{assumeInteractionOn:["syn-blur","syn-input"]}),this.hasSlotController=new q(this,"help-text","label","prefix","suffix"),this.localize=new j(this),this.hasFocus=!1,this.title="",this.__numberInput=Object.assign(document.createElement("input"),{type:"number"}),this.__dateInput=Object.assign(document.createElement("input"),{type:"date"}),this.type="text",this.name="",this.value="",this.defaultValue="",this.size="medium",this.label="",this.helpText="",this.clearable=!1,this.disabled=!1,this.placeholder="",this.readonly=!1,this.passwordToggle=!1,this.passwordVisible=!1,this.noSpinButtons=!1,this.form="",this.required=!1,this.spellcheck=!0}static{this.styles=[w,$e,Go,Oe,Yo]}static{this.dependencies={"syn-icon":ue,"syn-divider":Fe}}get valueAsDate(){return this.__dateInput.type=this.type,this.__dateInput.value=this.value,this.input?.valueAsDate||this.__dateInput.valueAsDate}set valueAsDate(e){this.__dateInput.type=this.type,this.__dateInput.valueAsDate=e,this.value=this.__dateInput.value}get valueAsNumber(){return this.__numberInput.value=this.value,this.input?.valueAsNumber||this.__numberInput.valueAsNumber}set valueAsNumber(e){this.__numberInput.valueAsNumber=e,this.value=this.__numberInput.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleStep(){this.handleInput(),this.input.focus()}handleStepUp(){this.stepUp(),this.handleStep()}handleStepDown(){this.stepDown(),this.handleStep()}isDecrementDisabled(){if(this.disabled||this.readonly)return!0;if(this.min===void 0||this.min===null||this.disabled)return!1;const e=typeof this.min=="string"?parseFloat(this.min):this.min;return this.valueAsNumber<=e}isIncrementDisabled(){if(this.disabled||this.readonly)return!0;if(this.max===void 0||this.max===null)return!1;const e=typeof this.max=="string"?parseFloat(this.max):this.max;return this.valueAsNumber>=e}handleChange(){this.value=this.input.value,this.emit("syn-change")}handleClearClick(e){e.preventDefault(),this.value!==""&&(this.value="",this.emit("syn-clear"),this.emit("syn-input"),this.emit("syn-change")),this.input.focus()}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleInput(){this.value=this.input.value,this.formControlController.updateValidity(),this.emit("syn-input")}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleKeyDown(e){const t=e.metaKey||e.ctrlKey||e.shiftKey||e.altKey;e.key==="Enter"&&!t&&setTimeout(()=>{!e.defaultPrevented&&!e.isComposing&&this.formControlController.submit()})}handlePasswordToggle(){this.passwordVisible=!this.passwordVisible}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStepChange(){this.input.step=String(this.step),this.formControlController.updateValidity()}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(e){this.input.focus(e)}blur(){this.input.blur()}select(){this.input.select()}setSelectionRange(e,t,n="none"){this.input.setSelectionRange(e,t,n)}setRangeText(e,t,n,i="preserve"){const o=t??this.input.selectionStart,s=n??this.input.selectionEnd;this.input.setRangeText(e,o,s,i),this.value!==this.input.value&&(this.value=this.input.value)}showPicker(){"showPicker"in HTMLInputElement.prototype&&this.input.showPicker()}stepUp(){this.input.stepUp(),this.value!==this.input.value&&(this.value=this.input.value)}stepDown(){this.input.stepDown(),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("label"),t=this.hasSlotController.test("help-text"),n=this.hasSlotController.test("prefix"),i=this.hasSlotController.test("suffix"),o=this.label?!0:!!e,s=this.helpText?!0:!!t,d=this.clearable&&!this.disabled&&!this.readonly&&(typeof this.value=="number"||this.value.length>0);return p`
            ...
            ${this.type==="number"&&!this.noSpinButtons?p`
              <div part="stepper" class="input__number-stepper">
                <button
                  ...
                  aria-hidden="true"
                  ${_n({start:()=>this.handleStepDown(),end:()=>this.handleChange()})}
                  tabindex="-1"
                >
                ...
                <button
                  ...
                  aria-hidden="true"
                  ${_n({start:()=>this.handleStepUp(),end:()=>this.handleChange()})}
                  tabindex="-1"
                >
    ...
    `:p` <slot name="submenu" hidden></slot> `}}const Zo=h`
	/* stylelint-disable */
  :host {
    --submenu-offset: -2px;
...
`;function ts(a,e){const t={waitUntilFirstUpdated:!1,...e};return n=>class extends n{#e=!t.waitUntilFirstUpdated;updated(i){if(!this.#e){this.#e=!0;return}const o=Array.from(i).filter(([l])=>a.includes(l));if(o.length===0){super.updated(i);return}const s=o.map(([l,d])=>({attribute:l,newValue:this[l],oldValue:d}));this.emit("syn-attributes-changed",{detail:s}),super.updated(i)}}}var ns=Object.defineProperty,is=Object.getOwnPropertyDescriptor,xe=(a,e,t,n)=>{for(var i=n>1?void 0:n?is(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&ns(e,t,i),i};let ne=class extends v{constructor(){super(...arguments),this.localize=new j(this),this.type="normal",this.checked=!1,this.value="",this.loading=!1,this.disabled=!1,this.hasSlotController=new q(this,"submenu"),this.submenuController=new Jo(this,this.hasSlotController),this.handleHostClick=a=>{this.disabled&&(a.preventDefault(),a.stopImmediatePropagation())},this.handleMouseOver=a=>{this.focus(),a.stopPropagation()}}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this.handleHostClick),this.addEventListener("mouseover",this.handleMouseOver)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.handleHostClick),this.removeEventListener("mouseover",this.handleMouseOver)}handleDefaultSlotChange(){const a=this.getTextLabel();if(typeof this.cachedTextLabel>"u"){this.cachedTextLabel=a;return}a!==this.cachedTextLabel&&(this.cachedTextLabel=a,this.emit("slotchange",{bubbles:!0,composed:!1,cancelable:!1}))}handleCheckedChange(){if(this.checked&&this.type!=="checkbox"){this.checked=!1,console.error('The checked attribute can only be used on menu items with type="checkbox"',this);return}this.type==="checkbox"?this.setAttribute("aria-checked",this.checked?"true":"false"):this.removeAttribute("aria-checked")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleTypeChange(){this.type==="checkbox"?(this.setAttribute("role","menuitemcheckbox"),this.setAttribute("aria-checked",this.checked?"true":"false")):(this.setAttribute("role","menuitem"),this.removeAttribute("aria-checked"))}getTextLabel(){return Jn(this.defaultSlot)}isSubmenu(){return this.hasSlotController.test("submenu")}render(){const a=this.localize.dir()==="rtl",e=this.submenuController.isExpanded();return p`
    ...
    `}};ne.styles=[w,Zo,es];ne.dependencies={"syn-icon":ue,"syn-popup":O,"syn-spinner":tn};xe([u("slot:not([name])")],ne.prototype,"defaultSlot",2);xe([u(".menu-item")],ne.prototype,"menuItem",2);xe([r()],ne.prototype,"type",2);xe([r({type:Boolean,reflect:!0})],ne.prototype,"checked",2);xe([r()],ne.prototype,"value",2);xe([r({type:Boolean,reflect:!0})],ne.prototype,"loading",2);xe([r({type:Boolean,reflect:!0})],ne.prototype,"disabled",2);xe([m("checked")],ne.prototype,"handleCheckedChange",1);xe([m("disabled")],ne.prototype,"handleDisabledChange",1);xe([m("type")],ne.prototype,"handleTypeChange",1);ne=xe([ts(["type","loading"],{waitUntilFirstUpdated:!0})],ne);ne.define("syn-menu-item");const as=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`;class ss extends v{static{this.styles=[w,as,os]}static{this.dependencies={"syn-divider":Fe}}render(){return p`
    ...
    `}}ss.define("syn-menu-label");const rs=h`
	/* stylelint-disable */
  :host {
    display: block;
    position: relative;
...
`;var ds=Object.defineProperty,li=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&ds(e,t,i),i};class It extends v{constructor(){super(...arguments),this.hasMenuItemsWithCheckmarks=!1,this.updateCheckMarksByChildPropChange=e=>{e.stopImmediatePropagation(),this.handleUpdateCheckmarks(this.getAllItems())}}static{this.styles=[w,rs,ls]}handleUpdateCheckmarks(e){this.hasMenuItemsWithCheckmarks=e.some(t=>t.type==="checkbox"||t.loading)}disconnectedCallback(){this.removeEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu"),this.addEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}handleClick(e){const t=["menuitem","menuitemcheckbox"],n=e.composedPath(),i=n.find(d=>t.includes(d?.getAttribute?.("role")||""));if(!i||n.find(d=>d?.getAttribute?.("role")==="menu")!==this)return;const l=i;l.type==="checkbox"&&(l.checked=!l.checked),this.emit("syn-select",{detail:{item:l}})}handleKeyDown(e){if(e.key==="Enter"||e.key===" "){const t=this.getCurrentItem();e.preventDefault(),e.stopPropagation(),t?.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(e.key)){const t=this.getAllItems(),n=this.getCurrentItem();let i=n?t.indexOf(n):0;t.length>0&&(e.preventDefault(),e.stopPropagation(),e.key==="ArrowDown"?i++:e.key==="ArrowUp"?i--:e.key==="Home"?i=0:e.key==="End"&&(i=t.length-1),i<0&&(i=t.length-1),i>t.length-1&&(i=0),this.setCurrentItem(t[i]),t[i].focus())}}handleMouseDown(e){const t=e.target;this.isMenuItem(t)&&this.setCurrentItem(t)}handleSlotChange(){const e=this.getAllItems();this.handleUpdateCheckmarks(e),e.length>0&&this.setCurrentItem(e[0])}isMenuItem(e){return e.tagName.toLowerCase()==="syn-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes(e.getAttribute("role")??"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>!(e.inert||!this.isMenuItem(e)))}getCurrentItem(){return this.getAllItems().find(e=>e.getAttribute("tabindex")==="0")}setCurrentItem(e){this.getAllItems().forEach(n=>{n.setAttribute("tabindex",n===e?"0":"-1")})}render(){return p`
      ...
      ></slot>
    `}}li([u("slot")],It.prototype,"defaultSlot");li([b()],It.prototype,"hasMenuItemsWithCheckmarks");It.define("syn-menu");const cs=h`
  /**
...
`;var ms=Object.defineProperty,fs=Object.getOwnPropertyDescriptor,Nt=(a,e,t,n)=>{for(var i=n>1?void 0:n?fs(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&ms(e,t,i),i};class xt extends v{constructor(){super(...arguments),this.hasSlotController=new q(this,"[default]","prefix","suffix","label"),this.disabled=!1,this.label=""}static{this.styles=us}static{this.dependencies={"syn-divider":Fe}}handleDisableOptions(){const{disabled:e}=this;this.defaultSlot.assignedElements().filter(t=>t.tagName.toLowerCase()==="syn-option").forEach(t=>{t.disabled=e})}handleDisabledChange(){this.handleDisableOptions()}render(){const{disabled:e}=this,t=this.hasSlotController.test("label"),n=this.label?!0:!!t;return k`
      <div
    ...
    `}}Nt([u("slot:not([name])")],xt.prototype,"defaultSlot",2);Nt([r({reflect:!0,type:Boolean})],xt.prototype,"disabled",2);Nt([r()],xt.prototype,"label",2);Nt([m("disabled",{waitUntilFirstUpdate:!0})],xt.prototype,"handleDisabledChange",1);xt.define("syn-optgroup");ve.define("syn-option");O.define("syn-popup");const ys=h`
  :host {
    display: block;
...
`,Tn=a=>Array.from(a.assignedElements({flatten:!0})),bs=a=>a.tagName.toLocaleLowerCase()==="syn-nav-item"||(a.getAttribute("role")??"")==="menuitem",Cn=a=>a.filter(bs),gs=a=>{a.setAttribute("horizontal","true"),a.removeAttribute("slot"),a.removeAttribute("tabindex"),a.dataset.originalRole?a.setAttribute("role",a.dataset.originalRole):a.removeAttribute("role")},vs=a=>{a.removeAttribute("horizontal"),a.setAttribute("slot","menu"),a.setAttribute("role","menuitem")};var ws=Object.defineProperty,Ve=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&ws(e,t,i),i};class Ie extends v{constructor(){super(...arguments),this.localize=new j(this),this.itemPositionsCached=!1,this.amountOfNavItems=0,this.amountOfVisibleItems=0,this.hasItemsInDropdown=!1}static{this.styles=[w,ys]}static{this.dependencies={"syn-dropdown":ae,"syn-icon":ue,"syn-menu":It,"syn-nav-item":J}}getSlottedNavItems(){const e=Cn(Tn(this.defaultSlot)),t=Cn(Tn(this.menuSlot));return e.concat(t)}cacheItemPositions(e){const{left:t}=this.horizontalNav.getBoundingClientRect();e.forEach(n=>{n.removeAttribute("slot");const{right:i}=n.getBoundingClientRect();n.dataset.right=(i-t).toString()}),this.itemPositionsCached=!0}handlePriorityMenu(){const e=this.getSlottedNavItems();this.itemPositionsCached||this.cacheItemPositions(e);const{width:t}=this.horizontalNav.getBoundingClientRect(),n=this.priorityMenu.classList.contains("priority-menu--hidden")?0:this.priorityMenu.clientWidth,i=t-n;let o;const s=e.at(-1),l=e.map(y=>{const T=y===s?t:i,U=!!(o||parseFloat(y.dataset.right)>T);return U&&!o&&(o=parseFloat(y.dataset.right)),{isHidden:U,item:y}}),d=l.filter(({isHidden:y})=>!y).length,c=d===1;l.forEach(({item:y,isHidden:T})=>{T||c?vs(y):gs(y)}),this.hasItemsInDropdown=d!==e.length,this.amountOfVisibleItems=c?0:d}renderPriorityMenu(){return k`
      <syn-dropdown
...
`;var _s=Object.defineProperty,an=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&_s(e,t,i),i};class At extends v{constructor(){super(...arguments),this.localize=new j(this),this.value=0,this.indeterminate=!1,this.label=""}static{this.styles=[w,xs,ks]}render(){return p`
      <div
        part="base"
    ...
    `}}an([r({type:Number,reflect:!0})],At.prototype,"value");an([r({type:Boolean,reflect:!0})],At.prototype,"indeterminate");an([r()],At.prototype,"label");At.define("syn-progress-bar");const Ts=h`
	/* stylelint-disable */
  :host {
    --size: 128px;
    --track-width: 4px;
...
`;var Ss=Object.defineProperty,Mt=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Ss(e,t,i),i};class kt extends v{constructor(){super(...arguments),this.localize=new j(this),this.value=0,this.label=""}static{this.styles=[w,Ts,Cs]}updated(e){if(super.updated(e),e.has("value")){const t=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),n=2*Math.PI*t,i=n-this.value/100*n;this.indicatorOffset=`${i}px`}}render(){return p`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
    ...
    `}}Mt([u(".progress-ring__indicator")],kt.prototype,"indicator");Mt([b()],kt.prototype,"indicatorOffset");Mt([r({type:Number,reflect:!0})],kt.prototype,"value");Mt([r()],kt.prototype,"label");kt.define("syn-progress-ring");const zs=h`
	/* stylelint-disable */
  ${ni}
...
`;var Es=Object.defineProperty,$s=Object.getOwnPropertyDescriptor,Ne=(a,e,t,n)=>{for(var i=n>1?void 0:n?$s(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Es(e,t,i),i};class Se extends v{constructor(){super(...arguments),this.hasSlotController=new q(this,"[default]","prefix","suffix"),this.hasFocus=!1,this.checked=!1,this.disabled=!1,this.size="medium",this.pill=!1}static{this.styles=[w,zs]}connectedCallback(){super.connectedCallback(),this.setAttribute("role","presentation")}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleClick(e){if(this.disabled){e.preventDefault(),e.stopPropagation();return}this.checked=!0}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}focus(e){this.input.focus(e)}blur(){this.input.blur()}render(){return k`
...
`;var Ps=Object.defineProperty,Ls=Object.getOwnPropertyDescriptor,Je=(a,e,t,n)=>{for(var i=n>1?void 0:n?Ls(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Ps(e,t,i),i};class He extends v{constructor(){super(),this.checked=!1,this.hasFocus=!1,this.size="medium",this.disabled=!1,this.handleBlur=()=>{this.hasFocus=!1,this.emit("syn-blur")},this.handleClick=()=>{this.disabled||(this.checked=!0)},this.handleFocus=()=>{this.hasFocus=!0,this.emit("syn-focus")},this.addEventListener("blur",this.handleBlur),this.addEventListener("click",this.handleClick),this.addEventListener("focus",this.handleFocus)}static{this.styles=[w,As,Ms]}static{this.dependencies={"syn-icon":ue}}connectedCallback(){super.connectedCallback(),this.setInitialAttributes()}setInitialAttributes(){this.setAttribute("role","radio"),this.setAttribute("tabindex","-1"),this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleCheckedChange(){this.setAttribute("aria-checked",this.checked?"true":"false"),this.setAttribute("tabindex",this.checked?"0":"-1")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}render(){return p`
      <span
        part="base"
    ...
    `}}Je([b()],He.prototype,"checked",2);Je([b()],He.prototype,"hasFocus",2);Je([r()],He.prototype,"value",2);Je([r({reflect:!0})],He.prototype,"size",2);Je([r({type:Boolean,reflect:!0})],He.prototype,"disabled",2);Je([m("checked")],He.prototype,"handleCheckedChange",1);Je([m("disabled",{waitUntilFirstUpdate:!0})],He.prototype,"handleDisabledChange",1);He.define("syn-radio");const js=h`
  :host {
...
`;var Fs=Object.defineProperty,Vs=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Fs(e,t,i),i};class di extends v{constructor(){super(...arguments),this.subdivision=!1}static{this.styles=[w,js]}render(){return p`
      <div
    ...
    `}}Vs([r({reflect:!0,type:Boolean})],di.prototype,"subdivision");di.define("syn-range-tick");const Hs=h`
	/* stylelint-disable */
  :host {
    --max-width: 20rem;
    --hide-delay: 0ms;
...
`;var Rs=Object.defineProperty,Us=Object.getOwnPropertyDescriptor,de=(a,e,t,n)=>{for(var i=n>1?void 0:n?Us(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Rs(e,t,i),i};class Z extends v{constructor(){super(),this.localize=new j(this),this.content="",this.placement="top",this.disabled=!1,this.distance=13,this.open=!1,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleBlur=()=>{this.hasTrigger("focus")&&this.hide()},this.handleClick=()=>{this.hasTrigger("click")&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger("focus")&&this.show()},this.handleDocumentKeyDown=e=>{e.key==="Escape"&&(e.stopPropagation(),this.hide())},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){const e=mn(getComputedStyle(this).getPropertyValue("--show-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.show(),e)}},this.handleMouseOut=()=>{if(this.hasTrigger("hover")){const e=mn(getComputedStyle(this).getPropertyValue("--hide-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.hide(),e)}},this.addEventListener("blur",this.handleBlur,!0),this.addEventListener("focus",this.handleFocus,!0),this.addEventListener("click",this.handleClick),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}static{this.styles=[w,Hs,Bs]}static{this.dependencies={"syn-popup":O}}disconnectedCallback(){super.disconnectedCallback(),this.closeWatcher?.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(e){return this.trigger.split(" ").includes(e)}async handleOpenChange(){if(this.open){if(this.disabled)return;this.emit("syn-show"),"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide()}):document.addEventListener("keydown",this.handleDocumentKeyDown),await K(this.body),this.body.hidden=!1,this.popup.active=!0;const{keyframes:e,options:t}=N(this,"tooltip.show",{dir:this.localize.dir()});await F(this.popup.popup,e,t),this.popup.reposition(),this.emit("syn-after-show")}else{this.emit("syn-hide"),this.closeWatcher?.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown),await K(this.body);const{keyframes:e,options:t}=N(this,"tooltip.hide",{dir:this.localize.dir()});await F(this.popup.popup,e,t),this.popup.active=!1,this.body.hidden=!0,this.emit("syn-after-hide")}}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,W(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,W(this,"syn-after-hide")}render(){return p`
    ...
    `}}de([u("slot:not([name])")],Z.prototype,"defaultSlot",2);de([u(".tooltip__body")],Z.prototype,"body",2);de([u("syn-popup")],Z.prototype,"popup",2);de([r()],Z.prototype,"content",2);de([r()],Z.prototype,"placement",2);de([r({type:Boolean,reflect:!0})],Z.prototype,"disabled",2);de([r({type:Number})],Z.prototype,"distance",2);de([r({type:Boolean,reflect:!0})],Z.prototype,"open",2);de([r({type:Number})],Z.prototype,"skidding",2);de([r()],Z.prototype,"trigger",2);de([r({type:Boolean})],Z.prototype,"hoist",2);de([m("open",{waitUntilFirstUpdate:!0})],Z.prototype,"handleOpenChange",1);de([m(["content","distance","hoist","placement","skidding"])],Z.prototype,"handleOptionsChange",1);de([m("disabled")],Z.prototype,"handleDisabledChange",1);_("tooltip.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:150,easing:"ease"}});_("tooltip.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:150,easing:"ease"}});const Ke=(a,e)=>a-e,ht=(a,e)=>{if(a.length!==e.length)return!0;const t=a.slice().sort(Ke),n=e.slice().sort(Ke);for(let i=0;i<t.length;i+=1)if(t[i]!==n[i])return!0;return!1},Sn=(a,e,t)=>{const n=a.getBoundingClientRect(),i=n.width;if(i<=0)return 0;let o=e;return o-=n.left,o<=0?t?1:0:o>=i?t?0:1:(o/=i,t?1-o:o)},Ws=h`
  :host {
    /*
...
`;var qs=Object.defineProperty,Ks=Object.getOwnPropertyDescriptor,Y=(a,e,t,n)=>{for(var i=n>1?void 0:n?Ks(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&qs(e,t,i),i};class G extends v{constructor(){super(),this.name="",this.label="",this.helpText="",this.disabled=!1,this.min=0,this.max=100,this.step=1,this.size="medium",this.tooltipPlacement="top",this.restrictMovement=!1,this.defaultValue="0",this.form="",this.hasSlotController=new q(this,"help-text","label","prefix","suffix","ticks"),this.formControlController=new _e(this,{assumeInteractionOn:["syn-change"]}),this.localize=new j(this),this.#e=[0],this.#t=new Map,this.#o=!1,this.#i="",this.#n=[],this.tooltipFormatter=this.localize.number.bind(this.localize)}static{this.styles=[w,$e,Oe,Ws]}static{this.dependencies={"syn-tooltip":Z}}set value(e){this.#e=e?e.split(" ").map(t=>+t).sort(Ke):[]}get value(){return this.#e.slice().sort(Ke).join(" ")}set valueAsArray(e){const t=this.#e;this.#e=Array.isArray(e)?e.slice().sort(Ke):e||[],ht(t,this.#e)&&this.requestUpdate("value",t.join(" "))}get valueAsArray(){return[...this.#e].sort(Ke)}#e;#t;#o;#i;#c;#n;get#s(){return this.localize.dir()==="rtl"}disconnectedCallback(){super.disconnectedCallback(),this?.visibilityObserver?.disconnect()}firstUpdated(){this.visibilityObserver=new IntersectionObserver(e=>{const t=e.at(0);t&&t.isIntersecting&&t.target.checkVisibility()&&this.#w(t.boundingClientRect.height)},{root:this.ticks.parentElement}),this.visibilityObserver.observe(this.ticks),this.formControlController.updateValidity(),this.#n=Array.from(this.#e),this.thumbs.forEach(e=>{const t=e.parentElement;t.updateComplete.then(()=>{t.shadowRoot.querySelector(".tooltip__body")?.setAttribute("aria-hidden","true")})})}willUpdate(e){super.willUpdate(e),this.min>this.max&&([this.min,this.max]=[this.max,this.min]),this.step>this.max-this.min&&(this.step=this.max-this.min),this.step<=0&&(this.step=1);const t=this.#e.map(n=>{if(n<=this.min)return this.min;if(n>=this.max)return this.max;const i=this.min+this.step*Math.round((n-this.min)/this.step);return i>this.max?this.max:i});ht(this.#e,t)&&(this.#e=t)}updated(e){super.updated(e);for(const t of this.thumbs){const n=+t.dataset.rangeId;this.#t.has(n)&&this.#r(t,this.#t.get(n))}this.#l()}focus(e){const t=this.thumbs.item(0);t?t.focus(e):super.focus(e)}checkValidity(){if(this.disabled)return!0;const e=!this.#i;return e||this.formControlController.emitInvalidEvent(),e}reportValidity(){if(this.disabled)return!0;const e=this.validity.valid;return this.formControlController.setValidity(e),this.validationInput.hidden=!0,clearTimeout(this.#c),e||(this.validationInput.hidden=!1,this.validationInput.reportValidity(),this.#c=setTimeout(()=>{this.validationInput.hidden=!0},1e4)),e}setCustomValidity(e){this.#i=e,this.validationInput.setCustomValidity(e),this.formControlController.updateValidity()}getForm(){return this.formControlController.getForm()}get validity(){return this.#i?ti:vt}get validationMessage(){return this.#i}#p(e,t=!0){if(this.disabled)return;const{clientX:n}=e,i=Array.from(this.thumbs),o=Sn(this.baseDiv,n,this.#s),s=this.step/(this.max-this.min),l=this.min+this.step*Math.round(o/s),d=i.reduce((U,ze)=>{const be=this.#t.get(+ze.dataset.rangeId),Pe=this.#t.get(+U.dataset.rangeId),Ue=Math.abs(be-l),We=Math.abs(Pe-l);return Ue===We?be<l?ze:U:Ue<We?ze:U}),c=+d.dataset.rangeId;if(!c)return;this.#t.set(c,l),this.#r(d,l);const y=this.#e;this.#e=Array.from(this.#t.values()),this.#l(),ht(y,this.#e)&&(this.#n=Array.from(this.#e),this.emit("syn-input"),this.emit("syn-change"));const T=new PointerEvent("pointerdown",e);t&&d.dispatchEvent(T)&&this.#a(d)}#u(e){this.#p(e,!1)}#h(e,t){const n=this.valueAsArray,o=Array.from(this.thumbs).indexOf(e),s=n[o-1]||this.min,l=n[o+1]||this.max,d=t<s||t>l;return{finalValue:Math.max(s,Math.min(l,t)),isRestricted:d,nextValue:l,prevValue:s}}async#m(e){if(this.disabled)return;const t=e.target;this.#a(t),t.dataset.pointerId&&t.releasePointerCapture(+t.dataset.pointerId),t.dataset.pointerId=e.pointerId.toString(),t.setPointerCapture(e.pointerId),t.classList.add("grabbed"),await t.parentElement.show()}#f(e){if(this.disabled)return;const t=e.target,n=+t.dataset.rangeId;if(!this.#t.has(n)||(t.dataset.pointerId?+t.dataset.pointerId:null)!==e.pointerId)return;const o=Sn(this.baseDiv,e.clientX,this.#s),s=this.step/(this.max-this.min);let l=this.min+this.step*Math.round(o/s);if(this.emit("syn-move",{cancelable:!0,detail:{element:t,value:l}}).defaultPrevented)return;if(this.restrictMovement){const y=this.#h(t,l);y.isRestricted?(l=y.finalValue,t.style.zIndex=(3+this.thumbs.length).toFixed(0)):t.style.zIndex="3"}this.#t.set(n,l),this.#r(t,l);const c=this.#e;this.#e=Array.from(this.#t.values()),this.#l(),ht(c,this.#e)&&this.emit("syn-input")}async#d(e){const t=e.target;!t.dataset.pointerId||e.pointerId!==+t.dataset.pointerId||(t.classList.remove("grabbed"),t.releasePointerCapture(e.pointerId),delete t.dataset.pointerId,ht(this.#n,this.#e)&&(this.#n=Array.from(this.#e),this.emit("syn-change")),await t.parentElement.hide())}#r(e,t){e.setAttribute("aria-valuenow",t.toString()),e.setAttribute("aria-valuetext",this.tooltipFormatter(t));const n=(t-this.min)/(this.max-this.min);e.style.insetInlineStart=`calc( ${100*n}% - var(--full-thumb-size) / 2 )`,this.#a(e)}#l(){const{activeTrack:e}=this;if(!e)return;if(this.min===this.max){e.style.insetInlineStart="0%",e.style.insetInlineEnd="0%";return}if(this.#e.length===1){const o=getComputedStyle(this).getPropertyValue("--track-active-offset")||"0%",s=100*(this.#e[0]-this.min)/(this.max-this.min);e.style.insetInlineStart=`min(${o}, ${s}%)`,e.style.insetInlineEnd=`min(calc(100% - ${o}), calc(100% - ${s}%))`;return}const t=this.#e.slice().sort(Ke),n=100*(t[0]-this.min)/(this.max-this.min),i=100*(t[t.length-1]-this.min)/(this.max-this.min);e.style.insetInlineStart=`${n}%`,e.style.insetInlineEnd=`calc(100% - ${i}%)`}#y(e){const t=e.target,n=+t.dataset.rangeId,i=this.#t.get(n);if(i===void 0)return;let o=i;switch(e.key){case"ArrowUp":case"Up":o=Math.min(i+this.step,this.max);break;case"ArrowDown":case"Down":o=Math.max(i-this.step,this.min);break;case"ArrowLeft":case"Left":o=this.#s?Math.min(i+this.step,this.max):Math.max(i-this.step,this.min);break;case"ArrowRight":case"Right":o=this.#s?Math.max(i-this.step,this.min):Math.min(i+this.step,this.max);break;case"PageUp":o=Math.min(i+(this.max-this.min)/5,this.max);break;case"PageDown":o=Math.max(i-(this.max-this.min)/5,this.min);break;case"Home":o=this.min;break;case"End":o=this.max;break;default:return}if(o!==i){if(this.emit("syn-move",{cancelable:!0,detail:{element:t,value:o}}).defaultPrevented)return;if(this.restrictMovement){const l=this.#h(t,o);l.isRestricted&&(o=l.finalValue)}this.#r(t,o),this.#t.set(n,o),this.#e=Array.from(this.#t.values()),this.#l(),this.#a(t),this.#n=Array.from(this.#e),this.emit("syn-input"),this.emit("syn-change")}e.stopPropagation(),e.preventDefault()}#b(e){e.relatedTarget&&this.shadowRoot?.contains(e.relatedTarget)||(this.emit("syn-blur"),this.#o=!1)}#a(e){if(this.tooltipPlacement==="none")return;const t=+e.dataset.rangeId;if(!this.#t.has(t))return;const n=this.#t.get(t),i=e.parentElement;i.content=this.tooltipFormatter(n)}#g(e){if(this.disabled)return;this.#o||(this.#o=!0,this.emit("syn-focus"));const t=e.target;t?.dataset?.rangeId&&this.#a(t)}#v(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}#w(e){const t=this.hasSlotController.test("ticks"),n=this.hasSlotController.test("prefix"),i=this.hasSlotController.test("suffix");if(!t)return;let o=e||this.shadowRoot?.querySelector(".ticks")?.clientHeight;if(o){if(o+=2,o/=2,n){const s=this.shadowRoot?.querySelector(".input__prefix");s.style.transform=`translateY(-${o}px)`}if(i){const s=this.shadowRoot?.querySelector(".input__suffix");s.style.transform=`translateY(-${o}px)`}}}renderThumbs(e){const t=this.#e.length>1;return this.#t.clear(),this.#e.map((n,i)=>{const o=i+1;this.#t.set(o,n);const s=`thumb-${o}`;let l="",d="";return t?(d=e?`label aria-label-hidden ${s}`:`aria-label-hidden ${s}`,i===0?l=`${this.localize.term("rangeMin")} (${this.tooltipFormatter(n)})`:i===this.#e.length-1?l=`${this.localize.term("rangeMax")} (${this.tooltipFormatter(n)})`:l=this.tooltipFormatter(n)):d=e?"label aria-label-hidden":"",p`
    ...
    `}}Y([r()],G.prototype,"name",2);Y([r()],G.prototype,"label",2);Y([r({attribute:"help-text"})],G.prototype,"helpText",2);Y([r({reflect:!0,type:Boolean})],G.prototype,"disabled",2);Y([r({type:Number})],G.prototype,"min",2);Y([r({type:Number})],G.prototype,"max",2);Y([r({type:Number})],G.prototype,"step",2);Y([r({reflect:!0})],G.prototype,"size",2);Y([r({attribute:"tooltip-placement",type:String})],G.prototype,"tooltipPlacement",2);Y([r({type:String})],G.prototype,"value",1);Y([r({attribute:"restrict-movement",type:Boolean})],G.prototype,"restrictMovement",2);Y([Xe()],G.prototype,"defaultValue",2);Y([r({reflect:!0})],G.prototype,"form",2);Y([r({attribute:!1})],G.prototype,"tooltipFormatter",2);Y([u(".input__wrapper")],G.prototype,"baseDiv",2);Y([u(".active-track")],G.prototype,"activeTrack",2);Y([u(".ticks")],G.prototype,"ticks",2);Y([$i(".thumb")],G.prototype,"thumbs",2);Y([u(".range__validation-input")],G.prototype,"validationInput",2);G.define("syn-range");const Gs=h`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
`;var Xs=Object.defineProperty,ci=(a,e,t,n)=>{for(var i=void 0,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=s(e,t,i)||i);return i&&Xs(e,t,i),i};class Pt extends v{constructor(){super(...arguments),this.localize=new j(this),this.size="medium",this.removable=!1}static{this.styles=[w,Gs,Ys]}static{this.dependencies={"syn-icon-button":it}}handleRemoveClick(){this.emit("syn-remove")}render(){return p`
      <span
        part="base"
    ...
    `}}ci([r({reflect:!0})],Pt.prototype,"size");ci([r({type:Boolean})],Pt.prototype,"removable");const Qs=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`,Js=h`
  ...
  ${ai}
`;var Zs=Object.defineProperty,er=Object.getOwnPropertyDescriptor,D=(a,e,t,n)=>{for(var i=n>1?void 0:n?er(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Zs(e,t,i),i};class $ extends v{constructor(){super(...arguments),this.formControlController=new _e(this,{assumeInteractionOn:["syn-blur","syn-input"]}),this.hasSlotController=new q(this,"help-text","label"),this.localize=new j(this),this.typeToSelectString="",this.hasFocus=!1,this.displayLabel="",this.selectedOptions=[],this.valueHasChanged=!1,this.name="",this._value="",this.defaultValue="",this.size="medium",this.placeholder="",this.multiple=!1,this.maxOptionsVisible=3,this.disabled=!1,this.clearable=!1,this.open=!1,this.hoist=!1,this.label="",this.placement="bottom",this.helpText="",this.form="",this.required=!1,this.getTag=e=>p`
      <syn-tag
        part="tag"
        exportparts="
              base:tag__base,
...
`;var nr=Object.defineProperty,ir=Object.getOwnPropertyDescriptor,Be=(a,e,t,n)=>{for(var i=n>1?void 0:n?ir(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&nr(e,t,i),i};class Ae extends v{constructor(){super(),this.hasSlotController=new q(this,"[default]","footer"),this.localize=new j(this),this.isAnimationActive=!1,this.open=!1,this.rail=!1,this.noFocusTrapping=!1,this.handleMouseEnter=this.handleMouseEnter.bind(this),this.handleMouseLeave=this.handleMouseLeave.bind(this),this.addEventListener("syn-initial-focus",e=>{this.rail&&(e.preventDefault(),this.drawer.originalTrigger=null)}),this.addEventListener("focusin",e=>{e.target.tagName.toLowerCase()==="syn-nav-item"&&this.rail&&!this.open&&(this.open=!0)}),this.addEventListener("focusout",e=>{const t=e.target.tagName.toLowerCase(),n=e.relatedTarget?.tagName.toLowerCase();t==="syn-nav-item"&&n!=="syn-nav-item"&&this.rail&&this.open&&(this.open=!1)})}static{this.styles=[w,tr]}static{this.dependencies={"syn-divider":Fe,"syn-drawer":ye}}setDelayedCallback(e){clearTimeout(this.timeout),this.timeout=setTimeout(e,100)}handleMouseEnter(){this.setDelayedCallback(()=>{this.open=!0})}handleMouseLeave(){this.setDelayedCallback(()=>{this.open=!1})}handleRequestClose(){this.open&&(this.open=!1)}addMouseListener(){this.drawer.shadowRoot.querySelector(".drawer__panel")?.addEventListener("mouseenter",this.handleMouseEnter),this.drawer.shadowRoot.querySelector(".drawer__panel")?.addEventListener("mouseleave",this.handleMouseLeave)}removeMouseListener(){this.drawer.shadowRoot.querySelector(".drawer__panel")?.removeEventListener("mouseenter",this.handleMouseEnter),this.drawer.shadowRoot.querySelector(".drawer__panel")?.removeEventListener("mouseleave",this.handleMouseLeave)}setDrawerVisibility(e){this.drawer.shadowRoot.querySelector(".drawer").hidden=!e,this.drawer.shadowRoot.querySelector(".drawer__panel")?.setAttribute("aria-hidden",e?"false":"true")}forceDrawerVisibilityForRailMode(){return W(this.drawer,"syn-after-hide").then(()=>{this.setDrawerVisibility(!0),this.isAnimationActive=!1})}setDrawerAnimations(){const e=N(this,`sideNav.show${this.rail?"Rail":"NonRail"}`,{dir:this.localize.dir()}),t=N(this,`sideNav.hide${this.rail?"Rail":"NonRail"}`,{dir:this.localize.dir()}),n=N(this,"sideNav.overlay.hide",{dir:this.localize.dir()}),i=N(this,"sideNav.overlay.show",{dir:this.localize.dir()});Tt(this.drawer,"drawer.showStart",e),Tt(this.drawer,"drawer.hideStart",t),Tt(this.drawer,"drawer.overlay.hide",n),Tt(this.drawer,"drawer.overlay.show",i)}handleModeChange(){this.setDrawerAnimations(),this.rail?(this.addMouseListener(),this.setDrawerVisibility(!0)):(this.removeMouseListener(),this.open||this.setDrawerVisibility(!1))}handleOpenChange(){this.rail&&(this.isAnimationActive=!0,this.open?W(this.drawer,"syn-after-show").then(()=>{this.isAnimationActive=!1}):this.forceDrawerVisibilityForRailMode())}handleFocusTrapping(){this.rail||(this.noFocusTrapping?this.drawer.modal.activateExternal():this.drawer.modal.deactivateExternal())}async show(){if(!this.open)return this.open=!0,W(this.drawer,"syn-after-show")}async hide(){if(this.open)return this.open=!1,W(this.drawer,"syn-after-hide")}firstUpdated(){this.setDrawerAnimations(),this.drawer.updateComplete.then(()=>{this.drawer.shadowRoot.querySelector(".drawer__panel").tabIndex=-1}),this.rail?this.drawer.updateComplete.then(()=>{this.addMouseListener(),this.setDrawerVisibility(!0)}):this.noFocusTrapping&&this.drawer.modal.activateExternal()}disconnectedCallback(){super.disconnectedCallback(),this.drawer&&(tt(this.drawer),this.drawer.modal.deactivate())}render(){const e=window.navigator.maxTouchPoints>0||"ontouchstart"in window,t=this.hasSlotController.test("footer");return k`
      <nav
...
:host([size='small']) {
  ...
  `;var sr=Object.defineProperty,rr=Object.getOwnPropertyDescriptor,ce=(a,e,t,n)=>{for(var i=n>1?void 0:n?rr(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&sr(e,t,i),i};class se extends v{constructor(){super(...arguments),this.formControlController=new _e(this,{value:e=>e.checked?e.value||"on":void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=t}),this.hasSlotController=new q(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}static{this.styles=[w,$e,ar,Oe,or]}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleInput(){this.emit("syn-input")}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleClick(){this.checked=!this.checked,this.emit("syn-change")}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleKeyDown(e){e.key==="ArrowLeft"&&(e.preventDefault(),this.checked=!1,this.emit("syn-change"),this.emit("syn-input")),e.key==="ArrowRight"&&(e.preventDefault(),this.checked=!0,this.emit("syn-change"),this.emit("syn-input"))}handleCheckedChange(){this.input.checked=this.checked,this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(!0)}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("help-text"),t=this.helpText?!0:!!e;return p`
      <div
        class=${f({"form-control":!0,"form-control--small":this.size==="small","form-control--medium":this.size==="medium","form-control--large":this.size==="large","form-control--has-help-text":t})}
      >
        <label
    ...
    `}}ce([u('input[type="checkbox"]')],se.prototype,"input",2);ce([b()],se.prototype,"hasFocus",2);ce([r()],se.prototype,"title",2);ce([r()],se.prototype,"name",2);ce([r()],se.prototype,"value",2);ce([r({reflect:!0})],se.prototype,"size",2);ce([r({type:Boolean,reflect:!0})],se.prototype,"disabled",2);ce([r({type:Boolean,reflect:!0})],se.prototype,"checked",2);ce([Xe("checked")],se.prototype,"defaultChecked",2);ce([r({reflect:!0})],se.prototype,"form",2);ce([r({type:Boolean,reflect:!0})],se.prototype,"required",2);ce([r({attribute:"help-text"})],se.prototype,"helpText",2);ce([m("checked",{waitUntilFirstUpdate:!0})],se.prototype,"handleCheckedChange",1);ce([m("disabled",{waitUntilFirstUpdate:!0})],se.prototype,"handleDisabledChange",1);se.define("syn-switch");const lr=(a,e)=>{let t=0;return function(...n){window.clearTimeout(t),t=window.setTimeout(()=>{a.call(this,...n)},e)}},zn=(a,e,t)=>{const n=a[e];a[e]=function(...i){n.call(this,...i),t.call(this,n,...i)}},dr="onscrollend"in window;if(!dr){const a=new Set,e=new WeakMap,t=i=>{for(const o of i.changedTouches)a.add(o.identifier)},n=i=>{for(const o of i.changedTouches)a.delete(o.identifier)};document.addEventListener("touchstart",t,!0),document.addEventListener("touchend",n,!0),document.addEventListener("touchcancel",n,!0),zn(EventTarget.prototype,"addEventListener",function(i,o){if(o!=="scrollend")return;const s=lr(()=>{a.size?s():this.dispatchEvent(new Event("scrollend"))},100);i.call(this,"scroll",s,{passive:!0}),e.set(this,s)}),zn(EventTarget.prototype,"removeEventListener",function(i,o){if(o!=="scrollend")return;const s=e.get(this);s&&i.call(this,"scroll",s,{passive:!0})})}const cr=h`
	/* stylelint-disable */
  :host {
    display: contents;
  }
`;var pr=Object.defineProperty,hr=Object.getOwnPropertyDescriptor,pi=(a,e,t,n)=>{for(var i=n>1?void 0:n?hr(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&pr(e,t,i),i};class on extends v{constructor(){super(...arguments),this.observedElements=[],this.disabled=!1}static{this.styles=[w,cr]}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{this.emit("syn-resize",{detail:{entries:e}})}),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}handleSlotChange(){this.disabled||this.startObserver()}startObserver(){const e=this.shadowRoot.querySelector("slot");if(e!==null){const t=e.assignedElements({flatten:!0});this.observedElements.forEach(n=>this.resizeObserver.unobserve(n)),this.observedElements=[],t.forEach(n=>{this.resizeObserver.observe(n),this.observedElements.push(n)})}}stopObserver(){this.resizeObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}render(){return p` <slot @slotchange=${this.handleSlotChange}></slot> `}}pi([r({type:Boolean,reflect:!0})],on.prototype,"disabled",2);pi([m("disabled",{waitUntilFirstUpdate:!0})],on.prototype,"handleDisabledChange",1);const ur=h`
	/* stylelint-disable */
  :host {
    --indicator-color: var(--syn-color-primary-600);
    --track-color: var(--syn-color-neutral-200);
...
`;var vr=Object.defineProperty,wr=Object.getOwnPropertyDescriptor,sn=(a,e,t,n)=>{for(var i=n>1?void 0:n?wr(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&vr(e,t,i),i};let xr=0;class Lt extends v{constructor(){super(...arguments),this.attrId=++xr,this.componentId=`syn-tab-panel-${this.attrId}`,this.name="",this.active=!1}static{this.styles=[w,br,gr]}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return p`
      <slot
        part="base"
        class=${f({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}}sn([r({reflect:!0})],Lt.prototype,"name",2);sn([r({type:Boolean,reflect:!0})],Lt.prototype,"active",2);sn([m("active")],Lt.prototype,"handleActiveChange",1);Lt.define("syn-tab-panel");const kr=h`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
`;var Tr=Object.defineProperty,Cr=Object.getOwnPropertyDescriptor,Re=(a,e,t,n)=>{for(var i=n>1?void 0:n?Cr(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Tr(e,t,i),i};let Sr=0;class Me extends v{constructor(){super(...arguments),this.localize=new j(this),this.attrId=++Sr,this.componentId=`syn-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}static{this.styles=[w,kr,_r]}static{this.dependencies={"syn-icon-button":it}}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}handleCloseClick(e){e.stopPropagation(),this.emit("syn-close")}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false"),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,p`
      <div
        part="base"
...
`;var Ar=Object.defineProperty,Mr=Object.getOwnPropertyDescriptor,fe=(a,e,t,n)=>{for(var i=n>1?void 0:n?Mr(e,t):e,o=a.length-1,s;o>=0;o--)(s=a[o])&&(i=(n?s(e,t,i):s(i))||i);return n&&i&&Ar(e,t,i),i};class pe extends v{constructor(){super(...arguments),this.controller=new AbortController,this.validationMessage="",this.eagerFirstMount=!0,this.isInternalTriggeredInvalid=!1,this.isValid=!0,this.variant="native",this.hideIcon=!1,this.on="",this.customValidationMessage="",this.eager=!1,this.internalRevalidate=e=>{e.currentTarget.validity?.valid&&(this.validationMessage="")},this.validate=e=>{if(Ht(e.type)&&this.variant==="native"&&this.isInternalTriggeredInvalid===!0){this.isInternalTriggeredInvalid=!1;return}Ht(e.type)&&this.variant!=="native"&&(e.preventDefault(),e.stopPropagation());const t=e.currentTarget;if(this.isValid=t.validity?.valid,this.eager&&this.eagerFirstMount){this.eagerFirstMount=!1,this.setValidationMessage(t);return}!this.isValid&&!En(e.type)&&this.handleFocus(t),this.setValidationMessage(t),!En(e.type)&&this.variant==="native"&&this.updateComplete.then(()=>{this.isInternalTriggeredInvalid=!0,t.reportValidity()})}}static{this.styles=[w,Nr]}static{this.dependencies={"syn-alert":ge}}handleListenerChange(){this.updateEvents()}async handleEagerChange(){if(this.eager){const e=this.getInput();await this.updateComplete,e?.reportValidity(),this.eagerFirstMount=!0}else this.eagerFirstMount=!1}handleCustomValidationMessageChange(){const e=this.getInput();e&&(this.setCustomValidationMessage(e),this.setValidationMessage(e))}getValidity(){return this.isValid}getInput(){const e=this.slottedChildren[0];return e||void 0}getUsedEventNames(){const e=this.getInput();if(!e)return[];const t=Ir(this.on),[...n]=t.filter(Boolean);return n.includes("invalid")||n.push("invalid"),n.includes("live")&&(n.push("input"),n.push("blur")),Array.from(new Set(n.filter(i=>i!=="live").map(i=>$n(e,i))))}updateEvents(){this.controller.abort(),this.controller=new AbortController;const e=this.getInput();if(!e)return;const t=this.getUsedEventNames();t.forEach(i=>{e.addEventListener(i,this.validate,{capture:Ht(i),signal:this.controller.signal})});const n=$n(e,"change");t.includes(n)||e.addEventListener(n,this.internalRevalidate,{signal:this.controller.signal})}setValidationMessage(e){const{customValidationMessage:t}=this,n=t||e.validationMessage;this.validationMessage=n}setCustomValidationMessage(e){e.setCustomValidity(this.customValidationMessage)}handleFocus(e){const t=document.activeElement,n=t.closest("syn-validate");!t.validity?.valid&&n||(e.scrollIntoView({block:"nearest"}),e.focus())}async firstUpdated(e){super.firstUpdated(e),this.updateEvents();const t=this.getInput();this.customValidationMessage&&(t instanceof v&&await t.updateComplete,t?.setCustomValidity(this.customValidationMessage)),this.eager&&(await this.updateComplete,this.isValid=t?.validity?.valid??!1,t?.reportValidity())}connectedCallback(){super.connectedCallback(),this.observer=new MutationObserver(e=>{const t=this.getInput();if(!t)return;e.filter(({target:i})=>i===t).every(i=>{const o=i.target;return o.hasAttribute("disabled")||o.hasAttribute("readonly")})?(this.isValid=!0,this.validationMessage=""):(t instanceof v?t.updateComplete:Promise.resolve()).then(()=>{this.isValid=t?.validity?.valid??!1,this.validationMessage=t?.validationMessage??""})}),this.observer.observe(this,{attributeFilter:["disabled","readonly"],attributes:!0,subtree:!0})}disconnectedCallback(){super.disconnectedCallback(),this.controller.abort(),this?.observer?.disconnect()}renderInlineValidation(){return this.variant!=="inline"||!this.validationMessage?"":p`
    ...
    `}}fe([Nn()],pe.prototype,"slottedChildren",2);fe([b()],pe.prototype,"validationMessage",2);fe([b()],pe.prototype,"eagerFirstMount",2);fe([b()],pe.prototype,"isInternalTriggeredInvalid",2);fe([b()],pe.prototype,"isValid",2);fe([r({reflect:!0})],pe.prototype,"variant",2);fe([r({attribute:"hide-icon",reflect:!0,type:Boolean})],pe.prototype,"hideIcon",2);fe([r({reflect:!0})],pe.prototype,"on",2);fe([r({attribute:"custom-validation-message",type:String})],pe.prototype,"customValidationMessage",2);fe([r({type:Boolean})],pe.prototype,"eager",2);fe([m("on",{waitUntilFirstUpdate:!0})],pe.prototype,"handleListenerChange",1);fe([m("eager",{waitUntilFirstUpdate:!1})],pe.prototype,"handleEagerChange",1);fe([m("customValidationMessage",{waitUntilFirstUpdate:!0})],pe.prototype,"handleCustomValidationMessageChange",1);pe.define("syn-validate");function Pr(a){const e=typeof window<"u"&&window;return!!(e&&(/Chromatic/.test(e.navigator.userAgent)||/chromatic=true/.test(e.location.href)))}const Lr=(a,...e)=>Pr()?p`
      ...
      ${a(...e)}
    `:a(...e),$t="🌞 light",Wt="🌙 dark",jr=a=>`https://www.figma.com/file/bZFqk9urD3NlghGUKrkKCR/Synergy-Digital-Design-System?type=design&node-id=${a}`,Fr=(a,e="Go to Figma page")=>({label:e,type:"link",url:jr(a)});function Vr(a,e){const t=document.querySelectorAll(`#anchor--${e.id}`),i=JSON.parse('{"@synergy-design-system/components":"2.18.6","@synergy-design-system/assets":"1.11.2","@synergy-design-system/styles":"1.6.0","@synergy-design-system/tokens":"2.17.0"}');return t.forEach(o=>{const s=o.querySelector(".docblock-code-toggle");if(s){const l=s.cloneNode(!0);l.textContent="Edit on CodePen",l.classList.add("docblock-codepen-button");const d=o.querySelector(".sb-bar");d?o.querySelectorAll(".docblock-codepen-button:not(:last-of-type)").forEach(c=>{c.remove()}):o.querySelectorAll(".docblock-codepen-button").forEach(c=>{c.remove()}),s.parentElement.appendChild(l),d&&(o.querySelectorAll(".docblock-codepen-button:not(:last-of-type)").forEach(c=>{c.style.display="block",c.style.borderRight="none"}),o.querySelector(".docblock-codepen-button:last-of-type").style.display="none"),l.addEventListener("click",()=>{const c=document.createElement("form");c.action="https://codepen.io/pen/define",c.method="POST",c.target="_blank";const y={css:`/* Import theme */
 ...
 */`,dependencies:["syn-alert"]}],exports:[{kind:"js",name:"default",declaration:{name:"SynValidate",module:"../components/src/components/validate/validate.js"}}]}],package:{author:{name:"SICK Global UX Foundation",url:"https://www.sick.com"},description:"",homepage:"https://synergy-design-system.github.io",license:"MIT",name:"@synergy-design-system/components",version:"2.18.6"}},Br={modules:[{declarations:[{attributes:[{default:"'syn-link-list--medium'",description:"The size of the link list",name:"syn-link-list",type:{text:"'syn-link-list--medium' | 'syn-link-list--small' | 'syn-link-list--large'"}},{default:"false",description:"Applies horizontal styling to the link list",name:"syn-link-list--horizontal",type:{text:"boolean"}}],customElement:!0,kind:"class",members:[{attribute:"syn-link-list",default:"'syn-link-list--medium'",description:"The size of the link list",kind:"field",name:"syn-link-list",type:{text:"'syn-link-list--medium' | 'syn-link-list--small' | 'syn-link-list--large'"}},{attribute:"syn-link-list--horizontal",default:"false",description:"Applies horizontal styling to the link list",kind:"field",name:"syn-link-list--horizontal",type:{text:"boolean"}}],name:"syn-link-list",slots:[{description:"Main content of syn-link-list",name:""}],tagName:"syn-link-list",tagNameWithoutPrefix:"link-list"}],description:"The size of the link list",kind:"javascript-module",path:"../styles/src/link-list/index.css"},{declarations:[{attributes:[{default:"true",description:"Applies the table cell styling",name:"syn-table-cell",type:{text:"boolean"}},{default:"false",description:"Applies an alternating style to help separate rows visually",name:"syn-table-cell--alternating",type:{text:"boolean"}},{default:"false",description:"Applies a border to the left of the table cell",name:"syn-table-cell--border-start",type:{text:"boolean"}},{default:"false",description:"Applies a border to the right of the table cell",name:"syn-table-cell--border-end",type:{text:"boolean"}},{default:"false",description:"Applies a border to the top of the table cell",name:"syn-table-cell--border-top",type:{text:"boolean"}},{default:"false",description:"Applies a border to the bottom of the table cell",name:"syn-table-cell--border-bottom",type:{text:"boolean"}},{default:"false",description:"Applies the table cell header styling",name:"syn-table-cell--header",type:{text:"boolean"}},{default:"",description:"Applies the selected shadow to the table cell",name:"syn-table-cell--shadow",type:{text:" | 'syn-table-cell--shadow-bottom' | 'syn-table-cell--shadow-top' | 'syn-table-cell--shadow-start' | 'syn-table-cell--shadow-end'"}},{default:"false",description:"Displays the table shadow",name:"syn-table-cell--shadow-active",type:{text:"boolean"}}],customElement:!0,kind:"class",members:[{attribute:"syn-table-cell",default:"true",description:"Applies the table cell styling",kind:"field",name:"syn-table-cell",type:{text:"boolean"}},{attribute:"syn-table-cell--alternating",default:"false",description:"Applies an alternating style to help separate rows visually",kind:"field",name:"syn-table-cell--alternating",type:{text:"boolean"}},{attribute:"syn-table-cell--border-start",default:"false",description:"Applies a border to the left of the table cell",kind:"field",name:"syn-table-cell--border-start",type:{text:"boolean"}},{attribute:"syn-table-cell--border-end",default:"false",description:"Applies a border to the right of the table cell",kind:"field",name:"syn-table-cell--border-end",type:{text:"boolean"}},{attribute:"syn-table-cell--border-top",default:"false",description:"Applies a border to the top of the table cell",kind:"field",name:"syn-table-cell--border-top",type:{text:"boolean"}},{attribute:"syn-table-cell--border-bottom",default:"false",description:"Applies a border to the bottom of the table cell",kind:"field",name:"syn-table-cell--border-bottom",type:{text:"boolean"}},{attribute:"syn-table-cell--header",default:"false",description:"Applies the table cell header styling",kind:"field",name:"syn-table-cell--header",type:{text:"boolean"}},{attribute:"syn-table-cell--shadow",default:"",description:"Applies the selected shadow to the table cell",kind:"field",name:"syn-table-cell--shadow",type:{text:" | 'syn-table-cell--shadow-bottom' | 'syn-table-cell--shadow-top' | 'syn-table-cell--shadow-start' | 'syn-table-cell--shadow-end'"}},{attribute:"syn-table-cell--shadow-active",default:"false",description:"Displays the table shadow",kind:"field",name:"syn-table-cell--shadow-active",type:{text:"boolean"}}],name:"syn-table-cell",slots:[{description:"Main content of syn-table-cell",name:""}],tagName:"syn-table-cell",tagNameWithoutPrefix:"table-cell"}],description:"Applies the table cell styling",kind:"javascript-module",path:"../styles/src/tables/table-cell.css"},{declarations:[{attributes:[{default:"false",description:"Applies the styling to a table element",name:"syn-table",type:{text:"boolean"}},{default:"true",description:"Applies all default table stylings to a table and its children",name:"syn-table--default",type:{text:"boolean"}},{default:"false",description:"Applies all alternate table stylings to a table and its children",name:"syn-table--alternating",type:{text:"boolean"}},{default:"false",description:"Applies all border table stylings to a table and its children",name:"syn-table--border",type:{text:"boolean"}}],customElement:!0,kind:"class",members:[{attribute:"syn-table",default:"false",description:"Applies the styling to a table element",kind:"field",name:"syn-table",type:{text:"boolean"}},{attribute:"syn-table--default",default:"true",description:"Applies all default table stylings to a table and its children",kind:"field",name:"syn-table--default",type:{text:"boolean"}},{attribute:"syn-table--alternating",default:"false",description:"Applies all alternate table stylings to a table and its children",kind:"field",name:"syn-table--alternating",type:{text:"boolean"}},{attribute:"syn-table--border",default:"false",description:"Applies all border table stylings to a table and its children",kind:"field",name:"syn-table--border",type:{text:"boolean"}}],name:"syn-table",slots:[{description:"Main content of syn-table",name:""}],tagName:"syn-table",tagNameWithoutPrefix:"table"}],description:"Applies the styling to a table element",kind:"javascript-module",path:"../styles/src/tables/table.css"},{declarations:[{attributes:[{default:"'syn-link--small'",description:"The size of the link",name:"syn-link",type:{text:"'syn-link--small' | 'syn-link--medium' | 'syn-link--large'"}},{default:"false",description:"Applies the quiet link styling",name:"syn-link--quiet",type:{text:"boolean"}},{default:"false",description:"Applies the disabled link styling",name:"syn-link--disabled",type:{text:"boolean"}}],customElement:!0,kind:"class",members:[{attribute:"syn-link",default:"'syn-link--small'",description:"The size of the link",kind:"field",name:"syn-link",type:{text:"'syn-link--small' | 'syn-link--medium' | 'syn-link--large'"}},{attribute:"syn-link--quiet",default:"false",description:"Applies the quiet link styling",kind:"field",name:"syn-link--quiet",type:{text:"boolean"}},{attribute:"syn-link--disabled",default:"false",description:"Applies the disabled link styling",kind:"field",name:"syn-link--disabled",type:{text:"boolean"}}],name:"syn-link",slots:[{description:"Main content of syn-link",name:""}],tagName:"syn-link",tagNameWithoutPrefix:"link"}],description:"The size of the link",kind:"javascript-module",path:"../styles/src/link/index.css"},{declarations:[{attributes:[{default:"'syn-body--x-small'",description:"The font size of the body text",name:"syn-body",type:{text:"'syn-body--x-small' | 'syn-body--small' | 'syn-body--medium' | 'syn-body--large'"}}],customElement:!0,kind:"class",members:[{attribute:"syn-body",default:"'syn-body--x-small'",description:"The font size of the body text",kind:"field",name:"syn-body",type:{text:"'syn-body--x-small' | 'syn-body--small' | 'syn-body--medium' | 'syn-body--large'"}}],name:"syn-body",slots:[{description:"Main content of syn-body",name:""}],tagName:"syn-body",tagNameWithoutPrefix:"body"}],description:"The font size of the body text",kind:"javascript-module",path:"../styles/src/typography/body.css"},{declarations:[{attributes:[{default:"'syn-heading--3x-large'",description:"The size of the headline",name:"syn-heading",type:{text:"'syn-heading--3x-large' | 'syn-heading--2x-large' | 'syn-heading--x-large' | 'syn-heading--large'"}}],customElement:!0,kind:"class",members:[{attribute:"syn-heading",default:"'syn-heading--3x-large'",description:"The size of the headline",kind:"field",name:"syn-heading",type:{text:"'syn-heading--3x-large' | 'syn-heading--2x-large' | 'syn-heading--x-large' | 'syn-heading--large'"}}],name:"syn-heading",slots:[{description:"Main content of syn-heading",name:""}],tagName:"syn-heading",tagNameWithoutPrefix:"heading"}],description:"The size of the headline",kind:"javascript-module",path:"../styles/src/typography/heading.css"},{declarations:[{attributes:[{default:"'syn-weight--normal'",description:"The font weight to apply",name:"syn-weight",type:{text:"'syn-weight--normal' | 'syn-weight--semibold' | 'syn-weight--bold'"}}],customElement:!0,kind:"class",members:[{attribute:"syn-weight",default:"'syn-weight--normal'",description:"The font weight to apply",kind:"field",name:"syn-weight",type:{text:"'syn-weight--normal' | 'syn-weight--semibold' | 'syn-weight--bold'"}}],name:"syn-weight",slots:[{description:"Main content of syn-weight",name:""}],tagName:"syn-weight",tagNameWithoutPrefix:"weight"}],description:"The font weight to apply",kind:"javascript-module",path:"../styles/src/typography/weight.css"}],readme:"",schemaVersion:"1.0.0"};ta({hideArgRef:!0,hideScriptTag:!0});ft.modules&&(ft.modules=ft.modules.map(a=>(a.declarations&&(a.declarations=a.declarations.map(e=>(e.members&&(e.members=e.members.filter(t=>t.description&&t.privacy!=="private")),e))),a)));const Rr={...ft,modules:[...ft.modules,...Br.modules]};Di(Rr);console.log("Custom elements manifest loaded for components and styles");const qt=a=>{const{args:e,events:t,argTypes:n}=Bn(a),i=Ln(a,window.__STORYBOOK_CUSTOM_ELEMENTS_MANIFEST__),o=()=>({status:{styles:{backgroundColor:i?.status==="stable"?"#43b02a":"rgb(255, 131, 0)",borderColor:"white",color:"white"},title:`Status: ${i?.status}`},since:{styles:{backgroundColor:"#333",borderColor:"#fff",color:"#fff"},title:`Since: ${i?.since}`}});return{args:e,argTypes:(()=>{for(const d in n)n.hasOwnProperty(d)&&n[d].table&&n[d].table.category==="properties"&&(n[d].control={disabled:!0});return{...n,...i?.events?.reduce((d,c)=>(d[c.name]={...c,control:!1,table:{category:"Events"}},d),{}),...i?.members?.filter(d=>d.kind==="method").reduce((d,c)=>(d[c.name]={...c,control:!1,table:{category:"Methods"}},d),{})}})(),parameters:{badges:["status","since"],badgesConfig:o(),actions:{handles:t}}}},et=a=>({getSuffixFromType:e=>({attribute:"",property:"-prop",slot:"-slot",cssPart:"-part",cssProperty:""})[e],getValuesFromAttribute:e=>{e.endsWith("-attr")||(e=`${e}-attr`);const{argTypes:t}=qt(a);return t[e]?.control?.type==="boolean"?[!0,!1]:t[e].options},getValuesFromAttributes:e=>e?.map(t=>(t.endsWith("-attr")||(t=`${t}-attr`),{name:t,values:et(a).getValuesFromAttribute(t)})),overrideArgs:(e,t)=>{const n=t||qt(a).args,i=Array.isArray(e)?e:[e];for(const o of i){const s=et(a).getSuffixFromType(o.type);n[`${o.name}${s}`]=o.value}return n}}),ol=a=>{const{template:e,manifest:t}=Bn(a),{args:n}=qt(a),{getValuesFromAttribute:i}=et(a);return{generateTemplate:({axis:s,constants:l=[],options:d,args:c=n})=>{const y=x=>{if(!t?.style)return e(x);const P=Object.keys(x).filter(L=>L.endsWith("-attr")).reduce((L,ke)=>{const he=ke.substring(0,ke.length-5);return x[ke]===!0?L[he]=!0:x[ke]==="false"||x[ke]==="(default)"?L[he]=!1:x[ke]&&(he.endsWith("...")?L[he.replace("...",x[ke])]=!0:L[x[ke]]=!0),L},{}),Le=x["default-slot"]||"",qe={[a]:!0,...P},st=Object.keys(qe).filter(L=>qe[L]).join(" ");if(d?.templateContent){const L=d.templateContent.replaceAll("%SLOT%",Le).replaceAll("%CLASSES%",st);return te(L)}return k`<div class=${f(qe)}>${te(Le)}</div>`},T=(Array.isArray(l)?l:[l]).reduce((x,P)=>({...x,[`${P.name}${et(a).getSuffixFromType(P.type)}`]:P.value}),{});if(!s?.x&&!s?.y&&!d?.title)return k`${y({...c,...T})}`;const U=x=>x?Array.isArray(x)?x.map(P=>({...P,values:P.values||i(P.name)})):[{...x,values:x.values||i(x.name)}]:[{}],ze=U(s?.x),be=U(s?.y),Ue=(Array.isArray(l)?l:[l]).find(x=>x.type==="template")?.value,We=`uuid-${crypto.randomUUID()}`;return k`
      ...
      ${ze.map(x=>k` ${be.map(P=>{let Le=!0;const qe=ze.length>1||x.values,st=(x&&P||be.length>1)&&P?.values;return k`
          ...
          `})}`)}
    `}}},Ur={codeOptimizer:a=>{const{body:e}=new DOMParser().parseFromString(a,"text/html"),t=e.querySelectorAll(".template");let n="";return t.length?n=Array.from(t).map(i=>i.innerHTML).join(`
`):n=e.innerHTML,n=n.replace(/<style><\/style>/g,"").replace(/<!-- preview-ignore:start -->[\s\S]*?<!-- preview-ignore:end -->/g,"").replace(/\/\/ preview-ignore:start[\s\S]*?\/\/ preview-ignore:end/g,"").replace(/<style>\n<\/style>/g,"").replace(/<script>\s*component = document\.querySelector\('(.+?)'\);\s*<\/script>/g,""),n}},sl=(a,e)=>{const t=pn?.components?.[a]?.[e]?.description?.value??"No Description",n=pn?.components?.[a]?.[e]?.note?.value??"",i=t.replace(/\n/g,"<br/>"),o=n.length>0?`

  > **👨‍💻 Additional developer Information**:<br>
  > ${n.replace(/\n/g,"<br/>")}`:n;return`${i}${o}`},rl=(a,e=150)=>{const t=isNaN(e)?e:{heightPx:e},{afterRender:n="",additionalChromaticOptions:i={},heightPx:o=150,styleHeading:s={}}=t,l=Object.entries(s).map(([d,c])=>`${d}: ${c};`).join(" ");return{parameters:{chromatic:{...ui?.parameters?.chromatic,...i,disableSnapshot:!1},docs:{disable:!0}},render:(d,c)=>k`
      ${Object.entries(a).map(([y,T])=>{const U=T.name??Ii(y);return k`
      ...
      `})}
      ${n}
    `}};export{ol as a,sl as b,rl as c,et as d,al as e,Fr as g,il as h,Pr as i,ui as p,qt as s};
