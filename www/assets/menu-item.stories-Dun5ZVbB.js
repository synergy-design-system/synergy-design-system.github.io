import{i as e}from"./preload-helper-xPQekRTU.js";import{Ht as t,It as n,d as r,f as i,g as a,u as o}from"./iframe-BLAzlACc.js";import{t as s}from"./icon-BFcjyE5U.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-RhnClGwj.js";import{n as m,t as h}from"./taggedTemplateLiteral-pWa2IaV6.js";import{n as g,t as _}from"./menu-item-CUl6QqYu.js";import{t as v}from"./divider-DUlR8KM9.js";var y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P=e((()=>{n(),v(),g(),_(),s(),f(),r(),a(),m(),{args:b,argTypes:x}=l(`syn-menu-item`),{overrideArgs:S}=c(`syn-menu-item`),{generateTemplate:C}=d(`syn-menu-item`),w={args:S([{name:`default`,type:`slot`,value:`Option 1`}],b),argTypes:x,component:`syn-menu-item`,parameters:{chromatic:{modes:i},design:o(`41203-369012`),docs:{description:{component:u(`menu-item`,`default`)}}},tags:[`Navigation`],title:`Components/syn-menu-item`},T={parameters:{controls:{disable:!1},docs:{description:{story:u(`menu-item`,`default`)}}},render:e=>t`
  ...
  `},D={parameters:{docs:{description:{story:u(`menu-item`,`disabled`)}}},render:()=>t`
    <syn-menu style="max-width: 240px;">
      <syn-menu-item>Option 1</syn-menu-item>
      <syn-menu-item disabled>Option 2</syn-menu-item>
      <syn-menu-item>Option 3</syn-menu-item>
    </syn-menu>
  `},O={parameters:{docs:{description:{story:u(`menu-item`,`loading`)}}},render:()=>t`
    <syn-menu style="max-width: 240px;">
      <syn-menu-item>Option 1</syn-menu-item>
      <syn-menu-item loading>Option 2</syn-menu-item>
      <syn-menu-item>Option 3</syn-menu-item>
    </syn-menu>
  `},k={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`menu-item`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-menu-item:nth-child(2)`);t&&t.focus()},render:()=>t`
    <syn-menu style="max-width: 240px;">
      <syn-menu-item>Option 1</syn-menu-item>
      <syn-menu-item disabled>Option 2</syn-menu-item>
      <syn-menu-item>Option 3</syn-menu-item>
    </syn-menu>
  `},A={parameters:{docs:{description:{story:u(`menu-item`,`checkbox`)}}},render:()=>t`
    <syn-menu style="max-width: 240px;">
  ...
  `},j={parameters:{docs:{description:{story:u(`menu-item`,`selection`)}}},render:()=>t(y||=h([`
