...
arg ref - \`${e}\``}const Ca=t=>`on${za(Sa(t))}`;function Sa(t=""){return t.split("-").map((a,i)=>i?a.charAt(0).toUpperCase()+a.slice(1).toLowerCase():a.toLowerCase()).join("")}function za(t){return t.charAt(0).toUpperCase()+t.slice(1)}const{useArgs:Ea}=__STORYBOOK_MODULE_PREVIEW_API__;let Wt,Mn,gn={};setTimeout(()=>{gn=globalThis?.__WC_STORYBOOK_HELPERS_CONFIG__||{}});var ei;function $a(t,e,n,a){if(!e)return C`<${ue(t.tagName)}></${ue(t.tagName)}>`;t?.tagName!==Mn&&(Wt=void 0,Mn=t?.tagName);const{attrOperators:i,additionalAttrs:o}=Oa(t,e,a),s={...i,...o},l=Na(t,e),d=Da(t,e);return Aa(t),C`${ci(t,e)}
<${ue(t.tagName)} 
  ${wa(s)}
  ${d}
  >
...
`;function Us(t,e){const n={waitUntilFirstUpdated:!1,...e};return a=>class extends a{#e=!n.waitUntilFirstUpdated;updated(i){if(!this.#e){this.#e=!0;return}const o=Array.from(i).filter(([l])=>t.includes(l));if(o.length===0){super.updated(i);return}const s=o.map(([l,d])=>({attribute:l,newValue:this[l],oldValue:d}));this.emit("syn-attributes-changed",{detail:s}),super.updated(i)}}}var Ws=Object.defineProperty,qs=Object.getOwnPropertyDescriptor,Oe=(t,e,n,a)=>{for(var i=a>1?void 0:a?qs(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&Ws(e,n,i),i};let fe=class extends w{constructor(){super(...arguments),this.localize=new R(this),this.type="normal",this.checked=!1,this.value="",this.loading=!1,this.disabled=!1,this.hasSlotController=new Q(this,"submenu"),this.submenuController=new Bs(this,this.hasSlotController),this.handleHostClick=t=>{this.disabled&&(t.preventDefault(),t.stopImmediatePropagation())},this.handleMouseOver=t=>{this.focus(),t.stopPropagation()}}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this.handleHostClick),this.addEventListener("mouseover",this.handleMouseOver)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.handleHostClick),this.removeEventListener("mouseover",this.handleMouseOver)}handleDefaultSlotChange(){const t=this.getTextLabel();if(typeof this.cachedTextLabel>"u"){this.cachedTextLabel=t;return}t!==this.cachedTextLabel&&(this.cachedTextLabel=t,this.emit("slotchange",{bubbles:!0,composed:!1,cancelable:!1}))}handleCheckedChange(){if(this.checked&&this.type!=="checkbox"){this.checked=!1,console.error('The checked attribute can only be used on menu items with type="checkbox"',this);return}this.type==="checkbox"?this.setAttribute("aria-checked",this.checked?"true":"false"):this.removeAttribute("aria-checked")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleTypeChange(){this.type==="checkbox"?(this.setAttribute("role","menuitemcheckbox"),this.setAttribute("aria-checked",this.checked?"true":"false")):(this.setAttribute("role","menuitem"),this.removeAttribute("aria-checked"))}getTextLabel(){return xi(this.defaultSlot)}isSubmenu(){return this.hasSlotController.test("submenu")}render(){const t=this.localize.dir()==="rtl",e=this.submenuController.isExpanded();return c`
      <div
        id="anchor"
        part="base"
...
`;var el=Object.defineProperty,tl=Object.getOwnPropertyDescriptor,Ui=(t,e,n,a)=>{for(var i=a>1?void 0:a?tl(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&el(e,n,i),i};class $n extends w{constructor(){super(...arguments),this.observedElements=[],this.disabled=!1}static{this.styles=[x,Zr]}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{this.emit("syn-resize",{detail:{entries:e}})}),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}handleSlotChange(){this.disabled||this.startObserver()}startObserver(){const e=this.shadowRoot.querySelector("slot");if(e!==null){const n=e.assignedElements({flatten:!0});this.observedElements.forEach(a=>this.resizeObserver.unobserve(a)),this.observedElements=[],n.forEach(a=>{this.resizeObserver.observe(a),this.observedElements.push(a)})}}stopObserver(){this.resizeObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}render(){return c` <slot @slotchange=${this.handleSlotChange}></slot> `}}Ui([r({type:Boolean,reflect:!0})],$n.prototype,"disabled",2);Ui([m("disabled",{waitUntilFirstUpdate:!0})],$n.prototype,"handleDisabledChange",1);const nl=h`
	/* stylelint-disable */
  :host {
    --indicator-color: var(--syn-color-primary-600);
    --track-color: var(--syn-color-neutral-200);
...
`;var ul=Object.defineProperty,ml=Object.getOwnPropertyDescriptor,Ze=(t,e,n,a)=>{for(var i=a>1?void 0:a?ml(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&ul(e,n,i),i};let fl=0;class Ue extends w{constructor(){super(...arguments),this.localize=new R(this),this.attrId=++fl,this.componentId=`syn-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}static{this.styles=[x,pl,hl]}static{this.dependencies={"syn-icon-button":ut}}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}handleCloseClick(e){e.stopPropagation(),this.emit("syn-close")}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false"),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,c`
      <div
        part="base"
