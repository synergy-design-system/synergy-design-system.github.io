import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-DRz18Lsn.js";import{c as i,t as a}from"./lit-D4-0ovri.js";import{t as o}from"./button-CBC8ywKX.js";import{t as s}from"./icon-BbsmBxau.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-NnlguzJ1.js";import{n as m,t as h}from"./PaddingDecorator-Dx4_2Fla.js";var g=t({Caret:()=>A,Default:()=>S,Disabled:()=>M,Focus:()=>T,IconOnly:()=>O,LinkButtons:()=>E,Loading:()=>j,PrefixAndSuffixIcons:()=>k,Screenshot:()=>N,SettingACustomWidth:()=>D,Sizes:()=>w,Variants:()=>C,__namedExportsOrder:()=>P,default:()=>x}),_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P;function F(){return(F=e((()=>{o(),s(),a(),f(),h(),r(),{args:_,argTypes:v}=l(`syn-button`),{overrideArgs:y}=c(`syn-button`),{generateTemplate:b}=d(`syn-button`),x={args:y({name:`default`,type:`slot`,value:`Default`},_),argTypes:v,component:`syn-button`,parameters:{chromatic:{modes:n},docs:{description:{component:u(`button`,`default`)}}},tags:[`Form`,`Navigation`],title:`Components/syn-button`},S={parameters:{controls:{disable:!1},docs:{description:{story:u(`button`,`default`)}}},render:e=>b({args:e})},C={parameters:{docs:{description:{story:u(`button`,`variant`)}}},render:()=>i`
  ...
  `},N=p({Default:S,Variants:C,Sizes:w,LinkButtons:E,SettingACustomWidth:D,IconOnly:O,PrefixAndSuffixIcons:k,Caret:A,Loading:j,Disabled:M},280),P=[`Default`,`Variants`,`Sizes`,`Focus`,`LinkButtons`,`SettingACustomWidth`,`IconOnly`,`PrefixAndSuffixIcons`,`Caret`,`Loading`,`Disabled`,`Screenshot`],S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  Loading,
  Disabled
}, 280)`,...N.parameters?.docs?.source}}}})))()}export{g as n,F as r,S as t};