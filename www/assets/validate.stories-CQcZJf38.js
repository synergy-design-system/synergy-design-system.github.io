import{j as q,c as r,x as A,C as R,d as L}from"./iframe-QGd5S99W.js";import{S as P,c as B,n as c}from"./synergy-element--DJW8VCO.js";import{r as m}from"./icon.component-4gUjtIYr.js";import{a as N}from"./query-D0jTsbLw.js";import{o as U}from"./query-assigned-elements-CIlqV-be.js";import{o as j}from"./if-defined-D8K4JhUN.js";import{w as z}from"./watch-CEsCE2EF.js";import{S as H}from"./alert.component-DQQwGhSD.js";import{S as K}from"./tooltip.component--vkb3ynX.js";import{e as W}from"./decorator-UnohHU6S.js";import"./input-Cvk53MTM.js";import"./button-DI7VxfdG.js";import{g as l,a as Y,s as G,b as J,c as Q}from"./component-rNl6mxJE.js";import"./preload-helper-PPVm8Dsz.js";import"./animation-registry-DyRYqZdt.js";import"./closeActiveElement-Bnbpk8Kw.js";import"./class-map-D_GpYIlr.js";import"./slot-9EVoRGQc.js";import"./localize-Dh03wnLC.js";import"./index-DihgwUfS.js";import"./event-B0iVuGLD.js";import"./icon-button.component-0WzzSnTe.js";import"./popup.component-av-zfZfG.js";import"./functions-B4dslKTf.js";import"./default-value-BHzc_aPh.js";import"./form-d9hCJUdr.js";import"./live-69pOvvDJ.js";import"./form-control.styles-COxr7qDI.js";import"./divider.component-DVwo3l8M.js";import"./spinner.component-sJipPYRp.js";import"./index-3hbeBem-.js";import"./_docs-ZdRmyf7z.js";const X=e=>(t,a)=>{a!==void 0?a.addInitializer(()=>{customElements.define(e,t)}):customElements.define(e,t)},Z=["blur","change","clear","focus","invalid","input","move"],k=(e,t)=>e.includes(t),x=e=>k(e,"blur"),F=e=>k(e,"invalid"),I=e=>e instanceof P,ee=(e="")=>e.split(" ").map(t=>t.trim()).filter(Boolean),C=(e,t)=>{const a=t.trim();return I(e)&&Z.includes(a)?`syn-${a}`:a},te=e=>{if(!I(e))return;const{size:t}=e;return t!=null?t:void 0},ae={"syn-checkbox":"input","syn-combobox":".combobox__value-input","syn-file":"input","syn-input":"input","syn-radio-group":"input","syn-range":".input__control","syn-select":".select__value-input","syn-switch":"input","syn-textarea":".textarea__control"},$=(e,t)=>e.shadowRoot?.querySelector(t)??null,ie=e=>{if(!e)return;if(!e.shadowRoot)return e;const t=e.tagName.toLowerCase(),a=ae[t];if(a){const s=$(e,a);if(s)return s}const i=$(e,"input,select,textarea");return i||e},se=q`
  .validate {
    display: flex;
    flex-direction: column;
    gap: var(--syn-spacing-small);
  }
`;var ne=Object.defineProperty,re=Object.getOwnPropertyDescriptor,o=(e,t,a,i)=>{for(var s=i>1?void 0:i?re(t,a):t,d=e.length-1,u;d>=0;d--)(u=e[d])&&(s=(i?u(t,a,s):u(s))||s);return i&&s&&ne(t,a,s),s};const D=()=>r`
  <slot
    class="validate__input-wrapper"
    part="input-wrapper"
  ></slot>
`;let n=class extends P{constructor(){super(...arguments),this.controller=new AbortController,this.validationMessage="",this.eagerFirstMount=!0,this.isInternalTriggeredInvalid=!1,this.isValid=!0,this.hasFocus=!1,this.variant="native",this.hideIcon=!1,this.on="",this.customValidationMessage="",this.eager=!1,this.internalRevalidate=e=>{e.currentTarget.validity?.valid&&(this.validationMessage="")},this.handleInputFocus=()=>{this.hasFocus=!0},this.handleInputBlur=()=>{this.hasFocus=!1},this.validate=async e=>{if(F(e.type)&&this.variant==="native"&&this.isInternalTriggeredInvalid===!0){this.isInternalTriggeredInvalid=!1;return}F(e.type)&&this.variant!=="native"&&(e.preventDefault(),e.stopPropagation());const t=e.currentTarget;if(I(t)&&await t.updateComplete,this.isValid=t.validity?.valid,this.eager&&this.eagerFirstMount){this.eagerFirstMount=!1,this.setValidationMessage(t);return}!this.isValid&&!x(e.type)&&this.handleFocus(t),this.setValidationMessage(t),!x(e.type)&&this.variant==="native"&&this.updateComplete.then(()=>{this.isInternalTriggeredInvalid=!0,t.reportValidity()})}}handleListenerChange(){this.updateEvents()}async handleEagerChange(){if(this.eager){const e=this.getInput();await this.updateComplete,e?.reportValidity(),this.eagerFirstMount=!0}else this.eagerFirstMount=!1}handleCustomValidationMessageChange(){const e=this.getInput();e&&(this.setCustomValidationMessage(e),this.setValidationMessage(e))}getValidity(){return this.isValid}getInput(){const e=this.slottedChildren[0];return e||void 0}setAlertSize(){this.alertSize=te(this.getInput())}getUsedEventNames(){const e=this.getInput();if(!e)return[];const t=ee(this.on),[...a]=t.filter(Boolean);return a.includes("invalid")||a.push("invalid"),a.includes("live")&&(a.push("input"),a.push("blur")),Array.from(new Set(a.filter(i=>i!=="live").map(i=>C(e,i))))}updateEvents(){this.controller.abort(),this.controller=new AbortController;const e=this.getInput();if(!e)return;const t=this.getUsedEventNames();t.forEach(d=>{e.addEventListener(d,this.validate,{capture:F(d),signal:this.controller.signal})});const a=C(e,"change");t.includes(a)||e.addEventListener(a,this.internalRevalidate,{signal:this.controller.signal});const i=C(e,"focus"),s=C(e,"blur");e.addEventListener(i,this.handleInputFocus,{signal:this.controller.signal}),e.addEventListener(s,this.handleInputBlur,{signal:this.controller.signal})}setValidationMessage(e){const{customValidationMessage:t}=this,a=t||e.validationMessage;this.validationMessage=a}setCustomValidationMessage(e){e.setCustomValidity(this.customValidationMessage)}handleFocus(e){const t=document.activeElement,a=t.closest("syn-validate");!t.validity?.valid&&a||(e.scrollIntoView({block:"nearest"}),e.focus())}async firstUpdated(e){super.firstUpdated(e),this.updateEvents();const t=this.getInput();this.customValidationMessage&&(I(t)&&await t.updateComplete,t?.setCustomValidity(this.customValidationMessage)),this.eager&&(await this.updateComplete,this.isValid=t?.validity?.valid??!1,t?.reportValidity())}connectedCallback(){super.connectedCallback(),this.sizeObserver=new MutationObserver(e=>{const t=this.getInput();if(!t)return;e.filter(({target:i})=>i===t).every(i=>i.attributeName==="size")&&this.setAlertSize()}),this.sizeObserver.observe(this,{attributeFilter:["size"],attributes:!0,subtree:!0}),this.observer=new MutationObserver(e=>{const t=this.getInput();if(!t)return;e.filter(({target:i})=>i===t).every(i=>{const s=i.target;return s.hasAttribute("disabled")||s.hasAttribute("readonly")})?(this.isValid=!0,this.validationMessage=""):(I(t)?t.updateComplete:Promise.resolve()).then(()=>{this.isValid=t?.validity?.valid??!1,this.validationMessage=t?.validationMessage??""})}),this.observer.observe(this,{attributeFilter:["disabled","readonly"],attributes:!0,subtree:!0})}disconnectedCallback(){super.disconnectedCallback(),this.controller.abort(),this?.observer?.disconnect(),this?.sizeObserver?.disconnect()}updated(e){if(super.updated(e),this.variant!=="tooltip")return;const t=this.tooltipElement;if(!t)return;!this.isValid&&this.validationMessage&&this.hasFocus?(t.content=this.validationMessage,t.show()):t.hide()}renderInlineValidation(){return this.variant!=="inline"||!this.validationMessage?"":r`
      <syn-alert
        open
    ...
    `}render(){const e=this.variant==="tooltip"?r`
        <syn-tooltip
          ...
          .open=${this.eager?!this.isValid&&this.validationMessage.length>0:!1}
          part="tooltip"
          placement="bottom"
          trigger="manual"
        >
...
></syn-input>
  ...
  `},E={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:l("validate","size")}}},render:()=>r`
  ...
  `},V={parameters:{docs:{description:{story:l("validate","custom-event-names")}}},render:()=>r`
    <syn-validate
      class="validation-custom-validation"
      on="mouseover blur"
      variant="inline"
...
\`
  ...
  CustomFormField,
  Eager
}, 200)`,..._.parameters?.docs?.source}}};const Ye=["Default","TooltipVariant","InlineVariant","HideIcon","Sizes","Live","CustomValidationMessage","CustomFormField","BindingToCustomEventNames","Eager","Screenshot"];export{V as BindingToCustomEventNames,S as CustomFormField,b as CustomValidationMessage,v as Default,w as Eager,g as HideIcon,h as InlineVariant,f as Live,_ as Screenshot,E as Sizes,y as TooltipVariant,Ye as __namedExportsOrder,We as default};
