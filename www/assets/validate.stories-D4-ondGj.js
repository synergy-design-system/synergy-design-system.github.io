import{j as q,c as r,x as A,C as R,d as L}from"./iframe-FNtzKa2k.js";import{S as P,c as B,n as c}from"./synergy-element-CGdwBTi5.js";import{r as m}from"./icon.component-p6LFEyO5.js";import{a as N}from"./query-D0jTsbLw.js";import{o as U}from"./query-assigned-elements-CIlqV-be.js";import{o as j}from"./if-defined-BzjXKReZ.js";import{w as z}from"./watch-CEsCE2EF.js";import{S as H}from"./alert.component-kQkG91x2.js";import{S as K}from"./tooltip.component-B3IW6BfA.js";import{e as W}from"./decorator-CWkWRMhy.js";import"./input-bFoEdYuf.js";import"./button-BskTVqFf.js";import{g as l,a as Y,s as G,b as J,c as Q}from"./component-DbK8_7W3.js";import"./preload-helper-PPVm8Dsz.js";import"./animation-registry-DyRYqZdt.js";import"./closeActiveElement-Bnbpk8Kw.js";import"./class-map-Zt2w1C29.js";import"./slot-9EVoRGQc.js";import"./localize-Dh03wnLC.js";import"./index-DihgwUfS.js";import"./event-B0iVuGLD.js";import"./icon-button.component-D4iSKLkB.js";import"./popup.component-Dwuj9Glg.js";import"./functions-bkELIyT9.js";import"./default-value-Crei5WKI.js";import"./form-d9hCJUdr.js";import"./live-D4foJ2bF.js";import"./form-control.styles-ghejVbWD.js";import"./divider.component-ls6Klga1.js";import"./spinner.component-1v-gRCRt.js";import"./index-3hbeBem-.js";import"./_docs-DSlvmijE.js";const X=e=>(t,a)=>{a!==void 0?a.addInitializer(()=>{customElements.define(e,t)}):customElements.define(e,t)},Z=["blur","change","clear","focus","invalid","input","move"],k=(e,t)=>e.includes(t),x=e=>k(e,"blur"),F=e=>k(e,"invalid"),V=e=>e instanceof P,ee=(e="")=>e.split(" ").map(t=>t.trim()).filter(Boolean),I=(e,t)=>{const a=t.trim();return V(e)&&Z.includes(a)?`syn-${a}`:a},te=e=>{if(!V(e))return;const{size:t}=e;return t!=null?t:void 0},ae={"syn-checkbox":"input","syn-combobox":".combobox__value-input","syn-file":"input","syn-input":"input","syn-radio-group":"input","syn-range":".input__control","syn-select":".select__value-input","syn-switch":"input","syn-textarea":".textarea__control"},D=(e,t)=>e.shadowRoot?.querySelector(t)??null,ie=e=>{if(!e)return;if(!e.shadowRoot)return e;const t=e.tagName.toLowerCase(),a=ae[t];if(a){const s=D(e,a);if(s)return s}const i=D(e,"input,select,textarea");return i||e},se=q`
  .validate {
    display: flex;
