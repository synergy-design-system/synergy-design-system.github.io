import{k as n}from"./directive-helpers-CDT6qhDs.js";import{s as i,g as y,e as d,c as h,d as m}from"./component-Cu-mjNZ0.js";import{r as u}from"./styles-6ZDi2QNq.js";import"./index-C27LhpSP.js";import"./icon.component-DyJfbvH5.js";import"./chunk-L4EGOTBX-C9C4DwME.js";import"./entry-preview-D9TbQDUR.js";import"./index-DrFu-skq.js";import"./index-B-o1Wr-g.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon-B-41sCRR.js";const{args:C,argTypes:g}=i("syn-table"),{overrideArgs:f}=m("syn-table"),p="It is possible to achieve different table stylings (default, with border, alternating, ...) \n  either via multiple classes on the `table`, `td` and `th` elements or as a convenient alternative\n  as auto styling class, which is applied on a `table` element. These auto styling classes will\n  style the `td` and `th` elements correctly, without the need to apply further classes.\n  <br> <br>\n  **Note:** The auto styling table classes work for simple table layouts. For more complex ones or advanced use cases, the table cell classes should be used.\n",o=()=>`
  <thead>
    <tr>
