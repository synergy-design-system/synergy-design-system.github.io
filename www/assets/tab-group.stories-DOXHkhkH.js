import{n as e}from"./chunk-DnJy8xQt.js";import{At as t,C as n,Ft as r,S as i,d as a,f as o,p as s,u as c}from"./iframe-CFxyVgYz.js";import{i as l,n as u}from"./dist-DKcu4P11.js";import{t as d}from"./icon-BNvARCZB.js";import{a as f,i as p,n as m,o as h,r as g,t as _}from"./component-u4nxi-rq.js";import{n as v,t as y}from"./taggedTemplateLiteral-BuD1d7yP.js";import{n as b,t as x}from"./tab-panel-B60PBWwN.js";import{t as S}from"./tab-Uao89ZoI.js";var C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J;e((()=>{b(),S(),x(),d(),t(),u(),i(),g(),a(),s(),v(),{args:w,argTypes:T}=p(`syn-tab-group`),{overrideArgs:E}=f(`syn-tab-group`),{generateTemplate:D}=h(`syn-tab-group`),O=(e,t,{active:n=!1,closable:r=!1,disabled:i=!1}={})=>`<syn-tab slot="nav" panel="${e}" ${n?`active`:``} ${i?`disabled`:``} ${r?`closable`:``}>${t}</syn-tab>`,k=(e,t,{active:r=!1,closable:i=!1,disabled:a=!1}={})=>n(O(e,t,{active:r,closable:i,disabled:a})),A=()=>[{panel:`general`,props:{active:!0}},{panel:`custom`},{panel:`advanced`},{panel:`disabled`,props:{disabled:!0}}].map(({panel:e,props:t})=>O(e,l(e),t)).join(`
`),j=()=>n(A()),M=(e,t,n=!1)=>`<syn-tab-panel name="${e}" ${n?`active`:``}>${t}</syn-tab-panel>`,N=(e,t,r=!1)=>n(M(e,t,r)),P=()=>[`general`,`custom`,`advanced`,`disabled`].map((e,t)=>M(e,`This is the ${e} tab panel.`,t===0)).join(`
`),F=(e,t=!1)=>r`
