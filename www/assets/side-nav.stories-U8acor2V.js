import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,d as r,f as i,g as a,u as o}from"./iframe-DJ0QlWgc.js";import{t as s}from"./icon-CiIVLsag.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-CYGmWguq.js";import{n as m,t as h}from"./taggedTemplateLiteral-BuD1d7yP.js";import{n as g,t as _}from"./DisableFocusTrap-COQ-agyx.js";import{t as v}from"./nav-item-D-Kf8igX.js";import{t as y}from"./header-CVSMA64Q.js";import{t as b}from"./side-nav-D9aeDUks.js";var x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W;e((()=>{b(),v(),s(),y(),t(),f(),g(),r(),a(),m(),{args:k,argTypes:A}=l(`syn-side-nav`),{overrideArgs:j}=c(`syn-side-nav`),{generateTemplate:M}=d(`syn-side-nav`),N={args:j([],k),argTypes:A,component:`syn-side-nav`,parameters:{chromatic:{modes:i},design:o(`41227-327748`),docs:{container:_,description:{component:u(`side-nav`,`default`)}}},tags:[`Application Shell`],title:`Components/syn-side-nav`},P=()=>n`
...
`)}],k),parameters:{controls:{disable:!1},docs:{description:{story:u(`side-nav`,`default`)}}},render:e=>n(S||=h([`
    ...
    <\/script>
    `,`
  `]),M({args:e}),F(`.side-nav-default`))},L={parameters:{docs:{description:{story:u(`side-nav`,`rail`)}}},render:()=>n(C||=h([`
  ...
  `]),P(),F(`.side-nav-rail`))},R={parameters:{docs:{description:{story:u(`side-nav`,`sticky`)}}},render:()=>n(w||=h([`
  ...
  `]),P(),F(`.side-nav-sticky`))},z={parameters:{docs:{description:{story:u(`side-nav`,`footer`)}}},render:()=>n(T||=h([`
  ...
  `]),P(),F(`.side-nav-footer`))},B={parameters:{docs:{description:{story:u(`side-nav`,`fixed`)}}},render:()=>n(E||=h([`
  ...
  `]),P(),F(`.side-nav-fixed`))},V={parameters:{docs:{description:{story:u(`side-nav`,`shrinking`)}}},render:()=>n(D||=h([`
  ...
  `]),P(),F(`.side-nav-shrink`))},H={parameters:{docs:{description:{story:u(`side-nav`,`indentation`)}}},render:()=>n(O||=h([`
  ...
  Shrink,
  Indentation
}, 700)`,...U.parameters?.docs?.source}}},W=[`Default`,`Rail`,`Sticky`,`Footer`,`Fixed`,`Shrink`,`Indentation`,`Screenshot`]}))();export{I as Default,B as Fixed,z as Footer,H as Indentation,L as Rail,U as Screenshot,V as Shrink,R as Sticky,W as __namedExportsOrder,N as default};