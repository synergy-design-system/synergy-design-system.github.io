...
`)}}},play:c,tags:[`Charting`,`Data Visualization`],title:`Charts/syn-chart`},k={parameters:{controls:{disable:!1},docs:{description:{story:p(`chart`,`default`)}}},render:e=>i(y||=_([`
  ...
  `]))},N={parameters:{docs:{description:{story:p(`chart`,`multiple-charts`)}}},render:()=>i(C||=_([`
    ...
    <\/script>
  `]))},P=g({Default:k,Config:A,Palette:j,GetInstance:M,MultipleChartsWithDifferentPalettes:N},700),F=[`Default`,`Config`,`Palette`,`GetInstance`,`MultipleChartsWithDifferentPalettes`,`Screenshot`],k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
...
}, 700)`,...P.parameters?.docs?.source}}}})))()}export{v as n,I as r,k as t};