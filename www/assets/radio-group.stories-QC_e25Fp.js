import"./radio-CbGZX9X_.js";import"./button-DPFLjHtv.js";import{C as O,c as a,d as S}from"./iframe-r0CQHRKQ.js";import{g as o,a as k,s as T,b as x,c as E}from"./component-H_NDQ3WO.js";import"./class-map-BSAfnhal.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./synergy-element-C0zzvLBX.js";import"./icon.component-BtCkPkUy.js";import"./watch-CEsCE2EF.js";import"./query-D0jTsbLw.js";import"./form-control.custom.styles-CtgJ8K7o.js";import"./button-group.component-cqRQxnTE.js";import"./decorator-UnohHU6S.js";import"./functions-B4dslKTf.js";import"./if-defined-BE596y_O.js";import"./localize-Dh03wnLC.js";import"./index-DihgwUfS.js";import"./spinner.component-CBNnwNtq.js";import"./preload-helper-PPVm8Dsz.js";import"./index-3hbeBem-.js";import"./_docs-B-LcOZte.js";const{userEvent:g}=__STORYBOOK_MODULE_TEST__,{args:h,argTypes:C}=T("syn-radio-group"),{overrideArgs:D}=E("syn-radio-group"),{generateTemplate:z}=x("syn-radio-group"),X={args:h,argTypes:C,component:"syn-radio-group",parameters:{chromatic:{modes:O},design:S("1345-16160"),docs:{description:{component:o("radio-group","default")}}},tags:["Form"],title:"Components/syn-radio-group"},s={args:D([{name:"label",type:"attribute",value:"This is a label"},{name:"default",type:"slot",value:`<syn-radio value="1">Option</syn-radio>
  ...
  <form>
    ...
    <br />
    <syn-button type="submit" variant="filled">Submit</syn-button>
  </form>`},u=k({Default:s,Labels:i,Checked:t,HelpText:n,Disabled:l,Sizes:d},400);s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: overrideArgs([{
    name: 'label',
    type: 'attribute',
  ...
  Disabled,
  Sizes
}, 400)`,...u.parameters?.docs?.source}}};const Z=["Default","Labels","Checked","HelpText","Focus","Disabled","Sizes","Invalid","CustomValidity","Screenshot"];export{t as Checked,y as CustomValidity,s as Default,l as Disabled,p as Focus,n as HelpText,c as Invalid,i as Labels,u as Screenshot,d as Sizes,Z as __namedExportsOrder,X as default};
