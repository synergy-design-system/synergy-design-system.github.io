import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{_ as t,a as n,d as r,o as i,s as a,y as o}from"./preview-DdzcclEm.js";import{c as s,t as c}from"./lit-BfcklOOD.js";import{t as l}from"./button-BpLoAK9F.js";import{t as u}from"./icon-8cT1hKpd.js";import{t as d}from"./option-hlWzwvd4.js";import{a as ee,i as te,n as f,o as ne,r as re,t as ie}from"./component-BjD7AuVi.js";import{n as ae,t as p}from"./taggedTemplateLiteral-C9cDEsPD.js";import{n as oe,t as se}from"./PaddingDecorator-B8dy7wkX.js";import{n as m,t as h}from"./decorators-hI1Naz7G.js";import{n as g,r as ce,t as _}from"./combobox-BNr252cr.js";import{t as v}from"./optgroup-D8K0J-r8.js";var y,le,ue,de,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=e((()=>{_(),l(),u(),d(),v(),c(),t(),ce(),h(),re(),i(),se(),r(),ae(),{userEvent:y}=__STORYBOOK_MODULE_TEST__,{args:b,argTypes:x}=te(`syn-combobox`),{overrideArgs:S}=ee(`syn-combobox`),{generateTemplate:C}=ne(`syn-combobox`),w={args:b,argTypes:x,component:`syn-combobox`,parameters:{chromatic:{modes:a},design:n(`42207-352063`),docs:{description:{component:f(`combobox`,`default`)},story:{height:`250px`}}},tags:[`Form`],title:`Components/syn-combobox`},T=[`Yellow`,`Light Green`,`Grey`,`Green`,`Blue`,`Red`,`Orange`,`Magenta`,`White`,`Purple`,`Pink`,`Black`,`Brown`].sort(),E=e=>`<syn-option value="${e.replaceAll(` `,`_`)}">${e}</syn-option>`,D=e=>o(E(e)),O=()=>T.map(E),k=()=>o(O().join(`
`)),A={parameters:{args:S({name:`default`,type:`slot`,value:`
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>`},b),controls:{disable:!1},docs:{description:{story:f(`combobox`,`default`)}}},render:e=>C({args:e})},j={parameters:{docs:{description:{story:f(`combobox`,`label`)}}},render:()=>s`
    <syn-combobox label="State">
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},M={parameters:{docs:{description:{story:f(`combobox`,`help-text`)}}},render:()=>s`
    <syn-combobox label="State" help-text="Select a State">
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},N={parameters:{docs:{description:{story:f(`combobox`,`placeholder`)}}},render:()=>s`
    <syn-combobox label="State" help-text="Select a State" placeholder="Select a State">
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},P={decorators:[oe()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:f(`combobox`,`focus`)}}},play:({canvasElement:e})=>{let t=e.querySelector(`syn-combobox`);t&&t.focus()},render:()=>s`
    <syn-combobox>
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},F={parameters:{docs:{description:{story:f(`combobox`,`clearable`)}}},render:()=>s`
    <syn-combobox value="Green" clearable>
      ${k()}
    </syn-combobox>
  `},I={parameters:{docs:{description:{story:f(`combobox`,`disabled`)}}},render:()=>s`
    <syn-combobox  disabled placeholder="Disabled">
      ${k()}
    </syn-combobox>
  `},L={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:f(`combobox`,`readonly`)}}},render:()=>s`
  ...
  `},R={parameters:{docs:{description:{story:f(`combobox`,`multiple`)}}},render:()=>s`
  ...
  `},z={parameters:{docs:{description:{story:f(`combobox`,`initial-values`)}}},render:()=>s`
    <syn-combobox value="option-1 option-2 option-3" multiple clearable max-options-visible="2">
      <syn-option value="option-1">Option 1</syn-option>
      <syn-option value="option-2">Option 2</syn-option>
      <syn-option value="option-3">Option 3</syn-option>
  ...
  `},B={parameters:{docs:{description:{story:f(`combobox`,`restrict-options`)}}},render:()=>s`
    <syn-combobox value="Option 1" restricted>
      <syn-option value="option-1">Option 1</syn-option>
      <syn-option value="option-2">Option 2</syn-option>
      <syn-option value="option-3">Option 3</syn-option>
    </syn-combobox>
  `},V={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:f(`combobox`,`no-results`)},story:{inline:!1}}},play:async({canvasElement:e})=>{let t=e.querySelector(`syn-combobox`);await t.updateComplete,t.focus();let n=t.shadowRoot?.querySelector(`input`);n&&await y.type(n,`Search term`)},render:()=>s`
    <syn-combobox id="no-results" value="Search term" open restricted>
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},H={parameters:{docs:{description:{story:f(`combobox`,`size`)}}},render:()=>s`
  ...
  `},U={decorators:[m],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:f(`combobox`,`invalid`)}}},play:async({canvasElement:e})=>{let t=e.querySelector(`form`),n=t.querySelector(`syn-combobox`),r=t.querySelector(`syn-button`);r&&n&&(await y.click(r),r.click())},render:()=>s`
    <syn-combobox required placeholder="Type something" help-text="This is required">
      ${k()}
    </syn-combobox>
  `},W={parameters:{docs:{description:{story:f(`combobox`,`preffix-sufffix`)}}},render:()=>s`
  ...
  `},G={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:f(`combobox`,`simple`)}}},play:async({canvasElement:e})=>{let t=e.querySelector(`syn-combobox`);await t.updateComplete,await t.show()},render:()=>s`
    <syn-combobox label="Preferred Color" value="g">
     ${k()}
    </syn-combobox>
  `},K={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:f(`combobox`,`highlight`)}}},play:async({canvasElement:e})=>{let t=e.querySelector(`syn-combobox`);await t.updateComplete,await t.show()},render:()=>{let e=g;return s(le||=p([`
    ...
    <\/script>
  `]),k(),e)}},q={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:f(`combobox`,`grouping`)}}},play:async({canvasElement:e})=>{let t=e.querySelector(`syn-combobox`);await t.updateComplete,await t.show()},render:()=>s`
  ...
  `},J={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:f(`combobox`,`container-height`)}}},play:async({canvasElement:e})=>{let t=e.querySelector(`syn-combobox`);await t.updateComplete,await t.show()},render:()=>s`
  ...
  `},Y={parameters:{docs:{description:{story:f(`combobox`,`async-options`)}}},render:()=>s(ue||=p([`
    ...
    <\/script>
  `])),tags:[`skip_mcp`]},X={parameters:{docs:{description:{story:f(`combobox`,`custom-filter`)}}},render:()=>s(de||=p([`
    ...
    <\/script>
  `]),k())},Z=ie({Default:A,Labels:j,HelpText:M,Placeholder:N,Clearable:F,Disabled:I,Readonly:L,Multiple:R,SettingInitialValue:z,Restricted:B,NoResultsFound:V,Sizes:H,PrefixSuffixTextAndIcons:W,AsyncOptions:Y,CustomFilter:X},500),A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  parameters: {
    args: overrideArgs({
      name: 'default',
      type: 'slot',
