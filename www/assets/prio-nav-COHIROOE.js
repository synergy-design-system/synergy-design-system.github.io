import{n as e}from"./chunk-DnJy8xQt.js";import{A as t,D as n,Nt as r,Ut as i}from"./iframe-BcSabCAt.js";import{n as a,t as o}from"./class-map-ubcCJG2R.js";import{n as s,t as c}from"./localize-BO4uh8LG.js";import{a as l,i as u,n as d,o as f,p,r as m,s as h,t as g,u as _}from"./synergy-element-B9jDHluB.js";import{n as v,t as y}from"./icon.component-Coa5KnIf.js";import{n as b,t as x}from"./menu.component-Ve7PQUmf.js";import{n as S,t as C}from"./dropdown.component-6J_bpWcZ.js";import{n as w,t as T}from"./nav-item.component-BxXoJpY1.js";var E,D=e((()=>{r(),E=i`
  :host {
    display: block;
...
`})),O,k,A,j,M,N=e((()=>{O=e=>Array.from(e.assignedElements({flatten:!0})),k=e=>e.tagName.toLocaleLowerCase()===`syn-nav-item`||(e.getAttribute(`role`)??``)===`menuitem`,A=e=>e.filter(k),j=e=>{e.setAttribute(`horizontal`,`true`),e.removeAttribute(`slot`),e.removeAttribute(`tabindex`),e.dataset.originalRole?e.setAttribute(`role`,e.dataset.originalRole):e.removeAttribute(`role`)},M=e=>{e.removeAttribute(`horizontal`),e.setAttribute(`slot`,`menu`),e.setAttribute(`role`,`menuitem`)}})),P,F=e((()=>{o(),n(),h(),f(),d(),D(),S(),v(),b(),w(),c(),N(),u(),P=class extends g{constructor(...e){super(...e),this.localize=new s(this),this.itemPositionsCached=!1,this.amountOfNavItems=0,this.amountOfVisibleItems=0,this.hasItemsInDropdown=!1}static{this.styles=[l,E]}static{this.dependencies={"syn-dropdown":C,"syn-icon":y,"syn-menu":x,"syn-nav-item":T}}getSlottedNavItems(){let e=A(O(this.defaultSlot)),t=A(O(this.menuSlot));return e.concat(t)}cacheItemPositions(e){let{left:t}=this.horizontalNav.getBoundingClientRect();e.forEach(e=>{e.removeAttribute(`slot`);let{right:n}=e.getBoundingClientRect();e.dataset.right=(n-t).toString()}),this.itemPositionsCached=!0}handlePriorityMenu(){let e=this.getSlottedNavItems();this.itemPositionsCached||this.cacheItemPositions(e);let{width:t}=this.horizontalNav.getBoundingClientRect(),n=t-(this.priorityMenu.classList.contains(`priority-menu--hidden`)?0:this.priorityMenu.clientWidth),r,i=e.at(-1),a=e.map(e=>{let a=e===i?t:n,o=!!(r||parseFloat(e.dataset.right)>a);return o&&!r&&(r=parseFloat(e.dataset.right)),{isHidden:o,item:e}}),o=a.filter(({isHidden:e})=>!e).length,s=o===1&&e.length>1;a.forEach(({item:e,isHidden:t})=>{t||s?M(e):j(e)}),this.hasItemsInDropdown=o!==e.length,this.amountOfVisibleItems=s?0:o}renderPriorityMenu(){return t`
    ...
    `}},m([_(`slot:not([name])`)],P.prototype,`defaultSlot`,void 0),m([_(`slot[name=menu]`)],P.prototype,`menuSlot`,void 0),m([_(`.horizontal-nav`)],P.prototype,`horizontalNav`,void 0),m([_(`.priority-menu`)],P.prototype,`priorityMenu`,void 0),m([p()],P.prototype,`itemPositionsCached`,void 0),m([p()],P.prototype,`amountOfNavItems`,void 0),m([p()],P.prototype,`amountOfVisibleItems`,void 0),m([p()],P.prototype,`hasItemsInDropdown`,void 0)})),I=e((()=>{F(),F(),P.define(`syn-prio-nav`)}));export{I as t};