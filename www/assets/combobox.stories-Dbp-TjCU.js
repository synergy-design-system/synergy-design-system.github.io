import{h as A}from"./combobox-Dkkr7Lvk.js";import"./button-CwZJTvX8.js";import"./icon-DLaBEzps.js";import"./option-DeFG7o_Z.js";import"./optgroup-D2J1rLeQ.js";import{g as L,x as r,o as z}from"./iframe-GSRepqjd.js";import{g as e,s as k,c as _,a as G,b as M}from"./component-sz2YSCF4.js";import"./class-map-QQ7HVnPG.js";import"./property-ImbD-3qY.js";import"./directive-helpers-CvZEagFv.js";import"./query-DAIS6qJ0.js";import"./animation-registry-l4L8bmT6.js";import"./default-value-CoJKpiHX.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./localize-CatY2peN.js";import"./index-DihgwUfS.js";import"./event-B0iVuGLD.js";import"./watch-CEsCE2EF.js";import"./component.styles-DXWA7L2q.js";import"./form-control.custom.styles-CXpzbCE1.js";import"./icon.component-B3J6d3UF.js";import"./popup.component-BJEudzMA.js";import"./composed-offset-position.browser.min-DQsihIor.js";import"./unsafe-html-C37otmSZ.js";import"./scroll-DgKSCJoS.js";import"./decorator-DANECR0-.js";import"./functions-CDi3doZH.js";import"./static-BkNWbPkN.js";import"./if-defined-CDNCanKK.js";import"./spinner.component-pJEN2kXr.js";import"./query-assigned-elements-QtOlz7Yz.js";import"./divider.component-DbTnzFXm.js";import"./index-Bkk0Z6Ex.js";import"./_docs-CrPFe_9C.js";var w=Object.freeze,R=Object.defineProperty,$=(o,n)=>w(R(o,"raw",{value:w(o.slice())})),H,E,q;const{userEvent:F}=__STORYBOOK_MODULE_TEST__,{args:D,argTypes:B}=k("syn-combobox"),{overrideArgs:I}=G("syn-combobox"),{generateTemplate:W}=_("syn-combobox"),qo={args:D,argTypes:B,component:"syn-combobox",parameters:{design:L("25272-35634"),docs:{description:{component:e("combobox","default")},story:{height:"250px"}}},tags:["Form"],title:"Components/syn-combobox"},Y=["Yellow","Light Green","Grey","Green","Blue","Red","Orange","Magenta","White","Purple","Pink","Black","Brown"].sort(),P=o=>`<syn-option value="${o.replaceAll(" ","_")}">${o}</syn-option>`,s=o=>z(P(o)),j=()=>Y.map(P),t=()=>z(j().join(`
`)),a={parameters:{args:I({name:"default",type:"slot",value:`
  ...
  `},h={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:e("combobox","invalid")}}},play:async({canvasElement:o})=>{const n=o.querySelector("form"),T=n.querySelector("syn-combobox"),C=n.querySelector("syn-button");C&&T&&(await F.click(C),C.click())},render:()=>r`
  ...
  `},f={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:e("combobox","highlight")}}},play:async({canvasElement:o})=>{const n=o.querySelector("syn-combobox");await n.updateComplete,await n.show()},render:()=>{const o=A;return r(H||(H=$([`
  ...
  `},d={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:e("combobox","async-options")}}},render:()=>r(E||(E=$([`
    ...
    <\/script>
  `])))},u={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:e("combobox","custom-filter")}}},render:()=>r(q||(q=$([`
