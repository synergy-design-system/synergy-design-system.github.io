import{g as e,a as u,s as h,b as g,c as v,d as b}from"./component-D9Cr7x-I.js";import{x as a}from"./directive-helpers-Dvm_Ferq.js";import"./if-defined-zGpnP1OK.js";import"./ref-CgC99LRu.js";import"./chunk-L4EGOTBX-Boit2UGA.js";import"./entry-preview-DkJqm5dP.js";import"./index-DrFu-skq.js";import"./icon-button-CQW7__-s.js";import"./library-C58jM0s5.js";import"./icon.component-BoDp9LRR.js";import"./index-Vx7n56Jp.js";import"./index-_2TAQcTa.js";import"./_commonjsHelpers-CqkleIqs.js";import"./icon-mIpjUOpH.js";var m=Object.freeze,f=Object.defineProperty,S=(r,y)=>m(f(r,"raw",{value:m(r.slice())})),d;const{args:k,argTypes:A}=h("syn-header"),{overrideArgs:w}=g("syn-header"),{generateTemplate:x}=v("syn-header"),F={args:w([{name:"label",type:"slot",value:'<span slot="label">App Name</span>'}],k),argTypes:A,component:"syn-header",parameters:{design:u("10540-8605"),docs:{description:{component:e("header","default")}}},title:"Components/syn-header"},t={parameters:{controls:{disable:!1},docs:{description:{story:e("header","default")}}},render:r=>x({args:r})},o={parameters:{docs:{description:{story:e("header","label")}}},render:()=>a`
  ...
  heightPx: 200
})`,...p.parameters?.docs?.source}}};const U=["Default","Label","Logo","Focus","MetaNavigation","Navigation","BurgerMenu","Screenshot"];export{c as BurgerMenu,t as Default,l as Focus,o as Label,n as Logo,s as MetaNavigation,i as Navigation,p as Screenshot,U as __namedExportsOrder,F as default};
