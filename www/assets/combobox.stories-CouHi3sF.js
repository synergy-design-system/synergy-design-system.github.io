import{h as A}from"./combobox-Dy86xKSM.js";import"./button-Ct_RHWlL.js";import"./icon-B6wOVNRF.js";import"./option-Bz0Pc3BN.js";import"./optgroup-bxLDjlCy.js";import{g as L,x as r,o as D}from"./iframe-0UxjpWda.js";import{g as n,s as k,c as _,a as G,b as M}from"./component-DUcdzUn5.js";import{p as R}from"./PaddingDecorator-CuZFJ3Xd.js";import"./class-map-D_EmVpM1.js";import"./property-B5xXPlsR.js";import"./state-Bf2jxics.js";import"./query-DAIS6qJ0.js";import"./animation-registry-l4L8bmT6.js";import"./default-value-K4VoZzeK.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./localize-CatY2peN.js";import"./index-DihgwUfS.js";import"./event-B0iVuGLD.js";import"./watch-CEsCE2EF.js";import"./component.styles-BtoW6U7E.js";import"./form-control.custom.styles-Bmrq85XH.js";import"./icon.component-ve8nTo37.js";import"./popup.component-Dsm4GhqJ.js";import"./composed-offset-position.browser.min-BaXfCfax.js";import"./scroll-DgKSCJoS.js";import"./decorator-DANECR0-.js";import"./functions-CDi3doZH.js";import"./if-defined-zJ0-s7Of.js";import"./spinner.component-pa2R42J0.js";import"./query-assigned-elements-QtOlz7Yz.js";import"./divider.component-BhAcegMc.js";import"./index-Bkk0Z6Ex.js";import"./_docs-CrPFe_9C.js";var w=Object.freeze,F=Object.defineProperty,$=(o,e)=>w(F(o,"raw",{value:w(o.slice())})),H,E,q;const{userEvent:B}=__STORYBOOK_MODULE_TEST__,{args:z,argTypes:I}=k("syn-combobox"),{overrideArgs:W}=G("syn-combobox"),{generateTemplate:Y}=_("syn-combobox"),qo={args:z,argTypes:I,component:"syn-combobox",parameters:{design:L("25272-35634"),docs:{description:{component:n("combobox","default")},story:{height:"250px"}}},tags:["Form"],title:"Components/syn-combobox"},j=["Yellow","Light Green","Grey","Green","Blue","Red","Orange","Magenta","White","Purple","Pink","Black","Brown"].sort(),P=o=>`<syn-option value="${o.replaceAll(" ","_")}">${o}</syn-option>`,s=o=>D(P(o)),Q=()=>j.map(P),t=()=>D(Q().join(`
`)),a={parameters:{args:W({name:"default",type:"slot",value:`
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>`},z),controls:{disable:!1},docs:{description:{story:n("combobox","default")}}},render:o=>Y({args:o})},i={parameters:{docs:{description:{story:n("combobox","label")}}},render:()=>r`
    <syn-combobox label="State">
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},c={parameters:{docs:{description:{story:n("combobox","help-text")}}},render:()=>r`
    <syn-combobox label="State" help-text="Select a State">
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},l={parameters:{docs:{description:{story:n("combobox","placeholder")}}},render:()=>r`
    <syn-combobox label="State" help-text="Select a State" placeholder="Select a State">
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},x={decorators:[R()],parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:n("combobox","focus")}}},play:({canvasElement:o})=>{const e=o.querySelector("syn-combobox");e&&e.focus()},render:()=>r`
    <syn-combobox>
      <syn-option>Option 1</syn-option>
      <syn-option>Option 2</syn-option>
      <syn-option>Option 3</syn-option>
    </syn-combobox>
  `},p={parameters:{docs:{description:{story:n("combobox","clearable")}}},render:()=>r`
    <syn-combobox value="Green" clearable>
      ${t()}
    </syn-combobox>
  `},m={parameters:{docs:{description:{story:n("combobox","disabled")}}},render:()=>r`
    <syn-combobox  disabled placeholder="Disabled">
      ${t()}
    </syn-combobox>
  `},b={parameters:{docs:{description:{story:n("combobox","size")}}},render:()=>r`
  ...
  `},g={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:n("combobox","invalid")}}},play:async({canvasElement:o})=>{const e=o.querySelector("form"),T=e.querySelector("syn-combobox"),C=e.querySelector("syn-button");C&&T&&(await B.click(C),C.click())},render:()=>r`
  ...
  `},y={parameters:{docs:{description:{story:n("combobox","preffix-sufffix")}}},render:()=>r`
  ...
  `},h={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:n("combobox","simple")}}},play:async({canvasElement:o})=>{const e=o.querySelector("syn-combobox");await e.updateComplete,await e.show()},render:()=>r`
    <syn-combobox label="Preferred Color" value="g">
     ${t()}
    </syn-combobox>
  `},f={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:n("combobox","highlight")}}},play:async({canvasElement:o})=>{const e=o.querySelector("syn-combobox");await e.updateComplete,await e.show()},render:()=>{const o=A;return r(H||(H=$([`
    ...
    <\/script>
  `])),t(),o)}},S={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:n("combobox","grouping")}}},play:async({canvasElement:o})=>{const e=o.querySelector("syn-combobox");await e.updateComplete,await e.show()},render:()=>r`
  ...
  `},O={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:n("combobox","container-height")}}},play:async({canvasElement:o})=>{const e=o.querySelector("syn-combobox");await e.updateComplete,await e.show()},render:()=>r`
  ...
  `},d={parameters:{docs:{description:{story:n("combobox","async-options")}}},render:()=>r(E||(E=$([`
    ...
    <\/script>
  `])))},u={parameters:{docs:{description:{story:n("combobox","custom-filter")}}},render:()=>r(q||(q=$([`
    ...
    <\/script>
  `])),t())},v=M({Default:a,Labels:i,HelpText:c,Placeholder:l,Clearable:p,Disabled:m,Sizes:b,PrefixSuffixTextAndIcons:y,AsyncOptions:d,CustomFilter:u},500);a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  parameters: {
    args: overrideArgs({
      name: 'default',
      type: 'slot',
  ...
  AsyncOptions,
  CustomFilter
}, 500)`,...v.parameters?.docs?.source}}};const Do=["Default","Labels","HelpText","Placeholder","Focus","Clearable","Disabled","Sizes","Invalid","PrefixSuffixTextAndIcons","SimpleSuggests","HighlightQuery","GroupingQuery","SuggestionContainerHeight","AsyncOptions","CustomFilter","Screenshot"];export{d as AsyncOptions,p as Clearable,u as CustomFilter,a as Default,m as Disabled,x as Focus,S as GroupingQuery,c as HelpText,f as HighlightQuery,g as Invalid,i as Labels,l as Placeholder,y as PrefixSuffixTextAndIcons,v as Screenshot,h as SimpleSuggests,b as Sizes,O as SuggestionContainerHeight,Do as __namedExportsOrder,qo as default};
