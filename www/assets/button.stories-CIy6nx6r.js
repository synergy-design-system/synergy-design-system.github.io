import{g}from"./preview-DszUOtWR.js";import{x as t}from"./lit-element-DILkAbkc.js";import{s as f,a as S,g as n,b as x,c as h}from"./component-CcTyadHm.js";import"./index-B3ehnkiM.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon.component-7B7zNgNb.js";import"./directive-helpers-DbZfDV3x.js";import"./icon-button-BDdQ3v9d.js";import"./icon-D0WpraVk.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-BOByFueo.js";const{args:z,argTypes:v}=f("syn-button"),{overrideArgs:D}=h("syn-button"),{generateTemplate:k}=S("syn-button"),W={args:D({name:"default",type:"slot",value:"Button"},z),argTypes:v,component:"syn-button",parameters:{design:g("1055-22957"),docs:{description:{component:n("button","default")}}},title:"Components/syn-button"},s={parameters:{controls:{disable:!1},docs:{description:{story:n("button","default")}}},render:d=>k({args:d})},e={parameters:{docs:{description:{story:n("button","variant")}}},render:()=>t`
