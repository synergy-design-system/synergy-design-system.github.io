import"./preview-BMgyQje8.js";import{x as t}from"./lit-element-ZYWMe1i1.js";import{s as p,a as g,g as n,b as f,c as h}from"./component-CzF4s4R4.js";import"./index-DH5ua8nC.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./icon-button-DcbuMwrE.js";import"./icon.component-D55FUTwa.js";import"./directive-helpers-CkpR4LMI.js";import"./icon-BrqnReZV.js";import"./chunk-GKNNPQCW-Dc4YePFK.js";import"./index-7bc9rCDE.js";const{args:x,argTypes:S}=p("syn-button"),{overrideArgs:z}=h("syn-button"),{generateTemplate:v}=g("syn-button"),B={args:z({name:"default",type:"slot",value:"Button"},x),argTypes:S,component:"syn-button",parameters:{docs:{description:{component:n("button","default")}}},title:"Components/syn-button"},s={parameters:{controls:{disable:!1},docs:{description:{story:n("button","default")}}},render:b=>v({args:b})},e={parameters:{docs:{description:{story:n("button","variant")}}},render:()=>t`
  ...
  <syn-button variant="text" disabled>Text</syn-button>`},m=f({Default:s,Variants:e,Sizes:o,LinkButtons:r,SettingACustomWidth:a,PrefixAndSuffixIcons:i,Caret:u,Loading:y,Disabled:l},280);s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
