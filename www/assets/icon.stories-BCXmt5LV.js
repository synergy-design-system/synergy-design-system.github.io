import"./icon-5q8oryo5.js";import{k as n}from"./directive-helpers-CDT6qhDs.js";import{s as f,a as h,g,c as b,d as v}from"./component-C5VI2Py7.js";import{r as d}from"./library-BZPO0bHa.js";import{d as u}from"./default-icons-B7cd3LAo.js";import"./icon.component-ULMuVEGu.js";import"./if-defined-BaykDp1D.js";import"./ref-lLHsj5FH.js";import"./chunk-L4EGOTBX-C9C4DwME.js";import"./entry-preview-D9TbQDUR.js";import"./index-DrFu-skq.js";import"./index-CBCu9vDS.js";import"./index-7h80QhK_.js";import"./_commonjsHelpers-Cpj98o6Y.js";const{args:w,argTypes:S}=f("syn-icon"),{overrideArgs:I}=v("syn-icon"),{generateTemplate:C}=h("syn-icon"),_=`
...
---
`,V={args:I({name:"name",type:"attribute",value:"wallpaper"},w),argTypes:S,component:"syn-icon",parameters:{design:g("1616-1512"),docs:{description:{component:_}}},title:"Components/syn-icon"},s={parameters:{controls:{disable:!1}},render:e=>C({args:e})},t={render:()=>n`<div style="color: var(--syn-color-primary-600);">
...
</div>`)},y=b({Default:s,Colors:t,Sizing:o,Labels:r,CustomIcons:i,CDNIconLibrary:a,BundledIconLibrary:c,SpriteSheetUsage:l});s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    }
...
} as Story`,...s.parameters?.docs?.source},description:{story:"This shows the syn-icon in its default state",...s.parameters?.docs?.description}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
