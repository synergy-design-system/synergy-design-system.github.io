import{i as e}from"./preload-helper-xPQekRTU.js";import{Ht as t,It as n}from"./iframe-BjJCO_Oc.js";import{a as r,i,n as a,o,r as s}from"./component-Bp0Gg8Fw.js";import{n as c,t as l}from"./taggedTemplateLiteral-pWa2IaV6.js";import{t as u}from"./popup-B2WqweqH.js";import{t as d}from"./option-DF2ix79p.js";import{t as f}from"./select-Cd5zr7Dw.js";import{t as p}from"./switch-D5PWguuC.js";import{t as m}from"./range-DC7zA8Pi.js";var h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H=e((()=>{u(),p(),f(),d(),m(),n(),s(),c(),{args:w,argTypes:T}=i(`syn-popup`),{overrideArgs:E}=r(`syn-popup`),{generateTemplate:D}=o(`syn-popup`),O={args:E([{name:`active`,type:`attribute`,value:!0},{name:`anchor`,type:`slot`,value:`<span></span>`},{name:`default`,type:`slot`,value:`<div class="box"></div>`}],w),argTypes:T,component:`syn-popup`,parameters:{chromatic:{disableSnapshot:!0},docs:{description:{component:a(`popup`,`default`)},story:{iframeHeight:300}}},tags:[`Structure`],title:`Components/syn-popup`},k={parameters:{docs:{description:{story:a(`popup`,`default`)}}},render:e=>t`
  ...
  `},A={render:()=>t(h||=l([`<div class="popup-active">
...
<\/script>`]))},j={render:()=>t`<span id="external-anchor"></span>
...
</style>`},M={render:()=>t(g||=l([`<div class="popup-placement">
  <syn-popup placement="top" active>
    <span slot="anchor"></span>
    <div class="box"></div>
  </syn-popup>
...
<\/script>`]))},N={render:()=>t(_||=l([`<div class="popup-distance">
...
<\/script>`]))},P={render:()=>t(v||=l([`<div class="popup-skidding">
...
<\/script>`]))},F={render:()=>t(y||=l([`<div class="popup-arrow">
  ...
  <\/script>
</div>`]))},I={render:()=>t(b||=l([`<div class="popup-sync">
...
<\/script>`]))},L={render:()=>t(x||=l([`<div class="popup-flip">
  <div class="overflow">
...
<\/script>`]))},R={render:()=>t`<div class="popup-flip-fallbacks">
  <div class="overflow">
...
</style>`},z={render:()=>t(S||=l([`<div class="popup-shift">
  <div class="overflow">
...
<\/script>`]))},B={render:()=>t(C||=l([`<div class="popup-virtual-element">
...
<style>
...
</style>`]))},k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
  ...
  \`
} as Story`,...k.parameters?.docs?.source}}},A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
...
<script type="module">
  ...
  active.addEventListener('syn-change', () => (popup.active = active.checked));
<\/script>\`
}`,...A.parameters?.docs?.source},description:{story:`Popups are inactive and hidden until the active attribute is applied.
Removing the attribute will tear down all positioning logic and listeners,
meaning you can have many idle popups on the page without affecting performance.`,...A.parameters?.docs?.description}}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
...
}`,...j.parameters?.docs?.source},description:{story:`By default, anchors are slotted into the popup using the anchor slot.
...
to the anchor property to achieve the same effect without using an id.`,...j.parameters?.docs?.description}}},M.parameters={...M.parameters,docs:{...M.parameters?.docs,source:{originalSource:`{
...
<script type="module">
  ...
  select.addEventListener('syn-change', () => (popup.placement = select.value));
<\/script>\`
}`,...M.parameters?.docs?.source},description:{story:`Use the placement attribute to tell the popup the preferred placement of the popup.
...
available space and it will be removed when the popup is deactivated.`,...M.parameters?.docs?.description}}},N.parameters={...N.parameters,docs:{...N.parameters?.docs,source:{originalSource:`{
...
<script type="module">
  ...
  distance.addEventListener('syn-input', () => (popup.distance = distance.value));
<\/script>\`
}`,...N.parameters?.docs?.source},description:{story:`Use the distance attribute to change the distance between the popup and its anchor.
A positive value will move the popup further away and a negative value will move it closer.`,...N.parameters?.docs?.description}}},P.parameters={...P.parameters,docs:{...P.parameters?.docs,source:{originalSource:`{
...
<script type="module">
  ...
  skidding.addEventListener('syn-input', () => (popup.skidding = skidding.value));
<\/script>\`
}`,...P.parameters?.docs?.source},description:{story:`The skidding attribute is similar to distance,
but instead allows you to offset the popup along the anchor's axis.
Both positive and negative values are allowed.`,...P.parameters?.docs?.description}}},F.parameters={...F.parameters,docs:{...F.parameters?.docs,source:{originalSource:`{
...
}`,...F.parameters?.docs?.source},description:{story:`Add an arrow to your popup with the arrow attribute.
...
the arrow to align to the start, end, or center of the  instead.`,...F.parameters?.docs?.description}}},I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`{
...
This is useful for controls that need the popup to stay the same width or height as the trigger.`,...I.parameters?.docs?.description}}},L.parameters={...L.parameters,docs:{...L.parameters?.docs,source:{originalSource:`{
...
<script type="module">
  ...
  flip.addEventListener('syn-change', () => (popup.flip = flip.checked));
<\/script>\`
}`,...L.parameters?.docs?.source},description:{story:`When the popup doesn't have enough room in its preferred placement,
...
Additional options are available to control the flip behavior's boundary and padding.`,...L.parameters?.docs?.description}}},R.parameters={...R.parameters,docs:{...R.parameters?.docs,source:{originalSource:`{
...
}`,...R.parameters?.docs?.source},description:{story:`While using the flip attribute, you can customize the placement
...
Scroll the container to see how the popup changes it's fallback placement to prevent clipping.`,...R.parameters?.docs?.description}}},z.parameters={...z.parameters,docs:{...z.parameters?.docs,source:{originalSource:`{
...
<script type="module">
  ...
  shift.addEventListener('syn-change', () => (popup.shift = shift.checked));
<\/script>\`
}`,...z.parameters?.docs?.source},description:{story:`When a popup is longer than its anchor, it risks being clipped by an overflowing container.
...
Toggle the switch to see the difference.`,...z.parameters?.docs?.description}}},B.parameters={...B.parameters,docs:{...B.parameters?.docs,source:{originalSource:`{
...
}`,...B.parameters?.docs?.source},description:{story:`In most cases, popups are anchored to an actual element.
...
As such, a mouse is required to properly view it.`,...B.parameters?.docs?.description}}},V=[`Default`,`Activating`,`ExternalAnchors`,`Placement`,`Distance`,`Skidding`,`Arrows`,`SyncingWithTheAnchorsDimensions`,`Flip`,`FlipFallbacks`,`Shift`,`VirtualElements`]}));H();export{A as Activating,F as Arrows,k as Default,N as Distance,j as ExternalAnchors,L as Flip,R as FlipFallbacks,M as Placement,z as Shift,P as Skidding,I as SyncingWithTheAnchorsDimensions,B as VirtualElements,V as __namedExportsOrder,O as default,H as t};