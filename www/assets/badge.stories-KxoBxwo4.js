import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,l as r}from"./preview-DRz18Lsn.js";import{c as i,t as a}from"./lit-D4-0ovri.js";import{t as o}from"./button-CBC8ywKX.js";import{t as s}from"./icon-BbsmBxau.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-NnlguzJ1.js";import{t as m}from"./badge-AsPwSCp-.js";import{n as h,t as g}from"./menu-item-I3gppQTq.js";import{t as _}from"./menu-label-DAD8fX7G.js";import{t as v}from"./popup-5PBvaCYB.js";var y=t({Default:()=>T,Screenshot:()=>A,Variants:()=>E,WithButtons:()=>D,WithEmptyContent:()=>k,WithMenuItems:()=>O,__namedExportsOrder:()=>j,default:()=>w}),b,x,S,C,w,T,E,D,O,k,A,j;function M(){return(M=e((()=>{a(),m(),o(),s(),h(),_(),g(),v(),f(),r(),{args:b,argTypes:x}=l(`syn-badge`),{overrideArgs:S}=c(`syn-badge`),{generateTemplate:C}=d(`syn-badge`),w={args:S([{name:`default`,type:`slot`,value:`Badge`}],b),argTypes:x,component:`syn-badge`,parameters:{chromatic:{modes:n},docs:{description:{component:u(`badge`,`default`)}}},tags:[`Feedback`],title:`Components/syn-badge`},T={parameters:{controls:{disable:!1},docs:{description:{story:u(`badge`,`default`)}}},render:e=>C({args:e})},E={parameters:{docs:{description:{story:u(`badge`,`variants`)}}},render:()=>i`
  ...
  `},A=p({Default:T,Variants:E,WithButtons:D,WithMenuItems:O,WithEmptyContent:k},250),j=[`Default`,`Variants`,`WithButtons`,`WithMenuItems`,`WithEmptyContent`,`Screenshot`],T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
  ...
  WithMenuItems,
  WithEmptyContent
}, 250)`,...A.parameters?.docs?.source}}}})))()}export{y as n,M as r,T as t};