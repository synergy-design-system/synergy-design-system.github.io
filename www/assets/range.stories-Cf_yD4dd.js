import{C as V,c as r,d as C}from"./iframe-r0CQHRKQ.js";import"./range-YXVGHlWg.js";import"./button-DPFLjHtv.js";import"./input-P3pGlS0T.js";import"./range-tick-DDL00lLe.js";import{g as e,a as M,s as _,b as q,c as z}from"./component-H_NDQ3WO.js";import"./preload-helper-PPVm8Dsz.js";import"./if-defined-BE596y_O.js";import"./synergy-element-C0zzvLBX.js";import"./query-D0jTsbLw.js";import"./class-map-BSAfnhal.js";import"./default-value-IZvEus9V.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./localize-Dh03wnLC.js";import"./index-DihgwUfS.js";import"./form-control.custom.styles-CtgJ8K7o.js";import"./tooltip.component-DMKAKuvo.js";import"./animation-registry-DyRYqZdt.js";import"./event-B0iVuGLD.js";import"./watch-CEsCE2EF.js";import"./popup.component-D6gJNkI9.js";import"./decorator-UnohHU6S.js";import"./functions-B4dslKTf.js";import"./icon.component-BtCkPkUy.js";import"./spinner.component-CBNnwNtq.js";import"./live-CBv9XL3n.js";import"./divider.component-BeWBm2g7.js";import"./index-3hbeBem-.js";import"./_docs-B-LcOZte.js";var T=Object.freeze,L=Object.defineProperty,S=(t,s)=>T(L(t,"raw",{value:T(t.slice())})),D,w,E;const{userEvent:O}=__STORYBOOK_MODULE_TEST__,{args:P,argTypes:A}=_("syn-range"),{overrideArgs:F}=z("syn-range"),{generateTemplate:j}=q("syn-range"),de={args:F([{name:"value",type:"attribute",value:"50"}],P),argTypes:A,component:"syn-range",parameters:{chromatic:{modes:V},design:C("20575-35283"),docs:{description:{component:e("range","default")}}},tags:["Form"],title:"Components/syn-range"},a={parameters:{controls:{disable:!1},docs:{description:{story:e("range","default")},story:{height:"80px"}}},render:t=>j({args:t})},n={parameters:{docs:{description:{story:e("range","labels")}}},render:()=>r`
  ...
  `},v={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:e("range","invalid")}}},play:async({canvasElement:t})=>{try{const s=t.querySelector("syn-range"),h=t.querySelector("syn-button");s&&h&&(await O.click(h),h.click())}catch(s){console.error("Error in play function:",s)}},render:()=>r(D||(D=S([`
  ...
  `},f={parameters:{docs:{description:{story:e("range","tooltip-formatter")}}},render:()=>r(E||(E=S([`
    ...
    <\/script>
  `])))},b=M({Default:a,Labels:n,HelpText:i,Disabled:o,Sizes:c,PrefixSuffixText:l,CustomTrackColors:p,CustomTrackOffset:m,MultiThumb:y,Ticks:u,TooltipPlacement:g,TooltipDisabled:d,TooltipFormatter:f},500);a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
