import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-BVDl_-fF.js";import{d as r,g as i,p as a,u as o}from"./iframe-Cn79ht60.js";import{n as s,r as c,t as l}from"./chart-DG_4uNdU.js";import{a as u,i as d,n as f,o as p,r as m,t as h}from"./component-BsxLXFpR.js";import{n as g,t as _}from"./taggedTemplateLiteral-pWa2IaV6.js";var v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F=e((()=>{n(),l(),c(),m(),r(),i(),g(),{overrideArgs:C}=u(`syn-chart`),{args:w,argTypes:T}=d(`syn-chart`),{generateTemplate:E}=p(`syn-chart`),D={args:C([{name:`id`,type:`attribute`,value:`chart-default`}],w),argTypes:{...T,palette:{control:`select`,options:Object.keys(s)}},component:`syn-chart`,parameters:{chromatic:{modes:a,pauseAnimationAtEnd:!1},design:o(`41094-279501`),docs:{description:{component:[`>⚠️ **Experimental**:`,`>syn-chart is currently experimental.`,`>The API may change in future releases without prior notice.`,`>Use it with caution in production environments and expect potential breaking changes.
