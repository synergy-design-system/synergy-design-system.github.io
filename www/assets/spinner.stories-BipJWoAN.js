import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{a as t,d as n,o as r,s as i}from"./preview-DdzcclEm.js";import{c as a,t as o}from"./lit-BfcklOOD.js";import{i as s,n as c,o as l,r as u,t as d}from"./component-BjD7AuVi.js";import{t as f}from"./spinner-CVCm4vTr.js";var p,m,h,g,_,v,y,b,x,S,C=e((()=>{f(),o(),u(),r(),n(),{args:p,argTypes:m}=s(`syn-spinner`),{generateTemplate:h}=l(`syn-spinner`),g={args:p,argTypes:m,component:`syn-spinner`,parameters:{chromatic:{modes:i},design:t(`41227-223775`),docs:{description:{component:c(`spinner`,`default`)}}},tags:[`Feedback`],title:`Components/syn-spinner`},_={parameters:{docs:{description:{story:c(`spinner`,`default`)}}},render:e=>h({args:e})},v={parameters:{docs:{description:{story:c(`spinner`,`size`)}}},render:()=>a`
  ...
  `},y={parameters:{docs:{description:{story:c(`spinner`,`track-width`)}}},render:()=>a`
    <syn-spinner style="font-size: 48px; --track-width: 8px;"></syn-spinner>
  `},b={parameters:{docs:{description:{story:c(`spinner`,`color`)}}},render:()=>a`
