import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{_ as t,h as n}from"./preview-DRz18Lsn.js";import{a as r,c as i,h as a,t as o}from"./lit-D4-0ovri.js";import{a as s,d as c,l,n as ee,o as u,r as d,s as te,t as ne}from"./synergy-element-Di-hMrpy.js";import{t as f}from"./query-DOHNhzf6.js";import{r as p,t as re}from"./if-defined-BN5mMhH6.js";import{n as m,t as ie}from"./class-map-LsJiuvgY.js";import{r as ae,t as oe}from"./form-D9RYqjir.js";import{r as se,t as ce}from"./slot-CUH75lUH.js";import{n as h,t as g}from"./localize-Du3bqz3O.js";import{n as _}from"./watch-Q8hEwzVb.js";import{n as v,t as le}from"./icon.component-C5O4LU7A.js";import{n as ue,t as de}from"./decorator-DZesXZg7.js";import{a as y,i as b,l as x,n as fe,t as S}from"./animation-registry-DCzWq2z4.js";import{r as pe,t as me}from"./scroll-CAqkVgC4.js";import{n as C}from"./event-B7qjsglH.js";import{n as he,t as ge}from"./form-control.styles-BbnxDpsH.js";import{n as _e,t as ve}from"./popup.component-CiAHNn5G.js";import{n as w,t as ye}from"./tag.component-CIUIFhiK.js";import{a as T,i as E,n as D,o as O,r as k,s as A,t as j}from"./option.component-CAyuAiSt.js";var M;function N(){return(N=e((()=>{o(),O(),M=a`
  ...
  */
  ...
  ${A}
`})))()}var P,F,I,L,R,z,B,V,H,U,W,G;function K(){return(K=e((()=>{o(),n(),P=e=>Array.from(e.assignedElements({flatten:!0})),F=e=>e.tagName.toLocaleLowerCase()===`syn-option`?e:Array.from(e.querySelectorAll(`:scope > syn-option`)),I=e=>e.tagName.toLocaleLowerCase()===`syn-optgroup`,L=e=>e.map(F),R=e=>e.filter(I),z=e=>e.normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).toLowerCase(),B=e=>{let t=document.createElement(`div`);return r(e,t),t.firstElementChild},V=e=>e.tagName.toLocaleLowerCase()===`syn-option`?e:void 0,H=e=>{if(e){if(e instanceof HTMLElement)return V(e);if(typeof e==`string`){let n=i`${t(e)}`,r=B(n);return V(r)}if(Object.prototype.hasOwnProperty.call(e,`_$litType$`)){let t=B(e);return V(t)}}},U=e=>{let{value:t}=e;return t==null||t===``?e.getTextLabel():t},W=e=>e.map(U),G=(e,t)=>{if(!t||e==null||e===``)return!1;let n=t.value,r=t.getTextLabel();return String(e)===String(n)||String(e)===r}})))()}var q,J;function Y(){return(Y=e((()=>{o(),q=e=>e,J=(e,t)=>{if(!t)return e;let n=e.cloneNode(!0),r=n.getTextLabel();n.selected=e.selected;let i=r.toLowerCase().indexOf(t.toLowerCase()),a=n.innerHTML.indexOf(r),o=document.createElement(`mark`);o.textContent=r.slice(i,i+t.length),o.classList.add(`syn-highlight-style`);let s=r.replace(new RegExp(t,`i`),o.outerHTML),c=n.innerHTML.slice(0,a),l=n.innerHTML.slice(a+r.length);return n.innerHTML=c.concat(s,l),n}})))()}var X,Z;function Q(){return(Q=e((()=>{ie(),re(),o(),te(),n(),ae(),fe(),se(),g(),u(),he(),ee(),v(),_e(),j(),ye(),N(),K(),me(),Y(),ue(),E(),X=class extends ne{constructor(...e){super(...e),this.formControlController=new oe(this,{assumeInteractionOn:[`syn-blur`,`syn-input`]}),this.hasSlotController=new ce(this,`help-text`,`label`),this.localize=new h(this),this.lastOptions=[],this.isInitialized=!1,this.isOptionRendererTriggered=!1,this.hasFocus=!1,this.isUserInput=!1,this.displayLabel=``,this.selectedOptions=[],this.numberFilteredOptions=0,this.cachedOptions=[],this.valueHasChanged=!1,this.hideOptions=!1,this.name=``,this._value=``,this.defaultValue=``,this.size=`medium`,this.placeholder=``,this.disabled=!1,this.readonly=!1,this.clearable=!1,this.open=!1,this.label=``,this.placement=`bottom`,this.helpText=``,this.form=``,this.required=!1,this.restricted=!1,this.multiple=!1,this.getOption=q,this.filter=(e,t)=>{let n=e?.textContent||``;e instanceof D&&(n=e.getTextLabel());let r=z(n),i=z(t);return r.includes(i)?!0:(e?.value?.toString()||``).includes(t)},this.delimiter=` `,this.maxOptionsVisible=3,this.getTag=e=>i`
    <syn-tag
      part="tag"
      exportparts="
            base:tag__base,
  ...
  `,this.calculateTagMaxWidth=e=>{let t=e.at(0);if(!t||!this.tagContainer)return;let n=t.contentRect.width,r=this.tagContainer.getBoundingClientRect().width,i=Math.max(85,r+n-48);this.tagContainer.style.setProperty(`--syn-select-tag-max-width`,`${i}px`)},this.handleDocumentFocusIn=e=>{let t=e.composedPath();this&&!t.includes(this)&&this.hide()},this.handleDocumentKeyDown=e=>{if(e.target.closest(`.combobox__clear`)===null){if(e.key===`Escape`&&(this.open&&!this.closeWatcher?(e.preventDefault(),e.stopPropagation(),this.hide(),this.displayInput.focus({preventScroll:!0})):this.open||(this.multiple?this.clearInputField():this.clearCombobox())),e.key===`Enter`){let t=this.getCurrentOption(),n=e.metaKey||e.ctrlKey||e.shiftKey||e.altKey;if(!this.open&&!n){setTimeout(()=>{e.defaultPrevented||this.formControlController.submit()});return}if(!this.open||t&&t.disabled)return;if(t){this.isUserInput=!0,this.valueHasChanged=!0;let e=this.lastOptions?W(this.lastOptions):[];this.multiple?this.toggleOptionSelection(t):this.setSelectedOptions(t),this.selectionChanged();let n=Array.isArray(this.value)?this.value:[this.value];this.updateComplete.then(()=>{this.isUserInput=!1}),k(e,n)||this.updateComplete.then(()=>{this.emit(`syn-input`),this.emit(`syn-change`)})}this.multiple||this.hide(),this.displayInput.focus({preventScroll:!0});return}[`ArrowUp`,`ArrowDown`].includes(e.key)&&(e.preventDefault(),e.stopPropagation(),this.open||this.show(),this.selectNextOption(e.key===`ArrowDown`)),[`Home`,`End`].includes(e.key)&&(e.preventDefault(),e.stopPropagation(),e.key===`Home`?this.displayInput.setSelectionRange(0,0):e.key===`End`&&this.displayInput.setSelectionRange(this.displayLabel.length,this.displayLabel.length))}},this.handleDocumentMouseDown=e=>{let t=e.composedPath();this&&!t.includes(this)&&this.hide()}}static{this.styles=[s,ge,M]}static{this.dependencies={"syn-icon":le,"syn-popup":ve,"syn-tag":w}}get value(){return this._value}set value(e){this.multiple?Array.isArray(e)||(e=typeof e==`string`?e.split(this.delimiter):[e].filter(T)):e=Array.isArray(e)?e.join(this.delimiter):e,!k(this._value,e)&&(this.valueHasChanged=!0,this._value=e)}get validity(){return this.valueInput.validity}get validationMessage(){return this.valueInput.validationMessage}enableResizeObserver(){this.multiple&&(this.resizeObserver||=new ResizeObserver(this.calculateTagMaxWidth),this.resizeObserver.observe(this.displayInput))}connectedCallback(){super.connectedCallback(),this.mutationObserver=new MutationObserver(e=>{let t=e.some(e=>{if(!(e.target instanceof D)||e.type!==`attributes`||e.attributeName!==`value`)return!1;let t=e.target.getAttribute(`value`);return e.oldValue!==t&&!!t}),n=(this.restricted||this.multiple)&&e.some(e=>e.type!==`characterData`&&e.type!==`childList`?!1:this.selectedOptions.some(t=>t===e.target||t.contains(e.target)));t&&this.handleSlotContentChange(),n&&(this.multiple?this.readonly?this.displayLabel=this.selectedOptions.map(e=>e.getTextLabel()).join(`, `):this.requestUpdate():this.displayLabel=this.selectedOptions[0]?.getTextLabel?.()??this.displayLabel)}),this.mutationObserver.observe(this,{attributeFilter:[`value`],attributeOldValue:!0,attributes:!0,characterData:!0,childList:!0,subtree:!0}),setTimeout(()=>{this.handleSlotContentChange()}),this.open=!1}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect(),this.mutationObserver?.disconnect(),this.removeOpenListeners()}firstUpdated(){this.isInitialized=!0,this.formControlController.updateValidity()}updated(e){super.updated(e),e.has(`multiple`)&&(this.multiple?this.enableResizeObserver():this.resizeObserver?.disconnect())}willUpdate(e){super.willUpdate(e);let t=this.defaultValue==null||this.defaultValue===``||Array.isArray(this.defaultValue)&&this.defaultValue.length===0;if(e.has(`value`)&&t&&this.value&&!this.isUserInput&&(this.defaultValue=this.multiple&&Array.isArray(this.value)?this.value.join(this.delimiter):this.value,this.valueHasChanged=!1),!this.isInitialized&&e.has(`value`)&&this.value!==void 0&&e.has(`multiple`)&&this.multiple&&!Array.isArray(this.defaultValue)){let e=this.valueHasChanged;this.value=typeof this.defaultValue==`string`?this.defaultValue.split(this.delimiter):[this.defaultValue].filter(T),this.valueHasChanged=e}}attributeChangedCallback(e,t,n){if(super.attributeChangedCallback(e,t,n),e===`value`){let e=this.valueHasChanged;this.value=this.defaultValue,this.valueHasChanged=e}}get tags(){return this.selectedOptions.map((e,n)=>{if(n<this.maxOptionsVisible||this.maxOptionsVisible<=0){let r=this.getTag(e,n);return i`<div @syn-remove=${t=>this.handleTagRemove(t,e)}>
    ...
    `}},d([f(`.combobox`)],X.prototype,`popup`,void 0),d([f(`.combobox__inputs`)],X.prototype,`combobox`,void 0),d([f(`.combobox__display-input`)],X.prototype,`displayInput`,void 0),d([f(`.combobox__value-input`)],X.prototype,`valueInput`,void 0),d([f(`.combobox__listbox`)],X.prototype,`listbox`,void 0),d([f(`slot:not([name])`)],X.prototype,`defaultSlot`,void 0),d([f(`.combobox__tags`)],X.prototype,`tagContainer`,void 0),d([l()],X.prototype,`hasFocus`,void 0),d([l()],X.prototype,`isUserInput`,void 0),d([l()],X.prototype,`displayLabel`,void 0),d([l()],X.prototype,`selectedOptions`,void 0),d([l()],X.prototype,`numberFilteredOptions`,void 0),d([l()],X.prototype,`cachedOptions`,void 0),d([l()],X.prototype,`valueHasChanged`,void 0),d([l()],X.prototype,`hideOptions`,void 0),d([c()],X.prototype,`name`,void 0),d([l()],X.prototype,`value`,null),d([c({attribute:`value`})],X.prototype,`defaultValue`,void 0),d([c({reflect:!0})],X.prototype,`size`,void 0),d([c()],X.prototype,`placeholder`,void 0),d([c({reflect:!0,type:Boolean})],X.prototype,`disabled`,void 0),d([c({reflect:!0,type:Boolean})],X.prototype,`readonly`,void 0),d([c({type:Boolean})],X.prototype,`clearable`,void 0),d([c({reflect:!0,type:Boolean})],X.prototype,`open`,void 0),d([c()],X.prototype,`label`,void 0),d([c({type:Number})],X.prototype,`maxlength`,void 0),d([c({reflect:!0})],X.prototype,`placement`,void 0),d([c({attribute:`help-text`})],X.prototype,`helpText`,void 0),d([c({reflect:!0})],X.prototype,`form`,void 0),d([c({reflect:!0,type:Boolean})],X.prototype,`required`,void 0),d([c({reflect:!0,type:Boolean})],X.prototype,`restricted`,void 0),d([c({reflect:!0,type:Boolean})],X.prototype,`multiple`,void 0),d([c()],X.prototype,`getOption`,void 0),d([c()],X.prototype,`filter`,void 0),d([c()],X.prototype,`delimiter`,void 0),d([c({attribute:`max-options-visible`,type:Number})],X.prototype,`maxOptionsVisible`,void 0),d([c()],X.prototype,`getTag`,void 0),d([_([`filter`,`getOption`],{waitUntilFirstUpdate:!0})],X.prototype,`handlePropertiesChange`,null),d([_(`displayLabel`,{waitUntilFirstUpdate:!0})],X.prototype,`handleDisplayInputValueChange`,null),d([_([`disabled`,`readonly`],{waitUntilFirstUpdate:!0})],X.prototype,`handleDisabledChange`,null),d([_(`delimiter`)],X.prototype,`handleDelimiterChange`,null),d([_([`defaultValue`,`value`,`delimiter`,`multiple`,`restricted`],{waitUntilFirstUpdate:!0})],X.prototype,`handleValueChange`,null),d([_(`open`,{waitUntilFirstUpdate:!0})],X.prototype,`handleOpenChange`,null),X=d([de(`SynCombobox`)],X),Z=X,b(`combobox.show`,{keyframes:[{opacity:0,scale:.9},{opacity:1,scale:1}],options:{duration:100,easing:`ease`}}),b(`combobox.hide`,{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.9}],options:{duration:100,easing:`ease`}})})))()}function $(){return($=e((()=>{Q(),Z.define(`syn-combobox`)})))()}export{J as n,Y as r,$ as t};