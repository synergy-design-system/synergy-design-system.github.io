import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,h as n,n as r,t as i}from"./lit-BVDl_-fF.js";import{_ as ee,d as te,f as ne,p as re}from"./iframe-BiSXA87W.js";import{_ as a,a as ie,f as ae,i as o,l as oe,n as s,o as se,r as c,s as l,t as u,x as ce,y as d}from"./synergy-element-DzBHqVed.js";import{r as le,t as ue}from"./if-defined-BsCyJVG6.js";import{n as f,t as de}from"./watch-I6gMK-uE.js";import{n as fe,t as pe}from"./decorator--vj33aRy.js";import{t as me}from"./button-6RBRhEco.js";import{a as he,i as p,n as m,o as ge,r as h,t as _e}from"./component-BZMStFjM.js";import{n as ve,t as ye}from"./taggedTemplateLiteral-pWa2IaV6.js";import{n as be,t as g}from"./alert.component-D11fonaZ.js";import{n as _,t as xe}from"./tooltip.component-C5JtJdQK.js";import{t as Se}from"./input-B88dl7oc.js";var v,y,b,x,S,C,w,T,E,D,O,k=e((()=>{s(),v=[`blur`,`change`,`clear`,`focus`,`invalid`,`input`,`move`],y=(e,t)=>e.includes(t),b=e=>y(e,`blur`),x=e=>y(e,`invalid`),S=e=>e instanceof u,C=(e=``)=>e.split(` `).map(e=>e.trim()).filter(Boolean),w=(e,t)=>{let n=t.trim();return S(e)&&v.includes(n)?`syn-${n}`:n},T=e=>{if(!S(e))return;let{size:t}=e;return t??void 0},E={"syn-checkbox":`input`,"syn-combobox":`.combobox__value-input`,"syn-file":`input`,"syn-input":`input`,"syn-radio-group":`input`,"syn-range":`.input__control`,"syn-select":`.select__value-input`,"syn-switch":`input`,"syn-textarea":`.textarea__control`},D=(e,t)=>e.shadowRoot?.querySelector(t)??null,O=e=>{if(!e)return;if(!e.shadowRoot)return e;let t=E[e.tagName.toLowerCase()];if(t){let n=D(e,t);if(n)return n}return D(e,`input,select,textarea`)||e}})),A,Ce=e((()=>{i(),A=n`
  .validate {
    display: flex;
