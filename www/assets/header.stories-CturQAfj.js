import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,t as n}from"./lit-DWg8XNs3.js";import{d as r,f as i,g as a,u as o}from"./iframe-DFZAAaEN.js";import{t as s}from"./icon-Bkwl5xpe.js";import{t as c}from"./divider-5c3zPm77.js";import{a as l,i as u,n as d,o as f,r as p,t as m}from"./component-C-mvpOf5.js";import{n as h,t as g}from"./taggedTemplateLiteral-pWa2IaV6.js";import{t as _}from"./icon-button-CUNH9Kad.js";import{t as v}from"./prio-nav-Bsc5gwlq.js";import{t as y}from"./nav-item-CrEIbEAT.js";import{t as b}from"./header-B8MJ5hOd.js";var x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R=e((()=>{c(),v(),y(),b(),s(),_(),n(),p(),r(),a(),h(),{args:S,argTypes:C}=u(`syn-header`),{overrideArgs:w}=l(`syn-header`),{generateTemplate:T}=f(`syn-header`),E={args:w([{name:`label`,type:`slot`,value:`<span slot="label">App Name</span>`}],S),argTypes:C,component:`syn-header`,parameters:{chromatic:{modes:i},design:o(`41163-318668`),docs:{description:{component:d(`header`,`default`)}}},tags:[`Application Shell`],title:`Components/syn-header`},D={parameters:{controls:{disable:!1},docs:{description:{story:d(`header`,`default`)}}},render:e=>T({args:e})},O={parameters:{docs:{description:{story:d(`header`,`label`)}}},render:()=>t`
