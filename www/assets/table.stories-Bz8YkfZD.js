import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{B as n,Ht as r,It as i,d as a,f as o,g as s,n as c,t as l,u}from"./iframe-BjJCO_Oc.js";import{d,f,i as p,p as m,u as h}from"./blocks-BtcIpwDF.js";import{t as g}from"./button-Cq0pTj4t.js";import{t as _}from"./icon-BS9OsfYG.js";import{n as v,r as y}from"./component-Bp0Gg8Fw.js";import{n as b,t as x}from"./taggedTemplateLiteral-pWa2IaV6.js";import{n as S,t as C}from"./translations-C4Vy0kAa.js";var w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V;e((()=>{w=t(n(),1),m(),i(),l(),y(),S(),a(),s(),g(),_(),b(),k=(e,t=5)=>Array(t).fill(void 0).map(e),A=(e=void 0)=>{let t=e?`syn-table-cell--shadow-${e} shadow-cell`:``,n=n=>`${e===`end`&&n===0||e===`start`&&n===4||e===`bottom`?t:``}`;return r`
    <thead>
      <tr>
  ...
  `},j=(e=void 0)=>{let t=e?`syn-table-cell--shadow-${e} shadow-cell`:``,n=n=>`${e===`end`&&n===0||e===`start`&&n===4?t:``}`;return r`
    <tr>
...
`,N={parameters:{chromatic:{...c?.parameters?.chromatic,disableSnapshot:!1,modes:o},design:u(`16648-52486`),docs:{description:{component:v(`table`,`default`,`templates`)},page:()=>w.createElement(w.Fragment,null,w.createElement(f,null),w.createElement(d,null),w.createElement(p,null),w.createElement(h,{title:``})),story:{iframeHeight:550}}},tags:[`Structure`],title:`Templates/Table`},P={render:()=>{let e=k(()=>j());return r`
    ...
    `}},L={render:()=>{let e=k(()=>j(`end`));return r(T||=x([`
      ...
      <\/script>
    `]),A(`end`),e)}},R={render:()=>{let e=k(()=>j(`start`));return r(E||=x([`
      ...
      <\/script>
    `]),A(`start`),e)}},z={render:()=>{let e=k(()=>j());return r(D||=x([`
      ...
      <\/script>
    `]),A(`bottom`),e)}},B={render:()=>{let e=k(()=>M());return r(O||=x([`
