import{a as _}from"./class-map-QQ7HVnPG.js";import{H as g}from"./slot-9EVoRGQc.js";import{i as c,x as m,n as d}from"./property-ImbD-3qY.js";import{o as f}from"./if-defined-CDNCanKK.js";import{r as v}from"./directive-helpers-CvZEagFv.js";import{a as b}from"./query-DAIS6qJ0.js";import{w as x}from"./watch-CEsCE2EF.js";import{S as h,c as y}from"./component.styles-DXWA7L2q.js";import{L as S}from"./localize-CatY2peN.js";import{S as w}from"./icon.component-B3J6d3UF.js";const C=c`
	/* stylelint-disable */
  :host {
    display: inline-flex;
  }
...
`;var E=Object.defineProperty,u=(s,r,e,a)=>{for(var t=void 0,o=s.length-1,n;o>=0;o--)(n=s[o])&&(t=n(r,e,t)||t);return t&&E(r,e,t),t};class p extends h{constructor(){super(...arguments),this.localize=new S(this),this.separatorDir=this.localize.dir(),this.label=""}static{this.styles=[y,A,D]}static{this.dependencies={"syn-icon":w}}getSeparator(){const e=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[e,...e.querySelectorAll("[id]")].forEach(a=>a.removeAttribute("id")),e.setAttribute("data-default",""),e.slot="separator",e}handleSlotChange(){const r=[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>e.tagName.toLowerCase()==="syn-breadcrumb-item");r.forEach((e,a)=>{const t=e.querySelector('[slot="separator"]');t===null?e.append(this.getSeparator()):t.hasAttribute("data-default")&&t.replaceWith(this.getSeparator()),a===r.length-1?e.setAttribute("aria-current","page"):e.removeAttribute("aria-current")})}render(){return this.separatorDir!==this.localize.dir()&&(this.separatorDir=this.localize.dir(),this.updateComplete.then(()=>this.handleSlotChange())),m`
