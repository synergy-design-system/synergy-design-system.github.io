...
`,B={args:T([{name:"default",type:"slot",value:o().trim()}],g),argTypes:f,component:"syn-table",parameters:{chromatic:{modes:y},design:p("19479-134433"),docs:{description:{component:i}}},tags:["Structure","Styles","SICK2018","SICK2025"],title:"Styles/syn-table"},s={parameters:{controls:{disable:!1},docs:{description:{story:i}}},render:c=>m(c,"table")},t={render:()=>n`
  ...
  `},w={render:()=>b()},A={render:()=>b("border")},H={render:()=>b("alternating")},r=C({AtomicTable:t,AutoDefaultTable:e,AutoAlternatingTable:l,AutoBorderTable:a,ComplexTableDefault:w,ComplexTableBorder:A,ComplexTableAlternating:H},400);s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    },
