import{j as x,x as a,g as S}from"./iframe-HYWqsTHs.js";import{L as k}from"./localize-Dh03wnLC.js";import{S as w,c as z,n as _}from"./synergy-element-Bv7T9Cbj.js";import{r as R}from"./icon.component-CwSx8_oh.js";import{a as C}from"./query-DAIS6qJ0.js";import"./button-3Inan2Ri.js";import"./icon-DiS0YKRv.js";import{g as s,s as D,a as E,c as B,b as L}from"./component-Dql1Y4BB.js";import"./preload-helper-Ct5FWWRu.js";import"./index-DihgwUfS.js";import"./watch-CEsCE2EF.js";import"./class-map-CqeSldTo.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./if-defined-CdJRJEIB.js";import"./spinner.component-DZZLghiC.js";import"./decorator-DANECR0-.js";import"./functions-CDi3doZH.js";import"./index-Bkk0Z6Ex.js";import"./_docs-UXgsQIP6.js";const O=x`
	/* stylelint-disable */
  :host {
    --size: 128px;
    --track-width: 4px;
...
`;var P=Object.defineProperty,m=(r,t,d,y)=>{for(var e=void 0,v=r.length-1,h;v>=0;v--)(h=r[v])&&(e=h(t,d,e)||e);return e&&P(t,d,e),e};class g extends w{constructor(){super(...arguments),this.localize=new k(this),this.value=0,this.label=""}static{this.styles=[z,O,j]}updated(t){if(super.updated(t),t.has("value")){const d=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),y=2*Math.PI*d,e=y-this.value/100*y;this.indicatorOffset=`${e}px`}}render(){return a`
    ...
    `}}m([C(".progress-ring__indicator")],g.prototype,"indicator");m([R()],g.prototype,"indicatorOffset");m([_({type:Number,reflect:!0})],g.prototype,"value");m([_()],g.prototype,"label");g.define("syn-progress-ring");var f=Object.freeze,T=Object.defineProperty,I=(r,t)=>f(T(r,"raw",{value:f(r.slice())})),b;const{args:$,argTypes:A}=D("syn-progress-ring"),{overrideArgs:M}=E("syn-progress-ring"),{generateTemplate:V}=B("syn-progress-ring"),ir={args:M([{name:"default",type:"slot",value:""},{name:"value",type:"attribute",value:"25"}],$),argTypes:A,component:"syn-progress-ring",parameters:{design:S("14207-8709"),docs:{description:{component:s("progress-ring","default")}}},tags:["Feedback"],title:"Components/syn-progress-ring"},o={parameters:{docs:{description:{story:s("progress-ring","default")}}},render:r=>V({args:r})},n={parameters:{docs:{description:{story:s("progress-ring","size")}}},render:()=>a`
