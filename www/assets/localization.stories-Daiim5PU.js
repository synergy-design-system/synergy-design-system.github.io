import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{c as n,t as r}from"./lit-BVDl_-fF.js";import{U as i,_ as a,n as o,p as s,t as c}from"./iframe-Dn-tjrvc.js";import{d as l,f as u,i as d,p as f,u as p}from"./blocks-Djr6a2r4.js";import{t as m}from"./card-Cqmx6gRw.js";import{n as h,r as g}from"./component-D_QZftXm.js";import{n as _,t as v}from"./taggedTemplateLiteral-pWa2IaV6.js";import{n as y,t as b}from"./menu-item-bx6g0jgT.js";import{t as x}from"./dropdown-C3jrl2sQ.js";import{t as S}from"./tooltip-CWEroo5f.js";import{t as C}from"./icon-button-BFNASnJP.js";import{t as w}from"./file-mDE9JFfV.js";import{t as T}from"./prio-nav-ByqFbLs9.js";import{t as E}from"./header-CWsJpFjH.js";import{n as D,t as O}from"./localization-DYHno_I0.js";var k,A,j,M,N,P,F,I;e((()=>{k=t(i(),1),f(),r(),c(),g(),a(),D(),T(),m(),x(),w(),E(),C(),y(),b(),S(),_(),j={parameters:{chromatic:{...o?.parameters?.chromatic,disableSnapshot:!1,modes:s},docs:{description:{component:h(`localization`,`default`,`templates`)},page:()=>k.createElement(k.Fragment,null,k.createElement(u,null),k.createElement(l,null),k.createElement(d,null),k.createElement(p,{title:``}))}},tags:[`i18n`,`localization`,`translations`],title:`Templates/Localization`},M=Object.values(O()),N=M.find(e=>e.$code===`de`)||M[0],P=M.map(e=>({code:e.$code,dir:e.$dir,name:e.$name})),F={parameters:{docs:{description:{story:h(`localization`,`dynamicallySetLocalizations`,`templates`)}},synergy:{customImports:M.filter(e=>e.$code===`en`||e.$code===`de`).map(e=>`https://esm.sh/@synergy-design-system/components@latest/dist/translations/${e.$code}.js`)}},render:()=>n(A||=v([`
