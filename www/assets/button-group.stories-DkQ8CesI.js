import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,Rt as n,d as r,f as i,g as a,u as o}from"./iframe-rzuzvTqw.js";import{t as s}from"./button-r_Sen7MB.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-CQhtHSyB.js";import{n as m,t as h}from"./menu-item-DVZe_ard.js";import{t as g}from"./dropdown-CV8Fc5Dl.js";import{t as _}from"./button-group-RADxlWDi.js";import{t as v}from"./tooltip-BuRnEYx0.js";var y,b,x,S,C,w,T,E,D,O,k,A,j,M;e((()=>{_(),s(),g(),m(),h(),v(),t(),f(),r(),a(),{args:y,argTypes:b}=l(`syn-button-group`),{overrideArgs:x}=c(`syn-button-group`),{generateTemplate:S}=d(`syn-button-group`),C={args:x({name:`default`,type:`slot`,value:`<syn-button>Left</syn-button>
<syn-button>Center</syn-button>
<syn-button>Right</syn-button>`},y),argTypes:b,component:`syn-button-group`,parameters:{chromatic:{modes:i},design:o(`45597-333063`),docs:{description:{component:u(`button-group`,`default`)}}},title:`Components/syn-button-group`},w={parameters:{controls:{disable:!1},docs:{description:{story:u(`button-group`,`default`)}}},render:e=>S({args:e})},T={parameters:{docs:{description:{story:u(`button-group`,`variant`)}}},render:()=>n`
  ...
  `},E={parameters:{docs:{description:{story:u(`button-group`,`size`)}}},render:()=>n`
    <div style="display: flex; gap: var(--syn-spacing-large); flex-direction: column;">
  ...
  `},D={parameters:{docs:{description:{story:u(`button-group`,`dropdowns-in-button-groups`)}}},render:()=>n`
  ...
  `},O={parameters:{docs:{description:{story:u(`button-group`,`split-buttons`)}}},render:()=>n`
    <syn-button-group label="Example Button Group">
  ...
  `},k={parameters:{docs:{description:{story:u(`button-group`,`tooltips`)}}},render:()=>n`
    <syn-button-group label="Example Button Group">
  ...
  `},A={parameters:{docs:{description:{story:u(`button-group`,`toolbar`)}}},render:()=>n`
  ...
  ToolbarExample
}, 280)`,...j.parameters?.docs?.source}}},M=[`Default`,`Variants`,`ButtonSizes`,`DropdownsInButtonGroups`,`SplitButtons`,`TooltipsInButtonGroups`,`ToolbarExample`,`Screenshot`]}))();export{E as ButtonSizes,w as Default,D as DropdownsInButtonGroups,j as Screenshot,O as SplitButtons,A as ToolbarExample,k as TooltipsInButtonGroups,T as Variants,M as __namedExportsOrder,C as default};