import{e as _}from"./class-map-Bo2NiYIQ.js";import{e as w,a as B,t as k,T as C,q as S,x as n,g as z,C as E}from"./iframe-CW_KonjK.js";import{o as $}from"./if-defined-qefA8dKN.js";import{L as D}from"./localize-Dh03wnLC.js";import{S as I,c as L,n as b}from"./synergy-element-BoJA4F0K.js";import"./button-BbfaGMjJ.js";import"./icon-CBxjVoUr.js";import{g as i,s as T,a as P,c as O,b as j}from"./component-C0ootQNb.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DihgwUfS.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./icon.component-9N7Azsi9.js";import"./watch-CEsCE2EF.js";import"./query-D0jTsbLw.js";import"./spinner.component-DvWUUZZP.js";import"./decorator-CVE5vLu9.js";import"./functions-Cnw7w7U0.js";import"./index-CQ0aEGxp.js";import"./_docs-DNIao1HN.js";const x="important",M=" !"+x,A=w(class extends B{constructor(e){if(super(e),e.type!==k.ATTRIBUTE||e.name!=="style"||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((a,s)=>{const r=e[s];return r==null?a:a+`${s=s.includes("-")?s:s.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${r};`}),"")}update(e,[a]){const{style:s}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(a)),this.render(a);for(const r of this.ft)a[r]==null&&(this.ft.delete(r),r.includes("-")?s.removeProperty(r):s[r]=null);for(const r in a){const t=a[r];if(t!=null){this.ft.add(r);const o=typeof t=="string"&&t.endsWith(M);r.includes("-")||o?s.setProperty(r,o?t.slice(0,-11):t,o?x:""):s[r]=t}}return C}}),H=S`
	/* stylelint-disable */
  :host {
    --height: 1rem;
