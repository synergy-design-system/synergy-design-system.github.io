import{i as e}from"./preload-helper-xPQekRTU.js";import{Ht as t,It as n,d as r,f as i,g as a,u as o}from"./iframe-BjJCO_Oc.js";import{t as s}from"./icon-BS9OsfYG.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./component-Bp0Gg8Fw.js";import{n as m,t as h}from"./taggedTemplateLiteral-pWa2IaV6.js";import{t as g}from"./icon-button-iltpZ1cJ.js";import{t as _}from"./divider-CkQncvjD.js";import{t as v}from"./prio-nav-gejP4NT0.js";import{t as y}from"./nav-item-DWT8R8MU.js";import{t as b}from"./header-E8-8Nrju.js";var x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R=e((()=>{_(),v(),y(),b(),s(),g(),n(),f(),r(),a(),m(),{args:S,argTypes:C}=l(`syn-header`),{overrideArgs:w}=c(`syn-header`),{generateTemplate:T}=d(`syn-header`),E={args:w([{name:`label`,type:`slot`,value:`<span slot="label">App Name</span>`}],S),argTypes:C,component:`syn-header`,parameters:{chromatic:{modes:i},design:o(`41163-318668`),docs:{description:{component:u(`header`,`default`)}}},tags:[`Application Shell`],title:`Components/syn-header`},D={parameters:{controls:{disable:!1},docs:{description:{story:u(`header`,`default`)}}},render:e=>T({args:e})},O={parameters:{docs:{description:{story:u(`header`,`label`)}}},render:()=>t`
    <syn-header label="A new label"></syn-header>
  `},k={parameters:{docs:{description:{story:u(`header`,`logo`)}}},render:()=>t`
  ...
  `},A={parameters:{chromatic:{disableSnapshot:!1},docs:{description:{story:u(`header`,`focus`)}}},play:({canvasElement:e})=>{e.querySelector(`a`)?.focus()},render:()=>t`
    <style>
  ...
  `},j={parameters:{docs:{description:{story:u(`header`,`options`)}}},render:()=>t`
    <syn-header label="App Name">
  ...
  `},M={parameters:{docs:{description:{story:u(`header`,`options-with-dividers`)}}},render:()=>t`
    <syn-header label="App Name">
      <nav slot="meta-navigation">
  ...
  `},N={parameters:{docs:{description:{story:u(`header`,`navigation`)}}},render:()=>t(x||=h([`
    <syn-header label="App Name">
    ...
    <\/script>
  `]))},P={parameters:{docs:{description:{story:u(`header`,`burger-menu`)}}},render:()=>t`
    <syn-header burger-menu="closed" label="App Name">
    </syn-header>
  `},F={parameters:{docs:{description:{story:u(`header`,`sticky`)}}},render:()=>t`
