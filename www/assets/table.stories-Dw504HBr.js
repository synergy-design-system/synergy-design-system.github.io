import{R as r}from"./index-_2TAQcTa.js";import{T as $,S as C,b as z,c as S}from"./index-DX_flYiH.js";import{x as a}from"./directive-helpers-DGrfjhaU.js";import{g as L,a as E,p as D}from"./component-DWZBRS4O.js";import{g as l}from"./translations-CnhJ1T76.js";import"./button-g-CcO67S.js";import"./icon-DDvBgRpz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-B2bVberJ.js";import"./index-BwkS7JH_.js";import"./index-DrFu-skq.js";import"./static-gmWA-8Kq.js";import"./async-directive-PIeysb9D.js";import"./chunk-L4EGOTBX-CsK1v_wc.js";import"./entry-preview-B_oC2lVs.js";import"./_docs-CrPFe_9C.js";import"./index-BmTV649i.js";import"./custom-elements-manifest-BvFG-x67.js";import"./form-d9hCJUdr.js";import"./slot-9EVoRGQc.js";import"./if-defined-B2ZFWIyt.js";import"./localize-CatY2peN.js";import"./index-DihgwUfS.js";import"./property-BGzwfL48.js";import"./library-6WV9-XO2.js";import"./query-DAIS6qJ0.js";import"./watch-CEsCE2EF.js";import"./component.styles-Bzr6o2G3.js";import"./icon.component-CqZOTSyT.js";import"./spinner.component-DjO7gRap.js";import"./decorator-DANECR0-.js";import"./functions-CDi3doZH.js";var w=Object.freeze,_=Object.defineProperty,v=(e,s)=>w(_(e,"raw",{value:w(e.slice())})),g,f,x,T;const o=(e,s=5)=>new Array(s).fill(void 0).map(e),n=(e=void 0)=>{const s=e?`syn-table-cell--shadow-${e} shadow-cell`:"",t=d=>`${e==="end"&&d===0||e==="start"&&d===4||e==="bottom"?s:""}`;return a`
    <thead>
      <tr>
  ...
  `},c=(e=void 0)=>{const s=e?`syn-table-cell--shadow-${e} shadow-cell`:"",t=d=>`${e==="end"&&d===0||e==="start"&&d===4?s:""}`;return a`
    <tr>
...
`,ie={parameters:{chromatic:{...D?.parameters?.chromatic,disableSnapshot:!1},design:E("19923-55456"),docs:{description:{component:L("table","default","templates")},page:()=>r.createElement(r.Fragment,null,r.createElement($,null),r.createElement(C,null),r.createElement(z,null),r.createElement(S,{title:""})),story:{iframeHeight:550}}},title:"Templates/Table"},h={render:()=>{const e=o(()=>c());return a`
    ...
    `}},i={render:()=>{const e=o(()=>c("end"));return a(g||(g=v([`
      ...
      <\/script>
    `])),n("end"),e)}},b={render:()=>{const e=o(()=>c("start"));return a(f||(f=v([`
      ...
      <\/script>
    `])),n("start"),e)}},p={render:()=>{const e=o(()=>c());return a(x||(x=v([`
      ...
      <\/script>
    `])),n("bottom"),e)}},u={render:()=>{const e=o(()=>P());return a(T||(T=v([`
...
}`,...u.parameters?.docs?.source}}};const be=["TableWithHeader","TableWithAlternatingRows","TableWithBorders","TableShadowLeftColumn","TableShadowRightColumn","TableShadowTopRow","TableProduct"];export{u as TableProduct,i as TableShadowLeftColumn,b as TableShadowRightColumn,p as TableShadowTopRow,y as TableWithAlternatingRows,m as TableWithBorders,h as TableWithHeader,be as __namedExportsOrder,ie as default};
