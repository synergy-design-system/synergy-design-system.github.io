var On=Object.freeze,qi=Object.defineProperty;var Dn=(t,e)=>On(qi(t,"raw",{value:On(e||t.slice())}));import{a as f,c as Zn,s as ue,u as C,e as u,o as y,i as kt,t as Ki}from"./if-defined-zGpnP1OK.js";import{i as h,x as p,E as ei,u as In,B as Gi,T as Yi}from"./directive-helpers-Dvm_Ferq.js";import{h as ti,k as ni,r as ii,L as Xi,l as Ct,a as Ji,b as Qi,c as Nn,f as Zi,s as ea,d as ta,p as an,e as na,g as ia,o as ai,m as aa,n as oa,j as sa,i as ra,t as la}from"./ref-BbXSZ-3a.js";import{s as da}from"./chunk-L4EGOTBX-Boit2UGA.js";import"./entry-preview-DkJqm5dP.js";import{e as se,S as ut,d as ca}from"./icon-button-CM_m1Wpw.js";import{d as pa}from"./index-DrFu-skq.js";import"./index-_2TAQcTa.js";import{n as r,a as b}from"./library-C58jM0s5.js";import{c as x,w as m,a as w,S as Te}from"./icon.component-CNx_GwpD.js";import"./icon-DUMdkemV.js";import{a as ha}from"./index-Vx7n56Jp.js";const ua=h`
  :host {
    display: block;
  }
...
${gn.hideScriptTag?"":C(Qn||(Qn=Dn([`<script>
  window.component = document.querySelector("`,`");
<\/script>`])),t.tagName)}
`}function di(t,e){const n=Da(t,e);return`${n}`?.replaceAll(/\s+/g,"")!=""?C`<style>${n}</style>`:""}function $a(t,e,n){const a=un(t),i={},o={},s={};return Object.keys(a).forEach(l=>{const d=a[l];if(d?.table?.category!=="attributes")return;const c=d.name,g=e[l],T=d.control.type==="boolean"?`?${c}`:c;(g!==a[l].defaultValue||gn.renderDefaultAttributeValues)&&(i[T]=g==="false"?!1:g)}),Object.keys(e).filter(l=>a[l]?.table?.category==="properties").forEach(l=>{if(l.startsWith("on"))return;const d=e[l];o[`.${l}`]=d}),Object.keys(e).filter(l=>!Object.keys(n||{}).includes(l)).forEach(l=>{!l.startsWith("on")&&typeof e[l]!="function"&&(s[l]=e[l])}),{attrOperators:i,propOperators:o,additionalAttrs:s}}function Oa(t,e){if(!t?.cssProperties?.length)return;const n=mn(t);return ue(`style="${Object.keys(n).map(a=>{const i=n[a].name,o=e[a];return o?`${i}: ${o||""}`:null}).filter(a=>a!==null).join(";")}"`)}function Da(t,e){const n=fn(t);if(!Object.keys(n).some(o=>!!e[o]))return;const i=Object.keys(n).filter(o=>o.endsWith("-part")).map(o=>{const s=n[o].name,l=e[o];return l?.replaceAll(/\s+/g,"")!==`${t?.tagName}::part(${s}){}`?`
${l}`:null}).filter(o=>o!==null).join(`
`);return i?ue(`${i}
`):""}function Ia(t,e){const n=yn(t);return ue(`${Object.keys(n).filter(i=>i.endsWith("-slot")).map(i=>{const o=n[i].name,s=e[i];return o==="default"?s||null:s!==`<span slot="${o}"></span>`?s:null}).filter(i=>i!==null).join("")}`)}function Na(t){Aa(t),setTimeout(()=>{const e=document.querySelector(t.tagName);Wt?.observe(e,{attributes:!0})})}function Aa(t){let e=!1;const n=za()[1],a=un(t);Wt||(Wt=new MutationObserver(i=>{i.forEach(o=>{if(o.type!=="attributes"||o.attributeName==="class"&&e)return;e=!0;const s=a[`${o.attributeName}`];s?.control==="boolean"||s?.control?.type==="boolean"?n({[`${o.attributeName}`]:o.target?.hasAttribute(o.attributeName||"")}):n({[`${o.attributeName}`]:o.target.getAttribute(o.attributeName||"")}),e=!1})}))}function Ma(t){window.__WC_STORYBOOK_HELPERS_CONFIG__=t}function ci(t){const e=window.__STORYBOOK_CUSTOM_ELEMENTS_MANIFEST__;if(!e)throw new Error(`Custom Elements Manifest not found. Be sure to follow the pre-install steps in this guide:
https://www.npmjs.com/package/wc-storybook-helpers#before-you-install`);const n=oi(t,e),a=n?.events?.map(o=>o.name)||[],i=pi(n);return{args:hi(n),argTypes:i,reactArgs:La(n),reactArgTypes:ui(n),events:a,styleTemplate:o=>di(n,o),template:(o,s)=>Ea(n,o,s,i)}}function pi(t){return{...mn(t),...fn(t),...yn(t),...un(t),...xa(t)}}function hi(t,e){return e||(e=pi(t)),Object.entries(e).filter(([,a])=>a?.control).map(([a,i])=>{let o=Pa(i.defaultValue);return i.table?.category==="css properties"&&(o=o?.toString()),{[a]:o===void 0?"":o}}).reduce((a,i)=>({...a,...i}),{})}function Pa(t){try{return JSON.parse(t)}catch{return t}}function ui(t){return{...wa(t),...si(t),...mn(t,!1),...fn(t,!1),...yn(t,!1)}}function La(t){const e=hi(t,ui(t)),n=Object.entries(si(t)).map(([a])=>({[a]:()=>{}})).reduce((a,i)=>({...a,...i}),{});return{...e,...n}}const{useParameter:ja,addons:Fa,useEffect:Va,useMemo:Wl,definePreview:ql}=__STORYBOOK_MODULE_PREVIEW_API__,{deprecate:Ba}=__STORYBOOK_MODULE_CLIENT_LOGGER__;var Ha=Object.defineProperty,mi=(t,e)=>{for(var n in e)Ha(t,n,{get:e[n],enumerable:!0})},Ra={};mi(Ra,{initialGlobals:()=>qa});var qt="themes",Ua=`storybook/${qt}`,fi="theme",Mn={},Wa={REGISTER_THEMES:`${Ua}/REGISTER_THEMES`},qa={[fi]:""},Ka={};mi(Ka,{initializeThemeState:()=>bi,pluckThemeFromContext:()=>yi,useThemeParameters:()=>Ga});function yi({globals:t}){return t[fi]||""}function Ga(t){return Ba(pa`The useThemeParameters function is deprecated. Please access parameters via the context directly instead e.g.
    - const { themeOverride } = context.parameters.themes ?? {};
    `),t?t.parameters[qt]??Mn:ja(qt,Mn)}function bi(t,e){Fa.getChannel().emit(Wa.REGISTER_THEMES,{defaultTheme:e,themes:t})}var Ya="html",Pn=t=>t.split(" ").filter(Boolean),Xa=({themes:t,defaultTheme:e,parentSelector:n=Ya})=>(bi(Object.keys(t),e),(a,i)=>{let{themeOverride:o}=i.parameters[qt]??{},s=yi(i);return Va(()=>{let l=o||s||e,d=document.querySelector(n);if(!d)return;Object.entries(t).filter(([g])=>g!==l).forEach(([g,T])=>{let Y=Pn(T);Y.length>0&&d.classList.remove(...Y)});let c=Pn(t[l]);c.length>0&&d.classList.add(...c)},[o,s]),a()});const{definePreview:Kl}=__STORYBOOK_MODULE_PREVIEW_API__;var Ja=Object.defineProperty,Qa=(t,e)=>{for(var n in e)Ja(t,n,{get:e[n],enumerable:!0})},Za={};Qa(Za,{initialGlobals:()=>io});var eo="viewport",to={[eo]:{value:void 0,isRotated:!1}},no={viewport:"reset",viewportRotated:!1},io=globalThis.FEATURES?.viewportStoryGlobals?to:no,ao={mobile1:{name:"Small mobile",styles:{height:"568px",width:"320px"},type:"mobile"},mobile2:{name:"Large mobile",styles:{height:"896px",width:"414px"},type:"mobile"},tablet:{name:"Tablet",styles:{height:"1112px",width:"834px"},type:"tablet"}};function W(t,e,n){return new Promise(a=>{if(n?.duration===1/0)throw new Error("Promise-based animations must be finite.");const i=t.animate(e,{...n,duration:oo()?0:n.duration});i.addEventListener("cancel",a,{once:!0}),i.addEventListener("finish",a,{once:!0})})}function Ln(t){return t=t.toString().toLowerCase(),t.indexOf("ms")>-1?parseFloat(t):t.indexOf("s")>-1?parseFloat(t)*1e3:parseFloat(t)}function oo(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Z(t){return Promise.all(t.getAnimations().map(e=>new Promise(n=>{e.cancel(),requestAnimationFrame(n)})))}function jn(t,e){return t.map(n=>({...n,height:n.height==="auto"?`${e}px`:n.height}))}const Yt=t=>{const{activeElement:e}=document;e&&t.contains(e)&&document.activeElement?.blur()},gi=new Map,ln=new WeakMap;function vi(t){return t??{keyframes:[],options:{duration:0}}}function Fn(t,e){return e.toLowerCase()==="rtl"?{keyframes:t.rtlKeyframes||t.keyframes,options:t.options}:t}function S(t,e){gi.set(t,vi(e))}function Vt(t,e,n){ln.set(t,{...ln.get(t),[e]:vi(n)})}function j(t,e,n){const a=ln.get(t);if(a?.[e])return Fn(a[e],n.dir);const i=gi.get(e);return i?Fn(i,n.dir):{keyframes:[],options:{duration:0}}}class Q{constructor(e,...n){this.slotNames=[],this.handleSlotChange=a=>{const i=a.target;(this.slotNames.includes("[default]")&&!i.name||i.name&&this.slotNames.includes(i.name))&&this.host.requestUpdate()},(this.host=e).addController(this),this.slotNames=n}hasDefaultSlot(){return[...this.host.childNodes].some(e=>{if(e.nodeType===e.TEXT_NODE&&e.textContent.trim()!=="")return!0;if(e.nodeType===e.ELEMENT_NODE){const n=e;if(n.tagName.toLowerCase()==="syn-visually-hidden")return!1;if(!n.hasAttribute("slot"))return!0}return!1})}hasNamedSlot(e){return this.host.querySelector(`:scope > [slot="${e}"]`)!==null}test(e){return e==="[default]"?this.hasDefaultSlot():this.hasNamedSlot(e)}hostConnected(){this.host.shadowRoot.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener("slotchange",this.handleSlotChange)}}function wi(t){if(!t)return"";const e=t.assignedNodes({flatten:!0});let n="";return[...e].forEach(a=>{a.nodeType===Node.TEXT_NODE&&(n+=a.textContent)}),n}const xi={$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(t,e)=>`Go to slide ${t} of ${e}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:t=>t===0?"No options selected":t===1?"1 option selected":`${t} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:t=>`Slide ${t}`,toggleColorFormat:"Toggle color format",closeMenu:"Close menu",danger:"Danger",fileButtonText:"Choose file",fileButtonTextMultiple:"Choose files",folderButtonText:"Choose folder",fileDragDrop:"Drop or choose file",folderDragDrop:"Drop or choose folder",menu:"Menu",notification:"Notification",numFilesSelected:(t,e)=>t===0?`No ${e?"folder":"files"} chosen`:`${t} files`,openMenu:"Open menu",rangeMax:"Maximum",rangeMin:"Minimum",sideNav:"Side navigation",success:"Success",warning:"Warning"};ii(xi);class R extends Xi{static{ii(xi)}}function J(t,e){return new Promise(n=>{function a(i){i.target===t&&(t.removeEventListener(e,a),n())}t.addEventListener(e,a)})}const so=h`
	/* stylelint-disable */
  :host {
    display: contents;
...
`;var lo=Object.defineProperty,co=Object.getOwnPropertyDescriptor,Ae=(t,e,n,a)=>{for(var i=a>1?void 0:a?co(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&lo(e,n,i),i};let X=class extends w{constructor(){super(...arguments),this.hasSlotController=new Q(this,"icon","suffix"),this.localize=new R(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.remainingTime=this.duration}static get toastStack(){return this.currentToastStack||(this.currentToastStack=Object.assign(document.createElement("div"),{className:"syn-toast-stack"})),this.currentToastStack}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){this.countdownAnimation?.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),this.countdownAnimation?.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){const{countdownElement:t}=this,e="100%",n="0";this.countdownAnimation=t.animate([{width:e},{width:n}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.duration<1/0&&this.restartAutoHide(),await Z(this.base),this.base.hidden=!1;const{keyframes:t,options:e}=j(this,"alert.show",{dir:this.localize.dir()});await W(this.base,t,e),this.emit("syn-after-show")}else{Yt(this),this.emit("syn-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await Z(this.base);const{keyframes:t,options:e}=j(this,"alert.hide",{dir:this.localize.dir()});await W(this.base,t,e),this.base.hidden=!0,this.emit("syn-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,J(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,J(this,"syn-after-hide")}async toast(){return new Promise(t=>{this.handleCountdownChange(),X.toastStack.parentElement===null&&document.body.append(X.toastStack),X.toastStack.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("syn-after-hide",()=>{X.toastStack.removeChild(this),t(),X.toastStack.querySelector("syn-alert")===null&&X.toastStack.remove()},{once:!0})})}render(){return p`
    ...
    `}};X.styles=[x,so,ro];X.dependencies={"syn-icon-button":ut};Ae([u('[part~="base"]')],X.prototype,"base",2);Ae([u(".alert__countdown-elapsed")],X.prototype,"countdownElement",2);Ae([r({type:Boolean,reflect:!0})],X.prototype,"open",2);Ae([r({type:Boolean,reflect:!0})],X.prototype,"closable",2);Ae([r({reflect:!0})],X.prototype,"variant",2);Ae([r({type:Number})],X.prototype,"duration",2);Ae([b()],X.prototype,"remainingTime",2);Ae([m("open",{waitUntilFirstUpdate:!0})],X.prototype,"handleOpenChange",1);Ae([m("duration")],X.prototype,"handleDurationChange",1);X=Ae([se("SynAlert")],X);S("alert.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});S("alert.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});X.define("syn-alert");const po=h`
	/* stylelint-disable */
  :host {
    display: inline-flex;
  }
...
`;var uo=Object.defineProperty,mo=Object.getOwnPropertyDescriptor,ki=(t,e,n,a)=>{for(var i=a>1?void 0:a?mo(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&uo(e,n,i),i};let zt=class extends w{constructor(){super(...arguments),this.localize=new R(this),this.variant="primary"}render(){return p`
      <span
        part="base"
    ...
    `}};zt.styles=[x,po,ho];ki([r({reflect:!0})],zt.prototype,"variant",2);zt=ki([se("SynBadge")],zt);zt.define("syn-badge");const fo=h`
	/* stylelint-disable */
  :host {
    display: inline-flex;
  }
...
`;var bo=Object.defineProperty,go=Object.getOwnPropertyDescriptor,mt=(t,e,n,a)=>{for(var i=a>1?void 0:a?go(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&bo(e,n,i),i};class st extends w{constructor(){super(...arguments),this.hasSlotController=new Q(this,"prefix","suffix"),this.renderType="button",this.rel="noreferrer noopener"}static{this.styles=[x,fo,yo]}setRenderType(){const e=this.defaultSlot.assignedElements({flatten:!0}).filter(n=>n.tagName.toLowerCase()==="syn-dropdown").length>0;if(this.href){this.renderType="link";return}if(e){this.renderType="dropdown";return}this.renderType="button"}hrefChanged(){this.setRenderType()}handleSlotChange(){this.setRenderType()}render(){return p`
      <div
        part="base"
    ...
    `}}mt([u("slot:not([name])")],st.prototype,"defaultSlot",2);mt([b()],st.prototype,"renderType",2);mt([r()],st.prototype,"href",2);mt([r()],st.prototype,"target",2);mt([r()],st.prototype,"rel",2);mt([m("href",{waitUntilFirstUpdate:!0})],st.prototype,"hrefChanged",1);st.define("syn-breadcrumb-item");const vo=h`
	/* stylelint-disable */
  .breadcrumb {
    display: flex;
    align-items: center;
...
`;var xo=Object.defineProperty,vn=(t,e,n,a)=>{for(var i=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=s(e,n,i)||i);return i&&xo(e,n,i),i};class Xt extends w{constructor(){super(...arguments),this.localize=new R(this),this.separatorDir=this.localize.dir(),this.label=""}static{this.styles=[x,vo,wo]}static{this.dependencies={"syn-icon":Te}}getSeparator(){const n=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[n,...n.querySelectorAll("[id]")].forEach(a=>a.removeAttribute("id")),n.setAttribute("data-default",""),n.slot="separator",n}handleSlotChange(){const e=[...this.defaultSlot.assignedElements({flatten:!0})].filter(n=>n.tagName.toLowerCase()==="syn-breadcrumb-item");e.forEach((n,a)=>{const i=n.querySelector('[slot="separator"]');i===null?n.append(this.getSeparator()):i.hasAttribute("data-default")&&i.replaceWith(this.getSeparator()),a===e.length-1?n.setAttribute("aria-current","page"):n.removeAttribute("aria-current")})}render(){return this.separatorDir!==this.localize.dir()&&(this.separatorDir=this.localize.dir(),this.updateComplete.then(()=>this.handleSlotChange())),p`
    ...
    `}}vn([u("slot")],Xt.prototype,"defaultSlot");vn([u('slot[name="separator"]')],Xt.prototype,"separatorSlot");vn([r()],Xt.prototype,"label");Xt.define("syn-breadcrumb");const ko=h`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
`;var _o=Object.defineProperty,wn=(t,e,n,a)=>{for(var i=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=s(e,n,i)||i);return i&&_o(e,n,i),i};class Dt extends w{constructor(){super(...arguments),this.disableRole=!1,this.label=""}static{this.styles=[x,ko]}handleFocus(e){bt(e.target)?.toggleAttribute("data-syn-button-group__button--focus",!0)}handleBlur(e){bt(e.target)?.toggleAttribute("data-syn-button-group__button--focus",!1)}handleMouseOver(e){bt(e.target)?.toggleAttribute("data-syn-button-group__button--hover",!0)}handleMouseOut(e){bt(e.target)?.toggleAttribute("data-syn-button-group__button--hover",!1)}handleSlotChange(){const e=[...this.defaultSlot.assignedElements({flatten:!0})];e.forEach(n=>{const a=e.indexOf(n),i=bt(n);i&&(i.toggleAttribute("data-syn-button-group__button",!0),i.toggleAttribute("data-syn-button-group__button--first",a===0),i.toggleAttribute("data-syn-button-group__button--inner",a>0&&a<e.length-1),i.toggleAttribute("data-syn-button-group__button--last",a===e.length-1),i.toggleAttribute("data-syn-button-group__button--radio",i.tagName.toLowerCase()==="syn-radio-button"))})}render(){return p`
      <div
        part="base"
        class="button-group"
...
`;class xn extends w{constructor(){super(...arguments),this.localize=new R(this)}static{this.styles=[x,Co,So]}render(){return p`
...
`;var Io=Object.defineProperty,No=(t,e,n,a)=>{for(var i=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=s(e,n,i)||i);return i&&Io(e,n,i),i};class Ci extends w{constructor(){super(...arguments),this.hasSlotController=new Q(this,"footer","header","image"),this.sharp=!1}static{this.styles=[x,Oo,Do]}render(){return p`
      <div
        part="base"
    ...
    `}}No([r({type:Boolean,reflect:!0})],Ci.prototype,"sharp");Ci.define("syn-card");const rt=(t="value")=>(e,n)=>{const a=e.constructor,i=a.prototype.attributeChangedCallback;a.prototype.attributeChangedCallback=function(o,s,l){const d=a.getPropertyOptions(t),c=typeof d.attribute=="string"?d.attribute:t;if(o===c){const g=d.converter||In,Y=(typeof g=="function"?g:g?.fromAttribute??In.fromAttribute)(l,d.type);this[t]!==Y&&(this[n]=Y)}i.call(this,o,s,l)}},Fe=h`
	/* stylelint-disable */
...
`;var Po=Object.defineProperty,Lo=Object.getOwnPropertyDescriptor,de=(t,e,n,a)=>{for(var i=a>1?void 0:a?Lo(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&Po(e,n,i),i};let ee=class extends w{constructor(){super(...arguments),this.formControlController=new Me(this,{value:t=>t.checked?t.value||"on":void 0,defaultValue:t=>t.defaultChecked,setValue:(t,e)=>t.checked=e}),this.hasSlotController=new Q(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.indeterminate=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleClick(){this.checked=!this.checked,this.indeterminate=!1,this.emit("syn-change")}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleInput(){this.emit("syn-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStateChange(){this.input.checked=this.checked,this.input.indeterminate=this.indeterminate,this.formControlController.updateValidity()}click(){this.input.click()}focus(t){this.input.focus(t)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("help-text"),e=this.helpText?!0:!!t;return p`
    ...
    `}};ee.styles=[x,Fe,Ao,Ve,Mo];ee.dependencies={"syn-icon":Te};de([u('input[type="checkbox"]')],ee.prototype,"input",2);de([b()],ee.prototype,"hasFocus",2);de([r()],ee.prototype,"title",2);de([r()],ee.prototype,"name",2);de([r()],ee.prototype,"value",2);de([r({reflect:!0})],ee.prototype,"size",2);de([r({type:Boolean,reflect:!0})],ee.prototype,"disabled",2);de([r({type:Boolean,reflect:!0})],ee.prototype,"checked",2);de([r({type:Boolean,reflect:!0})],ee.prototype,"indeterminate",2);de([rt("checked")],ee.prototype,"defaultChecked",2);de([r({reflect:!0})],ee.prototype,"form",2);de([r({type:Boolean,reflect:!0})],ee.prototype,"required",2);de([r({attribute:"help-text"})],ee.prototype,"helpText",2);de([m("disabled",{waitUntilFirstUpdate:!0})],ee.prototype,"handleDisabledChange",1);de([m(["checked","indeterminate"],{waitUntilFirstUpdate:!0})],ee.prototype,"handleStateChange",1);ee=de([se("SynCheckbox")],ee);ee.define("syn-checkbox");const jo=h`
	/* stylelint-disable */
  :host {
...
`;var Fo=Object.defineProperty,G=(t,e,n,a)=>{for(var i=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=s(e,n,i)||i);return i&&Fo(e,n,i),i};function Vo(t){return t!==null&&typeof t=="object"&&"getBoundingClientRect"in t&&("contextElement"in t?t.contextElement instanceof Element:!0)}class P extends w{constructor(){super(...arguments),this.localize=new R(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){const e=this.anchorEl.getBoundingClientRect(),n=this.popup.getBoundingClientRect(),a=this.placement.includes("top")||this.placement.includes("bottom");let i=0,o=0,s=0,l=0,d=0,c=0,g=0,T=0;a?e.top<n.top?(i=e.left,o=e.bottom,s=e.right,l=e.bottom,d=n.left,c=n.top,g=n.right,T=n.top):(i=n.left,o=n.bottom,s=n.right,l=n.bottom,d=e.left,c=e.top,g=e.right,T=e.top):e.left<n.left?(i=e.right,o=e.top,s=n.left,l=n.top,d=e.right,c=e.bottom,g=n.left,T=n.bottom):(i=n.right,o=n.top,s=e.left,l=e.top,d=n.right,c=n.bottom,g=e.left,T=e.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${i}px`),this.style.setProperty("--hover-bridge-top-left-y",`${o}px`),this.style.setProperty("--hover-bridge-top-right-x",`${s}px`),this.style.setProperty("--hover-bridge-top-right-y",`${l}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${d}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${c}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${g}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${T}px`)}}}static{this.styles=[x,jo]}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has("active")&&(this.active?this.start():this.stop()),e.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){const e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchor instanceof Element||Vo(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){!this.anchorEl||!this.active||(this.cleanup=Ji(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>e())):e()})}reposition(){if(!this.active||!this.anchorEl)return;const e=[Qi({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?e.push(Nn({apply:({rects:a})=>{const i=this.sync==="width"||this.sync==="both",o=this.sync==="height"||this.sync==="both";this.popup.style.width=i?`${a.reference.width}px`:"",this.popup.style.height=o?`${a.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&e.push(Zi({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&e.push(ea({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?e.push(Nn({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:a,availableHeight:i})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${i}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${a}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&e.push(ta({element:this.arrowEl,padding:this.arrowPadding}));const n=this.strategy==="absolute"?a=>an.getOffsetParent(a,na):an.getOffsetParent;ia(this.anchorEl,this.popup,{placement:this.placement,middleware:e,strategy:this.strategy,platform:{...an,getOffsetParent:n}}).then(({x:a,y:i,middlewareData:o,placement:s})=>{const l=this.localize.dir()==="rtl",d={top:"bottom",right:"left",bottom:"top",left:"right"}[s.split("-")[0]];if(this.setAttribute("data-current-placement",s),Object.assign(this.popup.style,{left:`${a}px`,top:`${i}px`}),this.arrow){const c=o.arrow.x,g=o.arrow.y;let T="",Y="",We="",De="";if(this.arrowPlacement==="start"){const je=typeof c=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";T=typeof g=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",Y=l?je:"",De=l?"":je}else if(this.arrowPlacement==="end"){const je=typeof c=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";Y=l?"":je,De=l?je:"",We=typeof g=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else this.arrowPlacement==="center"?(De=typeof c=="number"?"calc(50% - var(--arrow-size-diagonal))":"",T=typeof g=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(De=typeof c=="number"?`${c}px`:"",T=typeof g=="number"?`${g}px`:"");Object.assign(this.arrowEl.style,{top:T,right:Y,bottom:We,left:De,[d]:"calc(var(--arrow-size-diagonal) * -1)"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("syn-reposition")}render(){return p`
...
`;var os=Object.defineProperty,ss=Object.getOwnPropertyDescriptor,$e=(t,e,n,a)=>{for(var i=a>1?void 0:a?ss(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&os(e,n,i),i};let me=class extends w{constructor(){super(...arguments),this.localize=new R(this),this.open=!1,this.disabled=!1,this.contained=!1,this.size="medium"}firstUpdated(){this.body.style.height=this.open?"auto":"0",this.open&&(this.details.open=!0),this.detailsObserver=new MutationObserver(t=>{for(const e of t)e.type==="attributes"&&e.attributeName==="open"&&(this.details.open?this.show():this.hide())}),this.detailsObserver.observe(this.details,{attributes:!0})}disconnectedCallback(){super.disconnectedCallback(),this.detailsObserver?.disconnect()}handleSummaryClick(t){t.preventDefault(),this.disabled||(this.open?this.hide():this.show(),this.header.focus())}handleSummaryKeyDown(t){(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),this.open?this.hide():this.show()),(t.key==="ArrowUp"||t.key==="ArrowLeft")&&(t.preventDefault(),this.hide()),(t.key==="ArrowDown"||t.key==="ArrowRight")&&(t.preventDefault(),this.show())}async handleOpenChange(){if(this.open){if(this.details.open=!0,this.emit("syn-show",{cancelable:!0}).defaultPrevented){this.open=!1,this.details.open=!1;return}await Z(this.body);const{keyframes:e,options:n}=j(this,"details.show",{dir:this.localize.dir()});await W(this.body,jn(e,this.body.scrollHeight),n),this.body.style.height="auto",this.emit("syn-after-show")}else{if(this.emit("syn-hide",{cancelable:!0}).defaultPrevented){this.details.open=!0,this.open=!0;return}await Z(this.body);const{keyframes:e,options:n}=j(this,"details.hide",{dir:this.localize.dir()});await W(this.body,jn(e,this.body.scrollHeight),n),this.body.style.height="auto",this.details.open=!1,this.emit("syn-after-hide")}}async show(){if(!(this.open||this.disabled))return this.open=!0,J(this,"syn-after-show")}async hide(){if(!(!this.open||this.disabled))return this.open=!1,J(this,"syn-after-hide")}render(){return p`
    ...
    `}};me.styles=[x,is,as];me.dependencies={"syn-icon":Te};$e([u(".details")],me.prototype,"details",2);$e([u(".details__header")],me.prototype,"header",2);$e([u(".details__body")],me.prototype,"body",2);$e([u(".details__expand-icon-slot")],me.prototype,"expandIconSlot",2);$e([r({type:Boolean,reflect:!0})],me.prototype,"open",2);$e([r()],me.prototype,"summary",2);$e([r({type:Boolean,reflect:!0})],me.prototype,"disabled",2);$e([r({type:Boolean,reflect:!0})],me.prototype,"contained",2);$e([r({reflect:!0})],me.prototype,"size",2);$e([m("open",{waitUntilFirstUpdate:!0})],me.prototype,"handleOpenChange",1);me=$e([se("SynDetails")],me);S("details.show",{keyframes:[{height:"0",opacity:"0"},{height:"auto",opacity:"1"}],options:{duration:250,easing:"linear"}});S("details.hide",{keyframes:[{height:"auto",opacity:"1"},{height:"0",opacity:"0"}],options:{duration:250,easing:"linear"}});me.define("syn-details");function*kn(t=document.activeElement){t!=null&&(yield t,"shadowRoot"in t&&t.shadowRoot&&t.shadowRoot.mode!=="closed"&&(yield*kn(t.shadowRoot.activeElement)))}function zi(){return[...kn()].pop()}const Un=new WeakMap;function Ei(t){let e=Un.get(t);return e||(e=window.getComputedStyle(t,null),Un.set(t,e)),e}function rs(t){if(typeof t.checkVisibility=="function")return t.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});const e=Ei(t);return e.visibility!=="hidden"&&e.display!=="none"}function ls(t){const e=Ei(t),{overflowY:n,overflowX:a}=e;return n==="scroll"||a==="scroll"?!0:n!=="auto"||a!=="auto"?!1:t.scrollHeight>t.clientHeight&&n==="auto"||t.scrollWidth>t.clientWidth&&a==="auto"}function ds(t){const e=t.tagName.toLowerCase(),n=Number(t.getAttribute("tabindex"));if(t.hasAttribute("tabindex")&&(isNaN(n)||n<=-1)||t.hasAttribute("disabled")||t.closest("[inert]"))return!1;if(e==="input"&&t.getAttribute("type")==="radio"){const o=t.getRootNode(),s=`input[type='radio'][name="${t.getAttribute("name")}"]`,l=o.querySelector(`${s}:checked`);return l?l===t:o.querySelector(s)===t}return rs(t)?(e==="audio"||e==="video")&&t.hasAttribute("controls")||t.hasAttribute("tabindex")||t.hasAttribute("contenteditable")&&t.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(e)?!0:ls(t):!1}function cs(t){const e=cn(t),n=e[0]??null,a=e[e.length-1]??null;return{start:n,end:a}}function ps(t,e){return t.getRootNode({composed:!0})?.host!==e}function cn(t){const e=new WeakMap,n=[];function a(i){if(i instanceof Element){if(i.hasAttribute("inert")||i.closest("[inert]")||e.has(i))return;e.set(i,!0),!n.includes(i)&&ds(i)&&n.push(i),i instanceof HTMLSlotElement&&ps(i,t)&&i.assignedElements({flatten:!0}).forEach(o=>{a(o)}),i.shadowRoot!==null&&i.shadowRoot.mode==="open"&&a(i.shadowRoot)}for(const o of i.children)a(o)}return a(t),n.sort((i,o)=>{const s=Number(i.getAttribute("tabindex"))||0;return(Number(o.getAttribute("tabindex"))||0)-s})}let xt=[];class $i{constructor(e){this.tabDirection="forward",this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=n=>{if(n.key!=="Tab"||this.isExternalActivated||!this.isActive())return;const a=zi();if(this.previousFocus=a,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;n.shiftKey?this.tabDirection="backward":this.tabDirection="forward";const i=cn(this.element);let o=i.findIndex(l=>l===a);this.previousFocus=this.currentFocus;const s=this.tabDirection==="forward"?1:-1;for(;;){o+s>=i.length?o=0:o+s<0?o=i.length-1:o+=s,this.previousFocus=this.currentFocus;const l=i[o];if(this.tabDirection==="backward"&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||l&&this.possiblyHasTabbableChildren(l))return;n.preventDefault(),this.currentFocus=l,this.currentFocus?.focus({preventScroll:!1});const d=[...kn()];if(d.includes(this.currentFocus)||!d.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=e,this.elementsWithTabbableControls=["iframe"]}activate(){xt.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){xt=xt.filter(e=>e!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return xt[xt.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){const e=cn(this.element);if(!this.element.matches(":focus-within")){const n=e[0],a=e[e.length-1],i=this.tabDirection==="forward"?n:a;typeof i?.focus=="function"&&(this.currentFocus=i,i.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(e){return this.elementsWithTabbableControls.includes(e.tagName.toLowerCase())||e.hasAttribute("controls")}}const hs=h`
	/* stylelint-disable */
  :host {
    --width: 31rem;
...
`;var ms=Object.defineProperty,fs=Object.getOwnPropertyDescriptor,lt=(t,e,n,a)=>{for(var i=a>1?void 0:a?fs(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&ms(e,n,i),i};class Ge extends w{constructor(){super(...arguments),this.hasSlotController=new Q(this,"footer"),this.localize=new R(this),this.modal=new $i(this),this.open=!1,this.label="",this.noHeader=!1,this.handleDocumentKeyDown=e=>{e.key==="Escape"&&this.modal.isActive()&&this.open&&(e.stopPropagation(),this.requestClose("keyboard"))}}static{this.styles=[x,hs,us]}static{this.dependencies={"syn-icon-button":ut}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),_t(this))}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate(),pt(this),this.removeOpenListeners()}requestClose(e){if(this.emit("syn-request-close",{cancelable:!0,detail:{source:e}}).defaultPrevented){const a=j(this,"dialog.denyClose",{dir:this.localize.dir()});W(this.panel,a.keyframes,a.options);return}this.hide()}addOpenListeners(){"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard")):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){this.closeWatcher?.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit("syn-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),_t(this);const e=this.querySelector("[autofocus]");e&&e.removeAttribute("autofocus"),await Promise.all([Z(this.dialog),Z(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit("syn-initial-focus",{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute("autofocus","")});const n=j(this,"dialog.show",{dir:this.localize.dir()}),a=j(this,"dialog.overlay.show",{dir:this.localize.dir()});await Promise.all([W(this.panel,n.keyframes,n.options),W(this.overlay,a.keyframes,a.options)]),this.emit("syn-after-show")}else{Yt(this),this.emit("syn-hide"),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([Z(this.dialog),Z(this.overlay)]);const e=j(this,"dialog.hide",{dir:this.localize.dir()}),n=j(this,"dialog.overlay.hide",{dir:this.localize.dir()});await Promise.all([W(this.overlay,n.keyframes,n.options).then(()=>{this.overlay.hidden=!0}),W(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,pt(this);const a=this.originalTrigger;typeof a?.focus=="function"&&setTimeout(()=>a.focus()),this.emit("syn-after-hide")}}async show(){if(!this.open)return this.open=!0,J(this,"syn-after-show")}async hide(){if(this.open)return this.open=!1,J(this,"syn-after-hide")}render(){return p`
    ...
    `}}lt([u(".dialog")],Ge.prototype,"dialog",2);lt([u(".dialog__panel")],Ge.prototype,"panel",2);lt([u(".dialog__overlay")],Ge.prototype,"overlay",2);lt([r({type:Boolean,reflect:!0})],Ge.prototype,"open",2);lt([r({reflect:!0})],Ge.prototype,"label",2);lt([r({attribute:"no-header",type:Boolean,reflect:!0})],Ge.prototype,"noHeader",2);lt([m("open",{waitUntilFirstUpdate:!0})],Ge.prototype,"handleOpenChange",1);S("dialog.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});S("dialog.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});S("dialog.denyClose",{keyframes:[{scale:1},{scale:1.02},{scale:1}],options:{duration:250}});S("dialog.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});S("dialog.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});Ge.define("syn-dialog");const ys=h`
	/* stylelint-disable */
  :host {
...
`;var gs=Object.defineProperty,vs=Object.getOwnPropertyDescriptor,Oi=(t,e,n,a)=>{for(var i=a>1?void 0:a?vs(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&gs(e,n,i),i};class Ye extends w{constructor(){super(...arguments),this.vertical=!1}static{this.styles=[x,ys,bs]}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}}Oi([r({type:Boolean,reflect:!0})],Ye.prototype,"vertical",2);Oi([m("vertical")],Ye.prototype,"handleVerticalChange",1);Ye.define("syn-divider");function Wn(t){return t.charAt(0).toUpperCase()+t.slice(1)}const ws=h`
	/* stylelint-disable */
  :host {
    --size: 25rem;
    --header-spacing: var(--syn-spacing-large);
...
`;var Ls=Object.defineProperty,js=Object.getOwnPropertyDescriptor,E=(t,e,n,a)=>{for(var i=a>1?void 0:a?js(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&Ls(e,n,i),i};let _=class extends w{constructor(){super(...arguments),this.formControlController=new Me(this,{assumeInteractionOn:["syn-blur","syn-input"]}),this.hasSlotController=new Q(this,"help-text","label","prefix","suffix"),this.localize=new R(this),this.hasFocus=!1,this.title="",this.__numberInput=Object.assign(document.createElement("input"),{type:"number"}),this.__dateInput=Object.assign(document.createElement("input"),{type:"date"}),this.type="text",this.name="",this.value="",this.defaultValue="",this.size="medium",this.label="",this.helpText="",this.clearable=!1,this.disabled=!1,this.placeholder="",this.readonly=!1,this.passwordToggle=!1,this.passwordVisible=!1,this.noSpinButtons=!1,this.form="",this.required=!1,this.spellcheck=!0}get valueAsDate(){return this.__dateInput.type=this.type,this.__dateInput.value=this.value,this.input?.valueAsDate||this.__dateInput.valueAsDate}set valueAsDate(t){this.__dateInput.type=this.type,this.__dateInput.valueAsDate=t,this.value=this.__dateInput.value}get valueAsNumber(){return this.__numberInput.value=this.value,this.input?.valueAsNumber||this.__numberInput.valueAsNumber}set valueAsNumber(t){this.__numberInput.valueAsNumber=t,this.value=this.__numberInput.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("syn-blur")}handleStep(){this.handleInput(),this.input.focus()}handleStepUp(){this.stepUp(),this.handleStep()}handleStepDown(){this.stepDown(),this.handleStep()}isDecrementDisabled(){if(this.disabled||this.readonly)return!0;if(this.min===void 0||this.min===null||this.disabled)return!1;const t=typeof this.min=="string"?parseFloat(this.min):this.min;return this.valueAsNumber<=t}isIncrementDisabled(){if(this.disabled||this.readonly)return!0;if(this.max===void 0||this.max===null)return!1;const t=typeof this.max=="string"?parseFloat(this.max):this.max;return this.valueAsNumber>=t}handleChange(){this.value=this.input.value,this.emit("syn-change")}handleClearClick(t){t.preventDefault(),this.value!==""&&(this.value="",this.emit("syn-clear"),this.emit("syn-input"),this.emit("syn-change")),this.input.focus()}handleFocus(){this.hasFocus=!0,this.emit("syn-focus")}handleInput(){this.value=this.input.value,this.formControlController.updateValidity(),this.emit("syn-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}handleKeyDown(t){const e=t.metaKey||t.ctrlKey||t.shiftKey||t.altKey;t.key==="Enter"&&!e&&setTimeout(()=>{!t.defaultPrevented&&!t.isComposing&&this.formControlController.submit()})}handlePasswordToggle(){this.passwordVisible=!this.passwordVisible}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStepChange(){this.input.step=String(this.step),this.formControlController.updateValidity()}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(t){this.input.focus(t)}blur(){this.input.blur()}select(){this.input.select()}setSelectionRange(t,e,n="none"){this.input.setSelectionRange(t,e,n)}setRangeText(t,e,n,a="preserve"){const i=e??this.input.selectionStart,o=n??this.input.selectionEnd;this.input.setRangeText(t,i,o,a),this.value!==this.input.value&&(this.value=this.input.value)}showPicker(){"showPicker"in HTMLInputElement.prototype&&this.input.showPicker()}stepUp(){this.input.stepUp(),this.value!==this.input.value&&(this.value=this.input.value)}stepDown(){this.input.stepDown(),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("label"),e=this.hasSlotController.test("help-text"),n=this.hasSlotController.test("prefix"),a=this.hasSlotController.test("suffix"),i=this.label?!0:!!t,o=this.helpText?!0:!!e,l=this.clearable&&!this.disabled&&!this.readonly&&(typeof this.value=="number"||this.value.length>0);return p`
    ...
    `:p` <slot name="submenu" hidden></slot> `}}const Vs=h`
	/* stylelint-disable */
  :host {
    --submenu-offset: -2px;
...
`;function Hs(t,e){const n={waitUntilFirstUpdated:!1,...e};return a=>class extends a{#e=!n.waitUntilFirstUpdated;updated(i){if(!this.#e){this.#e=!0;return}const o=Array.from(i).filter(([l])=>t.includes(l));if(o.length===0){super.updated(i);return}const s=o.map(([l,d])=>({attribute:l,newValue:this[l],oldValue:d}));this.emit("syn-attributes-changed",{detail:s}),super.updated(i)}}}var Rs=Object.defineProperty,Us=Object.getOwnPropertyDescriptor,Oe=(t,e,n,a)=>{for(var i=a>1?void 0:a?Us(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&Rs(e,n,i),i};let fe=class extends w{constructor(){super(...arguments),this.localize=new R(this),this.type="normal",this.checked=!1,this.value="",this.loading=!1,this.disabled=!1,this.hasSlotController=new Q(this,"submenu"),this.submenuController=new Fs(this,this.hasSlotController),this.handleHostClick=t=>{this.disabled&&(t.preventDefault(),t.stopImmediatePropagation())},this.handleMouseOver=t=>{this.focus(),t.stopPropagation()}}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this.handleHostClick),this.addEventListener("mouseover",this.handleMouseOver)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.handleHostClick),this.removeEventListener("mouseover",this.handleMouseOver)}handleDefaultSlotChange(){const t=this.getTextLabel();if(typeof this.cachedTextLabel>"u"){this.cachedTextLabel=t;return}t!==this.cachedTextLabel&&(this.cachedTextLabel=t,this.emit("slotchange",{bubbles:!0,composed:!1,cancelable:!1}))}handleCheckedChange(){if(this.checked&&this.type!=="checkbox"){this.checked=!1,console.error('The checked attribute can only be used on menu items with type="checkbox"',this);return}this.type==="checkbox"?this.setAttribute("aria-checked",this.checked?"true":"false"):this.removeAttribute("aria-checked")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleTypeChange(){this.type==="checkbox"?(this.setAttribute("role","menuitemcheckbox"),this.setAttribute("aria-checked",this.checked?"true":"false")):(this.setAttribute("role","menuitem"),this.removeAttribute("aria-checked"))}getTextLabel(){return wi(this.defaultSlot)}isSubmenu(){return this.hasSlotController.test("submenu")}render(){const t=this.localize.dir()==="rtl",e=this.submenuController.isExpanded();return p`
      <div
        id="anchor"
        part="base"
...
`;class Ks extends w{static{this.styles=[x,Ws,qs]}static{this.dependencies={"syn-divider":Ye}}render(){return p`
    ...
    `}}Ks.define("syn-menu-label");const Gs=h`
	/* stylelint-disable */
  :host {
    display: block;
    position: relative;
...
`;var Xs=Object.defineProperty,Di=(t,e,n,a)=>{for(var i=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=s(e,n,i)||i);return i&&Xs(e,n,i),i};class Qt extends w{constructor(){super(...arguments),this.hasMenuItemsWithCheckmarks=!1,this.updateCheckMarksByChildPropChange=e=>{e.stopImmediatePropagation(),this.handleUpdateCheckmarks(this.getAllItems())}}static{this.styles=[x,Gs,Ys]}handleUpdateCheckmarks(e){this.hasMenuItemsWithCheckmarks=e.some(n=>n.type==="checkbox"||n.loading)}disconnectedCallback(){this.removeEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu"),this.addEventListener("syn-attributes-changed",this.updateCheckMarksByChildPropChange)}handleClick(e){const n=["menuitem","menuitemcheckbox"],a=e.composedPath(),i=a.find(d=>n.includes(d?.getAttribute?.("role")||""));if(!i||a.find(d=>d?.getAttribute?.("role")==="menu")!==this)return;const l=i;l.type==="checkbox"&&(l.checked=!l.checked),this.emit("syn-select",{detail:{item:l}})}handleKeyDown(e){if(e.key==="Enter"||e.key===" "){const n=this.getCurrentItem();e.preventDefault(),e.stopPropagation(),n?.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(e.key)){const n=this.getAllItems(),a=this.getCurrentItem();let i=a?n.indexOf(a):0;n.length>0&&(e.preventDefault(),e.stopPropagation(),e.key==="ArrowDown"?i++:e.key==="ArrowUp"?i--:e.key==="Home"?i=0:e.key==="End"&&(i=n.length-1),i<0&&(i=n.length-1),i>n.length-1&&(i=0),this.setCurrentItem(n[i]),n[i].focus())}}handleMouseDown(e){const n=e.target;this.isMenuItem(n)&&this.setCurrentItem(n)}handleSlotChange(){const e=this.getAllItems();this.handleUpdateCheckmarks(e),e.length>0&&this.setCurrentItem(e[0])}isMenuItem(e){return e.tagName.toLowerCase()==="syn-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes(e.getAttribute("role")??"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>!(e.inert||!this.isMenuItem(e)))}getCurrentItem(){return this.getAllItems().find(e=>e.getAttribute("tabindex")==="0")}setCurrentItem(e){this.getAllItems().forEach(a=>{a.setAttribute("tabindex",a===e?"0":"-1")})}render(){return p`
      ...
      ></slot>
    `}}Di([u("slot")],Qt.prototype,"defaultSlot");Di([b()],Qt.prototype,"hasMenuItemsWithCheckmarks");Qt.define("syn-menu");const Js=h`
  /**
...
`;var tr=Object.defineProperty,nr=Object.getOwnPropertyDescriptor,Zt=(t,e,n,a)=>{for(var i=a>1?void 0:a?nr(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&tr(e,n,i),i};class At extends w{constructor(){super(...arguments),this.hasSlotController=new Q(this,"[default]","prefix","suffix","label"),this.disabled=!1,this.label=""}static{this.styles=er}static{this.dependencies={"syn-divider":Ye}}handleDisableOptions(){const{disabled:e}=this;this.defaultSlot.assignedElements().filter(n=>n.tagName.toLowerCase()==="syn-option").forEach(n=>{n.disabled=e})}handleDisabledChange(){this.handleDisableOptions()}render(){const{disabled:e}=this,n=this.hasSlotController.test("label"),a=this.label?!0:!!n;return C`
      <div
    ...
    `}}Zt([u("slot:not([name])")],At.prototype,"defaultSlot",2);Zt([r({reflect:!0,type:Boolean})],At.prototype,"disabled",2);Zt([r()],At.prototype,"label",2);Zt([m("disabled",{waitUntilFirstUpdate:!0})],At.prototype,"handleDisabledChange",1);At.define("syn-optgroup");Ee.define("syn-option");P.define("syn-popup");const ir=h`
  :host {
    display: block;
...
`,Kn=t=>Array.from(t.assignedElements({flatten:!0})),ar=t=>t.tagName.toLocaleLowerCase()==="syn-nav-item"||(t.getAttribute("role")??"")==="menuitem",Gn=t=>t.filter(ar),or=t=>{t.setAttribute("horizontal","true"),t.removeAttribute("slot"),t.removeAttribute("tabindex"),t.dataset.originalRole?t.setAttribute("role",t.dataset.originalRole):t.removeAttribute("role")},sr=t=>{t.removeAttribute("horizontal"),t.setAttribute("slot","menu"),t.setAttribute("role","menuitem")};var rr=Object.defineProperty,Xe=(t,e,n,a)=>{for(var i=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=s(e,n,i)||i);return i&&rr(e,n,i),i};class He extends w{constructor(){super(...arguments),this.localize=new R(this),this.itemPositionsCached=!1,this.amountOfNavItems=0,this.amountOfVisibleItems=0,this.hasItemsInDropdown=!1}static{this.styles=[x,ir]}static{this.dependencies={"syn-dropdown":ye,"syn-icon":Te,"syn-menu":Qt,"syn-nav-item":re}}getSlottedNavItems(){const e=Gn(Kn(this.defaultSlot)),n=Gn(Kn(this.menuSlot));return e.concat(n)}cacheItemPositions(e){const{left:n}=this.horizontalNav.getBoundingClientRect();e.forEach(a=>{a.removeAttribute("slot");const{right:i}=a.getBoundingClientRect();a.dataset.right=(i-n).toString()}),this.itemPositionsCached=!0}handlePriorityMenu(){const e=this.getSlottedNavItems();this.itemPositionsCached||this.cacheItemPositions(e);const{width:n}=this.horizontalNav.getBoundingClientRect(),a=this.priorityMenu.classList.contains("priority-menu--hidden")?0:this.priorityMenu.clientWidth,i=n-a;let o;const s=e.at(-1),l=e.map(g=>{const T=g===s?n:i,Y=!!(o||parseFloat(g.dataset.right)>T);return Y&&!o&&(o=parseFloat(g.dataset.right)),{isHidden:Y,item:g}}),d=l.filter(({isHidden:g})=>!g).length,c=d===1;l.forEach(({item:g,isHidden:T})=>{T||c?sr(g):or(g)}),this.hasItemsInDropdown=d!==e.length,this.amountOfVisibleItems=c?0:d}renderPriorityMenu(){return C`
      <syn-dropdown
...
`;var cr=Object.defineProperty,_n=(t,e,n,a)=>{for(var i=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=s(e,n,i)||i);return i&&cr(e,n,i),i};class en extends w{constructor(){super(...arguments),this.localize=new R(this),this.value=0,this.indeterminate=!1,this.label=""}static{this.styles=[x,lr,dr]}render(){return p`
      <div
        part="base"
      ...
      >
        <div part="indicator" class="progress-bar__indicator" style=${sa({width:`${this.value}%`})}>
          ${this.indeterminate?"":p` <slot part="label" class="progress-bar__label"></slot> `}
        </div>
      </div>
    `}}_n([r({type:Number,reflect:!0})],en.prototype,"value");_n([r({type:Boolean,reflect:!0})],en.prototype,"indeterminate");_n([r()],en.prototype,"label");en.define("syn-progress-bar");const pr=h`
	/* stylelint-disable */
  :host {
    --size: 128px;
    --track-width: 4px;
...
`;var ur=Object.defineProperty,tn=(t,e,n,a)=>{for(var i=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=s(e,n,i)||i);return i&&ur(e,n,i),i};class Mt extends w{constructor(){super(...arguments),this.localize=new R(this),this.value=0,this.label=""}static{this.styles=[x,pr,hr]}updated(e){if(super.updated(e),e.has("value")){const n=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),a=2*Math.PI*n,i=a-this.value/100*a;this.indicatorOffset=`${i}px`}}render(){return p`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
    ...
    `}}tn([u(".progress-ring__indicator")],Mt.prototype,"indicator");tn([b()],Mt.prototype,"indicatorOffset");tn([r({type:Number,reflect:!0})],Mt.prototype,"value");tn([r()],Mt.prototype,"label");Mt.define("syn-progress-ring");const mr=h`
	/* stylelint-disable */
  ${Ti}
...
`;var Sr=Object.defineProperty,zr=(t,e,n,a)=>{for(var i=void 0,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=s(e,n,i)||i);return i&&Sr(e,n,i),i};class Ii extends w{constructor(){super(...arguments),this.subdivision=!1}static{this.styles=[x,Cr]}render(){return p`
      <div
    ...
    `}}zr([r({reflect:!0,type:Boolean})],Ii.prototype,"subdivision");Ii.define("syn-range-tick");const Er=h`
	/* stylelint-disable */
  :host {
    --max-width: 20rem;
    --hide-delay: 0ms;
...
`;var Lr=Object.defineProperty,jr=Object.getOwnPropertyDescriptor,zn=(t,e,n,a)=>{for(var i=a>1?void 0:a?jr(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&Lr(e,n,i),i};let Ke=class extends w{constructor(){super(...arguments),this.localize=new R(this),this.size="medium",this.removable=!1}handleRemoveClick(){this.emit("syn-remove")}render(){return p`
      <span
        part="base"
    ...
    `}};Ke.styles=[x,Mr,Pr];Ke.dependencies={"syn-icon-button":ut};zn([r({reflect:!0})],Ke.prototype,"size",2);zn([r({type:Boolean})],Ke.prototype,"removable",2);Ke=zn([se("SynTag")],Ke);const Fr=h`
	/* stylelint-disable */
  :host {
    display: block;
  }
...
`;var Qr=Object.defineProperty,Zr=Object.getOwnPropertyDescriptor,Ri=(t,e,n,a)=>{for(var i=a>1?void 0:a?Zr(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&Qr(e,n,i),i};class En extends w{constructor(){super(...arguments),this.observedElements=[],this.disabled=!1}static{this.styles=[x,Jr]}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{this.emit("syn-resize",{detail:{entries:e}})}),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}handleSlotChange(){this.disabled||this.startObserver()}startObserver(){const e=this.shadowRoot.querySelector("slot");if(e!==null){const n=e.assignedElements({flatten:!0});this.observedElements.forEach(a=>this.resizeObserver.unobserve(a)),this.observedElements=[],n.forEach(a=>{this.resizeObserver.observe(a),this.observedElements.push(a)})}}stopObserver(){this.resizeObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}render(){return p` <slot @slotchange=${this.handleSlotChange}></slot> `}}Ri([r({type:Boolean,reflect:!0})],En.prototype,"disabled",2);Ri([m("disabled",{waitUntilFirstUpdate:!0})],En.prototype,"handleDisabledChange",1);const el=h`
	/* stylelint-disable */
  :host {
    --indicator-color: var(--syn-color-primary-600);
    --track-color: var(--syn-color-neutral-200);
...
`;var sl=Object.defineProperty,rl=Object.getOwnPropertyDescriptor,$n=(t,e,n,a)=>{for(var i=a>1?void 0:a?rl(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&sl(e,n,i),i};let ll=0;class nn extends w{constructor(){super(...arguments),this.attrId=++ll,this.componentId=`syn-tab-panel-${this.attrId}`,this.name="",this.active=!1}static{this.styles=[x,al,ol]}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return p`
      <slot
        part="base"
        class=${f({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}}$n([r({reflect:!0})],nn.prototype,"name",2);$n([r({type:Boolean,reflect:!0})],nn.prototype,"active",2);$n([m("active")],nn.prototype,"handleActiveChange",1);nn.define("syn-tab-panel");const dl=h`
	/* stylelint-disable */
  :host {
    display: inline-block;
  }
...
`;var xl=Object.defineProperty,kl=Object.getOwnPropertyDescriptor,xe=(t,e,n,a)=>{for(var i=a>1?void 0:a?kl(e,n):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(a?s(e,n,i):s(i))||i);return a&&i&&xl(e,n,i),i};let oe=class extends w{constructor(){super(...arguments),this.controller=new AbortController,this.validationMessage="",this.eagerFirstMount=!0,this.isInternalTriggeredInvalid=!1,this.isValid=!0,this.variant="native",this.hideIcon=!1,this.on="",this.customValidationMessage="",this.eager=!1,this.internalRevalidate=t=>{t.currentTarget.validity?.valid&&(this.validationMessage="")},this.validate=t=>{if(rn(t.type)&&this.variant==="native"&&this.isInternalTriggeredInvalid===!0){this.isInternalTriggeredInvalid=!1;return}rn(t.type)&&this.variant!=="native"&&(t.preventDefault(),t.stopPropagation());const e=t.currentTarget;if(this.isValid=e.validity?.valid,this.eager&&this.eagerFirstMount){this.eagerFirstMount=!1,this.setValidationMessage(e);return}!this.isValid&&!Xn(t.type)&&this.handleFocus(e),this.setValidationMessage(e),!Xn(t.type)&&this.variant==="native"&&this.updateComplete.then(()=>{this.isInternalTriggeredInvalid=!0,e.reportValidity()})}}handleListenerChange(){this.updateEvents()}async handleEagerChange(){if(this.eager){const t=this.getInput();await this.updateComplete,t?.reportValidity(),this.eagerFirstMount=!0}else this.eagerFirstMount=!1}handleCustomValidationMessageChange(){const t=this.getInput();t&&(this.setCustomValidationMessage(t),this.setValidationMessage(t))}getValidity(){return this.isValid}getInput(){const t=this.slottedChildren[0];return t||void 0}getUsedEventNames(){const t=this.getInput();if(!t)return[];const e=vl(this.on),[...n]=e.filter(Boolean);return n.includes("invalid")||n.push("invalid"),n.includes("live")&&(n.push("input"),n.push("blur")),Array.from(new Set(n.filter(a=>a!=="live").map(a=>Jn(t,a))))}updateEvents(){this.controller.abort(),this.controller=new AbortController;const t=this.getInput();if(!t)return;const e=this.getUsedEventNames();e.forEach(a=>{t.addEventListener(a,this.validate,{capture:rn(a),signal:this.controller.signal})});const n=Jn(t,"change");e.includes(n)||t.addEventListener(n,this.internalRevalidate,{signal:this.controller.signal})}setValidationMessage(t){const{customValidationMessage:e}=this,n=e||t.validationMessage;this.validationMessage=n}setCustomValidationMessage(t){t.setCustomValidity(this.customValidationMessage)}handleFocus(t){const e=document.activeElement,n=e.closest("syn-validate");!e.validity?.valid&&n||(t.scrollIntoView({block:"nearest"}),t.focus())}async firstUpdated(t){super.firstUpdated(t),this.updateEvents();const e=this.getInput();this.customValidationMessage&&(e instanceof w&&await e.updateComplete,e?.setCustomValidity(this.customValidationMessage)),this.eager&&(await this.updateComplete,this.isValid=e?.validity?.valid??!1,e?.reportValidity())}connectedCallback(){super.connectedCallback(),this.observer=new MutationObserver(t=>{const e=this.getInput();if(!e)return;t.filter(({target:a})=>a===e).every(a=>{const i=a.target;return i.hasAttribute("disabled")||i.hasAttribute("readonly")})?(this.isValid=!0,this.validationMessage=""):(e instanceof w?e.updateComplete:Promise.resolve()).then(()=>{this.isValid=e?.validity?.valid??!1,this.validationMessage=e?.validationMessage??""})}),this.observer.observe(this,{attributeFilter:["disabled","readonly"],attributes:!0,subtree:!0})}disconnectedCallback(){super.disconnectedCallback(),this.controller.abort(),this?.observer?.disconnect()}renderInlineValidation(){return this.variant!=="inline"||!this.validationMessage?"":p`
    ...
    `}};oe.styles=[x,wl];oe.dependencies={"syn-alert":X};xe([ti()],oe.prototype,"slottedChildren",2);xe([b()],oe.prototype,"validationMessage",2);xe([b()],oe.prototype,"eagerFirstMount",2);xe([b()],oe.prototype,"isInternalTriggeredInvalid",2);xe([b()],oe.prototype,"isValid",2);xe([r({reflect:!0})],oe.prototype,"variant",2);xe([r({attribute:"hide-icon",reflect:!0,type:Boolean})],oe.prototype,"hideIcon",2);xe([r({reflect:!0})],oe.prototype,"on",2);xe([r({attribute:"custom-validation-message",type:String})],oe.prototype,"customValidationMessage",2);xe([r({type:Boolean})],oe.prototype,"eager",2);xe([m("on",{waitUntilFirstUpdate:!0})],oe.prototype,"handleListenerChange",1);xe([m("eager",{waitUntilFirstUpdate:!1})],oe.prototype,"handleEagerChange",1);xe([m("customValidationMessage",{waitUntilFirstUpdate:!0})],oe.prototype,"handleCustomValidationMessageChange",1);oe=xe([se("SynValidate")],oe);oe.define("syn-validate");function _l(t){const e=typeof window<"u"&&window;return!!(e&&(/Chromatic/.test(e.navigator.userAgent)||/chromatic=true/.test(e.location.href)))}const Tl=(t,...e)=>_l()?p`
      ...
      ${t(...e)}
    `:t(...e),Gt="🌞 light",pn="🌙 dark",Cl=t=>`https://www.figma.com/file/bZFqk9urD3NlghGUKrkKCR/Synergy-Digital-Design-System?type=design&node-id=${t}`,Sl=(t,e="Go to Figma page")=>({label:e,type:"link",url:Cl(t)});function zl(t,e){const n=document.querySelectorAll(`#anchor--${e.id}`),i=JSON.parse('{"@synergy-design-system/components":"2.26.1","@synergy-design-system/assets":"1.13.1","@synergy-design-system/styles":"1.7.0","@synergy-design-system/tokens":"2.18.0"}');return n.forEach(o=>{const s=o.querySelector(".docblock-code-toggle");if(s){const l=s.cloneNode(!0);l.textContent="Edit on CodePen",l.classList.add("docblock-codepen-button");const d=o.querySelector(".sb-bar");d?o.querySelectorAll(".docblock-codepen-button:not(:last-of-type)").forEach(c=>{c.remove()}):o.querySelectorAll(".docblock-codepen-button").forEach(c=>{c.remove()}),s.parentElement.appendChild(l),d&&(o.querySelectorAll(".docblock-codepen-button:not(:last-of-type)").forEach(c=>{c.style.display="block",c.style.borderRight="none"}),o.querySelector(".docblock-codepen-button:last-of-type").style.display="none"),l.addEventListener("click",()=>{const c=document.createElement("form");c.action="https://codepen.io/pen/define",c.method="POST",c.target="_blank";const g={css:`/* Import theme */
...
`):a=e.innerHTML,a=a.replace(/<style><\/style>/g,"").replace(/<!-- preview-ignore:start -->[\s\S]*?<!-- preview-ignore:end -->/g,"").replace(/\/\/ preview-ignore:start[\s\S]*?\/\/ preview-ignore:end/g,"").replace(/<style>\n<\/style>/g,"").replace(/<script>\s*component = document\.querySelector\('(.+?)'\);\s*<\/script>/g,""),a}},Jl=(t,e,n="components")=>{const a=ca[n][t]??{},i=a[e]?.description?.value??"No Description",o=a[e]?.note?.value??"",s=c=>c.replace(/\n/g,"<br/>"),l=s(i),d=o?`<br/><br/><strong>👨‍💻 Additional developer Information:</strong><br>${s(o)}`:"";return`${l}${d}`},Ql=(t,e=150)=>{const n=isNaN(e)?e:{heightPx:e},{afterRender:a="",additionalChromaticOptions:i={},heightPx:o=150,styleHeading:s={}}=n,l=Object.entries(s).map(([d,c])=>`${d}: ${c};`).join(" ");return{parameters:{chromatic:{...Wi?.parameters?.chromatic,...i,disableSnapshot:!1},docs:{disable:!0}},render:(d,c)=>C`
      ...
      `})}
      ${a}
    `}};export{Sl as a,ct as b,Xl as c,Ql as d,Yl as e,Jl as g,Gl as h,_l as i,Wi as p,hn as s};
