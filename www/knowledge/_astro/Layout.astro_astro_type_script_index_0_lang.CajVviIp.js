...
`,{I:Gt}=Qe,Kt=(e,t)=>t===void 0?e?._$litType$!==void 0:e?._$litType$===t,qt=e=>e.strings===void 0,Jt={},Yt=(e,t=Jt)=>e._$AH=t,Xt=Symbol(),Zt=Symbol(),Qt,$t=new Map,A=class extends O{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label=``,this.library=`default`}async resolveIcon(e,t){let n;if(t?.spriteSheet)return this.svg=g`<svg part="svg">
        <use part="use" href="${e}" width="100%" height="100%"></use>
      </svg>`,this.svg;if(this.library===`system`){if(!e)return Xt;n=new Response(e,{status:200})}else try{if(n=await fetch(e,{mode:`cors`}),!n.ok)return n.status===410?Xt:Zt}catch{return Zt}try{let e=document.createElement(`div`);e.innerHTML=await n.text();let t=e.firstElementChild;if(t?.tagName?.toLowerCase()!==`svg`)return Xt;Qt||=new DOMParser;let r=Qt.parseFromString(t.outerHTML,`text/html`).body.querySelector(`svg`);return r?(r.part.add(`svg`),document.adoptNode(r)):Xt}catch{return Xt}}connectedCallback(){super.connectedCallback(),zt(this)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),Bt(this)}getIconSource(){let e=Vt(this.library);return this.name&&e?{url:e.resolver(this.name),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){typeof this.label==`string`&&this.label.length>0?(this.setAttribute(`role`,`img`),this.setAttribute(`aria-label`,this.label),this.removeAttribute(`aria-hidden`)):(this.removeAttribute(`role`),this.removeAttribute(`aria-label`),this.setAttribute(`aria-hidden`,`true`))}async setIcon(){let{url:e,fromLibrary:t}=this.getIconSource(),n=t?Vt(this.library):void 0;if(!e){this.svg=null;return}let r=$t.get(e);if(r||(r=this.resolveIcon(e,n),$t.set(e,r)),!this.initialRender)return;let i=await r;if(i===Zt&&$t.delete(e),e===this.getIconSource().url){if(Kt(i)){if(this.svg=i,n){await this.updateComplete;let e=this.shadowRoot.querySelector(`[part='svg']`);typeof n.mutator==`function`&&e&&n.mutator(e)}return}switch(i){case Zt:case Xt:this.svg=null,this.emit(`syn-error`);break;default:this.svg=i.cloneNode(!0),n?.mutator?.(this.svg),this.emit(`syn-load`)}}}render(){return this.svg}};A.styles=[w,Wt],v([E()],A.prototype,`svg`,2),v([T({reflect:!0})],A.prototype,`name`,2),v([T()],A.prototype,`src`,2),v([T()],A.prototype,`label`,2),v([T({reflect:!0})],A.prototype,`library`,2),v([C(`label`)],A.prototype,`handleLabelChange`,1),v([C([`name`,`src`,`library`])],A.prototype,`setIcon`,1);var en=new Set,tn=new Map,nn,rn=`ltr`,an=`en`,on=typeof MutationObserver<`u`&&typeof document<`u`&&document.documentElement!==void 0;function sn(){on&&(rn=document.documentElement.dir||`ltr`,an=document.documentElement.lang||navigator.language),[...en.keys()].forEach(e=>{typeof e.requestUpdate==`function`&&e.requestUpdate()})}if(on){let e=new MutationObserver(sn);rn=document.documentElement.dir||`ltr`,an=document.documentElement.lang||navigator.language,e.observe(document.documentElement,{attributeFilter:[`dir`,`lang`],attributes:!0})}function cn(...e){e.forEach(e=>{let t=e.$code.toLowerCase();tn.has(t)?tn.set(t,{...tn.get(t),...e}):tn.set(t,e),nn||=e}),sn()}var ln=class{constructor(e){this.host=e,this.host.addController(this)}hostConnected(){en.add(this.host)}hostDisconnected(){en.delete(this.host)}dir(){return`${this.host.dir||rn}`.toLowerCase()}lang(){return`${this.host.lang||an}`.toLowerCase()}getTranslationData(e){let t=new Intl.Locale(e.replace(/_/g,`-`)),n=t?.language.toLowerCase(),r=t?.region?.toLowerCase()??``;return{language:n,locale:t,primary:tn.get(`${n}-${r}`),region:r,secondary:tn.get(n)}}exists(e,t){let{primary:n,secondary:r}=this.getTranslationData(t.lang??this.lang()),i={ignoreFallback:!1,...t};return!!(n&&n[e]||r&&r[e]||i.includeFallback&&nn&&nn[e])}term(e,...t){let{primary:n,secondary:r}=this.getTranslationData(this.lang()),i;if(n&&n[e])i=n[e];else if(r&&r[e])i=r[e];else if(nn&&nn[e])i=nn[e];else return console.error(`No translation found for: ${String(e)}`),String(e);return typeof i==`function`?i(...t):i}date(e,t){let n=new Date(e);return new Intl.DateTimeFormat(this.lang(),t).format(n)}number(e,t){let n=Number(e);return isNaN(n)?``:new Intl.NumberFormat(this.lang(),t).format(n)}relativeTime(e,t,n){return new Intl.RelativeTimeFormat(this.lang(),n).format(e,t)}},un={$code:`en`,$name:`English`,$dir:`ltr`,clearEntry:`Clear entry`,close:`Close`,hidePassword:`Hide password`,loading:`Loading`,numOptionsSelected:e=>e===0?`No options selected`:e===1?`1 option selected`:`${e} options selected`,progress:`Progress`,remove:`Remove`,scrollToEnd:`Scroll to end`,scrollToStart:`Scroll to start`,showPassword:`Show password`,closeMenu:`Close menu`,critical:`Critical`,danger:`Danger`,error:`Error`,fileButtonText:`Select file`,fileButtonTextMultiple:`Select files`,fileDragDrop:`Drop or select file`,folderButtonText:`Select folder`,folderDragDrop:`Drop or select folder`,menu:`Menu`,noResults:`No results found`,notification:`Notification`,numFilesSelected:(e,t)=>e===0?`No ${t?`folders`:`files`} chosen`:`${e} ${t?`folders`:`files`} chosen`,openMenu:`Open menu`,paginationFirstPage:`First page`,paginationInputLabel:`Select page`,paginationItemsPerPage:`Items per page`,paginationItemSummary:(e,t,n)=>`${e}-${t} of ${n} items`,paginationLastPage:`Last page`,paginationNextPage:`Next page`,paginationOfTotalPages:e=>`of ${e}`,paginationPreviousPage:`Previous page`,rangeMax:`Maximum`,rangeMin:`Minimum`,sideNav:`Page navigation`,sideNavHide:`Hide navigation`,sideNavShow:`Show navigation`,success:`Success`,warning:`Warning`};cn(un);var dn=un,j=class extends ln{};cn(dn);var fn=class extends O{constructor(){super(...arguments),this.localize=new j(this),this.separatorDir=this.localize.dir(),this.label=``}getSeparator(){let e=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[e,...e.querySelectorAll(`[id]`)].forEach(e=>e.removeAttribute(`id`)),e.setAttribute(`data-default`,``),e.slot=`separator`,e}handleSlotChange(){let e=[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>e.tagName.toLowerCase()===`syn-breadcrumb-item`);e.forEach((t,n)=>{let r=t.querySelector(`[slot="separator"]`);r===null?t.append(this.getSeparator()):r.hasAttribute(`data-default`)&&r.replaceWith(this.getSeparator()),n===e.length-1?t.setAttribute(`aria-current`,`page`):t.removeAttribute(`aria-current`)})}render(){return this.separatorDir!==this.localize.dir()&&(this.separatorDir=this.localize.dir(),this.updateComplete.then(()=>this.handleSlotChange())),g`
    ...
    `}};fn.styles=[w,jt],fn.dependencies={"syn-icon":A},v([D(`slot`)],fn.prototype,`defaultSlot`,2),v([D(`slot[name="separator"]`)],fn.prototype,`separatorSlot`,2),v([T()],fn.prototype,`label`,2),fn.define(`syn-breadcrumb`);var pn=h`
  :host {
    display: inline-flex;
  }
...
`,mn=class extends O{constructor(){super(...arguments),this.localize=new j(this),this.variant=`primary`}render(){return g`
      <span
        part="base"
    ...
    `}};mn.styles=[w,pn],v([T({reflect:!0})],mn.prototype,`variant`,2),mn=v([S(`SynBadge`)],mn),mn.define(`syn-badge`);var hn=h`
...
`,gn=e=>{let{activeElement:t}=document;t&&e.contains(t)&&document.activeElement?.blur()},M=class{constructor(e,...t){this.slotNames=[],this.handleSlotChange=e=>{let t=e.target;(this.slotNames.includes(`[default]`)&&!t.name||t.name&&this.slotNames.includes(t.name))&&this.host.requestUpdate()},(this.host=e).addController(this),this.slotNames=t}hasDefaultSlot(){return[...this.host.childNodes].some(e=>{if(e.nodeType===e.TEXT_NODE&&e.textContent.trim()!==``)return!0;if(e.nodeType===e.ELEMENT_NODE){let t=e;if(t.tagName.toLowerCase()===`syn-visually-hidden`)return!1;if(!t.hasAttribute(`slot`))return!0}return!1})}hasNamedSlot(e){return this.host.querySelector(`:scope > [slot="${e}"]`)!==null}test(e){return e===`[default]`?this.hasDefaultSlot():this.hasNamedSlot(e)}hostConnected(){this.host.shadowRoot.addEventListener(`slotchange`,this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener(`slotchange`,this.handleSlotChange)}};function _n(e){if(!e)return``;let t=e.assignedNodes({flatten:!0}),n=``;return[...t].forEach(e=>{e.nodeType===Node.TEXT_NODE&&(n+=e.textContent)}),n}var vn=h`
  :host {
...
`,yn=Symbol.for(``),bn=e=>{if(e?.r===yn)return e?._$litStatic$},xn=(e,...t)=>({_$litStatic$:t.reduce((t,n,r)=>t+(e=>{if(e._$litStatic$!==void 0)return e._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${e}. Use 'unsafeStatic' to pass non-literal values, but\n            take care to ensure page security.`)})(n)+e[r+1],e[0]),r:yn}),Sn=new Map,Cn=(e=>(t,...n)=>{let r=n.length,i,a,o=[],s=[],c,l=0,u=!1;for(;l<r;){for(c=t[l];l<r&&(a=n[l],(i=bn(a))!==void 0);)c+=i+t[++l],u=!0;l!==r&&s.push(a),o.push(c),l++}if(l===r&&o.push(t[r]),u){let e=o.join(`$$lit$$`);(t=Sn.get(e))===void 0&&(o.raw=o,Sn.set(e,t=o)),n=s}return e(t,...n)})(g),N=e=>e??_,P=class extends O{constructor(){super(...arguments),this.hasFocus=!1,this.label=``,this.size=`inherit`,this.color=`currentColor`,this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){let e=!!this.href,t=e?xn`a`:xn`button`;return Cn`
      <${t}
        part="base"
    ...
    `}};P.styles=[w,vn],P.dependencies={"syn-icon":A},v([D(`.icon-button`)],P.prototype,`button`,2),v([E()],P.prototype,`hasFocus`,2),v([T()],P.prototype,`name`,2),v([T()],P.prototype,`library`,2),v([T()],P.prototype,`src`,2),v([T()],P.prototype,`href`,2),v([T()],P.prototype,`target`,2),v([T()],P.prototype,`download`,2),v([T()],P.prototype,`label`,2),v([T({reflect:!0})],P.prototype,`size`,2),v([T({reflect:!0})],P.prototype,`color`,2),v([T({reflect:!0,type:Boolean})],P.prototype,`disabled`,2),P=v([S(`SynIconButton`)],P);function F(e,t){return new Promise(n=>{function r(i){i.target===e&&(e.removeEventListener(t,r),n())}e.addEventListener(t,r)})}function I(e,t,n){return new Promise(r=>{if(n?.duration===1/0)throw Error(`Promise-based animations must be finite.`);let i=e.animate(t,{...n,duration:Tn()?0:n.duration});i.addEventListener(`cancel`,r,{once:!0}),i.addEventListener(`finish`,r,{once:!0})})}function wn(e){return e=e.toString().toLowerCase(),e.indexOf(`ms`)>-1?parseFloat(e):e.indexOf(`s`)>-1?parseFloat(e)*1e3:parseFloat(e)}function Tn(){return window.matchMedia(`(prefers-reduced-motion: reduce)`).matches}function L(e){return Promise.all(e.getAnimations().map(e=>new Promise(t=>{e.cancel(),requestAnimationFrame(t)})))}function En(e,t){return e.map(e=>({...e,height:e.height===`auto`?`${t}px`:e.height}))}var Dn=new Map,On=new WeakMap;function kn(e){return e??{keyframes:[],options:{duration:0}}}function An(e,t){return t.toLowerCase()===`rtl`?{keyframes:e.rtlKeyframes||e.keyframes,options:e.options}:e}function R(e,t){Dn.set(e,kn(t))}function jn(e,t,n){On.set(e,{...On.get(e),[t]:kn(n)})}function z(e,t,n){let r=On.get(e);if(r?.[t])return An(r[t],n.dir);let i=Dn.get(t);return i?An(i,n.dir):{keyframes:[],options:{duration:0}}}var Mn=class extends O{constructor(){super(...arguments),this.hasSlotController=new M(this,`icon`,`suffix`),this.localize=new j(this),this.open=!1,this.closable=!1,this.variant=`primary`,this.duration=1/0,this.size=`medium`}static get toastStack(){return this.currentToastStack||=Object.assign(document.createElement(`div`),{className:`syn-toast-stack`}),this.currentToastStack}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){clearTimeout(this.autoHideTimeout),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>{this.hide()},this.duration))}pauseAutoHide(){clearTimeout(this.autoHideTimeout)}resumeAutoHide(){this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>{this.hide()},this.duration))}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit(`syn-show`),this.duration<1/0&&this.restartAutoHide(),await L(this.base),this.base.hidden=!1;let{keyframes:e,options:t}=z(this,`alert.show`,{dir:this.localize.dir()});await I(this.base,e,t),this.emit(`syn-after-show`)}else{gn(this),this.emit(`syn-hide`),clearTimeout(this.autoHideTimeout),await L(this.base);let{keyframes:e,options:t}=z(this,`alert.hide`,{dir:this.localize.dir()});await I(this.base,e,t),this.base.hidden=!0,this.emit(`syn-after-hide`)}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,F(this,`syn-after-show`)}async hide(){if(this.open)return this.open=!1,F(this,`syn-after-hide`)}async toast(){return new Promise(e=>{Mn.toastStack.parentElement===null&&document.body.append(Mn.toastStack),Mn.toastStack.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener(`syn-after-hide`,()=>{Mn.toastStack.removeChild(this),e(),Mn.toastStack.querySelector(`syn-alert`)===null&&Mn.toastStack.remove()},{once:!0})})}render(){return g`
      <div
        part="base"
    ...
    `}};Mn.styles=[w,hn],Mn.dependencies={"syn-icon-button":P},v([D(`[part~="base"]`)],Mn.prototype,`base`,2),v([T({reflect:!0,type:Boolean})],Mn.prototype,`open`,2),v([T({reflect:!0,type:Boolean})],Mn.prototype,`closable`,2),v([T({reflect:!0})],Mn.prototype,`variant`,2),v([T({type:Number})],Mn.prototype,`duration`,2),v([T({reflect:!0})],Mn.prototype,`size`,2),v([C(`open`,{waitUntilFirstUpdate:!0})],Mn.prototype,`handleOpenChange`,1),v([C(`duration`)],Mn.prototype,`handleDurationChange`,1),Mn=v([S(`SynAlert`)],Mn),R(`alert.show`,{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:`ease`}}),R(`alert.hide`,{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:`ease`}}),Mn.define(`syn-alert`);var Nn=h`
  /* stylelint-disable no-descending-specificity */
  /*
...
`,Ln=class extends O{constructor(){super(...arguments),this.localize=new j(this)}render(){return g`
    ...
    `}};Ln.styles=[w,In,Fn];var B=class extends O{constructor(){super(...arguments),this.formControlController=new a(this,{assumeInteractionOn:[`click`]}),this.hasSlotController=new M(this,`[default]`,`prefix`,`suffix`),this.localize=new j(this),this.iconOnly=!1,this.hasFocus=!1,this.invalid=!1,this.title=``,this.variant=`outline`,this.size=`medium`,this.caret=!1,this.disabled=!1,this.loading=!1,this.type=`button`,this.name=``,this.value=``,this.href=``,this.rel=`noreferrer noopener`}get validity(){return this.isButton()?this.button.validity:o}get validationMessage(){return this.isButton()?this.button.validationMessage:``}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleClick(){this.type===`submit`&&this.formControlController.submit(this),this.type===`reset`&&this.formControlController.reset(this)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}isButton(){return!this.href}isLink(){return!!this.href}handleSlotChange(){let e=_n(this.defaultSlot).trim(),t=this.defaultSlot.assignedElements({flatten:!0}),n=t.length===1&&t[0].tagName.toLowerCase()===`syn-icon`;this.iconOnly=n&&e===``}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}checkValidity(){return!this.isButton()||this.button.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return!this.isButton()||this.button.reportValidity()}setCustomValidity(e){this.isButton()&&(this.button.setCustomValidity(e),this.formControlController.updateValidity())}render(){let e=this.isLink(),t=e?xn`a`:xn`button`;return Cn`
      ...
      >
        ...
        ${this.caret?Cn` <syn-icon part="caret" class="button__caret" library="system" name="chevron-down"></syn-icon> `:``}
        ${this.loading?Cn`<syn-spinner part="spinner"></syn-spinner>`:``}
      </${t}>
    `}};B.styles=[w,Pn,Nn],B.dependencies={"syn-icon":A,"syn-spinner":Ln},v([D(`.button`)],B.prototype,`button`,2),v([D(`slot:not([name])`)],B.prototype,`defaultSlot`,2),v([E()],B.prototype,`iconOnly`,2),v([E()],B.prototype,`hasFocus`,2),v([E()],B.prototype,`invalid`,2),v([T({reflect:!0})],B.prototype,`title`,2),v([T({reflect:!0})],B.prototype,`variant`,2),v([T({reflect:!0})],B.prototype,`size`,2),v([T({reflect:!0,type:Boolean})],B.prototype,`caret`,2),v([T({reflect:!0,type:Boolean})],B.prototype,`disabled`,2),v([T({reflect:!0,type:Boolean})],B.prototype,`loading`,2),v([T()],B.prototype,`type`,2),v([T()],B.prototype,`name`,2),v([T()],B.prototype,`value`,2),v([T()],B.prototype,`href`,2),v([T()],B.prototype,`target`,2),v([T()],B.prototype,`rel`,2),v([T()],B.prototype,`download`,2),v([T()],B.prototype,`form`,2),v([T({attribute:`formaction`})],B.prototype,`formAction`,2),v([T({attribute:`formenctype`})],B.prototype,`formEnctype`,2),v([T({attribute:`formmethod`})],B.prototype,`formMethod`,2),v([T({attribute:`formnovalidate`,type:Boolean})],B.prototype,`formNoValidate`,2),v([T({attribute:`formtarget`})],B.prototype,`formTarget`,2),v([C(`disabled`,{waitUntilFirstUpdate:!0})],B.prototype,`handleDisabledChange`,1),B=v([S(`SynButton`)],B),B.define(`syn-button`);var Rn=h`
  .breadcrumb-item {
...
`,Bn=class extends O{constructor(){super(...arguments),this.hasSlotController=new M(this,`prefix`,`suffix`),this.renderType=`button`,this.rel=`noreferrer noopener`}setRenderType(){let e=this.defaultSlot.assignedElements({flatten:!0}).filter(e=>e.tagName.toLowerCase()===`syn-dropdown`).length>0;if(this.href){this.renderType=`link`;return}if(e){this.renderType=`dropdown`;return}this.renderType=`button`}hrefChanged(){this.setRenderType()}handleSlotChange(){this.setRenderType()}render(){return g`
    ...
    `}};Bn.styles=[w,zn,Rn],v([D(`slot:not([name])`)],Bn.prototype,`defaultSlot`,2),v([E()],Bn.prototype,`renderType`,2),v([T()],Bn.prototype,`href`,2),v([T()],Bn.prototype,`target`,2),v([T()],Bn.prototype,`rel`,2),v([C(`href`,{waitUntilFirstUpdate:!0})],Bn.prototype,`hrefChanged`,1),Bn.define(`syn-breadcrumb-item`);var Vn=h`
  :host {
...
`,Hn=class extends O{constructor(){super(...arguments),this.hasSlotController=new M(this,`footer`,`header`,`image`),this.shadow=!1,this.sharp=!1}render(){return g`
      <div
        part="base"
    ...
    `}};Hn.styles=[w,Vn],v([T({reflect:!0,type:Boolean})],Hn.prototype,`shadow`,2),v([T({reflect:!0,type:Boolean})],Hn.prototype,`sharp`,2),Hn.define(`syn-card`);var Un=h`
  :host {
    display: inline-block;
  }
...
`;function Wn(e){let t=`syn-button, syn-radio-button`;return e.closest(t)??e.querySelector(t)}var Gn=class extends O{constructor(){super(...arguments),this.disableRole=!1,this.label=``,this.size=`medium`,this.variant=`outline`}handleFocus(e){Wn(e.target)?.toggleAttribute(`data-syn-button-group__button--focus`,!0)}handleBlur(e){Wn(e.target)?.toggleAttribute(`data-syn-button-group__button--focus`,!1)}handleMouseOver(e){Wn(e.target)?.toggleAttribute(`data-syn-button-group__button--hover`,!0)}handleMouseOut(e){Wn(e.target)?.toggleAttribute(`data-syn-button-group__button--hover`,!1)}handleSlotChange(){let e=[...this.defaultSlot.assignedElements({flatten:!0})];e.forEach(t=>{let n=e.indexOf(t),r=Wn(t);r&&(r.size=this.size,r.tagName.toLowerCase()===`syn-button`&&(r.variant=this.variant),r.toggleAttribute(`data-syn-button-group__button`,!0),r.toggleAttribute(`data-syn-button-group__button--first`,n===0),r.toggleAttribute(`data-syn-button-group__button--inner`,n>0&&n<e.length-1),r.toggleAttribute(`data-syn-button-group__button--last`,n===e.length-1),r.toggleAttribute(`data-syn-button-group__button--radio`,r.tagName.toLowerCase()===`syn-radio-button`))})}firstUpdated(){let e=()=>{this.mutationObserver.observe(this,{attributeFilter:[`size`,`variant`],attributes:!0,subtree:!0})};this.mutationObserver=new MutationObserver(t=>{this.mutationObserver.disconnect();let n=t.some(e=>e.target===this),r=t.some(e=>e.target!==this);r&&t.filter(e=>e.target!==this).forEach(e=>{let t=e.target,n=Wn(t);n&&(n.size=void 0,n.tagName.toLowerCase()===`syn-button`&&(n.variant=void 0))}),(n||r)&&this.handleSlotChange(),this.updateComplete.then(()=>{e()})}),e()}disconnectedCallback(){super.disconnectedCallback(),this.mutationObserver?.disconnect()}render(){return g`
      <div
        part="base"
        class="button-group"
    ...
    `}};Gn.styles=[w,Un],v([D(`slot`)],Gn.prototype,`defaultSlot`,2),v([E()],Gn.prototype,`disableRole`,2),v([T()],Gn.prototype,`label`,2),v([T({reflect:!0})],Gn.prototype,`size`,2),v([T({reflect:!0})],Gn.prototype,`variant`,2),Gn=v([S(`SynButtonGroup`)],Gn),Gn.define(`syn-button-group`);var Kn=h`
  :host {
    display: block;
  }
...
`,Jn=class extends O{constructor(){super(...arguments),this.hasSlotController=new M(this,`help-text`,`label`),this.label=``,this.helpText=``,this.size=`medium`,this.layout=`vertical`,this.form=``}handleSizeChange(){this.syncCheckboxes()}handleFormChange(){this.syncCheckboxes()}async syncCheckboxElements(){let e=this.getAllCheckboxes();await Promise.all(e.map(async e=>{await e.updateComplete;let t=e;t.size=this.size,t.form=this.form}))}syncCheckboxes(){let e=!!this.querySelector(`syn-checkbox`),t=!!this.querySelector(`syn-switch`),n=!!customElements.get(`syn-checkbox`),r=!!customElements.get(`syn-switch`);if((!e||n)&&(!t||r)){this.syncCheckboxElements().catch(()=>void 0);return}e&&!n&&customElements.whenDefined(`syn-checkbox`).then(()=>this.syncCheckboxes()).catch(()=>void 0),t&&!r&&customElements.whenDefined(`syn-switch`).then(()=>this.syncCheckboxes()).catch(()=>void 0)}getAllCheckboxes(){return[...this.querySelectorAll(`syn-checkbox, syn-switch`)]}handleKeyDown(e){if(![`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`].includes(e.key))return;let t=this.getAllCheckboxes().filter(e=>!e.disabled&&!e.readonly);if(!t.length)return;let n=e.composedPath().find(e=>{if(!e||!(e instanceof HTMLElement))return!1;let t=e.tagName.toLowerCase();return t===`syn-checkbox`||t===`syn-switch`}),r=t.find(e=>e.checked),i=t.indexOf(n??r??t[0])+([`ArrowUp`,`ArrowLeft`].includes(e.key)?-1:1);i<0&&(i=t.length-1),i>t.length-1&&(i=0),t[i].focus(),e.preventDefault()}handleLabelClick(){this.focus()}focus(e){let t=this.getAllCheckboxes(),n=t.find(e=>e.checked),r=t.find(e=>!e.disabled),i=n||r;i&&i.focus({...e,focusVisible:!0})}firstUpdated(){this.syncCheckboxes()}render(){let e=this.hasSlotController.test(`label`),t=this.hasSlotController.test(`help-text`),n=this.label?!0:!!e,r=this.helpText?!0:!!t;return g`
    ...
    `}};Jn.styles=[w,qn,Kn],v([D(`slot:not([name])`)],Jn.prototype,`defaultSlot`,2),v([T()],Jn.prototype,`label`,2),v([T({attribute:`help-text`})],Jn.prototype,`helpText`,2),v([T({reflect:!0})],Jn.prototype,`size`,2),v([T({reflect:!0})],Jn.prototype,`layout`,2),v([T({reflect:!0})],Jn.prototype,`form`,2),v([C(`size`,{waitUntilFirstUpdate:!0})],Jn.prototype,`handleSizeChange`,1),v([C(`form`,{waitUntilFirstUpdate:!0})],Jn.prototype,`handleFormChange`,1),Jn=v([S(`SynCheckboxGroup`)],Jn),Jn.define(`syn-checkbox-group`);var Yn=h`
  /* stylelint-disable no-descending-specificity */
  :host {
    display: inline-block;
  }
...
`,Xn=(e=`value`)=>(t,n)=>{let r=t.constructor,i=r.prototype.attributeChangedCallback;r.prototype.attributeChangedCallback=function(t,a,o){let s=r.getPropertyOptions(e);if(t===(typeof s.attribute==`string`?s.attribute:e)){let t=s.converter||pe,r=(typeof t==`function`?t:t?.fromAttribute??pe.fromAttribute)(o,s.type);this[e]!==r&&(this[n]=r)}i.call(this,t,a,o)}},Zn=Ot(class extends kt{constructor(e){if(super(e),e.type!==Dt.PROPERTY&&e.type!==Dt.ATTRIBUTE&&e.type!==Dt.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!qt(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===Re||t===_)return t;let n=e.element,r=e.name;if(e.type===Dt.PROPERTY){if(t===n[r])return Re}else if(e.type===Dt.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return Re}else if(e.type===Dt.ATTRIBUTE&&n.getAttribute(r)===t+``)return Re;return Yt(e),t}}),Qn=class extends O{constructor(){super(...arguments),this.formControlController=new a(this,{value:e=>e.checked?e.value||`on`:void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=t}),this.hasSlotController=new M(this,`help-text`),this.title=``,this.name=``,this.size=`medium`,this.disabled=!1,this.readonly=!1,this.checked=!1,this.indeterminate=!1,this.defaultChecked=!1,this.form=``,this.required=!1,this.helpText=``}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleClick(e){if(this.readonly){e.preventDefault();return}this.checked=!this.checked,this.indeterminate=!1,this.emit(`syn-change`)}handleBlur(){this.emit(`syn-blur`)}handleInput(){this.emit(`syn-input`)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleFocus(){this.emit(`syn-focus`)}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStateChange(){this.input.checked=this.checked,this.input.indeterminate=this.indeterminate,this.formControlController.updateValidity()}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){let e=this.hasSlotController.test(`help-text`),t=this.helpText?!0:!!e;return g`
      <div
    ...
    `}};Qn.styles=[w,qn,Yn],Qn.dependencies={"syn-icon":A},v([D(`input[type="checkbox"]`)],Qn.prototype,`input`,2),v([T({reflect:!0})],Qn.prototype,`title`,2),v([T()],Qn.prototype,`name`,2),v([T()],Qn.prototype,`value`,2),v([T({reflect:!0})],Qn.prototype,`size`,2),v([T({type:Boolean,reflect:!0})],Qn.prototype,`disabled`,2),v([T({type:Boolean,reflect:!0})],Qn.prototype,`readonly`,2),v([T({type:Boolean,reflect:!0})],Qn.prototype,`checked`,2),v([T({type:Boolean,reflect:!0})],Qn.prototype,`indeterminate`,2),v([Xn(`checked`)],Qn.prototype,`defaultChecked`,2),v([T({reflect:!0})],Qn.prototype,`form`,2),v([T({type:Boolean,reflect:!0})],Qn.prototype,`required`,2),v([T({attribute:`help-text`})],Qn.prototype,`helpText`,2),v([C(`disabled`,{waitUntilFirstUpdate:!0})],Qn.prototype,`handleDisabledChange`,1),v([C([`checked`,`indeterminate`],{waitUntilFirstUpdate:!0})],Qn.prototype,`handleStateChange`,1),Qn=v([S(`SynCheckbox`)],Qn),Qn.define(`syn-checkbox`);var $n=h`
  :host {
...
`,er=class extends O{constructor(){super(...arguments),this.localize=new j(this),this.open=!1,this.disabled=!1,this.contained=!1,this.size=`medium`}firstUpdated(){this.body.style.height=this.open?`auto`:`0`,this.open&&(this.details.open=!0),this.detailsObserver=new MutationObserver(e=>{for(let t of e)t.type===`attributes`&&t.attributeName===`open`&&(this.details.open?this.show():this.hide())}),this.detailsObserver.observe(this.details,{attributes:!0})}disconnectedCallback(){super.disconnectedCallback(),this.detailsObserver?.disconnect()}handleSummaryClick(e){e.preventDefault(),this.disabled||(this.open?this.hide():this.show(),this.header.focus())}handleSummaryKeyDown(e){(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),this.open?this.hide():this.show()),(e.key===`ArrowUp`||e.key===`ArrowLeft`)&&(e.preventDefault(),this.hide()),(e.key===`ArrowDown`||e.key===`ArrowRight`)&&(e.preventDefault(),this.show())}async handleOpenChange(){if(this.open){if(this.details.open=!0,this.emit(`syn-show`,{cancelable:!0}).defaultPrevented){this.open=!1,this.details.open=!1;return}await L(this.body);let{keyframes:e,options:t}=z(this,`details.show`,{dir:this.localize.dir()});await I(this.body,En(e,this.body.scrollHeight),t),this.body.style.height=`auto`,this.emit(`syn-after-show`)}else{if(this.emit(`syn-hide`,{cancelable:!0}).defaultPrevented){this.details.open=!0,this.open=!0;return}await L(this.body);let{keyframes:e,options:t}=z(this,`details.hide`,{dir:this.localize.dir()});await I(this.body,En(e,this.body.scrollHeight),t),this.body.style.height=`0`,this.details.open=!1,this.emit(`syn-after-hide`)}}async show(){if(!(this.open||this.disabled))return this.open=!0,F(this,`syn-after-show`)}async hide(){if(this.open&&!this.disabled)return this.open=!1,F(this,`syn-after-hide`)}render(){return g`
    ...
    `}};er.styles=[w,$n],er.dependencies={"syn-icon":A},v([D(`.details`)],er.prototype,`details`,2),v([D(`.details__header`)],er.prototype,`header`,2),v([D(`.details__body`)],er.prototype,`body`,2),v([D(`.details__expand-icon-slot`)],er.prototype,`expandIconSlot`,2),v([T({type:Boolean,reflect:!0})],er.prototype,`open`,2),v([T()],er.prototype,`summary`,2),v([T({type:Boolean,reflect:!0})],er.prototype,`disabled`,2),v([T({type:Boolean,reflect:!0})],er.prototype,`contained`,2),v([T({reflect:!0})],er.prototype,`size`,2),v([C(`open`,{waitUntilFirstUpdate:!0})],er.prototype,`handleOpenChange`,1),er=v([S(`SynDetails`)],er),R(`details.show`,{keyframes:[{height:`0`,opacity:`0`},{height:`auto`,opacity:`1`}],options:{duration:250,easing:`linear`}}),R(`details.hide`,{keyframes:[{height:`auto`,opacity:`1`},{height:`0`,opacity:`0`}],options:{duration:250,easing:`linear`}}),er.define(`syn-details`);var tr=h`
  /**
...
`,nr=h`
  ...
  */
  ...
  ${tr}
`,rr=e=>e,ir=class extends kt{constructor(e){if(super(e),this.it=_,e.type!==Dt.CHILD)throw Error(this.constructor.directiveName+`() can only be used in child bindings`)}render(e){if(e===_||e==null)return this._t=void 0,this.it=e;if(e===Re)return e;if(typeof e!=`string`)throw Error(this.constructor.directiveName+`() called with a non-string value`);if(e===this.it)return this._t;this.it=e;let t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};ir.directiveName=`unsafeHTML`,ir.resultType=1;var ar=Ot(ir),or=e=>Array.from(e.assignedElements({flatten:!0})),sr=e=>e.tagName.toLocaleLowerCase()===`syn-option`?e:Array.from(e.querySelectorAll(`:scope > syn-option`)),cr=e=>e.tagName.toLocaleLowerCase()===`syn-optgroup`,lr=e=>e.map(sr),ur=e=>e.filter(cr),dr=e=>e.normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).toLowerCase(),fr=e=>{let t=document.createElement(`div`);return et(e,t),t.firstElementChild},pr=e=>e.tagName.toLocaleLowerCase()===`syn-option`?e:void 0,mr=e=>{if(e){if(e instanceof HTMLElement)return pr(e);if(typeof e==`string`)return pr(fr(g`${ar(e)}`));if(Object.prototype.hasOwnProperty.call(e,`_$litType$`))return pr(fr(e))}},hr=e=>{let{value:t}=e;return t==null||t===``?e.getTextLabel():t},gr=e=>e.map(hr),_r=(e,t)=>{if(!t||e==null||e===``)return!1;let n=t.value,r=t.getTextLabel();return String(e)===String(n)||String(e)===r},vr=h`
  :host {
    display: block;
    /* stylelint-disable-next-line property-no-vendor-prefix */
    -webkit-user-select: none;
...
`,Mr=class extends O{constructor(){super(...arguments),this.localize=new j(this),this.size=`medium`,this.removable=!1}handleRemoveClick(){this.emit(`syn-remove`)}render(){return g`
      <span
        part="base"
    ...
    `}};Mr.styles=[w,jr,Ar],Mr.dependencies={"syn-icon-button":P},v([T({reflect:!0})],Mr.prototype,`size`,2),v([T({type:Boolean})],Mr.prototype,`removable`,2),Mr=v([S(`SynTag`)],Mr);var Nr=h`
  :host {
...
`,Pr=Math.min,Fr=Math.max,Ir=Math.round,Lr=Math.floor,Rr=e=>({x:e,y:e}),zr={left:`right`,right:`left`,bottom:`top`,top:`bottom`};function Br(e,t,n){return Fr(e,Pr(t,n))}function Vr(e,t){return typeof e==`function`?e(t):e}function Hr(e){return e.split(`-`)[0]}function Ur(e){return e.split(`-`)[1]}function Wr(e){return e===`x`?`y`:`x`}function Gr(e){return e===`y`?`height`:`width`}function Kr(e){let t=e[0];return t===`t`||t===`b`?`y`:`x`}function qr(e){return Wr(Kr(e))}function Jr(e,t,n){n===void 0&&(n=!1);let r=Ur(e),i=qr(e),a=Gr(i),o=i===`x`?r===(n?`end`:`start`)?`right`:`left`:r===`start`?`bottom`:`top`;return t.reference[a]>t.floating[a]&&(o=ri(o)),[o,ri(o)]}function Yr(e){let t=ri(e);return[Xr(e),t,Xr(t)]}function Xr(e){return e.includes(`start`)?e.replace(`start`,`end`):e.replace(`end`,`start`)}var Zr=[`left`,`right`],Qr=[`right`,`left`],$r=[`top`,`bottom`],ei=[`bottom`,`top`];function ti(e,t,n){switch(e){case`top`:case`bottom`:return n?t?Qr:Zr:t?Zr:Qr;case`left`:case`right`:return t?$r:ei;default:return[]}}function ni(e,t,n,r){let i=Ur(e),a=ti(Hr(e),n===`start`,r);return i&&(a=a.map(e=>e+`-`+i),t&&(a=a.concat(a.map(Xr)))),a}function ri(e){let t=Hr(e);return zr[t]+e.slice(t.length)}function ii(e){return{top:e.top??0,right:e.right??0,bottom:e.bottom??0,left:e.left??0}}function ai(e){return typeof e==`number`?{top:e,right:e,bottom:e,left:e}:ii(e)}function oi(e){let{x:t,y:n,width:r,height:i}=e;return{width:r,height:i,top:n,left:t,right:t+r,bottom:n+i,x:t,y:n}}function si(e,t,n){let{reference:r,floating:i}=e,a=Kr(t),o=qr(t),s=Gr(o),c=Hr(t),l=a===`y`,u=r.x+r.width/2-i.width/2,d=r.y+r.height/2-i.height/2,f=r[s]/2-i[s]/2,p;switch(c){case`top`:p={x:u,y:r.y-i.height};break;case`bottom`:p={x:u,y:r.y+r.height};break;case`right`:p={x:r.x+r.width,y:d};break;case`left`:p={x:r.x-i.width,y:d};break;default:p={x:r.x,y:r.y}}let m=Ur(t);return m&&(p[o]+=f*(m===`end`?1:-1)*(n&&l?-1:1)),p}async function ci(e,t){t===void 0&&(t={});let{x:n,y:r,platform:i,rects:a,elements:o,strategy:s}=e,{boundary:c=`clippingAncestors`,rootBoundary:l=`viewport`,elementContext:u=`floating`,altBoundary:d=!1,padding:f=0}=Vr(t,e),p=ai(f),m=o[d?u===`floating`?`reference`:`floating`:u],h=oi(await i.getClippingRect({element:await(i.isElement==null?void 0:i.isElement(m))??!0?m:m.contextElement||await(i.getDocumentElement==null?void 0:i.getDocumentElement(o.floating)),boundary:c,rootBoundary:l,strategy:s})),ee=u===`floating`?{x:n,y:r,width:a.floating.width,height:a.floating.height}:a.reference,te=await(i.getOffsetParent==null?void 0:i.getOffsetParent(o.floating)),ne=await(i.isElement==null?void 0:i.isElement(te))&&await(i.getScale==null?void 0:i.getScale(te))||{x:1,y:1},re=oi(i.convertOffsetParentRelativeRectToViewportRelativeRect?await i.convertOffsetParentRelativeRectToViewportRelativeRect({elements:o,rect:ee,offsetParent:te,strategy:s}):ee);return{top:(h.top-re.top+p.top)/ne.y,bottom:(re.bottom-h.bottom+p.bottom)/ne.y,left:(h.left-re.left+p.left)/ne.x,right:(re.right-h.right+p.right)/ne.x}}var li=50,ui=async(e,t,n)=>{let{placement:r=`bottom`,strategy:i=`absolute`,middleware:a=[],platform:o}=n,s=o.detectOverflow?o:{...o,detectOverflow:ci},c=await(o.isRTL==null?void 0:o.isRTL(t)),l=await o.getElementRects({reference:e,floating:t,strategy:i}),{x:u,y:d}=si(l,r,c),f=r,p=0,m={};for(let n=0;n<a.length;n++){let h=a[n];if(!h)continue;let{name:ee,fn:te}=h,{x:ne,y:re,data:ie,reset:ae}=await te({x:u,y:d,initialPlacement:r,placement:f,strategy:i,middlewareData:m,rects:l,platform:s,elements:{reference:e,floating:t}});u=ne??u,d=re??d,m[ee]={...m[ee],...ie},ae&&p<li&&(p++,typeof ae==`object`&&(ae.placement&&(f=ae.placement),ae.rects&&(l=ae.rects===!0?await o.getElementRects({reference:e,floating:t,strategy:i}):ae.rects),{x:u,y:d}=si(l,f,c)),n=-1)}return{x:u,y:d,placement:f,strategy:i,middlewareData:m}},di=e=>({name:`arrow`,options:e,async fn(t){let{x:n,y:r,placement:i,rects:a,platform:o,elements:s,middlewareData:c}=t,{element:l,padding:u=0}=Vr(e,t)||{};if(l==null)return{};let d=ai(u),f={x:n,y:r},p=qr(i),m=Gr(p),h=await o.getDimensions(l),ee=p===`y`,te=ee?`top`:`left`,ne=ee?`bottom`:`right`,re=ee?`clientHeight`:`clientWidth`,ie=a.reference[m]+a.reference[p]-f[p]-a.floating[m],ae=f[p]-a.reference[p],oe=await(o.getOffsetParent==null?void 0:o.getOffsetParent(l)),se=oe?oe[re]:0;(!se||!await(o.isElement==null?void 0:o.isElement(oe)))&&(se=s.floating[re]||a.floating[m]);let ce=ie/2-ae/2,le=se/2-h[m]/2-1,ue=Pr(d[te],le),de=Pr(d[ne],le),fe=se-h[m]-de,pe=se/2-h[m]/2+ce,me=Br(ue,pe,fe),he=!c.arrow&&Ur(i)!=null&&pe!==me&&a.reference[m]/2-(pe<ue?ue:de)-h[m]/2<0,ge=he?pe<ue?pe-ue:pe-fe:0;return{[p]:f[p]+ge,data:{[p]:me,centerOffset:pe-me-ge,...he&&{alignmentOffset:ge}},reset:he}}}),fi=function(e){return e===void 0&&(e={}),{name:`flip`,options:e,async fn(t){var n;let{placement:r,middlewareData:i,rects:a,initialPlacement:o,platform:s,elements:c}=t,{mainAxis:l=!0,crossAxis:u=!0,fallbackPlacements:d,fallbackStrategy:f=`bestFit`,fallbackAxisSideDirection:p=`none`,flipAlignment:m=!0,...h}=Vr(e,t);if((n=i.arrow)!=null&&n.alignmentOffset)return{};let ee=Hr(r),te=Kr(o),ne=Hr(o)===o,re=await(s.isRTL==null?void 0:s.isRTL(c.floating)),ie=d||(ne||!m?[ri(o)]:Yr(o)),ae=p!==`none`;!d&&ae&&ie.push(...ni(o,m,p,re));let oe=[o,...ie],se=await s.detectOverflow(t,h),ce=[],le=i.flip?.overflows||[];if(l&&ce.push(se[ee]),u){let e=Jr(r,a,re);ce.push(se[e[0]],se[e[1]])}if(le=[...le,{placement:r,overflows:ce}],!ce.every(e=>e<=0)){let e=(i.flip?.index||0)+1,t=oe[e];if(t&&(u!==`alignment`||te===Kr(t)||le.every(e=>Kr(e.placement)!==te||e.overflows[0]>0)))return{data:{index:e,overflows:le},reset:{placement:t}};let n=le.filter(e=>e.overflows[0]<=0).sort((e,t)=>e.overflows[1]-t.overflows[1])[0]?.placement;if(!n)switch(f){case`bestFit`:{let e=le.filter(e=>{if(ae){let t=Kr(e.placement);return t===te||t===`y`}return!0}).map(e=>[e.placement,e.overflows.filter(e=>e>0).reduce((e,t)=>e+t,0)]).sort((e,t)=>e[1]-t[1])[0]?.[0];e&&(n=e);break}case`initialPlacement`:n=o}if(r!==n)return{reset:{placement:n}}}return{}}}},pi=new Set([`left`,`top`]);async function mi(e,t){let{placement:n,platform:r,elements:i}=e,a=await(r.isRTL==null?void 0:r.isRTL(i.floating)),o=Hr(n),s=Ur(n),c=Kr(n)===`y`,l=pi.has(o)?-1:1,u=a&&c?-1:1,d=Vr(t,e),{mainAxis:f,crossAxis:p,alignmentAxis:m}=typeof d==`number`?{mainAxis:d,crossAxis:0,alignmentAxis:null}:{mainAxis:d.mainAxis||0,crossAxis:d.crossAxis||0,alignmentAxis:d.alignmentAxis};return s&&typeof m==`number`&&(p=s===`end`?m*-1:m),c?{x:p*u,y:f*l}:{x:f*l,y:p*u}}var hi=function(e){return e===void 0&&(e=0),{name:`offset`,options:e,async fn(t){var n;let{x:r,y:i,placement:a,middlewareData:o}=t,s=await mi(t,e);return a===o.offset?.placement&&(n=o.arrow)!=null&&n.alignmentOffset?{}:{x:r+s.x,y:i+s.y,data:{...s,placement:a}}}}},gi=function(e){return e===void 0&&(e={}),{name:`shift`,options:e,async fn(t){let{x:n,y:r,placement:i,platform:a}=t,{mainAxis:o=!0,crossAxis:s=!1,limiter:c={fn:e=>{let{x:t,y:n}=e;return{x:t,y:n}}},...l}=Vr(e,t),u={x:n,y:r},d=await a.detectOverflow(t,l),f=Kr(i),p=Wr(f),m=u[p],h=u[f],ee=(e,t)=>Br(t+d[e===`y`?`top`:`left`],t,t-d[e===`y`?`bottom`:`right`]);o&&(m=ee(p,m)),s&&(h=ee(f,h));let te=c.fn({...t,[p]:m,[f]:h});return{...te,data:{x:te.x-n,y:te.y-r,enabled:{[p]:o,[f]:s}}}}}},_i=function(e){return e===void 0&&(e={}),{name:`size`,options:e,async fn(t){let{placement:n,rects:r,platform:i,elements:a}=t,{apply:o=()=>{},...s}=Vr(e,t),c=await i.detectOverflow(t,s),l=Hr(n),u=Ur(n),d=Kr(n)===`y`,{width:f,height:p}=r.floating,m,h;l===`top`||l===`bottom`?(m=l,h=u===(await(i.isRTL==null?void 0:i.isRTL(a.floating))?`start`:`end`)?`left`:`right`):(h=l,m=u===`end`?`top`:`bottom`);let ee=p-c.top-c.bottom,te=f-c.left-c.right,ne=Pr(p-c[m],ee),re=Pr(f-c[h],te),ie=t.middlewareData.shift,ae=!ie,oe=ne,se=re;ie!=null&&ie.enabled.x&&(se=te),ie!=null&&ie.enabled.y&&(oe=ee),ae&&!u&&(d?se=f-2*Fr(c.left,c.right):oe=p-2*Fr(c.top,c.bottom)),await o({...t,availableWidth:se,availableHeight:oe});let ce=await i.getDimensions(a.floating);return f!==ce.width||p!==ce.height?{reset:{rects:!0}}:{}}}};function vi(){return typeof window<`u`}function yi(e){return Si(e)?(e.nodeName||``).toLowerCase():`#document`}function bi(e){var t;return(e==null||(t=e.ownerDocument)==null?void 0:t.defaultView)||window}function xi(e){return((Si(e)?e.ownerDocument:e.document)||window.document)?.documentElement}function Si(e){return vi()?e instanceof Node||e instanceof bi(e).Node:!1}function Ci(e){return vi()?e instanceof Element||e instanceof bi(e).Element:!1}function wi(e){return vi()?e instanceof HTMLElement||e instanceof bi(e).HTMLElement:!1}function Ti(e){return!vi()||typeof ShadowRoot>`u`?!1:e instanceof ShadowRoot||e instanceof bi(e).ShadowRoot}function Ei(e){let{overflow:t,overflowX:n,overflowY:r,display:i}=Li(e);return/auto|scroll|overlay|hidden|clip/.test(t+r+n)&&i!==`inline`&&i!==`contents`}function Di(e){return/^(table|td|th)$/.test(yi(e))}function Oi(e){try{if(e.matches(`:popover-open`))return!0}catch{}try{return e.matches(`:modal`)}catch{return!1}}var ki=/transform|translate|scale|rotate|perspective|filter/,Ai=/paint|layout|strict|content/,ji=e=>!!e&&e!==`none`,Mi;function Ni(e){let t=Ci(e)?Li(e):e;return ji(t.transform)||ji(t.translate)||ji(t.scale)||ji(t.rotate)||ji(t.perspective)||!Fi()&&(ji(t.backdropFilter)||ji(t.filter))||ki.test(t.willChange||``)||Ai.test(t.contain||``)}function Pi(e){let t=zi(e);for(;wi(t)&&!Ii(t);){if(Ni(t))return t;if(Oi(t))return null;t=zi(t)}return null}function Fi(){return Mi??=typeof CSS<`u`&&CSS.supports&&CSS.supports(`-webkit-backdrop-filter`,`none`),Mi}function Ii(e){return/^(html|body|#document)$/.test(yi(e))}function Li(e){return bi(e).getComputedStyle(e)}function Ri(e){return Ci(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function zi(e){if(yi(e)===`html`)return e;let t=e.assignedSlot||e.parentNode||Ti(e)&&e.host||xi(e);return Ti(t)?t.host:t}function Bi(e){let t=zi(e);return Ii(t)?(e.ownerDocument||e).body:wi(t)&&Ei(t)?t:Bi(t)}function Vi(e,t,n){t===void 0&&(t=[]),n===void 0&&(n=!0);let r=Bi(e),i=r===e.ownerDocument?.body,a=bi(r);if(i){let e=Hi(a);return t.concat(a,a.visualViewport||[],Ei(r)?r:[],e&&n?Vi(e):[])}return t.concat(r,Vi(r,[],n))}function Hi(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function Ui(e){let t=Li(e),n=parseFloat(t.width)||0,r=parseFloat(t.height)||0,i=wi(e),a=i?e.offsetWidth:n,o=i?e.offsetHeight:r,s=Ir(n)!==a||Ir(r)!==o;return s&&(n=a,r=o),{width:n,height:r,$:s}}function Wi(e){return Ci(e)?e:e.contextElement}function Gi(e){let t=Wi(e);if(!wi(t))return Rr(1);let n=t.getBoundingClientRect(),{width:r,height:i,$:a}=Ui(t),o=(a?Ir(n.width):n.width)/r,s=(a?Ir(n.height):n.height)/i;return(!o||!Number.isFinite(o))&&(o=1),(!s||!Number.isFinite(s))&&(s=1),{x:o,y:s}}var Ki=Rr(0);function qi(e){let t=bi(e);return!Fi()||!t.visualViewport?Ki:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function Ji(e,t,n){return t===void 0&&(t=!1),!!n&&t&&n===bi(e)}function Yi(e,t,n,r){t===void 0&&(t=!1),n===void 0&&(n=!1);let i=e.getBoundingClientRect(),a=Wi(e),o=Rr(1);t&&(r?Ci(r)&&(o=Gi(r)):o=Gi(e));let s=Ji(a,n,r)?qi(a):Rr(0),c=(i.left+s.x)/o.x,l=(i.top+s.y)/o.y,u=i.width/o.x,d=i.height/o.y;if(a&&r){let e=bi(a),t=Ci(r)?bi(r):r,n=e,i=Hi(n);for(;i&&t!==n;){let e=Gi(i),t=i.getBoundingClientRect(),r=Li(i),a=t.left+(i.clientLeft+parseFloat(r.paddingLeft))*e.x,o=t.top+(i.clientTop+parseFloat(r.paddingTop))*e.y;c*=e.x,l*=e.y,u*=e.x,d*=e.y,c+=a,l+=o,n=bi(i),i=Hi(n)}}return oi({width:u,height:d,x:c,y:l})}function Xi(e,t){let n=Ri(e).scrollLeft;return t?t.left+n:Yi(xi(e)).left+n}function Zi(e,t){let n=e.getBoundingClientRect();return{x:n.left+t.scrollLeft-Xi(e,n),y:n.top+t.scrollTop}}function Qi(e){let{elements:t,rect:n,offsetParent:r,strategy:i}=e,a=i===`fixed`,o=xi(r),s=t?Oi(t.floating):!1;if(r===o||s&&a)return n;let c={scrollLeft:0,scrollTop:0},l=Rr(1),u=Rr(0),d=wi(r);if((d||!a)&&((yi(r)!==`body`||Ei(o))&&(c=Ri(r)),d)){let e=Yi(r);l=Gi(r),u.x=e.x+r.clientLeft,u.y=e.y+r.clientTop}let f=o&&!d&&!a?Zi(o,c):Rr(0);return{width:n.width*l.x,height:n.height*l.y,x:n.x*l.x-c.scrollLeft*l.x+u.x+f.x,y:n.y*l.y-c.scrollTop*l.y+u.y+f.y}}function $i(e){return e.getClientRects?Array.from(e.getClientRects()):[]}function ea(e){let t=Ri(e),n=e.ownerDocument.body,r=Fr(e.scrollWidth,e.clientWidth,n.scrollWidth,n.clientWidth),i=Fr(e.scrollHeight,e.clientHeight,n.scrollHeight,n.clientHeight),a=-t.scrollLeft+Xi(e),o=-t.scrollTop;return Li(n).direction===`rtl`&&(a+=Fr(e.clientWidth,n.clientWidth)-r),{width:r,height:i,x:a,y:o}}var ta=25;function na(e,t,n){n===void 0&&(n=`viewport`);let r=n===`layoutViewport`,i=bi(e),a=xi(e),o=i.visualViewport,s=a.clientWidth,c=a.clientHeight,l=0,u=0;if(o){let e=!Fi()||t===`fixed`;r?e||(l=-o.offsetLeft,u=-o.offsetTop):(s=o.width,c=o.height,e&&(l=o.offsetLeft,u=o.offsetTop))}if(Xi(a)<=0){let e=a.ownerDocument,t=e.body,n=getComputedStyle(t),r=e.compatMode===`CSS1Compat`&&parseFloat(n.marginLeft)+parseFloat(n.marginRight)||0,i=Math.abs(a.clientWidth-t.clientWidth-r),o=getComputedStyle(a).scrollbarGutter===`stable both-edges`?i/2:i;o<=ta&&(s-=o)}return{width:s,height:c,x:l,y:u}}function ra(e,t){let n=Yi(e,!0,t===`fixed`),r=n.top+e.clientTop,i=n.left+e.clientLeft,a=Gi(e);return{width:e.clientWidth*a.x,height:e.clientHeight*a.y,x:i*a.x,y:r*a.y}}function ia(e,t,n){let r;if(t===`viewport`||t===`layoutViewport`)r=na(e,n,t);else if(t===`document`)r=ea(xi(e));else if(Ci(t))r=ra(t,n);else{let n=qi(e);r={x:t.x-n.x,y:t.y-n.y,width:t.width,height:t.height}}return oi(r)}function aa(e,t){let n=t.get(e);if(n)return n;let r=Vi(e,[],!1).filter(e=>Ci(e)&&yi(e)!==`body`),i=null,a=Li(e).position===`fixed`,o=a?zi(e):e;for(;Ci(o)&&!Ii(o);){let e=Li(o),t=Ni(o),n=i?i.position:a?`fixed`:``;!t&&(n===`fixed`||n===`absolute`&&e.position===`static`)?r=r.filter(e=>e!==o):i=e,o=zi(o)}return t.set(e,r),r}function oa(e){let{element:t,boundary:n,rootBoundary:r,strategy:i}=e,a=[...n===`clippingAncestors`?Oi(t)?[]:aa(t,this._c):[].concat(n),r],o=ia(t,a[0],i),s=o.top,c=o.right,l=o.bottom,u=o.left;for(let e=1;e<a.length;e++){let n=ia(t,a[e],i);s=Fr(n.top,s),c=Pr(n.right,c),l=Pr(n.bottom,l),u=Fr(n.left,u)}return{width:c-u,height:l-s,x:u,y:s}}function sa(e){let{width:t,height:n}=Ui(e);return{width:t,height:n}}function ca(e,t,n){let r=wi(t),i=xi(t),a=n===`fixed`,o=Yi(e,!0,a,t),s={scrollLeft:0,scrollTop:0},c=Rr(0);if((r||!a)&&((yi(t)!==`body`||Ei(i))&&(s=Ri(t)),r)){let e=Yi(t,!0,a,t);c.x=e.x+t.clientLeft,c.y=e.y+t.clientTop}!r&&i&&(c.x=Xi(i));let l=i&&!r&&!a?Zi(i,s):Rr(0);return{x:o.left+s.scrollLeft-c.x-l.x,y:o.top+s.scrollTop-c.y-l.y,width:o.width,height:o.height}}function la(e){return Li(e).position===`static`}function ua(e,t){if(!wi(e)||Li(e).position===`fixed`)return null;if(t)return t(e);let n=e.offsetParent;return xi(e)===n&&(n=n.ownerDocument.body),n}function da(e,t){let n=bi(e);if(Oi(e))return n;if(!wi(e)){let t=zi(e);for(;t&&!Ii(t);){if(Ci(t)&&!la(t))return t;t=zi(t)}return n}let r=ua(e,t);for(;r&&Di(r)&&la(r);)r=ua(r,t);return r&&Ii(r)&&la(r)&&!Ni(r)?n:r||Pi(e)||n}var fa=async function(e){let t=this.getOffsetParent||da,n=this.getDimensions,r=await n(e.floating);return{reference:ca(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:r.width,height:r.height}}};function pa(e){return Li(e).direction===`rtl`}var ma={convertOffsetParentRelativeRectToViewportRelativeRect:Qi,getDocumentElement:xi,getClippingRect:oa,getOffsetParent:da,getElementRects:fa,getClientRects:$i,getDimensions:sa,getScale:Gi,isElement:Ci,isRTL:pa};function ha(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function ga(e,t,n){let r=null,i,a=xi(e);function o(){var e;clearTimeout(i),(e=r)==null||e.disconnect(),r=null}function s(n,c){n===void 0&&(n=!1),c===void 0&&(c=1),o();let l=e.getBoundingClientRect(),{left:u,top:d,width:f,height:p}=l;if(n||t(),!f||!p)return;let m=Lr(d),h=Lr(a.clientWidth-(u+f)),ee=Lr(a.clientHeight-(d+p)),te=Lr(u),ne={rootMargin:-m+`px `+-h+`px `+-ee+`px `+-te+`px`,threshold:Fr(0,Pr(1,c))||1},re=!0;function ie(t){let n=t[0].intersectionRatio;if(!ha(l,e.getBoundingClientRect()))return s();if(n!==c){if(!re)return s();n?s(!1,n):i=setTimeout(()=>{s(!1,1e-7)},1e3)}re=!1}try{r=new IntersectionObserver(ie,{...ne,root:a.ownerDocument})}catch{r=new IntersectionObserver(ie,ne)}r.observe(e)}let c=bi(e),l=()=>s(n);return c.addEventListener(`resize`,l),s(!0),()=>{c.removeEventListener(`resize`,l),o()}}function _a(e,t,n,r){r===void 0&&(r={});let{ancestorScroll:i=!0,ancestorResize:a=!0,elementResize:o=typeof ResizeObserver==`function`,layoutShift:s=typeof IntersectionObserver==`function`,animationFrame:c=!1}=r,l=Wi(e),u=i||a?[...l?Vi(l):[],...t?Vi(t):[]]:[];u.forEach(e=>{i&&e.addEventListener(`scroll`,n),a&&e.addEventListener(`resize`,n)});let d=l&&s?ga(l,n,a):null,f=-1,p=null;o&&(p=new ResizeObserver(e=>{let[r]=e;r&&r.target===l&&p&&t&&(p.unobserve(t),cancelAnimationFrame(f),f=requestAnimationFrame(()=>{var e;(e=p)==null||e.observe(t)})),n()}),l&&!c&&p.observe(l),t&&p.observe(t));let m,h=c?Yi(e):null;c&&ee();function ee(){let t=Yi(e);h&&!ha(h,t)&&n(),h=t,m=requestAnimationFrame(ee)}return n(),()=>{var e;u.forEach(e=>{i&&e.removeEventListener(`scroll`,n),a&&e.removeEventListener(`resize`,n)}),d?.(),(e=p)==null||e.disconnect(),p=null,c&&cancelAnimationFrame(m)}}var va=hi,ya=gi,ba=fi,xa=_i,Sa=di,Ca=(e,t,n)=>{let r=new Map,i=n??{},a={...ma,...i.platform,_c:r};return ui(e,t,{...i,platform:a})};function wa(e){return Ea(e)}function Ta(e){return e.assignedSlot?e.assignedSlot:e.parentNode instanceof ShadowRoot?e.parentNode.host:e.parentNode}function Ea(e){for(let t=e;t;t=Ta(t))if(t instanceof Element&&getComputedStyle(t).display===`none`)return null;for(let t=Ta(e);t;t=Ta(t)){if(!(t instanceof Element))continue;let e=getComputedStyle(t);if(e.display!==`contents`&&(e.position!==`static`||Ni(e)||t.tagName===`BODY`))return t}return null}var Da=globalThis?.HTMLElement?.prototype.hasOwnProperty(`popover`);function Oa(e){return typeof e==`object`&&!!e&&`getBoundingClientRect`in e&&(`contextElement`in e?e.contextElement instanceof Element:!0)}var V=class extends O{constructor(){super(...arguments),this.localize=new j(this),this.active=!1,this.placement=`top`,this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement=`anchor`,this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements=``,this.flipFallbackStrategy=`best-fit`,this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){let e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),n=this.placement.includes(`top`)||this.placement.includes(`bottom`),r=0,i=0,a=0,o=0,s=0,c=0,l=0,u=0;n?e.top<t.top?(r=e.left,i=e.bottom,a=e.right,o=e.bottom,s=t.left,c=t.top,l=t.right,u=t.top):(r=t.left,i=t.bottom,a=t.right,o=t.bottom,s=e.left,c=e.top,l=e.right,u=e.top):e.left<t.left?(r=e.right,i=e.top,a=t.left,o=t.top,s=e.right,c=e.bottom,l=t.left,u=t.bottom):(r=t.right,i=t.top,a=e.left,o=e.top,s=t.right,c=t.bottom,l=e.left,u=e.bottom),this.style.setProperty(`--hover-bridge-top-left-x`,`${r}px`),this.style.setProperty(`--hover-bridge-top-left-y`,`${i}px`),this.style.setProperty(`--hover-bridge-top-right-x`,`${a}px`),this.style.setProperty(`--hover-bridge-top-right-y`,`${o}px`),this.style.setProperty(`--hover-bridge-bottom-left-x`,`${s}px`),this.style.setProperty(`--hover-bridge-bottom-left-y`,`${c}px`),this.style.setProperty(`--hover-bridge-bottom-right-x`,`${l}px`),this.style.setProperty(`--hover-bridge-bottom-right-y`,`${u}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has(`active`)&&(this.active?this.start():this.stop()),e.has(`anchor`)&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor==`string`){let e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchorEl=this.anchor instanceof Element||Oa(this.anchor)?this.anchor:this.querySelector(`[slot="anchor"]`);this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){this.anchorEl&&this.active&&(Da&&this.popup.showPopover?.(),this.cleanup=_a(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(e=>{Da&&this.popup?.hidePopover?.(),this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute(`data-current-placement`),this.style.removeProperty(`--auto-size-available-width`),this.style.removeProperty(`--auto-size-available-height`),requestAnimationFrame(()=>e())):e()})}reposition(){if(!this.active||!this.anchorEl)return;let e=[va({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?e.push(xa({apply:({rects:e})=>{let t=this.sync===`width`||this.sync===`both`,n=this.sync===`height`||this.sync===`both`;this.popup.style.width=t?`${e.reference.width}px`:``,this.popup.style.height=n?`${e.reference.height}px`:``}})):(this.popup.style.width=``,this.popup.style.height=``),this.flip&&e.push(ba({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy===`best-fit`?`bestFit`:`initialPlacement`,padding:this.flipPadding})),this.shift&&e.push(ya({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?e.push(xa({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:e,availableHeight:t})=>{this.autoSize===`vertical`||this.autoSize===`both`?this.style.setProperty(`--auto-size-available-height`,`${t}px`):this.style.removeProperty(`--auto-size-available-height`),this.autoSize===`horizontal`||this.autoSize===`both`?this.style.setProperty(`--auto-size-available-width`,`${e}px`):this.style.removeProperty(`--auto-size-available-width`)}})):(this.style.removeProperty(`--auto-size-available-width`),this.style.removeProperty(`--auto-size-available-height`)),this.arrow&&e.push(Sa({element:this.arrowEl,padding:this.arrowPadding}));let t=Da?e=>ma.getOffsetParent(e,wa):ma.getOffsetParent;Ca(this.anchorEl,this.popup,{placement:this.placement,middleware:e,strategy:Da?`absolute`:`fixed`,platform:{...ma,getOffsetParent:t}}).then(({x:e,y:t,middlewareData:n,placement:r})=>{let i=this.localize.dir()===`rtl`,a={top:`bottom`,right:`left`,bottom:`top`,left:`right`}[r.split(`-`)[0]];if(this.setAttribute(`data-current-placement`,r),Object.assign(this.popup.style,{left:`${e}px`,top:`${t}px`}),this.arrow){let e=n.arrow.x,t=n.arrow.y,r=``,o=``,s=``,c=``;if(this.arrowPlacement===`start`){let n=typeof e==`number`?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:``;r=typeof t==`number`?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:``,o=i?n:``,c=i?``:n}else if(this.arrowPlacement===`end`){let n=typeof e==`number`?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:``;o=i?``:n,c=i?n:``,s=typeof t==`number`?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:``}else this.arrowPlacement===`center`?(c=typeof e==`number`?`calc(50% - var(--arrow-size-diagonal))`:``,r=typeof t==`number`?`calc(50% - var(--arrow-size-diagonal))`:``):(c=typeof e==`number`?`${e}px`:``,r=typeof t==`number`?`${t}px`:``);Object.assign(this.arrowEl.style,{top:r,right:o,bottom:s,left:c,[a]:`calc(var(--arrow-size-diagonal) * -1)`})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit(`syn-reposition`)}render(){return g`
      ...
      <div
        part="popup"
        popover=${N(Da?`manual`:void 0)}
        class=${k({popup:!0,"popup--active":this.active,"popup--fixed":!Da,"popup--has-arrow":this.arrow})}
      >
        <slot></slot>
        ${this.arrow?g`<div part="arrow" class="popup__arrow" role="presentation"></div>`:``}
      </div>
    `}};V.styles=[w,Nr],v([D(`.popup`)],V.prototype,`popup`,2),v([D(`.popup__arrow`)],V.prototype,`arrowEl`,2),v([T()],V.prototype,`anchor`,2),v([T({type:Boolean,reflect:!0})],V.prototype,`active`,2),v([T({reflect:!0})],V.prototype,`placement`,2),v([T({type:Number})],V.prototype,`distance`,2),v([T({type:Number})],V.prototype,`skidding`,2),v([T({type:Boolean})],V.prototype,`arrow`,2),v([T({attribute:`arrow-placement`})],V.prototype,`arrowPlacement`,2),v([T({attribute:`arrow-padding`,type:Number})],V.prototype,`arrowPadding`,2),v([T({type:Boolean})],V.prototype,`flip`,2),v([T({attribute:`flip-fallback-placements`,converter:{fromAttribute:e=>e.split(` `).map(e=>e.trim()).filter(e=>e!==``),toAttribute:e=>e.join(` `)}})],V.prototype,`flipFallbackPlacements`,2),v([T({attribute:`flip-fallback-strategy`})],V.prototype,`flipFallbackStrategy`,2),v([T({type:Object})],V.prototype,`flipBoundary`,2),v([T({attribute:`flip-padding`,type:Number})],V.prototype,`flipPadding`,2),v([T({type:Boolean})],V.prototype,`shift`,2),v([T({type:Object})],V.prototype,`shiftBoundary`,2),v([T({attribute:`shift-padding`,type:Number})],V.prototype,`shiftPadding`,2),v([T({attribute:`auto-size`})],V.prototype,`autoSize`,2),v([T()],V.prototype,`sync`,2),v([T({type:Object})],V.prototype,`autoSizeBoundary`,2),v([T({attribute:`auto-size-padding`,type:Number})],V.prototype,`autoSizePadding`,2),v([T({attribute:`hover-bridge`,type:Boolean})],V.prototype,`hoverBridge`,2);var H=class extends O{constructor(){super(...arguments),this.formControlController=new a(this,{assumeInteractionOn:[`syn-blur`,`syn-input`]}),this.hasSlotController=new M(this,`help-text`,`label`),this.localize=new j(this),this.lastOptions=[],this.isInitialized=!1,this.isOptionRendererTriggered=!1,this.hasFocus=!1,this.isUserInput=!1,this.displayLabel=``,this.selectedOptions=[],this.numberFilteredOptions=0,this.cachedOptions=[],this.valueHasChanged=!1,this.hideOptions=!1,this.name=``,this._value=``,this.defaultValue=``,this.size=`medium`,this.placeholder=``,this.disabled=!1,this.readonly=!1,this.clearable=!1,this.open=!1,this.label=``,this.placement=`bottom`,this.helpText=``,this.form=``,this.required=!1,this.restricted=!1,this.multiple=!1,this.getOption=rr,this.filter=(e,t)=>{let n=e?.textContent||``;e instanceof br&&(n=e.getTextLabel());let r=dr(n),i=dr(t);return r.includes(i)?!0:(e?.value?.toString()||``).includes(t)},this.delimiter=` `,this.maxOptionsVisible=3,this.getTag=e=>g`
    <syn-tag
      part="tag"
      exportparts="
            base:tag__base,
  ...
  `,this.calculateTagMaxWidth=e=>{let t=e.at(0);if(!t||!this.tagContainer)return;let n=t.contentRect.width,r=this.tagContainer.getBoundingClientRect().width,i=Math.max(85,r+n-48);this.tagContainer.style.setProperty(`--syn-select-tag-max-width`,`${i}px`)},this.handleDocumentFocusIn=e=>{let t=e.composedPath();this&&!t.includes(this)&&this.hide()},this.handleDocumentKeyDown=e=>{if(e.target.closest(`.combobox__clear`)===null){if(e.key===`Escape`&&(this.open&&!this.closeWatcher?(e.preventDefault(),e.stopPropagation(),this.hide(),this.displayInput.focus({preventScroll:!0})):this.open||(this.multiple?this.clearInputField():this.clearCombobox())),e.key===`Enter`){let t=this.getCurrentOption(),n=e.metaKey||e.ctrlKey||e.shiftKey||e.altKey;if(!this.open&&!n){setTimeout(()=>{e.defaultPrevented||this.formControlController.submit()});return}if(!this.open||t&&t.disabled)return;if(t){this.isUserInput=!0,this.valueHasChanged=!0;let e=this.lastOptions?gr(this.lastOptions):[];this.multiple?this.toggleOptionSelection(t):this.setSelectedOptions(t),this.selectionChanged();let n=Array.isArray(this.value)?this.value:[this.value];this.updateComplete.then(()=>{this.isUserInput=!1}),Sr(e,n)||this.updateComplete.then(()=>{this.emit(`syn-input`),this.emit(`syn-change`)})}this.multiple||this.hide(),this.displayInput.focus({preventScroll:!0});return}[`ArrowUp`,`ArrowDown`].includes(e.key)&&(e.preventDefault(),e.stopPropagation(),this.open||this.show(),this.selectNextOption(e.key===`ArrowDown`)),[`Home`,`End`].includes(e.key)&&(e.preventDefault(),e.stopPropagation(),e.key===`Home`?this.displayInput.setSelectionRange(0,0):e.key===`End`&&this.displayInput.setSelectionRange(this.displayLabel.length,this.displayLabel.length))}},this.handleDocumentMouseDown=e=>{let t=e.composedPath();this&&!t.includes(this)&&this.hide()}}get value(){return this._value}set value(e){this.multiple?Array.isArray(e)||(e=typeof e==`string`?e.split(this.delimiter):[e].filter(xr)):e=Array.isArray(e)?e.join(this.delimiter):e,!Sr(this._value,e)&&(this.valueHasChanged=!0,this._value=e)}get validity(){return this.valueInput.validity}get validationMessage(){return this.valueInput.validationMessage}enableResizeObserver(){this.multiple&&(this.resizeObserver||=new ResizeObserver(this.calculateTagMaxWidth),this.resizeObserver.observe(this.displayInput))}connectedCallback(){super.connectedCallback(),this.mutationObserver=new MutationObserver(e=>{let t=e.some(e=>{if(!(e.target instanceof br)||e.type!==`attributes`||e.attributeName!==`value`)return!1;let t=e.target.getAttribute(`value`);return e.oldValue!==t&&!!t}),n=(this.restricted||this.multiple)&&e.some(e=>e.type!==`characterData`&&e.type!==`childList`?!1:this.selectedOptions.some(t=>t===e.target||t.contains(e.target)));t&&this.handleSlotContentChange(),n&&(this.multiple?this.readonly?this.displayLabel=this.selectedOptions.map(e=>e.getTextLabel()).join(`, `):this.requestUpdate():this.displayLabel=this.selectedOptions[0]?.getTextLabel?.()??this.displayLabel)}),this.mutationObserver.observe(this,{attributeFilter:[`value`],attributeOldValue:!0,attributes:!0,characterData:!0,childList:!0,subtree:!0}),setTimeout(()=>{this.handleSlotContentChange()}),this.open=!1}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect(),this.mutationObserver?.disconnect(),this.removeOpenListeners()}firstUpdated(){this.isInitialized=!0,this.formControlController.updateValidity()}updated(e){super.updated(e),e.has(`multiple`)&&(this.multiple?this.enableResizeObserver():this.resizeObserver?.disconnect())}willUpdate(e){super.willUpdate(e);let t=this.defaultValue==null||this.defaultValue===``||Array.isArray(this.defaultValue)&&this.defaultValue.length===0;if(e.has(`value`)&&t&&this.value&&!this.isUserInput&&(this.defaultValue=this.multiple&&Array.isArray(this.value)?this.value.join(this.delimiter):this.value,this.valueHasChanged=!1),!this.isInitialized&&e.has(`value`)&&this.value!==void 0&&e.has(`multiple`)&&this.multiple&&!Array.isArray(this.defaultValue)){let e=this.valueHasChanged;this.value=typeof this.defaultValue==`string`?this.defaultValue.split(this.delimiter):[this.defaultValue].filter(xr),this.valueHasChanged=e}}attributeChangedCallback(e,t,n){if(super.attributeChangedCallback(e,t,n),e===`value`){let e=this.valueHasChanged;this.value=this.defaultValue,this.valueHasChanged=e}}get tags(){return this.selectedOptions.map((e,t)=>{if(t<this.maxOptionsVisible||this.maxOptionsVisible<=0){let n=this.getTag(e,t);return g`<div @syn-remove=${t=>this.handleTagRemove(t,e)}>
    ...
    `}};H.styles=[w,qn,nr],H.dependencies={"syn-icon":A,"syn-popup":V,"syn-tag":Mr},v([D(`.combobox`)],H.prototype,`popup`,2),v([D(`.combobox__inputs`)],H.prototype,`combobox`,2),v([D(`.combobox__display-input`)],H.prototype,`displayInput`,2),v([D(`.combobox__value-input`)],H.prototype,`valueInput`,2),v([D(`.combobox__listbox`)],H.prototype,`listbox`,2),v([D(`slot:not([name])`)],H.prototype,`defaultSlot`,2),v([D(`.combobox__tags`)],H.prototype,`tagContainer`,2),v([E()],H.prototype,`hasFocus`,2),v([E()],H.prototype,`isUserInput`,2),v([E()],H.prototype,`displayLabel`,2),v([E()],H.prototype,`selectedOptions`,2),v([E()],H.prototype,`numberFilteredOptions`,2),v([E()],H.prototype,`cachedOptions`,2),v([E()],H.prototype,`valueHasChanged`,2),v([E()],H.prototype,`hideOptions`,2),v([T()],H.prototype,`name`,2),v([E()],H.prototype,`value`,1),v([T({attribute:`value`})],H.prototype,`defaultValue`,2),v([T({reflect:!0})],H.prototype,`size`,2),v([T()],H.prototype,`placeholder`,2),v([T({reflect:!0,type:Boolean})],H.prototype,`disabled`,2),v([T({reflect:!0,type:Boolean})],H.prototype,`readonly`,2),v([T({type:Boolean})],H.prototype,`clearable`,2),v([T({reflect:!0,type:Boolean})],H.prototype,`open`,2),v([T()],H.prototype,`label`,2),v([T({type:Number})],H.prototype,`maxlength`,2),v([T({reflect:!0})],H.prototype,`placement`,2),v([T({attribute:`help-text`})],H.prototype,`helpText`,2),v([T({reflect:!0})],H.prototype,`form`,2),v([T({reflect:!0,type:Boolean})],H.prototype,`required`,2),v([T({reflect:!0,type:Boolean})],H.prototype,`restricted`,2),v([T({reflect:!0,type:Boolean})],H.prototype,`multiple`,2),v([T()],H.prototype,`getOption`,2),v([T()],H.prototype,`filter`,2),v([T()],H.prototype,`delimiter`,2),v([T({attribute:`max-options-visible`,type:Number})],H.prototype,`maxOptionsVisible`,2),v([T()],H.prototype,`getTag`,2),v([C([`filter`,`getOption`],{waitUntilFirstUpdate:!0})],H.prototype,`handlePropertiesChange`,1),v([C(`displayLabel`,{waitUntilFirstUpdate:!0})],H.prototype,`handleDisplayInputValueChange`,1),v([C([`disabled`,`readonly`],{waitUntilFirstUpdate:!0})],H.prototype,`handleDisabledChange`,1),v([C(`delimiter`)],H.prototype,`handleDelimiterChange`,1),v([C([`defaultValue`,`value`,`delimiter`,`multiple`,`restricted`],{waitUntilFirstUpdate:!0})],H.prototype,`handleValueChange`,1),v([C(`open`,{waitUntilFirstUpdate:!0})],H.prototype,`handleOpenChange`,1),H=v([S(`SynCombobox`)],H),R(`combobox.show`,{keyframes:[{opacity:0,scale:.9},{opacity:1,scale:1}],options:{duration:100,easing:`ease`}}),R(`combobox.hide`,{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.9}],options:{duration:100,easing:`ease`}}),H.define(`syn-combobox`);var ka=h`
  :host {
...
`,Aa=class extends O{constructor(){super(...arguments),this.vertical=!1}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`separator`)}handleVerticalChange(){this.setAttribute(`aria-orientation`,this.vertical?`vertical`:`horizontal`)}};Aa.styles=[w,ka],v([T({type:Boolean,reflect:!0})],Aa.prototype,`vertical`,2),v([C(`vertical`)],Aa.prototype,`handleVerticalChange`,1),Aa.define(`syn-divider`);var ja=h`
  :host {
    --width: 31rem;
...
`;function*Ma(e=document.activeElement){e!=null&&(yield e,`shadowRoot`in e&&e.shadowRoot&&e.shadowRoot.mode!==`closed`&&(yield*Ma(e.shadowRoot.activeElement)))}function Na(){return[...Ma()].pop()}var Pa=new WeakMap;function Fa(e){let t=Pa.get(e);return t||(t=window.getComputedStyle(e,null),Pa.set(e,t)),t}function Ia(e){if(typeof e.checkVisibility==`function`)return e.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});let t=Fa(e);return t.visibility!==`hidden`&&t.display!==`none`}function La(e){let{overflowY:t,overflowX:n}=Fa(e);return t===`scroll`||n===`scroll`?!0:t!==`auto`||n!==`auto`?!1:e.scrollHeight>e.clientHeight&&t===`auto`||e.scrollWidth>e.clientWidth&&n===`auto`}function Ra(e){let t=e.tagName.toLowerCase(),n=Number(e.getAttribute(`tabindex`));if(e.hasAttribute(`tabindex`)&&(isNaN(n)||n<=-1)||e.hasAttribute(`disabled`)||e.closest(`[inert]`))return!1;if(t===`input`&&e.getAttribute(`type`)===`radio`){let t=e.getRootNode(),n=`input[type='radio'][name="${e.getAttribute(`name`)}"]`,r=t.querySelector(`${n}:checked`);return r?r===e:t.querySelector(n)===e}return Ia(e)?(t===`audio`||t===`video`)&&e.hasAttribute(`controls`)||e.hasAttribute(`tabindex`)||e.hasAttribute(`contenteditable`)&&e.getAttribute(`contenteditable`)!==`false`||[`button`,`input`,`select`,`textarea`,`a`,`audio`,`video`,`summary`,`iframe`].includes(t)?!0:La(e):!1}function za(e){let t=Va(e);return{start:t[0]??null,end:t[t.length-1]??null}}function Ba(e,t){return e.getRootNode({composed:!0})?.host!==t}function Va(e){let t=new WeakMap,n=[];function r(i){if(i instanceof Element){if(i.hasAttribute(`inert`)||i.closest(`[inert]`)||t.has(i))return;t.set(i,!0),!n.includes(i)&&Ra(i)&&n.push(i),i instanceof HTMLSlotElement&&Ba(i,e)&&i.assignedElements({flatten:!0}).forEach(e=>{r(e)}),i.shadowRoot!==null&&i.shadowRoot.mode===`open`&&r(i.shadowRoot)}for(let e of i.children)r(e)}return r(e),n.sort((e,t)=>{let n=Number(e.getAttribute(`tabindex`))||0;return(Number(t.getAttribute(`tabindex`))||0)-n})}var Ha=[],Ua=class{constructor(e){this.tabDirection=`forward`,this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=e=>{if(e.key!==`Tab`||this.isExternalActivated||!this.isActive())return;let t=Na();if(this.previousFocus=t,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;this.tabDirection=e.shiftKey?`backward`:`forward`;let n=Va(this.element),r=n.findIndex(e=>e===t);this.previousFocus=this.currentFocus;let i=this.tabDirection===`forward`?1:-1;for(;;){r+i>=n.length?r=0:r+i<0?r=n.length-1:r+=i,this.previousFocus=this.currentFocus;let t=n[r];if(this.tabDirection===`backward`&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||t&&this.possiblyHasTabbableChildren(t))return;e.preventDefault(),this.currentFocus=t,this.currentFocus?.focus({preventScroll:!1});let a=[...Ma()];if(a.includes(this.currentFocus)||!a.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection=`forward`},this.element=e,this.elementsWithTabbableControls=[`iframe`]}activate(){Ha.push(this.element),document.addEventListener(`focusin`,this.handleFocusIn),document.addEventListener(`keydown`,this.handleKeyDown),document.addEventListener(`keyup`,this.handleKeyUp)}deactivate(){Ha=Ha.filter(e=>e!==this.element),this.currentFocus=null,document.removeEventListener(`focusin`,this.handleFocusIn),document.removeEventListener(`keydown`,this.handleKeyDown),document.removeEventListener(`keyup`,this.handleKeyUp)}isActive(){return Ha[Ha.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){let e=Va(this.element);if(!(()=>{let e=document.activeElement;for(;e;){if(this.element.contains(e))return!0;let t=e.shadowRoot;e=t?t.activeElement:null}return!1})()){let t=e[0],n=e[e.length-1],r=this.tabDirection===`forward`?t:n;typeof r?.focus==`function`&&(this.currentFocus=r,r.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(e){return this.elementsWithTabbableControls.includes(e.tagName.toLowerCase())||e.hasAttribute(`controls`)}},Wa=class extends O{constructor(){super(...arguments),this.hasSlotController=new M(this,`footer`),this.localize=new j(this),this.modal=new Ua(this),this.open=!1,this.label=``,this.noHeader=!1,this.handleDocumentKeyDown=e=>{e.key===`Escape`&&this.modal.isActive()&&this.open&&(e.stopPropagation(),this.requestClose(`keyboard`))}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),Dr(this))}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate(),Or(this),this.removeOpenListeners()}requestClose(e){if(this.emit(`syn-request-close`,{cancelable:!0,detail:{source:e}}).defaultPrevented){let e=z(this,`dialog.denyClose`,{dir:this.localize.dir()});I(this.panel,e.keyframes,e.options);return}this.hide()}addOpenListeners(){`CloseWatcher`in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose(`keyboard`)):document.addEventListener(`keydown`,this.handleDocumentKeyDown)}removeOpenListeners(){this.closeWatcher?.destroy(),document.removeEventListener(`keydown`,this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit(`syn-show`),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),Dr(this);let e=this.querySelector(`[autofocus]`);e&&e.removeAttribute(`autofocus`),await Promise.all([L(this.dialog),L(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit(`syn-initial-focus`,{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute(`autofocus`,``)});let t=z(this,`dialog.show`,{dir:this.localize.dir()}),n=z(this,`dialog.overlay.show`,{dir:this.localize.dir()});await Promise.all([I(this.panel,t.keyframes,t.options),I(this.overlay,n.keyframes,n.options)]),this.emit(`syn-after-show`)}else{gn(this),this.emit(`syn-hide`),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([L(this.dialog),L(this.overlay)]);let e=z(this,`dialog.hide`,{dir:this.localize.dir()}),t=z(this,`dialog.overlay.hide`,{dir:this.localize.dir()});await Promise.all([I(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),I(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,Or(this);let n=this.originalTrigger;typeof n?.focus==`function`&&setTimeout(()=>n.focus()),this.emit(`syn-after-hide`)}}async show(){if(!this.open)return this.open=!0,F(this,`syn-after-show`)}async hide(){if(this.open)return this.open=!1,F(this,`syn-after-hide`)}render(){return g`
      <div
        part="base"
    ...
    `}};Wa.styles=[w,ja],Wa.dependencies={"syn-icon-button":P},v([D(`.dialog`)],Wa.prototype,`dialog`,2),v([D(`.dialog__panel`)],Wa.prototype,`panel`,2),v([D(`.dialog__overlay`)],Wa.prototype,`overlay`,2),v([T({reflect:!0,type:Boolean})],Wa.prototype,`open`,2),v([T({reflect:!0})],Wa.prototype,`label`,2),v([T({attribute:`no-header`,reflect:!0,type:Boolean})],Wa.prototype,`noHeader`,2),v([C(`open`,{waitUntilFirstUpdate:!0})],Wa.prototype,`handleOpenChange`,1),R(`dialog.show`,{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:`ease`}}),R(`dialog.hide`,{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:`ease`}}),R(`dialog.denyClose`,{keyframes:[{offset:0,transform:`translateX(0)`},{offset:.32,transform:`translateX(calc(var(--syn-spacing-x-small) * -1))`},{offset:.6,transform:`translateX(var(--syn-spacing-2x-small))`},{offset:.82,transform:`translateX(calc(var(--syn-spacing-3x-small) * -1))`},{offset:1,transform:`translateX(0)`}],options:{duration:250,easing:`cubic-bezier(0.25, 0.1, 0.25, 1)`}}),R(`dialog.overlay.show`,{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}}),R(`dialog.overlay.hide`,{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}}),Wa.define(`syn-dialog`);var Ga=e=>{let t=[`button`,`fieldset`,`input`,`select`,`textarea`,`syn-button`,`syn-checkbox`,`syn-checkbox-group`,`syn-combobox`,`syn-dropdown`,`syn-fieldset`,`syn-file`,`syn-icon-button`,`syn-input`,`syn-radio-group`,`syn-radio`,`syn-range`,`syn-select`,`syn-switch`,`syn-textarea`].join(`,`);return Array.from(e.querySelectorAll(t))},Ka=e=>`disabled`in e,qa=`syn-radio-group, syn-checkbox-group`,Ja=(e,t)=>e!==`two-columns`||t<640?`vertical`:`horizontal`,Ya=(e,t)=>{e.querySelectorAll(qa).forEach(e=>{e.layout!==t&&(e.layout=t)})},Xa=h`
  :host {
    /*
...
`,Za=class extends O{constructor(){super(...arguments),this.hasSlotController=new M(this,`description`,`legend`),this.forcedDisabledElements=new WeakSet,this.lightDomObserver=new MutationObserver(e=>{this.disabled&&this.syncDisabledState(),e.some(e=>e.type===`childList`)&&this.scheduleGroupedControlLayoutSync()}),this.fieldContainerResizeObserver=new ResizeObserver(()=>{this.scheduleGroupedControlLayoutSync()}),this.groupedLayoutSyncAnimationFrame=null,this.handleSlotChange=()=>{this.disabled&&this.syncDisabledState(),this.scheduleGroupedControlLayoutSync()},this.description=``,this.legend=``,this.disabled=!1,this.disableAutoGroupLayout=!1,this.layout=`one-column`}getFieldContainerWidth(){return(this.shadowRoot?.querySelector(`.fields`))?.getBoundingClientRect().width??0}syncGroupedControlLayouts(){if(this.disableAutoGroupLayout)return;let e=Ja(this.layout,this.getFieldContainerWidth());Ya(this,e)}scheduleGroupedControlLayoutSync(){this.groupedLayoutSyncAnimationFrame===null&&(this.groupedLayoutSyncAnimationFrame=requestAnimationFrame(()=>{this.groupedLayoutSyncAnimationFrame=null,this.syncGroupedControlLayouts()}))}syncDisabledState(){Array.from(Ga(this)).filter(Ka).forEach(e=>{this.disabled&&(e.disabled||=(this.forcedDisabledElements.add(e),!0)),!this.disabled&&this.forcedDisabledElements.has(e)&&(e.disabled=!1)})}connectedCallback(){super.connectedCallback(),this.lightDomObserver.observe(this,{attributeFilter:[`disabled`],attributes:!0,childList:!0,subtree:!0})}firstUpdated(){let e=this.shadowRoot?.querySelector(`.fields`);e&&this.fieldContainerResizeObserver.observe(e),this.syncGroupedControlLayouts()}disconnectedCallback(){super.disconnectedCallback(),this.lightDomObserver?.disconnect(),this.fieldContainerResizeObserver?.disconnect(),this.groupedLayoutSyncAnimationFrame!==null&&(cancelAnimationFrame(this.groupedLayoutSyncAnimationFrame),this.groupedLayoutSyncAnimationFrame=null)}updated(e){super.updated(e),e.has(`disabled`)&&this.syncDisabledState(),(e.has(`layout`)||e.has(`disableAutoGroupLayout`))&&this.scheduleGroupedControlLayoutSync()}render(){let e=this.hasSlotController.test(`legend`)||this.legend.length>0,t=this.hasSlotController.test(`description`)||this.description.length>0;return g`
      <fieldset
    ...
    `}};Za.styles=[w,Xa],v([T({reflect:!0,type:String})],Za.prototype,`description`,2),v([T({reflect:!0,type:String})],Za.prototype,`legend`,2),v([T({reflect:!0,type:Boolean})],Za.prototype,`disabled`,2),v([T({attribute:`disable-auto-group-layout`,reflect:!0,type:Boolean})],Za.prototype,`disableAutoGroupLayout`,2),v([T({reflect:!0})],Za.prototype,`layout`,2),Za.define(`syn-fieldset`);var Qa=h`
  :host {
    display: inline-block;
  }
...
`,$a=class extends O{constructor(){super(...arguments),this.localize=new j(this),this.open=!1,this.placement=`bottom-start`,this.disabled=!1,this.stayOpenOnSelect=!1,this.distance=0,this.skidding=0,this.sync=void 0,this.handleKeyDown=e=>{this.open&&e.key===`Escape`&&(e.stopPropagation(),this.hide(),this.focusOnTrigger())},this.handleDocumentKeyDown=e=>{if(e.key===`Escape`&&this.open&&!this.closeWatcher){e.stopPropagation(),this.focusOnTrigger(),this.hide();return}if(e.key===`Tab`){if(this.open&&document.activeElement?.tagName.toLowerCase()===`syn-menu-item`){e.preventDefault(),this.hide(),this.focusOnTrigger();return}let t=(e,n)=>{if(!e)return null;let r=e.closest(n);if(r)return r;let i=e.getRootNode();return i instanceof ShadowRoot?t(i.host,n):null};setTimeout(()=>{let e=this.containingElement?.getRootNode()instanceof ShadowRoot?Na():document.activeElement;(!this.containingElement||t(e,this.containingElement.tagName.toLowerCase())!==this.containingElement)&&this.hide()})}},this.handleDocumentMouseDown=e=>{let t=e.composedPath();this.containingElement&&!t.includes(this.containingElement)&&this.hide()},this.handlePanelSelect=e=>{let t=e.target;!this.stayOpenOnSelect&&t.tagName.toLowerCase()===`syn-menu`&&(this.hide(),this.focusOnTrigger())}}connectedCallback(){super.connectedCallback(),this.containingElement||=this}firstUpdated(){this.panel.hidden=!this.open,this.open&&(this.addOpenListeners(),this.popup.active=!0)}disconnectedCallback(){super.disconnectedCallback(),this.removeOpenListeners(),this.hide()}focusOnTrigger(){let e=this.trigger.assignedElements({flatten:!0})[0];typeof e?.focus==`function`&&e.focus()}getContainingModalHost(){return this.closest(`syn-dialog, syn-drawer`)}getMenu(){return this.panel.assignedElements({flatten:!0}).find(e=>e.tagName.toLowerCase()===`syn-menu`)}handleTriggerClick(){this.open?this.hide():(this.show(),this.focusOnTrigger())}async handleTriggerKeyDown(e){if([` `,`Enter`].includes(e.key)){e.preventDefault(),this.handleTriggerClick();return}let t=this.getMenu();if(t){let n=t.getAllItems(),r=n[0],i=n[n.length-1];[`ArrowDown`,`ArrowUp`,`Home`,`End`].includes(e.key)&&(e.preventDefault(),this.open||(this.show(),await this.updateComplete),n.length>0&&this.updateComplete.then(()=>{(e.key===`ArrowDown`||e.key===`Home`)&&(t.setCurrentItem(r),r.focus()),(e.key===`ArrowUp`||e.key===`End`)&&(t.setCurrentItem(i),i.focus())}))}}handleTriggerKeyUp(e){e.key===` `&&e.preventDefault()}handleTriggerSlotChange(){this.updateAccessibleTrigger()}updateAccessibleTrigger(){let e=this.trigger.assignedElements({flatten:!0}).find(e=>za(e).start),t;if(e){switch(e.tagName.toLowerCase()){case`syn-button`:case`syn-icon-button`:t=e.button;break;default:t=e}t.setAttribute(`aria-haspopup`,`true`),t.setAttribute(`aria-expanded`,this.open?`true`:`false`)}}async show(){if(!this.open)return this.open=!0,F(this,`syn-after-show`)}async hide(){if(this.open)return this.open=!1,F(this,`syn-after-hide`)}reposition(){this.popup.reposition()}addOpenListeners(){this.panel.addEventListener(`syn-select`,this.handlePanelSelect),this.getContainingModalHost()?.modal?.activateExternal(),`CloseWatcher`in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide(),this.focusOnTrigger()}):this.panel.addEventListener(`keydown`,this.handleKeyDown),document.addEventListener(`keydown`,this.handleDocumentKeyDown),document.addEventListener(`mousedown`,this.handleDocumentMouseDown)}removeOpenListeners(){this.panel&&(this.panel.removeEventListener(`syn-select`,this.handlePanelSelect),this.panel.removeEventListener(`keydown`,this.handleKeyDown)),this.getContainingModalHost()?.modal?.deactivateExternal(),document.removeEventListener(`keydown`,this.handleDocumentKeyDown),document.removeEventListener(`mousedown`,this.handleDocumentMouseDown),this.closeWatcher?.destroy()}async handleOpenChange(){if(this.disabled){this.open=!1;return}if(this.updateAccessibleTrigger(),this.open){this.emit(`syn-show`),this.addOpenListeners(),await L(this),this.panel.hidden=!1,this.popup.active=!0;let{keyframes:e,options:t}=z(this,`dropdown.show`,{dir:this.localize.dir()});await I(this.popup.popup,e,t),this.emit(`syn-after-show`)}else{this.emit(`syn-hide`),this.removeOpenListeners(),await L(this);let{keyframes:e,options:t}=z(this,`dropdown.hide`,{dir:this.localize.dir()});await I(this.popup.popup,e,t),this.panel.hidden=!0,this.popup.active=!1,this.emit(`syn-after-hide`)}}render(){return g`
    ...
    `}};$a.styles=[w,Qa],$a.dependencies={"syn-popup":V},v([D(`.dropdown`)],$a.prototype,`popup`,2),v([D(`.dropdown__trigger`)],$a.prototype,`trigger`,2),v([D(`.dropdown__panel`)],$a.prototype,`panel`,2),v([T({type:Boolean,reflect:!0})],$a.prototype,`open`,2),v([T({reflect:!0})],$a.prototype,`placement`,2),v([T({type:Boolean,reflect:!0})],$a.prototype,`disabled`,2),v([T({attribute:`stay-open-on-select`,type:Boolean,reflect:!0})],$a.prototype,`stayOpenOnSelect`,2),v([T({attribute:!1})],$a.prototype,`containingElement`,2),v([T({type:Number})],$a.prototype,`distance`,2),v([T({type:Number})],$a.prototype,`skidding`,2),v([T({reflect:!0})],$a.prototype,`sync`,2),v([C(`open`,{waitUntilFirstUpdate:!0})],$a.prototype,`handleOpenChange`,1),R(`dropdown.show`,{keyframes:[{opacity:0,scale:.9},{opacity:1,scale:1}],options:{duration:100,easing:`ease`}}),R(`dropdown.hide`,{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.9}],options:{duration:100,easing:`ease`}}),$a.define(`syn-dropdown`);var eo=h`
  :host {
    --size: 25rem;
    --header-spacing: var(--syn-spacing-large) var(--syn-spacing-x-small) var(--syn-spacing-large) var(--syn-spacing-large);
    --body-spacing: var(--syn-spacing-medium) var(--syn-spacing-large);
...
`;function to(e){return e.charAt(0).toUpperCase()+e.slice(1)}var no=class extends O{constructor(){super(...arguments),this.hasSlotController=new M(this,`footer`),this.localize=new j(this),this.modal=new Ua(this),this.isVisible=!1,this.open=!1,this.label=``,this.placement=`end`,this.contained=!1,this.noHeader=!1,this.handleDocumentKeyDown=e=>{this.contained||e.key===`Escape`&&this.modal.isActive()&&this.open&&(e.stopImmediatePropagation(),this.requestClose(`keyboard`))}}firstUpdated(){this.drawer.hidden=!this.isVisible&&!this.open,this.open&&(this.addOpenListeners(),this.contained||(this.modal.activate(),Dr(this)))}disconnectedCallback(){super.disconnectedCallback(),Or(this),this.removeOpenListeners()}requestClose(e){if(this.emit(`syn-request-close`,{cancelable:!0,detail:{source:e}}).defaultPrevented){let e=z(this,`drawer.denyClose`,{dir:this.localize.dir()});I(this.panel,e.keyframes,e.options);return}this.hide()}addOpenListeners(){`CloseWatcher`in window?(this.closeWatcher?.destroy(),this.contained||(this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose(`keyboard`))):document.addEventListener(`keydown`,this.handleDocumentKeyDown)}removeOpenListeners(){document.removeEventListener(`keydown`,this.handleDocumentKeyDown),this.closeWatcher?.destroy()}async handleOpenChange(){if(this.open){this.emit(`syn-show`),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.contained||(this.modal.activate(),Dr(this));let e=this.querySelector(`[autofocus]`);e&&e.removeAttribute(`autofocus`),await Promise.all([L(this.drawer),L(this.overlay)]),this.drawer.hidden=!1,requestAnimationFrame(()=>{this.emit(`syn-initial-focus`,{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute(`autofocus`,``)});let t=z(this,`drawer.show${to(this.placement)}`,{dir:this.localize.dir()}),n=z(this,`drawer.overlay.show`,{dir:this.localize.dir()});await Promise.all([I(this.panel,t.keyframes,t.options),I(this.overlay,n.keyframes,n.options)]),this.emit(`syn-after-show`)}else{gn(this),this.emit(`syn-hide`),this.removeOpenListeners(),this.contained||(this.modal.deactivate(),Or(this)),await Promise.all([L(this.drawer),L(this.overlay)]);let e=z(this,`drawer.hide${to(this.placement)}`,{dir:this.localize.dir()}),t=z(this,`drawer.overlay.hide`,{dir:this.localize.dir()});await Promise.all([I(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),I(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.drawer.hidden=!this.isVisible,this.overlay.hidden=!1,this.panel.hidden=!1;let n=this.originalTrigger;typeof n?.focus==`function`&&setTimeout(()=>n.focus()),this.emit(`syn-after-hide`)}}handleNoModalChange(){this.open&&!this.contained&&(this.modal.activate(),Dr(this)),this.open&&this.contained&&(this.modal.deactivate(),Or(this))}async show(){if(!this.open)return this.open=!0,F(this,`syn-after-show`)}async hide(){if(this.open)return this.open=!1,F(this,`syn-after-hide`)}forceVisibility(e){this.isVisible=e,this.drawer.hidden=!e&&!this.open}render(){return g`
      <div
        part="base"
    ...
    `}};no.styles=[w,eo],no.dependencies={"syn-icon-button":P},v([E()],no.prototype,`isVisible`,2),v([D(`.drawer`)],no.prototype,`drawer`,2),v([D(`.drawer__panel`)],no.prototype,`panel`,2),v([D(`.drawer__overlay`)],no.prototype,`overlay`,2),v([T({type:Boolean,reflect:!0})],no.prototype,`open`,2),v([T({reflect:!0})],no.prototype,`label`,2),v([T({reflect:!0})],no.prototype,`placement`,2),v([T({type:Boolean,reflect:!0})],no.prototype,`contained`,2),v([T({attribute:`no-header`,type:Boolean,reflect:!0})],no.prototype,`noHeader`,2),v([C(`open`,{waitUntilFirstUpdate:!0})],no.prototype,`handleOpenChange`,1),v([C(`contained`,{waitUntilFirstUpdate:!0})],no.prototype,`handleNoModalChange`,1),R(`drawer.showTop`,{keyframes:[{opacity:0,translate:`0 -100%`},{opacity:1,translate:`0 0`}],options:{duration:250,easing:`ease`}}),R(`drawer.hideTop`,{keyframes:[{opacity:1,translate:`0 0`},{opacity:0,translate:`0 -100%`}],options:{duration:250,easing:`ease`}}),R(`drawer.showEnd`,{keyframes:[{opacity:0,translate:`100%`},{opacity:1,translate:`0`}],rtlKeyframes:[{opacity:0,translate:`-100%`},{opacity:1,translate:`0`}],options:{duration:250,easing:`ease`}}),R(`drawer.hideEnd`,{keyframes:[{opacity:1,translate:`0`},{opacity:0,translate:`100%`}],rtlKeyframes:[{opacity:1,translate:`0`},{opacity:0,translate:`-100%`}],options:{duration:250,easing:`ease`}}),R(`drawer.showBottom`,{keyframes:[{opacity:0,translate:`0 100%`},{opacity:1,translate:`0 0`}],options:{duration:250,easing:`ease`}}),R(`drawer.hideBottom`,{keyframes:[{opacity:1,translate:`0 0`},{opacity:0,translate:`0 100%`}],options:{duration:250,easing:`ease`}}),R(`drawer.showStart`,{keyframes:[{opacity:0,translate:`-100%`},{opacity:1,translate:`0`}],rtlKeyframes:[{opacity:0,translate:`100%`},{opacity:1,translate:`0`}],options:{duration:250,easing:`ease`}}),R(`drawer.hideStart`,{keyframes:[{opacity:1,translate:`0`},{opacity:0,translate:`-100%`}],rtlKeyframes:[{opacity:1,translate:`0`},{opacity:0,translate:`100%`}],options:{duration:250,easing:`ease`}}),R(`drawer.denyClose`,{keyframes:[{scale:1},{scale:1.01},{scale:1}],options:{duration:250}}),R(`drawer.overlay.show`,{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}}),R(`drawer.overlay.hide`,{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}}),no.define(`syn-drawer`);var ro=h`
  :host {
    --sticky-position: 0;
...
`,io=class extends O{constructor(){super(...arguments),this.hasSlotController=new M(this,`[default]`,`logo`,`label`,`meta-navigation`,`navigation`),this.localize=new j(this),this.isSideNavAnimating=!1,this.label=``,this.burgerMenu=`hidden`,this.sticky=!1}toggleBurgerMenu(){switch(this.burgerMenu){case`closed`:this.burgerMenu=`open`;break;case`open`:this.burgerMenu=`closed`}}handleBurgerMenuToggle(){this.sideNav&&this.sideNav.variant==="default"&&!this.isSideNavAnimating&&(this.sideNav.open=!this.sideNav.open),this.isSideNavAnimating||this.toggleBurgerMenu()}updateBurgerMenuBasedOnSideNav(){this.sideNav&&(this.burgerMenu=this.sideNav.variant==="default"?this.sideNav.open?`open`:`closed`:`hidden`)}updateMetaNavigation(){let e=[];this.metaNavigationSlot.assignedElements({flatten:!0}).forEach(t=>{if(t.tagName.toLowerCase()===`syn-divider`)e.push(t);else{let n=t.querySelectorAll(`:scope > syn-divider`);n.length&&e.push(...n)}}),e.filter(e=>e.hasAttribute(`vertical`)).forEach(e=>{e.style.cssText+=`--spacing: var(--syn-spacing-x-small); align-self: center; display: flex; height: var(--metanavigation-item-size);`})}handleBurgerMenu(){let e=`syn-burger-menu-${this.burgerMenu}`;this.emit(e)}connectedCallback(){super.connectedCallback(),this.mutationObserver=new MutationObserver(()=>this.updateBurgerMenuBasedOnSideNav())}firstUpdated(){this.updateComplete.then(()=>{let e=document.querySelector(`syn-side-nav`);this.connectSideNavigation(e)})}disconnectedCallback(){super.disconnectedCallback(),this.mutationObserver.disconnect()}connectSideNavigation(e){if(this.mutationObserver.disconnect(),this.sideNav=e||document.querySelector(`syn-side-nav`),this.sideNav){this.updateBurgerMenuBasedOnSideNav(),this.mutationObserver.observe(this.sideNav,{attributeFilter:[`open`,`variant`],attributes:!0});let e=e=>{e.target===this.sideNav&&(this.isSideNavAnimating=!0)},t=e=>{e.target===this.sideNav&&(this.isSideNavAnimating=!1)};this.sideNav.addEventListener(`syn-show`,e),this.sideNav.addEventListener(`syn-hide`,e),this.sideNav.addEventListener(`syn-after-show`,t),this.sideNav.addEventListener(`syn-after-hide`,t)}}render(){let e=this.hasSlotController.test(`navigation`),t=this.burgerMenu!==`hidden`;return Cn`
    ...
    `}};io.styles=[w,ro],io.dependencies={"syn-icon":A},v([D(`slot[name="meta-navigation"]`)],io.prototype,`metaNavigationSlot`,2),v([T()],io.prototype,`label`,2),v([T({attribute:`burger-menu`,reflect:!0})],io.prototype,`burgerMenu`,2),v([T({reflect:!0,type:Boolean})],io.prototype,`sticky`,2),v([E()],io.prototype,`sideNav`,2),v([C(`burgerMenu`,{waitUntilFirstUpdate:!0})],io.prototype,`handleBurgerMenu`,1),io.define(`syn-header`);var ao=h`
  :host {
    display: block;
  }
...
`,co=(e,t,n={})=>{let{maximumFractionDigits:r,minimumFractionDigits:i,...a}=n,o=(t===`any`||!t?1:+t).toString().split(`.`)[1]?.length||0,s,c,l=typeof i==`number`,u=typeof r==`number`;return l&&!u?(s=i,c=i):u&&!l?(s=r,c=r):l&&u&&(s=Math.min(i,r),c=Math.max(i,r)),o>(s||0)&&(s=o),o>(c||0)&&(c=o),s!==void 0&&s>100&&(s=100),c!==void 0&&c>100&&(c=100),new Intl.NumberFormat(`en-US`,{maximumFractionDigits:c,minimumFractionDigits:s,useGrouping:!1,...a}).format(e)},lo=(e,t)=>{let n=e._$AN;if(n===void 0)return!1;for(let e of n)e._$AO?.(t,!1),lo(e,t);return!0},uo=e=>{let t,n;do{if((t=e._$AM)===void 0)break;n=t._$AN,n.delete(e),e=t}while(n?.size===0)},fo=e=>{for(let t;t=e._$AM;e=t){let n=t._$AN;if(n===void 0)t._$AN=n=new Set;else if(n.has(e))break;n.add(e),ho(t)}};function po(e){this._$AN===void 0?this._$AM=e:(uo(this),this._$AM=e,fo(this))}function mo(e,t=!1,n=0){let r=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0){if(t){if(Array.isArray(r))for(let e=n;e<r.length;e++)lo(r[e],!1),uo(r[e]);else r!=null&&(lo(r,!1),uo(r))}else lo(this,e)}}var ho=e=>{e.type==Dt.CHILD&&(e._$AP??=mo,e._$AQ??=po)},go=class extends kt{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,n){super._$AT(e,t,n),fo(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(lo(this,e),uo(this))}setValue(e){if(qt(this._$Ct))this._$Ct._$AI(e,this);else{let t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}},_o=Ot(class extends go{constructor(e){if(super(e),this.handlePointerDown=e=>{e.button!==0||this.host.disabled||this.spinOnLongPressCallback(e)},this.handlePointerUp=e=>{e?.preventDefault(),e?.stopPropagation(),this.timeout&&this.callbacks.start(),this.stopSpinningAndCleanUp(),this.callbacks.end(),document.removeEventListener(`pointerup`,this.handlePointerUp)},e.type!==Dt.ELEMENT||!(e.element instanceof HTMLButtonElement))throw Error("The `longPress` directive must be used on an HTMLButtonElement.")}render(e){return _}update(e,[t]){return this.callbacks===void 0&&this.host===void 0&&(this.host=e.element,this.callbacks={...t},this.host.addEventListener(`pointerdown`,this.handlePointerDown)),Re}reconnected(){this.host.addEventListener(`pointerdown`,this.handlePointerDown)}disconnected(){this.stopSpinningAndCleanUp(),this.host.removeEventListener(`pointerdown`,this.handlePointerDown),document.removeEventListener(`pointerup`,this.handlePointerUp)}spinOnLongPressCallback(e){e.preventDefault(),e.stopPropagation(),this.timeout=setTimeout(()=>{this.timeout=void 0,this.interval=setInterval(()=>{this.callbacks.start()},50)},500),document.addEventListener(`pointerup`,this.handlePointerUp),this.observer?.disconnect(),this.observer=new MutationObserver(e=>{e.forEach(e=>{e.attributeName===`disabled`&&this.stopSpinningAndCleanUp()})}),this.observer.observe(this.host,{attributes:!0})}stopSpinningAndCleanUp(){clearInterval(this.interval),clearTimeout(this.timeout),this.observer?.disconnect()}}),vo,yo,bo,xo,W=class extends O{constructor(){super(...arguments),vt(this,yo),this.formControlController=new a(this,{assumeInteractionOn:[`syn-blur`,`syn-input`]}),this.hasSlotController=new M(this,`help-text`,`label`,`prefix`,`suffix`),this.localize=new j(this),this.hasFocus=!1,this.title=``,this.__numberInput=Object.assign(document.createElement(`input`),{type:`number`}),this.__dateInput=Object.assign(document.createElement(`input`),{type:`date`}),this.type=`text`,this.name=``,this.value=``,this.defaultValue=``,this.size=`medium`,this.label=``,this.helpText=``,this.clearable=!1,this.disabled=!1,this.placeholder=``,this.readonly=!1,this.passwordToggle=!1,this.passwordVisible=!1,this.noSpinButtons=!1,this.form=``,this.required=!1,this.spellcheck=!0,vt(this,vo,ot)}set numericStrategy(e){switch(typeof e){case`string`:b(this,vo,e===`modern`?ot:at);break;case`object`:b(this,vo,st(e));break;default:b(this,vo,at)}}get numericStrategy(){return y(this,vo)}get valueAsDate(){return this.__dateInput.type=this.type,this.__dateInput.value=this.value,this.input?.valueAsDate||this.__dateInput.valueAsDate}set valueAsDate(e){this.__dateInput.type=this.type,this.__dateInput.valueAsDate=e,this.value=this.__dateInput.value}get valueAsNumber(){return this.__numberInput.value=this.value,this.input?.valueAsNumber||this.__numberInput.valueAsNumber}set valueAsNumber(e){this.__numberInput.valueAsNumber=e,this.value=this.__numberInput.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleStep(){this.handleInput(),this.input.focus()}handleStepUp(){this.stepUp(),this.handleStep()}handleStepDown(){this.stepDown(),this.handleStep()}isDecrementDisabled(){if(this.disabled||this.readonly)return!0;if(this.min===void 0||this.min===null)return!1;let e=typeof this.min==`string`?parseFloat(this.min):this.min;return parseFloat(this.value)<=e}isIncrementDisabled(){if(this.disabled||this.readonly)return!0;if(this.max===void 0||this.max===null)return!1;let e=typeof this.max==`string`?parseFloat(this.max):this.max;return parseFloat(this.value)>=e}handleNumericStrategyAutoClamp(){let{valueAsNumber:e,max:t,min:n}=this;if(!y(this,vo).autoClamp)return{eventObj:null,shouldClamp:!1,nextValue:e};let r=typeof n==`string`?parseFloat(n):n,i=typeof t==`string`?parseFloat(t):t,a=e,o=``;a<r?(a=r,o=`min`):a>i&&(a=i,o=`max`);let s=o?{detail:{clampedTo:o,lastUserValue:e}}:null;return{eventObj:s,shouldClamp:!!s,nextValue:a}}handleChange(){if(this.type===`number`&&(x(this,yo,xo).call(this)||y(this,vo).autoClamp)){let{eventObj:e,shouldClamp:t,nextValue:n}=this.handleNumericStrategyAutoClamp(),r=y(this,vo).autoClamp?n:this.valueAsNumber;if(isNaN(r)){let{max:e,min:t}=this;r=e==null?t==null?0:typeof t==`string`?parseFloat(t):+t:typeof e==`string`?parseFloat(e):+e}this.value=x(this,yo,xo).call(this)?x(this,yo,bo).call(this,r):r.toString(),this.updateComplete.then(()=>{t&&e&&this.emit(`syn-clamp`,e),this.formControlController.updateValidity(),this.emit(`syn-change`)});return}this.value=this.input.value,this.emit(`syn-change`)}handleClearClick(e){e.preventDefault(),this.value!==``&&(this.value=``,this.emit(`syn-clear`),this.emit(`syn-input`),this.emit(`syn-change`)),this.input.focus()}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleInput(){this.value=this.input.value,this.formControlController.updateValidity(),this.emit(`syn-input`)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleKeyDown(e){if(y(this,vo).noStepAlign&&this.type===`number`){let{key:t}=e;if(t===`ArrowUp`||t===`ArrowDown`){e.preventDefault(),e.stopPropagation(),t===`ArrowUp`?this.handleStepUp():t===`ArrowDown`&&this.handleStepDown(),this.handleChange();return}}let t=e.metaKey||e.ctrlKey||e.shiftKey||e.altKey;e.key===`Enter`&&!t&&setTimeout(()=>{!e.defaultPrevented&&!e.isComposing&&this.formControlController.submit()})}handlePasswordToggle(){this.passwordVisible=!this.passwordVisible}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStepChange(){y(this,vo).noStepValidation||(this.input.step=String(this.step),this.formControlController.updateValidity())}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(e){this.input.focus(e)}blur(){this.input.blur()}select(){this.input.select()}setSelectionRange(e,t,n=`none`){this.input.setSelectionRange(e,t,n)}setRangeText(e,t,n,r=`preserve`){let i=t??this.input.selectionStart,a=n??this.input.selectionEnd;this.input.setRangeText(e,i,a,r),this.value!==this.input.value&&(this.value=this.input.value)}showPicker(){`showPicker`in HTMLInputElement.prototype&&this.input.showPicker()}stepUp(){if(y(this,vo).noStepAlign){let{max:e,step:t,valueAsNumber:n}=this,r=Number.isNaN(n)?0:n,i=typeof this.min==`string`?parseFloat(this.min):this.min,a=typeof e==`string`?parseFloat(e):e,o=r+(t==null||t===`any`?1:typeof t==`number`?t:parseFloat(t));typeof a==`number`&&a<o?o=a:typeof i==`number`&&i>o&&(o=i);let s=x(this,yo,xo).call(this)?x(this,yo,bo).call(this,o):o.toString();this.input.value=s,this.value!==this.input.value&&(this.value=this.input.value);return}this.input.stepUp(),this.value!==this.input.value&&(this.value=this.input.value)}stepDown(){if(y(this,vo).noStepAlign){let{min:e,max:t,step:n,valueAsNumber:r}=this,i=Number.isNaN(r)?0:r,a=typeof e==`string`?parseFloat(e):e,o=typeof t==`string`?parseFloat(t):t,s=i-(n==null||n===`any`?1:typeof n==`number`?n:parseFloat(n));typeof a==`number`&&a>s?s=a:typeof o==`number`&&o<s&&(s=o);let c=x(this,yo,xo).call(this)?x(this,yo,bo).call(this,s):s.toString();this.input.value=c,this.value!==this.input.value&&(this.value=this.input.value);return}this.input.stepDown(),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){let e=this.hasSlotController.test(`label`),t=this.hasSlotController.test(`help-text`),n=this.hasSlotController.test(`prefix`),r=this.hasSlotController.test(`suffix`),i=this.label?!0:!!e,a=this.helpText?!0:!!t,o=this.clearable&&!this.disabled&&!this.readonly&&(typeof this.value==`number`||this.value.length>0);return g`
      <div
        part="form-control"
        ...
        <div part="form-control-input" class="form-control-input">
          ...
          >
            ...
            <input
              ...
              min=${N(this.min)}
              max=${N(this.max)}
              step=${N(y(this,vo).noStepValidation?`any`:this.step)}
              .value=${Zn(this.value)}
    ...
    `}};vo=new WeakMap,yo=new WeakSet,bo=function(e){return co(e,this.step,{maximumFractionDigits:this.maxFractionDigits,minimumFractionDigits:this.minFractionDigits,...this.numberFormatterOptions})},xo=function(){let{numberFormatterOptions:e,maxFractionDigits:t,minFractionDigits:n,step:r}=this;return t!==void 0&&!Number.isNaN(t)||n!==void 0&&!Number.isNaN(n)||typeof e==`object`||((r===`any`||!r?1:+r).toString().split(`.`)[1]?.length||0)>0},W.styles=[w,qn,so],W.dependencies={"syn-icon":A,"syn-divider":Aa},v([D(`.input__control`)],W.prototype,`input`,2),v([E()],W.prototype,`hasFocus`,2),v([T({reflect:!0})],W.prototype,`title`,2),v([T({reflect:!0})],W.prototype,`type`,2),v([T()],W.prototype,`name`,2),v([T()],W.prototype,`value`,2),v([Xn()],W.prototype,`defaultValue`,2),v([T({reflect:!0})],W.prototype,`size`,2),v([T()],W.prototype,`label`,2),v([T({attribute:`help-text`})],W.prototype,`helpText`,2),v([T({type:Boolean})],W.prototype,`clearable`,2),v([T({type:Boolean,reflect:!0})],W.prototype,`disabled`,2),v([T()],W.prototype,`placeholder`,2),v([T({type:Boolean,reflect:!0})],W.prototype,`readonly`,2),v([T({attribute:`password-toggle`,type:Boolean})],W.prototype,`passwordToggle`,2),v([T({attribute:`password-visible`,type:Boolean})],W.prototype,`passwordVisible`,2),v([T({attribute:`no-spin-buttons`,type:Boolean,reflect:!0})],W.prototype,`noSpinButtons`,2),v([T({reflect:!0})],W.prototype,`form`,2),v([T({type:Boolean,reflect:!0})],W.prototype,`required`,2),v([T()],W.prototype,`pattern`,2),v([T({type:Number})],W.prototype,`minlength`,2),v([T({type:Number})],W.prototype,`maxlength`,2),v([T()],W.prototype,`min`,2),v([T()],W.prototype,`max`,2),v([T()],W.prototype,`step`,2),v([T()],W.prototype,`autocapitalize`,2),v([T({attribute:`autocorrect`,reflect:!0,converter:{fromAttribute:e=>e===``||e===`on`,toAttribute:e=>e?`on`:`off`},type:Boolean})],W.prototype,`autocorrect`,2),v([T()],W.prototype,`autocomplete`,2),v([T({type:Boolean})],W.prototype,`autofocus`,2),v([T()],W.prototype,`enterkeyhint`,2),v([T({type:Boolean,converter:{fromAttribute:e=>!(!e||e===`false`),toAttribute:e=>e?`true`:`false`}})],W.prototype,`spellcheck`,2),v([T()],W.prototype,`inputmode`,2),v([T({attribute:!1,reflect:!1,type:Object})],W.prototype,`numberFormatterOptions`,2),v([T({attribute:`min-fraction-digits`,type:Number})],W.prototype,`minFractionDigits`,2),v([T({attribute:`max-fraction-digits`,type:Number})],W.prototype,`maxFractionDigits`,2),v([T({attribute:`numeric-strategy`,converter:{fromAttribute:e=>e===`modern`?ot:at},type:Object})],W.prototype,`numericStrategy`,1),v([C(`disabled`,{waitUntilFirstUpdate:!0})],W.prototype,`handleDisabledChange`,1),v([C(`step`,{waitUntilFirstUpdate:!0})],W.prototype,`handleStepChange`,1),v([C(`value`,{waitUntilFirstUpdate:!0})],W.prototype,`handleValueChange`,1),W=v([S(`SynInput`)],W),W.define(`syn-input`),P.define(`syn-icon-button`);var So=h`
  /* stylelint-disable no-descending-specificity */
  :host {
    --submenu-offset: -2px;
...
`,Co=()=>new wo,wo=class{},To=new WeakMap,Eo=Ot(class extends go{render(e){return _}update(e,[t]){let n=t!==this.G;return n&&this.rt(void 0),(n||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),_}rt(e){if(this.G!==void 0){if(this.isConnected||(e=void 0),typeof this.G==`function`){let t=this.ht??globalThis,n=To.get(t);n===void 0&&(n=new WeakMap,To.set(t,n)),n.get(this.G)!==void 0&&this.G.call(this.ht,void 0),n.set(this.G,e),e!==void 0&&this.G.call(this.ht,e)}else this.G.value=e}}get lt(){return typeof this.G==`function`?To.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),Do=class{constructor(e,t){this.popupRef=Co(),this.enableSubmenuTimer=-1,this.hasGlobalDismissListeners=!1,this.isConnected=!1,this.isPopupConnected=!1,this.skidding=0,this.submenuOpenDelay=100,this.handleMouseMove=e=>{this.host.style.setProperty(`--safe-triangle-cursor-x`,`${e.clientX}px`),this.host.style.setProperty(`--safe-triangle-cursor-y`,`${e.clientY}px`)},this.handleMouseOver=()=>{this.hasSlotController.test(`submenu`)&&this.enableSubmenu()},this.handleHostMouseLeave=e=>{this.isWithinSubmenuInteractionTree(e.relatedTarget)||this.disableSubmenu()},this.handleKeyDown=e=>{switch(e.key){case`Escape`:case`Tab`:this.disableSubmenu();break;case`ArrowLeft`:e.target!==this.host&&(e.preventDefault(),e.stopPropagation(),this.host.focus(),this.disableSubmenu());break;case`ArrowRight`:case`Enter`:case` `:this.handleSubmenuEntry(e)}},this.handleClick=e=>{e.target===this.host?(e.preventDefault(),e.stopPropagation()):e.target instanceof Element&&(e.target.tagName===`syn-menu-item`||e.target.role?.startsWith(`menuitem`))&&this.disableSubmenu()},this.handleFocusOut=e=>{e.relatedTarget&&e.relatedTarget instanceof Element&&this.host.contains(e.relatedTarget)||this.disableSubmenu()},this.handleWindowBlur=()=>{this.disableSubmenu()},this.handlePageHide=()=>{this.disableSubmenu()},this.handleVisibilityChange=()=>{document.visibilityState===`hidden`&&this.disableSubmenu()},this.handleDocumentKeyDown=e=>{e.key===`Escape`&&this.isExpanded()&&(this.disableSubmenu(),e.stopPropagation())},this.handlePopupMouseover=e=>{e.stopPropagation()},this.handlePopupMouseLeave=e=>{this.isWithinSubmenuInteractionTree(e.relatedTarget)||this.disableSubmenu()},this.handlePopupReposition=()=>{let e=this.host.renderRoot.querySelector(`slot[name='submenu']`)?.assignedElements({flatten:!0}).filter(e=>e.localName===`syn-menu`)[0],t=getComputedStyle(this.host).direction===`rtl`;if(!e)return;let{left:n,top:r,width:i,height:a}=e.getBoundingClientRect();this.host.style.setProperty(`--safe-triangle-submenu-start-x`,`${t?n+i:n}px`),this.host.style.setProperty(`--safe-triangle-submenu-start-y`,`${r}px`),this.host.style.setProperty(`--safe-triangle-submenu-end-x`,`${t?n+i:n}px`),this.host.style.setProperty(`--safe-triangle-submenu-end-y`,`${r+a}px`)},(this.host=e).addController(this),this.hasSlotController=t}hostConnected(){this.hasSlotController.test(`submenu`)&&!this.host.disabled&&this.addListeners()}hostDisconnected(){this.removeListeners()}hostUpdated(){this.hasSlotController.test(`submenu`)&&!this.host.disabled?(this.addListeners(),this.updateSkidding()):this.removeListeners()}addListeners(){this.isConnected||=(this.host.addEventListener(`mousemove`,this.handleMouseMove),this.host.addEventListener(`mouseover`,this.handleMouseOver),this.host.addEventListener(`mouseleave`,this.handleHostMouseLeave),this.host.addEventListener(`keydown`,this.handleKeyDown),this.host.addEventListener(`click`,this.handleClick),this.host.addEventListener(`focusout`,this.handleFocusOut),!0),this.isPopupConnected||this.popupRef.value&&(this.popupRef.value.addEventListener(`mouseover`,this.handlePopupMouseover),this.popupRef.value.addEventListener(`mouseleave`,this.handlePopupMouseLeave),this.popupRef.value.addEventListener(`syn-reposition`,this.handlePopupReposition),this.isPopupConnected=!0)}removeListeners(){this.isConnected&&=(this.host.removeEventListener(`mousemove`,this.handleMouseMove),this.host.removeEventListener(`mouseover`,this.handleMouseOver),this.host.removeEventListener(`mouseleave`,this.handleHostMouseLeave),this.host.removeEventListener(`keydown`,this.handleKeyDown),this.host.removeEventListener(`click`,this.handleClick),this.host.removeEventListener(`focusout`,this.handleFocusOut),!1),this.isPopupConnected&&this.popupRef.value&&(this.popupRef.value.removeEventListener(`mouseover`,this.handlePopupMouseover),this.popupRef.value.removeEventListener(`mouseleave`,this.handlePopupMouseLeave),this.popupRef.value.removeEventListener(`syn-reposition`,this.handlePopupReposition),this.isPopupConnected=!1),this.removeGlobalDismissListeners()}addGlobalDismissListeners(){this.hasGlobalDismissListeners||=(document.addEventListener(`keydown`,this.handleDocumentKeyDown),window.addEventListener(`blur`,this.handleWindowBlur),window.addEventListener(`pagehide`,this.handlePageHide),document.addEventListener(`visibilitychange`,this.handleVisibilityChange),!0)}removeGlobalDismissListeners(){this.hasGlobalDismissListeners&&=(document.removeEventListener(`keydown`,this.handleDocumentKeyDown),window.removeEventListener(`blur`,this.handleWindowBlur),window.removeEventListener(`pagehide`,this.handlePageHide),document.removeEventListener(`visibilitychange`,this.handleVisibilityChange),!1)}isWithinSubmenuInteractionTree(e){if(!(e instanceof Node))return!1;if(this.host.contains(e)||this.popupRef.value?.contains(e))return!0;let t=e.getRootNode();return t instanceof ShadowRoot&&this.isWithinSubmenuInteractionTree(t.host)}handleSubmenuEntry(e){let t=this.host.renderRoot.querySelector(`slot[name='submenu']`);if(!t){console.error(`Cannot activate a submenu if no corresponding menuitem can be found.`,this);return}let n=null;for(let e of t.assignedElements())if(n=e.querySelectorAll(`syn-menu-item, [role^='menuitem']`),n.length!==0)break;if(n&&n.length!==0){n[0].setAttribute(`tabindex`,`0`);for(let e=1;e!==n.length;++e)n[e].setAttribute(`tabindex`,`-1`);this.popupRef.value&&(e.preventDefault(),e.stopPropagation(),this.popupRef.value.active?n[0]instanceof HTMLElement&&n[0].focus():(this.enableSubmenu(!1),this.host.updateComplete.then(()=>{n[0]instanceof HTMLElement&&n[0].focus()}),this.host.requestUpdate()))}}setSubmenuState(e){this.popupRef.value&&this.popupRef.value.active!==e&&(this.popupRef.value.active=e,e?this.addGlobalDismissListeners():this.removeGlobalDismissListeners(),this.host.requestUpdate())}enableSubmenu(e=!0){e?(window.clearTimeout(this.enableSubmenuTimer),this.enableSubmenuTimer=window.setTimeout(()=>{this.setSubmenuState(!0)},this.submenuOpenDelay)):this.setSubmenuState(!0)}disableSubmenu(){window.clearTimeout(this.enableSubmenuTimer),this.setSubmenuState(!1)}updateSkidding(){if(!this.host.parentElement?.computedStyleMap)return;let e=this.host.parentElement.computedStyleMap(),t=[`padding-top`,`border-top-width`,`margin-top`].reduce((t,n)=>{let r=e.get(n)??new CSSUnitValue(0,`px`);return t-(r instanceof CSSUnitValue?r:new CSSUnitValue(0,`px`)).to(`px`).value},0);this.skidding=t}isExpanded(){return this.popupRef.value?this.popupRef.value.active:!1}renderSubmenu(){let e=getComputedStyle(this.host).direction===`rtl`;return this.isConnected?g`
    ...
    `}};ko.styles=[w,So],ko.dependencies={"syn-icon":A,"syn-popup":V,"syn-spinner":Ln},v([D(`slot:not([name])`)],ko.prototype,`defaultSlot`,2),v([D(`.menu-item`)],ko.prototype,`menuItem`,2),v([T()],ko.prototype,`type`,2),v([T({type:Boolean,reflect:!0})],ko.prototype,`checked`,2),v([T()],ko.prototype,`value`,2),v([T({type:Boolean,reflect:!0})],ko.prototype,`loading`,2),v([T({type:Boolean,reflect:!0})],ko.prototype,`disabled`,2),v([C(`checked`)],ko.prototype,`handleCheckedChange`,1),v([C(`disabled`)],ko.prototype,`handleDisabledChange`,1),v([C(`type`)],ko.prototype,`handleTypeChange`,1),ko=v([Oo([`type`,`loading`],{waitUntilFirstUpdated:!0})],ko),ko.define(`syn-menu-item`);var Ao=h`
  :host {
    background: var(--syn-panel-background-color);
    border: solid var(--syn-panel-border-width) var(--syn-panel-border-color);
    border-radius: var(--syn-input-border-radius-medium);
...
`,jo=class extends O{constructor(){super(...arguments),this.hasMenuItemsWithCheckmarks=!1,this.checkmarkStyledItems=new Set,this.updateCheckMarksByChildPropChange=e=>{e.stopImmediatePropagation(),this.handleUpdateCheckmarks(this.getAllItems())}}handleUpdateCheckmarks(e){this.hasMenuItemsWithCheckmarks=e.some(e=>e.type===`checkbox`||e.loading),this.syncCheckmarkVisibility(e)}syncCheckmarkVisibility(e){if(this.checkmarkStyledItems.forEach(t=>{e.includes(t)||(t.style.removeProperty(`--display-checkmark`),this.checkmarkStyledItems.delete(t))}),this.hasMenuItemsWithCheckmarks){e.forEach(e=>{e.style.removeProperty(`--display-checkmark`),this.checkmarkStyledItems.delete(e)});return}e.forEach(e=>{e.style.setProperty(`--display-checkmark`,`none`),this.checkmarkStyledItems.add(e)})}disconnectedCallback(){this.removeEventListener(`syn-attributes-changed`,this.updateCheckMarksByChildPropChange),this.checkmarkStyledItems.forEach(e=>e.style.removeProperty(`--display-checkmark`)),this.checkmarkStyledItems.clear()}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`menu`),this.addEventListener(`syn-attributes-changed`,this.updateCheckMarksByChildPropChange)}getMenuItemFromEvent(e){let t=e.composedPath(),n=t.find(e=>e instanceof HTMLElement&&this.isMenuItem(e));if(n&&n instanceof HTMLElement&&t.find(e=>e instanceof Element&&e.getAttribute(`role`)===`menu`)===this)return n}handleClick(e){let t=this.getMenuItemFromEvent(e);t&&(t.type===`checkbox`&&(t.checked=!t.checked),this.emit(`syn-select`,{detail:{item:t}}))}handleKeyDown(e){if(e.key===`Enter`||e.key===` `){let t=this.getCurrentItem();e.preventDefault(),e.stopPropagation(),t?.click()}else if([`ArrowDown`,`ArrowUp`,`Home`,`End`].includes(e.key)){let t=this.getAllItems(),n=this.getCurrentItem(),r=n?t.indexOf(n):0;t.length>0&&(e.preventDefault(),e.stopPropagation(),e.key===`ArrowDown`?r++:e.key===`ArrowUp`?r--:e.key===`Home`?r=0:e.key===`End`&&(r=t.length-1),r<0&&(r=t.length-1),r>t.length-1&&(r=0),this.setCurrentItem(t[r]),t[r].focus())}}handleMouseDown(e){let t=this.getMenuItemFromEvent(e);t&&this.setCurrentItem(t)}handleSlotChange(){let e=this.getAllItems();this.handleUpdateCheckmarks(e),e.length>0&&this.setCurrentItem(e[0])}isMenuItem(e){return e.tagName.toLowerCase()===`syn-menu-item`||[`menuitem`,`menuitemcheckbox`,`menuitemradio`].includes(e.getAttribute(`role`)??``)}getMenuItemsFromElement(e){return e.inert?[]:this.isMenuItem(e)?[e]:e.tagName.toLowerCase()===`syn-menu`?[]:[...e.children].flatMap(e=>this.getMenuItemsFromElement(e))}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].flatMap(e=>this.getMenuItemsFromElement(e))}getCurrentItem(){return this.getAllItems().find(e=>e.getAttribute(`tabindex`)===`0`)}setCurrentItem(e){this.getAllItems().forEach(t=>{t.setAttribute(`tabindex`,t===e?`0`:`-1`)})}render(){return g`
      ...
      ></slot>
    `}};jo.styles=[w,Ao],v([D(`slot`)],jo.prototype,`defaultSlot`,2),v([E()],jo.prototype,`hasMenuItemsWithCheckmarks`,2),jo.define(`syn-menu`);var Mo=h`
  :host {
...
`,No=(e,t)=>{e.disabled?e.dataset.originallyDisabled=`true`:delete e.dataset.originallyDisabled,t&&(e.disabled=!0)},Po=class extends O{constructor(){super(...arguments),this.hasSlotController=new M(this,`[default]`,`prefix`,`suffix`,`label`),this.disabled=!1,this.label=``}enableObserver(){this.mutationObserver.observe(this,{attributeFilter:[`disabled`],childList:!0,subtree:!0})}connectedCallback(){super.connectedCallback(),this.mutationObserver=new MutationObserver(e=>{let t=e.filter(e=>e.target===this),n=e.filter(e=>e.target.matches(`syn-option`)),r=t.length>0||n.length>0;r&&this.mutationObserver.disconnect(),n.length>0&&n.forEach(e=>{No(e.target,this.disabled)}),t.length>0&&t.forEach(e=>{e.type===`attributes`&&this.assignedOptions.forEach(e=>{e.disabled=this.disabled?!0:!!e.dataset?.originallyDisabled}),e.type===`childList`&&e.addedNodes.forEach(e=>{e instanceof HTMLElement&&e.matches(`syn-option`)&&No(e,this.disabled)})}),r&&this.updateComplete.then(()=>{this.enableObserver()})}),this.enableObserver()}render(){let{disabled:e}=this,t=this.hasSlotController.test(`label`);return Cn`
    ...
    `}};Po.styles=Mo,Po.dependencies={"syn-divider":Aa},v([Tt({selector:`syn-option`})],Po.prototype,`assignedOptions`,2),v([T({reflect:!0,type:Boolean})],Po.prototype,`disabled`,2),v([T()],Po.prototype,`label`,2),Po.define(`syn-optgroup`);var Fo=h`
  /**
...
`,G=class extends O{constructor(){super(...arguments),this.hasSlotController=new M(this,`[default]`,`children`,`prefix`,`suffix`),this.hasFocus=!1,this.showPrefixOnly=!1,this.currentMarkedChild=!1,this.isMultiLine=!1,this.rel=`noreferrer noopener`,this.current=!1,this.disabled=!1,this.horizontal=!1,this.chevron=!1,this.open=!1,this.divider=!1}isButton(){return!this.href&&!this.hasSlotController.test(`children`)}isLink(){return!!this.href&&!this.hasSlotController.test(`children`)}isAccordion(){return this.hasSlotController.test(`children`)}getNavItemChildren(e){return Array.from(e?.assignedElements({flatten:!0})||[]).map(e=>e.tagName.toLowerCase()===`syn-nav-item`?e:Array.from(e.querySelectorAll(`:scope > syn-nav-item`))).flat()}getAllNestedNavItems(e){let t=this.getNavItemChildren(e),n=t.map(e=>e.getAllNestedNavItems(e.childrenSlot)).flat();return t.concat(n)}handleCurrentMarkedChild(){let e=this.closest(`syn-side-nav`);(!this.open||e?.variant===`rail`)&&(this.currentMarkedChild=this.getAllNestedNavItems(this.childrenSlot).some(e=>e.current))}handleClickButton(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}handleClickSummary(e){e.preventDefault(),e.stopPropagation(),!this.disabled&&(this.open?this.hideDetails():this.showDetails())}hideDetails(){this.open=!1,this.emit(`syn-hide`,{cancelable:!0})}showDetails(){this.open=!0,this.emit(`syn-show`,{cancelable:!0})}handleSlotChange(){let e=getComputedStyle(this).getPropertyValue(`--indentation`);if(e===``){requestAnimationFrame(()=>{this.handleSlotChange()});return}this.handleCurrentMarkedChild();let t=Math.min(parseInt(e,10)+1,2);this.getNavItemChildren(this.childrenSlot).forEach(e=>{e.style.setProperty(`--indentation`,t.toFixed(0))})}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleWidth(e){e.forEach(e=>{requestAnimationFrame(()=>{if(e.contentRect.width<100){let e=this.hasSlotController.test(`prefix`);this.showPrefixOnly=e}else this.showPrefixOnly=!1;this.isMultiLine=e.contentRect.height>48})})}handleHorizontalChange(){this.horizontal?this.resizeObserver.disconnect():this.resizeObserver.observe(this)}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>this.handleWidth(e)),this.horizontal||this.resizeObserver.observe(this)}firstUpdated(e){super.firstUpdated(e),this.mutationObserver=new MutationObserver(()=>{this.childrenSlot&&this.handleCurrentMarkedChild()}),this.mutationObserver.observe(this,{attributeFilter:[`current`,`open`],childList:!0,subtree:!0})}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect(),this.mutationObserver?.disconnect()}blur(){this.control.blur()}click(){this.control.click()}focus(e){this.control.focus(e)}render(){let e=this.isButton(),t=this.isLink(),n=this.isAccordion(),r=this.closest(`syn-side-nav`),i=this.currentMarkedChild&&!this.open||this.currentMarkedChild&&this.open&&r?.variant===`rail`&&!r?.open,a=xn`button`;n?a=xn`summary`:t&&(a=xn`a`);let o=(this.chevron||n)&&!this.horizontal,s;n?s=this.handleClickSummary:e&&(s=this.handleClickButton);let c=Cn`
      ...
      >
        ...
        ${this.divider&&!this.horizontal?Cn`<syn-divider class="divider" part="divider"></syn-divider>`:``}
    ...
    `:c}};G.styles=[w,Fo],G.dependencies={"syn-divider":Aa,"syn-icon":A},v([E()],G.prototype,`hasFocus`,2),v([E()],G.prototype,`showPrefixOnly`,2),v([E()],G.prototype,`currentMarkedChild`,2),v([E()],G.prototype,`isMultiLine`,2),v([D(`slot[name="children"]`)],G.prototype,`childrenSlot`,2),v([D(`.nav-item`)],G.prototype,`control`,2),v([T({reflect:!0,type:String})],G.prototype,`href`,2),v([T()],G.prototype,`target`,2),v([T()],G.prototype,`rel`,2),v([T({reflect:!0,type:Boolean})],G.prototype,`current`,2),v([T({reflect:!0,type:Boolean})],G.prototype,`disabled`,2),v([T({reflect:!0,type:Boolean})],G.prototype,`horizontal`,2),v([T({reflect:!0,type:Boolean})],G.prototype,`chevron`,2),v([T({reflect:!0,type:Boolean})],G.prototype,`open`,2),v([T({reflect:!0,type:Boolean})],G.prototype,`divider`,2),v([C(`horizontal`,{waitUntilFirstUpdate:!0})],G.prototype,`handleHorizontalChange`,1);var Io=G;G.define(`syn-nav-item`);var Lo=h`
  :host {
    --display-divider: block;
...
`,Ro=class extends O{render(){return g`
    ...
    `}};Ro.styles=[w,Lo],Ro.dependencies={"syn-divider":Aa},Ro.define(`syn-menu-label`),br.define(`syn-option`);var zo=e=>Array.from(e.assignedElements({flatten:!0})),Bo=e=>e.tagName.toLocaleLowerCase()===`syn-nav-item`||(e.getAttribute(`role`)??``)===`menuitem`,Vo=e=>e.filter(Bo),Ho=e=>{e.setAttribute(`horizontal`,`true`),e.removeAttribute(`slot`),e.removeAttribute(`tabindex`),e.dataset.originalRole?e.setAttribute(`role`,e.dataset.originalRole):e.removeAttribute(`role`)},Uo=e=>{e.removeAttribute(`horizontal`),e.setAttribute(`slot`,`menu`),e.setAttribute(`role`,`menuitem`)},Wo=h`
  :host {
    display: block;
...
`,Go=class extends O{constructor(){super(...arguments),this.localize=new j(this),this.itemPositionsCached=!1,this.amountOfNavItems=0,this.amountOfVisibleItems=0,this.hasItemsInDropdown=!1}getSlottedNavItems(){let e=Vo(zo(this.defaultSlot)),t=Vo(zo(this.menuSlot));return e.concat(t)}cacheItemPositions(e){let{left:t}=this.horizontalNav.getBoundingClientRect();e.forEach(e=>{e.removeAttribute(`slot`);let{right:n}=e.getBoundingClientRect();e.dataset.right=(n-t).toString()}),this.itemPositionsCached=!0}handlePriorityMenu(){let e=this.getSlottedNavItems();this.itemPositionsCached||this.cacheItemPositions(e);let{width:t}=this.horizontalNav.getBoundingClientRect(),n=t-(this.priorityMenu.classList.contains(`priority-menu--hidden`)?0:this.priorityMenu.clientWidth),r,i=e.at(-1),a=e.map(e=>{let a=e===i?t:n,o=!!(r||parseFloat(e.dataset.right)>a);return o&&!r&&(r=parseFloat(e.dataset.right)),{isHidden:o,item:e}}),o=a.filter(({isHidden:e})=>!e).length,s=o===1&&e.length>1;a.forEach(({item:e,isHidden:t})=>{t||s?Uo(e):Ho(e)}),this.hasItemsInDropdown=o!==e.length,this.amountOfVisibleItems=s?0:o}renderPriorityMenu(){return Cn`
      <syn-dropdown
    ...
    `}slotChange(){let e=this.getSlottedNavItems();e.length!==this.amountOfNavItems&&(this.cacheItemPositions(e),this.handlePriorityMenu(),this.amountOfNavItems=e.length)}firstUpdated(){this.getSlottedNavItems().forEach(e=>{e.dataset.originalRole=e.getAttribute(`role`)??``})}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>this.handlePriorityMenu()),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver.unobserve(this)}render(){return Cn`
      <nav class="horizontal-nav" part="base">
        <slot @slotchange=${this.slotChange}></slot>
        ${this.renderPriorityMenu()}
      </nav>
    `}};Go.styles=[w,Wo],Go.dependencies={"syn-dropdown":$a,"syn-icon":A,"syn-menu":jo,"syn-nav-item":G},v([D(`slot:not([name])`)],Go.prototype,`defaultSlot`,2),v([D(`slot[name=menu]`)],Go.prototype,`menuSlot`,2),v([D(`.horizontal-nav`)],Go.prototype,`horizontalNav`,2),v([D(`.priority-menu`)],Go.prototype,`priorityMenu`,2),v([E()],Go.prototype,`itemPositionsCached`,2),v([E()],Go.prototype,`amountOfNavItems`,2),v([E()],Go.prototype,`amountOfVisibleItems`,2),v([E()],Go.prototype,`hasItemsInDropdown`,2),Go.define(`syn-prio-nav`),V.define(`syn-popup`);var Ko=[10,25,50,100],qo=e=>Number.isSafeInteger(e)&&Number(e)>0,Jo=e=>Number.isSafeInteger(e)&&Number(e)>=0,Yo=(e,t,n,r)=>{let i=e.get(t);return r(i)?i:n},Xo=(e,t)=>Math.ceil((Number.isFinite(e)&&e>0?e:0)/(Number.isFinite(t)&&t>0?t:1)),Zo=(e,t,n)=>{if(e<=0)return{endIndex:0,startIndex:0};let r=Xo(e,t),i=Math.min(Math.max(n,1),r),a=(i-1)*t+1;return{endIndex:Math.min(i*t,e),startIndex:a}},Qo=(e,t)=>Number.isFinite(e)?Math.min(Math.max(e,1),Number.isFinite(t)?Math.max(t,1):1):1,$o=(e,t)=>{let n=Number.isFinite(e)&&e>0?e:1;return Math.max(1,Math.ceil((Number.isFinite(t)&&t>0?t:0)/n))},es=e=>{let t=(Array.isArray(e)?e:[]).map(e=>Number(e)).filter(e=>Number.isSafeInteger(e)&&e>0);return t.length>0?t:Ko},ts=e=>es(e).reduce((e,t)=>Math.max(e,String(t).length),1),ns=(e,t)=>String($o(e,t)).length,rs=h`
  :host {
    display: block;
  }
...
`,K=class extends O{constructor(){super(...arguments),this.formControlController=new a(this,{assumeInteractionOn:[`syn-blur`,`syn-input`]}),this.hasSlotController=new M(this,`help-text`,`label`),this.localize=new j(this),this.typeToSelectString=``,this.isUserInput=!1,this.hasFocus=!1,this.displayLabel=``,this.selectedOptions=[],this.valueHasChanged=!1,this.delimiter=` `,this.name=``,this._value=``,this.defaultValue=``,this.size=`medium`,this.placeholder=``,this.multiple=!1,this.maxOptionsVisible=3,this.disabled=!1,this.readonly=!1,this.clearable=!1,this.open=!1,this.label=``,this.placement=`bottom`,this.helpText=``,this.form=``,this.required=!1,this.getTag=e=>g`
    ...
    `}};K.styles=[w,qn,is],K.dependencies={"syn-icon":A,"syn-popup":V,"syn-tag":Mr},v([D(`.select`)],K.prototype,`popup`,2),v([D(`.select__combobox`)],K.prototype,`combobox`,2),v([D(`.select__display-input`)],K.prototype,`displayInput`,2),v([D(`.select__value-input`)],K.prototype,`valueInput`,2),v([D(`.select__listbox`)],K.prototype,`listbox`,2),v([D(`.select__tags`)],K.prototype,`tagContainer`,2),v([E()],K.prototype,`hasFocus`,2),v([E()],K.prototype,`displayLabel`,2),v([E()],K.prototype,`currentOption`,2),v([E()],K.prototype,`selectedOptions`,2),v([E()],K.prototype,`valueHasChanged`,2),v([T()],K.prototype,`delimiter`,2),v([T()],K.prototype,`name`,2),v([E()],K.prototype,`value`,1),v([T({attribute:`value`})],K.prototype,`defaultValue`,2),v([T({reflect:!0})],K.prototype,`size`,2),v([T()],K.prototype,`placeholder`,2),v([T({type:Boolean,reflect:!0})],K.prototype,`multiple`,2),v([T({attribute:`max-options-visible`,type:Number})],K.prototype,`maxOptionsVisible`,2),v([T({type:Boolean,reflect:!0})],K.prototype,`disabled`,2),v([T({reflect:!0,type:Boolean})],K.prototype,`readonly`,2),v([T({type:Boolean})],K.prototype,`clearable`,2),v([T({type:Boolean,reflect:!0})],K.prototype,`open`,2),v([T()],K.prototype,`label`,2),v([T({reflect:!0})],K.prototype,`placement`,2),v([T({attribute:`help-text`})],K.prototype,`helpText`,2),v([T({reflect:!0})],K.prototype,`form`,2),v([T({type:Boolean,reflect:!0})],K.prototype,`required`,2),v([T()],K.prototype,`getTag`,2),v([C(`delimiter`)],K.prototype,`handleDelimiterChange`,1),v([C([`disabled`,`readonly`],{waitUntilFirstUpdate:!0})],K.prototype,`handleDisabledChange`,1),v([C([`defaultValue`,`value`,`delimiter`],{waitUntilFirstUpdate:!0})],K.prototype,`handleValueChange`,1),v([C(`open`,{waitUntilFirstUpdate:!0})],K.prototype,`handleOpenChange`,1),K=v([S(`SynSelect`)],K),R(`select.show`,{keyframes:[{opacity:0,scale:.9},{opacity:1,scale:1}],options:{duration:100,easing:`ease`}}),R(`select.hide`,{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.9}],options:{duration:100,easing:`ease`}});var q=class extends O{constructor(){super(...arguments),this.baseRef=Co(),this.localize=new j(this),this.divider=!1,this.disabled=!1,this.size=`medium`,this.currentPage=1,this.pageSize=25,this.pageSizeOptions=[10,25,50,100],this.totalItems=0,this.variant=`full`,this.ariaLabel=`Pagination`}pageChangedViaUserInput(e){let t=e.target.valueAsNumber;qo(t)&&this.updateCurrentPage(t)}navigationClicked(e,t){e.currentTarget?.blur(),this.updateCurrentPage(t)}sanitizeInvalidPropertyValues(e){if(e.has(`pageSize`)&&!qo(this.pageSize)&&(this.pageSize=Yo(e,`pageSize`,q.DEFAULT_PAGE_SIZE,qo)),e.has(`currentPage`)&&!qo(this.currentPage)&&(this.currentPage=Yo(e,`currentPage`,q.DEFAULT_CURRENT_PAGE,qo)),e.has(`totalItems`)&&!Jo(this.totalItems)&&(this.totalItems=Yo(e,`totalItems`,q.DEFAULT_TOTAL_ITEMS,Jo)),e.has(`pageSizeOptions`)){let e=es(this.pageSizeOptions);(this.pageSizeOptions.length!==e.length||this.pageSizeOptions.some((t,n)=>t!==e[n]))&&(this.pageSizeOptions=e)}}updateCurrentPage(e){let t=Qo(e,$o(this.pageSize,this.totalItems)),{currentPage:n}=this;t!==n&&(this.emit(`syn-pagination-page-changed`,{detail:{currentPage:t,previousPage:n}}),this.currentPage=t)}pageSizeChanged(e){let{currentPage:t,pageSize:n}=this,{value:r}=e.target,i=parseInt(r,10);if(!Number.isSafeInteger(i)||i<=0)return;let a=(t-1)*n+1,o=$o(i,this.totalItems),s=Qo(Math.floor((a-1)/i)+1,o);this.pageSize=i,this.currentPage=s,this.emit(`syn-pagination-page-size-changed`,{detail:{currentPageSize:i,previousPageSize:n}}),s!==t&&this.emit(`syn-pagination-page-changed`,{detail:{currentPage:s,previousPage:t}})}willUpdate(e){super.willUpdate(e),this.sanitizeInvalidPropertyValues(e);let t=e.get(`pageSizeOptions`);if(Array.isArray(t)&&!this.pageSizeOptions.includes(this.pageSize)){let e=this.pageSizeOptions[0],t=(this.currentPage-1)*this.pageSize+1,n=$o(e,this.totalItems),r=Qo(Math.floor((t-1)/e)+1,n);this.pageSize=e,this.currentPage=r}if(e.has(`currentPage`)||e.has(`pageSize`)||e.has(`totalItems`)){let e=$o(this.pageSize,this.totalItems),t=Qo(this.currentPage,e);t!==this.currentPage&&(this.currentPage=t)}}updated(e){if(super.updated(e),e.has(`pageSizeOptions`)||e.has(`pageSize`)||e.has(`totalItems`)){let e=ts(this.pageSizeOptions),t=ns(this.pageSize,this.totalItems),n=this.baseRef.value;n&&(n.style.setProperty(`--pagination-page-size-option-char-count`,String(e)),n.style.setProperty(`--pagination-total-pages-char-count`,String(t)))}}render(){let e=Xo(this.totalItems,this.pageSize),t=this.variant===`compact`,n=this.disabled||e===0,r=Zo(this.totalItems,this.pageSize,this.currentPage),i=this.pageSizeOptions.includes(this.pageSize)?this.pageSize:this.pageSizeOptions[0],a=this.currentPage===1,o=this.currentPage===e;return g`
    ...
    `}};q.DEFAULT_PAGE_SIZE=25,q.DEFAULT_CURRENT_PAGE=1,q.DEFAULT_TOTAL_ITEMS=0,q.styles=[w,rs],q.dependencies={"syn-divider":Aa,"syn-icon-button":P,"syn-input":W,"syn-option":br,"syn-select":K},v([T({type:Boolean})],q.prototype,`divider`,2),v([T({reflect:!0,type:Boolean})],q.prototype,`disabled`,2),v([T({reflect:!0})],q.prototype,`size`,2),v([T({attribute:`current-page`,reflect:!0,type:Number})],q.prototype,`currentPage`,2),v([T({attribute:`page-size`,reflect:!0,type:Number})],q.prototype,`pageSize`,2),v([T({attribute:`page-size-options`,converter:{fromAttribute:e=>e.split(`,`).map(e=>{let t=parseInt(e.trim(),10);return Number.isSafeInteger(t)?t:null}).filter(Boolean)},type:Array})],q.prototype,`pageSizeOptions`,2),v([T({attribute:`total-items`,reflect:!0,type:Number})],q.prototype,`totalItems`,2),v([T({attribute:`variant`,reflect:!0})],q.prototype,`variant`,2),v([T({attribute:`aria-label`})],q.prototype,`ariaLabel`,2),q=v([S(`SynPagination`)],q),q.define(`syn-pagination`);var as=h`
  :host {
    --size: 120px;
...
`,os=class extends O{constructor(){super(...arguments),this.localize=new j(this),this.value=0,this.label=``}updated(e){if(super.updated(e),e.has(`value`)){let e=parseFloat(getComputedStyle(this.indicator).getPropertyValue(`r`)),t=2*Math.PI*e,n=t-this.value/100*t;Number.isFinite(n)&&(this.indicator.style.strokeDashoffset=`${n}px`)}}render(){return g`
      <div
    ...
    `}};os.styles=[w,as],v([D(`.progress-ring__indicator`)],os.prototype,`indicator`,2),v([T({reflect:!0,type:Number})],os.prototype,`value`,2),v([T()],os.prototype,`label`,2),os.define(`syn-progress-ring`);var ss=h`
  :host {
...
`,ls=`important`,us=` !`+ls,ds=Ot(class extends kt{constructor(e){if(super(e),e.type!==Dt.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(us);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?ls:``):n[e]=r}}return Re}}),fs=class extends O{constructor(){super(...arguments),this.localize=new j(this),this.value=0,this.indeterminate=!1,this.label=``}render(){return g`
      <div
        part="base"
      ...
      >
        <div part="indicator" class="progress-bar__indicator" style=${ds({width:`${this.value}%`})}>
          ${this.indeterminate?``:g` <slot part="label" class="progress-bar__label"></slot> `}
        </div>
      </div>
    `}};fs.styles=[w,cs,ss],v([T({type:Number,reflect:!0})],fs.prototype,`value`,2),v([T({type:Boolean,reflect:!0})],fs.prototype,`indeterminate`,2),v([T()],fs.prototype,`label`,2),fs.define(`syn-progress-bar`);var ps=h`
  :host {
    display: block;
  }
...
`,ms=class extends O{constructor(){super(...arguments),this.formControlController=new a(this),this.hasSlotController=new M(this,`help-text`,`label`),this.customValidityMessage=``,this.hasButtonGroup=!1,this.errorMessage=``,this.defaultValue=``,this.label=``,this.helpText=``,this.name=`option`,this.value=``,this.size=`medium`,this.layout=`vertical`,this.form=``,this.required=!1}get validity(){let e=this.required&&!this.value;return this.customValidityMessage===``?e?s:o:c}get validationMessage(){let e=this.required&&!this.value;return this.customValidityMessage===``?e?this.validationInput.validationMessage:``:this.customValidityMessage}connectedCallback(){super.connectedCallback(),this.defaultValue=this.value}firstUpdated(){this.formControlController.updateValidity()}getAllRadios(){return[...this.querySelectorAll(`syn-radio, syn-radio-button`)]}handleRadioClick(e){let t=e.target.closest(`syn-radio, syn-radio-button`);if(!t||t.disabled||t.readonly)return;let n=this.getAllRadios(),r=this.value;this.value=t.value,n.forEach(e=>{e.checked=e===t}),this.value!==r&&(this.emit(`syn-change`),this.emit(`syn-input`))}handleKeyDown(e){if(![`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`,` `].includes(e.key))return;let t=this.getAllRadios().filter(e=>!e.disabled&&!e.readonly),n=t.find(e=>e.checked)??t[0],r=e.key===` `?0:[`ArrowUp`,`ArrowLeft`].includes(e.key)?-1:1,i=this.value,a=t.indexOf(n)+r;a<0&&(a=t.length-1),a>t.length-1&&(a=0),t[a]&&(this.getAllRadios().forEach(e=>{e.checked=!1,this.hasButtonGroup||e.setAttribute(`tabindex`,`-1`)}),this.value=t[a].value,t[a].checked=!0,this.hasButtonGroup?t[a].shadowRoot.querySelector(`button`).focus():(t[a].setAttribute(`tabindex`,`0`),t[a].focus()),this.value!==i&&(this.emit(`syn-change`),this.emit(`syn-input`)),e.preventDefault())}handleLabelClick(){this.focus()}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}async syncRadioElements(){let e=this.getAllRadios();if(await Promise.all(e.map(async e=>{await e.updateComplete,e.checked=e.value===this.value,e.size=this.size})),this.hasButtonGroup=e.some(e=>e.tagName.toLowerCase()===`syn-radio-button`),e.length>0&&!e.some(e=>e.checked)){if(this.hasButtonGroup){let t=e[0].shadowRoot?.querySelector(`button`);t&&t.setAttribute(`tabindex`,`0`)}else e[0].setAttribute(`tabindex`,`0`)}if(this.hasButtonGroup){let t=this.shadowRoot?.querySelector(`syn-button-group`);t&&t.toggleAttribute(`readonly`,e.every(e=>e.readonly)),t&&(t.disableRole=!0)}}syncRadios(){if(customElements.get(`syn-radio`)&&customElements.get(`syn-radio-button`)){this.syncRadioElements();return}customElements.get(`syn-radio`)?this.syncRadioElements():customElements.whenDefined(`syn-radio`).then(()=>this.syncRadios()),customElements.get(`syn-radio-button`)?this.syncRadioElements():customElements.whenDefined(`syn-radio-button`).then(()=>this.syncRadios())}updateCheckedRadio(){this.getAllRadios().forEach(e=>{e.checked=e.value===this.value}),this.formControlController.setValidity(this.validity.valid)}handleSizeChange(){this.syncRadios()}handleValueChange(){this.hasUpdated&&this.updateCheckedRadio()}checkValidity(){let e=this.required&&!this.value,t=this.customValidityMessage!==``;return e||t?(this.formControlController.emitInvalidEvent(),!1):!0}getForm(){return this.formControlController.getForm()}reportValidity(){let e=this.validity.valid;return this.errorMessage=this.customValidityMessage||e?``:this.validationInput.validationMessage,this.formControlController.setValidity(e),this.validationInput.hidden=!0,clearTimeout(this.validationTimeout),e||(this.validationInput.hidden=!1,this.validationInput.reportValidity(),this.validationTimeout=setTimeout(()=>{this.validationInput.hidden=!0},1e4)),e}setCustomValidity(e=``){this.customValidityMessage=e,this.errorMessage=e,this.validationInput.setCustomValidity(e),this.formControlController.updateValidity()}focus(e){let t=this.getAllRadios(),n=t.find(e=>e.checked),r=t.find(e=>!e.disabled),i=n||r;i&&i.focus({...e,focusVisible:!0})}render(){let e=this.hasSlotController.test(`label`),t=this.hasSlotController.test(`help-text`),n=this.label?!0:!!e,r=this.helpText?!0:!!t,i=g`
    ...
    `}};ms.styles=[w,qn,ps],ms.dependencies={"syn-button-group":Gn},v([D(`slot:not([name])`)],ms.prototype,`defaultSlot`,2),v([D(`.radio-group__validation-input`)],ms.prototype,`validationInput`,2),v([E()],ms.prototype,`hasButtonGroup`,2),v([E()],ms.prototype,`errorMessage`,2),v([E()],ms.prototype,`defaultValue`,2),v([T()],ms.prototype,`label`,2),v([T({attribute:`help-text`})],ms.prototype,`helpText`,2),v([T()],ms.prototype,`name`,2),v([T({reflect:!0})],ms.prototype,`value`,2),v([T({reflect:!0})],ms.prototype,`size`,2),v([T({reflect:!0})],ms.prototype,`layout`,2),v([T({reflect:!0})],ms.prototype,`form`,2),v([T({reflect:!0,type:Boolean})],ms.prototype,`required`,2),v([C(`size`,{waitUntilFirstUpdate:!0})],ms.prototype,`handleSizeChange`,1),v([C(`value`)],ms.prototype,`handleValueChange`,1),ms=v([S(`SynRadioGroup`)],ms),ms.define(`syn-radio-group`);var hs=h`
  :host([readonly]) {
    cursor: default;
  }
...
`,gs=class extends O{constructor(){super(...arguments),this.hasSlotController=new M(this,`[default]`,`prefix`,`suffix`),this.hasFocus=!1,this.iconOnly=!1,this.checked=!1,this.disabled=!1,this.readonly=!1,this.size=`medium`}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`presentation`)}isDisabled(){return this.disabled||this.readonly}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleClick(e){if(this.isDisabled()){e.preventDefault(),e.stopPropagation();return}this.checked=!0}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleSlotChange(){let e=_n(this.defaultSlot).trim(),t=this.defaultSlot.assignedElements({flatten:!0}),n=t.length===1&&t[0].tagName.toLowerCase()===`syn-icon`;this.iconOnly=n&&e===``}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.isDisabled()?`true`:`false`)}focus(e){this.input.focus(e)}blur(){this.input.blur()}render(){return g`
    ...
    `}};gs.styles=[w,Pn,hs],v([D(`.button`)],gs.prototype,`input`,2),v([D(`slot:not([name])`)],gs.prototype,`defaultSlot`,2),v([E()],gs.prototype,`hasFocus`,2),v([E()],gs.prototype,`iconOnly`,2),v([T({reflect:!0,type:Boolean})],gs.prototype,`checked`,2),v([T()],gs.prototype,`value`,2),v([T({reflect:!0,type:Boolean})],gs.prototype,`disabled`,2),v([T({reflect:!0,type:Boolean})],gs.prototype,`readonly`,2),v([T({reflect:!0})],gs.prototype,`size`,2),v([C([`disabled`,`readonly`],{waitUntilFirstUpdate:!0})],gs.prototype,`handleDisabledChange`,1),gs=v([S(`SynRadioButton`)],gs),gs.define(`syn-radio-button`);var _s=h`
  /* stylelint-disable no-descending-specificity */
  :host {
    display: block;
  }
...
`,vs=class extends O{constructor(){super(),this.checked=!1,this.hasFocus=!1,this.size=`medium`,this.disabled=!1,this.readonly=!1,this.handleBlur=()=>{this.hasFocus=!1,this.emit(`syn-blur`)},this.handleClick=()=>{if(this.readonly){this.focus();return}this.disabled||(this.checked=!0)},this.handleFocus=()=>{this.hasFocus=!0,this.emit(`syn-focus`)},this.addEventListener(`blur`,this.handleBlur),this.addEventListener(`click`,this.handleClick),this.addEventListener(`focus`,this.handleFocus)}connectedCallback(){super.connectedCallback(),this.setInitialAttributes()}setInitialAttributes(){this.setAttribute(`role`,`radio`),this.setAttribute(`tabindex`,`-1`),this.setAttribute(`aria-disabled`,this.disabled||this.readonly?`true`:`false`)}handleCheckedChange(){this.setAttribute(`aria-checked`,this.checked?`true`:`false`),this.setAttribute(`tabindex`,this.checked?`0`:`-1`)}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled||this.readonly?`true`:`false`)}render(){return g`
    ...
    `}};vs.styles=[w,_s],vs.dependencies={"syn-icon":A},v([E()],vs.prototype,`checked`,2),v([E()],vs.prototype,`hasFocus`,2),v([T()],vs.prototype,`value`,2),v([T({reflect:!0})],vs.prototype,`size`,2),v([T({reflect:!0,type:Boolean})],vs.prototype,`disabled`,2),v([T({reflect:!0,type:Boolean})],vs.prototype,`readonly`,2),v([C(`checked`)],vs.prototype,`handleCheckedChange`,1),v([C([`disabled`,`readonly`],{waitUntilFirstUpdate:!0})],vs.prototype,`handleDisabledChange`,1),vs=v([S(`SynRadio`)],vs),vs.define(`syn-radio`);var ys=h`
  :host {
...
`,bs=class extends O{constructor(){super(...arguments),this.subdivision=!1}render(){return g`
    ...
    `}};bs.styles=[w,ys],v([T({reflect:!0,type:Boolean})],bs.prototype,`subdivision`,2),bs.define(`syn-range-tick`);var xs=h`
  :host {
    /*
...
`,Es=class extends O{constructor(){super(),this.localize=new j(this),this.anchor=void 0,this.content=``,this.placement=`top`,this.disabled=!1,this.distance=13,this.open=!1,this.skidding=0,this.trigger=`hover focus`,this.handleBlur=()=>{this.hasTrigger(`focus`)&&this.hide()},this.handleClick=()=>{this.hasTrigger(`click`)&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger(`focus`)&&this.show()},this.handleDocumentKeyDown=e=>{e.key===`Escape`&&(e.stopPropagation(),this.hide())},this.handleMouseOver=()=>{if(this.hasTrigger(`hover`)){let e=wn(getComputedStyle(this).getPropertyValue(`--show-delay`));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.show(),e)}},this.handleMouseOut=()=>{if(this.hasTrigger(`hover`)){let e=wn(getComputedStyle(this).getPropertyValue(`--hide-delay`));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.hide(),e)}},this.addEventListener(`blur`,this.handleBlur,!0),this.addEventListener(`focus`,this.handleFocus,!0),this.addEventListener(`click`,this.handleClick),this.addEventListener(`mouseover`,this.handleMouseOver),this.addEventListener(`mouseout`,this.handleMouseOut)}disconnectedCallback(){super.disconnectedCallback(),this.closeWatcher?.destroy(),document.removeEventListener(`keydown`,this.handleDocumentKeyDown)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(e){return this.trigger.split(` `).includes(e)}async handleOpenChange(){if(this.open){if(this.disabled)return;this.emit(`syn-show`),`CloseWatcher`in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide()}):document.addEventListener(`keydown`,this.handleDocumentKeyDown),await L(this.body),this.body.hidden=!1,this.popup.active=!0;let{keyframes:e,options:t}=z(this,`tooltip.show`,{dir:this.localize.dir()});await I(this.popup.popup,e,t),this.popup.reposition(),this.emit(`syn-after-show`)}else{this.emit(`syn-hide`),this.closeWatcher?.destroy(),document.removeEventListener(`keydown`,this.handleDocumentKeyDown),await L(this.body);let{keyframes:e,options:t}=z(this,`tooltip.hide`,{dir:this.localize.dir()});await I(this.popup.popup,e,t),this.popup.active=!1,this.body.hidden=!0,this.emit(`syn-after-hide`)}}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,F(this,`syn-after-show`)}async hide(){if(this.open)return this.open=!1,F(this,`syn-after-hide`)}render(){return g`
    ...
    `}};Es.styles=[w,Ts],Es.dependencies={"syn-popup":V},v([D(`slot:not([name])`)],Es.prototype,`defaultSlot`,2),v([D(`.tooltip__body`)],Es.prototype,`body`,2),v([D(`syn-popup`)],Es.prototype,`popup`,2),v([E()],Es.prototype,`anchor`,2),v([T()],Es.prototype,`content`,2),v([T()],Es.prototype,`placement`,2),v([T({type:Boolean,reflect:!0})],Es.prototype,`disabled`,2),v([T({type:Number})],Es.prototype,`distance`,2),v([T({type:Boolean,reflect:!0})],Es.prototype,`open`,2),v([T({type:Number})],Es.prototype,`skidding`,2),v([T()],Es.prototype,`trigger`,2),v([C(`open`,{waitUntilFirstUpdate:!0})],Es.prototype,`handleOpenChange`,1),v([C([`anchor`,`content`,`distance`,`placement`,`skidding`])],Es.prototype,`handleOptionsChange`,1),v([C(`disabled`)],Es.prototype,`handleDisabledChange`,1),R(`tooltip.show`,{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:150,easing:`ease`}}),R(`tooltip.hide`,{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:150,easing:`ease`}});var J,Ds,Os,ks,As,js,Y,Ms,Ns,Ps,Fs,Is,Ls,Rs,zs,Bs,Vs,Hs,Us,Ws,Gs,Ks,X=class extends O{constructor(){super(),vt(this,Y),this.name=``,this.label=``,this.helpText=``,this.disabled=!1,this.readonly=!1,this.min=0,this.max=100,this.step=1,this.size=`medium`,this.tooltipPlacement=`top`,this.restrictMovement=!1,this.defaultValue=`0`,this.form=``,this.hasSlotController=new M(this,`help-text`,`label`,`prefix`,`suffix`,`ticks`),this.formControlController=new a(this,{assumeInteractionOn:[`syn-change`]}),this.localize=new j(this),vt(this,J,[0]),vt(this,Ds,new Map),vt(this,Os,!1),vt(this,ks,``),vt(this,As),vt(this,js,[]),this.tooltipFormatter=this.localize.number.bind(this.localize)}set value(e){b(this,J,e?e.split(` `).map(Number).sort(Ss):[]),b(this,js,Array.from(y(this,J)))}get value(){return y(this,J).slice().sort(Ss).join(` `)}set valueAsArray(e){let t=y(this,J);b(this,J,Array.isArray(e)?e.slice().sort(Ss):e||[]),b(this,js,Array.from(y(this,J))),Cs(t,y(this,J))&&this.requestUpdate(`value`,t.join(` `))}get valueAsArray(){return[...y(this,J)].sort(Ss)}disconnectedCallback(){super.disconnectedCallback(),this?.ticksResizeObserver?.disconnect(),this?.visibilityObserver?.disconnect()}firstUpdated(){this.ticksResizeObserver=new ResizeObserver(()=>{x(this,Y,Ks).call(this)}),this.ticksResizeObserver.observe(this.ticks),this.ticksResizeObserver.observe(this.baseControl),this.visibilityObserver=new IntersectionObserver(e=>{let t=e.at(0);t&&t.isIntersecting&&x(this,Y,Ks).call(this)}),this.visibilityObserver.observe(this),x(this,Y,Ks).call(this),this.formControlController.updateValidity(),b(this,js,Array.from(y(this,J))),this.thumbs.forEach(e=>{let t=e.parentElement;t.updateComplete.then(()=>{t.shadowRoot.querySelector(`.tooltip__body`)?.setAttribute(`aria-hidden`,`true`)})})}willUpdate(e){super.willUpdate(e),this.min>this.max&&([this.min,this.max]=[this.max,this.min]),this.step>this.max-this.min&&(this.step=this.max-this.min),this.step<=0&&(this.step=1);let t=y(this,J).map(e=>{if(e<=this.min)return this.min;if(e>=this.max)return this.max;let t=this.min+this.step*Math.round((e-this.min)/this.step);return t>this.max?this.max:t});Cs(y(this,J),t)&&b(this,J,t)}updated(e){super.updated(e);for(let e of this.thumbs){let t=+e.dataset.rangeId;y(this,Ds).has(t)&&x(this,Y,zs).call(this,e,y(this,Ds).get(t))}x(this,Y,Bs).call(this)}focus(e){let t=this.thumbs.item(0);t?t.focus(e):super.focus(e)}checkValidity(){if(this.disabled)return!0;let e=!y(this,ks);return e||this.formControlController.emitInvalidEvent(),e}reportValidity(){if(this.disabled)return!0;let e=this.validity.valid;return this.formControlController.setValidity(e),this.validationInput.hidden=!0,clearTimeout(y(this,As)),e||(this.validationInput.hidden=!1,this.validationInput.reportValidity(),b(this,As,setTimeout(()=>{this.validationInput.hidden=!0},1e4))),e}setCustomValidity(e){b(this,ks,e),this.validationInput.setCustomValidity(e),this.formControlController.updateValidity()}getForm(){return this.formControlController.getForm()}get validity(){return y(this,ks)?c:o}get validationMessage(){return y(this,ks)}renderThumbs(e){let t=y(this,J).length>1;return y(this,Ds).clear(),y(this,J).map((n,r)=>{let i=r+1;y(this,Ds).set(i,n);let a=`thumb-${i}`,o=``,s=``;return t?(s=e?`label aria-label-hidden ${a}`:`aria-label-hidden ${a}`,o=r===0?`${this.localize.term(`rangeMin`)} (${this.tooltipFormatter(n)})`:r===y(this,J).length-1?`${this.localize.term(`rangeMax`)} (${this.tooltipFormatter(n)})`:this.tooltipFormatter(n)):s=e?`label aria-label-hidden`:``,g`
        <syn-tooltip
        ...
        >
          <div
            ...
            role="slider"
            tabindex="${this.disabled?-1:0}"
            @pointerdown=${x(this,Y,Is)}
            @pointermove=${x(this,Y,Ls)}
            @pointerup=${x(this,Y,Rs)}
            @pointercancel=${x(this,Y,Rs)}
            @pointerleave=${x(this,Y,Rs)}
            @keydown=${x(this,Y,Vs)}
            @focus=${x(this,Y,Ws)}
          ></div>
        </syn-tooltip>
    ...
    `}};J=new WeakMap,Ds=new WeakMap,Os=new WeakMap,ks=new WeakMap,As=new WeakMap,js=new WeakMap,Y=new WeakSet,Ms=function(){return this.localize.dir()===`rtl`},Ns=function(e,t=!0){if(this.disabled)return;if(this.readonly){e.preventDefault(),this.focus();return}let{clientX:n}=e,r=Array.from(this.thumbs),i=ws(this.baseDiv,n,y(this,Y,Ms)),a=this.step/(this.max-this.min),o=this.min+this.step*Math.round(i/a),s=r.reduce((e,t)=>{let n=y(this,Ds).get(+t.dataset.rangeId),r=y(this,Ds).get(+e.dataset.rangeId),i=Math.abs(n-o),a=Math.abs(r-o);return i===a?n<o?t:e:i<a?t:e}),c=+s.dataset.rangeId;if(!c)return;y(this,Ds).set(c,o),x(this,Y,zs).call(this,s,o);let l=y(this,J);b(this,J,Array.from(y(this,Ds).values())),x(this,Y,Bs).call(this),Cs(l,y(this,J))&&(b(this,js,Array.from(y(this,J))),this.emit(`syn-input`),this.emit(`syn-change`));let u=new PointerEvent(`pointerdown`,e);t&&s.dispatchEvent(u)&&x(this,Y,Us).call(this,s)},Ps=function(e){x(this,Y,Ns).call(this,e,!1)},Fs=function(e,t){let n=this.valueAsArray,r=Array.from(this.thumbs).indexOf(e),i=n[r-1]||this.min,a=n[r+1]||this.max;return{finalValue:Math.max(i,Math.min(a,t)),isRestricted:t<i||t>a,nextValue:a,prevValue:i}},Is=async function(e){if(this.disabled||this.readonly)return;let t=e.target;x(this,Y,Us).call(this,t),t.dataset.pointerId&&t.releasePointerCapture(+t.dataset.pointerId),t.dataset.pointerId=e.pointerId.toString(),t.setPointerCapture(e.pointerId),t.classList.add(`grabbed`),await t.parentElement.show()},Ls=function(e){if(this.disabled||this.readonly)return;let t=e.target,n=+t.dataset.rangeId;if(!y(this,Ds).has(n)||(t.dataset.pointerId?+t.dataset.pointerId:null)!==e.pointerId)return;let r=ws(this.baseDiv,e.clientX,y(this,Y,Ms)),i=this.step/(this.max-this.min),a=this.min+this.step*Math.round(r/i);if(this.emit(`syn-move`,{cancelable:!0,detail:{element:t,value:a}}).defaultPrevented)return;if(this.restrictMovement){let e=x(this,Y,Fs).call(this,t,a);e.isRestricted?(a=e.finalValue,t.style.zIndex=(3+this.thumbs.length).toFixed(0)):t.style.zIndex=`3`}y(this,Ds).set(n,a),x(this,Y,zs).call(this,t,a);let o=y(this,J);b(this,J,Array.from(y(this,Ds).values())),x(this,Y,Bs).call(this),Cs(o,y(this,J))&&this.emit(`syn-input`)},Rs=async function(e){if(this.disabled||this.readonly)return;let t=e.target;t.dataset.pointerId&&e.pointerId===+t.dataset.pointerId&&(t.classList.remove(`grabbed`),t.releasePointerCapture(e.pointerId),delete t.dataset.pointerId,Cs(y(this,js),y(this,J))&&(b(this,js,Array.from(y(this,J))),this.emit(`syn-change`)),await t.parentElement.hide())},zs=function(e,t){e.setAttribute(`aria-valuenow`,t.toString()),e.setAttribute(`aria-valuetext`,this.tooltipFormatter(t));let n=(t-this.min)/(this.max-this.min);e.style.insetInlineStart=`calc(${100*n}% - var(--half-thumb-size))`,x(this,Y,Us).call(this,e)},Bs=function(){let{activeTrack:e}=this;if(!e)return;if(this.min===this.max){e.style.insetInlineStart=`0%`,e.style.insetInlineEnd=`0%`;return}if(y(this,J).length===1){let t=getComputedStyle(this).getPropertyValue(`--track-active-offset`)||`0%`,n=100*(y(this,J)[0]-this.min)/(this.max-this.min);e.style.insetInlineStart=`min(${t}, ${n}%)`,e.style.insetInlineEnd=`min(calc(100% - ${t}), calc(100% - ${n}%))`;return}let t=y(this,J).slice().sort(Ss),n=100*(t[0]-this.min)/(this.max-this.min),r=100*(t[t.length-1]-this.min)/(this.max-this.min);e.style.insetInlineStart=`${n}%`,e.style.insetInlineEnd=`calc(100% - ${r}%)`},Vs=function(e){if(this.readonly)return;let t=e.target,n=+t.dataset.rangeId,r=y(this,Ds).get(n);if(r===void 0)return;let i=r;switch(e.key){case`ArrowUp`:case`Up`:i=Math.min(r+this.step,this.max);break;case`ArrowDown`:case`Down`:i=Math.max(r-this.step,this.min);break;case`ArrowLeft`:case`Left`:i=y(this,Y,Ms)?Math.min(r+this.step,this.max):Math.max(r-this.step,this.min);break;case`ArrowRight`:case`Right`:i=y(this,Y,Ms)?Math.max(r-this.step,this.min):Math.min(r+this.step,this.max);break;case`PageUp`:i=Math.min(r+(this.max-this.min)/5,this.max);break;case`PageDown`:i=Math.max(r-(this.max-this.min)/5,this.min);break;case`Home`:i=this.min;break;case`End`:i=this.max;break;default:return}if(i!==r){if(this.emit(`syn-move`,{cancelable:!0,detail:{element:t,value:i}}).defaultPrevented)return;if(this.restrictMovement){let e=x(this,Y,Fs).call(this,t,i);e.isRestricted&&(i=e.finalValue)}x(this,Y,zs).call(this,t,i),y(this,Ds).set(n,i),b(this,J,Array.from(y(this,Ds).values())),x(this,Y,Bs).call(this),x(this,Y,Us).call(this,t),b(this,js,Array.from(y(this,J))),this.emit(`syn-input`),this.emit(`syn-change`)}e.stopPropagation(),e.preventDefault()},Hs=function(e){e.relatedTarget&&this.shadowRoot?.contains(e.relatedTarget)||(this.emit(`syn-blur`),b(this,Os,!1))},Us=function(e){if(this.tooltipPlacement===`none`)return;let t=+e.dataset.rangeId;if(!y(this,Ds).has(t))return;let n=y(this,Ds).get(t),r=e.parentElement;r.content=this.tooltipFormatter(n)},Ws=function(e){if(this.disabled)return;y(this,Os)||(b(this,Os,!0),this.emit(`syn-focus`));let t=e.target;t?.dataset?.rangeId&&x(this,Y,Us).call(this,t)},Gs=function(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)},Ks=function(){if(!this.hasSlotController.test(`ticks`)){this.baseControl.style.marginBottom=``;return}let e=this.ticks.getBoundingClientRect().height,t=(this.baseControl.getBoundingClientRect().height-this.baseDiv.getBoundingClientRect().height)/2,n=Math.ceil(Math.max(0,e-t));this.baseControl.style.marginBottom=n>0?`${n}px`:``},X.styles=[w,qn,xs],X.dependencies={"syn-tooltip":Es},v([T()],X.prototype,`name`,2),v([T()],X.prototype,`label`,2),v([T({attribute:`help-text`})],X.prototype,`helpText`,2),v([T({reflect:!0,type:Boolean})],X.prototype,`disabled`,2),v([T({reflect:!0,type:Boolean})],X.prototype,`readonly`,2),v([T({type:Number})],X.prototype,`min`,2),v([T({type:Number})],X.prototype,`max`,2),v([T({type:Number})],X.prototype,`step`,2),v([T({reflect:!0})],X.prototype,`size`,2),v([T({attribute:`tooltip-placement`,type:String})],X.prototype,`tooltipPlacement`,2),v([T({type:String})],X.prototype,`value`,1),v([T({attribute:`restrict-movement`,type:Boolean})],X.prototype,`restrictMovement`,2),v([Xn()],X.prototype,`defaultValue`,2),v([T({reflect:!0})],X.prototype,`form`,2),v([T({attribute:!1})],X.prototype,`tooltipFormatter`,2),v([D(`.input__wrapper`)],X.prototype,`baseDiv`,2),v([D(`.base`)],X.prototype,`baseControl`,2),v([D(`.active-track`)],X.prototype,`activeTrack`,2),v([D(`.ticks`)],X.prototype,`ticks`,2),v([wt(`.thumb`)],X.prototype,`thumbs`,2),v([D(`.range__validation-input`)],X.prototype,`validationInput`,2),X=v([S(`SynRange`)],X),X.define(`syn-range`);var qs=h`
  :host {
...
`,Js=class extends O{constructor(){super(),this.hasSlotController=new M(this,`[default]`,`footer`),this.localize=new j(this),this.isAnimationActive=!1,this.open=!1,this.variant=`default`,this.noFocusTrapping=!1,this.handleMouseEnter=this.handleMouseEnter.bind(this),this.handleMouseLeave=this.handleMouseLeave.bind(this),this.addEventListener(`syn-initial-focus`,e=>{this.variant!=="default"&&(e.preventDefault(),this.drawer.originalTrigger=null)}),this.addEventListener(`focusin`,e=>{e.target.tagName.toLowerCase()===`syn-nav-item`&&this.variant===`rail`&&!this.open&&(this.open=!0)}),this.addEventListener(`focusout`,e=>{let t=e.target.tagName.toLowerCase(),n=e.relatedTarget?.tagName.toLowerCase();t===`syn-nav-item`&&n!==`syn-nav-item`&&this.variant===`rail`&&this.open&&(this.open=!1)})}setDelayedCallback(e){clearTimeout(this.timeout),this.timeout=setTimeout(e,100)}handleMouseEnter(){this.setDelayedCallback(()=>{this.open=!0})}handleMouseLeave(){this.setDelayedCallback(()=>{this.open=!1})}handleRequestClose(){this.open&&=!1}addMouseListener(){this.drawer.shadowRoot.querySelector(`.drawer__panel`)?.addEventListener(`mouseenter`,this.handleMouseEnter),this.drawer.shadowRoot.querySelector(`.drawer__panel`)?.addEventListener(`mouseleave`,this.handleMouseLeave)}removeMouseListener(){this.drawer.shadowRoot.querySelector(`.drawer__panel`)?.removeEventListener(`mouseenter`,this.handleMouseEnter),this.drawer.shadowRoot.querySelector(`.drawer__panel`)?.removeEventListener(`mouseleave`,this.handleMouseLeave)}setDrawerAnimations(){let e=z(this,`sideNav.show${this.variant==="default"?`NonRail`:`Rail`}`,{dir:this.localize.dir()}),t=z(this,`sideNav.hide${this.variant==="default"?`NonRail`:`Rail`}`,{dir:this.localize.dir()}),n=z(this,`sideNav.overlay.hide`,{dir:this.localize.dir()}),r=z(this,`sideNav.overlay.show`,{dir:this.localize.dir()});jn(this.drawer,`drawer.showStart`,e),jn(this.drawer,`drawer.hideStart`,t),jn(this.drawer,`drawer.overlay.hide`,n),jn(this.drawer,`drawer.overlay.show`,r)}handleVariantChange(){switch(this.setDrawerAnimations(),this.drawer.forceVisibility(this.variant!=="default"),this.variant){case`rail`:this.addMouseListener();break;default:this.removeMouseListener()}}handleOpenChange(){this.variant!=="default"&&(this.isAnimationActive=!0,F(this.drawer,`syn-after-${this.open?`show`:`hide`}`).then(()=>{this.isAnimationActive=!1}))}handleFocusTrapping(){this.variant==="default"&&(this.noFocusTrapping?this.drawer.modal.activateExternal():this.drawer.modal.deactivateExternal())}async show(){if(!this.open)return this.open=!0,F(this.drawer,`syn-after-show`)}async hide(){if(this.open)return this.open=!1,F(this.drawer,`syn-after-hide`)}firstUpdated(){switch(this.setDrawerAnimations(),this.drawer.updateComplete.then(()=>{this.drawer.forceVisibility(this.variant!=="default"),this.drawer.shadowRoot.querySelector(`.drawer__panel`).tabIndex=-1}),this.variant){case`rail`:this.drawer.updateComplete.then(()=>{this.addMouseListener()});break;case`sticky`:break;default:this.noFocusTrapping&&this.drawer.modal.activateExternal()}}disconnectedCallback(){super.disconnectedCallback(),this.drawer&&(Or(this.drawer),this.drawer.modal.deactivate())}toggleOpenState(){this.open=!this.open}render(){let e=window.navigator.maxTouchPoints>0||`ontouchstart`in window,t=this.hasSlotController.test(`footer`),n=t||this.variant===`sticky`;return Cn`
      ...
      >
        ...
        >
          ...
          <footer class="side-nav__footer" part="footer-container" slot="footer">  
            ...
            ${n?Cn`<syn-divider part="footer-divider" class="side-nav__footer-divider"></syn-divider>`:``}
            <slot name="footer" part="footer" ></slot>
            ${this.variant===`sticky`?Cn`<syn-nav-item part="toggle-nav-item" class="side-nav__toggle-nav-item" @click=${this.toggleOpenState} ?divider=${t}>
    ...
    `}};Js.styles=[w,qs],Js.dependencies={"syn-divider":Aa,"syn-drawer":no,"syn-icon":A,"syn-nav-item":G},v([E()],Js.prototype,`isAnimationActive`,2),v([D(`.side-nav__drawer`)],Js.prototype,`drawer`,2),v([T({reflect:!0,type:Boolean})],Js.prototype,`open`,2),v([T({reflect:!0})],Js.prototype,`variant`,2),v([T({attribute:`no-focus-trapping`,reflect:!0,type:Boolean})],Js.prototype,`noFocusTrapping`,2),v([C(`variant`,{waitUntilFirstUpdate:!0})],Js.prototype,`handleVariantChange`,1),v([C(`open`,{waitUntilFirstUpdate:!0})],Js.prototype,`handleOpenChange`,1),v([C(`noFocusTrapping`,{waitUntilFirstUpdate:!0})],Js.prototype,`handleFocusTrapping`,1),Js=v([S(`SynSideNav`)],Js),R(`sideNav.showRail`,{keyframes:[{width:`var(--side-nav-rail-width)`},{width:`var(--side-nav-open-width)`}],options:{duration:250,easing:`ease`}}),R(`sideNav.showNonRail`,{keyframes:[{opacity:0,translate:`-100%`},{opacity:1,translate:`0`}],options:{duration:250,easing:`ease`}}),R(`sideNav.hideNonRail`,{keyframes:[{opacity:1,translate:`0`},{opacity:0,translate:`-100%`}],options:{duration:250,easing:`ease`}}),R(`sideNav.hideRail`,{keyframes:[{width:`var(--side-nav-open-width)`},{width:`var(--side-nav-rail-width)`}],options:{duration:250,easing:`ease`}}),R(`sideNav.overlay.show`,{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}}),R(`sideNav.overlay.hide`,{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}}),Js.define(`syn-side-nav`),K.define(`syn-select`);var Ys=h`
  /* stylelint-disable no-descending-specificity */
  :host {
    display: inline-block;
  }
...
`,Xs=class extends O{constructor(){super(...arguments),this.formControlController=new a(this,{value:e=>e.checked?e.value||`on`:void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=t}),this.hasSlotController=new M(this,`help-text`),this.hasFocus=!1,this.title=``,this.name=``,this.size=`medium`,this.disabled=!1,this.readonly=!1,this.checked=!1,this.defaultChecked=!1,this.form=``,this.required=!1,this.helpText=``}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit(`syn-blur`)}handleInput(){this.emit(`syn-input`)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleClick(e){if(this.readonly){e.preventDefault();return}this.checked=!this.checked,this.emit(`syn-change`)}handleFocus(){this.hasFocus=!0,this.emit(`syn-focus`)}handleKeyDown(e){this.readonly||(e.key===`ArrowLeft`&&(e.preventDefault(),this.checked=!1,this.emit(`syn-change`),this.emit(`syn-input`)),e.key===`ArrowRight`&&(e.preventDefault(),this.checked=!0,this.emit(`syn-change`),this.emit(`syn-input`)))}handleCheckedChange(){this.input.checked=this.checked,this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(!0)}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){let e=this.hasSlotController.test(`help-text`),t=this.helpText?!0:!!e;return g`
    ...
    `}};Xs.styles=[w,qn,Ys],v([D(`input[type="checkbox"]`)],Xs.prototype,`input`,2),v([E()],Xs.prototype,`hasFocus`,2),v([T({reflect:!0})],Xs.prototype,`title`,2),v([T()],Xs.prototype,`name`,2),v([T()],Xs.prototype,`value`,2),v([T({reflect:!0})],Xs.prototype,`size`,2),v([T({type:Boolean,reflect:!0})],Xs.prototype,`disabled`,2),v([T({type:Boolean,reflect:!0})],Xs.prototype,`readonly`,2),v([T({type:Boolean,reflect:!0})],Xs.prototype,`checked`,2),v([Xn(`checked`)],Xs.prototype,`defaultChecked`,2),v([T({reflect:!0})],Xs.prototype,`form`,2),v([T({type:Boolean,reflect:!0})],Xs.prototype,`required`,2),v([T({attribute:`help-text`})],Xs.prototype,`helpText`,2),v([C(`checked`,{waitUntilFirstUpdate:!0})],Xs.prototype,`handleCheckedChange`,1),v([C(`disabled`,{waitUntilFirstUpdate:!0})],Xs.prototype,`handleDisabledChange`,1),Xs=v([S(`SynSwitch`)],Xs),Xs.define(`syn-switch`),Ln.define(`syn-spinner`);var Zs=h`
	/* stylelint-disable */
  :host {
    display: contents;
  }
`,Qs=class extends O{constructor(){super(...arguments),this.observedElements=[],this.disabled=!1}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{this.emit(`syn-resize`,{detail:{entries:e}})}),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}handleSlotChange(){this.disabled||this.startObserver()}startObserver(){let e=this.shadowRoot.querySelector(`slot`);if(e!==null){let t=e.assignedElements({flatten:!0});this.observedElements.forEach(e=>this.resizeObserver.unobserve(e)),this.observedElements=[],t.forEach(e=>{this.resizeObserver.observe(e),this.observedElements.push(e)})}}stopObserver(){this.resizeObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}render(){return g` <slot @slotchange=${this.handleSlotChange}></slot> `}};Qs.styles=[w,Zs],v([T({type:Boolean,reflect:!0})],Qs.prototype,`disabled`,2),v([C(`disabled`,{waitUntilFirstUpdate:!0})],Qs.prototype,`handleDisabledChange`,1);var $s=h`
  /* stylelint-disable no-descending-specificity */
...
`,tc=(e,t)=>{let n=0;return function(...r){window.clearTimeout(n),n=window.setTimeout(()=>{e.call(this,...r)},t)}},nc=(e,t,n)=>{let r=e[t];e[t]=function(...e){r.call(this,...e),n.call(this,r,...e)}};(()=>{if(typeof window<`u`&&!(`onscrollend`in window)){let e=new Set,t=new WeakMap,n=t=>{for(let n of t.changedTouches)e.add(n.identifier)},r=t=>{for(let n of t.changedTouches)e.delete(n.identifier)};document.addEventListener(`touchstart`,n,!0),document.addEventListener(`touchend`,r,!0),document.addEventListener(`touchcancel`,r,!0),nc(EventTarget.prototype,`addEventListener`,function(n,r){if(r!==`scrollend`)return;let i=tc(()=>{e.size?i():this.dispatchEvent(new Event(`scrollend`))},100);n.call(this,`scroll`,i,{passive:!0}),t.set(this,i)}),nc(EventTarget.prototype,`removeEventListener`,function(e,n){if(n!==`scrollend`)return;let r=t.get(this);r&&e.call(this,`scroll`,r,{passive:!0})})}})();var Z=class extends O{constructor(){super(...arguments),this.focusableTabs=[],this.localize=new j(this),this.hasScrollControls=!1,this.shouldHideScrollStartButton=!1,this.shouldHideScrollEndButton=!1,this.placement=`top`,this.activation=`auto`,this.noScrollControls=!1,this.contained=!1,this.sharp=!1,this.fixedScrollControls=!1,this.scrollOffset=1}connectedCallback(){let e=Promise.all([customElements.whenDefined(`syn-tab`),customElements.whenDefined(`syn-tab-panel`)]);super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>{this.repositionIndicator(),this.updateScrollControls()}),this.mutationObserver=new MutationObserver(e=>{let t=e.filter(({target:e})=>{if(e===this)return!0;if(e.closest(`syn-tab-group`)!==this)return!1;let t=e.tagName.toLowerCase();return t===`syn-tab`||t===`syn-tab-panel`});if(t.length!==0){if(t.some(e=>![`aria-labelledby`,`aria-controls`].includes(e.attributeName))&&setTimeout(()=>this.setAriaLabels()),t.some(e=>e.attributeName===`disabled`))this.syncTabsAndPanels();else if(t.some(e=>e.attributeName===`active`)){let e=t.filter(e=>e.attributeName===`active`&&e.target.tagName.toLowerCase()===`syn-tab`).map(e=>e.target).find(e=>e.active);e&&this.setActiveTab(e)}}}),this.updateComplete.then(()=>{this.syncTabsAndPanels(),this.mutationObserver.observe(this,{attributes:!0,attributeFilter:[`active`,`disabled`,`name`,`panel`],childList:!0,subtree:!0}),this.resizeObserver.observe(this.nav),e.then(()=>{new IntersectionObserver((e,t)=>{e[0].intersectionRatio>0&&(this.setAriaLabels(),this.setActiveTab(this.getActiveTab()??this.tabs[0],{emitEvents:!1}),t.unobserve(e[0].target))}).observe(this.tabGroup)})})}disconnectedCallback(){super.disconnectedCallback(),this.mutationObserver?.disconnect(),this.nav&&this.resizeObserver?.unobserve(this.nav)}getActiveTab(){return this.tabs.find(e=>e.active)}handleClick(e){let t=e.target.closest(`syn-tab`);t?.closest(`syn-tab-group`)===this&&t!==null&&this.setActiveTab(t,{scrollBehavior:`smooth`})}handleKeyDown(e){let t=e.target.closest(`syn-tab`);if(t?.closest(`syn-tab-group`)===this&&([`Enter`,` `].includes(e.key)&&t!==null&&(this.setActiveTab(t,{scrollBehavior:`smooth`}),e.preventDefault()),[`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`Home`,`End`].includes(e.key))){let t=this.tabs.find(e=>e.matches(`:focus`)),n=this.localize.dir()===`rtl`,r=null;if(t?.tagName.toLowerCase()===`syn-tab`){if(e.key===`Home`)r=this.focusableTabs[0];else if(e.key===`End`)r=this.focusableTabs[this.focusableTabs.length-1];else if([`top`].includes(this.placement)&&e.key===(n?`ArrowRight`:`ArrowLeft`)||[`start`,`end`].includes(this.placement)&&e.key===`ArrowUp`){let e=this.tabs.findIndex(e=>e===t);r=this.findNextFocusableTab(e,`backward`)}else if([`top`].includes(this.placement)&&e.key===(n?`ArrowLeft`:`ArrowRight`)||[`start`,`end`].includes(this.placement)&&e.key===`ArrowDown`){let e=this.tabs.findIndex(e=>e===t);r=this.findNextFocusableTab(e,`forward`)}if(!r)return;r.tabIndex=0,r.focus({preventScroll:!0}),this.activation===`auto`?this.setActiveTab(r,{scrollBehavior:`smooth`}):this.tabs.forEach(e=>{e.tabIndex=e===r?0:-1}),[`top`].includes(this.placement)&&kr(r,this.nav,`horizontal`),e.preventDefault()}}}handleScrollToStart(){this.nav.scroll({left:this.localize.dir()===`rtl`?this.nav.scrollLeft+this.nav.clientWidth:this.nav.scrollLeft-this.nav.clientWidth,behavior:`smooth`})}handleScrollToEnd(){this.nav.scroll({left:this.localize.dir()===`rtl`?this.nav.scrollLeft-this.nav.clientWidth:this.nav.scrollLeft+this.nav.clientWidth,behavior:`smooth`})}setActiveTab(e,t){if(t={emitEvents:!0,scrollBehavior:`auto`,...t},e!==this.activeTab&&!e.disabled){let n=this.activeTab;this.activeTab=e,this.tabs.forEach(e=>{e.active=e===this.activeTab,e.tabIndex=e===this.activeTab?0:-1}),this.panels.forEach(e=>e.active=e.name===this.activeTab?.panel),this.syncIndicator(),[`top`].includes(this.placement)&&kr(this.activeTab,this.nav,`horizontal`,t.scrollBehavior),t.emitEvents&&(n&&this.emit(`syn-tab-hide`,{detail:{name:n.panel}}),this.emit(`syn-tab-show`,{detail:{name:this.activeTab.panel}}))}}setAriaLabels(){this.tabs.forEach(e=>{let t=this.panels.find(t=>t.name===e.panel);t&&(e.setAttribute(`aria-controls`,t.getAttribute(`id`)),t.setAttribute(`aria-labelledby`,e.getAttribute(`id`)))})}repositionIndicator(){let e=this.getActiveTab();if(!e)return;let t=e.clientWidth,n=e.clientHeight,r=this.localize.dir()===`rtl`,i=this.tabs.slice(0,this.tabs.indexOf(e)).reduce((e,t)=>({left:e.left+t.clientWidth,top:e.top+t.clientHeight}),{left:0,top:0});switch(this.placement){case`top`:this.indicator.style.width=`calc(${t}px - ${this.contained||this.sharp?`2 * var(--syn-spacing-large)`:`0px`})`,this.indicator.style.height=`auto`,this.indicator.style.translate=`calc(${r?`-`:``}1 * (${i.left}px + ${this.contained||this.sharp?`var(--syn-spacing-large)`:`0px`}))`;break;case`start`:case`end`:this.indicator.style.width=`auto`,this.indicator.style.height=`calc(${n}px - ${this.contained||this.sharp?`2 * var(--syn-spacing-small)`:`0px`})`,this.indicator.style.translate=`0 calc(${i.top}px + ${this.contained||this.sharp?`var(--syn-spacing-small)`:`0px`})`}}syncTabsAndPanels(){this.focusableTabs=this.tabs.filter(e=>!e.disabled),this.syncIndicator(),this.updateComplete.then(()=>this.updateScrollControls())}findNextFocusableTab(e,t){let n=null,r=t===`forward`?1:-1,i=e+r;for(;e<this.tabs.length;){if(n=this.tabs[i]||null,n===null){n=t===`forward`?this.focusableTabs[0]:this.focusableTabs[this.focusableTabs.length-1];break}if(!n.disabled)break;i+=r}return n}updateScrollButtons(){this.hasScrollControls&&!this.fixedScrollControls&&(this.shouldHideScrollStartButton=this.scrollFromStart()<=this.scrollOffset,this.shouldHideScrollEndButton=this.isScrolledToEnd())}isScrolledToEnd(){return this.scrollFromStart()+this.nav.clientWidth>=this.nav.scrollWidth-this.scrollOffset}scrollFromStart(){return this.localize.dir()===`rtl`?-this.nav.scrollLeft:this.nav.scrollLeft}updateScrollControls(){this.hasScrollControls=!this.noScrollControls&&[`top`].includes(this.placement)&&this.nav.scrollWidth>this.nav.clientWidth+1,this.updateScrollButtons()}syncIndicator(){this.getActiveTab()?(this.indicator.style.display=`block`,this.repositionIndicator()):this.indicator.style.display=`none`}show(e){let t=this.tabs.find(t=>t.panel===e);t&&this.setActiveTab(t,{scrollBehavior:`smooth`})}preventFocus(e){e.preventDefault()}render(){let e=this.localize.dir()===`rtl`;return g`
    ...
    `}};Z.styles=[w,ec,$s],Z.dependencies={"syn-icon-button":P,"syn-resize-observer":Qs},v([Tt({slot:`nav`,selector:`syn-tab`})],Z.prototype,`tabs`,2),v([Tt({selector:`syn-tab-panel`})],Z.prototype,`panels`,2),v([D(`.tab-group`)],Z.prototype,`tabGroup`,2),v([D(`.tab-group__body`)],Z.prototype,`body`,2),v([D(`.tab-group__nav`)],Z.prototype,`nav`,2),v([D(`.tab-group__indicator`)],Z.prototype,`indicator`,2),v([E()],Z.prototype,`hasScrollControls`,2),v([E()],Z.prototype,`shouldHideScrollStartButton`,2),v([E()],Z.prototype,`shouldHideScrollEndButton`,2),v([T()],Z.prototype,`placement`,2),v([T()],Z.prototype,`activation`,2),v([T({attribute:`no-scroll-controls`,type:Boolean})],Z.prototype,`noScrollControls`,2),v([T({type:Boolean})],Z.prototype,`contained`,2),v([T({type:Boolean})],Z.prototype,`sharp`,2),v([T({attribute:`fixed-scroll-controls`,type:Boolean})],Z.prototype,`fixedScrollControls`,2),v([xt({passive:!0})],Z.prototype,`updateScrollButtons`,1),v([C(`noScrollControls`,{waitUntilFirstUpdate:!0})],Z.prototype,`updateScrollControls`,1),v([C(`placement`,{waitUntilFirstUpdate:!0})],Z.prototype,`syncIndicator`,1),Z.define(`syn-tab-group`);var rc=h`
  :host {
...
`,ac=0,oc=class extends O{constructor(){super(...arguments),this.localize=new j(this),this.attrId=++ac,this.componentId=`syn-tab-${this.attrId}`,this.panel=``,this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`tab`)}handleCloseClick(e){e.stopPropagation(),this.emit(`syn-close`)}handleActiveChange(){this.setAttribute(`aria-selected`,this.active?`true`:`false`)}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled?`true`:`false`),this.tabIndex=this.disabled&&!this.active?-1:0}render(){return this.id=this.id.length>0?this.id:this.componentId,g`
    ...
    `}};oc.styles=[w,ic,rc],oc.dependencies={"syn-icon-button":P},v([D(`.tab`)],oc.prototype,`tab`,2),v([T({reflect:!0})],oc.prototype,`panel`,2),v([T({type:Boolean,reflect:!0})],oc.prototype,`active`,2),v([T({type:Boolean,reflect:!0})],oc.prototype,`closable`,2),v([T({type:Boolean,reflect:!0})],oc.prototype,`disabled`,2),v([T({type:Number,reflect:!0})],oc.prototype,`tabIndex`,2),v([C(`active`)],oc.prototype,`handleActiveChange`,1),v([C(`disabled`)],oc.prototype,`handleDisabledChange`,1),oc.define(`syn-tab`),Mr.define(`syn-tag`);var sc=h`
  /* Write custom CSS here */
  .tab-panel {
    color: var(--syn-typography-color-text);
  }
...
`,lc=0,uc=class extends O{constructor(){super(...arguments),this.attrId=++lc,this.componentId=`syn-tab-panel-${this.attrId}`,this.name=``,this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute(`role`,`tabpanel`)}handleActiveChange(){this.setAttribute(`aria-hidden`,this.active?`false`:`true`)}render(){return g`
      ...
      ></slot>
    `}};uc.styles=[w,cc,sc],v([T({reflect:!0})],uc.prototype,`name`,2),v([T({type:Boolean,reflect:!0})],uc.prototype,`active`,2),v([C(`active`)],uc.prototype,`handleActiveChange`,1),uc.define(`syn-tab-panel`),Es.define(`syn-tooltip`);var dc=h`
  /* stylelint-disable no-descending-specificity */
